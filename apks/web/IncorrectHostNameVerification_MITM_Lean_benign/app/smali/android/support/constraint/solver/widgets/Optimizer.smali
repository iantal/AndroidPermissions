...
.method static applyChainOptimized(Landroid/support/constraint/solver/widgets/ConstraintWidgetContainer;Landroid/support/constraint/solver/LinearSystem;IILandroid/support/constraint/solver/widgets/ConstraintWidget;)Z
    ...
    .line 388
    .local v10, "previousMatchConstraintsWidget":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    move-object/from16 v11, p0

    iget-object v12, v11, Landroid/support/constraint/solver/widgets/ConstraintWidgetContainer;->mListDimensionBehaviors:[Landroid/support/constraint/solver/widgets/ConstraintWidget$DimensionBehaviour;
    ...
    .line 400
    iget-object v3, v14, Landroid/support/constraint/solver/widgets/ConstraintAnchor;->mOwner:Landroid/support/constraint/solver/widgets/ConstraintWidget;
    ...
    .local v20, "firstVisibleWidget":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    ...
    .line 406
    .end local v20    # "firstVisibleWidget":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    ...
    .line 406
    .end local v4    # "firstVisibleWidget":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    .restart local v20    # "firstVisibleWidget":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    const/4 v3, 0x0
    ...
    .local v2, "head":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    ...
    iget v3, v2, Landroid/support/constraint/solver/widgets/ConstraintWidget;->mVerticalChainStyle:I
    ...
    .line 427
    .end local v2    # "head":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    ...
    .local v26, "next":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    if-eq v6, v7, :cond_12
    ...
    iget-object v3, v4, Landroid/support/constraint/solver/widgets/ConstraintWidget;->mListDimensionBehaviors:[Landroid/support/constraint/solver/widgets/ConstraintWidget$DimensionBehaviour;
    ...
    .line 474
    iget v3, v4, Landroid/support/constraint/solver/widgets/ConstraintWidget;->mMatchConstraintDefaultWidth:I
    ...
    iget v7, v4, Landroid/support/constraint/solver/widgets/ConstraintWidget;->mMatchConstraintMinWidth:I

    if-nez v7, :cond_14

    iget v7, v4, Landroid/support/constraint/solver/widgets/ConstraintWidget;->mMatchConstraintMaxWidth:I
    ...
    .line 482
    :cond_16
    iget v3, v4, Landroid/support/constraint/solver/widgets/ConstraintWidget;->mMatchConstraintMinHeight:I

    if-nez v3, :cond_19

    iget v3, v4, Landroid/support/constraint/solver/widgets/ConstraintWidget;->mMatchConstraintMaxHeight:I
    ...
    .line 486
    :cond_17
    iget-object v3, v4, Landroid/support/constraint/solver/widgets/ConstraintWidget;->mWeight:[F
    ...
    .line 496
    .end local v10    # "previousMatchConstraintsWidget":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    ...
    .restart local v10    # "previousMatchConstraintsWidget":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    :cond_19
    :goto_f
    const/4 v3, 0x0
    ...
    .line 499
    .end local v26    # "next":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    ...
    .local v28, "nextAnchor":Landroid/support/constraint/solver/widgets/ConstraintAnchor;
    ...
    .line 503
    .end local v28    # "nextAnchor":Landroid/support/constraint/solver/widgets/ConstraintAnchor;
    .local v3, "nextAnchor":Landroid/support/constraint/solver/widgets/ConstraintAnchor;
    .restart local v26    # "next":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    :cond_1c
    move-object/from16 v28, v3

    .line 503
    .end local v3    # "nextAnchor":Landroid/support/constraint/solver/widgets/ConstraintAnchor;
    .restart local v28    # "nextAnchor":Landroid/support/constraint/solver/widgets/ConstraintAnchor;
    const/4 v3, 0x0
    ...
    .line 514
    .end local v10    # "previousMatchConstraintsWidget":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    .local v30, "previousMatchConstraintsWidget":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    add-int/lit8 v19, p3, 0x1
    ...
    .local v31, "last":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    if-eqz v6, :cond_46
    ...
    iget-object v12, v10, Landroid/support/constraint/solver/widgets/ResolutionAnchor;->target:Landroid/support/constraint/solver/widgets/ResolutionAnchor;
    ...
    .line 565
    iget-object v12, v4, Landroid/support/constraint/solver/widgets/ConstraintWidget;->mListNextVisibleWidget:[Landroid/support/constraint/solver/widgets/ConstraintWidget;
    ...
    :goto_16
    iget-object v7, v4, Landroid/support/constraint/solver/widgets/ConstraintWidget;->mListNextVisibleWidget:[Landroid/support/constraint/solver/widgets/ConstraintWidget;
    ...
    invoke-virtual {v8, v13, v14}, Landroid/support/constraint/solver/widgets/ResolutionAnchor;->resolve(Landroid/support/constraint/solver/widgets/ResolutionAnchor;F)V
    ...
    .line 612
    :cond_33
    iget-object v8, v4, Landroid/support/constraint/solver/widgets/ConstraintWidget;->mListNextVisibleWidget:[Landroid/support/constraint/solver/widgets/ConstraintWidget;
    ...
    invoke-virtual {v12, v13, v10}, Landroid/support/constraint/solver/widgets/ResolutionAnchor;->resolve(Landroid/support/constraint/solver/widgets/ResolutionAnchor;F)V
    ...
    invoke-virtual {v12, v13, v14}, Landroid/support/constraint/solver/widgets/ResolutionAnchor;->resolve(Landroid/support/constraint/solver/widgets/ResolutionAnchor;F)V
    ...
    invoke-virtual {v12, v0}, Landroid/support/constraint/solver/widgets/ResolutionAnchor;->addResolvedValue(Landroid/support/constraint/solver/LinearSystem;)V
    ...
    iget-wide v13, v12, Landroid/support/constraint/solver/Metrics;->nonresolvedWidgets:J

    sub-long v13, v13, v21

    iput-wide v13, v12, Landroid/support/constraint/solver/Metrics;->nonresolvedWidgets:J

    .line 659
    sget-object v12, Landroid/support/constraint/solver/LinearSystem;->sMetrics:Landroid/support/constraint/solver/Metrics;

    iget-wide v13, v12, Landroid/support/constraint/solver/Metrics;->resolvedWidgets:J

    add-long v13, v13, v21

    iput-wide v13, v12, Landroid/support/constraint/solver/Metrics;->resolvedWidgets:J

    .line 660
    sget-object v12, Landroid/support/constraint/solver/LinearSystem;->sMetrics:Landroid/support/constraint/solver/Metrics;

    iget-wide v13, v12, Landroid/support/constraint/solver/Metrics;->chainConnectionResolved:J

    add-long v13, v13, v21

    iput-wide v13, v12, Landroid/support/constraint/solver/Metrics;->chainConnectionResolved:J
    ...
    iget-object v14, v9, Landroid/support/constraint/solver/widgets/ResolutionAnchor;->resolvedTarget:Landroid/support/constraint/solver/widgets/ResolutionAnchor;

    invoke-virtual {v13, v14, v8}, Landroid/support/constraint/solver/widgets/ResolutionAnchor;->resolve(Landroid/support/constraint/solver/widgets/ResolutionAnchor;F)V
