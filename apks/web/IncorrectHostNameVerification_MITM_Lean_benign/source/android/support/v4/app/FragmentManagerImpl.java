  ...
  implements LayoutInflater.Factory2
{
  ...
  private void executeOpsTogether(ArrayList<BackStackRecord> paramArrayList, ArrayList<Boolean> paramArrayList1, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      for (localObject = localBackStackRecord.expandOps(this.mTmpAddedFragments, (Fragment)localObject);; localObject = localBackStackRecord.trackAddedFragmentsInPop(this.mTmpAddedFragments, (Fragment)localObject)) {
        break;
      }
      i = m;
      if (j == 0) {
        if (localBackStackRecord.mAddToBackStack) {
          i = m;
        } else {
          i = 0;
        }
    ...
    if (bool)
    {
      ...
      i = postponePostponableTransactions(paramArrayList, paramArrayList1, paramInt1, paramInt2, (ArraySet)localObject);
      ...
      while (i < n)
      {
        ...
        if (localObject1 != null)
        {
          ...
          if ((((Fragment)localObject1).mState > 0) && (((FragmentState)localObject2).mSavedFragmentState == null))
          {
            ...
            if (((Fragment)localObject1).mTarget != null)
            {
              if (((Fragment)localObject1).mTarget.mIndex < 0)
              {
                ...
                ((StringBuilder)localObject3).append(((Fragment)localObject1).mTarget);
          ...
          if (DEBUG)
          {
            ...
            ((StringBuilder)localObject3).append(localObject1);
            ((StringBuilder)localObject3).append(": ");
            ((StringBuilder)localObject3).append(((FragmentState)localObject2).mSavedFragmentState);
            Log.v("FragmentManager", ((StringBuilder)localObject3).toString());
            j = m;
          }
        }
  ...
  void saveNonConfig()
  {
    ...
    this.mSavedNonConfig = new FragmentManagerNonConfig((List)localObject1, (List)localObject3, (List)localObject2);
  }
