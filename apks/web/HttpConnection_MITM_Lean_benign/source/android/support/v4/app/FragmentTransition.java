...
class FragmentTransition
{
  ...
  private static void addToFirstInLastOut(BackStackRecord paramBackStackRecord, BackStackRecord.Op paramOp, SparseArray<FragmentContainerTransition> paramSparseArray, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      ...
      {
        bool1 = bool2;
        if (localFragment.mHiddenChanged)
        {
          bool1 = bool2;
      ...
      if (paramBoolean2)
      {
        ...
        if (!localFragment.mAdded)
        {
          ...
          {
            i = i2;
            if (localFragment.mView.getVisibility() == 0)
            {
              i = i2;
    ...
    {
      localObject = paramOp;
      if ((localObject == null) || (((FragmentContainerTransition)localObject).firstOut == null))
      {
        paramOp = ensureContainer((FragmentContainerTransition)localObject, paramSparseArray, i4);
    ...
    if ((!paramBoolean2) && (i != 0) && (paramOp != null) && (paramOp.lastIn == localFragment)) {
      paramOp.lastIn = null;
    }
  }
  ...
  private static Object configureSharedElementsOrdered(FragmentTransitionImpl paramFragmentTransitionImpl, ViewGroup paramViewGroup, final View paramView, final ArrayMap<String, String> paramArrayMap, final FragmentContainerTransition paramFragmentContainerTransition, final ArrayList<View> paramArrayList1, final ArrayList<View> paramArrayList2, final Object paramObject1, Object paramObject2)
  {
    ...
    if (localFragment1 != null)
    {
      ...
      if (paramArrayMap.isEmpty()) {
        ...
        localObject = getSharedElementTransition(paramFragmentTransitionImpl, localFragment1, localFragment2, bool1);
      }
      ...
      callSharedElementStartEnd(localFragment1, localFragment2, bool1, localArrayMap, true);
      ...
      if (localObject != null)
      {
        ...
        setOutEpicenter(paramFragmentTransitionImpl, localObject, paramObject2, localArrayMap, bool2, localBackStackRecord);
      ...
      OneShotPreDrawListener.add(paramViewGroup, new Runnable()
      {
        public void run()
        {
          ...
          FragmentTransition.callSharedElementStartEnd(localFragment1, localFragment2, bool1, (ArrayMap)localObject, false);
          if (localObject != null)
          {
            this.val$impl.swapSharedElementTargets(localObject, paramArrayList1, paramArrayList2);
            localObject = FragmentTransition.getInEpicenterView((ArrayMap)localObject, paramFragmentContainerTransition, paramObject1, bool1);
            if (localObject != null) {
              this.val$impl.getBoundsOnScreen((View)localObject, localRect);
            }
          }
        }
      });
    ...
    if (localFragment1 != null)
    {
      ...
      OneShotPreDrawListener.add(paramViewGroup, new Runnable()
      {
        public void run()
        {
          ...
          if (paramArrayMap != null) {
            paramFragmentTransitionImpl.getBoundsOnScreen(paramArrayMap, paramView);
          }
        }
      });
      return localObject;
  ...
  private static void configureTransitionsOrdered(FragmentManagerImpl paramFragmentManagerImpl, int paramInt, FragmentContainerTransition paramFragmentContainerTransition, View paramView, ArrayMap<String, String> paramArrayMap)
  {
    ...
    if (paramFragmentManagerImpl.mContainer.onHasView()) {
      ...
      paramFragmentManagerImpl = localObject1;
    }
    ...
    localObject1 = getExitTransition(localFragmentTransitionImpl, (Fragment)localObject4, bool2);
  ...
  private static void configureTransitionsReordered(FragmentManagerImpl paramFragmentManagerImpl, int paramInt, FragmentContainerTransition paramFragmentContainerTransition, View paramView, ArrayMap<String, String> paramArrayMap)
  {
    ...
    localObject1 = getExitTransition(localFragmentTransitionImpl, (Fragment)localObject3, bool2);
