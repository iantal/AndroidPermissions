...
{
  private static String TAG = "Secure/AddStudent";
  ...
  {
    super.onResume();
    final EditText localEditText1 = (EditText)findViewById(2131165312);
    final EditText localEditText2 = (EditText)findViewById(2131165311);
    ((Button)findViewById(2131165282)).setOnClickListener(new View.OnClickListener()
    {
