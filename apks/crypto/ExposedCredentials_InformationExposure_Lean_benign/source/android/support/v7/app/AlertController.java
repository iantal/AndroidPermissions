...
class AlertController
{
  ...
  {
    Object localObject = this.mWindow.findViewById(R.id.scrollIndicatorUp);
  ...
  public static class AlertParams
  {
    ...
    private void createListView(final AlertController paramAlertController)
    {
      ...
      if (this.mIsMultiChoice)
      {
        ...
        for (localObject = new ArrayAdapter(this.mContext, paramAlertController.mMultiChoiceItemLayout, 16908308, this.mItems)
            {
