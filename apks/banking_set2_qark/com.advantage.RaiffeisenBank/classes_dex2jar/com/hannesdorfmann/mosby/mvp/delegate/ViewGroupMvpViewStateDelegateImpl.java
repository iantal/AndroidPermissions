  ...
  extends ViewGroupMvpDelegateImpl<V, P>
{
  ...
  public void onRestoreInstanceState(Parcelable paramParcelable)
  {
    ...
    ViewStateSavedState localViewStateSavedState = (ViewStateSavedState)paramParcelable;
    ((MvpInternalLayoutViewStateDelegate)getInternalDelegate()).createOrRestoreViewState(localViewStateSavedState);
    localMvpViewStateViewGroupDelegateCallback.superOnRestoreInstanceState(localViewStateSavedState.getSuperState());
  }
