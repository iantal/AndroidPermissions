  ...
  extends MvpInternalDelegate<V, P>
{
  ...
  public Parcelable saveViewState(Parcelable paramParcelable)
  {
    ...
    ViewStateSavedState localViewStateSavedState = new ViewStateSavedState(paramParcelable);
    localViewStateSavedState.setMosbyViewState((RestorableParcelableViewState)localMvpViewStateViewGroupDelegateCallback.getViewState());
    return localViewStateSavedState;
  }
}
