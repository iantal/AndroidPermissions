...
class GifFrameLoader
{
  ...
  private void loadNextFrame()
  {
    ...
    long l = SystemClock.uptimeMillis() + this.gifDecoder.getNextDelay();
    DelayTarget localDelayTarget = new DelayTarget(this.handler, this.gifDecoder.getCurrentFrameIndex(), l);
