  ...
  implements GifFrameLoader.FrameCallback
{
  ...
  public void draw(Canvas paramCanvas)
  {
    ...
    Bitmap localBitmap1 = this.frameLoader.getCurrentFrame();
    if (localBitmap1 != null) {}
    for (Bitmap localBitmap2 = localBitmap1;; localBitmap2 = this.state.firstFrame)
    {
      paramCanvas.drawBitmap(localBitmap2, null, this.destRect, this.paint);
      return;
    }
  }
