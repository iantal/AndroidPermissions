  ...
  implements ResourceDecoder<ImageVideoWrapper, GifBitmapWrapper>
{
    ...
    throws IOException
  {
    ...
    if (localResource != null) {
      localGifBitmapWrapper = new GifBitmapWrapper(localResource, null);
    }
    ...
    throws IOException
  {
    ...
    if (localResource != null)
    {
      localGifDrawable = (GifDrawable)localResource.get();
      if (localGifDrawable.getFrameCount() > 1) {
        localGifBitmapWrapper = new GifBitmapWrapper(null, localResource);
      }
    }
    else
    {
