  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      if ((bool) && (localObject1 == null) && (Log.isLoggable("RMRetriever", 5))) {
        Log.w("RMRetriever", "Failed to remove expected request manager fragment, manager: " + localObject2);
      }
      return bool;
      android.app.FragmentManager localFragmentManager1 = (android.app.FragmentManager)paramMessage.obj;
      localObject2 = localFragmentManager1;
      localObject1 = this.pendingRequestManagerFragments.remove(localFragmentManager1);
      continue;
      android.support.v4.app.FragmentManager localFragmentManager = (android.support.v4.app.FragmentManager)paramMessage.obj;
      localObject2 = localFragmentManager;
      localObject1 = this.pendingSupportRequestManagerFragments.remove(localFragmentManager);
    }
  }
