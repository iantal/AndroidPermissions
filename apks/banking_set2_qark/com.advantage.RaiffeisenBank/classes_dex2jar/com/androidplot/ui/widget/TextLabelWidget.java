  ...
  extends Widget
{
  ...
  public void doOnDraw(Canvas paramCanvas, RectF paramRectF)
  {
    ...
    PointF localPointF = LayoutManager.getAnchorCoordinates(paramRectF, AnchorPosition.CENTER);
    try
    {
      paramCanvas.save(31);
  ...
  public void pack()
  {
    ...
    default: 
      return;
    case 1: 
      setSize(new SizeMetrics(localRect.height(), SizeLayoutType.ABSOLUTE, 2 + localRect.width(), SizeLayoutType.ABSOLUTE));
      return;
    }
    setSize(new SizeMetrics(localRect.width(), SizeLayoutType.ABSOLUTE, 2 + localRect.height(), SizeLayoutType.ABSOLUTE));
  }
