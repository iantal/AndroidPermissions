...
public abstract class ValueMarker<PositionMetricType extends PositionMetric>
{
  ...
  public static enum TextOrientation
  {
    static
    {
      TextOrientation[] arrayOfTextOrientation = new TextOrientation[2];
      arrayOfTextOrientation[0] = HORIZONTAL;
      arrayOfTextOrientation[1] = VERTICAL;
      a = arrayOfTextOrientation;
    }
