...
public class XYStepCalculator
{
  ...
  public static XYStep getStep(XYStepMode paramXYStepMode, float paramFloat, double paramDouble, Number paramNumber1, Number paramNumber2)
  {
    ...
    for (;;)
    {
      return new XYStep(f1, f2, paramDouble);
      f2 = (float)(paramDouble / ValPixConverter.valPerPix(paramNumber1.doubleValue(), paramNumber2.doubleValue(), paramFloat));
      f1 = paramFloat / f2;
      continue;
      f2 = new Double(paramDouble).floatValue();
      f1 = paramFloat / f2;
      paramDouble = ValPixConverter.valPerPix(paramNumber1.doubleValue(), paramNumber2.doubleValue(), paramFloat) * f2;
      continue;
      f1 = new Double(paramDouble).floatValue();
      f2 = paramFloat / (f1 - 1.0F);
      paramDouble = ValPixConverter.valPerPix(paramNumber1.doubleValue(), paramNumber2.doubleValue(), paramFloat) * f2;
    }
  }
}
