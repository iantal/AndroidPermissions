  ...
  implements PageIndicator
{
  ...
  public UnderlinePageIndicator(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    setFades(localTypedArray.getBoolean(R.styleable.UnderlinePageIndicator_fades, bool));
    setSelectedColor(localTypedArray.getColor(R.styleable.UnderlinePageIndicator_selectedColor, k));
    setFadeDelay(localTypedArray.getInteger(R.styleable.UnderlinePageIndicator_fadeDelay, i));
    setFadeLength(localTypedArray.getInteger(R.styleable.UnderlinePageIndicator_fadeLength, j));
    Drawable localDrawable = localTypedArray.getDrawable(R.styleable.UnderlinePageIndicator_android_background);
