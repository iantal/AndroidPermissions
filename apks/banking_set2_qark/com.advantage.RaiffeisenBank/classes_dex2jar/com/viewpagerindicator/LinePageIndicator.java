  ...
  implements PageIndicator
{
  ...
  public LinePageIndicator(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    this.mCentered = localTypedArray.getBoolean(R.styleable.LinePageIndicator_centered, bool);
    this.mLineWidth = localTypedArray.getDimension(R.styleable.LinePageIndicator_lineWidth, f1);
    this.mGapWidth = localTypedArray.getDimension(R.styleable.LinePageIndicator_gapWidth, f2);
    setStrokeWidth(localTypedArray.getDimension(R.styleable.LinePageIndicator_strokeWidth, f3));
    this.mPaintUnselected.setColor(localTypedArray.getColor(R.styleable.LinePageIndicator_unselectedColor, j));
    this.mPaintSelected.setColor(localTypedArray.getColor(R.styleable.LinePageIndicator_selectedColor, i));
    Drawable localDrawable = localTypedArray.getDrawable(R.styleable.LinePageIndicator_android_background);
