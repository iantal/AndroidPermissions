  ...
  implements PageIndicator
{
  ...
  public TitlePageIndicator(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    this.mFooterLineHeight = localTypedArray.getDimension(R.styleable.TitlePageIndicator_footerLineHeight, f1);
    this.mFooterIndicatorStyle = IndicatorStyle.fromValue(localTypedArray.getInteger(R.styleable.TitlePageIndicator_footerIndicatorStyle, j));
    this.mFooterIndicatorHeight = localTypedArray.getDimension(R.styleable.TitlePageIndicator_footerIndicatorHeight, f2);
    this.mFooterIndicatorUnderlinePadding = localTypedArray.getDimension(R.styleable.TitlePageIndicator_footerIndicatorUnderlinePadding, f3);
    this.mFooterPadding = localTypedArray.getDimension(R.styleable.TitlePageIndicator_footerPadding, f4);
    this.mLinePosition = LinePosition.fromValue(localTypedArray.getInteger(R.styleable.TitlePageIndicator_linePosition, k));
    this.mTopPadding = localTypedArray.getDimension(R.styleable.TitlePageIndicator_topPadding, f8);
    this.mTitlePadding = localTypedArray.getDimension(R.styleable.TitlePageIndicator_titlePadding, f6);
    this.mClipPadding = localTypedArray.getDimension(R.styleable.TitlePageIndicator_clipPadding, f7);
    this.mColorSelected = localTypedArray.getColor(R.styleable.TitlePageIndicator_selectedColor, m);
    this.mColorText = localTypedArray.getColor(R.styleable.TitlePageIndicator_android_textColor, n);
    this.mBoldText = localTypedArray.getBoolean(R.styleable.TitlePageIndicator_selectedBold, bool);
    float f9 = localTypedArray.getDimension(R.styleable.TitlePageIndicator_android_textSize, f5);
    int i1 = localTypedArray.getColor(R.styleable.TitlePageIndicator_footerColor, i);
    ...
    Drawable localDrawable = localTypedArray.getDrawable(R.styleable.TitlePageIndicator_android_background);
  ...
  {
    Object localObject = this.mViewPager.getAdapter().getPageTitle(paramInt);
    if (localObject == null) {
      localObject = "";
    }
    return localObject;
  ...
  protected void onDraw(Canvas paramCanvas)
  {
    ...
    do
    {
      ...
      for (int i5 = 1;; i5 = 0)
      {
        ...
        if (localRect1.right > f3) {
          clipViewOnTheRight(localRect1, f6, i2);
        }
      ...
      if (this.mCurrentPage < k) {
        for (int i11 = 1 + this.mCurrentPage; i11 < i; i11++)
        {
          ...
          if (localRect5.right > f3)
          {
            ...
            clipViewOnTheRight(localRect5, i12, i2);
      ...
      int i6 = this.mColorText >>> 24;
      int i7 = 0;
      if (i7 < i)
      {
        Rect localRect3 = (Rect)localArrayList.get(i7);
        int i8;
        CharSequence localCharSequence;
        Paint localPaint;
        if (((localRect3.left > m) && (localRect3.left < i2)) || ((localRect3.right > m) && (localRect3.right < i2)))
        {
          if (i7 != i3) {
            break label946;
          }
          i8 = 1;
          localCharSequence = getTitle(i7);
          localPaint = this.mPaintText;
          if ((i8 == 0) || (i5 == 0) || (!this.mBoldText)) {
            break label952;
          }
        }
        for (boolean bool = true;; bool = false)
        {
          ...
          if ((i8 != 0) && (i4 != 0)) {
            this.mPaintText.setAlpha(i6 - (int)(f5 * i6));
          }
          int i9 = j - 1;
          if (i7 < i9)
          {
            Rect localRect4 = (Rect)localArrayList.get(i7 + 1);
      ...
      f8 = this.mFooterIndicatorHeight;
      ...
      this.mPath.reset();
      this.mPath.moveTo(0.0F, i1 - f7 / 2.0F);
      this.mPath.lineTo(n, i1 - f7 / 2.0F);
      this.mPath.close();
    ...
    Rect localRect2 = (Rect)localArrayList.get(i3);
  ...
  public static enum IndicatorStyle
  {
    ...
    {
      for (IndicatorStyle localIndicatorStyle : ) {
  ...
  public static enum LinePosition
  {
    ...
    {
      for (LinePosition localLinePosition : ) {
