  ...
  extends Fragment
{
  ...
  {
    View localView = paramLayoutInflater.inflate(2130903304, paramViewGroup, false);
    ...
    this.mDiscard = ((ViewGroup)localView.findViewById(2131558607));
    this.mDone = ((ViewGroup)localView.findViewById(2131558609));
    ...
    extends AsyncTask<String[], Void, GenericResponse>
  {
    ...
    protected GenericResponse doInBackground(String[]... paramVarArgs)
    {
      ...
      String str3 = DSQHelper.getMobileAPICollectInfo(PasswordExpiredFragment.this.getActivity());
      return new SOAPRequests().changePasswordRequest(str1, str2, str3, "1");
    }
