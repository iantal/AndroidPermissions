  ...
  extends BaseActivity
{
  ...
  protected void onDestroy()
  {
    ...
    TagConstraint localTagConstraint = TagConstraint.ANY;
    String[] arrayOfString = new String[1];
    arrayOfString[0] = this.activitySessionId;
    localJobManager.cancelJobsInBackground(null, localTagConstraint, arrayOfString);
    super.onDestroy();
  }
