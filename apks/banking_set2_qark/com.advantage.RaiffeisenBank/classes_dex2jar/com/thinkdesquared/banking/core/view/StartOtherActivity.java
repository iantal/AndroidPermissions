  ...
  implements AIBASConstants
{
  ...
  private boolean removeNonUsefulExtrasForWidgetConf(String paramString, Intent paramIntent)
  {
    ...
    if (localBundle != null)
    {
      boolean bool2 = paramIntent.getExtras().containsKey("INTENT_START_WITH_CONFIGURATION_WIDGET");
      bool1 = false;
      if (bool2)
      {
        boolean bool3 = paramString.equals(getString(2131166271));
        bool1 = false;
        if (!bool3)
        {
      ...
      if ((paramIntent.getExtras().containsKey("INTENT_UNREGISTER_CONFIGURATION_WIDGET")) && (!paramString.equals(getString(2131166271))))
      {
        paramIntent.removeExtra("INTENT_UNREGISTER_CONFIGURATION_WIDGET");
        bool1 = true;
      }
      if ((paramIntent.getExtras().containsKey("appWidgetId")) && (!paramString.equals(getString(2131166271))))
      {
      ...
      if ((paramIntent.getExtras().containsKey("INTENT_START_SELECT_FOR_WIDGET_CONFIGURATION")) && (!paramIntent.getExtras().getBoolean("INTENT_START_SELECT_FOR_WIDGET_CONFIGURATION", false)))
      {
        paramIntent.removeExtra("INTENT_START_SELECT_FOR_WIDGET_CONFIGURATION");
        bool1 = true;
      }
      if ((paramIntent.getExtras().containsKey("INTENT_START_MANAGE_WIDGET_FOR_WIDGET_CONFIGURATION")) && (!paramIntent.getExtras().getBoolean("INTENT_START_MANAGE_WIDGET_FOR_WIDGET_CONFIGURATION", false)))
      {
  ...
  public void startActivityWithCode(String paramString, Intent paramIntent)
  {
    ...
    for (;;)
    {
      ...
      boolean bool1 = removeNonUsefulExtrasForWidgetConf(paramString, paramIntent);
      ...
      {
        boolean bool2 = paramString.equals(getString(2131166272));
        localIntent = null;
        if (bool2) {
