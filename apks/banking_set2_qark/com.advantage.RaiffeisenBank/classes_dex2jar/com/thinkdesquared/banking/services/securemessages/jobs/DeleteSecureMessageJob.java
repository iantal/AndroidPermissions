  ...
  extends SessionBoundJob
{
    ...
    throws Throwable
  {
    ...
    for (GenericResponse localGenericResponse = new DemoRequests().deleteSecureMessageDemoRequest();; localGenericResponse = new SOAPRequests().deleteSecureMessageRequest(localArrayList))
    {
      assertNotCancelled();
      EventBus.getDefault().post(new DeleteSecureMessageResponseEvent(localGenericResponse, getSessionId(), this.mOrigin));
      return;
      localArrayList = new ArrayList();
      localArrayList.add(this.conversation.getStp());
    }
  }
