  ...
  implements LoaderManager.LoaderCallbacks<ManageWidgetsServiceVerifyResponse>
{
  ...
  public void onActivityCreated(Bundle paramBundle)
  {
    ...
    DSQHelper.setActionBarTitle(getActivity(), localActionBar, getString(2131166114));
    ...
    extends AsyncTask<String, Void, ManageWidgetsResultServiceResponse>
  {
    ...
    protected ManageWidgetsResultServiceResponse doInBackground(String... paramVarArgs)
    {
      if (AibasStore.getInstance().getLoggedInState() == AibasStore.LoggedInState.LoggedInState_ON)
      {
        ...
        return new SOAPRequests().executeManageWidgetsResult(str, ManageWidgetVerifyFragment.this.getAuthorizationElements());
      }
    ...
    protected void onPostExecute(ManageWidgetsResultServiceResponse paramManageWidgetsResultServiceResponse)
    {
      ...
      {
        String str2 = ManageWidgetVerifyFragment.this.getString(2131165683);
        if (ManageWidgetVerifyFragment.this.successMessage != null) {
          str2 = ManageWidgetVerifyFragment.this.successMessage;
        }
        if (AibasStore.getInstance().getLoggedInState() == AibasStore.LoggedInState.LoggedInState_ON)
        {
        ...
        if (!ManageWidgetVerifyFragment.this.startForManageWidgetConfiguration) {
          ManageWidgetVerifyFragment.this.mListener.onReceivedSuccessfullResultResponse(str2, true, paramManageWidgetsResultServiceResponse, 2131166290);
        }
        return;
      }
      ...
      String str1 = paramManageWidgetsResultServiceResponse.getErrors();
      ManageWidgetVerifyFragment.this.mListener.onReceivedSuccessfullResultResponse(str1, true, paramManageWidgetsResultServiceResponse, 2131166290);
    }
