  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    if (paramBundle == null)
    {
      ...
      if (!this.mIsTablet)
      {
        ...
        localFragmentTransaction2.replace(2131558650, this.mSecureMessageInboxFragment, getString(2131166262));
        localFragmentTransaction2.replace(2131558689, this.mSecureMessageInboxFiltersFragment, "fragment_tag_filters");
    ...
    localFragmentTransaction1.replace(2131558650, this.mSecureMessageInboxFragment, getString(2131166262));
    localFragmentTransaction1.replace(2131558689, this.mSecureMessageInboxFiltersFragment, "fragment_tag_filters");
    localFragmentTransaction1.replace(2131558690, this.mSecureMessageInboxViewMessageFragment, "fragment_tag_view");
