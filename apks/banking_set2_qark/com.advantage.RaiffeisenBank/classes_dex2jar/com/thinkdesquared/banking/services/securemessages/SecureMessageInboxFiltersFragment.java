  ...
  implements SecureMessageInboxFiltersView
{
  ...
  private void prepareIconsAndBackgrounds()
  {
    ...
    this.mSearchDrawable = localDSQBitmap.paintDrawableRes(2130838081, DSQStylist.fetchThemedResource(getActivity(), 2130772073));
    this.mDiscardDrawable = localDSQBitmap.paintDrawableRes(2130837876, DSQStylist.fetchThemedResource(getActivity(), 2130772073));
    this.mSearchImageView.setImageDrawable(localDSQBitmap.paintDrawableRes(2130838081, DSQStylist.fetchThemedResource(getActivity(), 2130772076)));
    this.mSearchDiscardImageView.setImageDrawable(this.mSearchDrawable);
    this.mDoneImageView.setImageDrawable(localDSQBitmap.paintDrawableRes(2130837879, DSQStylist.fetchThemedResource(getActivity(), 2130772076)));
    this.mFilterImageButton.setImageDrawable(localDSQBitmap.paintDrawableRes(2130837752, DSQStylist.fetchThemedResource(getActivity(), 2130772073)));
    Drawable localDrawable = localDSQBitmap.paintDrawableRes(2130838499, DSQStylist.fetchThemedResource(getActivity(), 2130772057));
    this.mArrowImageView.setImageDrawable(localDrawable);
    this.mFromDateButton.setCompoundDrawablesWithIntrinsicBounds(null, null, localDrawable, null);
    this.mToDateButton.setCompoundDrawablesWithIntrinsicBounds(null, null, localDrawable, null);
  }
  
  private void toggleFiltersLayoutVisibility(boolean paramBoolean)
  {
    LinearLayout localLinearLayout1 = this.mDatesLinearLayout;
    int i;
    int j;
    label29:
    ...
    if (paramBoolean)
    {
      ...
      LinearLayout localLinearLayout2 = this.mSpinnersLinearLayout;
      if (!paramBoolean) {
        break label63;
      }
      j = 0;
      localLinearLayout2.setVisibility(j);
      localLinearLayout3 = this.mAddFiltersLinearLayout;
      k = 0;
      if (!paramBoolean) {
        break label70;
      }
    ...
    for (;;)
    {
      localLinearLayout3.setVisibility(k);
      return;
      i = 8;
      break;
      label63:
  ...
  {
    int i = 8;
    RelativeLayout localRelativeLayout = this.mToolbarTitleWrapper;
    int j;
    ...
    if (paramBoolean)
    {
      ...
      localLinearLayout = this.mToolbarSearchWrapper;
      if (!paramBoolean) {
        break label44;
      }
    }
  ...
  {
    ImageView localImageView1 = this.mSearchDiscardImageView;
    Drawable localDrawable;
    ImageView localImageView2;
    if (this.mSearchEditText.getText().length() > 0)
    {
      localDrawable = this.mDiscardDrawable;
      localImageView1.setImageDrawable(localDrawable);
      localImageView2 = this.mDoneImageView;
    ...
    for (int i = 0;; i = 8)
    {
      ...
      return;
      localDrawable = this.mSearchDrawable;
      break;
    }
  }
