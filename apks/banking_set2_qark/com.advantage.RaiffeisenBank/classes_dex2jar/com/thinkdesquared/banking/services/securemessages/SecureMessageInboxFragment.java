  ...
  implements SecureMessageInboxView
{
  ...
  public void showValidationDialog(int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      ...
      return;
      str = getString(2131165467);
      bool = true;
      localOnClickListener = this.mDeleteDialogListener;
      continue;
      str = getString(2131165468);
  ...
  {
    PagingStickyListHeadersListView localPagingStickyListHeadersListView = this.mListView;
    int i;
    ...
    {
      i = 0;
      localPagingStickyListHeadersListView.setVisibility(i);
      localLinearLayout = this.mEmptyLinearLayout;
      j = 0;
      if (!paramBoolean) {
        break label43;
      }
