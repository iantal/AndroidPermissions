  ...
  extends SessionBoundJob
{
    ...
    throws Throwable
  {
    ...
    File localFile1 = localCacheManager.getFile(this.mFileName, this.mConversationStp, this.mFileId);
    if (localFile1 != null)
    {
      LogHelper.i("File retrieved from cache");
      sendResponseEvent(new GenericResponse("", "S", null), localFile1.getPath(), 1000);
      return;
    }
    ...
    File localFile2;
    for (GetSecureMessageAttachmentResponse localGetSecureMessageAttachmentResponse = new DemoRequests().getSecureMessageAttachmentRequest();; localGetSecureMessageAttachmentResponse = new SOAPRequests().getSecureMessageAttachmentRequest(this.mConversationStp, this.mStp, this.mFileId))
    {
      assertNotCancelled();
      localFile2 = localCacheManager.getPathForConversation(this.mConversationStp);
      if ((!"S".equalsIgnoreCase(localGetSecureMessageAttachmentResponse.resultCode)) || (localGetSecureMessageAttachmentResponse.getAttachment() == null)) {
        break;
      }
      localFile2 = localCacheManager.saveFile(localGetSecureMessageAttachmentResponse.getAttachment(), this.mFileName, this.mConversationStp, this.mFileId);
      if (localFile2 != null) {
        break;
      }
    ...
    sendResponseEvent(localGetSecureMessageAttachmentResponse, localFile2.getPath(), 1000);
  }
