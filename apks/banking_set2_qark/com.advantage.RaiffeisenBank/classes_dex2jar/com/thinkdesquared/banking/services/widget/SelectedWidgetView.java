  ...
  extends LinearLayout
{
  ...
  public SelectedWidgetView(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    View localView = ((LayoutInflater)paramContext.getSystemService("layout_inflater")).inflate(2130903433, this, false);
    this.container = ((RelativeLayout)localView.findViewById(2131558629));
    this.editButtonLinearLayout = ((LinearLayout)localView.findViewById(2131559569));
    this.editButton = ((AppCompatButton)localView.findViewById(2131558860));
    this.imageView = ((ImageView)localView.findViewById(2131559568));
