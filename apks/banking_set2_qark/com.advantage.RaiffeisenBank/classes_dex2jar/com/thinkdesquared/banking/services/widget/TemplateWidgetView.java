  ...
  extends LinearLayout
{
  ...
  private void updateUI()
  {
    ...
    if (this.template.getFromAccountNickname() == null)
    {
      ...
      str2 = this.template.getToAccountNickname();
    }
    for (;;)
    {
      this.targetAccountTextView.setText(str2);
      if (!this.isSelected) {
        break label334;
      }
      ...
      return;
      str1 = this.template.getFromAccountNickname();
      break;
      label118:
      ...
      {
        str2 = DSQHelper.formatIBANWithSpaces(this.template.getToAccountNickname());
      }
      ...
      else
      {
        ...
        if (this.template.getACTN().length() == 24) {
          str2 = DSQHelper.formatIBANWithSpaces(this.template.getACTN());
        } else {
          str2 = this.template.getACTN();
        }
      }
    }
    label334:
