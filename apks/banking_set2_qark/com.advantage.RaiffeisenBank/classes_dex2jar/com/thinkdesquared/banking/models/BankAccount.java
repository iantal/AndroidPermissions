  ...
  implements Serializable, Parcelable
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    do
    {
      ...
      localBankAccount = (BankAccount)paramObject;
      if (this.number == null) {
        break;
      }
    } while (this.number.equals(localBankAccount.number));
    for (;;)
    {
      return false;
      if (localBankAccount.number == null) {
        break;
      }
    }
  }
  ...
  public String getAmountWithCurrencyString(Context paramContext)
  {
    ...
    {
      boolean bool1 = this.ledgerBalance.contains("-");
      i = 0;
      if (bool1)
      {
        i = 1;
      ...
      str = DSQHelper.formatAmountString(this.ledgerBalance, paramContext);
      if (i != 0)
      {
        str = "-" + str;
        if ((this.typeRes != 2131166221) && (this.typeRes != 2131166219)) {
    ...
    for (;;)
    {
      return this.currency.toString() + " " + str;
      boolean bool2 = this.availableBalance.contains("-");
      i = 0;
      if (bool2)
      {
        i = 1;
      ...
      str = DSQHelper.formatAmountString(this.availableBalance, paramContext);
      break;
      label210:
