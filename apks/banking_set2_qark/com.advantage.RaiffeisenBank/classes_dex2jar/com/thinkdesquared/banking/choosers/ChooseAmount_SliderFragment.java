  ...
  extends Fragment
{
  ...
  public void onActivityCreated(Bundle paramBundle)
  {
    ...
    this.mRedRadioButton.setOnClickListener(local1);
    this.mNeutralRadioButton.setOnClickListener(local1);
    this.mGreenRadioButton.setOnClickListener(local1);
  }
  
  public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle)
  {
    LogHelper.d("RadioGroup Fragment", "onCreateView");
    View localView = paramLayoutInflater.inflate(2130903261, paramViewGroup, false);
    this.mRedRadioButton = ((RadioButton)localView.findViewById(2131559092));
    this.mNeutralRadioButton = ((RadioButton)localView.findViewById(2131559093));
    this.mGreenRadioButton = ((RadioButton)localView.findViewById(2131559094));
    return localView;
  }
