  ...
  extends BaseFragment
{
      ...
      if (this.mDecimalSeparatorIsClicked)
      {
        if (this.mDecimalPart.length() == 0)
        {
          ...
          if (this.mIntegerPart.length() > 0) {
            this.mIntegerPart = this.mIntegerPart.substring(0, -1 + this.mIntegerPart.length());
          }
        }
  ...
  public void numericButtonOnClick(Button paramButton)
  {
    ...
    for (;;)
    {
      ...
      return;
      label72:
      if ((this.mDecimalPart.length() == 1) && (!"0".equalsIgnoreCase(str)))
      {
        this.mDecimalPart += str;
        continue;
        if ((!this.mIntegerPart.equals("")) || (!str.equals("0"))) {
          if ((DSQHelper.isNotEmpty(this.mAmountType)) && (this.mIntegerPart.length() < 15)) {
            this.mIntegerPart += str;
  ...
  public void onActivityCreated(Bundle paramBundle)
  {
    ...
    for (;;)
    {
      String str = DSQHelper.getDecimalSeparator(getActivity());
      this.mButtonDecimalSeperator.setText(str);
      return;
