    ...
    extends BaseAdapter
  {
    ...
    public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
    {
      ...
      if (paramView == null)
      {
        ...
        localViewHolder.linearLayout = ((LinearLayout)paramView.findViewById(2131558638));
        localViewHolder.templateNameTextView = ((TextView)paramView.findViewById(2131558826));
        localViewHolder.fromAccountTextView = ((TextView)paramView.findViewById(2131558827));
        localViewHolder.arrowImageView = ((ImageView)paramView.findViewById(2131558828));
        localViewHolder.toAccountTextView = ((TextView)paramView.findViewById(2131558829));
        localViewHolder.scanTemplateButton = ((ImageView)paramView.findViewById(2131558825));
        paramView.setTag(localViewHolder);
        localTemplateModel = (TemplateModel)this.mTemplates.get(paramInt);
        localViewHolder.templateNameTextView.setText(localTemplateModel.getName());
        localViewHolder.fromAccountTextView.setText(TemplateChooserFragment.this.findFromAccount(localTemplateModel));
        ...
        localViewHolder.toAccountTextView.setText(TemplateChooserFragment.this.findToAccount(localTemplateModel));
      }
      for (;;)
      {
        if (TemplateChooserFragment.this.isBarcodeScanningEnabled(((TemplateModel)TemplateChooserFragment.this.mTemplatesList.get(paramInt)).getACTN())) {
          localViewHolder.scanTemplateButton.setVisibility(0);
        }
        ViewCompat.setRotation(localViewHolder.arrowImageView, 180.0F);
        if (TemplateChooserFragment.this.mSelectedPosition != paramInt) {
          break label370;
        }
        localViewHolder.linearLayout.setBackgroundColor(this.mSelectedBackgroundColor);
        localViewHolder.templateNameTextView.setTextColor(this.mHeaderSelectedTextColor);
        localViewHolder.fromAccountTextView.setTextColor(this.mDetailsSelectedTextColor);
        localViewHolder.toAccountTextView.setTextColor(this.mDetailsSelectedTextColor);
        localViewHolder.arrowImageView.setImageDrawable(this.mArrowSelectedDrawable);
        localViewHolder.scanTemplateButton.setImageDrawable(this.mScanSelectedDrawable);
        return paramView;
        localViewHolder = (ViewHolder)paramView.getTag();
        break;
        label347:
        localViewHolder.toAccountTextView.setText(DSQHelper.formatIBANWithSpaces(TemplateChooserFragment.this.findToAccount(localTemplateModel)));
      }
      label370:
      localViewHolder.linearLayout.setBackgroundColor(this.mNormalBackgroundColor);
      localViewHolder.templateNameTextView.setTextColor(this.mHeaderNormalTextColor);
      localViewHolder.fromAccountTextView.setTextColor(this.mDetailsNormalTextColor);
      localViewHolder.toAccountTextView.setTextColor(this.mDetailsNormalTextColor);
      localViewHolder.arrowImageView.setImageDrawable(this.mArrowNormalDrawable);
      localViewHolder.scanTemplateButton.setImageDrawable(this.mScanNormalDrawable);
      return paramView;
    }
