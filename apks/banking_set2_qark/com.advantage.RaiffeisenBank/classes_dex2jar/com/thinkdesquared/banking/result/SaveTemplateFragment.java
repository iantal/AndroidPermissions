  ...
  extends Fragment
{
  ...
  public void onActivityCreated(Bundle paramBundle)
  {
    ...
    Drawable localDrawable = new DSQBitmap(getActivity()).paintDrawableRes(2130838492, DSQStylist.fetchThemedResource(getActivity(), 2130772073));
    this.mTemplateNameEditText.setCompoundDrawablesWithIntrinsicBounds(null, null, localDrawable, null);
    this.mTemplateNameEditText.setOnTouchListener(new View.OnTouchListener()
    {
      public boolean onTouch(View paramAnonymousView, MotionEvent paramAnonymousMotionEvent)
      {
        if (paramAnonymousMotionEvent.getAction() == 1)
        {
          ...
          for (int i = 20 + (SaveTemplateFragment.this.mTemplateNameEditText.getRight() + SaveTemplateFragment.this.mTemplateNameEditText.getCompoundDrawables()[2].getBounds().width()); paramAnonymousMotionEvent.getRawX() >= i; i = SaveTemplateFragment.this.mTemplateNameEditText.getRight() - SaveTemplateFragment.this.mTemplateNameEditText.getCompoundDrawables()[2].getBounds().width())
          {
  ...
  public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle)
  {
    ...
    View localView = paramLayoutInflater.inflate(2130903313, paramViewGroup, false);
    this.mSaveTemplateLayout = localView.findViewById(2131559306);
    this.mTemplateMessageTextView = ((TextView)localView.findViewById(2131559307));
    this.mTemplateResultTextView = ((TextView)localView.findViewById(2131559305));
    this.mTemplateNameEditText = ((AppCompatEditText)localView.findViewById(2131559308));
    ...
    extends AsyncTask<Void, Void, SaveTemplateResponse>
  {
    ...
    protected void onPostExecute(SaveTemplateResponse paramSaveTemplateResponse)
    {
      ...
      if (paramSaveTemplateResponse.resultCode.equals("S"))
      {
        ...
        if (!localAibasStore.getHasMobileTemplate()) {
          localAibasStore.setHasMobileTemplate(true);
        }
        return;
      }
