  ...
  implements AIBASConstants
{
  ...
  private void initAmountRangeSpinners()
  {
    ...
    this.mAmountFromSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener()
    {
      public void onItemSelected(AdapterView<?> paramAnonymousAdapterView, View paramAnonymousView, int paramAnonymousInt, long paramAnonymousLong)
      {
        ...
        if ((str != null) && (str != AccountHistoryFiltersFragment.this.mAmountFrom))
        {
    ...
    this.mAmountToSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener()
    {
      ...
      {
        String str = (String)paramAnonymousAdapterView.getItemAtPosition(paramAnonymousInt);
        if ((str != null) && (str != AccountHistoryFiltersFragment.this.mAmountTo))
        {
    ...
    {
      j = 0;
      if (j < this.mAmountValuesWithZeros.length)
      {
        if (!this.mAmountValuesWithZeros[j].equals(this.mSelectedFilters.amountFrom)) {
          break label287;
        }
        this.mAmountFromSpinnerPosition = (j + 1);
      }
    }
  ...
  private void initDoneAndDiscardButtons()
  {
    ...
    this.mDoneLayout.setOnClickListener(new View.OnClickListener()
    {
      public void onClick(View paramAnonymousView)
      {
        ...
        {
          String str3 = AccountHistoryFiltersFragment.this.mAmountValuesWithZeros[(-1 + AccountHistoryFiltersFragment.this.mAmountFromSpinnerPosition)];
          ...
          for (;;)
          {
            AccountHistoryFiltersFragment.this.mListener.onSubmitFiltersButtonClicked(str1, str2, str3, str4, str5);
            return;
  ...
  private void prepareIcons()
  {
    ...
    Bitmap localBitmap1 = localDSQBitmap.paintRes(2130838500, i);
    this.mCreditImageView.setImageBitmap(localBitmap1);
    Bitmap localBitmap2 = localDSQBitmap.paintRes(2130838501, j);
    this.mDebitImageView.setImageBitmap(localBitmap2);
  }
  
  private void updateAmountToSpinner()
  {
    int i = Integer.parseInt(this.mAmountFrom);
    int j;
    ...
    label126:
    label140:
    for (int k = -1 + this.mAmountFromSpinnerPosition;; k++)
    {
      if (k < this.mAmountToValues.length) {
        if (!this.mAmountToValues[k].equals(getString(2131165310))) {
          break label126;
        }
      }
      for (int m = Integer.MAX_VALUE;; m = Integer.parseInt(this.mAmountToValues[k]))
      {
        if (i >= m) {
          break label140;
        }
        this.mAmountToSpinner.setSelection(k + 1);
        this.mAmountTo = ((String)this.mAmountToSpinner.getItemAtPosition(k + 1));
        this.mAmountToSpinnerPosition = (k + 1);
        return;
        j = Integer.parseInt(this.mAmountTo);
        break;
      }
    }
  }
  ...
  {
    View localView = paramLayoutInflater.inflate(2130903243, paramViewGroup, false);
    this.mWrapperLayout = ((RelativeLayout)localView.findViewById(2131558633));
    this.mSeperator = localView.findViewById(2131558678);
    this.mFromDateButton = ((AppCompatButton)localView.findViewById(2131558972));
    this.mToDateButton = ((AppCompatButton)localView.findViewById(2131558973));
    this.mAmountFromSpinner = ((Spinner)localView.findViewById(2131558976));
    this.mAmountToSpinner = ((Spinner)localView.findViewById(2131558978));
    this.mCreditCheckBox = ((CheckBox)localView.findViewById(2131558981));
    this.mDebitCheckBox = ((CheckBox)localView.findViewById(2131558983));
    this.mFromAmountLayout = ((LinearLayout)localView.findViewById(2131558975));
    this.mToAmountLayout = ((LinearLayout)localView.findViewById(2131558977));
    this.mCreditAndDebitCheckBoxesLayout = ((LinearLayout)localView.findViewById(2131558979));
    this.mAmountRangeLayout = localView.findViewById(2131558974);
    this.mDiscardLayout = ((ViewGroup)localView.findViewById(2131558607));
    this.mDoneLayout = ((ViewGroup)localView.findViewById(2131558609));
    this.mCreditImageView = ((ImageView)localView.findViewById(2131558980));
    this.mDebitImageView = ((ImageView)localView.findViewById(2131558982));
    this.mDummyLayout = ((LinearLayout)localView.findViewById(2131558984));
