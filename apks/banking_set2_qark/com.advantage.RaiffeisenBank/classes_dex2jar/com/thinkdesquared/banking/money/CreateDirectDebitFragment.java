  ...
  implements LoaderManager.LoaderCallbacks<CreateDebitInputResponse>
{
  ...
  {
    QuickPayTask localQuickPayTask = new QuickPayTask();
    CreateDirectDebitData[] arrayOfCreateDirectDebitData = new CreateDirectDebitData[1];
    arrayOfCreateDirectDebitData[0] = this.mDataModel;
    localQuickPayTask.execute(arrayOfCreateDirectDebitData);
  }
  ...
  private void initCheckbox()
  {
    this.mThirdPartyCheckbox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener()
    {
      ...
      {
        int i = CreateDirectDebitFragment.this.mSelectedCompanyPosition;
        UtilityCompany localUtilityCompany = null;
        if (i != -1) {
          localUtilityCompany = (UtilityCompany)CreateDirectDebitFragment.this.mInputResponse.companies.get(CreateDirectDebitFragment.this.mSelectedCompanyPosition);
        }
        if (paramAnonymousBoolean)
        {
          CreateDirectDebitFragment.this.mThirdPartyLayout.setVisibility(0);
          if ((localUtilityCompany != null) && (DSQHelper.isNotEmpty(localUtilityCompany.getDefaultValue1())))
          {
        ...
        } while ((localUtilityCompany == null) || (!DSQHelper.isNotEmpty(localUtilityCompany.getDefaultValue1())));
        CreateDirectDebitFragment.this.mData.setIdField1(localUtilityCompany.getDefaultValue1());
        CreateDirectDebitFragment.this.mDetailEditText1.setText(CreateDirectDebitFragment.this.mData.getIdField1());
      }
    });
  }
    ...
    if (this.mInputResponse.maxAmount != null)
    {
      ...
      this.mDefaultAmountCheckbox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener()
      {
        public void onCheckedChanged(CompoundButton paramAnonymousCompoundButton, boolean paramAnonymousBoolean)
        {
          if (paramAnonymousBoolean)
          {
            TransactionAmountModel localTransactionAmountModel = new TransactionAmountModel(CreateDirectDebitFragment.this.mInputResponse.maxAmount, CreateDirectDebitFragment.this.mInputResponse.maxAmountCurrency);
            CreateDirectDebitFragment.this.mData.setMaxAmountModel(localTransactionAmountModel);
            CreateDirectDebitFragment.this.mAmountButton.setText(localTransactionAmountModel.getLocalizedAmountString(CreateDirectDebitFragment.this.getActivity()));
            CreateDirectDebitFragment.this.mAmountCcy.setText(localTransactionAmountModel.getCurrency().getCode());
            return;
          }
  ...
  private void initFromAccountSpinner(ArrayList<BankAccount> paramArrayList)
  {
    ...
    this.mChooseAccountSpinner.setAdapter(localAccountSpinnerAdapter);
    this.mChooseAccountSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener()
    {
      public void onItemSelected(AdapterView<?> paramAnonymousAdapterView, View paramAnonymousView, int paramAnonymousInt, long paramAnonymousLong)
      {
        ...
        {
          CreateDirectDebitFragment.access$002(CreateDirectDebitFragment.this, localBankAccount);
          CreateDirectDebitFragment.this.mData.setFromAccountNumber(localBankAccount.getNumber());
          CreateDirectDebitFragment.this.mData.setFromAccountNickname(localBankAccount.getNickname());
  ...
  public void onAmountChooserDismissedWithAmount(TransactionAmountModel paramTransactionAmountModel)
  {
    ...
    if (this.mAmountButton != null)
    {
      ...
      this.mData.setMaxAmountModel(new TransactionAmountModel("", this.mInputResponse.maxAmountCurrency));
      String str2 = getActivity().getString(2131165340);
      TransactionAmountModel localTransactionAmountModel2 = new TransactionAmountModel(this.mInputResponse.maxAmount, this.mInputResponse.maxAmountCurrency);
      DSQHelper.showValidationDialogWithIcon(getActivity(), str2 + " " + localTransactionAmountModel2.toString(getActivity()), 2130838056);
    }
    for (;;)
    {
      this.mAmountButton.setText(this.mData.getMaxAmountModel().getLocalizedAmountString(getActivity()));
      ...
      {
        this.mData.setMaxAmountModel(new TransactionAmountModel("", this.mInputResponse.maxAmountCurrency));
        String str1 = getActivity().getString(2131165340);
        TransactionAmountModel localTransactionAmountModel1 = new TransactionAmountModel(this.mInputResponse.maxAmount, this.mInputResponse.maxAmountCurrency);
        DSQHelper.showValidationDialogWithIcon(getActivity(), str1 + " " + localTransactionAmountModel1.toString(getActivity()), 2130838056);
      }
      else
      {
        this.mData.setMaxAmountModel(paramTransactionAmountModel);
  ...
  public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle)
  {
    ...
    View localView = paramLayoutInflater.inflate(2130903268, paramViewGroup, false);
    this.mLoadingAndErrorView = localView.findViewById(2131559348);
    this.mFromAccountSpinnerLayout = ((LinearLayout)localView.findViewById(2131558987));
    this.mChooseAccountSpinner = ((Spinner)localView.findViewById(2131558988));
    this.mChooseCompanyButton = ((AppCompatButton)localView.findViewById(2131559118));
    this.mThirdPartyCheckbox = ((AppCompatCheckBox)localView.findViewById(2131559120));
    this.mThirdPartyLayout = ((LinearLayout)localView.findViewById(2131559121));
    this.mThirdNameEditText = ((AppCompatEditText)localView.findViewById(2131559122));
    this.mDetailsParentLayout = ((LinearLayout)localView.findViewById(2131559123));
    this.mDetailsLayout1 = ((LinearLayout)localView.findViewById(2131559124));
    this.mLabel1 = ((TextView)localView.findViewById(2131559125));
    this.mDetailEditText1 = ((AppCompatEditText)localView.findViewById(2131559126));
    this.mDetailsLayout2 = ((LinearLayout)localView.findViewById(2131559127));
    this.mLabel2 = ((TextView)localView.findViewById(2131559128));
    this.mDetailEditText2 = ((AppCompatEditText)localView.findViewById(2131559129));
    this.mDetailsLayout3 = ((LinearLayout)localView.findViewById(2131559130));
    this.mLabel3 = ((TextView)localView.findViewById(2131559131));
    this.mDetailEditText3 = ((AppCompatEditText)localView.findViewById(2131559132));
    ...
    this.mDefaultAmountCheckbox = ((AppCompatCheckBox)localView.findViewById(2131559133));
  ...
  {
    if (paramString != null) {
      for (int i = 0; i < this.mInputResponse.companies.size(); i++) {
    ...
    extends AsyncTask<CreateDirectDebitData, Void, String>
  {
    ...
    protected String doInBackground(CreateDirectDebitData... paramVarArgs)
    {
      ...
      CreateDirectDebitData localCreateDirectDebitData = paramVarArgs[0];
      if (AibasStore.getInstance().getLoggedInState() == AibasStore.LoggedInState.LoggedInState_ON)
      {
        this.resultResponse = new SOAPRequests().createDirectDebitQuickPayRequest(localCreateDirectDebitData);
        return null;
      }
      this.resultResponse = new DemoRequests().createDirectDebitQuickPayDemoRequest(localCreateDirectDebitData);
      return null;
    }
