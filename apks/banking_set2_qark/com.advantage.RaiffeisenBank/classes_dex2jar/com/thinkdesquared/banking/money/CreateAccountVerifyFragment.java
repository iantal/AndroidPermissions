    ...
    extends AsyncTask<String, Void, CreateAccountResultResponse>
  {
    ...
    protected CreateAccountResultResponse doInBackground(String... paramVarArgs)
    {
      if (AibasStore.getInstance().getLoggedInState() == AibasStore.LoggedInState.LoggedInState_ON)
      {
        ...
        return new SOAPRequests().createAccountResultRequest(str, CreateAccountVerifyFragment.this.getAuthorizationElements());
      }
    ...
    protected void onPostExecute(CreateAccountResultResponse paramCreateAccountResultResponse)
    {
      ...
      {
        String str2 = CreateAccountVerifyFragment.this.getString(2131165283) + " " + paramCreateAccountResultResponse.getAccountNumber();
        CreateAccountVerifyFragment.this.mListener.onReceivedSuccessfullResultResponse(str2, true, paramCreateAccountResultResponse, 2131166250);
        return;
      }
      ...
      CreateAccountVerifyFragment.this.mListener.onReceivedSuccessfullResultResponse(str1, true, paramCreateAccountResultResponse, 2131166250);
    }
