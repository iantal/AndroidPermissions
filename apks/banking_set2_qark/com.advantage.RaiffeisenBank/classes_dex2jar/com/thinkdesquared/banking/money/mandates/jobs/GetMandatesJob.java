  ...
  extends SessionBoundJob
{
    ...
    throws Throwable
  {
    ...
    for (GetMandatesResponse localGetMandatesResponse = new DemoRequests().getMandatesDemoRequest(str);; localGetMandatesResponse = new SOAPRequests().getMandatesRequest(this.supplierIntId, this.supplierServiceId, this.transactionStatusFilter, this.selectedFromAccount, this.selectedFromAccountType, str))
    {
      LogHelper.d(this.TAG, localGetMandatesResponse.toString());
      assertNotCancelled();
      EventBus.getDefault().post(new GetMandatesResponseEvent(localGetMandatesResponse, this.page));
      return;
    }
  }
