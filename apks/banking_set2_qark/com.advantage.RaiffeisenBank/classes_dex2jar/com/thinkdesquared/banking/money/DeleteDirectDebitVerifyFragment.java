  ...
  implements LoaderManager.LoaderCallbacks<DeleteDirectDebitVerifyResponse>
{
  ...
  public static DeleteDirectDebitVerifyFragment newInstance(String paramString, DirectDebitModel paramDirectDebitModel)
  {
    ...
    DeleteDirectDebitVerifyFragment localDeleteDirectDebitVerifyFragment = new DeleteDirectDebitVerifyFragment();
    localDeleteDirectDebitVerifyFragment.setArguments(localBundle);
    return localDeleteDirectDebitVerifyFragment;
  }
    ...
    extends AsyncTask<String, Void, GenericResultResponse>
  {
    ...
    protected GenericResultResponse doInBackground(String... paramVarArgs)
    {
      if (AibasStore.getInstance().getLoggedInState() == AibasStore.LoggedInState.LoggedInState_ON)
      {
        ...
        return new SOAPRequests().directDebitsDeleteResultRequest(str, DeleteDirectDebitVerifyFragment.this.getAuthorizationElements());
      }
    ...
    protected void onPostExecute(GenericResultResponse paramGenericResultResponse)
    {
      ...
      {
        String str2 = DeleteDirectDebitVerifyFragment.this.getString(2131165508);
        DeleteDirectDebitVerifyFragment.this.mListener.onReceivedSuccessfullResultResponse(str2, true, paramGenericResultResponse, 2131166257);
        return;
      }
      ...
      DeleteDirectDebitVerifyFragment.this.mListener.onReceivedSuccessfullResultResponse(str1, true, paramGenericResultResponse, 2131166257);
    }
