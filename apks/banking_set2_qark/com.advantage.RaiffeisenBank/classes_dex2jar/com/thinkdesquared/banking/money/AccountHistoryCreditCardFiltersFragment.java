  ...
  extends Fragment
{
    ...
    if ((this.mFormattedPeriods != null) && (this.mFormattedPeriods.size() > 0))
    {
      ...
      this.mCreditCardSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener()
      {
        public void onItemSelected(AdapterView<?> paramAnonymousAdapterView, View paramAnonymousView, int paramAnonymousInt, long paramAnonymousLong)
        {
          ...
          if ((str != null) && (str != AccountHistoryCreditCardFiltersFragment.this.selectedPeriod)) {
  ...
  private void initViewGroups()
  {
    ...
    this.mDoneLayout.setOnClickListener(new View.OnClickListener()
    {
      public void onClick(View paramAnonymousView)
      {
        ...
        String str = AccountHistoryCreditCardFiltersFragment.this.getResources().getString(2131165428);
        if (AccountHistoryCreditCardFiltersFragment.this.mCreditCardSpinner.getSelectedItem().toString().equals(str))
        {
        ...
        {
          String[] arrayOfString = AccountHistoryCreditCardFiltersFragment.this.selectedPeriod.split(" - ");
          AccountHistoryCreditCardFiltersFragment.access$302(AccountHistoryCreditCardFiltersFragment.this, arrayOfString[0]);
          AccountHistoryCreditCardFiltersFragment.access$402(AccountHistoryCreditCardFiltersFragment.this, arrayOfString[1]);
  ...
  {
    View localView = paramLayoutInflater.inflate(2130903272, paramViewGroup, false);
    this.mCreditCardSpinner = ((Spinner)localView.findViewById(2131559200));
