  ...
  implements CreateMandateView
{
  ...
  public void initFinalBeneficiary(boolean paramBoolean)
  {
    ...
    RelativeLayout localRelativeLayout = this.mFinalBeneficiarySwitchRelativeLayout;
    int i;
    View localView;
    int j;
    if (paramBoolean)
  ...
  public void initSchemeTypes(@Nullable ArrayList<SchemeType> paramArrayList, int paramInt)
  {
    if (!CollectionUtils.isEmpty(paramArrayList))
    {
      ...
      SchemeTypesAdapter localSchemeTypesAdapter = new SchemeTypesAdapter(getActivity(), paramArrayList);
      this.mSchemeTypeSpinner.setAdapter(localSchemeTypesAdapter);
  ...
  public void initThirdParty(boolean paramBoolean)
  {
    ...
    RelativeLayout localRelativeLayout = this.mThirdPartyPurchaseSwitchRelativeLayout;
    int i;
    View localView;
    int j;
    if (paramBoolean)
    ...
    for (;;)
    {
      ...
      break;
      label51:
      int k = this.mSeparator2.getVisibility();
      j = 0;
      if (k != 8) {
        j = 8;
      }
  ...
  public void setCustomerIdentificationAfterFocus(Boolean paramBoolean1, Boolean paramBoolean2, Boolean paramBoolean3, Boolean paramBoolean4)
  {
    ...
    {
      localProgressWheel = this.mLoadingWheel;
  ...
  public void setFinalBeneficiary(String paramString1, boolean paramBoolean1, String paramString2, boolean paramBoolean2)
  {
    ...
    LinearLayout localLinearLayout1 = this.mFinalBeneficiaryNameGroup;
    int i;
    ...
    if (paramBoolean1)
    {
      ...
      localLinearLayout2 = this.mFinalBeneficiaryCodeGroup;
      j = 0;
      if (!paramBoolean2) {
        break label79;
      }
  ...
  {
    int i = 8;
    View localView = this.mSeparator1;
    if (paramBoolean) {}
    for (int j = 0;; j = i)
    {
      localView.setVisibility(j);
      LinearLayout localLinearLayout = this.mSupplierLinearLayout;
      if (paramBoolean) {
        i = 0;
      }
      localLinearLayout.setVisibility(i);
  ...
  public void showValidationDialog(int paramInt, String paramString, TransactionAmountModel paramTransactionAmountModel)
  {
    ...
    for (;;)
    {
      ...
      continue;
      str = getString(2131165814);
      continue;
      str = getString(2131165757);
      continue;
      str = getString(2131166038);
      continue;
      str = getString(2131165340) + " " + paramTransactionAmountModel.toString(getActivity());
      continue;
      str = getString(2131165744);
      continue;
      str = getString(2131165752);
    }
  }
