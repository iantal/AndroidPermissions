  ...
  extends SessionBoundJob
{
    ...
    throws Throwable
  {
    ...
    String str;
    for (PaymentVerifyResponse localPaymentVerifyResponse = new DemoRequests().paymentVerifyDemoRequest(this.mPaymentData);; localPaymentVerifyResponse = new SOAPRequests().domesticPaymentVerifyRequest(this.mPaymentData, this.mWorkflowId, str, this.mTouchIdAuthorizationData))
    {
      assertNotCancelled();
