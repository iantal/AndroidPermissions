  ...
  implements InternationalPaymentView, PaymentDetailsFragment.AddButtonListener, InitUIListener
{
  ...
  private HashMap<String, String> getEditTextValuesHashMap()
  {
    ...
    {
      boolean bool2 = this.mPaymentDetailsFragment.isValid();
      localObject = null;
      if (bool2)
      {
        ...
        str1 = this.mBeneficiaryIbanEditText.getText().toString().replace(" ", "");
        localHashMap.put("BENEFICIARY_ACCOUNT_NUMBER", str1);
        if (this.mBeneficiaryNameTextView.getText().length() <= 0) {
          break label616;
        }
        str2 = this.mBeneficiaryNameTextView.getText().toString();
        localHashMap.put("BENEFICIARY_NAME", str2);
        if (this.mBeneficiaryName2TextView.getText().length() <= 0) {
          break label622;
        }
        str3 = this.mBeneficiaryName2TextView.getText().toString();
        localHashMap.put("BENEFICIARY_NAME_2", str3);
        if (this.mBeneficiaryAddressButton.getText().length() <= 0) {
          break label628;
        }
        str4 = this.mBeneficiaryAddressButton.getText().toString();
        localHashMap.put("BENEFICIARY_ADDRESS", str4);
        if (this.mBeneficiaryBankSWIFTButton.getText().length() <= 0) {
          break label634;
        }
        str5 = this.mBeneficiaryBankSWIFTButton.getText().toString();
        localHashMap.put("BENEFICIARY_SWIFT", str5);
        if (this.mBank2Bank1.getText().length() <= 0) {
          break label640;
        }
        str6 = this.mBank2Bank1.getText().toString();
        localHashMap.put("BANK_2_BANK_INFO_1", str6);
        if (this.mBank2Bank2.getText().length() <= 0) {
          break label646;
        }
        str7 = this.mBank2Bank2.getText().toString();
        localHashMap.put("BANK_2_BANK_INFO_2", str7);
        if (this.mBank2Bank3.getText().length() <= 0) {
          break label652;
        }
        str8 = this.mBank2Bank3.getText().toString();
        localHashMap.put("BANK_2_BANK_INFO_3", str8);
        if (this.mStatisticalCodeEditText.getText().length() <= 0) {
          break label658;
        }
        str9 = this.mStatisticalCodeEditText.getText().toString();
        localHashMap.put("STATISTICAL_CODE", str9);
        if (this.mPaymentOrderNumberEditText.getText().length() <= 0) {
          break label664;
        }
        str10 = this.mPaymentOrderNumberEditText.getText().toString();
        localHashMap.put("PAYMENT_ORDER_NUMBER", str10);
        if (this.mInitialPayersNameEditText.getText().length() <= 0) {
          break label670;
        }
        str11 = this.mInitialPayersNameEditText.getText().toString();
        localHashMap.put("INITIAL_PAYERS_NAME", str11);
        if (this.mInitialPayersIDEditText.getText().length() <= 0) {
          break label676;
        }
        str12 = this.mInitialPayersIDEditText.getText().toString();
        localHashMap.put("INITIAL_PAYERS_ID", str12);
        if (this.mFinalBeneficiarysNameEditText.getText().length() <= 0) {
          break label682;
        }
        str13 = this.mFinalBeneficiarysNameEditText.getText().toString();
        label501:
        localHashMap.put("FINAL_BENEFICIARYS_NAME", str13);
    ...
    label682:
    label688:
    for (String str14 = this.mFinalBeneficiarysIDEditText.getText().toString();; str14 = null)
    {
      localHashMap.put("FINAL_BENEFICIARYS_ID", str14);
      PaymentReasonCodeModel localPaymentReasonCodeModel = this.mPaymentReasonCodeModel;
      String str15 = null;
      if (localPaymentReasonCodeModel != null) {
        str15 = this.mPaymentReasonCodeModel.code;
      }
      localHashMap.put("PAYMENTS_REASON_CODE", str15);
      localObject = localHashMap;
      boolean bool1;
      do
      {
        return localObject;
        bool1 = this.mSepaDetailsFragment.isValid();
        localObject = null;
      } while (!bool1);
  ...
  public void initLayout(ArrayList<BankAccount> paramArrayList, ArrayList<String> paramArrayList1, ArrayList<String> paramArrayList2, ArrayList<String> paramArrayList3, ArrayList<String> paramArrayList4)
  {
    ...
    {
      PrioritiesAdapter localPrioritiesAdapter1 = new PrioritiesAdapter(getActivity(), paramArrayList3);
      this.mPrioritiesSpinner.setAdapter(localPrioritiesAdapter1);
    }
    if (!CollectionUtils.isEmpty(paramArrayList4))
    {
      PrioritiesAdapter localPrioritiesAdapter2 = new PrioritiesAdapter(getActivity(), paramArrayList4);
      this.mChargesSpinner.setAdapter(localPrioritiesAdapter2);
    }
  ...
  public void setChargesList(ArrayList<String> paramArrayList)
  {
    if (!CollectionUtils.isEmpty(paramArrayList))
    {
      ...
      this.mChargesSpinner.setAdapter(localPrioritiesAdapter);
    }
  }
