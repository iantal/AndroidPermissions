  ...
  extends SessionBoundJob
{
    ...
    throws Throwable
  {
    ...
    String str;
    for (PaymentVerifyResponse localPaymentVerifyResponse = new DemoRequests().paymentVerifyDemoRequest(this.mPaymentData);; localPaymentVerifyResponse = new SOAPRequests().internationalPaymentVerifyRequest(this.mPaymentData, this.mWorkflowId, str, DSQHelper.getTouchIdAuthorizationData(getApplicationContext())))
    {
      assertNotCancelled();
