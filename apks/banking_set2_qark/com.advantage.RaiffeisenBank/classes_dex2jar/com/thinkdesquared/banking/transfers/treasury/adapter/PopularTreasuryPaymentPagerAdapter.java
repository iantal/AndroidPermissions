  ...
  extends PagerAdapter
{
  ...
  {
    String str = paramTreasuryPayment.getBudgetAccountCode();
    if ("21.A.07.01.01".equalsIgnoreCase(str)) {
      return 2130837697;
    }
    if ("21.A.16.02.01".equalsIgnoreCase(str)) {
      return 2130837705;
    }
    if ("20.A.03.01.00".equalsIgnoreCase(str)) {
      return 2130838053;
    }
    if ("21.A.07.02.01".equalsIgnoreCase(str)) {
      return 2130838058;
    }
    if ("20.A.03.03.00".equalsIgnoreCase(str)) {
      return 2130838221;
    }
    if ("50.26.02".equalsIgnoreCase(str)) {
      return 2130838124;
    }
    return 2130837867;
  }
  ...
  private boolean isContainBudgetCode(String paramString1, String paramString2)
  {
    ...
    return paramString1.replaceAll("[\\.]", "").equalsIgnoreCase(str);
  }
  ...
  private void populateLayout(View paramView, final TreasuryPayment paramTreasuryPayment)
  {
    ...
    TextView localTextView3 = (TextView)ButterKnife.findById(paramView, 2131558915);
    ...
    localTextView3.setText(paramTreasuryPayment.getBudgetAccountCode());
