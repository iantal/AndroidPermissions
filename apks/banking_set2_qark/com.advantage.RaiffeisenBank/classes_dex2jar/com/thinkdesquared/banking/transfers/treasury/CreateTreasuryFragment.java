  ...
  implements CreateTreasuryView
{
  ...
  private HashMap<String, String> getEditTextValuesHashMap()
  {
    ...
    for (String str1 = this.mPaymentEvidenceNumberEditText.getText().toString();; str1 = null)
    {
      localHashMap.put("PAYMENT_EVIDENCE_NUMBER", str1);
      int i = this.mPaymentDetailsEditText.getText().length();
      String str2 = null;
      if (i > 0) {
        str2 = this.mPaymentDetailsEditText.getText().toString();
      }
      localHashMap.put("PAYMENT_DETAILS", str2);
      return localHashMap;
    }
  }
  ...
  public void initLayout(ArrayList<TreasuryPayment> paramArrayList, ArrayList<BankAccount> paramArrayList1)
  {
    ...
    for (;;)
    {
      ...
      {
        AccountSpinnerAdapter localAccountSpinnerAdapter = new AccountSpinnerAdapter(getActivity(), paramArrayList1);
  ...
  public void lockTreasuryPaymentBeneficiary(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    {
      localAppCompatButton.setEnabled(bool);
      if (paramBoolean2) {
