  ...
  implements LoaderManager.LoaderCallbacks<PaymentVerifyResponse>, CancelAuthenticationResponse, AuthenticationResponse
{
  ...
  private static VerifyDomesticPaymentFragment newInstance(Bundle paramBundle, String paramString)
  {
    ...
    VerifyDomesticPaymentFragment localVerifyDomesticPaymentFragment = new VerifyDomesticPaymentFragment();
    if (paramBundle.getSerializable("ACTIVE_TRANSFER") != null) {
      localVerifyDomesticPaymentFragment.setActiveTransfer();
    }
    localVerifyDomesticPaymentFragment.setArguments(paramBundle);
    return localVerifyDomesticPaymentFragment;
  }
    ...
    protected GenericResultResponse doInBackground(String... paramVarArgs)
    {
      if (VerifyDomesticPaymentFragment.this.isActiveTransfersDeleteVerify())
      {
        if (AibasStore.getInstance().getLoggedInState() == AibasStore.LoggedInState.LoggedInState_ON)
        {
          ...
          return new SOAPRequests().activeTransfersDeleteDomesticResultRequest(str2, VerifyDomesticPaymentFragment.this.getAuthorizationElements(), this.mTouchIdAuthorizationData);
        }
      ...
      if (AibasStore.getInstance().getLoggedInState() == AibasStore.LoggedInState.LoggedInState_ON)
      {
        ...
        return new SOAPRequests().domesticPaymentResultRequest(str1, VerifyDomesticPaymentFragment.this.getAuthorizationElements(), new TouchIdAuthorizationData());
      }
    ...
    protected void onPostExecute(GenericResultResponse paramGenericResultResponse)
    {
      ...
      while (paramGenericResultResponse.resultCode.equals("S")) {
        if (bool)
        {
          ...
          String str3 = VerifyDomesticPaymentFragment.this.getString(2131165466);
          VerifyDomesticPaymentFragment.this.mListener.onReceivedSuccessfullResultResponse(str3, true, paramGenericResultResponse, i);
          return;
          i = 2131166241;
        }
        else
        {
          String str2 = VerifyDomesticPaymentFragment.this.getString(2131166151);
          VerifyDomesticPaymentFragment.this.mListener.onReceivedSuccessfullResultResponse(str2, true, paramGenericResultResponse, i);
          return;
        }
      }
      ...
      VerifyDomesticPaymentFragment.this.mListener.onReceivedSuccessfullResultResponse(str1, true, paramGenericResultResponse, i);
    }
