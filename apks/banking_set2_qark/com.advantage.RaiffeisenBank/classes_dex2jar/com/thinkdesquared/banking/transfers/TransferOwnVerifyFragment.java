  ...
  implements LoaderManager.LoaderCallbacks<TransferOwnVerifyResponse>
{
  ...
  private static TransferOwnVerifyFragment newInstance(Bundle paramBundle, String paramString)
  {
    ...
    TransferOwnVerifyFragment localTransferOwnVerifyFragment = new TransferOwnVerifyFragment();
    if (paramBundle.getSerializable("ACTIVE_TRANSFER") != null) {
      localTransferOwnVerifyFragment.setActiveTransfer();
    }
    localTransferOwnVerifyFragment.setArguments(paramBundle);
    return localTransferOwnVerifyFragment;
  }
  ...
  public void onActivityCreated(Bundle paramBundle)
  {
    ...
    if (localBundle != null)
    {
      this.mPassedData = ((TransferOwnData)localBundle.get("PASSED_DATA"));
    ...
    protected GenericResultResponse doInBackground(String... paramVarArgs)
    {
      if (TransferOwnVerifyFragment.this.isActiveTransfersDeleteVerify())
      {
        if (AibasStore.getInstance().getLoggedInState() == AibasStore.LoggedInState.LoggedInState_ON)
        {
          ...
          return new SOAPRequests().activeTransfersDeleteTransferOwnResultRequest(str2, TransferOwnVerifyFragment.this.getAuthorizationElements());
        }
      ...
      if (AibasStore.getInstance().getLoggedInState() == AibasStore.LoggedInState.LoggedInState_ON)
      {
        ...
        return new SOAPRequests().transferOwnResultRequest(str1, TransferOwnVerifyFragment.this.getAuthorizationElements());
      }
    ...
    protected void onPostExecute(GenericResultResponse paramGenericResultResponse)
    {
      ...
      while (paramGenericResultResponse.resultCode.equals("S")) {
        if (bool)
        {
          ...
          String str3 = TransferOwnVerifyFragment.this.getString(2131165475);
          TransferOwnVerifyFragment.this.mListener.onReceivedSuccessfullResultResponse(str3, true, paramGenericResultResponse, i);
          return;
          i = 2131166241;
        }
        else
        {
          String str2 = TransferOwnVerifyFragment.this.getString(2131166151);
          TransferOwnVerifyFragment.this.mListener.onReceivedSuccessfullResultResponse(str2, true, paramGenericResultResponse, i);
          return;
        }
      }
      ...
      TransferOwnVerifyFragment.this.mListener.onReceivedSuccessfullResultResponse(str1, true, paramGenericResultResponse, i);
    }
