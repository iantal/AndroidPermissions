  ...
  implements LoaderManager.LoaderCallbacks<BuyInvestmentUnitsInputResponse>, OnSubmitButtonClickedListener, AIBASConstants
{
  ...
  private void initSpinners()
  {
    ...
    {
      final AccountSpinnerAdapter localAccountSpinnerAdapter = new AccountSpinnerAdapter(getActivity(), this.mInputResponse.getFromAccounts());
      ...
      this.mFromAccountSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener()
      {
        public void onItemSelected(AdapterView<?> paramAnonymousAdapterView, View paramAnonymousView, int paramAnonymousInt, long paramAnonymousLong)
        {
          ...
          if ((localBankAccount != null) && (localBankAccount != BuyInvestmentUnitsFragment.this.mData.fromAccount))
          {
    ...
    if (this.mInputResponse.getAssets() != null)
    {
      ...
      this.mToAssetSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener()
      {
        ...
        {
          BankAccount localBankAccount = (BankAccount)paramAnonymousAdapterView.getItemAtPosition(paramAnonymousInt);
          if ((localBankAccount != null) && (localBankAccount != BuyInvestmentUnitsFragment.this.mData.assetAccount))
          {
    ...
    this.mPeriodValueSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener()
    {
      public void onItemSelected(AdapterView<?> paramAnonymousAdapterView, View paramAnonymousView, int paramAnonymousInt, long paramAnonymousLong)
      {
        ...
        if (BuyInvestmentUnitsFragment.this.mPeriodNameSpinner.getAdapter() != null)
        {
          ...
          localArrayList.add(BuyInvestmentUnitsFragment.this.getString(2131165455));
          localArrayList.add(BuyInvestmentUnitsFragment.this.getString(2131165726));
        }
        for (;;)
        {
          ((TransactionDatesAdapter)BuyInvestmentUnitsFragment.this.mPeriodNameSpinner.getAdapter()).refreshData(localArrayList);
          return;
          label90:
          localArrayList.add(BuyInvestmentUnitsFragment.this.getString(2131165457));
          localArrayList.add(BuyInvestmentUnitsFragment.this.getString(2131165731));
        }
      }
    ...
    this.mSubmitButton.setOnClickListener(new View.OnClickListener()
    {
      public void onClick(View paramAnonymousView)
      {
        ...
        if (BuyInvestmentUnitsFragment.this.validations())
        {
          ...
          {
            String str = BuyInvestmentUnitsFragment.this.getString(2131166138);
            AlertDialog.Builder localBuilder = new AlertDialog.Builder(BuyInvestmentUnitsFragment.this.getActivity());
            localBuilder.setMessage(str).setPositiveButton(BuyInvestmentUnitsFragment.this.getString(2131165301), new DialogInterface.OnClickListener()
            {
  ...
  private void setToAccountSpinnerInitialSelection(BankAccount paramBankAccount)
  {
    ...
    for (;;)
    {
      ...
      if (i == 1)
      {
        this.mData.assetAccount = ((BankAccount)localObject);
        this.mToAssetSpinnerPosition = k;
      ...
      {
        for (int m = 0; m < this.mInputResponse.getAssets().size(); m++) {
          if (AccountSpinnerAdapter.isAllowed(false, this.mData.fromAccount, (BankAccount)this.mInputResponse.getAssets().get(m)) == AccountSpinnerAdapter.AccountComparisonResult.Allowed)
          {
            this.mData.assetAccount = ((BankAccount)this.mInputResponse.getAssets().get(m));
            this.mToAssetSpinnerPosition = (m + 1);
  ...
  private void updateInterfaceWithData()
  {
    ...
    if (this.mData.selectedTemplate != null)
    {
      ...
      for (;;)
      {
        for (int i = 0; i < this.mInputResponse.getAssets().size(); i++) {
  ...
  private boolean validations()
  {
    ...
    do
    {
      ...
      {
        String str3 = getActivity().getString(2131165807);
      ...
      {
        String str2 = getActivity().getString(2131165759);
        DSQHelper.showValidationDialogWithIcon(getActivity(), str2, 2130838056);
        return false;
      }
    ...
    {
      String str1 = getActivity().getString(2131165826);
      DSQHelper.showValidationDialogWithIcon(getActivity(), str1, 2130838056);
      return false;
    }
    return true;
  ...
  public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle)
  {
    ...
    View localView = paramLayoutInflater.inflate(2130903252, paramViewGroup, false);
    ...
    this.mToAssetSpinner = ((Spinner)localView.findViewById(2131559059));
    this.mPeriodNameSpinner = ((Spinner)localView.findViewById(2131559495));
    this.mPeriodValueSpinner = ((Spinner)localView.findViewById(2131559494));
    ...
    this.mUntilDateButton = ((Button)localView.findViewById(2131559496));
    this.mRepeatCheckBox = ((SwitchCompat)localView.findViewById(2131559491));
    this.thirdPartyCheckBox = ((CheckBox)localView.findViewById(2131559060));
    this.thirdPartyNameEditText = ((AppCompatEditText)localView.findViewById(2131559061));
    this.thirdPartyCNPEditText = ((AppCompatEditText)localView.findViewById(2131559062));
    this.mRequestFocusLayout = ((LinearLayout)localView.findViewById(2131559053));
    this.mFromAccountLayout = ((LinearLayout)localView.findViewById(2131558986));
    this.mRepeatGroup = ((LinearLayout)localView.findViewById(2131559492));
    this.mPaymentLayout = ((LinearLayout)localView.findViewById(2131559054));
    this.mTemplateName = ((LinearLayout)localView.findViewById(2131559063));
    this.mTemplateNameEditText = ((AppCompatEditText)localView.findViewById(2131559064));
  ...
  {
    BuyInvestmentUnitsTemplate localBuyInvestmentUnitsTemplate = (BuyInvestmentUnitsTemplate)this.mInputResponse.getTemplates().get(paramInt);
    this.mData.selectedTemplate = localBuyInvestmentUnitsTemplate;
    ...
    if (this.mData.selectedTemplate.getThirdPartyFlag().booleanValue())
    {
      ...
      if ((this.mInputResponse.getFromAccounts() != null) && (this.mInputResponse.getAssets() != null) && (this.mData.selectedTemplate != null)) {
        str1 = this.mData.selectedTemplate.getACFN();
      }
    }
    else
    {
      for (int i = 0;; i++) {
        ...
        {
          if ((((BankAccount)this.mInputResponse.getFromAccounts().get(i)).getNumber() != null) && (((BankAccount)this.mInputResponse.getFromAccounts().get(i)).getNumber().equals(str1)))
          {
            this.mFromAccountSpinnerPosition = (i + 1);
            this.mData.fromAccount = ((BankAccount)this.mFromAccountSpinner.getItemAtPosition(this.mFromAccountSpinnerPosition));
        ...
        {
          String str2 = this.mData.selectedTemplate.getACTN();
          for (int j = 0; j < this.mInputResponse.getAssets().size(); j++) {
            if ((((BankAccount)this.mInputResponse.getAssets().get(j)).getProductCode() != null) && (((BankAccount)this.mInputResponse.getAssets().get(j)).getProductCode().equals(str2)))
            {
              this.mToAssetSpinnerPosition = (j + 1);
              this.mData.assetAccount = ((BankAccount)this.mToAssetSpinner.getItemAtPosition(this.mToAssetSpinnerPosition));
