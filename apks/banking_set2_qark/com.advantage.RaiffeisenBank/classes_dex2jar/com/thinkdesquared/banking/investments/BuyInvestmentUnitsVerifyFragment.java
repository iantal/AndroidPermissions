  ...
  implements LoaderManager.LoaderCallbacks<BuyInvestmentUnitsVerifyResponse>
{
  ...
  private static BuyInvestmentUnitsVerifyFragment newInstance(Bundle paramBundle, String paramString)
  {
    ...
    BuyInvestmentUnitsVerifyFragment localBuyInvestmentUnitsVerifyFragment = new BuyInvestmentUnitsVerifyFragment();
    if (paramBundle.getSerializable("ACTIVE_TRANSFER") != null) {
      localBuyInvestmentUnitsVerifyFragment.setActiveTransfer();
    }
    localBuyInvestmentUnitsVerifyFragment.setArguments(paramBundle);
    return localBuyInvestmentUnitsVerifyFragment;
  }
  ...
  public void onActivityCreated(Bundle paramBundle)
  {
    ...
    if (localBundle != null)
    {
      this.mPassedData = ((BuyInvestmentUnitsData)localBundle.get("PASSED_DATA"));
    ...
    extends AsyncTask<String, Void, GenericResultResponse>
  {
    ...
    protected GenericResultResponse doInBackground(String... paramVarArgs)
    {
      if (BuyInvestmentUnitsVerifyFragment.this.isActiveTransfersDeleteVerify())
      {
        if (AibasStore.getInstance().getLoggedInState() == AibasStore.LoggedInState.LoggedInState_ON)
        {
          ...
          return new SOAPRequests().activeTransfersDeleteRamResultRequest(str2, BuyInvestmentUnitsVerifyFragment.this.getAuthorizationElements());
        }
      ...
      if (AibasStore.getInstance().getLoggedInState() == AibasStore.LoggedInState.LoggedInState_ON)
      {
        ...
        return new SOAPRequests().buyInvestmentUnitsResultRequest(str1, BuyInvestmentUnitsVerifyFragment.this.getAuthorizationElements());
      }
    ...
    protected void onPostExecute(GenericResultResponse paramGenericResultResponse)
    {
      ...
      while (paramGenericResultResponse.resultCode.equals("S")) {
        if (bool)
        {
          String str3 = BuyInvestmentUnitsVerifyFragment.this.getString(2131165465);
          BuyInvestmentUnitsVerifyFragment.this.mListener.onReceivedSuccessfullResultResponse(str3, true, paramGenericResultResponse, i);
          return;
          i = 2131166243;
        }
        else
        {
          String str2 = BuyInvestmentUnitsVerifyFragment.this.getString(2131166151);
          BuyInvestmentUnitsVerifyFragment.this.mListener.onReceivedSuccessfullResultResponse(str2, true, paramGenericResultResponse, i);
          return;
        }
      }
      ...
      BuyInvestmentUnitsVerifyFragment.this.mListener.onReceivedSuccessfullResultResponse(str1, true, paramGenericResultResponse, i);
    }
