  ...
  implements TransferFromTimeFragment.TransferFromTimeAccountFragmentListener, DatePickerFragment.DatePickerFragmentListener, TemplateChooserFragment.OnSelectedTemplateListener
{
  ...
  protected void onActivityResult(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    if ((paramInt2 == -1) && (paramInt1 == 1))
    {
      ...
      if (localBundle != null)
      {
        ...
        this.mTransferFromFragment.onAmountChooserDismissedWithAmount(localTransactionAmountModel);
      }
    }
  }
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    if (paramBundle == null)
    {
      ...
      localFragmentTransaction.replace(2131558652, this.mTransferFromFragment, str);
  ...
  public void showValidationMessage(String paramString)
  {
    ...
    Intent localIntent = new Intent(this, ShowValidationDialogActivity.class);
    localIntent.putExtras(localBundle);
