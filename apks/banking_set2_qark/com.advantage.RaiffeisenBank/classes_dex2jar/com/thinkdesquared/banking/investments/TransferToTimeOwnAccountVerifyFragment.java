  ...
  implements LoaderManager.LoaderCallbacks<TransferToTimeAccountVerifyResponse>, CancelAuthenticationResponse, AuthenticationResponse
{
  ...
  private static TransferToTimeOwnAccountVerifyFragment newInstance(Bundle paramBundle, String paramString)
  {
    ...
    TransferToTimeOwnAccountVerifyFragment localTransferToTimeOwnAccountVerifyFragment = new TransferToTimeOwnAccountVerifyFragment();
    if (paramBundle.getSerializable("ACTIVE_TRANSFER") != null) {
      localTransferToTimeOwnAccountVerifyFragment.setActiveTransfer();
    }
    localTransferToTimeOwnAccountVerifyFragment.setArguments(paramBundle);
    return localTransferToTimeOwnAccountVerifyFragment;
  }
    ...
    protected GenericResultResponse doInBackground(String... paramVarArgs)
    {
      if (TransferToTimeOwnAccountVerifyFragment.this.isActiveTransfersDeleteVerify())
      {
        if (AibasStore.getInstance().getLoggedInState() == AibasStore.LoggedInState.LoggedInState_ON)
        {
          ...
          return new SOAPRequests().activeTransfersDeleteTransferToTimeDepositResultRequest(str2, TransferToTimeOwnAccountVerifyFragment.this.getAuthorizationElements(), this.mTouchIdAuthorizationData);
        }
      ...
      if (AibasStore.getInstance().getLoggedInState() == AibasStore.LoggedInState.LoggedInState_ON)
      {
        ...
        return new SOAPRequests().transferToTimeAccountResultRequest(str1, TransferToTimeOwnAccountVerifyFragment.this.getAuthorizationElements(), this.mTouchIdAuthorizationData);
      }
    ...
    protected void onPostExecute(GenericResultResponse paramGenericResultResponse)
    {
      ...
      while (paramGenericResultResponse.resultCode.equals("S")) {
        if (bool)
        {
          ...
          String str3 = TransferToTimeOwnAccountVerifyFragment.this.getString(2131165476);
          TransferToTimeOwnAccountVerifyFragment.this.mListener.onReceivedSuccessfullResultResponse(str3, true, paramGenericResultResponse, i);
          return;
          i = 2131166287;
        }
        else
        {
          String str2 = TransferToTimeOwnAccountVerifyFragment.this.getString(2131166151);
          TransferToTimeOwnAccountVerifyFragment.this.mListener.onReceivedSuccessfullResultResponse(str2, true, paramGenericResultResponse, i);
          return;
        }
      }
      ...
      TransferToTimeOwnAccountVerifyFragment.this.mListener.onReceivedSuccessfullResultResponse(str1, true, paramGenericResultResponse, i);
    }
