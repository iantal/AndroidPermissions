  ...
  implements ExchangeRatesFragment.OnExchangeRatesCurrencySelectedListener
{
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    if (paramBundle == null)
    {
      ...
      localFragmentTransaction.replace(2131558649, new ExchangeRatesFragment(), getString(2131166259));
      localFragmentTransaction.replace(2131558647, new ExchangeRatesHistoryFragment(), getString(2131166260));
    }
    for (;;)
    {
