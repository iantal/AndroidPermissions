  ...
  implements LoaderManager.LoaderCallbacks<AccountStatementDownloadResponse>
{
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    if (localBundle != null)
    {
      this.mData = ((AccountStatementData)localBundle.getSerializable("ACCOUNT_STATEMENT_DATA"));
      this.mDownloadResponse = ((AccountStatementDownloadResponse)localBundle.getSerializable("RESPONSE"));
      this.mWorkflowId = localBundle.getString("WORKFLOW_ID");
      this.mFormat = localBundle.getString("FORMAT");
