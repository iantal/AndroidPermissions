  ...
  extends AppCompatActivity
{
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    Boolean localBoolean1 = Boolean.valueOf(localBundle.getBoolean("SHOW_CLOSE_ACCEPT_BUTTONS", false));
    this.mShowLogoutDialogOnClose = localBundle.getBoolean("SHOW_LOGOUT_DIALOG_ON_CLOSE", false);
    Boolean localBoolean2 = Boolean.valueOf(localBundle.getBoolean("SHOW_ONLY_CLOSE_BUTTON", false));
    this.url = localBundle.getString("URL");
    String str = localBundle.getString("MESSAGE");
    this.mContract = ((UserContractModel)localBundle.getSerializable("CONTRACT"));
