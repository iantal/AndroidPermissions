  ...
  extends FrameLayout
{
  ...
  {
    TypedArray localTypedArray = paramContext.obtainStyledAttributes(paramAttributeSet, R.styleable.ScrimInsetsView, paramInt, 0);
    if (localTypedArray == null) {
      return;
    }
    this.mInsetForeground = localTypedArray.getDrawable(0);
