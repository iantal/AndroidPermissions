  ...
  extends ImageView
{
  ...
  public CircleImageView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    this.mBorderOverlay = localTypedArray.getBoolean(2, false);
  ...
  private Bitmap getBitmapFromDrawable(Drawable paramDrawable)
  {
    ...
    try
    {
      ...
      Bitmap localBitmap;
      for (Object localObject = Bitmap.createBitmap(2, 2, BITMAP_CONFIG);; localObject = localBitmap)
      {
  ...
  private void updateShaderMatrix()
  {
    ...
    for (float f3 = 0.5F * (this.mDrawableRect.width() - f2 * this.mBitmapWidth);; f3 = 0.0F)
    {
      ...
      this.mShaderMatrix.postTranslate((int)(f3 + 0.5F) + this.mDrawableRect.left, (int)(f1 + 0.5F) + this.mDrawableRect.top);
