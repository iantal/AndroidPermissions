  ...
  extends RelativeLayout
{
  ...
  {
    return paramInt + this.mPopularViewPager.getCurrentItem();
  }
  ...
  private void init(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    TypedArray localTypedArray = paramContext.obtainStyledAttributes(paramAttributeSet, R.styleable.popularRelativeLayout, paramInt, 0);
    setPopularIndicatorSelectedColor(localTypedArray.getColor(1, ContextCompat.getColor(paramContext, 2131493056)));
    setPopularImageSize(localTypedArray.getDimensionPixelSize(2, getResources().getDimensionPixelOffset(2131231001)), localTypedArray.getDimensionPixelSize(3, getResources().getDimensionPixelOffset(2131231000)));
    setPopularLeftImageRotation(localTypedArray.getInteger(4, getResources().getInteger(2131427347)));
    setPopularRightImageRotation(localTypedArray.getInteger(5, getResources().getInteger(2131427348)));
    setPopularImageDrawable(localTypedArray.getDrawable(6));
    setPopularImageActiveColor(Integer.valueOf(localTypedArray.getColor(7, ContextCompat.getColor(paramContext, 2131493056))));
    setPopularImageInactiveColor(Integer.valueOf(localTypedArray.getColor(8, ContextCompat.getColor(paramContext, 2131493057))));
