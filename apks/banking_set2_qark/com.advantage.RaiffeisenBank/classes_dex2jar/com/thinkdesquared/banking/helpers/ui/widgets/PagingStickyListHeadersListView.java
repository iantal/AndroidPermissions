  ...
  private void init()
  {
    ...
    super.setOnScrollListener(new AbsListView.OnScrollListener()
    {
      public void onScroll(AbsListView paramAnonymousAbsListView, int paramAnonymousInt1, int paramAnonymousInt2, int paramAnonymousInt3)
      {
        ...
        if ((!PagingStickyListHeadersListView.this.isLoading) && (PagingStickyListHeadersListView.this.hasMoreItems) && (i == paramAnonymousInt3) && (PagingStickyListHeadersListView.this.pagingableListener != null))
        {
