  ...
  extends View
{
  ...
  private void calculateColor(int paramInt)
  {
    ...
    do
    {
      ...
      for (;;)
      {
        this.mColor = Color.HSVToColor(Math.round(this.mPosToOpacFactor * i), this.mHSVColor);
  ...
  protected void onRestoreInstanceState(Parcelable paramParcelable)
  {
    ...
    setOpacity(localBundle.getInt("opacity"));
  ...
  protected void onSizeChanged(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if (this.mOrientation == true)
    {
      ...
      arrayOfInt[0] = Color.HSVToColor(0, this.mHSVColor);
    ...
    for (;;)
    {
      ...
      break;
      label333:
      this.shader = new LinearGradient(this.mBarPointerHaloRadius, 0.0F, i, j, new int[] { 8519424, -8257792 }, null, Shader.TileMode.CLAMP);
