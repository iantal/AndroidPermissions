  ...
  implements PreferenceManager.OnActivityDestroyListener, Preference.OnPreferenceClickListener, OnColorChangedListener
{
  ...
  protected void onRestoreInstanceState(Parcelable paramParcelable)
  {
    if ((paramParcelable instanceof Bundle))
    {
      ...
      this.mDefaultValue = localBundle.getInt("mDefaultValue");
      this.mCurrentValue = localBundle.getInt("mCurrentValue");
      this.mAlphaSliderEnabled = localBundle.getBoolean("mAlphaSliderEnabled");
      this.mPickerId = localBundle.getInt("mPickerId");
