  ...
  extends MediaProcessor
{
    ...
    throws IOException, Exception
  {
    ...
    RTImage localRTImage;
    do
    {
      return;
      RTMediaSource localRTMediaSource = new RTMediaSource(RTMediaType.IMAGE, localInputStream, getOriginalFile(), getMimeType());
      localRTImage = this.mMediaFactory.createImage(localRTMediaSource);
    } while ((localRTImage == null) || (this.mListener == null));
    this.mListener.onImageProcessed(localRTImage);
  }
