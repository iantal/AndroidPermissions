  ...
  implements Serializable
{
    ...
    throws IllegalArgumentException
  {
    ...
    {
      return paramString;
      localMethod = IDNHolder.JAVA_NET_IDN_TO_ASCII;
    } while (localMethod == null);
    try
    {
      String[] arrayOfString = new String[1];
      arrayOfString[0] = paramString.toLowerCase(Locale.ENGLISH);
      String str = (String)localMethod.invoke(null, arrayOfString);
      return str;
    }
  ...
  static String unicodeToASCII(String paramString)
  {
    try
    {
      String str = toASCII(paramString);
      return str;
    }
  ...
  public boolean isValid(String paramString)
  {
    ...
    do
    {
      ...
      {
        return false;
        str = unicodeToASCII(paramString);
      } while (str.length() > 253);
      String[] arrayOfString = this.domainRegex.match(str);
      if ((arrayOfString != null) && (arrayOfString.length > 0)) {
        return isValidTld(arrayOfString[0]);
      }
    } while ((!this.allowLocal) || (!this.hostnameRegex.isValid(str)));
    return true;
  }
  
  public boolean isValidCountryCodeTld(String paramString)
  {
    String str = unicodeToASCII(paramString);
    return Arrays.binarySearch(COUNTRY_CODE_TLDS, chompLeadingDot(str.toLowerCase(Locale.ENGLISH))) >= 0;
  }
  
  final boolean isValidDomainSyntax(String paramString)
  {
    if (paramString == null) {}
    String str;
    ...
    do
    {
      ...
      arrayOfString = this.domainRegex.match(str);
    } while (((arrayOfString == null) || (arrayOfString.length <= 0)) && (!this.hostnameRegex.isValid(str)));
    return true;
  }
  ...
  {
    String str = unicodeToASCII(paramString);
    return Arrays.binarySearch(GENERIC_TLDS, chompLeadingDot(str.toLowerCase(Locale.ENGLISH))) >= 0;
  }
  
  public boolean isValidInfrastructureTld(String paramString)
  {
    String str = unicodeToASCII(paramString);
    return Arrays.binarySearch(INFRASTRUCTURE_TLDS, chompLeadingDot(str.toLowerCase(Locale.ENGLISH))) >= 0;
  }
  
  public boolean isValidLocalTld(String paramString)
  {
    String str = unicodeToASCII(paramString);
    return Arrays.binarySearch(LOCAL_TLDS, chompLeadingDot(str.toLowerCase(Locale.ENGLISH))) >= 0;
  }
  ...
  public boolean isValidTld(String paramString)
  {
    ...
    while ((isValidInfrastructureTld(str)) || (isValidGenericTld(str)) || (isValidCountryCodeTld(str))) {
      return true;
    }
    return false;
  }
  ...
  private static class IDNHolder
  {
    ...
    private static Method getMethod()
    {
      try
      {
        Method localMethod = Class.forName("java.net.IDN", false, DomainValidator.class.getClassLoader()).getDeclaredMethod("toASCII", new Class[] { String.class });
        return localMethod;
      }
