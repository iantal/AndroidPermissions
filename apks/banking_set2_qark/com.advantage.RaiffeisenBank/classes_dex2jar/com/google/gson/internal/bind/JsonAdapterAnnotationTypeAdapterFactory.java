  ...
  implements TypeAdapterFactory
{
  ...
  {
    Class localClass = paramJsonAdapter.value();
    if (TypeAdapter.class.isAssignableFrom(localClass)) {
      return (TypeAdapter)paramConstructorConstructor.get(TypeToken.get(localClass)).construct();
    }
    if (TypeAdapterFactory.class.isAssignableFrom(localClass)) {
      return ((TypeAdapterFactory)paramConstructorConstructor.get(TypeToken.get(localClass)).construct()).create(paramGson, paramTypeToken);
    }
