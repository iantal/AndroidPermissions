  ...
  extends AbstractSafeParcelable
{
  ...
  {
    this.amz = ((360.0F + paramFloat % 360.0F) % 360.0F);
    return this;
  }
  ...
  public GroundOverlayOptions position(LatLng paramLatLng, float paramFloat)
  {
    ...
    {
      bool2 = bool1;
      zzac.zza(bool2, "Position has already been set using positionFromBounds");
      if (paramLatLng == null) {
        break label60;
      }
      bool3 = bool1;
      label26:
      zzac.zzb(bool3, "Location must be specified");
      if (paramFloat < 0.0F) {
        break label66;
      }
    }
  ...
  public GroundOverlayOptions position(LatLng paramLatLng, float paramFloat1, float paramFloat2)
  {
    ...
    if (this.akB == null)
    {
      ...
      bool4 = bool1;
      label46:
      zzac.zzb(bool4, "Width must be non-negative");
      if (paramFloat2 < 0.0F) {
        break label92;
      }
    }
  ...
  public GroundOverlayOptions positionFromBounds(LatLngBounds paramLatLngBounds)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      zzac.zza(bool, 46 + String.valueOf(str).length() + "Position has already been set using position: " + str);
      this.akB = paramLatLngBounds;
      return this;
    }
  }
