    ...
    public void zzbru()
    {
      if ((this.alG != null) && (zzbdt() == null)) {
        try
        {
          ...
          IMapViewDelegate localIMapViewDelegate = zzai.zzdp(this.mContext).zza(zze.zzac(this.mContext), this.alO);
          if (localIMapViewDelegate == null) {
            return;
          }
          this.alG.zza(new MapView.zza(this.alN, localIMapViewDelegate));
