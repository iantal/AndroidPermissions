...
public abstract class zze<T extends IInterface>
{
  ...
  private void zzats()
  {
    if (this.Bl != null)
    {
      String str3 = String.valueOf(zzix());
      String str4 = String.valueOf(zzatq());
    ...
    {
      String str1 = String.valueOf(zzix());
      String str2 = String.valueOf(zzatq());
  ...
  public void dump(String paramString, FileDescriptor paramFileDescriptor, PrintWriter paramPrintWriter, String[] paramArrayOfString)
  {
    for (;;)
    {
      ...
      synchronized (this.zzakd)
      {
        ...
        default: 
          ...
          if (this.Bc > 0L)
          {
            ...
            long l3 = this.Bc;
            String str3 = String.valueOf(localSimpleDateFormat.format(new Date(this.Bc)));
          ...
          default: 
            ...
            long l2 = this.Bb;
            String str2 = String.valueOf(localSimpleDateFormat.format(new Date(this.Bb)));
            ...
            if (this.Be > 0L)
            {
              ...
              long l1 = this.Be;
              String str1 = String.valueOf(localSimpleDateFormat.format(new Date(this.Be)));
      ...
      continue;
      label496:
      paramPrintWriter.append(zziy()).append("@").println(Integer.toHexString(System.identityHashCode(localIInterface.asBinder())));
      continue;
  ...
  @WorkerThread
  public void zza(zzr paramZzr, Set<Scope> paramSet)
  {
    try
    {
      Bundle localBundle = zzagl();
      GetServiceRequest localGetServiceRequest = new GetServiceRequest(this.Bp).zzht(this.mContext.getPackageName()).zzo(localBundle);
      if (paramSet != null) {
        localGetServiceRequest.zzf(paramSet);
      }
      if (zzahd()) {
        localGetServiceRequest.zzd(zzatv()).zzb(paramZzr);
      }
      return;
    }
    catch (DeadObjectException localDeadObjectException)
    {
      synchronized (this.Bg)
      {
        while (this.Bh != null)
        {
          this.Bh.zza(new zzg(this, this.Br.get()), localGetServiceRequest);
          return;
          if (zzaty())
          {
            localGetServiceRequest.zzd(getAccount());
            continue;
    ...
    extends zze.zze<Boolean>
  {
    ...
    protected void zzc(Boolean paramBoolean)
    {
      ...
      do
      {
        ...
        default: 
          zze.zza(zze.this, 1, null);
          Bundle localBundle = this.Bt;
          PendingIntent localPendingIntent = null;
          if (localBundle != null) {
            localPendingIntent = (PendingIntent)this.Bt.getParcelable("pendingIntent");
          }
          zzm(new ConnectionResult(this.statusCode, localPendingIntent));
          return;
        }
      } while (zzaua());
      zze.zza(zze.this, 1, null);
    ...
    extends Handler
  {
    ...
    {
      zze.zze localZze = (zze.zze)paramMessage.obj;
      localZze.zzaub();
      localZze.unregister();
    }
    ...
    public void handleMessage(Message paramMessage)
    {
      ...
      if (paramMessage.what == 3)
      {
        ...
        zze.zzb(zze.this).zzh(localConnectionResult);
        zze.this.onConnectionFailed(localConnectionResult);
        return;
      }
    ...
    extends zze.zza
  {
    ...
    protected boolean zzaua()
    {
      ...
      do
      {
        ...
        localIInterface = zze.this.zzh(this.By);
      } while ((localIInterface == null) || (!zze.zza(zze.this, 2, 3, localIInterface)));
      Bundle localBundle = zze.this.zzaoe();
      if (zze.zzc(zze.this) != null) {
        zze.zzc(zze.this).onConnected(localBundle);
      }
      return true;
    }
