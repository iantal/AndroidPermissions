  ...
  extends StatsEvent
{
  ...
  public String zzawt()
  {
    ...
    String str2 = String.valueOf(zzawk());
    String str3 = String.valueOf(zzawl());
    String str4 = String.valueOf("\t");
    String str5 = String.valueOf(zzawm());
    String str6 = String.valueOf(zzawn());
    String str7 = String.valueOf("\t");
    if (this.DS == null) {}
    for (String str8 = "";; str8 = this.DS)
    {
      String str9 = String.valueOf("\t");
      long l = zzawr();
      return 22 + String.valueOf(str1).length() + String.valueOf(str2).length() + String.valueOf(str3).length() + String.valueOf(str4).length() + String.valueOf(str5).length() + String.valueOf(str6).length() + String.valueOf(str7).length() + String.valueOf(str8).length() + String.valueOf(str9).length() + str1 + str2 + "/" + str3 + str4 + str5 + "/" + str6 + str7 + str8 + str9 + l;
    }
  }
}
