...
public abstract interface zzad
{
    ...
    extends zzare<zza>
  {
    ...
    protected int zzx()
    {
      int i = super.zzx();
      if (this.zzck != null) {
        i += zzard.zzs(1, this.zzck);
      }
      if (this.zzcl != null) {
        i += zzard.zzf(2, this.zzcl.longValue());
      }
      if (this.stackTrace != null) {
        i += zzard.zzs(3, this.stackTrace);
      }
      if (this.zzcm != null) {
        i += zzard.zzs(4, this.zzcm);
      }
      if (this.zzcn != null) {
        i += zzard.zzs(5, this.zzcn);
      }
      if (this.zzco != null) {
        i += zzard.zzf(6, this.zzco.longValue());
      }
      if (this.zzcp != null) {
        i += zzard.zzf(7, this.zzcp.longValue());
      }
      if (this.zzcq != null) {
        i += zzard.zzs(8, this.zzcq);
      }
      if (this.zzcr != null) {
        i += zzard.zzf(9, this.zzcr.longValue());
      }
      if (this.zzcs != null) {
        i += zzard.zzs(10, this.zzcs);
      }
      return i;
    }
  }
