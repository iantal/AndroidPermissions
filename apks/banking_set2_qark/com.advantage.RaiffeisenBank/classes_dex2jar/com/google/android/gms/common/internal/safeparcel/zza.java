...
public class zza
{
  ...
  private static void zza(Parcel paramParcel, int paramInt1, int paramInt2)
  {
    ...
    if (i != paramInt2)
    {
      ...
      throw new zza(46 + String.valueOf(str).length() + "Expected size " + paramInt2 + " got " + i + " (0x" + str + ")", paramParcel);
    }
  }
  ...
  private static void zza(Parcel paramParcel, int paramInt1, int paramInt2, int paramInt3)
  {
    if (paramInt2 != paramInt3)
    {
      ...
      throw new zza(46 + String.valueOf(str).length() + "Expected size " + paramInt3 + " got " + paramInt2 + " (0x" + str + ")", paramParcel);
    }
  }
  ...
  public static int zzcq(Parcel paramParcel)
  {
    ...
    if (zzgv(i) != 20293)
    {
      ...
      for (String str2 = "Expected object header. Got 0x".concat(str1);; str2 = new String("Expected object header. Got 0x")) {
        throw new zza(str2, paramParcel);
      }
    }
    int m = k + j;
    if ((m < k) || (m > paramParcel.dataSize())) {
      throw new zza(54 + "Size read is invalid start=" + k + " end=" + m, paramParcel);
    }
    return m;
  }
