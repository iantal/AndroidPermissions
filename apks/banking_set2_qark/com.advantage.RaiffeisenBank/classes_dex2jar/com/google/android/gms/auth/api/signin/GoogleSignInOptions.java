  ...
  implements Api.ApiOptions.Optional, ReflectedParcelable
{
  ...
  private JSONObject zzahi()
  {
    ...
    if (this.ec != null) {
      localJSONObject.put("accountName", this.ec.name);
    }
    localJSONObject.put("idTokenRequested", this.hh);
    localJSONObject.put("forceCodeForRefreshToken", this.hj);
    localJSONObject.put("serverAuthRequested", this.hi);
    if (!TextUtils.isEmpty(this.hk)) {
      localJSONObject.put("serverClientId", this.hk);
    }
    if (!TextUtils.isEmpty(this.hl)) {
      localJSONObject.put("hostedDomain", this.hl);
    }
  ...
  public boolean equals(Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((this.hg.size() != localGoogleSignInOptions.zzahj().size()) || (!this.hg.containsAll(localGoogleSignInOptions.zzahj()))) {
          continue;
        }
        if (this.ec == null)
        {
          ...
          if (!TextUtils.isEmpty(localGoogleSignInOptions.zzahn())) {
            continue;
          }
        }
        while ((this.hj == localGoogleSignInOptions.zzahm()) && (this.hh == localGoogleSignInOptions.zzahk()) && (this.hi == localGoogleSignInOptions.zzahl()))
        {
          return true;
          if (!this.ec.equals(localGoogleSignInOptions.getAccount())) {
            break;
          }
          break label56;
          label128:
          boolean bool = this.hk.equals(localGoogleSignInOptions.zzahn());
          if (!bool) {
            break;
          }
        }
