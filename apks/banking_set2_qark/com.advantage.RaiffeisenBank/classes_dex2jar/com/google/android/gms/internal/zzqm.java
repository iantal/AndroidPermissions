  ...
  implements zzqq
{
    ...
    throws DeadObjectException
  {
    ...
    Object localObject = this.xk.wV.zzb(paramZza.zzapp());
    if ((!((Api.zze)localObject).isConnected()) && (this.xk.yl.containsKey(paramZza.zzapp())))
    {
      paramZza.zzz(new Status(17));
      return;
    }
    if ((localObject instanceof zzai)) {
      localObject = ((zzai)localObject).zzavk();
    }
