  ...
  implements Result, ReflectedParcelable
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    } while ((this.mVersionCode != localStatus.mVersionCode) || (this.rR != localStatus.rR) || (!zzab.equal(this.uK, localStatus.uK)) || (!zzab.equal(this.mPendingIntent, localStatus.mPendingIntent)));
    return true;
  }
  ...
  public int hashCode()
  {
    ...
    arrayOfObject[1] = Integer.valueOf(this.rR);
    arrayOfObject[2] = this.uK;
