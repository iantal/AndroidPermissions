  ...
  extends zzg<zzy>
{
    ...
    throws zzg.zza
  {
    try
    {
      ...
      View localView = (View)zze.zzae(((zzy)zzcu(paramContext)).zza(localZzd, localSignInButtonConfig));
      return localView;
    }
    catch (Exception localException)
    {
      throw new zzg.zza(64 + "Could not get button with size " + paramInt1 + " and color " + paramInt2, localException);
    }
  }
