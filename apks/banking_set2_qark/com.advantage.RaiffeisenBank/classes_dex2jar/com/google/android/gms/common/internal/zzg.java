...
public abstract class zzg
{
  ...
  static
  {
    zzg localZzg1 = zza('0', '9');
    char[] arrayOfChar = "٠۰߀०০੦૦୦௦౦೦൦๐໐༠၀႐០᠐᥆᧐᭐᮰᱀᱐꘠꣐꤀꩐０".toCharArray();
    int i = arrayOfChar.length;
    zzg localZzg2 = localZzg1;
    for (int j = 0; j < i; j++)
    {
      char c = arrayOfChar[j];
      localZzg2 = localZzg2.zza(zza(c, (char)(c + '\t')));
    }
    BE = localZzg2;
  }
  ...
  {
    zzg[] arrayOfZzg = new zzg[2];
    arrayOfZzg[0] = this;
    arrayOfZzg[1] = ((zzg)zzac.zzy(paramZzg));
    return new zza(Arrays.asList(arrayOfZzg));
  }
