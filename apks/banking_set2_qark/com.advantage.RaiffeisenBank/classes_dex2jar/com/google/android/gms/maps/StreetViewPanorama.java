...
public class StreetViewPanorama
{
  ...
  public Point orientationToPoint(StreetViewPanoramaOrientation paramStreetViewPanoramaOrientation)
  {
    try
    {
      zzd localZzd = this.alQ.orientationToPoint(paramStreetViewPanoramaOrientation);
      if (localZzd == null) {
        return null;
      }
      Point localPoint = (Point)zze.zzae(localZzd);
      return localPoint;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public StreetViewPanoramaOrientation pointToOrientation(Point paramPoint)
  {
    try
    {
      StreetViewPanoramaOrientation localStreetViewPanoramaOrientation = this.alQ.pointToOrientation(zze.zzac(paramPoint));
