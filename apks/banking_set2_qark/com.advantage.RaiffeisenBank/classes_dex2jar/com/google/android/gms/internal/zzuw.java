...
public abstract class zzuw<T>
{
    ...
    extends zzuw<Boolean>
  {
    ...
    public Boolean zzb(zzuz paramZzuz)
    {
      try
      {
        Boolean localBoolean = Boolean.valueOf(paramZzuz.getBooleanFlagValue(getKey(), ((Boolean)zzkq()).booleanValue(), getSource()));
        return localBoolean;
      }
    ...
    extends zzuw<Integer>
  {
    ...
    public Integer zzc(zzuz paramZzuz)
    {
      try
      {
        Integer localInteger = Integer.valueOf(paramZzuz.getIntFlagValue(getKey(), ((Integer)zzkq()).intValue(), getSource()));
        return localInteger;
      }
      catch (RemoteException localRemoteException) {}
      return (Integer)zzkq();
    ...
    extends zzuw<Long>
  {
    ...
    public Long zzd(zzuz paramZzuz)
    {
      try
      {
        Long localLong = Long.valueOf(paramZzuz.getLongFlagValue(getKey(), ((Long)zzkq()).longValue(), getSource()));
        return localLong;
      }
      catch (RemoteException localRemoteException) {}
      return (Long)zzkq();
    ...
    extends zzuw<String>
  {
    ...
    public String zze(zzuz paramZzuz)
    {
      try
      {
        String str = paramZzuz.getStringFlagValue(getKey(), (String)zzkq(), getSource());
        return str;
      }
      catch (RemoteException localRemoteException) {}
      return (String)zzkq();
