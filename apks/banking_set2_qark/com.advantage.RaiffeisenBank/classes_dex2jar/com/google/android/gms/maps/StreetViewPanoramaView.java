  ...
  extends FrameLayout
{
    ...
    extends zza<StreetViewPanoramaView.zza>
  {
    ...
    public void zzbru()
    {
      ...
      try
      {
        IStreetViewPanoramaViewDelegate localIStreetViewPanoramaViewDelegate = zzai.zzdp(this.mContext).zza(zze.zzac(this.mContext), this.amn);
        this.alG.zza(new StreetViewPanoramaView.zza(this.alN, localIStreetViewPanoramaViewDelegate));
