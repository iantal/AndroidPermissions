  ...
  implements zzaou, Cloneable
{
  ...
  public <T> zzaot<T> zza(final zzaob paramZzaob, final zzapx<T> paramZzapx)
  {
    ...
    new zzaot()
    {
      ...
      private zzaot<T> bd()
      {
        ...
        zzaot localZzaot2 = paramZzaob.zza(zzapc.this, paramZzapx);
  ...
  public boolean zza(Class<?> paramClass, boolean paramBoolean)
  {
    ...
    if (paramBoolean) {}
    for (List localList = this.blJ;; localList = this.blK)
    {
      ...
      } while (!((zzanx)localIterator.next()).zzh(paramClass));
      return true;
    }
    return false;
  }
  ...
  public boolean zza(Field paramField, boolean paramBoolean)
  {
    ...
    if (paramBoolean) {}
    for (List localList = this.blJ; !localList.isEmpty(); localList = this.blK)
    {
      zzany localZzany = new zzany(paramField);
      Iterator localIterator = localList.iterator();
      do
      {
        if (!localIterator.hasNext()) {
      ...
      } while (!((zzanx)localIterator.next()).zza(localZzany));
      return true;
    }
    return false;
  }
