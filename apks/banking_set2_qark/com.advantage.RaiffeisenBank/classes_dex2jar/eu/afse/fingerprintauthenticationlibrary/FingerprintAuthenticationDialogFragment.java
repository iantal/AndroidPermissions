  ...
  implements AuthenticationResponse
{
  ...
  public void error(CharSequence paramCharSequence, int paramInt)
  {
    ...
    if (paramInt == FingerPrintProvider.FAILURE_CODE_TOO_MANY_ATTEMPTS)
    {
      ...
      str = this.fingerToManyAttemptsResource;
    }
    for (;;)
    {
      showError(str, bool);
      ...
      str = this.fingerNotRecognizedStringResource;
      bool = false;
    }
  }
  ...
  public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle)
  {
    ...
    View localView = paramLayoutInflater.inflate(R.layout.fingerprint_dialog_container, paramViewGroup, false);
    ...
    this.mFingerprintContent = localView.findViewById(R.id.fingerprint_container);
    this.mIcon = ((ImageView)localView.findViewById(R.id.fingerprint_icon));
    this.mErrorTextView = ((TextView)localView.findViewById(R.id.fingerprint_status));
    if (this.messageStringResource != null) {
      ((TextView)localView.findViewById(R.id.fingerprint_description)).setText(this.messageStringResource);
    }
    updateStage();
    return localView;
  }
  ...
  public static enum Stage
  {
    static
    {
      ...
      arrayOfStage[0] = FINGERPRINT;
      arrayOfStage[1] = NEW_FINGERPRINT_ENROLLED;
      $VALUES = arrayOfStage;
    }
