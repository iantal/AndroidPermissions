...
class PathParser
{
  ...
  {
    paramArrayList.add(new PathDataNode(paramChar, paramArrayOfFloat, null));
  }
  ...
  public static PathDataNode[] deepCopyNodes(PathDataNode[] paramArrayOfPathDataNode)
  {
    ...
    for (;;)
    {
      ...
      for (int i = 0; i < paramArrayOfPathDataNode.length; i++) {
        arrayOfPathDataNode[i] = new PathDataNode(paramArrayOfPathDataNode[i], null);
      }
    }
  }
  ...
  private static float[] getFloats(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        k = 1;
        ExtractFloatResult localExtractFloatResult = new ExtractFloatResult(null);
