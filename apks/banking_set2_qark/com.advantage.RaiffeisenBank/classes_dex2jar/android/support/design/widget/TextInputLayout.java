  ...
  extends LinearLayout
{
  ...
  public TextInputLayout(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    TypedArray localTypedArray = paramContext.obtainStyledAttributes(paramAttributeSet, R.styleable.TextInputLayout, paramInt, R.style.Widget_Design_TextInputLayout);
    this.mHintEnabled = localTypedArray.getBoolean(R.styleable.TextInputLayout_hintEnabled, true);
    setHint(localTypedArray.getText(R.styleable.TextInputLayout_android_hint));
    this.mHintAnimationEnabled = localTypedArray.getBoolean(R.styleable.TextInputLayout_hintAnimationEnabled, true);
    if (localTypedArray.hasValue(R.styleable.TextInputLayout_android_textColorHint))
    {
      ColorStateList localColorStateList = localTypedArray.getColorStateList(R.styleable.TextInputLayout_android_textColorHint);
      this.mFocusedTextColor = localColorStateList;
      this.mDefaultTextColor = localColorStateList;
    }
    if (localTypedArray.getResourceId(R.styleable.TextInputLayout_hintTextAppearance, -1) != -1) {
      setHintTextAppearance(localTypedArray.getResourceId(R.styleable.TextInputLayout_hintTextAppearance, 0));
    }
    this.mErrorTextAppearance = localTypedArray.getResourceId(R.styleable.TextInputLayout_errorTextAppearance, 0);
    boolean bool1 = localTypedArray.getBoolean(R.styleable.TextInputLayout_errorEnabled, false);
    boolean bool2 = localTypedArray.getBoolean(R.styleable.TextInputLayout_counterEnabled, false);
    setCounterMaxLength(localTypedArray.getInt(R.styleable.TextInputLayout_counterMaxLength, -1));
    this.mCounterTextAppearance = localTypedArray.getResourceId(R.styleable.TextInputLayout_counterTextAppearance, 0);
    this.mCounterOverflowTextAppearance = localTypedArray.getResourceId(R.styleable.TextInputLayout_counterOverflowTextAppearance, 0);
    ...
    for (;;)
    {
      ...
      if ((paramDrawable instanceof DrawableContainer))
      {
        ...
        if (localDrawableContainerState != null)
        {
          ...
          while (i < j)
          {
            clearColorFilter(localDrawableContainerState.getChild(i));
            i++;
          }
        }
      }
  ...
  private void setEditText(EditText paramEditText)
  {
    ...
    this.mCollapsingTextHelper.setCollapsedTextGravity(0x30 | 0x800007 & i);
  ...
  private void updateCounter(int paramInt)
  {
    ...
    {
      localTextView2.setTextAppearance(localContext2, j);
      ...
      localTextView1.setText(localContext1.getString(i, arrayOfObject));
      break;
      bool2 = false;
      break label64;
    }
  ...
  private void updateEditTextBackground()
  {
    ...
    Drawable localDrawable = this.mEditText.getBackground();
  ...
  private LinearLayout.LayoutParams updateEditTextMargin(ViewGroup.LayoutParams paramLayoutParams)
  {
    ...
    for (LinearLayout.LayoutParams localLayoutParams = (LinearLayout.LayoutParams)paramLayoutParams; this.mHintEnabled; localLayoutParams = new LinearLayout.LayoutParams(paramLayoutParams))
    {
      ...
      localLayoutParams.topMargin = ((int)-this.mTmpPaint.ascent());
  ...
  private void updateLabelState(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      break label46;
      label125:
      if ((bool) && (this.mFocusedTextColor != null)) {
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    {
      int i = this.mEditText.getLeft() + this.mEditText.getCompoundPaddingLeft();
      int j = this.mEditText.getRight() - this.mEditText.getCompoundPaddingRight();
      this.mCollapsingTextHelper.setExpandedBounds(i, this.mEditText.getTop() + this.mEditText.getCompoundPaddingTop(), j, this.mEditText.getBottom() - this.mEditText.getCompoundPaddingBottom());
