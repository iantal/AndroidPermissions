  ...
  extends ScrimInsetsFrameLayout
{
  ...
  public NavigationView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    for (ColorStateList localColorStateList1 = localTypedArray.getColorStateList(R.styleable.NavigationView_itemIconTint);; localColorStateList1 = createDefaultColorStateList(16842808))
    {
      boolean bool1 = localTypedArray.hasValue(R.styleable.NavigationView_itemTextAppearance);
      int i = 0;
      int j = 0;
      if (bool1)
      {
        i = localTypedArray.getResourceId(R.styleable.NavigationView_itemTextAppearance, 0);
        j = 1;
      }
      boolean bool2 = localTypedArray.hasValue(R.styleable.NavigationView_itemTextColor);
      ColorStateList localColorStateList2 = null;
      if (bool2) {
        localColorStateList2 = localTypedArray.getColorStateList(R.styleable.NavigationView_itemTextColor);
      }
  ...
  {
    this.mPresenter.setPaddingTopDefault(paramRect.top);
  }
