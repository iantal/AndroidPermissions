  ...
  extends CoordinatorLayout.Behavior<V>
{
  ...
  public BottomSheetBehavior(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    TypedArray localTypedArray = paramContext.obtainStyledAttributes(paramAttributeSet, R.styleable.BottomSheetBehavior_Params);
    setPeekHeight(localTypedArray.getDimensionPixelSize(R.styleable.BottomSheetBehavior_Params_behavior_peekHeight, 0));
    setHideable(localTypedArray.getBoolean(R.styleable.BottomSheetBehavior_Params_behavior_hideable, false));
