  ...
  extends VisibilityAwareImageButton
{
  ...
  public FloatingActionButton(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    this.mBackgroundTintMode = parseTintMode(localTypedArray.getInt(R.styleable.FloatingActionButton_backgroundTintMode, -1), null);
    this.mRippleColor = localTypedArray.getColor(R.styleable.FloatingActionButton_rippleColor, 0);
    this.mSize = localTypedArray.getInt(R.styleable.FloatingActionButton_fabSize, 0);
    ...
    int i = (int)getResources().getDimension(R.dimen.design_fab_image_size);
    this.mImagePadding = ((getSizeDimension() - i) / 2);
    ...
    extends CoordinatorLayout.Behavior<FloatingActionButton>
  {
    ...
    private void offsetIfNeeded(CoordinatorLayout paramCoordinatorLayout, FloatingActionButton paramFloatingActionButton)
    {
      ...
      for (;;)
      {
        paramFloatingActionButton.offsetTopAndBottom(i1);
        paramFloatingActionButton.offsetLeftAndRight(k);
        return;
        label91:
    ...
    private void updateFabTranslationForSnackbar(CoordinatorLayout paramCoordinatorLayout, final FloatingActionButton paramFloatingActionButton, View paramView)
    {
      ...
      if ((paramFloatingActionButton.isShown()) && (Math.abs(f2 - f1) > 0.667F * paramFloatingActionButton.getHeight()))
      {
