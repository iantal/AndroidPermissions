  ...
  extends FloatingActionButtonImpl
{
  ...
  void hide(@Nullable final FloatingActionButtonImpl.InternalVisibilityChangedListener paramInternalVisibilityChangedListener, final boolean paramBoolean)
  {
    ...
    localAnimation.setAnimationListener(new AnimationUtils.AnimationListenerAdapter()
    {
      public void onAnimationEnd(Animation paramAnonymousAnimation)
      {
        ...
        FloatingActionButtonEclairMr1.this.mView.internalSetVisibility(8, paramBoolean);
        if (paramInternalVisibilityChangedListener != null) {
          paramInternalVisibilityChangedListener.onHidden();
        }
      }
  ...
  void onElevationChanged(float paramFloat)
  {
    ...
    {
      this.mShadowDrawable.setShadowSize(paramFloat, paramFloat + this.mPressedTranslationZ);
      updatePadding();
    }
  }
  ...
  void onTranslationZChanged(float paramFloat)
  {
    if (this.mShadowDrawable != null)
    {
      this.mShadowDrawable.setMaxShadowSize(paramFloat + this.mElevation);
      updatePadding();
    }
  }
    ...
    extends Animation
  {
    ...
    {
      FloatingActionButtonEclairMr1.this.mShadowDrawable.setShadowSize(this.mShadowSizeStart + paramFloat * this.mShadowSizeDiff);
    }
