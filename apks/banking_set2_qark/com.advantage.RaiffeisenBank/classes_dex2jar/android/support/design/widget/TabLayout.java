  ...
  extends HorizontalScrollView
{
  ...
  public TabLayout(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    TypedArray localTypedArray1 = paramContext.obtainStyledAttributes(paramAttributeSet, R.styleable.TabLayout, paramInt, R.style.Widget_Design_TabLayout);
    this.mTabStrip.setSelectedIndicatorHeight(localTypedArray1.getDimensionPixelSize(R.styleable.TabLayout_tabIndicatorHeight, 0));
    this.mTabStrip.setSelectedIndicatorColor(localTypedArray1.getColor(R.styleable.TabLayout_tabIndicatorColor, 0));
    int i = localTypedArray1.getDimensionPixelSize(R.styleable.TabLayout_tabPadding, 0);
    this.mTabPaddingBottom = i;
    this.mTabPaddingEnd = i;
    this.mTabPaddingTop = i;
    this.mTabPaddingStart = i;
    this.mTabPaddingStart = localTypedArray1.getDimensionPixelSize(R.styleable.TabLayout_tabPaddingStart, this.mTabPaddingStart);
    this.mTabPaddingTop = localTypedArray1.getDimensionPixelSize(R.styleable.TabLayout_tabPaddingTop, this.mTabPaddingTop);
    this.mTabPaddingEnd = localTypedArray1.getDimensionPixelSize(R.styleable.TabLayout_tabPaddingEnd, this.mTabPaddingEnd);
    this.mTabPaddingBottom = localTypedArray1.getDimensionPixelSize(R.styleable.TabLayout_tabPaddingBottom, this.mTabPaddingBottom);
    this.mTabTextAppearance = localTypedArray1.getResourceId(R.styleable.TabLayout_tabTextAppearance, R.style.TextAppearance_Design_Tab);
    TypedArray localTypedArray2 = paramContext.obtainStyledAttributes(this.mTabTextAppearance, R.styleable.TextAppearance);
    try
    {
      this.mTabTextSize = localTypedArray2.getDimensionPixelSize(R.styleable.TextAppearance_android_textSize, 0);
      this.mTabTextColors = localTypedArray2.getColorStateList(R.styleable.TextAppearance_android_textColor);
      localTypedArray2.recycle();
      if (localTypedArray1.hasValue(R.styleable.TabLayout_tabTextColor)) {
        this.mTabTextColors = localTypedArray1.getColorStateList(R.styleable.TabLayout_tabTextColor);
      }
      if (localTypedArray1.hasValue(R.styleable.TabLayout_tabSelectedTextColor))
      {
        int j = localTypedArray1.getColor(R.styleable.TabLayout_tabSelectedTextColor, 0);
        this.mTabTextColors = createColorStateList(this.mTabTextColors.getDefaultColor(), j);
      }
      this.mRequestedTabMinWidth = localTypedArray1.getDimensionPixelSize(R.styleable.TabLayout_tabMinWidth, -1);
      this.mRequestedTabMaxWidth = localTypedArray1.getDimensionPixelSize(R.styleable.TabLayout_tabMaxWidth, -1);
      this.mTabBackgroundResId = localTypedArray1.getResourceId(R.styleable.TabLayout_tabBackground, 0);
      this.mContentInsetStart = localTypedArray1.getDimensionPixelSize(R.styleable.TabLayout_tabContentStart, 0);
      this.mMode = localTypedArray1.getInt(R.styleable.TabLayout_tabMode, 1);
      this.mTabGravity = localTypedArray1.getInt(R.styleable.TabLayout_tabGravity, 0);
  ...
  private void addTabView(Tab paramTab, int paramInt, boolean paramBoolean)
  {
    ...
    this.mTabStrip.addView(localTabView, paramInt, createLayoutParamsForTabs());
    if (paramBoolean) {
  ...
  {
    TabView localTabView = paramTab.mView;
    this.mTabStrip.addView(localTabView, createLayoutParamsForTabs());
    if (paramBoolean) {
      localTabView.setSelected(true);
    }
  }
  ...
  private int calculateScrollXForTab(int paramInt, float paramFloat)
  {
    ...
    for (int k = localView1.getWidth();; k = 0)
    {
      ...
      j = localView1.getLeft() + (int)(0.5F * (paramFloat * (k + m))) + localView1.getWidth() / 2 - getWidth() / 2;
      return j;
      localView2 = null;
      break;
    }
  ...
  private void setSelectedTabView(int paramInt)
  {
    ...
    if ((paramInt < i) && (!this.mTabStrip.getChildAt(paramInt).isSelected()))
    {
      int j = 0;
      if (j < i)
      {
  ...
  public Tab newTab()
  {
    ...
    if (localTab == null) {
      localTab = new Tab(null);
    }
    Tab.access$002(localTab, this);
    Tab.access$202(localTab, createTabView(localTab));
    return localTab;
  }
    ...
    void animateIndicatorToPosition(final int paramInt1, int paramInt2)
    {
      ...
      for (;;)
      {
        ...
        while ((i1 != j) || (n != k))
        {
          ...
          localValueAnimatorCompat.setUpdateListener(new ValueAnimatorCompat.AnimatorUpdateListener()
          {
            public void onAnimationUpdate(ValueAnimatorCompat paramAnonymousValueAnimatorCompat)
            {
          ...
          localValueAnimatorCompat.setListener(new ValueAnimatorCompat.AnimatorListenerAdapter()
          {
    ...
    implements View.OnLongClickListener
  {
    ...
    public TabView(Context paramContext)
    {
      ...
      if (TabLayout.this.mTabBackgroundResId != 0) {
        setBackgroundDrawable(AppCompatDrawableManager.get().getDrawable(paramContext, TabLayout.this.mTabBackgroundResId));
      }
      ...
      for (;;)
      {
        ...
        if ((f1 != f2) || ((i2 >= 0) && (n != i2)))
        {
          ...
          if ((TabLayout.this.mMode == 1) && (f1 > f2) && (i1 == 1))
          {
            ...
            if ((localLayout == null) || (approximateLineWidth(localLayout, 0, f1) > localLayout.getWidth())) {
              i3 = 0;
            }
          }
          if (i3 != 0)
    ...
    final void update()
    {
      ...
      if (localTab != null)
      {
        ...
        if (this.mIconView == null)
        {
          localImageView = (ImageView)LayoutInflater.from(getContext()).inflate(R.layout.design_layout_tab_icon, this, false);
          addView(localImageView, 0);
          this.mIconView = localImageView;
        }
        if (this.mTextView == null)
        {
          localTextView = (TextView)LayoutInflater.from(getContext()).inflate(R.layout.design_layout_tab_text, this, false);
