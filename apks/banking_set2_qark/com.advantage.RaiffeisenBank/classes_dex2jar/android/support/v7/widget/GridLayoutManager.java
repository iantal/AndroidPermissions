  ...
  extends LinearLayoutManager
{
  ...
  private void measureChildWithDecorationsAndMargin(View paramView, int paramInt1, int paramInt2, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if ((paramBoolean1) || (this.mOrientation == 1)) {
    ...
    if ((paramBoolean1) || (this.mOrientation == 0)) {
  ...
  void layoutChunk(RecyclerView.Recycler paramRecycler, RecyclerView.State paramState, LinearLayoutManager.LayoutState paramLayoutState, LinearLayoutManager.LayoutChunkResult paramLayoutChunkResult)
  {
    ...
    for (;;)
    {
      ...
      {
        int i31 = paramLayoutState.mCurrentPosition;
        i32 = getSpanSize(paramRecycler, paramState, i31);
        if (i32 > this.mSpanCount)
        {
          throw new IllegalArgumentException("Item at position " + i31 + " requires " + i32 + " spans but GridLayoutManager has only " + this.mSpanCount + " spans.");
          j = 0;
          break;
          label210:
          k = 0;
    ...
    int i2 = 0;
    float f1 = 0.0F;
    assignSpans(paramRecycler, paramState, n, i1, bool1);
    int i3 = 0;
    if (i3 < n)
    {
      ...
      if (paramLayoutState.mScrapList == null) {
        if (bool1)
        {
          ...
          int i23 = this.mCachedBorders[(localLayoutParams4.mSpanIndex + localLayoutParams4.mSpanSize)] - this.mCachedBorders[localLayoutParams4.mSpanIndex];
          if (this.mOrientation != 0) {
            break label575;
          }
          i24 = localLayoutParams4.height;
          i25 = getChildMeasureSpec(i23, i, 0, i24, false);
          int i26 = this.mOrientationHelper.getTotalSpace();
          int i27 = this.mOrientationHelper.getMode();
          if (this.mOrientation != 1) {
            break label585;
          }
          i28 = localLayoutParams4.height;
          i29 = getChildMeasureSpec(i26, i27, 0, i28, true);
          if (this.mOrientation != 1) {
            break label601;
          }
          if (localLayoutParams4.height != -1) {
            break label595;
          }
        }
      }
      ...
      {
        measureChildWithDecorationsAndMargin(localView4, i25, i29, bool3, false);
        int i30 = this.mOrientationHelper.getDecoratedMeasurement(localView4);
        if (i30 > i2) {
          i2 = i30;
        }
        float f2 = 1.0F * this.mOrientationHelper.getDecoratedMeasurementInOther(localView4) / localLayoutParams4.mSpanSize;
        if (f2 > f1) {
          f1 = f2;
        }
        i3++;
        ...
        break label335;
        i24 = localLayoutParams4.width;
        break label388;
        i28 = localLayoutParams4.width;
        break label434;
      }
      label601:
      if (localLayoutParams4.width == -1) {}
      for (boolean bool2 = true;; bool2 = false)
      {
        measureChildWithDecorationsAndMargin(localView4, i29, i25, bool2, false);
        break;
      }
    }
    if (j != 0)
    {
      ...
      if (i14 < n)
      {
        View localView3 = this.mSet[i14];
        LayoutParams localLayoutParams3 = (LayoutParams)localView3.getLayoutParams();
        int i15 = this.mCachedBorders[(localLayoutParams3.mSpanIndex + localLayoutParams3.mSpanSize)] - this.mCachedBorders[localLayoutParams3.mSpanIndex];
        int i16;
        label723:
        int i17;
        int i20;
        ...
        if (this.mOrientation == 0)
        {
          i16 = localLayoutParams3.height;
          i17 = getChildMeasureSpec(i15, 1073741824, 0, i16, false);
          int i18 = this.mOrientationHelper.getTotalSpace();
          int i19 = this.mOrientationHelper.getMode();
          if (this.mOrientation != 1) {
            break label841;
          }
          i20 = localLayoutParams3.height;
          i21 = getChildMeasureSpec(i18, i19, 0, i20, true);
          if (this.mOrientation != 1) {
            break label851;
          }
          measureChildWithDecorationsAndMargin(localView3, i17, i21, false, true);
        }
        for (;;)
        {
          int i22 = this.mOrientationHelper.getDecoratedMeasurement(localView3);
          if (i22 > i2) {
            i2 = i22;
          }
          i14++;
          break;
          i16 = localLayoutParams3.width;
          break label723;
          label841:
          i20 = localLayoutParams3.width;
          break label770;
          label851:
          measureChildWithDecorationsAndMargin(localView3, i21, i17, false, true);
        }
      }
    }
    ...
    if (i5 < n)
    {
      ...
      if (this.mOrientationHelper.getDecoratedMeasurement(localView2) != i2)
      {
        ...
        int i11 = this.mCachedBorders[(localLayoutParams2.mSpanIndex + localLayoutParams2.mSpanSize)] - this.mCachedBorders[localLayoutParams2.mSpanIndex];
        if (this.mOrientation != 0) {
          break label1002;
        }
        i12 = localLayoutParams2.height;
        i13 = getChildMeasureSpec(i11, 1073741824, 0, i12, false);
        if (this.mOrientation != 1) {
          break label1012;
        }
        measureChildWithDecorationsAndMargin(localView2, i13, i4, true, true);
      }
      for (;;)
      {
        i5++;
        break;
        label1002:
        i12 = localLayoutParams2.width;
        break label962;
        label1012:
        measureChildWithDecorationsAndMargin(localView2, i4, i13, true, true);
      }
    }
    ...
    if (this.mOrientation == 1) {
      if (paramLayoutState.mLayoutDirection == -1)
      {
        ...
        i7 = getPaddingLeft() + this.mCachedBorders[(localLayoutParams1.mSpanIndex + localLayoutParams1.mSpanSize)];
        i6 = i7 - this.mOrientationHelper.getDecoratedMeasurementInOther(localView1);
      }
    }
    for (;;)
    {
      layoutDecorated(localView1, i6 + localLayoutParams1.leftMargin, i9 + localLayoutParams1.topMargin, i7 - localLayoutParams1.rightMargin, i8 - localLayoutParams1.bottomMargin);
      ...
      break;
      label1306:
      i6 = getPaddingLeft() + this.mCachedBorders[localLayoutParams1.mSpanIndex];
      i7 = i6 + this.mOrientationHelper.getDecoratedMeasurementInOther(localView1);
      continue;
      label1340:
      i9 = getPaddingTop() + this.mCachedBorders[localLayoutParams1.mSpanIndex];
      i8 = i9 + this.mOrientationHelper.getDecoratedMeasurementInOther(localView1);
    }
    label1374:
  ...
  public View onFocusSearchFailed(View paramView, int paramInt, RecyclerView.Recycler paramRecycler, RecyclerView.State paramState)
  {
    ...
    do
    {
      ...
      i = localLayoutParams1.mSpanIndex;
      j = localLayoutParams1.mSpanIndex + localLayoutParams1.mSpanSize;
      ...
      for (;;)
      {
        ...
        if (localView3.isFocusable()) {
          break label216;
        }
        i5 += m;
      }
      localLayoutParams2 = (LayoutParams)localView3.getLayoutParams();
      i6 = localLayoutParams2.mSpanIndex;
      i7 = localLayoutParams2.mSpanIndex + localLayoutParams2.mSpanSize;
    } while ((i6 == i) && (i7 == j));
    int i11;
    if (localView2 == null) {
      i11 = 1;
    ...
    for (;;)
    {
      ...
      if (i11 != 0)
      {
        ...
        i4 = Math.min(i7, j) - Math.max(i6, i);
        break;
        int i8 = Math.max(i6, i);
        int i9 = Math.min(i7, j) - i8;
        if (i9 > i4)
        {
          i11 = 1;
        }
