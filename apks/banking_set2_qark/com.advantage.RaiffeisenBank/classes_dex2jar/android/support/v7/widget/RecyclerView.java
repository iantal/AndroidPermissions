  ...
  implements ScrollingView, NestedScrollingChild
{
    ...
    for (boolean bool2 = true;; bool2 = false)
    {
      ...
      if (paramAttributeSet != null)
      {
        ...
        if (Build.VERSION.SDK_INT >= 21)
        {
          ...
          bool3 = localTypedArray2.getBoolean(0, true);
          localTypedArray2.recycle();
        }
      }
      setNestedScrollingEnabled(bool3);
      return;
      bool1 = false;
      break;
    }
  ...
  private boolean didChildRangeChange(int paramInt1, int paramInt2)
  {
    ...
    do
    {
      ...
      i = this.mMinMaxLayoutPositions[1];
      bool = false;
    } while (i == paramInt2);
    return true;
  }
  ...
  private void dispatchLayoutStep1()
  {
    ...
    {
      bool1 = true;
      State.access$2702(localState, bool1);
    ...
    if (this.mState.mRunPredictiveAnimations)
    {
      ...
      State.access$1802(this.mState, bool2);
      int i = 0;
  ...
  private void initChildrenHelper()
  {
    this.mChildHelper = new ChildHelper(new ChildHelper.Callback()
    {
      ...
      public void onEnteredHiddenState(View paramAnonymousView)
      {
        RecyclerView.ViewHolder localViewHolder = RecyclerView.getChildViewHolderInt(paramAnonymousView);
        if (localViewHolder != null) {
          RecyclerView.ViewHolder.access$1500(localViewHolder);
        }
      }
      ...
      public void onLeftHiddenState(View paramAnonymousView)
      {
        RecyclerView.ViewHolder localViewHolder = RecyclerView.getChildViewHolderInt(paramAnonymousView);
        if (localViewHolder != null) {
          RecyclerView.ViewHolder.access$1600(localViewHolder);
        }
      }
  ...
  private void processAdapterUpdatesAndSetAnimationFlags()
  {
    ...
    if (predictiveItemAnimationsEnabled())
    {
      ...
      bool3 = bool1;
      State.access$2502(localState1, bool3);
    ...
    for (;;)
    {
      State.access$2302(localState2, bool1);
      return;
      this.mAdapterHelper.consumeUpdatesInOnePass();
      break;
      label177:
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      return true;
      this.mScrollPointerId = MotionEventCompat.getPointerId(paramMotionEvent, 0);
      int i10 = (int)(0.5F + paramMotionEvent.getX());
      this.mLastTouchX = i10;
      this.mInitialTouchX = i10;
      int i11 = (int)(0.5F + paramMotionEvent.getY());
      ...
      startNestedScroll(i12);
      k = 0;
      continue;
      this.mScrollPointerId = MotionEventCompat.getPointerId(paramMotionEvent, j);
      int i8 = (int)(0.5F + MotionEventCompat.getX(paramMotionEvent, j));
      this.mLastTouchX = i8;
      this.mInitialTouchX = i8;
      int i9 = (int)(0.5F + MotionEventCompat.getY(paramMotionEvent, j));
      this.mLastTouchY = i9;
      this.mInitialTouchY = i9;
      k = 0;
      continue;
      int m = MotionEventCompat.findPointerIndex(paramMotionEvent, this.mScrollPointerId);
      if (m < 0)
      {
        Log.e("RecyclerView", "Error processing scroll; pointer index for id " + this.mScrollPointerId + " not found. Did any MotionEvents get skipped?");
        return false;
      }
      int n = (int)(0.5F + MotionEventCompat.getX(paramMotionEvent, m));
      int i1 = (int)(0.5F + MotionEventCompat.getY(paramMotionEvent, m));
      ...
      if (i5 == 1)
      {
        ...
        for (;;)
        {
          boolean bool3 = scrollByInternal(i2, i3, localMotionEvent);
          k = 0;
          if (!bool3) {
            break;
          }
  ...
  public static abstract class ItemAnimator
  {
    ...
    {
      int i = 0xE & RecyclerView.ViewHolder.access$6500(paramViewHolder);
  ...
  public static abstract class LayoutManager
  {
    ...
    public boolean requestChildRectangleOnScreen(RecyclerView paramRecyclerView, View paramView, Rect paramRect, boolean paramBoolean)
    {
      ...
      for (;;)
      {
        ...
        break label154;
        label236:
        paramRecyclerView.smoothScrollBy(i8, i9);
      }
      label247:
      return false;
    }
    ...
    void setMeasuredDimensionFromChildren(int paramInt1, int paramInt2)
    {
      ...
      for (int i1 = 0; i1 < i; i1++)
      {
        ...
        int i2 = getDecoratedLeft(localView) - localLayoutParams.leftMargin;
        int i3 = getDecoratedRight(localView) + localLayoutParams.rightMargin;
        int i4 = getDecoratedTop(localView) - localLayoutParams.topMargin;
        int i5 = getDecoratedBottom(localView) + localLayoutParams.bottomMargin;
        if (i2 < j) {
          j = i2;
        }
        if (i3 > m) {
  ...
  public final class Recycler
  {
    ...
    RecyclerView.ViewHolder getScrapViewForPosition(int paramInt1, int paramInt2, boolean paramBoolean)
    {
      ...
      for (int j = 0;; j++)
      {
        if (j < i)
        {
          ...
          if ((localViewHolder1.wasReturnedFromScrap()) || (localViewHolder1.getLayoutPosition() != paramInt1) || (localViewHolder1.isInvalid()) || ((!RecyclerView.State.access$2400(RecyclerView.this.mState)) && (localViewHolder1.isRemoved()))) {
            continue;
          }
          if ((paramInt2 != -1) && (localViewHolder1.getItemViewType() != paramInt2)) {
            Log.e("RecyclerView", "Scrap view for position " + paramInt1 + " isn't dirty but has" + " wrong view type! (found " + localViewHolder1.getItemViewType() + " but expected " + paramInt2 + ")");
          }
        }
        else
        {
          ...
          localView = RecyclerView.this.mChildHelper.findHiddenNonRemovedView(paramInt1, paramInt2);
          if (localView == null) {
            break label292;
          }
          localViewHolder2 = RecyclerView.getChildViewHolderInt(localView);
          RecyclerView.this.mChildHelper.unhide(localView);
          n = RecyclerView.this.mChildHelper.indexOfChild(localView);
          if (n != -1) {
            break;
          }
    ...
    View getViewForPosition(int paramInt, boolean paramBoolean)
    {
      ...
      for (;;)
      {
        if (localViewHolder == null)
        {
          int n = RecyclerView.this.mAdapterHelper.findPositionOffset(paramInt);
          if ((n < 0) || (n >= RecyclerView.this.mAdapter.getItemCount()))
          {
            throw new IndexOutOfBoundsException("Inconsistency detected. Invalid item position " + paramInt + "(offset:" + n + ")." + "state:" + RecyclerView.this.mState.getItemCount());
            i = 0;
            break;
            label288:
          ...
          int i1 = RecyclerView.this.mAdapter.getItemViewType(n);
          if (RecyclerView.this.mAdapter.hasStableIds())
          {
            localViewHolder = getScrapViewForId(RecyclerView.this.mAdapter.getItemId(n), i1, paramBoolean);
            if (localViewHolder != null)
            {
              localViewHolder.mPosition = n;
              i = 1;
            }
          }
          if ((localViewHolder == null) && (this.mViewCacheExtension != null))
          {
            View localView = this.mViewCacheExtension.getViewForPositionAndType(this, paramInt, i1);
            if (localView != null)
            {
          ...
          if (localViewHolder == null)
          {
            localViewHolder = getRecycledViewPool().getRecycledView(i1);
            if (localViewHolder != null)
            {
              localViewHolder.resetInternal();
          ...
          if (localViewHolder == null) {
            localViewHolder = RecyclerView.this.mAdapter.createViewHolder(RecyclerView.this, i1);
          }
        }
      }
      if ((i != 0) && (!RecyclerView.this.mState.isPreLayout()) && (localViewHolder.hasAnyOfTheFlags(8192)))
      {
        localViewHolder.setFlags(0, 8192);
        if (RecyclerView.State.access$2500(RecyclerView.this.mState))
        {
          int m = 0x1000 | RecyclerView.ItemAnimator.buildAdapterChangeFlagsForAnimations(localViewHolder);
          RecyclerView.ItemAnimator.ItemHolderInfo localItemHolderInfo = RecyclerView.this.mItemAnimator.recordPreLayoutInformation(RecyclerView.this.mState, localViewHolder, m, localViewHolder.getUnmodifiedPayloads());
          RecyclerView.this.recordAnimationInfoIfBouncedHiddenView(localViewHolder, localItemHolderInfo);
        }
      }
      int j = 0;
    ...
    {
      RecyclerView.ViewHolder localViewHolder = RecyclerView.getChildViewHolderInt(paramView);
      RecyclerView.ViewHolder.access$5002(localViewHolder, null);
      RecyclerView.ViewHolder.access$5102(localViewHolder, false);
      localViewHolder.clearReturnedFromScrapFlag();
      recycleViewHolderInternal(localViewHolder);
    }
    ...
    void recycleViewHolderInternal(RecyclerView.ViewHolder paramViewHolder)
    {
      ...
      boolean bool2 = RecyclerView.ViewHolder.access$4900(paramViewHolder);
