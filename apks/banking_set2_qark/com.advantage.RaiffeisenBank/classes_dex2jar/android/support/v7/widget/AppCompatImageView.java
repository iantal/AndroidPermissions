  ...
  implements TintableBackgroundView
{
  ...
  public AppCompatImageView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    this.mBackgroundTintHelper = new AppCompatBackgroundHelper(this, localAppCompatDrawableManager);
    this.mBackgroundTintHelper.loadFromAttributes(paramAttributeSet, paramInt);
    this.mImageHelper = new AppCompatImageHelper(this, localAppCompatDrawableManager);
