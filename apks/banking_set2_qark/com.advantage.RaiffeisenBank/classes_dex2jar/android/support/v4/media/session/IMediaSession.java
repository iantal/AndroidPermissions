        ...
        public boolean onTransact(int n, Parcel parcel, Parcel parcel2, int n2) throws RemoteException {
            switch (n) {
                ...
                case 14: {
                    ...
                    Bundle bundle = parcel.readInt() != 0 ? (Bundle)Bundle.CREATOR.createFromParcel(parcel) : null;
                    this.playFromMediaId(string5, bundle);
                    parcel2.writeNoException();
                    return true;
                }
                case 15: {
                    ...
                    Bundle bundle = parcel.readInt() != 0 ? (Bundle)Bundle.CREATOR.createFromParcel(parcel) : null;
                    this.playFromSearch(string6, bundle);
                    parcel2.writeNoException();
                    return true;
                }
                case 16: {
                ...
                case 26: {
                    ...
                    Bundle bundle = parcel.readInt() != 0 ? (Bundle)Bundle.CREATOR.createFromParcel(parcel) : null;
                    this.sendCustomAction(string7, bundle);
                    parcel2.writeNoException();
                    return true;
                }
                case 27: {
                ...
                case 34: {
                    ...
                    Bundle bundle = parcel.readInt() != 0 ? (Bundle)Bundle.CREATOR.createFromParcel(parcel) : null;
                    this.prepareFromMediaId(string8, bundle);
                    parcel2.writeNoException();
                    return true;
                }
                case 35: {
                    ...
                    Bundle bundle = parcel.readInt() != 0 ? (Bundle)Bundle.CREATOR.createFromParcel(parcel) : null;
                    this.prepareFromSearch(string9, bundle);
                    parcel2.writeNoException();
                    return true;
                }
                case 36: 
