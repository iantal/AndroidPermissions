...
public class NotificationCompat
{
  ...
  private static void addStyleToBuilderApi24(NotificationBuilderWithBuilderAccessor paramNotificationBuilderWithBuilderAccessor, Style paramStyle)
  {
    if (paramStyle != null)
    {
      if ((paramStyle instanceof MessagingStyle))
      {
        ...
        Iterator localIterator = localMessagingStyle.mMessages.iterator();
        while (localIterator.hasNext())
        {
        ...
        NotificationCompatApi24.addMessagingStyle(paramNotificationBuilderWithBuilderAccessor, localMessagingStyle.mUserDisplayName, localMessagingStyle.mConversationTitle, localArrayList1, localArrayList2, localArrayList3, localArrayList4, localArrayList5);
      }
    }
    else {
      return;
    ...
    extends NotificationCompat.NotificationCompatImplKitKat
  {
    ...
    public Notification build(NotificationCompat.Builder paramBuilder, NotificationCompat.BuilderExtender paramBuilderExtender)
    {
      ...
      if (paramBuilder.mStyle != null) {
        paramBuilder.mStyle.addCompatExtras(getExtras(localNotification));
      }
    ...
    implements NotificationCompat.NotificationCompatImpl
  {
    ...
    public Notification build(NotificationCompat.Builder paramBuilder, NotificationCompat.BuilderExtender paramBuilderExtender)
    {
      Notification localNotification = NotificationCompatBase.add(paramBuilder.mNotification, paramBuilder.mContext, paramBuilder.mContentTitle, paramBuilder.mContentText, paramBuilder.mContentIntent);
    ...
    extends NotificationCompat.NotificationCompatImplBase
  {
    ...
    public Notification build(NotificationCompat.Builder paramBuilder, NotificationCompat.BuilderExtender paramBuilderExtender)
    {
      Notification localNotification = NotificationCompatGingerbread.add(paramBuilder.mNotification, paramBuilder.mContext, paramBuilder.mContentTitle, paramBuilder.mContentText, paramBuilder.mContentIntent, paramBuilder.mFullScreenIntent);
      if (paramBuilder.mPriority > 0) {
        localNotification.flags = (0x80 | localNotification.flags);
      }
      if (paramBuilder.mContentView != null) {
    ...
    extends NotificationCompat.NotificationCompatImplBase
  {
    ...
    public Notification build(NotificationCompat.Builder paramBuilder, NotificationCompat.BuilderExtender paramBuilderExtender)
    {
      Notification localNotification = NotificationCompatHoneycomb.add(paramBuilder.mContext, paramBuilder.mNotification, paramBuilder.mContentTitle, paramBuilder.mContentText, paramBuilder.mContentInfo, paramBuilder.mTickerView, paramBuilder.mNumber, paramBuilder.mContentIntent, paramBuilder.mFullScreenIntent, paramBuilder.mLargeIcon);
      if (paramBuilder.mContentView != null) {
        localNotification.contentView = paramBuilder.mContentView;
      }
      return localNotification;
