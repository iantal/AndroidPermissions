    ...
    extends LayoutInflater {
        ...
        protected View onCreateView(String string2, AttributeSet attributeSet) throws ClassNotFoundException {
            for (String string3 : sClassPrefixList) {
                try {
                    View view = this.createView(string2, string3, attributeSet);
    ...
    extends Thread {
        ...
        public void enqueue(InflateRequest inflateRequest) {
            try {
                ...
                throw new RuntimeException("Failed to enqueue async inflate request", var2_2);
            }
        }
        ...
        public void run() {
            do {
                ...
                try {
                    ...
                    Log.w((String)"AsyncLayoutInflater", (Throwable)var1_1);
                    continue;
                }
                try {
                    ...
                    Log.w((String)"AsyncLayoutInflater", (String)"Failed to inflate resource in the background! Retrying on the UI thread", (Throwable)var4_3);
                }
