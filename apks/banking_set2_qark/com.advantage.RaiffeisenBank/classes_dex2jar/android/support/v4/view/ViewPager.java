  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      if (!this.mIsBeingDragged)
      {
        ...
        f4 = MotionEventCompat.getY(paramMotionEvent, i1);
      ...
      if (bool3)
      {
        ...
        setCurrentItemInternal(determineTargetPage(localItemInfo.position, (n / m - localItemInfo.offset) / (f1 + localItemInfo.widthFactor), k, (int)(MotionEventCompat.getX(paramMotionEvent, MotionEventCompat.findPointerIndex(paramMotionEvent, this.mActivePointerId)) - this.mInitialMotionX)), true, true, k);
        bool1 = resetTouch();
        continue;
