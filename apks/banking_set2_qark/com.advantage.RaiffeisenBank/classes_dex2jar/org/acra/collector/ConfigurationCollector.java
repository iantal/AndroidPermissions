...
public final class ConfigurationCollector
{
        ...
        if ((Modifier.isStatic(localField.getModifiers())) && (Modifier.isFinal(localField.getModifiers())))
        {
          ...
          catch (IllegalArgumentException localIllegalArgumentException)
          {
            ...
            if (str.startsWith("KEYBOARDHIDDEN_")) {
              localSparseArray3.put(localField.getInt(null), str);
            }
          }
          ...
          if (str.startsWith("NAVIGATION_")) {
            localSparseArray4.put(localField.getInt(null), str);
          } else if (str.startsWith("NAVIGATIONHIDDEN_")) {
            localSparseArray5.put(localField.getInt(null), str);
          } else if (str.startsWith("ORIENTATION_")) {
            localSparseArray6.put(localField.getInt(null), str);
          } else if (str.startsWith("SCREENLAYOUT_")) {
            localSparseArray7.put(localField.getInt(null), str);
          } else if (str.startsWith("TOUCHSCREEN_")) {
            localSparseArray8.put(localField.getInt(null), str);
          } else if (str.startsWith("UI_MODE_")) {
            localSparseArray9.put(localField.getInt(null), str);
          }
        }
      }
      else
    ...
    throws IllegalAccessException
  {
    ...
    do
    {
      ...
      SparseArray localSparseArray = (SparseArray)this.mValueArrays.get(str1.toUpperCase() + '_');
