...
public final class HttpRequest
{
    ...
    throws IOException
  {
    ...
    try
    {
      ...
      {
        String str2 = new String(Base64.encode((this.login + ":" + this.password).getBytes("UTF-8"), 0), "UTF-8");
        localHttpURLConnection.setRequestProperty("Authorization", "Basic " + str2);
      }
      ...
      if (this.headers != null)
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          localHttpURLConnection.setRequestProperty(str1, (String)this.headers.get(str1));
        }
      }
    }
