  ...
  implements XmlSerializer
{
    ...
    throws IOException
  {
    ...
    if (i < this.nspCounts[this.depth])
    {
      ...
      while ((!"".equals(getNamespace())) || ("".equals(this.nspStack[(1 + i * 2)])))
      {
        this.writer.write("=\"");
  ...
  {
    while (this.depth > 0) {
      endTag(this.elementStack[(-3 + 3 * this.depth)], this.elementStack[(-1 + 3 * this.depth)]);
    }
    flush();
  }
    ...
    throws IOException
  {
    ...
    if (((paramString1 == null) && (this.elementStack[(3 * this.depth)] != null)) || ((paramString1 != null) && (!paramString1.equals(this.elementStack[(3 * this.depth)]))) || (!this.elementStack[(2 + 3 * this.depth)].equals(paramString2))) {
    ...
    throws IOException
  {
    ...
    if (paramString == null) {}
    for (OutputStreamWriter localOutputStreamWriter = new OutputStreamWriter(paramOutputStream);; localOutputStreamWriter = new OutputStreamWriter(paramOutputStream, paramString))
    {
