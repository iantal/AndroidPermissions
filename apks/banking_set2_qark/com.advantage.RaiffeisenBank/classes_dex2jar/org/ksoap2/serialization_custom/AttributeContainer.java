...
public class AttributeContainer
{
  ...
  public void addAttribute(String paramString, Object paramObject)
  {
    ...
    {
      localAttributeInfo.type = localClass;
  ...
  protected boolean attributesAreEqual(AttributeContainer paramAttributeContainer)
  {
    ...
    if (i != paramAttributeContainer.getAttributeCount()) {
      return false;
    }
    for (int j = 0;; j++)
    {
      ...
      AttributeInfo localAttributeInfo = (AttributeInfo)this.attributes.elementAt(j);
      Object localObject = localAttributeInfo.getValue();
      if ((!paramAttributeContainer.hasAttribute(localAttributeInfo.getName())) || (!localObject.equals(paramAttributeContainer.safeGetAttribute(localAttributeInfo.getName())))) {
        break;
      }
    }
    label77:
  ...
  public Object safeGetAttribute(String paramString)
  {
    return getAttributeSafely(paramString);
  }
}
