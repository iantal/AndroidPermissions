...
public class AsyncSession
{
  ...
  {
    AsyncOperation localAsyncOperation = new AsyncOperation(paramOperationType, this.daoSession.getDao(paramClass), null, paramObject, paramInt | this.sessionFlags);
    this.executor.enqueue(localAsyncOperation);
  ...
  {
    AsyncOperation localAsyncOperation = new AsyncOperation(paramOperationType, null, this.daoSession.getDatabase(), paramObject, paramInt | this.sessionFlags);
    this.executor.enqueue(localAsyncOperation);
    return localAsyncOperation;
  }
  ...
  public void setSessionFlags(int paramInt)
  {
    this.sessionFlags = paramInt;
  }
