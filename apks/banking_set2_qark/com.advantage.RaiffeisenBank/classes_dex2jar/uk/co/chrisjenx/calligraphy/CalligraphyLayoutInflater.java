  ...
  implements CalligraphyActivityFactory
{
  ...
  private View createCustomViewInternal(View paramView1, View paramView2, String paramString, Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    if ((paramView2 == null) && (paramString.indexOf('.') > -1))
    {
      ...
      arrayOfObject = (Object[])ReflectionUtils.getValue(this.mConstructorArgs, this);
      localObject1 = arrayOfObject[0];
      arrayOfObject[0] = paramContext;
      ReflectionUtils.setValue(this.mConstructorArgs, this, arrayOfObject);
    }
    try
    {
  ...
  private void setPrivateFactoryInternal()
  {
    ...
    if (localMethod != null)
    {
      ...
      arrayOfObject[0] = new PrivateWrapperFactory2((LayoutInflater.Factory2)getContext(), this, this.mCalligraphyFactory);
      ReflectionUtils.invokeMethod(this, localMethod, arrayOfObject);
    }
    this.mSetPrivateFactory = true;
  }
    ...
    throws ClassNotFoundException
  {
    ...
    if (localObject == null) {
      localObject = super.onCreateView(paramString, paramAttributeSet);
    }
    return this.mCalligraphyFactory.onViewCreated((View)localObject, ((View)localObject).getContext(), paramAttributeSet);
  }
