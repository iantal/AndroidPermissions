  ...
  implements Serializable
{
    ...
    throws IllegalArgumentException
  {
    ...
    {
      return paramString;
      localObject = IDNHolder.JAVA_NET_IDN_TO_ASCII;
    } while (localObject == null);
    try
    {
      paramString = (String)((Method)localObject).invoke(null, new String[] { paramString.toLowerCase(Locale.ENGLISH) });
      return paramString;
    }
    ...
    {
      localObject = paramString.getCause();
  ...
  final boolean isValidDomainSyntax(String paramString)
  {
    ...
    do
    {
      ...
      arrayOfString = this.domainRegex.match(paramString);
    } while (((arrayOfString == null) || (arrayOfString.length <= 0)) && (!this.hostnameRegex.isValid(paramString)));
    return true;
  }
