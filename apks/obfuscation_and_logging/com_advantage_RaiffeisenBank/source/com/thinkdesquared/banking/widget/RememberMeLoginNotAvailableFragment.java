  ...
  extends Fragment
{
  ...
  public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle)
  {
    ...
    paramLayoutInflater = paramLayoutInflater.inflate(2130903311, paramViewGroup, false);
    ((Button)paramLayoutInflater.findViewById(2131559051)).setOnClickListener(new View.OnClickListener()
    {
