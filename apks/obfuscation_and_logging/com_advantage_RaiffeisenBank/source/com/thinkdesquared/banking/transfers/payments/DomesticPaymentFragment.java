  ...
  implements DomesticPaymentView
{
  ...
  private HashMap<String, String> getEditTextValuesHashMap()
  {
    ...
    if (this.mBeneficiaryNameTextView.getText().length() > 0)
    {
      ...
      localObject1 = this.mDomesticBeneficiaryIdButton.getText().toString();
      label70:
      localHashMap.put("BENEFICIARY_ID", localObject1);
      if (this.mFiscalRegistrationEditText.getText().length() <= 0) {
        break label228;
      }
      localObject1 = this.mFiscalRegistrationEditText.getText().toString();
      label104:
      localHashMap.put("FISCAL_REGISTRATION_NUMBER", localObject1);
    ...
    label233:
    label238:
    for (Object localObject1 = this.mTransactionDetails2.getText().toString();; localObject1 = null)
    {
  ...
  public void setBeneficiaryIbanAfterFocus(Boolean paramBoolean1, Boolean paramBoolean2, Boolean paramBoolean3, Boolean paramBoolean4)
  {
    ...
    {
      paramBoolean1 = this.mIbanLoading;
