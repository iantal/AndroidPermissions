  ...
  extends SearchWithListAdapter<TreasuryPaymentBeneficiary>
{
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (paramInt = 0;; paramInt = 4)
    {
      ...
      paramViewGroup.titleTextView.setText(localTreasuryPaymentBeneficiary.getBeneficiaryName());
      paramViewGroup.detailTextView.setText(localTreasuryPaymentBeneficiary.getCountryName());
      return paramView;
