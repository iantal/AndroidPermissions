  ...
  extends FontTabLayout
{
  ...
  public void init(FragmentManager paramFragmentManager, FragmentActivity paramFragmentActivity, PaymentDetailsFragment paramPaymentDetailsFragment, SepaDetailsFragment paramSepaDetailsFragment, boolean paramBoolean)
  {
    ...
    paramFragmentManager = this.mPaymentDetailsFragment;
    if (!paramBoolean) {}
    for (paramBoolean = true;; paramBoolean = false)
    {
      paramFragmentManager.addButtonVisibilityForCorp(paramBoolean);
      ...
      setOnTabSelectedListener(new TabLayout.OnTabSelectedListener()
      {
        ...
        public void onTabSelected(TabLayout.Tab paramAnonymousTab)
        {
          ...
          label78:
          for (paramAnonymousTab = DSQHelper.getString(2131165899);; paramAnonymousTab = DSQHelper.getString(2131165908))
          {
            DSQHelper.validationDialog(SepaDetailsFragmentTabLayout.this.getActivity(), paramAnonymousTab, 2130838056, SepaDetailsFragmentTabLayout.this.mAcceptPageTransition, SepaDetailsFragmentTabLayout.this.mRejectPageTransition);
            return;
          }
          label87:
          SepaDetailsFragmentTabLayout.this.acceptTransition();
  ...
  {
    int i = 0;
    if (this.mSepaDetailsFragment.isAdded()) {
      i = 1;
    }
    swapThePaymentDetailsFrag();
    setVisibility(8);
