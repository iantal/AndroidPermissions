...
public class DomesticPaymentVerifyJob
  extends SessionBoundJob
{
  ...
  public DomesticPaymentVerifyJob(String paramString1, String paramString2, PaymentData paramPaymentData, Activity paramActivity, TouchIdAuthorizationData paramTouchIdAuthorizationData)
  {
    ...
    throws Throwable
  {
    ...
    for (Object localObject = new DemoRequests().paymentVerifyDemoRequest(this.mPaymentData);; localObject = new SOAPRequests().domesticPaymentVerifyRequest(this.mPaymentData, this.mWorkflowId, (String)localObject, this.mTouchIdAuthorizationData))
    {
      assertNotCancelled();
      EventBus.getDefault().post(new PaymentVerifyResponseEvent((PaymentVerifyResponse)localObject));
      return;
