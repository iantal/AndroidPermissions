  ...
  extends DSQFragment
{
  ...
  {
    paramViewGroup = paramLayoutInflater.inflate(2130903310, paramViewGroup, false);
    this.profile = ((CircleImageView)paramViewGroup.findViewById(2131559236));
    ...
    label140:
    for (paramLayoutInflater = ImageUtils.decodeBitmapFromResources(getActivity(), 2130837891, (int)getResources().getDimension(2131230765), (int)getResources().getDimension(2131230765));; paramLayoutInflater = ImageUtils.decodeBitmapFromFile(this.data.getProfileImage(), (int)getResources().getDimension(2131230765), (int)getResources().getDimension(2131230765)))
    {
      this.profile.setImageBitmap(paramLayoutInflater);
