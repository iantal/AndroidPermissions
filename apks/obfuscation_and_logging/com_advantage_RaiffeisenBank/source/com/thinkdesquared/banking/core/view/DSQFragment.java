  ...
  implements AIBASConstants
{
  ...
  {
    int i = Math.max(10, ((ViewGroup.MarginLayoutParams)paramSpinner.getLayoutParams()).rightMargin * 2);
  ...
  public void onActivityCreated(Bundle paramBundle)
  {
    ...
    if ((paramBundle instanceof RootActivity)) {
      this.mIsTablet = ((RootActivity)paramBundle).mIsTablet;
    }
  }
