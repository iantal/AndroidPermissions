  ...
  implements LoaderManager.LoaderCallbacks<InvestmentsInterestRatesResponse>
{
  ...
  private void setContent(InvestmentsInterestRatesResponse paramInvestmentsInterestRatesResponse, int paramInt)
  {
    ...
    {
      int i = 0;
      while (i < paramInvestmentsInterestRatesResponse.getRates().size())
      {
  ...
  {
    Object localObject = (LayoutInflater)getActivity().getSystemService("layout_inflater");
    ...
    for (;;)
    {
      localObject = ((LayoutInflater)localObject).inflate(2130903167, null);
      ((TextView)((View)localObject).findViewById(2131558842)).setText(paramString);
      ...
      localTableLayout.addView((View)localObject);
      return;
      if (paramInt == 2) {
        localTableLayout = (TableLayout)this.mView.findViewById(2131559211);
      } else {
