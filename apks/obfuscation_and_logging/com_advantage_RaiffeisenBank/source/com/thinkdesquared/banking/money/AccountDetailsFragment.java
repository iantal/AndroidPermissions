  ...
  implements LoaderManager.LoaderCallbacks<AccountDetailsResponse>
{
  ...
  private void addSectionToView(ArrayList<String> paramArrayList1, ArrayList<String> paramArrayList2, ViewGroup paramViewGroup, View paramView, LayoutInflater paramLayoutInflater)
  {
    if (paramArrayList1.size() > 0)
    {
      ...
      {
        paramView = paramLayoutInflater.inflate(2130903144, localLinearLayout, false);
        TextView localTextView1 = (TextView)paramView.findViewById(2131558767);
        TextView localTextView2 = (TextView)paramView.findViewById(2131558768);
  ...
  private String formatAmount(String paramString)
  {
    ...
    str = DSQHelper.formatAmountString(str, getActivity());
    paramString = str;
    if (i != 0) {
      paramString = "-" + str;
    }
  ...
  public void setContent()
  {
    ...
    this.mLayout.removeAllViews();
    Object localObject2 = localLayoutInflater.inflate(2130903171, this.mLayout, false);
    Object localObject1 = (TextView)((View)localObject2).findViewById(2131558821);
    localObject2 = (ImageView)((View)localObject2).findViewById(2131558770);
    int i;
    if (this.mSelectedAccount.getTypeRes() == 2131166218)
    {
      i = 2130837602;
      ((TextView)localObject1).setText(localAccountDetailsModel.getIBANNumber());
    }
    for (;;)
    {
      ((ImageView)localObject2).setImageBitmap(new DSQBitmap(getActivity()).bankImage(i));
      ...
      createArrayListsForSection0(localAccountDetailsModel, (ArrayList)localObject1, (ArrayList)localObject2);
      createArrayListsForSection1(localAccountDetailsModel, (ArrayList)localObject3, localArrayList1);
      createArrayListsForSection2(localAccountDetailsModel, localArrayList2, localArrayList3);
      addSectionToView(localArrayList2, localArrayList3, this.mLayout, null, localLayoutInflater);
      addSectionToView((ArrayList)localObject3, localArrayList1, this.mLayout, null, localLayoutInflater);
      return;
      ...
      {
        i = 2130837606;
        ((TextView)localObject1).setText(getString(2131165703) + " " + localAccountDetailsModel.getNextExpirationDate());
      }
      else if (this.mSelectedAccount.getTypeRes() == 2131166219)
      {
        i = 2130837604;
        ((TextView)localObject1).setText(getString(2131165561) + " " + localAccountDetailsModel.getLoanMaturityDate());
      }
      else
      {
        i = 2130837603;
        localObject3 = DSQDateModel.convertDateStringToPresentable(getActivity(), localAccountDetailsModel.getExpirationDate());
        ((TextView)localObject1).setText(getString(2131165561) + " " + (String)localObject3);
      }
    }
  }
