  ...
  extends RootInputActivity
{
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    paramBundle = (Mandate)getIntent().getParcelableExtra("extra_mandate");
    ...
    if (bool) {}
    for (paramBundle = DeleteMandateVerifyFragmentBuilder.newDeleteMandateVerifyFragment(paramBundle, str);; paramBundle = RejectMandateVerifyFragmentBuilder.newRejectMandateVerifyFragment(paramBundle, str))
    {
      localFragmentTransaction.replace(2131558617, paramBundle);
