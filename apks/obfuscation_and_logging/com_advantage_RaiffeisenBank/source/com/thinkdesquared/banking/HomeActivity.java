  ...
  extends StartOtherActivity
{
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    paramBundle = getIntent().getStringExtra("INTENT_CODE_TO_LAUNCH");
    if (bool == true)
    {
    ...
    {
      paramBundle = new Intent(getApplicationContext(), LoginActivity.class);
      paramBundle.putExtras(getIntent());
      paramBundle.setFlags(67108864);
      startActivityForResult(paramBundle, 10000);
      finish();
      return;
    }
    ...
    if (paramBundle != null)
    {
      if (localArrayList.indexOf(paramBundle) > -1)
      {
        startActivityWithCode(paramBundle, getIntent());
        return;
      }
      AibasStore localAibasStore = AibasStore.getInstance();
      if (AibasStore.getInstance().getCustomerType() != AibasStore.CustomerType.CustomerTypeRetail)
      {
        paramBundle = getString(2131165830);
        localAibasStore.setTransactionNotAllowedMessage(paramBundle);
      }
    }
    for (paramBundle = getFirstAvailableTransaction(localArrayList);; paramBundle = getFirstAvailableTransaction(localArrayList))
    {
      LogHelper.i("activity", "activity" + paramBundle);
      ...
      return;
      paramBundle = getString(2131165829);
      break;
    }
  }
