...
public abstract class zzc
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    if ((paramObject instanceof zzc))
    {
      ...
      bool1 = bool2;
      if (zzab.equal(Integer.valueOf(paramObject.zK), Integer.valueOf(this.zK)))
      {
        bool1 = bool2;
        if (zzab.equal(Integer.valueOf(paramObject.zL), Integer.valueOf(this.zL)))
        {
          bool1 = bool2;
          if (paramObject.xi == this.xi) {
            bool1 = true;
          }
        }
      }
