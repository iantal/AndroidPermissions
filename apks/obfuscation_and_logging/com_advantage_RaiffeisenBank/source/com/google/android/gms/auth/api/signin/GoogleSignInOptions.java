  ...
  public boolean equals(Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((this.hg.size() != paramObject.zzahj().size()) || (!this.hg.containsAll(paramObject.zzahj()))) {
          continue;
        }
        if (this.ec == null)
        {
          ...
          if (!TextUtils.isEmpty(paramObject.zzahn())) {
            continue;
          }
        }
        while ((this.hj == paramObject.zzahm()) && (this.hh == paramObject.zzahk()) && (this.hi == paramObject.zzahl()))
        {
          return true;
          if (!this.ec.equals(paramObject.getAccount())) {
            break;
          }
          break label56;
          label128:
          boolean bool = this.hk.equals(paramObject.zzahn());
          if (!bool) {
            break;
          }
        }
