  ...
  extends OneDReader
{
  ...
  static
  {
    ...
    int[] arrayOfInt7 = { 3, 1, 1, 3, 1 };
    int[] arrayOfInt8 = { 1, 3, 1, 3, 1 };
    PATTERNS = new int[][] { arrayOfInt1, arrayOfInt2, arrayOfInt3, { 3, 3, 1, 1, 1 }, { 1, 1, 3, 1, 3 }, arrayOfInt4, arrayOfInt5, arrayOfInt6, arrayOfInt7, arrayOfInt8 };
  }
