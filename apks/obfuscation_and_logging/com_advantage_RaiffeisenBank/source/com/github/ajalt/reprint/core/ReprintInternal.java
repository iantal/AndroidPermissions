 ...
 enum ReprintInternal
{
  ...
  public ReprintInternal initialize(Context paramContext, Reprint.Logger paramLogger)
  {
    ...
    {
      return this;
      Reprint.Logger localLogger = paramLogger;
      if (paramLogger == null) {
        localLogger = NULL_LOGGER;
      }
      try
      {
        registerModule((ReprintModule)Class.forName("com.github.ajalt.reprint.module.spass.SpassReprintModule").getConstructor(new Class[] { Context.class, Reprint.Logger.class }).newInstance(new Object[] { paramContext, localLogger }));
        if (Build.VERSION.SDK_INT < 23) {
          continue;
        }
        registerModule(new MarshmallowReprintModule(paramContext, localLogger));
        return this;
      }
      catch (Exception paramLogger)
      {
        for (;;) {}
      }
    }
