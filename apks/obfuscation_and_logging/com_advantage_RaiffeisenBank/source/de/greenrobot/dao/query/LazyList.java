  ...
  implements List<E>, Closeable
{
  ...
  public E get(int paramInt)
  {
    if (this.entities != null)
    {
      Object localObject5 = this.entities.get(paramInt);
      ...
      try
      {
        localObject5 = this.entities.get(paramInt);
        localObject1 = localObject5;
        if (localObject5 == null)
        {
          localObject5 = loadEntity(paramInt);
          this.entities.set(paramInt, localObject5);
          this.loadedCount += 1;
          localObject1 = localObject5;
    ...
    try
    {
      Object localObject3 = loadEntity(paramInt);
      return localObject3;
    }
    finally
    {
