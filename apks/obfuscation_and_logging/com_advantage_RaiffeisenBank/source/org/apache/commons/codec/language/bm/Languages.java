...
public class Languages
{
    ...
    extends Languages.LanguageSet
  {
    ...
    public Languages.LanguageSet merge(Languages.LanguageSet paramLanguageSet)
    {
      ...
      Object localObject = (SomeLanguages)paramLanguageSet;
      paramLanguageSet = new HashSet(this.languages);
      localObject = ((SomeLanguages)localObject).languages.iterator();
      while (((Iterator)localObject).hasNext()) {
        paramLanguageSet.add((String)((Iterator)localObject).next());
      }
      return from(paramLanguageSet);
    }
