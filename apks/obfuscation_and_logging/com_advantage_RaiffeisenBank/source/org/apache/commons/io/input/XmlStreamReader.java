  ...
  extends Reader
{
  ...
  static String getContentTypeEncoding(String paramString)
  {
    ...
    label65:
    for (paramString = paramString.group(1); paramString != null; paramString = null)
    {
    ...
    throws IOException
  {
    ...
    if (paramString != null)
    {
      ...
      int m = 0;
      int k = 4096;
      int i = paramInputStream.read((byte[])localObject2, 0, 4096);
      int j = -1;
      Object localObject1 = null;
      while ((i != -1) && (j == -1) && (m < 4096))
      {
        m += i;
        k -= i;
        i = paramInputStream.read((byte[])localObject2, m, k);
      ...
      if (m > 0)
      {
        ...
        paramString = new BufferedReader(new StringReader(((String)localObject1).substring(0, j + 1)));
