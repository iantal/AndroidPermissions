...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/a/c;->b:Landroid/support/v4/h/g;
...
.method public static a(Landroid/content/Context;Landroid/content/res/Resources;ILjava/lang/String;I)Landroid/graphics/Typeface;
    ...
    .line 156
    sget-object p2, Landroid/support/v4/a/c;->b:Landroid/support/v4/h/g;

    invoke-virtual {p2, p1, p0}, Landroid/support/v4/h/g;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static a(Landroid/content/Context;Landroid/os/CancellationSignal;[Landroid/support/v4/f/b$b;I)Landroid/graphics/Typeface;
    ...
    invoke-interface {v0, p0, p1, p2, p3}, Landroid/support/v4/a/c$a;->a(Landroid/content/Context;Landroid/os/CancellationSignal;[Landroid/support/v4/f/b$b;I)Landroid/graphics/Typeface;
...
.method public static a(Landroid/content/Context;Landroid/support/v4/content/a/a$a;Landroid/content/res/Resources;IILandroid/support/v4/content/a/b$a;Landroid/os/Handler;Z)Landroid/graphics/Typeface;
    ...
    .line 116
    instance-of v4, p1, Landroid/support/v4/content/a/a$d;
    ...
    check-cast v0, Landroid/support/v4/content/a/a$d;
    ...
    .line 119
    invoke-virtual {v0}, Landroid/support/v4/content/a/a$d;->b()I
    ...
    .line 122
    invoke-virtual {v0}, Landroid/support/v4/content/a/a$d;->c()I
    ...
    .line 124
    :goto_3
    invoke-virtual {v0}, Landroid/support/v4/content/a/a$d;->a()Landroid/support/v4/f/a;
    ...
    invoke-static/range {v0 .. v6}, Landroid/support/v4/f/b;->a(Landroid/content/Context;Landroid/support/v4/f/a;Landroid/support/v4/content/a/b$a;Landroid/os/Handler;ZII)Landroid/graphics/Typeface;
    ...
    check-cast v0, Landroid/support/v4/content/a/a$b;

    invoke-interface {v1, p0, v0, p2, p4}, Landroid/support/v4/a/c$a;->a(Landroid/content/Context;Landroid/support/v4/content/a/a$b;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
    ...
    .line 140
    sget-object v1, Landroid/support/v4/a/c;->b:Landroid/support/v4/h/g;
...
.method public static a(Landroid/content/res/Resources;II)Landroid/graphics/Typeface;
    ...
    .line 89
    sget-object v0, Landroid/support/v4/a/c;->b:Landroid/support/v4/h/g;

    invoke-static {p0, p1, p2}, Landroid/support/v4/a/c;->b(Landroid/content/res/Resources;II)Ljava/lang/String;

    move-result-object p0

    invoke-virtual {v0, p0}, Landroid/support/v4/h/g;->get(Ljava/lang/Object;)Ljava/lang/Object;
