...
.method private constructor <init>(Landroid/content/Context;Landroid/view/ViewGroup;Landroid/support/v4/widget/s$a;)V
    ...
    iput p3, p0, Landroid/support/v4/widget/s;->b:I
...
.method private a(III)I
    ...
    .line 642
    invoke-direct {p0, v2}, Landroid/support/v4/widget/s;->b(F)F
...
.method private a(Landroid/view/View;IIII)I
    ...
    invoke-virtual {v2, p1}, Landroid/support/v4/widget/s$a;->getViewHorizontalDragRange(Landroid/view/View;)I

    move-result v2

    invoke-direct {p0, p2, p4, v2}, Landroid/support/v4/widget/s;->a(III)I

    move-result p2

    .line 628
    iget-object p4, p0, Landroid/support/v4/widget/s;->r:Landroid/support/v4/widget/s$a;

    invoke-virtual {p4, p1}, Landroid/support/v4/widget/s$a;->getViewVerticalDragRange(Landroid/view/View;)I

    move-result p1

    invoke-direct {p0, p3, p5, p1}, Landroid/support/v4/widget/s;->a(III)I
...
.method private a(FF)V
    ...
    invoke-virtual {v1, v2, p1, p2}, Landroid/support/v4/widget/s$a;->onViewReleased(Landroid/view/View;FF)V
    ...
    .line 781
    invoke-virtual {p0, p1}, Landroid/support/v4/widget/s;->c(I)V
...
.method private a(FFI)V
    ...
    invoke-direct {p0, p1, p2}, Landroid/support/v4/widget/s;->e(II)I
...
.method private a(FFII)Z
    ...
    invoke-virtual {p2, p4}, Landroid/support/v4/widget/s$a;->onEdgeLock(I)Z
    ...
    .line 1282
    iget-object p1, p0, Landroid/support/v4/widget/s;->j:[I
...
.method private a(IIII)Z
    ...
    invoke-direct/range {v4 .. v9}, Landroid/support/v4/widget/s;->a(Landroid/view/View;IIII)I
...
.method private a(Landroid/view/View;FF)Z
    ...
    invoke-virtual {v1, p1}, Landroid/support/v4/widget/s$a;->getViewHorizontalDragRange(Landroid/view/View;)I
    ...
    invoke-virtual {v3, p1}, Landroid/support/v4/widget/s$a;->getViewVerticalDragRange(Landroid/view/View;)I
    ...
    iget p3, p0, Landroid/support/v4/widget/s;->b:I
...
.method private b(FFI)V
    ...
    .line 1267
    iget-object p1, p0, Landroid/support/v4/widget/s;->r:Landroid/support/v4/widget/s$a;

    invoke-virtual {p1, v0, p3}, Landroid/support/v4/widget/s$a;->onEdgeDragStarted(II)V
...
.method private b(IIII)V
    ...
    invoke-virtual {v2, v3, p1, p3}, Landroid/support/v4/widget/s$a;->clampViewPositionHorizontal(Landroid/view/View;II)I
    ...
    invoke-static {v2, v3}, Landroid/support/v4/view/t;->e(Landroid/view/View;I)V
    ...
    invoke-virtual {p1, v2, p2, p4}, Landroid/support/v4/widget/s$a;->clampViewPositionVertical(Landroid/view/View;II)I
    ...
    invoke-static {p1, v2}, Landroid/support/v4/view/t;->d(Landroid/view/View;I)V
    ...
    invoke-virtual/range {v4 .. v9}, Landroid/support/v4/widget/s$a;->onViewPositionChanged(Landroid/view/View;IIII)V
...
.method private e(II)I
    ...
    iget v1, p0, Landroid/support/v4/widget/s;->o:I
...
.method private f(I)V
    ...
    .line 826
    iget-object v6, p0, Landroid/support/v4/widget/s;->f:[F
    ...
    .line 827
    iget-object v6, p0, Landroid/support/v4/widget/s;->g:[F
    ...
    .line 828
    iget-object v6, p0, Landroid/support/v4/widget/s;->h:[I
    ...
    .line 829
    iget-object v6, p0, Landroid/support/v4/widget/s;->i:[I
    ...
    .line 830
    iget-object v6, p0, Landroid/support/v4/widget/s;->j:[I
    ...
    .line 839
    iput-object p1, p0, Landroid/support/v4/widget/s;->j:[I
...
.method public a(F)V
    ...
    .line 409
    iput p1, p0, Landroid/support/v4/widget/s;->n:F
...
.method public a(Landroid/view/View;I)V
    ...
    invoke-virtual {v0, p1, p2}, Landroid/support/v4/widget/s$a;->onViewCaptured(Landroid/view/View;I)V
...
.method public a(Landroid/view/MotionEvent;)Z
    ...
    .line 965
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/widget/s;->e()V
    ...
    .line 1072
    invoke-direct {v0, v1}, Landroid/support/v4/widget/s;->e(I)V
    ...
    .line 1002
    iget v3, v0, Landroid/support/v4/widget/s;->a:I

    if-nez v3, :cond_3

    .line 1003
    iget-object v1, v0, Landroid/support/v4/widget/s;->h:[I

    aget v1, v1, v2

    .line 1004
    iget v3, v0, Landroid/support/v4/widget/s;->p:I
    ...
    .line 1005
    iget-object v3, v0, Landroid/support/v4/widget/s;->r:Landroid/support/v4/widget/s$a;

    iget v4, v0, Landroid/support/v4/widget/s;->p:I

    and-int/2addr v1, v4

    invoke-virtual {v3, v1, v2}, Landroid/support/v4/widget/s$a;->onEdgeTouched(II)V
    ...
    .line 1009
    invoke-virtual {v0, v3, v1}, Landroid/support/v4/widget/s;->d(II)Landroid/view/View;
    ...
    .line 1011
    invoke-virtual {v0, v1, v2}, Landroid/support/v4/widget/s;->b(Landroid/view/View;I)Z
    ...
    .line 1026
    invoke-direct {v0, v4}, Landroid/support/v4/widget/s;->g(I)Z
    ...
    .line 1033
    invoke-virtual {v0, v7, v8}, Landroid/support/v4/widget/s;->d(II)Landroid/view/View;
    ...
    .line 1043
    iget-object v14, v0, Landroid/support/v4/widget/s;->r:Landroid/support/v4/widget/s$a;

    invoke-virtual {v14, v7, v13, v12}, Landroid/support/v4/widget/s$a;->clampViewPositionHorizontal(Landroid/view/View;II)I
    ...
    invoke-virtual {v5, v7, v15, v14}, Landroid/support/v4/widget/s$a;->clampViewPositionVertical(Landroid/view/View;II)I
    ...
    invoke-virtual {v14, v7}, Landroid/support/v4/widget/s$a;->getViewHorizontalDragRange(Landroid/view/View;)I
    ...
    invoke-virtual {v15, v7}, Landroid/support/v4/widget/s$a;->getViewVerticalDragRange(Landroid/view/View;)I
    ...
    .line 1057
    iget v5, v0, Landroid/support/v4/widget/s;->a:I
    ...
    .line 1062
    invoke-virtual {v0, v7, v4}, Landroid/support/v4/widget/s;->b(Landroid/view/View;I)Z
    ...
    .line 980
    invoke-virtual {v0, v2, v3}, Landroid/support/v4/widget/s;->d(II)Landroid/view/View;
    ...
    .line 984
    invoke-virtual {v0, v2, v1}, Landroid/support/v4/widget/s;->b(Landroid/view/View;I)Z
    ...
    invoke-virtual {v3, v2, v1}, Landroid/support/v4/widget/s$a;->onEdgeTouched(II)V
...
.method public a(Z)Z
    ...
    invoke-static {v4, v8}, Landroid/support/v4/view/t;->e(Landroid/view/View;I)V
    ...
    invoke-static {v4, v9}, Landroid/support/v4/view/t;->d(Landroid/view/View;I)V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/s;->w:Ljava/lang/Runnable;
...
.method public b(Landroid/view/MotionEvent;)V
    ...
    .line 1133
    invoke-direct {p0, v2, p1, v0}, Landroid/support/v4/widget/s;->a(FFI)V
    ...
    .line 1139
    invoke-virtual {p0, v1, p1}, Landroid/support/v4/widget/s;->d(II)Landroid/view/View;

    move-result-object p1

    .line 1140
    invoke-virtual {p0, p1, v0}, Landroid/support/v4/widget/s;->b(Landroid/view/View;I)Z

    .line 1142
    iget-object p1, p0, Landroid/support/v4/widget/s;->h:[I
    ...
    invoke-virtual {v1, p1, v0}, Landroid/support/v4/widget/s$a;->onEdgeTouched(II)V
    ...
    .line 1146
    invoke-virtual {p0, v1, p1}, Landroid/support/v4/widget/s;->c(II)Z
    ...
    .line 1177
    invoke-direct {p0, v1}, Landroid/support/v4/widget/s;->g(I)Z
    ...
    .line 1185
    iget v8, p0, Landroid/support/v4/widget/s;->a:I
    ...
    .line 1190
    invoke-virtual {p0, v4, v5}, Landroid/support/v4/widget/s;->d(II)Landroid/view/View;
    ...
    .line 1192
    invoke-virtual {p0, v4, v1}, Landroid/support/v4/widget/s;->b(Landroid/view/View;I)Z
    ...
    .line 1112
    invoke-virtual {p0, v2, v3}, Landroid/support/v4/widget/s;->d(II)Landroid/view/View;
    ...
    .line 1119
    invoke-virtual {p0, v2, p1}, Landroid/support/v4/widget/s;->b(Landroid/view/View;I)Z
    ...
    invoke-virtual {v1, v0, p1}, Landroid/support/v4/widget/s$a;->onEdgeTouched(II)V
...
.method public b(II)Z
    ...
    .line 1362
    :goto_1
    iget-object v3, p0, Landroid/support/v4/widget/s;->f:[F

    aget v3, v3, p2

    iget-object v4, p0, Landroid/support/v4/widget/s;->d:[F
    ...
    .line 1363
    iget-object v4, p0, Landroid/support/v4/widget/s;->g:[F

    aget v4, v4, p2

    iget-object v5, p0, Landroid/support/v4/widget/s;->e:[F
...
.method b(Landroid/view/View;I)Z
    ...
    invoke-virtual {v0, p1, p2}, Landroid/support/v4/widget/s$a;->tryCaptureView(Landroid/view/View;I)Z
...
.method c(I)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/widget/s$a;->onViewDragStateChanged(I)V
...
.method public d(II)Landroid/view/View;
    ...
    invoke-virtual {v2, v0}, Landroid/support/v4/widget/s$a;->getOrderedChildIndex(I)I
...
.method public d(I)Z
    ...
    .line 1332
    invoke-virtual {p0, p1, v2}, Landroid/support/v4/widget/s;->b(II)Z
...
.method public e()V
    ...
    .line 508
    invoke-direct {p0}, Landroid/support/v4/widget/s;->f()V
