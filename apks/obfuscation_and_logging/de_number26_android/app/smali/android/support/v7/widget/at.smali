...
.method private a(Landroid/support/v7/widget/RecyclerView$i;Landroid/support/v7/widget/ay;II)I
    .locals 2

    .line 166
    invoke-virtual {p0, p3, p4}, Landroid/support/v7/widget/at;->b(II)[I

    move-result-object p3

    .line 167
    invoke-direct {p0, p1, p2}, Landroid/support/v7/widget/at;->b(Landroid/support/v7/widget/RecyclerView$i;Landroid/support/v7/widget/ay;)F
...
.method private b(Landroid/support/v7/widget/RecyclerView$i;Landroid/support/v7/widget/ay;)F
    .locals 10
    ...
    .line 259
    :cond_5
    invoke-virtual {p2, v3}, Landroid/support/v7/widget/ay;->a(Landroid/view/View;)I
    ...
    .line 261
    invoke-virtual {p2, v3}, Landroid/support/v7/widget/ay;->b(Landroid/view/View;)I

    move-result v0

    .line 262
    invoke-virtual {p2, v5}, Landroid/support/v7/widget/ay;->b(Landroid/view/View;)I
...
.method private d(Landroid/support/v7/widget/RecyclerView$i;)Landroid/support/v7/widget/ay;
    ...
    .line 272
    iget-object v0, p0, Landroid/support/v7/widget/at;->b:Landroid/support/v7/widget/ay;
    ...
    iput-object p1, p0, Landroid/support/v7/widget/at;->b:Landroid/support/v7/widget/ay;

    .line 275
    :cond_1
    iget-object p1, p0, Landroid/support/v7/widget/at;->b:Landroid/support/v7/widget/ay;
...
.method private e(Landroid/support/v7/widget/RecyclerView$i;)Landroid/support/v7/widget/ay;
    ...
    .line 284
    :cond_1
    iget-object p1, p0, Landroid/support/v7/widget/at;->c:Landroid/support/v7/widget/ay;
...
.method public a(Landroid/support/v7/widget/RecyclerView$i;II)I
    ...
    .line 74
    :cond_1
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/at;->a(Landroid/support/v7/widget/RecyclerView$i;)Landroid/view/View;
    ...
    .line 98
    invoke-direct {p0, p1}, Landroid/support/v7/widget/at;->e(Landroid/support/v7/widget/RecyclerView$i;)Landroid/support/v7/widget/ay;

    move-result-object v5

    .line 97
    invoke-direct {p0, p1, v5, p2, v7}, Landroid/support/v7/widget/at;->a(Landroid/support/v7/widget/RecyclerView$i;Landroid/support/v7/widget/ay;II)I
    ...
    .line 107
    invoke-direct {p0, p1}, Landroid/support/v7/widget/at;->d(Landroid/support/v7/widget/RecyclerView$i;)Landroid/support/v7/widget/ay;

    move-result-object v5

    .line 106
    invoke-direct {p0, p1, v5, v7, p3}, Landroid/support/v7/widget/at;->a(Landroid/support/v7/widget/RecyclerView$i;Landroid/support/v7/widget/ay;II)I
...
.method public a(Landroid/support/v7/widget/RecyclerView$i;)Landroid/view/View;
    ...
    invoke-direct {p0, p1, v0}, Landroid/support/v7/widget/at;->a(Landroid/support/v7/widget/RecyclerView$i;Landroid/support/v7/widget/ay;)Landroid/view/View;
...
.method public a(Landroid/support/v7/widget/RecyclerView$i;Landroid/view/View;)[I
    ...
    .line 47
    invoke-direct {p0, p1, p2, v1}, Landroid/support/v7/widget/at;->a(Landroid/support/v7/widget/RecyclerView$i;Landroid/view/View;Landroid/support/v7/widget/ay;)I
