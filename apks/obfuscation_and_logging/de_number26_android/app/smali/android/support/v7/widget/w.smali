...
.method protected static a(Landroid/content/Context;Landroid/support/v7/widget/l;I)Landroid/support/v7/widget/bn;
    ...
    .line 334
    new-instance p1, Landroid/support/v7/widget/bn;

    invoke-direct {p1}, Landroid/support/v7/widget/bn;-><init>()V

    const/4 p2, 0x1

    .line 335
    iput-boolean p2, p1, Landroid/support/v7/widget/bn;->d:Z

    .line 336
    iput-object p0, p1, Landroid/support/v7/widget/bn;->a:Landroid/content/res/ColorStateList;
...
.method private a(Landroid/content/Context;Landroid/support/v7/widget/bp;)V
    ...
    invoke-virtual {p2, v0}, Landroid/support/v7/widget/bp;->g(I)Z
    ...
    .line 253
    iput-boolean v2, p0, Landroid/support/v7/widget/w;->i:Z

    .line 254
    sget p1, Landroid/support/v7/a/a$j;->TextAppearance_android_typeface:I

    invoke-virtual {p2, p1, v1}, Landroid/support/v7/widget/bp;->a(II)I
    ...
    .line 221
    new-instance v3, Landroid/support/v7/widget/w$1;

    invoke-direct {v3, p0, p1}, Landroid/support/v7/widget/w$1;-><init>(Landroid/support/v7/widget/w;Ljava/lang/ref/WeakReference;)V

    .line 234
    :try_start_0
    iget p1, p0, Landroid/support/v7/widget/w;->g:I

    invoke-virtual {p2, v0, p1, v3}, Landroid/support/v7/widget/bp;->a(IILandroid/support/v4/content/a/b$a;)Landroid/graphics/Typeface;
    ...
    .line 243
    invoke-virtual {p2, v0}, Landroid/support/v7/widget/bp;->d(I)Ljava/lang/String;
...
.method static synthetic a(Landroid/support/v7/widget/w;Ljava/lang/ref/WeakReference;Landroid/graphics/Typeface;)V
    .locals 0

    .line 43
    invoke-direct {p0, p1, p2}, Landroid/support/v7/widget/w;->a(Ljava/lang/ref/WeakReference;Landroid/graphics/Typeface;)V
...
.method private a(Ljava/lang/ref/WeakReference;Landroid/graphics/Typeface;)V
    ...
    .line 273
    iput-object p2, p0, Landroid/support/v7/widget/w;->h:Landroid/graphics/Typeface;
...
.method a()V
    ...
    .line 314
    iget-object v0, p0, Landroid/support/v7/widget/w;->b:Landroid/support/v7/widget/bn;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/w;->c:Landroid/support/v7/widget/bn;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/w;->d:Landroid/support/v7/widget/bn;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/w;->e:Landroid/support/v7/widget/bn;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/w;->b:Landroid/support/v7/widget/bn;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/w;->c:Landroid/support/v7/widget/bn;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/w;->d:Landroid/support/v7/widget/bn;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/w;->e:Landroid/support/v7/widget/bn;
...
.method a(IF)V
    ...
    .line 353
    sget-boolean v0, Landroid/support/v4/widget/c;->a:Z
...
.method a(Landroid/content/Context;I)V
    ...
    invoke-virtual {p2, v0, v1}, Landroid/support/v7/widget/bp;->a(IZ)Z
    ...
    .line 296
    invoke-virtual {p2, v0}, Landroid/support/v7/widget/bp;->e(I)Landroid/content/res/ColorStateList;
    ...
    .line 302
    :cond_1
    invoke-direct {p0, p1, p2}, Landroid/support/v7/widget/w;->a(Landroid/content/Context;Landroid/support/v7/widget/bp;)V
    ...
    iget-object p2, p0, Landroid/support/v7/widget/w;->h:Landroid/graphics/Typeface;
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    invoke-static {v0, p1, v2, p2, v3}, Landroid/support/v7/widget/bp;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/bp;
    ...
    invoke-virtual {v2, v4, v5}, Landroid/support/v7/widget/bp;->g(II)I
    ...
    invoke-virtual {v2, v6}, Landroid/support/v7/widget/bp;->g(I)Z
    ...
    .line 88
    invoke-virtual {v2, v6, v3}, Landroid/support/v7/widget/bp;->g(II)I

    move-result v6

    .line 87
    invoke-static {v0, v1, v6}, Landroid/support/v7/widget/w;->a(Landroid/content/Context;Landroid/support/v7/widget/l;I)Landroid/support/v7/widget/bn;

    move-result-object v6

    iput-object v6, p0, Landroid/support/v7/widget/w;->b:Landroid/support/v7/widget/bn;
    ...
    iput-object v6, p0, Landroid/support/v7/widget/w;->c:Landroid/support/v7/widget/bn;
    ...
    iput-object v6, p0, Landroid/support/v7/widget/w;->d:Landroid/support/v7/widget/bn;
    ...
    iput-object v1, p0, Landroid/support/v7/widget/w;->e:Landroid/support/v7/widget/bn;
    ...
    invoke-static {v0, v4, v5}, Landroid/support/v7/widget/bp;->a(Landroid/content/Context;I[I)Landroid/support/v7/widget/bp;
    ...
    invoke-virtual {v4, v5}, Landroid/support/v7/widget/bp;->g(I)Z
    ...
    invoke-virtual {v4, v5, v3}, Landroid/support/v7/widget/bp;->a(IZ)Z
    ...
    .line 123
    :goto_0
    invoke-direct {p0, v0, v4}, Landroid/support/v7/widget/w;->a(Landroid/content/Context;Landroid/support/v7/widget/bp;)V
    ...
    invoke-virtual {v4, v9}, Landroid/support/v7/widget/bp;->g(I)Z
    ...
    invoke-virtual {v4, v9}, Landroid/support/v7/widget/bp;->e(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v4, v10}, Landroid/support/v7/widget/bp;->g(I)Z
    ...
    invoke-virtual {v4, v10}, Landroid/support/v7/widget/bp;->e(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v4, v11}, Landroid/support/v7/widget/bp;->g(I)Z
    ...
    invoke-virtual {v4, v7}, Landroid/support/v7/widget/bp;->e(I)Landroid/content/res/ColorStateList;
    ...
    .line 139
    :goto_3
    invoke-virtual {v4}, Landroid/support/v7/widget/bp;->a()V
    ...
    invoke-static {v0, p1, v4, p2, v3}, Landroid/support/v7/widget/bp;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/bp;
    ...
    invoke-virtual {v4, v2}, Landroid/support/v7/widget/bp;->g(I)Z
    ...
    invoke-virtual {v4, v2}, Landroid/support/v7/widget/bp;->e(I)Landroid/content/res/ColorStateList;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/w;->h:Landroid/graphics/Typeface;
    ...
    .line 186
    sget-boolean p1, Landroid/support/v4/widget/c;->a:Z
    ...
    invoke-virtual {p1}, Landroid/support/v7/widget/z;->a()I
