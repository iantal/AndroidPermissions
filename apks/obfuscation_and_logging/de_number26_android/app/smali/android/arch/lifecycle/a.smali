...
.method private a(Ljava/lang/Class;[Ljava/lang/reflect/Method;)Landroid/arch/lifecycle/a$a;
    ...
    check-cast v6, Landroid/arch/lifecycle/e$a;

    invoke-direct {p0, v1, v7, v6, p1}, Landroid/arch/lifecycle/a;->a(Ljava/util/Map;Landroid/arch/lifecycle/a$b;Landroid/arch/lifecycle/e$a;Ljava/lang/Class;)V
    ...
    .line 124
    const-class v6, Landroid/arch/lifecycle/p;
    ...
    const-class v9, Landroid/arch/lifecycle/h;
    ...
    .line 138
    :goto_4
    invoke-interface {v6}, Landroid/arch/lifecycle/p;->a()Landroid/arch/lifecycle/e$a;
    ...
    const-class v10, Landroid/arch/lifecycle/e$a;
    ...
    .line 146
    :cond_7
    sget-object v8, Landroid/arch/lifecycle/e$a;->ON_ANY:Landroid/arch/lifecycle/e$a;
    ...
    .line 155
    invoke-direct {p0, v1, v4, v6, p1}, Landroid/arch/lifecycle/a;->a(Ljava/util/Map;Landroid/arch/lifecycle/a$b;Landroid/arch/lifecycle/e$a;Ljava/lang/Class;)V
...
.method private a(Ljava/util/Map;Landroid/arch/lifecycle/a$b;Landroid/arch/lifecycle/e$a;Ljava/lang/Class;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method a(Ljava/lang/Class;)Z
    ...
    .line 51
    const-class v5, Landroid/arch/lifecycle/p;

    invoke-virtual {v4, v5}, Ljava/lang/reflect/Method;->getAnnotation(Ljava/lang/Class;)Ljava/lang/annotation/Annotation;

    move-result-object v4

    check-cast v4, Landroid/arch/lifecycle/p;
