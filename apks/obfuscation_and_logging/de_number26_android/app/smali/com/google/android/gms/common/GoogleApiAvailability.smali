...
.method static zza(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
    ...
    invoke-virtual {p1, p0, p2}, Lcom/google/android/gms/common/SupportErrorDialogFragment;->show(Landroid/support/v4/app/m;Ljava/lang/String;)V
...
.method private final zza(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;)V
    ...
    invoke-static {}, Lcom/google/android/gms/common/util/zzr;->zzf()Z
    ...
    invoke-direct {v3, p1}, Landroid/support/v4/app/ab$c;-><init>(Landroid/content/Context;)V

    const v5, 0x108008a

    invoke-virtual {v3, v5}, Landroid/support/v4/app/ab$c;->a(I)Landroid/support/v4/app/ab$c;
    ...
    invoke-virtual {v3, v1}, Landroid/support/v4/app/ab$c;->c(Ljava/lang/CharSequence;)Landroid/support/v4/app/ab$c;
    ...
    invoke-virtual {v1, v5, v6}, Landroid/support/v4/app/ab$c;->a(J)Landroid/support/v4/app/ab$c;

    move-result-object v1

    invoke-virtual {v1, v4}, Landroid/support/v4/app/ab$c;->a(Z)Landroid/support/v4/app/ab$c;

    move-result-object v1

    invoke-virtual {v1, p4}, Landroid/support/v4/app/ab$c;->a(Landroid/app/PendingIntent;)Landroid/support/v4/app/ab$c;

    move-result-object p4

    invoke-virtual {p4, p3}, Landroid/support/v4/app/ab$c;->a(Ljava/lang/CharSequence;)Landroid/support/v4/app/ab$c;

    move-result-object p3

    invoke-virtual {p3, v0}, Landroid/support/v4/app/ab$c;->b(Ljava/lang/CharSequence;)Landroid/support/v4/app/ab$c;

    move-result-object p3

    invoke-virtual {p3, v4}, Landroid/support/v4/app/ab$c;->b(Z)Landroid/support/v4/app/ab$c;

    move-result-object p3

    new-instance p4, Landroid/support/v4/app/ab$b;

    invoke-direct {p4}, Landroid/support/v4/app/ab$b;-><init>()V

    invoke-virtual {p4, v0}, Landroid/support/v4/app/ab$b;->a(Ljava/lang/CharSequence;)Landroid/support/v4/app/ab$b;

    move-result-object p4

    invoke-virtual {p3, p4}, Landroid/support/v4/app/ab$c;->a(Landroid/support/v4/app/ab$e;)Landroid/support/v4/app/ab$c;
    ...
    invoke-virtual {p3, p1}, Landroid/support/v4/app/ab$c;->a(Ljava/lang/String;)Landroid/support/v4/app/ab$c;

    :cond_5
    invoke-virtual {p3}, Landroid/support/v4/app/ab$c;->a()Landroid/app/Notification;
