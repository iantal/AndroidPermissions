...
.method private static updateDigestIncludingSize(Lorg/bouncycastle/crypto/Digest;Ljava/lang/String;)V
    ...
    invoke-static {v2}, Lorg/bouncycastle/crypto/agreement/jpake/JPAKEUtil;->intToByteArray(I)[B

    move-result-object v2

    invoke-interface {p0, v2, v0, v1}, Lorg/bouncycastle/crypto/Digest;->update([BII)V
...
.method private static updateMac(Lorg/bouncycastle/crypto/Mac;Ljava/lang/String;)V
    ...
    invoke-interface {p0, p1, v0, v1}, Lorg/bouncycastle/crypto/Mac;->update([BII)V
