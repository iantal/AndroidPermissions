...
.method private generateDerivedKey()[B
    ...
    invoke-interface {v1, v2, v5, v3}, Lorg/bouncycastle/crypto/Digest;->update([BII)V
    ...
    .line 45
    :goto_0
    iget v1, p0, Lorg/bouncycastle/crypto/generators/PKCS5S1ParametersGenerator;->iterationCount:I
    ...
    invoke-interface {v1, v0, v5, v2}, Lorg/bouncycastle/crypto/Digest;->update([BII)V
