...
.method public constructor <init>(Lg/t;)V
    ...
    .line 545
    invoke-static {v0}, Lokhttp3/Cache;->access$1000(Lg/e;)I
    ...
    .line 579
    invoke-direct {p0, v0}, Lokhttp3/Cache$Entry;->readCertificateList(Lg/e;)Ljava/util/List;
    ...
    .line 589
    :goto_3
    invoke-interface {p1}, Lg/t;->close()V
...
.method private readCertificateList(Lg/e;)Ljava/util/List;
    .locals 6
    ...
    .line 661
    invoke-static {p1}, Lokhttp3/Cache;->access$1000(Lg/e;)I
    ...
    .line 668
    invoke-interface {p1}, Lg/e;->s()Ljava/lang/String;
    ...
    .line 671
    invoke-virtual {v5}, Lg/c;->g()Ljava/io/InputStream;
...
.method private writeCertList(Lg/d;Ljava/util/List;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p1, v0, v1}, Lg/d;->n(J)Lg/d;
    ...
    .line 683
    invoke-interface {v0, v1}, Lg/d;->i(I)Lg/d;
    ...
    .line 686
    invoke-static {v3}, Lg/f;->a([B)Lg/f;

    move-result-object v3

    invoke-virtual {v3}, Lg/f;->b()Ljava/lang/String;

    move-result-object v3

    .line 687
    invoke-interface {p1, v3}, Lg/d;->b(Ljava/lang/String;)Lg/d;

    move-result-object v3

    .line 688
    invoke-interface {v3, v1}, Lg/d;->i(I)Lg/d;
    :try_end_0
...
.method public writeTo(Lokhttp3/internal/cache/DiskLruCache$Editor;)V
    ...
    .line 607
    invoke-virtual {p1, v0}, Lokhttp3/internal/cache/DiskLruCache$Editor;->newSink(I)Lg/s;
    ...
    invoke-interface {p1, v3, v4}, Lg/d;->n(J)Lg/d;
    ...
    invoke-interface {p1, v4}, Lg/d;->b(Ljava/lang/String;)Lg/d;
    ...
    .line 619
    invoke-interface {v4, v2}, Lg/d;->i(I)Lg/d;
    ...
    .line 630
    invoke-interface {v3, v2}, Lg/d;->i(I)Lg/d;
    ...
    invoke-direct {p0, p1, v0}, Lokhttp3/Cache$Entry;->writeCertList(Lg/d;Ljava/util/List;)V
    ...
    .line 653
    :cond_2
    invoke-interface {p1}, Lg/d;->close()V
