...
.field public sink:Lg/d;

.field public socket:Ljava/net/Socket;

.field public source:Lg/e;
...
.method private buildTunneledConnection(IIILokhttp3/internal/connection/ConnectionSpecSelector;)V
    ...
    .line 163
    iput-object v3, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lg/d;

    .line 164
    iput-object v3, p0, Lokhttp3/internal/connection/RealConnection;->source:Lg/e;
...
.method private connectSocket(II)V
    ...
    iput-object p1, p0, Lokhttp3/internal/connection/RealConnection;->source:Lg/e;
    ...
    invoke-static {p1}, Lg/m;->a(Lg/s;)Lg/d;

    move-result-object p1

    iput-object p1, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lg/d;
...
.method private createTunnel(IILokhttp3/Request;Lokhttp3/HttpUrl;)Lokhttp3/Request;
    ...
    iget-object v1, p0, Lokhttp3/internal/connection/RealConnection;->source:Lg/e;

    iget-object v2, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lg/d;

    const/4 v3, 0x0

    invoke-direct {v0, v3, v3, v1, v2}, Lokhttp3/internal/http/Http1xStream;-><init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/StreamAllocation;Lg/e;Lg/d;)V

    .line 292
    iget-object v1, p0, Lokhttp3/internal/connection/RealConnection;->source:Lg/e;

    invoke-interface {v1}, Lg/e;->timeout()Lg/u;
    ...
    invoke-virtual {v1, v4, v5, v2}, Lg/u;->timeout(JLjava/util/concurrent/TimeUnit;)Lg/u;

    .line 293
    iget-object v1, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lg/d;

    invoke-interface {v1}, Lg/d;->timeout()Lg/u;
    ...
    .line 303
    :cond_0
    invoke-virtual {v0, v1, v2}, Lokhttp3/internal/http/Http1xStream;->newFixedLengthSource(J)Lg/t;
    ...
    invoke-static {v0, v1, v2}, Lokhttp3/internal/Util;->skipAll(Lg/t;ILjava/util/concurrent/TimeUnit;)Z
    ...
    .line 313
    :cond_4
    iget-object p1, p0, Lokhttp3/internal/connection/RealConnection;->source:Lg/e;

    invoke-interface {p1}, Lg/e;->b()Lg/c;

    move-result-object p1

    invoke-virtual {p1}, Lg/c;->f()Z

    move-result p1

    if-eqz p1, :cond_6

    iget-object p1, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lg/d;

    invoke-interface {p1}, Lg/d;->b()Lg/c;
...
.method private establishProtocol(IILokhttp3/internal/connection/ConnectionSpecSelector;)V
    ...
    iget-object v0, p0, Lokhttp3/internal/connection/RealConnection;->source:Lg/e;

    iget-object v1, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lg/d;

    invoke-virtual {p1, p2, p3, v0, v1}, Lokhttp3/internal/framed/FramedConnection$Builder;->socket(Ljava/net/Socket;Ljava/lang/String;Lg/e;Lg/d;)Lokhttp3/internal/framed/FramedConnection$Builder;
...
.method public connect(IIILjava/util/List;Z)V
    ...
    .line 121
    iput-object p4, p0, Lokhttp3/internal/connection/RealConnection;->source:Lg/e;

    .line 122
    iput-object p4, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lg/d;
