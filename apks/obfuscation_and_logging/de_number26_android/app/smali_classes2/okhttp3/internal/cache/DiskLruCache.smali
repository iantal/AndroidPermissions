...
.field private static final NULL_SINK:Lg/s;
...
.field private journalWriter:Lg/d;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lokhttp3/internal/cache/DiskLruCache;->NULL_SINK:Lg/s;
...
.method static synthetic access$802(Lokhttp3/internal/cache/DiskLruCache;Lg/d;)Lg/d;
    .locals 0

    .line 88
    iput-object p1, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Lg/d;

    return-object p1
.end method

.method static synthetic access$900()Lg/s;
    .locals 1

    .line 88
    sget-object v0, Lokhttp3/internal/cache/DiskLruCache;->NULL_SINK:Lg/s;
...
.method private declared-synchronized completeEdit(Lokhttp3/internal/cache/DiskLruCache$Editor;Z)V
    ...
    .line 569
    iget-object p1, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Lg/d;
    ...
    invoke-interface {p1, v3}, Lg/d;->i(I)Lg/d;
    ...
    invoke-virtual {v0, p1}, Lokhttp3/internal/cache/DiskLruCache$Entry;->writeLengths(Lg/d;)V

    .line 572
    iget-object p1, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Lg/d;

    invoke-interface {p1, v2}, Lg/d;->i(I)Lg/d;
...
.method private declared-synchronized edit(Ljava/lang/String;J)Lokhttp3/internal/cache/DiskLruCache$Editor;
    ...
    .line 481
    :cond_3
    iget-object p2, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Lg/d;

    const-string p3, "DIRTY"

    invoke-interface {p2, p3}, Lg/d;->b(Ljava/lang/String;)Lg/d;

    move-result-object p2

    const/16 p3, 0x20

    invoke-interface {p2, p3}, Lg/d;->i(I)Lg/d;

    move-result-object p2

    invoke-interface {p2, p1}, Lg/d;->b(Ljava/lang/String;)Lg/d;
    ...
    invoke-interface {p2}, Lg/d;->flush()V
...
.method private newJournalWriter()Lg/d;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    invoke-interface {v0, v1}, Lokhttp3/internal/io/FileSystem;->appendingSink(Ljava/io/File;)Lg/s;
    ...
    invoke-direct {v1, p0, v0}, Lokhttp3/internal/cache/DiskLruCache$2;-><init>(Lokhttp3/internal/cache/DiskLruCache;Lg/s;)V

    .line 317
    invoke-static {v1}, Lg/m;->a(Lg/s;)Lg/d;
...
.method private readJournal()V
    ...
    invoke-interface {v0, v1}, Lokhttp3/internal/io/FileSystem;->source(Ljava/io/File;)Lg/t;
    ...
    .line 302
    :cond_1
    invoke-direct {p0}, Lokhttp3/internal/cache/DiskLruCache;->newJournalWriter()Lg/d;

    move-result-object v1

    iput-object v1, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Lg/d;
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
...
.method private declared-synchronized rebuildJournal()V
    ...
    .line 387
    :try_start_0
    iget-object v0, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Lg/d;
    ...
    invoke-interface {v0, v1}, Lokhttp3/internal/io/FileSystem;->sink(Ljava/io/File;)Lg/s;
    ...
    invoke-interface {v1, v2}, Lg/d;->i(I)Lg/d;
    ...
    invoke-interface {v0, v3, v4}, Lg/d;->n(J)Lg/d;
    ...
    .line 397
    invoke-interface {v0, v2}, Lg/d;->i(I)Lg/d;
    ...
    .line 401
    invoke-interface {v0, v4}, Lg/d;->b(Ljava/lang/String;)Lg/d;

    move-result-object v4

    invoke-interface {v4, v5}, Lg/d;->i(I)Lg/d;
    ...
    invoke-interface {v0, v3}, Lg/d;->b(Ljava/lang/String;)Lg/d;
    ...
    .line 407
    invoke-virtual {v3, v0}, Lokhttp3/internal/cache/DiskLruCache$Entry;->writeLengths(Lg/d;)V
    ...
    iput-object v0, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Lg/d;
...
.method private removeEntry(Lokhttp3/internal/cache/DiskLruCache$Entry;)Z
    ...
    invoke-interface {v0, v2}, Lg/d;->b(Ljava/lang/String;)Lg/d;
...
.method public declared-synchronized get(Ljava/lang/String;)Lokhttp3/internal/cache/DiskLruCache$Snapshot;
    ...
    .line 442
    iget-object v1, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Lg/d;
    ...
    invoke-interface {p1, v1}, Lg/d;->i(I)Lg/d;
