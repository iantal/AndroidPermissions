...
.method snapshot()Lokhttp3/internal/cache/DiskLruCache$Snapshot;
    ...
    invoke-interface {v2, v3}, Lokhttp3/internal/io/FileSystem;->source(Ljava/io/File;)Lg/t;
    ...
    invoke-direct/range {v1 .. v8}, Lokhttp3/internal/cache/DiskLruCache$Snapshot;-><init>(Lokhttp3/internal/cache/DiskLruCache;Ljava/lang/String;J[Lg/t;[JLokhttp3/internal/cache/DiskLruCache$1;)V
    :try_end_0
...
.method writeLengths(Lg/d;)V
    ...
    .line 1022
    invoke-interface {p1, v5}, Lg/d;->i(I)Lg/d;

    move-result-object v5

    invoke-interface {v5, v3, v4}, Lg/d;->n(J)Lg/d;
