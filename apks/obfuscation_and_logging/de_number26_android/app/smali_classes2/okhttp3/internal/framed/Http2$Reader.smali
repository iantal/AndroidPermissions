...
# direct methods
.method constructor <init>(Lg/e;IZ)V
    .locals 0
    ...
    .line 94
    iput-object p1, p0, Lokhttp3/internal/framed/Http2$Reader;->source:Lg/e;
    ...
    iget-object p3, p0, Lokhttp3/internal/framed/Http2$Reader;->source:Lg/e;

    invoke-direct {p1, p3}, Lokhttp3/internal/framed/Http2$ContinuationSource;-><init>(Lg/e;)V
    ...
    invoke-direct {p1, p2, p3}, Lokhttp3/internal/framed/Hpack$Reader;-><init>(ILg/t;)V
...
.method private readData(Lokhttp3/internal/framed/FrameReader$Handler;IBI)V
    ...
    .line 223
    iget-object v1, p0, Lokhttp3/internal/framed/Http2$Reader;->source:Lg/e;

    invoke-interface {v1}, Lg/e;->i()B
    ...
    invoke-interface {p1, v0, p4, p3, p2}, Lokhttp3/internal/framed/FrameReader$Handler;->data(ZILg/e;I)V

    .line 227
    iget-object p1, p0, Lokhttp3/internal/framed/Http2$Reader;->source:Lg/e;

    int-to-long p2, v2

    invoke-interface {p1, p2, p3}, Lg/e;->i(J)V
...
.method private readGoAway(Lokhttp3/internal/framed/FrameReader$Handler;IBI)V
    ...
    .line 331
    :cond_1
    iget-object p4, p0, Lokhttp3/internal/framed/Http2$Reader;->source:Lg/e;

    invoke-interface {p4}, Lg/e;->k()I

    move-result p4

    .line 332
    iget-object v2, p0, Lokhttp3/internal/framed/Http2$Reader;->source:Lg/e;

    invoke-interface {v2}, Lg/e;->k()I
    ...
    invoke-interface {p3, v1, v2}, Lg/e;->d(J)Lg/f;

    move-result-object p3

    .line 342
    :cond_3
    invoke-interface {p1, p4, v0, p3}, Lokhttp3/internal/framed/FrameReader$Handler;->goAway(ILokhttp3/internal/framed/ErrorCode;Lg/f;)V
...
.method private readHeaders(Lokhttp3/internal/framed/FrameReader$Handler;IBI)V
    ...
    .line 187
    iget-object v0, p0, Lokhttp3/internal/framed/Http2$Reader;->source:Lg/e;
...
.method private readPing(Lokhttp3/internal/framed/FrameReader$Handler;IBI)V
    ...
    .line 321
    :cond_1
    iget-object p2, p0, Lokhttp3/internal/framed/Http2$Reader;->source:Lg/e;

    invoke-interface {p2}, Lg/e;->k()I
...
.method private readPriority(Lokhttp3/internal/framed/FrameReader$Handler;I)V
    ...
    .line 241
    iget-object v3, p0, Lokhttp3/internal/framed/Http2$Reader;->source:Lg/e;

    invoke-interface {v3}, Lg/e;->i()B
...
.method public nextFrame(Lokhttp3/internal/framed/FrameReader$Handler;)Z
    ...
    invoke-static {v1}, Lokhttp3/internal/framed/Http2;->access$300(Lg/e;)I
    ...
    .line 134
    iget-object v4, p0, Lokhttp3/internal/framed/Http2$Reader;->source:Lg/e;

    invoke-interface {v4}, Lg/e;->k()I
    ...
    invoke-interface {p1, v0, v1}, Lg/e;->i(J)V
...
.method public readConnectionPreface()V
    ...
    invoke-static {}, Lokhttp3/internal/framed/Http2;->access$000()Lg/f;

    move-result-object v1

    invoke-virtual {v1}, Lg/f;->e()I

    move-result v1

    int-to-long v1, v1

    invoke-interface {v0, v1, v2}, Lg/e;->d(J)Lg/f;
    ...
    invoke-virtual {v0}, Lg/f;->c()Ljava/lang/String;
