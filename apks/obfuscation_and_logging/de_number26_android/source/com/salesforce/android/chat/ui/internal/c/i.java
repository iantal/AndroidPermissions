...
import com.salesforce.android.chat.ui.internal.c.b.b;
...
class i
{
  ...
  com.salesforce.android.service.common.utilities.b.a<com.salesforce.android.chat.ui.internal.c.b.c> a(b paramB)
  {
    a.c("Creating thumbnail image for {}", new Object[] { paramB });
    paramB = new b.a().a(this.b).a(paramB).a();
    this.d.a(paramB).a(new a.d()
    {
      public void a(com.salesforce.android.service.common.utilities.b.a<?> paramAnonymousA, com.salesforce.android.chat.ui.internal.c.b.c paramAnonymousC)
      {
        i.a(i.this).a(paramAnonymousC);
      }
    }).a(new a.b()
    {
      public void a(com.salesforce.android.service.common.utilities.b.a<?> paramAnonymousA, Throwable paramAnonymousThrowable)
      {
        i.a().e("Error encountered while producing thumbnail image:\n{}", new Object[] { paramAnonymousThrowable });
      }
    });
  }
  ...
  com.salesforce.android.service.common.utilities.b.a<com.salesforce.android.chat.ui.internal.c.b.a> b(b paramB)
  {
    a.c("Creating final image for {}", new Object[] { paramB });
    paramB = new a.a().a(this.b).a(paramB).a();
    this.d.a(paramB).a(new a.d()
    {
      public void a(com.salesforce.android.service.common.utilities.b.a<?> paramAnonymousA, com.salesforce.android.chat.ui.internal.c.b.a paramAnonymousA1)
      {
        i.a(i.this, paramAnonymousA1);
      }
    }).a(new a.b()
    {
      public void a(com.salesforce.android.service.common.utilities.b.a<?> paramAnonymousA, Throwable paramAnonymousThrowable)
      {
        i.a().e("Error encountered while producing final image:\n{}", new Object[] { paramAnonymousThrowable });
      }
    });
  }
