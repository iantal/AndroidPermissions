...
public final class Detector
{
    ...
    throws NotFoundException
  {
    ...
    paramPoint = (Point)localObject4;
    while (this.nbCenterLayers < 9)
    {
      Point localPoint2 = getFirstDifferent((Point)localObject3, bool, 1, -1);
      Point localPoint1 = getFirstDifferent((Point)localObject1, bool, 1, 1);
      localObject4 = getFirstDifferent((Point)localObject2, bool, -1, 1);
      Point localPoint3 = getFirstDifferent(paramPoint, bool, -1, -1);
      if (this.nbCenterLayers > 2)
      {
        double d = distance(localPoint3, localPoint2) * this.nbCenterLayers / (distance(paramPoint, (Point)localObject3) * (this.nbCenterLayers + 2));
        if ((d < 0.75D) || (d > 1.25D) || (!isWhiteOrBlackRectangle(localPoint2, localPoint1, (Point)localObject4, localPoint3))) {
          break;
        }
      }
      bool ^= true;
    ...
    return expandSquare(new ResultPoint[] { localObject3, localObject1, localObject2, paramPoint }, f1, f2);
  }
