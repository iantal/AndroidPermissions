  ...
  extends ResultParser
{
  ...
  private static void formatNames(Iterable<List<String>> paramIterable)
  {
    if (paramIterable != null)
    {
      ...
      while (paramIterable.hasNext())
      {
        ...
        int i = 0;
        int k;
        for (int j = i; i < arrayOfString.length - 1; j = k + 1)
        {
  ...
  static List<List<String>> matchVCardPrefixedField(CharSequence paramCharSequence, String paramString, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    while (j < m)
    {
      ...
      if (!((Matcher)localObject2).find(k)) {
        return localObject1;
      }
      int n = ((Matcher)localObject2).end(i);
  ...
  public AddressBookParsedResult parse(Result paramResult)
  {
    ...
    if (paramResult.find())
    {
      ...
      List localList1 = matchVCardPrefixedField("TEL", str, true, false);
      List localList2 = matchVCardPrefixedField("EMAIL", str, true, false);
      List localList3 = matchSingleVCardPrefixedField("NOTE", str, false, false);
      List localList4 = matchVCardPrefixedField("ADR", str, true, true);
      List localList5 = matchSingleVCardPrefixedField("ORG", str, true, true);
      paramResult = matchSingleVCardPrefixedField("BDAY", str, true, false);
      ...
      List localList6 = matchSingleVCardPrefixedField("TITLE", str, true, false);
      List localList7 = matchVCardPrefixedField("URL", str, true, false);
      List localList8 = matchSingleVCardPrefixedField("IMPP", str, true, false);
