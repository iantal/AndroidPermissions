...
public final class Detector
{
    ...
    throws NotFoundException
  {
    ...
    if ((localObject3 != null) && (localObject4 != null) && (localObject2 != null))
    {
      ...
      int k = transitionsBetween(localObject3, (ResultPoint)localObject1).getTransitions();
      ...
      if ((4 * k < 7 * i) && (4 * i < 7 * k))
      {
        localObject2 = correctTopRight(localEntry, localIterator, localObject3, (ResultPoint)localObject1, Math.min(i, k));
        if (localObject2 != null) {
          localObject1 = localObject2;
        }
        j = Math.max(transitionsBetween(localObject3, (ResultPoint)localObject1).getTransitions(), transitionsBetween(localIterator, (ResultPoint)localObject1).getTransitions()) + 1;
        i = j;
        if ((j & 0x1) == 1) {
          i = j + 1;
        }
        localObject2 = sampleGrid(this.image, localObject3, localEntry, localIterator, (ResultPoint)localObject1, i, i);
      }
      else
      {
        localObject2 = localObject3;
        localObject4 = correctTopRightRectangular(localEntry, localIterator, localObject3, (ResultPoint)localObject1, k, i);
        if (localObject4 != null) {
          localObject1 = localObject4;
        }
        j = transitionsBetween((ResultPoint)localObject2, (ResultPoint)localObject1).getTransitions();
        k = transitionsBetween(localIterator, (ResultPoint)localObject1).getTransitions();
        i = j;
        if ((j & 0x1) == 1) {
          i = j + 1;
        }
        ...
        localObject2 = sampleGrid(this.image, (ResultPoint)localObject2, localEntry, localIterator, (ResultPoint)localObject1, i, j);
      }
      return new DetectorResult((BitMatrix)localObject2, new ResultPoint[] { localObject3, localEntry, localIterator, localObject1 });
    }
