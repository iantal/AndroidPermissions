  ...
  implements ReflectedParcelable
{
  ...
  private final boolean zza(double paramDouble)
  {
    ...
    if (this.southwest.longitude > paramDouble) {
      return paramDouble <= this.northeast.longitude;
    }
    return true;
  }
  ...
  public final boolean contains(LatLng paramLatLng)
  {
    ...
    return (i != 0) && (zza(paramLatLng.longitude));
  }
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    return (this.southwest.equals(paramObject.southwest)) && (this.northeast.equals(paramObject.northeast));
  }
  ...
  {
    return zzbg.zza(this).zza("southwest", this.southwest).zza("northeast", this.northeast).toString();
  }
  
  public final void writeToParcel(Parcel paramParcel, int paramInt)
  {
    int i = zzbgp.zza(paramParcel);
    zzbgp.zza(paramParcel, 2, this.southwest, paramInt, false);
    zzbgp.zza(paramParcel, 3, this.northeast, paramInt, false);
  ...
  public static final class Builder
  {
    ...
    {
      zzbq.zza(Double.isNaN(this.zzc) ^ true, "no included points");
    ...
    {
      this.zza = Math.min(this.zza, paramLatLng.latitude);
      this.zzb = Math.max(this.zzb, paramLatLng.latitude);
      ...
      else
      {
        ...
        if (LatLngBounds.zza(this.zzc, d1) < LatLngBounds.zzb(this.zzd, d1))
        {
          this.zzc = d1;
          return this;
        }
