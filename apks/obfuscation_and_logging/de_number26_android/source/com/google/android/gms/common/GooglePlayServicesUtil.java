  ...
  extends zzs
{
  ...
  public static boolean showErrorDialogFragment(int paramInt1, Activity paramActivity, i paramI, int paramInt2, DialogInterface.OnCancelListener paramOnCancelListener)
  {
    int i = paramInt1;
    if (zzs.zzc(paramActivity, paramInt1)) {
      i = 18;
    ...
    paramI = GoogleApiAvailability.zza(paramActivity, i, zzv.zza(paramI, zzf.zza(paramActivity, i, "d"), paramInt2), paramOnCancelListener);
    if (paramI == null) {
      return false;
    }
    GoogleApiAvailability.zza(paramActivity, paramI, "GooglePlayServicesErrorDialog", paramOnCancelListener);
    return true;
  }
