  ...
  extends SQLiteOpenHelper
{
  ...
  private static boolean zza(String paramString, SQLiteDatabase paramSQLiteDatabase)
  {
    ...
    //   6: ldc 19
    //   8: iconst_1
    //   9: anewarray 21	java/lang/String
    //   12: dup
    //   13: iconst_0
    //   14: ldc 23
    //   16: aastore
    ...
    //   28: aconst_null
    //   29: aconst_null
    //   30: invokevirtual 31	android/database/sqlite/SQLiteDatabase:query	(Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   33: astore_1
    //   34: aload_1
    ...
    //   67: astore_3
    //   68: aload_0
    //   69: invokestatic 45	java/lang/String:valueOf	(Ljava/lang/Object;)Ljava/lang/String;
    //   72: astore_0
    //   73: aload_1
    //   74: astore_3
    //   75: aload_0
    //   76: invokevirtual 49	java/lang/String:length	()I
    //   79: ifeq +15 -> 94
    //   82: aload_1
    //   83: astore_3
    //   84: ldc 51
    //   86: aload_0
    //   87: invokevirtual 55	java/lang/String:concat	(Ljava/lang/String;)Ljava/lang/String;
    //   90: astore_0
    //   91: goto +15 -> 106
    //   94: aload_1
    //   95: astore_3
    //   96: new 21	java/lang/String
    //   99: dup
    //   100: ldc 51
    //   102: invokespecial 58	java/lang/String:<init>	(Ljava/lang/String;)V
    //   105: astore_0
    //   106: aload_1
    //   107: astore_3
    //   108: aload_0
    //   109: invokestatic 63	com/google/android/gms/tagmanager/zzdj:zzb	(Ljava/lang/String;)V
    //   112: aload_1
    //   113: ifnull +9 -> 122
    //   116: aload_1
    //   117: invokeinterface 41 1 0
    //   122: iconst_0
    //   123: ireturn
    //   124: aload_3
    //   125: ifnull +9 -> 134
    //   128: aload_3
    //   129: invokeinterface 41 1 0
    //   134: aload_0
    //   135: athrow
    //   136: astore_1
    //   137: aload 4
  ...
  public final SQLiteDatabase getWritableDatabase()
  {
    ...
    zzat.zzb(this.zza).getDatabasePath("google_tagmanager.db").delete();
