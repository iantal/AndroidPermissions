...
public final class zza
{
  ...
  public static zza zza(ContentResolver paramContentResolver, Uri paramUri)
  {
    ...
    if (localZza2 == null)
    {
      ...
      if (localZza1 == null)
      {
        paramContentResolver.zzb.registerContentObserver(paramContentResolver.zzc, false, paramContentResolver.zzd);
  ...
  public final Map<String, String> zza()
  {
    ...
    if (localObject1 == null) {
      ...
      {
        Map localMap1 = this.zzf;
        localObject1 = localMap1;
        if (localMap1 == null)
        {
          localObject1 = zzc();
          this.zzf = ((Map)localObject1);
        }
        return localObject1;
      }
    }
