  ...
  extends zzetj
{
  ...
  private static int zza(byte[] paramArrayOfByte, int paramInt1, long paramLong, int paramInt2)
  {
    ...
    case 2: 
      return zzeti.zza(paramInt1, zzetg.zza(paramArrayOfByte, paramLong), zzetg.zza(paramArrayOfByte, paramLong + 1L));
    case 1: 
      return zzeti.zza(paramInt1, zzetg.zza(paramArrayOfByte, paramLong));
    }
    return zzeti.zza(paramInt1);
  }
  ...
  private static int zza(byte[] paramArrayOfByte, long paramLong, int paramInt)
  {
    ...
    else
    {
      ...
      while (i < paramInt)
      {
        if (zzetg.zza(paramArrayOfByte, l1) < 0) {
          break label54;
        }
        i += 1;
        l1 += 1L;
    ...
    for (;;)
    {
      ...
      {
        l2 = paramLong + 1L;
        j = zzetg.zza(paramArrayOfByte, paramLong);
        l1 = l2;
        paramInt = j;
        if (j < 0) {
          break label121;
      ...
      if (paramInt < -32)
      {
        ...
        if (paramInt >= -62)
        {
          paramLong = l1 + 1L;
          paramInt = i;
          if (zzetg.zza(paramArrayOfByte, l1) <= -65) {}
        }
        else
        {
          return -1;
      ...
      else if (paramInt < -16)
      {
        ...
        i -= 2;
        l2 = l1 + 1L;
        j = zzetg.zza(paramArrayOfByte, l1);
        if ((j <= -65) && ((paramInt != -32) || (j >= -96)) && ((paramInt != -19) || (j < -96)))
        {
          paramLong = l2 + 1L;
          paramInt = i;
          if (zzetg.zza(paramArrayOfByte, l2) <= -65) {}
        }
        else
        {
          return -1;
      ...
      else
      {
        ...
        l1 = paramLong + 1L;
        if (zzetg.zza(paramArrayOfByte, paramLong) > -65) {
          break;
        }
        if (zzetg.zza(paramArrayOfByte, l1) > -65) {
          return -1;
  ...
  final int zza(CharSequence paramCharSequence, byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    ...
    if ((j <= paramInt2) && (paramArrayOfByte.length - paramInt2 >= paramInt1))
    {
      ...
      while (paramInt2 < j)
      {
        ...
        zzetg.zza(paramArrayOfByte, l1, (byte)paramInt1);
        paramInt2 += 1;
        l1 = 1L + l1;
      }
      paramInt1 = paramInt2;
      ...
      while (paramInt1 < j)
      {
        ...
        if ((i < 128) && (l2 < l3))
        {
          zzetg.zza(paramArrayOfByte, l2, (byte)i);
          l1 = l2 + 1L;
        }
        else
        {
          ...
          {
            l4 = l2 + 1L;
            zzetg.zza(paramArrayOfByte, l2, (byte)(0x3C0 | i >>> 6));
            l1 = l4 + 1L;
            zzetg.zza(paramArrayOfByte, l4, (byte)(i & 0x3F | 0x80));
          }
          else if (((i < 55296) || (57343 < i)) && (l2 <= l3 - 3L))
          {
            l1 = l2 + 1L;
            zzetg.zza(paramArrayOfByte, l2, (byte)(0x1E0 | i >>> 12));
            l2 = l1 + 1L;
            zzetg.zza(paramArrayOfByte, l1, (byte)(i >>> 6 & 0x3F | 0x80));
            zzetg.zza(paramArrayOfByte, l2, (byte)(i & 0x3F | 0x80));
            l1 = l2 + 1L;
          }
          else
          {
            ...
            l1 = l2 + 1L;
            zzetg.zza(paramArrayOfByte, l2, (byte)(0xF0 | paramInt1 >>> 18));
            l2 = l1 + 1L;
            zzetg.zza(paramArrayOfByte, l1, (byte)(paramInt1 >>> 12 & 0x3F | 0x80));
            l4 = l2 + 1L;
            zzetg.zza(paramArrayOfByte, l2, (byte)(paramInt1 >>> 6 & 0x3F | 0x80));
            l1 = l4 + 1L;
            zzetg.zza(paramArrayOfByte, l4, (byte)(paramInt1 & 0x3F | 0x80));
            paramInt1 = paramInt2;
          }
        }
        paramInt1 += 1;
