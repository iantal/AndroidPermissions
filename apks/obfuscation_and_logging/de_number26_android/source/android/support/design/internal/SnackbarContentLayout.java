  ...
  implements BaseTransientBottomBar.ContentViewCallback
{
  ...
  private static void a(View paramView, int paramInt1, int paramInt2)
  {
    if (t.r(paramView))
    {
      t.a(paramView, t.g(paramView), paramInt1, t.h(paramView), paramInt2);
      return;
    }
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    int k = getResources().getDimensionPixelSize(a.d.design_snackbar_padding_vertical_2lines);
    int m = getResources().getDimensionPixelSize(a.d.design_snackbar_padding_vertical);
