  ...
  extends g
{
  ...
  public android.graphics.Typeface a(android.content.Context paramContext, android.os.CancellationSignal paramCancellationSignal, android.support.v4.f.b.b[] paramArrayOfB, int paramInt)
  {
    ...
    //   9: aload_3
    //   10: iload 4
    //   12: invokevirtual 70	android/support/v4/a/d:a	([Landroid/support/v4/f/b$b;I)Landroid/support/v4/f/b$b;
    //   15: astore_3
    //   16: aload_1
    ...
    //   22: aload 5
    //   24: aload_3
    //   25: invokevirtual 81	android/support/v4/f/b$b:a	()Landroid/net/Uri;
    //   28: ldc 83
    //   30: aload_2
    ...
    //   35: aload_0
    //   36: aload_3
    //   37: invokespecial 91	android/support/v4/a/d:a	(Landroid/os/ParcelFileDescriptor;)Ljava/io/File;
    //   40: astore_2
    //   41: aload_2
    //   42: ifnull +28 -> 70
    //   45: aload_2
    //   46: invokevirtual 95	java/io/File:canRead	()Z
    //   49: ifne +6 -> 55
    //   52: goto +18 -> 70
    //   55: aload_2
    //   56: invokestatic 101	android/graphics/Typeface:createFromFile	(Ljava/io/File;)Landroid/graphics/Typeface;
    //   59: astore_1
    //   60: aload_3
    //   61: ifnull +7 -> 68
    //   64: aload_3
    //   65: invokevirtual 104	android/os/ParcelFileDescriptor:close	()V
    //   68: aload_1
    //   69: areturn
    //   70: new 106	java/io/FileInputStream
    //   73: dup
    //   74: aload_3
    //   75: invokevirtual 110	android/os/ParcelFileDescriptor:getFileDescriptor	()Ljava/io/FileDescriptor;
    //   78: invokespecial 113	java/io/FileInputStream:<init>	(Ljava/io/FileDescriptor;)V
    //   81: astore 5
    //   83: aload_0
    //   84: aload_1
    //   85: aload 5
    //   87: invokespecial 116	android/support/v4/a/g:a	(Landroid/content/Context;Ljava/io/InputStream;)Landroid/graphics/Typeface;
    //   90: astore_1
    //   91: aload 5
    //   93: ifnull +8 -> 101
    //   96: aload 5
    ...
    //   102: ifnull +7 -> 109
    //   105: aload_3
    //   106: invokevirtual 104	android/os/ParcelFileDescriptor:close	()V
    //   109: aload_1
    //   110: areturn
    //   111: astore_1
    //   112: aconst_null
    ...
    //   127: ifnull +22 -> 149
    //   130: aload 5
    //   132: invokevirtual 117	java/io/FileInputStream:close	()V
    //   135: goto +19 -> 154
    //   138: astore 5
    //   140: aload_2
    //   141: aload 5
    //   143: invokevirtual 121	java/lang/Throwable:addSuppressed	(Ljava/lang/Throwable;)V
    //   146: goto +8 -> 154
    //   149: aload 5
    //   151: invokevirtual 117	java/io/FileInputStream:close	()V
    //   154: aload_1
    //   155: athrow
    //   156: astore_1
    //   157: aconst_null
    ...
    //   171: ifnull +19 -> 190
    //   174: aload_3
    //   175: invokevirtual 104	android/os/ParcelFileDescriptor:close	()V
    //   178: goto +16 -> 194
    //   181: astore_3
    //   182: aload_2
    //   183: aload_3
    //   184: invokevirtual 121	java/lang/Throwable:addSuppressed	(Ljava/lang/Throwable;)V
    //   187: goto +7 -> 194
    //   190: aload_3
    //   191: invokevirtual 104	android/os/ParcelFileDescriptor:close	()V
    //   194: aload_1
    //   195: athrow
    //   196: astore_1
    //   197: aconst_null
    ...
    //   0	199	3	paramArrayOfB	android.support.v4.f.b.b[]
