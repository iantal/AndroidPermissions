...
public class h
{
  ...
  public static ByteBuffer a(Context paramContext, android.os.CancellationSignal paramCancellationSignal, android.net.Uri paramUri)
  {
    ...
    //   19: ifnull +7 -> 26
    //   22: aload_2
    //   23: invokevirtual 86	android/os/ParcelFileDescriptor:close	()V
    //   26: aconst_null
    //   27: areturn
    //   28: new 88	java/io/FileInputStream
    //   31: dup
    //   32: aload_2
    //   33: invokevirtual 92	android/os/ParcelFileDescriptor:getFileDescriptor	()Ljava/io/FileDescriptor;
    //   36: invokespecial 95	java/io/FileInputStream:<init>	(Ljava/io/FileDescriptor;)V
    //   39: astore 5
    //   41: aload 5
    //   43: invokevirtual 99	java/io/FileInputStream:getChannel	()Ljava/nio/channels/FileChannel;
    //   46: astore_0
    //   47: aload_0
    //   48: invokevirtual 105	java/nio/channels/FileChannel:size	()J
    //   51: lstore_3
    //   52: aload_0
    //   53: getstatic 111	java/nio/channels/FileChannel$MapMode:READ_ONLY	Ljava/nio/channels/FileChannel$MapMode;
    //   56: lconst_0
    //   57: lload_3
    //   58: invokevirtual 115	java/nio/channels/FileChannel:map	(Ljava/nio/channels/FileChannel$MapMode;JJ)Ljava/nio/MappedByteBuffer;
    //   61: astore_0
    //   62: aload 5
    //   64: ifnull +8 -> 72
    //   67: aload 5
    //   69: invokevirtual 116	java/io/FileInputStream:close	()V
    //   72: aload_2
    //   73: ifnull +7 -> 80
    //   76: aload_2
    //   77: invokevirtual 86	android/os/ParcelFileDescriptor:close	()V
    //   80: aload_0
    //   81: areturn
    //   82: astore_1
    //   83: aconst_null
    ...
    //   111: aload_0
    //   112: aload 5
    //   114: invokevirtual 120	java/lang/Throwable:addSuppressed	(Ljava/lang/Throwable;)V
    //   117: goto +8 -> 125
    //   120: aload 5
    //   122: invokevirtual 116	java/io/FileInputStream:close	()V
    //   125: aload_1
    //   126: athrow
    //   127: astore_0
    //   128: aconst_null
    ...
    //   142: ifnull +19 -> 161
    //   145: aload_2
    //   146: invokevirtual 86	android/os/ParcelFileDescriptor:close	()V
    //   149: goto +16 -> 165
    //   152: astore_2
    //   153: aload_1
    //   154: aload_2
    //   155: invokevirtual 120	java/lang/Throwable:addSuppressed	(Ljava/lang/Throwable;)V
    //   158: goto +7 -> 165
    //   161: aload_2
    //   162: invokevirtual 86	android/os/ParcelFileDescriptor:close	()V
    //   165: aload_0
    //   166: athrow
    //   167: astore_0
    //   168: aconst_null
  ...
  private static ByteBuffer a(File paramFile)
  {
    ...
    //   8: astore 4
    //   10: aload 4
    //   12: invokevirtual 99	java/io/FileInputStream:getChannel	()Ljava/nio/channels/FileChannel;
    //   15: astore_0
    //   16: aload_0
    //   17: invokevirtual 105	java/nio/channels/FileChannel:size	()J
    //   20: lstore_1
    //   21: aload_0
    //   22: getstatic 111	java/nio/channels/FileChannel$MapMode:READ_ONLY	Ljava/nio/channels/FileChannel$MapMode;
    //   25: lconst_0
    //   26: lload_1
    //   27: invokevirtual 115	java/nio/channels/FileChannel:map	(Ljava/nio/channels/FileChannel$MapMode;JJ)Ljava/nio/MappedByteBuffer;
    //   30: astore_0
    //   31: aload 4
    //   33: ifnull +8 -> 41
    //   36: aload 4
    //   38: invokevirtual 116	java/io/FileInputStream:close	()V
    //   41: aload_0
    //   42: areturn
    //   43: astore_3
    //   44: aconst_null
    ...
    //   59: ifnull +22 -> 81
    //   62: aload 4
    //   64: invokevirtual 116	java/io/FileInputStream:close	()V
    //   67: goto +19 -> 86
    //   70: astore 4
    //   72: aload_0
    //   73: aload 4
    //   75: invokevirtual 120	java/lang/Throwable:addSuppressed	(Ljava/lang/Throwable;)V
    //   78: goto +8 -> 86
    //   81: aload 4
    //   83: invokevirtual 116	java/io/FileInputStream:close	()V
    //   86: aload_3
    //   87: athrow
    //   88: astore_0
    //   89: aconst_null
  ...
  public static boolean a(File paramFile, Resources paramResources, int paramInt)
  {
    ...
    //   0: aload_1
    //   1: iload_2
    //   2: invokevirtual 133	android/content/res/Resources:openRawResource	(I)Ljava/io/InputStream;
    //   5: astore_1
    //   6: aload_0
    //   7: aload_1
    //   8: invokestatic 136	android/support/v4/a/h:a	(Ljava/io/File;Ljava/io/InputStream;)Z
    //   11: istore_3
    //   12: aload_1
    //   13: invokestatic 138	android/support/v4/a/h:a	(Ljava/io/Closeable;)V
    //   16: iload_3
    //   17: ireturn
    //   18: astore_0
    //   19: goto +6 -> 25
    ...
    //   24: astore_1
    //   25: aload_1
    //   26: invokestatic 138	android/support/v4/a/h:a	(Ljava/io/Closeable;)V
    //   29: aload_0
    //   30: athrow
    // Local variable table:
    //   start	length	slot	name	signature
  ...
  public static boolean a(File paramFile, java.io.InputStream paramInputStream)
  {
    ...
    //   3: aconst_null
    //   4: astore_3
    //   5: new 140	java/io/FileOutputStream
    //   8: dup
    //   9: aload_0
    //   10: iconst_0
    //   11: invokespecial 143	java/io/FileOutputStream:<init>	(Ljava/io/File;Z)V
    //   14: astore_0
    //   15: sipush 1024
    //   18: newarray byte
    //   20: astore_3
    //   21: aload_1
    //   22: aload_3
    //   23: invokevirtual 149	java/io/InputStream:read	([B)I
    //   26: istore_2
    //   27: iload_2
    //   28: iconst_m1
    //   29: if_icmpeq +13 -> 42
    ...
    //   34: iconst_0
    //   35: iload_2
    //   36: invokevirtual 153	java/io/FileOutputStream:write	([BII)V
    //   39: goto -18 -> 21
    //   42: aload_0
    //   43: invokestatic 138	android/support/v4/a/h:a	(Ljava/io/Closeable;)V
    //   46: iconst_1
    //   47: ireturn
    //   48: astore_1
    //   49: aload_0
    ...
    //   91: aload 4
    //   93: aload_1
    //   94: invokevirtual 158	java/io/IOException:getMessage	()Ljava/lang/String;
    ...
    //   110: invokestatic 166	android/util/Log:e	(Ljava/lang/String;Ljava/lang/String;)I
    //   113: pop
    //   114: aload_0
    //   115: invokestatic 138	android/support/v4/a/h:a	(Ljava/io/Closeable;)V
    //   118: iconst_0
    //   119: ireturn
    //   120: aload_3
    //   121: invokestatic 138	android/support/v4/a/h:a	(Ljava/io/Closeable;)V
    //   124: aload_0
    //   125: athrow
    // Local variable table:
    //   start	length	slot	name	signature
