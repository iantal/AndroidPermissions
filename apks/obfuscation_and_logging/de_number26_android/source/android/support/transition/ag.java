  ...
  implements ai
{
  ...
  public void a(ViewGroup paramViewGroup, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      if (localLayoutTransition != null)
      {
        ...
        if (localLayoutTransition != a) {
          paramViewGroup.setTag(r.a.transition_layout_save, localLayoutTransition);
        }
      }
    ...
    localLayoutTransition = (LayoutTransition)paramViewGroup.getTag(r.a.transition_layout_save);
    if (localLayoutTransition != null)
    {
