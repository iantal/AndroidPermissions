  ...
  implements MenuView.ItemView, View.OnClickListener, ActionMenuView.ActionMenuChildView
{
  ...
  private void updateTextButtonVisibility()
  {
    ...
    CharSequence localCharSequence = this.mItemData.getContentDescription();
    if (TextUtils.isEmpty(localCharSequence))
    {
      if (i != 0) {
        localCharSequence = null;
      } else {
        localCharSequence = this.mItemData.getTitle();
      }
    ...
    localCharSequence = this.mItemData.getTooltipText();
    if (TextUtils.isEmpty(localCharSequence))
    {
      if (i != 0) {
        localCharSequence = null;
    ...
    extends ForwardingListener
  {
    ...
    protected boolean onForwardingStarted()
    {
      if ((ActionMenuItemView.this.mItemInvoker != null) && (ActionMenuItemView.this.mItemInvoker.invokeItem(ActionMenuItemView.this.mItemData)))
      {
        ...
        return (localShowableListMenu != null) && (localShowableListMenu.isShowing());
      }
      return false;
    }
  }
