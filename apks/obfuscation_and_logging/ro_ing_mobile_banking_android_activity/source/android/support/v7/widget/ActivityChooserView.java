  ...
  implements ActivityChooserModel.ActivityChooserModelClient
{
  ...
  public ActivityChooserView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    ((View)localObject).setOnClickListener(this.mCallbacks);
    ...
    this.mExpandActivityOverflowButtonImage = ((ImageView)((View)localObject).findViewById(R.id.image));
  ...
  protected void onDetachedFromWindow()
  {
    ...
    if (localObject != null) {
      ((Observable)localObject).unregisterObserver(this.mModelDataSetObserver);
    }
