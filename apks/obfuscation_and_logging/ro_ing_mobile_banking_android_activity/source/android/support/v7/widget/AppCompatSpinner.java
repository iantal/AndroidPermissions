    ...
    if (this.mPopupContext != null)
    {
      ...
      if (paramInt2 == -1) {
        if (Build.VERSION.SDK_INT >= 11)
        {
          ...
          try
          {
            TypedArray localTypedArray2 = paramContext.obtainStyledAttributes(paramAttributeSet, ATTRS_ANDROID_SPINNERMODE, paramInt1, 0);
            TypedArray localTypedArray1 = localTypedArray2;
            i = paramInt2;
            paramTheme = localTypedArray1;
            localObject = localTypedArray1;
