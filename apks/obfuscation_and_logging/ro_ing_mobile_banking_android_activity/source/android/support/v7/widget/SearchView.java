  ...
  implements CollapsibleActionView
{
  ...
  private Intent createIntentFromSuggestion(Cursor paramCursor, int paramInt, String paramString)
  {
    ...
    catch (RuntimeException paramString)
    {
      for (;;)
      {
        ...
        paramInt = -1;
        Log.w("SearchView", new StringBuilder("Search suggestions cursor at row ").append(paramInt).append(" returned exception.").toString(), paramString);
        return null;
        label205:
    ...
    if (localObject1 != null)
    {
      ...
      if (str != null)
      {
        localObject3 = new StringBuilder().append((String)localObject1).append("/").append(Uri.encode(str)).toString();
        break label222;
  ...
  private void launchIntent(Intent paramIntent)
  {
    ...
    {
      Log.e("SearchView", "Failed launch activity: ".concat(String.valueOf(paramIntent)), localRuntimeException);
    }
  }
    ...
    extends AbsSavedState
  {
    ...
    {
      public final SearchView.SavedState createFromParcel(Parcel paramAnonymousParcel)
      {
        return new SearchView.SavedState(paramAnonymousParcel, null);
      }
      
      public final SearchView.SavedState createFromParcel(Parcel paramAnonymousParcel, ClassLoader paramAnonymousClassLoader)
      {
        return new SearchView.SavedState(paramAnonymousParcel, paramAnonymousClassLoader);
      }
      
      public final SearchView.SavedState[] newArray(int paramAnonymousInt)
      {
    ...
    extends TouchDelegate
  {
    ...
    public boolean onTouchEvent(MotionEvent paramMotionEvent)
    {
      ...
      case 1: 
      case 2: 
        boolean bool4 = this.mDelegateTargeted;
        bool2 = bool4;
        bool1 = bool2;
        i = j;
        if (bool4)
