  ...
  implements Parcelable
{
  ...
  public static PlaybackStateCompat fromPlaybackState(Object paramObject)
  {
    if ((paramObject != null) && (Build.VERSION.SDK_INT >= 21))
    {
      ...
      if (Build.VERSION.SDK_INT >= 22) {
        localObject2 = PlaybackStateCompatApi22.getExtras(paramObject);
      } else {
        localObject2 = null;
      }
  ...
  public final Object getPlaybackState()
  {
    if ((this.mStateObj == null) && (Build.VERSION.SDK_INT >= 21))
    {
      ...
      if (Build.VERSION.SDK_INT >= 22) {
        this.mStateObj = PlaybackStateCompatApi22.newInstance(this.mState, this.mPosition, this.mBufferedPosition, this.mSpeed, this.mActions, this.mErrorMessage, this.mUpdateTime, localObject, this.mActiveItemId, this.mExtras);
      } else {
        this.mStateObj = PlaybackStateCompatApi21.newInstance(this.mState, this.mPosition, this.mBufferedPosition, this.mSpeed, this.mActions, this.mErrorMessage, this.mUpdateTime, localObject, this.mActiveItemId);
      }
    }
  ...
  public static final class Builder
  {
    ...
    public final Builder setErrorMessage(int paramInt, CharSequence paramCharSequence)
    {
