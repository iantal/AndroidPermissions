...
public class NotificationCompat
{
    ...
    extends NotificationCompatBase.Action
  {
    ...
    {
      public final NotificationCompatBase.Action build(int paramAnonymousInt, CharSequence paramAnonymousCharSequence, PendingIntent paramAnonymousPendingIntent, Bundle paramAnonymousBundle, RemoteInputCompatBase.RemoteInput[] paramAnonymousArrayOfRemoteInput1, RemoteInputCompatBase.RemoteInput[] paramAnonymousArrayOfRemoteInput2, boolean paramAnonymousBoolean)
      {
    ...
    public static final class Builder
    {
      ...
      public final Builder setAllowGeneratedReplies(boolean paramBoolean)
      {
        this.mAllowGeneratedReplies = paramBoolean;
        return this;
      }
      ...
      implements NotificationCompat.Action.Extender
    {
      ...
      public final WearableExtender setHintDisplayActionInline(boolean paramBoolean)
      {
        setFlag(4, paramBoolean);
        return this;
      }
      
      public final WearableExtender setHintLaunchesActivity(boolean paramBoolean)
      {
    ...
    implements NotificationCompat.Extender
  {
    ...
    public final CarExtender setColor(@ColorInt int paramInt)
    {
      this.mColor = paramInt;
      return this;
    }
    ...
    public final CarExtender setUnreadConversation(UnreadConversation paramUnreadConversation)
    {
    ...
    extends NotificationCompat.Style
  {
    ...
    private CharSequence makeMessageLine(Message paramMessage)
    {
      ...
      if (TextUtils.isEmpty(paramMessage.getSender()))
      {
        ...
        if ((j != 0) && (this.mBuilder.getColor() != 0)) {
      ...
      localSpannableStringBuilder.setSpan(makeFontColorSpan(k), localSpannableStringBuilder.length() - ((CharSequence)localObject).length(), localSpannableStringBuilder.length(), 33);
    ...
    public void apply(NotificationBuilderWithBuilderAccessor paramNotificationBuilderWithBuilderAccessor)
    {
      ...
      if (Build.VERSION.SDK_INT >= 24)
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          ((List)localObject1).add(localMessage.getText());
          ((List)localObject2).add(Long.valueOf(localMessage.getTimestamp()));
          localArrayList1.add(localMessage.getSender());
          localArrayList2.add(localMessage.getDataMimeType());
          localArrayList3.add(localMessage.getDataUri());
        }
        NotificationCompatApi24.addMessagingStyle(paramNotificationBuilderWithBuilderAccessor, this.mUserDisplayName, this.mConversationTitle, (List)localObject1, (List)localObject2, localArrayList1, localArrayList2, localArrayList3);
        return;
      }
    ...
    public static final class Message
    {
      ...
      static Message getMessageFromBundle(Bundle paramBundle)
      {
        try
        {
          ...
          {
            boolean bool = paramBundle.containsKey("time");
            if (bool) {}
          }
          else
          {
      ...
      public final Message setData(String paramString, Uri paramUri)
      {
    ...
    implements NotificationCompat.Extender
  {
    ...
    public final WearableExtender setBridgeTag(String paramString)
    {
    ...
    public final WearableExtender setDismissalId(String paramString)
    {
    ...
    public final WearableExtender setHintAmbientBigPicture(boolean paramBoolean)
    {
    ...
    public final WearableExtender setHintContentIntentLaunchesActivity(boolean paramBoolean)
    {
