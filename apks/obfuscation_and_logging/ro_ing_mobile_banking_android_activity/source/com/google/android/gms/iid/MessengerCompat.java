...
{
  public static final Parcelable.Creator<MessengerCompat> CREATOR = new ܢ();
  ...
  public MessengerCompat(IBinder paramIBinder)
  {
    ...
    else
    {
      ...
      if ((localIInterface instanceof ץ)) {
        paramIBinder = (ץ)localIInterface;
      } else {
        paramIBinder = new ز(paramIBinder);
      }
    }
