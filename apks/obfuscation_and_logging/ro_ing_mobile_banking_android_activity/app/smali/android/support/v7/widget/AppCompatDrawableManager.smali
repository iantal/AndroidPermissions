...
.method private getCachedDrawable(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    :try_start_1
    invoke-virtual {v2, p2, p3}, Landroid/support/v4/util/LongSparseArray;->get(J)Ljava/lang/Object;
    ...
    :cond_1
    :try_start_2
    invoke-virtual {v2, p2, p3}, Landroid/support/v4/util/LongSparseArray;->delete(J)V
    :try_end_2
...
.method private loadDrawableFromDelegates(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0, p2, v8}, Landroid/support/v4/util/SparseArrayCompat;->append(ILjava/lang/Object;)V
    ...
    .line 365
    invoke-interface {v8, p1, v3, v7, v0}, Landroid/support/v7/widget/AppCompatDrawableManager$InflateDelegate;->createFromXmlInner(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
...
.method private tintDrawable(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    .line 274
    invoke-static {p4, p2}, Landroid/support/v4/graphics/drawable/DrawableCompat;->setTintMode(Landroid/graphics/drawable/Drawable;Landroid/graphics/PorterDuff$Mode;)V
