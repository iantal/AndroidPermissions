...
.method public build()Landroid/support/v4/media/AudioAttributesCompat;
    ...
    .line 446
    iget-object v0, p0, Landroid/support/v4/media/AudioAttributesCompat$Builder;->mLegacyStream:Ljava/lang/Integer;
    ...
    invoke-direct {v2, v0}, Landroid/support/v4/media/AudioAttributesCompat;-><init>(Landroid/support/v4/media/AudioAttributesCompat$1;)V

    .line 455
    iget v0, p0, Landroid/support/v4/media/AudioAttributesCompat$Builder;->mContentType:I

    iput v0, v2, Landroid/support/v4/media/AudioAttributesCompat;->mContentType:I

    .line 456
    iget v0, p0, Landroid/support/v4/media/AudioAttributesCompat$Builder;->mFlags:I

    iput v0, v2, Landroid/support/v4/media/AudioAttributesCompat;->mFlags:I

    .line 457
    iget v0, p0, Landroid/support/v4/media/AudioAttributesCompat$Builder;->mUsage:I

    iput v0, v2, Landroid/support/v4/media/AudioAttributesCompat;->mUsage:I

    .line 458
    iget-object v0, p0, Landroid/support/v4/media/AudioAttributesCompat$Builder;->mLegacyStream:Ljava/lang/Integer;

    iput-object v0, v2, Landroid/support/v4/media/AudioAttributesCompat;->mLegacyStream:Ljava/lang/Integer;

    .line 459
    const/4 v0, 0x0

    invoke-static {v2, v0}, Landroid/support/v4/media/AudioAttributesCompat;->access$202(Landroid/support/v4/media/AudioAttributesCompat;Landroid/support/v4/media/AudioAttributesCompatApi21$Wrapper;)Landroid/support/v4/media/AudioAttributesCompatApi21$Wrapper;
