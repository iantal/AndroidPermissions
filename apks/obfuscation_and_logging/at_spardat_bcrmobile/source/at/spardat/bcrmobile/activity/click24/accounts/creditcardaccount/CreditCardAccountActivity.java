  ...
  extends at.spardat.bcrmobile.activity.click24.d
{
  ...
  private final BroadcastReceiver i = new BroadcastReceiver()
  {
    public final void onReceive(Context paramAnonymousContext, Intent paramAnonymousIntent)
    {
      ...
      try
      {
        ...
        paramAnonymousContext = (ProductOffersModel)CreditCardAccountActivity.e(CreditCardAccountActivity.this).a("PRODUCT_OFFERS_LIST");
        CreditCardAccountActivity.a(CreditCardAccountActivity.this, paramAnonymousContext);
        return;
      }
      catch (IllegalArgumentException paramAnonymousContext)
      {
        if (at.spardat.bcrmobile.b.b.a()) {
          at.spardat.bcrmobile.b.b.a(at.spardat.bcrmobile.b.c.WARN, CreditCardAccountActivity.class.getName() + "unregisterProductOffersListReceiver", paramAnonymousContext.getMessage());
        }
  ...
  private final m j = new m()
  {
    ...
    public final void a(int paramAnonymousInt)
    {
      ...
      for (;;)
      {
        at.spardat.bcrmobile.view.layout.a.b localB = (at.spardat.bcrmobile.view.layout.a.b)CreditCardAccountActivity.i(CreditCardAccountActivity.this).findViewWithTag(Integer.valueOf(paramAnonymousInt));
        if (localB != null) {
          localB.c();
        }
        return;
    ...
    public final void b(int paramAnonymousInt)
    {
      ...
      {
        localB = (at.spardat.bcrmobile.view.layout.a.b)CreditCardAccountActivity.i(CreditCardAccountActivity.this).findViewWithTag(Integer.valueOf(paramAnonymousInt - 1));
        if (localB != null) {
          localB.c();
        }
      }
    ...
    public final View c(int paramAnonymousInt)
    {
      ...
      Object localObject = (RelativeLayout)localView1.findViewById(2131427394);
      localObject = new at.spardat.bcrmobile.view.layout.a.b(CreditCardAccountActivity.this, (RelativeLayout)localObject, localCreditCardAccItemModel, at.spardat.bcrmobile.b.a.a.TRANSACTIONS);
      ((at.spardat.bcrmobile.view.layout.a.b)localObject).a();
      ((at.spardat.bcrmobile.view.layout.a.b)localObject).setTag(Integer.valueOf(paramAnonymousInt));
  ...
  private void a(ProductOffersModel paramProductOffersModel)
  {
    ...
    if (!at.spardat.bcrmobile.e.d.a(localArrayList))
    {
      ...
      paramProductOffersModel.putExtra("ACTIVITY_FROM", CreditCardAccountActivity.class);
  ...
  private void g()
  {
    ...
    if ((this.c != null) && (!at.spardat.bcrmobile.e.d.a(this.c.getAccounts())))
    {
        ...
        if (this.c != null)
        {
          ...
          if (!at.spardat.bcrmobile.e.d.a((Collection)localObject2))
          {
            ...
            for (;;)
            {
              ...
              m = k;
              if (((String)localObject1).equals(((CreditCardAccItemModel)((Iterator)localObject2).next()).getAccountInternalId())) {
                break;
              }
              k += 1;
            }
      ...
      localObject1 = new at.spardat.bcrmobile.view.widget.d(this, this.c.getAccounts().size(), this.h, this.j, this.E / 6);
    ...
    if (this.c == null)
    {
      this.d = new at.spardat.bcrmobile.a.b.a.b(this, this.e, getString(2131165673), k.DEFAULT)
      {
        protected final AccountDetailModel<CreditCardAccItemModel> a(String paramAnonymousString)
        {
          ...
          {
            paramAnonymousString = at.spardat.bcrmobile.e.d.a(CreditCardAccountActivity.b(CreditCardAccountActivity.this).getAccounts());
            CreditCardAccountActivity.b(CreditCardAccountActivity.this).setAccounts(paramAnonymousString);
          }
        ...
        protected final void a()
        {
          ...
          {
            localObject = ((at.spardat.bcrmobile.c.c)this.f).a();
            if (at.spardat.bcrmobile.e.d.a((String)localObject)) {}
          }
          try
          {
            localObject = w.valueOf((String)localObject);
            if (localObject == w.err_generic_error)
            {
              localObject = a(CreditCardAccountActivity.this.getApplicationContext(), this.f, CreditCardAccountActivity.this.getString(((w)localObject).getErrorMessageResId()));
              CreditCardAccountActivity.a(CreditCardAccountActivity.this, null, (String)localObject, true);
      ...
      this.d.execute(new String[] { at.spardat.bcrmobile.b.a.c.CC.name() });
      return;
    }
    this.e.setVisibility(8);
    g();
