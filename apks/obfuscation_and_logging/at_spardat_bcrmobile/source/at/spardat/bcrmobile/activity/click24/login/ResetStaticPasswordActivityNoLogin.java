  ...
  implements h
{
  ...
  private final View.OnFocusChangeListener o = new View.OnFocusChangeListener()
  {
    public final void onFocusChange(View paramAnonymousView, boolean paramAnonymousBoolean)
    {
      ...
      {
        paramAnonymousView = ResetStaticPasswordActivityNoLogin.f(ResetStaticPasswordActivityNoLogin.this).c();
        if (!at.spardat.bcrmobile.e.d.a(paramAnonymousView)) {
          break label101;
        }
        paramAnonymousView = String.format(ResetStaticPasswordActivityNoLogin.this.getResources().getString(2131165487), new Object[] { ResetStaticPasswordActivityNoLogin.this.getResources().getString(2131165452) });
        if (paramAnonymousBoolean) {
          ResetStaticPasswordActivityNoLogin.f(ResetStaticPasswordActivityNoLogin.this).b(paramAnonymousView);
        }
      }
      else
      {
      ...
      ResetStaticPasswordActivityNoLogin.f(ResetStaticPasswordActivityNoLogin.this).a(paramAnonymousView);
      return;
      label101:
  ...
  private final View.OnFocusChangeListener p = new View.OnFocusChangeListener()
  {
    public final void onFocusChange(View paramAnonymousView, boolean paramAnonymousBoolean)
    {
      ...
      {
        paramAnonymousView = ResetStaticPasswordActivityNoLogin.d(ResetStaticPasswordActivityNoLogin.this).c();
        if (!at.spardat.bcrmobile.e.d.a(paramAnonymousView)) {
          break label113;
        }
        if (!paramAnonymousBoolean) {
      ...
      for (;;)
      {
        ...
        if (paramAnonymousBoolean)
        {
          if (!localK.a(paramAnonymousView, ResetStaticPasswordActivityNoLogin.g(ResetStaticPasswordActivityNoLogin.this), ResetStaticPasswordActivityNoLogin.h(ResetStaticPasswordActivityNoLogin.this))) {
        ...
        else if (!localK.a(paramAnonymousView, ResetStaticPasswordActivityNoLogin.g(ResetStaticPasswordActivityNoLogin.this), ResetStaticPasswordActivityNoLogin.h(ResetStaticPasswordActivityNoLogin.this)))
        {
          ResetStaticPasswordActivityNoLogin.d(ResetStaticPasswordActivityNoLogin.this).b();
  ...
  private final View.OnFocusChangeListener q = new View.OnFocusChangeListener()
  {
    public final void onFocusChange(View paramAnonymousView, boolean paramAnonymousBoolean)
    {
      ...
      {
        paramAnonymousView = ResetStaticPasswordActivityNoLogin.i(ResetStaticPasswordActivityNoLogin.this).c();
        if (!at.spardat.bcrmobile.e.d.a(paramAnonymousView)) {
          break label101;
        }
        paramAnonymousView = String.format(ResetStaticPasswordActivityNoLogin.this.getResources().getString(2131165487), new Object[] { ResetStaticPasswordActivityNoLogin.this.getResources().getString(2131165423) });
        if (paramAnonymousBoolean) {
          ResetStaticPasswordActivityNoLogin.i(ResetStaticPasswordActivityNoLogin.this).b(paramAnonymousView);
        }
      }
      else
      {
      ...
      ResetStaticPasswordActivityNoLogin.i(ResetStaticPasswordActivityNoLogin.this).a(paramAnonymousView);
      return;
      label101:
      if (ResetStaticPasswordActivityNoLogin.d(ResetStaticPasswordActivityNoLogin.this) != null)
      {
        if (!paramAnonymousView.equals(ResetStaticPasswordActivityNoLogin.d(ResetStaticPasswordActivityNoLogin.this).c()))
        {
          if (paramAnonymousBoolean)
          {
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    if (paramBundle != null)
    {
      this.e = paramBundle.getStringExtra("user_id");
      this.f = paramBundle.getStringExtra("ALIAS");
    }
    ...
    paramBundle = (LinearLayout)this.k.findViewById(2131427754).findViewById(2131427758);
    ...
    this.k.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener()
    {
      ...
      {
        if ((ResetStaticPasswordActivityNoLogin.a(ResetStaticPasswordActivityNoLogin.this, ResetStaticPasswordActivityNoLogin.d(ResetStaticPasswordActivityNoLogin.this).getRootView())) && (localEditText.hasFocus())) {
          ResetStaticPasswordActivityNoLogin.a(ResetStaticPasswordActivityNoLogin.this).post(new Runnable()
          {
            public final void run()
            {
    ...
    this.i = ((LinearLayout)((LayoutInflater)localObject).inflate(2130903161, null));
    this.j = new at.spardat.bcrmobile.view.layout.a.a.b(this, true, getString(2131165423), "");
    this.j.c(16);
    localObject = (EditText)this.j.findViewById(2131427723);
  ...
  protected void onResume()
  {
    ...
    for (long l1 = ((Long)localObject).longValue();; l1 = 0L)
    {
      ...
      if (at.spardat.bcrmobile.b.b.a()) {
        at.spardat.bcrmobile.b.b.a(c.INFO, getClass().getName(), "TimeDifference " + (l2 - l1) / 1000L + "Sec.");
      }
