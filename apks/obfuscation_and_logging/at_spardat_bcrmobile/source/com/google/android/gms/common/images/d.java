  ...
  implements Runnable
{
  ...
  public final void run()
  {
    if (Looper.getMainLooper().getThread() != Thread.currentThread())
    {
      ...
      new StringBuilder(String.valueOf(???).length() + 57 + String.valueOf(str).length()).append("checkMainThread: current thread ").append((String)???).append(" IS NOT the main thread ").append(str).append("!");
