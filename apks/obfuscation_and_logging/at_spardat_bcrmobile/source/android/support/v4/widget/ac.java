...
public final class ac
{
  ...
  public static ac a(ViewGroup paramViewGroup, float paramFloat, ad paramAd)
  {
    ...
    paramViewGroup.b = ((int)(paramViewGroup.b * 1.0F));
  ...
  private boolean a(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    for (float f2 = i6 / i7;; f2 = i4 / i8)
    {
      ...
      localObject = this.q;
      ((r)localObject).b.a(((r)localObject).a, i1, i2, paramInt1, paramInt2, paramInt3);
      b(2);
      return true;
      f1 = i3 / i8;
      break;
  ...
  {
    int i2 = android.support.v4.view.ac.c(paramMotionEvent);
    int i1 = 0;
    while (i1 < i2)
    {
      int i3 = android.support.v4.view.ac.b(paramMotionEvent, i1);
  ...
  public final boolean a(MotionEvent paramMotionEvent)
  {
    ...
    int i1 = android.support.v4.view.ac.b(paramMotionEvent);
    if (i2 == 0) {
      e();
    }
    if (this.l == null) {
    ...
    while (this.a == 1)
    {
      ...
      i1 = android.support.v4.view.ac.b(paramMotionEvent, 0);
      a(f1, f2, i1);
      ...
      if ((this.h[i1] & this.p) != 0)
      {
        this.r.b();
        continue;
        i2 = android.support.v4.view.ac.b(paramMotionEvent, i1);
        f1 = android.support.v4.view.ac.c(paramMotionEvent, i1);
        f2 = android.support.v4.view.ac.d(paramMotionEvent, i1);
        a(f1, f2, i2);
        if (this.a == 0)
        {
          ...
          if (paramMotionEvent == this.s)
          {
            ...
            if ((this.d != null) && (this.e != null))
            {
              ...
              for (;;)
              {
                ...
                if (i1 < i3)
                {
                  i4 = android.support.v4.view.ac.b(paramMotionEvent, i1);
                  if (!f(i4)) {
                    break label518;
                  }
                  f1 = android.support.v4.view.ac.c(paramMotionEvent, i1);
                  ...
                  int i6 = (int)f3;
                  i6 = this.r.b(localView, i6 + i5);
                  localView.getTop();
                  this.r.d(localView);
                  int i7 = this.r.c(localView);
                  if ((i7 != 0) && ((i7 <= 0) || (i6 != i5))) {
                    break label484;
                  }
                }
              ...
              d(android.support.v4.view.ac.b(paramMotionEvent, i1));
              continue;
              e();
            }
          }
  ...
  public final boolean a(boolean paramBoolean)
  {
    ...
    if (this.a == 2)
    {
      ...
      if (bool2)
      {
        r localR = this.q;
        paramBoolean = bool2;
        if (i1 == localR.b.g(localR.a))
        {
          localR = this.q;
          paramBoolean = bool2;
          if (i2 == localR.b.h(localR.a))
          {
            this.q.f();
            paramBoolean = false;
          }
  ...
  public final void b(MotionEvent paramMotionEvent)
  {
    int i1 = 0;
    int i2 = 0;
    int i4 = android.support.v4.view.ac.a(paramMotionEvent);
    ...
    case 2: 
      do
      {
        do
        {
          do
          {
            ...
            this.r.b();
            return;
            i1 = android.support.v4.view.ac.b(paramMotionEvent, i3);
            f1 = android.support.v4.view.ac.c(paramMotionEvent, i3);
            f2 = android.support.v4.view.ac.d(paramMotionEvent, i3);
            a(f1, f2, i1);
            if (this.a != 0) {
              break;
            }
      ...
      i1 = android.support.v4.view.ac.a(paramMotionEvent, this.c);
      f1 = android.support.v4.view.ac.c(paramMotionEvent, i1);
      f2 = android.support.v4.view.ac.d(paramMotionEvent, i1);
      ...
      c(paramMotionEvent);
      return;
      i3 = android.support.v4.view.ac.c(paramMotionEvent);
      i1 = i2;
      while (i1 < i3)
      {
        i2 = android.support.v4.view.ac.b(paramMotionEvent, i1);
      ...
      return;
    case 6: 
      i2 = android.support.v4.view.ac.b(paramMotionEvent, i3);
  ...
  public final boolean c(int paramInt)
  {
    ...
    while (i1 < i2)
    {
      if (e(i1))
      {
        float f1 = this.f[i1] - this.d[i1];
        float f2 = this.g[i1] - this.e[i1];
