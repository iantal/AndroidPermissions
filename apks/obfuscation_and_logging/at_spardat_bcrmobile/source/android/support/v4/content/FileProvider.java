  ...
  private static b a(Context paramContext, String paramString)
  {
    ...
    for (;;)
    {
      ...
      catch (IOException paramContext)
      {
        ...
        {
          localObject1 = a(b, new String[] { str2 });
          if (localObject1 == null) {
            continue;
          }
          ((c)localObject2).a(str1, (File)localObject1);
          continue;
        }
      }
      ...
      {
        localObject1 = a(paramContext.getFilesDir(), new String[] { str2 });
      }
      else if ("cache-path".equals(localObject1))
      {
        localObject1 = a(paramContext.getCacheDir(), new String[] { str2 });
      }
      else if ("external-path".equals(localObject1))
      {
        localObject1 = a(Environment.getExternalStorageDirectory(), new String[] { str2 });
        continue;
        label281:
