...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1, v0}, Lnet/hockeyapp/android/e/b;-><init>(Landroid/content/Context;B)V
...
.method private constructor <init>(Landroid/content/Context;B)V
    ...
    invoke-direct {p0, p1, v0, v1}, Lnet/hockeyapp/android/e/b;-><init>(Landroid/content/Context;ZZ)V
...
.method public constructor <init>(Landroid/content/Context;ZZ)V
    ...
    iput-object v0, p0, Lnet/hockeyapp/android/e/b;->a:Landroid/widget/RelativeLayout;

    iput-boolean v7, p0, Lnet/hockeyapp/android/e/b;->b:Z

    iput-boolean v7, p0, Lnet/hockeyapp/android/e/b;->c:Z

    if-eqz p2, :cond_1

    invoke-virtual {p0}, Lnet/hockeyapp/android/e/b;->getResources()Landroid/content/res/Resources;
    ...
    iput-boolean v8, p0, Lnet/hockeyapp/android/e/b;->b:Z

    :goto_0
    iput-boolean p3, p0, Lnet/hockeyapp/android/e/b;->c:Z

    new-instance v0, Landroid/widget/RelativeLayout$LayoutParams;

    invoke-direct {v0, v1, v9}, Landroid/widget/RelativeLayout$LayoutParams;-><init>(II)V

    invoke-virtual {p0, v1}, Lnet/hockeyapp/android/e/b;->setBackgroundColor(I)V

    invoke-virtual {p0, v0}, Lnet/hockeyapp/android/e/b;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V
    ...
    iget-object v0, p0, Lnet/hockeyapp/android/e/b;->a:Landroid/widget/RelativeLayout;

    const/16 v2, 0x1001

    invoke-virtual {v0, v2}, Landroid/widget/RelativeLayout;->setId(I)V

    iget-boolean v0, p0, Lnet/hockeyapp/android/e/b;->b:Z
    ...
    iget-object v2, p0, Lnet/hockeyapp/android/e/b;->a:Landroid/widget/RelativeLayout;
    ...
    invoke-virtual {p0, v0}, Lnet/hockeyapp/android/e/b;->addView(Landroid/view/View;)V
    ...
    iget-boolean v4, p0, Lnet/hockeyapp/android/e/b;->c:Z
    ...
    invoke-virtual {p0, v2}, Lnet/hockeyapp/android/e/b;->addView(Landroid/view/View;)V
    ...
    iget-boolean v3, p0, Lnet/hockeyapp/android/e/b;->b:Z
