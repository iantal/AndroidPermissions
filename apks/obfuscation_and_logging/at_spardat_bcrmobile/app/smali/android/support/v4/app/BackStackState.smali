...
.method public constructor <init>(Landroid/support/v4/app/e;)V
    ...
    iget-object v0, p1, Landroid/support/v4/app/e;->c:Landroid/support/v4/app/f;
    ...
    iget-object v2, v1, Landroid/support/v4/app/f;->i:Ljava/util/ArrayList;
    ...
    :cond_0
    iget-object v1, v1, Landroid/support/v4/app/f;->a:Landroid/support/v4/app/f;
    ...
    iget v4, v5, Landroid/support/v4/app/f;->c:I
    ...
    iget-object v0, v5, Landroid/support/v4/app/f;->d:Landroid/support/v4/app/Fragment;
    ...
    iget v2, v5, Landroid/support/v4/app/f;->e:I
    ...
    iget v4, v5, Landroid/support/v4/app/f;->f:I
    ...
    iget v4, v5, Landroid/support/v4/app/f;->g:I
    ...
    iget v4, v5, Landroid/support/v4/app/f;->h:I

    aput v4, v0, v1

    iget-object v0, v5, Landroid/support/v4/app/f;->i:Ljava/util/ArrayList;
    ...
    :goto_4
    iget-object v1, v5, Landroid/support/v4/app/f;->a:Landroid/support/v4/app/f;
...
# virtual methods
.method public final a(Landroid/support/v4/app/w;)Landroid/support/v4/app/e;
    .locals 11
    ...
    invoke-direct {v6, p1}, Landroid/support/v4/app/e;-><init>(Landroid/support/v4/app/w;)V
    ...
    new-instance v7, Landroid/support/v4/app/f;

    invoke-direct {v7}, Landroid/support/v4/app/f;-><init>()V
    ...
    iput v0, v7, Landroid/support/v4/app/f;->c:I
    ...
    iput-object v0, v7, Landroid/support/v4/app/f;->d:Landroid/support/v4/app/Fragment;
    ...
    iput v0, v7, Landroid/support/v4/app/f;->e:I
    ...
    iput v0, v7, Landroid/support/v4/app/f;->f:I
    ...
    iput v0, v7, Landroid/support/v4/app/f;->g:I
    ...
    iput v0, v7, Landroid/support/v4/app/f;->h:I
    ...
    iput-object v0, v7, Landroid/support/v4/app/f;->i:Ljava/util/ArrayList;
    ...
    iget-object v3, v7, Landroid/support/v4/app/f;->i:Ljava/util/ArrayList;
    ...
    :cond_3
    iget v0, v7, Landroid/support/v4/app/f;->e:I

    iput v0, v6, Landroid/support/v4/app/e;->f:I

    iget v0, v7, Landroid/support/v4/app/f;->f:I

    iput v0, v6, Landroid/support/v4/app/e;->g:I

    iget v0, v7, Landroid/support/v4/app/f;->g:I

    iput v0, v6, Landroid/support/v4/app/e;->h:I

    iget v0, v7, Landroid/support/v4/app/f;->h:I

    iput v0, v6, Landroid/support/v4/app/e;->i:I

    invoke-virtual {v6, v7}, Landroid/support/v4/app/e;->a(Landroid/support/v4/app/f;)V
