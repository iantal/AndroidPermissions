...
public abstract interface zzo
  extends IInterface
{
  public abstract void zzf(zzf paramZzf)
    ...
    implements zzo
  {
    ...
    public static zzo zzih(IBinder paramIBinder)
    {
      ...
      throws RemoteException
    {
      ...
      zzf(zzf.zza.zzjk(paramParcel1.readStrongBinder()));
      ...
      implements zzo
    {
        ...
        throws RemoteException
      {
        ...
        //   30: aload_0
        //   31: getfield 18	com/google/android/gms/maps/internal/zzo$zza$zza:zzajq	Landroid/os/IBinder;
        //   34: iconst_1
        //   35: aload_2
        //   36: aload_3
        //   37: iconst_0
