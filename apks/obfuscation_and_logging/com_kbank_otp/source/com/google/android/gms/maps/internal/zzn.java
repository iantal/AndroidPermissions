...
public abstract interface zzn
  extends IInterface
{
  public abstract void zzg(zzf paramZzf)
    ...
    implements zzn
  {
    ...
    public static zzn zzig(IBinder paramIBinder)
    {
      ...
      throws RemoteException
    {
      ...
      zzg(zzf.zza.zzjk(paramParcel1.readStrongBinder()));
      ...
      implements zzn
    {
        ...
        throws RemoteException
      {
        ...
        //   30: aload_0
        //   31: getfield 18	com/google/android/gms/maps/internal/zzn$zza$zza:zzajq	Landroid/os/IBinder;
        //   34: iconst_1
        //   35: aload_2
        //   36: aload_3
        //   37: iconst_0
