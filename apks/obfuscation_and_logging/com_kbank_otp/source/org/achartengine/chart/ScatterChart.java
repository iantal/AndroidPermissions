  ...
  extends XYChart
{
  ...
  public void drawSeries(Canvas paramCanvas, Paint paramPaint, List<Float> paramList, SimpleSeriesRenderer paramSimpleSeriesRenderer, float paramFloat, int paramInt1, int paramInt2)
  {
    ...
    if (paramSimpleSeriesRenderer.isFillPoints())
    {
      paramPaint.setStyle(Paint.Style.FILL);
      paramInt2 = paramList.size();
      switch (1.$SwitchMap$org$achartengine$chart$PointStyle[paramSimpleSeriesRenderer.getPointStyle().ordinal()])
      {
      }
    }
    for (;;)
    {
      ...
      return;
      paramPaint.setStrokeWidth(paramSimpleSeriesRenderer.getPointStrokeWidth());
      paramPaint.setStyle(Paint.Style.STROKE);
      break;
      paramPaint.setStrokeWidth(paramSimpleSeriesRenderer.getPointStrokeWidth());
      paramInt1 = 0;
      ...
      paramSimpleSeriesRenderer = new float[6];
      paramInt1 = 0;
      while (paramInt1 < paramInt2)
      {
        drawTriangle(paramCanvas, paramPaint, paramSimpleSeriesRenderer, ((Float)paramList.get(paramInt1)).floatValue(), ((Float)paramList.get(paramInt1 + 1)).floatValue());
        paramInt1 += 2;
      }
      paramInt1 = 0;
      while (paramInt1 < paramInt2)
      ...
      paramSimpleSeriesRenderer = new float[8];
      paramInt1 = 0;
      while (paramInt1 < paramInt2)
      {
        drawDiamond(paramCanvas, paramPaint, paramSimpleSeriesRenderer, ((Float)paramList.get(paramInt1)).floatValue(), ((Float)paramList.get(paramInt1 + 1)).floatValue());
        paramInt1 += 2;
      }
      paramInt1 = 0;
      while (paramInt1 < paramInt2)
