  ...
  implements Serializable
{
  ...
  private ItemLabelAnchor(String paramString)
  {
  ...
  {
    ItemLabelAnchor localItemLabelAnchor = null;
    if (equals(CENTER)) {
      localItemLabelAnchor = CENTER;
    }
    do
    {
      return localItemLabelAnchor;
      if (equals(INSIDE1)) {
        return INSIDE1;
      }
      if (equals(INSIDE2)) {
  ...
  public boolean equals(Object paramObject)
  {
    ...
    {
      return true;
      if (!(paramObject instanceof ItemLabelAnchor)) {
        return false;
      }
      paramObject = (ItemLabelAnchor)paramObject;
