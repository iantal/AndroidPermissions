...
public final class FirebaseAnalytics
{
  ...
  public FirebaseAnalytics(ᒩ paramᒩ)
  {
  ...
  {
    return ᒩ.zzdx(paramContext).zzbaa();
  }
  ...
  {
    this.zziwf.zzazz().logEvent(paramString, paramBundle);
  }
  ...
  {
    this.zziwf.zzazz().setMeasurementEnabled(paramBoolean);
  }
  ...
  {
    this.zziwf.zzawq().setCurrentScreen(paramActivity, paramString1, paramString2);
  }
  
  public final void setMinimumSessionDuration(long paramLong)
  {
    this.zziwf.zzazz().setMinimumSessionDuration(paramLong);
  }
  
  public final void setSessionTimeoutDuration(long paramLong)
  {
    this.zziwf.zzazz().setSessionTimeoutDuration(paramLong);
  }
  
  public final void setUserId(String paramString)
  {
    this.zziwf.zzazz().setUserPropertyInternal("app", "_id", paramString);
  }
  ...
  {
    this.zziwf.zzazz().setUserProperty(paramString1, paramString2);
  }
