...
public final class ᴰ
{
  ...
  private static void zza(Parcel paramParcel, int paramInt1, int paramInt2)
  {
    ...
    if (paramInt1 != paramInt2)
    {
      ...
      throw new ﮢ(String.valueOf(str).length() + 46 + "Expected size " + paramInt2 + " got " + paramInt1 + " (0x" + str + ")", paramParcel);
    }
  }
  ...
  private static void zza(Parcel paramParcel, int paramInt1, int paramInt2, int paramInt3)
  {
    if (paramInt2 != paramInt3)
    {
      ...
      throw new ﮢ(String.valueOf(str).length() + 46 + "Expected size " + paramInt3 + " got " + paramInt2 + " (0x" + str + ")", paramParcel);
    }
  }
  ...
  public static void zzaf(Parcel paramParcel, int paramInt)
  {
    if (paramParcel.dataPosition() != paramInt) {
      throw new ﮢ(37 + "Overread allowed size end=" + paramInt, paramParcel);
    }
  }
  ...
  public static int zzd(Parcel paramParcel)
  {
    ...
    if ((0xFFFF & j) != 20293)
    {
      ...
      throw new ﮢ(str, paramParcel);
    }
    j = i + k;
    if ((j < i) || (j > paramParcel.dataSize())) {
      throw new ﮢ(54 + "Size read is invalid start=" + i + " end=" + j, paramParcel);
    }
    return j;
  }
