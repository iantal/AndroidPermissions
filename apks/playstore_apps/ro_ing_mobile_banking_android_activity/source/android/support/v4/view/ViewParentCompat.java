...
public final class ViewParentCompat
{
    ...
    extends ViewParentCompat.ViewParentCompatApi19Impl
  {
    ...
    public boolean onNestedFling(ViewParent paramViewParent, View paramView, float paramFloat1, float paramFloat2, boolean paramBoolean)
    {
      ...
      {
        Log.e("ViewParentCompat", new StringBuilder("ViewParent ").append(paramViewParent).append(" does not implement interface method onNestedFling").toString(), paramView);
      }
      return false;
    }
    ...
    public boolean onNestedPreFling(ViewParent paramViewParent, View paramView, float paramFloat1, float paramFloat2)
    {
      ...
      {
        Log.e("ViewParentCompat", new StringBuilder("ViewParent ").append(paramViewParent).append(" does not implement interface method onNestedPreFling").toString(), paramView);
      }
      return false;
    }
    ...
    public void onNestedPreScroll(ViewParent paramViewParent, View paramView, int paramInt1, int paramInt2, int[] paramArrayOfInt)
    {
      ...
      {
        Log.e("ViewParentCompat", new StringBuilder("ViewParent ").append(paramViewParent).append(" does not implement interface method onNestedPreScroll").toString(), paramView);
      }
    }
    ...
    public void onNestedScroll(ViewParent paramViewParent, View paramView, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
    {
      ...
      {
        Log.e("ViewParentCompat", new StringBuilder("ViewParent ").append(paramViewParent).append(" does not implement interface method onNestedScroll").toString(), paramView);
      }
    }
    ...
    public void onNestedScrollAccepted(ViewParent paramViewParent, View paramView1, View paramView2, int paramInt)
    {
      ...
      {
        Log.e("ViewParentCompat", new StringBuilder("ViewParent ").append(paramViewParent).append(" does not implement interface method onNestedScrollAccepted").toString(), paramView1);
      }
    }
    ...
    public boolean onStartNestedScroll(ViewParent paramViewParent, View paramView1, View paramView2, int paramInt)
    {
      ...
      {
        Log.e("ViewParentCompat", new StringBuilder("ViewParent ").append(paramViewParent).append(" does not implement interface method onStartNestedScroll").toString(), paramView1);
      }
      return false;
    }
    ...
    public void onStopNestedScroll(ViewParent paramViewParent, View paramView)
    {
      ...
      {
        Log.e("ViewParentCompat", new StringBuilder("ViewParent ").append(paramViewParent).append(" does not implement interface method onStopNestedScroll").toString(), paramView);
      }
    }
  }
