      ...
      if (localView != null)
      {
        ...
        if (!bool)
        {
          ...
          if ((localView instanceof TextView)) {
            ...
            throw new IllegalStateException(new StringBuilder().append(localView.getClass().getName()).append(" is not a  view that can be bounds by this SimpleCursorAdapter").toString());
          }
        }
      }
      i += 1;
