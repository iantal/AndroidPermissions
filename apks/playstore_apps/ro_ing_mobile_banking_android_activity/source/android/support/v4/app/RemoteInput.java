  ...
  extends RemoteInputCompatBase.RemoteInput
{
  ...
  {
    public final RemoteInput build(String paramAnonymousString, CharSequence paramAnonymousCharSequence, CharSequence[] paramAnonymousArrayOfCharSequence, boolean paramAnonymousBoolean, Bundle paramAnonymousBundle, Set<String> paramAnonymousSet)
    {
  ...
  public static final class Builder
  {
    ...
    public final Builder setAllowDataType(String paramString, boolean paramBoolean)
    {
      if (paramBoolean)
      {
