  ...
  implements TabHost.OnTabChangeListener
{
  ...
  private void ensureContent()
  {
    if (this.mRealTabContent == null)
    {
      ...
      if (this.mRealTabContent == null) {
        throw new IllegalStateException(new StringBuilder("No tab content FrameLayout found for id ").append(this.mContainerId).toString());
      }
    }
  }
    ...
    extends View.BaseSavedState
  {
    ...
    {
      return new StringBuilder("FragmentTabHost.SavedState{").append(Integer.toHexString(System.identityHashCode(this))).append(" curTab=").append(this.curTab).append("}").toString();
    }
