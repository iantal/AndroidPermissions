  ...
  implements Parcelable
{
  ...
  public final MediaDescriptionCompat getDescription()
  {
    ...
    else
    {
      int j = 0;
      int k;
      for (i = 0; (j < 3) && (i < PREFERRED_DESCRIPTION_ORDER.length); i = k)
      {
  ...
  public static final class Builder
  {
    ...
    public final Builder putBitmap(String paramString, Bitmap paramBitmap)
    {
      if ((MediaMetadataCompat.METADATA_KEYS_TYPE.containsKey(paramString)) && (((Integer)MediaMetadataCompat.METADATA_KEYS_TYPE.get(paramString)).intValue() != 2)) {
        throw new IllegalArgumentException(new StringBuilder("The ").append(paramString).append(" key cannot be used to put a Bitmap").toString());
      }
    ...
    public final Builder putLong(String paramString, long paramLong)
    {
      if ((MediaMetadataCompat.METADATA_KEYS_TYPE.containsKey(paramString)) && (((Integer)MediaMetadataCompat.METADATA_KEYS_TYPE.get(paramString)).intValue() != 0)) {
        throw new IllegalArgumentException(new StringBuilder("The ").append(paramString).append(" key cannot be used to put a long").toString());
      }
    ...
    public final Builder putRating(String paramString, RatingCompat paramRatingCompat)
    {
      if ((MediaMetadataCompat.METADATA_KEYS_TYPE.containsKey(paramString)) && (((Integer)MediaMetadataCompat.METADATA_KEYS_TYPE.get(paramString)).intValue() != 3)) {
        throw new IllegalArgumentException(new StringBuilder("The ").append(paramString).append(" key cannot be used to put a Rating").toString());
      }
      if (Build.VERSION.SDK_INT >= 19)
      {
    ...
    public final Builder putString(String paramString1, String paramString2)
    {
      if ((MediaMetadataCompat.METADATA_KEYS_TYPE.containsKey(paramString1)) && (((Integer)MediaMetadataCompat.METADATA_KEYS_TYPE.get(paramString1)).intValue() != 1)) {
        throw new IllegalArgumentException(new StringBuilder("The ").append(paramString1).append(" key cannot be used to put a String").toString());
      }
    ...
    public final Builder putText(String paramString, CharSequence paramCharSequence)
    {
      if ((MediaMetadataCompat.METADATA_KEYS_TYPE.containsKey(paramString)) && (((Integer)MediaMetadataCompat.METADATA_KEYS_TYPE.get(paramString)).intValue() != 1)) {
        throw new IllegalArgumentException(new StringBuilder("The ").append(paramString).append(" key cannot be used to put a CharSequence").toString());
      }
