  ...
  extends Service
{
  ...
  void performCustomAction(String paramString, Bundle paramBundle, ConnectionRecord paramConnectionRecord, final ResultReceiver paramResultReceiver)
  {
    ...
    if (!paramResultReceiver.isDone()) {
      throw new IllegalStateException(new StringBuilder("onCustomAction must call detach() or sendResult() or sendError() before returning for action=").append(paramString).append(" extras=").append(paramBundle).toString());
    }
  }
  ...
  void performLoadChildren(final String paramString, final ConnectionRecord paramConnectionRecord, final Bundle paramBundle)
  {
      ...
      void onResultSent(List<MediaBrowserCompat.MediaItem> paramAnonymousList)
      {
        if (MediaBrowserServiceCompat.this.mConnections.get(paramConnectionRecord.callbacks.asBinder()) != paramConnectionRecord)
        {
          if (MediaBrowserServiceCompat.DEBUG) {
            Log.d("MBServiceCompat", new StringBuilder("Not sending onLoadChildren result for connection that has been disconnected. pkg=").append(paramConnectionRecord.pkg).append(" id=").append(paramString).toString());
          }
          return;
        }
        if ((getFlags() & 0x1) != 0) {
        ...
        Log.w("MBServiceCompat", new StringBuilder("Calling onLoadChildren() failed for id=").append(paramString).append(" package=").append(paramConnectionRecord.pkg).toString());
      }
    };
    this.mCurConnection = paramConnectionRecord;
    if (paramBundle == null) {
    ...
    this.mCurConnection = null;
    if (!local1.isDone()) {
      throw new IllegalStateException(new StringBuilder("onLoadChildren must call detach() or sendResult() before returning for package=").append(paramConnectionRecord.pkg).append(" id=").append(paramString).toString());
    }
  }
  ...
  void performLoadItem(String paramString, ConnectionRecord paramConnectionRecord, final ResultReceiver paramResultReceiver)
  {
    ...
    this.mCurConnection = null;
    if (!paramResultReceiver.isDone()) {
      throw new IllegalStateException("onLoadItem must call detach() or sendResult() before returning for id=".concat(String.valueOf(paramString)));
    }
  }
  ...
  void performSearch(String paramString, Bundle paramBundle, ConnectionRecord paramConnectionRecord, final ResultReceiver paramResultReceiver)
  {
    ...
    this.mCurConnection = null;
    if (!paramResultReceiver.isDone()) {
      throw new IllegalStateException("onSearch must call detach() or sendResult() before returning for query=".concat(String.valueOf(paramString)));
    }
  }
      ...
      MediaBrowserServiceCompat.this.mHandler.post(new Runnable()
      {
        public void run()
        {
          ...
          while (localIterator.hasNext())
          {
            ...
            Log.w("MBServiceCompat", new StringBuilder("Connection for ").append(localConnectionRecord.pkg).append(" is no longer valid.").toString());
            localIterator.remove();
          }
        }
      });
  ...
  public static class Result<T>
  {
    ...
    public void detach()
    {
      ...
      if (this.mSendErrorCalled) {
        throw new IllegalStateException(new StringBuilder("detach() called when sendError() had already been called for: ").append(this.mDebug).toString());
      }
    ...
    {
      throw new UnsupportedOperationException(new StringBuilder("It is not supported to send an error for ").append(this.mDebug).toString());
    }
    
    void onProgressUpdateSent(Bundle paramBundle)
    {
      throw new UnsupportedOperationException(new StringBuilder("It is not supported to send an interim update for ").append(this.mDebug).toString());
    }
    ...
    public void sendError(Bundle paramBundle)
    {
      if ((this.mSendResultCalled) || (this.mSendErrorCalled)) {
        throw new IllegalStateException(new StringBuilder("sendError() called when either sendResult() or sendError() had already been called for: ").append(this.mDebug).toString());
      }
    ...
    {
      if ((this.mSendResultCalled) || (this.mSendErrorCalled)) {
        throw new IllegalStateException(new StringBuilder("sendProgressUpdate() called when either sendResult() or sendError() had already been called for: ").append(this.mDebug).toString());
      }
    ...
    {
      if ((this.mSendResultCalled) || (this.mSendErrorCalled)) {
        throw new IllegalStateException(new StringBuilder("sendResult() called when either sendResult() or sendError() had already been called for: ").append(this.mDebug).toString());
      }
  ...
  class ServiceBinderImpl
  {
    ...
    public void addSubscription(final String paramString, final IBinder paramIBinder, final Bundle paramBundle, final MediaBrowserServiceCompat.ServiceCallbacks paramServiceCallbacks)
    {
      MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable()
      {
        public void run()
        {
          ...
          if (localObject == null)
          {
            Log.w("MBServiceCompat", new StringBuilder("addSubscription for callback that isn't registered id=").append(paramString).toString());
            return;
          }
    ...
    public void connect(final String paramString, final int paramInt, final Bundle paramBundle, final MediaBrowserServiceCompat.ServiceCallbacks paramServiceCallbacks)
    {
      if (!MediaBrowserServiceCompat.this.isValidPackage(paramString, paramInt)) {
        throw new IllegalArgumentException(new StringBuilder("Package/uid mismatch: uid=").append(paramInt).append(" package=").append(paramString).toString());
      }
      MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable()
      {
        public void run()
        {
          ...
          if (localConnectionRecord.root == null) {
            Log.i("MBServiceCompat", new StringBuilder("No root for client ").append(paramString).append(" from service ").append(getClass().getName()).toString());
          }
          try
          {
          ...
          Log.w("MBServiceCompat", new StringBuilder("Calling onConnectFailed() failed. Ignoring. pkg=").append(paramString).toString());
          return;
          try
          {
          ...
          Log.w("MBServiceCompat", new StringBuilder("Calling onConnect() failed. Dropping client. pkg=").append(paramString).toString());
          MediaBrowserServiceCompat.this.mConnections.remove(localIBinder);
        }
      });
    }
    ...
    public void getMediaItem(final String paramString, final ResultReceiver paramResultReceiver, final MediaBrowserServiceCompat.ServiceCallbacks paramServiceCallbacks)
    {
      ...
      MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable()
      {
        public void run()
        {
          ...
          if (localObject == null)
          {
            Log.w("MBServiceCompat", new StringBuilder("getMediaItem for callback that isn't registered id=").append(paramString).toString());
            return;
          }
    ...
    public void removeSubscription(final String paramString, final IBinder paramIBinder, final MediaBrowserServiceCompat.ServiceCallbacks paramServiceCallbacks)
    {
      MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable()
      {
        public void run()
        {
          ...
          if (localObject == null)
          {
            Log.w("MBServiceCompat", new StringBuilder("removeSubscription for callback that isn't registered id=").append(paramString).toString());
            return;
          }
          if (!MediaBrowserServiceCompat.this.removeSubscription(paramString, (MediaBrowserServiceCompat.ConnectionRecord)localObject, paramIBinder)) {
            Log.w("MBServiceCompat", new StringBuilder("removeSubscription called for ").append(paramString).append(" which is not subscribed").toString());
          }
        }
      });
    }
    ...
    public void search(final String paramString, final Bundle paramBundle, final ResultReceiver paramResultReceiver, final MediaBrowserServiceCompat.ServiceCallbacks paramServiceCallbacks)
    {
      ...
      MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable()
      {
        public void run()
        {
          ...
          if (localObject == null)
          {
            Log.w("MBServiceCompat", new StringBuilder("search for callback that isn't registered query=").append(paramString).toString());
            return;
          }
    ...
    public void sendCustomAction(final String paramString, final Bundle paramBundle, final ResultReceiver paramResultReceiver, final MediaBrowserServiceCompat.ServiceCallbacks paramServiceCallbacks)
    {
      ...
      MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable()
      {
        public void run()
        {
          ...
          if (localObject == null)
          {
            Log.w("MBServiceCompat", new StringBuilder("sendCustomAction for callback that isn't registered action=").append(paramString).append(", extras=").append(paramBundle).toString());
            return;
          }
  ...
  static abstract interface ServiceCallbacks
  {
  ...
  static class ServiceCallbacksCompat
    ...
    extends Handler
  {
    ...
    public final void handleMessage(Message paramMessage)
    {
      ...
      Log.w("MBServiceCompat", new StringBuilder("Unhandled message: ").append(paramMessage).append("\n  Service version: 1\n  Client version: ").append(paramMessage.arg1).toString());
    }
