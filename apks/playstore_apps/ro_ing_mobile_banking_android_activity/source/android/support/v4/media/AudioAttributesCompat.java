...
public class AudioAttributesCompat
{
  ...
  private static boolean sForceLegacyBehavior = false;
  ...
  static int toVolumeStreamType(boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    if (paramBoolean) {
      throw new IllegalArgumentException(new StringBuilder("Unknown usage value ").append(paramInt2).append(" in audio attributes").toString());
    }
    return 3;
  }
  ...
  static String usageToString(int paramInt)
  {
    ...
    return new String("unknown usage ".concat(String.valueOf(paramInt)));
  }
  ...
  public boolean equals(Object paramObject)
  {
    ...
    if ((Build.VERSION.SDK_INT >= 21) && (!sForceLegacyBehavior) && (this.mAudioAttributesWrapper != null)) {
      return this.mAudioAttributesWrapper.unwrap().equals(paramObject.unwrap());
    }
    return (this.mContentType == paramObject.getContentType()) && (this.mFlags == paramObject.getFlags()) && (this.mUsage == paramObject.getUsage()) && (this.mLegacyStream != null ? this.mLegacyStream.equals(paramObject.mLegacyStream) : paramObject.mLegacyStream == null);
  }
