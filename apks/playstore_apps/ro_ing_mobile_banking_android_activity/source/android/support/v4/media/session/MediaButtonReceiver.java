  ...
  extends BroadcastReceiver
{
  ...
  public static PendingIntent buildMediaButtonPendingIntent(Context paramContext, ComponentName paramComponentName, long paramLong)
  {
    ...
    if (i == 0)
    {
      Log.w("MediaButtonReceiver", "Cannot build a media button pending intent with the given action: ".concat(String.valueOf(paramLong)));
      return null;
    }
  ...
  private static ComponentName getServiceComponentByAction(Context paramContext, String paramString)
  {
    ...
    throw new IllegalStateException(new StringBuilder("Expected 1 service that handles ").append(paramString).append(", found ").append(paramContext.size()).toString());
  }
  ...
  static class MediaButtonConnectionCallback
