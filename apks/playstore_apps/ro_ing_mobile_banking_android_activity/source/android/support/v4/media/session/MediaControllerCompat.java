...
public final class MediaControllerCompat
{
  ...
  private static void validateCustomAction(String paramString, Bundle paramBundle)
  {
    ...
    if ((paramBundle == null) || (!paramBundle.containsKey("android.support.v4.media.session.ARGUMENT_MEDIA_ATTRIBUTE"))) {
      throw new IllegalArgumentException(new StringBuilder("An extra field android.support.v4.media.session.ARGUMENT_MEDIA_ATTRIBUTE is required for this action ").append(paramString).append(".").toString());
    }
  }
  ...
  public final void addQueueItem(MediaDescriptionCompat paramMediaDescriptionCompat, int paramInt)
  {
  ...
  public final void registerCallback(@NonNull Callback paramCallback)
  {
    registerCallback(paramCallback, null);
  }
  
  public final void registerCallback(@NonNull Callback paramCallback, Handler paramHandler)
  {
  ...
  public final void sendCommand(@NonNull String paramString, Bundle paramBundle, ResultReceiver paramResultReceiver)
  {
  ...
  public final void unregisterCallback(@NonNull Callback paramCallback)
  {
    if (paramCallback == null) {
      throw new IllegalArgumentException("callback must not be null");
    }
  ...
  static class MediaControllerExtraData
