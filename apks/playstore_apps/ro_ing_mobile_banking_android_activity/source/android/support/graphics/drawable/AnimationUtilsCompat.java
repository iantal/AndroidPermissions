...
public class AnimationUtilsCompat
{
  ...
  private static Interpolator createInterpolatorFromXml(Context paramContext, Resources paramResources, Resources.Theme paramTheme, XmlPullParser paramXmlPullParser)
  {
    ...
    throw new RuntimeException(new StringBuilder("Unknown interpolator name: ").append(paramXmlPullParser.getName()).toString());
    return paramResources;
  }
  ...
  public static Interpolator loadInterpolator(Context paramContext, int paramInt)
  {
    ...
    catch (XmlPullParserException paramContext)
    {
      ...
      localObject3 = new Resources.NotFoundException(new StringBuilder("Can't load animation resource ID #0x").append(Integer.toHexString(paramInt)).toString());
      localObject1 = localObject2;
      ((Throwable)localObject3).initCause(paramContext);
      localObject1 = localObject2;
    ...
    catch (IOException paramContext)
    {
      ...
      localObject2 = new Resources.NotFoundException(new StringBuilder("Can't load animation resource ID #0x").append(Integer.toHexString(paramInt)).toString());
      localObject1 = localObject3;
      ((Throwable)localObject2).initCause(paramContext);
      localObject1 = localObject3;
    ...
    paramContext = createInterpolatorFromXml(paramContext, paramContext.getResources(), paramContext.getTheme(), localXmlResourceParser);
