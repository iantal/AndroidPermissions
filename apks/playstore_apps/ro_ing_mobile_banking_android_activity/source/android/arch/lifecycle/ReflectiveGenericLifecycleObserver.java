  ...
  implements GenericLifecycleObserver
{
  ...
  private static void verifyAndPutHandler(Map<MethodReference, Lifecycle.Event> paramMap, MethodReference paramMethodReference, Lifecycle.Event paramEvent, Class paramClass)
  {
    ...
    if ((localEvent != null) && (paramEvent != localEvent))
    {
      ...
      throw new IllegalArgumentException(new StringBuilder("Method ").append(paramMap.getName()).append(" in ").append(paramClass.getName()).append(" already declared with different @OnLifecycleEvent value: previous value ").append(localEvent).append(", new value ").append(paramEvent).toString());
    }
    if (localEvent == null) {
