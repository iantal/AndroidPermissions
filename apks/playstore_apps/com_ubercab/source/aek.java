...
public class aek
{
  ...
  public static Rect a(Drawable paramDrawable)
  {
    if (b != null)
    {
      for (;;)
      {
        try
        {
          paramDrawable = ny.h(paramDrawable);
  ...
  public static boolean c(Drawable paramDrawable)
  {
    ...
    else
    {
      if ((paramDrawable instanceof nz)) {
        return c(((nz)paramDrawable).a());
      }
      if ((paramDrawable instanceof zu)) {
        return c(((zu)paramDrawable).b());
      }
  ...
  private static void d(Drawable paramDrawable)
  {
    ...
    if ((arrayOfInt != null) && (arrayOfInt.length != 0)) {
      paramDrawable.setState(ahw.h);
    } else {
      paramDrawable.setState(ahw.e);
    }
