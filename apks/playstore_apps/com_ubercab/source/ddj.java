...
public final class ddj
  ...
  implements ddi
{
  private static WeakHashMap<Activity, WeakReference<ddj>> a = new WeakHashMap();
  ...
  public static ddj a(Activity paramActivity)
  {
    Object localObject = (WeakReference)a.get(paramActivity);
    if (localObject != null)
    {
      localObject = (ddj)((WeakReference)localObject).get();
      if (localObject != null) {
        return localObject;
      }
    }
    try
    {
      ddj localDdj = (ddj)paramActivity.getFragmentManager().findFragmentByTag("LifecycleFragmentImpl");
      if (localDdj != null)
      {
        localObject = localDdj;
        if (!localDdj.isRemoving()) {}
      }
      else
      {
        localObject = new ddj();
  ...
  public final void a(String paramString, LifecycleCallback paramLifecycleCallback)
  {
    if (!this.b.containsKey(paramString))
    {
      ...
      if (this.c > 0) {
        new Handler(Looper.getMainLooper()).post(new ddk(this, paramLifecycleCallback, paramString));
      }
      return;
    }
