  ...
  implements apk<amv>
{
  ...
  private int a(double paramDouble, double[] paramArrayOfDouble1, double[] paramArrayOfDouble2)
  {
    ...
    while (i < paramArrayOfDouble1.length)
    {
      ...
      if (paramArrayOfDouble1[i] >= paramDouble)
      {
        ...
        return (int)(apo.a(paramArrayOfDouble2[j], paramArrayOfDouble2[i], paramDouble) * 255.0D);
      }
      i += 1;
    }
  ...
  private void a(amv paramAmv, List<Float> paramList)
  {
    int i = this.a * 4;
    if (paramList.size() <= i) {
      return;
    ...
    {
      i = paramAmv.b()[j];
      i = Color.argb(a(paramAmv.a()[j], arrayOfDouble1, arrayOfDouble2), Color.red(i), Color.green(i), Color.blue(i));
      paramAmv.b()[j] = i;
      j += 1;
    }
  }
  
  public amv a(JsonReader paramJsonReader, float paramFloat)
    throws IOException
  {
    ...
    paramJsonReader = new amv(paramJsonReader, (int[])localObject1);
