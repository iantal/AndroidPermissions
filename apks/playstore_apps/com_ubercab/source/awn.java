public class awn
{
  ...
  {
    if (a.a(2)) {
      a.a(a(paramClass), a(paramString, new Object[] { paramObject }));
    }
  }
  ...
  {
    if (a.a(2)) {
      a.a(a(paramClass), a(paramString, new Object[] { paramObject1, paramObject2 }));
    }
  }
  
  public static void a(Class<?> paramClass, String paramString, Object paramObject1, Object paramObject2, Object paramObject3)
  {
    if (a(2)) {
      a(paramClass, a(paramString, new Object[] { paramObject1, paramObject2, paramObject3 }));
    }
  }
  
  public static void a(Class<?> paramClass, String paramString, Object paramObject1, Object paramObject2, Object paramObject3, Object paramObject4)
  {
    if (a.a(2)) {
      a.a(a(paramClass), a(paramString, new Object[] { paramObject1, paramObject2, paramObject3, paramObject4 }));
    }
  }
  ...
  {
    if (a(5)) {
      a(paramClass, a(paramString, paramVarArgs), paramThrowable);
    }
  }
  ...
  {
    if (a.a(3)) {
      a.b(a(paramClass), a(paramString, new Object[] { paramObject }));
    }
  }
  ...
  {
    if (a.a(6)) {
      a.c(a(paramClass), paramString, paramThrowable);
    }
  }
  ...
  {
    if (a.a(5)) {
      a.d(a(paramClass), a(paramString, paramVarArgs));
    }
  }
  ...
  {
    if (a.a(6)) {
      a.c(a(paramClass), a(paramString, paramVarArgs), paramThrowable);
    }
  }
  ...
  {
    if (a.a(6)) {
      a.d(a(paramClass), paramString, paramThrowable);
    }
  }
  ...
  {
    if (a.a(6)) {
      a.e(a(paramClass), a(paramString, paramVarArgs));
    }
  }
  ...
  {
    if (a.a(6)) {
      a.f(a(paramClass), a(paramString, paramVarArgs));
    }
  }
