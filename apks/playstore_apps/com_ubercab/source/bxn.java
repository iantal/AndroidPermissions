...
public class bxn
{
  ...
  public static void a(double[] paramArrayOfDouble, bxo paramBxo)
  {
    boolean bool;
    ...
    bky.a(bool);
    double[] arrayOfDouble2 = paramBxo.a;
    double[] arrayOfDouble1 = paramBxo.b;
    Object localObject = paramBxo.c;
    double[] arrayOfDouble3 = paramBxo.d;
    paramBxo = paramBxo.e;
    ...
    else
    {
      ...
      paramArrayOfDouble = c(b(arrayOfDouble4));
      b(new double[] { d1, d2, d3, d4 }, paramArrayOfDouble, arrayOfDouble2);
    }
    i = 0;
    while (i < 3)
    {
    ...
    arrayOfDouble1[0] = d(paramArrayOfDouble[0]);
    paramArrayOfDouble[0] = a(paramArrayOfDouble[0], arrayOfDouble1[0]);
    ...
    localObject[0] = a(paramArrayOfDouble[0], paramArrayOfDouble[1]);
    paramArrayOfDouble[1] = a(paramArrayOfDouble[1], paramArrayOfDouble[0], 1.0D, -localObject[0]);
    arrayOfDouble1[1] = d(paramArrayOfDouble[1]);
    paramArrayOfDouble[1] = a(paramArrayOfDouble[1], arrayOfDouble1[1]);
    ...
    arrayOfDouble1[2] = d(paramArrayOfDouble[2]);
    paramArrayOfDouble[2] = a(paramArrayOfDouble[2], arrayOfDouble1[2]);
    ...
    paramBxo[0] = a(-Math.atan2(paramArrayOfDouble[2][1], paramArrayOfDouble[2][2]) * 57.29577951308232D);
    paramBxo[1] = a(-Math.atan2(-paramArrayOfDouble[2][0], Math.sqrt(paramArrayOfDouble[2][1] * paramArrayOfDouble[2][1] + paramArrayOfDouble[2][2] * paramArrayOfDouble[2][2])) * 57.29577951308232D);
    paramBxo[2] = a(-Math.atan2(paramArrayOfDouble[1][0], paramArrayOfDouble[0][0]) * 57.29577951308232D);
  }
