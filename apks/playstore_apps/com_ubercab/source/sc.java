  ...
  implements sb
{
  ...
  public sc(Context paramContext, GestureDetector.OnGestureListener paramOnGestureListener, Handler paramHandler)
  {
    if (paramHandler != null) {
      this.m = new sd(this, paramHandler);
    } else {
      this.m = new sd(this);
    }
  ...
  public boolean a(MotionEvent paramMotionEvent)
  {
    ...
    if (this.b != null)
    {
      ...
      if ((this.e != null) && (this.q != null) && (bool2) && (a(this.e, this.q, paramMotionEvent)))
      {
        this.r = true;
    ...
    boolean bool2 = bool1 | this.a.onDown(paramMotionEvent);
    label1161:
    return bool2;
  }
}
