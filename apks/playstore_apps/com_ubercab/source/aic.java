...
public class aic
{
  ...
  private aic(Context paramContext, TypedArray paramTypedArray)
  {
    this.a = paramContext;
    this.b = paramTypedArray;
  }
  
  public static aic a(Context paramContext, int paramInt, int[] paramArrayOfInt)
  {
    return new aic(paramContext, paramContext.obtainStyledAttributes(paramInt, paramArrayOfInt));
  }
  
  public static aic a(Context paramContext, AttributeSet paramAttributeSet, int[] paramArrayOfInt)
  {
    return new aic(paramContext, paramContext.obtainStyledAttributes(paramAttributeSet, paramArrayOfInt));
  }
  
  public static aic a(Context paramContext, AttributeSet paramAttributeSet, int[] paramArrayOfInt, int paramInt1, int paramInt2)
  {
    return new aic(paramContext, paramContext.obtainStyledAttributes(paramAttributeSet, paramArrayOfInt, paramInt1, paramInt2));
  }
  ...
  public Typeface a(int paramInt1, int paramInt2, nk paramNk)
  {
    ...
    return nj.a(this.a, paramInt1, this.c, paramInt2, paramNk);
  }
  ...
  public Drawable b(int paramInt)
  {
    if (this.b.hasValue(paramInt))
    {
      ...
      if (paramInt != 0) {
        return adg.a().a(this.a, paramInt, true);
      }
    }
    return null;
  }
  ...
  public ColorStateList e(int paramInt)
  {
    if (this.b.hasValue(paramInt))
    {
      ...
      if (i != 0)
      {
        ColorStateList localColorStateList = zr.a(this.a, i);
