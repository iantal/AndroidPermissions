  ...
  implements Parcelable
{
  ...
  protected static ThreeDSecureInfo a(JSONObject paramJSONObject)
  {
    JSONObject localJSONObject = paramJSONObject;
    if (paramJSONObject == null) {
      localJSONObject = new JSONObject();
    }
    paramJSONObject = new ThreeDSecureInfo();
    paramJSONObject.a = localJSONObject.optBoolean("liabilityShifted");
    paramJSONObject.b = localJSONObject.optBoolean("liabilityShiftPossible");
    boolean bool;
    if ((localJSONObject.has("liabilityShifted")) && (localJSONObject.has("liabilityShiftPossible"))) {
      bool = true;
    } else {
      bool = false;
    }
