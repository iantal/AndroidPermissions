  ...
  implements h
{
  ...
  public p()
  {
    a.put(fw.a, "Aceptar y pagar");
    a.put(fw.b, "y otro");
    a.put(fw.c, "Autenticando");
    a.put(fw.d, "Atrás");
    a.put(fw.e, "Respaldo");
    a.put(fw.f, "Cancelar");
    ...
    a.put(fw.v, "Visa");
    a.put(fw.w, "Cambiar forma de pago");
    a.put(fw.x, "De cheques");
    a.put(fw.y, "Comprobando este dispositivo…");
    a.put(fw.z, "Borrar los datos de la tarjeta");
    a.put(fw.A, "Confirmar");
    a.put(fw.B, "¿Seguro que desea borrar los datos de su tarjeta?");
    a.put(fw.C, "Cargar en tarjeta");
    a.put(fw.D, "¿Seguro que desea cerrar la sesión de PayPal?");
    a.put(fw.E, "Pagar");
    a.put(fw.F, "Aceptar");
    a.put(fw.G, "Fecha de creación de la cuenta");
    a.put(fw.H, "Estado de la cuenta");
    a.put(fw.I, "Tipo de cuenta");
    a.put(fw.J, "Dirección");
    a.put(fw.K, "Rango de edad");
    a.put(fw.L, "Fecha de nacimiento");
    a.put(fw.M, "Dirección de correo electrónico");
    a.put(fw.N, "Nombre completo");
    a.put(fw.O, "Sexo");
    a.put(fw.P, "Idioma");
    a.put(fw.Q, "Idioma");
    a.put(fw.R, "Teléfono");
    a.put(fw.S, "Zona horaria");
    a.put(fw.T, "Compartir lo siguiente: %s.");
    a.put(fw.U, "Utilizar One Touch™");
    a.put(fw.V, "%s le solicita que usted:");
    a.put(fw.W, "Comparta las <a href='%1$s'>formas de pago</a> asociadas a su cuenta PayPal.");
    a.put(fw.X, "Active la visualización de sus formas de pago para que pueda elegir cuál utilizar.");
    a.put(fw.Y, "<a href='%1$s'>Autorice cargos</a> correspondientes a futuras compras en %2$s pagadas con PayPal. Indique a PayPal que pague todos los importes solicitados por %3$s.");
    a.put(fw.Z, "Le permita agregar y administrar su tarjeta de lealtad en su cartera de PayPal.");
    a.put(fw.aa, "Acepte la <a href='%2$s'>Política de Privacidad</a> y las <a href='%3$s'>Condiciones de Uso</a> de %1$s.");
    a.put(fw.ab, "Le permita <a href='%1$s'>solicitar pagos</a> en su nombre hasta que usted retire dicho permiso.");
    a.put(fw.ac, "Le permita <a href='%1$s'>enviar pagos</a> en su nombre hasta que usted retire dicho permiso.");
    a.put(fw.ad, "Permiso");
    a.put(fw.ae, "Correo electrónico");
    a.put(fw.af, "Datos de prueba");
    a.put(fw.ag, "Sandbox");
    a.put(fw.ah, "Vence");
    a.put(fw.ai, "<h1><strong>Formas de pago</strong></h1><p>PayPal solo comparte las formas de pago que están disponibles para su utilización.</p>");
    a.put(fw.aj, "¿Ha olvidado su contraseña?");
    a.put(fw.ak, "De");
    a.put(fw.al, "¿Con qué forma de pago le gustaría hacer los pagos futuros a %1$s?");
    a.put(fw.am, "<h1><strong>Acuerdo de pago futuro</strong></h1><p>Su forma de pago predeterminada se utilizará para realizar futuros pagos con PayPal de este vendedor.</p><p>Para cancelar este acuerdo, inicie sesión en su cuenta PayPal, vaya a <strong>Perfil</strong> &gt; <strong>Mi configuración</strong> &gt; <strong>Iniciar sesión con PayPal</strong> y elimine a este comercio de la lista.</p><p>Aplicará el artículo Pagos recurrentes de las <a href='%s'>Condiciones de Uso de PayPal</a>.</p><p>Para garantizar que los pagos con su cuenta PayPal funcionen correctamente, esta aplicación puede simular una pequeña transacción de prueba, pero no se transferirá dinero.</p>");
    a.put(fw.an, "Error interno");
    a.put(fw.ao, "<p>Al hacer clic en el botón a continuación, por el presente documento acepto los términos de las <a href='%1$s'>Condiciones de Uso de PayPal</a> y declaro que cumplo las leyes y normas japonesas, incluidas las sanciones contra pagos a Corea del Norte e Irán de conformidad con la <a href='%2$s'>Ley de divisas y comercio exterior</a> para realizar la transacción.</p>");
    a.put(fw.ap, "Iniciar sesión");
    a.put(fw.aq, "Iniciar sesión con Paypal");
    a.put(fw.ar, "Cerrar sesión");
    a.put(fw.as, "Cerrar sesión");
    a.put(fw.at, "Aceptar");
    a.put(fw.au, "Contraseña");
    a.put(fw.av, "Pago tras la entrega");
    a.put(fw.aw, "Pagar con");
    a.put(fw.ax, "Pagar con tarjeta");
    a.put(fw.ay, "Saldo PayPal");
    a.put(fw.az, "PayPal Credit");
    a.put(fw.aA, "Teléfono");
    a.put(fw.aB, "NIP");
    a.put(fw.aC, "Forma de pago preferida");
    a.put(fw.aD, "PayPal protege su <a href='%s'>privacidad</a> y sus datos financieros.");
    a.put(fw.aE, "Procesando");
    a.put(fw.aF, "Recordar tarjeta");
    a.put(fw.aG, "Solicitar pago");
    a.put(fw.aH, "<h1><strong>%s</strong></h1><p>Todos los detalles relevantes de la transacción se compartirán con el comercio.</p><p>Para retirar el permiso, inicie sesión en paypal.com y luego vaya a las opciones <strong>Iniciar sesión con PayPal</strong> en la sección de configuración del <strong>Perfil</strong> y elimine a este comercio.</p><p>PayPal no se responsabiliza de ninguna acción o error cometido por el partner.</p>");
    a.put(fw.aI, "De ahorros");
    a.put(fw.aJ, "Enviar un pago");
    a.put(fw.aK, "Hay problema en la comunicación con los servidores de PayPal. Inténtelo de nuevo.");
    a.put(fw.aL, "Inicie sesión de nuevo en PayPal.");
    a.put(fw.aM, "Sesión caducada");
    a.put(fw.aN, "Dirección de envío");
    a.put(fw.aO, "¿Usuario nuevo de PayPal? Registrarse");
    a.put(fw.aP, "Mantener abierta la sesión");
    a.put(fw.aQ, "Error del sistema (%s). Inténtelo de nuevo más tarde.");
    a.put(fw.aR, "Inténtelo de nuevo");
    a.put(fw.aS, "No puede iniciar sesión porque la autenticación de dos factores ha sido activada para su cuenta.");
    a.put(fw.aT, "Código de seguridad");
    a.put(fw.aU, "Enviar mensaje de texto a su teléfono. El código de 6 dígitos que reciba será válido durante 5 minutos.");
    a.put(fw.aV, "Enviando mensaje de texto");
    a.put(fw.aW, "Ingrese el código de seguridad de 6 dígitos.");
    a.put(fw.aX, "Su número de celular");
    a.put(fw.aY, "Enviar mensaje de texto");
    a.put(fw.aZ, "Volver a enviar mensaje de texto");
    a.put(fw.ba, "No puede iniciar sesión porque la autenticación de dos factores ha sido activada para su cuenta. Visite el sitio web de PayPal para activar su clave de seguridad.");
    a.put(fw.bb, "No se permiten los pagos desde este dispositivo.");
    a.put(fw.bc, "Dispositivo no autorizado");
    a.put(fw.bd, "Los pagos a este comercio no se permiten (Id. de cliente no válida).");
    a.put(fw.be, "Comercio no válido");
    a.put(fw.bf, "Hubo surgido un problema al procesar su pago. Inténtelo de nuevo.");
    a.put(fw.bg, "Origen no reconocido");
    a.put(fw.bh, "Lo sentimos");
    a.put(fw.bi, "Su pedido");
    a.put(fw.bj, "Este dispositivo no puede comunicarse con PayPal porque esta versión de Android es demasiado antigua. Actualice su versión de Android o inténtelo con un dispositivo más nuevo.");
    a.put(fw.bk, "¿Eliminar tarjeta?");
    a.put(fw.bl, "Error en el permiso");
    a.put(fw.bm, "Error de conexión");
    a.put(fw.bn, "Error de inicio de sesión");
    a.put(fw.bo, "Iniciar sesión con contraseña");
    a.put(fw.bp, "Iniciar sesión con NIP");
    a.put(fw.bq, "Un momento…");
    a.put(fw.br, "Pago fallido");
    a.put(fw.bs, "Escanear");
    a.put(fw.bt, "Código de seguridad incorrecto. Inténtelo de nuevo.");
    a.put(fw.bu, "Vía");
    a.put(fw.bv, "Error del sistema. Inténtelo de nuevo más tarde.");
