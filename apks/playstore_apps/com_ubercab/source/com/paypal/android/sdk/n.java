  ...
  implements h
{
  ...
  public n()
  {
    a.put(fw.a, "Agree and Pay");
    a.put(fw.b, "& other");
    a.put(fw.c, "Authenticating");
    a.put(fw.d, "Back");
    a.put(fw.e, "Backup");
    a.put(fw.f, "Cancel");
    ...
    a.put(fw.v, "Visa");
    a.put(fw.w, "Change Funding Source");
    a.put(fw.x, "Current");
    a.put(fw.y, "Checking this device…");
    a.put(fw.z, "Clear card details");
    a.put(fw.A, "Confirm");
    a.put(fw.B, "Are you sure you want to clear your card details?");
    a.put(fw.C, "Charge Card");
    a.put(fw.D, "Are you sure you want to log out of PayPal?");
    a.put(fw.E, "Pay");
    a.put(fw.F, "Agree");
    a.put(fw.G, "Account Creation Date");
    a.put(fw.H, "Account Status");
    a.put(fw.I, "Account Type");
    a.put(fw.J, "Address Line 1");
    a.put(fw.K, "Age Range");
    a.put(fw.L, "Date of Birth");
    a.put(fw.M, "Email Address");
    a.put(fw.N, "Full Name");
    a.put(fw.O, "Gender");
    a.put(fw.P, "Language");
    a.put(fw.Q, "Locale");
    a.put(fw.R, "Phone Number");
    a.put(fw.S, "Time Zone");
    a.put(fw.T, "Share the following: %s.");
    a.put(fw.U, "Use Seamless Checkout.");
    a.put(fw.V, "%s asks that you:");
    a.put(fw.W, "Share the <a href='%1$s'>funding sources</a> linked to your PayPal account.");
    a.put(fw.X, "Enable the display of your funding options to allow you to make a choice.");
    a.put(fw.Y, "<a href='%1$s'>Authorise charges</a> for future %2$s purchases paid for with PayPal. You instruct PayPal to pay all amounts requested by %3$s.");
    a.put(fw.Z, "Allow them to add and manage their loyalty card in your PayPal wallet.");
    a.put(fw.aa, "Agree to the %1$s <a href='%2$s'>privacy policy</a> and <a href='%3$s'>user agreement</a>");
    a.put(fw.ab, "Permit them to <a href='%1$s'>request money</a> on your behalf until you withdraw consent.");
    a.put(fw.ac, "Permit them to <a href='%1$s'>send money</a> on your behalf until you withdraw consent.");
    a.put(fw.ad, "Consent");
    a.put(fw.ae, "Email");
    a.put(fw.af, "Mock Data");
    a.put(fw.ag, "Sandbox");
    a.put(fw.ah, "Expires");
    a.put(fw.ai, "<h1><strong>Funding Sources</strong></h1><p>PayPal only shares which of your funding sources are available for use.</p>");
    a.put(fw.aj, "Forgotten your password?");
    a.put(fw.ak, "From");
    a.put(fw.al, "How would you like to fund future payments to %1$s?");
    a.put(fw.am, "<h1><strong>Future Payment Agreement</strong></h1><p>Your default funding source will be used to pay for future PayPal payments from this merchant.</p><p>To cancel this agreement, log in to your PayPal account, go to <strong>Profile</strong> &gt; <strong>My Settings</strong> &gt; <strong>Log In with PayPal</strong> and remove this merchant from the list.</p><p>The Recurring Payment section of the <a href='%s'>PayPal User Agreement</a> shall apply.</p><p>To make sure payments work with your PayPal account, this app may simulate a small test transaction, but no money will be transferred for this.</p>");
    a.put(fw.an, "Internal Error");
    a.put(fw.ao, "<p>By clicking the button below, I hereby agree to the terms of the <a href='%1$s'>PayPal User Agreement</a> and declare that I am in compliance with Japanese laws and regulations, including sanctions against payments to North Korea and Iran pursuant to the <a href='%2$s'>Foreign Exchange and Foreign Trade Act</a> to complete the transaction.</p>");
    a.put(fw.ap, "Log In");
    a.put(fw.aq, "Log In with PayPal");
    a.put(fw.ar, "Log Out");
    a.put(fw.as, "Log out");
    a.put(fw.at, "OK");
    a.put(fw.au, "Password");
    a.put(fw.av, "Pay After Delivery");
    a.put(fw.aw, "Pay with");
    a.put(fw.ax, "Pay with Card");
    a.put(fw.ay, "PayPal Balance");
    a.put(fw.az, "PayPal Credit");
    a.put(fw.aA, "Phone");
    a.put(fw.aB, "PIN");
    a.put(fw.aC, "Preferred Funding Source");
    a.put(fw.aD, "PayPal protects your <a href='%s'>privacy</a> and financial information.");
    a.put(fw.aE, "Processing");
    a.put(fw.aF, "Remember card");
    a.put(fw.aG, "Request Money");
    a.put(fw.aH, "<h1><strong>%s</strong></h1><p>Any relevant transaction details will be shared with the merchant.</p><p>To withdraw consent, log in at paypal.com then go to <strong>Log In with PayPal</strong> options under <strong>Profile</strong> settings and remove this merchant.</p><p>PayPal is not responsible for any actions or errors on the part of the partner.</p>");
    a.put(fw.aI, "Savings");
    a.put(fw.aJ, "Send Money");
    a.put(fw.aK, "There was a problem communicating with the PayPal servers. Please try again.");
    a.put(fw.aL, "Please log in to PayPal again.");
    a.put(fw.aM, "Session Expired");
    a.put(fw.aN, "Delivery Address");
    a.put(fw.aO, "New to PayPal? Sign Up");
    a.put(fw.aP, "Stay logged in");
    a.put(fw.aQ, "System error (%s). Please try again later.");
    a.put(fw.aR, "Try Again");
    a.put(fw.aS, "Unable to log in because two-factor authentication has been enabled for your account.");
    a.put(fw.aT, "Verification Code");
    a.put(fw.aU, "Send a text message to your phone. The 6-digit code you receive will be valid for 5 minutes.");
    a.put(fw.aV, "Sending Text");
    a.put(fw.aW, "Enter the 6-digit verification code");
    a.put(fw.aX, "Your mobile number");
    a.put(fw.aY, "Send Text");
    a.put(fw.aZ, "Send Text Again");
    a.put(fw.ba, "Unable to log in because two-factor authentication has been enabled for your account. Please visit the PayPal website to activate your security key.");
    a.put(fw.bb, "Payments from this device are not allowed.");
    a.put(fw.bc, "Unauthorised Device");
    a.put(fw.bd, "Payments to this merchant are not allowed (invalid clientId).");
    a.put(fw.be, "Invalid merchant");
    a.put(fw.bf, "There was a problem processing your payment. Please try again.");
    a.put(fw.bg, "Unrecognised Source");
    a.put(fw.bh, "We’re Sorry");
    a.put(fw.bi, "Your Order");
    a.put(fw.bj, "This device cannot communicate with PayPal because this version of Android is too old. Please upgrade Android or try a newer device.");
    a.put(fw.bk, "Clear Card?");
    a.put(fw.bl, "Consent Failed");
    a.put(fw.bm, "Connection Failed");
    a.put(fw.bn, "Login Failed");
    a.put(fw.bo, "Log in with password");
    a.put(fw.bp, "Log in with PIN");
    a.put(fw.bq, "One moment…");
    a.put(fw.br, "Payment Failed");
    a.put(fw.bs, "Scan");
    a.put(fw.bt, "Incorrect Security code. Please try again.");
    a.put(fw.bu, "Via");
    a.put(fw.bv, "System error. Please try again later.");
