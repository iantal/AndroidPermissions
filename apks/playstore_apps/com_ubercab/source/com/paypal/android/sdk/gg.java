...
public final class gg
{
  ...
  public gg(Context paramContext)
  {
    ...
    ((TableRow)localObject).addView(this.c);
    cz.a(this.c, -2, -1);
    localObject = new TableRow(paramContext);
    this.a.addView((View)localObject);
    this.d = new TextView(paramContext);
    this.d.setTextColor(cy.b);
    this.d.setTextSize(14.0F);
    this.d.setPaintFlags(8);
    ((TableRow)localObject).addView(this.d);
    this.d.setGravity(19);
    cz.b(this.d, "0dip", "4dip", "0dip", "4dip");
    cz.a(this.d, -2, -2);
