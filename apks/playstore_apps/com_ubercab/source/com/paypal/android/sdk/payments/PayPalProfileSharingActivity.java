  ...
  extends Activity
{
  ...
  protected final void onCreate(Bundle paramBundle)
  {
    ...
    new gs(this).a();
    new gr(this).a();
    new gq(this).a(Arrays.asList(new String[] { PayPalProfileSharingActivity.class.getName(), LoginActivity.class.getName(), FuturePaymentInfoActivity.class.getName(), ProfileSharingConsentActivity.class.getName() }));
