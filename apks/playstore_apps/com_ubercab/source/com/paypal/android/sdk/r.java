  ...
  implements h
{
  ...
  public r()
  {
    a.put(fw.a, "הסכם ושלם");
    a.put(fw.b, "ואחרים");
    a.put(fw.c, "אימות");
    a.put(fw.d, "חזרה");
    a.put(fw.e, "גיבוי");
    a.put(fw.f, "ביטול");
    a.put(fw.g, "אמריקן אקספרס");
    ...
    a.put(fw.p, "JCB‏");
    a.put(fw.q, "Maestro‏");
    a.put(fw.r, "מאסטרקארד");
    a.put(fw.s, "Postepay‏");
    a.put(fw.t, "‎4 étoiles‎‏");
    a.put(fw.u, "Tarjeta Aurora‏");
    a.put(fw.v, "ויזה");
    a.put(fw.w, "שנה שיטת תשלום");
    a.put(fw.x, "עו״ש");
    a.put(fw.y, "בודק מכשיר זה…");
    a.put(fw.z, "נקה פרטי כרטיס");
    a.put(fw.A, "אשר");
    a.put(fw.B, "האם אתה בטוח שאתה רוצה להסיר את פרטי הכרטיס שלך?");
    a.put(fw.C, "חייב כרטיס");
    a.put(fw.D, "האם אתה בטוח שאתה רוצה לצאת מ-PayPal‏?");
    a.put(fw.E, "שלם");
    a.put(fw.F, "מסכים");
    a.put(fw.G, "תאריך פתיחת החשבון");
    a.put(fw.H, "מצב חשבון");
    a.put(fw.I, "סוג חשבון");
    a.put(fw.J, "כתובת");
    a.put(fw.K, "טווח גילים");
    a.put(fw.L, "תאריך לידה");
    a.put(fw.M, "כתובת אימייל");
    a.put(fw.N, "שם מלא");
    a.put(fw.O, "מין");
    a.put(fw.P, "שפה");
    a.put(fw.Q, "אזור");
    a.put(fw.R, "טלפון");
    a.put(fw.S, "אזור זמן");
    a.put(fw.T, "שתף את הפרטים הבאים: ‎%s‏.");
    a.put(fw.U, "השתמש ב-Express Checkout‏.");
    a.put(fw.V, "%s מבקש כי:");
    a.put(fw.W, "שתף את <a href='%1$s'>שיטות התשלום</a> המקושרות לחשבון ה-PayPal שלך.");
    a.put(fw.X, "הפעל תצוגה של האפשרויות הכספיות שלך שתאפשר לך לבחור.");
    a.put(fw.Y, "<a href='%1$s'>אשר חיובים</a> עבור קניות עתידיות אצל ‎%2$s באמצעות PayPal‏. הורית ל-PayPal לשלם את כל הסכומים ש-‎%3$s מבקש.");
    a.put(fw.Z, "תאפשר לו להוסיף ולנהל את כרטיס המועדון שלו ב‘ארנק‘ שבחשבון ה-PayPal שלך.");
    a.put(fw.aa, "תסכים ל<a href='%2$s'>מדיניות הפרטיות</a> ו<a href='%3$s'>הסכם המשתמש</a> של %1$s‏.");
    a.put(fw.ab, "תאפשר לו <a href='%1$s'>לבקש תשלום</a> בשמך, עד שתבטל את הסכמתך.");
    a.put(fw.ac, "תאפשר לו <a href='%1$s'>לשלוח תשלום</a> בשמך, עד שתבטל את הסכמתך.");
    a.put(fw.ad, "הסכמה");
    a.put(fw.ae, "אימייל");
    a.put(fw.af, "פרטים מדומים");
    a.put(fw.ag, "‏Sandbox");
    a.put(fw.ah, "תאריך תפוגה");
    a.put(fw.ai, "<h1><strong>דרכי תשלום</strong></h1><p>המידע היחיד ש-PayPal משתפת הוא אילו משיטות התשלום שלך זמינות לשימוש.</p>");
    a.put(fw.aj, "שכחת את הסיסמה?");
    a.put(fw.ak, "מ-");
    a.put(fw.al, "כיצד תרצה לשלם עבור תשלומים עתידיים ל-%1$s‏?");
    a.put(fw.am, "<h1><strong>הסכם תשלום עתידי</strong></h1><p>ברירת המחדל לשיטת התשלום שלך תשמש עבור תשלומים עתידיים באמצעות PayPal אצל בעל עסק זה.</p><p>כדי לבטל הסכם זה, היכנס לחשבון ה-PayPal שלך, עבור אל <strong>פרופיל</strong> &gt; <strong>ההגדרות שלי</strong> &gt; <strong>היכנס עם PayPal</strong> והסר בעל עסק זה מהרשימה.</p><p>המקטע ‘הוראת קבע‘ של <a href='%s'>הסכם המשתמש של PayPal</a> יחול.</p><p>כדי לוודא שהתשלומים שלך יעבדו עם חשבון ה-PayPal שלך, יישום זה עשוי לבצע הדמיה של עסקה קטנה לצורך בדיקה, אך בפועל לא יועבר כסף.</p>");
    a.put(fw.an, "שגיאה פנימית");
    a.put(fw.ao, "<p>על-ידי לחיצה על הלחצן למטה, אני מסכים בזאת לתנאי <a href='%1$s'>הסכם המשתמש של PayPal</a> ומצהיר שאני פועל בהתאם לחוקים ולתקנות ביפן, כולל סנקציות נגד תשלום לצפון קוריאה ואירן, בהתאם ל-<a href='%2$s'>Foreign Exchange and Foreign Trade Act</a>, להשלמת העסקה.</p>");
    a.put(fw.ap, "כניסה");
    a.put(fw.aq, "היכנס עם PayPal‏");
    a.put(fw.ar, "יציאה");
    a.put(fw.as, "יציאה");
    a.put(fw.at, "אישור");
    a.put(fw.au, "סיסמה");
    a.put(fw.av, "שלם לאחר המסירה");
    a.put(fw.aw, "שלם באמצעות");
    a.put(fw.ax, "שלם באמצעות כרטיס");
    a.put(fw.ay, "יתרת חשבון ה-PayPal");
    a.put(fw.az, "PayPal Credit");
    a.put(fw.aA, "טלפון");
    a.put(fw.aB, "קוד סודי");
    a.put(fw.aC, "שיטת תשלום מועדפת");
    a.put(fw.aD, "PayPal מגינה על ה<a href='%s'>פרטיות</a> והמידע הפיננסי שלך.");
    a.put(fw.aE, "עיבוד");
    a.put(fw.aF, "זכור כרטיס");
    a.put(fw.aG, "בקש תשלום");
    a.put(fw.aH, "<h1><strong>%s</strong></h1><p>כל פרטי העסקה הרלוונטיים ישותפו עם בעל העסק.</p><p>כדי לבטל את הסכמתך, היכנס אל paypal.com, עבור אל אפשרויות <strong>היכנס עם PayPal</strong> תחת הגדרות ה<strong>פרופיל</strong> והסר בעל עסק זה.</p><p>PayPal אינה אחראית לפעולות או שגיאות כלשהן מצדו של השותף.</p>");
    a.put(fw.aI, "חיסכון");
    a.put(fw.aJ, "שלח תשלום");
    a.put(fw.aK, "הייתה בעיה ביצירת קשר עם השרתים של PayPal‏. נסה שוב.");
    a.put(fw.aL, "היכנס שוב ל-PayPal‏.");
    a.put(fw.aM, "פג תוקף ההפעלה");
    a.put(fw.aN, "כתובת למשלוח");
    a.put(fw.aO, "חדש ב-PayPal‏? הירשם");
    a.put(fw.aP, "הישאר מחובר");
    a.put(fw.aQ, "שגיאת מערכת (%s‏). נסה שוב מאוחר יותר.");
    a.put(fw.aR, "נסה שוב");
    a.put(fw.aS, "לא ניתן להיכנס לחשבון, משום שאימות בשני שלבים הופעל עבור החשבון שלך.");
    a.put(fw.aT, "קוד אבטחה");
    a.put(fw.aU, "שלח הודעת טקסט לטלפון שלך. הקוד בן שש הספרות שתקבל יישאר בתוקף למשך 5 דקות.");
    a.put(fw.aV, "שולח טקסט");
    a.put(fw.aW, "הזן את קוד האבטחה בן שש הספרות");
    a.put(fw.aX, "מספר הטלפון הנייד שלך");
    a.put(fw.aY, "שלח טקסט");
    a.put(fw.aZ, "שלח טקסט שוב");
    a.put(fw.ba, "לא ניתן להיכנס לחשבון, משום שאימות בשני שלבים הופעל עבור החשבון שלך. בקר באתר PayPal כדי להפעיל את מפתח האבטחה שלך.");
    a.put(fw.bb, "לא ניתן לשלם ממכשיר זה.");
    a.put(fw.bc, "מכשיר בלתי-מורשה");
    a.put(fw.bd, "לא ניתן לשלם לבעל עסק זה (מזהה לקוח בלתי-חוקי).");
    a.put(fw.be, "בעל עסק בלתי-חוקי");
    a.put(fw.bf, "אירעה בעיה בעיבוד התשלום שלך. נסה שוב.");
    a.put(fw.bg, "מקור בלתי מזוהה");
    a.put(fw.bh, "מצטערים");
    a.put(fw.bi, "ההזמנה שלך");
    a.put(fw.bj, "מכשיר זה לא יכול ליצור קשר עם PayPal משום שגירסה זו של אנדרואיד ישנה מדי. שדרג את גירסת האנדרואיד או נסה מכשיר חדש יותר.");
    a.put(fw.bk, "להסיר את הכרטיס?");
    a.put(fw.bl, "ההסכמה נכשלה");
    a.put(fw.bm, "החיבור נכשל");
    a.put(fw.bn, "הכניסה נכשלה");
    a.put(fw.bo, "היכנס באמצעות סיסמה");
    a.put(fw.bp, "היכנס באמצעות קוד סודי");
    a.put(fw.bq, "המתן רגע אחד…");
    a.put(fw.br, "התשלום נכשל");
    a.put(fw.bs, "סריקה");
    a.put(fw.bt, "קוד אבטחה שגוי. נסה שוב.");
    a.put(fw.bu, "באמצעות");
    a.put(fw.bv, "שגיאת מערכת. נסה שוב מאוחר יותר.");
    ...
    c.put("account_locked_generate_challenge_limit_exceeded", "נסיונות כניסה רבים מדי. נסה שוב מאוחר יותר, או צור קשר עם PayPal לקבלת עזרה.");
  }
