  ...
  implements h
{
  ...
  public ac()
  {
    a.put(fw.a, "Согласиться и оплатить");
    a.put(fw.b, "и прочие");
    a.put(fw.c, "Выполняется проверка");
    a.put(fw.d, "Пред.");
    a.put(fw.e, "Резервный");
    a.put(fw.f, "Отмена");
    ...
    a.put(fw.v, "Visa");
    a.put(fw.w, "Изменить способ оплаты");
    a.put(fw.x, "Проверка");
    a.put(fw.y, "Выполняется проверка устройства…");
    a.put(fw.z, "Очистить данные карты");
    a.put(fw.A, "Подтвердить");
    a.put(fw.B, "Вы уверены, что хотите очистить сведения о банковской карте?");
    a.put(fw.C, "Оплатить по карте");
    a.put(fw.D, "Выйти из учетной записи PayPal?");
    a.put(fw.E, "Оплатить");
    a.put(fw.F, "Соглашаюсь");
    a.put(fw.G, "Дата создания счета");
    a.put(fw.H, "Статус счета");
    a.put(fw.I, "Тип счета");
    a.put(fw.J, "Адрес");
    a.put(fw.K, "Возрастной диапазон");
    a.put(fw.L, "Дата рождения");
    a.put(fw.M, "Эл. почта");
    a.put(fw.N, "Полное имя");
    a.put(fw.O, "Пол");
    a.put(fw.P, "Язык");
    a.put(fw.Q, "Локаль");
    a.put(fw.R, "Телефон");
    a.put(fw.S, "Часовой пояс");
    a.put(fw.T, "Использовать совместно: %s.");
    a.put(fw.U, "Оцените идеальный процесс оплаты покупок.");
    a.put(fw.V, "%s просит вашего разрешения:");
    a.put(fw.W, "Поделиться информацией о <a href='%1$s'>способах оплаты</a>, привязанных к вашему счету PayPal.");
    a.put(fw.X, "Включите отображение ваших источников средств, чтобы вы могли выбирать при совершении покупок.");
    a.put(fw.Y, "<a href='%1$s'>Подтвердить списания</a> за будущие покупки через PayPal у продавца %2$s. Вы разрешаете PayPal оплачивать все суммы, запрашиваемые %3$s.");
    a.put(fw.Z, "подключать и управлять дисконтными картами через ваш счет PayPal.");
    a.put(fw.aa, "Подтвердить согласие с положениями %1$s <a href='%2$s'>Политики конфиденциальности</a> и <a href='%3$s'>Соглашения с пользователем</a>.");
    a.put(fw.ab, "Разрешить им <a href='%1$s'>запрашивать денежные средства</a> от вашего имени, пока вы не аннулируете свое согласие.");
    a.put(fw.ac, "Разрешить им <a href='%1$s'>отправлять денежные средства</a> от вашего имени, пока вы не аннулируете свое согласие.");
    a.put(fw.ad, "Согласиться");
    a.put(fw.ae, "Эл. почта");
    a.put(fw.af, "Ложные данные");
    a.put(fw.ag, "Изолированная программная среда");
    a.put(fw.ah, "Действует до");
    a.put(fw.ai, "<h1><strong>Способы оплаты</strong></h1><p>PayPal делится информацией только о том, какой из ваших способов оплаты доступен для использования.</p>");
    a.put(fw.aj, "Забыли пароль?");
    a.put(fw.ak, "С");
    a.put(fw.al, "Какой источник средств предпочтительнее для будущих платежей пользователю %1$s?");
    a.put(fw.am, "<h1><strong>Соглашение о будущих платежах</strong></h1><p>Для всех будущих платежей через PayPal этот продавец будет использовать ваш источник средств по умолчанию.</p><p>Для отмены данного соглашения войдите в систему PayPal под своим именем и перейдите по вкладке <strong>Профиль</strong> &gt; <strong>Мои настройки</strong> &gt; <strong>Войти через PayPal</strong> и удалите этого продавца из списка.</p><p>Будут применены условия раздела о регулярных платежах <a href='%s'>Соглашения с пользователем в отношении услуг PayPal</a>.</p><p>Для проверки работоспособности вашего счета PayPal это приложение может выполнить небольшую тестовую операцию без снятия или перевода денег.</p>");
    a.put(fw.an, "Внутренняя ошибка");
    a.put(fw.ao, "<p>Нажимая кнопку ниже, я подтверждаю свое согласие с условиями <a href='%1$s'>Соглашения с пользователем в отношении услуг PayPal</a> и заявляю, что, совершая данную финансовую операцию, действую в соответствии с действующим законодательством Японии, включая санкции в отношении перевода платежей в Северную Корею и Иран в рамках <a href='%2$s'>Закона об обмене валют и зарубежной торговле</a>.</p>");
    a.put(fw.ap, "Войти");
    a.put(fw.aq, "Войти через PayPal");
    a.put(fw.ar, "Выход");
    a.put(fw.as, "Выход");
    a.put(fw.at, "ОК");
    a.put(fw.au, "Пароль");
    a.put(fw.av, "Оплата после доставки");
    a.put(fw.aw, "Способ оплаты:");
    a.put(fw.ax, "Оплатить картой");
    a.put(fw.ay, "Остаток на счете PayPal");
    a.put(fw.az, "PayPal Credit");
    a.put(fw.aA, "Телефон");
    a.put(fw.aB, "PIN-код");
    a.put(fw.aC, "Предпочтительный способ оплаты");
    a.put(fw.aD, "PayPal гарантирует защиту ваших <a href='%s'>конфиденциальных данных</a> и финансовой информации.");
    a.put(fw.aE, "Выполняется обработка");
    a.put(fw.aF, "Запомнить карту");
    a.put(fw.aG, "Запросить средства");
    a.put(fw.aH, "<h1><strong>%s</strong></h1><p>Любые сведения, относящиеся к операции, будут переданы продавцу.</p><p>Для отмены согласия зайдите на сайт paypal.com, выберите <strong>Войти через PayPal</strong> в разделе <strong>Профиль</strong> и удалите данного продавца.</p><p>Компания PayPal не несет ответственности за действия или ошибки со стороны продавца.</p>");
    a.put(fw.aI, "Сберегательный");
    a.put(fw.aJ, "Отпр. средства");
    a.put(fw.aK, "Была проблема связи с серверами PayPal. Повторите попытку.");
    a.put(fw.aL, "Войдите в учетную запись PayPal заново.");
    a.put(fw.aM, "Ваш сеанс истек");
    a.put(fw.aN, "Адрес доставки");
    a.put(fw.aO, "Впервые в PayPal? Зарегистрироваться");
    a.put(fw.aP, "Не выходить из системы");
    a.put(fw.aQ, "Системная ошибка (%s). Повторите попытку позже.");
    a.put(fw.aR, "Повторить");
    a.put(fw.aS, "Не удалось выполнить вход, так как для вашего счета включена процедура двухфакторной аутентификации.");
    a.put(fw.aT, "Код безопасности карты");
    a.put(fw.aU, "Отправьте SMS-сообщение на свой номер телефона. 6-значный код, который вы получили, будет действителен в течение 5 минут.");
    a.put(fw.aV, "Отправка SMS-сообщения");
    a.put(fw.aW, "Введите 6-значный код безопасности");
    a.put(fw.aX, "Номер вашего мобильного телефона");
    a.put(fw.aY, "Отправить SMS-сообщение");
    a.put(fw.aZ, "Отправить SMS-сообщение еще раз");
    a.put(fw.ba, "Не удалось выполнить вход, так как для вашего счета включена процедура двухфакторной аутентификации. Войдите на веб-сайт PayPal, чтобы активировать ваш ключ безопасности.");
    a.put(fw.bb, "Платежи через данное устройство запрещены.");
    a.put(fw.bc, "Неавторизованное устройство");
    a.put(fw.bd, "Платежи данному продавцу не разрешены (недействительный код клиента).");
    a.put(fw.be, "Недействительный продавец");
    a.put(fw.bf, "При обработке платежа произошла ошибка. Повторите попытку.");
    a.put(fw.bg, "Нераспознанный источник");
    a.put(fw.bh, "Приносим извинения");
    a.put(fw.bi, "Ваш заказ");
    a.put(fw.bj, "Данное устройство не может связаться с PayPal, потому что данная версия Android слишком стара. Обновите версию Android или попробуйте более новое устройство.");
    a.put(fw.bk, "Очистить данные карты?");
    a.put(fw.bl, "Не удалось подтвердить согласие");
    a.put(fw.bm, "Соединение не выполнено");
    a.put(fw.bn, "Не удалось войти в систему");
    a.put(fw.bo, "Войти в систему при помощи пароля");
    a.put(fw.bp, "Войти при помощи PIN-кода");
    a.put(fw.bq, "Минуточку…");
    a.put(fw.br, "Не удалось выполнить платеж");
    a.put(fw.bs, "Сканирование");
    a.put(fw.bt, "Неправильный код безопасности. Повторите попытку.");
    a.put(fw.bu, "через");
    a.put(fw.bv, "Системная ошибка. Повторите попытку позже.");
