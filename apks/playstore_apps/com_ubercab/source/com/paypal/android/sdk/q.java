  ...
  implements h
{
  ...
  public q()
  {
    a.put(fw.a, "Valider et payer");
    a.put(fw.b, "et autre(s)");
    a.put(fw.c, "Authentification");
    a.put(fw.d, "Retour");
    a.put(fw.e, "Secondaire");
    a.put(fw.f, "Annuler");
    ...
    a.put(fw.v, "Visa");
    a.put(fw.w, "Modifier le mode de paiement");
    a.put(fw.x, "Courant");
    a.put(fw.y, "Vérification de l’appareil…");
    a.put(fw.z, "Effacer les informations de carte");
    a.put(fw.A, "Confirmer");
    a.put(fw.B, "Souhaitez-vous vraiment effacer les informations relatives à votre carte ?");
    a.put(fw.C, "Débiter la carte");
    a.put(fw.D, "Souhaitez-vous vraiment vous déconnecter de PayPal ?");
    a.put(fw.E, "Payer");
    a.put(fw.F, "Accepter");
    a.put(fw.G, "Date de création du compte");
    a.put(fw.H, "État du compte");
    a.put(fw.I, "Type de compte");
    a.put(fw.J, "Adresse");
    a.put(fw.K, "Tranche d’âge");
    a.put(fw.L, "Date de naissance");
    a.put(fw.M, "Adresse email");
    a.put(fw.N, "Nom complet");
    a.put(fw.O, "Sexe");
    a.put(fw.P, "Langue");
    a.put(fw.Q, "Pays");
    a.put(fw.R, "Téléphone");
    a.put(fw.S, "Fuseau horaire");
    a.put(fw.T, "Partager les informations suivantes : %s.");
    a.put(fw.U, "Utiliser le paiement simplifié.");
    a.put(fw.V, "%s vous demande de :");
    a.put(fw.W, "Partager les <a href='%1$s'>modes de paiement</a> liés à votre compte PayPal.");
    a.put(fw.X, "Activer l’affichage de vos options d’approvisionnement pour vous permettre de faire votre choix.");
    a.put(fw.Y, "<a href='%1$s'>Autoriser les débits</a> pour les futurs achats chez %2$s payés avec PayPal. Vous donnez pour instruction à PayPal de payer tous les montants demandés par %3$s.");
    a.put(fw.Z, "L’autoriser à ajouter et à gérer sa carte de fidélité dans votre portefeuille.");
    a.put(fw.aa, "Accepter le <a href='%2$s'>règlement sur le respect de la vie privée</a> et les <a href='%3$s'>conditions d’utilisation</a> de %1$s .");
    a.put(fw.ab, "L’autoriser à <a href='%1$s'>demander de l’argent</a> en votre nom jusqu’à nouvel ordre.");
    a.put(fw.ac, "L’autoriser à <a href='%1$s'>envoyer de l’argent</a> en votre nom jusqu’à nouvel ordre.");
    a.put(fw.ad, "Accepter");
    a.put(fw.ae, "Email");
    a.put(fw.af, "Données d’exemple");
    a.put(fw.ag, "Environnement de test");
    a.put(fw.ah, "Date d’expiration");
    a.put(fw.ai, "<h1><strong>Modes de paiement</strong></h1><p>PayPal communique uniquement vos modes de paiement disponibles.</p>");
    a.put(fw.aj, "Mot de passe oublié ?");
    a.put(fw.ak, "De");
    a.put(fw.al, "Comment souhaitez-vous approvisionner les futurs paiements à %1$s ?");
    a.put(fw.am, "<h1><strong>Autorisation pour les futurs paiements</strong></h1><p>Votre source d’approvisionnement par défaut sera utilisée pour payer les futurs paiements PayPal chez ce marchand.</p><p>Pour annuler cette autorisation, connectez-vous à votre compte PayPal et accédez à <strong>Préférences</strong> &gt; <strong>Mes paramètres</strong> &gt; <strong>Connexion avec PayPal</strong> et supprimez ce marchand de la liste.</p><p>L’article Paiement récurrent des <a href='%s'>Conditions d’utilisation de PayPal</a> s’appliquera.</p><p>Pour s’assurer que votre compte PayPal pourra être débité à l’avenir, cette application peut simuler une petite transaction test sans transfert d’argent.</p>");
    a.put(fw.an, "Erreur interne");
    a.put(fw.ao, "<p>En cliquant sur le bouton ci-dessous, j’accepte les <a href='%1$s'>Conditions d’utilisation de PayPal</a> et déclare être en conformité avec les lois et réglementations japonaises, notamment les sanctions liées aux paiements vers la Corée-du-Nord et l’Iran conformément au <a href='%2$s'>Foreign Exchange and Foreign Trade Act</a> pour effectuer cette transaction.</p>");
    a.put(fw.ap, "Connexion");
    a.put(fw.aq, "Connexion avec PayPal");
    a.put(fw.ar, "Déconnexion");
    a.put(fw.as, "Déconnexion");
    a.put(fw.at, "OK");
    a.put(fw.au, "Mot de passe");
    a.put(fw.av, "Paiement après Livraison");
    a.put(fw.aw, "Payer par");
    a.put(fw.ax, "Payer par carte");
    a.put(fw.ay, "Solde PayPal");
    a.put(fw.az, "PayPal Credit");
    a.put(fw.aA, "Téléphone");
    a.put(fw.aB, "Code d’accès");
    a.put(fw.aC, "Source d’approvisionnement préférée");
    a.put(fw.aD, "PayPal garantit le <a href='%s'>respect de votre vie privée</a> et protège vos informations financières.");
    a.put(fw.aE, "En cours de traitement");
    a.put(fw.aF, "Mémoriser la carte");
    a.put(fw.aG, "Demande d’argent");
    a.put(fw.aH, "<h1><strong>%s</strong></h1><p>Toute information pertinente relative à la transaction sera communiquée au marchand.</p><p>Pour annuler l’autorisation, connectez-vous à paypal.com, puis accédez à <strong>Connexion avec PayPal</strong> sous <strong>Préférences</strong> et supprimez ce marchand.</p><p>PayPal n’est pas responsable des actions ou erreurs imputables au partenaire.</p>");
    a.put(fw.aI, "Épargne");
    a.put(fw.aJ, "Envoi d’argent");
    a.put(fw.aK, "Un problème est survenu lors de la communication avec les serveurs PayPal. Merci de recommencer.");
    a.put(fw.aL, "Merci de vous reconnecter à PayPal.");
    a.put(fw.aM, "La session a expiré");
    a.put(fw.aN, "Adresse de livraison");
    a.put(fw.aO, "Nouveau sur PayPal ? Ouvrir un compte");
    a.put(fw.aP, "Rester connecté");
    a.put(fw.aQ, "Erreur système (%s). Réessayez ultérieurement.");
    a.put(fw.aR, "Réessayer");
    a.put(fw.aS, "Nous ne pouvons pas vous connecter car votre compte fait l’objet d’une authentification à deux facteurs.");
    a.put(fw.aT, "Code de sécurité");
    a.put(fw.aU, "Envoyer un SMS à votre téléphone. Le code à six chiffres que vous recevez sera valide pendant cinq minutes.");
    a.put(fw.aV, "Envoi du SMS");
    a.put(fw.aW, "Saisissez le code de sécurité à six chiffres");
    a.put(fw.aX, "Votre numéro de mobile");
    a.put(fw.aY, "Envoyer un SMS");
    a.put(fw.aZ, "Envoyer de nouveau un SMS");
    a.put(fw.ba, "Nous ne pouvons pas vous connecter, car votre compte fait l’objet d’une authentification à deux facteurs. Rendez-vous sur le site PayPal pour activer votre clé de sécurité.");
    a.put(fw.bb, "Vous ne pouvez pas effectuer de paiements à partir de cet appareil.");
    a.put(fw.bc, "Appareil non autorisé");
    a.put(fw.bd, "Les paiements à ce marchand ne sont pas autorisés (identifiant client incorrect).");
    a.put(fw.be, "Marchand incorrect");
    a.put(fw.bf, "Un problème est survenu lors du traitement de votre paiement. Réessayez.");
    a.put(fw.bg, "Source non reconnue");
    a.put(fw.bh, "Désolé");
    a.put(fw.bi, "Votre commande");
    a.put(fw.bj, "Cet appareil ne peut pas communiquer avec PayPal, car cette version d’Android est trop ancienne. Mettez à jour Android ou essayez un appareil plus récent.");
    a.put(fw.bk, "Effacer la carte ?");
    a.put(fw.bl, "Échec de l’autorisation");
    a.put(fw.bm, "Échec de la connexion");
    a.put(fw.bn, "Échec de la connexion");
    a.put(fw.bo, "Connexion par mot de passe");
    a.put(fw.bp, "Connexion par code d’accès");
    a.put(fw.bq, "Un instant…");
    a.put(fw.br, "Échec du paiement");
    a.put(fw.bs, "Scanner");
    a.put(fw.bt, "Cryptogramme visuel incorrect. Réessayez.");
    a.put(fw.bu, "Via");
    a.put(fw.bv, "Erreur système. Réessayez ultérieurement.");
