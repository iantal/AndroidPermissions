  ...
  implements h
{
  ...
  public m()
  {
    ...
    a.put(fw.v, "Visa");
    a.put(fw.w, "Change Payment Method");
    a.put(fw.x, "Cheque");
    a.put(fw.y, "Checking this device…");
    a.put(fw.z, "Clear card information");
    a.put(fw.A, "Confirm");
    a.put(fw.B, "Are you sure you want to clear your card information?");
    ...
    a.put(fw.W, "Share the <a href='%1$s'>payment methods</a> linked to your PayPal account.");
    ...
    a.put(fw.Z, "Allow them to link and manage their loyalty card in your PayPal wallet.");
    ...
    a.put(fw.aA, "Phone");
    a.put(fw.aB, "PIN");
    a.put(fw.aC, "Preferred Payment Method");
    ...
    a.put(fw.aT, "Security Code");
    a.put(fw.aU, "Send an SMS to your phone. The 6-digit code you receive will be valid for 5 minutes.");
    a.put(fw.aV, "Sending SMS");
    a.put(fw.aW, "Enter the 6-digit security code");
    a.put(fw.aX, "Your mobile number");
    a.put(fw.aY, "Send SMS");
    a.put(fw.aZ, "Send SMS Again");
