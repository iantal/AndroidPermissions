  ...
  implements h
{
  ...
  public ae()
  {
    a.put(fw.a, "ยอมรับและชำระเงิน");
    a.put(fw.b, "และอื่นๆ");
    a.put(fw.c, "กำลังตรวจสอบความถูกต้อง");
    a.put(fw.d, "ย้อนกลับ");
    a.put(fw.e, "สำรอง");
    a.put(fw.f, "ยกเลิก");
    ...
    a.put(fw.v, "Visa");
    a.put(fw.w, "เปลี่ยนวิธีการชำระเงิน");
    a.put(fw.x, "กระแสรายวัน");
    a.put(fw.y, "กำลังตรวจสอบอุปกรณ์นี้…");
    a.put(fw.z, "ลบข้อมูลบัตรทั้งหมด");
    a.put(fw.A, "ยืนยัน");
    a.put(fw.B, "คุณแน่ใจหรือไม่ว่าต้องการลบข้อมูลบัตรทั้งหมด");
    a.put(fw.C, "ชาร์จการ์ด");
    a.put(fw.D, "คุณแน่ใจหรือไม่ว่าต้องการออกจากระบบ PayPal");
    a.put(fw.E, "ชำระเงิน");
    a.put(fw.F, "ยอมรับ");
    a.put(fw.G, "วันที่สร้างบัญชี");
    a.put(fw.H, "สถานะบัญชี");
    a.put(fw.I, "ประเภทบัญชี");
    a.put(fw.J, "ที่อยู่");
    a.put(fw.K, "ช่วงอายุ");
    a.put(fw.L, "วันเดือนปีเกิด");
    a.put(fw.M, "ที่อยู่อีเมล");
    a.put(fw.N, "ชื่อเต็ม");
    a.put(fw.O, "เพศ");
    a.put(fw.P, "ภาษา");
    a.put(fw.Q, "ประเทศ");
    a.put(fw.R, "หมายเลขโทรศัพท์");
    a.put(fw.S, "เขตเวลา");
    a.put(fw.T, "เปิดเผยข้อมูลต่อไปนี้: %s");
    a.put(fw.U, "ใช้การชำระเงินแบบไร้รอยต่อ");
    a.put(fw.V, "%s ขอให้คุณ:");
    a.put(fw.W, "เปิดเผย<a href='%1$s'>วิธีการชำระเงิน</a>ที่เชื่อมโยงอยู่กับบัญชี PayPal ของคุณ");
    a.put(fw.X, "เปิดใช้งานการแสดงแหล่งเงิน เพื่อให้คุณสามารถเลือกได้");
    a.put(fw.Y, "<a href='%1$s'>อนุญาตให้เรียกเก็บเงิน</a> สำหรับการซื้อสินค้า %2$s ในอนาคตที่ชำระด้วย PayPal คุณระบุให้ PayPal ชำระเงินทั้งหมดตามที่ %3$s ขอ");
    a.put(fw.Z, "อนุญาตให้เพิ่มและจัดการบัตรตอบแทนลูกค้าสมาชิกในกระเป๋าสตางค์ PayPal ของคุณ");
    a.put(fw.aa, "ยอมรับ <a href='%2$s'>นโยบายความเป็นส่วนตัว</a> และ <a href='%3$s'>สัญญาสำหรับผู้ใช้บริการ</a> ของ %1$s");
    a.put(fw.ab, "อนุญาตให้บุคคลดังกล่าว<a href='%1$s'>เรียกเก็บเงิน</a>ในนามของคุณจนกว่าคุณจะเพิกถอนความยินยอม");
    a.put(fw.ac, "อนุญาตให้บุคคลดังกล่าว<a href='%1$s'>ชำระเงิน</a>ในนามของคุณจนกว่าคุณจะเพิกถอนความยินยอม");
    a.put(fw.ad, "ความยินยอม");
    a.put(fw.ae, "อีเมล");
    a.put(fw.af, "ข้อมูลจำลอง");
    a.put(fw.ag, "Sandbox");
    a.put(fw.ah, "หมดอายุ");
    a.put(fw.ai, "<h1><strong>วิธีการชำระเงิน</strong></h1><p>PayPal จะเปิดเผยเพียงแค่ว่ามีวิธีการชำระเงินใดบ้างที่สามารถใช้ได้</p>");
    a.put(fw.aj, "ลืมรหัสผ่าน");
    a.put(fw.ak, "จาก");
    a.put(fw.al, "คุณต้องการใช้แหล่งเงินใดชำระเงินให้แก่ %1$s ในอนาคต");
    a.put(fw.am, "<h1><strong>ข้อตกลงการชำระเงินในอนาคต</strong></h1><p>ระบบจะใช้แหล่งเงินที่เป็นค่าดีฟอลต์ของคุณเพื่อชำระเงินด้วย PayPal จากผู้ค้ารายนี้ในอนาคต</p><p>ถ้าต้องการยกเลิกข้อตกลงนี้ ให้เข้าสู่บัญชี PayPal ของคุณ จากนั้นไปที่ <strong>‘ข้อมูลบัญชี’</strong> &gt; <strong>‘การตั้งค่าของฉัน’</strong> &gt; <strong>‘เข้าสู่ระบบด้วย PayPal’</strong> แล้วลบผู้ค้ารายนี้ออกจากรายการ</p><p>หัวข้อ ‘การชำระเงินเป็นงวด’ ใน<a href='%s'>สัญญาสำหรับผู้ใช้บริการของ PayPal</a> มีผลกับข้อตกลงนี้</p><p>แอปนี้อาจจำลองการทำรายการยอดเล็กๆ เพื่อเป็นการทดสอบโดยไม่มีการโอนเงินจริง เพื่อให้มั่นใจว่าบัญชี PayPal ของคุณสามารถชำระเงินได้ในอนาคต</p>");
    a.put(fw.an, "ข้อผิดพลาดภายใน");
    a.put(fw.ao, "<p>โดยการคลิกที่ปุ่มด้านล่างนี้ ข้าพเจ้าตกลงยอมรับข้อกำหนดของ <a href='%1$s'>สัญญาสำหรับผู้ใช้บริการของ PayPal</a> และขอยืนยันว่าข้าพเจ้าปฏิบัติตามกฎหมายและข้อบังคับของญี่ปุ่น ซึ่งรวมถึงมาตรการห้ามไม่ให้มีการชำระเงินไปยังเกาหลีเหนือและอิหร่าน ซึ่งเป็นไปตาม <a href='%2$s'>กฎหมายว่าด้วยการแลกเปลี่ยนเงินตราต่างประเทศและการค้าต่างประเทศ</a> เพื่อทำรายการดังกล่าวให้เสร็จสมบูรณ์</p>");
    a.put(fw.ap, "เข้าสู่ระบบ");
    a.put(fw.aq, "เข้าสู่ระบบด้วย PayPal");
    a.put(fw.ar, "ออกจากระบบ");
    a.put(fw.as, "ออกจากระบบ");
    a.put(fw.at, "ตกลง");
    a.put(fw.au, "รหัสผ่าน");
    a.put(fw.av, "ชำระเงินหลังจากได้รับสินค้า");
    a.put(fw.aw, "ชำระเงินด้วย");
    a.put(fw.ax, "ชำระเงินด้วยบัตร");
    a.put(fw.ay, "ยอดคงเหลือในบัญชี PayPal");
    a.put(fw.az, "PayPal Credit");
    a.put(fw.aA, "โทรศัพท์");
    a.put(fw.aB, "PIN");
    a.put(fw.aC, "วิธีการชำระเงินหลัก");
    a.put(fw.aD, "PayPal ปกป้อง<a href='%s'>ความเป็นส่วนตัว</a>และข้อมูลทางการเงินของคุณ");
    a.put(fw.aE, "กำลังดำเนินการ");
    a.put(fw.aF, "จำบัตร");
    a.put(fw.aG, "เรียกเก็บเงิน");
    a.put(fw.aH, "<h1><strong>%s</strong></h1><p>เราจะเปิดเผยรายละเอียดการทำรายการใดๆ ก็ตามที่เกี่ยวข้องให้ผู้ค้าทราบ</p><p>ถ้าต้องการเพิกถอนความยินยอม ให้เข้าสู่ระบบที่ paypal.com แล้วไปที่ตัวเลือก <strong>‘เข้าสู่ระบบด้วย PayPal‘</strong> ใต้การตั้งค่า <strong>‘ข้อมูลบัญชี‘</strong> แล้วลบผู้ค้ารายนี้ออก</p><p>PayPal จะไม่รับผิดชอบต่อการดำเนินการหรือข้อผิดพลาดใดๆ ในส่วนของพันธมิตร</p>");
    a.put(fw.aI, "ออมทรัพย์");
    a.put(fw.aJ, "ชำระเงิน");
    a.put(fw.aK, "เกิดปัญหาในการติดต่อกับเซิร์ฟเวอร์ของ PayPal โปรดลองอีกครั้ง");
    a.put(fw.aL, "โปรดเข้าสู่ระบบ PayPal อีกครั้ง");
    a.put(fw.aM, "เซสชันหมดเวลา");
    a.put(fw.aN, "ที่อยู่สำหรับจัดส่ง");
    a.put(fw.aO, "ถ้าไม่เคยใช้ PayPal มาก่อน สมัครสมาชิก");
    a.put(fw.aP, "อยู่ในระบบต่อไป");
    a.put(fw.aQ, "ระบบเกิดข้อผิดพลาด (%s) โปรดลองอีกครั้งในภายหลัง");
    a.put(fw.aR, "โปรดลองอีกครั้ง");
    a.put(fw.aS, "ไม่สามารถเข้าสู่ระบบได้เนื่องจากบัญชีของคุณเปิดใช้งานการรับรองความถูกต้องด้วยสองปัจจัยอยู่");
    a.put(fw.aT, "รหัสความปลอดภัย");
    a.put(fw.aU, "ส่งข้อความไปที่โทรศัพท์ของคุณ รหัส 6 หลักที่คุณได้รับจะใช้ได้เป็นเวลา 5 นาที");
    a.put(fw.aV, "กำลังส่งข้อความ");
    a.put(fw.aW, "โปรดป้อนรหัสความปลอดภัย 6 หลัก");
    a.put(fw.aX, "หมายเลขโทรศัพท์มือถือของคุณ");
    a.put(fw.aY, "ส่งข้อความ");
    a.put(fw.aZ, "ส่งข้อความอีกครั้ง");
    a.put(fw.ba, "ไม่สามารถเข้าสู่ระบบได้เนื่องจากบัญชีของคุณเปิดใช้งานการรับรองความถูกต้องด้วยสองปัจจัยอยู่ โปรดเข้าไปที่เว็บไซต์ PayPal เพื่อเปิดใช้รหัสลับความปลอดภัยค่ะ");
    a.put(fw.bb, "ไม่อนุญาตให้ชำระเงินจากอุปกรณ์นี้");
    a.put(fw.bc, "อุปกรณ์ไม่ได้รับอนุญาต");
    a.put(fw.bd, "ไม่อนุญาตให้ชำระเงินให้ผู้ค้ารายนี้ (clientId ไม่ถูกต้อง)");
    a.put(fw.be, "ผู้ค้าไม่ถูกต้อง");
    a.put(fw.bf, "เกิดปัญหาขณะดำเนินการชำระเงินให้คุณ โปรดลองอีกครั้ง");
    a.put(fw.bg, "ไม่ทราบแหล่งที่มา");
    a.put(fw.bh, "ขออภัยค่ะ");
    a.put(fw.bi, "คำสั่งซื้อของคุณ");
    a.put(fw.bj, "อุปกรณ์นี้ไม่สามารถสื่อสารกับ PayPal ได้เนื่องจาก Andriod เวอร์ชันนี้เก่าเกินไป โปรดอัปเกรด Android หรือลองอุปกรณ์ที่ใหม่กว่า");
    a.put(fw.bk, "ลบบัตรทั้งหมดหรือไม่");
    a.put(fw.bl, "ขอความยินยอมไม่สำเร็จ");
    a.put(fw.bm, "เชื่อมต่อไม่สำเร็จ");
    a.put(fw.bn, "เข้าสู่ระบบไม่สำเร็จ");
    a.put(fw.bo, "เข้าสู่ระบบด้วยรหัสผ่าน");
    a.put(fw.bp, "เข้าสู่ระบบด้วย PIN");
    a.put(fw.bq, "โปรดรอสักครู่…");
    a.put(fw.br, "ชำระเงินไม่สำเร็จ");
    a.put(fw.bs, "สแกน");
    a.put(fw.bt, "รหัสความปลอดภัยไม่ถูกต้อง โปรดลองอีกครั้ง");
    a.put(fw.bu, "ผ่าน");
    a.put(fw.bv, "ระบบเกิดข้อผิดพลาด โปรดลองอีกครั้งในภายหลัง");
