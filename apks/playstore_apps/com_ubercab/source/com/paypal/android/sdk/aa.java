  ...
  implements h
{
  ...
  public aa()
  {
    a.put(fw.a, "Concordar e pagar");
    a.put(fw.b, "& outros");
    a.put(fw.c, "A autenticar");
    a.put(fw.d, "Voltar");
    a.put(fw.e, "Reserva");
    a.put(fw.f, "Cancelar");
    ...
    a.put(fw.v, "Visa");
    a.put(fw.w, "Alterar meio de pagamento");
    a.put(fw.x, "Corrente");
    a.put(fw.y, "A verificar o dispositivo…");
    a.put(fw.z, "Apagar informações do cartão");
    a.put(fw.A, "Confirmar");
    a.put(fw.B, "Tem a certeza de que pretende apagar os dados do seu cartão?");
    a.put(fw.C, "Debitar no cartão");
    a.put(fw.D, "Tem a certeza de que pretende terminar a sessão PayPal?");
    a.put(fw.E, "Pagar");
    a.put(fw.F, "Concordo");
    a.put(fw.G, "Data de criação da conta");
    a.put(fw.H, "Estado da conta");
    a.put(fw.I, "Tipo de conta");
    a.put(fw.J, "Morada");
    a.put(fw.K, "Faixa etária");
    a.put(fw.L, "Data de nascimento");
    a.put(fw.M, "Endereço de e-mail");
    a.put(fw.N, "Nome completo");
    a.put(fw.O, "Sexo");
    a.put(fw.P, "Idioma");
    a.put(fw.Q, "Local");
    a.put(fw.R, "Telefone");
    a.put(fw.S, "Fuso horário");
    a.put(fw.T, "Partilhar o seguinte: %s.");
    a.put(fw.U, "Usar checkout com um só toque.");
    a.put(fw.V, "%s pede-lhe para:");
    a.put(fw.W, "Partilhar os <a href='%1$s'>meios de pagamento</a> associados à sua conta PayPal.");
    a.put(fw.X, "Ativar a exibição das suas opções de financiamento para que possa fazer uma escolha.");
    a.put(fw.Y, "<a href='%1$s'>Autorizar débitos</a> para compras futuras feitas em %2$s pagas com PayPal. Está a dar ao PayPal instruções para pagar todos os montantes solicitados por %3$s.");
    a.put(fw.Z, "Permitir que adicionem e façam a gestão do respetivo cartão de fidelização na sua carteira PayPal.");
    a.put(fw.aa, "Concordar com a <a href='%2$s'>Política de Privacidade</a> e o <a href='%3$s'>Contrato do Utilizador</a> de %1$s.");
    a.put(fw.ab, "Permitir que <a href='%1$s'>solicitem dinheiro</a> em seu nome até que retire o seu consentimento.");
    a.put(fw.ac, "Permitir que <a href='%1$s'>enviem dinheiro</a> em seu nome até que retire o seu consentimento.");
    a.put(fw.ad, "Autorizar");
    a.put(fw.ae, "E-mail");
    a.put(fw.af, "Dados fictícios");
    a.put(fw.ag, "Sandbox");
    a.put(fw.ah, "Validade");
    a.put(fw.ai, "<h1><strong>Meios de pagamento</strong></h1><p>PayPal apenas partilha quais dos seus meios de pagamento estão disponíveis para utilização.</p>");
    a.put(fw.aj, "Esqueceu-se da palavra-passe?");
    a.put(fw.ak, "De");
    a.put(fw.al, "De que forma gostaria de financiar os pagamentos futuros a %1$s?");
    a.put(fw.am, "<h1><strong>Contrato de Pagamento Futuro</strong></h1><p>A sua fonte de financiamento predefinida será usada em pagamentos futuros com PayPal efetuados neste comerciante.</p><p>Para cancelar este contrato, inicie sessão na sua conta PayPal, entre em <strong>Perfil</strong> &gt; <strong>As minhas definições</strong> &gt; <strong>Iniciar a sessão com PayPal</strong> e remova este comerciante da lista.</p><p>Aplica-se a secção de Pagamento Periódico do <a href='%s'>Contrato do Utilizador do PayPal</a>.</p><p>Para garantir que os pagamentos são efetuados corretamente com a sua conta PayPal, esta aplicação poderá simular uma pequena transação de teste, mas não será transferido qualquer dinheiro.</p>");
    a.put(fw.an, "Erro interno");
    a.put(fw.ao, "<p>Ao clicar no botão em baixo, confirmo que concordo com os termos do <a href='%1$s'>Contrato do Utilizador do PayPal</a> e declaro que estou em conformidade com as leis e regulamentos japoneses, inclusive as sanções contra pagamentos à Coreia do Norte e ao Irão definidas na <a href='%2$s'>Lei do Câmbio Internacional e Comércio Externo (Foreign Exchange and Foreign Trade Act)</a>, para concluir a transação.</p>");
    a.put(fw.ap, "Iniciar sessão");
    a.put(fw.aq, "Iniciar sessão com PayPal");
    a.put(fw.ar, "Terminar sessão");
    a.put(fw.as, "Terminar sessão");
    a.put(fw.at, "OK");
    a.put(fw.au, "Palavra-passe");
    a.put(fw.av, "Pagar após a entrega");
    a.put(fw.aw, "Pagar com");
    a.put(fw.ax, "Pagar com cartão");
    a.put(fw.ay, "Saldo PayPal");
    a.put(fw.az, "PayPal Credit");
    a.put(fw.aA, "Telefone");
    a.put(fw.aB, "PIN");
    a.put(fw.aC, "Meio de pagamento preferido");
    a.put(fw.aD, "PayPal protege a sua <a href='%s'>privacidade</a> e os seus dados financeiros.");
    a.put(fw.aE, "A processar");
    a.put(fw.aF, "Memorizar cartão");
    a.put(fw.aG, "Solicitar dinheiro");
    a.put(fw.aH, "<h1><strong>%s</strong></h1><p>Quaisquer detalhes relevantes da transação serão partilhados com o comerciante.</p><p>Para retirar o consentimento, inicie sessão em paypal.com, entre nas opções <strong>Iniciar sessão com PayPal</strong> nas definições de <strong>Perfil</strong> e remova este comerciante.</p><p>PayPal não é responsável por quaisquer ações ou erros da parte do parceiro.</p>");
    a.put(fw.aI, "Poupança");
    a.put(fw.aJ, "Enviar dinheiro");
    a.put(fw.aK, "Ocorreu um erro ao comunicar com os servidores do PayPal. Tente novamente.");
    a.put(fw.aL, "Inicie novamente a sessão PayPal.");
    a.put(fw.aM, "A sessão expirou");
    a.put(fw.aN, "Morada de envio");
    a.put(fw.aO, "Novo no PayPal? Criar conta");
    a.put(fw.aP, "Manter a sessão iniciada");
    a.put(fw.aQ, "Erro de sistema (%s). Tente novamente mais tarde.");
    a.put(fw.aR, "Tente novamente");
    a.put(fw.aS, "Não foi possível iniciar sessão porque a autenticação de dois factores está ativada na sua conta.");
    a.put(fw.aT, "Código de segurança");
    a.put(fw.aU, "Envie uma mensagem de texto para o seu telefone. O código com 6 dígitos que receber será válido durante 5 minutos.");
    a.put(fw.aV, "A enviar mensagem");
    a.put(fw.aW, "Introduza o código com 6 dígitos");
    a.put(fw.aX, "O seu número de telemóvel");
    a.put(fw.aY, "Enviar mensagem");
    a.put(fw.aZ, "Enviar mensagem novamente");
    a.put(fw.ba, "Não foi possível iniciar sessão porque a autenticação de dois factores está ativada na sua conta. Visite o site do PayPal para ativar a sua chave de segurança.");
    a.put(fw.bb, "Não são permitidos pagamentos com este dispositivo.");
    a.put(fw.bc, "Dispositivo não autorizado");
    a.put(fw.bd, "Não são permitidos pagamentos a este comerciante (ID de cliente inválida).");
    a.put(fw.be, "Comerciante inválido");
    a.put(fw.bf, "Houve um problema no processamento do seu pagamento. Tente novamente.");
    a.put(fw.bg, "Fonte não reconhecida");
    a.put(fw.bh, "Lamentamos");
    a.put(fw.bi, "O seu pedido");
    a.put(fw.bj, "Este dispositivo tem uma versão de Android demasiado antiga, pelo que não pode comunicar com PayPal. Atualize a versão do sistema operativo ou tentar usar um dispositivo mais recente.");
    a.put(fw.bk, "Apagar cartão?");
    a.put(fw.bl, "Erro na autorização");
    a.put(fw.bm, "Falha na ligação");
    a.put(fw.bn, "Falha ao iniciar sessão");
    a.put(fw.bo, "Iniciar sessão com palavra-passe");
    a.put(fw.bp, "Iniciar sessão com PIN");
    a.put(fw.bq, "Aguarde…");
    a.put(fw.br, "O pagamento falhou");
    a.put(fw.bs, "Ler");
    a.put(fw.bt, "Código de segurança incorreto. Tente novamente.");
    a.put(fw.bu, "Via");
    a.put(fw.bv, "Erro de sistema. Tente novamente mais tarde.");
    ...
    c.put("account_locked_generate_challenge_limit_exceeded", "Houve demasiadas tentativas de início de sessão. Tente novamente mais tarde ou entre em contacto com PayPal para obter ajuda.");
  }
