...
public final class fx
{
  ...
  public fx(Context paramContext)
  {
    ...
    while (m < 10)
    {
      ...
      localTextView.setTextColor(cy.k);
      localTextView.setLinkTextColor(cy.t);
      localTextView.setTypeface(cy.s);
      localTextView.setTextSize(18.0F);
      localTextView.setSingleLine(false);
      localTextView.setMovementMethod(LinkMovementMethod.getInstance());
      localLinearLayout.addView(localTextView);
      cz.a(localTextView, -1, -2);
      cz.a(localTextView, null, "10dip");
      arrayOfTextView[m] = localTextView;
      this.c[m].setFocusable(false);
      this.c[m].setVisibility(8);
      this.c[m].setId(m + 100);
      m += 1;
    }
    ...
    cz.a(this.e, -1, -2);
    cz.b(this.e, null, "20dip", null, "10dip");
    this.e.setVisibility(8);
    this.h = cz.a(paramContext, true, 1, localLinearLayout);
    this.h.setNextFocusLeftId(2);
    this.h.setNextFocusRightId(3);
    this.i = new TextView(paramContext);
    cz.a(this.i);
    this.i.setText("Agree");
    this.h.addView(this.i, new ViewGroup.LayoutParams(-2, -2));
    this.g = new Button(paramContext);
    this.g.setId(3);
    cz.a(this.g);
    localLinearLayout.addView(this.g);
    cz.b(this.g, null, null, null, "16dip");
    cz.a(this.g, -2, -2);
    cz.a(this.g, 17, 1.0F);
    this.g.setNextFocusLeftId(1);
    this.f = new fy(paramContext);
    this.k.addView(this.f.a);
    cz.a(this.f.a, -2, -2);
    cz.a(this.f.a, 17, 1.0F);
    this.a = this.j;
  }
}
