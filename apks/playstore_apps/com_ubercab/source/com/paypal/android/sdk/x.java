  ...
  implements h
{
  ...
  public x()
  {
    a.put(fw.a, "Godta og betal");
    a.put(fw.b, "og andre");
    a.put(fw.c, "Godkjenner");
    a.put(fw.d, "Tilbake");
    a.put(fw.e, "Reserve");
    a.put(fw.f, "Avbryt");
    ...
    a.put(fw.v, "Visa");
    a.put(fw.w, "Endre betalingsmetode");
    a.put(fw.x, "Brukskonto");
    a.put(fw.y, "Kontrollerer denne enheten …");
    a.put(fw.z, "Fjern kortopplysningene");
    a.put(fw.A, "Bekreft");
    a.put(fw.B, "Er du sikker på at du vil fjerne kortopplysningene dine?");
    a.put(fw.C, "Belast kortet");
    a.put(fw.D, "Er du sikker på at du vil logge av PayPal?");
    a.put(fw.E, "Betal");
    a.put(fw.F, "Godta");
    a.put(fw.G, "Opprettelsesdato for kontoen");
    a.put(fw.H, "Kontostatus");
    a.put(fw.I, "Kontotype");
    a.put(fw.J, "Adresse");
    a.put(fw.K, "Aldersgruppe");
    a.put(fw.L, "Fødselsdato");
    a.put(fw.M, "E-postadresse");
    a.put(fw.N, "Fullt navn");
    a.put(fw.O, "Kjønn");
    a.put(fw.P, "Språk");
    a.put(fw.Q, "Norsk, Norge");
    a.put(fw.R, "Telefon");
    a.put(fw.S, "Tidssone");
    a.put(fw.T, "Del følgende: %s.");
    a.put(fw.U, "Bruk sømløs betaling.");
    a.put(fw.V, "%s ber om at du:");
    a.put(fw.W, "Del <a href='%1$s'>betalingsmetodene</a> som er tilknyttet PayPal-kontoen din.");
    a.put(fw.X, "Aktiver visning av finansieringskilder slik at du kan velge en.");
    a.put(fw.Y, "<a href='%1$s'>Godkjenn betalinger</a> for fremtidige kjøp hos %2$s via PayPal. Du ber PayPal om å betale alle summer som %3$s ber om.");
    a.put(fw.Z, "Tillater at de legger til og administrerer et fordelskort i PayPal-lommeboken din.");
    a.put(fw.aa, "Godtar %1$s sine <a href='%2$s'>retningslinjer for personvern</a> og <a href='%3$s'>brukeravtale</a>.");
    a.put(fw.ab, "Gi vedkommende tillatelse til å <a href='%1$s'>be om penger</a> på dine vegne inntil du trekker tilbake tillatelsen.");
    a.put(fw.ac, "Gi vedkommende tillatelse til å <a href='%1$s'>overføre penger</a> på dine vegne inntil du trekker tilbake tillatelsen.");
    a.put(fw.ad, "Godta");
    a.put(fw.ae, "E-postadresse");
    a.put(fw.af, "Eksempeldata");
    a.put(fw.ag, "Sandbox");
    a.put(fw.ah, "Utløper");
    a.put(fw.ai, "<h1><strong>Betalingsmetoder</strong></h1><p>PayPal deler kun hvilke av betalingsmetodene dine som er tilgjengelige for bruk.</p>");
    a.put(fw.aj, "Har du glemt passordet?");
    a.put(fw.ak, "Fra");
    a.put(fw.al, "Hvordan vil du finansiere fremtidige betalinger til %1$s er?");
    a.put(fw.am, "<h1><strong>Fremtidig betalingsavtale</strong></h1><p>Den standard finansieringskilden din brukes til å utføre fremtidige PayPal-betalinger for denne forhandleren.</p><p>Hvis du vil avbryte denne avtalen, logger du på PayPal-kontoen, går til <strong>Profil</strong> &gt; <strong>Mine innstillinger</strong> &gt; <strong>Logg på med PayPal</strong> og fjerner denne forhandleren fra listen.</p><p>Regelmessig betaling-delen av <a href='%s'>PayPals brukeravtale</a> er gjeldende.</p><p>For å kontrollere at betalinger fungerer med PayPal-kontoen din, kan denne appen simulere en liten prøvetransaksjonen, men ingen penger overføres.</p>");
    a.put(fw.an, "Intern feil");
    a.put(fw.ao, "<p>Ved å klikke på knappen nedenfor, godtar jeg vilkårene i <a href='%1$s'>PayPals brukeravtale</a> og jeg erklærer samtidig at jeg overholder japanske lover og forskrifter, herunder sanksjonsbestemmelser om betalinger til Nord-Korea og Iran, i tråd med japansk <a href='%2$s'>lovgivning om handel med utenlandske produkter og valuta</a>, for å fullføre transaksjonen.</p>");
    a.put(fw.ap, "Logg på");
    a.put(fw.aq, "Logg på med PayPal");
    a.put(fw.ar, "Logg ut");
    a.put(fw.as, "Logg ut");
    a.put(fw.at, "OK");
    a.put(fw.au, "Passord");
    a.put(fw.av, "Betal etter levering");
    a.put(fw.aw, "Betal med");
    a.put(fw.ax, "Betal med kort");
    a.put(fw.ay, "PayPal-saldo");
    a.put(fw.az, "PayPal Credit");
    a.put(fw.aA, "Telefonnummer");
    a.put(fw.aB, "PIN-kode");
    a.put(fw.aC, "Foretrukket betalingsmetode");
    a.put(fw.aD, "PayPal beskytter <a href='%s'>personvern</a>-opplysningene dine og den økonomiske informasjonen din.");
    a.put(fw.aE, "Behandler");
    a.put(fw.aF, "Husk kortet");
    a.put(fw.aG, "Pengeforespørsel");
    a.put(fw.aH, "<h1><strong>%s</strong></h1><p>Alle relevante transaksjonsdetaljer deles med forhandleren.</p><p>Hvis du vil trekke tilbake tillatelsen din, logger du på paypal.com, går til <strong>Logg på med PayPal</strong>-alternativene under <strong>Profil</strong>-innstillingene og fjerner denne forhandleren.</p><p>PayPal er ikke ansvarlig for partnerens handlinger eller feil.</p>");
    a.put(fw.aI, "Sparekonto");
    a.put(fw.aJ, "Betal/overfør");
    a.put(fw.aK, "Det var et kommunikasjonsproblem med PayPal-serverne. Prøv på nytt.");
    a.put(fw.aL, "Logg deg på PayPal på nytt.");
    a.put(fw.aM, "Økten er utløpt");
    a.put(fw.aN, "Leveringsadresse");
    a.put(fw.aO, "Ny på PayPal? Opprett konto");
    a.put(fw.aP, "Forbli pålogget");
    a.put(fw.aQ, "Systemfeil (%s). Prøv på nytt senere.");
    a.put(fw.aR, "Prøv på nytt");
    a.put(fw.aS, "Kan ikke logge på, fordi påloggingen til kontoen din har godkjenning med to faktorer.");
    a.put(fw.aT, "Sikkerhetskode");
    a.put(fw.aU, "Send en tekstmelding til telefonen din. Den 6-sifrede koden du mottar, er gyldig i 5 minutter.");
    a.put(fw.aV, "Sender meldingen");
    a.put(fw.aW, "Oppgi den 6-sifrede sikkerhetskoden");
    a.put(fw.aX, "Ditt mobilnummer");
    a.put(fw.aY, "Send melding");
    a.put(fw.aZ, "Send meldingen på nytt");
    a.put(fw.ba, "Kan ikke logge på, fordi påloggingen til kontoen din har godkjenning med to faktorer. Gå til PayPals nettsted for å aktivere sikkerhetsnøkkelen din.");
    a.put(fw.bb, "Betaling fra denne enheten er ikke tillatt.");
    a.put(fw.bc, "Uautorisert enhet");
    a.put(fw.bd, "Betalinger til denne forhandleren er ikke tillatt (ugyldig bruker-id).");
    a.put(fw.be, "Ugyldig forhandler");
    a.put(fw.bf, "Det oppsto et problem ved behandlingen av betalingen. Prøv på nytt.");
    a.put(fw.bg, "Ukjent betalingsmetode");
    a.put(fw.bh, "Vi beklager");
    a.put(fw.bi, "Din bestilling");
    a.put(fw.bj, "Denne enheten kan ikke kommunisere med PayPal fordi androidversjonen er for gammel. Oppgrader til en nyere androidversjon, eller forsøk med en nyere enhet.");
    a.put(fw.bk, "Vil du fjerne kortet?");
    a.put(fw.bl, "Godkjenningen mislyktes");
    a.put(fw.bm, "Tilkobling mislykket");
    a.put(fw.bn, "Pålogging mislyktes");
    a.put(fw.bo, "Logg på med passord");
    a.put(fw.bp, "Logg på med PIN");
    a.put(fw.bq, "Et øyeblikk …");
    a.put(fw.br, "Betaling mislyktes");
    a.put(fw.bs, "Skann");
    a.put(fw.bt, "Feil sikkerhetskode. Prøv på nytt.");
    a.put(fw.bu, "via");
    a.put(fw.bv, "Systemfeil. Prøv på nytt senere.");
