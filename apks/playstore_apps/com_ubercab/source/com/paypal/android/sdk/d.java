...
public class d
{
  ...
  public static String a(String paramString)
  {
    ...
    localObject = new StringBuilder("unable_to_encode:");
  ...
  public static void a(Activity paramActivity, TextView paramTextView, String paramString1, String paramString2, Drawable paramDrawable)
  {
    ...
    paramActivity.setTitle(localStringBuilder.toString());
    paramString2 = paramActivity.getActionBar();
    paramString2.setBackgroundDrawable(cy.c);
  ...
  {
    // Byte code:
    //   0: new 161	java/io/FileOutputStream
    //   3: dup
    //   4: aload_0
    //   5: invokespecial 164	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   8: astore_0
    //   9: aload_0
    //   10: aload_1
    //   11: ldc 33
    //   13: invokevirtual 168	java/lang/String:getBytes	(Ljava/lang/String;)[B
    //   16: invokevirtual 171	java/io/FileOutputStream:write	([B)V
    //   19: aload_0
    //   20: invokestatic 176	com/paypal/android/sdk/aw:a	(Ljava/io/Closeable;)V
    //   23: return
    //   24: astore_1
    //   25: goto +6 -> 31
    //   28: astore_1
    ...
    //   30: astore_0
    //   31: aload_0
    //   32: invokestatic 176	com/paypal/android/sdk/aw:a	(Ljava/io/Closeable;)V
    //   35: aload_1
    //   36: athrow
      ...
      if (i == 0)
      {
        ...
        if (i == 0)
        {
          ...
          if (i == 0)
          {
            ...
            if ((i == 0) && (!Build.FINGERPRINT.startsWith("generic")))
            {
              ...
              if (i == 0)
              {
                ...
                localStringBuilder.append(File.separatorChar);
                localStringBuilder.append("BstSharedFolder");
  ...
  public static boolean a(String paramString1, String paramString2, String paramString3)
  {
    ...
    boolean bool2 = c(paramString2);
    if (bool2)
    {
      paramString2 = new StringBuilder();
      paramString2.append(paramString3);
      paramString2.append(" contains whitespace.");
  ...
  public static SpannableString b(String paramString)
  {
    ...
    String str = fu.a(fw.ao);
    if ((b(paramString)) && (paramString.equals("ja"))) {
      paramString = "https://cms.paypal.com/jp/cgi-bin/marketingweb?cmd=_render-content&content_ID=ua/Legal_Hub_full&locale.x=ja_JP";
    } else {
      paramString = "https://cms.paypal.com/jp/cgi-bin/marketingweb?cmd=_render-content&content_ID=ua/Legal_Hub_full&locale.x=en_US";
    }
  ...
  public static InputStream b()
  {
    ...
    {
      throw new SSLException(localUnsupportedEncodingException.getMessage());
    }
  }
  ...
  public static boolean c(String paramString)
  {
    ...
    return (paramString.matches("^([a-zA-Z0-9]|_|-)*$")) && (paramString.length() <= 32);
  }
  
  public c a(a paramA)
  {
    String str = a(paramA.e());
    paramA = paramA.c();
    StringBuilder localStringBuilder = new StringBuilder();
    localStringBuilder.append(str);
    localStringBuilder.append(paramA);
    return new eg(localStringBuilder.toString());
  }
}
