  ...
  implements h
{
  ...
  public l()
  {
    ...
    a.put(fw.X, "Enable display of your funding options to allow you to make a choice.");
    a.put(fw.Y, "<a href='%1$s'>Authorize charges</a> for future %2$s purchases paid for with PayPal. You instruct PayPal to pay all amounts requested by %3$s.");
    ...
    a.put(fw.aL, "Please log in again to PayPal.");
    ...
    a.put(fw.bc, "Unauthorized Device");
    ...
    a.put(fw.bg, "Unrecognized Source");
