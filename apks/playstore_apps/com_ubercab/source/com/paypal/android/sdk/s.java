  ...
  implements h
{
  ...
  public s()
  {
    a.put(fw.a, "Accetta e paga");
    a.put(fw.b, "e altri");
    a.put(fw.c, "Autenticazione…");
    a.put(fw.d, "Indietro");
    a.put(fw.e, "Di riserva");
    a.put(fw.f, "Annulla");
    a.put(fw.g, "American Express");
    a.put(fw.h, "Carta Aura");
    a.put(fw.i, "Carta Aura");
    a.put(fw.j, "Prepagata PayPal");
    ...
    a.put(fw.v, "Visa");
    a.put(fw.w, "Modifica metodo di pagamento");
    a.put(fw.x, "Conto corrente");
    a.put(fw.y, "Controllo dispositivo…");
    a.put(fw.z, "Rimuovi dati della carta");
    a.put(fw.A, "Conferma");
    a.put(fw.B, "Rimuovere i dati della carta?");
    a.put(fw.C, "Addebita importo sulla carta");
    a.put(fw.D, "Vuoi uscire da PayPal?");
    a.put(fw.E, "Paga");
    a.put(fw.F, "Accetta");
    a.put(fw.G, "Data creazione conto");
    a.put(fw.H, "Stato del conto");
    a.put(fw.I, "Tipo di conto");
    a.put(fw.J, "Indirizzo");
    a.put(fw.K, "Fascia di età");
    a.put(fw.L, "Data di nascita");
    a.put(fw.M, "Indirizzo email");
    a.put(fw.N, "Nome e cognome");
    a.put(fw.O, "Sesso");
    a.put(fw.P, "Lingua");
    a.put(fw.Q, "Locale");
    a.put(fw.R, "Telefono");
    a.put(fw.S, "Fuso orario");
    a.put(fw.T, "Condividi il seguente: %s.");
    a.put(fw.U, "Usa Pagamento express.");
    a.put(fw.V, "%s ti chiede di:");
    a.put(fw.W, "Condividi i <a href='%1$s'>metodi di pagamento</a> collegati al tuo conto PayPal.");
    a.put(fw.X, "Per effettuare una scelta, attiva la visualizzazione dei metodi di pagamento.");
    a.put(fw.Y, "<a href='%1$s'>Autorizza l’addebito</a> dei prossimi acquisti effettuati su %2$s e pagati con PayPal. Autorizzi PayPal a pagare tutti gli importi richiesti da %3$s.");
    a.put(fw.Z, "consentirgli di aggiungere e gestire la propria carta fedeltà nel tuo portafoglio PayPal.");
    a.put(fw.aa, "Accettare l’<a href='%2$s'></a> Informativa sulla privacy<a href='%3$s'> e le</a> Condizioni d’uso di %1$s.");
    a.put(fw.ab, "Consentirgli di <a href='%1$s'>richiedere denaro</a> a tuo nome fino alla revoca del consenso.");
    a.put(fw.ac, "Consentirgli di <a href='%1$s'>inviare denaro</a> a tuo nome fino alla revoca del consenso.");
    a.put(fw.ad, "Consenso");
    a.put(fw.ae, "Email");
    a.put(fw.af, "Dati di esempio");
    a.put(fw.ag, "Sandbox");
    a.put(fw.ah, "Scadenza");
    a.put(fw.ai, "<h1><strong>Metodi di pagamento</strong></h1><p>PayPal condivide solo i tuoi metodi di pagamento disponibili per l’utilizzo.</p>");
    a.put(fw.aj, "Password dimenticata?");
    a.put(fw.ak, "Da");
    a.put(fw.al, "Come vuoi pagare i prossimi acquisti su %1$s?");
    a.put(fw.am, "<h1><strong>Consenso ai pagamenti preautorizzati</strong></h1><p>Gli importi dei prossimi pagamenti effettuati con PayPal da questa app verranno prelevati dal tuo metodo di pagamento predefinito.</p><p>Per annullare il consenso, accedi al tuo conto PayPal, seleziona <strong>Profilo</strong> &gt; <strong>Sicurezza</strong> &gt; <strong>Log in con PayPal</strong> e rimuovi il commerciante dall’elenco.</p><p>Si applica la sezione Pagamenti automatici delle <a href='%s'>Condizioni d’uso PayPal</a>.</p><p>Per verificare il funzionamento dell’addebito dei pagamenti futuri sul tuo conto PayPal, questa app potrebbe simulare una transazione di prova, senza un reale trasferimento di denaro.</p>");
    a.put(fw.an, "Errore interno");
    a.put(fw.ao, "<p>Cliccando il pulsante di seguito, accetto le <a href='%1$s'>Condizioni d’uso PayPal</a> e dichiaro di rispettare le leggi e normative del Giappone, tra cui le sanzioni previste per i pagamenti alla Corea del Nord e all’Iran in base al <a href='%2$s'>Foreign Exchange and Foreign Trade Act</a> (Legge sugli scambi e sul commercio estero), per completare la transazione.</p>");
    a.put(fw.ap, "Accedi");
    a.put(fw.aq, "Log in con PayPal");
    a.put(fw.ar, "Esci");
    a.put(fw.as, "Esci");
    a.put(fw.at, "OK");
    a.put(fw.au, "Password");
    a.put(fw.av, "Paga dopo la consegna");
    a.put(fw.aw, "Paga con");
    a.put(fw.ax, "Paga con una carta");
    a.put(fw.ay, "Saldo PayPal");
    a.put(fw.az, "PayPal Credit");
    a.put(fw.aA, "Telefono");
    a.put(fw.aB, "PIN");
    a.put(fw.aC, "Metodo di pagamento preferito");
    a.put(fw.aD, "PayPal protegge la tua <a href='%s'>privacy</a> e i tuoi dati.");
    a.put(fw.aE, "Elaborazione in corso");
    a.put(fw.aF, "Ricorda dati carta");
    a.put(fw.aG, "Richiedi denaro");
    a.put(fw.aH, "<h1><strong>%s</strong></h1><p>Tutti i dettagli rilevanti della transazione verranno condivisi con il commerciante.</p><p>Per annullare il consenso, accedi al tuo conto PayPal, seleziona l’icona <strong>Profilo</strong> &gt; Sicurezza &gt; <strong>Log in con PayPal</strong> e rimuovi questo commerciante.</p><p>PayPal non è responsabile di azioni o errori da parte del Partner.</p>");
    a.put(fw.aI, "Conto corrente");
    a.put(fw.aJ, "Invia denaro");
    a.put(fw.aK, "Si è verificato un problema con i nostri server. Riprova.");
    a.put(fw.aL, "Ripeti l’accesso a PayPal.");
    a.put(fw.aM, "Sessione scaduta");
    a.put(fw.aN, "Indirizzo di spedizione");
    a.put(fw.aO, "Non hai un conto PayPal? Registrati");
    a.put(fw.aP, "Rimani connesso");
    a.put(fw.aQ, "Errore di sistema (%s). Riprova più tardi.");
    a.put(fw.aR, "Riprova");
    a.put(fw.aS, "Impossibile effettuare l’accesso perché sul tuo conto è attiva la doppia autenticazione.");
    a.put(fw.aT, "Codice di sicurezza");
    a.put(fw.aU, "Ricevi un SMS sul tuo telefono. Il codice a 6 cifre sarà valido per 5 minuti.");
    a.put(fw.aV, "Invio SMS in corso");
    a.put(fw.aW, "Immetti il codice di sicurezza a 6 cifre");
    a.put(fw.aX, "Numero di cellulare");
    a.put(fw.aY, "Ricevi SMS");
    a.put(fw.aZ, "Ricevi un altro SMS");
    a.put(fw.ba, "Impossibile effettuare l’accesso perché sul tuo conto è attiva la doppia autenticazione. Visita il sito PayPal per attivare la chiave di accesso.");
    a.put(fw.bb, "Pagamenti da questo dispositivo non consentiti.");
    a.put(fw.bc, "Dispositivo non autorizzato");
    a.put(fw.bd, "I pagamenti a questo venditore non sono consentiti (clientId non valido).");
    a.put(fw.be, "Sito non valido");
    a.put(fw.bf, "Si è verificato un problema durante l’elaborazione del pagamento. Riprova.");
    a.put(fw.bg, "Metodo non riconosciuto");
    a.put(fw.bh, "Spiacenti");
    a.put(fw.bi, "Il tuo ordine");
    a.put(fw.bj, "Questo dispositivo non dialoga con PayPal perché la versione di Android è obsoleta. Aggiorna Android o prova con un dispositivo più recente.");
    a.put(fw.bk, "Rimuovere la carta?");
    a.put(fw.bl, "Consenso non riuscito");
    a.put(fw.bm, "Connessione non riuscita");
    a.put(fw.bn, "Accesso non riuscito");
    a.put(fw.bo, "Accedi con la password");
    a.put(fw.bp, "Accedi con il PIN");
    a.put(fw.bq, "Attendi…");
    a.put(fw.br, "Pagamento non riuscito");
    a.put(fw.bs, "Scansione");
    a.put(fw.bt, "Codice di sicurezza errato. Riprova.");
    a.put(fw.bu, "tramite");
    a.put(fw.bv, "Errore di sistema. Riprova più tardi.");
    ...
    c.put("account_locked_generate_challenge_limit_exceeded", "Troppi tentativi di accesso. Riprova più tardi o contatta PayPal per richiedere assistenza.");
  }
