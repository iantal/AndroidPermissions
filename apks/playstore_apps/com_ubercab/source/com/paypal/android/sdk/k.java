  ...
  implements h
{
  ...
  public k()
  {
    a.put(fw.a, "Zustimmen und zahlen");
    a.put(fw.b, "und andere");
    a.put(fw.c, "Authentifizierung");
    a.put(fw.d, "Zurück");
    a.put(fw.e, "Alternative");
    a.put(fw.f, "Abbrechen");
    ...
    a.put(fw.v, "Visa");
    a.put(fw.w, "Zahlungsmethode ändern");
    a.put(fw.x, "Girokonto");
    a.put(fw.y, "Gerät wird überprüft…");
    a.put(fw.z, "Kreditkartendaten löschen");
    a.put(fw.A, "Bestätigen");
    a.put(fw.B, "Möchten Sie Ihre Kreditkartendaten wirklich löschen?");
    a.put(fw.C, "Kreditkarte belasten");
    a.put(fw.D, "Möchten Sie sich wirklich ausloggen?");
    a.put(fw.E, "Zahlen");
    a.put(fw.F, "Zustimmen");
    a.put(fw.G, "Konto eröffnet am");
    a.put(fw.H, "Kontostatus");
    a.put(fw.I, "Kontotyp");
    a.put(fw.J, "Adresse");
    a.put(fw.K, "Altersgruppe");
    a.put(fw.L, "Geburtsdatum");
    a.put(fw.M, "E-Mail-Adresse");
    a.put(fw.N, "Vollständiger Name");
    a.put(fw.O, "Geschlecht");
    a.put(fw.P, "Sprache");
    a.put(fw.Q, "Ländereinstellung");
    a.put(fw.R, "Telefon");
    a.put(fw.S, "Zeitzone");
    a.put(fw.T, "Folgende Informationen weitergeben: %s.");
    a.put(fw.U, "PayPal Express verwenden.");
    a.put(fw.V, "%s bittet um folgende Zustimmung:");
    a.put(fw.W, "Sie genehmigen die Weitergabe von Informationen über die in Ihrem PayPal-Konto hinterlegten <a href='%1$s'>Zahlungsmethoden</a>.");
    a.put(fw.X, "Zahlungsquellen anzeigen, damit Sie bei der Zahlung wählen können.");
    a.put(fw.Y, "Sie <a href='%1$s'>autorisieren Abbuchungen für zukünftige PayPal-Zahlungen</a> bei %2$s. Sie weisen PayPal an, die von %3$s geforderten Beträge zu zahlen.");
    a.put(fw.Z, "Sie stimmen zu, dass der Händler seine Kundenkarte Ihrer E-Börse hinzufügt und sie dort verwaltet.");
    a.put(fw.aa, "Sie stimmen den <a href='%2$s'>Datenschutzgrundsätzen</a> und den <a href='%3$s'>Nutzungsbedingungen</a> von %1$s zu.");
    a.put(fw.ab, "Sie gestatten dem Händler, bis auf Widerruf in Ihrem Namen <a href='%1$s'>Geld anzufordern</a>.");
    a.put(fw.ac, "Sie gestatten dem Händler, bis auf Widerruf in Ihrem Namen <a href='%1$s'>Geld zu senden</a>.");
    a.put(fw.ad, "Zustimmen");
    a.put(fw.ae, "E-Mail-Adresse");
    a.put(fw.af, "Beispieldaten");
    a.put(fw.ag, "Sandbox");
    a.put(fw.ah, "Gültig bis");
    a.put(fw.ai, "<h1><strong>Zahlungsmethoden</strong></h1><p>PayPal gibt nur weiter, welche Zahlungsmethoden verfügbar sind.</p>");
    a.put(fw.aj, "Passwort vergessen?");
    a.put(fw.ak, "Von");
    a.put(fw.al, "Wie möchten Sie Ihre weiteren Zahlungen an %1$s finanzieren?");
    a.put(fw.am, "<h1><strong>Abbuchungsvereinbarung</strong></h1><p>Für zukünftige PayPal-Zahlungen bei diesem Händler wird Ihre Standardzahlungsquelle verwendet. </p><p>Um diese Vereinbarung zu kündigen, loggen Sie sich in Ihr PayPal-Konto ein, rufen Sie <strong>Mein Profil</strong> &gt; <strong>Einstellungen</strong> &gt; <strong>Login mit PayPal</strong> auf und entfernen diesen Händler von der Liste.</p><p>Es gelten die <a href='%s'>PayPal-Nutzungsbedingungen</a> für Zahlungen im Einzugsverfahren.</p><p>Damit wir künftig Zahlungen von Ihrem PayPal-Konto abbuchen können, führt diese App eventuell eine kleine Testtransaktion durch. Hierbei wird aber kein Geld abgebucht.</p>");
    a.put(fw.an, "Interner Fehler");
    a.put(fw.ao, "<p>Durch Klicken auf den Button unten stimme ich den <a href='%1$s'>PayPal-Nutzungsbedingungen</a> zu und bestätige, dass ich bei dieser Transaktion die japanischen Gesetze und Vorschriften einhalte, einschließlich Sanktionen hinsichtlich Zahlungen nach Nordkorea oder in den Iran gemäß dem <a href='%2$s'>Gesetz über Devisen und internationalen Handel</a>.</p>");
    a.put(fw.ap, "Einloggen");
    a.put(fw.aq, "Login mit PayPal");
    a.put(fw.ar, "Ausloggen");
    a.put(fw.as, "Ausloggen");
    a.put(fw.at, "OK");
    a.put(fw.au, "Passwort");
    a.put(fw.av, "Bezahlung nach 14 Tagen");
    a.put(fw.aw, "Zahlen mit");
    a.put(fw.ax, "Mit Kreditkarte zahlen");
    a.put(fw.ay, "PayPal-Guthaben");
    a.put(fw.az, "PayPal Credit");
    a.put(fw.aA, "Handynr.");
    a.put(fw.aB, "PIN");
    a.put(fw.aC, "Bevorzugte Zahlungsmethode");
    a.put(fw.aD, "PayPal schützt Ihre <a href='%s'>Privatsphäre</a> und Ihre Finanzinformationen.");
    a.put(fw.aE, "In Verarbeitung");
    a.put(fw.aF, "Kreditkarte speichern");
    a.put(fw.aG, "Geld anfordern");
    a.put(fw.aH, "<h1><strong>%s</strong></h1><p>Alle relevanten Transaktionsdetails werden an den Händler weitergegeben.</p><p>Wenn Sie Ihre Zustimmung widerrufen möchten, loggen Sie sich auf PayPal.com ein und klicken Sie unter <strong>Mein Profil</strong> auf “Einstellungen”. Anschließend klicken Sie auf <strong>Login mit PayPal</strong> und entfernen diesen Händler.</p><p>PayPal übernimmt keine Verantwortung für die Handlungen oder Fehler des Partners.</p>");
    a.put(fw.aI, "Sparkonto");
    a.put(fw.aJ, "Geld senden");
    a.put(fw.aK, "Beim Datenaustausch mit den PayPal-Servern ist ein Problem aufgetreten. Bitte versuchen Sie es erneut.");
    a.put(fw.aL, "Loggen Sie sich erneut bei PayPal ein.");
    a.put(fw.aM, "Sitzung abgelaufen");
    a.put(fw.aN, "Lieferadresse");
    a.put(fw.aO, "Neu bei PayPal? Neu anmelden");
    a.put(fw.aP, "Eingeloggt bleiben");
    a.put(fw.aQ, "Systemfehler (%s). Bitte versuchen Sie es später noch einmal.");
    a.put(fw.aR, "Erneut versuchen");
    a.put(fw.aS, "Einloggen nicht möglich, da in Ihrem Konto die Zwei-Faktor-Authentifizierung aktiviert ist.");
    a.put(fw.aT, "Sicherheitscode");
    a.put(fw.aU, "Wir senden Ihnen eine SMS auf Ihr Handy. Diese enthält einen 6-stelligen Code, der fünf Minuten lang gültig ist.");
    a.put(fw.aV, "SMS senden");
    a.put(fw.aW, "6-stelligen Sicherheitscode eingeben");
    a.put(fw.aX, "Ihre Handynummer");
    a.put(fw.aY, "SMS senden");
    a.put(fw.aZ, "SMS erneut senden");
    a.put(fw.ba, "Einloggen nicht möglich, da in Ihrem Konto die Zwei-Faktor-Authentifizierung aktiviert ist. Aktivieren Sie über die PayPal-Website Ihren Sicherheitsschlüssel.");
    a.put(fw.bb, "Mit diesem Gerät sind keine Zahlungen möglich.");
    a.put(fw.bc, "Nicht autorisiertes Gerät");
    a.put(fw.bd, "Zahlungen an diesen Händler sind nicht möglich (ungültige Client-ID).");
    a.put(fw.be, "Ungültiger Händler");
    a.put(fw.bf, "Bei der Verarbeitung Ihrer Zahlung ist ein Problem aufgetreten. Bitte versuchen Sie es erneut.");
    a.put(fw.bg, "Nicht erkannte Zahlungsquelle");
    a.put(fw.bh, "Fehler");
    a.put(fw.bi, "Ihre Bestellung");
    a.put(fw.bj, "Dieses Gerät kann nicht mit PayPal kommunizieren, weil seine Android-Version zu alt ist. Aktualisieren Sie Android oder versuchen Sie es mit einem neueren Gerät.");
    a.put(fw.bk, "Kreditkarte löschen?");
    a.put(fw.bl, "Zustimmung fehlgeschlagen");
    a.put(fw.bm, "Keine Verbindung");
    a.put(fw.bn, "Login nicht erfolgreich");
    a.put(fw.bo, "Mit Passwort einloggen");
    a.put(fw.bp, "Mit PIN einloggen");
    a.put(fw.bq, "Einen Moment…");
    a.put(fw.br, "Zahlung fehlgeschlagen.");
    a.put(fw.bs, "Fotografieren");
    a.put(fw.bt, "Sicherheitscode falsch. Bitte versuchen Sie es erneut.");
    a.put(fw.bu, "über");
    a.put(fw.bv, "Systemfehler. Bitte versuchen Sie es später noch einmal.");
