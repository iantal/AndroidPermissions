  ...
  implements HttpHandler
{
    ...
    throws JSONException
  {
    if (this.mPageListResponse == null)
    {
      ...
      localStringBuilder.append(this.mInspectorPath);
      localJSONObject.put("webSocketDebuggerUrl", localStringBuilder.toString());
  ...
  public boolean handleRequest(SocketLike paramSocketLike, LightHttpRequest paramLightHttpRequest, LightHttpResponse paramLightHttpResponse)
  {
    ...
    try
    {
      ...
      else if ("/json/activate/1".equals(paramSocketLike))
      {
      ...
      else
      {
        ...
        paramLightHttpRequest.append("No support for ");
        paramLightHttpRequest.append(paramSocketLike);
        paramLightHttpRequest.append("\n");
        paramLightHttpResponse.body = LightHttpBody.create(paramLightHttpRequest.toString(), "text/plain");
      }
    }
    catch (JSONException paramSocketLike)
    {
      ...
      paramLightHttpRequest = new StringBuilder();
      paramLightHttpRequest.append(paramSocketLike.toString());
      paramLightHttpRequest.append("\n");
      paramLightHttpResponse.body = LightHttpBody.create(paramLightHttpRequest.toString(), "text/plain");
    }
    return true;
