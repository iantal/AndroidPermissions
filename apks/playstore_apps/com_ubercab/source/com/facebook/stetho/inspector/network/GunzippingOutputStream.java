  ...
  extends FilterOutputStream
{
    ...
    throws IOException
  {
    ...
    return new GunzippingOutputStream(new PipedOutputStream(localPipedInputStream), sExecutor.submit(new GunzippingOutputStream.GunzippingCallable(localPipedInputStream, paramOutputStream)));
  }
    ...
    throws IOException
  {
    // Byte code:
    //   0: aload_0
    //   1: invokespecial 86	java/io/FilterOutputStream:close	()V
    //   4: aload_0
    //   5: getfield 29	com/facebook/stetho/inspector/network/GunzippingOutputStream:mCopyFuture	Ljava/util/concurrent/Future;
    //   8: invokestatic 88	com/facebook/stetho/inspector/network/GunzippingOutputStream:getAndRethrow	(Ljava/util/concurrent/Future;)Ljava/lang/Object;
    //   11: pop
    //   12: return
    //   13: astore_1
    //   14: aload_1
    ...
    //   16: astore_1
    //   17: aload_0
    //   18: getfield 29	com/facebook/stetho/inspector/network/GunzippingOutputStream:mCopyFuture	Ljava/util/concurrent/Future;
    //   21: invokestatic 88	com/facebook/stetho/inspector/network/GunzippingOutputStream:getAndRethrow	(Ljava/util/concurrent/Future;)Ljava/lang/Object;
    //   24: pop
    //   25: aload_1
    //   26: athrow
    //   27: astore_2
