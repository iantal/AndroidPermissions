...
{
  public static final Parcelable.Creator<MessengerCompat> CREATOR = new dmh();
  private Messenger a;
  private dmf b;
  ...
  public MessengerCompat(IBinder paramIBinder)
  {
    ...
    else
    {
      ...
      if ((localIInterface instanceof dmf)) {
        paramIBinder = (dmf)localIInterface;
      } else {
        paramIBinder = new dmg(paramIBinder);
      }
    }
    this.b = paramIBinder;
  }
