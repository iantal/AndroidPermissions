...
class BackgroundManager
{
  ...
  private final List<BackgroundManager.Listener> listeners = new ArrayList();
  ...
  public void onActivityPaused()
  {
    if ((this.flushOnBackground) && (!this.inBackground))
    {
      ...
      {
        axbe.h().a("Answers", "Failed to schedule background detector", localRejectedExecutionException);
      }
    }
  }
