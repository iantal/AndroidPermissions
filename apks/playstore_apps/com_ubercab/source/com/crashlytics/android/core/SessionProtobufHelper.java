...
class SessionProtobufHelper
{
  ...
  private static int getDeviceIdentifierSize(axcp paramAxcp, String paramString)
  {
    return CodedOutputStream.computeEnumSize(1, paramAxcp.h) + CodedOutputStream.computeBytesSize(2, ByteString.copyFromUtf8(paramString));
  }
  ...
  private static int getEventAppExecutionSize(TrimmedThrowableData paramTrimmedThrowableData, Thread paramThread, StackTraceElement[] paramArrayOfStackTraceElement, Thread[] paramArrayOfThread, List<StackTraceElement[]> paramList, int paramInt, ByteString paramByteString1, ByteString paramByteString2)
  {
    ...
    m = getEventAppExecutionSignalSize();
  ...
  private static int getSessionAppSize(ByteString paramByteString1, ByteString paramByteString2, ByteString paramByteString3, ByteString paramByteString4, ByteString paramByteString5, int paramInt, ByteString paramByteString6)
  {
    ...
    j = i + 0 + j + k + (CodedOutputStream.computeTagSize(5) + CodedOutputStream.computeRawVarint32Size(m) + m) + CodedOutputStream.computeBytesSize(6, paramByteString5);
    i = j;
  ...
  private static int getSessionDeviceSize(int paramInt1, ByteString paramByteString1, ByteString paramByteString2, int paramInt2, long paramLong1, long paramLong2, boolean paramBoolean, Map<axcp, String> paramMap, int paramInt3, ByteString paramByteString3, ByteString paramByteString4)
  {
    int j = CodedOutputStream.computeBytesSize(1, paramByteString1);
    int i = 0;
    int k = CodedOutputStream.computeEnumSize(3, paramInt1);
    if (paramByteString2 == null) {
      paramInt1 = 0;
    } else {
      paramInt1 = CodedOutputStream.computeBytesSize(4, paramByteString2);
    }
    paramInt1 = j + 0 + k + paramInt1 + CodedOutputStream.computeUInt32Size(5, paramInt2) + CodedOutputStream.computeUInt64Size(6, paramLong1) + CodedOutputStream.computeUInt64Size(7, paramLong2) + CodedOutputStream.computeBoolSize(10, paramBoolean);
    paramInt2 = paramInt1;
    if (paramMap != null)
    {
      ...
      for (;;)
      {
        ...
        paramInt2 = getDeviceIdentifierSize((axcp)paramByteString2.getKey(), (String)paramByteString2.getValue());
        paramInt1 += CodedOutputStream.computeTagSize(11) + CodedOutputStream.computeRawVarint32Size(paramInt2) + paramInt2;
      }
    }
    j = CodedOutputStream.computeUInt32Size(12, paramInt3);
    ...
    if (paramByteString4 == null) {
      ...
      paramInt3 = CodedOutputStream.computeBytesSize(14, paramByteString4);
    }
    return paramInt2 + j + paramInt1 + paramInt3;
  }
  ...
  public static void writeSessionDevice(CodedOutputStream paramCodedOutputStream, String paramString1, int paramInt1, String paramString2, int paramInt2, long paramLong1, long paramLong2, boolean paramBoolean, Map<axcp, String> paramMap, int paramInt3, String paramString3, String paramString4)
    throws Exception
  {
    ...
    while (paramString1.hasNext())
    {
      ...
      paramCodedOutputStream.writeRawVarint32(getDeviceIdentifierSize((axcp)paramMap.getKey(), (String)paramMap.getValue()));
      paramCodedOutputStream.writeEnum(1, ((axcp)paramMap.getKey()).h);
