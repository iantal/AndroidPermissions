...
public abstract interface on
  extends MenuItem
{
  public abstract on a(CharSequence paramCharSequence);
  
  public abstract on a(rx paramRx);
  
  public abstract rx a();
  
  public abstract on b(CharSequence paramCharSequence);
