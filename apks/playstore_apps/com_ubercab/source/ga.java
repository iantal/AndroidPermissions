...
public class ga
{
    ...
    throws android.content.res.Resources.NotFoundException
  {
    ...
    //   82: aload_3
    //   83: invokestatic 57	ga:a	(Landroid/content/Context;Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Lorg/xmlpull/v1/XmlPullParser;)Landroid/view/animation/Interpolator;
    //   86: astore_0
    //   87: aload_3
    //   88: ifnull +9 -> 97
    //   91: aload_3
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        else
        {
          ...
          paramResources = new ge(paramContext, paramResources, paramXmlPullParser);
        }
      }
    }
    label277:
