...
public class np
{
  ...
  np(char paramChar, float[] paramArrayOfFloat)
  {
    this.a = paramChar;
  ...
  {
    this.a = paramNp.a;
    this.b = nn.a(paramNp.b, 0, paramNp.b.length);
  }
  ...
  public static void a(np[] paramArrayOfNp, Path paramPath)
  {
    ...
    {
      a(paramPath, arrayOfFloat, c, paramArrayOfNp[i].a, paramArrayOfNp[i].b);
      c = paramArrayOfNp[i].a;
      i += 1;
    }
  }
  
  public void a(np paramNp1, np paramNp2, float paramFloat)
  {
    int i = 0;
    while (i < paramNp1.b.length)
    {
      this.b[i] = (paramNp1.b[i] * (1.0F - paramFloat) + paramNp2.b[i] * paramFloat);
      i += 1;
    }
  }
}
