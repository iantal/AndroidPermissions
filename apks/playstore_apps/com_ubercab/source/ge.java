  ...
  implements Interpolator
{
  ...
  public ge(Context paramContext, AttributeSet paramAttributeSet, XmlPullParser paramXmlPullParser)
  {
    this(paramContext.getResources(), paramContext.getTheme(), paramAttributeSet, paramXmlPullParser);
  }
  
  public ge(Resources paramResources, Resources.Theme paramTheme, AttributeSet paramAttributeSet, XmlPullParser paramXmlPullParser)
  {
    paramResources = nl.a(paramResources, paramTheme, paramAttributeSet, fv.l);
  ...
  private void a(TypedArray paramTypedArray, XmlPullParser paramXmlPullParser)
  {
    ...
    {
      paramTypedArray = nl.a(paramTypedArray, paramXmlPullParser, "pathData", 4);
      paramXmlPullParser = nn.a(paramTypedArray);
    ...
    if (nl.a(paramXmlPullParser, "controlX1"))
    {
      if (nl.a(paramXmlPullParser, "controlY1"))
      {
        float f1 = nl.a(paramTypedArray, paramXmlPullParser, "controlX1", 0, 0.0F);
        float f2 = nl.a(paramTypedArray, paramXmlPullParser, "controlY1", 1, 0.0F);
        boolean bool = nl.a(paramXmlPullParser, "controlX2");
        if (bool == nl.a(paramXmlPullParser, "controlY2"))
        {
          if (!bool)
          {
            a(f1, f2);
          ...
          a(f1, f2, nl.a(paramTypedArray, paramXmlPullParser, "controlX2", 2, 0.0F), nl.a(paramTypedArray, paramXmlPullParser, "controlY2", 3, 0.0F));
          return;
        }
