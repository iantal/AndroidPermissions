  ...
  implements agj
{
  ...
  private final agk E = new agk()
  {
    ...
    {
      aem.this.a(paramAnonymousRecyclerView.computeHorizontalScrollOffset(), paramAnonymousRecyclerView.computeVerticalScrollOffset());
    }
  };
  int a;
  int b;
  ...
  public aem(RecyclerView paramRecyclerView, StateListDrawable paramStateListDrawable1, Drawable paramDrawable1, StateListDrawable paramStateListDrawable2, Drawable paramDrawable2, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    this.k.setAlpha(255);
    this.l.setAlpha(255);
    this.B.addListener(new aen(this, null));
    this.B.addUpdateListener(new aeo(this, null));
    a(paramRecyclerView);
  }
