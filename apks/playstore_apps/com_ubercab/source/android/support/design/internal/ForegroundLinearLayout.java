  ...
  extends LinearLayoutCompat
{
  ...
  public ForegroundLinearLayout(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    paramContext = paramContext.obtainStyledAttributes(paramAttributeSet, cl.ForegroundLinearLayout, paramInt, 0);
    this.f = paramContext.getInt(cl.ForegroundLinearLayout_android_foregroundGravity, this.f);
    paramAttributeSet = paramContext.getDrawable(cl.ForegroundLinearLayout_android_foreground);
    if (paramAttributeSet != null) {
      setForeground(paramAttributeSet);
    }
    this.a = paramContext.getBoolean(cl.ForegroundLinearLayout_foregroundInsidePadding, true);
