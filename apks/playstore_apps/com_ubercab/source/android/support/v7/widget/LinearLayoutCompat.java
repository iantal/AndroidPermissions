  ...
  extends ViewGroup
{
  ...
  public LinearLayoutCompat(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    paramContext = aic.a(paramContext, paramAttributeSet, zk.LinearLayoutCompat, paramInt, 0);
    paramInt = paramContext.a(zk.LinearLayoutCompat_android_orientation, -1);
    if (paramInt >= 0) {
      setOrientation(paramInt);
    }
    paramInt = paramContext.a(zk.LinearLayoutCompat_android_gravity, -1);
    if (paramInt >= 0) {
      setGravity(paramInt);
    }
    boolean bool = paramContext.a(zk.LinearLayoutCompat_android_baselineAligned, true);
    if (!bool) {
      setBaselineAligned(bool);
    }
    this.mWeightSum = paramContext.a(zk.LinearLayoutCompat_android_weightSum, -1.0F);
    this.mBaselineAlignedChildIndex = paramContext.a(zk.LinearLayoutCompat_android_baselineAlignedChildIndex, -1);
    this.mUseLargestChild = paramContext.a(zk.LinearLayoutCompat_measureWithLargestChild, false);
    setDividerDrawable(paramContext.a(zk.LinearLayoutCompat_divider));
    this.mShowDividers = paramContext.a(zk.LinearLayoutCompat_showDividers, 0);
    this.mDividerPadding = paramContext.e(zk.LinearLayoutCompat_dividerPadding, 0);
    paramContext.a();
  }
  ...
  void layoutHorizontal(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    paramInt4 = sf.a(paramInt4 & 0x800007, tb.f(this));
    if (paramInt4 != 1)
    {
      if (paramInt4 != 5) {
    ...
    while (paramInt2 < n)
    {
      ...
      for (;;)
      {
        ...
        if (localView.getVisibility() != 8)
        {
          ...
          paramInt3 = sf.a(paramInt3, tb.f(this)) & 0x7;
          if (paramInt3 != 1) {
            if (paramInt3 != 5) {
    ...
    while (m < i7)
    {
      ...
      for (;;)
      {
        ...
        else
        {
          ...
          if ((i12 == 1073741824) && (localLayoutParams.width == 0) && (localLayoutParams.g > 0.0F))
          {
            if (i6 != 0)
            {
  ...
  void measureVertical(int paramInt1, int paramInt2)
  {
    ...
    while (i2 < i4)
    {
      ...
      else
      {
        ...
        localLayoutParams = (LinearLayoutCompat.LayoutParams)localView.getLayoutParams();
        f1 += localLayoutParams.g;
        if ((k == 1073741824) && (localLayoutParams.height == 0) && (localLayoutParams.g > 0.0F))
        {
          i5 = this.mTotalLength;
        ...
        if ((i9 < i13) && (localLayoutParams.g > 0.0F)) {
    ...
    if ((i5 == 0) && ((k == 0) || (f1 <= 0.0F)))
    {
      ...
      if ((bool) && (i2 != 1073741824))
      {
        ...
        while (j < i4)
        {
          ...
          if ((localView != null) && (localView.getVisibility() != 8) && (((LinearLayoutCompat.LayoutParams)localView.getLayoutParams()).g > 0.0F)) {
