  ...
  implements aal
{
  ...
  static final ahl HIDDEN_METHOD_INVOKER = new ahl();
  ...
  private ahn mOnQueryChangeListener;
  View.OnFocusChangeListener mOnQueryTextFocusChangeListener;
  private View.OnClickListener mOnSearchClickListener;
  private aho mOnSuggestionListener;
  ...
  private Runnable mReleaseCursorRunnable = new Runnable()
  {
    public void run()
    {
      if ((SearchView.this.mSuggestionsAdapter != null) && ((SearchView.this.mSuggestionsAdapter instanceof ahu))) {
  ...
  View.OnKeyListener mTextKeyListener = new View.OnKeyListener()
  {
    public boolean onKey(View paramAnonymousView, int paramAnonymousInt, KeyEvent paramAnonymousKeyEvent)
    {
      ...
      if ((!SearchView.SearchAutoComplete.a(SearchView.this.mSearchSrcTextView)) && (paramAnonymousKeyEvent.hasNoModifiers()) && (paramAnonymousKeyEvent.getAction() == 1) && (paramAnonymousInt == 66))
      {
  ...
  {
    this(paramContext, paramAttributeSet, zb.searchViewStyle);
  }
  
  public SearchView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    super(paramContext, paramAttributeSet, paramInt);
    paramAttributeSet = aic.a(paramContext, paramAttributeSet, zk.SearchView, paramInt, 0);
    LayoutInflater.from(paramContext).inflate(paramAttributeSet.g(zk.SearchView_layout, zh.abc_search_view), this, true);
    this.mSearchSrcTextView = ((SearchView.SearchAutoComplete)findViewById(zg.search_src_text));
    this.mSearchSrcTextView.a(this);
    this.mSearchEditFrame = findViewById(zg.search_edit_frame);
    this.mSearchPlate = findViewById(zg.search_plate);
    this.mSubmitArea = findViewById(zg.submit_area);
    this.mSearchButton = ((ImageView)findViewById(zg.search_button));
    this.mGoButton = ((ImageView)findViewById(zg.search_go_btn));
    this.mCloseButton = ((ImageView)findViewById(zg.search_close_btn));
    this.mVoiceButton = ((ImageView)findViewById(zg.search_voice_btn));
    this.mCollapsedIcon = ((ImageView)findViewById(zg.search_mag_icon));
    tb.a(this.mSearchPlate, paramAttributeSet.a(zk.SearchView_queryBackground));
    tb.a(this.mSubmitArea, paramAttributeSet.a(zk.SearchView_submitBackground));
    this.mSearchButton.setImageDrawable(paramAttributeSet.a(zk.SearchView_searchIcon));
    this.mGoButton.setImageDrawable(paramAttributeSet.a(zk.SearchView_goIcon));
    this.mCloseButton.setImageDrawable(paramAttributeSet.a(zk.SearchView_closeIcon));
    this.mVoiceButton.setImageDrawable(paramAttributeSet.a(zk.SearchView_voiceIcon));
    this.mCollapsedIcon.setImageDrawable(paramAttributeSet.a(zk.SearchView_searchIcon));
    this.mSearchHintIcon = paramAttributeSet.a(zk.SearchView_searchHintIcon);
    aig.a(this.mSearchButton, getResources().getString(zi.abc_searchview_description_search));
    this.mSuggestionRowLayout = paramAttributeSet.g(zk.SearchView_suggestionRowLayout, zh.abc_search_dropdown_item_icons_2line);
    this.mSuggestionCommitIconResId = paramAttributeSet.g(zk.SearchView_commitIcon, 0);
    ...
    setIconifiedByDefault(paramAttributeSet.a(zk.SearchView_iconifiedByDefault, true));
    paramInt = paramAttributeSet.e(zk.SearchView_android_maxWidth, -1);
    if (paramInt != -1) {
      setMaxWidth(paramInt);
    }
    this.mDefaultQueryHint = paramAttributeSet.c(zk.SearchView_defaultQueryHint);
    this.mQueryHint = paramAttributeSet.c(zk.SearchView_queryHint);
    paramInt = paramAttributeSet.a(zk.SearchView_android_imeOptions, -1);
    if (paramInt != -1) {
      setImeOptions(paramInt);
    }
    paramInt = paramAttributeSet.a(zk.SearchView_android_inputType, -1);
    if (paramInt != -1) {
      setInputType(paramInt);
    }
    setFocusable(paramAttributeSet.a(zk.SearchView_android_focusable, true));
    paramAttributeSet.a();
  ...
  private Intent createIntentFromSuggestion(Cursor paramCursor, int paramInt, String paramString)
  {
    try
    {
      localObject2 = ahu.a(paramCursor, "suggest_intent_action");
    ...
    localObject3 = ahu.a(paramCursor, "suggest_intent_data");
    ...
    if (localObject1 != null)
    {
      str = ahu.a(paramCursor, "suggest_intent_data_id");
      localObject3 = localObject1;
      if (str != null)
      {
        ...
        localObject3 = ahu.a(paramCursor, "suggest_intent_query");
        paramString = createIntent((String)localObject2, (Uri)localObject1, ahu.a(paramCursor, "suggest_intent_extra_data"), (String)localObject3, paramInt, paramString);
        return paramString;
      }
    }
  }
  ...
  {
    return getContext().getResources().getDimensionPixelSize(ze.abc_search_view_preferred_height);
  }
  
  private int getPreferredWidth()
  {
    return getContext().getResources().getDimensionPixelSize(ze.abc_search_view_preferred_width);
  }
  ...
  private void updateSearchAutoComplete()
  {
    ...
    if (this.mSearchable.getSuggestAuthority() != null)
    {
      this.mSuggestionsAdapter = new ahu(getContext(), this, this.mSearchable, this.mOutsideDrawablesCache);
      this.mSearchSrcTextView.setAdapter(this.mSuggestionsAdapter);
      ahu localAhu = (ahu)this.mSuggestionsAdapter;
      i = j;
  ...
  void adjustDropDownSizeAndPosition()
  {
    if (this.mDropDownAnchor.getWidth() > 1)
    {
      ...
      boolean bool = aiu.a(this);
      int i;
      if (this.mIconifiedByDefault) {
        i = localResources.getDimensionPixelSize(ze.abc_dropdownitem_icon_width) + localResources.getDimensionPixelSize(ze.abc_dropdownitem_text_padding_left);
      } else {
        i = 0;
      }
  ...
  public void clearFocus()
  {
    ...
    SearchView.SearchAutoComplete.a(this.mSearchSrcTextView, false);
  ...
  public vm getSuggestionsAdapter()
  {
  ...
  void onCloseClicked()
  {
    ...
    else
    {
      ...
      SearchView.SearchAutoComplete.a(this.mSearchSrcTextView, true);
    }
  }
  ...
  public void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if (paramBoolean)
    {
      ...
      {
        this.mTouchDelegate = new ahp(this.mSearchSrtTextViewBoundsExpanded, this.mSearchSrcTextViewBounds, this.mSearchSrcTextView);
  ...
  public void setOnCloseListener(ahm paramAhm)
  {
    this.mOnCloseListener = paramAhm;
  }
  ...
  public void setOnQueryTextListener(ahn paramAhn)
  {
    this.mOnQueryChangeListener = paramAhn;
  }
  ...
  public void setOnSuggestionListener(aho paramAho)
  {
    this.mOnSuggestionListener = paramAho;
  }
  ...
  public void setQueryRefinementEnabled(boolean paramBoolean)
  {
    ...
    if ((this.mSuggestionsAdapter instanceof ahu))
    {
      ahu localAhu = (ahu)this.mSuggestionsAdapter;
      int i;
      if (paramBoolean) {
  ...
  public void setSuggestionsAdapter(vm paramVm)
  {
    this.mSuggestionsAdapter = paramVm;
    this.mSearchSrcTextView.setAdapter(this.mSuggestionsAdapter);
  }
