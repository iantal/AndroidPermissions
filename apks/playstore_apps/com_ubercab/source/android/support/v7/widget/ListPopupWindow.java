  ...
  implements aca
{
  ...
  private final afi D = new afi(this);
  private final afh E = new afh(this);
  private final aff F = new aff(this);
  private Runnable G;
  ...
  public final afj e = new afj(this);
  ...
  {
    this(paramContext, null, zb.listPopupWindowStyle);
  }
  ...
  public ListPopupWindow(Context paramContext, AttributeSet paramAttributeSet, int paramInt1, int paramInt2)
  {
    ...
    TypedArray localTypedArray = paramContext.obtainStyledAttributes(paramAttributeSet, zk.ListPopupWindow, paramInt1, paramInt2);
    this.m = localTypedArray.getDimensionPixelOffset(zk.ListPopupWindow_android_dropDownHorizontalOffset, 0);
    this.n = localTypedArray.getDimensionPixelOffset(zk.ListPopupWindow_android_dropDownVerticalOffset, 0);
    if (this.n != 0) {
      this.p = true;
    }
    localTypedArray.recycle();
    this.g = new adn(paramContext, paramAttributeSet, paramInt1, paramInt2);
  ...
  private int b()
  {
    ...
    if (localObject1 == null)
    {
      ...
      this.G = new Runnable()
      {
        public void run()
        {
          View localView = ListPopupWindow.this.i();
  ...
  public ael a(Context paramContext, boolean paramBoolean)
  {
    return new ael(paramContext, paramBoolean);
  }
  ...
  public void d()
  {
    ...
    wm.a(this.g, i(), this.m, this.n, this.t);
  ...
  public void i(int paramInt)
  {
    ...
    {
      localAel.a(false);
      localAel.setSelection(paramInt);
      if (localAel.getChoiceMode() != 0) {
        localAel.setItemChecked(paramInt, true);
      }
    }
  }
