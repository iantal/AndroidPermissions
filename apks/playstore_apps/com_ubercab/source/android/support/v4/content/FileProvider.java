  ...
  extends ContentProvider
{
  ...
  private static HashMap<String, mq> c = new HashMap();
  private mq d;
  ...
  private static mq a(Context paramContext, String paramString)
  {
    synchronized (c)
    {
      mq localMq2 = (mq)c.get(paramString);
      mq localMq1 = localMq2;
      if (localMq2 == null) {
        try
        {
          localMq1 = b(paramContext, paramString);
          c.put(paramString, localMq1);
        }
  ...
  private static mq b(Context paramContext, String paramString)
    throws IOException, XmlPullParserException
  {
    mr localMr = new mr(paramString);
    ...
    if (localXmlResourceParser != null)
    {
      for (;;)
      {
        ...
        if (i == 2)
        {
          ...
          {
            localObject2 = mp.a(paramContext, null);
          ...
          else
          {
            ...
            {
              localObject2 = mp.a(paramContext);
              paramString = localObject1;
              if (localObject2.length > 0) {
                paramString = localObject2[0];
              }
          ...
          if (paramString != null) {
            localMr.a(str1, a(paramString, new String[] { str2 }));
          }
        }
      }
      return localMr;
