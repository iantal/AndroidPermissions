  ...
  implements sq, st
{
  ...
  private final Animation N = new Animation()
  {
    public void applyTransformation(float paramAnonymousFloat, Transformation paramAnonymousTransformation)
    {
      ...
      SwipeRefreshLayout.this.c(j + i - k);
  ...
  private void c(float paramFloat)
  {
    ...
    if (this.d) {
      a(Math.min(1.0F, paramFloat / this.p));
    }
  ...
  private void c(int paramInt, Animation.AnimationListener paramAnimationListener)
  {
    ...
    this.J = new Animation()
    {
      public void applyTransformation(float paramAnonymousFloat, Transformation paramAnonymousTransformation)
      {
        ...
        SwipeRefreshLayout.this.a(f1 + f2 * paramAnonymousFloat);
        SwipeRefreshLayout.this.b(paramAnonymousFloat);
      }
    };
  ...
  private void d()
  {
    this.e = new ve(getContext(), -328966);
    this.j = new vg(getContext());
    this.j.a(1);
  ...
  void a(Animation.AnimationListener paramAnimationListener)
  {
    this.G = new Animation()
    {
      public void applyTransformation(float paramAnonymousFloat, Transformation paramAnonymousTransformation)
      {
        SwipeRefreshLayout.this.a(1.0F - paramAnonymousFloat);
      }
    };
  ...
  {
    c(this.f + (int)((this.h - this.f) * paramFloat) - this.e.getTop());
  }
  ...
  public void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    paramInt1 /= 2;
    paramInt3 /= 2;
    ((ve)localObject).layout(paramInt1 - paramInt3, this.c, paramInt1 + paramInt3, this.c + paramInt2);
  }
