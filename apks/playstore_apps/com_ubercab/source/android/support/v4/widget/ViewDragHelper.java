...
public class ViewDragHelper
{
  ...
  private ViewDragHelper(Context paramContext, ViewGroup paramViewGroup, xl paramXl)
  {
  ...
  private boolean checkNewEdgeDrag(float paramFloat1, float paramFloat2, int paramInt1, int paramInt2)
  {
    ...
    if (((i & paramInt2) == paramInt2) && ((this.mTrackingEdges & paramInt2) != 0) && ((this.mEdgeDragsLocked[paramInt1] & paramInt2) != paramInt2) && ((this.mEdgeDragsInProgress[paramInt1] & paramInt2) != paramInt2))
    {
      ...
      if ((paramFloat1 < paramFloat2 * 0.5F) && (this.mCallback.b(paramInt2)))
      {
  ...
  private boolean checkTouchSlop(View paramView, float paramFloat1, float paramFloat2)
  {
    ...
    int i;
    if (this.mCallback.b(paramView) > 0) {
      i = 1;
    } else {
      i = 0;
    }
    int j;
    if (this.mCallback.a(paramView) > 0) {
      j = 1;
    } else {
      j = 0;
    }
  ...
  private int computeSettleDuration(View paramView, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    paramInt1 = computeAxisDuration(paramInt1, paramInt3, this.mCallback.b(paramView));
    paramInt2 = computeAxisDuration(paramInt2, paramInt4, this.mCallback.a(paramView));
    return (int)(paramInt1 * f3 + paramInt2 * f1);
  }
  
  public static ViewDragHelper create(ViewGroup paramViewGroup, float paramFloat, xl paramXl)
  {
    paramViewGroup = create(paramViewGroup, paramXl);
    paramViewGroup.mTouchSlop = ((int)(paramViewGroup.mTouchSlop * (1.0F / paramFloat)));
    return paramViewGroup;
  }
  
  public static ViewDragHelper create(ViewGroup paramViewGroup, xl paramXl)
  {
    return new ViewDragHelper(paramViewGroup.getContext(), paramViewGroup, paramXl);
  }
  
  private void dispatchViewReleased(float paramFloat1, float paramFloat2)
  {
    this.mReleaseInProgress = true;
    this.mCallback.a(this.mCapturedView, paramFloat1, paramFloat2);
  ...
  private void dragTo(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if (paramInt3 != 0)
    {
      i = this.mCallback.b(this.mCapturedView, paramInt1, paramInt3);
      tb.g(this.mCapturedView, i - j);
    }
    paramInt1 = paramInt2;
    if (paramInt4 != 0)
    {
      paramInt1 = this.mCallback.a(this.mCapturedView, paramInt2, paramInt4);
      tb.f(this.mCapturedView, paramInt1 - k);
    }
    if ((paramInt3 != 0) || (paramInt4 != 0)) {
      this.mCallback.a(this.mCapturedView, i, paramInt1, i - j, paramInt1 - k);
    }
  }
  ...
  public void abort()
  {
    ...
    if (this.mDragState == 2)
    {
      ...
      this.mCallback.a(this.mCapturedView, k, m, k - i, m - j);
    }
    setDragState(0);
  }
  ...
  public void captureChildView(View paramView, int paramInt)
  {
    if (paramView.getParent() == this.mParentView)
    {
      ...
      this.mCallback.b(paramView, paramInt);
      setDragState(1);
      return;
    }
  ...
  public boolean continueSettling(boolean paramBoolean)
  {
    ...
    if (i == 2)
    {
      ...
      if (k != 0) {
        tb.g(this.mCapturedView, k);
      }
      if (m != 0) {
        tb.f(this.mCapturedView, m);
      }
      if ((k != 0) || (m != 0)) {
        this.mCallback.a(this.mCapturedView, i, j, k, m);
      }
      boolean bool1 = bool3;
      if (bool3)
      {
  ...
  public View findTopChildUnder(int paramInt1, int paramInt2)
  {
    ...
    while (i >= 0)
    {
      View localView = this.mParentView.getChildAt(this.mCallback.c(i));
    ...
    case 5: 
      ...
      if (this.mDragState == 0)
      {
        ...
        if ((this.mTrackingEdges & j) != 0) {
          this.mCallback.a(j & this.mTrackingEdges, i);
        }
      }
    ...
    for (;;)
    {
      ...
      if (this.mDragState == 0)
      {
        ...
        if ((this.mTrackingEdges & i) != 0) {
          this.mCallback.a(i & this.mTrackingEdges, j);
        }
      }
            ...
            while (i < k)
            {
              ...
              if (isValidPointerForActionMove(m))
              {
                ...
                if (j != 0)
                {
                  ...
                  int i1 = (int)f3;
                  i1 = this.mCallback.b(localView, n + i1, i1);
                  int i2 = localView.getTop();
                  int i3 = (int)f4;
                  i3 = this.mCallback.a(localView, i2 + i3, i3);
                  int i4 = this.mCallback.b(localView);
                  int i5 = this.mCallback.a(localView);
  ...
  boolean tryCaptureViewForDrag(View paramView, int paramInt)
  {
    ...
    if ((paramView != null) && (this.mCallback.a(paramView, paramInt)))
    {
      this.mActivePointerId = paramInt;
