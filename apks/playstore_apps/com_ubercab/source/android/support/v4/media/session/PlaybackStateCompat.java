  ...
  implements Parcelable
{
  ...
  public static PlaybackStateCompat a(Object paramObject)
  {
    ...
    {
      Object localObject2 = pr.h(paramObject);
      ...
      if (Build.VERSION.SDK_INT >= 22) {
        localBundle = pt.a(paramObject);
      }
      Object localObject1 = new PlaybackStateCompat(pr.a(paramObject), pr.b(paramObject), pr.c(paramObject), pr.d(paramObject), pr.e(paramObject), 0, pr.f(paramObject), pr.g(paramObject), (List)localObject1, pr.i(paramObject), localBundle);
