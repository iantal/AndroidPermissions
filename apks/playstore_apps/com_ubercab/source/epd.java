...
public final class epd
  ...
  implements exf
{
  private static final epd g;
  private static volatile exj<epd> h;
  private int d;
  private epg e;
  private euu f = euu.a;
  ...
  static
  {
    ...
    g = localEpd;
    localEpd.a(ewb.f, null, null);
    localEpd.b.c();
  }
  
  private epd() {}
  
  public static epd a(euu paramEuu)
    throws ewi
  {
    return (epd)evu.a(g, paramEuu);
  }
  ...
  private final void a(epg paramEpg)
  {
    if (paramEpg != null)
    {
      this.e = paramEpg;
  ...
  {
    epd localEpd = g;
    evv localEvv = (evv)localEpd.a(ewb.h, null, null);
    localEvv.a(localEpd);
    return (epe)localEvv;
  }
  ...
  protected final Object a(int paramInt, Object paramObject1, Object paramObject2)
  {
    ...
    //   86: areturn
    //   87: getstatic 106	epd:h	Lexj;
    //   90: ifnonnull +37 -> 127
    //   93: ldc 2
    //   95: monitorenter
    //   96: getstatic 106	epd:h	Lexj;
    //   99: ifnonnull +16 -> 115
    //   102: new 108	evw
    //   105: dup
    //   106: getstatic 25	epd:g	Lepd;
    //   109: invokespecial 111	evw:<init>	(Levu;)V
    //   112: putstatic 106	epd:h	Lexj;
    //   115: ldc 2
    //   117: monitorexit
    //   118: goto +9 -> 127
    //   121: astore_2
    ...
    //   203: putfield 50	epd:f	Leuu;
    //   206: goto -60 -> 146
    //   209: aload_0
    //   210: getfield 73	epd:e	Lepg;
    //   213: ifnull +334 -> 547
    //   216: aload_0
    //   217: getfield 73	epd:e	Lepg;
    //   220: astore_2
    //   221: aload_2
    ...
    //   247: checkcast 125	eph
    //   250: astore_2
    //   251: goto +3 -> 254
    //   254: aload_0
    //   255: aload 8
    //   257: invokestatic 130	epg:g	()Lepg;
    //   260: aload_3
    //   261: invokevirtual 133	evd:a	(Levu;Levm;)Levu;
    //   264: checkcast 127	epg
    //   267: putfield 73	epd:e	Lepg;
    //   270: aload_2
    //   271: ifnull -125 -> 146
    //   274: aload_2
    //   275: aload_0
    //   276: getfield 73	epd:e	Lepg;
    ...
    //   288: checkcast 5	evu
    //   291: checkcast 127	epg
    //   294: putfield 73	epd:e	Lepg;
    //   297: goto -151 -> 146
    //   300: aload_0
    //   301: aload 8
    //   303: invokevirtual 138	evd:h	()I
    //   306: putfield 60	epd:d	I
    //   309: goto -163 -> 146
    //   312: iconst_1
    //   313: istore_1
    //   314: goto -168 -> 146
    ...
    //   397: istore 5
    //   399: aload_0
    //   400: getfield 60	epd:d	I
    //   403: istore_1
    //   404: aload_3
    //   405: getfield 60	epd:d	I
    //   408: ifeq +9 -> 417
    //   411: iconst_1
    //   412: istore 6
    //   414: goto +6 -> 420
    ...
    //   425: iload 6
    //   427: aload_3
    //   428: getfield 60	epd:d	I
    //   431: invokeinterface 158 5 0
    //   436: putfield 60	epd:d	I
    //   439: aload_0
    //   440: aload_2
    //   441: aload_0
    //   442: getfield 73	epd:e	Lepg;
    //   445: aload_3
    //   446: getfield 73	epd:e	Lepg;
    //   449: invokeinterface 161 3 0
    //   454: checkcast 127	epg
    //   457: putfield 73	epd:e	Lepg;
    //   460: aload_0
    //   461: getfield 50	epd:f	Leuu;
    ...
    //   477: istore 5
    //   479: aload_0
    //   480: getfield 50	epd:f	Leuu;
    //   483: astore 8
    //   485: iload 7
    //   487: istore 6
    //   489: aload_3
    //   490: getfield 50	epd:f	Leuu;
    ...
    //   508: iload 6
    //   510: aload_3
    //   511: getfield 50	epd:f	Leuu;
    //   514: invokeinterface 164 5 0
    //   519: putfield 50	epd:f	Leuu;
    //   522: aload_0
    //   523: areturn
    //   524: new 86	epe
    //   527: dup
    //   528: aconst_null
    //   529: invokespecial 167	epe:<init>	(Lepf;)V
    //   532: areturn
    //   533: aconst_null
    //   534: areturn
    //   535: getstatic 25	epd:g	Lepd;
    //   538: areturn
    //   539: new 2	epd
    //   542: dup
    //   543: invokespecial 23	epd:<init>	()V
    //   546: areturn
    //   547: aconst_null
    //   548: astore_2
    //   549: goto -295 -> 254
