...
public final class erd
  ...
  implements exf
{
  private static final erd f;
  private static volatile exj<erd> g;
  private int d;
  private erg e;
  
  static
  {
    erd localErd = new erd();
    f = localErd;
    localErd.a(ewb.f, null, null);
    localErd.b.c();
  }
  
  private erd() {}
  
  public static erd a(euu paramEuu)
    throws ewi
  {
    return (erd)evu.a(f, paramEuu);
  }
  ...
  private final void a(erg paramErg)
  {
    if (paramErg != null)
    {
      this.e = paramErg;
  ...
  {
    erd localErd = f;
    evv localEvv = (evv)localErd.a(ewb.h, null, null);
    localEvv.a(localErd);
    return (ere)localEvv;
  }
  ...
  protected final Object a(int paramInt, Object paramObject1, Object paramObject2)
  {
    ...
    //   86: areturn
    //   87: getstatic 95	erd:g	Lexj;
    //   90: ifnonnull +37 -> 127
    //   93: ldc 2
    //   95: monitorenter
    //   96: getstatic 95	erd:g	Lexj;
    //   99: ifnonnull +16 -> 115
    //   102: new 97	evw
    //   105: dup
    //   106: getstatic 23	erd:f	Lerd;
    //   109: invokespecial 100	evw:<init>	(Levu;)V
    //   112: putstatic 95	erd:g	Lexj;
    //   115: ldc 2
    //   117: monitorexit
    //   118: goto +9 -> 127
    //   121: astore_2
    ...
    //   187: goto +106 -> 293
    //   190: aload_0
    //   191: getfield 61	erd:e	Lerg;
    //   194: ifnull +266 -> 460
    //   197: aload_0
    //   198: getfield 61	erd:e	Lerg;
    //   201: astore_2
    //   202: aload_2
    ...
    //   228: checkcast 111	erh
    //   231: astore_2
    //   232: goto +3 -> 235
    //   235: aload_0
    //   236: aload 7
    //   238: invokestatic 116	erg:c	()Lerg;
    //   241: aload_3
    //   242: invokevirtual 119	evd:a	(Levu;Levm;)Levu;
    //   245: checkcast 113	erg
    //   248: putfield 61	erd:e	Lerg;
    //   251: aload_2
    //   252: ifnull -106 -> 146
    //   255: aload_2
    //   256: aload_0
    //   257: getfield 61	erd:e	Lerg;
    ...
    //   269: checkcast 5	evu
    //   272: checkcast 113	erg
    //   275: putfield 61	erd:e	Lerg;
    //   278: goto -132 -> 146
    //   281: aload_0
    //   282: aload 7
    //   284: invokevirtual 124	evd:h	()I
    //   287: putfield 52	erd:d	I
    //   290: goto -144 -> 146
    //   293: iconst_1
    //   294: istore_1
    //   295: goto -149 -> 146
    ...
    //   378: istore 5
    //   380: aload_0
    //   381: getfield 52	erd:d	I
    //   384: istore_1
    //   385: aload_3
    //   386: getfield 52	erd:d	I
    //   389: ifeq +6 -> 395
    //   392: iconst_1
    //   393: istore 6
    //   395: aload_0
    ...
    //   400: iload 6
    //   402: aload_3
    //   403: getfield 52	erd:d	I
    //   406: invokeinterface 144 5 0
    //   411: putfield 52	erd:d	I
    //   414: aload_0
    //   415: aload_2
    //   416: aload_0
    //   417: getfield 61	erd:e	Lerg;
    //   420: aload_3
    //   421: getfield 61	erd:e	Lerg;
    //   424: invokeinterface 147 3 0
    //   429: checkcast 113	erg
    //   432: putfield 61	erd:e	Lerg;
    //   435: aload_0
    //   436: areturn
    //   437: new 75	ere
    //   440: dup
    //   441: aconst_null
    //   442: invokespecial 150	ere:<init>	(Lerf;)V
    //   445: areturn
    //   446: aconst_null
    //   447: areturn
    //   448: getstatic 23	erd:f	Lerd;
    //   451: areturn
    //   452: new 2	erd
    //   455: dup
    //   456: invokespecial 21	erd:<init>	()V
    //   459: areturn
    //   460: aconst_null
    //   461: astore_2
    //   462: goto -227 -> 235
