...
{
  private static aik i;
  private static aik j;
  ...
  private aik(View paramView, CharSequence paramCharSequence)
  {
    this.a = paramView;
  ...
  public static void a(View paramView, CharSequence paramCharSequence)
  {
    ...
    new aik(paramView, paramCharSequence);
  }
  ...
  private void a(boolean paramBoolean)
  {
    ...
    j = this;
    this.h = paramBoolean;
    this.g = new ail(this.a.getContext());
    this.g.a(this.a, this.e, this.f, this.h, this.b);
    this.a.addOnAttachStateChangeListener(this);
    long l;
    if (this.h) {
      l = 2500L;
    } else if ((tb.p(this.a) & 0x1) == 1) {
  ...
  private static void b(aik paramAik)
  {
    if (i != null) {
      i.c();
    }
