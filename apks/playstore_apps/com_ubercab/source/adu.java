...
class adu
{
  ...
  private <T> T a(Object paramObject, String paramString, T paramT)
  {
    ...
    //   0: aload_0
    //   1: aload_2
    //   2: invokespecial 196	adu:a	(Ljava/lang/String;)Ljava/lang/reflect/Method;
    //   5: aload_1
    //   6: iconst_0
  ...
  {
    paramAttributeSet = this.l.obtainStyledAttributes(paramAttributeSet, zk.AppCompatTextView, paramInt, 0);
    if (paramAttributeSet.hasValue(zk.AppCompatTextView_autoSizeTextType)) {
      this.c = paramAttributeSet.getInt(zk.AppCompatTextView_autoSizeTextType, 0);
    }
    float f1;
    if (paramAttributeSet.hasValue(zk.AppCompatTextView_autoSizeStepGranularity)) {
      f1 = paramAttributeSet.getDimension(zk.AppCompatTextView_autoSizeStepGranularity, -1.0F);
    } else {
      f1 = -1.0F;
    }
    float f2;
    if (paramAttributeSet.hasValue(zk.AppCompatTextView_autoSizeMinTextSize)) {
      f2 = paramAttributeSet.getDimension(zk.AppCompatTextView_autoSizeMinTextSize, -1.0F);
    } else {
      f2 = -1.0F;
    }
    float f3;
    if (paramAttributeSet.hasValue(zk.AppCompatTextView_autoSizeMaxTextSize)) {
      f3 = paramAttributeSet.getDimension(zk.AppCompatTextView_autoSizeMaxTextSize, -1.0F);
    } else {
      f3 = -1.0F;
    }
    if (paramAttributeSet.hasValue(zk.AppCompatTextView_autoSizePresetSizes))
    {
      paramInt = paramAttributeSet.getResourceId(zk.AppCompatTextView_autoSizePresetSizes, 0);
      if (paramInt > 0)
      {
