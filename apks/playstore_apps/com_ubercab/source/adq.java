  ...
  implements ListAdapter, SpinnerAdapter
{
  ...
  public adq(SpinnerAdapter paramSpinnerAdapter, Resources.Theme paramTheme)
  {
    ...
    if (paramTheme != null) {
      ...
      else if ((paramSpinnerAdapter instanceof ahx))
      {
        paramSpinnerAdapter = (ahx)paramSpinnerAdapter;
