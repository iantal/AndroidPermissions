...
public abstract class ld
{
  ...
  ArrayList<String> a(ArrayList<View> paramArrayList)
  {
    ...
    while (i < j)
    {
      ...
      localArrayList.add(tb.o(localView));
      tb.a(localView, null);
      i += 1;
    }
  ...
  void a(View paramView, final ArrayList<View> paramArrayList1, final ArrayList<View> paramArrayList2, final ArrayList<String> paramArrayList, Map<String, String> paramMap)
  {
    ...
    while (i < k)
    {
      ...
      String str = tb.o((View)localObject);
      localArrayList.add(str);
      if (str != null)
      {
        tb.a((View)localObject, null);
        ...
        while (j < k)
        {
          ...
          {
            tb.a((View)paramArrayList2.get(j), str);
            break;
          }
          j += 1;
        }
    ...
    mb.a(paramView, new Runnable()
    {
      public void run()
      {
        ...
        while (i < k)
        {
          tb.a((View)paramArrayList2.get(i), (String)paramArrayList.get(i));
          tb.a((View)paramArrayList1.get(i), (String)localArrayList.get(i));
          i += 1;
        }
      }
    });
  ...
  void a(View paramView, final ArrayList<View> paramArrayList, final Map<String, String> paramMap)
  {
    mb.a(paramView, new Runnable()
    {
      public void run()
      {
        ...
        {
          View localView = (View)paramArrayList.get(i);
          String str = tb.o(localView);
          if (str != null) {
            tb.a(localView, ld.a(paramMap, str));
          }
          i += 1;
        }
      }
    ...
    mb.a(paramViewGroup, new Runnable()
    {
      public void run()
      {
        ...
        while (i < j)
        {
          View localView = (View)paramArrayList.get(i);
          String str = tb.o(localView);
          tb.a(localView, (String)paramMap.get(str));
          i += 1;
        }
      }
    });
