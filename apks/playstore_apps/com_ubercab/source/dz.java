  ...
  extends Drawable
{
  ...
  private Shader a()
  {
    ...
    int m = nm.a(this.e, this.j);
    int n = nm.a(this.f, this.j);
    int i1 = nm.a(nm.b(this.f, 0), this.j);
    int i2 = nm.a(nm.b(this.h, 0), this.j);
    int i3 = nm.a(this.h, this.j);
    int i4 = nm.a(this.g, this.j);
