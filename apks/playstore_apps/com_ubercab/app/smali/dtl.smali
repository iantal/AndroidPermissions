...
# virtual methods
.method public abstract a(Lflq;Ljava/util/Map;)Lebs;
...
.method public final b(Lflq;Ljava/util/Map;)Lorg/apache/http/HttpResponse;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, p1, p2}, Ldtl;->a(Lflq;Ljava/util/Map;)Lebs;
    ...
    invoke-virtual {p1}, Lebs;->b()Ljava/util/List;
    ...
    invoke-virtual {v2}, Lffw;->b()Ljava/lang/String;
    ...
    invoke-virtual {p1}, Lebs;->d()Ljava/io/InputStream;
