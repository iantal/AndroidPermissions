...
.method public constructor <init>(Ljava/security/interfaces/ECPublicKey;)V
    ...
    iput-object p1, p0, Lesf;->a:Ljava/security/interfaces/ECPublicKey;
...
# virtual methods
.method public final a(Ljava/lang/String;[B[BILesk;)Lesg;
    .locals 9
    ...
    iget-object v0, p0, Lesf;->a:Ljava/security/interfaces/ECPublicKey;

    invoke-interface {v0}, Ljava/security/interfaces/ECPublicKey;->getParams()Ljava/security/spec/ECParameterSpec;

    move-result-object v0

    sget-object v1, Lesm;->d:Lesm;

    const-string v2, "EC"

    invoke-virtual {v1, v2}, Lesm;->a(Ljava/lang/String;)Ljava/lang/Object;
    ...
    iget-object v2, p0, Lesf;->a:Ljava/security/interfaces/ECPublicKey;

    invoke-interface {v2}, Ljava/security/interfaces/ECPublicKey;->getW()Ljava/security/spec/ECPoint;

    move-result-object v2

    iget-object v3, p0, Lesf;->a:Ljava/security/interfaces/ECPublicKey;
    ...
    invoke-static {v2, v3}, Lesh;->a(Ljava/security/spec/ECPoint;Ljava/security/spec/EllipticCurve;)V

    sget-object v2, Lesm;->c:Lesm;

    const-string v3, "ECDH"

    invoke-virtual {v2, v3}, Lesm;->a(Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-static {v1, v2}, Lesh;->a(Ljava/security/spec/ECPoint;Ljava/security/spec/EllipticCurve;)V

    invoke-static {v2}, Lesh;->a(Ljava/security/spec/EllipticCurve;)I

    move-result v2

    sget-object v4, Lesi;->a:[I

    invoke-virtual {p5}, Lesk;->ordinal()I
    ...
    invoke-static {v1}, Lers;->a([[B)[B

    move-result-object v0

    invoke-static {p1, v0, p2, p3, p4}, Lesw;->a(Ljava/lang/String;[B[B[BI)[B

    move-result-object p1

    new-instance p2, Lesg;

    invoke-direct {p2, p5, p1}, Lesg;-><init>([B[B)V
