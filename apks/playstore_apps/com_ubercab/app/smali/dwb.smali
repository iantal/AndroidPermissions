...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Ldwb;->b:Ljava/util/Map;

    new-instance v0, Ldwc;

    invoke-direct {v0, p0}, Ldwc;-><init>(Ldwb;)V

    iput-object v0, p0, Ldwb;->a:Landroid/content/BroadcastReceiver;
...
.method private final declared-synchronized a(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    :try_start_0
    iget-object v0, p0, Ldwb;->b:Ljava/util/Map;
...
.method static synthetic a(Ldwb;Landroid/content/Context;Landroid/content/Intent;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Ldwb;->a(Landroid/content/Context;Landroid/content/Intent;)V
...
.method public final declared-synchronized a(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Ldwb;->e:Landroid/content/Context;
    ...
    :cond_1
    iget-object p1, p0, Ldwb;->e:Landroid/content/Context;

    invoke-static {p1}, Lfhv;->a(Landroid/content/Context;)V

    sget-object p1, Lfhv;->bT:Lfhk;
    ...
    iget-object v1, p0, Ldwb;->a:Landroid/content/BroadcastReceiver;

    invoke-virtual {v0, v1, p1}, Landroid/content/Context;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;

    const/4 p1, 0x1

    iput-boolean p1, p0, Ldwb;->c:Z
    :try_end_1
...
.method public final declared-synchronized a(Landroid/content/Context;Landroid/content/BroadcastReceiver;)V
    ...
    iget-object p1, p0, Ldwb;->b:Ljava/util/Map;
