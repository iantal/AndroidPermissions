...
# static fields
.field private static final a:Ljava/lang/String; = "fxr"

.field private static b:Landroid/content/Context;

.field private static c:Lfxu;
...
.method public static a(Landroid/content/Context;)Lfxu;
    .locals 3
    ...
    sget-object v0, Lfxr;->c:Lfxu;

    if-eqz v0, :cond_0

    sget-object p0, Lfxr;->c:Lfxu;
    ...
    invoke-static {p0}, Lfxr;->b(Landroid/content/Context;)Landroid/content/Context;
    ...
    invoke-static {v0, v1}, Lfxr;->a(Ljava/lang/ClassLoader;Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-direct {v1, v0}, Lfxv;-><init>(Landroid/os/IBinder;)V

    move-object v0, v1

    :goto_0
    sput-object v0, Lfxr;->c:Lfxu;
    ...
    invoke-interface {v0, p0, v1}, Lfxu;->a(Ldjx;I)V
    :try_end_0
...
.method private static a(Ljava/lang/ClassLoader;Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-static {p0}, Lfxr;->a(Ljava/lang/Class;)Ljava/lang/Object;
...
.method private static b(Landroid/content/Context;)Landroid/content/Context;
    ...
    sget-object v0, Lfxr;->b:Landroid/content/Context;

    if-eqz v0, :cond_0

    sget-object p0, Lfxr;->b:Landroid/content/Context;

    return-object p0

    :cond_0
    invoke-static {p0}, Lfxr;->c(Landroid/content/Context;)Landroid/content/Context;

    move-result-object p0

    sput-object p0, Lfxr;->b:Landroid/content/Context;
...
.method private static c(Landroid/content/Context;)Landroid/content/Context;
    ...
    :try_start_0
    sget-object v0, Lcom/google/android/gms/dynamite/DynamiteModule;->a:Ldkp;

    const-string v1, "com.google.android.gms.maps_dynamite"

    invoke-static {p0, v0, v1}, Lcom/google/android/gms/dynamite/DynamiteModule;->a(Landroid/content/Context;Ldkp;Ljava/lang/String;)Lcom/google/android/gms/dynamite/DynamiteModule;
    ...
    sget-object v1, Lfxr;->a:Ljava/lang/String;
