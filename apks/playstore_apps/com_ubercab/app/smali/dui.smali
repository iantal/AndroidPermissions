...
.method public a(Ldzy;Z)Ldzz;
    ...
    invoke-direct {v0, p1, p2}, Lebi;-><init>(Ldzy;Z)V
...
.method public a(Landroid/content/Context;Landroid/webkit/WebSettings;)Z
    ...
    invoke-super {p0, p1, p2}, Lduh;->a(Landroid/content/Context;Landroid/webkit/WebSettings;)Z

    new-instance v0, Lduj;

    invoke-direct {v0, p0, p1, p2}, Lduj;-><init>(Ldui;Landroid/content/Context;Landroid/webkit/WebSettings;)V

    invoke-static {p1, v0}, Ldvy;->a(Landroid/content/Context;Ljava/util/concurrent/Callable;)Ljava/lang/Object;
...
.method public c(Ldzy;)Landroid/webkit/WebChromeClient;
    ...
    invoke-direct {v0, p1}, Leba;-><init>(Ldzy;)V
