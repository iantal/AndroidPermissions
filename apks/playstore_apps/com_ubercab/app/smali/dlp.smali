...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Ldlp;->d:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {p1}, Landroid/content/Context;->getApplicationContext()Landroid/content/Context;

    move-result-object p1

    iput-object p1, p0, Ldlp;->b:Landroid/content/Context;
...
.method private final a()Landroid/os/Bundle;
    ...
    :try_start_0
    iget-object v0, p0, Ldlp;->b:Landroid/content/Context;

    invoke-virtual {v0}, Landroid/content/Context;->getPackageManager()Landroid/content/pm/PackageManager;

    move-result-object v0

    iget-object v1, p0, Ldlp;->b:Landroid/content/Context;
...
.method public static declared-synchronized a(Landroid/content/Context;)Ldlp;
    .locals 2
    ...
    sput-object v1, Ldlp;->a:Ldlp;

    :cond_0
    sget-object p0, Ldlp;->a:Ldlp;
    :try_end_0
...
.method private final b(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1, p2}, Ldlp;->a(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    :goto_0
    invoke-static {p1, v0}, Ldlp;->a(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v4, p0, Ldlp;->b:Landroid/content/Context;
    ...
    :goto_2
    invoke-static {p1, v5}, Ldlp;->a(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
...
.method private final c(Landroid/os/Bundle;)Landroid/app/PendingIntent;
    ...
    :cond_4
    iget-object p1, p0, Ldlp;->b:Landroid/content/Context;

    iget-object v0, p0, Ldlp;->d:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public final b(Landroid/os/Bundle;)Z
    ...
    invoke-direct {p0, p1, v0}, Ldlp;->b(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {p0, p1, v1}, Ldlp;->b(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    const-string v2, "gcm.n.icon"

    invoke-static {p1, v2}, Ldlp;->a(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v3, p0, Ldlp;->b:Landroid/content/Context;
    ...
    iget-object v5, p0, Ldlp;->b:Landroid/content/Context;
    ...
    :cond_3
    iget-object v2, p0, Ldlp;->b:Landroid/content/Context;
    ...
    invoke-static {p1, v3}, Ldlp;->a(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v8, p0, Ldlp;->b:Landroid/content/Context;
    ...
    iget-object v7, p0, Ldlp;->b:Landroid/content/Context;
    ...
    :goto_1
    invoke-direct {p0, p1}, Ldlp;->c(Landroid/os/Bundle;)Landroid/app/PendingIntent;
    ...
    invoke-static {p1, v7}, Ldlp;->a(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_7
    iget-object v6, p0, Ldlp;->b:Landroid/content/Context;
    ...
    :cond_9
    iget-object v7, p0, Ldlp;->c:Ljava/lang/String;

    if-eqz v7, :cond_a

    :goto_2
    iget-object v6, p0, Ldlp;->c:Ljava/lang/String;

    goto :goto_4

    :cond_a
    invoke-direct {p0}, Ldlp;->a()Landroid/os/Bundle;
    ...
    iput-object v7, p0, Ldlp;->c:Ljava/lang/String;
    ...
    iget-object v11, p0, Ldlp;->b:Landroid/content/Context;

    sget v12, Lcnh;->gcm_fallback_notification_channel_label:I
    ...
    iput-object v6, p0, Ldlp;->c:Ljava/lang/String;
    ...
    iget-object v10, p0, Ldlp;->b:Landroid/content/Context;
    ...
    invoke-direct {v6, v7}, Llq;-><init>(Landroid/content/Context;)V

    invoke-virtual {v6, v9}, Llq;->b(Z)Llq;

    move-result-object v6

    invoke-virtual {v6, v4}, Llq;->a(I)Llq;
    ...
    invoke-virtual {v4, v0}, Llq;->a(Ljava/lang/CharSequence;)Llq;
    ...
    invoke-virtual {v4, v1}, Llq;->b(Ljava/lang/CharSequence;)Llq;
    ...
    invoke-virtual {v4, v0}, Llq;->d(I)Llq;

    :cond_17
    if-eqz v3, :cond_18

    invoke-virtual {v4, v3}, Llq;->a(Landroid/net/Uri;)Llq;

    :cond_18
    if-eqz v5, :cond_19

    invoke-virtual {v4, v5}, Llq;->a(Landroid/app/PendingIntent;)Llq;

    :cond_19
    invoke-virtual {v4}, Llq;->a()Landroid/app/Notification;
    ...
    invoke-static {p1, v1}, Ldlp;->a(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
