...
.method protected final onActivityResult(IILandroid/content/Intent;)V
    ...
    const-string/jumbo v0, "unexpected request code "
    ...
    const-string p3, "com.paypal.android.sdk.paymentConfirmation"

    invoke-virtual {p2, p3, p1}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Landroid/os/Parcelable;)Landroid/content/Intent;

    const/4 p1, -0x1

    invoke-virtual {p0, p1, p2}, Lcom/paypal/android/sdk/payments/PaymentActivity;->setResult(ILandroid/content/Intent;)V

    goto :goto_1

    :cond_0
    sget-object p1, Lcom/paypal/android/sdk/payments/PaymentActivity;->a:Ljava/lang/String;

    const-string p2, "result was OK, have data, but no payment state in bundle, oops"
