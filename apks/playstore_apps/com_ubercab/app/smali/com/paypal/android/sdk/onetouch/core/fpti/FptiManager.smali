...
.field private mToken:Lcom/paypal/android/sdk/onetouch/core/fpti/FptiToken;
...
.method static synthetic access$000(Lcom/paypal/android/sdk/onetouch/core/fpti/FptiManager;)Lcom/paypal/android/sdk/onetouch/core/network/PayPalHttpClient;
    .locals 0
...
.method private getEventParams(Ljava/util/Map;)Lorg/json/JSONObject;
    .locals 4
...
.method private getGmtOffsetInMinutes()Ljava/lang/String;
    .locals 1

    .line 113
    invoke-direct {p0}, Lcom/paypal/android/sdk/onetouch/core/fpti/FptiManager;->getGMTOffset()I
...
# virtual methods
.method sendRequest(Ljava/lang/String;)V
    .locals 4
...
.method public trackFpti(Lcom/paypal/android/sdk/onetouch/core/fpti/TrackingPoint;Ljava/lang/String;Ljava/util/Map;Lcom/paypal/android/sdk/onetouch/core/enums/Protocol;)V
    ...
    invoke-virtual {p4}, Lcom/paypal/android/sdk/onetouch/core/enums/Protocol;->name()Ljava/lang/String;
    ...
    .line 60
    invoke-direct {p0}, Lcom/paypal/android/sdk/onetouch/core/fpti/FptiManager;->getGmtOffsetInMinutes()Ljava/lang/String;
    ...
    .line 63
    iget-object v4, p0, Lcom/paypal/android/sdk/onetouch/core/fpti/FptiManager;->mContextInspector:Lcom/paypal/android/sdk/onetouch/core/base/ContextInspector;

    invoke-virtual {v4}, Lcom/paypal/android/sdk/onetouch/core/base/ContextInspector;->getContext()Landroid/content/Context;

    move-result-object v4

    invoke-static {v4}, Lcom/paypal/android/sdk/onetouch/core/base/DeviceInspector;->getSimOperatorName(Landroid/content/Context;)Ljava/lang/String;

    move-result-object v4

    invoke-interface {v3, p3, v4}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string p3, "mdvs"
    ...
    .line 73
    iget-object p2, p0, Lcom/paypal/android/sdk/onetouch/core/fpti/FptiManager;->mToken:Lcom/paypal/android/sdk/onetouch/core/fpti/FptiToken;

    iget-object p2, p2, Lcom/paypal/android/sdk/onetouch/core/fpti/FptiToken;->mToken:Ljava/lang/String;
    ...
    .line 84
    invoke-direct {p0, v3}, Lcom/paypal/android/sdk/onetouch/core/fpti/FptiManager;->getEventParams(Ljava/util/Map;)Lorg/json/JSONObject;
