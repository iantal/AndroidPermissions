.class Lcom/paypal/android/sdk/onetouch/core/config/ConfigFileParser;
...
.method private addEnvironment(Lcom/paypal/android/sdk/onetouch/core/config/OAuth2Recipe;Ljava/lang/String;Lorg/json/JSONObject;)V
    .locals 3
...
.method private getBillingAgreementRecipe(Lorg/json/JSONObject;)Lcom/paypal/android/sdk/onetouch/core/config/BillingAgreementRecipe;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/json/JSONException;
    ...
    .line 63
    invoke-direct {p0, v0, p1}, Lcom/paypal/android/sdk/onetouch/core/config/ConfigFileParser;->populateCommonData(Lcom/paypal/android/sdk/onetouch/core/config/Recipe;Lorg/json/JSONObject;)V

    return-object v0
.end method

.method private getCheckoutRecipe(Lorg/json/JSONObject;)Lcom/paypal/android/sdk/onetouch/core/config/CheckoutRecipe;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/json/JSONException;
...
.method private getOAuth2Recipe(Lorg/json/JSONObject;)Lcom/paypal/android/sdk/onetouch/core/config/OAuth2Recipe;
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/json/JSONException;
    ...
    .line 115
    invoke-direct {p0, v0, v1, v2}, Lcom/paypal/android/sdk/onetouch/core/config/ConfigFileParser;->addEnvironment(Lcom/paypal/android/sdk/onetouch/core/config/OAuth2Recipe;Ljava/lang/String;Lorg/json/JSONObject;)V
    ...
    .line 127
    invoke-direct {p0, v0, v1, p1}, Lcom/paypal/android/sdk/onetouch/core/config/ConfigFileParser;->addEnvironment(Lcom/paypal/android/sdk/onetouch/core/config/OAuth2Recipe;Ljava/lang/String;Lorg/json/JSONObject;)V

    :cond_4
    return-object v0
.end method

.method private populateCommonData(Lcom/paypal/android/sdk/onetouch/core/config/Recipe;Lorg/json/JSONObject;)V
    .locals 4
...
# virtual methods
.method getParsedConfig(Lorg/json/JSONObject;)Lcom/paypal/android/sdk/onetouch/core/config/OtcConfiguration;
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/json/JSONException;
    ...
    .line 24
    invoke-direct {p0, v4}, Lcom/paypal/android/sdk/onetouch/core/config/ConfigFileParser;->getOAuth2Recipe(Lorg/json/JSONObject;)Lcom/paypal/android/sdk/onetouch/core/config/OAuth2Recipe;
    ...
    .line 35
    invoke-direct {p0, v4}, Lcom/paypal/android/sdk/onetouch/core/config/ConfigFileParser;->getCheckoutRecipe(Lorg/json/JSONObject;)Lcom/paypal/android/sdk/onetouch/core/config/CheckoutRecipe;
    ...
    .line 46
    invoke-direct {p0, v1}, Lcom/paypal/android/sdk/onetouch/core/config/ConfigFileParser;->getBillingAgreementRecipe(Lorg/json/JSONObject;)Lcom/paypal/android/sdk/onetouch/core/config/BillingAgreementRecipe;
