...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iget-object v0, p0, Lcom/paypal/android/sdk/gi;->d:Landroid/widget/TableLayout;
    ...
    iget-object v3, p0, Lcom/paypal/android/sdk/gi;->d:Landroid/widget/TableLayout;

    invoke-virtual {v3, v0}, Landroid/widget/TableLayout;->addView(Landroid/view/View;)V

    iget-object v3, p0, Lcom/paypal/android/sdk/gi;->a:Landroid/widget/LinearLayout;

    iget-object v4, p0, Lcom/paypal/android/sdk/gi;->d:Landroid/widget/TableLayout;
    ...
    iput-object v3, p0, Lcom/paypal/android/sdk/gi;->b:Landroid/widget/RelativeLayout;

    iget-object v3, p0, Lcom/paypal/android/sdk/gi;->b:Landroid/widget/RelativeLayout;
    ...
    invoke-static {v3, v5, v4}, Lcom/paypal/android/sdk/cz;->a(Landroid/view/View;IF)V
    ...
    invoke-static {v3, v6, v6, v5, v6}, Lcom/paypal/android/sdk/cz;->b(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    new-instance v3, Landroid/widget/TextView;

    invoke-direct {v3, p1}, Landroid/widget/TextView;-><init>(Landroid/content/Context;)V

    iput-object v3, p0, Lcom/paypal/android/sdk/gi;->g:Landroid/widget/TextView;

    iget-object v3, p0, Lcom/paypal/android/sdk/gi;->g:Landroid/widget/TextView;

    invoke-static {v3, v2}, Lcom/paypal/android/sdk/cz;->d(Landroid/widget/TextView;I)V
    ...
    invoke-static {v3, v7, v6, v6, v6}, Lcom/paypal/android/sdk/cz;->b(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    new-instance v3, Landroid/widget/TextView;

    invoke-direct {v3, p1}, Landroid/widget/TextView;-><init>(Landroid/content/Context;)V

    iput-object v3, p0, Lcom/paypal/android/sdk/gi;->f:Landroid/widget/TextView;

    iget-object v3, p0, Lcom/paypal/android/sdk/gi;->f:Landroid/widget/TextView;

    invoke-static {v3, v2}, Lcom/paypal/android/sdk/cz;->b(Landroid/widget/TextView;I)V
    ...
    invoke-static {v3, v3, v8, v5}, Lcom/paypal/android/sdk/cz;->a(IIII)Landroid/widget/RelativeLayout$LayoutParams;

    move-result-object v3

    iget-object v8, p0, Lcom/paypal/android/sdk/gi;->b:Landroid/widget/RelativeLayout;

    iget-object v9, p0, Lcom/paypal/android/sdk/gi;->f:Landroid/widget/TextView;
    ...
    invoke-static {v3, v8, v6, v6, v6}, Lcom/paypal/android/sdk/cz;->b(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    const-string v3, ""

    const-string v8, "go to selection"

    invoke-static {p1, v3, v8}, Lcom/paypal/android/sdk/cz;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/widget/ImageView;

    move-result-object v3

    iput-object v3, p0, Lcom/paypal/android/sdk/gi;->e:Landroid/widget/ImageView;

    iget-object v3, p0, Lcom/paypal/android/sdk/gi;->e:Landroid/widget/ImageView;
    ...
    sget v8, Lcom/paypal/android/sdk/cy;->g:I

    invoke-virtual {v3, v8}, Landroid/widget/ImageView;->setColorFilter(I)V

    const-string v3, "20dip"

    const-string v8, "20dip"

    const/16 v9, 0xf

    invoke-static {p1, v3, v8, v9}, Lcom/paypal/android/sdk/cz;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;I)Landroid/widget/RelativeLayout$LayoutParams;
    ...
    iget-object v5, p0, Lcom/paypal/android/sdk/gi;->e:Landroid/widget/ImageView;
    ...
    iput-object v1, p0, Lcom/paypal/android/sdk/gi;->c:Landroid/widget/Button;

    iget-object p1, p0, Lcom/paypal/android/sdk/gi;->c:Landroid/widget/Button;
    ...
    invoke-static {p1, v1}, Lcom/paypal/android/sdk/cz;->a(Landroid/widget/TextView;I)V
    ...
    invoke-static {p1, v6, v6, v0, v6}, Lcom/paypal/android/sdk/cz;->b(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    iget-object p1, p0, Lcom/paypal/android/sdk/gi;->c:Landroid/widget/Button;

    invoke-static {p1, v1, v4}, Lcom/paypal/android/sdk/cz;->a(Landroid/view/View;IF)V
