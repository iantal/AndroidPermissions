...
.method public static synthetic access$100(Lcom/facebook/react/modules/camera/ImageStoreManager;)Lboy;
    .locals 0

    .line 31
    invoke-virtual {p0}, Lcom/facebook/react/modules/camera/ImageStoreManager;->getReactApplicationContext()Lboy;
...
.method public getBase64ForTag(Ljava/lang/String;Lbnf;Lbnf;)V
    .locals 8
    ...
    invoke-direct/range {v0 .. v6}, Lbud;-><init>(Lcom/facebook/react/modules/camera/ImageStoreManager;Lbpa;Ljava/lang/String;Lbnf;Lbnf;Lcom/facebook/react/modules/camera/ImageStoreManager$1;)V
    ...
    .line 54
    invoke-virtual {v7, p1, p2}, Lbud;->executeOnExecutor(Ljava/util/concurrent/Executor;[Ljava/lang/Object;)Landroid/os/AsyncTask;
