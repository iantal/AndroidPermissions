...
.field private final mParser:Laxkt;
...
.method public constructor <init>(Ljava/lang/Iterable;)V
    ...
    invoke-direct {p0, p1, v0}, Lcom/facebook/stetho/dumpapp/Dumper;-><init>(Ljava/lang/Iterable;Laxkt;)V

    return-void
.end method

.method public constructor <init>(Ljava/lang/Iterable;Laxkt;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 44
    iput-object p2, p0, Lcom/facebook/stetho/dumpapp/Dumper;->mParser:Laxkt;
...
.method private doDump(Ljava/io/InputStream;Ljava/io/PrintStream;Ljava/io/PrintStream;[Ljava/lang/String;)I
    ...
    .line 93
    iget-object v0, p0, Lcom/facebook/stetho/dumpapp/Dumper;->mParser:Laxkt;

    iget-object v1, p0, Lcom/facebook/stetho/dumpapp/Dumper;->mGlobalOptions:Lcom/facebook/stetho/dumpapp/GlobalOptions;

    iget-object v1, v1, Lcom/facebook/stetho/dumpapp/GlobalOptions;->options:Laxld;

    const/4 v2, 0x1

    invoke-interface {v0, v1, p4, v2}, Laxkt;->a(Laxld;[Ljava/lang/String;Z)Laxks;
    ...
    iget-object v0, v0, Lcom/facebook/stetho/dumpapp/GlobalOptions;->optionHelp:Laxla;

    invoke-virtual {v0}, Laxla;->b()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {p4, v0}, Laxks;->a(Ljava/lang/String;)Z
    ...
    iget-object v0, v0, Lcom/facebook/stetho/dumpapp/GlobalOptions;->optionListPlugins:Laxla;
    ...
    .line 103
    :cond_1
    invoke-virtual {p4}, Laxks;->a()Ljava/util/List;
    ...
    .line 104
    invoke-direct {p0, p1, p2, p3, p4}, Lcom/facebook/stetho/dumpapp/Dumper;->dumpPluginOutput(Ljava/io/InputStream;Ljava/io/PrintStream;Ljava/io/PrintStream;Laxks;)V
...
.method private dumpPluginOutput(Ljava/io/InputStream;Ljava/io/PrintStream;Ljava/io/PrintStream;Laxks;)V
    .locals 7
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/facebook/stetho/dumpapp/DumpException;
    ...
    iget-object v4, p0, Lcom/facebook/stetho/dumpapp/Dumper;->mParser:Laxkt;
    ...
    invoke-direct/range {v0 .. v5}, Lcom/facebook/stetho/dumpapp/DumperContext;-><init>(Ljava/io/InputStream;Ljava/io/PrintStream;Ljava/io/PrintStream;Laxkt;Ljava/util/List;)V
...
.method private dumpUsage(Ljava/io/PrintStream;)V
    ...
    .line 153
    :try_start_0
    invoke-virtual {v0}, Laxkv;->a()I

    move-result v2

    iget-object p1, p0, Lcom/facebook/stetho/dumpapp/Dumper;->mGlobalOptions:Lcom/facebook/stetho/dumpapp/GlobalOptions;

    iget-object v3, p1, Lcom/facebook/stetho/dumpapp/GlobalOptions;->options:Laxld;

    .line 155
    invoke-virtual {v0}, Laxkv;->b()I

    move-result v4

    .line 156
    invoke-virtual {v0}, Laxkv;->c()I
    ...
    .line 151
    invoke-virtual/range {v0 .. v5}, Laxkv;->a(Ljava/io/PrintWriter;ILaxld;II)V
    :try_end_0
...
.method public dump(Ljava/io/InputStream;Ljava/io/PrintStream;Ljava/io/PrintStream;[Ljava/lang/String;)I
    ...
    move-result p1
    :try_end_0
    .catch Laxle; {:try_start_0 .. :try_end_0} :catch_3
    ...
    .line 71
    invoke-virtual {p1}, Laxle;->getMessage()Ljava/lang/String;
