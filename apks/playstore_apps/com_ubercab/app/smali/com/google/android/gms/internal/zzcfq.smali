...
.method public constructor <init>(ILcom/google/android/gms/internal/zzcfo;Landroid/os/IBinder;Landroid/app/PendingIntent;Landroid/os/IBinder;Landroid/os/IBinder;)V
    ...
    :cond_0
    invoke-static {p3}, Lfvz;->a(Landroid/os/IBinder;)Lfvy;

    move-result-object p2

    :goto_0
    iput-object p2, p0, Lcom/google/android/gms/internal/zzcfq;->c:Lfvy;
    ...
    :cond_1
    invoke-static {p5}, Lfvw;->a(Landroid/os/IBinder;)Lfvv;

    move-result-object p2

    :goto_1
    iput-object p2, p0, Lcom/google/android/gms/internal/zzcfq;->e:Lfvv;
    ...
    invoke-direct {p1, p6}, Lehc;-><init>(Landroid/os/IBinder;)V

    :goto_2
    iput-object p1, p0, Lcom/google/android/gms/internal/zzcfq;->f:Leha;

    return-void
.end method

.method public static a(Lfvv;Leha;)Lcom/google/android/gms/internal/zzcfq;
    .locals 8

    new-instance v7, Lcom/google/android/gms/internal/zzcfq;

    invoke-interface {p0}, Lfvv;->asBinder()Landroid/os/IBinder;

    move-result-object v5

    if-eqz p1, :cond_0

    invoke-interface {p1}, Leha;->asBinder()Landroid/os/IBinder;
...
.method public static a(Lfvy;Leha;)Lcom/google/android/gms/internal/zzcfq;
    .locals 8

    new-instance v7, Lcom/google/android/gms/internal/zzcfq;

    invoke-interface {p0}, Lfvy;->asBinder()Landroid/os/IBinder;
...
.method public final writeToParcel(Landroid/os/Parcel;I)V
    ...
    iget-object v1, p0, Lcom/google/android/gms/internal/zzcfq;->c:Lfvy;
    ...
    invoke-interface {v1}, Lfvy;->asBinder()Landroid/os/IBinder;
    ...
    invoke-static {p1, v4, v1, v2}, Leeh;->a(Landroid/os/Parcel;ILandroid/os/IBinder;Z)V

    const/4 v1, 0x4

    iget-object v4, p0, Lcom/google/android/gms/internal/zzcfq;->d:Landroid/app/PendingIntent;

    invoke-static {p1, v1, v4, p2, v2}, Leeh;->a(Landroid/os/Parcel;ILandroid/os/Parcelable;IZ)V

    const/4 p2, 0x5

    iget-object v1, p0, Lcom/google/android/gms/internal/zzcfq;->e:Lfvv;
    ...
    invoke-interface {v1}, Lfvv;->asBinder()Landroid/os/IBinder;

    move-result-object v1

    :goto_1
    invoke-static {p1, p2, v1, v2}, Leeh;->a(Landroid/os/Parcel;ILandroid/os/IBinder;Z)V

    const/4 p2, 0x6

    iget-object v1, p0, Lcom/google/android/gms/internal/zzcfq;->f:Leha;
    ...
    invoke-interface {v1}, Leha;->asBinder()Landroid/os/IBinder;

    move-result-object v3

    :goto_2
    invoke-static {p1, p2, v3, v2}, Leeh;->a(Landroid/os/Parcel;ILandroid/os/IBinder;Z)V
