...
.field public static final b:Ldkp;

.field public static final c:Ldkp;

.field public static final d:Ldkp;

.field public static final e:Ldkp;

.field private static f:Ljava/lang/Boolean;

.field private static g:Ldla;

.field private static h:Ldlc;
...
.field private static final k:Ldky;

.field private static l:Ldkp;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/android/gms/dynamite/DynamiteModule;->k:Ldky;

    new-instance v0, Ldkr;

    invoke-direct {v0}, Ldkr;-><init>()V

    sput-object v0, Lcom/google/android/gms/dynamite/DynamiteModule;->a:Ldkp;

    new-instance v0, Ldks;

    invoke-direct {v0}, Ldks;-><init>()V

    sput-object v0, Lcom/google/android/gms/dynamite/DynamiteModule;->l:Ldkp;

    new-instance v0, Ldkt;

    invoke-direct {v0}, Ldkt;-><init>()V

    sput-object v0, Lcom/google/android/gms/dynamite/DynamiteModule;->b:Ldkp;

    new-instance v0, Ldku;

    invoke-direct {v0}, Ldku;-><init>()V

    sput-object v0, Lcom/google/android/gms/dynamite/DynamiteModule;->c:Ldkp;

    new-instance v0, Ldkv;

    invoke-direct {v0}, Ldkv;-><init>()V

    sput-object v0, Lcom/google/android/gms/dynamite/DynamiteModule;->d:Ldkp;

    new-instance v0, Ldkw;

    invoke-direct {v0}, Ldkw;-><init>()V

    sput-object v0, Lcom/google/android/gms/dynamite/DynamiteModule;->e:Ldkp;
...
.method public static a(Landroid/content/Context;Ljava/lang/String;Z)I
    ...
    :try_end_3
    .catch Ldko; {:try_start_3 .. :try_end_3} :catch_0
    ...
    invoke-direct {v5, v6, v7}, Ldkx;-><init>(Ljava/lang/String;Ljava/lang/ClassLoader;)V
    ...
    :try_end_5
    .catch Ldko; {:try_start_5 .. :try_end_5} :catch_1
    ...
    move-result p0
    :try_end_d
    .catch Ldko; {:try_start_d .. :try_end_d} :catch_3
    ...
    invoke-virtual {p0}, Ldko;->getMessage()Ljava/lang/String;
...
.method private static a(Landroid/content/Context;Ljava/lang/String;ILandroid/database/Cursor;Ldlc;)Landroid/content/Context;
    .locals 0

    :try_start_0
    invoke-static {p0}, Ldki;->a(Ljava/lang/Object;)Ldjx;
    ...
    invoke-interface {p4, p0, p1, p2, p3}, Ldlc;->a(Ldjx;Ljava/lang/String;ILdjx;)Ldjx;
...
.method public static a(Landroid/content/Context;Ldkp;Ljava/lang/String;)Lcom/google/android/gms/dynamite/DynamiteModule;
    .locals 10
    ...
    invoke-direct {v1, v2}, Ldkm;-><init>(Ldkq;)V
    ...
    :try_start_0
    sget-object v3, Lcom/google/android/gms/dynamite/DynamiteModule;->k:Ldky;

    invoke-interface {p1, p0, p2, v3}, Ldkp;->a(Landroid/content/Context;Ljava/lang/String;Ldky;)Ldkz;
    ...
    iget-object p1, v1, Ldkm;->a:Landroid/database/Cursor;
    ...
    move-result-object v4
    :try_end_2
    .catch Ldko; {:try_start_2 .. :try_end_2} :catch_0
    .catchall {:try_start_2 .. :try_end_2} :catchall_0

    iget-object p0, v1, Ldkm;->a:Landroid/database/Cursor;
    ...
    invoke-virtual {v4}, Ldko;->getMessage()Ljava/lang/String;
    ...
    invoke-direct {v6, v3, v7}, Ldkn;-><init>(II)V

    invoke-interface {p1, p0, p2, v6}, Ldkp;->a(Landroid/content/Context;Ljava/lang/String;Ldky;)Ldkz;
    ...
    invoke-direct {p0, p1, v4, v2}, Ldko;-><init>(Ljava/lang/String;Ljava/lang/Throwable;Ldkq;)V
    ...
    invoke-direct {p0, p1, v2}, Ldko;-><init>(Ljava/lang/String;Ldkq;)V
...
.method private static a(Landroid/content/Context;Ljava/lang/String;I)Lcom/google/android/gms/dynamite/DynamiteModule;
    ...
    invoke-direct {p0, p2, p1}, Ldko;-><init>(Ljava/lang/String;Ldkq;)V
...
.method private static a(Landroid/content/Context;)Ldla;
    .locals 5
    ...
    :try_start_0
    sget-object v1, Lcom/google/android/gms/dynamite/DynamiteModule;->g:Ldla;

    if-eqz v1, :cond_0

    sget-object p0, Lcom/google/android/gms/dynamite/DynamiteModule;->g:Ldla;
    ...
    invoke-virtual {v1, p0}, Ldjm;->a(Landroid/content/Context;)I
    ...
    invoke-direct {v1, p0}, Ldlb;-><init>(Landroid/os/IBinder;)V
    ...
    sput-object p0, Lcom/google/android/gms/dynamite/DynamiteModule;->g:Ldla;
    :try_end_1
...
.method private static a(Ljava/lang/ClassLoader;)V
    ...
    invoke-direct {v1, p0}, Ldld;-><init>(Landroid/os/IBinder;)V

    move-object p0, v1

    :goto_0
    sput-object p0, Lcom/google/android/gms/dynamite/DynamiteModule;->h:Ldlc;
    :try_end_0
    ...
    invoke-direct {v1, v2, p0, v0}, Ldko;-><init>(Ljava/lang/String;Ljava/lang/Throwable;Ldkq;)V
...
.method private static b(Landroid/content/Context;Ljava/lang/String;Z)I
    ...
    invoke-static {p0}, Lcom/google/android/gms/dynamite/DynamiteModule;->a(Landroid/content/Context;)Ldla;
    ...
    invoke-interface {v0, p0, p1, p2}, Ldla;->a(Ldjx;Ljava/lang/String;Z)I
...
.method private static b(Landroid/content/Context;Ljava/lang/String;I)Lcom/google/android/gms/dynamite/DynamiteModule;
    ...
    invoke-interface {v0, p0, p1, p2}, Ldla;->a(Ldjx;Ljava/lang/String;I)Ldjx;
    ...
    invoke-direct {p0, p1, v1}, Ldko;-><init>(Ljava/lang/String;Ldkq;)V
    ...
    invoke-direct {p1, p2, p0, v1}, Ldko;-><init>(Ljava/lang/String;Ljava/lang/Throwable;Ldkq;)V
...
.method private static c(Landroid/content/Context;Ljava/lang/String;Z)I
    ...
    iget-object v1, p2, Ldkm;->a:Landroid/database/Cursor;

    if-nez v1, :cond_1

    iput-object p0, p2, Ldkm;->a:Landroid/database/Cursor;
    :try_end_3
    ...
    invoke-direct {p1, p2, v0}, Ldko;-><init>(Ljava/lang/String;Ldkq;)V
    ...
    :cond_4
    new-instance p2, Ldko;

    const-string v1, "V2 version check failed"

    invoke-direct {p2, v1, p0, v0}, Ldko;-><init>(Ljava/lang/String;Ljava/lang/Throwable;Ldkq;)V
...
.method private static c(Landroid/content/Context;Ljava/lang/String;I)Lcom/google/android/gms/dynamite/DynamiteModule;
    ...
    :try_start_0
    sget-object v1, Lcom/google/android/gms/dynamite/DynamiteModule;->h:Ldlc;
    ...
    iget-object v3, v2, Ldkm;->a:Landroid/database/Cursor;
    ...
    iget-object v2, v2, Ldkm;->a:Landroid/database/Cursor;

    invoke-static {p0, p1, p2, v2, v1}, Lcom/google/android/gms/dynamite/DynamiteModule;->a(Landroid/content/Context;Ljava/lang/String;ILandroid/database/Cursor;Ldlc;)Landroid/content/Context;
    ...
    invoke-direct {p0, p1, v0}, Ldko;-><init>(Ljava/lang/String;Ldkq;)V
...
.method public final a(Ljava/lang/String;)Landroid/os/IBinder;
    ...
    invoke-direct {v1, p1, v0, v2}, Ldko;-><init>(Ljava/lang/String;Ljava/lang/Throwable;Ldkq;)V
