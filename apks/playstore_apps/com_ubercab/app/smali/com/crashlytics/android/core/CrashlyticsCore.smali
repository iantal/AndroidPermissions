...
.field private httpRequestFactory:Laxeq;
...
.method constructor <init>(FLcom/crashlytics/android/core/CrashlyticsListener;Lcom/crashlytics/android/core/PinningInfoProvider;Z)V
    ...
    .line 181
    invoke-static {v0}, Laxcn;->a(Ljava/lang/String;)Ljava/util/concurrent/ExecutorService;
...
.method private static ensureFabricWithCalled(Ljava/lang/String;)Z
    ...
    invoke-interface {v0, v1, p0, v2}, Laxbp;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private finishInitSynchronously()V
    ...
    .line 686
    invoke-virtual {v0, v2}, Laxdk;->addDependency(Laxdq;)V

    goto :goto_0

    .line 689
    :cond_0
    invoke-virtual {p0}, Lcom/crashlytics/android/core/CrashlyticsCore;->getFabric()Laxbe;

    move-result-object v1

    invoke-virtual {v1}, Laxbe;->f()Ljava/util/concurrent/ExecutorService;
...
.method private static formatLogMessage(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0}, Laxcf;->b(I)Ljava/lang/String;
...
.method static isBuildIdValid(Ljava/lang/String;Z)Z
    ...
    invoke-interface {p0, p1, v1}, Laxbp;->a(Ljava/lang/String;Ljava/lang/String;)V

    return v0

    .line 881
    :cond_0
    invoke-static {p0}, Laxcf;->c(Ljava/lang/String;)Z
...
.method protected doInBackground()Ljava/lang/Void;
    ...
    invoke-virtual {v1}, Laxfp;->b()Laxft;
    ...
    invoke-interface {v1, v2, v3}, Laxbp;->d(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    :cond_1
    :try_start_1
    iget-object v2, v1, Laxft;->d:Laxfl;

    iget-boolean v2, v2, Laxfl;->c:Z
    ...
    iget-object v3, v1, Laxft;->b:Laxfo;

    invoke-virtual {v2, v3}, Lcom/crashlytics/android/core/CrashlyticsController;->finalizeSessions(Laxfo;)Z
    ...
    invoke-virtual {v2, v3, v1}, Lcom/crashlytics/android/core/CrashlyticsController;->submitAllReports(FLaxft;)V
    :try_end_2
...
.method getUserEmail()Ljava/lang/String;
    ...
    .line 656
    invoke-virtual {p0}, Lcom/crashlytics/android/core/CrashlyticsCore;->getIdManager()Laxco;

    move-result-object v0

    invoke-virtual {v0}, Laxco;->a()Z
...
.method internalVerifyPinning(Ljava/net/URL;)Z
    ...
    .line 778
    iget-object v0, p0, Lcom/crashlytics/android/core/CrashlyticsCore;->httpRequestFactory:Laxeq;

    sget-object v2, Laxej;->a:Laxej;
    ...
    .line 778
    invoke-interface {v0, v2, p1}, Laxeq;->a(Laxej;Ljava/lang/String;)Laxek;

    move-result-object p1

    .line 780
    invoke-virtual {p1}, Laxek;->a()Ljava/net/HttpURLConnection;
...
.method public log(ILjava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {v0, p1, p2, p3, v1}, Laxbp;->a(ILjava/lang/String;Ljava/lang/String;Z)V
...
.method public logException(Ljava/lang/Throwable;)V
    ...
    invoke-interface {p1, v0, v1, v2}, Laxbp;->a(ILjava/lang/String;Ljava/lang/String;)V
...
.method protected onPreExecute()Z
    ...
    .line 206
    invoke-super {p0}, Laxbm;->getContext()Landroid/content/Context;
...
.method onPreExecute(Landroid/content/Context;)Z
    ...
    invoke-virtual {v1, v0}, Laxcd;->a(Landroid/content/Context;)Ljava/lang/String;
    ...
    .line 227
    :cond_1
    invoke-static/range {p1 .. p1}, Laxcf;->m(Landroid/content/Context;)Ljava/lang/String;
    ...
    .line 231
    invoke-static {v0, v3, v12}, Laxcf;->a(Landroid/content/Context;Ljava/lang/String;Z)Z
    ...
    invoke-interface {v3, v4, v5}, Laxbp;->c(Ljava/lang/String;Ljava/lang/String;)V

    .line 240
    new-instance v7, Laxew;

    invoke-direct {v7, p0}, Laxew;-><init>(Laxbm;)V
    ...
    invoke-direct {v3, v4, v7}, Lcom/crashlytics/android/core/CrashlyticsFileMarker;-><init>(Ljava/lang/String;Laxev;)V
    ...
    invoke-direct {v3, v4, v5}, Laxey;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    .line 248
    invoke-static {v3, p0}, Lcom/crashlytics/android/core/PreferenceManager;->create(Laxex;Lcom/crashlytics/android/core/CrashlyticsCore;)Lcom/crashlytics/android/core/PreferenceManager;
    ...
    .line 252
    :goto_0
    new-instance v4, Laxei;

    invoke-static {}, Laxbe;->h()Laxbp;

    move-result-object v5

    invoke-direct {v4, v5}, Laxei;-><init>(Laxbp;)V

    iput-object v4, v10, Lcom/crashlytics/android/core/CrashlyticsCore;->httpRequestFactory:Laxeq;

    .line 253
    iget-object v4, v10, Lcom/crashlytics/android/core/CrashlyticsCore;->httpRequestFactory:Laxeq;

    invoke-interface {v4, v3}, Laxeq;->a(Laxes;)V
    ...
    .line 256
    invoke-static {v0, v5, v1, v2}, Lcom/crashlytics/android/core/AppData;->create(Landroid/content/Context;Laxco;Ljava/lang/String;Ljava/lang/String;)Lcom/crashlytics/android/core/AppData;
    ...
    .line 262
    new-instance v14, Lcom/crashlytics/android/core/CrashlyticsController;
    ...
    invoke-direct/range {v1 .. v9}, Lcom/crashlytics/android/core/CrashlyticsController;-><init>(Lcom/crashlytics/android/core/CrashlyticsCore;Lcom/crashlytics/android/core/CrashlyticsBackgroundWorker;Laxeq;Laxco;Lcom/crashlytics/android/core/PreferenceManager;Laxev;Lcom/crashlytics/android/core/AppData;Lcom/crashlytics/android/core/UnityVersionProvider;)V
    ...
    .line 275
    invoke-static/range {p1 .. p1}, Laxcf;->n(Landroid/content/Context;)Z
...
.method public declared-synchronized setListener(Lcom/crashlytics/android/core/CrashlyticsListener;)V
    ...
    invoke-interface {v0, v1, v2}, Laxbp;->d(Ljava/lang/String;Ljava/lang/String;)V
...
.method public setString(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 535
    invoke-static {p1}, Laxcf;->i(Landroid/content/Context;)Z
    ...
    invoke-interface {p1, p2, v0, v1}, Laxbp;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
