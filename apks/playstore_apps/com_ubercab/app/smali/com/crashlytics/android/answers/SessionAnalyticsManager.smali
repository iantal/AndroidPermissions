...
.field final lifecycleManager:Laxba;

.field final preferenceManager:Lcom/crashlytics/android/answers/AnswersPreferenceManager;


# direct methods
.method constructor <init>(Lcom/crashlytics/android/answers/AnswersEventsHandler;Laxba;Lcom/crashlytics/android/answers/BackgroundManager;Lcom/crashlytics/android/answers/AnswersPreferenceManager;J)V
    .locals 0
    ...
    .line 60
    iput-object p2, p0, Lcom/crashlytics/android/answers/SessionAnalyticsManager;->lifecycleManager:Laxba;
...
.method public static build(Laxbm;Landroid/content/Context;Laxco;Ljava/lang/String;Ljava/lang/String;J)Lcom/crashlytics/android/answers/SessionAnalyticsManager;
    .locals 13
    ...
    invoke-direct {v4, p1, p2, v1, v2}, Lcom/crashlytics/android/answers/SessionMetadataCollector;-><init>(Landroid/content/Context;Laxco;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v0, p0}, Laxew;-><init>(Laxbm;)V

    invoke-direct {v3, p1, v0}, Lcom/crashlytics/android/answers/AnswersFilesManagerProvider;-><init>(Landroid/content/Context;Laxev;)V
    ...
    invoke-direct {v5, v0}, Laxei;-><init>(Laxbp;)V

    .line 43
    new-instance v8, Laxba;

    invoke-direct {v8, p1}, Laxba;-><init>(Landroid/content/Context;)V

    const-string v0, "Answers Events Handler"

    .line 45
    invoke-static {v0}, Laxcn;->b(Ljava/lang/String;)Ljava/util/concurrent/ScheduledExecutorService;
    ...
    invoke-direct/range {v0 .. v6}, Lcom/crashlytics/android/answers/AnswersEventsHandler;-><init>(Laxbm;Landroid/content/Context;Lcom/crashlytics/android/answers/AnswersFilesManagerProvider;Lcom/crashlytics/android/answers/SessionMetadataCollector;Laxeq;Ljava/util/concurrent/ScheduledExecutorService;)V
    ...
    invoke-direct/range {v6 .. v12}, Lcom/crashlytics/android/answers/SessionAnalyticsManager;-><init>(Lcom/crashlytics/android/answers/AnswersEventsHandler;Laxba;Lcom/crashlytics/android/answers/BackgroundManager;Lcom/crashlytics/android/answers/AnswersPreferenceManager;J)V
...
.method public disable()V
    ...
    .line 84
    iget-object v0, p0, Lcom/crashlytics/android/answers/SessionAnalyticsManager;->lifecycleManager:Laxba;
...
.method public setAnalyticsSettingsData(Laxfa;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p1, p2}, Lcom/crashlytics/android/answers/AnswersEventsHandler;->setAnalyticsSettingsData(Laxfa;Ljava/lang/String;)V
