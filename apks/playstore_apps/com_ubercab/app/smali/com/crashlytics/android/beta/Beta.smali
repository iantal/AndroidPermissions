...
# instance fields
.field private final deviceTokenCache:Laxbs;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Laxbs<",
            "Ljava/lang/String;",
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/crashlytics/android/beta/Beta;->deviceTokenCache:Laxbs;
...
.method private getBetaDeviceToken(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 146
    :try_start_0
    iget-object v0, p0, Lcom/crashlytics/android/beta/Beta;->deviceTokenCache:Laxbs;

    iget-object v1, p0, Lcom/crashlytics/android/beta/Beta;->deviceTokenLoader:Lcom/crashlytics/android/beta/DeviceTokenLoader;

    invoke-virtual {v0, p1, v1}, Laxbs;->a(Landroid/content/Context;Laxbu;)Ljava/lang/Object;
...
.method private getBetaSettingsData()Laxfe;
    .locals 1
    ...
    .line 161
    iget-object v0, v0, Laxft;->f:Laxfe;
...
.method private loadBuildProperties(Landroid/content/Context;)Lcom/crashlytics/android/beta/BuildProperties;
    ...
    invoke-interface {v0, v2, v3, p1}, Laxbp;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
# virtual methods
.method canCheckForUpdates(Laxfe;Lcom/crashlytics/android/beta/BuildProperties;)Z
    .locals 0

    if-eqz p1, :cond_0

    .line 137
    iget-object p1, p1, Laxfe;->a:Ljava/lang/String;
...
.method createUpdatesController(ILandroid/app/Application;)Lcom/crashlytics/android/beta/UpdatesController;
    ...
    .line 102
    invoke-virtual {p0}, Lcom/crashlytics/android/beta/Beta;->getFabric()Laxbe;

    move-result-object p1

    invoke-virtual {p1}, Laxbe;->e()Laxba;
    ...
    invoke-virtual {p2}, Laxbe;->f()Ljava/util/concurrent/ExecutorService;
    ...
    invoke-direct {v0, p1, p2}, Lcom/crashlytics/android/beta/ActivityLifecycleCheckForUpdatesController;-><init>(Laxba;Ljava/util/concurrent/ExecutorService;)V
...
.method protected doInBackground()Ljava/lang/Boolean;
    ...
    .line 63
    invoke-virtual {p0}, Lcom/crashlytics/android/beta/Beta;->getIdManager()Laxco;

    move-result-object v6

    .line 64
    invoke-virtual {v6}, Laxco;->j()Ljava/lang/String;
    ...
    .line 74
    invoke-direct {p0}, Lcom/crashlytics/android/beta/Beta;->getBetaSettingsData()Laxfe;
    ...
    .line 77
    invoke-virtual {p0, v7, v8}, Lcom/crashlytics/android/beta/Beta;->canCheckForUpdates(Laxfe;Lcom/crashlytics/android/beta/BuildProperties;)Z
    ...
    new-instance v9, Laxey;

    invoke-direct {v9, p0}, Laxey;-><init>(Laxbm;)V

    new-instance v10, Laxcw;

    invoke-direct {v10}, Laxcw;-><init>()V

    new-instance v11, Laxei;
    ...
    invoke-direct {v11, v0}, Laxei;-><init>(Laxbp;)V

    move-object v5, p0

    .line 78
    invoke-interface/range {v3 .. v11}, Lcom/crashlytics/android/beta/UpdatesController;->initialize(Landroid/content/Context;Lcom/crashlytics/android/beta/Beta;Laxco;Laxfe;Lcom/crashlytics/android/beta/BuildProperties;Laxex;Laxck;Laxeq;)V
...
.method public getDeviceIdentifiers()Ljava/util/Map;
    ...
    invoke-virtual {v0}, Laxco;->j()Ljava/lang/String;
