...
.method private doWriteToLog(JLjava/lang/String;)V
    ...
    .line 114
    iget-object v0, p0, Lcom/crashlytics/android/core/QueueFileLogStore;->logFile:Laxcr;
    ...
    .line 150
    iget-object p2, p0, Lcom/crashlytics/android/core/QueueFileLogStore;->logFile:Laxcr;

    invoke-virtual {p2, p1}, Laxcr;->a([B)V

    .line 153
    :goto_0
    iget-object p1, p0, Lcom/crashlytics/android/core/QueueFileLogStore;->logFile:Laxcr;

    invoke-virtual {p1}, Laxcr;->b()Z
...
.method private openLogFile()V
    ...
    invoke-direct {v0, v1}, Laxcr;-><init>(Ljava/io/File;)V

    iput-object v0, p0, Lcom/crashlytics/android/core/QueueFileLogStore;->logFile:Laxcr;
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public getLogAsByteString()Lcom/crashlytics/android/core/ByteString;
    ...
    .line 68
    iget-object v2, p0, Lcom/crashlytics/android/core/QueueFileLogStore;->logFile:Laxcr;

    invoke-virtual {v2}, Laxcr;->a()I
    ...
    .line 71
    :try_start_0
    iget-object v3, p0, Lcom/crashlytics/android/core/QueueFileLogStore;->logFile:Laxcr;
    ...
    invoke-virtual {v3, v4}, Laxcr;->a(Laxcu;)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
