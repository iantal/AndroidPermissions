...
.method private performUpdateCheck()V
    ...
    invoke-virtual {v0, v1}, Laxcd;->a(Landroid/content/Context;)Ljava/lang/String;

    move-result-object v0

    .line 152
    iget-object v1, p0, Lcom/crashlytics/android/beta/AbstractCheckForUpdatesController;->idManager:Laxco;

    invoke-virtual {v1}, Laxco;->i()Ljava/util/Map;

    move-result-object v1

    sget-object v2, Laxcp;->c:Laxcp;
    ...
    iget-object v2, p0, Lcom/crashlytics/android/beta/AbstractCheckForUpdatesController;->betaSettings:Laxfe;

    iget-object v5, v2, Laxfe;->a:Ljava/lang/String;

    iget-object v6, p0, Lcom/crashlytics/android/beta/AbstractCheckForUpdatesController;->httpRequestFactory:Laxeq;
    ...
    invoke-direct/range {v2 .. v7}, Lcom/crashlytics/android/beta/CheckForUpdatesRequest;-><init>(Laxbm;Ljava/lang/String;Ljava/lang/String;Laxeq;Lcom/crashlytics/android/beta/CheckForUpdatesResponseTransform;)V
...
.method protected checkForUpdates()V
    ...
    .line 118
    iget-object v0, p0, Lcom/crashlytics/android/beta/AbstractCheckForUpdatesController;->preferenceStore:Laxex;

    monitor-enter v0

    .line 119
    :try_start_0
    iget-object v1, p0, Lcom/crashlytics/android/beta/AbstractCheckForUpdatesController;->preferenceStore:Laxex;
    ...
    iget-object v2, p0, Lcom/crashlytics/android/beta/AbstractCheckForUpdatesController;->preferenceStore:Laxex;

    invoke-interface {v2}, Laxex;->b()Landroid/content/SharedPreferences$Editor;
    ...
    invoke-interface {v1, v2}, Laxex;->a(Landroid/content/SharedPreferences$Editor;)Z
    ...
    .line 124
    iget-object v0, p0, Lcom/crashlytics/android/beta/AbstractCheckForUpdatesController;->currentTimeProvider:Laxck;

    invoke-interface {v0}, Laxck;->a()J
    ...
    invoke-interface {v2, v3, v6}, Laxbp;->a(Ljava/lang/String;Ljava/lang/String;)V
...
.method public initialize(Landroid/content/Context;Lcom/crashlytics/android/beta/Beta;Laxco;Laxfe;Lcom/crashlytics/android/beta/BuildProperties;Laxex;Laxck;Laxeq;)V
    .locals 0
    ...
    .line 83
    iput-object p3, p0, Lcom/crashlytics/android/beta/AbstractCheckForUpdatesController;->idManager:Laxco;

    .line 84
    iput-object p4, p0, Lcom/crashlytics/android/beta/AbstractCheckForUpdatesController;->betaSettings:Laxfe;
    ...
    .line 86
    iput-object p6, p0, Lcom/crashlytics/android/beta/AbstractCheckForUpdatesController;->preferenceStore:Laxex;

    .line 87
    iput-object p7, p0, Lcom/crashlytics/android/beta/AbstractCheckForUpdatesController;->currentTimeProvider:Laxck;

    .line 88
    iput-object p8, p0, Lcom/crashlytics/android/beta/AbstractCheckForUpdatesController;->httpRequestFactory:Laxeq;
