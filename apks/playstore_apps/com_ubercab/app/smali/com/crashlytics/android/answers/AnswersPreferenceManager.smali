...
# instance fields
.field private final prefStore:Laxex;


# direct methods
.method constructor <init>(Laxex;)V
    .locals 0
    ...
    .line 38
    iput-object p1, p0, Lcom/crashlytics/android/answers/AnswersPreferenceManager;->prefStore:Laxex;
...
.method public static build(Landroid/content/Context;)Lcom/crashlytics/android/answers/AnswersPreferenceManager;
    ...
    invoke-direct {v0, p0, v1}, Laxey;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    .line 34
    new-instance p0, Lcom/crashlytics/android/answers/AnswersPreferenceManager;

    invoke-direct {p0, v0}, Lcom/crashlytics/android/answers/AnswersPreferenceManager;-><init>(Laxex;)V
...
.method public hasAnalyticsLaunched()Z
    ...
    .line 48
    iget-object v0, p0, Lcom/crashlytics/android/answers/AnswersPreferenceManager;->prefStore:Laxex;
...
.method public setAnalyticsLaunched()V
    ...
    iget-object v1, p0, Lcom/crashlytics/android/answers/AnswersPreferenceManager;->prefStore:Laxex;
    ...
    invoke-interface {v0, v1}, Laxex;->a(Landroid/content/SharedPreferences$Editor;)Z
