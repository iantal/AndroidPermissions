...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {p1, p2}, Lrn;-><init>(I)V

    iput-object p1, p0, Landroid/support/design/internal/BottomNavigationMenuView;->g:Lrl;
    ...
    .line 76
    sget v1, Lce;->design_bottom_navigation_item_max_width:I
    ...
    .line 78
    sget v1, Lce;->design_bottom_navigation_item_min_width:I
    ...
    .line 80
    sget v1, Lce;->design_bottom_navigation_active_item_max_width:I
    ...
    .line 82
    sget v1, Lce;->design_bottom_navigation_height:I
    ...
    iput-object v0, p0, Landroid/support/design/internal/BottomNavigationMenuView;->a:Lim;

    .line 85
    iget-object v0, p0, Landroid/support/design/internal/BottomNavigationMenuView;->a:Lim;

    invoke-virtual {v0, p1}, Lim;->a(I)Lim;

    .line 86
    iget-object p1, p0, Landroid/support/design/internal/BottomNavigationMenuView;->a:Lim;

    const-wide/16 v0, 0x73

    invoke-virtual {p1, v0, v1}, Lim;->c(J)Lim;
    ...
    invoke-virtual {p1, v0}, Lim;->b(Landroid/animation/TimeInterpolator;)Lim;
    ...
    invoke-virtual {p1, v0}, Lim;->b(Lie;)Lim;
...
.method static synthetic b(Landroid/support/design/internal/BottomNavigationMenuView;)Labg;
    .locals 0

    .line 45
    iget-object p0, p0, Landroid/support/design/internal/BottomNavigationMenuView;->q:Labg;

    return-object p0
.end method

.method private d()Landroid/support/design/internal/BottomNavigationItemView;
    .locals 2

    .line 320
    iget-object v0, p0, Landroid/support/design/internal/BottomNavigationMenuView;->g:Lrl;
...
.method public a()V
    ...
    .line 260
    iget-object v5, p0, Landroid/support/design/internal/BottomNavigationMenuView;->g:Lrl;

    invoke-interface {v5, v4}, Lrl;->a(Ljava/lang/Object;)Z
    ...
    .line 263
    :cond_0
    iget-object v0, p0, Landroid/support/design/internal/BottomNavigationMenuView;->q:Labg;

    invoke-virtual {v0}, Labg;->size()I
    ...
    .line 271
    :goto_2
    iget-object v2, p0, Landroid/support/design/internal/BottomNavigationMenuView;->q:Labg;

    invoke-virtual {v2}, Labg;->size()I
    ...
    invoke-virtual {v2, v0}, Labg;->getItem(I)Landroid/view/MenuItem;
    ...
    .line 275
    invoke-direct {p0}, Landroid/support/design/internal/BottomNavigationMenuView;->d()Landroid/support/design/internal/BottomNavigationItemView;
    ...
    .line 281
    iget-object v4, p0, Landroid/support/design/internal/BottomNavigationMenuView;->q:Labg;

    invoke-virtual {v4, v0}, Labg;->getItem(I)Landroid/view/MenuItem;

    move-result-object v4

    check-cast v4, Labk;

    invoke-virtual {v2, v4, v1}, Landroid/support/design/internal/BottomNavigationItemView;->a(Labk;I)V
    ...
    invoke-virtual {v0, v1}, Labg;->getItem(I)Landroid/view/MenuItem;
...
.method public a(Labg;)V
    ...
    .line 105
    iput-object p1, p0, Landroid/support/design/internal/BottomNavigationMenuView;->q:Labg;
...
.method public a(Landroid/support/design/internal/BottomNavigationPresenter;)V
    .locals 0
...
.method public b()V
    ...
    invoke-virtual {v4, v3}, Labg;->getItem(I)Landroid/view/MenuItem;
    ...
    .line 308
    iget-object v1, p0, Landroid/support/design/internal/BottomNavigationMenuView;->a:Lim;

    invoke-static {p0, v1}, Lij;->a(Landroid/view/ViewGroup;Lie;)V
    ...
    invoke-virtual {v4, v1}, Labg;->getItem(I)Landroid/view/MenuItem;

    move-result-object v4

    check-cast v4, Labk;

    invoke-virtual {v3, v4, v2}, Landroid/support/design/internal/BottomNavigationItemView;->a(Labk;I)V
