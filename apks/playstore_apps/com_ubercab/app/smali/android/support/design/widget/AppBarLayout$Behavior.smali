...
.field private mOnDragCallback:Ldn;
...
.method private animateOffsetWithDuration(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;II)V
    ...
    sget-object v2, Ldm;->e:Landroid/view/animation/Interpolator;
...
.method private interpolateOffset(Landroid/support/design/widget/AppBarLayout;I)I
    ...
    .line 1184
    :cond_0
    invoke-static {v4}, Ltb;->r(Landroid/view/View;)Z
...
.method private shouldJumpElevationState(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;)Z
    ...
    .line 1245
    invoke-virtual {p1, p2}, Landroid/support/design/widget/CoordinatorLayout;->f_(Landroid/view/View;)Ljava/util/List;
...
.method private snapToChildIfNeeded(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;)V
    ...
    .line 966
    invoke-virtual {p2}, Landroid/support/design/widget/AppBarLayout;->k()I
    ...
    .line 971
    invoke-static {v2}, Ltb;->k(Landroid/view/View;)I
    ...
    invoke-static {v4, v0, v1}, Lop;->a(III)I
...
.method private updateAppBarLayoutDrawableState(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;IIZ)V
    ...
    :cond_1
    :goto_1
    invoke-virtual {p2, v3}, Landroid/support/design/widget/AppBarLayout;->b(Z)Z
...
.method canDragView(Landroid/support/design/widget/AppBarLayout;)Z
    ...
    .line 1077
    iget-object v0, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->mOnDragCallback:Ldn;
    ...
    invoke-virtual {v0, p1}, Ldn;->a(Landroid/support/design/widget/AppBarLayout;)Z
...
.method public onLayoutChild(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;I)Z
    ...
    :cond_6
    :goto_2
    invoke-virtual {p2}, Landroid/support/design/widget/AppBarLayout;->j()V
    ...
    invoke-static {v0, v1, v2}, Lop;->a(III)I
...
.method public setDragCallback(Ldn;)V
    .locals 0

    .line 893
    iput-object p1, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->mOnDragCallback:Ldn;
...
.method setHeaderTopBottomOffset(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;III)I
    ...
    .line 1119
    invoke-static {p3, p4, p5}, Lop;->a(III)I
    ...
    .line 1121
    invoke-virtual {p2}, Landroid/support/design/widget/AppBarLayout;->V_()Z
    ...
    .line 1137
    invoke-virtual {p1, p2}, Landroid/support/design/widget/CoordinatorLayout;->d_(Landroid/view/View;)V
