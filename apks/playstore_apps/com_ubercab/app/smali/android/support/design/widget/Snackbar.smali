...
# direct methods
.method private constructor <init>(Landroid/view/ViewGroup;Landroid/view/View;Ldq;)V
    .locals 0

    .line 112
    invoke-direct {p0, p1, p2, p3}, Landroid/support/design/widget/BaseTransientBottomBar;-><init>(Landroid/view/ViewGroup;Landroid/view/View;Ldq;)V
...
.method public static a(Landroid/view/View;Ljava/lang/CharSequence;I)Landroid/support/design/widget/Snackbar;
    ...
    .line 142
    sget v1, Lci;->design_layout_snackbar_include:I
    ...
    invoke-direct {v1, p0, v0, v0}, Landroid/support/design/widget/Snackbar;-><init>(Landroid/view/ViewGroup;Landroid/view/View;Ldq;)V
...
.method public a(Ley;)Landroid/support/design/widget/Snackbar;
    .locals 1
    .annotation runtime Ljava/lang/Deprecated;
    .end annotation

    .line 305
    iget-object v0, p0, Landroid/support/design/widget/Snackbar;->d:Ldp;
    ...
    invoke-virtual {p0, v0}, Landroid/support/design/widget/Snackbar;->b(Ldp;)Landroid/support/design/widget/BaseTransientBottomBar;

    :cond_0
    if-eqz p1, :cond_1

    .line 309
    invoke-virtual {p0, p1}, Landroid/support/design/widget/Snackbar;->a(Ldp;)Landroid/support/design/widget/BaseTransientBottomBar;

    .line 313
    :cond_1
    iput-object p1, p0, Landroid/support/design/widget/Snackbar;->d:Ldp;
...
.method public a(Ljava/lang/CharSequence;)Landroid/support/design/widget/Snackbar;
    ...
    .line 208
    iget-object v0, p0, Landroid/support/design/widget/Snackbar;->b:Ldt;

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, Ldt;->getChildAt(I)Landroid/view/View;
    ...
    .line 209
    invoke-virtual {v0}, Landroid/support/design/internal/SnackbarContentLayout;->a()Landroid/widget/TextView;
...
.method public a(Ljava/lang/CharSequence;Landroid/view/View$OnClickListener;)Landroid/support/design/widget/Snackbar;
    ...
    .line 244
    invoke-virtual {v0}, Landroid/support/design/internal/SnackbarContentLayout;->b()Landroid/widget/Button;
