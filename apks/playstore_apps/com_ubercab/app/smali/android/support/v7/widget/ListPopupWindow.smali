...
.field private final D:Lafi;

.field private final E:Lafh;

.field private final F:Laff;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 217
    sget v0, Lzb;->listPopupWindowStyle:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    invoke-direct {v2, p0}, Lafj;-><init>(Landroid/support/v7/widget/ListPopupWindow;)V

    iput-object v2, p0, Landroid/support/v7/widget/ListPopupWindow;->e:Lafj;

    .line 136
    new-instance v2, Lafi;

    invoke-direct {v2, p0}, Lafi;-><init>(Landroid/support/v7/widget/ListPopupWindow;)V

    iput-object v2, p0, Landroid/support/v7/widget/ListPopupWindow;->D:Lafi;

    .line 137
    new-instance v2, Lafh;

    invoke-direct {v2, p0}, Lafh;-><init>(Landroid/support/v7/widget/ListPopupWindow;)V

    iput-object v2, p0, Landroid/support/v7/widget/ListPopupWindow;->E:Lafh;

    .line 138
    new-instance v2, Laff;

    invoke-direct {v2, p0}, Laff;-><init>(Landroid/support/v7/widget/ListPopupWindow;)V

    iput-object v2, p0, Landroid/support/v7/widget/ListPopupWindow;->F:Laff;
    ...
    .line 258
    sget-object v2, Lzk;->ListPopupWindow:[I
    ...
    .line 260
    sget v3, Lzk;->ListPopupWindow_android_dropDownHorizontalOffset:I
    ...
    .line 262
    sget v3, Lzk;->ListPopupWindow_android_dropDownVerticalOffset:I
    ...
    invoke-direct {v1, p1, p2, p3, p4}, Ladn;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
...
.method private b()I
    ...
    .line 1137
    iget-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->c:Lael;
    ...
    invoke-virtual {p0, v0, v5}, Landroid/support/v7/widget/ListPopupWindow;->a(Landroid/content/Context;Z)Lael;

    move-result-object v5

    iput-object v5, p0, Landroid/support/v7/widget/ListPopupWindow;->c:Lael;
    ...
    .line 1159
    iget-object v5, p0, Landroid/support/v7/widget/ListPopupWindow;->c:Lael;

    iget-object v6, p0, Landroid/support/v7/widget/ListPopupWindow;->A:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v5, v6}, Lael;->setSelector(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v5, v6}, Lael;->setAdapter(Landroid/widget/ListAdapter;)V
    ...
    invoke-virtual {v5, v6}, Lael;->setOnItemClickListener(Landroid/widget/AdapterView$OnItemClickListener;)V

    .line 1163
    iget-object v5, p0, Landroid/support/v7/widget/ListPopupWindow;->c:Lael;

    invoke-virtual {v5, v3}, Lael;->setFocusable(Z)V

    .line 1164
    iget-object v5, p0, Landroid/support/v7/widget/ListPopupWindow;->c:Lael;

    invoke-virtual {v5, v3}, Lael;->setFocusableInTouchMode(Z)V
    ...
    invoke-virtual {v5, v6}, Lael;->setOnItemSelectedListener(Landroid/widget/AdapterView$OnItemSelectedListener;)V

    .line 1183
    iget-object v5, p0, Landroid/support/v7/widget/ListPopupWindow;->c:Lael;

    iget-object v6, p0, Landroid/support/v7/widget/ListPopupWindow;->E:Lafh;

    invoke-virtual {v5, v6}, Lael;->setOnScrollListener(Landroid/widget/AbsListView$OnScrollListener;)V
    ...
    .line 1300
    :goto_7
    iget-object v6, p0, Landroid/support/v7/widget/ListPopupWindow;->c:Lael;
    ...
    invoke-virtual/range {v6 .. v11}, Lael;->a(IIIII)I
    ...
    .line 1303
    iget-object v2, p0, Landroid/support/v7/widget/ListPopupWindow;->c:Lael;

    invoke-virtual {v2}, Lael;->getPaddingTop()I

    move-result v2

    iget-object v3, p0, Landroid/support/v7/widget/ListPopupWindow;->c:Lael;

    .line 1304
    invoke-virtual {v3}, Lael;->getPaddingBottom()I
...
# virtual methods
.method public a(Landroid/content/Context;Z)Lael;
    .locals 1

    .line 929
    new-instance v0, Lael;

    invoke-direct {v0, p1, p2}, Lael;-><init>(Landroid/content/Context;Z)V
...
.method public a(Landroid/widget/ListAdapter;)V
    ...
    invoke-direct {v0, p0}, Lafg;-><init>(Landroid/support/v7/widget/ListPopupWindow;)V
    ...
    .line 290
    :cond_2
    iget-object p1, p0, Landroid/support/v7/widget/ListPopupWindow;->c:Lael;
    ...
    invoke-virtual {p1, v0}, Lael;->setAdapter(Landroid/widget/ListAdapter;)V
...
.method public d()V
    ...
    invoke-static {v2, v3}, Lwm;->a(Landroid/widget/PopupWindow;I)V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/ListPopupWindow;->D:Lafi;
    ...
    invoke-static {v0, v1}, Lwm;->a(Landroid/widget/PopupWindow;Z)V
    ...
    invoke-static {v0, v1, v2, v3, v4}, Lwm;->a(Landroid/widget/PopupWindow;Landroid/view/View;III)V

    .line 735
    iget-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->c:Lael;

    invoke-virtual {v0, v6}, Lael;->setSelection(I)V
    ...
    invoke-virtual {v0}, Lael;->isInTouchMode()Z
    ...
    iget-object v1, p0, Landroid/support/v7/widget/ListPopupWindow;->F:Laff;
...
.method public e()V
    ...
    .line 754
    iput-object v1, p0, Landroid/support/v7/widget/ListPopupWindow;->c:Lael;

    .line 755
    iget-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->f:Landroid/os/Handler;

    iget-object v1, p0, Landroid/support/v7/widget/ListPopupWindow;->e:Lafj;
...
.method public i(I)V
    ...
    .line 812
    invoke-virtual {v0, p1}, Lael;->setSelection(I)V

    .line 814
    invoke-virtual {v0}, Lael;->getChoiceMode()I
    ...
    .line 815
    invoke-virtual {v0, p1, v1}, Lael;->setItemChecked(IZ)V
...
.method public m()V
    ...
    .line 830
    invoke-virtual {v0}, Lael;->requestLayout()V
