...
.field private final r:Lsv;

.field private final s:Lss;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {v1, p0}, Lsv;-><init>(Landroid/view/ViewGroup;)V

    iput-object v1, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->r:Lsv;

    .line 351
    new-instance v1, Lss;

    invoke-direct {v1, p0}, Lss;-><init>(Landroid/view/View;)V

    iput-object v1, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->s:Lss;
    ...
    .line 355
    invoke-virtual {p0, v1}, Landroid/support/v4/widget/SwipeRefreshLayout;->b(F)V
...
.method private a(II)Landroid/view/animation/Animation;
    ...
    .line 494
    iget-object p1, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->e:Lve;

    const/4 p2, 0x0

    invoke-virtual {p1, p2}, Lve;->a(Landroid/view/animation/Animation$AnimationListener;)V

    .line 495
    iget-object p1, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->e:Lve;

    invoke-virtual {p1}, Lve;->clearAnimation()V

    .line 496
    iget-object p1, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->e:Lve;

    invoke-virtual {p1, v0}, Lve;->startAnimation(Landroid/view/animation/Animation;)V
...
.method private a(ILandroid/view/animation/Animation$AnimationListener;)V
    ...
    invoke-virtual {p1, p2}, Lve;->startAnimation(Landroid/view/animation/Animation;)V
...
.method private b(Landroid/view/animation/Animation$AnimationListener;)V
    ...
    .line 420
    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->e:Lve;

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, Lve;->setVisibility(I)V
    ...
    .line 425
    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->j:Lvg;

    const/16 v1, 0xff

    invoke-virtual {v0, v1}, Lvg;->setAlpha(I)V
    ...
    invoke-virtual {v0, p1}, Lve;->a(Landroid/view/animation/Animation$AnimationListener;)V
...
.method private c(F)V
    ...
    invoke-virtual {v0, v1}, Lvg;->a(Z)V
    ...
    invoke-virtual {v0}, Lve;->getVisibility()I
    ...
    invoke-virtual {v0, v4}, Lve;->setVisibility(I)V
    ...
    invoke-virtual {v0, v1}, Lve;->setScaleX(F)V

    .line 923
    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->e:Lve;

    invoke-virtual {v0, v1}, Lve;->setScaleY(F)V
    ...
    .line 930
    iget-object p1, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->j:Lvg;

    invoke-virtual {p1}, Lvg;->getAlpha()I
    ...
    .line 942
    iget-object v4, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->j:Lvg;

    invoke-static {p1, v0}, Ljava/lang/Math;->min(FF)F

    move-result p1

    invoke-virtual {v4, v6, p1}, Lvg;->a(FF)V
    ...
    invoke-virtual {p1, v0}, Lvg;->b(F)V
    ...
    invoke-virtual {p1, v2}, Lvg;->c(F)V
    ...
    invoke-virtual {p0, v8}, Landroid/support/v4/widget/SwipeRefreshLayout;->c(I)V
...
.method private c(ILandroid/view/animation/Animation$AnimationListener;)V
    ...
    invoke-virtual {p1}, Lve;->getScaleX()F
...
.method private d()V
    ...
    invoke-direct {v0, v1, v2}, Lve;-><init>(Landroid/content/Context;I)V

    iput-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->e:Lve;
    ...
    iput-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->j:Lvg;
    ...
    invoke-virtual {v0, v1}, Lvg;->a(I)V

    .line 382
    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->e:Lve;

    iget-object v1, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->j:Lvg;

    invoke-virtual {v0, v1}, Lve;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V
...
.method private d(F)V
    ...
    invoke-virtual {v0, v1, v1}, Lvg;->a(FF)V
    ...
    invoke-virtual {v0, p1}, Lvg;->a(Z)V
...
.method private d(I)V
    ...
    invoke-virtual {v0}, Lve;->getBackground()Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0, p1}, Lvg;->setAlpha(I)V
...
.method private e()V
    ...
    invoke-virtual {v0}, Lvg;->getAlpha()I
...
.method private g()V
    ...
    .line 576
    iget-object v2, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->e:Lve;
...
.method a()V
    ...
    invoke-virtual {v0}, Lve;->clearAnimation()V

    .line 200
    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->j:Lvg;

    invoke-virtual {v0}, Lvg;->stop()V
    ...
    invoke-virtual {p0, v0}, Landroid/support/v4/widget/SwipeRefreshLayout;->c(I)V
...
.method a(F)V
    ...
    invoke-virtual {v0, p1}, Lve;->setScaleX(F)V

    .line 447
    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->e:Lve;

    invoke-virtual {v0, p1}, Lve;->setScaleY(F)V
...
.method public a(I)V
    ...
    invoke-virtual {v0, p1}, Lvg;->a(I)V
    ...
    invoke-virtual {p1, v0}, Lve;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V
...
.method public a(Lxb;)V
    ...
    .line 392
    iput-object p1, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->a:Lxb;
...
.method public a(Z)V
    ...
    invoke-virtual {p0, p1}, Landroid/support/v4/widget/SwipeRefreshLayout;->c(I)V
...
.method b(F)V
    ...
    invoke-virtual {p1}, Lve;->getTop()I
...
.method public b(I)V
    ...
    invoke-virtual {v0, p1}, Lve;->setBackgroundColor(I)V
...
.method c(I)V
    ...
    invoke-virtual {v0}, Lve;->bringToFront()V

    .line 1153
    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->e:Lve;

    invoke-static {v0, p1}, Ltb;->f(Landroid/view/View;I)V
...
.method public c()Z
    ...
    .line 658
    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->L:Lxa;
    ...
    invoke-interface {v0, p0, v1}, Lxa;->a(Landroid/support/v4/widget/SwipeRefreshLayout;Landroid/view/View;)Z
    ...
    invoke-static {v0, v1}, Lwj;->b(Landroid/widget/ListView;I)Z
...
.method public dispatchNestedFling(FFZ)Z
    ...
    .line 889
    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->s:Lss;
...
.method public getNestedScrollAxes()I
    ...
    .line 799
    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->r:Lsv;
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v1, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->e:Lve;

    invoke-virtual {v1}, Lve;->getTop()I
...
.method public onLayout(ZIIII)V
    ...
    .line 612
    iget-object p2, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->e:Lve;

    invoke-virtual {p2}, Lve;->getMeasuredWidth()I

    move-result p2

    .line 613
    iget-object p3, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->e:Lve;

    invoke-virtual {p3}, Lve;->getMeasuredHeight()I

    move-result p3

    .line 614
    iget-object p4, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->e:Lve;
    ...
    invoke-virtual {p4, p5, v0, p1, p2}, Lve;->layout(IIII)V
...
.method public onMeasure(II)V
    ...
    .line 631
    invoke-virtual {p1, p2, v0}, Lve;->measure(II)V
...
.method public onNestedPreScroll(Landroid/view/View;II[I)V
    ...
    invoke-virtual {p1, v1}, Lve;->setVisibility(I)V
...
.method public onNestedScrollAccepted(Landroid/view/View;Landroid/view/View;I)V
    ...
    invoke-virtual {v0, p1, p2, p3}, Lsv;->a(Landroid/view/View;Landroid/view/View;I)V
...
.method public requestDisallowInterceptTouchEvent(Z)V
    ...
    .line 740
    invoke-static {v0}, Ltb;->w(Landroid/view/View;)Z
