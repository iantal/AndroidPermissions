...
.method public constructor <init>(Lfkb;)V
    ...
    iput-object v0, p0, Lfke;->b:Ljava/util/List;
    ...
    invoke-interface {v0}, Lfkb;->a()Ljava/lang/String;
    ...
    :goto_0
    :try_start_1
    invoke-interface {p1}, Lfkb;->b()Ljava/util/List;
    ...
    invoke-direct {v1, v0}, Lfkh;-><init>(Landroid/os/IBinder;)V
    ...
    iget-object v0, p0, Lfke;->b:Ljava/util/List;

    new-instance v2, Lfki;

    invoke-direct {v2, v1}, Lfki;-><init>(Lfkf;)V
