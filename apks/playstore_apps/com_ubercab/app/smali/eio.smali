...
.field private static final s:Ljava/lang/String; = "eio"

.field private static volatile t:Leln; = null
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Leio;->r:Ljava/lang/Object;
...
.method protected constructor <init>(Landroid/content/Context;Ljava/lang/String;Z)V
    ...
    invoke-direct {p0, p1}, Lein;-><init>(Landroid/content/Context;)V

    const/4 p1, 0x0

    iput-boolean p1, p0, Leio;->q:Z

    iput-boolean p1, p0, Leio;->x:Z

    iput-boolean p1, p0, Leio;->y:Z

    iput-object p2, p0, Leio;->w:Ljava/lang/String;

    iput-boolean p3, p0, Leio;->q:Z

    return-void
.end method

.method private static a(Leln;Landroid/view/MotionEvent;Landroid/util/DisplayMetrics;)Lemd;
    .locals 4
    ...
    invoke-virtual {p0, v0, v1}, Leln;->a(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/reflect/Method;
    ...
    invoke-direct {v0, p0}, Lemd;-><init>(Ljava/lang/String;)V
    :try_end_0
    ...
    invoke-direct {p1, p0}, Leko;-><init>(Ljava/lang/Throwable;)V
...
.method protected static declared-synchronized a(Landroid/content/Context;Z)V
    ...
    :try_start_0
    sget-boolean v1, Leio;->u:Z

    if-nez v1, :cond_0

    invoke-static {}, Lene;->a()Ljava/lang/Long;
    ...
    sput-wide v1, Leio;->v:J

    invoke-static {p0, p1}, Leio;->b(Landroid/content/Context;Z)Leln;

    move-result-object p0

    sput-object p0, Leio;->t:Leln;

    const/4 p0, 0x1

    sput-boolean p0, Leio;->u:Z
    :try_end_0
...
.method private static a(Ljava/util/List;)V
    ...
    invoke-virtual {v0}, Leln;->c()Ljava/util/concurrent/ExecutorService;
    ...
    sget-object v0, Leio;->s:Ljava/lang/String;
    ...
    invoke-static {p0}, Lene;->a(Ljava/lang/Throwable;)Ljava/lang/String;
...
.method private static b(Landroid/content/Context;Z)Leln;
    .locals 7
    ...
    sget-object v0, Leio;->r:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    sget-object v1, Leio;->t:Leln;
    ...
    invoke-static {p0, v1, v2, p1}, Leln;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Z)Leln;

    move-result-object p0

    invoke-virtual {p0}, Leln;->b()Z
    ...
    invoke-virtual {p0, p1, v1, v3}, Leln;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Class;)Z

    const-string/jumbo p1, "yzGxsS8IwfgINPYaD3TFRjRVH+0Pq4QvVGq15MBf/opCBPnlCr4QHvEcReKXEMs7"
    ...
    const-string/jumbo p1, "yATd8qneW4MlwQIx8jIN6cfiWJ28/zOw6vW7xs0IWvNvim2a85v5X4ZiVD1KK9hX"
    ...
    invoke-virtual {p0, p1, v1, v4}, Leln;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Class;)Z
    ...
    const-string/jumbo v1, "z9Ycw/7CJTzBzg6MPXNZ2oLMXcxWzT8qsF0ig0ITUxc="
    ...
    const-string/jumbo v1, "wM87KVhGHShMaqkZWTxt04VnU6kJHrMxqQyksEW6glI="
    ...
    invoke-virtual {p0, p1, v1, v2}, Leln;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Class;)Z
...
.method protected final a([Ljava/lang/StackTraceElement;)J
    ...
    invoke-virtual {v0, v1, v2}, Leln;->a(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/reflect/Method;
    ...
    invoke-direct {v1, p1}, Lekp;-><init>(Ljava/lang/String;)V

    iget-object p1, v1, Lekp;->a:Ljava/lang/Long;
    ...
    invoke-direct {v0, p1}, Leko;-><init>(Ljava/lang/Throwable;)V
...
.method protected final a(Landroid/content/Context;Landroid/view/View;Landroid/app/Activity;)Leds;
    .locals 15
    ...
    invoke-direct {v10}, Leds;-><init>()V

    iget-object v1, v0, Leio;->w:Ljava/lang/String;
    ...
    iput-object v1, v10, Leds;->b:Ljava/lang/String;

    :cond_0
    iget-boolean v1, v0, Leio;->q:Z

    move-object/from16 v2, p1

    invoke-static {v2, v1}, Leio;->b(Landroid/content/Context;Z)Leln;

    move-result-object v11

    invoke-virtual {v11}, Leln;->b()Z
    ...
    iput-object v1, v10, Leds;->k:Ljava/lang/Long;

    new-array v1, v3, [Ljava/util/concurrent/Callable;

    new-instance v3, Letu;

    invoke-direct {v3, v11, v10}, Letu;-><init>(Leln;Leds;)V
    ...
    :cond_1
    :try_start_0
    iget-object v1, v0, Leio;->a:Landroid/view/MotionEvent;

    iget-object v4, v0, Leio;->p:Landroid/util/DisplayMetrics;

    invoke-static {v11, v1, v4}, Leio;->a(Leln;Landroid/view/MotionEvent;Landroid/util/DisplayMetrics;)Lemd;

    move-result-object v1

    iget-object v4, v1, Lemd;->a:Ljava/lang/Long;

    iput-object v4, v10, Leds;->g:Ljava/lang/Long;

    iget-object v4, v1, Lemd;->b:Ljava/lang/Long;

    iput-object v4, v10, Leds;->h:Ljava/lang/Long;

    iget-object v4, v1, Lemd;->c:Ljava/lang/Long;

    iput-object v4, v10, Leds;->i:Ljava/lang/Long;

    iget-boolean v4, v0, Leio;->o:Z

    if-eqz v4, :cond_2

    iget-object v4, v1, Lemd;->d:Ljava/lang/Long;

    iput-object v4, v10, Leds;->u:Ljava/lang/Long;

    iget-object v1, v1, Lemd;->e:Ljava/lang/Long;

    iput-object v1, v10, Leds;->v:Ljava/lang/Long;
    :try_end_0
    .catch Leko; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-static {v4}, Lene;->a(Landroid/util/DisplayMetrics;)Z

    move-result v4

    if-eqz v4, :cond_5

    sget-object v4, Lfhv;->bu:Lfhk;
    ...
    iget-wide v8, v0, Leio;->j:D

    iget-object v5, v0, Leio;->p:Landroid/util/DisplayMetrics;

    invoke-static {v8, v9, v4, v5}, Lene;->a(DILandroid/util/DisplayMetrics;)J
    ...
    iput-object v5, v1, Ledu;->m:Ljava/lang/Long;

    sget-object v5, Lfhv;->bv:Lfhk;

    invoke-static {}, Lfex;->f()Lfht;

    move-result-object v8

    invoke-virtual {v8, v5}, Lfht;->a(Lfhk;)Ljava/lang/Object;
    ...
    iput-object v5, v1, Ledu;->n:Ljava/lang/Long;
    ...
    iput-object v5, v1, Ledu;->o:Ljava/lang/Long;
    ...
    iput-object v5, v1, Ledu;->r:Ljava/lang/Long;
    ...
    iput-object v5, v1, Ledu;->s:Ljava/lang/Long;

    :cond_3
    sget-object v5, Lfhv;->bw:Lfhk;
    ...
    iget-boolean v5, v0, Leio;->o:Z

    if-eqz v5, :cond_5

    iget-object v5, v0, Leio;->a:Landroid/view/MotionEvent;
    ...
    iget-object v8, v0, Leio;->a:Landroid/view/MotionEvent;
    ...
    iput-object v5, v1, Ledu;->p:Ljava/lang/Long;
    ...
    iput-object v4, v1, Ledu;->q:Ljava/lang/Long;
    ...
    invoke-virtual {p0, v5}, Lein;->b(Landroid/view/MotionEvent;)Lemd;

    move-result-object v5

    iget-object v8, v5, Lemd;->a:Ljava/lang/Long;

    iput-object v8, v1, Ledu;->a:Ljava/lang/Long;

    iget-object v8, v5, Lemd;->b:Ljava/lang/Long;

    iput-object v8, v1, Ledu;->b:Ljava/lang/Long;

    iget-object v8, v5, Lemd;->l:Ljava/lang/Long;

    iput-object v8, v1, Ledu;->t:Ljava/lang/Long;

    iget-object v8, v5, Lemd;->m:Ljava/lang/Long;

    iput-object v8, v1, Ledu;->u:Ljava/lang/Long;

    iget-object v8, v5, Lemd;->c:Ljava/lang/Long;

    iput-object v8, v1, Ledu;->h:Ljava/lang/Long;

    iget-boolean v8, v0, Leio;->o:Z

    if-eqz v8, :cond_a

    iget-object v8, v5, Lemd;->e:Ljava/lang/Long;

    iput-object v8, v1, Ledu;->c:Ljava/lang/Long;

    iget-object v8, v5, Lemd;->d:Ljava/lang/Long;

    iput-object v8, v1, Ledu;->e:Ljava/lang/Long;

    iget-object v8, v5, Lemd;->f:Ljava/lang/Long;
    ...
    iput-object v8, v1, Ledu;->g:Ljava/lang/Integer;

    iget-wide v8, v0, Leio;->d:J

    cmp-long v12, v8, v6

    if-lez v12, :cond_8

    iget-object v8, v0, Leio;->p:Landroid/util/DisplayMetrics;

    invoke-static {v8}, Lene;->a(Landroid/util/DisplayMetrics;)Z

    move-result v8

    if-eqz v8, :cond_7

    iget-wide v8, v0, Leio;->i:J

    long-to-double v8, v8

    iget-wide v12, v0, Leio;->d:J
    ...
    :goto_1
    iput-object v8, v1, Ledu;->d:Ljava/lang/Long;

    iget-wide v8, v0, Leio;->h:J
    ...
    iput-object v8, v1, Ledu;->f:Ljava/lang/Long;

    :cond_8
    iget-object v8, v5, Lemd;->i:Ljava/lang/Long;

    iput-object v8, v1, Ledu;->j:Ljava/lang/Long;

    iget-object v8, v5, Lemd;->j:Ljava/lang/Long;

    iput-object v8, v1, Ledu;->i:Ljava/lang/Long;

    iget-object v5, v5, Lemd;->k:Ljava/lang/Long;
    ...
    iput-object v5, v1, Ledu;->k:Ljava/lang/Integer;
    :try_end_1
    .catch Leko; {:try_start_1 .. :try_end_1} :catch_1

    :catch_1
    :cond_a
    iget-wide v8, v0, Leio;->g:J
    ...
    iput-object v5, v1, Ledu;->l:Ljava/lang/Long;

    :cond_b
    iput-object v1, v10, Leds;->K:Ledu;

    iget-wide v8, v0, Leio;->c:J
    ...
    iput-object v1, v10, Leds;->y:Ljava/lang/Long;
    ...
    iput-object v1, v10, Leds;->x:Ljava/lang/Long;

    :cond_d
    iget-wide v8, v0, Leio;->e:J
    ...
    iput-object v1, v10, Leds;->w:Ljava/lang/Long;

    :cond_e
    iget-wide v8, v0, Leio;->f:J

    cmp-long v1, v8, v6

    if-lez v1, :cond_f

    iget-wide v5, v0, Leio;->f:J

    invoke-static {v5, v6}, Ljava/lang/Long;->valueOf(J)Ljava/lang/Long;

    move-result-object v1

    iput-object v1, v10, Leds;->z:Ljava/lang/Long;

    :cond_f
    :try_start_2
    iget-object v1, v0, Leio;->b:Ljava/util/LinkedList;
    ...
    new-array v3, v1, [Ledu;

    iput-object v3, v10, Leds;->L:[Ledu;

    :goto_3
    if-ge v2, v1, :cond_10

    sget-object v3, Leio;->t:Leln;

    iget-object v5, v0, Leio;->b:Ljava/util/LinkedList;
    ...
    iget-object v6, v0, Leio;->p:Landroid/util/DisplayMetrics;

    invoke-static {v3, v5, v6}, Leio;->a(Leln;Landroid/view/MotionEvent;Landroid/util/DisplayMetrics;)Lemd;
    ...
    iget-object v6, v3, Lemd;->a:Ljava/lang/Long;

    iput-object v6, v5, Ledu;->a:Ljava/lang/Long;

    iget-object v3, v3, Lemd;->b:Ljava/lang/Long;

    iput-object v3, v5, Ledu;->b:Ljava/lang/Long;

    iget-object v3, v10, Leds;->L:[Ledu;

    aput-object v5, v3, v2
    :try_end_2
    .catch Leko; {:try_start_2 .. :try_end_2} :catch_2
    ...
    :catch_2
    iput-object v4, v10, Leds;->L:[Ledu;
    ...
    invoke-virtual {v11}, Leln;->c()Ljava/util/concurrent/ExecutorService;

    move-result-object v1

    if-eqz v1, :cond_13

    invoke-virtual {v11}, Leln;->n()I

    move-result v13

    new-instance v1, Letu;

    invoke-direct {v1, v11, v10}, Letu;-><init>(Leln;Leds;)V
    ...
    invoke-direct/range {v1 .. v7}, Letx;-><init>(Leln;Ljava/lang/String;Ljava/lang/String;Leds;II)V

    invoke-interface {v12, v8}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    new-instance v14, Lets;
    ...
    invoke-direct/range {v1 .. v9}, Lets;-><init>(Leln;Ljava/lang/String;Ljava/lang/String;Leds;JII)V

    invoke-interface {v12, v14}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    new-instance v8, Letr;
    ...
    invoke-direct/range {v1 .. v7}, Letr;-><init>(Leln;Ljava/lang/String;Ljava/lang/String;Leds;II)V
    ...
    invoke-direct/range {v1 .. v7}, Letw;-><init>(Leln;Ljava/lang/String;Ljava/lang/String;Leds;II)V
    ...
    invoke-direct/range {v1 .. v7}, Lety;-><init>(Leln;Ljava/lang/String;Ljava/lang/String;Leds;II)V
    ...
    const-string/jumbo v4, "z9Ycw/7CJTzBzg6MPXNZ2oLMXcxWzT8qsF0ig0ITUxc="

    const/16 v7, 0x16

    move-object v1, v8

    invoke-direct/range {v1 .. v7}, Letv;-><init>(Leln;Ljava/lang/String;Ljava/lang/String;Leds;II)V

    invoke-interface {v12, v8}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    new-instance v8, Letq;
    ...
    invoke-direct/range {v1 .. v7}, Letq;-><init>(Leln;Ljava/lang/String;Ljava/lang/String;Leds;II)V
    ...
    invoke-direct/range {v1 .. v7}, Leuf;-><init>(Leln;Ljava/lang/String;Ljava/lang/String;Leds;II)V

    invoke-interface {v12, v8}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    new-instance v8, Letm;

    const-string/jumbo v3, "yATd8qneW4MlwQIx8jIN6cfiWJ28/zOw6vW7xs0IWvNvim2a85v5X4ZiVD1KK9hX"
    ...
    invoke-direct/range {v1 .. v7}, Letm;-><init>(Leln;Ljava/lang/String;Ljava/lang/String;Leds;II)V
    ...
    const-string/jumbo v4, "wM87KVhGHShMaqkZWTxt04VnU6kJHrMxqQyksEW6glI="

    const/16 v7, 0x33

    move-object v1, v8

    invoke-direct/range {v1 .. v7}, Leuc;-><init>(Leln;Ljava/lang/String;Ljava/lang/String;Leds;II)V
    ...
    invoke-direct/range {v1 .. v8}, Leub;-><init>(Leln;Ljava/lang/String;Ljava/lang/String;Leds;II[Ljava/lang/StackTraceElement;)V
    ...
    invoke-direct/range {v1 .. v8}, Leug;-><init>(Leln;Ljava/lang/String;Ljava/lang/String;Leds;IILandroid/view/View;)V

    invoke-interface {v12, v9}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    sget-object v1, Lfhv;->br:Lfhk;
    ...
    invoke-direct/range {v1 .. v7}, Leua;-><init>(Leln;Ljava/lang/String;Ljava/lang/String;Leds;II)V

    invoke-interface {v12, v8}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    :cond_11
    sget-object v1, Lfhv;->bs:Lfhk;
    ...
    invoke-direct/range {v1 .. v9}, Letl;-><init>(Leln;Ljava/lang/String;Ljava/lang/String;Leds;IILandroid/view/View;Landroid/app/Activity;)V

    invoke-interface {v12, v14}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    :cond_12
    sget-object v1, Lfhv;->bt:Lfhk;
    ...
    invoke-direct/range {v1 .. v8}, Leud;-><init>(Leln;Ljava/lang/String;Ljava/lang/String;Leds;IILeqd;)V

    invoke-interface {v12, v9}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    :cond_13
    :goto_4
    invoke-static {v12}, Leio;->a(Ljava/util/List;)V

    return-object v10
.end method

.method protected final a(Landroid/content/Context;Lecw;)Leds;
    .locals 1

    new-instance p2, Leds;

    invoke-direct {p2}, Leds;-><init>()V

    iget-object v0, p0, Leio;->w:Ljava/lang/String;
    ...
    iput-object v0, p2, Leds;->b:Ljava/lang/String;

    :cond_0
    iget-boolean v0, p0, Leio;->q:Z

    invoke-static {p1, v0}, Leio;->b(Landroid/content/Context;Z)Leln;
    ...
    invoke-virtual {p0, p1, p2, v0}, Leio;->a(Leln;Leds;Lecw;)Ljava/util/List;

    move-result-object p1

    invoke-static {p1}, Leio;->a(Ljava/util/List;)V

    :cond_1
    return-object p2
.end method

.method protected a(Leln;Leds;Lecw;)Ljava/util/List;
    .locals 11
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p2, Leds;->k:Ljava/lang/Long;
    ...
    invoke-direct/range {v0 .. v7}, Leto;-><init>(Leln;Ljava/lang/String;Ljava/lang/String;Leds;IILecw;)V

    invoke-interface {v10, v8}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    new-instance p3, Lets;
    ...
    invoke-direct/range {v0 .. v8}, Lets;-><init>(Leln;Ljava/lang/String;Ljava/lang/String;Leds;JII)V
    ...
    invoke-direct/range {v0 .. v6}, Letx;-><init>(Leln;Ljava/lang/String;Ljava/lang/String;Leds;II)V
    ...
    invoke-direct/range {v0 .. v6}, Letz;-><init>(Leln;Ljava/lang/String;Ljava/lang/String;Leds;II)V

    invoke-interface {v10, p3}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    new-instance p3, Leue;
    ...
    invoke-direct/range {v0 .. v6}, Leue;-><init>(Leln;Ljava/lang/String;Ljava/lang/String;Leds;II)V

    invoke-interface {v10, p3}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    new-instance p3, Letn;

    const-string/jumbo v2, "yzGxsS8IwfgINPYaD3TFRjRVH+0Pq4QvVGq15MBf/opCBPnlCr4QHvEcReKXEMs7"
    ...
    invoke-direct/range {v0 .. v6}, Letn;-><init>(Leln;Ljava/lang/String;Ljava/lang/String;Leds;II)V

    invoke-interface {v10, p3}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    new-instance p3, Letq;
    ...
    invoke-direct/range {v0 .. v6}, Letq;-><init>(Leln;Ljava/lang/String;Ljava/lang/String;Leds;II)V

    invoke-interface {v10, p3}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    new-instance p3, Letw;
    ...
    invoke-direct/range {v0 .. v6}, Letw;-><init>(Leln;Ljava/lang/String;Ljava/lang/String;Leds;II)V
    ...
    invoke-direct/range {v0 .. v6}, Lety;-><init>(Leln;Ljava/lang/String;Ljava/lang/String;Leds;II)V

    invoke-interface {v10, p3}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    new-instance p3, Letr;
    ...
    invoke-direct/range {v0 .. v6}, Letr;-><init>(Leln;Ljava/lang/String;Ljava/lang/String;Leds;II)V

    invoke-interface {v10, p3}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    new-instance p3, Letv;

    const-string v2, "BiRNVQ0aQHyQJTXKNLbpSFJJy6+rG5ICwTiWxRhS6qdZjM6S9BBOaVfdO1b0Kd8E"

    const-string/jumbo v3, "z9Ycw/7CJTzBzg6MPXNZ2oLMXcxWzT8qsF0ig0ITUxc="

    const/16 v6, 0x16

    move-object v0, p3

    invoke-direct/range {v0 .. v6}, Letv;-><init>(Leln;Ljava/lang/String;Ljava/lang/String;Leds;II)V

    invoke-interface {v10, p3}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    new-instance p3, Leuf;
    ...
    invoke-direct/range {v0 .. v6}, Leuf;-><init>(Leln;Ljava/lang/String;Ljava/lang/String;Leds;II)V

    invoke-interface {v10, p3}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    new-instance p3, Letm;

    const-string/jumbo v2, "yATd8qneW4MlwQIx8jIN6cfiWJ28/zOw6vW7xs0IWvNvim2a85v5X4ZiVD1KK9hX"
    ...
    invoke-direct/range {v0 .. v6}, Letm;-><init>(Leln;Ljava/lang/String;Ljava/lang/String;Leds;II)V
    ...
    const-string/jumbo v3, "wM87KVhGHShMaqkZWTxt04VnU6kJHrMxqQyksEW6glI="

    const/16 v6, 0x33

    move-object v0, p3

    invoke-direct/range {v0 .. v6}, Leuc;-><init>(Leln;Ljava/lang/String;Ljava/lang/String;Leds;II)V

    invoke-interface {v10, p3}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    sget-object p3, Lfhv;->br:Lfhk;

    invoke-static {}, Lfex;->f()Lfht;

    move-result-object v0

    invoke-virtual {v0, p3}, Lfht;->a(Lfhk;)Ljava/lang/Object;
    ...
    invoke-direct/range {v0 .. v6}, Leua;-><init>(Leln;Ljava/lang/String;Ljava/lang/String;Leds;II)V
...
.method public final a(Landroid/view/View;)V
    ...
    invoke-direct {v0, v1, p1}, Leqd;-><init>(Leln;Landroid/view/View;)V

    iput-object v0, p0, Leio;->z:Leqd;
    ...
    invoke-virtual {v0, p1}, Leqd;->a(Landroid/view/View;)V

    return-void
.end method

.method protected final b(Landroid/view/MotionEvent;)Lemd;
    .locals 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Leko;
    ...
    iget-object v4, p0, Leio;->p:Landroid/util/DisplayMetrics;
