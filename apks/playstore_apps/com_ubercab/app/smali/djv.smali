...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ldjv;->zzfln:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    sput-object v0, Ldjv;->zzflo:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static getErrorPendingIntent(ILandroid/content/Context;I)Landroid/app/PendingIntent;
    ...
    invoke-virtual {v0, p1, p0, p2}, Ldjm;->a(Landroid/content/Context;II)Landroid/app/PendingIntent;
...
.method public static isGooglePlayServicesAvailable(Landroid/content/Context;)I
    ...
    sget v2, Lcnh;->common_google_play_services_unknown_issue:I
    ...
    sget-object v1, Ldjv;->zzflo:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-static {p0}, Ldhe;->a(Landroid/content/Context;)I

    move-result v1

    if-eqz v1, :cond_1

    sget v2, Ldjv;->GOOGLE_PLAY_SERVICES_VERSION_CODE:I
    ...
    sget v0, Ldjv;->GOOGLE_PLAY_SERVICES_VERSION_CODE:I
    ...
    :cond_2
    :goto_1
    invoke-static {p0}, Ldiz;->b(Landroid/content/Context;)Z
    ...
    invoke-static {p0}, Ldiz;->d(Landroid/content/Context;)Z
    ...
    invoke-static {p0}, Ldjw;->a(Landroid/content/Context;)Ldjw;

    if-eqz v1, :cond_6

    sget-object p0, Ldjr;->a:[Ldjo;

    invoke-static {v4, p0}, Ldjw;->a(Landroid/content/pm/PackageInfo;[Ldjo;)Ldjo;
    ...
    :cond_5
    new-array v1, v2, [Ldjo;

    aput-object p0, v1, v3

    invoke-static {v6, v1}, Ldjw;->a(Landroid/content/pm/PackageInfo;[Ldjo;)Ldjo;
    ...
    invoke-static {v6, p0}, Ldjw;->a(Landroid/content/pm/PackageInfo;[Ldjo;)Ldjo;
    ...
    :cond_7
    sget p0, Ldjv;->GOOGLE_PLAY_SERVICES_VERSION_CODE:I
...
.method public static zzb(Landroid/content/Context;ILjava/lang/String;)Z
    ...
    invoke-static {p0, p1, p2}, Ldji;->a(Landroid/content/Context;ILjava/lang/String;)Z
...
.method public static zzbp(Landroid/content/Context;)V
    ...
    invoke-virtual {v0, p0}, Ldjm;->a(Landroid/content/Context;)I
    ...
    invoke-static {p0, v0, v1}, Ldjm;->a(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;
    ...
    invoke-direct {v1, v0, v2, p0}, Lczk;-><init>(ILjava/lang/String;Landroid/content/Intent;)V
...
.method public static zzce(Landroid/content/Context;)V
    ...
    sget-object v0, Ldjv;->zzfln:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static zzch(Landroid/content/Context;)Z
    ...
    invoke-virtual {v0, v3, v4}, Lefm;->b(Ljava/lang/String;I)Landroid/content/pm/PackageInfo;
    ...
    new-array p0, v2, [Ldjo;

    sget-object v3, Ldjr;->a:[Ldjo;

    aget-object v3, v3, v2

    aput-object v3, p0, v1

    invoke-static {v0, p0}, Ldjw;->a(Landroid/content/pm/PackageInfo;[Ldjo;)Ldjo;

    move-result-object p0

    if-eqz p0, :cond_0

    sput-boolean v2, Ldjv;->zzfll:Z

    goto :goto_0

    :cond_0
    sput-boolean v1, Ldjv;->zzfll:Z
    :try_end_0
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static zze(Landroid/content/Context;I)Z
    ...
    invoke-static {p0, p1}, Ldjv;->zzv(Landroid/content/Context;Ljava/lang/String;)Z
...
.method public static zzf(Landroid/content/Context;I)Z
    ...
    invoke-static {p0, p1}, Ldji;->a(Landroid/content/Context;I)Z
...
.method protected static zzv(Landroid/content/Context;Ljava/lang/String;)Z
    .locals 5
    .annotation build Landroid/annotation/TargetApi;
        value = 0x15
    .end annotation
