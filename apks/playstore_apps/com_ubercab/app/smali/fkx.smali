...
.method public constructor <init>(Lfku;)V
    ...
    iput-object v0, p0, Lfkx;->d:Lcnr;

    iput-object p1, p0, Lfkx;->a:Lfku;

    const/4 p1, 0x0

    :try_start_0
    iget-object v0, p0, Lfkx;->a:Lfku;

    invoke-interface {v0}, Lfku;->b()Ljava/util/List;
    ...
    invoke-interface {v0}, Lfku;->d()Lfkf;
    ...
    :goto_2
    iput-object v1, p0, Lfkx;->c:Lfki;

    :try_start_2
    iget-object v0, p0, Lfkx;->a:Lfku;

    invoke-interface {v0}, Lfku;->r()Lfkb;
    ...
    iget-object v1, p0, Lfkx;->a:Lfku;

    invoke-interface {v1}, Lfku;->r()Lfkb;
    ...
    :cond_5
    :goto_3
    iput-object p1, p0, Lfkx;->e:Lcnz;

    return-void
.end method

.method private final k()Ldjx;
    .locals 2

    :try_start_0
    iget-object v0, p0, Lfkx;->a:Lfku;

    invoke-interface {v0}, Lfku;->j()Ldjx;
...
.method public final b()Ljava/lang/CharSequence;
    ...
    invoke-interface {v0}, Lfku;->a()Ljava/lang/String;
...
.method public final d()Ljava/lang/CharSequence;
    ...
    invoke-interface {v0}, Lfku;->c()Ljava/lang/String;
...
.method public final f()Ljava/lang/CharSequence;
    ...
    invoke-interface {v0}, Lfku;->e()Ljava/lang/String;
...
.method public final g()Ljava/lang/Double;
    ...
    invoke-static {v2, v1}, Ldwq;->b(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public final h()Ljava/lang/CharSequence;
    ...
    invoke-interface {v0}, Lfku;->g()Ljava/lang/String;
...
.method public final i()Ljava/lang/CharSequence;
    ...
    invoke-interface {v0}, Lfku;->h()Ljava/lang/String;
...
.method public final j()Lcnr;
    .locals 2

    :try_start_0
    iget-object v0, p0, Lfkx;->a:Lfku;

    invoke-interface {v0}, Lfku;->i()Lfgi;

    move-result-object v0

    if-eqz v0, :cond_0

    iget-object v0, p0, Lfkx;->d:Lcnr;

    iget-object v1, p0, Lfkx;->a:Lfku;

    invoke-interface {v1}, Lfku;->i()Lfgi;
