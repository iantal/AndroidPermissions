...
.method private static a(Landroid/content/Context;Landroid/content/Intent;Lcrz;)Z
    .locals 3
    ...
    invoke-static {p0, p1}, Ldtz;->a(Landroid/content/Context;Landroid/content/Intent;)V

    if-eqz p2, :cond_1

    invoke-interface {p2}, Lcrz;->g()V
    :try_end_0
...
.method public static a(Landroid/content/Context;Lcom/google/android/gms/ads/internal/overlay/zzc;Lcrz;)Z
    .locals 6
    ...
    invoke-static {p0, p1, p2}, Lcrk;->a(Landroid/content/Context;Landroid/content/Intent;Lcrz;)Z
    ...
    invoke-static {p0, v1}, Ldtz;->b(Landroid/content/Context;Landroid/content/Intent;)V

    :cond_a
    :goto_4
    invoke-static {p0, v1, p2}, Lcrk;->a(Landroid/content/Context;Landroid/content/Intent;Lcrz;)Z
