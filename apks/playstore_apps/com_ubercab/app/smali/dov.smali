...
.method public constructor <init>(Lcom/google/android/gms/internal/zzaat;Ljava/lang/String;)V
    ...
    iput-wide v0, p0, Ldov;->i:J

    const/4 v2, 0x0

    iput-boolean v2, p0, Ldov;->j:Z

    iput-wide v0, p0, Ldov;->k:J

    iput-wide v0, p0, Ldov;->m:J

    const/4 v0, -0x1

    iput v0, p0, Ldov;->n:I

    iput-boolean v2, p0, Ldov;->o:Z

    iput-boolean v2, p0, Ldov;->p:Z

    iput-boolean v2, p0, Ldov;->q:Z

    const/4 v0, 0x1

    iput-boolean v0, p0, Ldov;->r:Z

    iput-boolean v0, p0, Ldov;->s:Z

    const-string v0, ""

    iput-object v0, p0, Ldov;->t:Ljava/lang/String;

    iput-boolean v2, p0, Ldov;->u:Z

    iput-boolean v2, p0, Ldov;->v:Z

    iput-boolean v2, p0, Ldov;->z:Z

    iput-boolean v2, p0, Ldov;->B:Z

    iput-object p2, p0, Ldov;->b:Ljava/lang/String;

    iput-object p1, p0, Ldov;->J:Lcom/google/android/gms/internal/zzaat;
...
.method public final a(JZ)Lcom/google/android/gms/internal/zzaax;
    ...
    iget-object v2, v0, Ldov;->J:Lcom/google/android/gms/internal/zzaat;

    iget-object v3, v0, Ldov;->b:Ljava/lang/String;

    iget-object v4, v0, Ldov;->c:Ljava/lang/String;

    iget-object v5, v0, Ldov;->d:Ljava/util/List;

    iget-object v6, v0, Ldov;->h:Ljava/util/List;

    iget-wide v7, v0, Ldov;->i:J

    iget-boolean v9, v0, Ldov;->j:Z

    iget-object v12, v0, Ldov;->l:Ljava/util/List;

    iget-wide v13, v0, Ldov;->m:J

    iget v15, v0, Ldov;->n:I

    iget-object v1, v0, Ldov;->a:Ljava/lang/String;

    iget-object v10, v0, Ldov;->f:Ljava/lang/String;

    iget-object v11, v0, Ldov;->g:Ljava/lang/String;

    move-object/from16 v46, v10

    iget-boolean v10, v0, Ldov;->o:Z

    move/from16 v47, v10

    iget-boolean v10, v0, Ldov;->p:Z

    move/from16 v48, v10

    iget-boolean v10, v0, Ldov;->q:Z

    move/from16 v49, v10

    iget-boolean v10, v0, Ldov;->r:Z

    move/from16 v50, v10

    iget-object v10, v0, Ldov;->t:Ljava/lang/String;

    move-object/from16 v51, v10

    iget-boolean v10, v0, Ldov;->u:Z

    move/from16 v52, v10

    iget-boolean v10, v0, Ldov;->v:Z

    move/from16 v53, v10

    iget-object v10, v0, Ldov;->w:Lcom/google/android/gms/internal/zzaeq;

    move-object/from16 v54, v10

    iget-object v10, v0, Ldov;->x:Ljava/util/List;

    move-object/from16 v55, v10

    iget-object v10, v0, Ldov;->y:Ljava/util/List;

    move-object/from16 v56, v10

    iget-boolean v10, v0, Ldov;->z:Z

    move/from16 v57, v10

    iget-object v10, v0, Ldov;->A:Lcom/google/android/gms/internal/zzaaz;

    move-object/from16 v58, v10

    iget-boolean v10, v0, Ldov;->B:Z

    move/from16 v59, v10

    iget-object v10, v0, Ldov;->C:Ljava/lang/String;

    move-object/from16 v60, v10

    iget-object v10, v0, Ldov;->D:Ljava/util/List;

    move-object/from16 v61, v10

    iget-boolean v10, v0, Ldov;->E:Z
    ...
    iget-object v10, v0, Ldov;->G:Lcom/google/android/gms/internal/zzaey;

    move-object/from16 v64, v10

    iget-object v10, v0, Ldov;->e:Ljava/lang/String;

    move-object/from16 v65, v10

    iget-boolean v10, v0, Ldov;->s:Z

    move/from16 v66, v10

    iget-boolean v10, v0, Ldov;->H:Z

    move/from16 v67, v10

    iget-boolean v10, v0, Ldov;->I:Z
...
.method public final a(Ljava/lang/String;Ljava/util/Map;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p2}, Ldov;->a(Ljava/util/Map;)V
...
.method public final a(Ljava/util/Map;)V
    ...
    invoke-static {p1, v0}, Ldov;->a(Ljava/util/Map;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    iput-object v0, p0, Ldov;->a:Ljava/lang/String;
    ...
    invoke-static {p1, v0}, Ldov;->c(Ljava/util/Map;Ljava/lang/String;)Ljava/util/List;
    ...
    iput-object v0, p0, Ldov;->h:Ljava/util/List;

    :cond_2
    const-string v0, "X-Afma-Interstitial-Timeout"

    invoke-static {p1, v0}, Ldov;->b(Ljava/util/Map;Ljava/lang/String;)J
    ...
    invoke-static {p1, v2}, Ldov;->d(Ljava/util/Map;Ljava/lang/String;)Z

    move-result v2

    or-int/2addr v0, v2

    iput-boolean v0, p0, Ldov;->j:Z
    ...
    iput-object v0, p0, Ldov;->l:Ljava/util/List;
    ...
    iput-boolean v0, p0, Ldov;->q:Z

    :cond_8
    iget-boolean v0, p0, Ldov;->o:Z
    ...
    iput-object v0, p0, Ldov;->w:Lcom/google/android/gms/internal/zzaeq;

    iget-object v0, p0, Ldov;->x:Ljava/util/List;
    ...
    iput-object v0, p0, Ldov;->x:Ljava/util/List;

    :cond_d
    iget-object v0, p0, Ldov;->y:Ljava/util/List;
    ...
    iput-object v0, p0, Ldov;->y:Ljava/util/List;

    :cond_e
    iget-boolean v0, p0, Ldov;->z:Z

    const-string v3, "X-Afma-Use-Displayed-Impression"

    invoke-static {p1, v3}, Ldov;->d(Ljava/util/Map;Ljava/lang/String;)Z

    move-result v3

    or-int/2addr v0, v3

    iput-boolean v0, p0, Ldov;->z:Z

    iget-boolean v0, p0, Ldov;->B:Z
    ...
    iput-object v0, p0, Ldov;->A:Lcom/google/android/gms/internal/zzaaz;
    :try_end_0
    ...
    iget-object v3, p0, Ldov;->f:Ljava/lang/String;
    ...
    iget-object v4, p0, Ldov;->f:Ljava/lang/String;
    ...
    iput-object v3, p0, Ldov;->A:Lcom/google/android/gms/internal/zzaaz;
    ...
    iput-object v0, p0, Ldov;->G:Lcom/google/android/gms/internal/zzaey;
    :try_end_1
    ...
    :cond_13
    :goto_4
    iget-boolean v0, p0, Ldov;->E:Z

    const-string v1, "X-Afma-Render-In-Browser"

    invoke-static {p1, v1}, Ldov;->d(Ljava/util/Map;Ljava/lang/String;)Z

    move-result v1

    or-int/2addr v0, v1

    iput-boolean v0, p0, Ldov;->E:Z
    ...
    invoke-static {p1, v0}, Ldov;->d(Ljava/util/Map;Ljava/lang/String;)Z

    move-result p1

    iput-boolean p1, p0, Ldov;->I:Z
