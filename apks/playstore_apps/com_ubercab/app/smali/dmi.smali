...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Ldmi;->h:Ljava/util/Map;

    iput-object p1, p0, Ldmi;->g:Landroid/content/Context;
...
.method public static a(Landroid/content/Context;)Ljava/lang/String;
    ...
    sget-object p0, Ldmi;->a:Ljava/lang/String;
    ...
    invoke-static {p0, v2, v3}, Ldmi;->a(Landroid/content/pm/PackageManager;Ljava/lang/String;Ljava/lang/String;)Z

    move-result v2

    if-eqz v2, :cond_1

    sput-boolean v1, Ldmi;->b:Z
    ...
    :cond_3
    invoke-static {p0}, Ldmi;->a(Landroid/content/pm/PackageManager;)Z
    ...
    invoke-static {p0, v0}, Ldmi;->a(Landroid/content/pm/PackageManager;Ljava/lang/String;)Z
...
.method private static varargs a(Ljava/security/KeyPair;[Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0}, Ldlx;->a([B)Ljava/lang/String;
...
.method private final a()V
    ...
    iget-object v0, p0, Ldmi;->i:Landroid/os/Messenger;
    ...
    :cond_0
    iget-object v0, p0, Ldmi;->g:Landroid/content/Context;

    invoke-static {v0}, Ldmi;->a(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-direct {v1, p0, v2}, Ldmj;-><init>(Ldmi;Landroid/os/Looper;)V

    invoke-direct {v0, v1}, Landroid/os/Messenger;-><init>(Landroid/os/Handler;)V

    iput-object v0, p0, Ldmi;->i:Landroid/os/Messenger;
...
.method private final a(Ljava/lang/Object;)V
    ...
    :try_start_0
    iget-object v1, p0, Ldmi;->h:Ljava/util/Map;
    ...
    iget-object v3, p0, Ldmi;->h:Ljava/util/Map;

    invoke-interface {v3, v2}, Ljava/util/Map;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v3

    iget-object v4, p0, Ldmi;->h:Ljava/util/Map;

    invoke-interface {v4, v2, p1}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    invoke-static {v3, p1}, Ldmi;->a(Ljava/lang/Object;Ljava/lang/Object;)V
...
.method private final a(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    iget-object v2, p0, Ldmi;->h:Ljava/util/Map;

    invoke-interface {v2, p1, p2}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    invoke-static {v1, p2}, Ldmi;->a(Ljava/lang/Object;Ljava/lang/Object;)V
...
.method private static a(Landroid/content/pm/PackageManager;Ljava/lang/String;)Z
    ...
    sput-object p1, Ldmi;->a:Ljava/lang/String;
...
.method private static a(Landroid/content/pm/PackageManager;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-static {p0, p1}, Ldmi;->a(Landroid/content/pm/PackageManager;Ljava/lang/String;)Z
...
.method private static b(Landroid/content/Context;)I
    ...
    :try_start_0
    invoke-static {p0}, Ldmi;->a(Landroid/content/Context;)Ljava/lang/String;
...
.method private final b(Landroid/os/Bundle;Ljava/security/KeyPair;)Landroid/content/Intent;
    ...
    invoke-static {}, Ldmi;->b()Ljava/lang/String;
    ...
    iput-wide v2, p0, Ldmi;->m:J

    new-instance v2, Landroid/content/Intent;

    sget-boolean v3, Ldmi;->b:Z
    ...
    iget-object v3, p0, Ldmi;->g:Landroid/content/Context;

    invoke-static {v3}, Ldmi;->b(Landroid/content/Context;)I
    ...
    iget-object v4, p0, Ldmi;->g:Landroid/content/Context;

    invoke-static {v4}, Ldlx;->a(Landroid/content/Context;)I
    ...
    invoke-static {v4}, Ldlx;->b(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {p2}, Ldlx;->a(Ljava/security/KeyPair;)Ljava/lang/String;
    ...
    invoke-static {v3}, Ldlx;->a([B)Ljava/lang/String;
    ...
    iget-object v7, p0, Ldmi;->g:Landroid/content/Context;
    ...
    invoke-static {p2, v5}, Ldmi;->a(Ljava/security/KeyPair;[Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {p0, v2}, Ldmi;->c(Landroid/content/Intent;)V

    invoke-static {}, Landroid/os/SystemClock;->elapsedRealtime()J

    move-result-wide p1

    iput-wide p1, p0, Ldmi;->m:J
    ...
    sget-object p2, Ldmi;->a:Ljava/lang/String;
    ...
    :cond_4
    iget-object p2, p0, Ldmi;->j:Landroid/os/Messenger;

    if-eqz p2, :cond_5

    const-string p2, "google.messenger"

    iget-object v4, p0, Ldmi;->i:Landroid/os/Messenger;
    ...
    :try_start_1
    iget-object v4, p0, Ldmi;->j:Landroid/os/Messenger;
    ...
    :try_start_2
    sget-object p1, Ldmi;->f:Landroid/content/BroadcastReceiver;

    if-nez p1, :cond_7

    new-instance p1, Ldmk;

    invoke-direct {p1, p0}, Ldmk;-><init>(Ldmi;)V

    sput-object p1, Ldmi;->f:Landroid/content/BroadcastReceiver;
    ...
    iget-object p2, p0, Ldmi;->g:Landroid/content/Context;
    ...
    sget-object v3, Ldmi;->f:Landroid/content/BroadcastReceiver;
    ...
    iget-object p2, p0, Ldmi;->i:Landroid/os/Messenger;
    ...
    iget-object p1, p0, Ldmi;->k:Lcom/google/android/gms/iid/MessengerCompat;
    ...
    :try_start_3
    iget-object p2, p0, Ldmi;->k:Lcom/google/android/gms/iid/MessengerCompat;
    ...
    :cond_9
    sget-boolean p1, Ldmi;->b:Z

    if-eqz p1, :cond_a

    :goto_2
    iget-object p1, p0, Ldmi;->g:Landroid/content/Context;
    ...
    :try_start_4
    iget-object p2, p0, Ldmi;->h:Ljava/util/Map;
...
.method private final declared-synchronized c(Landroid/content/Intent;)V
    ...
    :try_start_0
    iget-object v0, p0, Ldmi;->l:Landroid/app/PendingIntent;
    ...
    iget-object v1, p0, Ldmi;->g:Landroid/content/Context;
    ...
    iput-object v0, p0, Ldmi;->l:Landroid/app/PendingIntent;

    :cond_0
    const-string v0, "app"

    iget-object v1, p0, Ldmi;->l:Landroid/app/PendingIntent;
...
.method final a(Landroid/os/Bundle;Ljava/security/KeyPair;)Landroid/content/Intent;
    ...
    invoke-direct {p0, p1, p2}, Ldmi;->b(Landroid/os/Bundle;Ljava/security/KeyPair;)Landroid/content/Intent;
...
.method public final a(Landroid/os/Message;)V
    ...
    iput-object v1, p0, Ldmi;->k:Lcom/google/android/gms/iid/MessengerCompat;
    ...
    iput-object v0, p0, Ldmi;->j:Landroid/os/Messenger;
    ...
    invoke-virtual {p0, p1}, Ldmi;->b(Landroid/content/Intent;)V
...
.method public final b(Landroid/content/Intent;)V
    ...
    invoke-direct {p0, v1}, Ldmi;->a(Ljava/lang/Object;)V

    goto :goto_4

    :cond_e
    invoke-direct {p0, v2, v1}, Ldmi;->a(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    iput-wide v7, p0, Ldmi;->m:J

    iput-wide v4, p0, Ldmi;->q:J
    ...
    iget-object v2, p0, Ldmi;->g:Landroid/content/Context;

    invoke-static {v2}, Ldlx;->c(Landroid/content/Context;)Ldlx;

    invoke-static {}, Ldlx;->b()Ldml;

    move-result-object v2

    invoke-static {v0, v2}, Lcom/google/android/gms/iid/InstanceIDListenerService;->a(Landroid/content/Context;Ldml;)V

    const-string v0, "registration_id"

    invoke-virtual {p1, v0}, Landroid/content/Intent;->removeExtra(Ljava/lang/String;)V

    invoke-direct {p0, v1, p1}, Ldmi;->a(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-direct {p0, p1}, Ldmi;->a(Ljava/lang/Object;)V
