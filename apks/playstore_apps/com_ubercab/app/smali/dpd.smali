...
.method public constructor <init>(Landroid/content/Context;Lfoe;)V
    ...
    iput-object v0, p0, Ldpd;->a:Ljava/lang/Object;

    invoke-virtual {p1}, Landroid/content/Context;->getApplicationContext()Landroid/content/Context;

    move-result-object p1

    iput-object p1, p0, Ldpd;->b:Landroid/content/Context;

    iput-object p2, p0, Ldpd;->d:Lfoe;
...
.method public final a()Ldxj;
    ...
    :try_start_0
    iget-object v1, p0, Ldpd;->c:Landroid/content/SharedPreferences;
    ...
    :cond_0
    iget-object v1, p0, Ldpd;->b:Landroid/content/Context;
    ...
    iput-object v1, p0, Ldpd;->c:Landroid/content/SharedPreferences;
    :try_end_0
    ...
    :goto_1
    iget-object v0, p0, Ldpd;->c:Landroid/content/SharedPreferences;
    ...
    invoke-interface {v2}, Ldiw;->a()J

    move-result-wide v2

    sub-long/2addr v2, v0

    sget-object v0, Lfhv;->bH:Lfhk;
    ...
    iget-object v0, p0, Ldpd;->d:Lfoe;

    invoke-interface {v0, v1}, Lfoe;->b(Ljava/lang/Object;)Ldxj;
    ...
    sget-object v2, Ldxp;->b:Ljava/util/concurrent/Executor;

    invoke-static {v0, v1, v2}, Ldwz;->a(Ldxj;Ldwv;Ljava/util/concurrent/Executor;)Ldxj;
...
.method final synthetic a(Lorg/json/JSONObject;)Ljava/lang/Void;
    ...
    iget-object v0, p0, Ldpd;->b:Landroid/content/Context;

    const/4 v1, 0x1

    invoke-static {v0, v1, p1}, Lfhv;->a(Landroid/content/Context;ILorg/json/JSONObject;)V

    iget-object p1, p0, Ldpd;->c:Landroid/content/SharedPreferences;
