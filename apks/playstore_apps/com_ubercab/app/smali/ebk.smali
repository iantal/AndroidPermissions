...
.method public constructor <init>(Ldzy;Z)V
    ...
    invoke-direct {p0, p1, p2}, Ldzz;-><init>(Ldzy;Z)V
...
.method protected final a(Landroid/webkit/WebView;Ljava/lang/String;Ljava/util/Map;)Landroid/webkit/WebResourceResponse;
    ...
    invoke-interface {v2, p2, p3, v3}, Ldrl;->a(Ljava/lang/String;Ljava/util/Map;I)V
    ...
    invoke-super {p0, p1, p2}, Ldzz;->shouldInterceptRequest(Landroid/webkit/WebView;Ljava/lang/String;)Landroid/webkit/WebResourceResponse;
    ...
    sget-object p1, Lfhv;->F:Lfhk;

    goto :goto_0

    :cond_5
    sget-object p1, Lfhv;->E:Lfhk;
    ...
    iget-object p3, p3, Lcom/google/android/gms/internal/zzakd;->a:Ljava/lang/String;
    ...
    invoke-virtual {v3, p2, p3}, Ldtz;->a(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {p3, p2}, Ldvi;-><init>(Landroid/content/Context;)V

    invoke-virtual {p3, p1, v0}, Ldvi;->a(Ljava/lang/String;Ljava/util/Map;)Ldxj;
    ...
    invoke-interface {p1, p2, p3, v0}, Ldxj;->get(JLjava/util/concurrent/TimeUnit;)Ljava/lang/Object;
