...
.field volatile d:Lio/reactivex/disposables/CompositeDisposable;
...
.method public constructor <init>(Lio/reactivex/flowables/ConnectableFlowable;)V
    ...
    iput-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableRefCount;->d:Lio/reactivex/disposables/CompositeDisposable;
...
.method private a(Lio/reactivex/disposables/CompositeDisposable;)Lio/reactivex/disposables/Disposable;
    .locals 1
...
.method private a(Laxwi;Ljava/util/concurrent/atomic/AtomicBoolean;)Lio/reactivex/functions/Consumer;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p0, p1, p2}, Lio/reactivex/internal/operators/flowable/FlowableRefCount$DisposeConsumer;-><init>(Lio/reactivex/internal/operators/flowable/FlowableRefCount;Laxwi;Ljava/util/concurrent/atomic/AtomicBoolean;)V
...
.method public a(Laxwi;)V
    ...
    invoke-direct {p0, p1, v0}, Lio/reactivex/internal/operators/flowable/FlowableRefCount;->a(Laxwi;Ljava/util/concurrent/atomic/AtomicBoolean;)Lio/reactivex/functions/Consumer;

    move-result-object p1

    invoke-virtual {v1, p1}, Lio/reactivex/flowables/ConnectableFlowable;->b(Lio/reactivex/functions/Consumer;)V
    :try_end_0
    ...
    :cond_1
    :try_start_1
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableRefCount;->d:Lio/reactivex/disposables/CompositeDisposable;

    invoke-virtual {p0, p1, v0}, Lio/reactivex/internal/operators/flowable/FlowableRefCount;->a(Laxwi;Lio/reactivex/disposables/CompositeDisposable;)V
    :try_end_1
...
.method a(Laxwi;Lio/reactivex/disposables/CompositeDisposable;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 167
    invoke-direct {p0, p2}, Lio/reactivex/internal/operators/flowable/FlowableRefCount;->a(Lio/reactivex/disposables/CompositeDisposable;)Lio/reactivex/disposables/Disposable;
    ...
    invoke-direct {v1, p0, p1, p2, v0}, Lio/reactivex/internal/operators/flowable/FlowableRefCount$ConnectionSubscriber;-><init>(Lio/reactivex/internal/operators/flowable/FlowableRefCount;Laxwi;Lio/reactivex/disposables/CompositeDisposable;Lio/reactivex/disposables/Disposable;)V
    ...
    invoke-virtual {p1, v1}, Lio/reactivex/flowables/ConnectableFlowable;->a(Lio/reactivex/FlowableSubscriber;)V
