...
.method public static a(Laxwh;Laxwi;Lio/reactivex/functions/Function;)Z
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-direct {p2, p1, p0}, Lio/reactivex/internal/subscriptions/ScalarSubscription;-><init>(Laxwi;Ljava/lang/Object;)V

    invoke-interface {p1, p2}, Laxwi;->a(Laxwj;)V
    ...
    .line 83
    invoke-static {p0, p1}, Lio/reactivex/internal/subscriptions/EmptySubscription;->a(Ljava/lang/Throwable;Laxwi;)V

    return v0

    .line 93
    :cond_2
    invoke-interface {p0, p1}, Laxwh;->b(Laxwi;)V
