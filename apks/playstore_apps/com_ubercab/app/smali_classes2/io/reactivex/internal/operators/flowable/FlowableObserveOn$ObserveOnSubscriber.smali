...
# direct methods
.method constructor <init>(Laxwi;Lio/reactivex/Scheduler$Worker;ZI)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 255
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnSubscriber;->n:Laxwi;
...
.method public a(Laxwj;)V
    ...
    .line 260
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnSubscriber;->f:Laxwj;
    ...
    .line 261
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnSubscriber;->f:Laxwj;
    ...
    .line 274
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnSubscriber;->n:Laxwi;
    ...
    .line 281
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnSubscriber;->n:Laxwi;
...
.method public dY_()Ljava/lang/Object;
    ...
    .line 469
    iget-object v3, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnSubscriber;->f:Laxwj;
...
.method e()V
    ...
    .line 441
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnSubscriber;->n:Laxwi;

    const/4 v3, 0x0

    invoke-interface {v2, v3}, Laxwi;->onNext(Ljava/lang/Object;)V
    ...
    .line 446
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnSubscriber;->n:Laxwi;

    invoke-interface {v1, v0}, Laxwi;->onError(Ljava/lang/Throwable;)V
...
.method f()V
    ...
    :cond_0
    :goto_0
    iget-object v5, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnSubscriber;->e:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    .line 332
    :cond_2
    invoke-interface {v0, v7}, Laxwi;->onNext(Ljava/lang/Object;)V
    ...
    .line 317
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnSubscriber;->f:Laxwj;
    ...
    .line 337
    :cond_3
    iget-boolean v5, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnSubscriber;->h:Z
...
.method g()V
    ...
    .line 392
    :goto_2
    invoke-virtual {p0, v8, v10, v0}, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnSubscriber;->a(ZZLaxwi;)Z
    ...
    .line 400
    :cond_4
    invoke-interface {v0, v9}, Laxwi;->onNext(Ljava/lang/Object;)V
    ...
    .line 407
    :cond_5
    iget-object v8, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnSubscriber;->f:Laxwj;

    invoke-interface {v8, v2, v3}, Laxwj;->a(J)V
    ...
    .line 385
    invoke-interface {v0, v2}, Laxwi;->onError(Ljava/lang/Throwable;)V
    ...
    invoke-virtual {p0, v6, v7, v0}, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnSubscriber;->a(ZZLaxwi;)Z
