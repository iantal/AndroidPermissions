...
.method public static varargs a([Lio/reactivex/SingleSource;)Lio/reactivex/Single;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static {p0}, Lio/reactivex/Single;->a(Lio/reactivex/SingleSource;)Lio/reactivex/Single;
...
.method private b(JLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;Lio/reactivex/SingleSource;)Lio/reactivex/Single;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(J",
...
.method public final a(JLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;Lio/reactivex/SingleSource;)Lio/reactivex/Single;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(J",
    ...
    .line 3427
    invoke-direct/range {p0 .. p5}, Lio/reactivex/Single;->b(JLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;Lio/reactivex/SingleSource;)Lio/reactivex/Single;
...
.method public final a(Lio/reactivex/functions/BiConsumer;)Lio/reactivex/Single;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final b(JLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;)Lio/reactivex/Single;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(J",
    ...
    invoke-virtual {p0, p1}, Lio/reactivex/Single;->b(Lio/reactivex/ObservableSource;)Lio/reactivex/Single;
...
.method public final b(Lio/reactivex/ObservableSource;)Lio/reactivex/Single;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<U:",
...
.method public final c(JLjava/util/concurrent/TimeUnit;)Lio/reactivex/Single;
    ...
    invoke-virtual {p0, p1, p2, p3, v0}, Lio/reactivex/Single;->b(JLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;)Lio/reactivex/Single;
...
.method public final c(JLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;)Lio/reactivex/Single;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(J",
    ...
    .line 3406
    invoke-direct/range {v0 .. v5}, Lio/reactivex/Single;->b(JLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;Lio/reactivex/SingleSource;)Lio/reactivex/Single;
...
.method public final c(Lio/reactivex/SingleObserver;)Lio/reactivex/SingleObserver;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<E::",
...
.method public final d()Lio/reactivex/Flowable;
    ...
    invoke-interface {v0}, Lio/reactivex/internal/fuseable/FuseToFlowable;->dZ_()Lio/reactivex/Flowable;
...
.method public final d(JLjava/util/concurrent/TimeUnit;)Lio/reactivex/Single;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(J",
...
.method public final e()Lio/reactivex/Maybe;
    ...
    invoke-interface {v0}, Lio/reactivex/internal/fuseable/FuseToMaybe;->ea_()Lio/reactivex/Maybe;
...
.method public final f()Lio/reactivex/Observable;
    ...
    invoke-interface {v0}, Lio/reactivex/internal/fuseable/FuseToObservable;->eb_()Lio/reactivex/Observable;
...
.method public final h(Lio/reactivex/functions/Function;)Lio/reactivex/Flowable;
    ...
    .line 2953
    invoke-virtual {p0}, Lio/reactivex/Single;->d()Lio/reactivex/Flowable;

    move-result-object v0

    invoke-virtual {v0, p1}, Lio/reactivex/Flowable;->c(Lio/reactivex/functions/Function;)Lio/reactivex/Flowable;
...
.method public final j(Lio/reactivex/functions/Function;)Ljava/lang/Object;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<R:",
