...
.method public static a()Lio/reactivex/Maybe;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static b(Ljava/util/concurrent/Callable;)Lio/reactivex/Maybe;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
# virtual methods
.method public final a(JLjava/util/concurrent/TimeUnit;)Lio/reactivex/Maybe;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(J",
    ...
    invoke-virtual {p0, p1, p2, p3, v0}, Lio/reactivex/Maybe;->b(JLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;)Lio/reactivex/Maybe;
...
.method public final a(JLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;Lio/reactivex/MaybeSource;)Lio/reactivex/Maybe;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(J",
    ...
    invoke-virtual {p0, p1, p5}, Lio/reactivex/Maybe;->a(Lio/reactivex/MaybeSource;Lio/reactivex/MaybeSource;)Lio/reactivex/Maybe;
...
.method public final a(Lio/reactivex/MaybeSource;Lio/reactivex/MaybeSource;)Lio/reactivex/Maybe;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<U:",
...
.method public final a(Lio/reactivex/MaybeSource;Lio/reactivex/functions/BiFunction;)Lio/reactivex/Maybe;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<U:",
    ...
    .line 4480
    invoke-static {p0, p1, p2}, Lio/reactivex/Maybe;->a(Lio/reactivex/MaybeSource;Lio/reactivex/MaybeSource;Lio/reactivex/functions/BiFunction;)Lio/reactivex/Maybe;
...
.method public final b(Lio/reactivex/functions/Function;)Lio/reactivex/Observable;
    ...
    .line 2956
    invoke-virtual {p0}, Lio/reactivex/Maybe;->d()Lio/reactivex/Observable;
...
.method public final d(Ljava/lang/Object;)Lio/reactivex/Maybe;
    ...
    invoke-virtual {p0, p1}, Lio/reactivex/Maybe;->g(Lio/reactivex/functions/Function;)Lio/reactivex/Maybe;
...
.method public final e(Lio/reactivex/functions/Function;)Lio/reactivex/Maybe;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<R:",
...
.method public final f()Lio/reactivex/Maybe;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public final f(Lio/reactivex/functions/Function;)Ljava/lang/Object;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<R:",
