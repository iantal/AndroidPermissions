...
.method private a(Z)[B
    ...
    iget-object v3, p0, Lorg/apache/xml/security/signature/Reference;->m:Lorg/w3c/dom/Document;

    invoke-direct {p1, v3}, Lorg/apache/xml/security/transforms/Transforms;-><init>(Lorg/w3c/dom/Document;)V

    iput-object p1, p0, Lorg/apache/xml/security/signature/Reference;->f:Lorg/apache/xml/security/transforms/Transforms;

    iget-object p1, p0, Lorg/apache/xml/security/signature/Reference;->k:Lorg/w3c/dom/Element;

    iget-object v3, p0, Lorg/apache/xml/security/signature/Reference;->f:Lorg/apache/xml/security/transforms/Transforms;

    invoke-virtual {v3}, Lorg/apache/xml/security/transforms/Transforms;->k()Lorg/w3c/dom/Element;

    move-result-object v3

    iget-object v4, p0, Lorg/apache/xml/security/signature/Reference;->g:Lorg/w3c/dom/Element;

    invoke-interface {p1, v3, v4}, Lorg/w3c/dom/Element;->insertBefore(Lorg/w3c/dom/Node;Lorg/w3c/dom/Node;)Lorg/w3c/dom/Node;

    :cond_0
    iget-object p1, p0, Lorg/apache/xml/security/signature/Reference;->f:Lorg/apache/xml/security/transforms/Transforms;

    const-string v3, "http://www.w3.org/2006/12/xml-c14n11"

    invoke-virtual {p1, v3}, Lorg/apache/xml/security/transforms/Transforms;->a(Ljava/lang/String;)V

    const/4 p1, 0x1

    invoke-virtual {v2, v0, p1}, Lorg/apache/xml/security/signature/XMLSignatureInput;->a(Ljava/io/OutputStream;Z)V
...
.method public a()Lorg/apache/xml/security/algorithms/MessageDigestAlgorithm;
    ...
    :cond_1
    iget-object v1, p0, Lorg/apache/xml/security/signature/Reference;->m:Lorg/w3c/dom/Document;
...
.method public g()Lorg/apache/xml/security/signature/XMLSignatureInput;
    ...
    :goto_0
    iget-object v1, p0, Lorg/apache/xml/security/signature/Reference;->l:Ljava/lang/String;
    ...
    invoke-static {v0, v1, v3}, Lorg/apache/xml/security/utils/resolver/ResourceResolver;->a(Lorg/w3c/dom/Attr;Ljava/lang/String;Ljava/util/List;)Lorg/apache/xml/security/utils/resolver/ResourceResolver;

    move-result-object v1

    if-eqz v1, :cond_1

    iget-object v2, p0, Lorg/apache/xml/security/signature/Reference;->b:Lorg/apache/xml/security/signature/Manifest;

    iget-object v2, v2, Lorg/apache/xml/security/signature/Manifest;->d:Ljava/util/HashMap;

    invoke-virtual {v1, v2}, Lorg/apache/xml/security/utils/resolver/ResourceResolver;->a(Ljava/util/Map;)V

    iget-object v2, p0, Lorg/apache/xml/security/signature/Reference;->l:Ljava/lang/String;

    invoke-virtual {v1, v0, v2}, Lorg/apache/xml/security/utils/resolver/ResourceResolver;->b(Lorg/w3c/dom/Attr;Ljava/lang/String;)Lorg/apache/xml/security/signature/XMLSignatureInput;
    ...
    invoke-direct {v1, v2, v0}, Lorg/apache/xml/security/signature/ReferenceNotInitializedException;-><init>(Ljava/lang/String;[Ljava/lang/Object;)V
