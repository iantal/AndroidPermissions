...
.method public run()V
    ...
    invoke-virtual {v0, v2}, Lorg/npci/upi/security/pinactivitycomponent/ae;->getString(I)Ljava/lang/String;

    move-result-object v2

    iget-object v0, p0, Lorg/npci/upi/security/pinactivitycomponent/aj;->a:Lorg/npci/upi/security/pinactivitycomponent/ae;

    invoke-virtual {v0}, Lorg/npci/upi/security/pinactivitycomponent/ae;->getActivity()Landroid/support/v4/app/FragmentActivity;

    move-result-object v0

    sget v3, Lorg/npci/upi/security/pinactivitycomponent/R$drawable;->ic_action_reload:I

    invoke-static {v0, v3}, Lmp;->a(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
