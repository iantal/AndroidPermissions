...
.method private a(Landroid/view/View;)V
    ...
    iget-object v0, p0, Lorg/npci/upi/security/pinactivitycomponent/ao;->c:Lorg/json/JSONArray;
    ...
    :goto_0
    iget-object v1, p0, Lorg/npci/upi/security/pinactivitycomponent/ao;->c:Lorg/json/JSONArray;
    ...
    sget v2, Lorg/npci/upi/security/pinactivitycomponent/R$string;->npci_mpin_title:I

    :goto_2
    invoke-virtual {p0, v2}, Lorg/npci/upi/security/pinactivitycomponent/ao;->getString(I)Ljava/lang/String;
    ...
    sget v2, Lorg/npci/upi/security/pinactivitycomponent/R$string;->npci_atm_title:I

    goto :goto_2

    :cond_5
    :goto_3
    sget v2, Lorg/npci/upi/security/pinactivitycomponent/R$string;->npci_otp_title:I

    invoke-virtual {p0, v2}, Lorg/npci/upi/security/pinactivitycomponent/ao;->getString(I)Ljava/lang/String;

    move-result-object v4

    iput v0, p0, Lorg/npci/upi/security/pinactivitycomponent/ao;->g:I

    invoke-virtual {p0}, Lorg/npci/upi/security/pinactivitycomponent/ao;->getActivity()Landroid/support/v4/app/FragmentActivity;
    ...
    invoke-virtual {v2}, Lorg/npci/upi/security/pinactivitycomponent/GetCredential;->checkSMSReadPermission()Z

    move-result v2

    if-eqz v2, :cond_6

    invoke-virtual {p0, v3}, Lorg/npci/upi/security/pinactivitycomponent/ao;->b(I)V

    :cond_6
    :goto_4
    invoke-virtual {p0, v4, v0, v3}, Lorg/npci/upi/security/pinactivitycomponent/ao;->a(Ljava/lang/String;II)Lorg/npci/upi/security/pinactivitycomponent/widget/FormItemView;

    move-result-object v2

    invoke-virtual {v2, v1}, Lorg/npci/upi/security/pinactivitycomponent/widget/FormItemView;->setFormDataTag(Ljava/lang/Object;)V

    iget-object v1, p0, Lorg/npci/upi/security/pinactivitycomponent/ao;->f:Ljava/util/ArrayList;
    ...
    :cond_7
    :goto_6
    sget v2, Lorg/npci/upi/security/pinactivitycomponent/R$string;->npci_set_mpin_title:I

    invoke-virtual {p0, v2}, Lorg/npci/upi/security/pinactivitycomponent/ao;->getString(I)Ljava/lang/String;

    move-result-object v2

    invoke-virtual {p0, v2, v0, v3}, Lorg/npci/upi/security/pinactivitycomponent/ao;->a(Ljava/lang/String;II)Lorg/npci/upi/security/pinactivitycomponent/widget/FormItemView;

    move-result-object v2

    sget v4, Lorg/npci/upi/security/pinactivitycomponent/R$string;->npci_confirm_mpin_title:I

    invoke-virtual {p0, v4}, Lorg/npci/upi/security/pinactivitycomponent/ao;->getString(I)Ljava/lang/String;
    ...
    new-instance v2, Lorg/npci/upi/security/pinactivitycomponent/widget/FormItemPager;

    invoke-virtual {p0}, Lorg/npci/upi/security/pinactivitycomponent/ao;->getActivity()Landroid/support/v4/app/FragmentActivity;

    move-result-object v3

    invoke-direct {v2, v3}, Lorg/npci/upi/security/pinactivitycomponent/widget/FormItemPager;-><init>(Landroid/content/Context;)V

    invoke-virtual {v2, v4, p0}, Lorg/npci/upi/security/pinactivitycomponent/widget/FormItemPager;->a(Ljava/util/ArrayList;Lorg/npci/upi/security/pinactivitycomponent/widget/m;)V

    invoke-virtual {v2, v1}, Lorg/npci/upi/security/pinactivitycomponent/widget/FormItemPager;->setFormDataTag(Ljava/lang/Object;)V
    ...
    sget-object v2, Lorg/npci/upi/security/pinactivitycomponent/ao;->s:Ljava/lang/String;
...
.method private d()V
    ...
    iget v0, p0, Lorg/npci/upi/security/pinactivitycomponent/ao;->g:I

    const/4 v1, -0x1

    if-eq v0, v1, :cond_1

    iget-object v0, p0, Lorg/npci/upi/security/pinactivitycomponent/ao;->f:Ljava/util/ArrayList;

    iget v1, p0, Lorg/npci/upi/security/pinactivitycomponent/ao;->g:I
    ...
    invoke-virtual {p0, v1}, Lorg/npci/upi/security/pinactivitycomponent/ao;->getString(I)Ljava/lang/String;
    ...
    :goto_0
    iget-object v2, p0, Lorg/npci/upi/security/pinactivitycomponent/ao;->f:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v0}, Lorg/npci/upi/security/pinactivitycomponent/ao;->getString(I)Ljava/lang/String;
    ...
    iget-object v4, p0, Lorg/npci/upi/security/pinactivitycomponent/ao;->b:Lorg/json/JSONObject;

    const-string v5, "credential"

    iget-object v6, p0, Lorg/npci/upi/security/pinactivitycomponent/ao;->f:Ljava/util/ArrayList;
    ...
    iget-object v4, p0, Lorg/npci/upi/security/pinactivitycomponent/ao;->p:Landroid/content/Context;
    ...
    iget-object v5, p0, Lorg/npci/upi/security/pinactivitycomponent/ao;->b:Lorg/json/JSONObject;

    invoke-virtual {v4, v5}, Lorg/npci/upi/security/pinactivitycomponent/aq;->a(Lorg/json/JSONObject;)Ljava/lang/String;

    move-result-object v4

    iget-object v5, p0, Lorg/npci/upi/security/pinactivitycomponent/ao;->p:Landroid/content/Context;
    ...
    iget-object v6, p0, Lorg/npci/upi/security/pinactivitycomponent/ao;->b:Lorg/json/JSONObject;
    ...
    iget-object v3, p0, Lorg/npci/upi/security/pinactivitycomponent/ao;->w:Ljava/util/HashMap;

    invoke-virtual {v0, v2, v3}, Landroid/os/Bundle;->putSerializable(Ljava/lang/String;Ljava/io/Serializable;)V

    iget-object v2, p0, Lorg/npci/upi/security/pinactivitycomponent/ao;->p:Landroid/content/Context;
    ...
    iget-object v0, p0, Lorg/npci/upi/security/pinactivitycomponent/ao;->p:Landroid/content/Context;
...
.method private e()Z
    ...
    :goto_1
    iget-object v3, p0, Lorg/npci/upi/security/pinactivitycomponent/ao;->c:Lorg/json/JSONArray;
...
.method private f()V
    ...
    iget v2, p0, Lorg/npci/upi/security/pinactivitycomponent/ao;->g:I
    ...
    invoke-virtual {p0, v3}, Lorg/npci/upi/security/pinactivitycomponent/ao;->getString(I)Ljava/lang/String;
...
.method public a(ILjava/lang/String;)V
    ...
    iget p2, p0, Lorg/npci/upi/security/pinactivitycomponent/ao;->g:I
    ...
    iget-object p1, p0, Lorg/npci/upi/security/pinactivitycomponent/ao;->f:Ljava/util/ArrayList;
