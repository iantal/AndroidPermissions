.class public Lcom/paypal/android/sdk/onetouch/core/metadata/m;
.super Ljava/lang/Object;


# static fields
.field private static a:Ljava/lang/String; = "CONFIG_TIME"

.field private static b:Ljava/lang/String; = "3.0"

.field private static c:Ljava/lang/String; = "prdc"

.field private static d:Ljava/lang/String; = "CDS"

.field private static e:I = 0x3e8

.field private static final f:Ljava/lang/String; = "m"

.field private static final g:Ljava/lang/String; = "CONFIG_DATA"

.field private static final h:Ljava/lang/String; = "QW5kcm9pZE1hZ25lcw=="

.field private static final i:I = 0xe10

.field private static final j:I = 0x708

.field private static final k:I = 0x15180

.field private static final l:I = 0x1f4

.field private static final m:I = 0x708

.field private static final n:Ljava/lang/String; = "https://svcs.paypal.com/AccessControl/LogRiskMetadata"
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, p2, v0}, Lcom/paypal/android/sdk/onetouch/core/metadata/m;-><init>(Landroid/content/Context;Ljava/lang/String;B)V
...
.method private constructor <init>(Landroid/content/Context;Ljava/lang/String;B)V
    ...
    sget-object p3, Lcom/paypal/android/sdk/onetouch/core/metadata/m;->f:Ljava/lang/String;

    const-string v0, "entering Configuration url loading"

    invoke-static {p3, v0}, Lcom/paypal/android/sdk/onetouch/core/metadata/l;->a(Ljava/lang/String;Ljava/lang/String;)V

    iput-object p1, p0, Lcom/paypal/android/sdk/onetouch/core/metadata/m;->o:Landroid/content/Context;

    iput-object p2, p0, Lcom/paypal/android/sdk/onetouch/core/metadata/m;->p:Ljava/lang/String;

    invoke-direct {p0}, Lcom/paypal/android/sdk/onetouch/core/metadata/m;->q()Ljava/lang/String;
    ...
    sget-object p2, Lcom/paypal/android/sdk/onetouch/core/metadata/m;->f:Ljava/lang/String;

    const-string p3, "entering saveConfigDataToDisk"

    invoke-static {p2, p3}, Lcom/paypal/android/sdk/onetouch/core/metadata/l;->a(Ljava/lang/String;Ljava/lang/String;)V

    :try_start_0
    new-instance p2, Ljava/io/File;

    iget-object p3, p0, Lcom/paypal/android/sdk/onetouch/core/metadata/m;->o:Landroid/content/Context;
    ...
    iget-object v0, p0, Lcom/paypal/android/sdk/onetouch/core/metadata/m;->o:Landroid/content/Context;
    ...
    invoke-static {p2, p1}, Lcom/paypal/android/sdk/onetouch/core/metadata/s;->a(Ljava/io/File;Ljava/lang/String;)V
    ...
    invoke-static {p3, p2}, Lcom/paypal/android/sdk/onetouch/core/metadata/s;->a(Ljava/io/File;Ljava/lang/String;)V

    sget-object p2, Lcom/paypal/android/sdk/onetouch/core/metadata/m;->f:Ljava/lang/String;

    const-string p3, "leaving saveConfigDataToDisk successfully"
    ...
    const-string v0, "Failed to write config data: "
    ...
    iput-object p2, p0, Lcom/paypal/android/sdk/onetouch/core/metadata/m;->q:Lorg/json/JSONObject;

    sget-object p1, Lcom/paypal/android/sdk/onetouch/core/metadata/m;->f:Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;Z)V
    ...
    iput-object p1, p0, Lcom/paypal/android/sdk/onetouch/core/metadata/m;->p:Ljava/lang/String;

    iput-boolean p2, p0, Lcom/paypal/android/sdk/onetouch/core/metadata/m;->r:Z

    const-string p1, "PRD"

    new-instance p2, Ljava/lang/StringBuilder;

    const-string v0, "confIsUpdatable="

    invoke-direct {p2, v0}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    iget-boolean v0, p0, Lcom/paypal/android/sdk/onetouch/core/metadata/m;->r:Z
    ...
    invoke-static {v0, p1, p2}, Lcom/paypal/android/sdk/onetouch/core/metadata/l;->a(ILjava/lang/String;Ljava/lang/String;)V

    invoke-direct {p0}, Lcom/paypal/android/sdk/onetouch/core/metadata/m;->k()Lorg/json/JSONObject;

    move-result-object p1

    iput-object p1, p0, Lcom/paypal/android/sdk/onetouch/core/metadata/m;->q:Lorg/json/JSONObject;
    ...
    iget-object p2, p0, Lcom/paypal/android/sdk/onetouch/core/metadata/m;->q:Lorg/json/JSONObject;

    invoke-static {p1, p2}, Lcom/paypal/android/sdk/onetouch/core/metadata/l;->a(Ljava/lang/String;Lorg/json/JSONObject;)V
...
.method private a(Ljava/lang/String;)Lorg/json/JSONObject;
    ...
    :try_start_0
    sget-object v0, Lcom/paypal/android/sdk/onetouch/core/metadata/m;->f:Ljava/lang/String;
    ...
    invoke-static {v0, p1}, Lcom/paypal/android/sdk/onetouch/core/metadata/l;->b(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v1, v2, p1, v0}, Lcom/paypal/android/sdk/onetouch/core/metadata/l;->a(ILjava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private static a(Lorg/json/JSONObject;Lorg/json/JSONObject;)Lorg/json/JSONObject;
    ...
    sget-object v2, Lcom/paypal/android/sdk/onetouch/core/metadata/m;->f:Ljava/lang/String;
    ...
    invoke-static {v2, v3}, Lcom/paypal/android/sdk/onetouch/core/metadata/l;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p1, v0, v1, p0}, Lcom/paypal/android/sdk/onetouch/core/metadata/l;->a(ILjava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private a(Lorg/json/JSONObject;)Z
    ...
    invoke-direct {p0}, Lcom/paypal/android/sdk/onetouch/core/metadata/m;->t()Ljava/lang/String;
...
.method private b(Ljava/lang/String;)V
    ...
    const-string v1, "entering saveConfigDataToDisk"
    ...
    iget-object v1, p0, Lcom/paypal/android/sdk/onetouch/core/metadata/m;->o:Landroid/content/Context;
    ...
    iget-object v2, p0, Lcom/paypal/android/sdk/onetouch/core/metadata/m;->o:Landroid/content/Context;
    ...
    invoke-static {v0, p1}, Lcom/paypal/android/sdk/onetouch/core/metadata/s;->a(Ljava/io/File;Ljava/lang/String;)V
    ...
    invoke-static {v1, p1}, Lcom/paypal/android/sdk/onetouch/core/metadata/s;->a(Ljava/io/File;Ljava/lang/String;)V

    sget-object p1, Lcom/paypal/android/sdk/onetouch/core/metadata/m;->f:Ljava/lang/String;

    const-string v0, "leaving saveConfigDataToDisk successfully"
    ...
    const-string v1, "Failed to write config data: "
...
.method private k()Lorg/json/JSONObject;
    ...
    :try_start_0
    invoke-direct {p0}, Lcom/paypal/android/sdk/onetouch/core/metadata/m;->n()Lorg/json/JSONObject;
    ...
    invoke-static {v2, v3}, Lcom/paypal/android/sdk/onetouch/core/metadata/l;->b(Ljava/lang/String;Ljava/lang/String;)Z

    move-result v2

    if-eqz v2, :cond_2

    iget-boolean v2, p0, Lcom/paypal/android/sdk/onetouch/core/metadata/m;->r:Z
    ...
    invoke-static {}, Lcom/paypal/android/sdk/onetouch/core/metadata/m;->p()V

    :cond_1
    sget-object v2, Lcom/paypal/android/sdk/onetouch/core/metadata/m;->f:Ljava/lang/String;

    const-string v3, "Using cached config"
    ...
    :cond_2
    invoke-direct {p0}, Lcom/paypal/android/sdk/onetouch/core/metadata/m;->s()Z

    :cond_3
    invoke-static {}, Lcom/paypal/android/sdk/onetouch/core/metadata/m;->m()Lorg/json/JSONObject;

    move-result-object v1

    if-nez v1, :cond_4

    sget-object v1, Lcom/paypal/android/sdk/onetouch/core/metadata/m;->f:Ljava/lang/String;

    const-string v2, "default Configuration loading failed,Using hardcoded config"

    invoke-static {v1, v2}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;)I

    invoke-static {}, Lcom/paypal/android/sdk/onetouch/core/metadata/m;->o()Lorg/json/JSONObject;
    ...
    const-string v3, "prdc"

    const/4 v4, 0x0

    invoke-static {v2, v3, v4}, Lcom/paypal/android/sdk/onetouch/core/metadata/l;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v4, "prdc field not configured, using default config"

    invoke-static {v3, v2, v4}, Lcom/paypal/android/sdk/onetouch/core/metadata/l;->a(ILjava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v3, v4, v5}, Lcom/paypal/android/sdk/onetouch/core/metadata/l;->a(ILjava/lang/String;Ljava/lang/String;)V

    invoke-direct {p0, v2}, Lcom/paypal/android/sdk/onetouch/core/metadata/m;->a(Ljava/lang/String;)Lorg/json/JSONObject;
    ...
    invoke-static {v0, v2, v3}, Lcom/paypal/android/sdk/onetouch/core/metadata/l;->a(ILjava/lang/String;Ljava/lang/String;)V

    return-object v1

    :cond_7
    invoke-static {v1, v2}, Lcom/paypal/android/sdk/onetouch/core/metadata/m;->a(Lorg/json/JSONObject;Lorg/json/JSONObject;)Lorg/json/JSONObject;
    ...
    const-string v4, "prdc configuration loaded successfully"

    invoke-static {v3, v1, v4}, Lcom/paypal/android/sdk/onetouch/core/metadata/l;->a(ILjava/lang/String;Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-static {v0, v2, v3, v1}, Lcom/paypal/android/sdk/onetouch/core/metadata/l;->a(ILjava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private l()Ljava/lang/String;
    ...
    const-string v1, "prdc"

    const/4 v2, 0x0

    invoke-static {v0, v1, v2}, Lcom/paypal/android/sdk/onetouch/core/metadata/l;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method private static m()Lorg/json/JSONObject;
    ...
    invoke-static {v1, v2, v3, v0}, Lcom/paypal/android/sdk/onetouch/core/metadata/l;->a(ILjava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private n()Lorg/json/JSONObject;
    ...
    :try_start_0
    invoke-direct {p0}, Lcom/paypal/android/sdk/onetouch/core/metadata/m;->r()Ljava/lang/String;
...
.method private static o()Lorg/json/JSONObject;
    .locals 4
...
.method private static p()V
    ...
    invoke-virtual {v0}, Lcom/paypal/android/sdk/onetouch/core/metadata/a;->c()V
...
.method private q()Ljava/lang/String;
    ...
    iget-object v3, p0, Lcom/paypal/android/sdk/onetouch/core/metadata/m;->p:Ljava/lang/String;
    ...
    invoke-static {v1}, Lcom/paypal/android/sdk/onetouch/core/metadata/l;->a(Ljava/io/Closeable;)V
...
.method private r()Ljava/lang/String;
    ...
    :try_start_0
    invoke-static {v0}, Lcom/paypal/android/sdk/onetouch/core/metadata/s;->a(Ljava/io/File;)Ljava/lang/String;
...
.method private u()J
    ...
    iget-object v0, p0, Lcom/paypal/android/sdk/onetouch/core/metadata/m;->q:Lorg/json/JSONObject;
...
.method public final a()Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/paypal/android/sdk/onetouch/core/metadata/m;->p:Ljava/lang/String;
...
.method public final f()Ljava/util/List;
    ...
    iget-object v1, p0, Lcom/paypal/android/sdk/onetouch/core/metadata/m;->q:Lorg/json/JSONObject;
...
.method public final i()Lcom/paypal/android/sdk/onetouch/core/metadata/j;
    .locals 4
    ...
    invoke-static {v1, v2, v3}, Lcom/paypal/android/sdk/onetouch/core/metadata/l;->a(ILjava/lang/String;Ljava/lang/String;)V

    new-instance v1, Lcom/paypal/android/sdk/onetouch/core/metadata/j;

    invoke-virtual {v0}, Ljava/lang/String;->trim()Ljava/lang/String;

    move-result-object v0

    invoke-direct {v1, v0}, Lcom/paypal/android/sdk/onetouch/core/metadata/j;-><init>(Ljava/lang/String;)V
    ...
    invoke-static {v1, v0, v2}, Lcom/paypal/android/sdk/onetouch/core/metadata/l;->a(ILjava/lang/String;Ljava/lang/String;)V

    sget-object v0, Lcom/paypal/android/sdk/onetouch/core/metadata/j;->a:Lcom/paypal/android/sdk/onetouch/core/metadata/j;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
