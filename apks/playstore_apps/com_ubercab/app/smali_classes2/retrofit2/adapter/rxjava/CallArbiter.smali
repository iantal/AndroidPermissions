...
# direct methods
.method constructor <init>(Lretrofit2/Call;Laybz;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 47
    iput-object p2, p0, Lretrofit2/adapter/rxjava/CallArbiter;->subscriber:Laybz;
...
.method private deliverResponse(Lretrofit2/Response;)V
    ...
    .line 120
    iget-object v0, p0, Lretrofit2/adapter/rxjava/CallArbiter;->subscriber:Laybz;

    invoke-virtual {v0, p1}, Laybz;->onNext(Ljava/lang/Object;)V
    :try_end_0
    .catch Laycs; {:try_start_0 .. :try_end_0} :catch_5
    .catch Layct; {:try_start_0 .. :try_end_0} :catch_5
    .catch Laycu; {:try_start_0 .. :try_end_0} :catch_5
    ...
    .line 144
    iget-object p1, p0, Lretrofit2/adapter/rxjava/CallArbiter;->subscriber:Laybz;

    invoke-virtual {p1}, Laybz;->onCompleted()V
    :try_end_1
    .catch Laycs; {:try_start_1 .. :try_end_1} :catch_1
    .catch Layct; {:try_start_1 .. :try_end_1} :catch_1
    .catch Laycu; {:try_start_1 .. :try_end_1} :catch_1
    ...
    :try_end_2
    .catch Laycs; {:try_start_2 .. :try_end_2} :catch_4
    .catch Layct; {:try_start_2 .. :try_end_2} :catch_4
    .catch Laycu; {:try_start_2 .. :try_end_2} :catch_4
