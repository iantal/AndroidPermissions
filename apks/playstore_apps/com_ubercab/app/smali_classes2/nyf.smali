...
.method public constructor <init>(Lobz;Landroid/os/Handler;)V
    ...
    .line 42
    iput-object p1, p0, Lnyf;->b:Lobz;

    .line 43
    iput-object p2, p0, Lnyf;->a:Landroid/os/Handler;
...
# virtual methods
.method public a(Landroid/content/Context;Landroid/hardware/SensorManager;Lnyt;)Lio/reactivex/Flowable;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v1, p0, Lnyf;->b:Lobz;

    iget-object v2, p0, Lnyf;->a:Landroid/os/Handler;

    invoke-direct {v0, v1, v2}, Loci;-><init>(Lobz;Landroid/os/Handler;)V

    .line 62
    invoke-virtual {v0, p1, p2}, Loci;->a(Landroid/content/Context;Landroid/hardware/SensorManager;)Z
    ...
    .line 67
    :cond_0
    new-instance p1, Lnyf$1;

    invoke-direct {p1, p0, p3, v0, p2}, Lnyf$1;-><init>(Lnyf;Lnyt;Loci;Landroid/hardware/SensorManager;)V
