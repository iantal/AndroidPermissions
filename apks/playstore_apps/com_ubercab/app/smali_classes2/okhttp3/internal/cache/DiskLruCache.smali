...
.method private newJournalWriter()Laxju;
    .locals 2
    ...
    invoke-interface {v0, v1}, Lokhttp3/internal/io/FileSystem;->appendingSink(Ljava/io/File;)Laxkn;
    ...
    invoke-direct {v1, p0, v0}, Lokhttp3/internal/cache/DiskLruCache$2;-><init>(Lokhttp3/internal/cache/DiskLruCache;Laxkn;)V

    .line 322
    invoke-static {v1}, Laxke;->a(Laxkn;)Laxju;
...
.method private readJournal()V
    ...
    invoke-interface {v0, v1}, Lokhttp3/internal/io/FileSystem;->source(Ljava/io/File;)Laxko;
    ...
    .line 278
    :try_start_0
    invoke-interface {v0}, Laxjv;->t()Ljava/lang/String;
    ...
    .line 307
    :cond_0
    invoke-direct {p0}, Lokhttp3/internal/cache/DiskLruCache;->newJournalWriter()Laxju;

    move-result-object v1

    iput-object v1, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Laxju;
    :try_end_2
...
.method public declared-synchronized close()V
    ...
    .line 677
    iget-object v0, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Laxju;

    invoke-interface {v0}, Laxju;->close()V

    const/4 v0, 0x0

    .line 678
    iput-object v0, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Laxju;
...
.method declared-synchronized completeEdit(Lokhttp3/internal/cache/DiskLruCache$Editor;Z)V
    ...
    .line 574
    iget-object p1, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Laxju;

    const-string v1, "CLEAN"

    invoke-interface {p1, v1}, Laxju;->b(Ljava/lang/String;)Laxju;

    move-result-object p1

    invoke-interface {p1, v3}, Laxju;->k(I)Laxju;
    ...
    invoke-virtual {v0, p1}, Lokhttp3/internal/cache/DiskLruCache$Entry;->writeLengths(Laxju;)V

    .line 577
    iget-object p1, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Laxju;

    invoke-interface {p1, v2}, Laxju;->k(I)Laxju;
...
.method declared-synchronized edit(Ljava/lang/String;J)Lokhttp3/internal/cache/DiskLruCache$Editor;
    ...
    .line 486
    :cond_3
    iget-object p2, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Laxju;

    const-string p3, "DIRTY"

    invoke-interface {p2, p3}, Laxju;->b(Ljava/lang/String;)Laxju;

    move-result-object p2

    const/16 p3, 0x20

    invoke-interface {p2, p3}, Laxju;->k(I)Laxju;

    move-result-object p2

    invoke-interface {p2, p1}, Laxju;->b(Ljava/lang/String;)Laxju;
    ...
    invoke-interface {p2}, Laxju;->flush()V
...
.method public declared-synchronized get(Ljava/lang/String;)Lokhttp3/internal/cache/DiskLruCache$Snapshot;
    ...
    .line 447
    iget-object v1, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Laxju;
    ...
    invoke-interface {v1, v2}, Laxju;->k(I)Laxju;

    move-result-object v1

    invoke-interface {v1, p1}, Laxju;->b(Ljava/lang/String;)Laxju;

    move-result-object p1

    const/16 v1, 0xa

    invoke-interface {p1, v1}, Laxju;->k(I)Laxju;
...
.method declared-synchronized rebuildJournal()V
    ...
    invoke-interface {v0, v1}, Lokhttp3/internal/io/FileSystem;->sink(Ljava/io/File;)Laxkn;
    ...
    .line 398
    invoke-interface {v0, v1}, Laxju;->b(Ljava/lang/String;)Laxju;
    ...
    invoke-interface {v0, v3, v4}, Laxju;->n(J)Laxju;
    ...
    .line 402
    invoke-interface {v0, v2}, Laxju;->k(I)Laxju;
    ...
    .line 406
    invoke-interface {v0, v4}, Laxju;->b(Ljava/lang/String;)Laxju;

    move-result-object v4

    invoke-interface {v4, v5}, Laxju;->k(I)Laxju;

    .line 407
    iget-object v3, v3, Lokhttp3/internal/cache/DiskLruCache$Entry;->key:Ljava/lang/String;

    invoke-interface {v0, v3}, Laxju;->b(Ljava/lang/String;)Laxju;
    ...
    .line 412
    invoke-virtual {v3, v0}, Lokhttp3/internal/cache/DiskLruCache$Entry;->writeLengths(Laxju;)V
...
.method removeEntry(Lokhttp3/internal/cache/DiskLruCache$Entry;)Z
    ...
    invoke-interface {v0, v2}, Laxju;->b(Ljava/lang/String;)Laxju;
