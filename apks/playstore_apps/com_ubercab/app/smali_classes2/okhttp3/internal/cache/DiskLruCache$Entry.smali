...
.method snapshot()Lokhttp3/internal/cache/DiskLruCache$Snapshot;
    ...
    invoke-interface {v2, v3}, Lokhttp3/internal/io/FileSystem;->source(Ljava/io/File;)Laxko;
    ...
    invoke-direct/range {v1 .. v7}, Lokhttp3/internal/cache/DiskLruCache$Snapshot;-><init>(Lokhttp3/internal/cache/DiskLruCache;Ljava/lang/String;J[Laxko;[J)V
    :try_end_0
...
.method writeLengths(Laxju;)V
    ...
    .line 1011
    invoke-interface {p1, v5}, Laxju;->k(I)Laxju;

    move-result-object v5

    invoke-interface {v5, v3, v4}, Laxju;->n(J)Laxju;
