...
# direct methods
.method public constructor <init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/StreamAllocation;Laxjv;Laxju;)V
    .locals 2
    ...
    .line 93
    iput-object p3, p0, Lokhttp3/internal/http1/Http1Codec;->source:Laxjv;

    .line 94
    iput-object p4, p0, Lokhttp3/internal/http1/Http1Codec;->sink:Laxju;
...
.method private readHeaderLine()Ljava/lang/String;
    ...
    .line 215
    iget-object v0, p0, Lokhttp3/internal/http1/Http1Codec;->source:Laxjv;

    iget-wide v1, p0, Lokhttp3/internal/http1/Http1Codec;->headerLimit:J

    invoke-interface {v0, v1, v2}, Laxjv;->f(J)Ljava/lang/String;
...
.method public createRequestBody(Lokhttp3/Request;J)Laxkn;
    ...
    .line 100
    invoke-virtual {p0}, Lokhttp3/internal/http1/Http1Codec;->newChunkedSink()Laxkn;
    ...
    .line 105
    invoke-virtual {p0, p2, p3}, Lokhttp3/internal/http1/Http1Codec;->newFixedLengthSink(J)Laxkn;
...
.method detachTimeout(Laxka;)V
    .locals 2

    .line 268
    invoke-virtual {p1}, Laxka;->a()Laxkp;

    move-result-object v0

    .line 269
    sget-object v1, Laxkp;->NONE:Laxkp;

    invoke-virtual {p1, v1}, Laxka;->a(Laxkp;)Laxka;
...
.method public finishRequest()V
    ...
    .line 166
    iget-object v0, p0, Lokhttp3/internal/http1/Http1Codec;->sink:Laxju;

    invoke-interface {v0}, Laxju;->flush()V
...
.method public newChunkedSink()Laxkn;
    .locals 3
...
.method public newChunkedSource(Lokhttp3/HttpUrl;)Laxko;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public newFixedLengthSink(J)Laxkn;
    .locals 2
...
.method public newFixedLengthSource(J)Laxko;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public newUnknownLengthSource()Laxko;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public openResponseBody(Lokhttp3/Response;)Lokhttp3/ResponseBody;
    ...
    .line 138
    invoke-virtual {p0, v1, v2}, Lokhttp3/internal/http1/Http1Codec;->newFixedLengthSource(J)Laxko;
    ...
    invoke-virtual {p0, p1}, Lokhttp3/internal/http1/Http1Codec;->newChunkedSource(Lokhttp3/HttpUrl;)Laxko;
    ...
    invoke-direct {v1, v0, v2, v3, p1}, Lokhttp3/internal/http/RealResponseBody;-><init>(Ljava/lang/String;JLaxjv;)V
    ...
    .line 149
    invoke-virtual {p0, v4, v5}, Lokhttp3/internal/http1/Http1Codec;->newFixedLengthSource(J)Laxko;
    ...
    invoke-direct {v1, v0, v4, v5, p1}, Lokhttp3/internal/http/RealResponseBody;-><init>(Ljava/lang/String;JLaxjv;)V
    ...
    invoke-virtual {p0}, Lokhttp3/internal/http1/Http1Codec;->newUnknownLengthSource()Laxko;

    move-result-object v1

    invoke-static {v1}, Laxke;->a(Laxko;)Laxjv;

    move-result-object v1

    invoke-direct {p1, v0, v2, v3, v1}, Lokhttp3/internal/http/RealResponseBody;-><init>(Ljava/lang/String;JLaxjv;)V
...
.method public writeRequest(Lokhttp3/Headers;Ljava/lang/String;)V
    ...
    invoke-interface {v0, p2}, Laxju;->b(Ljava/lang/String;)Laxju;

    move-result-object p2

    const-string v0, "\r\n"

    invoke-interface {p2, v0}, Laxju;->b(Ljava/lang/String;)Laxju;
    ...
    .line 174
    iget-object v1, p0, Lokhttp3/internal/http1/Http1Codec;->sink:Laxju;

    invoke-virtual {p1, p2}, Lokhttp3/Headers;->name(I)Ljava/lang/String;

    move-result-object v2

    invoke-interface {v1, v2}, Laxju;->b(Ljava/lang/String;)Laxju;
    ...
    .line 179
    :cond_0
    iget-object p1, p0, Lokhttp3/internal/http1/Http1Codec;->sink:Laxju;

    const-string p2, "\r\n"

    invoke-interface {p1, p2}, Laxju;->b(Ljava/lang/String;)Laxju;
