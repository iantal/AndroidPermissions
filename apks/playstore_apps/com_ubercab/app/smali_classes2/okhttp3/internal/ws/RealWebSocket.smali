...
.method public constructor <init>(Lokhttp3/Request;Lokhttp3/WebSocketListener;Ljava/util/Random;J)V
    ...
    invoke-virtual {p1}, Laxjw;->b()Ljava/lang/String;
...
.method private declared-synchronized send(Laxjw;I)Z
    .locals 6
    ...
    invoke-direct {v1, p2, p1}, Lokhttp3/internal/ws/RealWebSocket$Message;-><init>(ILaxjw;)V
...
.method checkResponse(Lokhttp3/Response;)V
    ...
    .line 245
    invoke-virtual {v0}, Laxjw;->d()Laxjw;

    move-result-object v0

    invoke-virtual {v0}, Laxjw;->b()Ljava/lang/String;
...
.method declared-synchronized close(ILjava/lang/String;J)Z
    ...
    .line 418
    invoke-static {p2}, Laxjw;->a(Ljava/lang/String;)Laxjw;
    ...
    invoke-direct {v2, p1, v0, p3, p4}, Lokhttp3/internal/ws/RealWebSocket$Close;-><init>(ILaxjw;J)V
...
.method public initReaderAndWriter(Ljava/lang/String;Lokhttp3/internal/ws/RealWebSocket$Streams;)V
    ...
    iget-object v2, p2, Lokhttp3/internal/ws/RealWebSocket$Streams;->sink:Laxju;

    iget-object v3, p0, Lokhttp3/internal/ws/RealWebSocket;->random:Ljava/util/Random;

    invoke-direct {v0, v1, v2, v3}, Lokhttp3/internal/ws/WebSocketWriter;-><init>(ZLaxju;Ljava/util/Random;)V
    ...
    iget-object p2, p2, Lokhttp3/internal/ws/RealWebSocket$Streams;->source:Laxjv;

    invoke-direct {p1, v0, p2, p0}, Lokhttp3/internal/ws/WebSocketReader;-><init>(ZLaxjv;Lokhttp3/internal/ws/WebSocketReader$FrameCallback;)V
...
.method public onReadMessage(Laxjw;)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-virtual {v0, p0, p1}, Lokhttp3/WebSocketListener;->onMessage(Lokhttp3/WebSocket;Laxjw;)V
...
.method public declared-synchronized onReadPing(Laxjw;)V
    .locals 1
...
.method public declared-synchronized onReadPong(Laxjw;)V
    .locals 0
...
.method declared-synchronized pong(Laxjw;)Z
    .locals 1
...
.method public send(Laxjw;)Z
    ...
    .line 380
    invoke-direct {p0, p1, v0}, Lokhttp3/internal/ws/RealWebSocket;->send(Laxjw;I)Z
...
.method public send(Ljava/lang/String;)Z
    ...
    .line 375
    invoke-static {p1}, Laxjw;->a(Ljava/lang/String;)Laxjw;
...
.method writeOneFrame()Z
    ...
    .line 493
    :try_start_1
    invoke-virtual {v0, v2}, Lokhttp3/internal/ws/WebSocketWriter;->writePong(Laxjw;)V
    ...
    iget-object v1, v1, Lokhttp3/internal/ws/RealWebSocket$Message;->data:Laxjw;
    ...
    .line 497
    invoke-virtual {v0, v2, v5, v6}, Lokhttp3/internal/ws/WebSocketWriter;->newMessageSink(IJ)Laxkn;
    ...
    .line 499
    invoke-interface {v0, v1}, Laxju;->c(Laxjw;)Laxju;
    ...
    iget-object v3, v5, Lokhttp3/internal/ws/RealWebSocket$Close;->reason:Laxjw;

    invoke-virtual {v0, v2, v3}, Lokhttp3/internal/ws/WebSocketWriter;->writeClose(ILaxjw;)V
...
.method writePingFrame()V
    ...
    invoke-virtual {v0, v1}, Lokhttp3/internal/ws/WebSocketWriter;->writePing(Laxjw;)V
    :try_end_1
