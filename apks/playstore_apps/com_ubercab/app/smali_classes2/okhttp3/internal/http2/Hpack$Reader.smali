...
# direct methods
.method constructor <init>(IILaxko;)V
    .locals 1
    ...
    .line 137
    invoke-static {p3}, Laxke;->a(Laxko;)Laxjv;

    move-result-object p1

    iput-object p1, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:Laxjv;

    return-void
.end method

.method constructor <init>(ILaxko;)V
    .locals 0

    .line 131
    invoke-direct {p0, p1, p1, p2}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(IILaxko;)V
...
.method private getName(I)Laxjw;
    .locals 3
    ...
    iget-object p1, p1, Lokhttp3/internal/http2/Header;->name:Laxjw;
...
.method private readByte()I
    ...
    .line 315
    iget-object v0, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:Laxjv;
...
.method private readLiteralHeaderWithIncrementalIndexingIndexedName(I)V
    ...
    .line 250
    invoke-direct {p0, p1}, Lokhttp3/internal/http2/Hpack$Reader;->getName(I)Laxjw;

    move-result-object p1

    .line 251
    invoke-virtual {p0}, Lokhttp3/internal/http2/Hpack$Reader;->readByteString()Laxjw;
    ...
    invoke-direct {v1, p1, v0}, Lokhttp3/internal/http2/Header;-><init>(Laxjw;Laxjw;)V
...
.method private readLiteralHeaderWithIncrementalIndexingNewName()V
    ...
    invoke-static {v0}, Lokhttp3/internal/http2/Hpack;->checkLowercase(Laxjw;)Laxjw;
    ...
    invoke-direct {v2, v0, v1}, Lokhttp3/internal/http2/Header;-><init>(Laxjw;Laxjw;)V
...
.method private readLiteralHeaderWithoutIndexingIndexedName(I)V
    ...
    invoke-direct {v2, p1, v0}, Lokhttp3/internal/http2/Header;-><init>(Laxjw;Laxjw;)V
...
.method private readLiteralHeaderWithoutIndexingNewName()V
    ...
    invoke-direct {v3, v0, v1}, Lokhttp3/internal/http2/Header;-><init>(Laxjw;Laxjw;)V
...
.method readByteString()Laxjw;
    ...
    iget-object v2, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:Laxjv;

    int-to-long v3, v0

    invoke-interface {v2, v3, v4}, Laxjv;->h(J)[B
    ...
    .line 349
    :cond_1
    iget-object v1, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:Laxjv;

    int-to-long v2, v0

    invoke-interface {v1, v2, v3}, Laxjv;->d(J)Laxjw;
