...
.method constructor <init>(Lokhttp3/internal/http2/Http2Connection$Builder;)V
    ...
    iget-object v3, v1, Lokhttp3/internal/http2/Http2Connection$Builder;->sink:Laxju;

    iget-boolean v4, v0, Lokhttp3/internal/http2/Http2Connection;->client:Z

    invoke-direct {v2, v3, v4}, Lokhttp3/internal/http2/Http2Writer;-><init>(Laxju;Z)V
    ...
    iget-object v1, v1, Lokhttp3/internal/http2/Http2Connection$Builder;->source:Laxjv;

    iget-boolean v4, v0, Lokhttp3/internal/http2/Http2Connection;->client:Z

    invoke-direct {v3, v1, v4}, Lokhttp3/internal/http2/Http2Reader;-><init>(Laxjv;Z)V
...
.method pushDataLater(ILaxjv;IZ)V
    .locals 9
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 887
    invoke-interface {p2, v0, v1}, Laxjv;->a(J)V

    .line 888
    invoke-interface {p2, v5, v0, v1}, Laxjv;->read(Laxjs;J)J
    ...
    invoke-direct/range {v0 .. v7}, Lokhttp3/internal/http2/Http2Connection$5;-><init>(Lokhttp3/internal/http2/Http2Connection;Ljava/lang/String;[Ljava/lang/Object;ILaxjs;IZ)V
...
.method public writeData(IZLaxjs;J)V
    .locals 8
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-virtual {p4, p2, p1, p3, v3}, Lokhttp3/internal/http2/Http2Writer;->data(ZILaxjs;I)V
    ...
    :goto_2
    invoke-virtual {v4, v5, p1, p3, v2}, Lokhttp3/internal/http2/Http2Writer;->data(ZILaxjs;I)V
