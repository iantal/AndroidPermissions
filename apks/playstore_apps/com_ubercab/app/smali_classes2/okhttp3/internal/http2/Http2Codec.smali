...
# static fields
.field private static final CONNECTION:Laxjw;

.field private static final ENCODING:Laxjw;

.field private static final HOST:Laxjw;
...
.field private static final KEEP_ALIVE:Laxjw;

.field private static final PROXY_CONNECTION:Laxjw;

.field private static final TE:Laxjw;

.field private static final TRANSFER_ENCODING:Laxjw;

.field private static final UPGRADE:Laxjw;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lokhttp3/internal/http2/Http2Codec;->CONNECTION:Laxjw;
    ...
    sput-object v0, Lokhttp3/internal/http2/Http2Codec;->HOST:Laxjw;
    ...
    sput-object v0, Lokhttp3/internal/http2/Http2Codec;->KEEP_ALIVE:Laxjw;
    ...
    sput-object v0, Lokhttp3/internal/http2/Http2Codec;->PROXY_CONNECTION:Laxjw;
    ...
    sput-object v0, Lokhttp3/internal/http2/Http2Codec;->TRANSFER_ENCODING:Laxjw;
    ...
    sput-object v0, Lokhttp3/internal/http2/Http2Codec;->TE:Laxjw;
    ...
    sput-object v0, Lokhttp3/internal/http2/Http2Codec;->ENCODING:Laxjw;
    ...
    sput-object v0, Lokhttp3/internal/http2/Http2Codec;->UPGRADE:Laxjw;

    const/16 v0, 0xc

    .line 65
    new-array v0, v0, [Laxjw;

    sget-object v1, Lokhttp3/internal/http2/Http2Codec;->CONNECTION:Laxjw;

    const/4 v2, 0x0

    aput-object v1, v0, v2

    sget-object v1, Lokhttp3/internal/http2/Http2Codec;->HOST:Laxjw;

    const/4 v3, 0x1

    aput-object v1, v0, v3

    sget-object v1, Lokhttp3/internal/http2/Http2Codec;->KEEP_ALIVE:Laxjw;

    const/4 v4, 0x2

    aput-object v1, v0, v4

    sget-object v1, Lokhttp3/internal/http2/Http2Codec;->PROXY_CONNECTION:Laxjw;

    const/4 v5, 0x3

    aput-object v1, v0, v5

    sget-object v1, Lokhttp3/internal/http2/Http2Codec;->TE:Laxjw;

    const/4 v6, 0x4

    aput-object v1, v0, v6

    sget-object v1, Lokhttp3/internal/http2/Http2Codec;->TRANSFER_ENCODING:Laxjw;

    const/4 v7, 0x5

    aput-object v1, v0, v7

    sget-object v1, Lokhttp3/internal/http2/Http2Codec;->ENCODING:Laxjw;

    const/4 v8, 0x6

    aput-object v1, v0, v8

    sget-object v1, Lokhttp3/internal/http2/Http2Codec;->UPGRADE:Laxjw;

    const/4 v9, 0x7

    aput-object v1, v0, v9

    sget-object v1, Lokhttp3/internal/http2/Header;->TARGET_METHOD:Laxjw;

    const/16 v10, 0x8

    aput-object v1, v0, v10

    sget-object v1, Lokhttp3/internal/http2/Header;->TARGET_PATH:Laxjw;

    const/16 v11, 0x9

    aput-object v1, v0, v11

    sget-object v1, Lokhttp3/internal/http2/Header;->TARGET_SCHEME:Laxjw;

    const/16 v11, 0xa

    aput-object v1, v0, v11

    sget-object v1, Lokhttp3/internal/http2/Header;->TARGET_AUTHORITY:Laxjw;
...
.method public static http2HeadersList(Lokhttp3/Request;)Ljava/util/List;
    ...
    sget-object v3, Lokhttp3/internal/http2/Header;->TARGET_METHOD:Laxjw;

    invoke-virtual {p0}, Lokhttp3/Request;->method()Ljava/lang/String;

    move-result-object v4

    invoke-direct {v2, v3, v4}, Lokhttp3/internal/http2/Header;-><init>(Laxjw;Ljava/lang/String;)V
    ...
    sget-object v3, Lokhttp3/internal/http2/Header;->TARGET_PATH:Laxjw;
    ...
    sget-object v4, Lokhttp3/internal/http2/Header;->TARGET_AUTHORITY:Laxjw;

    invoke-direct {v3, v4, v2}, Lokhttp3/internal/http2/Header;-><init>(Laxjw;Ljava/lang/String;)V
    ...
    sget-object v3, Lokhttp3/internal/http2/Header;->TARGET_SCHEME:Laxjw;
    ...
    invoke-direct {v2, v3, p0}, Lokhttp3/internal/http2/Header;-><init>(Laxjw;Ljava/lang/String;)V
    ...
    invoke-static {v3}, Laxjw;->a(Ljava/lang/String;)Laxjw;
    ...
    invoke-direct {v4, v3, v5}, Lokhttp3/internal/http2/Header;-><init>(Laxjw;Ljava/lang/String;)V
...
.method public static readHttp2HeadersList(Ljava/util/List;)Lokhttp3/Response$Builder;
    ...
    .line 171
    :cond_0
    iget-object v6, v5, Lokhttp3/internal/http2/Header;->name:Laxjw;

    .line 172
    iget-object v5, v5, Lokhttp3/internal/http2/Header;->value:Laxjw;

    invoke-virtual {v5}, Laxjw;->a()Ljava/lang/String;

    move-result-object v5

    .line 173
    sget-object v7, Lokhttp3/internal/http2/Header;->RESPONSE_STATUS:Laxjw;

    invoke-virtual {v6, v7}, Laxjw;->equals(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v6}, Laxjw;->a()Ljava/lang/String;
...
.method public createRequestBody(Lokhttp3/Request;J)Laxkn;
    .locals 0

    .line 103
    iget-object p1, p0, Lokhttp3/internal/http2/Http2Codec;->stream:Lokhttp3/internal/http2/Http2Stream;

    invoke-virtual {p1}, Lokhttp3/internal/http2/Http2Stream;->getSink()Laxkn;
...
.method public finishRequest()V
    ...
    invoke-virtual {v0}, Lokhttp3/internal/http2/Http2Stream;->getSink()Laxkn;

    move-result-object v0

    invoke-interface {v0}, Laxkn;->close()V
...
.method public openResponseBody(Lokhttp3/Response;)Lokhttp3/ResponseBody;
    ...
    invoke-virtual {v3}, Lokhttp3/internal/http2/Http2Stream;->getSource()Laxko;

    move-result-object v3

    invoke-direct {p1, p0, v3}, Lokhttp3/internal/http2/Http2Codec$StreamFinishingSource;-><init>(Lokhttp3/internal/http2/Http2Codec;Laxko;)V
    ...
    invoke-direct {v3, v0, v1, v2, p1}, Lokhttp3/internal/http/RealResponseBody;-><init>(Ljava/lang/String;JLaxjv;)V
...
.method public writeRequestHeaders(Lokhttp3/Request;)V
    ...
    invoke-virtual {p1}, Lokhttp3/internal/http2/Http2Stream;->readTimeout()Laxkp;
    ...
    invoke-virtual {p1, v0, v1, v2}, Laxkp;->timeout(JLjava/util/concurrent/TimeUnit;)Laxkp;

    .line 113
    iget-object p1, p0, Lokhttp3/internal/http2/Http2Codec;->stream:Lokhttp3/internal/http2/Http2Stream;

    invoke-virtual {p1}, Lokhttp3/internal/http2/Http2Stream;->writeTimeout()Laxkp;
