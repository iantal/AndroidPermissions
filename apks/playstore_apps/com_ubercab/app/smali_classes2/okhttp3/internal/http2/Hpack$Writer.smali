...
# direct methods
.method constructor <init>(IZLaxjs;)V
    .locals 1
    ...
    .line 404
    iput-object p3, p0, Lokhttp3/internal/http2/Hpack$Writer;->out:Laxjs;
...
.method constructor <init>(Laxjs;)V
    ...
    .line 397
    invoke-direct {p0, v0, v1, p1}, Lokhttp3/internal/http2/Hpack$Writer;-><init>(IZLaxjs;)V
...
.method writeByteString(Laxjw;)V
    .locals 3
    ...
    invoke-virtual {v0, p1}, Lokhttp3/internal/http2/Huffman;->encodedLength(Laxjw;)I
    ...
    invoke-virtual {v2, p1, v0}, Lokhttp3/internal/http2/Huffman;->encode(Laxjw;Laxju;)V
    ...
    .line 557
    iget-object v0, p0, Lokhttp3/internal/http2/Hpack$Writer;->out:Laxjs;
...
.method writeHeaders(Ljava/util/List;)V
    ...
    .line 473
    iget-object v4, v3, Lokhttp3/internal/http2/Header;->name:Laxjw;

    invoke-virtual {v4}, Laxjw;->g()Laxjw;

    move-result-object v4

    .line 474
    iget-object v5, v3, Lokhttp3/internal/http2/Header;->value:Laxjw;
    ...
    iget-object v9, v9, Lokhttp3/internal/http2/Header;->value:Laxjw;
    ...
    iget-object v11, v11, Lokhttp3/internal/http2/Header;->name:Laxjw;
    ...
    iget-object v11, v11, Lokhttp3/internal/http2/Header;->value:Laxjw;
    ...
    .line 512
    iget-object v7, p0, Lokhttp3/internal/http2/Hpack$Writer;->out:Laxjs;

    invoke-virtual {v7, v6}, Laxjs;->b(I)Laxjs;

    .line 513
    invoke-virtual {p0, v4}, Lokhttp3/internal/http2/Hpack$Writer;->writeByteString(Laxjw;)V

    .line 514
    invoke-virtual {p0, v5}, Lokhttp3/internal/http2/Hpack$Writer;->writeByteString(Laxjw;)V
    ...
    .line 516
    :cond_9
    sget-object v7, Lokhttp3/internal/http2/Header;->PSEUDO_PREFIX:Laxjw;

    invoke-virtual {v4, v7}, Laxjw;->a(Laxjw;)Z

    move-result v7

    if-eqz v7, :cond_a

    sget-object v7, Lokhttp3/internal/http2/Header;->TARGET_AUTHORITY:Laxjw;

    invoke-virtual {v7, v4}, Laxjw;->equals(Ljava/lang/Object;)Z
...
.method writeInt(III)V
    ...
    .line 534
    iget-object p2, p0, Lokhttp3/internal/http2/Hpack$Writer;->out:Laxjs;

    or-int/2addr p1, p3

    invoke-virtual {p2, p1}, Laxjs;->b(I)Laxjs;
    ...
    invoke-virtual {v0, p3}, Laxjs;->b(I)Laxjs;
    ...
    invoke-virtual {v0, p2}, Laxjs;->b(I)Laxjs;
