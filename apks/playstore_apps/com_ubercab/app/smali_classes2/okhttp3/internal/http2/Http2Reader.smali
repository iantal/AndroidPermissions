...
.field private final source:Laxjv;
...
.method constructor <init>(Laxjv;Z)V
    .locals 1
    ...
    .line 71
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Laxjv;
    ...
    iget-object p2, p0, Lokhttp3/internal/http2/Http2Reader;->source:Laxjv;

    invoke-direct {p1, p2}, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;-><init>(Laxjv;)V
    ...
    invoke-direct {p1, v0, p2}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(ILaxko;)V
...
.method private readData(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 211
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Reader;->source:Laxjv;
    ...
    .line 214
    iget-object p3, p0, Lokhttp3/internal/http2/Http2Reader;->source:Laxjv;

    invoke-interface {p1, v1, p4, p3, p2}, Lokhttp3/internal/http2/Http2Reader$Handler;->data(ZILaxjv;I)V

    .line 215
    iget-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Laxjv;

    int-to-long p2, v0

    invoke-interface {p1, p2, p3}, Laxjv;->i(J)V
...
.method private readGoAway(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 319
    iget-object p4, p0, Lokhttp3/internal/http2/Http2Reader;->source:Laxjv;

    invoke-interface {p4}, Laxjv;->k()I

    move-result p4

    .line 320
    iget-object v2, p0, Lokhttp3/internal/http2/Http2Reader;->source:Laxjv;

    invoke-interface {v2}, Laxjv;->k()I
    ...
    invoke-interface {p3, v1, v2}, Laxjv;->d(J)Laxjw;

    move-result-object p3

    .line 330
    :cond_0
    invoke-interface {p1, p4, v0, p3}, Lokhttp3/internal/http2/Http2Reader$Handler;->goAway(ILokhttp3/internal/http2/ErrorCode;Laxjw;)V
...
.method static readMedium(Laxjv;)I
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method private readPriority(Lokhttp3/internal/http2/Http2Reader$Handler;I)V
    ...
    .line 229
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Reader;->source:Laxjv;
...
.method private readPushPromise(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 298
    :cond_0
    iget-object v1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Laxjv;

    invoke-interface {v1}, Laxjv;->k()I
...
.method public nextFrame(ZLokhttp3/internal/http2/Http2Reader$Handler;)Z
    ...
    invoke-interface {v1, v2, v3}, Laxjv;->a(J)V
    :try_end_0
    ...
    invoke-static {v1}, Lokhttp3/internal/http2/Http2Reader;->readMedium(Laxjv;)I
    ...
    invoke-interface {p1, v0, v1}, Laxjv;->i(J)V
...
.method public readConnectionPreface(Lokhttp3/internal/http2/Http2Reader$Handler;)V
    ...
    sget-object v0, Lokhttp3/internal/http2/Http2;->CONNECTION_PREFACE:Laxjw;
    ...
    invoke-interface {p1, v3, v4}, Laxjv;->d(J)Laxjw;
    ...
    invoke-virtual {v0, p1}, Laxjw;->equals(Ljava/lang/Object;)Z
