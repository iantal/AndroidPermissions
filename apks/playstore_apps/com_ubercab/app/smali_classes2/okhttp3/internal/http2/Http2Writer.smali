...
.field private final hpackBuffer:Laxjs;

.field final hpackWriter:Lokhttp3/internal/http2/Hpack$Writer;

.field private maxFrameSize:I

.field private final sink:Laxju;
...
.method constructor <init>(Laxju;Z)V
    .locals 0
    ...
    .line 58
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Laxju;

    .line 59
    iput-boolean p2, p0, Lokhttp3/internal/http2/Http2Writer;->client:Z

    .line 60
    new-instance p1, Laxjs;

    invoke-direct {p1}, Laxjs;-><init>()V

    iput-object p1, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Laxjs;

    .line 61
    new-instance p1, Lokhttp3/internal/http2/Hpack$Writer;

    iget-object p2, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Laxjs;

    invoke-direct {p1, p2}, Lokhttp3/internal/http2/Hpack$Writer;-><init>(Laxjs;)V
...
.method private writeContinuationFrames(IJ)V
    ...
    .line 293
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Laxju;

    iget-object v1, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Laxjs;

    invoke-interface {v0, v1, v3, v4}, Laxju;->write(Laxjs;J)V
...
.method private static writeMedium(Laxju;I)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 283
    invoke-interface {p0, v0}, Laxju;->k(I)Laxju;
    ...
    .line 285
    invoke-interface {p0, p1}, Laxju;->k(I)Laxju;
...
.method public declared-synchronized applyAndAckSettings(Lokhttp3/internal/http2/Settings;)V
    ...
    .line 87
    iget-object p1, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Laxju;
...
.method public declared-synchronized connectionPreface()V
    ...
    sget-object v4, Lokhttp3/internal/http2/Http2;->CONNECTION_PREFACE:Laxjw;

    invoke-virtual {v4}, Laxjw;->f()Ljava/lang/String;
    ...
    sget-object v1, Lokhttp3/internal/http2/Http2;->CONNECTION_PREFACE:Laxjw;

    invoke-virtual {v1}, Laxjw;->i()[B

    move-result-object v1

    invoke-interface {v0, v1}, Laxju;->c([B)Laxju;
...
.method public declared-synchronized data(ZILaxjs;I)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 173
    :cond_0
    invoke-virtual {p0, p2, v0, p3, p4}, Lokhttp3/internal/http2/Http2Writer;->dataFrame(IBLaxjs;I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method dataFrame(IBLaxjs;I)V
    ...
    invoke-interface {p1, p3, v0, v1}, Laxju;->write(Laxjs;J)V
...
.method public frameHeader(IIBB)V
    ...
    invoke-static {v0, p2}, Lokhttp3/internal/http2/Http2Writer;->writeMedium(Laxju;I)V

    .line 272
    iget-object p2, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Laxju;
    ...
    invoke-interface {p2, p1}, Laxju;->i(I)Laxju;
...
.method public declared-synchronized goAway(ILokhttp3/internal/http2/ErrorCode;[B)V
    ...
    invoke-interface {v0, p1}, Laxju;->i(I)Laxju;
    ...
    invoke-interface {p1, p2}, Laxju;->i(I)Laxju;
    ...
    invoke-interface {p1, p3}, Laxju;->c([B)Laxju;
...
.method headers(ZILjava/util/List;)V
    ...
    .line 301
    iget-object p3, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Laxjs;

    invoke-virtual {p3}, Laxjs;->a()J
    ...
    invoke-interface {p1, p3, v2, v3}, Laxju;->write(Laxjs;J)V
...
.method public declared-synchronized ping(ZII)V
    ...
    invoke-interface {p1, p3}, Laxju;->i(I)Laxju;
...
.method public declared-synchronized pushPromise(IILjava/util/List;)V
    ...
    .line 113
    iget-object p3, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Laxju;

    const v2, 0x7fffffff

    and-int/2addr p2, v2

    invoke-interface {p3, p2}, Laxju;->i(I)Laxju;
    ...
    invoke-interface {p2, p3, v4, v5}, Laxju;->write(Laxjs;J)V
...
.method public declared-synchronized settings(Lokhttp3/internal/http2/Settings;)V
    ...
    .line 200
    :goto_1
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Laxju;

    invoke-interface {v3, v0}, Laxju;->j(I)Laxju;
    ...
    invoke-interface {v0, v3}, Laxju;->i(I)Laxju;
