...
.method private findConnection(IIIIZ)Lokhttp3/internal/connection/RealConnection;
    ...
    invoke-virtual {v0, v7}, Lokhttp3/internal/connection/RealConnection;->setPooled(Z)V
    ...
    .line 214
    iget-object v4, v1, Lokhttp3/internal/connection/StreamAllocation;->routeSelection:Lokhttp3/internal/connection/RouteSelector$Selection;
    ...
    .line 216
    :cond_7
    iget-object v4, v1, Lokhttp3/internal/connection/StreamAllocation;->routeSelector:Lokhttp3/internal/connection/RouteSelector;
    ...
    iput-object v4, v1, Lokhttp3/internal/connection/StreamAllocation;->routeSelection:Lokhttp3/internal/connection/RouteSelector$Selection;
    ...
    .line 220
    :try_start_1
    iget-boolean v11, v1, Lokhttp3/internal/connection/StreamAllocation;->canceled:Z
    ...
    invoke-virtual {v4}, Lokhttp3/internal/connection/RouteSelector$Selection;->getAll()Ljava/util/List;
    ...
    check-cast v13, Lokhttp3/Route;

    .line 228
    sget-object v14, Lokhttp3/internal/Internal;->instance:Lokhttp3/internal/Internal;

    iget-object v15, v1, Lokhttp3/internal/connection/StreamAllocation;->connectionPool:Lokhttp3/ConnectionPool;

    iget-object v5, v1, Lokhttp3/internal/connection/StreamAllocation;->address:Lokhttp3/Address;

    invoke-virtual {v14, v15, v5, v1, v13}, Lokhttp3/internal/Internal;->get(Lokhttp3/ConnectionPool;Lokhttp3/Address;Lokhttp3/internal/connection/StreamAllocation;Lokhttp3/Route;)Lokhttp3/internal/connection/RealConnection;
    ...
    .line 232
    iput-object v13, v1, Lokhttp3/internal/connection/StreamAllocation;->route:Lokhttp3/Route;
    ...
    .line 243
    :cond_b
    invoke-virtual {v9}, Lokhttp3/Route;->timing()Lokhttp3/Timing;

    move-result-object v4

    .line 244
    invoke-virtual {v4, v2, v3}, Lokhttp3/Timing;->startTimeMillis(J)Lokhttp3/Timing;
    ...
    invoke-virtual {v2, v3, v4}, Lokhttp3/Timing;->endTimeMillis(J)Lokhttp3/Timing;

    .line 249
    iput-object v9, v1, Lokhttp3/internal/connection/StreamAllocation;->route:Lokhttp3/Route;

    .line 250
    iput v6, v1, Lokhttp3/internal/connection/StreamAllocation;->refusedStreamCount:I
    ...
    .line 252
    invoke-virtual {v1, v8, v6}, Lokhttp3/internal/connection/StreamAllocation;->acquire(Lokhttp3/internal/connection/RealConnection;Z)V
    ...
    invoke-virtual/range {v17 .. v24}, Lokhttp3/internal/connection/RealConnection;->connect(IIIIZLokhttp3/Call;Lokhttp3/EventListener;)V
