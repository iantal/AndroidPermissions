...
.field public negotiateProtocol:Ljava/lang/String;
...
.field private sink:Laxju;

.field private socket:Ljava/net/Socket;

.field private source:Laxjv;

.field public successCount:I

.field private final timing:Lokhttp3/Timing;
...
.method public constructor <init>(Lokhttp3/ConnectionPool;Lokhttp3/Route;)V
    ...
    .line 82
    new-instance v0, Lokhttp3/Timing;

    invoke-direct {v0}, Lokhttp3/Timing;-><init>()V

    iput-object v0, p0, Lokhttp3/internal/connection/RealConnection;->timing:Lokhttp3/Timing;
...
.method private connectSocket(IILokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    invoke-static {p1}, Laxke;->b(Ljava/net/Socket;)Laxko;
    ...
    iput-object p1, p0, Lokhttp3/internal/connection/RealConnection;->source:Laxjv;

    .line 261
    iget-object p1, p0, Lokhttp3/internal/connection/RealConnection;->rawSocket:Ljava/net/Socket;

    invoke-static {p1}, Laxke;->a(Ljava/net/Socket;)Laxkn;
    ...
    iput-object p1, p0, Lokhttp3/internal/connection/RealConnection;->sink:Laxju;
    :try_end_1
...
.method private connectTls(Lokhttp3/internal/connection/ConnectionSpecSelector;)V
    ...
    .line 329
    invoke-virtual {v5, v2, v7}, Lokhttp3/CertificatePinner;->check(Ljava/lang/String;Ljava/util/List;)V
    ...
    .line 338
    iput-object v4, p0, Lokhttp3/internal/connection/RealConnection;->negotiateProtocol:Ljava/lang/String;
    ...
    invoke-virtual {p1}, Lokhttp3/Handshake;->timing()Lokhttp3/Timing;

    move-result-object p1

    invoke-virtual {p1, v0, v1}, Lokhttp3/Timing;->startTimeMillis(J)Lokhttp3/Timing;
    ...
    invoke-virtual {p1, v0, v1}, Lokhttp3/Timing;->endTimeMillis(J)Lokhttp3/Timing;
    :try_end_1
...
.method private connectTunnel(IIILokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    .line 229
    iput-object v3, p0, Lokhttp3/internal/connection/RealConnection;->sink:Laxju;

    .line 230
    iput-object v3, p0, Lokhttp3/internal/connection/RealConnection;->source:Laxjv;
...
.method private createTunnel(IILokhttp3/Request;Lokhttp3/HttpUrl;)Lokhttp3/Request;
    ...
    iget-object v1, p0, Lokhttp3/internal/connection/RealConnection;->source:Laxjv;

    iget-object v2, p0, Lokhttp3/internal/connection/RealConnection;->sink:Laxju;

    const/4 v3, 0x0

    invoke-direct {v0, v3, v3, v1, v2}, Lokhttp3/internal/http1/Http1Codec;-><init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/StreamAllocation;Laxjv;Laxju;)V

    .line 379
    iget-object v1, p0, Lokhttp3/internal/connection/RealConnection;->source:Laxjv;

    invoke-interface {v1}, Laxjv;->timeout()Laxkp;
    ...
    invoke-virtual {v1, v4, v5, v2}, Laxkp;->timeout(JLjava/util/concurrent/TimeUnit;)Laxkp;

    .line 380
    iget-object v1, p0, Lokhttp3/internal/connection/RealConnection;->sink:Laxju;

    invoke-interface {v1}, Laxju;->timeout()Laxkp;
    ...
    .line 392
    :cond_0
    invoke-virtual {v0, v1, v2}, Lokhttp3/internal/http1/Http1Codec;->newFixedLengthSource(J)Laxko;
    ...
    invoke-static {v0, v1, v2}, Lokhttp3/internal/Util;->skipAll(Laxko;ILjava/util/concurrent/TimeUnit;)Z

    .line 394
    invoke-interface {v0}, Laxko;->close()V
    ...
    .line 402
    :cond_4
    iget-object p1, p0, Lokhttp3/internal/connection/RealConnection;->source:Laxjv;

    invoke-interface {p1}, Laxjv;->b()Laxjs;

    move-result-object p1

    invoke-virtual {p1}, Laxjs;->f()Z

    move-result p1

    if-eqz p1, :cond_5

    iget-object p1, p0, Lokhttp3/internal/connection/RealConnection;->sink:Laxju;

    invoke-interface {p1}, Laxju;->b()Laxjs;
...
.method private establishProtocol(Lokhttp3/internal/connection/ConnectionSpecSelector;ILokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    iget-object v0, p0, Lokhttp3/internal/connection/RealConnection;->source:Laxjv;

    iget-object v1, p0, Lokhttp3/internal/connection/RealConnection;->sink:Laxju;

    invoke-virtual {p1, p3, p4, v0, v1}, Lokhttp3/internal/http2/Http2Connection$Builder;->socket(Ljava/net/Socket;Ljava/lang/String;Laxjv;Laxju;)Lokhttp3/internal/http2/Http2Connection$Builder;
...
.method public connect(IIIIZLokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    .line 140
    iget-object v0, v7, Lokhttp3/internal/connection/RealConnection;->timing:Lokhttp3/Timing;

    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    move-result-wide v1

    invoke-virtual {v0, v1, v2}, Lokhttp3/Timing;->startTimeMillis(J)Lokhttp3/Timing;
    ...
    invoke-virtual {v0, v1, v2}, Lokhttp3/Timing;->endTimeMillis(J)Lokhttp3/Timing;
    ...
    .line 177
    iput-object v11, v7, Lokhttp3/internal/connection/RealConnection;->source:Laxjv;

    .line 178
    iput-object v11, v7, Lokhttp3/internal/connection/RealConnection;->sink:Laxju;
...
.method public isPooled()Z
    ...
    .line 539
    iget-boolean v0, p0, Lokhttp3/internal/connection/RealConnection;->isPooled:Z
...
.method public negotiateProtocol()Ljava/lang/String;
    ...
    .line 603
    iget-object v0, p0, Lokhttp3/internal/connection/RealConnection;->negotiateProtocol:Ljava/lang/String;
...
.method public newCodec(Lokhttp3/OkHttpClient;Lokhttp3/Interceptor$Chain;Lokhttp3/internal/connection/StreamAllocation;)Lokhttp3/internal/http/HttpCodec;
    ...
    invoke-virtual {v0, v1, v2, v3}, Laxkp;->timeout(JLjava/util/concurrent/TimeUnit;)Laxkp;

    .line 504
    iget-object v0, p0, Lokhttp3/internal/connection/RealConnection;->sink:Laxju;
    ...
    invoke-virtual {v0, v1, v2, p2}, Laxkp;->timeout(JLjava/util/concurrent/TimeUnit;)Laxkp;
    ...
    invoke-direct {p2, p1, p3, v0, v1}, Lokhttp3/internal/http1/Http1Codec;-><init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/StreamAllocation;Laxjv;Laxju;)V
...
.method public newWebSocketStreams(Lokhttp3/internal/connection/StreamAllocation;)Lokhttp3/internal/ws/RealWebSocket$Streams;
    ...
    iget-object v3, p0, Lokhttp3/internal/connection/RealConnection;->source:Laxjv;

    iget-object v4, p0, Lokhttp3/internal/connection/RealConnection;->sink:Laxju;
    ...
    invoke-direct/range {v0 .. v5}, Lokhttp3/internal/connection/RealConnection$1;-><init>(Lokhttp3/internal/connection/RealConnection;ZLaxjv;Laxju;Lokhttp3/internal/connection/StreamAllocation;)V
...
.method public setPooled(Z)V
    ...
    .line 518
    iput-boolean p1, p0, Lokhttp3/internal/connection/RealConnection;->isPooled:Z
...
.method public timing()Lokhttp3/Timing;
    ...
    .line 535
    iget-object v0, p0, Lokhttp3/internal/connection/RealConnection;->timing:Lokhttp3/Timing;
...
.method public toString()Ljava/lang/String;
    ...
    const-string v1, " negotiateProtocol="

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v1, p0, Lokhttp3/internal/connection/RealConnection;->negotiateProtocol:Ljava/lang/String;
