...
.method public constructor <init>(Lobz;Landroid/os/Handler;)V
    ...
    .line 42
    iput-object p1, p0, Lnyd;->b:Lobz;

    .line 43
    iput-object p2, p0, Lnyd;->a:Landroid/os/Handler;
...
# virtual methods
.method public a(Landroid/content/Context;Landroid/location/LocationManager;Lnyr;)Lio/reactivex/Flowable;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v1, p0, Lnyd;->b:Lobz;

    iget-object v2, p0, Lnyd;->a:Landroid/os/Handler;

    invoke-direct {v0, v1, v2}, Locg;-><init>(Lobz;Landroid/os/Handler;)V

    .line 62
    invoke-virtual {v0, p1, p2}, Locg;->a(Landroid/content/Context;Landroid/location/LocationManager;)Z
    ...
    .line 67
    :cond_0
    new-instance p1, Lnyd$1;

    invoke-direct {p1, p0, v0, p2, p3}, Lnyd$1;-><init>(Lnyd;Locg;Landroid/location/LocationManager;Lnyr;)V
