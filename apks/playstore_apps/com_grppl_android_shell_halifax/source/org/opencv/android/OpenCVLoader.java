...
public class OpenCVLoader
{
  ...
  public static boolean initAsync(String paramString, Context paramContext, LoaderCallbackInterface paramLoaderCallbackInterface)
  {
    return AsyncServiceHelper.initOpenCV(paramString, paramContext, paramLoaderCallbackInterface);
  }
  ...
  public static boolean initDebug(boolean paramBoolean)
  {
    return StaticHelper.initOpenCV(paramBoolean);
  }
}
