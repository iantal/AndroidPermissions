    ...
    throws ChecksumException
  {
    ...
    for (;;)
    {
      ...
      while (paramModulusPoly1.getDegree() >= paramInt / 2)
      {
        ...
        localObject = localModulusPoly2.multiply(localModulusPoly1).subtract((ModulusPoly)localObject).negative();
        localModulusPoly2 = paramModulusPoly1;
        paramModulusPoly1 = paramModulusPoly2;
        paramModulusPoly2 = (ModulusPoly)localObject;
        localObject = localModulusPoly1;
        localModulusPoly1 = paramModulusPoly2;
        paramModulusPoly2 = localModulusPoly2;
      }
      paramInt = localModulusPoly1.getCoefficient(0);
      if (paramInt == 0) {
        throw ChecksumException.getChecksumInstance();
      }
      paramInt = this.field.inverse(paramInt);
      return new ModulusPoly[] { localModulusPoly1.multiply(paramInt), paramModulusPoly1.multiply(paramInt) };
