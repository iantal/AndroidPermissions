...
public final class PerspectiveTransform
{
  ...
  public static PerspectiveTransform squareToQuadrilateral(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, float paramFloat5, float paramFloat6, float paramFloat7, float paramFloat8)
  {
    ...
    return new PerspectiveTransform(paramFloat3 - paramFloat1 + f4 * paramFloat3, paramFloat7 - paramFloat1 + paramFloat5 * paramFloat7, paramFloat1, paramFloat4 - paramFloat2 + f4 * paramFloat4, paramFloat8 - paramFloat2 + paramFloat5 * paramFloat8, paramFloat2, f4, paramFloat5, 1.0F);
  }
