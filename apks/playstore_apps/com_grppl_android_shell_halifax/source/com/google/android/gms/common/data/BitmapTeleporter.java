  ...
  implements ReflectedParcelable
{
  ...
  BitmapTeleporter(int paramInt1, ParcelFileDescriptor paramParcelFileDescriptor, int paramInt2)
  {
    ...
    this.zzSn = paramParcelFileDescriptor;
    this.zzanR = paramInt2;
    this.zzaCg = null;
    this.zzaCh = false;
  }
  ...
  public Bitmap zzwz()
  {
    Object localObject1;
    if (!this.zzaCh) {
      localObject1 = new DataInputStream(new ParcelFileDescriptor.AutoCloseInputStream(this.zzSn));
    }
    try
    {
      ...
      this.zzaCg = ((Bitmap)localObject2);
      this.zzaCh = true;
      return this.zzaCg;
    }
    catch (IOException localIOException)
