  ...
  extends IInterface
{
    ...
    implements ILocationSourceDelegate
  {
    ...
    public static ILocationSourceDelegate zzdw(IBinder paramIBinder)
    {
      ...
      throws RemoteException
    {
      ...
      case 1: 
        ...
        activate(zzp.zza.zzdK(paramParcel1.readStrongBinder()));
      ...
      implements ILocationSourceDelegate
    {
        ...
        throws RemoteException
      {
        ...
        //   30: aload_0
        //   31: getfield 18	com/google/android/gms/maps/internal/ILocationSourceDelegate$zza$zza:zzrp	Landroid/os/IBinder;
        //   34: iconst_1
        //   35: aload_2
        //   36: aload_3
        //   37: iconst_0
