...
public final class zzh
{
  ...
  public static String zzaB(Context paramContext)
  {
    ...
    try
    {
      str1 = zzacx.zzaQ(paramContext).zzdE(paramContext.getPackageName()).toString();
      return str1;
    }
  ...
  {
    if (paramInt == 6) {
      return zzg(paramContext, "common_google_play_services_resolution_required_text", zzaB(paramContext));
    }
  ...
  private static String zzu(Context paramContext, String paramString)
  {
    ...
    synchronized (zzaEg)
    {
      String str = (String)zzaEg.get(paramString);
      if (str != null) {
        return str;
      }
    ...
    zzaEg.put(paramString, paramContext);
    return paramContext;
  }
}
