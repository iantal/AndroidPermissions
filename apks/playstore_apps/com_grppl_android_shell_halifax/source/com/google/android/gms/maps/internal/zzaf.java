  ...
  extends IInterface
{
    ...
    implements zzaf
  {
    ...
    public static zzaf zzea(IBinder paramIBinder)
    {
      ...
      throws RemoteException
    {
      ...
      zza(IStreetViewPanoramaDelegate.zza.zzed(paramParcel1.readStrongBinder()));
      ...
      implements zzaf
    {
        ...
        throws RemoteException
      {
        ...
        //   30: aload_0
        //   31: getfield 18	com/google/android/gms/maps/internal/zzaf$zza$zza:zzrp	Landroid/os/IBinder;
        //   34: iconst_1
        //   35: aload_2
        //   36: aload_3
        //   37: iconst_0
