...
public final class BitmapDescriptorFactory
{
  ...
  public static BitmapDescriptor defaultMarker()
  {
    try
    {
      BitmapDescriptor localBitmapDescriptor = new BitmapDescriptor(zzIS().zzIY());
  ...
  public static BitmapDescriptor defaultMarker(float paramFloat)
  {
    try
    {
      BitmapDescriptor localBitmapDescriptor = new BitmapDescriptor(zzIS().zzi(paramFloat));
      return localBitmapDescriptor;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public static BitmapDescriptor fromAsset(String paramString)
  {
    try
    {
      paramString = new BitmapDescriptor(zzIS().zzfe(paramString));
      return paramString;
    }
  ...
  public static BitmapDescriptor fromBitmap(Bitmap paramBitmap)
  {
    try
    {
      paramBitmap = new BitmapDescriptor(zzIS().zze(paramBitmap));
      return paramBitmap;
    }
  ...
  public static BitmapDescriptor fromFile(String paramString)
  {
    try
    {
      paramString = new BitmapDescriptor(zzIS().zzff(paramString));
      return paramString;
    }
    catch (RemoteException paramString)
    {
  ...
  public static BitmapDescriptor fromPath(String paramString)
  {
    try
    {
      paramString = new BitmapDescriptor(zzIS().zzfg(paramString));
      return paramString;
    }
    catch (RemoteException paramString)
    {
  ...
  public static BitmapDescriptor fromResource(int paramInt)
  {
    try
    {
      BitmapDescriptor localBitmapDescriptor = new BitmapDescriptor(zzIS().zzlo(paramInt));
      return localBitmapDescriptor;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  {
    return (zza)zzac.zzb(zzboB, "IBitmapDescriptorFactory is not initialized");
  }
