...
public abstract interface zza
  extends IInterface
{
  public abstract zzd zzIY()
    throws RemoteException;
  
  public abstract zzd zze(Bitmap paramBitmap)
    throws RemoteException;
  
  public abstract zzd zzfe(String paramString)
    throws RemoteException;
  
  public abstract zzd zzff(String paramString)
    throws RemoteException;
  
  public abstract zzd zzfg(String paramString)
    throws RemoteException;
  
  public abstract zzd zzi(float paramFloat)
    throws RemoteException;
  
  public abstract zzd zzlo(int paramInt)
    throws RemoteException;
  ...
  public static abstract class zza
    ...
    implements zza
  {
    public static zza zzeh(IBinder paramIBinder)
    {
      ...
      throws RemoteException
    {
      ...
      case 1: 
        ...
        paramParcel1 = zzlo(paramParcel1.readInt());
      ...
      case 2: 
        paramParcel1.enforceInterface("com.google.android.gms.maps.model.internal.IBitmapDescriptorFactoryDelegate");
        localZzd1 = zzfe(paramParcel1.readString());
        paramParcel2.writeNoException();
      ...
      case 3: 
        paramParcel1.enforceInterface("com.google.android.gms.maps.model.internal.IBitmapDescriptorFactoryDelegate");
        localZzd1 = zzff(paramParcel1.readString());
        paramParcel2.writeNoException();
      ...
      paramParcel1.enforceInterface("com.google.android.gms.maps.model.internal.IBitmapDescriptorFactoryDelegate");
      localZzd1 = zzfg(paramParcel1.readString());
      paramParcel2.writeNoException();
      ...
      implements zza
    {
      ...
      /* Error */
      public zzd zze(Bitmap paramBitmap)
        throws RemoteException
      {
        // Byte code:
        ...
        //   29: aload_0
        //   30: getfield 18	com/google/android/gms/maps/model/internal/zza$zza$zza:zzrp	Landroid/os/IBinder;
        //   33: bipush 6
        //   35: aload_2
        //   36: aload_3
        //   37: iconst_0
        ...
        //   52: invokestatic 55	com/google/android/gms/dynamic/zzd$zza:zzcd	(Landroid/os/IBinder;)Lcom/google/android/gms/dynamic/zzd;
        //   55: astore_1
        //   56: aload_3
      ...
      public zzd zzfe(String paramString)
        throws RemoteException
      {
        Parcel localParcel1 = Parcel.obtain();
        Parcel localParcel2 = Parcel.obtain();
        try
        {
          ...
          localParcel2.readException();
          paramString = zzd.zza.zzcd(localParcel2.readStrongBinder());
          return paramString;
        }
        finally
        {
      ...
      public zzd zzff(String paramString)
        throws RemoteException
      {
        Parcel localParcel1 = Parcel.obtain();
        Parcel localParcel2 = Parcel.obtain();
      ...
      public zzd zzfg(String paramString)
        throws RemoteException
      {
        Parcel localParcel1 = Parcel.obtain();
        Parcel localParcel2 = Parcel.obtain();
