...
public final class zzbum
{
  ...
  private static int zza(CharSequence paramCharSequence, byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      {
        j = paramInt2 + 1;
        paramArrayOfByte[paramInt2] = ((byte)(byte)(i >>> 6 | 0x3C0));
        paramArrayOfByte[j] = ((byte)(byte)(i & 0x3F | 0x80));
        j += 1;
        paramInt2 = paramInt1;
        paramInt1 = j;
      }
      else if (((i < 55296) || (57343 < i)) && (paramInt2 <= m - 3))
      {
        j = paramInt2 + 1;
        paramArrayOfByte[paramInt2] = ((byte)(byte)(i >>> 12 | 0x1E0));
        paramInt2 = j + 1;
        paramArrayOfByte[j] = ((byte)(byte)(i >>> 6 & 0x3F | 0x80));
        paramArrayOfByte[paramInt2] = ((byte)(byte)(i & 0x3F | 0x80));
        j = paramInt2 + 1;
        paramInt2 = paramInt1;
        paramInt1 = j;
      }
    ...
    label491:
    throw new ArrayIndexOutOfBoundsException(37 + "Failed writing " + i + " at index " + paramInt2);
  }
