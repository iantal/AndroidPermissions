  ...
  extends zza
{
    ...
    do
    {
      ...
      do
      {
        do
        {
          ...
          bool1 = bool2;
        } while (this.zzauz != paramObject.zzauz);
        bool1 = bool2;
      } while (!zzaa.equal(this.mPendingIntent, paramObject.mPendingIntent));
    } while (zzaa.equal(this.zzawY, paramObject.zzawY));
    return false;
  }
  ...
  {
    return (this.zzauz != 0) && (this.mPendingIntent != null);
  }
  
  public int hashCode()
  {
    return zzaa.hashCode(new Object[] { Integer.valueOf(this.zzauz), this.mPendingIntent, this.zzawY });
  }
