...
public abstract interface zzaat
  extends IInterface
{
    ...
    implements zzaat
  {
    ...
    public static zzaat zzbp(IBinder paramIBinder)
    {
      ...
      if ((localIInterface != null) && ((localIInterface instanceof zzaat))) {
        return (zzaat)localIInterface;
      }
      ...
      implements zzaat
    {
        ...
        throws RemoteException
      {
        ...
        //   25: aload_0
        //   26: getfield 18	com/google/android/gms/internal/zzaat$zza$zza:zzrp	Landroid/os/IBinder;
        //   29: iconst_1
        //   30: aload_2
        //   31: aconst_null
        //   32: iconst_1
