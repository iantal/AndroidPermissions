...
public class zza
{
  ...
  private zza()
  {
    ...
    for (localObject = Collections.EMPTY_LIST;; localObject = Arrays.asList(((String)localObject).split(",")))
    {
      ...
      this.zzaFY = new zzd(1024, ((Long)zzb.zza.zzaGi.get()).longValue());
      this.zzaGa = new zzd(1024, ((Long)zzb.zza.zzaGi.get()).longValue());
      return;
