  ...
  implements zzaau
{
  ...
  public zzaac(Context paramContext, Lock paramLock, Looper paramLooper, com.google.android.gms.common.zzc paramZzc, Map<Api.zzc<?>, Api.zze> paramMap, zzg paramZzg, Map<Api<?>, Integer> paramMap1, Api.zza<? extends zzaxn, zzaxo> paramZza, ArrayList<zzzy> paramArrayList, zzaal paramZzaal)
  {
    ...
    while (paramMap1.hasNext())
    {
      ...
      paramZzc.put(paramArrayList.zzawb, paramArrayList);
    }
    ...
    while (paramMap.hasNext())
    {
      ...
      this.zzazt.put((Api.zzc)paramMap1.getKey(), new zzaab(paramContext, paramArrayList, paramLooper, paramZzaal, localZzzy, paramZzg, paramZza));
    }
  ...
  public void connect()
  {
    ...
    try
    {
      ...
      zzact localZzact = new zzact(this.zzrx);
      this.zzaxK.zza(this.zzazt.values()).addOnSuccessListener(localZzact, localZza).addOnFailureListener(localZzact, localZza);
      return;
    }
    finally
    {
  ...
  public ConnectionResult getConnectionResult(@NonNull Api<?> paramApi)
  {
    ...
    try
    {
      ...
      if (this.zzazz != null)
      {
        paramApi = (ConnectionResult)this.zzazz.get(((com.google.android.gms.common.api.zzc)this.zzazt.get(paramApi.zzuH())).getApiKey());
        return paramApi;
      }
      return null;
    }
  ...
  {
    this.zzazv.zzaAx.zzb(paramT);
    return ((com.google.android.gms.common.api.zzc)this.zzazt.get(paramT.zzuH())).doRead(paramT);
  }
  ...
  {
    this.zzazv.zzaAx.zzb(paramT);
    return ((com.google.android.gms.common.api.zzc)this.zzazt.get(paramT.zzuH())).doWrite(paramT);
  }
    ...
    implements OnFailureListener, OnSuccessListener<Void>
  {
    ...
    private ConnectionResult zzvs()
    {
      ...
      for (;;)
      {
        if (localIterator.hasNext())
        {
          ...
          localConnectionResult = (ConnectionResult)zzaac.zzc(zzaac.this).get(((com.google.android.gms.common.api.zzc)zzaac.zzb(zzaac.this).get(localApi.zzuH())).getApiKey());
          if (!localConnectionResult.isSuccess())
          {
            j = ((Integer)zzaac.zzg(zzaac.this).get(localApi)).intValue();
    ...
    private void zzvt()
    {
      ...
      zzaac.zzd(zzaac.this).zzaAs = localHashSet;
    }
