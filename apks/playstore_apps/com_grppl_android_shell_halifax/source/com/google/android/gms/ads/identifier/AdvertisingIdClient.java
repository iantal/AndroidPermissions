...
public class AdvertisingIdClient
{
  ...
  public static final class Info
  {
    ...
    {
      this.zzsp = paramString;
      this.zzsq = paramBoolean;
    }
    ...
    extends Thread
  {
    ...
    {
      this.zzsl = new WeakReference(paramAdvertisingIdClient);
      this.zzsm = paramLong;
    ...
    {
      AdvertisingIdClient localAdvertisingIdClient = (AdvertisingIdClient)this.zzsl.get();
