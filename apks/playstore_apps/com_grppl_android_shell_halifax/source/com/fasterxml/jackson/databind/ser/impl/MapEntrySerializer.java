  ...
  implements ContextualSerializer
{
    ...
    throws JsonMappingException
  {
    ...
    for (;;)
    {
      ...
      {
        if (localObject1 == null) {
          localObject1 = this._keySerializer;
        }
        for (;;)
        {
          if (localObject1 == null) {}
          for (paramSerializerProvider = paramSerializerProvider.findKeySerializer(this._keyType, paramBeanProperty);; paramSerializerProvider = paramSerializerProvider.handleSecondaryContextualization((JsonSerializer)localObject1, paramBeanProperty))
          {
