  ...
  implements ContextualDeserializer
{
    ...
    throws IOException
  {
    ...
    if ((localObject3 != JsonToken.START_OBJECT) && (localObject3 != JsonToken.FIELD_NAME) && (localObject3 != JsonToken.END_OBJECT)) {
    ...
    localObject3 = this._keyDeserializer;
    ...
    localObject3 = ((KeyDeserializer)localObject3).deserializeKey((String)localObject4, paramDeserializationContext);
    ...
    try
    {
      ...
      for (;;)
      {
        ...
        if (localObject4 == JsonToken.END_OBJECT) {
          break label279;
        }
        if (localObject4 != JsonToken.FIELD_NAME) {
          break;
        }
        paramDeserializationContext.reportMappingException("Problem binding JSON into Map.Entry: more than one entry in JSON (second field: '" + paramJsonParser.getCurrentName() + "')", new Object[0]);
        return null;
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        wrapAndThrow(localException, Map.Entry.class, (String)localObject4);
        localObject2 = null;
      }
      paramDeserializationContext.reportMappingException("Problem binding JSON into Map.Entry: unexpected content after JSON Object entry: " + localObject4, new Object[0]);
      return null;
    }
    label279:
    return new AbstractMap.SimpleEntry(localObject3, localObject2);
  }
