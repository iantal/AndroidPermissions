  ...
  extends BeanPropertyDefinition
{
  ...
  {
    this(paramAnnotatedMember, new PropertyName(paramString), paramAnnotationIntrospector, null, EMPTY_INCLUDE);
  }
  ...
  public static SimpleBeanPropertyDefinition construct(MapperConfig<?> paramMapperConfig, AnnotatedMember paramAnnotatedMember, String paramString)
  {
    ...
    if (paramMapperConfig == null) {}
    for (paramMapperConfig = null;; paramMapperConfig = paramMapperConfig.getAnnotationIntrospector()) {
      return new SimpleBeanPropertyDefinition(paramAnnotatedMember, paramString, paramMapperConfig, null, EMPTY_INCLUDE);
    }
  }
  ...
  public BeanPropertyDefinition withInclusion(JsonInclude.Value paramValue)
  {
    if (this._inclusion == paramValue) {
      return this;
    }
    return new SimpleBeanPropertyDefinition(this._member, this._fullName, this._introspector, this._metadata, paramValue);
  }
