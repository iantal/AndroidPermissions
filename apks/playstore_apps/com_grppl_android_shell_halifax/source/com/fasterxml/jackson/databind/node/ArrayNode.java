  ...
  extends ContainerNode<ArrayNode>
{
  ...
  public ArrayNode(JsonNodeFactory paramJsonNodeFactory, int paramInt)
  {
    super(paramJsonNodeFactory);
    this._children = new ArrayList(paramInt);
  }
  
  public ArrayNode(JsonNodeFactory paramJsonNodeFactory, List<JsonNode> paramList)
  {
    super(paramJsonNodeFactory);
    this._children = paramList;
  }
  ...
  public boolean equals(Comparator<JsonNode> paramComparator, JsonNode paramJsonNode)
  {
    ...
    Object localObject = (ArrayNode)paramJsonNode;
    int j = this._children.size();
    if (((ArrayNode)localObject).size() != j) {
      return false;
    }
    paramJsonNode = this._children;
    localObject = ((ArrayNode)localObject)._children;
    int i = 0;
    while (i < j)
    {
      if (!((JsonNode)paramJsonNode.get(i)).equals(paramComparator, (JsonNode)((List)localObject).get(i))) {
        return false;
      }
      i += 1;
    }
  ...
  public JsonNode set(int paramInt, JsonNode paramJsonNode)
  {
    ...
    return (JsonNode)this._children.set(paramInt, localObject);
  }
