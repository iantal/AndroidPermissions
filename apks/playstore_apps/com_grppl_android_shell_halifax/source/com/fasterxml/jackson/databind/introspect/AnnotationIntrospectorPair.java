  ...
  implements Serializable
{
  ...
  public static AnnotationIntrospector create(AnnotationIntrospector paramAnnotationIntrospector1, AnnotationIntrospector paramAnnotationIntrospector2)
  {
    ...
    if (paramAnnotationIntrospector1 == null) {
      localAnnotationIntrospector = paramAnnotationIntrospector2;
    }
    do
    {
      return localAnnotationIntrospector;
      localAnnotationIntrospector = paramAnnotationIntrospector1;
    } while (paramAnnotationIntrospector2 == null);
  ...
  protected boolean _isExplicitClassOrOb(Object paramObject, Class<?> paramClass)
  {
    ...
    } while ((paramObject == paramClass) || (ClassUtil.isBogusClass(paramObject)));
    return true;
  }
  ...
  {
    String str2 = this._primary.findClassDescription(paramAnnotatedClass);
    String str1;
    if (str2 != null)
    {
      str1 = str2;
    ...
    {
      str1 = this._secondary.findClassDescription(paramAnnotatedClass);
    }
    return str1;
  }
  ...
  {
    Enum localEnum2 = this._primary.findDefaultEnumValue(paramClass);
    Enum localEnum1 = localEnum2;
    if (localEnum2 == null) {
      localEnum1 = this._secondary.findDefaultEnumValue(paramClass);
    }
    return localEnum1;
  }
  ...
  {
    paramArrayOfString = this._secondary.findEnumValues(paramClass, paramArrayOfEnum, paramArrayOfString);
    return this._primary.findEnumValues(paramClass, paramArrayOfEnum, paramArrayOfString);
  }
  ...
  public JsonFormat.Value findFormat(Annotated paramAnnotated)
  {
    ...
    paramAnnotated = this._secondary.findFormat(paramAnnotated);
    if (paramAnnotated == null) {
      return localValue;
    }
    return paramAnnotated.withOverrides(localValue);
  }
  ...
  public PropertyName findNameForDeserialization(Annotated paramAnnotated)
  {
    ...
    do
    {
      ...
      if (localPropertyName2 != PropertyName.USE_DEFAULT) {
        break;
      }
      localPropertyName1 = this._secondary.findNameForDeserialization(paramAnnotated);
      paramAnnotated = localPropertyName1;
    } while (localPropertyName1 != null);
  ...
  public JsonProperty.Access findPropertyAccess(Annotated paramAnnotated)
  {
    ...
    if ((localAccess != null) && (localAccess != JsonProperty.Access.AUTO)) {
      paramAnnotated = localAccess;
    }
    do
    {
      return paramAnnotated;
      localAccess = this._secondary.findPropertyAccess(paramAnnotated);
      paramAnnotated = localAccess;
    } while (localAccess != null);
  ...
  {
    JsonIgnoreProperties.Value localValue = this._secondary.findPropertyIgnorals(paramAnnotated);
    paramAnnotated = this._primary.findPropertyIgnorals(paramAnnotated);
    if (localValue == null) {
      return paramAnnotated;
    }
  ...
  public JsonInclude.Value findPropertyInclusion(Annotated paramAnnotated)
  {
    ...
    paramAnnotated = this._primary.findPropertyInclusion(paramAnnotated);
    if (localValue == null) {
      return paramAnnotated;
    }
    return localValue.withOverrides(paramAnnotated);
  ...
  public PropertyName findRootName(AnnotatedClass paramAnnotatedClass)
  {
    ...
    do
    {
      ...
      paramAnnotatedClass = localPropertyName1;
    } while (localPropertyName1 != null);
    return localPropertyName2;
  }
  ...
  {
    paramInclude = this._secondary.findSerializationInclusionForContent(paramAnnotated, paramInclude);
    return this._primary.findSerializationInclusionForContent(paramAnnotated, paramInclude);
  }
  ...
  {
    paramJavaType = this._secondary.refineDeserializationType(paramMapperConfig, paramAnnotated, paramJavaType);
    return this._primary.refineDeserializationType(paramMapperConfig, paramAnnotated, paramJavaType);
  }
  
  public JavaType refineSerializationType(MapperConfig<?> paramMapperConfig, Annotated paramAnnotated, JavaType paramJavaType)
    throws JsonMappingException
  {
    paramJavaType = this._secondary.refineSerializationType(paramMapperConfig, paramAnnotated, paramJavaType);
    return this._primary.refineSerializationType(paramMapperConfig, paramAnnotated, paramJavaType);
  }
  ...
  {
    AnnotatedMethod localAnnotatedMethod2 = this._primary.resolveSetterConflict(paramMapperConfig, paramAnnotatedMethod1, paramAnnotatedMethod2);
    AnnotatedMethod localAnnotatedMethod1 = localAnnotatedMethod2;
    if (localAnnotatedMethod2 == null) {
      localAnnotatedMethod1 = this._secondary.resolveSetterConflict(paramMapperConfig, paramAnnotatedMethod1, paramAnnotatedMethod2);
    }
    return localAnnotatedMethod1;
  }
