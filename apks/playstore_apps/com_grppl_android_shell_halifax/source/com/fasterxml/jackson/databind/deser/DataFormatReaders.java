...
public class DataFormatReaders
{
    ...
    throws IOException
  {
    ...
    if (i < j)
    {
      localObjectReader = arrayOfObjectReader[i];
      paramAccessorForReader.reset();
      localObject3 = localObjectReader.getFactory().hasFormat(paramAccessorForReader);
    ...
    for (;;)
    {
      ...
      if ((localObject1 == null) || (localObject2.ordinal() < ((MatchStrength)localObject3).ordinal()))
      {
        ...
        for (;;)
        {
          return paramAccessorForReader.createMatcher(localObject1, (MatchStrength)localObject3);
          break;
