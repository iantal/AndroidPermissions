  ...
  extends StdScalarSerializer<UUID>
{
  ...
  {
    paramArrayOfChar[paramInt2] = ((char)HEX_CHARS[(paramInt1 >> 12 & 0xF)]);
    paramInt2 += 1;
    paramArrayOfChar[paramInt2] = ((char)HEX_CHARS[(paramInt1 >> 8 & 0xF)]);
    paramInt2 += 1;
    paramArrayOfChar[paramInt2] = ((char)HEX_CHARS[(paramInt1 >> 4 & 0xF)]);
    paramArrayOfChar[(paramInt2 + 1)] = ((char)HEX_CHARS[(paramInt1 & 0xF)]);
  }
