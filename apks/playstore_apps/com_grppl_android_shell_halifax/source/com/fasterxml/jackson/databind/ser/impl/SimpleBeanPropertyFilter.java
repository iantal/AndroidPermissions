  ...
  implements BeanPropertyFilter, PropertyFilter
{
    ...
    throws JsonMappingException
  {
    if (include(paramBeanPropertyWriter)) {
      paramBeanPropertyWriter.depositSchemaProperty(paramJsonObjectFormatVisitor, paramSerializerProvider);
    }
  }
    ...
    throws JsonMappingException
  {
    if (include(paramPropertyWriter)) {
      paramPropertyWriter.depositSchemaProperty(paramJsonObjectFormatVisitor, paramSerializerProvider);
    }
  }
