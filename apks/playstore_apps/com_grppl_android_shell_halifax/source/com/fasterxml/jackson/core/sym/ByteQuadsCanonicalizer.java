...
public final class ByteQuadsCanonicalizer
{
  ...
  private int _appendLongName(int[] paramArrayOfInt, int paramInt)
  {
    ...
    if (i + paramInt > this._hashArea.length)
    {
      ...
      this._hashArea = Arrays.copyOf(this._hashArea, k + j);
    }
  ...
  {
    return (this._hashSize - 1 & paramInt) << 2;
  }
  ...
  private int _findOffsetForAdd(int paramInt)
  {
    ...
    {
      return paramInt;
      i = this._secondaryStart + (paramInt >> 3 << 2);
      if (arrayOfInt[(i + 3)] == 0) {
        break;
      }
      j = this._tertiaryStart + (paramInt >> this._tertiaryShift + 2 << this._tertiaryShift);
  ...
  private String _findSecondary(int paramInt1, int paramInt2)
  {
    ...
    i = (paramInt1 >> this._tertiaryShift + 2 << this._tertiaryShift) + i;
    int[] arrayOfInt = this._hashArea;
  ...
  private boolean _verifyLongName(int[] paramArrayOfInt, int paramInt1, int paramInt2)
  {
        ...
        do
        {
          do
          {
            do
            {
              return bool1;
              bool1 = bool2;
            } while (paramArrayOfInt[0] != arrayOfInt[paramInt2]);
            paramInt2 += 1;
            paramInt1 = 1;
            bool1 = bool2;
          } while (paramArrayOfInt[paramInt1] != arrayOfInt[paramInt2]);
          paramInt1 += 1;
          paramInt2 += 1;
          bool1 = bool2;
        } while (paramArrayOfInt[paramInt1] != arrayOfInt[paramInt2]);
    ...
    for (;;)
    {
      ...
      bool1 = bool2;
      if (paramArrayOfInt[(paramInt2 + 1)] != arrayOfInt[(j + 1)]) {
        break;
      }
      return true;
      paramInt1 = 0;
  ...
  private boolean _verifyLongName2(int[] paramArrayOfInt, int paramInt1, int paramInt2)
  {
    ...
    {
      j = paramInt2 + 1;
      if (paramArrayOfInt[paramInt2] != this._hashArea[i]) {
        return false;
      }
      if (j >= paramInt1) {
        return true;
  ...
  private void rehash()
  {
    ...
    {
      return;
      this._hashArea = new int[(i << 3) + arrayOfInt.length];
      this._hashSize = j;
  ...
  {
    paramInt1 = (paramInt1 >>> 15) + paramInt1;
  ...
  {
    paramInt1 = this._seed ^ paramInt1;
  ...
  public String findName(int[] paramArrayOfInt, int paramInt)
  {
    ...
    k = this._secondaryStart + (j >> 3 << 2);
    int m = arrayOfInt[(k + 3)];
    if ((i == arrayOfInt[k]) && (m == paramInt) && (_verifyLongName(paramArrayOfInt, paramInt, arrayOfInt[(k + 1)]))) {
  ...
  public String toString()
  {
    ...
    int n = totalCount();
    return String.format("[%s: size=%d, hashSize=%d, %d/%d/%d/%d pri/sec/ter/spill (=%s), total:%d]", new Object[] { getClass().getName(), Integer.valueOf(this._count), Integer.valueOf(this._hashSize), Integer.valueOf(i), Integer.valueOf(j), Integer.valueOf(k), Integer.valueOf(m), Integer.valueOf(i + j + k + m), Integer.valueOf(n) });
  }
