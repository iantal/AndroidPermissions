...
public final class CharsToNameCanonicalizer
{
  ...
  private void rehash()
  {
    ...
    do
    {
      ...
      if (n < i3 >> 1)
      {
        localObject1 = arrayOfBucket[n];
        j = m;
        i = k;
        if (localObject1 != null)
        {
          localObject2 = ((Bucket)localObject1).symbol;
          k = _hashToIndex(calcHash((String)localObject2));
        ...
        for (;;)
        {
          ...
          break;
          k >>= 1;
          localObject2 = new Bucket((String)localObject2, this._buckets[k]);
          this._buckets[k] = localObject2;
