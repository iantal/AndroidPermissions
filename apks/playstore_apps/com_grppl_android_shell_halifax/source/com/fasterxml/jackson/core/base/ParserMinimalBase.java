  ...
  extends JsonParser
{
  ...
  protected void _reportInvalidEOF(String paramString)
    throws JsonParseException
  {
    throw new JsonEOFException(this, null, "Unexpected end-of-input" + paramString);
  }
  
  protected void _reportInvalidEOF(String paramString, JsonToken paramJsonToken)
    throws JsonParseException
  {
    throw new JsonEOFException(this, paramJsonToken, "Unexpected end-of-input" + paramString);
  }
  ...
  protected void _reportInvalidEOFInValue(JsonToken paramJsonToken)
    throws JsonParseException
  {
    String str;
    ...
    for (;;)
    {
      ...
      return;
      if ((paramJsonToken == JsonToken.VALUE_NUMBER_INT) || (paramJsonToken == JsonToken.VALUE_NUMBER_FLOAT)) {
