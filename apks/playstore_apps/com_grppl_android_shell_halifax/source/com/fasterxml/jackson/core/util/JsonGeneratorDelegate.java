  ...
  extends JsonGenerator
{
  ...
  public void writeArray(double[] paramArrayOfDouble, int paramInt1, int paramInt2)
    throws IOException
  {
    this.delegate.writeArray(paramArrayOfDouble, paramInt1, paramInt2);
  }
  
  public void writeArray(int[] paramArrayOfInt, int paramInt1, int paramInt2)
    throws IOException
  {
    this.delegate.writeArray(paramArrayOfInt, paramInt1, paramInt2);
  }
  
  public void writeArray(long[] paramArrayOfLong, int paramInt1, int paramInt2)
    throws IOException
  {
    this.delegate.writeArray(paramArrayOfLong, paramInt1, paramInt2);
  }
  ...
  public void writeEmbeddedObject(Object paramObject)
    throws IOException
  {
    this.delegate.writeEmbeddedObject(paramObject);
  }
  ...
  public void writeFieldId(long paramLong)
    throws IOException
  {
    this.delegate.writeFieldId(paramLong);
  }
  ...
  public void writeStartObject(Object paramObject)
    throws IOException
  {
    this.delegate.writeStartObject(paramObject);
  }
