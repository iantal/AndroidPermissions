        ...
        do
        {
          do
          {
            do
            {
              ...
              bool1 = bool2;
            } while (paramObject._majorVersion != this._majorVersion);
            bool1 = bool2;
          } while (paramObject._minorVersion != this._minorVersion);
          bool1 = bool2;
        } while (paramObject._patchLevel != this._patchLevel);
        bool1 = bool2;
      } while (!paramObject._artifactId.equals(this._artifactId));
    } while (paramObject._groupId.equals(this._groupId));
    return false;
  }
