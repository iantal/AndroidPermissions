  ...
  extends JsonGeneratorImpl
{
    ...
    if (paramInt3 != -2)
    {
      if ((paramInt1 > 5) && (paramInt1 < paramInt2))
      {
        ...
        if (paramChar > 'ÿ')
        {
          ...
          paramArrayOfChar[paramInt1] = ((char)HEX_CHARS[(paramInt2 >> 4)]);
          paramInt1 = paramInt3 + 1;
          paramArrayOfChar[paramInt3] = ((char)HEX_CHARS[(paramInt2 & 0xF)]);
          paramChar = (char)(paramChar & 0xFF);
        }
        for (;;)
        {
    ...
    throws IOException
  {
    ...
    int i = this._outputTail;
    this._outputTail = (i + 1);
    arrayOfChar[i] = ((char)this._quoteChar);
    ...
    arrayOfChar[paramInt] = ((char)this._quoteChar);
  }
    ...
    throws IOException
  {
    ...
    i = this._outputTail;
    this._outputTail = (i + 1);
    paramString[i] = ((char)this._quoteChar);
  }
    ...
    throws IOException
  {
    ...
    arrayOfChar[paramShort] = ((char)this._quoteChar);
  }
    ...
    throws IOException, JsonGenerationException
  {
    ...
    for (paramInt = 2;; paramInt = 1)
    {
      ...
      if (j <= 0)
      {
        ...
        paramInt = this._outputTail;
        this._outputTail = (paramInt + 1);
        arrayOfChar[paramInt] = ((char)92);
        arrayOfChar = this._outputBuffer;
        paramInt = this._outputTail;
        this._outputTail = (paramInt + 1);
        arrayOfChar[paramInt] = ((char)110);
    ...
    throws IOException
  {
    ...
    if (this._outputTail + i + 1 >= this._outputEnd)
    {
      ...
      i = this._outputTail;
      this._outputTail = (i + 1);
      paramSerializableString[i] = ((char)this._quoteChar);
      return;
    }
    ...
    throws IOException, JsonGenerationException
  {
    ...
    int i = this._outputTail;
    this._outputTail = (i + 1);
    localObject[i] = ((char)this._quoteChar);
    ...
    for (;;)
    {
      try
      {
        ...
        paramInt = this._outputTail;
        this._outputTail = (paramInt + 1);
        paramBase64Variant[paramInt] = ((char)this._quoteChar);
        return i;
      }
      finally
      {
    ...
    throws IOException, JsonGenerationException
  {
    ...
    paramInt1 = this._outputTail;
    this._outputTail = (paramInt1 + 1);
    paramBase64Variant[paramInt1] = ((char)this._quoteChar);
  }
    ...
    throws IOException
  {
    ...
    paramInt1 = this._outputTail;
    this._outputTail = (paramInt1 + 1);
    paramArrayOfChar[paramInt1] = ((char)this._quoteChar);
  }
