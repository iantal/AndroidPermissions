  ...
  implements Serializable
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    do
    {
      while ((this._lineNr == paramObject._lineNr) && (this._columnNr == paramObject._columnNr) && (this._totalChars == paramObject._totalChars) && (getByteOffset() == paramObject.getByteOffset()))
      {
        return true;
        if ((paramObject == null) || (!(paramObject instanceof JsonLocation))) {
          break label101;
        }
      ...
      return false;
    } while (this._sourceRef.equals(paramObject._sourceRef));
    return false;
    label101:
    return false;
  }
