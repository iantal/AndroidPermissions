  ...
  extends ParserMinimalBase
{
  ...
  protected ParserBase(IOContext paramIOContext, int paramInt)
  {
    ...
    for (paramIOContext = DupDetector.rootDetector(this);; paramIOContext = null)
    {
  ...
  protected void _checkStdFeatureChanges(int paramInt1, int paramInt2)
  {
    ...
    if (((paramInt2 & i) != 0) && ((i & paramInt1) != 0))
    {
    ...
    throws JsonParseException
  {
    ...
    label61:
    for (String str = "Array";; str = "Object")
    {
    ...
    throws JsonParseException
  {
    ...
    _reportError("Unexpected close marker '" + (char)paramInt + "': expected '" + paramChar + "' (for " + this._parsingContext.typeDesc() + " starting at " + str + ")");
  }
