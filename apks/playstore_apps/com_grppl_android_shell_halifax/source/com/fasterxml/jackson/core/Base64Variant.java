  ...
  implements Serializable
{
  ...
  public Base64Variant(String paramString1, String paramString2, boolean paramBoolean, char paramChar, int paramInt)
  {
    ...
    while (paramInt < j)
    {
      ...
      this._base64ToAsciiB[paramInt] = ((byte)(byte)i);
  ...
  public int encodeBase64Partial(int paramInt1, int paramInt2, byte[] paramArrayOfByte, int paramInt3)
  {
    ...
    if (this._usesPadding)
    {
      ...
      j = i + 1;
      if (paramInt2 == 2) {}
      for (paramInt1 = this._base64ToAsciiB[(paramInt1 >> 6 & 0x3F)];; paramInt1 = paramInt3)
      {
  ...
  public int encodeBase64Partial(int paramInt1, int paramInt2, char[] paramArrayOfChar, int paramInt3)
  {
    ...
    if (this._usesPadding)
    {
      i = paramInt3 + 1;
      if (paramInt2 == 2) {}
      for (paramInt1 = this._base64ToAsciiC[(paramInt1 >> 6 & 0x3F)];; paramInt1 = this._paddingChar)
      {
        paramArrayOfChar[paramInt3] = ((char)paramInt1);
        paramArrayOfChar[i] = ((char)this._paddingChar);
        return i + 1;
      }
    }
    if (paramInt2 == 2)
    {
      paramArrayOfChar[paramInt3] = ((char)this._base64ToAsciiC[(paramInt1 >> 6 & 0x3F)]);
      return paramInt3 + 1;
    }
    return paramInt3;
  }
