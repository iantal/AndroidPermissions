...
public class ObjectIdGenerators
{
    ...
    extends ObjectIdGenerators.Base<String>
  {
    ...
    private StringIdGenerator(Class<?> paramClass)
    {
      super();
    }
    ...
    public boolean canUseFor(ObjectIdGenerator<?> paramObjectIdGenerator)
    {
      return paramObjectIdGenerator instanceof StringIdGenerator;
    }
    
    public ObjectIdGenerator<String> forScope(Class<?> paramClass)
    {
      return this;
    }
    
    public String generateId(Object paramObject)
    {
    ...
    public ObjectIdGenerator<String> newForSerialization(Object paramObject)
    {
      return this;
    }
  }
