  ...
  extends CompoundButton
{
  ...
  private boolean hitThumb(float paramFloat1, float paramFloat2)
  {
    ...
    do
    {
      ...
      i4 = this.mTouchSlop;
    } while ((paramFloat1 <= k) || (paramFloat1 >= k + m + n + i1 + i2) || (paramFloat2 <= i - j) || (paramFloat2 >= i3 + i4));
    return true;
  }
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    for (paramInt2 = Math.max(0, localRect2.right - localRect1.right);; paramInt2 = i)
    {
      if (ViewUtils.isLayoutRtl(this))
      {
      ...
      for (;;)
      {
        ...
        paramInt3 = paramInt1 + (paramInt4 - this.mSwitchWidth) + paramInt2;
        break label113;
  ...
  public void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    for (int j = this.mTrackDrawable.getIntrinsicHeight();; j = m)
    {
      ...
      k = Math.max(this.mSwitchMinWidth, m + this.mThumbWidth * 2 + k);
      i = Math.max(j, i);
      this.mSwitchWidth = k;
