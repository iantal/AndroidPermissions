  ...
  implements ItemTouchHelper.ViewDropHandler, RecyclerView.SmoothScroller.ScrollVectorProvider
{
  ...
  public void collectAdjacentPrefetchPositions(int paramInt1, int paramInt2, RecyclerView.State paramState, RecyclerView.LayoutManager.LayoutPrefetchRegistry paramLayoutPrefetchRegistry)
  {
    ...
    for (paramInt1 = 1;; paramInt1 = -1)
    {
      updateLayoutState(paramInt1, Math.abs(paramInt2), true, paramState);
  ...
  public void collectInitialPrefetchPositions(int paramInt, RecyclerView.LayoutManager.LayoutPrefetchRegistry paramLayoutPrefetchRegistry)
  {
    ...
    {
      int k = 0;
      while ((k < this.mInitialPrefetchItemCount) && (i >= 0) && (i < paramInt))
      {
  ...
  View findOnePartiallyOrCompletelyInvisibleChild(int paramInt1, int paramInt2)
  {
    ...
    for (int j = 16388; this.mOrientation == 0; j = 4097)
    {
  ...
  public void onLayoutChildren(RecyclerView.Recycler paramRecycler, RecyclerView.State paramState)
  {
    ...
    if ((!this.mAnchorInfo.mValid) || (this.mPendingScrollPosition != -1) || (this.mPendingSavedState != null))
    {
      ...
      k = this.mOrientationHelper.getEndPadding() + j;
      ...
      j = this.mOrientationHelper.getEndAfterPadding() - this.mOrientationHelper.getDecoratedEnd((View)localObject) - this.mPendingScrollPositionOffset;
      label261:
      if (j <= 0) {
        break label726;
      }
    ...
    for (;;)
    {
      ...
      if (this.mAnchorInfo.mLayoutFromEnd) {
        ...
        {
          j = 1;
          onAnchorReady(paramRecycler, paramState, this.mAnchorInfo, j);
          ...
          updateLayoutStateToFillStart(m, j);
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          this.mAnchorInfo.assignFromViewAndKeepVisibleRect((View)localObject);
          break;
          j = 0;
          break label169;
          j = this.mOrientationHelper.getDecoratedStart((View)localObject);
          m = this.mOrientationHelper.getStartAfterPadding();
          j = this.mPendingScrollPositionOffset - (j - m);
          break label261;
          k -= j;
          break label271;
          j = -1;
      ...
      do
      {
        ...
        do
        {
          do
          {
            ...
            j = k - j - (Math.min(LinearLayoutManager.this.mOrientationHelper.getDecoratedStart(paramView) - m, 0) + m);
          } while (j >= 0);
          k = this.mCoordinate;
