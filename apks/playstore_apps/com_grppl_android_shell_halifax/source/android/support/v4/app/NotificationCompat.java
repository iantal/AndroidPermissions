...
public class NotificationCompat
{
    ...
    extends NotificationCompat.Style
  {
    ...
    private CharSequence makeMessageLine(Message paramMessage)
    {
      ...
      for (;;)
      {
        ...
        localSpannableStringBuilder.setSpan(makeFontColorSpan(i), localSpannableStringBuilder.length() - ((CharSequence)localObject).length(), localSpannableStringBuilder.length(), 33);
  ...
  public static abstract class Style
  {
    ...
    private int calculateTopPadding()
    {
      ...
      float f1 = (constrain(localResources.getConfiguration().fontScale, 1.0F, 1.3F) - 1.0F) / 0.29999995F;
      float f2 = i;
