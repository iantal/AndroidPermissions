...
abstract class MapCollections<K, V>
{
    ...
    implements Iterator<Map.Entry<K, V>>, Map.Entry<K, V>
  {
    ...
    public final boolean equals(Object paramObject)
    {
      ...
      do
      {
        return false;
        paramObject = (Map.Entry)paramObject;
      } while ((!ContainerHelpers.equal(paramObject.getKey(), MapCollections.this.colGetEntry(this.mIndex, 0))) || (!ContainerHelpers.equal(paramObject.getValue(), MapCollections.this.colGetEntry(this.mIndex, 1))));
      return true;
    }
    ...
    implements Collection<V>
  {
    ...
    {
      boolean bool = false;
      int k = MapCollections.this.colGetSize();
      int i = 0;
      while (i < k)
      {
        int m = i;
