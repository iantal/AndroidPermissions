  ...
  implements Parcelable
{
  ...
  public static MediaDescriptionCompat fromMediaDescription(Object paramObject)
  {
    ...
    if ((paramObject != null) && (Build.VERSION.SDK_INT >= 21))
    {
      ...
      Object localObject1 = MediaDescriptionCompatApi21.getExtras(paramObject);
      Uri localUri;
      if (localObject1 == null)
      {
        ...
        if ((!((Bundle)localObject1).containsKey("android.support.v4.media.description.NULL_BUNDLE_FLAG")) || (((Bundle)localObject1).size() != 2)) {
          break label161;
        }
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          return localObject1;
          localUri = (Uri)((Bundle)localObject1).getParcelable("android.support.v4.media.description.MEDIA_URI");
          break;
          ((Bundle)localObject1).remove("android.support.v4.media.description.MEDIA_URI");
          ((Bundle)localObject1).remove("android.support.v4.media.description.NULL_BUNDLE_FLAG");
          break label117;
