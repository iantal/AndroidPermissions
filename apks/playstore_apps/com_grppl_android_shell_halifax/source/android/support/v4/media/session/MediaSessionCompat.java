...
public class MediaSessionCompat
{
  ...
  public static abstract class Callback
  {
    ...
    public boolean onMediaButtonEvent(Intent paramIntent)
    {
      ...
      if (this.mMediaPlayPauseKeyPending)
      {
        ...
        if (paramIntent == null) {}
        for (long l = 0L; (l & 0x20) != 0L; l = paramIntent.getActions())
        {
          onSkipToNext();
          return true;
        }
      ...
      public void onCommand(String paramString, Bundle paramBundle, ResultReceiver paramResultReceiver)
      {
        ...
        try
        {
          if (paramString.equals("android.support.v4.media.session.command.GET_EXTRA_BINDER"))
          {
            ...
            if (paramString == null) {}
            for (paramString = localObject;; paramString = paramString.asBinder())
            {
        ...
        label302:
        for (paramString = (MediaSessionCompat.QueueItem)MediaSessionCompat.MediaSessionImplApi21.access$200(paramString).get(i); paramString != null; paramString = null)
        {
    ...
    extends MediaSessionCompat.MediaSessionImplBase
  {
    ...
    void setRccState(PlaybackStateCompat paramPlaybackStateCompat)
    {
      ...
      long l4 = SystemClock.elapsedRealtime();
      if ((paramPlaybackStateCompat.getState() == 3) && (l2 > 0L)) {
        if (l3 > 0L)
        {
          l3 = l4 - l3;
          l1 = l3;
    ...
    implements MediaSessionCompat.MediaSessionImpl
  {
    ...
    public void setMetadata(MediaMetadataCompat arg1)
    {
      ...
      if (localObject == null) {}
      for (??? = null;; ??? = localObject.getBundle())
      {
    ...
    boolean update()
    {
      if (this.mIsActive)
      {
        ...
        for (this.mIsMbrRegistered = true; (!this.mIsRccRegistered) && ((this.mFlags & 0x2) != 0); this.mIsMbrRegistered = false)
        {
          label40:
    ...
    public boolean equals(Object paramObject)
    {
      ...
      do
      {
        do
        {
          return bool1;
          bool1 = bool2;
        } while (!(paramObject instanceof Token));
