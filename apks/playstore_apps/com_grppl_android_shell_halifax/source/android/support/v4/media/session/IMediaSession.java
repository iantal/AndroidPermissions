    ...
    implements IMediaSession
  {
      ...
      throws RemoteException
    {
      ...
      case 2: 
        ...
        if (paramParcel1.readInt() != 0)
        {
          ...
          bool1 = sendMediaButton(paramParcel1);
          paramParcel2.writeNoException();
          if (!bool1) {
            break label2098;
          }
      ...
      for (paramInt1 = 1;; paramInt1 = 0)
      {
        ...
        return true;
        paramParcel1.enforceInterface("android.support.v4.media.session.IMediaSession");
        bool1 = isShuffleModeEnabledDeprecated();
        paramParcel2.writeNoException();
        paramInt1 = k;
        if (bool1) {
          paramInt1 = 1;
      ...
      implements IMediaSession
    {
        ...
        throws RemoteException
      {
        ...
        //   30: aload 4
        //   32: iconst_0
        //   33: invokevirtual 198	android/view/KeyEvent:writeToParcel	(Landroid/os/Parcel;I)V
        //   36: aload_0
        //   37: getfield 19	android/support/v4/media/session/IMediaSession$Stub$Proxy:mRemote	Landroid/os/IBinder;
        //   40: iconst_2
        //   41: aload 4
        //   43: aload 5
        //   45: iconst_0
        ...
        //   57: aload 5
        //   59: invokevirtual 75	android/os/Parcel:readInt	()I
        //   62: istore_2
        //   63: iload_2
        //   64: ifeq +5 -> 69
        //   67: iconst_1
        ...
        //   start	length	slot	name	signature
        //   0	103	0	this	Proxy
        //   0	103	1	paramKeyEvent	KeyEvent
        //   62	2	2	i	int
        //   1	79	3	bool	boolean
