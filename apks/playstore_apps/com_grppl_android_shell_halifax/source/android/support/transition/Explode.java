  ...
  extends Visibility
{
  ...
  private void calculateOut(View paramView, Rect paramRect, int[] paramArrayOfInt)
  {
    ...
    for (int i = paramView.getHeight() / 2 + m + Math.round(paramView.getTranslationY());; i = localRect.centerY())
    {
      ...
      f2 /= f3;
      f1 /= f3;
      f3 = calculateMaxDistance(paramView, j - k, i - m);
  ...
  public Animator onAppear(ViewGroup paramViewGroup, View paramView, TransitionValues paramTransitionValues1, TransitionValues paramTransitionValues2)
  {
    ...
    return TranslationAnimationCreator.createAnimation(paramView, paramTransitionValues2, paramTransitionValues1.left, paramTransitionValues1.top, f1 + f3, f4 + f2, f1, f2, sDecelerate);
  }
  ...
  public Animator onDisappear(ViewGroup paramViewGroup, View paramView, TransitionValues paramTransitionValues1, TransitionValues paramTransitionValues2)
  {
    ...
    if (arrayOfInt != null)
    {
      f1 = arrayOfInt[0] - paramTransitionValues2.left;
