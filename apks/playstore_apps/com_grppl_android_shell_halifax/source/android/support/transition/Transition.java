    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if (j != 0)
        {
          ...
          if (localObject1 != null) {
            ...
            {
              paramTransitionValuesMaps1 = localTransitionValues2.view;
              localObject3 = getTransitionProperties();
              if ((paramTransitionValuesMaps1 == null) || (localObject3 == null) || (localObject3.length <= 0)) {
                break label588;
              }
              localObject2 = new TransitionValues();
              ((TransitionValues)localObject2).view = paramTransitionValuesMaps1;
              TransitionValues localTransitionValues3 = (TransitionValues)paramTransitionValuesMaps2.mViewValues.get(paramTransitionValuesMaps1);
              if (localTransitionValues3 != null)
              {
                ...
                for (;;)
                {
                  ...
                  {
                    ((TransitionValues)localObject2).values.put(localObject3[j], localTransitionValues3.values.get(localObject3[j]));
                    j += 1;
                    continue;
                    j = 0;
                    break;
              ...
              if ((((AnimationInfo)localObject3).mValues != null) && (((AnimationInfo)localObject3).mView == paramTransitionValuesMaps1) && (((AnimationInfo)localObject3).mName.equals(getName())) && (((AnimationInfo)localObject3).mValues.equals(localObject2)))
              {
                localObject3 = null;
      ...
      for (;;)
      {
        if (localObject2 != null)
        {
          ...
          for (;;)
          {
            localArrayMap.put(localObject2, new AnimationInfo(paramTransitionValuesMaps1, getName(), this, ViewUtils.getWindowId(paramViewGroup), (TransitionValues)localObject1));
            this.mAnimators.add(localObject2);
            break;
            j += 1;
            break label296;
            paramTransitionValuesMaps1 = localTransitionValues1.view;
