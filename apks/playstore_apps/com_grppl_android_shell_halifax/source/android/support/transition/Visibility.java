  ...
  public Animator onDisappear(ViewGroup paramViewGroup, TransitionValues paramTransitionValues1, int paramInt1, TransitionValues paramTransitionValues2, int paramInt2)
  {
    ...
    for (;;)
    {
      if ((localObject2 != null) && (paramTransitionValues1 != null))
      {
        ...
        ((ViewGroupOverlayImpl)localObject1).add((View)localObject2);
        ...
        if (paramViewGroup == null)
        {
          ...
          if (!getVisibilityChangeInfo(getTransitionValues((View)localObject2, true), getMatchedTransitionValues((View)localObject2, true)).mVisibilityChange)
          {
            localObject2 = TransitionUtils.copyViewImage(paramViewGroup, (View)localObject1, (View)localObject2);
            localObject1 = null;
            continue;
          }
