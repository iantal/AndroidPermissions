  ...
  extends FrameLayout
{
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if ((this.mCollapsingTitleEnabled) && (this.mDummyView != null))
    {
      ...
      if (this.mDrawCollapsingTitle)
      {
        ...
        label254:
        ((CollapsingTextHelper)localObject).setCollapsedBounds(j + i1, i2 + n + i3, k + i4, n + this.mTmpRect.bottom - this.mToolbar.getTitleMarginBottom());
        localObject = this.mCollapsingTextHelper;
        if (i == 0) {
          break label448;
        }
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    if (this.mLastInsets != null) {}
    for (paramInt2 = this.mLastInsets.getSystemWindowInsetTop();; paramInt2 = 0)
    {
      if ((i == 0) && (paramInt2 > 0)) {
