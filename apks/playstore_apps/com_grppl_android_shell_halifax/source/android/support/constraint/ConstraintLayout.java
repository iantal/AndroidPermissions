  ...
  extends ViewGroup
{
  ...
  private void internalMeasureChildren(int paramInt1, int paramInt2)
  {
    ...
    if (k < i4)
    {
      ...
      if ((localLayoutParams.horizontalDimensionFixed) || (localLayoutParams.verticalDimensionFixed) || ((!localLayoutParams.horizontalDimensionFixed) && (localLayoutParams.matchConstraintDefaultWidth == 1)) || (localLayoutParams.width == -1) || ((!localLayoutParams.verticalDimensionFixed) && ((localLayoutParams.matchConstraintDefaultHeight == 1) || (localLayoutParams.height == -1))))
      {
        ...
        m = getChildMeasureSpec(paramInt1, i3, -2);
        i = 1;
        label207:
        if ((j != 0) && (j != -1)) {
          break label347;
        }
        n = getChildMeasureSpec(paramInt2, i2, -2);
        j = 1;
        label231:
    ...
    for (;;)
    {
      ...
      localConstraintWidget.setHeight(j);
      if (i != 0) {
        localConstraintWidget.setWrapWidth(m);
      }
      if (n != 0) {
        localConstraintWidget.setWrapHeight(j);
      }
      ...
      break label174;
      label332:
      m = getChildMeasureSpec(paramInt1, i3, m);
      i = 0;
      break label207;
      label347:
      n = getChildMeasureSpec(paramInt2, i2, j);
      j = i1;
      break label231;
      return;
      label365:
  ...
  private void setChildrenConstraints()
  {
    ...
    if (i5 < i9)
    {
      ...
      localObject1 = getViewWidget((View)localObject2);
      ...
      m = localLayoutParams.resolvedLeftToLeft;
      k = localLayoutParams.resolvedLeftToRight;
      i4 = localLayoutParams.resolvedRightToLeft;
      i3 = localLayoutParams.resolvedRightToRight;
      i1 = localLayoutParams.resolveGoneLeftMargin;
      i2 = localLayoutParams.resolveGoneRightMargin;
      f2 = localLayoutParams.resolvedHorizontalBias;
      if (Build.VERSION.SDK_INT >= 17) {
        break label1529;
      }
      k = localLayoutParams.leftToLeft;
      m = localLayoutParams.leftToRight;
      i8 = localLayoutParams.rightToLeft;
      i7 = localLayoutParams.rightToRight;
      i6 = localLayoutParams.goneLeftMargin;
      n = localLayoutParams.goneRightMargin;
      f1 = localLayoutParams.horizontalBias;
      i = m;
      j = k;
      if (k == -1)
      {
        ...
        if (m == -1)
        {
          ...
          j = localLayoutParams.startToStart;
          i = m;
        }
      }
      label479:
      ...
      {
        i1 = localLayoutParams.endToStart;
        k = n;
        m = i7;
        n = i1;
        i1 = i6;
    ...
    for (;;)
    {
      ...
      if (j != -1)
      {
        localObject2 = getTargetWidget(j);
        ...
        localObject2 = getTargetWidget(n);
        if (localObject2 != null) {
          ((ConstraintWidget)localObject1).immediateConnect(ConstraintAnchor.Type.RIGHT, (ConstraintWidget)localObject2, ConstraintAnchor.Type.LEFT, localLayoutParams.rightMargin, k);
        }
        label651:
      ...
      for (;;)
      {
        ...
        i = localLayoutParams.startToEnd;
        j = k;
        break label479;
        k = i;
        m = j;
        ...
        localObject2 = getTargetWidget(i);
        if (localObject2 == null) {
          break label612;
        }
        ...
        ((ConstraintWidget)localObject1).immediateConnect(ConstraintAnchor.Type.RIGHT, (ConstraintWidget)localObject2, ConstraintAnchor.Type.RIGHT, localLayoutParams.rightMargin, k);
        break label651;
        label1350:
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    if (i3 > 0)
    {
      ...
      if (this.mLayoutWidget.getHorizontalDimensionBehaviour() == ConstraintWidget.DimensionBehaviour.WRAP_CONTENT)
      {
        ...
        localConstraintWidget = (ConstraintWidget)this.mVariableDimensionsWidgets.get(n);
    ...
    for (;;)
    {
      ...
      if ((localView != null) && (localView.getVisibility() != 8))
      {
        ...
        {
          i1 = getChildMeasureSpec(paramInt1, i5, localLayoutParams.width);
          if (localLayoutParams.height != -2) {
            break label531;
          }
          i2 = getChildMeasureSpec(paramInt2, i4, localLayoutParams.height);
          label272:
          localView.measure(i1, i2);
          i2 = localView.getMeasuredWidth();
          i1 = localView.getMeasuredHeight();
          if (i2 != localConstraintWidget.getWidth())
          {
            localConstraintWidget.setWidth(i2);
            if ((k != 0) && (localConstraintWidget.getRight() > this.mLayoutWidget.getWidth()))
            {
              j = localConstraintWidget.getRight();
              i2 = localConstraintWidget.getAnchor(ConstraintAnchor.Type.RIGHT).getMargin();
              this.mLayoutWidget.setWidth(Math.max(this.mMinWidth, j + i2));
            }
            j = 1;
          }
          if (i1 != localConstraintWidget.getHeight())
          {
            localConstraintWidget.setHeight(i1);
            if ((m != 0) && (localConstraintWidget.getBottom() > this.mLayoutWidget.getHeight()))
            {
              j = localConstraintWidget.getBottom();
              i1 = localConstraintWidget.getAnchor(ConstraintAnchor.Type.BOTTOM).getMargin();
              this.mLayoutWidget.setHeight(Math.max(this.mMinHeight, j + i1));
            }
            j = 1;
          }
          if (!localLayoutParams.needsBaseline) {
          ...
          if ((i1 == -1) || (i1 == localConstraintWidget.getBaselineDistance())) {
            break label697;
          }
        ...
        for (;;)
        {
          if (Build.VERSION.SDK_INT >= 11)
          {
            ...
            break;
            i1 = View.MeasureSpec.makeMeasureSpec(localConstraintWidget.getWidth(), 1073741824);
            break label249;
            i2 = View.MeasureSpec.makeMeasureSpec(localConstraintWidget.getHeight(), 1073741824);
            break label272;
            k = i;
            if (j != 0)
            {
