...
.method public run()V
    ...
    invoke-virtual/range {v16 .. v16}, Landroid/widget/OverScroller;->computeScrollOffset()Z
    ...
    invoke-virtual/range {v16 .. v16}, Landroid/widget/OverScroller;->getCurrX()I

    move-result v18

    invoke-virtual/range {v16 .. v16}, Landroid/widget/OverScroller;->getCurrY()I
    ...
    invoke-virtual {v2, v9, v3, v4}, Landroid/support/v7/widget/RecyclerView$LayoutManager;->scrollHorizontallyBy(ILandroid/support/v7/widget/RecyclerView$Recycler;Landroid/support/v7/widget/RecyclerView$State;)I
    ...
    invoke-virtual {v2, v10, v3, v6}, Landroid/support/v7/widget/RecyclerView$LayoutManager;->scrollVerticallyBy(ILandroid/support/v7/widget/RecyclerView$Recycler;Landroid/support/v7/widget/RecyclerView$State;)I
    ...
    invoke-virtual/range {v17 .. v17}, Landroid/support/v7/widget/RecyclerView$SmoothScroller;->isPendingInitialRun()Z

    move-result v6

    if-nez v6, :cond_20

    invoke-virtual/range {v17 .. v17}, Landroid/support/v7/widget/RecyclerView$SmoothScroller;->isRunning()Z
    ...
    invoke-virtual/range {v17 .. v17}, Landroid/support/v7/widget/RecyclerView$SmoothScroller;->stop()V
    ...
    invoke-virtual {v2, v9, v10}, Landroid/support/v7/widget/RecyclerView;->considerReleasingGlowsOnScroll(II)V
    ...
    :cond_3
    invoke-virtual/range {v16 .. v16}, Landroid/widget/OverScroller;->getCurrVelocity()F
    ...
    invoke-virtual {v7, v8, v2}, Landroid/support/v7/widget/RecyclerView;->absorbGlows(II)V
    ...
    invoke-virtual/range {v16 .. v16}, Landroid/widget/OverScroller;->getFinalX()I
    ...
    invoke-virtual/range {v16 .. v16}, Landroid/widget/OverScroller;->getFinalY()I
    ...
    invoke-static {v0, v2, v3}, Landroid/support/v7/widget/RecyclerView$SmoothScroller;->access$600(Landroid/support/v7/widget/RecyclerView$SmoothScroller;II)V
    ...
    :cond_13
    invoke-virtual/range {v17 .. v17}, Landroid/support/v7/widget/RecyclerView$SmoothScroller;->getTargetPosition()I
    ...
    invoke-virtual {v0, v6}, Landroid/support/v7/widget/RecyclerView$SmoothScroller;->setTargetPosition(I)V
    ...
    invoke-static {v0, v6, v7}, Landroid/support/v7/widget/RecyclerView$SmoothScroller;->access$600(Landroid/support/v7/widget/RecyclerView$SmoothScroller;II)V
    ...
    invoke-virtual {v2, v3, v9, v10}, Landroid/support/v7/widget/GapWorker;->postFromTraversal(Landroid/support/v7/widget/RecyclerView;II)V
