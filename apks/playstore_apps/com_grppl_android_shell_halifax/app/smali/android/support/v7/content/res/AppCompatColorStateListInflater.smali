...
.method private static inflate(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)Landroid/content/res/ColorStateList;
    ...
    sget-object v3, Landroid/support/v7/appcompat/R$styleable;->ColorStateListItem:[I

    move-object/from16 v0, p3

    move-object/from16 v1, p2

    invoke-static {p0, v0, v1, v3}, Landroid/support/v7/content/res/AppCompatColorStateListInflater;->obtainAttributes(Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;

    move-result-object v6

    sget v3, Landroid/support/v7/appcompat/R$styleable;->ColorStateListItem_android_color:I
    ...
    sget v3, Landroid/support/v7/appcompat/R$styleable;->ColorStateListItem_android_alpha:I

    const/high16 v7, 0x3f800000    # 1.0f

    invoke-virtual {v6, v3, v7}, Landroid/content/res/TypedArray;->getFloat(IF)F
    ...
    sget v3, Landroid/support/v7/appcompat/R$styleable;->ColorStateListItem_alpha:I
    ...
    invoke-static {v11, v3}, Landroid/support/v7/content/res/AppCompatColorStateListInflater;->modulateColorAlpha(IF)I
    ...
    :cond_6
    invoke-static {v2, v5, v3}, Landroid/support/v7/content/res/GrowingArrayUtils;->append([III)[I

    move-result-object v3

    invoke-static {v4, v5, v6}, Landroid/support/v7/content/res/GrowingArrayUtils;->append([Ljava/lang/Object;ILjava/lang/Object;)[Ljava/lang/Object;
