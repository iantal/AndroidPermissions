...
.method private findMatchingItem(IIIZ)Z
    ...
    iget v8, v0, Landroid/support/v7/util/DiffUtil$Snake;->y:I

    iget v9, v0, Landroid/support/v7/util/DiffUtil$Snake;->size:I
    ...
    iget-object v8, p0, Landroid/support/v7/util/DiffUtil$DiffResult;->mCallback:Landroid/support/v7/util/DiffUtil$Callback;

    invoke-virtual {v8, v4, v5}, Landroid/support/v7/util/DiffUtil$Callback;->areItemsTheSame(II)Z
    ...
    invoke-virtual {v0, v4, v5}, Landroid/support/v7/util/DiffUtil$Callback;->areContentsTheSame(II)Z
    ...
    invoke-virtual {v6, v5, v4}, Landroid/support/v7/util/DiffUtil$Callback;->areItemsTheSame(II)Z
    ...
    invoke-virtual {v0, v5, v4}, Landroid/support/v7/util/DiffUtil$Callback;->areContentsTheSame(II)Z
...
.method private findMatchingItems()V
    ...
    iget v6, v0, Landroid/support/v7/util/DiffUtil$Snake;->y:I

    iget v7, v0, Landroid/support/v7/util/DiffUtil$Snake;->size:I

    iget-boolean v8, p0, Landroid/support/v7/util/DiffUtil$DiffResult;->mDetectMoves:Z
...
.method public dispatchUpdatesTo(Landroid/support/v7/util/ListUpdateCallback;)V
    ...
    invoke-virtual {v5, v7, v9}, Landroid/support/v7/util/DiffUtil$Callback;->getChangePayload(II)Ljava/lang/Object;
