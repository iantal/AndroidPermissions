...
.field public static zzaxl:Z

.field public static zzaxm:Z

.field static zzaxn:Z

.field private static zzaxo:Z

.field static final zzaxp:Ljava/util/concurrent/atomic/AtomicBoolean;

.field private static final zzaxq:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v1, Lcom/google/android/gms/common/zze;->zzaxl:Z

    sput-boolean v1, Lcom/google/android/gms/common/zze;->zzaxm:Z

    sput-boolean v1, Lcom/google/android/gms/common/zze;->zzaxn:Z

    sput-boolean v1, Lcom/google/android/gms/common/zze;->zzaxo:Z

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    sput-object v0, Lcom/google/android/gms/common/zze;->zzaxp:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    sput-object v0, Lcom/google/android/gms/common/zze;->zzaxq:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static isGooglePlayServicesAvailable(Landroid/content/Context;)I
    ...
    :cond_0
    invoke-static {p0}, Lcom/google/android/gms/common/util/zzi;->zzaJ(Landroid/content/Context;)Z

    move-result v3

    if-nez v3, :cond_2

    invoke-static {p0}, Lcom/google/android/gms/common/util/zzi;->zzaL(Landroid/content/Context;)Z
    ...
    sget-object v4, Lcom/google/android/gms/common/zzd$zzd;->zzaxk:[Lcom/google/android/gms/common/zzd$zza;
    ...
    invoke-static {v0}, Lcom/google/android/gms/common/util/zzl;->zzdj(I)I

    move-result v0

    iget v3, v6, Landroid/content/pm/PackageInfo;->versionCode:I

    invoke-static {v3}, Lcom/google/android/gms/common/util/zzl;->zzdj(I)I
...
.method public static zzZ(Landroid/content/Context;)V
    .locals 5
...
.method public static zzan(Landroid/content/Context;)V
    ...
    sget-object v0, Lcom/google/android/gms/common/zze;->zzaxp:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method private static zzap(Landroid/content/Context;)V
    ...
    sget-object v0, Lcom/google/android/gms/common/zze;->zzaxq:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :cond_1
    invoke-static {p0}, Lcom/google/android/gms/common/internal/zzz;->zzaE(Landroid/content/Context;)I
...
.method public static zzaq(Landroid/content/Context;)Z
    ...
    invoke-static {p0}, Lcom/google/android/gms/common/zze;->zzat(Landroid/content/Context;)V

    sget-boolean v0, Lcom/google/android/gms/common/zze;->zzaxn:Z
...
.method public static zzar(Landroid/content/Context;)Z
    ...
    invoke-static {}, Lcom/google/android/gms/common/zze;->zzuE()Z
...
.method private static zzat(Landroid/content/Context;)V
    .locals 1

    sget-boolean v0, Lcom/google/android/gms/common/zze;->zzaxo:Z

    if-nez v0, :cond_0

    invoke-static {p0}, Lcom/google/android/gms/common/zze;->zzau(Landroid/content/Context;)V

    :cond_0
    return-void
.end method

.method private static zzau(Landroid/content/Context;)V
    .locals 7
    ...
    invoke-virtual {v0, v1, v2}, Lcom/google/android/gms/internal/zzacw;->getPackageInfo(Ljava/lang/String;I)Landroid/content/pm/PackageInfo;
    ...
    sput-boolean v0, Lcom/google/android/gms/common/zze;->zzaxn:Z
    :try_end_0
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    :goto_0
    sput-boolean v6, Lcom/google/android/gms/common/zze;->zzaxo:Z
...
.method static zzs(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-static {p0}, Lcom/google/android/gms/common/zze;->zzas(Landroid/content/Context;)Z
    :try_end_0
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static zzuE()Z
    ...
    invoke-static {}, Lcom/google/android/gms/common/util/zzi;->zzyw()Z
