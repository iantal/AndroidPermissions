...
.method private correctBits([Z)[Z
    ...
    invoke-virtual {v4, v8, v0}, Lcom/google/zxing/common/reedsolomon/ReedSolomonDecoder;->decode([II)V
    :try_end_0
    ...
    invoke-static {v10, v4, v5, v0}, Ljava/util/Arrays;->fill([ZIIZ)V
...
.method private static getEncodedData([Z)Ljava/lang/String;
    ...
    :cond_1
    invoke-static {p0, v4, v3}, Lcom/google/zxing/aztec/decoder/Decoder;->readCode([ZII)I
    ...
    invoke-static {p0, v4, v0}, Lcom/google/zxing/aztec/decoder/Decoder;->readCode([ZII)I

    move-result v6

    add-int/2addr v4, v0

    invoke-static {v1, v6}, Lcom/google/zxing/aztec/decoder/Decoder;->getCharacter(Lcom/google/zxing/aztec/decoder/Decoder$Table;I)Ljava/lang/String;
