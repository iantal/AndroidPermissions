...
.method private handlePossibleCenter([III)Lcom/google/zxing/qrcode/detector/AlignmentPattern;
    ...
    invoke-direct {p0, p2, v4, v5, v0}, Lcom/google/zxing/qrcode/detector/AlignmentPatternFinder;->crossCheckVertical(IIII)F
    ...
    invoke-virtual {v0, v2, v1, v3}, Lcom/google/zxing/qrcode/detector/AlignmentPattern;->aboutEquals(FFF)Z

    move-result v5

    if-eqz v5, :cond_0

    invoke-virtual {v0, v1, v3, v2}, Lcom/google/zxing/qrcode/detector/AlignmentPattern;->combineEstimate(FFF)Lcom/google/zxing/qrcode/detector/AlignmentPattern;
    ...
    invoke-direct {v0, v3, v1, v2}, Lcom/google/zxing/qrcode/detector/AlignmentPattern;-><init>(FFF)V
...
.method find()Lcom/google/zxing/qrcode/detector/AlignmentPattern;
    ...
    iget v8, p0, Lcom/google/zxing/qrcode/detector/AlignmentPatternFinder;->startY:I
    ...
    invoke-virtual {v2, v0, v11}, Lcom/google/zxing/common/BitMatrix;->get(II)Z
    ...
    invoke-direct {p0, v10}, Lcom/google/zxing/qrcode/detector/AlignmentPatternFinder;->foundPatternCross([I)Z

    move-result v0

    if-eqz v0, :cond_4

    invoke-direct {p0, v10, v11, v2}, Lcom/google/zxing/qrcode/detector/AlignmentPatternFinder;->handlePossibleCenter([III)Lcom/google/zxing/qrcode/detector/AlignmentPattern;
    ...
    invoke-direct {p0, v10, v11, v7}, Lcom/google/zxing/qrcode/detector/AlignmentPatternFinder;->handlePossibleCenter([III)Lcom/google/zxing/qrcode/detector/AlignmentPattern;
