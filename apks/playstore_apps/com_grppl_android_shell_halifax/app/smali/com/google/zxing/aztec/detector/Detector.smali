...
.method private extractParameters([Lcom/google/zxing/ResultPoint;)V
    ...
    invoke-direct {p0, v0}, Lcom/google/zxing/aztec/detector/Detector;->isValid(Lcom/google/zxing/ResultPoint;)Z
    ...
    invoke-direct {p0, v1, v4, v0}, Lcom/google/zxing/aztec/detector/Detector;->sampleLine(Lcom/google/zxing/ResultPoint;Lcom/google/zxing/ResultPoint;I)I
    ...
    invoke-static {v3, v0}, Lcom/google/zxing/aztec/detector/Detector;->getRotation([II)I
...
.method private getBullsEyeCorners(Lcom/google/zxing/aztec/detector/Detector$Point;)[Lcom/google/zxing/ResultPoint;
    ...
    invoke-direct {p0, p1, v5, v0, v2}, Lcom/google/zxing/aztec/detector/Detector;->getFirstDifferent(Lcom/google/zxing/aztec/detector/Detector$Point;ZII)Lcom/google/zxing/aztec/detector/Detector$Point;
    ...
    invoke-direct {p0, v1, v5, v2, v4}, Lcom/google/zxing/aztec/detector/Detector;->getFirstDifferent(Lcom/google/zxing/aztec/detector/Detector$Point;ZII)Lcom/google/zxing/aztec/detector/Detector$Point;
    ...
    invoke-direct {p0, v3, v5, v4, v7}, Lcom/google/zxing/aztec/detector/Detector;->getFirstDifferent(Lcom/google/zxing/aztec/detector/Detector$Point;ZII)Lcom/google/zxing/aztec/detector/Detector$Point;
    ...
    invoke-direct {p0, v6, v5, v7, v8}, Lcom/google/zxing/aztec/detector/Detector;->getFirstDifferent(Lcom/google/zxing/aztec/detector/Detector$Point;ZII)Lcom/google/zxing/aztec/detector/Detector$Point;
    ...
    invoke-static {v7, v0}, Lcom/google/zxing/aztec/detector/Detector;->distance(Lcom/google/zxing/aztec/detector/Detector$Point;Lcom/google/zxing/aztec/detector/Detector$Point;)F
    ...
    invoke-static {v6, p1}, Lcom/google/zxing/aztec/detector/Detector;->distance(Lcom/google/zxing/aztec/detector/Detector$Point;Lcom/google/zxing/aztec/detector/Detector$Point;)F
    ...
    invoke-direct {p0, v0, v2, v4, v7}, Lcom/google/zxing/aztec/detector/Detector;->isWhiteOrBlackRectangle(Lcom/google/zxing/aztec/detector/Detector$Point;Lcom/google/zxing/aztec/detector/Detector$Point;Lcom/google/zxing/aztec/detector/Detector$Point;Lcom/google/zxing/aztec/detector/Detector$Point;)Z
    ...
    iput v3, p0, Lcom/google/zxing/aztec/detector/Detector;->nbCenterLayers:I
    ...
    invoke-direct {v2, v4, v1}, Lcom/google/zxing/ResultPoint;-><init>(FF)V
    ...
    invoke-static {v6, v4, v5}, Lcom/google/zxing/aztec/detector/Detector;->expandSquare([Lcom/google/zxing/ResultPoint;FF)[Lcom/google/zxing/ResultPoint;
...
.method private static getCorrectedParameterData(JZ)I
    ...
    invoke-direct {v2, v4}, Lcom/google/zxing/common/reedsolomon/ReedSolomonDecoder;-><init>(Lcom/google/zxing/common/reedsolomon/GenericGF;)V

    sub-int/2addr v0, v1

    invoke-virtual {v2, v5, v0}, Lcom/google/zxing/common/reedsolomon/ReedSolomonDecoder;->decode([II)V
    :try_end_0
...
.method private getFirstDifferent(Lcom/google/zxing/aztec/detector/Detector$Point;ZII)Lcom/google/zxing/aztec/detector/Detector$Point;
    ...
    :goto_2
    invoke-direct {p0, v2, v0}, Lcom/google/zxing/aztec/detector/Detector;->isValid(II)Z
...
.method private getMatrixCenter()Lcom/google/zxing/aztec/detector/Detector$Point;
    ...
    invoke-direct {v0, v1, v2, v4, v3}, Lcom/google/zxing/common/detector/WhiteRectangleDetector;-><init>(Lcom/google/zxing/common/BitMatrix;III)V
    ...
    invoke-direct {v4, v5, v0}, Lcom/google/zxing/aztec/detector/Detector$Point;-><init>(II)V
    ...
    invoke-direct {p0, v2, v7, v8, v8}, Lcom/google/zxing/aztec/detector/Detector;->getFirstDifferent(Lcom/google/zxing/aztec/detector/Detector$Point;ZII)Lcom/google/zxing/aztec/detector/Detector$Point;
    ...
    invoke-direct {v3, v5, v6}, Lcom/google/zxing/aztec/detector/Detector$Point;-><init>(II)V

    invoke-direct {p0, v3, v7, v9, v8}, Lcom/google/zxing/aztec/detector/Detector;->getFirstDifferent(Lcom/google/zxing/aztec/detector/Detector$Point;ZII)Lcom/google/zxing/aztec/detector/Detector$Point;

    move-result-object v3

    invoke-virtual {v3}, Lcom/google/zxing/aztec/detector/Detector$Point;->toResultPoint()Lcom/google/zxing/ResultPoint;
    ...
    invoke-direct {p0, v0, v7, v8, v9}, Lcom/google/zxing/aztec/detector/Detector;->getFirstDifferent(Lcom/google/zxing/aztec/detector/Detector$Point;ZII)Lcom/google/zxing/aztec/detector/Detector$Point;
    ...
    invoke-direct {v0, v2, v5}, Lcom/google/zxing/aztec/detector/Detector$Point;-><init>(II)V

    invoke-direct {p0, v0, v7, v8, v8}, Lcom/google/zxing/aztec/detector/Detector;->getFirstDifferent(Lcom/google/zxing/aztec/detector/Detector$Point;ZII)Lcom/google/zxing/aztec/detector/Detector$Point;
    ...
    invoke-direct {v2, v5, v6}, Lcom/google/zxing/aztec/detector/Detector$Point;-><init>(II)V

    invoke-direct {p0, v2, v7, v9, v8}, Lcom/google/zxing/aztec/detector/Detector;->getFirstDifferent(Lcom/google/zxing/aztec/detector/Detector$Point;ZII)Lcom/google/zxing/aztec/detector/Detector$Point;
    ...
    invoke-direct {v5, v4, v3}, Lcom/google/zxing/aztec/detector/Detector$Point;-><init>(II)V
...
.method private static getRotation([II)I
    ...
    sget-object v1, Lcom/google/zxing/aztec/detector/Detector;->EXPECTED_CORNER_BITS:[I
