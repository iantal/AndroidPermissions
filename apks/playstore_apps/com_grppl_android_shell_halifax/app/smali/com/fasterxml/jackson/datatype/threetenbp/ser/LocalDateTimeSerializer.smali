.class public Lcom/fasterxml/jackson/datatype/threetenbp/ser/LocalDateTimeSerializer;
...
# static fields
.field public static final INSTANCE:Lcom/fasterxml/jackson/datatype/threetenbp/ser/LocalDateTimeSerializer;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/fasterxml/jackson/datatype/threetenbp/ser/LocalDateTimeSerializer;

    invoke-direct {v0}, Lcom/fasterxml/jackson/datatype/threetenbp/ser/LocalDateTimeSerializer;-><init>()V

    sput-object v0, Lcom/fasterxml/jackson/datatype/threetenbp/ser/LocalDateTimeSerializer;->INSTANCE:Lcom/fasterxml/jackson/datatype/threetenbp/ser/LocalDateTimeSerializer;
...
.method protected constructor <init>()V
    ...
    invoke-direct {p0, v0}, Lcom/fasterxml/jackson/datatype/threetenbp/ser/LocalDateTimeSerializer;-><init>(Lorg/threeten/bp/format/DateTimeFormatter;)V

    return-void
.end method

.method private constructor <init>(Lcom/fasterxml/jackson/datatype/threetenbp/ser/LocalDateTimeSerializer;Ljava/lang/Boolean;Lorg/threeten/bp/format/DateTimeFormatter;)V
    .locals 0
...
.method public bridge synthetic serialize(Ljava/lang/Object;Lcom/fasterxml/jackson/core/JsonGenerator;Lcom/fasterxml/jackson/databind/SerializerProvider;)V
    ...
    invoke-virtual {p0, p1, p2, p3}, Lcom/fasterxml/jackson/datatype/threetenbp/ser/LocalDateTimeSerializer;->serialize(Lorg/threeten/bp/LocalDateTime;Lcom/fasterxml/jackson/core/JsonGenerator;Lcom/fasterxml/jackson/databind/SerializerProvider;)V

    return-void
.end method

.method public serialize(Lorg/threeten/bp/LocalDateTime;Lcom/fasterxml/jackson/core/JsonGenerator;Lcom/fasterxml/jackson/databind/SerializerProvider;)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-virtual {p0, p3}, Lcom/fasterxml/jackson/datatype/threetenbp/ser/LocalDateTimeSerializer;->useTimestamp(Lcom/fasterxml/jackson/databind/SerializerProvider;)Z
    ...
    invoke-virtual {p1}, Lorg/threeten/bp/LocalDateTime;->getMonthValue()I
    ...
    invoke-virtual {p1}, Lorg/threeten/bp/LocalDateTime;->getMinute()I

    move-result v0

    invoke-virtual {p2, v0}, Lcom/fasterxml/jackson/core/JsonGenerator;->writeNumber(I)V

    invoke-virtual {p1}, Lorg/threeten/bp/LocalDateTime;->getSecond()I

    move-result v0

    if-gtz v0, :cond_0

    invoke-virtual {p1}, Lorg/threeten/bp/LocalDateTime;->getNano()I
    ...
    invoke-virtual {p1, v0}, Lorg/threeten/bp/LocalDateTime;->get(Lorg/threeten/bp/temporal/TemporalField;)I
    ...
    :cond_3
    iget-object v0, p0, Lcom/fasterxml/jackson/datatype/threetenbp/ser/LocalDateTimeSerializer;->_formatter:Lorg/threeten/bp/format/DateTimeFormatter;

    if-nez v0, :cond_4

    invoke-virtual {p0}, Lcom/fasterxml/jackson/datatype/threetenbp/ser/LocalDateTimeSerializer;->_defaultFormatter()Lorg/threeten/bp/format/DateTimeFormatter;
...
.method protected withFormat(Ljava/lang/Boolean;Lorg/threeten/bp/format/DateTimeFormatter;)Lcom/fasterxml/jackson/datatype/threetenbp/ser/ThreeTenFormattedSerializerBase;
    ...
    invoke-direct {v0, p0, p1, p2}, Lcom/fasterxml/jackson/datatype/threetenbp/ser/LocalDateTimeSerializer;-><init>(Lcom/fasterxml/jackson/datatype/threetenbp/ser/LocalDateTimeSerializer;Ljava/lang/Boolean;Lorg/threeten/bp/format/DateTimeFormatter;)V
