...
.method public resolveDate(Ljava/util/Map;Lorg/threeten/bp/format/ResolverStyle;)Lorg/threeten/bp/LocalDate;
    ...
    invoke-virtual {p0, p1, v1, v2, v3}, Lorg/threeten/bp/chrono/IsoChronology;->updateResolveMap(Ljava/util/Map;Lorg/threeten/bp/temporal/ChronoField;J)V
    ...
    :goto_1
    invoke-virtual {p0, p1, v2, v0, v1}, Lorg/threeten/bp/chrono/IsoChronology;->updateResolveMap(Ljava/util/Map;Lorg/threeten/bp/temporal/ChronoField;J)V
    ...
    invoke-static {v2, v8}, Lorg/threeten/bp/jdk8/Jdk8Methods;->safeSubtract(II)I

    move-result v2

    int-to-long v2, v2

    invoke-static {v0, v8}, Lorg/threeten/bp/jdk8/Jdk8Methods;->safeSubtract(II)I

    move-result v0

    int-to-long v4, v0

    invoke-static {v1, v8, v8}, Lorg/threeten/bp/LocalDate;->of(III)Lorg/threeten/bp/LocalDate;
    ...
    sget-object v3, Lorg/threeten/bp/Month;->FEBRUARY:Lorg/threeten/bp/Month;
    ...
    invoke-virtual {v3, v4}, Lorg/threeten/bp/Month;->length(Z)I
    ...
    invoke-virtual {v0, v6, v7}, Lorg/threeten/bp/LocalDate;->plusDays(J)Lorg/threeten/bp/LocalDate;
    ...
    invoke-static {v1, v2, v8}, Lorg/threeten/bp/LocalDate;->of(III)Lorg/threeten/bp/LocalDate;
    ...
    invoke-virtual {v1, v0}, Lorg/threeten/bp/LocalDate;->with(Lorg/threeten/bp/temporal/TemporalAdjuster;)Lorg/threeten/bp/LocalDate;
    ...
    invoke-static {v1, v8}, Lorg/threeten/bp/LocalDate;->ofYearDay(II)Lorg/threeten/bp/LocalDate;
    ...
    invoke-static {v1, v0}, Lorg/threeten/bp/LocalDate;->ofYearDay(II)Lorg/threeten/bp/LocalDate;
    ...
    invoke-virtual {v3, v4, v5}, Lorg/threeten/bp/LocalDate;->plusDays(J)Lorg/threeten/bp/LocalDate;
    ...
    invoke-virtual {v0, v2}, Lorg/threeten/bp/LocalDate;->get(Lorg/threeten/bp/temporal/TemporalField;)I
    ...
    invoke-virtual {v3, v4, v5}, Lorg/threeten/bp/LocalDate;->plusWeeks(J)Lorg/threeten/bp/LocalDate;
    ...
    invoke-virtual {v2, v0}, Lorg/threeten/bp/LocalDate;->with(Lorg/threeten/bp/temporal/TemporalAdjuster;)Lorg/threeten/bp/LocalDate;
