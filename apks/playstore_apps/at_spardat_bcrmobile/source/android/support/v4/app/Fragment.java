  ...
  implements ComponentCallbacks, View.OnCreateContextMenuListener
{
  ...
  public static Fragment a(Context paramContext, String paramString, Bundle paramBundle)
  {
    ...
    {
      throw new o("Unable to instantiate fragment " + paramString + ": make sure class name exists, is public, and has an empty constructor that is public", paramContext);
    }
  ...
  public void a(Context paramContext)
  {
    this.P = true;
    if (this.C == null) {}
    for (paramContext = null;; paramContext = this.C.g())
    {
  ...
  public final void a(AttributeSet paramAttributeSet, Bundle paramBundle)
  {
    this.P = true;
    if (this.C == null) {}
    for (paramAttributeSet = null;; paramAttributeSet = this.C.g())
    {
  ...
  public LayoutInflater b(Bundle paramBundle)
  {
    ...
    {
      w localW = this.D;
      android.support.v4.view.s.a(paramBundle, this.D);
      return paramBundle;
      label49:
      if (this.k >= 4) {
        this.D.j();
