  ...
  extends d
{
  ...
  private void g()
  {
    ...
    if ((localObject != null) && (at.spardat.bcrmobile.b.a.a.compareTo((Integer)localObject) == 0))
    {
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    for (int i = paramBundle.getInt("APP_DEMO_CURRENT_PAGE", 0);; i = 0)
    {
      ...
      paramBundle = new c(this, new b(this, (byte)0), 11);
      ...
      ((Button)findViewById(2131427448)).setOnClickListener(new View.OnClickListener()
      {
        public final void onClick(View paramAnonymousView)
        {
          ...
          {
            paramAnonymousView = AppDemoActivity.this.getSharedPreferences("PREF_LOCALE_FILE", 0).edit();
            if (paramAnonymousView != null)
            {
              paramAnonymousView.putBoolean("PREF_APPDEMO_CHOICE_REMEMBER", true);
              paramAnonymousView.commit();
            }
            paramAnonymousView = new Intent(AppDemoActivity.this, HomeActivity.class);
            paramAnonymousView.putExtra("ACTIVITY_FROM", AppDemoActivity.class);
            AppDemoActivity.this.startActivity(paramAnonymousView);
          }
