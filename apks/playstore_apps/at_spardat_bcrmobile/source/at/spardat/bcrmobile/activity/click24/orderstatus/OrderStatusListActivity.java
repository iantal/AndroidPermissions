  ...
  implements at.spardat.bcrmobile.d.f
{
  ...
  private final AbsListView.OnScrollListener k = new AbsListView.OnScrollListener()
  {
    public final void onScroll(AbsListView paramAnonymousAbsListView, int paramAnonymousInt1, int paramAnonymousInt2, int paramAnonymousInt3)
    {
      ...
      {
        paramAnonymousAbsListView = OrderStatusListActivity.this;
      ...
      {
        OrderStatusListActivity.a(paramAnonymousAbsListView, bool);
        return;
      }
    }
  ...
  private final View.OnClickListener m = new View.OnClickListener()
  {
    public final void onClick(View paramAnonymousView)
    {
      ...
      {
        paramAnonymousView = at.spardat.bcrmobile.e.i.c(OrderStatusListActivity.e(OrderStatusListActivity.this).getCurrentLoadingDays());
        if (paramAnonymousView != null) {
          OrderStatusListActivity.a(OrderStatusListActivity.this, at.spardat.bcrmobile.e.d.c(paramAnonymousView.getDays()), at.spardat.bcrmobile.e.d.b(paramAnonymousView.getDays()));
        }
      }
    }
  };
  ...
  private void g()
  {
    ...
    if ((this.h != null) && (!at.spardat.bcrmobile.e.d.a(this.h.getPayments())))
    {
      ...
      Object localObject = at.spardat.bcrmobile.service.a.a.a(at.spardat.bcrmobile.e.d.a(this.h.getPayments()));
      ArrayList localArrayList1 = new ArrayList();
      ArrayList localArrayList2 = new ArrayList();
      localArrayList1.addAll(((Map)localObject).values());
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    if (this.h == null)
    {
      paramBundle = at.spardat.bcrmobile.e.i.c(null);
      b(at.spardat.bcrmobile.e.d.c(paramBundle.getDays()), at.spardat.bcrmobile.e.d.b(paramBundle.getDays()));
    }
    for (;;)
    {
