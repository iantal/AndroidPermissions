  ...
  implements at.spardat.bcrmobile.d.b
{
  ...
  private void c(String paramString)
  {
    ...
    catch (ActivityNotFoundException paramString)
    {
      ...
      at.spardat.bcrmobile.b.b.a(at.spardat.bcrmobile.b.c.ERROR, PaymentAuthorizationActivity.class.getName(), "pushEtokenApp() " + paramString.getLocalizedMessage());
    }
  }
  ...
  private void d(String paramString)
  {
    ...
    if (paramString != null)
    {
      this.h.execute(new String[] { this.f.getReferenceNumber(), paramString });
      return;
    }
    this.h.execute(new String[] { this.f.getReferenceNumber() });
  }
  ...
  private void g()
  {
    ...
    if (this.g != null)
    {
      localObject = new Intent(this, OpenTermDepositStatusActivity.class);
      if (this.d != null) {
        break label241;
      }
      ((Intent)localObject).putExtra("payment_process_status", "error");
    }
    for (;;)
    {
      if (!at.spardat.bcrmobile.e.d.a(this.o)) {
        ((Intent)localObject).putExtra("payment_error_message", this.o);
      }
      ...
      localObject = localIntent;
      if (!"done".equals(this.d.getProcessStatus())) {
        break;
      }
      ...
      if ((!this.c.equals("BILL_PAYMENT")) && (!this.c.equals("iban_payment")))
      {
        localObject = localIntent;
        if (!this.c.equals("personal_template_payment")) {
          break;
        }
      }
      ...
      break;
      label241:
      ((Intent)localObject).putExtra("payment_process_status", this.d.getProcessStatus());
    }
  }
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    this.k = paramBundle.inflate(2130903134, null);
    ((RelativeLayout.LayoutParams)localObject2).addRule(3, 2131427373);
    ...
    this.k.setVisibility(8);
    ((ViewGroup)localObject3).addView(this.k);
    ...
    localObject3 = ((Intent)localObject1).getStringExtra("payee_iban");
    String str1 = ((Intent)localObject1).getStringExtra("payee_name");
    String str2 = ((Intent)localObject1).getStringExtra("amount");
    this.c = ((Intent)localObject1).getStringExtra("payment_type");
    ...
    localObject1 = (LinearLayout)findViewById(2131427409);
    paramBundle.inflate(2130903130, (ViewGroup)localObject1, true);
    this.j = ((EditText)((LinearLayout)localObject1).findViewById(2131427716));
    this.l = ((TextView)((LinearLayout)localObject1).findViewById(2131427713));
    this.n = ((Button)((LinearLayout)localObject1).findViewById(2131427406));
    if (this.g != null)
    {
      paramBundle = this.g.getDepositAmount();
      localObject2 = (RelativeLayout)findViewById(2131427412);
      if (at.spardat.bcrmobile.e.d.a(paramBundle)) {
        break label931;
      }
      localObject3 = this.e.getAccountCurrency();
    }
    label926:
    label931:
    for (paramBundle = at.spardat.bcrmobile.e.d.a(new Object[] { at.spardat.bcrmobile.e.d.a(getApplicationContext(), paramBundle.trim(), (String)localObject3, true), " ", localObject3 });; paramBundle = null)
    {
      paramBundle = new at.spardat.bcrmobile.view.layout.a.a.a(this, null, null, this.g.getDepositName(), paramBundle);
      ((LinearLayout)localObject1).findViewById(2131427715).setVisibility(8);
      ...
      localObject2 = (RelativeLayout)findViewById(2131427412);
      String str3 = this.e.getAccountCurrency();
      if ((this.e.getAccountType() == at.spardat.bcrmobile.b.a.c.DEP) || (!a(this.f.isTokenRequired()))) {
        if (at.spardat.bcrmobile.e.d.a(str2)) {
          break label926;
        }
      }
      for (paramBundle = at.spardat.bcrmobile.e.d.a(new Object[] { at.spardat.bcrmobile.e.d.a(getApplicationContext(), str2.trim(), str3, true), " ", str3 });; paramBundle = null)
      {
        paramBundle = new at.spardat.bcrmobile.view.layout.a.a.a(this, this.f, (String)localObject3, str1, paramBundle);
        ((LinearLayout)localObject1).findViewById(2131427715).setVisibility(8);
        this.j.setVisibility(8);
        this.n.setText(2131165603);
        this.n.setPadding(at.spardat.bcrmobile.e.d.a(this, 20), 0, at.spardat.bcrmobile.e.d.a(this, 20), 0);
        ...
        localObject1 = "";
        if (!at.spardat.bcrmobile.e.d.a(str2)) {
          paramBundle = at.spardat.bcrmobile.e.d.a(str2.trim(), str3, getApplicationContext());
        }
        if (!at.spardat.bcrmobile.e.d.a((String)localObject3)) {
          localObject1 = at.spardat.bcrmobile.e.d.e((String)localObject3);
        }
        localObject1 = String.format(getString(2131165932), new Object[] { paramBundle, localObject1 });
        if (!at.spardat.bcrmobile.e.d.a(str2)) {}
        for (paramBundle = at.spardat.bcrmobile.e.d.a(new Object[] { h.a(str2.trim(), str3, getApplicationContext()), " ", str3 });; paramBundle = null)
        {
          paramBundle = new at.spardat.bcrmobile.view.layout.a.a.a(this, this.f, (String)localObject3, str1, paramBundle, (String)localObject1);
