...
public final class a
{
  ...
  private boolean[] a(boolean[] paramArrayOfBoolean)
  {
    ...
    for (;;)
    {
      ...
      catch (com.google.zxing.b.b.e paramArrayOfBoolean)
      {
        throw h.a(paramArrayOfBoolean);
      }
      if (i2 != 1)
      {
        m = k;
  ...
  public final com.google.zxing.b.e a(com.google.zxing.a.a paramA)
  {
    ...
    for (j = 0; k < i1; j = (i3 << 3) + j)
    {
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          if (n < 2)
          {
            localObject2[(j + i6 + n)] = paramA.a(localObject1[(i4 + n)], localObject1[(i4 + m)]);
            localObject2[(i3 * 2 + j + i6 + n)] = paramA.a(localObject1[(i4 + m)], localObject1[(i5 - n)]);
            localObject2[(i3 * 4 + j + i6 + n)] = paramA.a(localObject1[(i5 - n)], localObject1[(i5 - m)]);
            localObject2[(i3 * 6 + j + i6 + n)] = paramA.a(localObject1[(i5 - m)], localObject1[(i4 + n)]);
            n += 1;
            continue;
            m = 12;
            break;
    ...
    for (;;)
    {
      ...
      k = n;
      break;
      paramA = new com.google.zxing.b.e((byte[])localObject2, localStringBuilder.toString(), null, null);
      paramA.a(localObject1.length);
      return paramA;
      break label669;
    }
  }
