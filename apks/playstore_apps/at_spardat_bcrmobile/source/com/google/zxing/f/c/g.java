...
final class g
{
  ...
  private static int a(String paramString, int paramInt, Charset paramCharset)
  {
    ...
    while (j < m)
    {
      ...
      if (!paramCharset.canEncode(c1)) {
        throw new u("Non-encodable character detected: " + c1 + " (Unicode: " + c1 + ')');
      }
      j += 1;
    }
    return j - paramInt;
  ...
  static String a(String paramString, c paramC, Charset paramCharset)
  {
    ...
    while (j < i1)
    {
      ...
      else
      {
        ...
        else
        {
          ...
          a(paramC, 0, 1, 0, localStringBuilder);
        }
      }
    }
    for (;;)
    {
      ...
      break;
      label483:
      a(paramC, 0, paramC.length, k, localStringBuilder);
      i = 0;
      k = 1;
    }
  }
    ...
    else
    {
      for (;;)
      {
        ...
        for (;;)
        {
          if (paramInt3 < 6)
          {
            l = (l << 8) + (paramArrayOfByte[(paramInt1 + paramInt3)] & 0xFF);
            paramInt3 += 1;
            continue;
            if (paramInt2 % 6 == 0)
            {
        ...
        while (paramInt3 < 5)
        {
          arrayOfChar[paramInt3] = ((char)(int)(l % 900L));
          l /= 900L;
          paramInt3 += 1;
        }
        paramInt3 = 4;
        while (paramInt3 >= 0)
        {
          paramStringBuilder.append(arrayOfChar[paramInt3]);
          paramInt3 -= 1;
        }
        paramInt1 += 6;
      }
