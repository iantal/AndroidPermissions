...
.method private static a(Landroid/content/Context;ILcom/google/android/gms/common/internal/z;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    .locals 5
...
.method private static a(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
    ...
    invoke-virtual {p0}, Landroid/support/v4/app/p;->c()Landroid/support/v4/app/v;
    ...
    invoke-virtual {v1, v0, p2}, Lcom/google/android/gms/common/g;->a(Landroid/support/v4/app/v;Ljava/lang/String;)V
...
.method private a(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;)V
    .locals 7
    .annotation build Landroid/annotation/TargetApi;
        value = 0x14
    .end annotation
    ...
    sget v3, Lcom/google/android/gms/c;->o:I
    ...
    :cond_3
    new-instance v3, Landroid/support/v4/app/aq;

    invoke-direct {v3, p1}, Landroid/support/v4/app/aq;-><init>(Landroid/content/Context;)V

    iget-object v4, v3, Landroid/support/v4/app/aq;->F:Landroid/app/Notification;

    const v5, 0x108008a

    iput v5, v4, Landroid/app/Notification;->icon:I

    sget v4, Lcom/google/android/gms/c;->g:I

    invoke-virtual {v2, v4}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v3, v2}, Landroid/support/v4/app/aq;->c(Ljava/lang/CharSequence;)Landroid/support/v4/app/aq;
    ...
    iget-object v3, v2, Landroid/support/v4/app/aq;->F:Landroid/app/Notification;

    iput-wide v4, v3, Landroid/app/Notification;->when:J

    invoke-virtual {v2, v6}, Landroid/support/v4/app/aq;->a(Z)Landroid/support/v4/app/aq;

    move-result-object v2

    invoke-virtual {v2, p4}, Landroid/support/v4/app/aq;->a(Landroid/app/PendingIntent;)Landroid/support/v4/app/aq;

    move-result-object v2

    invoke-virtual {v2, v0}, Landroid/support/v4/app/aq;->a(Ljava/lang/CharSequence;)Landroid/support/v4/app/aq;

    move-result-object v0

    invoke-virtual {v0, v1}, Landroid/support/v4/app/aq;->b(Ljava/lang/CharSequence;)Landroid/support/v4/app/aq;

    move-result-object v0

    invoke-virtual {v0, v6}, Landroid/support/v4/app/aq;->b(Z)Landroid/support/v4/app/aq;

    move-result-object v0

    new-instance v2, Landroid/support/v4/app/ap;

    invoke-direct {v2}, Landroid/support/v4/app/ap;-><init>()V

    invoke-virtual {v2, v1}, Landroid/support/v4/app/ap;->a(Ljava/lang/CharSequence;)Landroid/support/v4/app/ap;

    move-result-object v1

    invoke-virtual {v0, v1}, Landroid/support/v4/app/aq;->a(Landroid/support/v4/app/bf;)Landroid/support/v4/app/aq;

    move-result-object v0

    invoke-virtual {v0}, Landroid/support/v4/app/aq;->a()Landroid/app/Notification;
    ...
    sget-object v1, Lcom/google/android/gms/common/q;->f:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public final a(Landroid/app/Activity;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    invoke-static {p1, v0, v1, p2}, Lcom/google/android/gms/common/b;->a(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
...
.method public final a(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;
    ...
    invoke-super {p0, p1, p2, p3}, Lcom/google/android/gms/common/k;->a(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;
...
.method public final a(Landroid/content/Context;Lcom/google/android/gms/internal/f;)Lcom/google/android/gms/internal/zzaar;
    .locals 2
    ...
    invoke-direct {v0, p2}, Lcom/google/android/gms/internal/zzaar;-><init>(Lcom/google/android/gms/internal/f;)V

    invoke-virtual {p1, v0, v1}, Landroid/content/Context;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;

    invoke-virtual {v0, p1}, Lcom/google/android/gms/internal/zzaar;->a(Landroid/content/Context;)V

    const-string v1, "com.google.android.gms"

    invoke-static {p1, v1}, Lcom/google/android/gms/common/q;->a(Landroid/content/Context;Ljava/lang/String;)Z

    move-result v1

    if-nez v1, :cond_0

    invoke-virtual {p2}, Lcom/google/android/gms/internal/f;->a()V

    invoke-virtual {v0}, Lcom/google/android/gms/internal/zzaar;->a()V
...
.method public final a(Landroid/content/Context;Lcom/google/android/gms/common/ConnectionResult;I)V
    ...
    invoke-super {p0, p1, v0, v1}, Lcom/google/android/gms/common/k;->a(Landroid/content/Context;II)Landroid/app/PendingIntent;
...
.method public final a(Landroid/app/Activity;IILandroid/content/DialogInterface$OnCancelListener;)Z
    ...
    invoke-super {p0, p1, p2, v1}, Lcom/google/android/gms/common/k;->a(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;

    move-result-object v1

    invoke-static {p1, v1, v0}, Lcom/google/android/gms/common/internal/z;->a(Landroid/app/Activity;Landroid/content/Intent;I)Lcom/google/android/gms/common/internal/z;

    move-result-object v0

    invoke-static {p1, p2, v0, p4}, Lcom/google/android/gms/common/b;->a(Landroid/content/Context;ILcom/google/android/gms/common/internal/z;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
...
.method public final a(Landroid/app/Activity;Lcom/google/android/gms/internal/h;IILandroid/content/DialogInterface$OnCancelListener;)Z
    .locals 2

    const-string v0, "d"

    invoke-super {p0, p1, p3, v0}, Lcom/google/android/gms/common/k;->a(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;

    move-result-object v0

    const/4 v1, 0x2

    invoke-static {p2, v0, v1}, Lcom/google/android/gms/common/internal/z;->a(Lcom/google/android/gms/internal/h;Landroid/content/Intent;I)Lcom/google/android/gms/common/internal/z;

    move-result-object v0

    invoke-static {p1, p3, v0, p5}, Lcom/google/android/gms/common/b;->a(Landroid/content/Context;ILcom/google/android/gms/common/internal/z;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
...
.method public final b(I)Ljava/lang/String;
    ...
    invoke-super {p0, p1}, Lcom/google/android/gms/common/k;->b(I)Ljava/lang/String;
