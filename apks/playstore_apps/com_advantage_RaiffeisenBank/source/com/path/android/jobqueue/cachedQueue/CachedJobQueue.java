  ...
  implements JobQueue
{
  ...
  public int countReadyJobs(boolean paramBoolean, Collection<String> paramCollection)
  {
    ...
    {
      return i;
      j = this.delegate.countReadyJobs(paramBoolean, paramCollection);
      i = j;
    } while (j != 0);
    count();
    return j;
  ...
  public JobHolder nextJobAndIncRunCount(boolean paramBoolean, Collection<String> paramCollection)
  {
    ...
    paramCollection = this.cache;
    Integer localInteger = paramCollection.count;
    paramCollection.count = Integer.valueOf(paramCollection.count.intValue() - 1);
    return localJobHolder;
  }
  ...
  private static class Cache
  {
    ...
    private static class DelayUntil
    {
      ...
      private boolean validateExcludes(Collection<String> paramCollection)
      {
        ...
        Iterator localIterator = this.excludeGroups.iterator();
