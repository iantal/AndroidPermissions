  ...
  implements ReprintModule
{
  ...
  public void authenticate(final CancellationSignal paramCancellationSignal, final AuthenticationListener paramAuthenticationListener, final boolean paramBoolean)
  {
    ...
    {
      this.logger.logException(paramCancellationSignal, "SpassReprintModule: fingerprint identification would not start");
  ...
  public boolean isHardwarePresent()
  {
    ...
    try
    {
      if (this.spass != null)
      {
        boolean bool3 = this.spass.isFeatureEnabled(0);
        bool1 = bool2;
        if (bool3) {
          bool1 = true;
        }
