  ...
  extends AbstractSafeParcelable
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    } while ((this.versionCode == paramObject.versionCode) && (this.packageName.equals(paramObject.packageName)) && (this.axu == paramObject.axu) && (this.axv == paramObject.axv) && (zzab.equal(this.axz, paramObject.axz)) && (zzab.equal(this.axw, paramObject.axw)) && (zzab.equal(this.axx, paramObject.axx)) && (this.axy == paramObject.axy) && (this.axA == paramObject.axA) && (this.axB == paramObject.axB));
    return false;
    return false;
  }
