  ...
  extends IInterface
{
    ...
    implements zzag
  {
    ...
    public static zzag zziw(IBinder paramIBinder)
    {
      ...
      throws RemoteException
    {
      ...
      paramParcel1.enforceInterface("com.google.android.gms.maps.internal.ISnapshotReadyCallback");
      zzag(zzd.zza.zzfe(paramParcel1.readStrongBinder()));
      paramParcel2.writeNoException();
      return true;
    }
      ...
      implements zzag
    {
        ...
        throws RemoteException
      {
        ...
        //   29: aload_0
        //   30: getfield 18	com/google/android/gms/maps/internal/zzag$zza$zza:zzajf	Landroid/os/IBinder;
        //   33: iconst_1
        //   34: aload_2
        //   35: aload_3
        //   36: iconst_0
        ...
        throws RemoteException
      {
        ...
        //   30: aload_0
        //   31: getfield 18	com/google/android/gms/maps/internal/zzag$zza$zza:zzajf	Landroid/os/IBinder;
        //   34: iconst_2
        //   35: aload_2
        //   36: aload_3
        //   37: iconst_0
