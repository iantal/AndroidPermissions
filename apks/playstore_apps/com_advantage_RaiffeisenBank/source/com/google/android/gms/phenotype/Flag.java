  ...
  implements Comparable<Flag>
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    if ((paramObject != null) && ((paramObject instanceof Flag)))
    {
      ...
      if ((this.mVersionCode != paramObject.mVersionCode) || (!zzab.equal(this.name, paramObject.name)) || (this.axr != paramObject.axr) || (this.axs != paramObject.axs)) {
        bool = false;
      }
      do
      {
        do
        {
          ...
          } while (this.axp == paramObject.axp);
          return false;
        } while (this.afy == paramObject.afy);
        return false;
      } while (this.afA == paramObject.afA);
      return false;
      return zzab.equal(this.Dr, paramObject.Dr);
      return Arrays.equals(this.axq, paramObject.axq);
    }
    return false;
  }
