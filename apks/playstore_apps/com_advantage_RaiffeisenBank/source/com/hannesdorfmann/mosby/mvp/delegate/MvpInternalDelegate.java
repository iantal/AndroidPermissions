...
class MvpInternalDelegate<V extends MvpView, P extends MvpPresenter<V>>
{
  ...
  {
    MvpPresenter localMvpPresenter2 = this.delegateCallback.getPresenter();
    MvpPresenter localMvpPresenter1 = localMvpPresenter2;
    if (localMvpPresenter2 == null) {
      localMvpPresenter1 = this.delegateCallback.createPresenter();
    }
    if (localMvpPresenter1 == null) {
      throw new NullPointerException("Presenter is null! Do you return null in createPresenter()?");
    }
    this.delegateCallback.setPresenter(localMvpPresenter1);
  }
