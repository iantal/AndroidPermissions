  ...
  implements MvpViewStateViewGroupDelegateCallback<V, P>
{
  ...
  public MvpViewStateLinearLayout(Context paramContext)
  {
    super(paramContext);
  }
  
  public MvpViewStateLinearLayout(Context paramContext, AttributeSet paramAttributeSet)
  {
    super(paramContext, paramAttributeSet);
  }
  
  public MvpViewStateLinearLayout(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    super(paramContext, paramAttributeSet, paramInt);
  }
  
  @TargetApi(21)
  public MvpViewStateLinearLayout(Context paramContext, AttributeSet paramAttributeSet, int paramInt1, int paramInt2)
  {
