  ...
  extends DSQFragment
{
  ...
  public void onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup)
  {
    ...
    if (this.withValidationFromServer)
    {
      paramLayoutInflater = getResources().getString(2131165501);
      if (this.comingFromAuthorization) {
        paramLayoutInflater = getResources().getString(2131165502);
      }
      DSQHelper.showValidationDialogWithIcon(getActivity(), paramLayoutInflater, 2130838056);
    }
  }
