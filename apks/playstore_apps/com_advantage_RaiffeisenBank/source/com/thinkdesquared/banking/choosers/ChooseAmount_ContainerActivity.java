  ...
  implements ChooseAmount_KeyboardFragment.OnAmountKeyboardListener, ChooseAmount_CurrencyFragment.OnAmountCurrencyChangedListener
{
  ...
  private void returnWithAmountAndCurrency(Boolean paramBoolean1, Boolean paramBoolean2)
  {
    ...
    {
      paramBoolean1 = this.mCurrencyFragment.getSelectedCurrency();
      paramBoolean2 = this.mCurrencyFragment.getAmountType();
      String str = this.mKeyboardFragment.getSelectedAmount();
      Bundle localBundle = new Bundle();
      localBundle.putString("amount", str);
      localBundle.putString("amountType", paramBoolean2);
      localBundle.putSerializable("ccy", paramBoolean1);
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    if (paramBundle == null)
    {
      ...
      paramBundle.add(2131558630, this.mKeyboardFragment);
      paramBundle.add(2131558632, this.mCurrencyFragment);
      paramBundle.add(2131558631, this.mScreenFragment);
      paramBundle.commit();
    ...
    this.mScreenFragment = ((ChooseAmount_ScreenFragment)paramBundle.findFragmentById(2131558631));
    this.mCurrencyFragment = ((ChooseAmount_CurrencyFragment)paramBundle.findFragmentById(2131558632));
    this.mKeyboardFragment = ((ChooseAmount_KeyboardFragment)paramBundle.findFragmentById(2131558630));
  }
