    ...
    extends AsyncTask<String, Void, GenericResultResponse>
  {
    ...
    protected GenericResultResponse doInBackground(String... paramVarArgs)
    {
      if (AibasStore.getInstance().getLoggedInState() == AibasStore.LoggedInState.LoggedInState_ON)
      {
        ...
        return new SOAPRequests().transferFromTimeAccountResultRequest(paramVarArgs, TransferFromTimeAccountVerifyFragment.this.getAuthorizationElements());
      }
    ...
    protected void onPostExecute(GenericResultResponse paramGenericResultResponse)
    {
      ...
      {
        str = TransferFromTimeAccountVerifyFragment.this.getString(2131166151);
        TransferFromTimeAccountVerifyFragment.this.mListener.onReceivedSuccessfullResultResponse(str, true, paramGenericResultResponse, 2131166284);
        return;
      }
