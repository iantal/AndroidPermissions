...
public class IntrabankPaymentResultJob
  extends SessionBoundJob
{
  ...
  public IntrabankPaymentResultJob(String paramString1, String paramString2, String paramString3, ArrayList<DSQAuthorizationInfo> paramArrayList, TouchIdAuthorizationData paramTouchIdAuthorizationData)
  {
    ...
    throws Throwable
  {
    ...
    for (GenericResultResponse localGenericResultResponse = new DemoRequests().paymentsDemoResultRequest(this.mTemplate);; localGenericResultResponse = new SOAPRequests().intrabankPaymentResultRequest(this.mWorkflowId, this.mAuthorizationInfo, this.mTouchIdAuthorizationData))
    {
      assertNotCancelled();
      LogHelper.d(this.TAG, "Intrabank Payment Result Send");
