  ...
  implements TransferOwnFragment.TransferOwnFragmentListener, DatePickerFragment.DatePickerFragmentListener
{
  ...
  protected void onActivityResult(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    if ((paramInt2 == -1) && (paramInt1 == 1))
    {
      ...
      if (paramIntent != null)
      {
        ...
        this.mTransferOwnFragment.onAmountChooserDismissedWithAmount(paramIntent);
      }
    }
  }
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    if (paramBundle == null)
    {
      ...
      paramBundle.replace(2131558652, this.mTransferOwnFragment, str);
      paramBundle.commit();
    }
    for (;;)
    {
  ...
  public void openVerifyFragment(final TransferOwnData paramTransferOwnData, String paramString)
  {
    paramTransferOwnData = TransferOwnVerifyFragment.newInstance(paramTransferOwnData, paramString);
    new Handler().postDelayed(new Runnable()
    {
      public void run()
      {
        ...
        localFragmentTransaction.replace(2131558652, paramTransferOwnData);
