  ...
  extends SessionBoundJob
{
    ...
    throws Throwable
  {
    ...
    for (Object localObject = new DemoRequests().paymentVerifyDemoRequest(this.mPaymentData);; localObject = new SOAPRequests().intrabankPaymentVerifyRequest(this.mPaymentData, this.mWorkflowId, (String)localObject, this.mTuchIdAuthorizationData))
    {
      assertNotCancelled();
