  ...
  extends VerifyFragment
{
  ...
  private void initWithVerifyResponse()
  {
    ...
    label418:
    for (String str = localMobileTopUpModel.getFromAccount() + " - " + localMobileTopUpModel.getFromAccountCcy();; str = localMobileTopUpModel.getFromAccountNickname() + " (" + localMobileTopUpModel.getFromAccount() + ") - " + localMobileTopUpModel.getFromAccountCcy())
    {
      ...
      return;
      str = localMobileTopUpModel.getTemplateId();
      break;
    }
  }
  ...
  public void onEventMainThread(MobileTopUpResultResponseEvent paramMobileTopUpResultResponseEvent)
  {
    ...
    if ("S".equalsIgnoreCase(localGenericResultResponse.resultCode))
    {
      ...
      for (paramMobileTopUpResultResponseEvent = getString(2131165929);; paramMobileTopUpResultResponseEvent = getString(2131165513))
      {
        this.mListener.onReceivedSuccessfullResultResponse(paramMobileTopUpResultResponseEvent, true, localGenericResultResponse, 2131166272);
        return;
      }
    }
    ...
    paramMobileTopUpResultResponseEvent = localGenericResultResponse.getErrors();
    this.mListener.onReceivedSuccessfullResultResponse(paramMobileTopUpResultResponseEvent, true, localGenericResultResponse, 2131166272);
  }
