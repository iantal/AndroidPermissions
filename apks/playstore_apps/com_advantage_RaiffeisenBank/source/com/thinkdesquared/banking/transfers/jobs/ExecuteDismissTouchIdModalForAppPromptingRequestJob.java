...
public class ExecuteDismissTouchIdModalForAppPromptingRequestJob
  extends Job
{
  private final String TAG = LogHelper.createTag(getClass());
  private String mDeviceId;
  
  public ExecuteDismissTouchIdModalForAppPromptingRequestJob(String paramString)
  {
    ...
    throws Throwable
  {
    if (AibasStore.getInstance().getLoggedInState() == AibasStore.LoggedInState.LoggedInState_DEMO) {
      new DemoRequests().executeDismissTouchIdModalForAppPrompting();
    }
    for (;;)
    {
      assertNotCancelled();
      ...
      return;
      new SOAPRequests().executeDismissTouchIdModalForAppPrompting(this.mDeviceId);
    }
  }
