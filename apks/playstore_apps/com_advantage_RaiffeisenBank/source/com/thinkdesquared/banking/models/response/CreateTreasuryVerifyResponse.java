...
public class CreateTreasuryVerifyResponse
  extends GenericVerifyResponse
{
  ...
  public CreateTreasuryVerifyResponse() {}
  
  public CreateTreasuryVerifyResponse(TreasuryData paramTreasuryData, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7, String paramString8, String paramString9)
  {
    this.verifiedData = paramTreasuryData;
    this.paymentEvidenceNumber = paramString1;
    this.toAccount = paramString2;
    this.documentNumber = paramString3;
    this.beneficiaryCountry = paramString4;
    this.payerCNP = paramString5;
    this.payerName = paramString6;
    this.amountCurrency = paramString7;
    this.fromAccountNickname = paramString8;
    this.benCounty = paramString9;
  }
  ...
  {
    StringBuilder localStringBuilder = new StringBuilder("CreateTreasuryVerifyResponse{");
