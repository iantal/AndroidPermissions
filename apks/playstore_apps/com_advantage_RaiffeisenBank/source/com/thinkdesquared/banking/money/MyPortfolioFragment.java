  ...
  extends DSQLoadingFragmentWithLayoutListener
{
  ...
  private boolean initWithAccounts(ArrayList<BankAccount> paramArrayList)
  {
    ...
    {
      public void onScroll(final AbsListView paramAnonymousAbsListView, int paramAnonymousInt1, int paramAnonymousInt2, int paramAnonymousInt3)
      {
        if (MyPortfolioFragment.this.lastFocusedPosition != -1)
        {
          ...
          {
            paramAnonymousAbsListView = (EditText)MyPortfolioFragment.this.mAdapter.getViewByPosition(MyPortfolioFragment.this.lastFocusedPosition, MyPortfolioFragment.this.mStickyList).findViewById(2131558887);
            if ((paramAnonymousAbsListView != null) && (!paramAnonymousAbsListView.isFocused())) {
              new Handler().postDelayed(new Runnable()
              {
                public void run()
                {
                  paramAnonymousAbsListView.requestFocus();
                  if ((MyPortfolioFragment.this.lastSelection != -1) && (MyPortfolioFragment.this.lastSelection <= paramAnonymousAbsListView.length())) {
                    paramAnonymousAbsListView.setSelection(MyPortfolioFragment.this.lastSelection);
                  }
                }
              }, 200L);
            }
      ...
      public Loader<MyPortfolioResponse> onCreateLoader(int paramAnonymousInt, Bundle paramAnonymousBundle)
      {
        new AsyncTaskLoader(MyPortfolioFragment.this.getActivity())
        {
          ...
          public MyPortfolioResponse loadInBackground()
          {
            ...
            Object localObject1;
            for (this.response = new DemoRequests().myPortfolioDemoRequest();; this.response = new SOAPRequests().myPortfolioRequest((String)localObject1))
            {
              ...
              {
                localObject1 = localObject2;
                if (DSQHelper.isNotEmpty(MyPortfolioFragment.this.accountNoToOpen)) {
                  localObject1 = localDeviceRegistrationData.getFeedId();
                }
              }
            }
          }
  ...
  public void onConfigurationChanged(final Configuration paramConfiguration)
  {
    ...
    if (this.mAdapter != null)
    {
      ...
      {
        paramConfiguration = (EditText)this.mAdapter.getViewByPosition(this.lastFocusedPosition, this.mStickyList).findViewById(2131558887);
        if (paramConfiguration != null) {
          new Handler().postDelayed(new Runnable()
          {
            public void run()
            {
              paramConfiguration.requestFocus();
              if ((MyPortfolioFragment.this.lastSelection != -1) && (MyPortfolioFragment.this.lastSelection <= paramConfiguration.length())) {
                paramConfiguration.setSelection(MyPortfolioFragment.this.lastSelection);
              }
            }
          }, 200L);
        }
  ...
  public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle)
  {
    ...
    paramLayoutInflater = paramLayoutInflater.inflate(2130903300, paramViewGroup, false);
    this.mLoadingAndErrorView = paramLayoutInflater.findViewById(2131559348);
    this.lineSeperator = paramLayoutInflater.findViewById(2131558818);
    this.mCancelImageView = ((ImageView)paramLayoutInflater.findViewById(2131559282));
    this.mEditTextView = ((TextView)paramLayoutInflater.findViewById(2131559283));
    this.mEditImageView = ((ImageView)paramLayoutInflater.findViewById(2131559285));
    this.mDoneTextView = ((TextView)paramLayoutInflater.findViewById(2131559284));
    this.mDummyLayout = ((RelativeLayout)paramLayoutInflater.findViewById(2131558622));
    this.mStickyList = ((OverScrolledStickyListHeadersListView)paramLayoutInflater.findViewById(2131558635));
    initLayoutListener(paramLayoutInflater, this.mStickyList);
    ...
    extends StickyListHeadersBaseAdapter
  {
    ...
    private void addNickName(View paramView, BankAccount paramBankAccount)
    {
      ...
      int j = 0;
      int i = 0;
      while (i < MyPortfolioFragment.this.nicknames.size())
      {
        if (((AccountNickname)MyPortfolioFragment.this.nicknames.get(i)).getAccountNumber().equals(localAccountNickname.getAccountNumber()))
        {
          j = 1;
          MyPortfolioFragment.this.nicknames.set(i, localAccountNickname);
        }
        i += 1;
      }
      if (j == 0) {
    ...
    private int getLastAvailablePositionOfEditText()
    {
      ...
      int i = this.accountsList.size() - 1;
      for (;;)
      {
        int j = k;
    ...
    {
      Object localObject2 = paramBankAccount.getNicknameOrNumberString();
      Object localObject1 = localObject2;
      if (!this.mIsRetail)
      {
        localObject1 = localObject2;
        if ("91".equals(paramBankAccount.getType())) {
          localObject1 = paramBankAccount.getCreditCardGenericProductName();
        }
      }
      localObject2 = localObject1;
      if (paramBankAccount.getNicknameOrNumberString().length() > 14)
      {
        localObject2 = localObject1;
        if (paramBankAccount.getAmountWithCurrencyString(MyPortfolioFragment.this.getActivity()).length() > 15)
        {
          localObject2 = localObject1;
          if (this.mContext.getResources().getConfiguration().orientation == 1)
          {
            ...
            if (!this.mContext.getResources().getBoolean(2131296263)) {
              localObject2 = MyPortfolioFragment.this.getString(2131166222, new Object[] { ((String)localObject1).substring(0, 12) });
            }
          }
        }
      }
      paramViewHolder.titleView.setText((CharSequence)localObject2);
      ...
      while (i < MyPortfolioFragment.this.nicknames.size())
      {
        localObject1 = (AccountNickname)MyPortfolioFragment.this.nicknames.get(i);
        if ((((AccountNickname)localObject1).getAccountNumber().equals(paramBankAccount.getNumber())) && (!((AccountNickname)localObject1).getAccountNickname().equals(paramBankAccount.getNickname()))) {
          paramViewHolder.editText.setText(((AccountNickname)localObject1).getAccountNickname());
        }
        i += 1;
      }
    }
    ...
    public View getHeaderView(int paramInt, View paramView)
    {
      ...
      if (paramView == null)
      {
        ...
        paramInt = getTransformerAccountType(localBankAccount.getType(), localBankAccount.getProductCode());
        if (paramInt == this.mFirstHeaderType) {
          break label224;
        }
        ...
        label141:
        MyPortfolioFragment.this.populateHeader(String.valueOf(paramInt), localHeaderViewHolder.textView);
      ...
      label224:
      label367:
      for (paramInt = DSQStylist.fetchThemedResource(this.mContext, 2130772076);; paramInt = DSQStylist.fetchThemedResource(this.mContext, 2130772148))
      {
        localHeaderViewHolder.textView.setTextColor(paramInt);
      ...
      if (paramView == null)
      {
        ...
        localViewHolder.editText.setOnEditorActionListener(new TextView.OnEditorActionListener()
        {
          public boolean onEditorAction(TextView paramAnonymousTextView, int paramAnonymousInt, KeyEvent paramAnonymousKeyEvent)
          {
            ...
            {
              MyPortfolioFragment.this.mStickyList.smoothScrollToPosition(paramInt + 2);
              if (MyPortfolioFragment.MyPortfolioAdapter.this.getViewByPosition(paramInt + 1, MyPortfolioFragment.this.mStickyList) != null)
              {
                paramAnonymousTextView = (EditText)MyPortfolioFragment.MyPortfolioAdapter.this.getViewByPosition(paramInt + 1, MyPortfolioFragment.this.mStickyList).findViewById(2131558887);
                if (paramAnonymousTextView != null)
                {
                  paramAnonymousTextView.setSelection(paramAnonymousTextView.getText().length());
    ...
    View getViewByPosition(int paramInt, StickyListHeadersListView paramStickyListHeadersListView)
    {
      ...
      int j = paramStickyListHeadersListView.getChildCount();
