  ...
  implements LoaderManager.LoaderCallbacks<CreateAccountInputResponse>
{
  ...
  private void initLayout()
  {
    ...
    if ((this.mInputResponse.getServiceChargeDays() != null) && (this.mInputResponse.getServiceChargeDays().size() > 0))
    {
      ...
      this.mServiceChargeDaySpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener()
      {
        ...
        {
          paramAnonymousAdapterView = (ServiceChargeDay)paramAnonymousAdapterView.getItemAtPosition(paramAnonymousInt);
          if (paramAnonymousAdapterView != null) {
            CreateAccountFragment.this.mData.serviceChargeDay = paramAnonymousAdapterView;
          }
        }
  ...
  private void updateServiceChargeDaySpinnerWithCode(String paramString)
  {
    ...
    {
      int j = k;
      if (i < this.mInputResponse.getServiceChargeDays().size())
      {
      ...
      {
        this.mServiceChargeDaySpinner.setSelection(j, false);
        return;
      }
    }
  }
  ...
  public void onChooseAccountProductReturnedWithSelection(String paramString)
  {
    ...
    for (;;)
    {
      ...
      {
        localObject = (AccountOffer)localIterator.next();
        if (i != 1) {}
      }
      else
      {
      ...
      Object localObject = ((AccountOffer)localObject).getOfferProducts().iterator();
      if (((Iterator)localObject).hasNext())
      {
        AccountProduct localAccountProduct = (AccountProduct)((Iterator)localObject).next();
  ...
  public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle)
  {
    ...
    paramLayoutInflater = paramLayoutInflater.inflate(2130903267, paramViewGroup, false);
    this.mChooseAccountProductButton = ((Button)paramLayoutInflater.findViewById(2131559113));
    this.mNicknameEditText = ((AppCompatEditText)paramLayoutInflater.findViewById(2131559114));
    this.mServiceChargeDayLayout = ((LinearLayout)paramLayoutInflater.findViewById(2131559115));
    this.mTermsAndConditionsLayout = ((LinearLayout)paramLayoutInflater.findViewById(2131559409));
    this.mServiceChargeDaySpinner = ((Spinner)paramLayoutInflater.findViewById(2131559116));
    ...
    this.mTriangleImageView = ((ImageView)paramLayoutInflater.findViewById(2131558756));
