...
public class CreateMandateResultJob
  extends SessionBoundJob
{
  ...
  public CreateMandateResultJob(String paramString1, String paramString2, ArrayList<DSQAuthorizationInfo> paramArrayList)
  {
    ...
    throws Throwable
  {
    ...
    for (GenericResultResponse localGenericResultResponse = new DemoRequests().createMandateResultDemoRequest();; localGenericResultResponse = new SOAPRequests().createMandateResultRequest(this.mWorkflowId, this.mAuthorizationInfo))
    {
      assertNotCancelled();
      LogHelper.d(this.TAG, "CreateMandate Result Send");
      EventBus.getDefault().post(new CreateMandateResultResponseEvent(localGenericResultResponse));
      return;
    }
  }
