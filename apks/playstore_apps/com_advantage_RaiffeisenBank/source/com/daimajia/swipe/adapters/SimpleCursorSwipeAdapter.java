...
public abstract class SimpleCursorSwipeAdapter
  ...
  implements SwipeItemMangerInterface, SwipeAdapterInterface
{
  ...
  protected SimpleCursorSwipeAdapter(Context paramContext, int paramInt, Cursor paramCursor, String[] paramArrayOfString, int[] paramArrayOfInt)
  {
    super(paramContext, paramInt, paramCursor, paramArrayOfString, paramArrayOfInt);
  }
  
  protected SimpleCursorSwipeAdapter(Context paramContext, int paramInt1, Cursor paramCursor, String[] paramArrayOfString, int[] paramArrayOfInt, int paramInt2)
  {
