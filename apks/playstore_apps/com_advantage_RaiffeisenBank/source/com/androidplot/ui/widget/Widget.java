  ...
  implements BoxModelable
{
    ...
    throws PlotRenderException
  {
    ...
    if (isVisible())
    {
      ...
      paramRectF = this.d.getMarginatedRect(paramRectF);
      paramRectF = this.d.getPaddedRect(paramRectF);
      doOnDraw(paramCanvas, paramRectF);
      if (this.a != null) {
        paramCanvas.drawRect(paramRectF, this.a);
      }
    }
  }
