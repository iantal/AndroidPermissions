  ...
  implements FragmentManager.OnBackStackChangedListener, FileListFragment.Callbacks
{
  ...
  private void replaceFragment(File paramFile)
  {
    ...
    paramFile = FileListFragment.newInstance(this.mPath);
    this.mFragmentManager.beginTransaction().replace(16908290, paramFile).setTransition(4097).addToBackStack(this.mPath).commit();
  }
