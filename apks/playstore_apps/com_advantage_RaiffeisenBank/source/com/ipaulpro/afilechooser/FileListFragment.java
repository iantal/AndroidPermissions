  ...
  implements LoaderManager.LoaderCallbacks<List<File>>
{
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    for (paramBundle = getArguments().getString("path");; paramBundle = Environment.getExternalStorageDirectory().getAbsolutePath())
    {
  ...
  {
    paramListView = (FileListAdapter)paramListView.getAdapter();
    if (paramListView != null)
    {
      paramListView = paramListView.getItem(paramInt);
      this.mPath = paramListView.getAbsolutePath();
      this.mListener.onFileSelected(paramListView);
    }
  }
