...
# instance fields
.field final aGI:Ljava/util/concurrent/ExecutorService;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/google/firebase/iid/zzb;->aij:Lcom/google/android/gms/iid/MessengerCompat;

    invoke-static {}, Ljava/util/concurrent/Executors;->newSingleThreadExecutor()Ljava/util/concurrent/ExecutorService;

    move-result-object v0

    iput-object v0, p0, Lcom/google/firebase/iid/zzb;->aGI:Ljava/util/concurrent/ExecutorService;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    iput-object v0, p0, Lcom/google/firebase/iid/zzb;->zzako:Ljava/lang/Object;

    const/4 v0, 0x0

    iput v0, p0, Lcom/google/firebase/iid/zzb;->agL:I
...
.method private zzaf(Landroid/content/Intent;)V
    ...
    :cond_0
    iget-object v1, p0, Lcom/google/firebase/iid/zzb;->zzako:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget v0, p0, Lcom/google/firebase/iid/zzb;->agL:I
    ...
    iget v0, p0, Lcom/google/firebase/iid/zzb;->agK:I

    invoke-virtual {p0, v0}, Lcom/google/firebase/iid/zzb;->zztl(I)Z
...
.method public final onBind(Landroid/content/Intent;)Landroid/os/IBinder;
    ...
    iget-object v0, p0, Lcom/google/firebase/iid/zzb;->aij:Lcom/google/android/gms/iid/MessengerCompat;
...
.method public final onStartCommand(Landroid/content/Intent;II)I
    ...
    :try_start_0
    iput p3, p0, Lcom/google/firebase/iid/zzb;->agK:I

    iget v2, p0, Lcom/google/firebase/iid/zzb;->agL:I

    add-int/lit8 v2, v2, 0x1

    iput v2, p0, Lcom/google/firebase/iid/zzb;->agL:I
    ...
    :cond_1
    iget-object v0, p0, Lcom/google/firebase/iid/zzb;->aGI:Ljava/util/concurrent/ExecutorService;
