...
public final class FirebaseAnalytics
{
  ...
  {
    this.aqw.zzbvu().setCurrentScreen(paramActivity, paramString1, paramString2);
  }
  
  public void setMinimumSessionDuration(long paramLong)
  {
    this.aqw.zzbxt().setMinimumSessionDuration(paramLong);
  }
  
  public void setSessionTimeoutDuration(long paramLong)
  {
    this.aqw.zzbxt().setSessionTimeoutDuration(paramLong);
  }
  
  public void setUserId(String paramString)
  {
    this.aqw.zzbxt().setUserId(paramString);
  }
  
  public void setUserProperty(@NonNull @Size(max=24L, min=1L) String paramString1, @Nullable @Size(max=36L) String paramString2)
  {
    this.aqw.zzbxt().setUserProperty(paramString1, paramString2);
  }
