  ...
  extends Button
{
  ...
  public zzaf(Context paramContext, AttributeSet paramAttributeSet)
  {
  ...
  {
    setTextColor((ColorStateList)zzaa.zzy(paramResources.getColorStateList(zzg(paramInt2, R.color.common_google_signin_btn_text_dark, R.color.common_google_signin_btn_text_light, R.color.common_google_signin_btn_text_light))));
    switch (paramInt1)
    {
    default: 
