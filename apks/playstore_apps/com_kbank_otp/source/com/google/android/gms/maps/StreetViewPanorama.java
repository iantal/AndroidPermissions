...
public class StreetViewPanorama
{
  ...
  {
    this.aoX = ((IStreetViewPanoramaDelegate)zzaa.zzy(paramIStreetViewPanoramaDelegate));
  }
  ...
  public void animateTo(StreetViewPanoramaCamera paramStreetViewPanoramaCamera, long paramLong)
  {
    try
    {
      this.aoX.animateTo(paramStreetViewPanoramaCamera, paramLong);
      return;
    }
  ...
  public StreetViewPanoramaLocation getLocation()
  {
    try
    {
      StreetViewPanoramaLocation localStreetViewPanoramaLocation = this.aoX.getStreetViewPanoramaLocation();
  ...
  public StreetViewPanoramaCamera getPanoramaCamera()
  {
    try
    {
      StreetViewPanoramaCamera localStreetViewPanoramaCamera = this.aoX.getPanoramaCamera();
  ...
  public boolean isPanningGesturesEnabled()
  {
    try
    {
      boolean bool = this.aoX.isPanningGesturesEnabled();
      return bool;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public boolean isStreetNamesEnabled()
  {
    try
    {
      boolean bool = this.aoX.isStreetNamesEnabled();
      return bool;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public boolean isUserNavigationEnabled()
  {
    try
    {
      boolean bool = this.aoX.isUserNavigationEnabled();
      return bool;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public boolean isZoomGesturesEnabled()
  {
    try
    {
      boolean bool = this.aoX.isZoomGesturesEnabled();
      return bool;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public Point orientationToPoint(StreetViewPanoramaOrientation paramStreetViewPanoramaOrientation)
  {
    try
    {
      paramStreetViewPanoramaOrientation = this.aoX.orientationToPoint(paramStreetViewPanoramaOrientation);
  ...
  public StreetViewPanoramaOrientation pointToOrientation(Point paramPoint)
  {
    try
    {
      paramPoint = this.aoX.pointToOrientation(zze.zzac(paramPoint));
      return paramPoint;
    }
  ...
  public final void setOnStreetViewPanoramaCameraChangeListener(final OnStreetViewPanoramaCameraChangeListener paramOnStreetViewPanoramaCameraChangeListener)
  {
    ...
    this.aoX.setOnStreetViewPanoramaCameraChangeListener(new zzab.zza()
    {
  ...
  public final void setOnStreetViewPanoramaChangeListener(final OnStreetViewPanoramaChangeListener paramOnStreetViewPanoramaChangeListener)
  {
    ...
    this.aoX.setOnStreetViewPanoramaChangeListener(new zzac.zza()
    {
  ...
  public final void setOnStreetViewPanoramaClickListener(final OnStreetViewPanoramaClickListener paramOnStreetViewPanoramaClickListener)
  {
    ...
    this.aoX.setOnStreetViewPanoramaClickListener(new zzad.zza()
    {
  ...
  public final void setOnStreetViewPanoramaLongClickListener(final OnStreetViewPanoramaLongClickListener paramOnStreetViewPanoramaLongClickListener)
  {
    ...
    this.aoX.setOnStreetViewPanoramaLongClickListener(new zzae.zza()
    {
  ...
  public void setPanningGesturesEnabled(boolean paramBoolean)
  {
    try
    {
      this.aoX.enablePanning(paramBoolean);
      return;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public void setPosition(LatLng paramLatLng)
  {
    try
    {
      this.aoX.setPosition(paramLatLng);
      return;
    }
  ...
  public void setPosition(LatLng paramLatLng, int paramInt)
  {
    try
    {
      this.aoX.setPositionWithRadius(paramLatLng, paramInt);
      return;
    }
    catch (RemoteException paramLatLng)
    {
  ...
  public void setPosition(String paramString)
  {
    try
    {
      this.aoX.setPositionWithID(paramString);
      return;
    }
  ...
  public void setStreetNamesEnabled(boolean paramBoolean)
  {
    try
    {
      this.aoX.enableStreetNames(paramBoolean);
      return;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public void setUserNavigationEnabled(boolean paramBoolean)
  {
    try
    {
      this.aoX.enableUserNavigation(paramBoolean);
      return;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public void setZoomGesturesEnabled(boolean paramBoolean)
  {
    try
    {
      this.aoX.enableZoom(paramBoolean);
      return;
    }
    catch (RemoteException localRemoteException)
    {
