...
public abstract class CustomAdapterView<T extends Adapter>
  extends ViewGroup
{
  ...
  private CustomAdapterView<T>.SelectionNotifier mSelectionNotifier;
  int mSpecificTop;
  long mSyncHeight;
  int mSyncMode;
  int mSyncPosition;
  ...
  public CustomAdapterView(Context paramContext)
  {
    super(paramContext);
  }
  
  public CustomAdapterView(Context paramContext, AttributeSet paramAttributeSet)
  {
    super(paramContext, paramAttributeSet);
  }
  
  public CustomAdapterView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    extends DataSetObserver
  {
    ...
    {
      CustomAdapterView.this.mDataChanged = true;
      CustomAdapterView.this.mOldItemCount = CustomAdapterView.this.mItemCount;
      CustomAdapterView.this.mItemCount = CustomAdapterView.this.getAdapter().getCount();
      if ((CustomAdapterView.this.getAdapter().hasStableIds()) && (this.mInstanceState != null) && (CustomAdapterView.this.mOldItemCount == 0) && (CustomAdapterView.this.mItemCount > 0))
      {
        CustomAdapterView.this.onRestoreInstanceState(this.mInstanceState);
        this.mInstanceState = null;
      }
      for (;;)
      {
        CustomAdapterView.this.checkFocus();
        CustomAdapterView.this.requestLayout();
        return;
        CustomAdapterView.this.rememberSyncState();
      }
    }
    ...
    public void onInvalidated()
    {
      ...
      if (CustomAdapterView.this.getAdapter().hasStableIds()) {
        this.mInstanceState = CustomAdapterView.this.onSaveInstanceState();
      }
      CustomAdapterView.this.mOldItemCount = CustomAdapterView.this.mItemCount;
      CustomAdapterView.this.mItemCount = 0;
      CustomAdapterView.this.mSelectedPosition = -1;
      CustomAdapterView.this.mSelectedRowId = Long.MIN_VALUE;
      CustomAdapterView.this.mNextSelectedPosition = -1;
      CustomAdapterView.this.mNextSelectedRowId = Long.MIN_VALUE;
      CustomAdapterView.this.mNeedSync = false;
      CustomAdapterView.this.checkFocus();
      CustomAdapterView.this.requestLayout();
    }
  }
  ...
  {
    public abstract void onItemClick(CustomAdapterView<?> paramCustomAdapterView, View paramView, int paramInt, long paramLong);
  }
  
  public static abstract interface OnItemLongClickListener
  {
    public abstract boolean onItemLongClick(CustomAdapterView<?> paramCustomAdapterView, View paramView, int paramInt, long paramLong);
  }
  
  public static abstract interface OnItemSelectedListener
  {
    public abstract void onItemSelected(CustomAdapterView<?> paramCustomAdapterView, View paramView, int paramInt, long paramLong);
    
    public abstract void onNothingSelected(CustomAdapterView<?> paramCustomAdapterView);
  }
    ...
    implements Runnable
  {
    ...
    public void run()
    {
      if (CustomAdapterView.this.mDataChanged)
      {
        if (CustomAdapterView.this.getAdapter() != null) {
          CustomAdapterView.this.post(this);
        }
        return;
      }
      CustomAdapterView.this.fireOnSelected();
    }
  }
}
