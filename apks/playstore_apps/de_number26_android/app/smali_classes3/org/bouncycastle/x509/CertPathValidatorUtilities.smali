...
.method protected static addAdditionalStoreFromLocation(Ljava/lang/String;Lorg/bouncycastle/x509/ExtendedPKIXParameters;)V
    ...
    .line 684
    invoke-static {v0, p0, v1}, Lorg/bouncycastle/x509/X509Store;->getInstance(Ljava/lang/String;Lorg/bouncycastle/x509/X509StoreParameters;Ljava/lang/String;)Lorg/bouncycastle/x509/X509Store;
    ...
    invoke-virtual {p1, p0}, Lorg/bouncycastle/x509/ExtendedPKIXParameters;->addAdditionalStore(Lorg/bouncycastle/util/Store;)V
    :try_end_0
...
.method protected static addAdditionalStoresFromAltNames(Ljava/security/cert/X509Certificate;Lorg/bouncycastle/x509/ExtendedPKIXParameters;)V
    ...
    .line 257
    invoke-static {v0, p1}, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->addAdditionalStoreFromLocation(Ljava/lang/String;Lorg/bouncycastle/x509/ExtendedPKIXParameters;)V
...
.method protected static addAdditionalStoresFromCRLDistributionPoint(Lorg/bouncycastle/asn1/x509/CRLDistPoint;Lorg/bouncycastle/x509/ExtendedPKIXParameters;)V
    ...
    .line 887
    invoke-static {v4}, Lorg/bouncycastle/asn1/DERIA5String;->getInstance(Ljava/lang/Object;)Lorg/bouncycastle/asn1/DERIA5String;
    ...
    .line 890
    invoke-static {v4, p1}, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->addAdditionalStoreFromLocation(Ljava/lang/String;Lorg/bouncycastle/x509/ExtendedPKIXParameters;)V
...
.method protected static findCertificates(Lorg/bouncycastle/x509/X509CertStoreSelector;Ljava/util/List;)Ljava/util/Collection;
    ...
    .line 731
    :try_start_0
    invoke-interface {v2, p0}, Lorg/bouncycastle/util/Store;->getMatches(Lorg/bouncycastle/util/Selector;)Ljava/util/Collection;
    ...
    .line 735
    instance-of v4, v3, Lorg/bouncycastle/util/Encodable;
    ...
    check-cast v3, Lorg/bouncycastle/util/Encodable;

    invoke-interface {v3}, Lorg/bouncycastle/util/Encodable;->getEncoded()[B

    move-result-object v3

    invoke-direct {v4, v3}, Ljava/io/ByteArrayInputStream;-><init>([B)V

    invoke-virtual {v1, v4}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;->engineGenerateCertificate(Ljava/io/InputStream;)Ljava/security/cert/Certificate;
...
.method static findIssuerCerts(Ljava/security/cert/X509Certificate;Ljava/util/List;Ljava/util/List;)Ljava/util/Collection;
    ...
    .line 1467
    invoke-static {p0, p1}, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->findCertificates(Lorg/bouncycastle/jcajce/PKIXCertStoreSelector;Ljava/util/List;)Ljava/util/Collection;
    ...
    .line 1468
    invoke-static {p0, p2}, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->findCertificates(Lorg/bouncycastle/jcajce/PKIXCertStoreSelector;Ljava/util/List;)Ljava/util/Collection;
...
.method protected static findTrustAnchor(Ljava/security/cert/X509Certificate;Ljava/util/Set;)Ljava/security/cert/TrustAnchor;
    ...
    .line 137
    invoke-static {p0, p1, v0}, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->findTrustAnchor(Ljava/security/cert/X509Certificate;Ljava/util/Set;Ljava/lang/String;)Ljava/security/cert/TrustAnchor;
...
.method protected static findTrustAnchor(Ljava/security/cert/X509Certificate;Ljava/util/Set;Ljava/lang/String;)Ljava/security/cert/TrustAnchor;
    ...
    .line 165
    invoke-static {p0}, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->getEncodedIssuerPrincipal(Ljava/lang/Object;)Ljavax/security/auth/x500/X500Principal;
    ...
    .line 220
    :try_start_2
    invoke-static {p0, v5, p2}, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->verifyX509Certificate(Ljava/security/cert/X509Certificate;Ljava/security/PublicKey;Ljava/lang/String;)V
    :try_end_2
...
.method protected static getCRLIssuersFromDistributionPoint(Lorg/bouncycastle/asn1/x509/DistributionPoint;Ljava/util/Collection;Ljava/security/cert/X509CRLSelector;Lorg/bouncycastle/x509/ExtendedPKIXParameters;)V
    ...
    invoke-direct {p1, v1}, Ljavax/security/auth/x500/X500Principal;-><init>([B)V
...
.method protected static getCompleteCRLs(Lorg/bouncycastle/asn1/x509/DistributionPoint;Ljava/lang/Object;Ljava/util/Date;Lorg/bouncycastle/x509/ExtendedPKIXParameters;)Ljava/util/Set;
    ...
    .line 1258
    invoke-interface {v2}, Lorg/bouncycastle/x509/X509AttributeCertificate;->getIssuer()Lorg/bouncycastle/x509/AttributeCertificateIssuer;
    ...
    .line 1264
    :goto_0
    invoke-static {p0, v1, v0, p3}, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->getCRLIssuersFromDistributionPoint(Lorg/bouncycastle/asn1/x509/DistributionPoint;Ljava/util/Collection;Ljava/security/cert/X509CRLSelector;Lorg/bouncycastle/x509/ExtendedPKIXParameters;)V
    :try_end_0
    ...
    invoke-virtual {v0, p0}, Lorg/bouncycastle/x509/X509CRLStoreSelector;->setAttrCertificateChecking(Lorg/bouncycastle/x509/X509AttributeCertificate;)V
    ...
    .line 1281
    invoke-virtual {v0, p0}, Lorg/bouncycastle/x509/X509CRLStoreSelector;->setCompleteCRLEnabled(Z)V

    .line 1283
    sget-object p0, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->CRL_UTIL:Lorg/bouncycastle/x509/PKIXCRLUtil;

    invoke-virtual {p0, v0, p3, p2}, Lorg/bouncycastle/x509/PKIXCRLUtil;->findCRLs(Lorg/bouncycastle/x509/X509CRLStoreSelector;Lorg/bouncycastle/x509/ExtendedPKIXParameters;Ljava/util/Date;)Ljava/util/Set;
...
.method protected static getDeltaCRLs(Ljava/util/Date;Lorg/bouncycastle/x509/ExtendedPKIXParameters;Ljava/security/cert/X509CRL;)Ljava/util/Set;
    ...
    .line 1156
    :try_start_0
    invoke-static {p2}, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->getIssuerPrincipal(Ljava/security/cert/X509CRL;)Ljavax/security/auth/x500/X500Principal;
    ...
    .line 1166
    invoke-static {p2, v1}, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->getExtensionValue(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/bouncycastle/asn1/ASN1Primitive;
    ...
    .line 1197
    invoke-virtual {v0, p2}, Lorg/bouncycastle/x509/X509CRLStoreSelector;->setIssuingDistributionPoint([B)V

    const/4 p2, 0x1

    .line 1198
    invoke-virtual {v0, p2}, Lorg/bouncycastle/x509/X509CRLStoreSelector;->setIssuingDistributionPointEnabled(Z)V

    .line 1201
    invoke-virtual {v0, v1}, Lorg/bouncycastle/x509/X509CRLStoreSelector;->setMaxBaseCRLNumber(Ljava/math/BigInteger;)V

    .line 1204
    sget-object p2, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->CRL_UTIL:Lorg/bouncycastle/x509/PKIXCRLUtil;

    invoke-virtual {p2, v0, p1, p0}, Lorg/bouncycastle/x509/PKIXCRLUtil;->findCRLs(Lorg/bouncycastle/x509/X509CRLStoreSelector;Lorg/bouncycastle/x509/ExtendedPKIXParameters;Ljava/util/Date;)Ljava/util/Set;
    ...
    .line 1212
    invoke-static {p2}, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->isDeltaCRL(Ljava/security/cert/X509CRL;)Z
...
.method protected static getValidCertDateFromValidityModel(Lorg/bouncycastle/x509/ExtendedPKIXParameters;Ljava/security/cert/CertPath;I)Ljava/util/Date;
    ...
    .line 1312
    invoke-static {p0}, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->getValidDate(Ljava/security/cert/PKIXParameters;)Ljava/util/Date;
...
.method protected static prepareNextCertB1(I[Ljava/util/List;Ljava/lang/String;Ljava/util/Map;Ljava/security/cert/X509Certificate;)V
    ...
    .line 603
    invoke-virtual {p4, v0}, Lorg/bouncycastle/jce/provider/PKIXPolicyNode;->addChild(Lorg/bouncycastle/jce/provider/PKIXPolicyNode;)V
