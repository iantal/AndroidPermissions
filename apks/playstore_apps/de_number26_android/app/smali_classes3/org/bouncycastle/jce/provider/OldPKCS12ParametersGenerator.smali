...
.method private generateDerivedKey(II)[B
    ...
    .line 150
    iget p1, p0, Lorg/bouncycastle/jce/provider/OldPKCS12ParametersGenerator;->u:I
    ...
    .line 156
    iget-object p1, p0, Lorg/bouncycastle/jce/provider/OldPKCS12ParametersGenerator;->digest:Lorg/bouncycastle/crypto/Digest;
    ...
    invoke-interface {p1, v9, v2}, Lorg/bouncycastle/crypto/Digest;->doFinal([BI)I

    move p1, v4

    .line 159
    :goto_6
    iget p2, p0, Lorg/bouncycastle/jce/provider/OldPKCS12ParametersGenerator;->iterationCount:I
    ...
    .line 177
    iget p2, p0, Lorg/bouncycastle/jce/provider/OldPKCS12ParametersGenerator;->u:I
    ...
    invoke-static {v9, v2, v1, p2, v3}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
    ...
    invoke-static {v9, v2, v1, p1, p2}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
    ...
    .line 172
    :cond_6
    iget p2, p0, Lorg/bouncycastle/jce/provider/OldPKCS12ParametersGenerator;->v:I

    mul-int/2addr p2, p1

    invoke-direct {p0, v5, p2, v6}, Lorg/bouncycastle/jce/provider/OldPKCS12ParametersGenerator;->adjust([BI[B)V
    ...
    .line 161
    :cond_8
    iget-object p2, p0, Lorg/bouncycastle/jce/provider/OldPKCS12ParametersGenerator;->digest:Lorg/bouncycastle/crypto/Digest;

    array-length v3, v9

    invoke-interface {p2, v9, v2, v3}, Lorg/bouncycastle/crypto/Digest;->update([BII)V

    .line 162
    iget-object p2, p0, Lorg/bouncycastle/jce/provider/OldPKCS12ParametersGenerator;->digest:Lorg/bouncycastle/crypto/Digest;

    invoke-interface {p2, v9, v2}, Lorg/bouncycastle/crypto/Digest;->doFinal([BI)I
