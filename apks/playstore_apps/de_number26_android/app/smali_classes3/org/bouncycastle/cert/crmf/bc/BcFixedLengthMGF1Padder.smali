...
.method public getPaddedData([B)[B
    ...
    invoke-virtual {v3, v2, v5, v6}, Lorg/bouncycastle/crypto/generators/MGF1BytesGenerator;->generateBytes([BII)I
    ...
    invoke-virtual {p1, v6}, Ljava/security/SecureRandom;->nextInt(I)I
...
.method public getUnpaddedData([B)[B
    ...
    invoke-virtual {v3, v1, v2, v4}, Lorg/bouncycastle/crypto/generators/MGF1BytesGenerator;->generateBytes([BII)I
