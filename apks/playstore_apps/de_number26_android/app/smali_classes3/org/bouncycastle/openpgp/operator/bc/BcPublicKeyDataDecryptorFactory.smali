...
.method public recoverSessionData(I[[B)[B
    ...
    invoke-virtual {v5, v0, v3, v4}, Lorg/bouncycastle/crypto/BufferedAsymmetricBlockCipher;->processBytes([BII)V
    ...
    .line 119
    new-instance v1, Lorg/bouncycastle/openpgp/operator/bc/RFC6637KDFCalculator;
    ...
    invoke-direct {v1, v4, p1}, Lorg/bouncycastle/openpgp/operator/bc/RFC6637KDFCalculator;-><init>(Lorg/bouncycastle/openpgp/operator/PGPDigestCalculator;I)V

    .line 120
    new-instance p1, Lorg/bouncycastle/crypto/params/KeyParameter;

    iget-object v4, p0, Lorg/bouncycastle/openpgp/operator/bc/BcPublicKeyDataDecryptorFactory;->privKey:Lorg/bouncycastle/openpgp/PGPPrivateKey;

    invoke-virtual {v4}, Lorg/bouncycastle/openpgp/PGPPrivateKey;->getPublicKeyPacket()Lorg/bouncycastle/bcpg/PublicKeyPacket;
    ...
    invoke-static {v4, v5}, Lorg/bouncycastle/openpgp/operator/RFC6637Utils;->createUserKeyingMaterial(Lorg/bouncycastle/bcpg/PublicKeyPacket;Lorg/bouncycastle/openpgp/operator/KeyFingerPrintCalculator;)[B

    move-result-object v4

    invoke-virtual {v1, v0, v4}, Lorg/bouncycastle/openpgp/operator/bc/RFC6637KDFCalculator;->createKey(Lorg/bouncycastle/math/ec/ECPoint;[B)[B
    ...
    .line 122
    invoke-interface {p2, v3, p1}, Lorg/bouncycastle/crypto/Wrapper;->init(ZLorg/bouncycastle/crypto/CipherParameters;)V

    .line 124
    array-length p1, v2

    invoke-interface {p2, v2, v3, p1}, Lorg/bouncycastle/crypto/Wrapper;->unwrap([BII)[B
