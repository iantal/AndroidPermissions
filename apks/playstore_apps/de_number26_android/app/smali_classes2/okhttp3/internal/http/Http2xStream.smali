...
# static fields
.field private static final CONNECTION:Lg/f;

.field private static final ENCODING:Lg/f;

.field private static final HOST:Lg/f;
...
.field private static final KEEP_ALIVE:Lg/f;

.field private static final PROXY_CONNECTION:Lg/f;
...
.field private static final TE:Lg/f;

.field private static final TRANSFER_ENCODING:Lg/f;

.field private static final UPGRADE:Lg/f;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lokhttp3/internal/http/Http2xStream;->CONNECTION:Lg/f;
    ...
    sput-object v0, Lokhttp3/internal/http/Http2xStream;->HOST:Lg/f;
    ...
    sput-object v0, Lokhttp3/internal/http/Http2xStream;->KEEP_ALIVE:Lg/f;
    ...
    sput-object v0, Lokhttp3/internal/http/Http2xStream;->PROXY_CONNECTION:Lg/f;
    ...
    sput-object v0, Lokhttp3/internal/http/Http2xStream;->TRANSFER_ENCODING:Lg/f;
    ...
    sput-object v0, Lokhttp3/internal/http/Http2xStream;->TE:Lg/f;
    ...
    sput-object v0, Lokhttp3/internal/http/Http2xStream;->ENCODING:Lg/f;
    ...
    sput-object v0, Lokhttp3/internal/http/Http2xStream;->UPGRADE:Lg/f;

    const/16 v0, 0xb

    .line 65
    new-array v1, v0, [Lg/f;

    sget-object v2, Lokhttp3/internal/http/Http2xStream;->CONNECTION:Lg/f;

    const/4 v3, 0x0

    aput-object v2, v1, v3

    sget-object v2, Lokhttp3/internal/http/Http2xStream;->HOST:Lg/f;

    const/4 v4, 0x1

    aput-object v2, v1, v4

    sget-object v2, Lokhttp3/internal/http/Http2xStream;->KEEP_ALIVE:Lg/f;

    const/4 v5, 0x2

    aput-object v2, v1, v5

    sget-object v2, Lokhttp3/internal/http/Http2xStream;->PROXY_CONNECTION:Lg/f;

    const/4 v6, 0x3

    aput-object v2, v1, v6

    sget-object v2, Lokhttp3/internal/http/Http2xStream;->TRANSFER_ENCODING:Lg/f;

    const/4 v7, 0x4

    aput-object v2, v1, v7

    sget-object v2, Lokhttp3/internal/framed/Header;->TARGET_METHOD:Lg/f;

    const/4 v8, 0x5

    aput-object v2, v1, v8

    sget-object v2, Lokhttp3/internal/framed/Header;->TARGET_PATH:Lg/f;

    const/4 v9, 0x6

    aput-object v2, v1, v9

    sget-object v2, Lokhttp3/internal/framed/Header;->TARGET_SCHEME:Lg/f;

    const/4 v10, 0x7

    aput-object v2, v1, v10

    sget-object v2, Lokhttp3/internal/framed/Header;->TARGET_AUTHORITY:Lg/f;

    const/16 v11, 0x8

    aput-object v2, v1, v11

    sget-object v2, Lokhttp3/internal/framed/Header;->TARGET_HOST:Lg/f;

    const/16 v12, 0x9

    aput-object v2, v1, v12

    sget-object v2, Lokhttp3/internal/framed/Header;->VERSION:Lg/f;
    ...
    sget-object v2, Lokhttp3/internal/http/Http2xStream;->TE:Lg/f;
    ...
    sget-object v2, Lokhttp3/internal/http/Http2xStream;->ENCODING:Lg/f;

    aput-object v2, v1, v9

    sget-object v2, Lokhttp3/internal/http/Http2xStream;->UPGRADE:Lg/f;
    ...
    sget-object v0, Lokhttp3/internal/framed/Header;->TARGET_HOST:Lg/f;

    const/16 v2, 0xc

    aput-object v0, v1, v2

    sget-object v0, Lokhttp3/internal/framed/Header;->VERSION:Lg/f;
    ...
    .line 100
    new-array v0, v11, [Lg/f;

    sget-object v1, Lokhttp3/internal/http/Http2xStream;->CONNECTION:Lg/f;

    aput-object v1, v0, v3

    sget-object v1, Lokhttp3/internal/http/Http2xStream;->HOST:Lg/f;

    aput-object v1, v0, v4

    sget-object v1, Lokhttp3/internal/http/Http2xStream;->KEEP_ALIVE:Lg/f;

    aput-object v1, v0, v5

    sget-object v1, Lokhttp3/internal/http/Http2xStream;->PROXY_CONNECTION:Lg/f;

    aput-object v1, v0, v6

    sget-object v1, Lokhttp3/internal/http/Http2xStream;->TE:Lg/f;

    aput-object v1, v0, v7

    sget-object v1, Lokhttp3/internal/http/Http2xStream;->TRANSFER_ENCODING:Lg/f;

    aput-object v1, v0, v8

    sget-object v1, Lokhttp3/internal/http/Http2xStream;->ENCODING:Lg/f;

    aput-object v1, v0, v9

    sget-object v1, Lokhttp3/internal/http/Http2xStream;->UPGRADE:Lg/f;
...
.method public static http2HeadersList(Lokhttp3/Request;)Ljava/util/List;
    ...
    sget-object v3, Lokhttp3/internal/framed/Header;->TARGET_METHOD:Lg/f;

    invoke-virtual {p0}, Lokhttp3/Request;->method()Ljava/lang/String;

    move-result-object v4

    invoke-direct {v2, v3, v4}, Lokhttp3/internal/framed/Header;-><init>(Lg/f;Ljava/lang/String;)V
    ...
    sget-object v3, Lokhttp3/internal/framed/Header;->TARGET_PATH:Lg/f;
    ...
    sget-object v3, Lokhttp3/internal/framed/Header;->TARGET_AUTHORITY:Lg/f;
    ...
    sget-object v3, Lokhttp3/internal/framed/Header;->TARGET_SCHEME:Lg/f;
    ...
    invoke-direct {v2, v3, p0}, Lokhttp3/internal/framed/Header;-><init>(Lg/f;Ljava/lang/String;)V
    ...
    invoke-static {v2}, Lg/f;->a(Ljava/lang/String;)Lg/f;
    ...
    invoke-direct {v3, v2, v4}, Lokhttp3/internal/framed/Header;-><init>(Lg/f;Ljava/lang/String;)V
...
.method public static readHttp2HeadersList(Ljava/util/List;)Lokhttp3/Response$Builder;
    ...
    iget-object v4, v4, Lokhttp3/internal/framed/Header;->name:Lg/f;
    ...
    iget-object v5, v5, Lokhttp3/internal/framed/Header;->value:Lg/f;

    invoke-virtual {v5}, Lg/f;->a()Ljava/lang/String;

    move-result-object v5

    .line 256
    sget-object v6, Lokhttp3/internal/framed/Header;->RESPONSE_STATUS:Lg/f;
    ...
    invoke-virtual {v4}, Lg/f;->a()Ljava/lang/String;
...
.method public static readSpdy3HeadersList(Ljava/util/List;)Lokhttp3/Response$Builder;
    ...
    iget-object v6, v6, Lokhttp3/internal/framed/Header;->name:Lg/f;
    ...
    iget-object v7, v7, Lokhttp3/internal/framed/Header;->value:Lg/f;
    ...
    .line 227
    sget-object v10, Lokhttp3/internal/framed/Header;->RESPONSE_STATUS:Lg/f;

    invoke-virtual {v6, v10}, Lg/f;->equals(Ljava/lang/Object;)Z
    ...
    .line 229
    :cond_1
    sget-object v10, Lokhttp3/internal/framed/Header;->VERSION:Lg/f;
    ...
    invoke-virtual {v6}, Lg/f;->a()Ljava/lang/String;
...
.method public static spdy3HeadersList(Lokhttp3/Request;)Ljava/util/List;
    ...
    sget-object v3, Lokhttp3/internal/framed/Header;->VERSION:Lg/f;
    ...
    sget-object v3, Lokhttp3/internal/framed/Header;->TARGET_HOST:Lg/f;
    ...
    invoke-static {v4}, Lg/f;->a(Ljava/lang/String;)Lg/f;
    ...
    invoke-direct {v7, v4, v6}, Lokhttp3/internal/framed/Header;-><init>(Lg/f;Ljava/lang/String;)V
    ...
    iget-object v8, v8, Lokhttp3/internal/framed/Header;->name:Lg/f;
    ...
    iget-object v8, v8, Lokhttp3/internal/framed/Header;->value:Lg/f;

    invoke-virtual {v8}, Lg/f;->a()Ljava/lang/String;
    ...
    invoke-direct {v8, v4, v6}, Lokhttp3/internal/framed/Header;-><init>(Lg/f;Ljava/lang/String;)V
...
.method public createRequestBody(Lokhttp3/Request;J)Lg/s;
    .locals 0

    .line 123
    iget-object p1, p0, Lokhttp3/internal/http/Http2xStream;->stream:Lokhttp3/internal/framed/FramedStream;

    invoke-virtual {p1}, Lokhttp3/internal/framed/FramedStream;->getSink()Lg/s;
...
.method public finishRequest()V
    ...
    invoke-virtual {v0}, Lokhttp3/internal/framed/FramedStream;->getSink()Lg/s;
...
.method public openResponseBody(Lokhttp3/Response;)Lokhttp3/ResponseBody;
    ...
    invoke-virtual {v1}, Lokhttp3/internal/framed/FramedStream;->getSource()Lg/t;

    move-result-object v1

    invoke-direct {v0, p0, v1}, Lokhttp3/internal/http/Http2xStream$StreamFinishingSource;-><init>(Lokhttp3/internal/http/Http2xStream;Lg/t;)V
    ...
    invoke-direct {v1, p1, v0}, Lokhttp3/internal/http/RealResponseBody;-><init>(Lokhttp3/Headers;Lg/e;)V
...
.method public writeRequestHeaders(Lokhttp3/Request;)V
    ...
    invoke-virtual {p1}, Lokhttp3/internal/framed/FramedStream;->readTimeout()Lg/u;
    ...
    invoke-virtual {p1, v0, v1, v2}, Lg/u;->timeout(JLjava/util/concurrent/TimeUnit;)Lg/u;

    .line 136
    iget-object p1, p0, Lokhttp3/internal/http/Http2xStream;->stream:Lokhttp3/internal/framed/FramedStream;

    invoke-virtual {p1}, Lokhttp3/internal/framed/FramedStream;->writeTimeout()Lg/u;
