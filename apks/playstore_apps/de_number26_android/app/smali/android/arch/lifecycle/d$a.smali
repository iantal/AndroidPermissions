...
.method constructor <init>()V
    ...
    iput-object v0, p0, Landroid/arch/lifecycle/d$a;->e:Landroid/support/v4/app/m$a;

    return-void
.end method

.method private static a(Landroid/support/v4/app/m;)Landroid/arch/lifecycle/d;
    .locals 1
    ...
    .line 142
    invoke-virtual {p0, v0}, Landroid/support/v4/app/m;->a(Ljava/lang/String;)Landroid/support/v4/app/i;
...
.method private static b(Landroid/support/v4/app/m;)Landroid/arch/lifecycle/d;
    .locals 2
    ...
    invoke-virtual {p0, v0, v1}, Landroid/support/v4/app/t;->a(Landroid/support/v4/app/i;Ljava/lang/String;)Landroid/support/v4/app/t;
...
# virtual methods
.method a(Landroid/support/v4/app/FragmentActivity;)Landroid/arch/lifecycle/d;
    .locals 3
    ...
    .line 158
    invoke-static {v0}, Landroid/arch/lifecycle/d$a;->a(Landroid/support/v4/app/m;)Landroid/arch/lifecycle/d;
    ...
    .line 171
    :cond_2
    invoke-static {v0}, Landroid/arch/lifecycle/d$a;->b(Landroid/support/v4/app/m;)Landroid/arch/lifecycle/d;
...
.method a(Landroid/support/v4/app/i;)V
    ...
    .line 127
    invoke-virtual {p1}, Landroid/support/v4/app/i;->getParentFragment()Landroid/support/v4/app/i;
    ...
    iget-object v0, p0, Landroid/arch/lifecycle/d$a;->e:Landroid/support/v4/app/m$a;

    invoke-virtual {p1, v0}, Landroid/support/v4/app/m;->a(Landroid/support/v4/app/m$a;)V
    ...
    invoke-virtual {p1}, Landroid/support/v4/app/i;->getActivity()Landroid/support/v4/app/FragmentActivity;
...
.method b(Landroid/support/v4/app/i;)Landroid/arch/lifecycle/d;
    .locals 4

    .line 177
    invoke-virtual {p1}, Landroid/support/v4/app/i;->getChildFragmentManager()Landroid/support/v4/app/m;
    ...
    iget-object v2, p0, Landroid/arch/lifecycle/d$a;->e:Landroid/support/v4/app/m$a;
