...
.method public constructor <init>(Landroid/support/c/a/i$e;)V
    ...
    iget-object p1, p1, Landroid/support/c/a/i$e;->g:Ljava/lang/String;
...
.method private a(Landroid/graphics/Matrix;)F
    ...
    invoke-static {p1, v3, v2, v0}, Landroid/support/c/a/i$e;->a(FFFF)F
...
.method static synthetic a(Landroid/support/c/a/i$e;)Landroid/graphics/Paint;
    ...
    .line 1048
    iget-object p0, p0, Landroid/support/c/a/i$e;->n:Landroid/graphics/Paint;
...
.method private a(Landroid/support/c/a/i$c;Landroid/graphics/Matrix;Landroid/graphics/Canvas;IILandroid/graphics/ColorFilter;)V
    ...
    .line 1146
    :cond_0
    instance-of v1, v0, Landroid/support/c/a/i$d;
    ...
    check-cast v4, Landroid/support/c/a/i$d;
    ...
    .line 1148
    invoke-direct/range {v2 .. v8}, Landroid/support/c/a/i$e;->a(Landroid/support/c/a/i$c;Landroid/support/c/a/i$d;Landroid/graphics/Canvas;IILandroid/graphics/ColorFilter;)V
...
.method private a(Landroid/support/c/a/i$c;Landroid/support/c/a/i$d;Landroid/graphics/Canvas;IILandroid/graphics/ColorFilter;)V
    ...
    .line 1162
    iget v0, p0, Landroid/support/c/a/i$e;->d:F
    ...
    .line 1163
    iget v0, p0, Landroid/support/c/a/i$e;->e:F
    ...
    .line 1167
    iget-object v1, p0, Landroid/support/c/a/i$e;->l:Landroid/graphics/Matrix;
    ...
    .line 1171
    invoke-direct {p0, p1}, Landroid/support/c/a/i$e;->a(Landroid/graphics/Matrix;)F
    ...
    .line 1176
    :cond_0
    iget-object p5, p0, Landroid/support/c/a/i$e;->i:Landroid/graphics/Path;

    invoke-virtual {p2, p5}, Landroid/support/c/a/i$d;->a(Landroid/graphics/Path;)V
    ...
    .line 1182
    iget-object p1, p0, Landroid/support/c/a/i$e;->j:Landroid/graphics/Path;

    iget-object p2, p0, Landroid/support/c/a/i$e;->l:Landroid/graphics/Matrix;
    ...
    .line 1190
    iget-object v2, p0, Landroid/support/c/a/i$e;->o:Landroid/graphics/PathMeasure;
    ...
    iput-object v2, p0, Landroid/support/c/a/i$e;->o:Landroid/graphics/PathMeasure;

    .line 1193
    :cond_3
    iget-object v2, p0, Landroid/support/c/a/i$e;->o:Landroid/graphics/PathMeasure;

    iget-object v5, p0, Landroid/support/c/a/i$e;->i:Landroid/graphics/Path;
    ...
    .line 1201
    iget-object v1, p0, Landroid/support/c/a/i$e;->o:Landroid/graphics/PathMeasure;
    ...
    .line 1207
    :cond_5
    iget-object p4, p0, Landroid/support/c/a/i$e;->j:Landroid/graphics/Path;
    ...
    .line 1209
    iget p4, p2, Landroid/support/c/a/i$b;->c:I

    if-eqz p4, :cond_8

    .line 1210
    iget-object p4, p0, Landroid/support/c/a/i$e;->n:Landroid/graphics/Paint;
    ...
    iput-object p4, p0, Landroid/support/c/a/i$e;->n:Landroid/graphics/Paint;
    ...
    .line 1217
    iget p5, p2, Landroid/support/c/a/i$b;->c:I

    iget v1, p2, Landroid/support/c/a/i$b;->f:F

    invoke-static {p5, v1}, Landroid/support/c/a/i;->a(IF)I
    ...
    .line 1219
    iget-object p5, p0, Landroid/support/c/a/i$e;->j:Landroid/graphics/Path;

    iget v1, p2, Landroid/support/c/a/i$b;->e:I
    ...
    .line 1224
    :cond_8
    iget p4, p2, Landroid/support/c/a/i$b;->a:I

    if-eqz p4, :cond_c

    .line 1225
    iget-object p4, p0, Landroid/support/c/a/i$e;->m:Landroid/graphics/Paint;
    ...
    iput-object p4, p0, Landroid/support/c/a/i$e;->m:Landroid/graphics/Paint;
    ...
    .line 1232
    iget-object p5, p2, Landroid/support/c/a/i$b;->k:Landroid/graphics/Paint$Join;
    ...
    .line 1236
    :cond_a
    iget-object p5, p2, Landroid/support/c/a/i$b;->j:Landroid/graphics/Paint$Cap;
    ...
    .line 1240
    :cond_b
    iget p5, p2, Landroid/support/c/a/i$b;->l:F

    invoke-virtual {p4, p5}, Landroid/graphics/Paint;->setStrokeMiter(F)V

    .line 1241
    iget p5, p2, Landroid/support/c/a/i$b;->a:I

    iget v1, p2, Landroid/support/c/a/i$b;->d:F
...
.method static synthetic b(Landroid/support/c/a/i$e;)Landroid/graphics/Paint;
    ...
    .line 1048
    iget-object p0, p0, Landroid/support/c/a/i$e;->m:Landroid/graphics/Paint;
...
.method public setAlpha(F)V
    ...
    .line 1102
    invoke-virtual {p0, p1}, Landroid/support/c/a/i$e;->setRootAlpha(I)V
