...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView$i;->a:Landroid/support/v7/widget/bv$b;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView$i;->b:Landroid/support/v7/widget/bv$b;

    .line 7291
    new-instance v0, Landroid/support/v7/widget/bv;

    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView$i;->a:Landroid/support/v7/widget/bv$b;

    invoke-direct {v0, v1}, Landroid/support/v7/widget/bv;-><init>(Landroid/support/v7/widget/bv$b;)V

    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView$i;->r:Landroid/support/v7/widget/bv;

    .line 7292
    new-instance v0, Landroid/support/v7/widget/bv;

    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView$i;->b:Landroid/support/v7/widget/bv$b;

    invoke-direct {v0, v1}, Landroid/support/v7/widget/bv;-><init>(Landroid/support/v7/widget/bv$b;)V

    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView$i;->s:Landroid/support/v7/widget/bv;
...
.method private a(ILandroid/view/View;)V
    ...
    .line 8411
    iget-object p2, p0, Landroid/support/v7/widget/RecyclerView$i;->p:Landroid/support/v7/widget/af;

    invoke-virtual {p2, p1}, Landroid/support/v7/widget/af;->e(I)V
...
.method private a(Landroid/support/v7/widget/RecyclerView$p;ILandroid/view/View;)V
    ...
    iget-object p1, p1, Landroid/support/v7/widget/RecyclerView;->g:Landroid/support/v7/widget/bw;

    invoke-virtual {p1, v0}, Landroid/support/v7/widget/bw;->h(Landroid/support/v7/widget/RecyclerView$x;)V
...
.method private a(Landroid/view/View;IZ)V
    ...
    iget-object p3, p3, Landroid/support/v7/widget/RecyclerView;->g:Landroid/support/v7/widget/bw;

    invoke-virtual {p3, v0}, Landroid/support/v7/widget/bw;->f(Landroid/support/v7/widget/RecyclerView$x;)V
    ...
    invoke-virtual {p3, v0}, Landroid/support/v7/widget/bw;->e(Landroid/support/v7/widget/RecyclerView$x;)V
    ...
    invoke-virtual {v1, p1}, Landroid/support/v7/widget/af;->b(Landroid/view/View;)I
    ...
    invoke-virtual {p2}, Landroid/support/v7/widget/af;->b()I
    ...
    invoke-virtual {v1, p1, p2, v2}, Landroid/support/v7/widget/af;->a(Landroid/view/View;IZ)V
...
.method public a(Landroid/view/View;ILandroid/support/v7/widget/RecyclerView$j;)V
    ...
    invoke-virtual {v1, v0}, Landroid/support/v7/widget/bw;->e(Landroid/support/v7/widget/RecyclerView$x;)V
    ...
    invoke-virtual {v1, v0}, Landroid/support/v7/widget/bw;->f(Landroid/support/v7/widget/RecyclerView$x;)V
...
.method public a(Landroid/support/v7/widget/RecyclerView;Landroid/view/View;Landroid/view/View;)Z
    ...
    .line 9602
    invoke-virtual {p0}, Landroid/support/v7/widget/RecyclerView$i;->u()Z
...
.method public a(Landroid/view/View;ZZ)Z
    ...
    .line 9558
    iget-object p3, p0, Landroid/support/v7/widget/RecyclerView$i;->r:Landroid/support/v7/widget/bv;

    const/16 v0, 0x6003

    invoke-virtual {p3, p1, v0}, Landroid/support/v7/widget/bv;->a(Landroid/view/View;I)Z
    ...
    iget-object p3, p0, Landroid/support/v7/widget/RecyclerView$i;->s:Landroid/support/v7/widget/bv;
...
.method b(Landroid/support/v7/widget/RecyclerView;)V
    ...
    .line 7368
    iput-object p1, p0, Landroid/support/v7/widget/RecyclerView$i;->p:Landroid/support/v7/widget/af;
...
.method public e(Landroid/view/View;)Landroid/view/View;
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/af;->c(Landroid/view/View;)Z
