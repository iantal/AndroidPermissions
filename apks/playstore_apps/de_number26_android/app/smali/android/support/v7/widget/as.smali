...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/as;->a(Landroid/util/DisplayMetrics;)F

    move-result p1

    iput p1, p0, Landroid/support/v7/widget/as;->f:F
...
.method public a(Landroid/view/View;I)I
    ...
    .line 302
    invoke-virtual {p0}, Landroid/support/v7/widget/as;->e()Landroid/support/v7/widget/RecyclerView$i;
    ...
    .line 308
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/RecyclerView$i;->i(Landroid/view/View;)I
    ...
    .line 309
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/RecyclerView$i;->k(Landroid/view/View;)I
    ...
    .line 312
    invoke-virtual/range {v4 .. v9}, Landroid/support/v7/widget/as;->a(IIIII)I
...
.method protected a(IILandroid/support/v7/widget/RecyclerView$u;Landroid/support/v7/widget/RecyclerView$t$a;)V
    ...
    .line 126
    invoke-virtual {p0}, Landroid/support/v7/widget/as;->j()I
    ...
    .line 136
    :cond_0
    iget p3, p0, Landroid/support/v7/widget/as;->d:I

    invoke-direct {p0, p3, p1}, Landroid/support/v7/widget/as;->a(II)I
    ...
    .line 137
    iget p1, p0, Landroid/support/v7/widget/as;->e:I

    invoke-direct {p0, p1, p2}, Landroid/support/v7/widget/as;->a(II)I
    ...
    .line 139
    iget p1, p0, Landroid/support/v7/widget/as;->d:I
    ...
    .line 140
    invoke-virtual {p0, p4}, Landroid/support/v7/widget/as;->a(Landroid/support/v7/widget/RecyclerView$t$a;)V
...
.method protected a(Landroid/support/v7/widget/RecyclerView$t$a;)V
    ...
    .line 232
    invoke-virtual {p0}, Landroid/support/v7/widget/as;->i()I

    move-result v0

    invoke-virtual {p0, v0}, Landroid/support/v7/widget/as;->c(I)Landroid/graphics/PointF;
    ...
    .line 239
    :cond_0
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/as;->a(Landroid/graphics/PointF;)V
    ...
    iget v3, p0, Landroid/support/v7/widget/as;->e:I
    ...
    iget-object v2, p0, Landroid/support/v7/widget/as;->a:Landroid/view/animation/LinearInterpolator;
...
.method protected a(Landroid/view/View;Landroid/support/v7/widget/RecyclerView$u;Landroid/support/v7/widget/RecyclerView$t$a;)V
    ...
    invoke-virtual {p0, p1, p2}, Landroid/support/v7/widget/as;->b(Landroid/view/View;I)I
    ...
    invoke-virtual {p0, p1, v0}, Landroid/support/v7/widget/as;->a(Landroid/view/View;I)I
    ...
    .line 115
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/as;->a(I)I
    ...
    .line 117
    iget-object v1, p0, Landroid/support/v7/widget/as;->b:Landroid/view/animation/DecelerateInterpolator;
...
.method protected b(I)I
    ...
    iget v0, p0, Landroid/support/v7/widget/as;->f:F
...
.method public b(Landroid/view/View;I)I
    ...
    .line 333
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/RecyclerView$i;->h(Landroid/view/View;)I
    ...
    .line 334
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/RecyclerView$i;->j(Landroid/view/View;)I
