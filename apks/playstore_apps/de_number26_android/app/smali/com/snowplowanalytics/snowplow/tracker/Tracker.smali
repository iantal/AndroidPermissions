...
.method private constructor <init>(Lcom/snowplowanalytics/snowplow/tracker/Tracker$TrackerBuilder;)V
    ...
    .line 329
    iget-object p1, p1, Lcom/snowplowanalytics/snowplow/tracker/Tracker$TrackerBuilder;->logLevel:Lcom/snowplowanalytics/snowplow/tracker/utils/LogLevel;

    invoke-static {p1}, Lcom/snowplowanalytics/snowplow/tracker/utils/Logger;->updateLogLevel(Lcom/snowplowanalytics/snowplow/tracker/utils/LogLevel;)V

    .line 330
    sget-object p1, Lcom/snowplowanalytics/snowplow/tracker/Tracker;->TAG:Ljava/lang/String;
...
.method static synthetic access$200(Lcom/snowplowanalytics/snowplow/tracker/Tracker;)Z
    ...
    .line 52
    iget-boolean p0, p0, Lcom/snowplowanalytics/snowplow/tracker/Tracker;->base64Encoded:Z
...
.method private addEventPayload(Lcom/snowplowanalytics/snowplow/tracker/payload/TrackerPayload;Ljava/util/List;Ljava/lang/String;)V
    ...
    .line 418
    invoke-virtual {p2}, Lcom/snowplowanalytics/snowplow/tracker/payload/SelfDescribingJson;->getMap()Ljava/util/Map;

    move-result-object p2

    iget-boolean p3, p0, Lcom/snowplowanalytics/snowplow/tracker/Tracker;->base64Encoded:Z
    ...
    invoke-virtual {p1, p2, p3, v0, v1}, Lcom/snowplowanalytics/snowplow/tracker/payload/TrackerPayload;->addMap(Ljava/util/Map;Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/String;)V

    .line 423
    :cond_1
    sget-object p2, Lcom/snowplowanalytics/snowplow/tracker/Tracker;->TAG:Ljava/lang/String;

    const-string p3, "Adding new payload to event storage: %s"
    ...
    invoke-static {p2, p3, v0}, Lcom/snowplowanalytics/snowplow/tracker/utils/Logger;->v(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    .line 424
    iget-object p2, p0, Lcom/snowplowanalytics/snowplow/tracker/Tracker;->emitter:Lcom/snowplowanalytics/snowplow/tracker/Emitter;

    invoke-virtual {p2, p1}, Lcom/snowplowanalytics/snowplow/tracker/Emitter;->add(Lcom/snowplowanalytics/snowplow/tracker/payload/Payload;)V
...
.method private getFinalContext(Ljava/util/List;Ljava/lang/String;)Lcom/snowplowanalytics/snowplow/tracker/payload/SelfDescribingJson;
    ...
    .line 443
    :cond_0
    iget-boolean p2, p0, Lcom/snowplowanalytics/snowplow/tracker/Tracker;->geoLocationContext:Z

    if-eqz p2, :cond_1

    .line 444
    iget-object p2, p0, Lcom/snowplowanalytics/snowplow/tracker/Tracker;->context:Landroid/content/Context;

    invoke-static {p2}, Lcom/snowplowanalytics/snowplow/tracker/utils/Util;->getGeoLocationContext(Landroid/content/Context;)Lcom/snowplowanalytics/snowplow/tracker/payload/SelfDescribingJson;
    ...
    .line 448
    :cond_1
    iget-boolean p2, p0, Lcom/snowplowanalytics/snowplow/tracker/Tracker;->mobileContext:Z
    ...
    invoke-static {p2}, Lcom/snowplowanalytics/snowplow/tracker/utils/Util;->getMobileContext(Landroid/content/Context;)Lcom/snowplowanalytics/snowplow/tracker/payload/SelfDescribingJson;
    ...
    check-cast v0, Lcom/snowplowanalytics/snowplow/tracker/payload/SelfDescribingJson;
    ...
    const-string v0, "iglu:com.snowplowanalytics.snowplow/contexts/jsonschema/1-0-1"

    invoke-direct {p1, v0, p2}, Lcom/snowplowanalytics/snowplow/tracker/payload/SelfDescribingJson;-><init>(Ljava/lang/String;Ljava/lang/Object;)V
...
.method public static init(Lcom/snowplowanalytics/snowplow/tracker/Tracker;)Lcom/snowplowanalytics/snowplow/tracker/Tracker;
    ...
    .line 65
    sget-object p0, Lcom/snowplowanalytics/snowplow/tracker/Tracker;->spTracker:Lcom/snowplowanalytics/snowplow/tracker/Tracker;
    ...
    invoke-virtual {p0}, Lcom/snowplowanalytics/snowplow/tracker/Emitter;->flush()V
