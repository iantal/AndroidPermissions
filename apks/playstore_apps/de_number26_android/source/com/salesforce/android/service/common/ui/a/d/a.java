...
public class a
{
  ...
  {
    paramTypedArray = paramTypedArray.getString(a.f.SalesforceTextView_salesforceFont);
    if ((paramTypedArray != null) && (!paramTypedArray.isEmpty())) {
      return d.a(this.a.getAssets(), paramTypedArray);
    }
    return null;
  }
  ...
  public CharSequence a(CharSequence paramCharSequence)
  {
    if ((this.d != null) && (paramCharSequence != null))
    {
      ...
      if (!(paramCharSequence instanceof Spannable)) {
        localObject = new c(paramCharSequence);
      }
      a((Spannable)localObject, this.d);
      return localObject;
    }
    return paramCharSequence;
  }
