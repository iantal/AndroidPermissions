...
public class o
{
  ...
  public Matrix b(float paramFloat)
  {
    ...
    ((Matrix)localObject).preScale((float)Math.pow(d1, d2), (float)Math.pow(localD.b(), d2));
  ...
  public Matrix d()
  {
    ...
    localObject = (com.airbnb.lottie.f.d)this.d.e();
    if ((((com.airbnb.lottie.f.d)localObject).a() != 1.0F) || (((com.airbnb.lottie.f.d)localObject).b() != 1.0F)) {
      this.a.preScale(((com.airbnb.lottie.f.d)localObject).a(), ((com.airbnb.lottie.f.d)localObject).b());
    }
