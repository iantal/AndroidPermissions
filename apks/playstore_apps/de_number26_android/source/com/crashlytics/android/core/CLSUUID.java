...
class CLSUUID
{
  ...
  public CLSUUID(o paramO)
  {
    ...
    _clsId = String.format(Locale.US, "%s-%s-%s-%s", new Object[] { ((String)localObject).substring(0, 12), ((String)localObject).substring(12, 16), ((String)localObject).subSequence(16, 20), paramO.substring(0, 12) }).toUpperCase(Locale.US);
  }
