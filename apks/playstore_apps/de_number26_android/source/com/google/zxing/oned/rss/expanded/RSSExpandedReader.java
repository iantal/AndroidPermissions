  ...
  extends AbstractRSSReader
{
  ...
  static
  {
    ...
    int[] arrayOfInt12 = { 134, 191, 151, 31, 93, 68, 204, 190 };
    ...
    int[] arrayOfInt19 = { 45, 135, 194, 160, 58, 174, 100, 89 };
    WEIGHTS = new int[][] { arrayOfInt1, arrayOfInt2, arrayOfInt3, arrayOfInt4, arrayOfInt5, { 185, 133, 188, 142, 4, 12, 36, 108 }, arrayOfInt6, arrayOfInt7, arrayOfInt8, arrayOfInt9, { 43, 129, 176, 106, 107, 110, 119, 146 }, arrayOfInt10, { 109, 116, 137, 200, 178, 112, 125, 164 }, arrayOfInt11, arrayOfInt12, arrayOfInt13, arrayOfInt14, arrayOfInt15, arrayOfInt16, arrayOfInt17, { 161, 61, 183, 127, 170, 88, 53, 159 }, arrayOfInt18, arrayOfInt19 };
    arrayOfInt1 = new int[] { 0, 0 };
    arrayOfInt2 = new int[] { 0, 2, 1, 3 };
    arrayOfInt3 = new int[] { 0, 4, 1, 3, 3, 5 };
    arrayOfInt4 = new int[] { 0, 4, 1, 3, 4, 5, 5 };
    arrayOfInt5 = new int[] { 0, 0, 1, 1, 2, 2, 3, 4, 4 };
    arrayOfInt6 = new int[] { 0, 0, 1, 1, 2, 2, 3, 4, 5, 5 };
    FINDER_PATTERN_SEQUENCES = new int[][] { arrayOfInt1, { 0, 1, 1 }, arrayOfInt2, { 0, 4, 1, 3, 2 }, arrayOfInt3, arrayOfInt4, { 0, 0, 1, 1, 2, 2, 3, 3 }, arrayOfInt5, arrayOfInt6, { 0, 0, 1, 1, 2, 3, 3, 4, 4, 5, 5 } };
  }
  ...
  private boolean checkChecksum()
  {
    ...
    if (211 * (i - 4) + j % 211 == ((DataCharacter)localObject1).getValue()) {
      bool = true;
    }
    return bool;
  }
    ...
    throws NotFoundException
  {
    ...
    //   6: iload_1
    //   7: invokevirtual 354	com/google/zxing/oned/rss/expanded/RSSExpandedReader:retrieveNextPair	(Lcom/google/zxing/common/BitArray;Ljava/util/List;I)Lcom/google/zxing/oned/rss/expanded/ExpandedPair;
    //   10: astore 4
    //   12: aload_0
    //   13: getfield 61	com/google/zxing/oned/rss/expanded/RSSExpandedReader:pairs	Ljava/util/List;
    //   16: aload 4
    //   18: invokeinterface 155 2 0
    //   23: pop
    //   24: goto -24 -> 0
    //   27: astore_2
    //   28: aload_0
    //   29: getfield 61	com/google/zxing/oned/rss/expanded/RSSExpandedReader:pairs	Ljava/util/List;
    //   32: invokeinterface 224 1 0
    //   37: ifeq +5 -> 42
    //   40: aload_2
    //   41: athrow
    //   42: aload_0
    //   43: invokespecial 151	com/google/zxing/oned/rss/expanded/RSSExpandedReader:checkChecksum	()Z
    //   46: ifeq +8 -> 54
    //   49: aload_0
    //   50: getfield 61	com/google/zxing/oned/rss/expanded/RSSExpandedReader:pairs	Ljava/util/List;
    //   53: areturn
    //   54: aload_0
    //   55: getfield 64	com/google/zxing/oned/rss/expanded/RSSExpandedReader:rows	Ljava/util/List;
    //   58: invokeinterface 224 1 0
    //   63: istore_3
    //   64: aload_0
    //   65: iload_1
    //   66: iconst_0
    //   67: invokespecial 356	com/google/zxing/oned/rss/expanded/RSSExpandedReader:storeRow	(IZ)V
    //   70: iload_3
    //   71: iconst_1
    //   72: ixor
    //   73: ifeq +27 -> 100
    //   76: aload_0
    //   77: iconst_0
    //   78: invokespecial 358	com/google/zxing/oned/rss/expanded/RSSExpandedReader:checkRows	(Z)Ljava/util/List;
    //   81: astore_2
    //   82: aload_2
    //   83: ifnull +5 -> 88
    //   86: aload_2
    ...
    //   88: aload_0
    //   89: iconst_1
    //   90: invokespecial 358	com/google/zxing/oned/rss/expanded/RSSExpandedReader:checkRows	(Z)Ljava/util/List;
    //   93: astore_2
    //   94: aload_2
    //   95: ifnull +5 -> 100
    //   98: aload_2
    //   99: areturn
    //   100: invokestatic 86	com/google/zxing/NotFoundException:getNotFoundInstance	()Lcom/google/zxing/NotFoundException;
    //   103: athrow
