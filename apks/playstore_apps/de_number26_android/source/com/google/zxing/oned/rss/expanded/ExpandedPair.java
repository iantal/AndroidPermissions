...
final class ExpandedPair
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    bool1 = bool2;
    if (equalsOrNull(this.leftChar, paramObject.leftChar))
    {
      bool1 = bool2;
      if (equalsOrNull(this.rightChar, paramObject.rightChar))
      {
        bool1 = bool2;
        if (equalsOrNull(this.finderPattern, paramObject.finderPattern)) {
          bool1 = true;
        }
      }
    }
