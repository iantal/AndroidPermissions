...
final class MatrixUtil
{
  ...
  static
  {
    ...
    int[] arrayOfInt14 = { 6, 28, 54, 80, 106, -1, -1 };
    int[] arrayOfInt15 = { 6, 30, 58, 86, 114, -1, -1 };
    int[] arrayOfInt16 = { 6, 26, 50, 74, 98, 122, -1 };
    int[] arrayOfInt17 = { 6, 30, 54, 78, 102, 126, -1 };
    int[] arrayOfInt18 = { 6, 30, 56, 82, 108, 134, -1 };
    ...
    POSITION_ADJUSTMENT_PATTERN_COORDINATE_TABLE = new int[][] { arrayOfInt1, { 6, 18, -1, -1, -1, -1, -1 }, { 6, 22, -1, -1, -1, -1, -1 }, arrayOfInt2, arrayOfInt3, arrayOfInt4, { 6, 22, 38, -1, -1, -1, -1 }, arrayOfInt5, { 6, 26, 46, -1, -1, -1, -1 }, arrayOfInt6, arrayOfInt7, { 6, 32, 58, -1, -1, -1, -1 }, arrayOfInt8, arrayOfInt9, arrayOfInt10, { 6, 26, 50, 74, -1, -1, -1 }, arrayOfInt11, { 6, 30, 56, 82, -1, -1, -1 }, { 6, 30, 58, 86, -1, -1, -1 }, arrayOfInt12, { 6, 28, 50, 72, 94, -1, -1 }, { 6, 26, 50, 74, 98, -1, -1 }, arrayOfInt13, arrayOfInt14, { 6, 32, 58, 84, 110, -1, -1 }, arrayOfInt15, { 6, 34, 62, 90, 118, -1, -1 }, arrayOfInt16, arrayOfInt17, { 6, 26, 52, 78, 104, 130, -1 }, arrayOfInt18, arrayOfInt19, { 6, 30, 58, 86, 114, 142, -1 }, arrayOfInt20, arrayOfInt21, arrayOfInt22, { 6, 28, 54, 80, 106, 132, 158 }, arrayOfInt23, { 6, 26, 54, 82, 110, 138, 166 }, arrayOfInt24 };
    arrayOfInt1 = new int[] { 8, 1 };
    arrayOfInt2 = new int[] { 8, 2 };
    arrayOfInt3 = new int[] { 8, 5 };
    arrayOfInt4 = new int[] { 8, 7 };
    TYPE_INFO_COORDINATES = new int[][] { { 8, 0 }, arrayOfInt1, arrayOfInt2, { 8, 3 }, { 8, 4 }, arrayOfInt3, arrayOfInt4, { 8, 8 }, { 7, 8 }, { 5, 8 }, { 4, 8 }, { 3, 8 }, { 2, 8 }, { 1, 8 }, { 0, 8 } };
  }
