  ...
  extends ParsedResult
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    bool1 = bool2;
    if (equalsOrNull(this.productID, paramObject.productID))
    {
      bool1 = bool2;
      if (equalsOrNull(this.sscc, paramObject.sscc))
      {
        bool1 = bool2;
        if (equalsOrNull(this.lotNumber, paramObject.lotNumber))
        {
          bool1 = bool2;
          if (equalsOrNull(this.productionDate, paramObject.productionDate))
          {
            bool1 = bool2;
            if (equalsOrNull(this.bestBeforeDate, paramObject.bestBeforeDate))
            {
              bool1 = bool2;
              if (equalsOrNull(this.expirationDate, paramObject.expirationDate))
              {
                bool1 = bool2;
                if (equalsOrNull(this.weight, paramObject.weight))
                {
                  bool1 = bool2;
                  if (equalsOrNull(this.weightType, paramObject.weightType))
                  {
                    bool1 = bool2;
                    if (equalsOrNull(this.weightIncrement, paramObject.weightIncrement))
                    {
                      bool1 = bool2;
                      if (equalsOrNull(this.price, paramObject.price))
                      {
                        bool1 = bool2;
                        if (equalsOrNull(this.priceIncrement, paramObject.priceIncrement))
                        {
                          bool1 = bool2;
                          if (equalsOrNull(this.priceCurrency, paramObject.priceCurrency))
                          {
                            bool1 = bool2;
                            if (equalsOrNull(this.uncommonAIs, paramObject.uncommonAIs)) {
                              bool1 = true;
                            }
                          }
                        }
