  ...
  extends Exception
{
  ...
  public ConnectionResult getConnectionResult(GoogleApi<? extends Api.ApiOptions> paramGoogleApi)
  {
    ...
    boolean bool;
    if (this.zza.get(paramGoogleApi) != null) {
      bool = true;
    } else {
      bool = false;
    }
    zzbq.zzb(bool, "The given API was not part of the availability request.");
    return (ConnectionResult)this.zza.get(paramGoogleApi);
  }
  
  public String getMessage()
  {
    ArrayList localArrayList = new ArrayList();
    Object localObject1 = this.zza.keySet().iterator();
    int i = 1;
    while (((Iterator)localObject1).hasNext())
    {
      localObject2 = (zzh)((Iterator)localObject1).next();
      Object localObject3 = (ConnectionResult)this.zza.get(localObject2);
