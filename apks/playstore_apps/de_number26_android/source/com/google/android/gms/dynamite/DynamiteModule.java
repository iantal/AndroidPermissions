...
public final class DynamiteModule
{
      ...
      if ((localZzj.zzc != 0) && ((localZzj.zzc != -1) || (localZzj.zza != 0)) && ((localZzj.zzc != 1) || (localZzj.zzb != 0)))
      {
        ...
        for (;;)
        {
          ...
          if (i == 1) {
            try
            {
              localObject = zza(paramContext, paramString, localZzj.zzb);
              return localObject;
            }
            catch (zzc localZzc)
            {
              ...
              if ((localZzj.zza != 0) && (paramZzd.zza(paramContext, paramString, new zzb(localZzj.zza, 0)).zzc == -1))
              {
                paramZzd = zzc(paramContext, paramString);
                paramContext = paramZzd;
                if (localZza2.zza == null) {
    ...
    throws DynamiteModule.zzc
  {
    ...
    try
    {
      ...
      {
        paramContext = zza(paramContext.getApplicationContext(), paramString, paramInt, localZza.zza, (zzm)localObject);
