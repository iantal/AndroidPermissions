  ...
  extends zzbgm
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    if (paramObject != null)
    {
      ...
      if ((this.zze == paramObject.zze) && (this.zzf == paramObject.zzf)) {
        return true;
      }
    }
    return false;
  ...
  public int hashCode()
  {
    return Arrays.hashCode(new Object[] { Integer.valueOf(this.zze), Integer.valueOf(this.zzf) });
  }
  ...
  public void writeToParcel(Parcel paramParcel, int paramInt)
  {
    ...
    zzbgp.zza(paramParcel, 1, this.zze);
    zzbgp.zza(paramParcel, 2, this.zzf);
