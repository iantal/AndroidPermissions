  ...
  implements FusedLocationProviderApi
{
  ...
  {
    return paramGoogleApiClient.zzb(new zzcge(this, paramGoogleApiClient));
  }
  ...
  {
    return paramGoogleApiClient.zzb(new zzcgj(this, paramGoogleApiClient, paramPendingIntent));
  }
  ...
  {
    return paramGoogleApiClient.zzb(new zzcgb(this, paramGoogleApiClient, paramLocationCallback));
  }
  ...
  {
    return paramGoogleApiClient.zzb(new zzcgi(this, paramGoogleApiClient, paramLocationListener));
  }
  ...
  {
    return paramGoogleApiClient.zzb(new zzcgh(this, paramGoogleApiClient, paramLocationRequest, paramPendingIntent));
  }
  ...
  {
    return paramGoogleApiClient.zzb(new zzcgg(this, paramGoogleApiClient, paramLocationRequest, paramLocationCallback, paramLooper));
  }
  ...
  public final PendingResult<Status> requestLocationUpdates(GoogleApiClient paramGoogleApiClient, LocationRequest paramLocationRequest, LocationListener paramLocationListener)
  {
    ...
    return paramGoogleApiClient.zzb(new zzcga(this, paramGoogleApiClient, paramLocationRequest, paramLocationListener));
  }
  ...
  {
    return paramGoogleApiClient.zzb(new zzcgf(this, paramGoogleApiClient, paramLocationRequest, paramLocationListener, paramLooper));
  }
  
  public final PendingResult<Status> setMockLocation(GoogleApiClient paramGoogleApiClient, Location paramLocation)
  {
    return paramGoogleApiClient.zzb(new zzcgd(this, paramGoogleApiClient, paramLocation));
  }
  
  public final PendingResult<Status> setMockMode(GoogleApiClient paramGoogleApiClient, boolean paramBoolean)
  {
    return paramGoogleApiClient.zzb(new zzcgc(this, paramGoogleApiClient, paramBoolean));
  }
}
