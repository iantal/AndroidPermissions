  ...
  implements ReflectedParcelable
{
  ...
  private final FileOutputStream zzc()
  {
    ...
    try
    {
      localFile = File.createTempFile("teleporter", ".tmp", this.zzf);
    }
    ...
    try
    {
      ...
      this.zzb = ParcelFileDescriptor.open(localFile, 268435456);
      localFile.delete();
  ...
  public void writeToParcel(android.os.Parcel paramParcel, int paramInt)
  {
    ...
    //   141: athrow
    //   142: aload_1
    //   143: invokestatic 175	com/google/android/gms/internal/zzbgp:zza	(Landroid/os/Parcel;)I
    //   146: istore_3
    //   147: aload_1
    //   148: iconst_1
    //   149: aload_0
    //   150: getfield 35	com/google/android/gms/common/data/BitmapTeleporter:zza	I
    //   153: invokestatic 178	com/google/android/gms/internal/zzbgp:zza	(Landroid/os/Parcel;II)V
    //   156: aload_1
    //   157: iconst_2
    //   158: aload_0
    ...
    //   164: ior
    //   165: iconst_0
    //   166: invokestatic 181	com/google/android/gms/internal/zzbgp:zza	(Landroid/os/Parcel;ILandroid/os/Parcelable;IZ)V
    //   169: aload_1
    //   170: iconst_3
    //   171: aload_0
    //   172: getfield 39	com/google/android/gms/common/data/BitmapTeleporter:zzc	I
    //   175: invokestatic 178	com/google/android/gms/internal/zzbgp:zza	(Landroid/os/Parcel;II)V
    //   178: aload_1
    //   179: iload_3
    //   180: invokestatic 183	com/google/android/gms/internal/zzbgp:zza	(Landroid/os/Parcel;I)V
    //   183: aload_0
    //   184: aconst_null
