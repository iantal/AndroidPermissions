...
public abstract interface TapAndPay
{
  ...
  public abstract PendingResult<GetActiveWalletIdResult> getActiveWalletId(GoogleApiClient paramGoogleApiClient);
  
  public abstract PendingResult<GetEnvironmentResult> getEnvironment(GoogleApiClient paramGoogleApiClient);
  
  public abstract PendingResult<GetStableHardwareIdResult> getStableHardwareId(GoogleApiClient paramGoogleApiClient);
  
  public abstract PendingResult<GetTokenStatusResult> getTokenStatus(GoogleApiClient paramGoogleApiClient, int paramInt, String paramString);
  ...
  public static abstract interface GetActiveWalletIdResult
    extends Result
  {
    public abstract String getActiveWalletId();
  }
  
  public static abstract interface GetEnvironmentResult
    extends Result
  {
    public abstract String getEnvironment();
  }
  
  public static abstract interface GetStableHardwareIdResult
    extends Result
  {
    public abstract String getStableHardwareId();
  }
  
  public static abstract interface GetTokenStatusResult
    extends Result
  {
    public abstract TokenStatus getTokenStatus();
  }
