...
public final class zzcza
{
  ...
  private zzcza(Context paramContext, int paramInt, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    if (zzz.zza(this.zzj))
    {
      ...
      this.zze = zzz.zza(paramContext, paramString1);
      paramContext = this.zze;
      if ((paramContext != null) && (zzz.zza(this.zzj)))
      {
        if (this.zze != null) {
          this.zze.add(paramContext);
        } else {
        ...
        try
        {
          this.zzd.setWorkSource(paramContext);
        }
  ...
  public final void zza(long paramLong)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        boolean bool = this.zzl.isEmpty();
        i = 0;
        if (((!bool) || (this.zzm > 0)) && (!this.zzd.isHeld()))
        {
          this.zzl.clear();
          this.zzm = 0;
        }
        if (this.zzk)
        {
          ...
          if (arrayOfInteger == null)
          {
            this.zzl.put(str, new Integer[] { Integer.valueOf(1) });
            i = 1;
          }
          else
          {
