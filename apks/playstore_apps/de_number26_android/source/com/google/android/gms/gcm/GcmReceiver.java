  ...
  extends WakefulBroadcastReceiver
{
  ...
  private final zzh zza(Context paramContext, String paramString)
  {
    try
    {
  ...
  private final void zza(Context paramContext, Intent paramIntent)
  {
    ...
    if ((localObject1 != null) && (((ResolveInfo)localObject1).serviceInfo != null))
    {
      ...
      else
      {
        ...
        localObject2 = ((ServiceInfo)localObject2).name;
        StringBuilder localStringBuilder = new StringBuilder(94 + String.valueOf(localObject1).length() + String.valueOf(localObject2).length());
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    if (i != 0)
    {
      ...
      zza(paramContext, paramIntent.getAction()).zza(paramIntent, goAsync());
      return;
    }
