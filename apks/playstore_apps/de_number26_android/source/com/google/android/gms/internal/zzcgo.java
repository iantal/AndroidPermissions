  ...
  implements GeofencingApi
{
  ...
  {
    return paramGoogleApiClient.zzb(new zzcgq(this, paramGoogleApiClient, paramZzal));
  }
  ...
  {
    return paramGoogleApiClient.zzb(new zzcgp(this, paramGoogleApiClient, paramGeofencingRequest, paramPendingIntent));
  }
