    ...
    throws IOException
  {
    ...
    try
    {
      ...
      if (paramInt == zzd(paramString.length() * 3))
      {
        ...
        if (this.zza.remaining() < paramInt) {
          throw new zzetx(i + paramInt, this.zza.limit());
        }
        this.zza.position(i + paramInt);
    ...
    catch (BufferOverflowException paramString)
    {
      ...
      localZzetx.initCause(paramString);
      throw localZzetx;
    }
  }
