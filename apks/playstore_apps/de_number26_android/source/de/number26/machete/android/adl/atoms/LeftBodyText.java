...
public final class LeftBodyText
  extends FrameLayout
{
  private HashMap a;
  
  public LeftBodyText(Context paramContext)
  {
    this(paramContext, null, 0, 6, null);
  }
  
  public LeftBodyText(Context paramContext, AttributeSet paramAttributeSet)
  {
    this(paramContext, paramAttributeSet, 0, 4, null);
  }
  
  public LeftBodyText(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    super(paramContext, paramAttributeSet, paramInt);
    View.inflate(paramContext, 2131427847, (ViewGroup)this);
  ...
  {
    paramAttributeSet = paramContext.obtainStyledAttributes(paramAttributeSet, a.b.LeftBodyText, 0, 0);
    if (isInEditMode())
    {
  ...
  public final void a(String paramString, List<de.number26.machete.android.adl.c.a> paramList)
  {
    ...
    j.b(paramList, "links");
    TextView localTextView = (TextView)a(a.a.textLeftBodyText);
    j.a(localTextView, "textLeftBodyText");
  ...
  {
    ((TextView)a(a.a.textLeftBodyText)).setTextColor(android.support.v4.content.c.c(getContext(), paramInt));
  }
