...
public class bp
{
  ...
  private bp(Context paramContext, TypedArray paramTypedArray)
  {
    this.a = paramContext;
    this.b = paramTypedArray;
  }
  
  public static bp a(Context paramContext, int paramInt, int[] paramArrayOfInt)
  {
    return new bp(paramContext, paramContext.obtainStyledAttributes(paramInt, paramArrayOfInt));
  }
  
  public static bp a(Context paramContext, AttributeSet paramAttributeSet, int[] paramArrayOfInt)
  {
    return new bp(paramContext, paramContext.obtainStyledAttributes(paramAttributeSet, paramArrayOfInt));
  }
  
  public static bp a(Context paramContext, AttributeSet paramAttributeSet, int[] paramArrayOfInt, int paramInt1, int paramInt2)
  {
    return new bp(paramContext, paramContext.obtainStyledAttributes(paramAttributeSet, paramArrayOfInt, paramInt1, paramInt2));
  }
  ...
  public Typeface a(int paramInt1, int paramInt2, b.a paramA)
  {
    ...
    return android.support.v4.content.a.b.a(this.a, paramInt1, this.c, paramInt2, paramA);
  }
  ...
  public Drawable a(int paramInt)
  {
    if (this.b.hasValue(paramInt))
    {
      ...
      if (i != 0) {
        return android.support.v7.c.a.b.b(this.a, i);
      }
    }
  ...
  public ColorStateList e(int paramInt)
  {
    if (this.b.hasValue(paramInt))
    {
      ...
      if (i != 0)
      {
        ColorStateList localColorStateList = android.support.v7.c.a.b.a(this.a, i);
