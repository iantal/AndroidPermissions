...
class h
{
  ...
  private boolean b(Drawable paramDrawable)
  {
    ...
    bn localBn = this.f;
    localBn.a();
    Object localObject = t.s(this.a);
    if (localObject != null)
    {
      localBn.d = true;
      localBn.a = ((ColorStateList)localObject);
    }
    localObject = t.t(this.a);
    if (localObject != null)
    {
      localBn.c = true;
  ...
  void a(AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    try
    {
      ...
      if (paramAttributeSet.g(a.j.ViewBackgroundHelper_backgroundTint)) {
        t.a(this.a, paramAttributeSet.e(a.j.ViewBackgroundHelper_backgroundTint));
      }
      if (paramAttributeSet.g(a.j.ViewBackgroundHelper_backgroundTintMode)) {
        t.a(this.a, ak.a(paramAttributeSet.a(a.j.ViewBackgroundHelper_backgroundTintMode, -1), null));
      }
      return;
    }
    finally
