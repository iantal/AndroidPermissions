  ...
  extends ar
{
  ...
  private void d(int paramInt1, int paramInt2)
  {
    ...
    while (i < paramInt1)
    {
      ...
      {
        ar.a localA = (ar.a)localView.getLayoutParams();
        if (localA.width == -1)
        {
          int k = localA.height;
    ...
    while (paramInt4 < i1)
    {
      ...
      if (localObject != null)
      {
        ...
        if (((View)localObject).getVisibility() != 8)
        {
          ...
          ar.a localA = (ar.a)((View)localObject).getLayoutParams();
          int i = localA.h;
          paramInt2 = i;
          if (i < 0) {
            paramInt2 = i2 & 0x800007;
          }
          paramInt2 = d.a(paramInt2, t.e(this)) & 0x7;
          if (paramInt2 != 1)
          {
            if (paramInt2 != 5) {
          ...
          paramInt2 = paramInt1 + (i4 + localA.bottomMargin);
        }
      }
      paramInt4 += 1;
      paramInt1 = paramInt2;
