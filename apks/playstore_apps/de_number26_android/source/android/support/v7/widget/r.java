...
class r
{
  ...
  private Drawable a(Drawable paramDrawable, boolean paramBoolean)
  {
    ...
    {
      localObject1 = (f)paramDrawable;
      localObject2 = ((f)localObject1).a();
      if (localObject2 != null)
      {
        ((f)localObject1).a(a((Drawable)localObject2, paramBoolean));
  ...
  {
    paramAttributeSet = bp.a(this.b.getContext(), paramAttributeSet, a, paramInt, 0);
