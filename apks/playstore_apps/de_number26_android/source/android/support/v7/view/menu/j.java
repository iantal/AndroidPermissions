  ...
  implements android.support.v4.c.a.b
{
  ...
  private Drawable a(Drawable paramDrawable)
  {
    ...
    if (paramDrawable != null)
    {
      ...
      if (this.x) {
        ...
        {
          localDrawable = a.g(paramDrawable).mutate();
          if (this.v) {
  ...
  public android.support.v4.c.a.b a(c paramC)
  {
    if (this.B != null) {
      this.B.f();
    }
  ...
  public android.support.v4.c.a.b a(CharSequence paramCharSequence)
  {
  ...
  public android.support.v4.c.a.b b(CharSequence paramCharSequence)
  {
