  ...
  extends Drawable
{
  ...
  private Shader createGradientShader()
  {
    ...
    int i = a.a(this.mTopOuterStrokeColor, this.mCurrentBorderTintColor);
    int j = a.a(this.mTopInnerStrokeColor, this.mCurrentBorderTintColor);
    int k = a.a(a.b(this.mTopInnerStrokeColor, 0), this.mCurrentBorderTintColor);
    int m = a.a(a.b(this.mBottomInnerStrokeColor, 0), this.mCurrentBorderTintColor);
    int n = a.a(this.mBottomInnerStrokeColor, this.mCurrentBorderTintColor);
    int i1 = a.a(this.mBottomOuterStrokeColor, this.mCurrentBorderTintColor);
