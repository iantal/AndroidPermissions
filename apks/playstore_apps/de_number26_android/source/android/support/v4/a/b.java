...
public class b
{
  ...
  public static class b
  {
    ...
    private static void a(Path paramPath, double paramDouble1, double paramDouble2, double paramDouble3, double paramDouble4, double paramDouble5, double paramDouble6, double paramDouble7, double paramDouble8, double paramDouble9)
    {
      ...
      paramDouble7 *= d7;
      double d6 = paramDouble4 * d5;
      double d8 = paramDouble9 / i;
      int j = 0;
      double d3 = d2 * paramDouble7 + d1 * d6;
      d1 = d10 * d2 - d11 * d1;
      d2 = paramDouble6;
      ...
      for (;;)
      {
        ...
        d7 = paramDouble1 + d6 * paramDouble5 * d12 - d11 * d8;
        double d9 = paramDouble2 + d6 * paramDouble4 * d12 + paramDouble6 * d8;
        d6 = d10 * d8 - d11 * d12;
        d8 = d8 * paramDouble8 + d12 * paramDouble6;
        d4 = d5 - d4;
        d12 = Math.tan(d4 / 2.0D);
        d4 = Math.sin(d4) * (Math.sqrt(4.0D + 3.0D * d12 * d12) - 1.0D) / 3.0D;
        paramPath.rLineTo(0.0F, 0.0F);
        paramPath.cubicTo((float)(paramDouble9 + d1 * d4), (float)(d2 + d3 * d4), (float)(d7 - d4 * d6), (float)(d9 - d4 * d8), (float)d7, (float)d9);
        j += 1;
        d2 = d9;
        paramDouble9 = d7;
        d3 = d8;
