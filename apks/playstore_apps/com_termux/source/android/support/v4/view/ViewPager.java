  ...
  extends ViewGroup
{
  ...
  private static final k ai = new k();
    ...
    for (int i1 = 0;; i1 = 1)
    {
      ...
      for (int i2 = 0;; i2 = 1)
      {
        if (f2 < paramFloat)
        {
          ...
          this.R.onPull(Math.abs(paramFloat - f2) / i3);
        }
        for (;;)
        {
          ...
          {
            if (i2 != 0) {
              this.S.onPull(Math.abs(f2 - f1) / i3);
            }
  ...
  void a()
  {
    ...
    f.a(this, new d()
    {
      ...
      public h a(View paramAnonymousView, h paramAnonymousH)
      {
        paramAnonymousView = f.a(paramAnonymousView, paramAnonymousH);
        if (paramAnonymousView.e()) {
          return paramAnonymousView;
        }
        paramAnonymousH = this.b;
        paramAnonymousH.left = paramAnonymousView.a();
        paramAnonymousH.top = paramAnonymousView.b();
        paramAnonymousH.right = paramAnonymousView.c();
        paramAnonymousH.bottom = paramAnonymousView.d();
        int i = 0;
        int j = ViewPager.this.getChildCount();
        while (i < j)
        {
          h localH = f.b(ViewPager.this.getChildAt(i), paramAnonymousView);
          paramAnonymousH.left = Math.min(localH.a(), paramAnonymousH.left);
          paramAnonymousH.top = Math.min(localH.b(), paramAnonymousH.top);
          paramAnonymousH.right = Math.min(localH.c(), paramAnonymousH.right);
          paramAnonymousH.bottom = Math.min(localH.d(), paramAnonymousH.bottom);
          i += 1;
        }
        return paramAnonymousView.a(paramAnonymousH.left, paramAnonymousH.top, paramAnonymousH.right, paramAnonymousH.bottom);
      }
    });
  }
      ...
      for (;;)
      {
        ...
        for (Object localObject3 = a(this.c, paramInt);; localObject3 = localObject1)
        {
          ...
          for (float f2 = 0.0F;; f2 = getPaddingRight() / i8 + 2.0F)
          {
            ...
            ((e)localObject2).b(this, paramInt, localObject1);
            this.b.b(this);
            i1 = getChildCount();
            paramInt = 0;
            while (paramInt < i1)
  ...
  public void onRestoreInstanceState(Parcelable paramParcelable)
  {
    ...
    if (this.b != null)
    {
      this.b.a(paramParcelable.c, paramParcelable.d);
  ...
  public void setAdapter(e paramE)
  {
    ...
    while ((this.ad != null) && (!this.ad.isEmpty()))
    {
      ...
      while (i1 < i3)
      {
        ((e)this.ad.get(i1)).a(this, (e)localObject, paramE);
        i1 += 1;
      }
      label300:
      if (!bool) {
  ...
  {
    setPageMarginDrawable(android.support.v4.a.a.a(getContext(), paramInt));
  }
  ...
  {
    public abstract void a(ViewPager paramViewPager, e paramE1, e paramE2);
  }
    ...
    extends a
  {
    ...
    i(Parcel paramParcel, ClassLoader paramClassLoader)
    {
      ...
      this.c = paramParcel.readParcelable(localClassLoader);
      this.d = localClassLoader;
    }
