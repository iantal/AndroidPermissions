...
public final class e
{
    ...
    throws Resources.NotFoundException
  {
    ...
    //   39: iconst_0
    //   40: fconst_1
    //   41: invokestatic 29	android/support/c/a/e:a	(Landroid/content/Context;Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/animation/AnimatorSet;IF)Landroid/animation/Animator;
    //   44: astore_0
    //   45: aload 7
    //   47: ifnull +10 -> 57
    //   50: aload 7
    ...
    throws XmlPullParserException, IOException
  {
    ...
    for (;;)
    {
      ...
      if (((String)localObject1).equals("set"))
      {
        ...
        localObject2 = c.a(paramResources, paramTheme, paramAttributeSet, a.h);
        i = c.a((TypedArray)localObject2, paramXmlPullParser, "ordering", 0, 0);
  ...
  private static PropertyValuesHolder a(TypedArray paramTypedArray, int paramInt1, int paramInt2, int paramInt3, String paramString)
  {
    ...
    for (;;)
    {
      if (i == 2)
      {
        ...
        b.b[] arrayOfB1 = b.b((String)localObject);
        b.b[] arrayOfB2 = b.b(paramTypedArray);
    ...
    throws Resources.NotFoundException
  {
    ...
    int i = c.a(localTypedArray, paramXmlPullParser, "interpolator", 0);
    if (i > 0) {
  ...
  private static void a(ValueAnimator paramValueAnimator, TypedArray paramTypedArray1, TypedArray paramTypedArray2, float paramFloat, XmlPullParser paramXmlPullParser)
  {
    ...
    for (int i = 3;; i = 0)
    {
      ...
      paramTypedArray1 = c.b(paramTypedArray2, paramXmlPullParser, "pathData", 1);
      if (paramTypedArray1 == null) {
        break label372;
      }
      localObject = c.b(paramTypedArray2, paramXmlPullParser, "propertyXName", 2);
      paramXmlPullParser = c.b(paramTypedArray2, paramXmlPullParser, "propertyYName", 3);
    ...
    label354:
    a(b.a(paramTypedArray1), paramValueAnimator, 0.5F * paramFloat, (String)localObject, paramXmlPullParser);
    label371:
    return;
    label372:
    paramValueAnimator.setPropertyName(c.b(paramTypedArray2, paramXmlPullParser, "propertyName", 0));
  }
    ...
    throws XmlPullParserException, IOException
  {
    ...
    {
      TypedArray localTypedArray1 = c.a(paramResources, paramTheme, paramAttributeSet, a.i);
      String str = c.b(localTypedArray1, paramXmlPullParser, "propertyName", 3);
      int i1 = c.a(localTypedArray1, paramXmlPullParser, "valueType", 2, 4);
      localObject1 = null;
      i = i1;
      ...
      if ((j != 3) && (j != 1))
      {
        ...
        localObject2 = c.a(paramResources, paramTheme, Xml.asAttributeSet(paramXmlPullParser), a.j);
        localObject3 = c.a((TypedArray)localObject2, paramXmlPullParser, "value");
        ...
        if (localObject3 != null)
        {
          ...
          i = 3;
          ((TypedArray)localObject2).recycle();
          localTypedArray2 = c.a(paramResources, paramTheme, Xml.asAttributeSet(paramXmlPullParser), a.j);
          localObject3 = null;
          f = c.a(localTypedArray2, paramXmlPullParser, "fraction", 3, -1.0F);
          localObject2 = c.a(localTypedArray2, paramXmlPullParser, "value");
        ...
        for (;;)
        {
          j = c.a(localTypedArray2, paramXmlPullParser, "interpolator", 1);
          if (j > 0) {
            ((Keyframe)localObject2).setInterpolator(d.a(paramContext, j));
          }
          ...
          j = 0;
          break label271;
          localObject2 = Keyframe.ofFloat(f, c.a(localTypedArray2, paramXmlPullParser, "value", 0, 0.0F));
          continue;
          localObject2 = Keyframe.ofInt(f, c.a(localTypedArray2, paramXmlPullParser, "value", 0, 0));
          continue;
          label464:
          if (j == 0) {
      ...
      else if (localObject1 != null)
      {
        ...
        if (j > 0)
        {
          ...
          if (f < 1.0F)
          {
            ...
            if (i == 3)
            {
              ((PropertyValuesHolder)localObject2).setEvaluator(f.a());
              localObject1 = localObject2;
            }
            label828:
            if (localObject1 == null)
