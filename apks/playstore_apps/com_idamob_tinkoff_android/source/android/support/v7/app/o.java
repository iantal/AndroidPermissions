...
final class o
{
  ...
  static void a(View paramView, AttributeSet paramAttributeSet)
  {
    ...
    if ((!(localObject instanceof ContextWrapper)) || ((Build.VERSION.SDK_INT >= 15) && (!s.F(paramView)))) {
      return;
    }
  ...
  final View a(Context paramContext, String paramString, AttributeSet paramAttributeSet)
  {
    ...
    //   3: aload_2
    //   4: ldc -77
    //   6: invokevirtual 183	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   9: ifeq +14 -> 23
    //   12: aload_3
    //   13: aconst_null
    //   14: ldc -71
    //   16: invokeinterface 189 3 0
    //   21: astore 5
    //   23: aload_0
    ...
    //   38: aload 5
    //   40: bipush 46
    //   42: invokevirtual 193	java/lang/String:indexOf	(I)I
    //   45: if_icmpne +74 -> 119
    //   48: iconst_0
    //   49: istore 4
    //   51: iload 4
    ...
    //   67: iload 4
    //   69: aaload
    //   70: invokespecial 195	android/support/v7/app/o:a	(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    //   73: astore_2
    //   74: aload_2
    //   75: ifnull +19 -> 94
    //   78: aload_0
    ...
    //   121: aload 5
    //   123: aconst_null
    //   124: invokespecial 195	android/support/v7/app/o:a	(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    //   127: astore_1
    //   128: aload_0
