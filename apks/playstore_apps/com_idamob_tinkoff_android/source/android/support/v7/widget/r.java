...
class r
{
  ...
  private Drawable a(Drawable paramDrawable, boolean paramBoolean)
  {
    ...
    {
      localObject1 = ((b)paramDrawable).a();
      if (localObject1 != null)
      {
        localObject1 = a((Drawable)localObject1, paramBoolean);
        ((b)paramDrawable).a((Drawable)localObject1);
      }
    }
    do
    {
  ...
  {
    bp localBp = bp.a(this.c.getContext(), paramAttributeSet, b, paramInt, 0);
    Object localObject = localBp.b(0);
    if (localObject != null)
    {
