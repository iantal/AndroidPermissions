  ...
  implements RecyclerView.l
{
  ...
  private final Runnable D = new Runnable()
  {
    public final void run()
    {
      ...
      localAm.o = 3;
      localAm.n.setFloatValues(new float[] { ((Float)localAm.n.getAnimatedValue()).floatValue(), 0.0F });
      localAm.n.setDuration(500L);
      localAm.n.start();
    }
  };
  private final RecyclerView.m E = new RecyclerView.m()
  {
    public final void a(RecyclerView paramAnonymousRecyclerView, int paramAnonymousInt1, int paramAnonymousInt2)
    {
      ...
      int i = localAm.j.computeVerticalScrollRange();
      int j = localAm.i;
      boolean bool;
      int k;
      int m;
      if ((i - j > 0) && (localAm.i >= localAm.a))
      {
        bool = true;
        localAm.k = bool;
        k = localAm.j.computeHorizontalScrollRange();
        m = localAm.h;
        if ((k - m <= 0) || (localAm.h < localAm.a)) {
          break label149;
        }
        bool = true;
        label105:
        localAm.l = bool;
        if ((localAm.k) || (localAm.l)) {
          break label155;
        }
        if (localAm.m != 0) {
          localAm.a(0);
      ...
      do
      {
        ...
        if (localAm.k)
        {
          localAm.c = ((int)((paramAnonymousInt2 + j / 2.0F) * j / i));
          localAm.b = Math.min(j, j * j / i);
        }
        if (localAm.l)
        {
          localAm.f = ((int)((paramAnonymousInt1 + m / 2.0F) * m / k));
          localAm.e = Math.min(m, m * m / k);
        }
      } while ((localAm.m != 0) && (localAm.m != 1));
      localAm.a(1);
    }
  };
  final int a;
  ...
  public final void b(RecyclerView paramRecyclerView, MotionEvent paramMotionEvent)
  {
    ...
    do
    {
      do
      {
        ...
        if (this.A == 1)
        {
          ...
          {
            i1 = a(this.g, f1, paramRecyclerView, this.j.computeHorizontalScrollRange(), this.j.computeHorizontalScrollOffset(), this.h);
            if (i1 != 0) {
    ...
    int i1 = a(this.d, f1, paramRecyclerView, this.j.computeVerticalScrollRange(), this.j.computeVerticalScrollOffset(), this.i);
    if (i1 != 0) {
