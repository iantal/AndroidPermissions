  ...
  extends CompoundButton
{
  ...
  public SwitchCompat(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    localObject = bp.a(paramContext, paramAttributeSet, a.j.SwitchCompat, paramInt, 0);
    this.c = ((bp)localObject).a(a.j.SwitchCompat_android_thumb);
    if (this.c != null) {
      this.c.setCallback(this);
    }
    this.h = ((bp)localObject).a(a.j.SwitchCompat_track);
    if (this.h != null) {
      this.h.setCallback(this);
    }
    this.q = ((bp)localObject).c(a.j.SwitchCompat_android_textOn);
    this.r = ((bp)localObject).c(a.j.SwitchCompat_android_textOff);
    this.s = ((bp)localObject).a(a.j.SwitchCompat_showText, true);
    this.m = ((bp)localObject).e(a.j.SwitchCompat_thumbTextPadding, 0);
    this.n = ((bp)localObject).e(a.j.SwitchCompat_switchMinWidth, 0);
    this.o = ((bp)localObject).e(a.j.SwitchCompat_switchPadding, 0);
    this.p = ((bp)localObject).a(a.j.SwitchCompat_splitTrack, false);
    paramAttributeSet = ((bp)localObject).e(a.j.SwitchCompat_thumbTint);
    if (paramAttributeSet != null)
    {
      this.d = paramAttributeSet;
      this.f = true;
    }
    paramAttributeSet = ak.a(((bp)localObject).a(a.j.SwitchCompat_thumbTintMode, -1), null);
    ...
    paramAttributeSet = ((bp)localObject).e(a.j.SwitchCompat_trackTint);
    if (paramAttributeSet != null)
    {
      this.i = paramAttributeSet;
      this.k = true;
    }
    paramAttributeSet = ak.a(((bp)localObject).a(a.j.SwitchCompat_trackTintMode, -1), null);
    ...
    paramInt = ((bp)localObject).g(a.j.SwitchCompat_switchTextAppearance, 0);
    bp localBp;
    int i1;
    label530:
    label545:
    ...
    if (paramInt != 0)
    {
      localBp = bp.a(paramContext, paramInt, a.j.TextAppearance);
      paramAttributeSet = localBp.e(a.j.TextAppearance_android_textColor);
      if (paramAttributeSet == null) {
        break label685;
      }
      this.I = paramAttributeSet;
      paramInt = localBp.e(a.j.TextAppearance_android_textSize, 0);
      if ((paramInt != 0) && (paramInt != this.H.getTextSize()))
      {
        this.H.setTextSize(paramInt);
        requestLayout();
      }
      paramInt = localBp.a(a.j.TextAppearance_android_typeface, -1);
      i1 = localBp.a(a.j.TextAppearance_android_textStyle, -1);
      switch (paramInt)
      {
      default: 
    ...
    label738:
    label768:
    for (this.L = new android.support.v7.f.a(getContext());; this.L = null)
    {
      localBp.b.recycle();
      ((bp)localObject).b.recycle();
  ...
  private int getThumbScrollRange()
  {
    if (this.h != null)
    {
      ...
      if (this.c != null) {}
      for (Rect localRect1 = ak.a(this.c);; localRect1 = ak.a) {
