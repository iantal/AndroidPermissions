      ...
      if (localObject == null)
      {
        ...
        if (localObject != null)
        {
          ...
          if (((View)localObject).getVisibility() != 8)
          {
            ...
            localA = (ar.a)((View)localObject).getLayoutParams();
            i = localA.h;
            paramInt2 = i;
            if (i < 0) {
              paramInt2 = 0x800007 & i2;
            }
            switch (d.a(paramInt2, s.g(this)) & 0x7)
            {
            default: 
              ...
              for (;;)
              {
                ...
                if (i4 != 1073741824)
                {
                  ...
                  while (i < i3)
                  {
                    ...
                    if (((View)localObject1).getVisibility() != 8)
                    {
                      localObject2 = (ar.a)((View)localObject1).getLayoutParams();
                      if (((ar.a)localObject2).width == -1)
                      {
                        k = ((ar.a)localObject2).height;
                        ((ar.a)localObject2).height = ((View)localObject1).getMeasuredHeight();
                        measureChildWithMargins((View)localObject1, j, 0, paramInt2, 0);
                        ((ar.a)localObject2).height = k;
                      }
                    }
                    i += 1;
                  }
