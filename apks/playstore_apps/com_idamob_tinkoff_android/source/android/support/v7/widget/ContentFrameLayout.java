  ...
  extends FrameLayout
{
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      if (i > 0)
      {
        m = View.MeasureSpec.makeMeasureSpec(Math.min(i - (this.b.left + this.b.right), View.MeasureSpec.getSize(paramInt1)), 1073741824);
        k = 1;
      }
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          i = paramInt2;
          if (paramInt1 > 0) {
            i = View.MeasureSpec.makeMeasureSpec(Math.min(paramInt1 - (this.b.top + this.b.bottom), View.MeasureSpec.getSize(paramInt2)), 1073741824);
          }
          super.onMeasure(m, i);
          i2 = getMeasuredWidth();
          ...
          for (;;)
          {
            ...
            paramInt2 = paramInt1;
            if (paramInt1 > 0) {
              paramInt2 = paramInt1 - (this.b.left + this.b.right);
            }
            if (i2 < paramInt2) {
