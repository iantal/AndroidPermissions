  ...
  extends a
{
  ...
  public ActionBarContextView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    s.a(this, paramContext.a(a.j.ActionMode_background));
    this.o = paramContext.g(a.j.ActionMode_titleTextStyle, 0);
    this.p = paramContext.g(a.j.ActionMode_subtitleTextStyle, 0);
  ...
  private void c()
  {
    ...
    if (this.l == null)
    {
      ...
      this.m = ((TextView)this.l.findViewById(a.f.action_bar_title));
  ...
  public final void a(final b paramB)
  {
    ...
    for (;;)
    {
      this.g.findViewById(a.f.action_mode_close_button).setOnClickListener(new View.OnClickListener()
      {
