  ...
  implements View.OnClickListener
{
  ...
  public bk(Context paramContext, SearchView paramSearchView, SearchableInfo paramSearchableInfo, WeakHashMap<String, Drawable.ConstantState> paramWeakHashMap)
  {
  ...
  public final View a(Context paramContext, Cursor paramCursor, ViewGroup paramViewGroup)
  {
    ...
    ((ImageView)paramContext.findViewById(a.f.edit_query)).setImageResource(this.p);
    return paramContext;
  }
  ...
  public final void a(View paramView, Cursor paramCursor)
  {
    ...
    for (int i = paramCursor.getInt(this.x);; i = 0)
    {
      ...
      if (localA.b != null)
      {
        ...
        if (localObject1 != null)
        {
          if (this.r == null)
          {
            ...
            this.d.getTheme().resolveAttribute(a.a.textColorSearchUrl, paramView, true);
      ...
      label374:
      label519:
      for (paramView = localObject2;; paramView = a(paramCursor.getString(this.w)))
      {
        ...
        break label201;
        localObject1 = a(paramCursor.getString(this.v));
