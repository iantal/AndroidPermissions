...
public final class s
{
  ...
  public static w o(View paramView)
  {
    j localJ = a;
    if (localJ.a == null) {
      localJ.a = new WeakHashMap();
    }
    w localW2 = (w)localJ.a.get(paramView);
    w localW1 = localW2;
    if (localW2 == null)
    {
      localW1 = new w(paramView);
      localJ.a.put(paramView, localW1);
    }
    return localW1;
  }
    ...
    extends s.b
  {
    ...
    public final Display o(View paramView)
    {
    ...
    extends s.e
  {
    ...
    {
      paramAa = (WindowInsets)aa.a(paramAa);
    ...
    public final void a(View paramView, final o paramO)
    {
      ...
      paramView.setOnApplyWindowInsetsListener(new View.OnApplyWindowInsetsListener()
      {
        ...
        {
          paramAnonymousWindowInsets = aa.a(paramAnonymousWindowInsets);
          return (WindowInsets)aa.a(paramO.a(paramAnonymousView, paramAnonymousWindowInsets));
        }
      });
    }
    ...
    public final String t(View paramView)
    {
    ...
    public final ColorStateList y(View paramView)
    {
      return paramView.getBackgroundTintList();
    }
    
    public final PorterDuff.Mode z(View paramView)
    {
    ...
    extends s.g
  {
    ...
    {
      if (paramQ != null) {}
      for (paramQ = paramQ.a;; paramQ = null)
      {
  ...
  static class j
  {
    ...
    {
      if (paramA == null) {}
      for (paramA = null;; paramA = paramA.b)
      {
    ...
    public Display o(View paramView)
    {
      if (s(paramView)) {
