  ...
  extends b
{
  ...
  public static void b(Activity paramActivity, ai paramAi)
  {
    Object localObject2 = null;
    Object localObject1 = null;
    if (Build.VERSION.SDK_INT >= 23)
    ...
    extends SharedElementCallback
  {
    ...
    public Parcelable onCaptureSharedElementSnapshot(View paramView, Matrix paramMatrix, RectF paramRectF)
    {
      ...
      if ((paramView instanceof ImageView))
      {
        ...
        {
          localObject2 = ai.a((Drawable)localObject1);
      ...
      float f = Math.min(1.0F, ai.b / (j * i));
      int j = (int)(j * f);
      int i = (int)(i * f);
      if (localAi.a == null) {
        localAi.a = new Matrix();
      }
      localAi.a.set(paramMatrix);
      localAi.a.postTranslate(-paramRectF.left, -paramRectF.top);
      localAi.a.postScale(f, f);
      paramMatrix = Bitmap.createBitmap(j, i, Bitmap.Config.ARGB_8888);
      paramRectF = new Canvas(paramMatrix);
      paramRectF.concat(localAi.a);
    ...
    {
      return ai.a(paramContext, paramParcelable);
    }
