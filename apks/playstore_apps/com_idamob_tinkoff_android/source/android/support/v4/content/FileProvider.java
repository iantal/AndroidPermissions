  ...
  extends ContentProvider
{
  ...
  private static a a(Context paramContext, String paramString)
  {
    ...
    //   279: ifeq +20 -> 299
    //   282: aload_0
    //   283: invokestatic 160	android/support/v4/content/b:a	(Landroid/content/Context;)[Ljava/io/File;
    //   286: astore_3
    //   287: aload_3
    //   288: arraylength
    //   289: ifle +80 -> 369
    ...
    //   305: ifeq +64 -> 369
    //   308: aload_0
    //   309: invokestatic 164	android/support/v4/content/b:b	(Landroid/content/Context;)[Ljava/io/File;
    //   312: astore_3
    //   313: aload_3
    //   314: arraylength
    //   315: ifle +54 -> 369
    ...
    //   322: goto -147 -> 175
    //   325: astore_0
    //   326: new 83	java/lang/IllegalArgumentException
    //   329: dup
    //   330: new 166	java/lang/StringBuilder
    //   333: dup
    //   334: ldc -88
    //   336: invokespecial 169	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   339: aload_3
    //   340: invokevirtual 173	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   343: invokevirtual 176	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   346: aload_0
    //   347: invokespecial 91	java/lang/IllegalArgumentException:<init>	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   350: athrow
    //   351: getstatic 43	android/support/v4/content/FileProvider:c	Ljava/util/HashMap;
    //   354: aload_1
    //   355: aload 4
    //   357: invokevirtual 101	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   360: pop
    //   361: aload 4
    //   363: astore_3
    //   364: aload 5
    ...
    //   119	9	2	i	int
    //   22	349	3	localObject1	Object
    //   18	344	4	localObject2	Object
    //   3	362	5	localHashMap	HashMap
    ...
    //   326	351	75	java/io/IOException
    //   8	20	87	finally
    //   28	60	87	finally
    //   65	75	87	finally
    //   76	87	87	finally
    ...
    //   326	351	211	org/xmlpull/v1/XmlPullParserException
    //   93	99	325	java/io/IOException
  }
