  ...
  implements i, l
{
  ...
  private Animation b(final int paramInt1, final int paramInt2)
  {
  ...
  private void b(float paramFloat)
  {
    ...
    for (;;)
    {
      ...
      d localD = this.j;
      localD.a.g = ((-0.25F + f3 * 0.4F + f4 * 2.0F) * 0.5F);
  ...
  {
    if (((Build.VERSION.SDK_INT >= 21) || (!(this.n instanceof AbsListView))) && ((this.n == null) || (s.z(this.n)))) {
  ...
  public void setColorSchemeResources(int... paramVarArgs)
  {
    ...
    {
      arrayOfInt[i1] = b.c(localContext, paramVarArgs[i1]);
      i1 += 1;
    }
  ...
  {
    setProgressBackgroundColorSchemeColor(b.c(getContext(), paramInt));
  }
