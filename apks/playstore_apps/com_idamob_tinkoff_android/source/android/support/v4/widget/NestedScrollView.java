  ...
  implements j, l
{
      ...
      else
      {
        ...
        if (this.j)
        {
          ...
          if (i2 != 0)
          {
            ...
            if (i2 < 0)
            {
              h.a(this.d, i1 / getHeight(), paramMotionEvent.getX(i3) / getWidth());
              if (!this.e.isFinished()) {
                this.e.onRelease();
              }
            }
            while ((this.d != null) && ((!this.d.isFinished()) || (!this.e.isFinished())))
            {
              ...
              if (i2 > i4)
              {
                h.a(this.e, i1 / getHeight(), 1.0F - paramMotionEvent.getX(i3) / getWidth());
                if (!this.d.isFinished()) {
                  this.d.onRelease();
                }
              }
    ...
    extends android.support.v4.view.a
  {
    ...
    public final void a(View paramView, android.support.v4.view.a.a paramA)
    {
      ...
      paramA.a(ScrollView.class.getName());
