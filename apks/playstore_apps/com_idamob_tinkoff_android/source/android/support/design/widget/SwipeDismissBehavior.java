  ...
  extends CoordinatorLayout.a<V>
{
  ...
  private final p.a j = new p.a()
  {
    ...
    public final void a(View paramAnonymousView, int paramAnonymousInt1, int paramAnonymousInt2)
    {
      ...
      paramAnonymousView.setAlpha(SwipeDismissBehavior.a(1.0F - SwipeDismissBehavior.a(f1, f2, paramAnonymousInt1)));
    }
  ...
  public boolean onInterceptTouchEvent(CoordinatorLayout paramCoordinatorLayout, V paramV, MotionEvent paramMotionEvent)
  {
    ...
    label142:
    for (paramCoordinatorLayout = p.a(paramCoordinatorLayout, this.h, this.j);; paramCoordinatorLayout = p.a(paramCoordinatorLayout, this.j))
    {
    ...
    implements Runnable
  {
    ...
    {
      if ((SwipeDismissBehavior.this.b != null) && (SwipeDismissBehavior.this.b.a())) {
        s.a(this.b, this);
      }
