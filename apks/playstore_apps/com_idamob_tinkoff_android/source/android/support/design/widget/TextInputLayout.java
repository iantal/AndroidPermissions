  ...
  implements by
{
  ...
  public TextInputLayout(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    this.d.a(a.b);
    g localG = this.d;
    localG.j = new AccelerateInterpolator();
    localG.b();
    this.d.b(8388659);
    paramContext = bp.a(paramContext, paramAttributeSet, a.k.TextInputLayout, paramInt, a.j.Widget_Design_TextInputLayout);
    this.g = paramContext.a(a.k.TextInputLayout_hintEnabled, true);
    setHint(paramContext.c(a.k.TextInputLayout_android_hint));
    this.K = paramContext.a(a.k.TextInputLayout_hintAnimationEnabled, true);
    if (paramContext.f(a.k.TextInputLayout_android_textColorHint))
    {
    ...
    this.o = paramContext.g(a.k.TextInputLayout_errorTextAppearance, 0);
    ...
    this.t = paramContext.g(a.k.TextInputLayout_counterTextAppearance, 0);
    this.u = paramContext.g(a.k.TextInputLayout_counterOverflowTextAppearance, 0);
    this.w = paramContext.a(a.k.TextInputLayout_passwordToggleEnabled, false);
    this.x = paramContext.a(a.k.TextInputLayout_passwordToggleDrawable);
    this.y = paramContext.c(a.k.TextInputLayout_passwordToggleContentDescription);
    if (paramContext.f(a.k.TextInputLayout_passwordToggleTint))
    {
      this.E = true;
      this.D = paramContext.e(a.k.TextInputLayout_passwordToggleTint);
    }
    if (paramContext.f(a.k.TextInputLayout_passwordToggleTintMode))
    {
      this.G = true;
      this.F = v.a(paramContext.a(a.k.TextInputLayout_passwordToggleTintMode, -1));
    }
  ...
  private void b()
  {
    android.support.v4.view.s.a(this.k, android.support.v4.view.s.i(this.a), 0, android.support.v4.view.s.j(this.a), this.a.getPaddingBottom());
  }
  ...
  private void c()
  {
    ...
    if ((i1 == 21) || (i1 == 22))
    {
      ...
      if ((localDrawable2 != null) && (!this.M))
      {
        ...
        if ((localDrawable2 instanceof DrawableContainer)) {
          this.M = i.a((DrawableContainer)localDrawable2, localDrawable3.getConstantState());
        }
        if (!this.M)
        {
          android.support.v4.view.s.a(this.a, localDrawable3);
          this.M = true;
        }
      }
    }
    if (ak.c(localDrawable1)) {
    ...
    for (;;)
    {
      ...
      {
        localDrawable1.setColorFilter(l.a(this.r.getCurrentTextColor(), PorterDuff.Mode.SRC_IN));
        return;
      }
      android.support.v4.a.a.a.d(localDrawable1);
  ...
  private void d()
  {
    ...
    do
    {
      do
      {
        ...
        for (int i1 = 1; i1 != 0; i1 = 0)
        {
          ...
          if ((this.a != null) && (android.support.v4.view.s.n(this.a) <= 0)) {
            this.a.setMinimumHeight(android.support.v4.view.s.n(this.z));
          }
          ...
          arrayOfDrawable = m.b(this.a);
          if (arrayOfDrawable[2] != this.B) {
            this.C = arrayOfDrawable[2];
          }
          m.a(this.a, arrayOfDrawable[0], arrayOfDrawable[1], this.B, arrayOfDrawable[3]);
    ...
    m.a(this.a, arrayOfDrawable[0], arrayOfDrawable[1], this.C, arrayOfDrawable[3]);
    this.B = null;
  }
  ...
  private void f()
  {
    ...
    {
      this.x = android.support.v4.a.a.a.e(this.x).mutate();
      if (this.E) {
  ...
  final void a(int paramInt)
  {
    ...
    {
      m.a(localTextView, i1);
      this.r.setText(getContext().getString(android.support.design.a.i.character_counter_pattern, new Object[] { Integer.valueOf(paramInt), Integer.valueOf(this.s) }));
      break;
      bool1 = false;
      break label67;
    }
  ...
  protected void drawableStateChanged()
  {
    ...
    int[] arrayOfInt = getDrawableState();
    if ((android.support.v4.view.s.B(this)) && (isEnabled()))
    {
      a(bool2, false);
      c();
      if (this.d == null) {
  ...
  public void setCounterEnabled(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      {
        m.a(this.r, android.support.v7.a.a.i.TextAppearance_AppCompat_Caption);
        this.r.setTextColor(android.support.v4.content.b.c(getContext(), a.c.error_color_material));
        continue;
        a(this.a.getText().length());
        continue;
      }
  ...
  public void setError(final CharSequence paramCharSequence)
  {
    boolean bool2 = true;
    boolean bool1;
    if ((android.support.v4.view.s.B(this)) && (isEnabled()) && ((this.b == null) || (!TextUtils.equals(this.b.getText(), paramCharSequence))))
    {
      bool1 = true;
  ...
  public void setErrorEnabled(boolean paramBoolean)
  {
    ...
    if (i1 != 0)
    {
      m.a(this.b, android.support.v7.a.a.i.TextAppearance_AppCompat_Caption);
      this.b.setTextColor(android.support.v4.content.b.c(getContext(), a.c.error_color_material));
    }
    this.b.setVisibility(4);
    android.support.v4.view.s.h(this.b);
    a(this.b, 0);
    for (;;)
    {
      this.n = paramBoolean;
