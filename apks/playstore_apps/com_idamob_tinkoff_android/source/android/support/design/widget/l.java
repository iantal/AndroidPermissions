  ...
  extends t<V>
{
  ...
  final boolean fling(CoordinatorLayout paramCoordinatorLayout, V paramV, int paramInt1, int paramInt2, float paramFloat)
  {
    ...
    {
      this.mFlingRunnable = new a(paramCoordinatorLayout, paramV);
      s.a(paramV, this.mFlingRunnable);
      return true;
    }
    ...
    implements Runnable
  {
    ...
    {
      if ((this.c != null) && (l.this.mScroller != null))
      {
        if (l.this.mScroller.computeScrollOffset())
        {
          l.this.setHeaderTopBottomOffset(this.b, this.c, l.this.mScroller.getCurrY());
          s.a(this.c, this);
        }
      }
      else {
      ...
      l.this.onFlingFinished(this.b, this.c);
    }
  }
}
