  ...
  extends a
{
  ...
  {
    super(paramDrawable);
    this.o = b.c(paramContext, a.c.design_fab_shadow_start_color);
    this.p = b.c(paramContext, a.c.design_fab_shadow_mid_color);
    this.q = b.c(paramContext, a.c.design_fab_shadow_end_color);
    this.b = new Paint(5);
