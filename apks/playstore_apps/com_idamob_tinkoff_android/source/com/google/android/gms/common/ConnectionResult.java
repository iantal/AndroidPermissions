  ...
  extends zza
{
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    } while ((this.b == paramObject.b) && (aa.a(this.c, paramObject.c)) && (aa.a(this.d, paramObject.d)));
    return false;
  }
  ...
  {
    return aa.a(this).a("statusCode", a(this.b)).a("resolution", this.c).a("message", this.d).toString();
  }
  
  public final void writeToParcel(Parcel paramParcel, int paramInt)
  {
    int i = b.a(paramParcel, 20293);
    b.b(paramParcel, 1, this.e);
