...
public final class av
{
  ...
  private static String a(Context paramContext)
  {
    ...
    try
    {
      Object localObject = fx.a(paramContext);
      localObject = ((fw)localObject).a.getPackageManager().getApplicationLabel(((fw)localObject).a.getPackageManager().getApplicationInfo(str1, 0)).toString();
    ...
    catch (NullPointerException localNullPointerException)
    {
      ...
      do
      {
        str2 = paramContext.getApplicationInfo().name;
        paramContext = str1;
