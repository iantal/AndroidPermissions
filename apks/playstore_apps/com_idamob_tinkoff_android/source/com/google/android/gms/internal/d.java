...
public final class d
{
  ...
  private d(ByteBuffer paramByteBuffer)
  {
  ...
  public static int b(int paramInt1, int paramInt2)
  {
    int i = b(paramInt1 << 3);
    if (paramInt2 >= 0) {}
    for (paramInt1 = b(paramInt2);; paramInt1 = 10) {
      return paramInt1 + i;
    }
  }
  
  public static int b(int paramInt, j paramJ)
  {
    paramInt = b(paramInt << 3);
    int i = paramJ.d();
    return paramInt + (i + b(i));
  }
  
  public static int b(int paramInt, String paramString)
  {
    return b(paramInt << 3) + a(paramString);
  }
  ...
  {
    return b(paramInt << 3) + a(paramLong);
  }
    ...
    throws IOException
  {
    ...
    if (!this.a.hasRemaining()) {
      throw new aeh(this.a.position(), this.a.limit());
    }
    this.a.put(b);
  }
    ...
    throws IOException
  {
    ...
    try
    {
      paramInt = b(paramString.length());
      if (paramInt != b(paramString.length() * 3)) {
        break label156;
      }
      i = this.a.position();
      if (this.a.remaining() < paramInt) {
        throw new aeh(paramInt + i, this.a.limit());
      }
    }
    catch (BufferOverflowException paramString)
    {
      aeh localAeh = new aeh(this.a.position(), this.a.limit());
      localAeh.initCause(paramString);
      throw localAeh;
    }
