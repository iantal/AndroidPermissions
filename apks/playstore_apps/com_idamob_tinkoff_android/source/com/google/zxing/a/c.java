  ...
  implements q
{
  ...
  public final b a(String paramString, com.google.zxing.a paramA, int paramInt1, int paramInt2, Map<f, ?> paramMap)
  {
    ...
    for (int j = 0;; j = paramMap.intValue())
    {
      ...
      break;
      localNumber = (Number)paramMap.get(f.a);
      break label16;
      paramMap = (Number)paramMap.get(f.j);
      break label24;
    ...
    label166:
    return a(com.google.zxing.a.c.c.a(paramString.getBytes((Charset)localObject), i, j), paramInt1, paramInt2);
  }
}
