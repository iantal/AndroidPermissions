...
public final class d
{
  ...
  static Collection<f> a(Iterable<f> paramIterable, int paramInt1, int paramInt2)
  {
    ...
    while (paramIterable.hasNext())
    {
      ...
      f localF2 = localF1.b(paramInt1);
      localLinkedList.add(localF2.a(4, paramInt2));
      if (localF1.b != 4) {
        localLinkedList.add(localF2.b(4, paramInt2));
      }
      if ((paramInt2 == 3) || (paramInt2 == 4)) {
        localLinkedList.add(localF2.a(2, 16 - paramInt2).a(2, 1));
      }
      if (localF1.c > 0) {
        localLinkedList.add(localF1.a(paramInt1).a(paramInt1 + 1));
      }
    }
