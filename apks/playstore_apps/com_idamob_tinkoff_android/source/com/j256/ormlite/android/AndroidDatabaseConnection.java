  ...
  implements DatabaseConnection
{
    ...
    throws java.sql.SQLException
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 54	com/j256/ormlite/android/AndroidDatabaseConnection:db	Landroid/database/sqlite/SQLiteDatabase;
    //   4: aload_1
    //   5: invokevirtual 157	android/database/sqlite/SQLiteDatabase:compileStatement	(Ljava/lang/String;)Landroid/database/sqlite/SQLiteStatement;
    //   8: astore 9
    //   10: aload 9
    //   12: astore 10
    //   14: aload_0
    ...
    //   17: aload_2
    //   18: aload_3
    //   19: invokespecial 159	com/j256/ormlite/android/AndroidDatabaseConnection:bindArgs	(Landroid/database/sqlite/SQLiteStatement;[Ljava/lang/Object;[Lcom/j256/ormlite/field/FieldType;)V
    //   22: aload 9
    //   24: astore 10
    //   26: aload 9
    //   28: invokevirtual 162	android/database/sqlite/SQLiteStatement:execute	()V
    //   31: aload 9
    //   33: ifnull +163 -> 196
    //   36: aload 9
    //   38: invokevirtual 165	android/database/sqlite/SQLiteStatement:close	()V
    //   41: aconst_null
    //   42: astore_2
    //   43: aload_0
    //   44: getfield 54	com/j256/ormlite/android/AndroidDatabaseConnection:db	Landroid/database/sqlite/SQLiteDatabase;
    //   47: ldc -89
    //   49: invokevirtual 157	android/database/sqlite/SQLiteDatabase:compileStatement	(Ljava/lang/String;)Landroid/database/sqlite/SQLiteStatement;
    //   52: astore_3
    //   53: aload_3
    //   54: astore_2
    //   55: aload_2
    //   56: invokevirtual 170	android/database/sqlite/SQLiteStatement:simpleQueryForLong	()J
    //   59: lstore 7
    //   61: lload 7
    //   63: l2i
    //   64: istore 6
    ...
    //   71: ifnull +11 -> 82
    //   74: aload_2
    //   75: invokevirtual 165	android/database/sqlite/SQLiteStatement:close	()V
    //   78: iload 6
    //   80: istore 5
    //   82: getstatic 34	com/j256/ormlite/android/AndroidDatabaseConnection:logger	Lcom/j256/ormlite/logger/Logger;
    //   85: ldc -84
    //   87: aload 4
    //   89: iload 5
    ...
    //   133: ifnull +8 -> 141
    //   136: aload 10
    //   138: invokevirtual 165	android/database/sqlite/SQLiteStatement:close	()V
    //   141: aload_1
    //   142: athrow
    //   143: astore_3
    //   144: iconst_1
    ...
    //   152: ifnull -70 -> 82
    //   155: aload_2
    //   156: invokevirtual 165	android/database/sqlite/SQLiteStatement:close	()V
    //   159: iload 6
    //   161: istore 5
    //   163: goto -81 -> 82
    //   166: astore_1
    ...
    //   168: ifnull +7 -> 175
    //   171: aload_2
    //   172: invokevirtual 165	android/database/sqlite/SQLiteStatement:close	()V
    //   175: aload_1
    //   176: athrow
    //   177: astore_1
    //   178: goto -11 -> 167
  ...
  public boolean isTableExists(String paramString)
  {
    ...
    //   27: aconst_null
    //   28: invokevirtual 291	android/database/sqlite/SQLiteDatabase:rawQuery	(Ljava/lang/String;[Ljava/lang/String;)Landroid/database/Cursor;
    //   31: astore_3
    //   32: aload_3
    ...
    //   41: iconst_1
    //   42: istore_2
    //   43: getstatic 34	com/j256/ormlite/android/AndroidDatabaseConnection:logger	Lcom/j256/ormlite/logger/Logger;
    //   46: ldc_w 298
    //   49: aload_0
    //   50: aload_1
    //   51: iload_2
    ...
    //   31	42	3	localCursor	android.database.Cursor
    // Exception table:
    //   from	to	target	type
    //   32	41	71	finally
    //   43	58	71	finally
    ...
    throws java.sql.SQLException
  {
    ...
    //   4: astore_3
    //   5: aload_0
    //   6: getfield 54	com/j256/ormlite/android/AndroidDatabaseConnection:db	Landroid/database/sqlite/SQLiteDatabase;
    //   9: aload_1
    //   10: aload_0
    //   11: aload_2
    //   12: invokespecial 308	com/j256/ormlite/android/AndroidDatabaseConnection:toStrings	([Ljava/lang/Object;)[Ljava/lang/String;
    //   15: invokevirtual 291	android/database/sqlite/SQLiteDatabase:rawQuery	(Ljava/lang/String;[Ljava/lang/String;)Landroid/database/Cursor;
    //   18: astore_2
    //   19: aload_2
    //   20: astore_3
    //   21: aload_2
    //   22: astore 6
    //   24: new 310	com/j256/ormlite/android/AndroidDatabaseResults
    //   27: dup
    //   28: aload_2
    //   29: aconst_null
    //   30: invokespecial 313	com/j256/ormlite/android/AndroidDatabaseResults:<init>	(Landroid/database/Cursor;Lcom/j256/ormlite/dao/ObjectCache;)V
    //   33: astore 7
    //   35: aload_2
    //   36: astore_3
    //   37: aload_2
    //   38: astore 6
    //   40: aload 7
    //   42: invokevirtual 316	com/j256/ormlite/android/AndroidDatabaseResults:first	()Z
    //   45: ifeq +50 -> 95
    //   48: aload_2
    //   49: astore_3
    //   50: aload_2
    ...
    //   53: aload 7
    //   55: iconst_0
    //   56: invokevirtual 320	com/j256/ormlite/android/AndroidDatabaseResults:getLong	(I)J
    //   59: lstore 4
    //   61: aload_2
    //   62: astore_3
    //   63: aload_2
    //   64: astore 6
    //   66: getstatic 34	com/j256/ormlite/android/AndroidDatabaseConnection:logger	Lcom/j256/ormlite/logger/Logger;
    //   69: ldc_w 322
    //   72: aload_0
    //   73: lload 4
    ...
    throws java.sql.SQLException
  {
    ...
    //   1: astore 7
    //   3: aload_0
    //   4: getfield 54	com/j256/ormlite/android/AndroidDatabaseConnection:db	Landroid/database/sqlite/SQLiteDatabase;
    //   7: aload_1
    //   8: aload_0
    //   9: aload_2
    //   10: invokespecial 308	com/j256/ormlite/android/AndroidDatabaseConnection:toStrings	([Ljava/lang/Object;)[Ljava/lang/String;
    //   13: invokevirtual 291	android/database/sqlite/SQLiteDatabase:rawQuery	(Ljava/lang/String;[Ljava/lang/String;)Landroid/database/Cursor;
    //   16: astore_2
    //   17: aload_2
    //   18: astore_3
    //   19: new 310	com/j256/ormlite/android/AndroidDatabaseResults
    //   22: dup
    //   23: aload_2
    //   24: aload 5
    //   26: invokespecial 313	com/j256/ormlite/android/AndroidDatabaseResults:<init>	(Landroid/database/Cursor;Lcom/j256/ormlite/dao/ObjectCache;)V
    //   29: astore 5
    //   31: aload_2
    //   32: astore_3
    //   33: getstatic 34	com/j256/ormlite/android/AndroidDatabaseConnection:logger	Lcom/j256/ormlite/logger/Logger;
    //   36: ldc_w 326
    //   39: aload_0
    //   40: aload_1
    ...
    //   45: astore_3
    //   46: aload 5
    //   48: invokevirtual 316	com/j256/ormlite/android/AndroidDatabaseResults:first	()Z
    //   51: istore 6
    //   53: iload 6
    //   55: ifne +21 -> 76
    //   58: aload 7
    ...
    //   90: astore_3
    //   91: aload 5
    //   93: invokevirtual 335	com/j256/ormlite/android/AndroidDatabaseResults:next	()Z
    //   96: ifeq +26 -> 122
    //   99: aload_2
    //   100: astore_3
    //   101: getstatic 339	com/j256/ormlite/android/AndroidDatabaseConnection:MORE_THAN_ONE	Ljava/lang/Object;
    //   104: astore 4
    //   106: aload 4
    //   108: astore_1
    //   109: aload_2
