  ...
  extends BaseDataType
{
    ...
    throws SQLException
  {
    ...
    //   6: aload 5
    //   8: astore_1
    //   9: new 60	java/io/ByteArrayOutputStream
    //   12: dup
    //   13: invokespecial 61	java/io/ByteArrayOutputStream:<init>	()V
    //   16: astore 6
    //   18: aload 5
    //   20: astore_1
    //   21: new 63	java/io/ObjectOutputStream
    //   24: dup
    //   25: aload 6
    //   27: invokespecial 66	java/io/ObjectOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   30: astore_3
    //   31: aload_3
    //   32: aload_2
    //   33: invokevirtual 70	java/io/ObjectOutputStream:writeObject	(Ljava/lang/Object;)V
    //   36: aload_3
    //   37: invokevirtual 73	java/io/ObjectOutputStream:close	()V
    //   40: aload 5
    //   42: astore_1
    //   43: aload 6
    //   45: invokevirtual 77	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   48: astore_3
    //   49: aload_3
    //   50: areturn
    //   51: astore_3
    ...
    //   58: dup
    //   59: ldc 81
    //   61: invokespecial 84	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   64: aload_2
    //   65: invokevirtual 88	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   68: invokevirtual 92	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   71: aload_3
    //   72: invokestatic 98	com/j256/ormlite/misc/SqlExceptionUtil:create	(Ljava/lang/String;Ljava/lang/Throwable;)Ljava/sql/SQLException;
    //   75: athrow
    //   76: astore_3
    //   77: aload_1
    //   78: astore_2
    ...
    //   82: ifnull +7 -> 89
    //   85: aload_2
    //   86: invokevirtual 73	java/io/ObjectOutputStream:close	()V
    //   89: aload_1
    //   90: athrow
    //   91: astore_2
    //   92: goto -3 -> 89
    ...
    throws SQLException
  {
    ...
    //   12: dup
    //   13: new 124	java/io/ByteArrayInputStream
    //   16: dup
    //   17: aload 5
    //   19: invokespecial 127	java/io/ByteArrayInputStream:<init>	([B)V
    //   22: invokespecial 130	java/io/ObjectInputStream:<init>	(Ljava/io/InputStream;)V
    //   25: astore_2
    //   26: aload_2
    //   27: astore_1
    //   28: aload_2
    //   29: invokevirtual 134	java/io/ObjectInputStream:readObject	()Ljava/lang/Object;
    //   32: astore 4
    //   34: aload_2
    //   35: invokevirtual 135	java/io/ObjectInputStream:close	()V
    //   38: aload 4
    //   40: areturn
    //   41: astore 4
    //   43: aconst_null
    ...
    //   48: dup
    //   49: ldc -119
    //   51: invokespecial 84	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   54: aload 5
    //   56: invokestatic 142	java/util/Arrays:toString	([B)Ljava/lang/String;
    //   59: invokevirtual 145	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   62: ldc -109
    //   64: invokevirtual 145	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   67: aload 5
    //   69: arraylength
    //   70: invokevirtual 150	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   73: ldc -104
    ...
    //   81: aload 4
    //   83: invokestatic 98	com/j256/ormlite/misc/SqlExceptionUtil:create	(Ljava/lang/String;Ljava/lang/Throwable;)Ljava/sql/SQLException;
    //   86: athrow
    //   87: astore 4
    //   89: aload_1
    //   90: astore_2
    ...
    //   95: ifnull +7 -> 102
    //   98: aload_2
    //   99: invokevirtual 135	java/io/ObjectInputStream:close	()V
    //   102: aload_1
    //   103: athrow
    //   104: astore_1
    //   105: aload 4
