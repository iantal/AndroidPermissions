  ...
  implements DatabaseType
{
  ...
  public void addPrimaryKeySql(FieldType[] paramArrayOfFieldType, List<String> paramList1, List<String> paramList2, List<String> paramList3, List<String> paramList4)
  {
    ...
    if (i < j)
    {
      ...
      if ((paramList4.isGeneratedId()) && (!generatedIdSqlAtEnd()))
      {
        paramList3 = paramList2;
        if (!paramList4.isSelfGeneratedId()) {}
      }
      else
      {
        paramList3 = paramList2;
  ...
  public void appendBooleanType(StringBuilder paramStringBuilder, FieldType paramFieldType, int paramInt)
  {
  ...
  public void appendDateType(StringBuilder paramStringBuilder, FieldType paramFieldType, int paramInt)
  {
