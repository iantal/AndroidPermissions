...
class ContactlessSelectedState
  implements ContactlessReadySubState
{
  private ContactlessContext mContext;
  
  public ContactlessSelectedState(ContactlessContext paramContactlessContext)
  {
  ...
  {
    return GetProcessingOptions.response(paramGetProcessingOptionsCommandApdu, this.mContext);
  }
