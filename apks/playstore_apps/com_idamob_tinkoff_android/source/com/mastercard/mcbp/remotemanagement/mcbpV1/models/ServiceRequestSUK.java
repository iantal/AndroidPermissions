...
public class ServiceRequestSUK
  implements Serializable
{
  ...
  public ServiceRequestSUK() {}
  
  public static ServiceRequestSUK valueOf(byte[] paramArrayOfByte)
  {
    paramArrayOfByte = new InputStreamReader(new ByteArrayInputStream(paramArrayOfByte));
    return (ServiceRequestSUK)new j().a(ByteArray.class, new ByteArrayObjectFactory()).a(Byte.TYPE, new ByteObjectFactory()).a(paramArrayOfByte, ServiceRequestSUK.class);
  }
  ...
  public void setServiceData(HashMap paramHashMap)
  {
    this.serviceData = paramHashMap;
  }
