...
final class e
{
  ...
  public e(p paramP)
  {
    ...
    paramP = i.a(paramP.a());
    localObject = i.a(new byte[] { i, j, k, m, n, i1, i2, i3, i4, i5 });
    b = String.format(Locale.US, "%s-%s-%s-%s", new Object[] { ((String)localObject).substring(0, 12), ((String)localObject).substring(12, 16), ((String)localObject).subSequence(16, 20), paramP.substring(0, 12) }).toUpperCase(Locale.US);
  }
