...
@DatabaseTable
public class TelecomBankAccount
  implements Serializable, c
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    do
    {
      ...
      paramObject = (TelecomBankAccount)paramObject;
    } while ((j.a(this.id, paramObject.id)) && (j.a(this.account, paramObject.account)) && (j.a(this.authorizationsAmount, paramObject.authorizationsAmount)) && (j.a(this.c2cOutLimitBorder, paramObject.c2cOutLimitBorder)) && (j.a(this.c2cOutLimit, paramObject.c2cOutLimit)) && (j.a(this.creditLimit, paramObject.creditLimit)) && (j.a(this.defaultMonthlyCashLimit, paramObject.defaultMonthlyCashLimit)) && (j.a(this.defaultMonthlyTinkoffCashInsertionLimit, paramObject.defaultMonthlyTinkoffCashInsertionLimit)) && (j.a(this.defaultMonthlyTinkoffCashLimit, paramObject.defaultMonthlyTinkoffCashLimit)) && (j.a(this.defaultRenewalAmountLeft, paramObject.defaultRenewalAmountLeft)) && (j.a(this.monthlyCashLimit, paramObject.monthlyCashLimit)) && (j.a(this.monthlyTinkoffCashInsertionLimit, paramObject.monthlyTinkoffCashInsertionLimit)) && (j.a(this.monthlyTinkoffCashLimit, paramObject.monthlyTinkoffCashLimit)) && (this.overdraftStatus == paramObject.overdraftStatus) && (j.a(this.rate, paramObject.rate)) && (j.a(this.rateHint, paramObject.rateHint)) && (j.a(this.renewalAmountLeft, paramObject.renewalAmountLeft)));
    return false;
  }
  
  public int hashCode()
  {
    return Arrays.hashCode(new Object[] { this.id, this.account, this.authorizationsAmount, this.c2cOutLimitBorder, this.c2cOutLimit, this.creditLimit, this.defaultMonthlyCashLimit, this.defaultMonthlyTinkoffCashInsertionLimit, this.defaultMonthlyTinkoffCashLimit, this.defaultRenewalAmountLeft, this.monthlyCashLimit, this.monthlyTinkoffCashInsertionLimit, this.monthlyTinkoffCashLimit, this.overdraftStatus, this.rate, this.rateHint, this.renewalAmountLeft });
  }
}
