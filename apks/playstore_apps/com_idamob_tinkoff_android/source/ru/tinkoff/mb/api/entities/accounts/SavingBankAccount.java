  ...
  implements Serializable, c
{
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    do
    {
      ...
      paramObject = (SavingBankAccount)paramObject;
    } while ((j.a(this.id, paramObject.id)) && (j.a(this.account, paramObject.account)) && (j.a(this.interest, paramObject.interest)));
    return false;
  }
  
  public final int hashCode()
  {
    return Arrays.hashCode(new Object[] { this.id, this.account, this.interest });
  }
}
