  ...
  implements Serializable, c
{
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    do
    {
      ...
      paramObject = (ExternalBankAccount)paramObject;
    } while ((j.a(this.id, paramObject.id)) && (j.a(this.account, paramObject.account)));
    return false;
  }
  
  public final int hashCode()
  {
    return Arrays.hashCode(new Object[] { this.id, this.account });
  }
}
