...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-static {v1}, Landroid/support/design/widget/v;->a(I)Landroid/graphics/PorterDuff$Mode;
    ...
    iput-object v0, p0, Landroid/support/design/widget/FloatingActionButton;->k:Landroid/support/v7/widget/o;
    ...
    .line 1183
    iget v1, v0, Landroid/support/design/widget/j;->j:F
    ...
    .line 1184
    iput v2, v0, Landroid/support/design/widget/j;->j:F

    .line 1185
    iget v1, v0, Landroid/support/design/widget/j;->i:F

    invoke-virtual {v0, v1, v2}, Landroid/support/design/widget/j;->a(FF)V
...
.method private a(Landroid/support/design/widget/FloatingActionButton$a;)Landroid/support/design/widget/j$c;
    .locals 1
...
.method private getImpl()Landroid/support/design/widget/j;
    ...
    invoke-direct {v0, p0, v1}, Landroid/support/design/widget/k;-><init>(Landroid/support/design/widget/x;Landroid/support/design/widget/o;)V
    ...
    invoke-direct {v0, p0, v1}, Landroid/support/design/widget/j;-><init>(Landroid/support/design/widget/x;Landroid/support/design/widget/o;)V
...
# virtual methods
.method public final a(Landroid/support/design/widget/FloatingActionButton$a;Z)V
    .locals 8
    ...
    invoke-direct {p0, p1}, Landroid/support/design/widget/FloatingActionButton;->a(Landroid/support/design/widget/FloatingActionButton$a;)Landroid/support/design/widget/j$c;

    move-result-object v3

    .line 2394
    iget-object v4, v2, Landroid/support/design/widget/j;->o:Landroid/support/design/widget/x;
    ...
    .line 2396
    iget v4, v2, Landroid/support/design/widget/j;->b:I
    ...
    .line 2263
    iget-object v0, v2, Landroid/support/design/widget/j;->o:Landroid/support/design/widget/x;
    ...
    .line 2265
    invoke-virtual {v2}, Landroid/support/design/widget/j;->i()Z
    ...
    .line 2266
    iput v7, v2, Landroid/support/design/widget/j;->b:I
    ...
    invoke-virtual {v0, v6}, Landroid/support/design/widget/x;->setAlpha(F)V

    .line 2271
    iget-object v0, v2, Landroid/support/design/widget/j;->o:Landroid/support/design/widget/x;

    invoke-virtual {v0, v6}, Landroid/support/design/widget/x;->setScaleY(F)V

    .line 2272
    iget-object v0, v2, Landroid/support/design/widget/j;->o:Landroid/support/design/widget/x;

    invoke-virtual {v0, v6}, Landroid/support/design/widget/x;->setScaleX(F)V
    ...
    invoke-direct {v1, v2, p2, v3}, Landroid/support/design/widget/j$2;-><init>(Landroid/support/design/widget/j;ZLandroid/support/design/widget/j$c;)V
    ...
    invoke-virtual {v0, v5}, Landroid/support/design/widget/x;->setAlpha(F)V

    .line 2298
    iget-object v0, v2, Landroid/support/design/widget/j;->o:Landroid/support/design/widget/x;

    invoke-virtual {v0, v5}, Landroid/support/design/widget/x;->setScaleY(F)V

    .line 2299
    iget-object v0, v2, Landroid/support/design/widget/j;->o:Landroid/support/design/widget/x;

    invoke-virtual {v0, v5}, Landroid/support/design/widget/x;->setScaleX(F)V

    goto :goto_1
.end method

.method public final b(Landroid/support/design/widget/FloatingActionButton$a;Z)V
    .locals 7
    ...
    .line 3213
    iput v1, v2, Landroid/support/design/widget/j;->b:I
    ...
    invoke-direct {v1, v2, p2, v3}, Landroid/support/design/widget/j$1;-><init>(Landroid/support/design/widget/j;ZLandroid/support/design/widget/j$c;)V
    ...
    .line 3250
    :cond_3
    iget-object v1, v2, Landroid/support/design/widget/j;->o:Landroid/support/design/widget/x;
    ...
    :goto_2
    invoke-virtual {v1, v0, p2}, Landroid/support/design/widget/x;->a(IZ)V
...
.method public getContentBackground()Landroid/graphics/drawable/Drawable;
    ...
    .line 6307
    iget-object v0, v0, Landroid/support/design/widget/j;->h:Landroid/graphics/drawable/Drawable;
...
.method protected onAttachedToWindow()V
    ...
    .line 4371
    iget-object v1, v0, Landroid/support/design/widget/j;->q:Landroid/view/ViewTreeObserver$OnPreDrawListener;

    if-nez v1, :cond_0

    .line 4372
    new-instance v1, Landroid/support/design/widget/j$3;

    invoke-direct {v1, v0}, Landroid/support/design/widget/j$3;-><init>(Landroid/support/design/widget/j;)V

    iput-object v1, v0, Landroid/support/design/widget/j;->q:Landroid/view/ViewTreeObserver$OnPreDrawListener;

    .line 4330
    :cond_0
    iget-object v1, v0, Landroid/support/design/widget/j;->o:Landroid/support/design/widget/x;

    invoke-virtual {v1}, Landroid/support/design/widget/x;->getViewTreeObserver()Landroid/view/ViewTreeObserver;

    move-result-object v1

    iget-object v0, v0, Landroid/support/design/widget/j;->q:Landroid/view/ViewTreeObserver$OnPreDrawListener;
...
.method protected onDetachedFromWindow()V
    ...
    iget-object v2, v0, Landroid/support/design/widget/j;->q:Landroid/view/ViewTreeObserver$OnPreDrawListener;
...
.method protected onMeasure(II)V
    ...
    invoke-virtual {v1}, Landroid/support/design/widget/j;->d()V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 6486
    invoke-static {p0}, Landroid/support/v4/view/s;->B(Landroid/view/View;)Z
...
.method public setBackgroundTintList(Landroid/content/res/ColorStateList;)V
    ...
    .line 2150
    iget-object v1, v0, Landroid/support/design/widget/j;->e:Landroid/graphics/drawable/Drawable;
    ...
    .line 2153
    :cond_0
    iget-object v1, v0, Landroid/support/design/widget/j;->g:Landroid/support/design/widget/e;

    if-eqz v1, :cond_1

    .line 2154
    iget-object v0, v0, Landroid/support/design/widget/j;->g:Landroid/support/design/widget/e;
...
.method public setBackgroundTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    .line 2160
    iget-object v0, v0, Landroid/support/design/widget/j;->e:Landroid/graphics/drawable/Drawable;
...
.method public setCompatElevation(F)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/design/widget/j;->a(F)V
