...
.field final d:Landroid/support/design/widget/b$e;

.field e:I

.field final f:Landroid/support/design/widget/p$a;

.field private final h:Landroid/support/design/widget/b$b;
...
.method static constructor <clinit>()V
    ...
    :goto_0
    sput-boolean v0, Landroid/support/design/widget/b;->g:Z
...
.method protected constructor <init>(Landroid/view/ViewGroup;Landroid/view/View;Landroid/support/design/widget/b$b;)V
    ...
    iput-object v0, p0, Landroid/support/design/widget/b;->f:Landroid/support/design/widget/p$a;
    ...
    .line 242
    :cond_2
    iput-object p1, p0, Landroid/support/design/widget/b;->b:Landroid/view/ViewGroup;

    .line 243
    iput-object p3, p0, Landroid/support/design/widget/b;->h:Landroid/support/design/widget/b$b;
    ...
    iput-object v0, p0, Landroid/support/design/widget/b;->c:Landroid/content/Context;
    ...
    iget-object v2, p0, Landroid/support/design/widget/b;->b:Landroid/view/ViewGroup;
    ...
    iput-object v0, p0, Landroid/support/design/widget/b;->d:Landroid/support/design/widget/b$e;

    .line 254
    iget-object v0, p0, Landroid/support/design/widget/b;->d:Landroid/support/design/widget/b$e;
...
.method static synthetic a(Landroid/support/design/widget/b;)Landroid/support/design/widget/b$b;
    ...
    .prologue
    .line 61
    iget-object v0, p0, Landroid/support/design/widget/b;->h:Landroid/support/design/widget/b$b;
...
.method static synthetic f()Z
    ...
    .prologue
    .line 61
    sget-boolean v0, Landroid/support/design/widget/b;->g:Z
...
.method public final a()V
    ...
    iget v1, p0, Landroid/support/design/widget/b;->e:I

    iget-object v2, p0, Landroid/support/design/widget/b;->f:Landroid/support/design/widget/p$a;

    .line 1071
    iget-object v3, v0, Landroid/support/design/widget/p;->a:Ljava/lang/Object;

    monitor-enter v3

    .line 1072
    :try_start_0
    invoke-virtual {v0, v2}, Landroid/support/design/widget/p;->d(Landroid/support/design/widget/p$a;)Z
    ...
    .line 1074
    iget-object v2, v0, Landroid/support/design/widget/p;->c:Landroid/support/design/widget/p$b;

    iput v1, v2, Landroid/support/design/widget/p$b;->b:I

    .line 1078
    iget-object v1, v0, Landroid/support/design/widget/p;->b:Landroid/os/Handler;
    ...
    .line 1079
    iget-object v1, v0, Landroid/support/design/widget/p;->c:Landroid/support/design/widget/p$b;

    invoke-virtual {v0, v1}, Landroid/support/design/widget/p;->a(Landroid/support/design/widget/p$b;)V
    ...
    .line 1081
    :cond_0
    invoke-virtual {v0, v2}, Landroid/support/design/widget/p;->e(Landroid/support/design/widget/p$a;)Z
    ...
    .line 1083
    iget-object v2, v0, Landroid/support/design/widget/p;->d:Landroid/support/design/widget/p$b;
    ...
    invoke-virtual {v0, v1, v2}, Landroid/support/design/widget/p;->a(Landroid/support/design/widget/p$b;I)Z
    ...
    :cond_1
    :try_start_1
    new-instance v4, Landroid/support/design/widget/p$b;

    invoke-direct {v4, v1, v2}, Landroid/support/design/widget/p$b;-><init>(ILandroid/support/design/widget/p$a;)V

    iput-object v4, v0, Landroid/support/design/widget/p;->d:Landroid/support/design/widget/p$b;
    ...
    iput-object v1, v0, Landroid/support/design/widget/p;->c:Landroid/support/design/widget/p$b;

    .line 1097
    invoke-virtual {v0}, Landroid/support/design/widget/p;->b()V
...
.method final a(I)V
    ...
    iget-object v1, p0, Landroid/support/design/widget/b;->f:Landroid/support/design/widget/p$a;
    ...
    invoke-virtual {v0, v1, p1}, Landroid/support/design/widget/p;->a(Landroid/support/design/widget/p$b;I)Z
    ...
    .line 1107
    iget-object v1, v0, Landroid/support/design/widget/p;->d:Landroid/support/design/widget/p$b;
...
.method final b()V
    ...
    .line 499
    sget-boolean v1, Landroid/support/design/widget/b;->g:Z

    if-eqz v1, :cond_0

    .line 500
    iget-object v1, p0, Landroid/support/design/widget/b;->d:Landroid/support/design/widget/b$e;

    invoke-static {v1, v0}, Landroid/support/v4/view/s;->b(Landroid/view/View;I)V
