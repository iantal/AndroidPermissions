...
.method private static a(Landroid/support/v7/widget/RecyclerView;IJ)Landroid/support/v7/widget/RecyclerView$v;
    ...
    invoke-virtual {v3, v0}, Landroid/support/v7/widget/af;->c(I)Landroid/view/View;
...
.method final a(Landroid/support/v7/widget/RecyclerView;II)V
    ...
    .line 184
    :cond_0
    iget-object v0, p1, Landroid/support/v7/widget/RecyclerView;->F:Landroid/support/v7/widget/ap$a;

    .line 12071
    iput p2, v0, Landroid/support/v7/widget/ap$a;->a:I

    .line 12072
    iput p3, v0, Landroid/support/v7/widget/ap$a;->b:I
...
.method public final run()V
    ...
    iget-wide v4, p0, Landroid/support/v7/widget/ap;->d:J
    ...
    .line 13219
    iget-object v5, v2, Landroid/support/v7/widget/RecyclerView;->F:Landroid/support/v7/widget/ap$a;

    const/4 v8, 0x0

    invoke-virtual {v5, v2, v8}, Landroid/support/v7/widget/ap$a;->a(Landroid/support/v7/widget/RecyclerView;Z)V

    .line 13220
    iget-object v2, v2, Landroid/support/v7/widget/RecyclerView;->F:Landroid/support/v7/widget/ap$a;

    iget v2, v2, Landroid/support/v7/widget/ap$a;->d:I
    ...
    .line 13225
    :cond_3
    iget-object v2, p0, Landroid/support/v7/widget/ap;->f:Ljava/util/ArrayList;
    ...
    .line 13234
    iget-object v11, v2, Landroid/support/v7/widget/RecyclerView;->F:Landroid/support/v7/widget/ap$a;

    .line 13235
    iget v4, v11, Landroid/support/v7/widget/ap$a;->a:I

    invoke-static {v4}, Ljava/lang/Math;->abs(I)I

    move-result v4

    iget v5, v11, Landroid/support/v7/widget/ap$a;->b:I
    ...
    :goto_6
    iget v3, v11, Landroid/support/v7/widget/ap$a;->d:I
    ...
    .line 13239
    iget-object v3, p0, Landroid/support/v7/widget/ap;->f:Ljava/util/ArrayList;
    ...
    .line 13240
    new-instance v3, Landroid/support/v7/widget/ap$b;

    invoke-direct {v3}, Landroid/support/v7/widget/ap$b;-><init>()V
    ...
    .line 13245
    :goto_7
    iget-object v3, v11, Landroid/support/v7/widget/ap$a;->c:[I
    ...
    :goto_8
    iput-boolean v3, v5, Landroid/support/v7/widget/ap$b;->a:Z

    .line 13248
    iput v12, v5, Landroid/support/v7/widget/ap$b;->b:I

    .line 13249
    iput v13, v5, Landroid/support/v7/widget/ap$b;->c:I

    .line 13250
    iput-object v2, v5, Landroid/support/v7/widget/ap$b;->d:Landroid/support/v7/widget/RecyclerView;
    ...
    iput v3, v5, Landroid/support/v7/widget/ap$b;->e:I
    ...
    check-cast v3, Landroid/support/v7/widget/ap$b;
    ...
    sget-object v3, Landroid/support/v7/widget/ap;->e:Ljava/util/Comparator;
    ...
    .line 13355
    iget-object v2, v3, Landroid/support/v7/widget/ap$b;->d:Landroid/support/v7/widget/RecyclerView;

    if-eqz v2, :cond_c

    .line 14341
    iget-boolean v2, v3, Landroid/support/v7/widget/ap$b;->a:Z
    ...
    iget v9, v3, Landroid/support/v7/widget/ap$b;->e:I

    invoke-static {v2, v9, v4, v5}, Landroid/support/v7/widget/ap;->a(Landroid/support/v7/widget/RecyclerView;IJ)Landroid/support/v7/widget/RecyclerView$v;
    ...
    iget-object v4, v2, Landroid/support/v7/widget/RecyclerView$v;->mNestedRecyclerView:Ljava/lang/ref/WeakReference;
    ...
    .line 14348
    iget-object v2, v2, Landroid/support/v7/widget/RecyclerView$v;->mNestedRecyclerView:Ljava/lang/ref/WeakReference;
    ...
    iget-object v4, v2, Landroid/support/v7/widget/RecyclerView;->f:Landroid/support/v7/widget/af;

    .line 15314
    invoke-virtual {v4}, Landroid/support/v7/widget/af;->b()I
    ...
    invoke-virtual {v5, v2, v4}, Landroid/support/v7/widget/ap$a;->a(Landroid/support/v7/widget/RecyclerView;Z)V

    .line 15324
    iget v4, v5, Landroid/support/v7/widget/ap$a;->d:I
    :try_end_2
    ...
    invoke-static {v4}, Landroid/support/v4/os/d;->a(Ljava/lang/String;)V
    ...
    :goto_c
    iget v9, v5, Landroid/support/v7/widget/ap$a;->d:I
    ...
    .line 15331
    iget-object v9, v5, Landroid/support/v7/widget/ap$a;->c:[I

    aget v9, v9, v4

    .line 15332
    invoke-static {v2, v9, v6, v7}, Landroid/support/v7/widget/ap;->a(Landroid/support/v7/widget/RecyclerView;IJ)Landroid/support/v7/widget/RecyclerView$v;
    :try_end_3
    ...
    iput-boolean v2, v3, Landroid/support/v7/widget/ap$b;->a:Z

    .line 16045
    const/4 v2, 0x0

    iput v2, v3, Landroid/support/v7/widget/ap$b;->b:I

    .line 16046
    const/4 v2, 0x0

    iput v2, v3, Landroid/support/v7/widget/ap$b;->c:I

    .line 16047
    const/4 v2, 0x0

    iput-object v2, v3, Landroid/support/v7/widget/ap$b;->d:Landroid/support/v7/widget/RecyclerView;

    .line 16048
    const/4 v2, 0x0

    iput v2, v3, Landroid/support/v7/widget/ap$b;->e:I
    ...
    iput-wide v4, p0, Landroid/support/v7/widget/ap;->c:J
