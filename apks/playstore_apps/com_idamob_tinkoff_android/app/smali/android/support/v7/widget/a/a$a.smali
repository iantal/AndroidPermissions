...
.method public static a(Landroid/support/v7/widget/RecyclerView$v;Ljava/util/List;II)Landroid/support/v7/widget/RecyclerView$v;
    ...
    iget-object v10, v0, Landroid/support/v7/widget/RecyclerView$v;->itemView:Landroid/view/View;

    invoke-virtual {v10}, Landroid/view/View;->getRight()I

    move-result v10

    iget-object v11, p0, Landroid/support/v7/widget/RecyclerView$v;->itemView:Landroid/view/View;
...
.method public static a(Landroid/graphics/Canvas;Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$v;FFIZ)V
    .locals 8
    ...
    iget-object v3, p2, Landroid/support/v7/widget/RecyclerView$v;->itemView:Landroid/view/View;
...
.method public static a(Landroid/support/v7/widget/RecyclerView$v;)V
    .locals 1
...
.method public static a(Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$v;Landroid/support/v7/widget/RecyclerView$v;I)V
    ...
    .line 1921
    iget-object v1, p2, Landroid/support/v7/widget/RecyclerView$v;->itemView:Landroid/view/View;

    invoke-static {v1}, Landroid/support/v7/widget/RecyclerView$h;->f(Landroid/view/View;)I
    ...
    invoke-static {v1}, Landroid/support/v7/widget/RecyclerView$h;->h(Landroid/view/View;)I
    ...
    invoke-static {v0}, Landroid/support/v7/widget/RecyclerView$h;->g(Landroid/view/View;)I
    ...
    invoke-static {v0}, Landroid/support/v7/widget/RecyclerView$h;->i(Landroid/view/View;)I
...
.method public static b(Landroid/support/v7/widget/RecyclerView$v;)V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView$v;->itemView:Landroid/view/View;
...
.method public static c(Landroid/support/v7/widget/RecyclerView$v;)V
    .locals 1
...
.method public final a(Landroid/support/v7/widget/RecyclerView;IIJ)I
    ...
    .line 2132
    .line 13869
    iget v2, p0, Landroid/support/v7/widget/a/a$a;->d:I
    ...
    iput v2, p0, Landroid/support/v7/widget/a/a$a;->d:I
    ...
    sget-object v4, Landroid/support/v7/widget/a/a$a;->c:Landroid/view/animation/Interpolator;
    ...
    sget-object v3, Landroid/support/v7/widget/a/a$a;->b:Landroid/view/animation/Interpolator;
