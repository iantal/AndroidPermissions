...
.method private a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 99
    iget-object v0, p0, Landroid/support/v7/widget/r;->a:Landroid/graphics/Bitmap;

    if-nez v0, :cond_7

    .line 100
    iput-object v1, p0, Landroid/support/v7/widget/r;->a:Landroid/graphics/Bitmap;
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    invoke-static {v0, p1, v1, p2, v3}, Landroid/support/v7/widget/bp;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/bp;

    move-result-object v4

    .line 54
    invoke-virtual {v4, v3}, Landroid/support/v7/widget/bp;->b(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 56
    iget-object v5, p0, Landroid/support/v7/widget/r;->c:Landroid/widget/ProgressBar;
    ...
    invoke-direct {p0, v7, v9}, Landroid/support/v7/widget/r;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 59
    :cond_2
    invoke-virtual {v4, v9}, Landroid/support/v7/widget/bp;->b(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 61
    iget-object v1, p0, Landroid/support/v7/widget/r;->c:Landroid/widget/ProgressBar;

    invoke-direct {p0, v0, v3}, Landroid/support/v7/widget/r;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 1244
    :cond_3
    iget-object v0, v4, Landroid/support/v7/widget/bp;->b:Landroid/content/res/TypedArray;
