...
.method private a(Landroid/view/View;IIZ)V
    ...
    .line 35700
    iget-boolean v1, p0, Landroid/support/v7/widget/RecyclerView$h;->x:Z
    ...
    invoke-static {v1, p2, v2}, Landroid/support/v7/widget/RecyclerView$h;->b_(III)Z
    ...
    invoke-static {v1, p3, v0}, Landroid/support/v7/widget/RecyclerView$h;->b_(III)Z
...
.method private a(Landroid/view/View;IZ)V
    ...
    .line 723
    iget-object v3, p0, Landroid/support/v7/widget/GridLayoutManager;->j:Landroid/support/v7/widget/az;

    invoke-virtual {v3}, Landroid/support/v7/widget/az;->e()I
    ...
    .line 728
    iget-object v2, p0, Landroid/support/v7/widget/GridLayoutManager;->j:Landroid/support/v7/widget/az;
...
.method final a(Landroid/support/v7/widget/RecyclerView$o;Landroid/support/v7/widget/RecyclerView$s;III)Landroid/view/View;
    ...
    .line 419
    iget-object v0, p0, Landroid/support/v7/widget/GridLayoutManager;->j:Landroid/support/v7/widget/az;
...
.method public final a(Landroid/view/View;ILandroid/support/v7/widget/RecyclerView$o;Landroid/support/v7/widget/RecyclerView$s;)Landroid/view/View;
    ...
    invoke-virtual {v0, v11, v1}, Landroid/support/v7/widget/GridLayoutManager;->a(Landroid/view/View;Z)Z
...
.method final a(Landroid/support/v7/widget/RecyclerView$o;Landroid/support/v7/widget/RecyclerView$s;Landroid/support/v7/widget/LinearLayoutManager$c;Landroid/support/v7/widget/LinearLayoutManager$b;)V
    ...
    invoke-virtual {v2}, Landroid/support/v7/widget/az;->h()I
    ...
    invoke-virtual {p0, v11, v2}, Landroid/support/v7/widget/RecyclerView$h;->b(Landroid/view/View;I)V

    .line 590
    :goto_6
    iget-object v2, p0, Landroid/support/v7/widget/GridLayoutManager;->h:Landroid/graphics/Rect;

    invoke-virtual {p0, v11, v2}, Landroid/support/v7/widget/GridLayoutManager;->c(Landroid/view/View;Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v2, v11}, Landroid/support/v7/widget/az;->e(Landroid/view/View;)I
    ...
    iget-object v13, p0, Landroid/support/v7/widget/GridLayoutManager;->j:Landroid/support/v7/widget/az;

    invoke-virtual {v13, v11}, Landroid/support/v7/widget/az;->f(Landroid/view/View;)I
    ...
    invoke-virtual {p0, v11, v2}, Landroid/support/v7/widget/RecyclerView$h;->a(Landroid/view/View;I)V
    ...
    .line 612
    iget-object v6, p0, Landroid/support/v7/widget/GridLayoutManager;->j:Landroid/support/v7/widget/az;

    invoke-virtual {v6, v2}, Landroid/support/v7/widget/az;->e(Landroid/view/View;)I
    ...
    invoke-virtual {v2, v7}, Landroid/support/v7/widget/az;->e(Landroid/view/View;)I
    ...
    invoke-direct {p0, v9, v10}, Landroid/support/v7/widget/GridLayoutManager;->f(II)I
    ...
    invoke-virtual {v3, v9}, Landroid/support/v7/widget/az;->f(Landroid/view/View;)I
    ...
    .line 34039
    iget-object v10, v2, Landroid/support/v7/widget/RecyclerView$i;->c:Landroid/support/v7/widget/RecyclerView$v;

    invoke-virtual {v10}, Landroid/support/v7/widget/RecyclerView$v;->isRemoved()Z
    ...
    .line 34050
    iget-object v2, v2, Landroid/support/v7/widget/RecyclerView$i;->c:Landroid/support/v7/widget/RecyclerView$v;

    invoke-virtual {v2}, Landroid/support/v7/widget/RecyclerView$v;->isUpdated()Z
    ...
    .line 677
    iget-object v7, p0, Landroid/support/v7/widget/GridLayoutManager;->j:Landroid/support/v7/widget/az;

    invoke-virtual {v7, v9}, Landroid/support/v7/widget/az;->f(Landroid/view/View;)I
    ...
    .line 681
    iget-object v4, p0, Landroid/support/v7/widget/GridLayoutManager;->j:Landroid/support/v7/widget/az;

    invoke-virtual {v4, v9}, Landroid/support/v7/widget/az;->f(Landroid/view/View;)I
...
.method public final a(Landroid/support/v7/widget/RecyclerView$o;Landroid/support/v7/widget/RecyclerView$s;Landroid/view/View;Landroid/support/v4/view/a/a;)V
    ...
    .line 12068
    iget-object v3, v0, Landroid/support/v7/widget/RecyclerView$i;->c:Landroid/support/v7/widget/RecyclerView$v;
...
.method final a(Landroid/support/v7/widget/RecyclerView$s;Landroid/support/v7/widget/LinearLayoutManager$c;Landroid/support/v7/widget/RecyclerView$h$a;)V
    .locals 5
    ...
    invoke-interface {p3, v3, v4}, Landroid/support/v7/widget/RecyclerView$h$a;->a(II)V
