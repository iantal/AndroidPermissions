...
.method private constructor <init>(Landroid/support/v7/widget/f$a;B)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/f;->h:Landroid/support/v4/f/k$a;
    ...
    .line 68
    iput v2, p0, Landroid/support/v7/widget/f;->g:I

    .line 75
    iput-object p1, p0, Landroid/support/v7/widget/f;->c:Landroid/support/v7/widget/f$a;

    .line 76
    iput-boolean v2, p0, Landroid/support/v7/widget/f;->e:Z
    ...
    iput-object v0, p0, Landroid/support/v7/widget/f;->f:Landroid/support/v7/widget/ay;
...
.method public final a(IIILjava/lang/Object;)Landroid/support/v7/widget/f$b;
    ...
    .prologue
    .line 726
    iget-object v0, p0, Landroid/support/v7/widget/f;->h:Landroid/support/v4/f/k$a;
...
.method final b()V
    ...
    .prologue
    .line 92
    iget-object v6, p0, Landroid/support/v7/widget/f;->f:Landroid/support/v7/widget/ay;

    iget-object v7, p0, Landroid/support/v7/widget/f;->a:Ljava/util/ArrayList;
    ...
    iget v4, v1, Landroid/support/v7/widget/f$b;->b:I
    ...
    .line 2170
    :cond_2
    iget v3, v1, Landroid/support/v7/widget/f$b;->b:I
    ...
    iget v4, v1, Landroid/support/v7/widget/f$b;->d:I

    add-int/2addr v3, v4

    iput v3, v0, Landroid/support/v7/widget/f$b;->b:I
    ...
    iput v3, v0, Landroid/support/v7/widget/f$b;->d:I
    ...
    iput v2, v1, Landroid/support/v7/widget/f$b;->b:I
    ...
    iget v9, v0, Landroid/support/v7/widget/f$b;->d:I
    ...
    .line 2070
    iget v9, v1, Landroid/support/v7/widget/f$b;->b:I

    iget v10, v0, Landroid/support/v7/widget/f$b;->b:I

    if-ne v9, v10, :cond_7

    iget v9, v1, Landroid/support/v7/widget/f$b;->d:I

    iget v10, v0, Landroid/support/v7/widget/f$b;->d:I

    iget v11, v0, Landroid/support/v7/widget/f$b;->b:I
    ...
    iget v10, v1, Landroid/support/v7/widget/f$b;->b:I
    ...
    iput v9, v1, Landroid/support/v7/widget/f$b;->b:I

    .line 2099
    :cond_8
    iget v9, v0, Landroid/support/v7/widget/f$b;->b:I
    ...
    .line 2112
    iget-object v1, v6, Landroid/support/v7/widget/ay;->a:Landroid/support/v7/widget/ay$a;

    invoke-interface {v1, v0}, Landroid/support/v7/widget/ay$a;->a(Landroid/support/v7/widget/f$b;)V
    ...
    iget v11, v0, Landroid/support/v7/widget/f$b;->d:I
    ...
    iget v11, v1, Landroid/support/v7/widget/f$b;->d:I
    ...
    iput v2, v0, Landroid/support/v7/widget/f$b;->a:I
    ...
    .line 2090
    iget v0, v1, Landroid/support/v7/widget/f$b;->d:I
    ...
    .line 2092
    iget-object v0, v6, Landroid/support/v7/widget/ay;->a:Landroid/support/v7/widget/ay$a;

    invoke-interface {v0, v1}, Landroid/support/v7/widget/ay$a;->a(Landroid/support/v7/widget/f$b;)V
    ...
    .line 2104
    iget-object v9, v6, Landroid/support/v7/widget/ay;->a:Landroid/support/v7/widget/ay$a;
    ...
    iput v9, v1, Landroid/support/v7/widget/f$b;->d:I
    ...
    iget v3, v4, Landroid/support/v7/widget/f$b;->b:I
    ...
    iget v3, v4, Landroid/support/v7/widget/f$b;->d:I
    ...
    .line 2150
    iget v1, v0, Landroid/support/v7/widget/f$b;->b:I
    ...
    iput v4, v1, Landroid/support/v7/widget/f$b;->b:I
    ...
    iget v10, v1, Landroid/support/v7/widget/f$b;->d:I
    ...
    .line 2191
    iget-object v2, v6, Landroid/support/v7/widget/ay;->a:Landroid/support/v7/widget/ay$a;
    ...
    iget-object v11, v1, Landroid/support/v7/widget/f$b;->c:Ljava/lang/Object;
    ...
    .line 2199
    iget-object v3, v6, Landroid/support/v7/widget/ay;->a:Landroid/support/v7/widget/ay$a;
    ...
    iput v4, v1, Landroid/support/v7/widget/f$b;->d:I
    ...
    .line 3133
    :pswitch_6
    iget v8, v0, Landroid/support/v7/widget/f$b;->b:I
    ...
    .line 3139
    iget-object v9, p0, Landroid/support/v7/widget/f;->c:Landroid/support/v7/widget/f$a;

    invoke-interface {v9, v2}, Landroid/support/v7/widget/f$a;->a(I)Landroid/support/v7/widget/RecyclerView$v;
    ...
    invoke-direct {p0, v2}, Landroid/support/v7/widget/f;->c(I)Z
    ...
    invoke-virtual {p0, v1, v8, v6, v4}, Landroid/support/v7/widget/f;->a(IIILjava/lang/Object;)Landroid/support/v7/widget/f$b;
    ...
    .line 3162
    invoke-direct {p0, v1}, Landroid/support/v7/widget/f;->c(Landroid/support/v7/widget/f$b;)V
    ...
    invoke-virtual {p0, v0, v8, v6, v1}, Landroid/support/v7/widget/f;->a(IIILjava/lang/Object;)Landroid/support/v7/widget/f$b;
    ...
    invoke-interface {v8, v3}, Landroid/support/v7/widget/f$a;->a(I)Landroid/support/v7/widget/RecyclerView$v;
    ...
    invoke-direct {p0, v3}, Landroid/support/v7/widget/f;->c(I)Z
    ...
    iget-object v8, v0, Landroid/support/v7/widget/f$b;->c:Ljava/lang/Object;

    invoke-virtual {p0, v4, v2, v1, v8}, Landroid/support/v7/widget/f;->a(IIILjava/lang/Object;)Landroid/support/v7/widget/f$b;
    ...
    .line 3215
    iget-object v3, v0, Landroid/support/v7/widget/f$b;->c:Ljava/lang/Object;
