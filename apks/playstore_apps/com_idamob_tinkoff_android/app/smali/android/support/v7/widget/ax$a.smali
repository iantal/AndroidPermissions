...
.method public constructor <init>(Landroid/content/Context;Z)V
    ...
    .line 143
    iput v3, p0, Landroid/support/v7/widget/ax$a;->h:I

    .line 144
    iput v4, p0, Landroid/support/v7/widget/ax$a;->i:I
    ...
    .line 146
    :cond_0
    iput v4, p0, Landroid/support/v7/widget/ax$a;->h:I

    .line 147
    iput v3, p0, Landroid/support/v7/widget/ax$a;->i:I
...
.method public final onHoverEvent(Landroid/view/MotionEvent;)Z
    ...
    .prologue
    .line 183
    iget-object v0, p0, Landroid/support/v7/widget/ax$a;->j:Landroid/support/v7/widget/aw;
    ...
    .line 209
    :goto_1
    iget-object v2, p0, Landroid/support/v7/widget/ax$a;->k:Landroid/view/MenuItem;
    ...
    .line 213
    iget-object v3, p0, Landroid/support/v7/widget/ax$a;->j:Landroid/support/v7/widget/aw;

    invoke-interface {v3, v0, v2}, Landroid/support/v7/widget/aw;->a(Landroid/support/v7/view/menu/h;Landroid/view/MenuItem;)V

    .line 216
    :cond_0
    iput-object v1, p0, Landroid/support/v7/widget/ax$a;->k:Landroid/view/MenuItem;

    .line 218
    if-eqz v1, :cond_1

    .line 219
    iget-object v2, p0, Landroid/support/v7/widget/ax$a;->j:Landroid/support/v7/widget/aw;

    invoke-interface {v2, v0, v1}, Landroid/support/v7/widget/aw;->b(Landroid/support/v7/view/menu/h;Landroid/view/MenuItem;)V
...
.method public final onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    iget v2, p0, Landroid/support/v7/widget/ax$a;->h:I
    ...
    iget v0, p0, Landroid/support/v7/widget/ax$a;->i:I
...
.method public final setHoverListener(Landroid/support/v7/widget/aw;)V
    ...
    .prologue
    .line 152
    iput-object p1, p0, Landroid/support/v7/widget/ax$a;->j:Landroid/support/v7/widget/aw;
