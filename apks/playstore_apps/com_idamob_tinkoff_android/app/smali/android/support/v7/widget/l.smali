...
.field private static d:Landroid/support/v7/widget/l;

.field private static final e:Landroid/support/v7/widget/l$b;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0}, Landroid/support/v7/widget/l$b;-><init>()V

    sput-object v0, Landroid/support/v7/widget/l;->e:Landroid/support/v7/widget/l$b;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/l;->a:Ljava/lang/Object;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/l;->b:Ljava/util/WeakHashMap;
...
.method public static a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
    ...
    .prologue
    .line 727
    sget-object v0, Landroid/support/v7/widget/l;->e:Landroid/support/v7/widget/l$b;

    .line 9678
    invoke-static {p0, p1}, Landroid/support/v7/widget/l$b;->a(ILandroid/graphics/PorterDuff$Mode;)I
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/l$b;->a(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 732
    sget-object v1, Landroid/support/v7/widget/l;->e:Landroid/support/v7/widget/l$b;
    ...
    invoke-virtual {v1, v2, v0}, Landroid/support/v7/widget/l$b;->a(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method private a(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    .line 390
    iget-object v3, p0, Landroid/support/v7/widget/l;->a:Ljava/lang/Object;

    monitor-enter v3

    .line 391
    :try_start_0
    iget-object v0, p0, Landroid/support/v7/widget/l;->b:Ljava/util/WeakHashMap;
    ...
    :cond_1
    :try_start_1
    iget-object v1, v0, Landroid/support/v4/f/f;->c:[J

    iget v4, v0, Landroid/support/v4/f/f;->e:I
    ...
    .line 6121
    iget-object v4, v0, Landroid/support/v4/f/f;->d:[Ljava/lang/Object;

    aget-object v4, v4, v1

    sget-object v5, Landroid/support/v4/f/f;->a:Ljava/lang/Object;
    ...
    iput-boolean v1, v0, Landroid/support/v4/f/f;->b:Z
...
.method public static a()Landroid/support/v7/widget/l;
    ...
    .prologue
    .line 84
    sget-object v0, Landroid/support/v7/widget/l;->d:Landroid/support/v7/widget/l;
    ...
    .line 86
    sput-object v0, Landroid/support/v7/widget/l;->d:Landroid/support/v7/widget/l;
    ...
    invoke-direct {v2}, Landroid/support/v7/widget/l$d;-><init>()V

    invoke-direct {v0, v1, v2}, Landroid/support/v7/widget/l;->a(Ljava/lang/String;Landroid/support/v7/widget/l$c;)V

    .line 1097
    const-string v1, "animated-vector"

    new-instance v2, Landroid/support/v7/widget/l$a;

    invoke-direct {v2}, Landroid/support/v7/widget/l$a;-><init>()V
...
.method private static a(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    .prologue
    .line 739
    invoke-static {p0}, Landroid/support/v7/widget/ak;->c(Landroid/graphics/drawable/Drawable;)Z
...
.method static a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/bn;[I)V
    ...
    :goto_1
    iget-boolean v2, p1, Landroid/support/v7/widget/bn;->c:Z

    if-eqz v2, :cond_5

    iget-object v2, p1, Landroid/support/v7/widget/bn;->b:Landroid/graphics/PorterDuff$Mode;
...
.method private a(Ljava/lang/String;Landroid/support/v7/widget/l$c;)V
    ...
    .prologue
    .line 490
    iget-object v0, p0, Landroid/support/v7/widget/l;->m:Landroid/support/v4/f/a;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/l;->m:Landroid/support/v4/f/a;
...
.method static a(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    .line 468
    invoke-static {p2}, Landroid/support/v7/widget/ak;->c(Landroid/graphics/drawable/Drawable;)Z
    ...
    .line 472
    :cond_0
    invoke-static {p0, v4}, Landroid/support/v7/widget/bl;->a(Landroid/content/Context;I)I
    ...
    .line 454
    :cond_3
    sget-object v4, Landroid/support/v7/widget/l;->i:[I
...
.method private a(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
    ...
    .line 416
    iget-object v2, p0, Landroid/support/v7/widget/l;->a:Ljava/lang/Object;
    ...
    .line 420
    iget-object v3, p0, Landroid/support/v7/widget/l;->b:Ljava/util/WeakHashMap;
    ...
    invoke-virtual {v0, p2, p3, v3}, Landroid/support/v4/f/f;->a(JLjava/lang/Object;)V
...
.method private static c(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p0, v2}, Landroid/support/v7/widget/bl;->a(Landroid/content/Context;I)I
    ...
    invoke-static {p0, v3}, Landroid/support/v7/widget/bl;->c(Landroid/content/Context;I)I

    move-result v3

    .line 605
    sget-object v4, Landroid/support/v7/widget/bl;->a:[I
    ...
    .line 609
    sget-object v3, Landroid/support/v7/widget/bl;->d:[I
    ...
    .line 613
    sget-object v3, Landroid/support/v7/widget/bl;->b:[I
    ...
    .line 618
    sget-object v2, Landroid/support/v7/widget/bl;->h:[I
...
.method final a(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    .line 306
    iget-object v0, p0, Landroid/support/v7/widget/l;->n:Landroid/support/v4/f/n;
    ...
    invoke-virtual {v0, p2}, Landroid/support/v4/f/n;->a(I)Ljava/lang/Object;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/l;->m:Landroid/support/v4/f/a;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/l;->n:Landroid/support/v4/f/n;
    ...
    .line 381
    iget-object v1, p0, Landroid/support/v7/widget/l;->n:Landroid/support/v4/f/n;

    const-string v2, "appcompat_skip_skip"

    invoke-virtual {v1, p2, v2}, Landroid/support/v4/f/n;->b(ILjava/lang/Object;)V
    ...
    .line 358
    iget-object v7, p0, Landroid/support/v7/widget/l;->n:Landroid/support/v4/f/n;

    invoke-virtual {v7, p2, v0}, Landroid/support/v4/f/n;->b(ILjava/lang/Object;)V

    .line 361
    iget-object v7, p0, Landroid/support/v7/widget/l;->m:Landroid/support/v4/f/a;
...
.method public final a(Landroid/content/Context;IZ)Landroid/graphics/drawable/Drawable;
    ...
    .line 1752
    iput-boolean v2, p0, Landroid/support/v7/widget/l;->p:Z

    .line 1753
    sget v0, Landroid/support/v7/a/a$e;->abc_vector_test:I

    .line 2186
    invoke-virtual {p0, p1, v0, v1}, Landroid/support/v7/widget/l;->a(Landroid/content/Context;IZ)Landroid/graphics/drawable/Drawable;
    ...
    .line 1755
    :cond_1
    iput-boolean v1, p0, Landroid/support/v7/widget/l;->p:Z
    ...
    .line 193
    :cond_3
    invoke-virtual {p0, p1, p2}, Landroid/support/v7/widget/l;->a(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    .line 3231
    :cond_4
    iget-object v3, p0, Landroid/support/v7/widget/l;->o:Landroid/util/TypedValue;
    ...
    .line 3233
    invoke-static {v3}, Landroid/support/v7/widget/l;->a(Landroid/util/TypedValue;)J
    ...
    .line 4186
    invoke-virtual {p0, p1, v7, v1}, Landroid/support/v7/widget/l;->a(Landroid/content/Context;IZ)Landroid/graphics/drawable/Drawable;
    ...
    .line 3252
    invoke-direct {p0, p1, v4, v5, v0}, Landroid/support/v7/widget/l;->a(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
    ...
    .line 203
    invoke-virtual {p0, p1, p2, p3, v0}, Landroid/support/v7/widget/l;->a(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    .line 207
    invoke-static {v0}, Landroid/support/v7/widget/ak;->b(Landroid/graphics/drawable/Drawable;)V
...
.method final a(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    .line 263
    invoke-static {p4}, Landroid/support/v7/widget/ak;->c(Landroid/graphics/drawable/Drawable;)Z
    ...
    .line 277
    invoke-static {p1, v2}, Landroid/support/v7/widget/bl;->a(Landroid/content/Context;I)I
    ...
    .line 281
    invoke-static {p1, v1}, Landroid/support/v7/widget/bl;->a(Landroid/content/Context;I)I
    ...
    .line 287
    invoke-static {p1, v2}, Landroid/support/v7/widget/bl;->c(Landroid/content/Context;I)I
...
.method final b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/l;->l:Ljava/util/WeakHashMap;
    ...
    .line 8575
    iget-object v2, p0, Landroid/support/v7/widget/l;->l:Ljava/util/WeakHashMap;

    invoke-virtual {v2, p1, v0}, Ljava/util/WeakHashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    .line 8577
    :cond_1
    invoke-virtual {v0, p2, v1}, Landroid/support/v4/f/n;->b(ILjava/lang/Object;)V
    ...
    invoke-static {p1, v1}, Landroid/support/v7/widget/bl;->b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    .line 6638
    sget-object v3, Landroid/support/v7/widget/bl;->a:[I
    ...
    .line 6642
    sget-object v3, Landroid/support/v7/widget/bl;->e:[I
    ...
    invoke-static {p1, v3}, Landroid/support/v7/widget/bl;->a(Landroid/content/Context;I)I
    ...
    .line 6647
    sget-object v3, Landroid/support/v7/widget/bl;->h:[I
    ...
    .line 6654
    :cond_8
    sget-object v1, Landroid/support/v7/widget/bl;->a:[I
    ...
    invoke-static {p1, v1}, Landroid/support/v7/widget/bl;->c(Landroid/content/Context;I)I
    ...
    .line 6658
    sget-object v1, Landroid/support/v7/widget/bl;->e:[I
    ...
    .line 6663
    sget-object v1, Landroid/support/v7/widget/bl;->h:[I
    ...
    .line 7582
    invoke-static {p1, v0}, Landroid/support/v7/widget/bl;->a(Landroid/content/Context;I)I

    move-result v0

    .line 7581
    invoke-static {p1, v0}, Landroid/support/v7/widget/l;->c(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    .line 7587
    invoke-static {p1, v4}, Landroid/support/v7/widget/l;->c(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v0}, Landroid/support/v7/widget/bl;->b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    .line 544
    :cond_f
    sget-object v1, Landroid/support/v7/widget/l;->j:[I
