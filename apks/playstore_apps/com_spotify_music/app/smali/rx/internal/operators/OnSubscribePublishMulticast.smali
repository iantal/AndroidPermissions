...
# static fields
.field private static a:[Lrx/internal/operators/OnSubscribePublishMulticast$PublishProducer; = null
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "[",
...
.field private static b:[Lrx/internal/operators/OnSubscribePublishMulticast$PublishProducer; = null
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "[",
            "Lrx/internal/operators/OnSubscribePublishMulticast$PublishProducer<",
...
.field public volatile producer:Lzgr;
...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lrx/internal/operators/OnSubscribePublishMulticast;->a:[Lrx/internal/operators/OnSubscribePublishMulticast$PublishProducer;
...
.method public constructor <init>(IZ)V
    ...
    invoke-direct {p2, p1}, Lzqm;-><init>(I)V
    ...
    invoke-direct {p2, p1}, Lzpr;-><init>(I)V

    iput-object p2, p0, Lrx/internal/operators/OnSubscribePublishMulticast;->queue:Ljava/util/Queue;

    .line 112
    :goto_0
    sget-object p1, Lrx/internal/operators/OnSubscribePublishMulticast;->a:[Lrx/internal/operators/OnSubscribePublishMulticast$PublishProducer;
    ...
    invoke-direct {p1, p0}, Lzji;-><init>(Lrx/internal/operators/OnSubscribePublishMulticast;)V

    iput-object p1, p0, Lrx/internal/operators/OnSubscribePublishMulticast;->parent:Lzji;
...
.method private a(ZZ)Z
    ...
    .line 257
    invoke-direct {p0}, Lrx/internal/operators/OnSubscribePublishMulticast;->b()[Lrx/internal/operators/OnSubscribePublishMulticast$PublishProducer;
    ...
    .line 261
    iget-object v3, v3, Lrx/internal/operators/OnSubscribePublishMulticast$PublishProducer;->actual:Lzgz;

    invoke-virtual {v3, p2}, Lzgz;->onError(Ljava/lang/Throwable;)V
    ...
    .line 265
    iget-object v2, v2, Lrx/internal/operators/OnSubscribePublishMulticast$PublishProducer;->actual:Lzgz;
...
.method private b(Lrx/internal/operators/OnSubscribePublishMulticast$PublishProducer;)Z
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private b()[Lrx/internal/operators/OnSubscribePublishMulticast$PublishProducer;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()[",
...
.method final a()V
    ...
    .line 207
    :goto_2
    invoke-direct {p0, v10, v12}, Lrx/internal/operators/OnSubscribePublishMulticast;->a(ZZ)Z
    ...
    .line 216
    iget-object v13, v13, Lrx/internal/operators/OnSubscribePublishMulticast$PublishProducer;->actual:Lzgz;

    invoke-virtual {v13, v11}, Lzgz;->onNext(Ljava/lang/Object;)V
    ...
    invoke-direct {p0, v8, v9}, Lrx/internal/operators/OnSubscribePublishMulticast;->a(ZZ)Z
    ...
    .line 229
    iget-object v3, p0, Lrx/internal/operators/OnSubscribePublishMulticast;->producer:Lzgr;

    if-eqz v3, :cond_8

    .line 231
    invoke-interface {v3, v6, v7}, Lzgr;->a(J)V
    ...
    .line 234
    invoke-static {v8, v6, v7}, Lzib;->b(Ljava/util/concurrent/atomic/AtomicLong;J)J
...
.method final a(Lrx/internal/operators/OnSubscribePublishMulticast$PublishProducer;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final synthetic call(Ljava/lang/Object;)V
    ...
    invoke-direct {v0, p1, p0}, Lrx/internal/operators/OnSubscribePublishMulticast$PublishProducer;-><init>(Lzgz;Lrx/internal/operators/OnSubscribePublishMulticast;)V
    ...
    .line 1122
    invoke-direct {p0, v0}, Lrx/internal/operators/OnSubscribePublishMulticast;->b(Lrx/internal/operators/OnSubscribePublishMulticast$PublishProducer;)Z
    ...
    .line 1124
    invoke-virtual {p0, v0}, Lrx/internal/operators/OnSubscribePublishMulticast;->a(Lrx/internal/operators/OnSubscribePublishMulticast$PublishProducer;)V

    return-void

    .line 1126
    :cond_0
    invoke-virtual {p0}, Lrx/internal/operators/OnSubscribePublishMulticast;->a()V
...
.method public final isUnsubscribed()Z
    ...
    .line 428
    iget-object v0, p0, Lrx/internal/operators/OnSubscribePublishMulticast;->parent:Lzji;

    invoke-virtual {v0}, Lzji;->isUnsubscribed()Z
...
.method public final onNext(Ljava/lang/Object;)V
    ...
    .line 141
    iget-object p1, p0, Lrx/internal/operators/OnSubscribePublishMulticast;->parent:Lzji;

    invoke-virtual {p1}, Lzji;->unsubscribe()V
...
.method public final unsubscribe()V
    ...
    invoke-virtual {v0}, Lzji;->unsubscribe()V
