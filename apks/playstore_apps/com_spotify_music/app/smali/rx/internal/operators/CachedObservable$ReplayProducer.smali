...
# direct methods
.method public constructor <init>(Lzgz;Lzid;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 289
    iput-object p1, p0, Lrx/internal/operators/CachedObservable$ReplayProducer;->child:Lzgz;

    .line 290
    iput-object p2, p0, Lrx/internal/operators/CachedObservable$ReplayProducer;->state:Lzid;
...
.method public final a()V
    ...
    .line 347
    :try_start_1
    iget-object v4, v1, Lrx/internal/operators/CachedObservable$ReplayProducer;->child:Lzgz;
    ...
    .line 360
    :cond_1
    iget-object v9, v1, Lrx/internal/operators/CachedObservable$ReplayProducer;->state:Lzid;
    ...
    .line 366
    iget-object v10, v1, Lrx/internal/operators/CachedObservable$ReplayProducer;->state:Lzid;

    .line 3083
    iget-object v10, v10, Lzpb;->f:[Ljava/lang/Object;
    ...
    .line 382
    invoke-static {v5}, Lrx/internal/operators/NotificationLite;->f(Ljava/lang/Object;)Ljava/lang/Throwable;

    move-result-object v5

    invoke-virtual {v4, v5}, Lzgz;->onError(Ljava/lang/Throwable;)V
    :try_end_3
    ...
    .line 392
    :try_start_5
    invoke-virtual {v4}, Lzgz;->isUnsubscribed()Z
    ...
    .line 403
    :try_start_6
    invoke-static {v4, v15}, Lrx/internal/operators/NotificationLite;->a(Lzgq;Ljava/lang/Object;)Z
    ...
    :goto_2
    :try_start_8
    invoke-static {v5}, Lzhl;->b(Ljava/lang/Throwable;)V
    :try_end_8
    ...
    .line 412
    invoke-static {v15}, Lrx/internal/operators/NotificationLite;->c(Ljava/lang/Object;)Z

    move-result v6

    if-nez v6, :cond_8

    invoke-static {v15}, Lrx/internal/operators/NotificationLite;->b(Ljava/lang/Object;)Z
    ...
    .line 413
    invoke-static {v15}, Lrx/internal/operators/NotificationLite;->e(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v6

    invoke-static {v5, v6}, Lrx/exceptions/OnErrorThrowable;->a(Ljava/lang/Throwable;Ljava/lang/Object;)Ljava/lang/Throwable;
    ...
    .line 3315
    invoke-virtual {v1, v5, v6}, Lrx/internal/operators/CachedObservable$ReplayProducer;->addAndGet(J)J
...
.method public final a(J)V
    ...
    .line 304
    invoke-virtual {p0}, Lrx/internal/operators/CachedObservable$ReplayProducer;->a()V
...
.method public final unsubscribe()V
    ...
    .line 328
    iget-object v0, p0, Lrx/internal/operators/CachedObservable$ReplayProducer;->state:Lzid;

    .line 1140
    iget-object v1, v0, Lzid;->b:Lzsf;

    monitor-enter v1

    .line 1141
    :try_start_0
    iget-object v2, v0, Lzid;->c:[Lrx/internal/operators/CachedObservable$ReplayProducer;
    ...
    .line 1154
    sget-object v2, Lzid;->d:[Lrx/internal/operators/CachedObservable$ReplayProducer;

    iput-object v2, v0, Lzid;->c:[Lrx/internal/operators/CachedObservable$ReplayProducer;
    ...
    .line 1157
    new-array v7, v7, [Lrx/internal/operators/CachedObservable$ReplayProducer;
    ...
    .line 1160
    iput-object v7, v0, Lzid;->c:[Lrx/internal/operators/CachedObservable$ReplayProducer;
