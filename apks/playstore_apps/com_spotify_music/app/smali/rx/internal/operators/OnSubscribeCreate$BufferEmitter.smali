...
.method public constructor <init>(Lzgz;I)V
    ...
    invoke-direct {p1, p2}, Lzqu;-><init>(I)V

    goto :goto_0

    :cond_0
    new-instance p1, Lzpu;

    invoke-direct {p1, p2}, Lzpu;-><init>(I)V
...
.method private c()V
    ...
    .line 333
    :cond_0
    iget-object v0, p0, Lrx/internal/operators/OnSubscribeCreate$BufferEmitter;->actual:Lzgz;
    ...
    .line 393
    invoke-static {p0, v8, v9}, Lzib;->b(Ljava/util/concurrent/atomic/AtomicLong;J)J
...
.method final b()V
    ...
    .line 317
    invoke-direct {p0}, Lrx/internal/operators/OnSubscribeCreate$BufferEmitter;->c()V
