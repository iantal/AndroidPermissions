...
.method public mySpinAddSearchResult(Ljava/lang/String;Ljava/lang/String;DD)V
    ...
    .line 134
    new-instance p3, Lcom/bosch/myspin/serversdk/maps/MySpinPlaceResult;

    invoke-direct {p3, p1, p2, v0}, Lcom/bosch/myspin/serversdk/maps/MySpinPlaceResult;-><init>(Ljava/lang/String;Ljava/lang/String;Lcom/bosch/myspin/serversdk/maps/MySpinLatLng;)V

    .line 135
    sget-object p1, Lcom/bosch/myspin/serversdk/maps/MySpinMapView;->sMySpinMap:Lcom/bosch/myspin/serversdk/maps/MySpinMap;

    iget-object p1, p1, Lcom/bosch/myspin/serversdk/maps/MySpinMap;->mMySpinPlaces:Lcom/bosch/myspin/serversdk/maps/MySpinPlaces;

    invoke-virtual {p1, p3}, Lcom/bosch/myspin/serversdk/maps/MySpinPlaces;->addResult(Lcom/bosch/myspin/serversdk/maps/MySpinPlaceResult;)V
...
.method public mySpinMapOnCameraChange(FFFFF)V
    ...
    invoke-direct {v1, v2, v3, p1, p2}, Lcom/bosch/myspin/serversdk/maps/MySpinLatLng;-><init>(DD)V
    ...
    iput-object v0, p1, Lcom/bosch/myspin/serversdk/maps/MySpinMap;->mMySpinCameraPosition:Lcom/bosch/myspin/serversdk/maps/MySpinCameraPosition;

    .line 90
    sget-object p1, Lcom/bosch/myspin/serversdk/maps/MySpinMapView;->sMySpinMap:Lcom/bosch/myspin/serversdk/maps/MySpinMap;

    iget-object p1, p1, Lcom/bosch/myspin/serversdk/maps/MySpinMap;->mOnCameraChangeListener:Lcom/bosch/myspin/serversdk/maps/MySpinMap$OnCameraChangeListener;
    ...
    invoke-interface {p1, v0}, Lcom/bosch/myspin/serversdk/maps/MySpinMap$OnCameraChangeListener;->onCameraChange(Lcom/bosch/myspin/serversdk/maps/MySpinCameraPosition;)V
...
.method public mySpinMarkerOnMarkerClick(IDD)V
    ...
    .line 109
    sget-object p2, Lcom/bosch/myspin/serversdk/maps/MySpinMapView;->sMySpinMap:Lcom/bosch/myspin/serversdk/maps/MySpinMap;

    iget-object p2, p2, Lcom/bosch/myspin/serversdk/maps/MySpinMap;->mOnMarkerClickListener:Lcom/bosch/myspin/serversdk/maps/MySpinMap$OnMarkerClickListener;

    if-eqz p2, :cond_0

    .line 111
    sget-object p2, Lcom/bosch/myspin/serversdk/maps/MySpinMapView;->mMySpinMarkerList:Ljava/util/List;
    ...
    sget-object p3, Lcom/bosch/myspin/serversdk/maps/MySpinMapView;->mMySpinMarkerList:Ljava/util/List;

    invoke-interface {p3, p1}, Ljava/util/List;->get(I)Ljava/lang/Object;

    move-result-object p1

    check-cast p1, Lcom/bosch/myspin/serversdk/maps/MySpinMarker;

    invoke-interface {p2, p1}, Lcom/bosch/myspin/serversdk/maps/MySpinMap$OnMarkerClickListener;->onMarkerClick(Lcom/bosch/myspin/serversdk/maps/MySpinMarker;)Z
...
.method public mySpinMarkerOnMarkerDrag(IDD)V
    ...
    iget-object p2, p2, Lcom/bosch/myspin/serversdk/maps/MySpinMap;->mOnMarkerDragListener:Lcom/bosch/myspin/serversdk/maps/MySpinMap$OnMarkerDragListener;
    ...
    invoke-interface {p2, p1}, Lcom/bosch/myspin/serversdk/maps/MySpinMap$OnMarkerDragListener;->onMarkerDrag(Lcom/bosch/myspin/serversdk/maps/MySpinMarker;)V
...
.method public mySpinMarkerOnMarkerDragEnd(IDD)V
    ...
    sget-object v1, Lcom/bosch/myspin/serversdk/maps/MySpinMapView;->mMySpinMarkerList:Ljava/util/List;

    invoke-interface {v1, p1}, Ljava/util/List;->get(I)Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Lcom/bosch/myspin/serversdk/maps/MySpinMarker;

    invoke-interface {v0, v1}, Lcom/bosch/myspin/serversdk/maps/MySpinMap$OnMarkerDragListener;->onMarkerDragEnd(Lcom/bosch/myspin/serversdk/maps/MySpinMarker;)V
    ...
    .line 206
    sget-object p2, Lcom/bosch/myspin/serversdk/maps/MySpinJavaScriptHandler;->a:Landroid/app/Activity;

    new-instance p3, Lcom/bosch/myspin/serversdk/maps/MySpinJavaScriptHandler$1;

    invoke-direct {p3, p0, p1, v0}, Lcom/bosch/myspin/serversdk/maps/MySpinJavaScriptHandler$1;-><init>(Lcom/bosch/myspin/serversdk/maps/MySpinJavaScriptHandler;ILcom/bosch/myspin/serversdk/maps/MySpinLatLng;)V
...
.method public mySpinMarkerOnMarkerDragStart(IDD)V
    ...
    .line 176
    invoke-interface {p2, p1}, Lcom/bosch/myspin/serversdk/maps/MySpinMap$OnMarkerDragListener;->onMarkerDragStart(Lcom/bosch/myspin/serversdk/maps/MySpinMarker;)V
