...
.method public constructor <init>(Ljava/lang/String;Lcom/moat/analytics/mobile/a;Lcom/moat/analytics/mobile/ap;)V
    ...
    iput p1, p0, Lcom/moat/analytics/mobile/k;->p:I

    const/4 p1, 0x0

    iput-boolean p1, p0, Lcom/moat/analytics/mobile/k;->q:Z
...
.method private k()V
    ...
    iget-object v0, p0, Lcom/moat/analytics/mobile/k;->e:Ljava/util/Map;

    iget-object v1, p0, Lcom/moat/analytics/mobile/k;->f:Ljava/lang/ref/WeakReference;

    invoke-virtual {v1}, Ljava/lang/ref/WeakReference;->get()Ljava/lang/Object;

    move-result-object v1

    iget-object v2, p0, Lcom/moat/analytics/mobile/k;->g:Ljava/lang/ref/WeakReference;
    ...
    invoke-super {p0, v0, v1, v2}, Lcom/moat/analytics/mobile/m;->a(Ljava/util/Map;Ljava/lang/Object;Landroid/view/View;)Z
...
.method protected a()Ljava/util/Map;
    ...
    iget-object v1, p0, Lcom/moat/analytics/mobile/k;->g:Ljava/lang/ref/WeakReference;
...
.method protected h()Z
    ...
    iget v1, p0, Lcom/moat/analytics/mobile/k;->p:I
    ...
    sget-object v2, Lcom/moat/analytics/mobile/o;->a:Lcom/moat/analytics/mobile/o;
    ...
    :goto_0
    iget v2, p0, Lcom/moat/analytics/mobile/k;->o:I
...
.method public onPlayerError(Lcom/google/android/exoplayer/ExoPlaybackException;)V
    ...
    const-string p1, "received player error"

    invoke-virtual {p0, p1}, Lcom/moat/analytics/mobile/k;->a(Ljava/lang/String;)V

    new-instance p1, Ljava/util/HashMap;

    invoke-direct {p1}, Ljava/util/HashMap;-><init>()V

    new-instance p1, Lcom/moat/analytics/mobile/MoatAdEvent;
    ...
    invoke-direct {p1, v0, v1}, Lcom/moat/analytics/mobile/MoatAdEvent;-><init>(Lcom/moat/analytics/mobile/MoatAdEventType;Ljava/lang/Integer;)V

    invoke-virtual {p0, p1}, Lcom/moat/analytics/mobile/k;->dispatchEvent(Lcom/moat/analytics/mobile/MoatAdEvent;)V
...
.method public onPlayerStateChanged(ZI)V
    ...
    const-string p1, "updated state from player: %d"
    ...
    iget v1, p0, Lcom/moat/analytics/mobile/k;->n:I
    ...
    :cond_1
    :goto_0
    iget-boolean p1, p0, Lcom/moat/analytics/mobile/k;->q:Z

    if-nez p1, :cond_2

    const-string p1, "player ready to play; starting tracking"
...
.method public trackVideoAd(Ljava/util/Map;Lcom/google/android/exoplayer/ExoPlayer;Landroid/view/View;)Z
    ...
    iput-object p1, p0, Lcom/moat/analytics/mobile/k;->f:Ljava/lang/ref/WeakReference;

    new-instance p1, Ljava/lang/ref/WeakReference;

    invoke-direct {p1, p3}, Ljava/lang/ref/WeakReference;-><init>(Ljava/lang/Object;)V

    iput-object p1, p0, Lcom/moat/analytics/mobile/k;->g:Ljava/lang/ref/WeakReference;
    ...
    iget-boolean p2, p0, Lcom/moat/analytics/mobile/k;->q:Z
    ...
    :cond_0
    const-string p1, "player might already be playing. start tracking it right away."
