...
.method private constructor <init>()V
    ...
    iput-boolean v0, p0, Lcom/moat/analytics/mobile/spot/w;->b:Z

    iput-boolean v0, p0, Lcom/moat/analytics/mobile/spot/w;->c:Z

    const/16 v1, 0xc8

    iput v1, p0, Lcom/moat/analytics/mobile/spot/w;->d:I

    new-instance v1, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v1, v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>(Z)V

    iput-object v1, p0, Lcom/moat/analytics/mobile/spot/w;->j:Ljava/util/concurrent/atomic/AtomicBoolean;

    const-wide/16 v1, 0x0

    iput-wide v1, p0, Lcom/moat/analytics/mobile/spot/w;->k:J

    new-instance v1, Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-direct {v1, v0}, Ljava/util/concurrent/atomic/AtomicInteger;-><init>(I)V

    iput-object v1, p0, Lcom/moat/analytics/mobile/spot/w;->l:Ljava/util/concurrent/atomic/AtomicInteger;

    new-instance v1, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v1, v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>(Z)V

    iput-object v1, p0, Lcom/moat/analytics/mobile/spot/w;->m:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method static declared-synchronized a()Lcom/moat/analytics/mobile/spot/w;
    ...
    const-class v0, Lcom/moat/analytics/mobile/spot/w;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lcom/moat/analytics/mobile/spot/w;->g:Lcom/moat/analytics/mobile/spot/w;

    if-nez v1, :cond_0

    new-instance v1, Lcom/moat/analytics/mobile/spot/w;

    invoke-direct {v1}, Lcom/moat/analytics/mobile/spot/w;-><init>()V

    sput-object v1, Lcom/moat/analytics/mobile/spot/w;->g:Lcom/moat/analytics/mobile/spot/w;
...
.method static synthetic b(Lcom/moat/analytics/mobile/spot/w;)Landroid/os/Handler;
    ...
    iget-object p0, p0, Lcom/moat/analytics/mobile/spot/w;->i:Landroid/os/Handler;
...
.method static synthetic c(Lcom/moat/analytics/mobile/spot/w;)Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object p0, p0, Lcom/moat/analytics/mobile/spot/w;->j:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method static synthetic d(Lcom/moat/analytics/mobile/spot/w;)Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object p0, p0, Lcom/moat/analytics/mobile/spot/w;->m:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method private d()V
    ...
    sget-object v3, Lcom/moat/analytics/mobile/spot/w;->h:Ljava/util/Queue;
    ...
    check-cast v4, Lcom/moat/analytics/mobile/spot/w$c;

    iget-object v4, v4, Lcom/moat/analytics/mobile/spot/w$c;->a:Ljava/lang/Long;
...
.method static synthetic e(Lcom/moat/analytics/mobile/spot/w;)Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object p0, p0, Lcom/moat/analytics/mobile/spot/w;->l:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method b()V
    ...
    iget-wide v0, p0, Lcom/moat/analytics/mobile/spot/w;->e:J
