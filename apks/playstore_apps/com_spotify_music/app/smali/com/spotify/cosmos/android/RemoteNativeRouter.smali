...
.field private static final TAG:Ljava/lang/String; = "RemoteNativeRouter"
...
.method static synthetic access$000(Lcom/spotify/cosmos/android/RemoteNativeRouter;)Z
    ...
    .line 25
    iget-boolean p0, p0, Lcom/spotify/cosmos/android/RemoteNativeRouter;->mRouterDestroyed:Z
...
.method static synthetic access$100(Lcom/spotify/cosmos/android/RemoteNativeRouter;)Ljava/lang/Object;
    ...
    .line 25
    iget-object p0, p0, Lcom/spotify/cosmos/android/RemoteNativeRouter;->mSubscriptionMutex:Ljava/lang/Object;
...
.method static synthetic access$200(Lcom/spotify/cosmos/android/RemoteNativeRouter;)Landroid/util/SparseArray;
    ...
    .line 25
    iget-object p0, p0, Lcom/spotify/cosmos/android/RemoteNativeRouter;->mSubscriptions:Landroid/util/SparseArray;
...
.method private checkCallbackCollision(ILjava/lang/String;)V
    ...
    const-string v2, "Callback ID collision"

    aput-object v2, v0, v4

    new-instance v2, Lcom/spotify/cosmos/android/ResolverException;

    invoke-direct {v2, p1}, Lcom/spotify/cosmos/android/ResolverException;-><init>(Ljava/lang/String;)V
...
.method private doResolve(Lcom/spotify/cosmos/router/Request;Lcom/spotify/cosmos/android/RemoteNativeRouter$SubscriptionResolveCallback;)I
    ...
    const-string p2, "Router already destroyed"
    ...
    .line 201
    sget-object p2, Lcom/spotify/cosmos/android/RemoteNativeRouter;->sRequestInterceptor:Lcom/spotify/cosmos/android/util/CosmosRequestInterceptor;

    invoke-interface {p2, p1, v1}, Lcom/spotify/cosmos/android/util/CosmosRequestInterceptor;->resolve(Lcom/spotify/cosmos/router/Request;Lcom/spotify/cosmos/router/ResolveCallback;)Z
...
.method public destroy()V
    ...
    :goto_0
    :try_start_0
    iget-object v2, p0, Lcom/spotify/cosmos/android/RemoteNativeRouter;->mSubscriptions:Landroid/util/SparseArray;
    ...
    check-cast v2, Lcom/spotify/cosmos/android/RemoteNativeRouter$SubscriptionResolveCallback;

    if-eqz v2, :cond_1

    .line 248
    invoke-virtual {v2}, Lcom/spotify/cosmos/android/RemoteNativeRouter$SubscriptionResolveCallback;->destroy()V
    ...
    .line 251
    :cond_2
    iget-object v1, p0, Lcom/spotify/cosmos/android/RemoteNativeRouter;->mSubscriptions:Landroid/util/SparseArray;
...
.method public resolve(Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;[BLcom/spotify/cosmos/android/ResolverCallbackReceiver;)I
    ...
    .line 162
    new-instance p5, Lcom/spotify/cosmos/android/RemoteNativeRouter$NullResolveCallback;

    invoke-direct {p5, p0}, Lcom/spotify/cosmos/android/RemoteNativeRouter$NullResolveCallback;-><init>(Lcom/spotify/cosmos/android/RemoteNativeRouter;)V
    ...
    invoke-direct {v0, p0, p5, v1}, Lcom/spotify/cosmos/android/RemoteNativeRouter$CancellingResolveCallback;-><init>(Lcom/spotify/cosmos/android/RemoteNativeRouter;Lcom/spotify/cosmos/android/ResolverCallbackReceiver;Lcom/spotify/cosmos/android/RemoteNativeRouter$1;)V
    ...
    invoke-direct {p0, v0, p5}, Lcom/spotify/cosmos/android/RemoteNativeRouter;->doResolve(Lcom/spotify/cosmos/router/Request;Lcom/spotify/cosmos/android/RemoteNativeRouter$SubscriptionResolveCallback;)I
...
.method public subscribe(Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;[BLcom/spotify/cosmos/android/ResolverCallbackReceiver;)I
    ...
    const-string p2, "Cannot call subscribe with null callback receiver"
    ...
    new-instance p1, Lcom/spotify/cosmos/android/RemoteNativeRouter$SubscriptionResolveCallback;

    const/4 p2, 0x0

    invoke-direct {p1, p0, p5, p2}, Lcom/spotify/cosmos/android/RemoteNativeRouter$SubscriptionResolveCallback;-><init>(Lcom/spotify/cosmos/android/RemoteNativeRouter;Lcom/spotify/cosmos/android/ResolverCallbackReceiver;Lcom/spotify/cosmos/android/RemoteNativeRouter$1;)V

    invoke-direct {p0, v0, p1}, Lcom/spotify/cosmos/android/RemoteNativeRouter;->doResolve(Lcom/spotify/cosmos/router/Request;Lcom/spotify/cosmos/android/RemoteNativeRouter$SubscriptionResolveCallback;)I
...
.method public unsubscribe(I)V
    ...
    check-cast v1, Lcom/spotify/cosmos/android/RemoteNativeRouter$SubscriptionResolveCallback;

    if-eqz v1, :cond_1

    .line 228
    invoke-virtual {v1}, Lcom/spotify/cosmos/android/RemoteNativeRouter$SubscriptionResolveCallback;->destroy()V
