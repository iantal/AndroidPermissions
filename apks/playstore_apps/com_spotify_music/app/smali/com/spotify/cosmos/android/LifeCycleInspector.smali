...
.method private static addRef(Ljava/lang/String;Lcom/spotify/cosmos/android/Resolver;)V
    ...
    .line 84
    const-class v0, Lcom/spotify/cosmos/android/Cosmos;

    monitor-enter v0

    .line 85
    :try_start_0
    sget-object v1, Lcom/spotify/cosmos/android/LifeCycleInspector;->REFS:Ljava/util/Map;
...
.method private static assertNoConnectedResolvers()V
    ...
    .line 71
    invoke-virtual {v6}, Lcom/spotify/cosmos/android/Resolver;->isConnected()Z
    ...
    const-string v3, "Shutdown stopped, Cosmos resolver is still connected ~ %s"
    ...
    invoke-static {v3, v6}, Lcom/spotify/base/java/logging/Logger;->e(Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public static getConnectedResolvers()Ljava/util/List;
    ...
    .line 57
    invoke-virtual {v5}, Lcom/spotify/cosmos/android/Resolver;->isConnected()Z
...
.method private static logCosmosRefs()V
    ...
    .line 115
    invoke-virtual {v3}, Lcom/spotify/cosmos/android/Resolver;->isConnected()Z

    move-result v4

    if-nez v4, :cond_2

    invoke-virtual {v3}, Lcom/spotify/cosmos/android/Resolver;->isConnecting()Z
