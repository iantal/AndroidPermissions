...
.method protected onError(Ljava/lang/Throwable;Lcom/spotify/mobile/android/cosmos/ParsingCallbackReceiver$ErrorCause;)V
    ...
    .line 257
    iget-object p1, p0, Lcom/spotify/mobile/android/cosmos/player/v2/ResolverPlayer$2;->val$callback:Lcom/spotify/mobile/android/cosmos/player/v2/Player$PreparePlayCallback;

    invoke-interface {p1}, Lcom/spotify/mobile/android/cosmos/player/v2/Player$PreparePlayCallback;->onPreparePlayFailed()V
...
.method protected onResolved(Lcom/spotify/cosmos/router/Response;Lcom/spotify/mobile/android/cosmos/player/v2/internal/PlayerSessionParameters;)V
    ...
    .line 250
    iget-object p1, p0, Lcom/spotify/mobile/android/cosmos/player/v2/ResolverPlayer$2;->val$playerSession:Lcom/spotify/mobile/android/cosmos/player/v2/PlayerSession;

    iget-object p2, p2, Lcom/spotify/mobile/android/cosmos/player/v2/internal/PlayerSessionParameters;->sessionUri:Ljava/lang/String;

    invoke-virtual {p1, p2}, Lcom/spotify/mobile/android/cosmos/player/v2/PlayerSession;->setSessionUri(Ljava/lang/String;)V

    .line 251
    iget-object p1, p0, Lcom/spotify/mobile/android/cosmos/player/v2/ResolverPlayer$2;->val$callback:Lcom/spotify/mobile/android/cosmos/player/v2/Player$PreparePlayCallback;

    iget-object p2, p0, Lcom/spotify/mobile/android/cosmos/player/v2/ResolverPlayer$2;->val$playerSession:Lcom/spotify/mobile/android/cosmos/player/v2/PlayerSession;

    invoke-interface {p1, p2}, Lcom/spotify/mobile/android/cosmos/player/v2/Player$PreparePlayCallback;->onPreparePlaySuccess(Lcom/spotify/mobile/android/cosmos/player/v2/PlayerSession;)V
