...
.method public final replayRequests(Lcom/spotify/cosmos/router/Router;)V
    ...
    check-cast v1, Lcom/spotify/mobile/android/cosmos/router/CosmosRequestQueue$QueuedRequest;

    .line 24
    invoke-static {v1}, Lcom/spotify/mobile/android/cosmos/router/CosmosRequestQueue$QueuedRequest;->access$000(Lcom/spotify/mobile/android/cosmos/router/CosmosRequestQueue$QueuedRequest;)Lcom/spotify/cosmos/router/Request;

    move-result-object v2

    invoke-static {v1}, Lcom/spotify/mobile/android/cosmos/router/CosmosRequestQueue$QueuedRequest;->access$100(Lcom/spotify/mobile/android/cosmos/router/CosmosRequestQueue$QueuedRequest;)Lcom/spotify/cosmos/router/ResolveCallback;

    move-result-object v1

    invoke-interface {p1, v2, v1}, Lcom/spotify/cosmos/router/Router;->resolve(Lcom/spotify/cosmos/router/Request;Lcom/spotify/cosmos/router/ResolveCallback;)V

    goto :goto_0

    .line 26
    :cond_0
    iget-object p1, p0, Lcom/spotify/mobile/android/cosmos/router/CosmosRequestQueue;->mQueuedRequests:Ljava/util/concurrent/ConcurrentLinkedQueue;
