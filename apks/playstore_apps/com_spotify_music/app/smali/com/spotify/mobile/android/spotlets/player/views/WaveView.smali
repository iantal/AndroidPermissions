...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lcom/spotify/mobile/android/spotlets/player/views/WaveView;->e:[I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object p1, p0, Lcom/spotify/mobile/android/spotlets/player/views/WaveView;->a:Landroid/graphics/Path;
    ...
    iput-object p1, p0, Lcom/spotify/mobile/android/spotlets/player/views/WaveView;->b:Landroid/graphics/Matrix;
    ...
    iput-object p1, p0, Lcom/spotify/mobile/android/spotlets/player/views/WaveView;->c:Landroid/graphics/Matrix;
    ...
    iput-object p1, p0, Lcom/spotify/mobile/android/spotlets/player/views/WaveView;->d:Landroid/graphics/Paint;
    ...
    iput-object p1, p0, Lcom/spotify/mobile/android/spotlets/player/views/WaveView;->g:Landroid/graphics/LinearGradient;

    .line 41
    iget-object p1, p0, Lcom/spotify/mobile/android/spotlets/player/views/WaveView;->d:Landroid/graphics/Paint;
    ...
    iget-object p2, p0, Lcom/spotify/mobile/android/spotlets/player/views/WaveView;->g:Landroid/graphics/LinearGradient;
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    .line 98
    iget-object p1, p0, Lcom/spotify/mobile/android/spotlets/player/views/WaveView;->b:Landroid/graphics/Matrix;
    ...
    .line 100
    iget-object p1, p0, Lcom/spotify/mobile/android/spotlets/player/views/WaveView;->a:Landroid/graphics/Path;

    iget-object v0, p0, Lcom/spotify/mobile/android/spotlets/player/views/WaveView;->b:Landroid/graphics/Matrix;
...
.method protected onLayout(ZIIII)V
    ...
    iput p2, p0, Lcom/spotify/mobile/android/spotlets/player/views/WaveView;->h:I
    ...
    iput p2, p0, Lcom/spotify/mobile/android/spotlets/player/views/WaveView;->i:I

    .line 68
    iget p2, p0, Lcom/spotify/mobile/android/spotlets/player/views/WaveView;->i:I

    iget p3, p0, Lcom/spotify/mobile/android/spotlets/player/views/WaveView;->h:I

    .line 1053
    iget-object p4, p0, Lcom/spotify/mobile/android/spotlets/player/views/WaveView;->a:Landroid/graphics/Path;
    ...
    invoke-virtual {p4, p5, p2}, Landroid/graphics/Path;->moveTo(FF)V
    ...
    invoke-virtual {v0, v2, v3, v1, p5}, Landroid/graphics/Path;->rQuadTo(FFFF)V

    .line 1058
    iget-object v0, p0, Lcom/spotify/mobile/android/spotlets/player/views/WaveView;->a:Landroid/graphics/Path;

    invoke-virtual {v0, v2, p2, v1, p5}, Landroid/graphics/Path;->rQuadTo(FFFF)V
    ...
    .line 71
    iget-object p1, p0, Lcom/spotify/mobile/android/spotlets/player/views/WaveView;->c:Landroid/graphics/Matrix;

    iget p2, p0, Lcom/spotify/mobile/android/spotlets/player/views/WaveView;->h:I
    ...
    .line 72
    iget-object p1, p0, Lcom/spotify/mobile/android/spotlets/player/views/WaveView;->g:Landroid/graphics/LinearGradient;

    iget-object p2, p0, Lcom/spotify/mobile/android/spotlets/player/views/WaveView;->c:Landroid/graphics/Matrix;
