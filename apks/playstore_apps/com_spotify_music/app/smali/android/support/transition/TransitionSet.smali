...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-static {p1, p2, v1, v0, v0}, Lmp;->a(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;II)I
...
.method public static synthetic a(Landroid/support/transition/TransitionSet;)Z
    ...
    .line 60
    iget-boolean p0, p0, Landroid/support/transition/TransitionSet;->k:Z
...
.method public static synthetic c(Landroid/support/transition/TransitionSet;)I
    ...
    .line 60
    iget p0, p0, Landroid/support/transition/TransitionSet;->j:I
...
.method public final bridge synthetic a(Lhe;)Landroid/support/transition/Transition;
    .locals 0

    .line 5255
    invoke-super {p0, p1}, Landroid/support/transition/Transition;->a(Lhe;)Landroid/support/transition/Transition;
...
.method public final a(I)Landroid/support/transition/TransitionSet;
    ...
    .line 112
    iput-boolean p1, p0, Landroid/support/transition/TransitionSet;->i:Z
...
.method final a(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 575
    :goto_0
    iget-object v2, p0, Landroid/support/transition/TransitionSet;->h:Ljava/util/ArrayList;
...
.method protected final a(Landroid/view/ViewGroup;Lhn;Lhn;Ljava/util/ArrayList;Ljava/util/ArrayList;)V
    .locals 12
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1379
    iget-wide v1, v0, Landroid/support/transition/Transition;->a:J

    .line 412
    iget-object v3, v0, Landroid/support/transition/TransitionSet;->h:Ljava/util/ArrayList;
    ...
    .line 414
    iget-object v5, v0, Landroid/support/transition/TransitionSet;->h:Ljava/util/ArrayList;
    ...
    .line 417
    iget-boolean v5, v0, Landroid/support/transition/TransitionSet;->i:Z
    ...
    .line 2379
    :cond_0
    iget-wide v9, v6, Landroid/support/transition/Transition;->a:J
    ...
    .line 425
    invoke-virtual/range {v6 .. v11}, Landroid/support/transition/Transition;->a(Landroid/view/ViewGroup;Lhn;Lhn;Ljava/util/ArrayList;Ljava/util/ArrayList;)V
...
.method public final a(Lhd;)V
    ...
    .line 565
    invoke-super {p0, p1}, Landroid/support/transition/Transition;->a(Lhd;)V
    ...
    invoke-virtual {v2, p1}, Landroid/support/transition/Transition;->a(Lhd;)V
...
.method public final a(Lhm;)V
    ...
    .line 471
    iget-object v2, p1, Lhm;->b:Landroid/view/View;
    ...
    .line 472
    invoke-virtual {v1, p1}, Landroid/support/transition/Transition;->a(Lhm;)V

    .line 473
    iget-object v2, p1, Lhm;->c:Ljava/util/ArrayList;
...
.method public final bridge synthetic b(Lhe;)Landroid/support/transition/Transition;
    .locals 0

    .line 4333
    invoke-super {p0, p1}, Landroid/support/transition/Transition;->b(Lhe;)Landroid/support/transition/Transition;
...
.method protected final b()V
    ...
    invoke-direct {v0, p0}, Lhj;-><init>(Landroid/support/transition/TransitionSet;)V
    ...
    .line 3365
    invoke-virtual {v2, v0}, Landroid/support/transition/Transition;->a(Lhe;)Landroid/support/transition/Transition;
    ...
    invoke-direct {v3, v2}, Landroid/support/transition/TransitionSet$1;-><init>(Landroid/support/transition/Transition;)V

    invoke-virtual {v1, v3}, Landroid/support/transition/Transition;->a(Lhe;)Landroid/support/transition/Transition;
    ...
    .line 462
    invoke-virtual {v1}, Landroid/support/transition/Transition;->b()V
...
.method public final b(Lhm;)V
    ...
    .line 484
    invoke-virtual {v1, p1}, Landroid/support/transition/Transition;->b(Lhm;)V
...
.method final c(Lhm;)V
    .locals 3

    .line 493
    invoke-super {p0, p1}, Landroid/support/transition/Transition;->c(Lhm;)V
    ...
    invoke-virtual {v2, p1}, Landroid/support/transition/Transition;->c(Lhm;)V
...
.method public final f()Landroid/support/transition/Transition;
    ...
    .line 587
    iget-object v3, p0, Landroid/support/transition/TransitionSet;->h:Ljava/util/ArrayList;
    ...
    invoke-virtual {v3}, Landroid/support/transition/Transition;->f()Landroid/support/transition/Transition;
