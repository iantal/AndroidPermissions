...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {v0, p0}, Lue;-><init>(Landroid/support/v4/view/PagerTitleStrip;)V

    iput-object v0, p0, Landroid/support/v4/view/PagerTitleStrip;->l:Lue;
    ...
    invoke-static {v2, v1}, Lxy;->a(Landroid/widget/TextView;I)V
    ...
    iput p2, p0, Landroid/support/v4/view/PagerTitleStrip;->g:I
    ...
    .line 2190
    iget p2, p0, Landroid/support/v4/view/PagerTitleStrip;->p:I

    shl-int/lit8 p2, p2, 0x18

    iget v2, p0, Landroid/support/v4/view/PagerTitleStrip;->g:I
    ...
    invoke-static {p2}, Landroid/support/v4/view/PagerTitleStrip;->a(Landroid/widget/TextView;)V
...
.method public a(IFZ)V
    ...
    .line 4566
    iget-object v3, v3, Landroid/support/v4/view/ViewPager;->b:Lud;

    .line 331
    invoke-virtual {v0, v1, v3}, Landroid/support/v4/view/PagerTitleStrip;->a(ILud;)V
    ...
    .line 408
    iget v1, v0, Landroid/support/v4/view/PagerTitleStrip;->f:I
...
.method public final a(ILud;)V
    ...
    .line 272
    invoke-virtual {p2, v3}, Lud;->b(I)Ljava/lang/CharSequence;
    ...
    .line 277
    invoke-virtual {p2, p1}, Lud;->b(I)Ljava/lang/CharSequence;
...
.method public final a(Lud;Lud;)V
    .locals 1

    if-eqz p1, :cond_0

    .line 314
    iget-object v0, p0, Landroid/support/v4/view/PagerTitleStrip;->l:Lue;

    invoke-virtual {p1, v0}, Lud;->b(Landroid/database/DataSetObserver;)V
    ...
    .line 318
    iget-object p1, p0, Landroid/support/v4/view/PagerTitleStrip;->l:Lue;

    invoke-virtual {p2, p1}, Lud;->a(Landroid/database/DataSetObserver;)V
    ...
    .line 324
    invoke-virtual {p0, p1, p2}, Landroid/support/v4/view/PagerTitleStrip;->a(ILud;)V
...
.method protected onAttachedToWindow()V
    ...
    .line 249
    iget-object v2, p0, Landroid/support/v4/view/PagerTitleStrip;->l:Lue;

    invoke-virtual {v0, v2}, Landroid/support/v4/view/ViewPager;->c(Lvc;)Lvc;

    .line 250
    iget-object v2, p0, Landroid/support/v4/view/PagerTitleStrip;->l:Lue;

    invoke-virtual {v0, v2}, Landroid/support/v4/view/ViewPager;->a(Lvb;)V
    ...
    :goto_0
    invoke-virtual {p0, v0, v1}, Landroid/support/v4/view/PagerTitleStrip;->a(Lud;Lud;)V
...
.method protected onDetachedFromWindow()V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/view/ViewPager;->c(Lvc;)Lvc;
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/view/ViewPager;->b(Lvb;)V
...
.method protected onLayout(ZIIII)V
    ...
    .line 457
    :cond_0
    iget p1, p0, Landroid/support/v4/view/PagerTitleStrip;->h:I
