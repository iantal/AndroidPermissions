...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v2, p0, Landroid/support/v7/widget/SwitchCompat;->w:Landroid/view/VelocityTracker;
    ...
    .line 221
    sget-object v2, Laap;->cn:[I

    invoke-static {p1, p2, v2, p3, v1}, Lalf;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Lalf;
    ...
    iput-object p3, p0, Landroid/support/v7/widget/SwitchCompat;->g:Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p2, p3}, Lalf;->c(I)Ljava/lang/CharSequence;
    ...
    invoke-virtual {p2, p3, v3}, Lalf;->a(IZ)Z

    move-result p3

    iput-boolean p3, p0, Landroid/support/v7/widget/SwitchCompat;->r:Z
    ...
    invoke-virtual {p2, p3, v1}, Lalf;->a(IZ)Z

    move-result p3

    iput-boolean p3, p0, Landroid/support/v7/widget/SwitchCompat;->o:Z
    ...
    .line 244
    iput-object p3, p0, Landroid/support/v7/widget/SwitchCompat;->c:Landroid/content/res/ColorStateList;
    ...
    .line 248
    invoke-virtual {p2, p3, v2}, Lalf;->a(II)I

    move-result p3

    .line 247
    invoke-static {p3, v0}, Lahw;->a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object p3

    .line 249
    iget-object v4, p0, Landroid/support/v7/widget/SwitchCompat;->d:Landroid/graphics/PorterDuff$Mode;

    if-eq v4, p3, :cond_3

    .line 250
    iput-object p3, p0, Landroid/support/v7/widget/SwitchCompat;->d:Landroid/graphics/PorterDuff$Mode;
    ...
    iget-object v4, p0, Landroid/support/v7/widget/SwitchCompat;->c:Landroid/content/res/ColorStateList;

    invoke-static {p3, v4}, Lnc;->a(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V
    ...
    invoke-static {p3, v4}, Lnc;->a(Landroid/graphics/drawable/Drawable;Landroid/graphics/PorterDuff$Mode;)V
    ...
    .line 259
    iput-object p3, p0, Landroid/support/v7/widget/SwitchCompat;->h:Landroid/content/res/ColorStateList;
    ...
    .line 264
    iget-object v4, p0, Landroid/support/v7/widget/SwitchCompat;->i:Landroid/graphics/PorterDuff$Mode;

    if-eq v4, p3, :cond_a

    .line 265
    iput-object p3, p0, Landroid/support/v7/widget/SwitchCompat;->i:Landroid/graphics/PorterDuff$Mode;
    ...
    iget-object v4, p0, Landroid/support/v7/widget/SwitchCompat;->h:Landroid/content/res/ColorStateList;
    ...
    .line 3296
    sget-object v4, Laap;->cC:[I

    invoke-static {p1, p3, v4}, Lalf;->a(Landroid/content/Context;I[I)Lalf;
    ...
    invoke-virtual {p3, v4}, Lalf;->e(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {p3, v4, v1}, Lalf;->e(II)I
    ...
    invoke-virtual {p3, v4, v2}, Lalf;->a(II)I
    ...
    invoke-virtual {p3, v5, v2}, Lalf;->a(II)I
    ...
    .line 3367
    :goto_2
    invoke-direct {p0, v4}, Landroid/support/v7/widget/SwitchCompat;->a(Landroid/graphics/Typeface;)V
    ...
    invoke-virtual {p3, v2, v1}, Lalf;->a(IZ)Z
    ...
    .line 4244
    :goto_6
    iget-object p3, p3, Lalf;->b:Landroid/content/res/TypedArray;
    ...
    iput p2, p0, Landroid/support/v7/widget/SwitchCompat;->t:I
    ...
    iput p1, p0, Landroid/support/v7/widget/SwitchCompat;->x:I
...
.method private c()I
    ...
    invoke-static {v1}, Lahw;->a(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    .line 1306
    :cond_0
    sget-object v1, Lahw;->a:Landroid/graphics/Rect;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v6}, Lahw;->a(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    .line 1141
    :cond_0
    sget-object v6, Lahw;->a:Landroid/graphics/Rect;
    ...
    .line 1183
    invoke-static {v0, v1, v2, v5, v4}, Lnc;->a(Landroid/graphics/drawable/Drawable;IIII)V
...
.method public drawableHotspotChanged(FF)V
    ...
    invoke-static {v0, p1, p2}, Lnc;->a(Landroid/graphics/drawable/Drawable;FF)V
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    .line 1212
    invoke-static {v4}, Lahw;->a(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
...
.method protected onLayout(ZIIII)V
    ...
    .line 1077
    iget-object p1, p0, Landroid/support/v7/widget/SwitchCompat;->b:Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p3}, Lahw;->a(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    .line 1094
    iget p4, p0, Landroid/support/v7/widget/SwitchCompat;->z:I
    ...
    .line 1124
    iput p4, p0, Landroid/support/v7/widget/SwitchCompat;->E:I
...
.method public onMeasure(II)V
    ...
    .line 810
    iget-object v3, p0, Landroid/support/v7/widget/SwitchCompat;->b:Landroid/graphics/drawable/Drawable;
    ...
    .line 817
    :goto_0
    iget-boolean v4, p0, Landroid/support/v7/widget/SwitchCompat;->r:Z
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 939
    iget v1, p0, Landroid/support/v7/widget/SwitchCompat;->u:F
    ...
    .line 953
    iput p1, p0, Landroid/support/v7/widget/SwitchCompat;->u:F
