...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcox;->a:Ljava/util/TreeSet;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcox;->b:Ljava/util/List;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcox;->c:Ljava/util/List;
...
.method private static a(Ljava/lang/String;Ljava/lang/String;)Ljava/util/TreeSet;
    ...
    invoke-static {v3}, Lcom/google/android/gms/auth/api/credentials/PasswordSpecification;->a(I)Z
...
.method public final a(Ljava/lang/String;)Lcox;
    .locals 2

    iget-object v0, p0, Lcox;->a:Ljava/util/TreeSet;

    const-string v1, "allowedChars"

    invoke-static {p1, v1}, Lcox;->a(Ljava/lang/String;Ljava/lang/String;)Ljava/util/TreeSet;
...
.method public final b()Lcom/google/android/gms/auth/api/credentials/PasswordSpecification;
    ...
    :cond_0
    iget-object v0, p0, Lcox;->c:Ljava/util/List;
    ...
    iget-object v1, p0, Lcox;->a:Ljava/util/TreeSet;
    ...
    iget-object v8, p0, Lcox;->b:Ljava/util/List;

    iget-object v9, p0, Lcox;->c:Ljava/util/List;

    iget v10, p0, Lcox;->d:I

    iget v11, p0, Lcox;->e:I
...
.method public final b(Ljava/lang/String;)Lcox;
    .locals 1

    const-string v0, "requiredChars"

    invoke-static {p1, v0}, Lcox;->a(Ljava/lang/String;Ljava/lang/String;)Ljava/util/TreeSet;

    move-result-object p1

    iget-object v0, p0, Lcox;->b:Ljava/util/List;
    ...
    iget-object p1, p0, Lcox;->c:Ljava/util/List;
