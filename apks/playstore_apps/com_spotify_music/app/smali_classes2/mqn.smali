...
.method public constructor <init>(Landroid/content/Context;Lizj;)V
    ...
    iput-object p1, p0, Lmqn;->c:Lcom/spotify/mobile/android/util/notifications/NotificationButtonHelper;
    ...
    iput-object p1, p0, Lmqn;->d:Lcom/spotify/mobile/android/util/notifications/NotificationButtonHelper;
    ...
    iput-object p1, p0, Lmqn;->e:Lcom/spotify/mobile/android/util/notifications/NotificationButtonHelper;
    ...
    iput-object p1, p0, Lmqn;->f:Lcom/spotify/mobile/android/util/notifications/NotificationButtonHelper;
    ...
    iput-object p1, p0, Lmqn;->g:Lcom/spotify/mobile/android/util/notifications/NotificationButtonHelper;
...
.method protected final a(Landroid/widget/RemoteViews;)V
    ...
    .line 39
    iget-object v3, p0, Lmqn;->b:Lizj;

    invoke-virtual {v3}, Lizj;->i()Z

    move-result v3

    .line 40
    iget-object v4, p0, Lmqn;->b:Lizj;
    ...
    .line 43
    iget-object v6, p0, Lmqn;->c:Lcom/spotify/mobile/android/util/notifications/NotificationButtonHelper;
    ...
    .line 46
    iget-object v1, p0, Lmqn;->d:Lcom/spotify/mobile/android/util/notifications/NotificationButtonHelper;
    ...
    .line 47
    iget-object v1, p0, Lmqn;->e:Lcom/spotify/mobile/android/util/notifications/NotificationButtonHelper;
    ...
    .line 50
    iget-object v1, p0, Lmqn;->f:Lcom/spotify/mobile/android/util/notifications/NotificationButtonHelper;

    invoke-virtual {v1, p1, v0}, Lcom/spotify/mobile/android/util/notifications/NotificationButtonHelper;->a(Landroid/widget/RemoteViews;Z)V

    .line 51
    iget-object v1, p0, Lmqn;->g:Lcom/spotify/mobile/android/util/notifications/NotificationButtonHelper;
    ...
    .line 54
    :cond_0
    iget-object v5, p0, Lmqn;->d:Lcom/spotify/mobile/android/util/notifications/NotificationButtonHelper;
    ...
    .line 72
    iget-object v0, p0, Lmqn;->f:Lcom/spotify/mobile/android/util/notifications/NotificationButtonHelper;
    ...
    .line 73
    iget-object v0, p0, Lmqn;->g:Lcom/spotify/mobile/android/util/notifications/NotificationButtonHelper;
...
.method protected final b()Landroid/widget/RemoteViews;
    ...
    iget-object v1, p0, Lmqn;->a:Landroid/content/Context;
    ...
    .line 99
    iget-object v3, p0, Lmqn;->a:Landroid/content/Context;

    iget-object v4, p0, Lmqn;->a:Landroid/content/Context;

    invoke-static {v4}, Lcom/spotify/music/spotlets/radio/service/RadioActionsService;->a(Landroid/content/Context;)Landroid/content/Intent;
    ...
    iget-object v7, p0, Lmqn;->a:Landroid/content/Context;

    invoke-static {v7}, Lcom/spotify/music/spotlets/radio/service/RadioActionsService;->b(Landroid/content/Context;)Landroid/content/Intent;

    move-result-object v7

    invoke-static {v4, v5, v7, v6}, Landroid/app/PendingIntent;->getService(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;

    move-result-object v4

    .line 101
    iget-object v5, p0, Lmqn;->a:Landroid/content/Context;

    iget-object v7, p0, Lmqn;->a:Landroid/content/Context;

    iget-object v8, v1, Lizo;->a:Ljava/lang/String;

    invoke-static {v7, v8}, Lcom/spotify/music/spotlets/radio/service/RadioActionsService;->a(Landroid/content/Context;Ljava/lang/String;)Landroid/content/Intent;

    move-result-object v7

    const/4 v8, 0x2

    invoke-static {v5, v8, v7, v6}, Landroid/app/PendingIntent;->getService(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
    ...
    iget-object v9, p0, Lmqn;->a:Landroid/content/Context;

    iget-object v1, v1, Lizo;->a:Ljava/lang/String;

    invoke-static {v9, v1}, Lcom/spotify/music/spotlets/radio/service/RadioActionsService;->c(Landroid/content/Context;Ljava/lang/String;)Landroid/content/Intent;

    move-result-object v1

    invoke-static {v7, v8, v1, v6}, Landroid/app/PendingIntent;->getService(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
    ...
    iget-object v8, p0, Lmqn;->a:Landroid/content/Context;
    ...
    invoke-static {v7, v9, v8, v6}, Landroid/app/PendingIntent;->getService(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
    ...
    iget-object v10, p0, Lmqn;->a:Landroid/content/Context;
    ...
    invoke-static {v8, v9, v10, v6}, Landroid/app/PendingIntent;->getService(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
    ...
    iget-object v11, p0, Lmqn;->a:Landroid/content/Context;
    ...
    invoke-static {v10, v9, v2, v6}, Landroid/app/PendingIntent;->getService(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
