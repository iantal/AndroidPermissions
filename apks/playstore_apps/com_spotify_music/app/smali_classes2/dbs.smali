...
.field public static final GOOGLE_PLAY_SERVICES_VERSION_CODE:I = 0xb2d540
    .annotation runtime Ljava/lang/Deprecated;
    .end annotation
.end field
...
.field private static zzfip:Z = false

.field private static zzfiq:Z = false

.field private static zzfir:Z = false

.field private static zzfis:Z = false
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ldbs;->zzfit:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    sput-object v0, Ldbs;->zzfiu:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static getErrorPendingIntent(ILandroid/content/Context;I)Landroid/app/PendingIntent;
    ...
    invoke-virtual {v0, p1, p0, p2}, Ldbk;->a(Landroid/content/Context;II)Landroid/app/PendingIntent;
...
.method public static isGooglePlayServicesAvailable(Landroid/content/Context;)I
    ...
    sget-object v1, Ldbs;->zzfiu:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-static {p0}, Lczb;->a(Landroid/content/Context;)I
    ...
    :cond_0
    sget v2, Ldbs;->GOOGLE_PLAY_SERVICES_VERSION_CODE:I

    if-eq v1, v2, :cond_1

    new-instance p0, Ljava/lang/IllegalStateException;

    sget v0, Ldbs;->GOOGLE_PLAY_SERVICES_VERSION_CODE:I
    ...
    :cond_1
    invoke-static {p0}, Lday;->b(Landroid/content/Context;)Z
    ...
    .line 1000
    sget-object v1, Lday;->a:Ljava/lang/Boolean;
    ...
    sput-object v1, Lday;->a:Ljava/lang/Boolean;
    ...
    sget-object p0, Ldbp;->a:[Ldbm;

    invoke-static {v4, p0}, Ldbt;->a(Landroid/content/pm/PackageInfo;[Ldbm;)Ldbm;
    ...
    :cond_7
    new-array v1, v2, [Ldbm;

    aput-object p0, v1, v3

    invoke-static {v6, v1}, Ldbt;->a(Landroid/content/pm/PackageInfo;[Ldbm;)Ldbm;
    ...
    invoke-static {v6, p0}, Ldbt;->a(Landroid/content/pm/PackageInfo;[Ldbm;)Ldbm;
    ...
    :cond_9
    sget p0, Ldbs;->GOOGLE_PLAY_SERVICES_VERSION_CODE:I
...
.method public static zzb(Landroid/content/Context;ILjava/lang/String;)Z
    ...
    invoke-static {p0, p1, p2}, Ldbf;->a(Landroid/content/Context;ILjava/lang/String;)Z
...
.method public static zzbn(Landroid/content/Context;)V
    ...
    invoke-static {p0, v0, v1}, Ldbk;->a(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;
...
.method public static zzcf(Landroid/content/Context;)Z
    ...
    invoke-virtual {v0, v3, v4}, Ldvc;->b(Ljava/lang/String;I)Landroid/content/pm/PackageInfo;
    ...
    new-array p0, v2, [Ldbm;

    sget-object v3, Ldbp;->a:[Ldbm;

    aget-object v3, v3, v2

    aput-object v3, p0, v1

    invoke-static {v0, p0}, Ldbt;->a(Landroid/content/pm/PackageInfo;[Ldbm;)Ldbm;

    move-result-object p0

    if-eqz p0, :cond_0

    sput-boolean v2, Ldbs;->zzfir:Z

    goto :goto_0

    :cond_0
    sput-boolean v1, Ldbs;->zzfir:Z
    :try_end_0
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static zze(Landroid/content/Context;I)Z
    ...
    invoke-static {p0, p1}, Ldbs;->zzv(Landroid/content/Context;Ljava/lang/String;)Z
...
.method public static zzf(Landroid/content/Context;I)Z
    ...
    invoke-static {p0, p1}, Ldbf;->a(Landroid/content/Context;I)Z
