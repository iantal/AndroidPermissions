...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ldas;->CREATOR:Landroid/os/Parcelable$Creator;
...
.method constructor <init>(IIILjava/lang/String;Landroid/os/IBinder;[Lcom/google/android/gms/common/api/Scope;Landroid/os/Bundle;Landroid/accounts/Account;[Ldbi;)V
    .locals 0
    ...
    iput-object p2, p0, Ldas;->a:Ljava/lang/String;

    goto :goto_0

    :cond_0
    iput-object p4, p0, Ldas;->a:Ljava/lang/String;
    ...
    invoke-direct {p1, p5}, Lcys;-><init>(Landroid/os/IBinder;)V

    :goto_1
    invoke-static {p1}, Lcyc;->a(Lcyq;)Landroid/accounts/Account;

    move-result-object p1

    :cond_3
    iput-object p1, p0, Ldas;->e:Landroid/accounts/Account;

    goto :goto_2

    :cond_4
    iput-object p5, p0, Ldas;->b:Landroid/os/IBinder;

    iput-object p8, p0, Ldas;->e:Landroid/accounts/Account;

    :goto_2
    iput-object p6, p0, Ldas;->c:[Lcom/google/android/gms/common/api/Scope;

    iput-object p7, p0, Ldas;->d:Landroid/os/Bundle;

    iput-object p9, p0, Ldas;->f:[Ldbi;
