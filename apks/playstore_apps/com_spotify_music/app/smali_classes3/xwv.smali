...
.method public constructor <init>()V
    ...
    invoke-direct {p0, v0}, Lxwv;-><init>(Lxum;)V
...
.method private declared-synchronized a()V
    ...
    .line 70
    :try_start_0
    iput-boolean v0, p0, Lxwv;->d:Z

    const/4 v0, 0x0

    .line 71
    iput-object v0, p0, Lxwv;->c:Ljavax/net/ssl/SSLSocketFactory;
    :try_end_0
...
.method private declared-synchronized b()Ljavax/net/ssl/SSLSocketFactory;
    ...
    .line 122
    :try_start_0
    iget-object v0, p0, Lxwv;->c:Ljavax/net/ssl/SSLSocketFactory;

    if-nez v0, :cond_0

    iget-boolean v0, p0, Lxwv;->d:Z

    if-nez v0, :cond_0

    .line 123
    invoke-direct {p0}, Lxwv;->c()Ljavax/net/ssl/SSLSocketFactory;
...
.method private declared-synchronized c()Ljavax/net/ssl/SSLSocketFactory;
    ...
    invoke-interface {v2}, Lxxb;->a()Ljava/io/InputStream;

    move-result-object v5

    .line 2039
    invoke-interface {v2}, Lxxb;->b()Ljava/lang/String;

    move-result-object v6

    invoke-direct {v4, v5, v6}, Lxxd;-><init>(Ljava/io/InputStream;Ljava/lang/String;)V

    .line 2040
    new-instance v5, Lxxc;

    invoke-direct {v5, v4, v2}, Lxxc;-><init>(Lxxd;Lxxb;)V
...
.method public final a(Lio/fabric/sdk/android/services/network/HttpMethod;Ljava/lang/String;Ljava/util/Map;)Lio/fabric/sdk/android/services/network/HttpRequest;
    ...
    .line 105
    iget-object p2, p0, Lxwv;->b:Lxxb;

    if-eqz p2, :cond_1

    .line 106
    invoke-direct {p0}, Lxwv;->b()Ljavax/net/ssl/SSLSocketFactory;
...
.method public final a(Lxxb;)V
    ...
    .line 64
    iput-object p1, p0, Lxwv;->b:Lxxb;

    .line 65
    invoke-direct {p0}, Lxwv;->a()V
