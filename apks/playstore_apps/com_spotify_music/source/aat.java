...
public final class aat
{
  ...
  private static final WeakHashMap<Context, SparseArray<aau>> b = new WeakHashMap(0);
  ...
  public static ColorStateList a(Context paramContext, int paramInt)
  {
    ...
    if (localColorStateList != null) {
      synchronized (c)
      {
        ...
        ((SparseArray)localObject1).append(paramInt, new aau(localColorStateList, paramContext.getResources().getConfiguration()));
        return localColorStateList;
      }
    }
    return lp.b(paramContext, paramInt);
  }
  
  public static Drawable b(Context paramContext, int paramInt)
  {
    return agu.a().a(paramContext, paramInt, false);
  }
  ...
  private static ColorStateList c(Context paramContext, int paramInt)
  {
    ...
    try
    {
      paramContext = aas.a((Resources)localObject1, (XmlPullParser)localObject2, paramContext.getTheme());
      return paramContext;
    }
  ...
  private static ColorStateList d(Context paramContext, int paramInt)
  {
    synchronized (c)
    {
      ...
      {
        aau localAau = (aau)localSparseArray.get(paramInt);
        if (localAau != null)
        {
          if (localAau.b.equals(paramContext.getResources().getConfiguration()))
          {
            paramContext = localAau.a;
            return paramContext;
          }
