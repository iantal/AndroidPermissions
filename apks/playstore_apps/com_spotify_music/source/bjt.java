  ...
  implements bjj
{
  ...
  public final Bitmap a(Bitmap paramBitmap, float paramFloat)
  {
    ...
    try
    {
      ...
      while (i < m)
      {
        ...
        paramBitmap.add(new bju(arrayOfInt, j, k, n, m, i, 1));
        localArrayList.add(new bju(arrayOfInt, j, k, n, m, i, 2));
        i += 1;
      }
    }
    ...
    try
    {
      bis.b.invokeAll(localArrayList);
    }
    catch (InterruptedException paramBitmap)
    {
      break label168;
    ...
    try
    {
      paramBitmap = Bitmap.createBitmap(arrayOfInt, j, k, Bitmap.Config.ARGB_8888);
      return paramBitmap;
    }
    catch (OutOfMemoryError paramBitmap)
    {
