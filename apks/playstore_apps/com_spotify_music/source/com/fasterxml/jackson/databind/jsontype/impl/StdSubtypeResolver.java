  ...
  implements Serializable
{
  ...
  protected void _collectAndResolve(AnnotatedClass paramAnnotatedClass, NamedType paramNamedType, MapperConfig<?> paramMapperConfig, AnnotationIntrospector paramAnnotationIntrospector, HashMap<NamedType, NamedType> paramHashMap)
  {
    ...
    if ((paramAnnotatedClass != null) && (!paramAnnotatedClass.isEmpty()))
    {
      ...
      while (paramAnnotatedClass.hasNext())
      {
        ...
        _collectAndResolve(AnnotatedClass.constructWithoutSuperTypes(paramNamedType.getType(), paramMapperConfig), paramNamedType, paramMapperConfig, paramAnnotationIntrospector, paramHashMap);
      }
    }
  }
  ...
  protected void _collectAndResolveByTypeId(AnnotatedClass paramAnnotatedClass, NamedType paramNamedType, MapperConfig<?> paramMapperConfig, Set<Class<?>> paramSet, Map<String, NamedType> paramMap)
  {
    ...
    if (paramSet.add(localNamedType.getType()))
    {
      ...
      if ((paramAnnotatedClass != null) && (!paramAnnotatedClass.isEmpty()))
      {
        ...
        {
          paramNamedType = (NamedType)paramAnnotatedClass.next();
          _collectAndResolveByTypeId(AnnotatedClass.constructWithoutSuperTypes(paramNamedType.getType(), paramMapperConfig), paramNamedType, paramMapperConfig, paramSet, paramMap);
        }
      }
    }
  }
    ...
    if (this._registeredSubtypes != null)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if (localClass.isAssignableFrom(localNamedType.getType())) {
          _collectAndResolve(AnnotatedClass.constructWithoutSuperTypes(localNamedType.getType(), paramMapperConfig), localNamedType, paramMapperConfig, localAnnotationIntrospector, localHashMap);
        }
      }
    }
  ...
  public Collection<NamedType> collectAndResolveSubtypesByClass(MapperConfig<?> paramMapperConfig, AnnotatedMember paramAnnotatedMember, JavaType paramJavaType)
  {
    ...
    if (paramJavaType == null) {
      paramJavaType = paramAnnotatedMember.getRawType();
    } else {
    ...
    if (paramAnnotatedMember != null)
    {
      ...
      while (paramAnnotatedMember.hasNext())
      {
        ...
        _collectAndResolve(AnnotatedClass.constructWithoutSuperTypes(((NamedType)localObject).getType(), paramMapperConfig), (NamedType)localObject, paramMapperConfig, localAnnotationIntrospector, localHashMap);
      }
    }
    paramAnnotatedMember = new NamedType(paramJavaType, null);
    _collectAndResolve(AnnotatedClass.constructWithoutSuperTypes(paramJavaType, paramMapperConfig), paramAnnotatedMember, paramMapperConfig, localAnnotationIntrospector, localHashMap);
    return new ArrayList(localHashMap.values());
  }
    ...
    if (this._registeredSubtypes != null)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if (paramAnnotatedClass.isAssignableFrom(localNamedType.getType())) {
          _collectAndResolveByTypeId(AnnotatedClass.constructWithoutSuperTypes(localNamedType.getType(), paramMapperConfig), localNamedType, paramMapperConfig, localHashSet, localLinkedHashMap);
        }
      }
    }
  ...
  {
    Object localObject = paramMapperConfig.getAnnotationIntrospector();
    if (paramJavaType == null) {
      paramJavaType = paramAnnotatedMember.getRawType();
    } else {
      paramJavaType = paramJavaType.getRawClass();
    ...
    HashSet localHashSet = new HashSet();
    LinkedHashMap localLinkedHashMap = new LinkedHashMap();
    NamedType localNamedType = new NamedType(paramJavaType, null);
    _collectAndResolveByTypeId(AnnotatedClass.constructWithoutSuperTypes(paramJavaType, paramMapperConfig), localNamedType, paramMapperConfig, localHashSet, localLinkedHashMap);
    paramAnnotatedMember = ((AnnotationIntrospector)localObject).findSubtypes(paramAnnotatedMember);
    if (paramAnnotatedMember != null)
    {
      paramAnnotatedMember = paramAnnotatedMember.iterator();
      while (paramAnnotatedMember.hasNext())
      {
        localObject = (NamedType)paramAnnotatedMember.next();
        _collectAndResolveByTypeId(AnnotatedClass.constructWithoutSuperTypes(((NamedType)localObject).getType(), paramMapperConfig), (NamedType)localObject, paramMapperConfig, localHashSet, localLinkedHashMap);
      }
    }
    if (this._registeredSubtypes != null)
    {
      ...
      {
        localObject = (NamedType)paramAnnotatedMember.next();
        if (paramJavaType.isAssignableFrom(((NamedType)localObject).getType())) {
          _collectAndResolveByTypeId(AnnotatedClass.constructWithoutSuperTypes(((NamedType)localObject).getType(), paramMapperConfig), (NamedType)localObject, paramMapperConfig, localHashSet, localLinkedHashMap);
        }
      }
    }
