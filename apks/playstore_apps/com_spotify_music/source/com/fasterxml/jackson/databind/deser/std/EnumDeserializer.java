  ...
  extends StdScalarDeserializer<Object>
{
  ...
  {
    CompactStringObjectMap localCompactStringObjectMap = this._lookupByToString;
    if (localCompactStringObjectMap == null) {
      try
      {
        paramDeserializationContext = EnumResolver.constructUnsafeUsingToString(_enumClass(), paramDeserializationContext.getAnnotationIntrospector()).constructLookup();
        this._lookupByToString = paramDeserializationContext;
  ...
  public Object deserialize(JsonParser paramJsonParser, DeserializationContext paramDeserializationContext)
  {
    ...
    if (paramDeserializationContext.isEnabled(DeserializationFeature.READ_ENUMS_USING_TO_STRING)) {
      localObject1 = _getToStringLookup(paramDeserializationContext);
    } else {
      localObject1 = this._lookupByName;
    }
    String str = paramJsonParser.getText();
    Object localObject2 = ((CompactStringObjectMap)localObject1).find(str);
