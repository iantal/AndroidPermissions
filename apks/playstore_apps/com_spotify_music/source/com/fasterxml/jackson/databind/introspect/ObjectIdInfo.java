...
public class ObjectIdInfo
{
  ...
  {
    StringBuilder localStringBuilder = new StringBuilder("ObjectIdInfo: propName=");
    localStringBuilder.append(this._propertyName);
    ...
    if (this._generator == null) {
      ...
      str = this._generator.getName();
    }
    localStringBuilder.append(str);
    localStringBuilder.append(", alwaysAsId=");
    localStringBuilder.append(this._alwaysAsId);
