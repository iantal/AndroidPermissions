...
public final class ProtoArtistOfflineState
  extends Message<ProtoArtistOfflineState, ProtoArtistOfflineState.Builder>
{
  public static final ProtoAdapter<ProtoArtistOfflineState> ADAPTER = new kby();
  ...
  public ProtoArtistOfflineState(String paramString1, String paramString2, Integer paramInteger, ByteString paramByteString)
  {
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    if (!(paramObject instanceof ProtoArtistOfflineState)) {
      return false;
    }
    paramObject = (ProtoArtistOfflineState)paramObject;
  ...
  public final String toString()
  {
    ...
    localStringBuilder = localStringBuilder.replace(0, 2, "ProtoArtistOfflineState{");
