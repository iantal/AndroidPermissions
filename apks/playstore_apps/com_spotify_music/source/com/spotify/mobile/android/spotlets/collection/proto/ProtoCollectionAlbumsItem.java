...
public final class ProtoCollectionAlbumsItem
  extends Message<ProtoCollectionAlbumsItem, ProtoCollectionAlbumsItem.Builder>
{
  public static final ProtoAdapter<ProtoCollectionAlbumsItem> ADAPTER = new kbz();
  ...
  public ProtoCollectionAlbumsItem(String paramString, Integer paramInteger1, Integer paramInteger2, ProtoAlbumMetadata paramProtoAlbumMetadata, ProtoAlbumCollectionState paramProtoAlbumCollectionState, ProtoAlbumOfflineState paramProtoAlbumOfflineState, ByteString paramByteString)
  {
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    if (!(paramObject instanceof ProtoCollectionAlbumsItem)) {
      return false;
    }
    paramObject = (ProtoCollectionAlbumsItem)paramObject;
    return (a().equals(paramObject.a())) && (xsi.a(this.header_field, paramObject.header_field)) && (xsi.a(this.headerless_index, paramObject.headerless_index)) && (xsi.a(this.add_time, paramObject.add_time)) && (xsi.a(this.album_metadata, paramObject.album_metadata)) && (xsi.a(this.collection_state, paramObject.collection_state)) && (xsi.a(this.offline_state, paramObject.offline_state));
  }
  ...
  public final int hashCode()
  {
    ...
    if (j == 0)
    {
      ...
      if (this.album_metadata != null) {
        m = this.album_metadata.hashCode();
      } else {
        m = 0;
      }
      int n;
  ...
  public final String toString()
  {
    ...
    localStringBuilder = localStringBuilder.replace(0, 2, "ProtoCollectionAlbumsItem{");
