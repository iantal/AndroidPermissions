...
public final class ProtoCollectionAlbumsResponse
  extends Message<ProtoCollectionAlbumsResponse, ProtoCollectionAlbumsResponse.Builder>
{
  public static final ProtoAdapter<ProtoCollectionAlbumsResponse> ADAPTER = new kca();
  ...
  public ProtoCollectionAlbumsResponse(List<ProtoCollectionAlbumsItem> paramList, Integer paramInteger1, Integer paramInteger2, Boolean paramBoolean, ByteString paramByteString)
  {
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    if (!(paramObject instanceof ProtoCollectionAlbumsResponse)) {
      return false;
    }
    paramObject = (ProtoCollectionAlbumsResponse)paramObject;
  ...
  public final String toString()
  {
    ...
    localStringBuilder = localStringBuilder.replace(0, 2, "ProtoCollectionAlbumsResponse{");
