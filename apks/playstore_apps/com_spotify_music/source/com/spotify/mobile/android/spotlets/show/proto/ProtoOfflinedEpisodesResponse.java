...
public final class ProtoOfflinedEpisodesResponse
  extends Message<ProtoOfflinedEpisodesResponse, ProtoOfflinedEpisodesResponse.Builder>
{
  public static final ProtoAdapter<ProtoOfflinedEpisodesResponse> ADAPTER = new lge();
  ...
  public ProtoOfflinedEpisodesResponse(List<ProtoOfflinedEpisodesRequestItem> paramList, Integer paramInteger1, Integer paramInteger2, Boolean paramBoolean, ByteString paramByteString)
  {
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    if (!(paramObject instanceof ProtoOfflinedEpisodesResponse)) {
      return false;
    }
    paramObject = (ProtoOfflinedEpisodesResponse)paramObject;
  ...
  public final String toString()
  {
    ...
    localStringBuilder = localStringBuilder.replace(0, 2, "ProtoOfflinedEpisodesResponse{");
