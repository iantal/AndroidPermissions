...
public final class ProtoShowRequestItem
  extends Message<ProtoShowRequestItem, ProtoShowRequestItem.Builder>
{
  public static final ProtoAdapter<ProtoShowRequestItem> ADAPTER = new lgk();
  ...
  public ProtoShowRequestItem(String paramString, ProtoEpisodeMetadata paramProtoEpisodeMetadata, ProtoEpisodeCollectionState paramProtoEpisodeCollectionState, ProtoEpisodeOfflineState paramProtoEpisodeOfflineState, ProtoEpisodePlayState paramProtoEpisodePlayState, ByteString paramByteString)
  {
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    if (!(paramObject instanceof ProtoShowRequestItem)) {
      return false;
    }
    paramObject = (ProtoShowRequestItem)paramObject;
  ...
  public final String toString()
  {
    ...
    localStringBuilder = localStringBuilder.replace(0, 2, "ProtoShowRequestItem{");
