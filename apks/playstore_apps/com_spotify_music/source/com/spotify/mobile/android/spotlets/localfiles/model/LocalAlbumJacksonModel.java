...
public class LocalAlbumJacksonModel
  implements JacksonModel, knj
{
  @JsonProperty("artist")
  ...
  public LocalAlbumJacksonModel(@JsonProperty("link") String paramString1, @JsonProperty("name") String paramString2, @JsonProperty("artist") LocalArtistJacksonModel paramLocalArtistJacksonModel, @JsonProperty("covers") CoversJacksonModel paramCoversJacksonModel, @JsonProperty("tracks") List<LocalTrackJacksonModel> paramList)
  {
    this.mUri = paramString1;
    this.mName = paramString2;
    this.mArtist = paramLocalArtistJacksonModel;
  ...
  {
    return gmb.a(paramContext, SpotifyIcon.b, false, true);
  }
  ...
  {
    paramGab = new StringBuilder();
    if (this.mArtist != null) {
      paramGab.append(this.mArtist.getTitle(paramContext));
    }
    if (paramGab.length() != 0) {
      paramGab.append(" • ");
    }
    int i = this.mTracksIds.size();
    paramGab.append(paramContext.getResources().getQuantityString(2131623954, i, new Object[] { Integer.valueOf(i) }));
    return paramGab.toString();
  }
