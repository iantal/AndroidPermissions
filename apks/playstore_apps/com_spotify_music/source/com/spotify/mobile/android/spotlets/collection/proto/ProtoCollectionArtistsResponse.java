...
public final class ProtoCollectionArtistsResponse
  extends Message<ProtoCollectionArtistsResponse, ProtoCollectionArtistsResponse.Builder>
{
  public static final ProtoAdapter<ProtoCollectionArtistsResponse> ADAPTER = new kcc();
  ...
  public ProtoCollectionArtistsResponse(List<ProtoCollectionArtistsItem> paramList, Integer paramInteger1, Integer paramInteger2, Boolean paramBoolean, ByteString paramByteString)
  {
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    if (!(paramObject instanceof ProtoCollectionArtistsResponse)) {
      return false;
    }
    paramObject = (ProtoCollectionArtistsResponse)paramObject;
  ...
  public final String toString()
  {
    ...
    localStringBuilder = localStringBuilder.replace(0, 2, "ProtoCollectionArtistsResponse{");
