...
public final class ProtoUnplayedEpisodesRequestItem
  extends Message<ProtoUnplayedEpisodesRequestItem, ProtoUnplayedEpisodesRequestItem.Builder>
{
  public static final ProtoAdapter<ProtoUnplayedEpisodesRequestItem> ADAPTER = new lgo();
  ...
  public ProtoUnplayedEpisodesRequestItem(String paramString, ProtoEpisodeMetadata paramProtoEpisodeMetadata, ProtoEpisodeCollectionState paramProtoEpisodeCollectionState, ProtoEpisodeOfflineState paramProtoEpisodeOfflineState, ProtoEpisodePlayState paramProtoEpisodePlayState, ByteString paramByteString)
  {
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    if (!(paramObject instanceof ProtoUnplayedEpisodesRequestItem)) {
      return false;
    }
    paramObject = (ProtoUnplayedEpisodesRequestItem)paramObject;
  ...
  public final String toString()
  {
    ...
    localStringBuilder = localStringBuilder.replace(0, 2, "ProtoUnplayedEpisodesRequestItem{");
