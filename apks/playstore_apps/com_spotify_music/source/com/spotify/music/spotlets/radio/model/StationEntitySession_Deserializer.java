...
public final class StationEntitySession_Deserializer
  extends StdDeserializer<StationEntitySession>
{
  ...
  private StationEntitySession a(JsonParser paramJsonParser, DeserializationContext paramDeserializationContext)
  {
    Object localObject2;
    int i;
    label118:
    ...
    for (;;)
    {
      ...
      if (1.a[paramJsonParser.getCurrentToken().ordinal()] == 1)
      {
        ...
        if (i != -1932791312)
        {
          if (i != -86827412)
          {
            if ((i != 100346066) || (!((String)localObject2).equals("index"))) {
              break label869;
            }
            i = 1;
            break label871;
          }
          if (!((String)localObject2).equals("lastUpdateTime")) {
            break label869;
          }
          i = 2;
          break label871;
        }
        if (!((String)localObject2).equals("radioStationModel")) {
          break label869;
        }
        i = 0;
        break label871;
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        localObject1 = new String[((List)localObject10).size()];
        ...
        break label179;
        localObject1 = new RadioStationModel(str, (String)localObject8, (String)localObject7, (String)localObject6, (String)localObject5, (String)localObject4, (String[])localObject1, (RelatedArtistModel[])localObject3, (PlayerTrack[])localObject2, (String)localObject9, bool);
        break;
        paramJsonParser.skipChildren();
        break;
        paramJsonParser = new StationEntitySession((RadioStationModel)localObject1, j, l);
