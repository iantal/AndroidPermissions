...
{
  public static final Parcelable.Creator<akw> CREATOR = new Parcelable.Creator() {};
  public int a;
  private int b;
  private int[] c;
  private boolean d;
  ...
  {
    StringBuilder localStringBuilder = new StringBuilder("FullSpanItem{mPosition=");
