...
public final class ahw
{
      ...
      for (;;)
      {
        try
        {
          if ((paramDrawable instanceof nd)) {
            localObject = ((nd)paramDrawable).a();
          }
  ...
  static void b(Drawable paramDrawable)
  {
    if ((Build.VERSION.SDK_INT == 21) && ("android.graphics.drawable.VectorDrawable".equals(paramDrawable.getClass().getName())))
    {
      ...
      if ((arrayOfInt != null) && (arrayOfInt.length != 0)) {
        paramDrawable.setState(alb.e);
      } else {
        paramDrawable.setState(alb.d);
      }
  ...
  public static boolean c(Drawable paramDrawable)
  {
    for (;;)
    {
      ...
      if ((paramDrawable instanceof nd))
      {
        paramDrawable = ((nd)paramDrawable).a();
      }
      else if ((paramDrawable instanceof abe))
      {
        paramDrawable = ((abe)paramDrawable).d;
      }
      else
      {
