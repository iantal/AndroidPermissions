  ...
  implements Parcelable.Creator<GameEntity>
{
  ...
  static void zza(GameEntity paramGameEntity, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zza(paramParcel, 10, paramGameEntity.zzrC());
    zzb.zza(paramParcel, 11, paramGameEntity.zzrE());
    zzb.zza(paramParcel, 12, paramGameEntity.zzrF(), false);
    zzb.zzc(paramParcel, 13, paramGameEntity.zzrG());
    ...
    zzb.zza(paramParcel, 22, paramGameEntity.zzrD());
  ...
  public GameEntity[] zzfm(int paramInt)
  {
