...
public abstract class zza
{
    ...
    extends zza
  {
    ...
    public boolean equals(Object paramObject)
    {
      ...
      ImageManager.OnImageLoadedListener localOnImageLoadedListener2 = (ImageManager.OnImageLoadedListener)paramObject.zzZm.get();
      if ((localOnImageLoadedListener2 != null) && (localOnImageLoadedListener1 != null) && (zzt.equal(localOnImageLoadedListener2, localOnImageLoadedListener1)) && (zzt.equal(paramObject.zzZc, this.zzZc))) {}
      for (boolean bool = true;; bool = false) {
        return bool;
      }
    }
