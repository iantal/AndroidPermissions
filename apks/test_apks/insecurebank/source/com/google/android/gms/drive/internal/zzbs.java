  ...
  implements Parcelable.Creator<UnsubscribeResourceRequest>
{
  ...
  static void zza(UnsubscribeResourceRequest paramUnsubscribeResourceRequest, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zzc(paramParcel, 1, paramUnsubscribeResourceRequest.zzCY);
    zzb.zza(paramParcel, 2, paramUnsubscribeResourceRequest.zzaeq, paramInt, false);
  ...
  public UnsubscribeResourceRequest[] zzdk(int paramInt)
  {
