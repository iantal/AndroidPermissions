  ...
  extends zzd
{
  ...
  {
    super(paramZzf);
    this.zzMr = new zzaj(paramZzf.zzhP());
  }
  ...
  private int zza(URL paramURL, byte[] paramArrayOfByte)
  {
    ...
    //   10: astore 7
    //   12: aload_1
    //   13: invokestatic 88	com/google/android/gms/common/internal/zzu:zzu	(Ljava/lang/Object;)Ljava/lang/Object;
    //   16: pop
    //   17: aload_2
    //   18: invokestatic 88	com/google/android/gms/common/internal/zzu:zzu	(Ljava/lang/Object;)Ljava/lang/Object;
    //   21: pop
    //   22: aload_0
    //   23: ldc 90
    //   25: aload_2
    ...
    //   34: aload_0
    //   35: invokevirtual 104	com/google/android/gms/analytics/internal/zzah:zzhZ	()Z
    //   38: ifeq +17 -> 55
    //   41: aload_0
    //   42: ldc 106
    ...
    //   202: astore 7
    //   204: aload_0
    //   205: invokevirtual 149	com/google/android/gms/analytics/internal/zzah:zzhl	()Lcom/google/android/gms/analytics/internal/zzb;
    //   208: invokevirtual 154	com/google/android/gms/analytics/internal/zzb:zzhL	()V
    //   211: aload 8
    //   213: astore_1
    //   214: aload 6
    //   216: astore 5
  ...
  private int zzb(URL paramURL, byte[] paramArrayOfByte)
  {
    ...
    //   4: astore 5
    //   6: aload_1
    //   7: invokestatic 88	com/google/android/gms/common/internal/zzu:zzu	(Ljava/lang/Object;)Ljava/lang/Object;
    //   10: pop
    //   11: aload_2
    //   12: invokestatic 88	com/google/android/gms/common/internal/zzu:zzu	(Ljava/lang/Object;)Ljava/lang/Object;
    //   15: pop
    //   16: aload_2
    ...
    //   75: aload_0
    //   76: invokevirtual 104	com/google/android/gms/analytics/internal/zzah:zzhZ	()Z
    //   79: ifeq +35 -> 114
    //   82: aload_0
    //   83: ldc -21
    ...
    //   178: aload_0
    //   179: invokevirtual 149	com/google/android/gms/analytics/internal/zzah:zzhl	()Lcom/google/android/gms/analytics/internal/zzb;
    //   182: invokevirtual 154	com/google/android/gms/analytics/internal/zzb:zzhL	()V
    //   185: aload_0
    //   186: ldc -100
    //   188: iload 4
  ...
  {
    if (paramZzab.zzjY()) {}
    for (paramZzab = zzhR().zzjk() + zzhR().zzjm() + "?" + paramString;; paramZzab = zzhR().zzjl() + zzhR().zzjm() + "?" + paramString) {
      try
      {
  ...
  private boolean zzg(zzab paramZzab)
  {
    ...
    if (!paramZzab.zzjY())
    {
      ...
      zzhQ().zza(paramZzab, "Error formatting hit for upload");
    }
    label43:
    label90:
    do
    {
      do
      {
        ...
        bool = false;
        break;
        if (((String)localObject).length() > zzhR().zziZ()) {
          break label90;
        }
      ...
      if (localObject == null)
      {
        zzhQ().zza(paramZzab, "Error formatting hit for POST upload");
        return true;
      }
      localObject = ((String)localObject).getBytes();
      if (localObject.length > zzhR().zzjb())
      {
        zzhQ().zza(paramZzab, "Hit payload exceeds size limit");
        return true;
      }
  ...
  {
    if (paramZzab.zzjY()) {}
    for (paramZzab = zzhR().zzjk() + zzhR().zzjm();; paramZzab = zzhR().zzjl() + zzhR().zzjm()) {
      try
      {
        paramZzab = new URL(paramZzab);
        return paramZzab;
  ...
  {
    return String.valueOf(paramZzab.zzjV());
  }
  
  private URL zzkh()
  {
    Object localObject = zzhR().zzjk() + zzhR().zzjn();
    try
    {
  ...
  String zza(zzab paramZzab, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      zza(localStringBuilder, "ht", String.valueOf(paramZzab.zzjW()));
    }
    ...
    zza(localStringBuilder, "qt", String.valueOf(zzhP().currentTimeMillis() - paramZzab.zzjW()));
    if (zzhR().zziW()) {
  ...
  List<Long> zza(List<zzab> paramList, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      localArrayList.add(Long.valueOf(localZzab.zzjV()));
    }
    label129:
    paramList = zzkh();
    if (paramList == null)
    ...
    {
      zza("Batched upload completed. Hits batched", Integer.valueOf(localZza.zzkj()));
      return localArrayList;
    }
    ...
    throws IOException
  {
    ...
    paramURL.setConnectTimeout(zzhR().zzjz());
    paramURL.setReadTimeout(zzhR().zzjA());
    paramURL.setInstanceFollowRedirects(false);
    paramURL.setRequestProperty("User-Agent", this.zzFP);
  ...
  public List<Long> zzf(List<zzab> paramList)
  {
    ...
    zzu.zzu(paramList);
    int j;
    if ((zzhR().zzjq().isEmpty()) || (!this.zzMr.zzv(zzhR().zzjj() * 1000L)))
    {
      bool = false;
      j = 0;
      if (j != 0) {
  ...
  List<Long> zzg(List<zzab> paramList)
  {
    ...
    do
    {
      ...
      localArrayList.add(Long.valueOf(localZzab.zzjV()));
    } while (localArrayList.size() < zzhR().zzjh());
    return localArrayList;
  }
  ...
  private class zza
  {
    ...
    public boolean zzj(zzab paramZzab)
    {
      ...
      if (localObject == null)
      {
        zzah.this.zzhQ().zza(paramZzab, "Error formatting hit");
        return true;
      }
      localObject = ((String)localObject).getBytes();
      int j = localObject.length;
      if (j > zzah.this.zzhR().zzja())
      {
        zzah.this.zzhQ().zza(paramZzab, "Hit size exceeds the maximum size limit");
        return true;
      }
      int i = j;
      if (this.zzMu.size() > 0) {
      ...
      if (i + this.zzMu.size() > zzah.this.zzhR().zzjc()) {
        return false;
      }
      try
      {
        if (this.zzMu.size() > 0) {
          this.zzMu.write(zzah.zzki());
        }
        this.zzMu.write((byte[])localObject);
        this.zzMt += 1;
        return true;
      }
