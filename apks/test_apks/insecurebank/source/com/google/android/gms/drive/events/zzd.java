  ...
  implements Parcelable.Creator<ChangesAvailableOptions>
{
  ...
  static void zza(ChangesAvailableOptions paramChangesAvailableOptions, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zzc(paramParcel, 1, paramChangesAvailableOptions.zzCY);
    zzb.zzc(paramParcel, 2, paramChangesAvailableOptions.zzadP);
    zzb.zza(paramParcel, 3, paramChangesAvailableOptions.zzadQ);
    zzb.zzc(paramParcel, 4, paramChangesAvailableOptions.zzadR, false);
    zzb.zzH(paramParcel, paramInt);
  }
  
  public ChangesAvailableOptions zzax(Parcel paramParcel)
  {
    boolean bool = false;
