  ...
  implements Parcelable.Creator<MaskedWalletRequest>
{
  ...
  static void zza(MaskedWalletRequest paramMaskedWalletRequest, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zza(paramParcel, 2, paramMaskedWalletRequest.zzaQn, false);
    zzb.zza(paramParcel, 3, paramMaskedWalletRequest.zzaRi);
    zzb.zza(paramParcel, 4, paramMaskedWalletRequest.zzaRj);
    zzb.zza(paramParcel, 5, paramMaskedWalletRequest.zzaRk);
    zzb.zza(paramParcel, 6, paramMaskedWalletRequest.zzaRl, false);
    zzb.zza(paramParcel, 7, paramMaskedWalletRequest.zzaQg, false);
    zzb.zza(paramParcel, 8, paramMaskedWalletRequest.zzaRm, false);
    zzb.zza(paramParcel, 9, paramMaskedWalletRequest.zzaQx, paramInt, false);
    zzb.zza(paramParcel, 10, paramMaskedWalletRequest.zzaRn);
    zzb.zza(paramParcel, 11, paramMaskedWalletRequest.zzaRo);
    zzb.zza(paramParcel, 12, paramMaskedWalletRequest.zzaRp, paramInt, false);
    zzb.zza(paramParcel, 13, paramMaskedWalletRequest.zzaRq);
    zzb.zza(paramParcel, 14, paramMaskedWalletRequest.zzaRr);
    zzb.zzc(paramParcel, 15, paramMaskedWalletRequest.zzaRs, false);
    zzb.zza(paramParcel, 17, paramMaskedWalletRequest.zzaRu, false);
    zzb.zza(paramParcel, 16, paramMaskedWalletRequest.zzaRt, paramInt, false);
    zzb.zzH(paramParcel, i);
  }
  
  public MaskedWalletRequest zzgl(Parcel paramParcel)
  {
  ...
  public MaskedWalletRequest[] zzjn(int paramInt)
  {
