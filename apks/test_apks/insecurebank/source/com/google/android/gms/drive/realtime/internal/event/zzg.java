  ...
  implements Parcelable.Creator<TextInsertedDetails>
{
  ...
  static void zza(TextInsertedDetails paramTextInsertedDetails, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zzc(paramParcel, 1, paramTextInsertedDetails.zzCY);
    zzb.zzc(paramParcel, 2, paramTextInsertedDetails.mIndex);
    zzb.zzc(paramParcel, 3, paramTextInsertedDetails.zzaiX);
    zzb.zzH(paramParcel, paramInt);
  }
  
  public TextInsertedDetails zzcd(Parcel paramParcel)
  {
    int k = 0;
  ...
  public TextInsertedDetails[] zzdT(int paramInt)
  {
