...
public abstract interface zzfi
  extends IInterface
{
    ...
    implements zzfi
  {
    ...
    public static zzfi zzP(IBinder paramIBinder)
    {
      ...
      if ((localIInterface != null) && ((localIInterface instanceof zzfi))) {
        return (zzfi)localIInterface;
      }
      ...
      implements zzfi
    {
        ...
        throws RemoteException
      {
        ...
        //   14: aload_0
        //   15: getfield 18	com/google/android/gms/internal/zzfi$zza$zza:zznF	Landroid/os/IBinder;
        //   18: iconst_2
        //   19: aload_2
        //   20: aload_3
        //   21: iconst_0
