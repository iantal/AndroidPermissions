  ...
  extends IInterface
{
  ...
  public static abstract class zza
    ...
    implements zza
  {
    public static zza zzdp(IBinder paramIBinder)
    {
      ...
      throws RemoteException
    {
      ...
      case 2: 
        ...
        for (paramParcel2 = PlayLoggerContext.CREATOR.zzfH(paramParcel1);; paramParcel2 = null)
        {
          if (paramParcel1.readInt() != 0) {
            localObject1 = LogEvent.CREATOR.zzfG(paramParcel1);
          }
      ...
      case 3: 
        ...
        paramParcel2 = str;
        if (paramParcel1.readInt() != 0) {
          paramParcel2 = PlayLoggerContext.CREATOR.zzfH(paramParcel1);
        }
      ...
      implements zza
    {
        ...
        throws RemoteException
      {
        ...
        //   41: aload_0
        //   42: getfield 18	com/google/android/gms/playlog/internal/zza$zza$zza:zznF	Landroid/os/IBinder;
        //   45: iconst_3
        //   46: aload 4
        //   48: aconst_null
        //   49: iconst_1
