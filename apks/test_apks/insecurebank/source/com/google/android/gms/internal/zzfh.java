...
public abstract interface zzfh
  extends IInterface
{
  public abstract IBinder zzd(zzd paramZzd)
  ...
  public static abstract class zza
    ...
    implements zzfh
  {
    public static zzfh zzO(IBinder paramIBinder)
    {
      ...
      if ((localIInterface != null) && ((localIInterface instanceof zzfh))) {
        return (zzfh)localIInterface;
      }
      ...
      throws RemoteException
    {
      ...
      paramParcel1 = zzd(zzd.zza.zzbg(paramParcel1.readStrongBinder()));
      ...
      implements zzfh
    {
      ...
      /* Error */
      public IBinder zzd(zzd paramZzd)
        throws RemoteException
      {
        // Byte code:
        ...
        //   30: aload_0
        //   31: getfield 18	com/google/android/gms/internal/zzfh$zza$zza:zznF	Landroid/os/IBinder;
        //   34: iconst_1
        //   35: aload_2
        //   36: aload_3
        //   37: iconst_0
