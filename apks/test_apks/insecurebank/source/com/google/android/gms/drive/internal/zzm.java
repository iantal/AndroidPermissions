  ...
  implements Parcelable.Creator<CreateFolderRequest>
{
  ...
  static void zza(CreateFolderRequest paramCreateFolderRequest, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zzc(paramParcel, 1, paramCreateFolderRequest.zzCY);
    zzb.zza(paramParcel, 2, paramCreateFolderRequest.zzaeC, paramInt, false);
    zzb.zza(paramParcel, 3, paramCreateFolderRequest.zzaeA, paramInt, false);
    zzb.zzH(paramParcel, i);
  }
  
  public CreateFolderRequest zzaL(Parcel paramParcel)
  {
  ...
  public CreateFolderRequest[] zzcw(int paramInt)
  {
