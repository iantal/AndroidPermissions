...
public abstract interface zzmf
  extends IInterface
{
    ...
    implements zzmf
  {
    ...
    public static zzmf zzbq(IBinder paramIBinder)
    {
      ...
      if ((localIInterface != null) && ((localIInterface instanceof zzmf))) {
        return (zzmf)localIInterface;
      }
      ...
      implements zzmf
    {
        ...
        throws RemoteException
      {
        ...
        //   25: aload_0
        //   26: getfield 18	com/google/android/gms/internal/zzmf$zza$zza:zznF	Landroid/os/IBinder;
        //   29: iconst_1
        //   30: aload_2
        //   31: aconst_null
        //   32: iconst_1
