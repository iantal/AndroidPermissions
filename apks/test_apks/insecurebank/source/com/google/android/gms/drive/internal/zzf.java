  ...
  implements Parcelable.Creator<CheckResourceIdsExistRequest>
{
  ...
  static void zza(CheckResourceIdsExistRequest paramCheckResourceIdsExistRequest, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zzb(paramParcel, 2, paramCheckResourceIdsExistRequest.zzpA(), false);
    zzb.zzH(paramParcel, paramInt);
  }
  
  public CheckResourceIdsExistRequest zzaF(Parcel paramParcel)
  {
  ...
  public CheckResourceIdsExistRequest[] zzcp(int paramInt)
  {
