  ...
  implements Parcelable.Creator<PersonEntity>
{
  ...
  static void zza(PersonEntity paramPersonEntity, Parcel paramParcel, int paramInt)
  {
    ...
    Set localSet = paramPersonEntity.zzaHQ;
    if (localSet.contains(Integer.valueOf(1))) {
      zzb.zzc(paramParcel, 1, paramPersonEntity.zzCY);
    }
    if (localSet.contains(Integer.valueOf(2))) {
      zzb.zza(paramParcel, 2, paramPersonEntity.zzaIO, true);
    }
    if (localSet.contains(Integer.valueOf(3))) {
      zzb.zza(paramParcel, 3, paramPersonEntity.zzaIP, paramInt, true);
    }
    if (localSet.contains(Integer.valueOf(4))) {
      zzb.zza(paramParcel, 4, paramPersonEntity.zzaIQ, true);
    }
    if (localSet.contains(Integer.valueOf(5))) {
      zzb.zza(paramParcel, 5, paramPersonEntity.zzaIR, true);
    }
    if (localSet.contains(Integer.valueOf(6))) {
      zzb.zzc(paramParcel, 6, paramPersonEntity.zzaIS);
    }
    if (localSet.contains(Integer.valueOf(7))) {
      zzb.zza(paramParcel, 7, paramPersonEntity.zzaIT, paramInt, true);
    }
    if (localSet.contains(Integer.valueOf(8))) {
      zzb.zza(paramParcel, 8, paramPersonEntity.zzaIU, true);
    }
    if (localSet.contains(Integer.valueOf(9))) {
      zzb.zza(paramParcel, 9, paramPersonEntity.zzadI, true);
    }
    if (localSet.contains(Integer.valueOf(12))) {
      zzb.zzc(paramParcel, 12, paramPersonEntity.zzsC);
    }
    if (localSet.contains(Integer.valueOf(14))) {
      zzb.zza(paramParcel, 14, paramPersonEntity.zzKI, true);
    }
    if (localSet.contains(Integer.valueOf(15))) {
      zzb.zza(paramParcel, 15, paramPersonEntity.zzaIV, paramInt, true);
    }
    if (localSet.contains(Integer.valueOf(16))) {
      zzb.zza(paramParcel, 16, paramPersonEntity.zzaIW);
    }
    if (localSet.contains(Integer.valueOf(19))) {
      zzb.zza(paramParcel, 19, paramPersonEntity.zzaIX, paramInt, true);
    }
    if (localSet.contains(Integer.valueOf(18))) {
      zzb.zza(paramParcel, 18, paramPersonEntity.zzRA, true);
    }
    if (localSet.contains(Integer.valueOf(21))) {
      zzb.zzc(paramParcel, 21, paramPersonEntity.zzaIZ);
    }
    if (localSet.contains(Integer.valueOf(20))) {
      zzb.zza(paramParcel, 20, paramPersonEntity.zzaIY, true);
    }
    if (localSet.contains(Integer.valueOf(23))) {
      zzb.zzc(paramParcel, 23, paramPersonEntity.zzaJb, true);
    }
    if (localSet.contains(Integer.valueOf(22))) {
      zzb.zzc(paramParcel, 22, paramPersonEntity.zzaJa, true);
    }
    if (localSet.contains(Integer.valueOf(25))) {
      zzb.zzc(paramParcel, 25, paramPersonEntity.zzaJd);
    }
    if (localSet.contains(Integer.valueOf(24))) {
      zzb.zzc(paramParcel, 24, paramPersonEntity.zzaJc);
    }
    ...
    if (localSet.contains(Integer.valueOf(26))) {
      zzb.zza(paramParcel, 26, paramPersonEntity.zzaJe, true);
    }
    if (localSet.contains(Integer.valueOf(29))) {
      zzb.zza(paramParcel, 29, paramPersonEntity.zzaJg);
    }
    if (localSet.contains(Integer.valueOf(28))) {
      zzb.zzc(paramParcel, 28, paramPersonEntity.zzaJf, true);
    }
    zzb.zzH(paramParcel, i);
  }
  
  public PersonEntity zzfM(Parcel paramParcel)
  {
    int i2 = com.google.android.gms.common.internal.safeparcel.zza.zzab(paramParcel);
    ...
    {
      int i3 = com.google.android.gms.common.internal.safeparcel.zza.zzaa(paramParcel);
      switch (com.google.android.gms.common.internal.safeparcel.zza.zzbA(i3))
      {
      case 10: 
      case 11: 
      case 13: 
      ...
      case 1: 
        ...
        break;
      case 2: 
        str10 = com.google.android.gms.common.internal.safeparcel.zza.zzo(paramParcel, i3);
      ...
      case 3: 
        ...
        break;
      case 4: 
        str9 = com.google.android.gms.common.internal.safeparcel.zza.zzo(paramParcel, i3);
        localHashSet.add(Integer.valueOf(4));
        break;
      case 5: 
        str8 = com.google.android.gms.common.internal.safeparcel.zza.zzo(paramParcel, i3);
      ...
      case 7: 
        ...
        break;
      case 8: 
        str7 = com.google.android.gms.common.internal.safeparcel.zza.zzo(paramParcel, i3);
        localHashSet.add(Integer.valueOf(8));
        break;
      case 9: 
        str6 = com.google.android.gms.common.internal.safeparcel.zza.zzo(paramParcel, i3);
      ...
      case 12: 
        ...
        break;
      case 14: 
        str5 = com.google.android.gms.common.internal.safeparcel.zza.zzo(paramParcel, i3);
      ...
      case 19: 
        ...
        break;
      case 18: 
        str4 = com.google.android.gms.common.internal.safeparcel.zza.zzo(paramParcel, i3);
      ...
      case 21: 
        ...
        break;
      case 20: 
        str3 = com.google.android.gms.common.internal.safeparcel.zza.zzo(paramParcel, i3);
      ...
      case 24: 
        ...
        break;
      case 27: 
        str1 = com.google.android.gms.common.internal.safeparcel.zza.zzo(paramParcel, i3);
        localHashSet.add(Integer.valueOf(27));
        break;
      case 26: 
        str2 = com.google.android.gms.common.internal.safeparcel.zza.zzo(paramParcel, i3);
  ...
  public PersonEntity[] zziC(int paramInt)
  {
