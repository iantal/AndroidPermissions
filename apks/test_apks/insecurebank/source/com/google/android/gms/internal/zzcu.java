...
public abstract interface zzcu
  extends IInterface
{
  public abstract void zza(zzco paramZzco)
    ...
    implements zzcu
  {
    ...
    public static zzcu zzz(IBinder paramIBinder)
    {
      ...
      throws RemoteException
    {
      ...
      zza(zzco.zza.zzw(paramParcel1.readStrongBinder()));
      ...
      implements zzcu
    {
        ...
        throws RemoteException
      {
        ...
        //   30: aload_0
        //   31: getfield 18	com/google/android/gms/internal/zzcu$zza$zza:zznF	Landroid/os/IBinder;
        //   34: iconst_1
        //   35: aload_2
        //   36: aload_3
        //   37: iconst_0
