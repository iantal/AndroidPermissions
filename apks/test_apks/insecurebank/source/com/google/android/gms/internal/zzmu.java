...
public abstract interface zzmu
  extends IInterface
{
    ...
    implements zzmu
  {
    ...
    public static zzmu zzbF(IBinder paramIBinder)
    {
      if (paramIBinder == null) {
        return null;
      }
      IInterface localIInterface = paramIBinder.queryLocalInterface("com.google.android.gms.fitness.internal.IStatusCallback");
      if ((localIInterface != null) && ((localIInterface instanceof zzmu))) {
        return (zzmu)localIInterface;
      }
      ...
      implements zzmu
    {
        ...
        throws RemoteException
      {
        ...
        //   29: aload_0
        //   30: getfield 18	com/google/android/gms/internal/zzmu$zza$zza:zznF	Landroid/os/IBinder;
        //   33: iconst_1
        //   34: aload_2
        //   35: aload_3
        //   36: iconst_0
