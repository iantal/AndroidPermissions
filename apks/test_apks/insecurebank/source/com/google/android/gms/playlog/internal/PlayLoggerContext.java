  ...
  implements SafeParcelable
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    } while ((this.versionCode == paramObject.versionCode) && (this.packageName.equals(paramObject.packageName)) && (this.zzaGP == paramObject.zzaGP) && (this.zzaGQ == paramObject.zzaGQ) && (zzt.equal(this.zzaGU, paramObject.zzaGU)) && (zzt.equal(this.zzaGR, paramObject.zzaGR)) && (zzt.equal(this.zzaGS, paramObject.zzaGS)) && (this.zzaGT == paramObject.zzaGT) && (this.zzaGV == paramObject.zzaGV));
    return false;
    return false;
  }
