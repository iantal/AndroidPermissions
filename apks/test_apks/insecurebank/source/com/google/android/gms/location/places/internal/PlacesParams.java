  ...
  implements SafeParcelable
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    } while ((this.zzaBa.equals(paramObject.zzaBa)) && (this.zzaAZ.equals(paramObject.zzaAZ)) && (zzt.equal(this.zzaBb, paramObject.zzaBb)) && (zzt.equal(this.zzazX, paramObject.zzazX)) && (zzt.equal(this.zzaBc, paramObject.zzaBc)));
    return false;
  }
