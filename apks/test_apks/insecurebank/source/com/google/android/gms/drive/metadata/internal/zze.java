...
public final class zze
{
  ...
  public static void zzb(DataHolder paramDataHolder)
  {
    zzlo.zzahl.zzd(paramDataHolder);
  }
  
  private static void zzb(MetadataField<?> paramMetadataField)
  {
    if (zzagH.containsKey(paramMetadataField.getName())) {
      throw new IllegalArgumentException("Duplicate field name registered: " + paramMetadataField.getName());
    }
    zzagH.put(paramMetadataField.getName(), paramMetadataField);
  }
  
  public static MetadataField<?> zzcw(String paramString)
  {
    return (MetadataField)zzagH.get(paramString);
  }
