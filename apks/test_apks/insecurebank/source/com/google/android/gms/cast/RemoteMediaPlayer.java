  ...
  implements Cast.MessageReceivedCallback
{
  ...
  public long getApproximateStreamPosition()
  {
    ...
    {
      long l = this.zzSt.getApproximateStreamPosition();
      return l;
    }
  }
  ...
  public MediaInfo getMediaInfo()
  {
    synchronized (this.zzqt)
    {
      MediaInfo localMediaInfo = this.zzSt.getMediaInfo();
  ...
  public MediaStatus getMediaStatus()
  {
    synchronized (this.zzqt)
    {
      MediaStatus localMediaStatus = this.zzSt.getMediaStatus();
  ...
  public long getStreamDuration()
  {
    synchronized (this.zzqt)
    {
      long l = this.zzSt.getStreamDuration();
      return l;
    }
  }
    ...
    paramGoogleApiClient.zzb(new zzb(paramGoogleApiClient)
    {
      protected void zza(zze arg1)
      {
        synchronized (RemoteMediaPlayer.zze(RemoteMediaPlayer.this))
        {
          ...
          try
          {
            RemoteMediaPlayer.zzg(RemoteMediaPlayer.this).zza(this.zzTa, paramMediaInfo, paramBoolean, paramLong, paramJSONObject, this.zzSG);
          }
    ...
    paramGoogleApiClient.zzb(new zzb(paramGoogleApiClient)
    {
      protected void zza(zze arg1)
      {
        synchronized (RemoteMediaPlayer.zze(RemoteMediaPlayer.this))
        {
          ...
          try
          {
            RemoteMediaPlayer.zzg(RemoteMediaPlayer.this).zza(this.zzTa, paramJSONObject);
          }
          catch (IOException localIOException)
          {
            for (;;)
    ...
    paramGoogleApiClient.zzb(new zzb(paramGoogleApiClient)
    {
      protected void zza(zze arg1)
      {
        synchronized (RemoteMediaPlayer.zze(RemoteMediaPlayer.this))
        {
          ...
          try
          {
            RemoteMediaPlayer.zzg(RemoteMediaPlayer.this).zzc(this.zzTa, paramJSONObject);
          }
          catch (IOException localIOException)
          {
            for (;;)
    ...
    paramGoogleApiClient.zzb(new zzb(paramGoogleApiClient)
    {
      protected void zza(zze arg1)
      {
        synchronized (RemoteMediaPlayer.zze(RemoteMediaPlayer.this))
        {
          ...
          try
          {
            RemoteMediaPlayer.zzg(RemoteMediaPlayer.this).zza(this.zzTa, paramArrayOfMediaQueueItem, paramInt, paramJSONObject);
          }
          catch (IOException localIOException)
          {
            for (;;)
  ...
  public PendingResult<MediaChannelResult> queueJumpToItem(final GoogleApiClient paramGoogleApiClient, final int paramInt, final JSONObject paramJSONObject)
  {
    paramGoogleApiClient.zzb(new zzb(paramGoogleApiClient)
    {
      protected void zza(zze arg1)
      {
        synchronized (RemoteMediaPlayer.zze(RemoteMediaPlayer.this))
        {
          ...
          try
          {
            RemoteMediaPlayer.zzg(RemoteMediaPlayer.this).zza(this.zzTa, paramInt, null, 0, null, paramJSONObject);
          }
          catch (IOException localIOException)
          {
            for (;;)
  ...
  public PendingResult<MediaChannelResult> queueLoad(final GoogleApiClient paramGoogleApiClient, final MediaQueueItem[] paramArrayOfMediaQueueItem, final int paramInt1, final int paramInt2, final JSONObject paramJSONObject)
    throws IllegalArgumentException
  {
    paramGoogleApiClient.zzb(new zzb(paramGoogleApiClient)
    {
      protected void zza(zze arg1)
      {
        synchronized (RemoteMediaPlayer.zze(RemoteMediaPlayer.this))
        {
          ...
          try
          {
            RemoteMediaPlayer.zzg(RemoteMediaPlayer.this).zza(this.zzTa, paramArrayOfMediaQueueItem, paramInt1, paramInt2, paramJSONObject);
          }
          catch (IOException localIOException)
          {
            for (;;)
    ...
    paramGoogleApiClient.zzb(new zzb(paramGoogleApiClient)
    {
      protected void zza(zze arg1)
      {
        ...
        synchronized (RemoteMediaPlayer.zze(RemoteMediaPlayer.this))
        {
          ...
          if (paramInt2 < 0)
          {
            setResult(zzn(new Status(2001, String.format(Locale.ROOT, "Invalid request: Invalid newIndex %d.", new Object[] { Integer.valueOf(paramInt2) }))));
            return;
          }
        }
        if (i == paramInt2)
    ...
    paramGoogleApiClient.zzb(new zzb(paramGoogleApiClient)
    {
      protected void zza(zze arg1)
      {
        synchronized (RemoteMediaPlayer.zze(RemoteMediaPlayer.this))
        {
          ...
          try
          {
            RemoteMediaPlayer.zzg(RemoteMediaPlayer.this).zza(this.zzTa, 0, null, 1, null, paramJSONObject);
          }
          catch (IOException localIOException)
          {
            for (;;)
    ...
    paramGoogleApiClient.zzb(new zzb(paramGoogleApiClient)
    {
      protected void zza(zze arg1)
      {
        synchronized (RemoteMediaPlayer.zze(RemoteMediaPlayer.this))
        {
          ...
          try
          {
            RemoteMediaPlayer.zzg(RemoteMediaPlayer.this).zza(this.zzTa, paramArrayOfInt, paramJSONObject);
          }
          catch (IOException localIOException)
          {
            for (;;)
    ...
    paramGoogleApiClient.zzb(new zzb(paramGoogleApiClient)
    {
      protected void zza(zze arg1)
      {
        synchronized (RemoteMediaPlayer.zze(RemoteMediaPlayer.this))
        {
          ...
          try
          {
            RemoteMediaPlayer.zzg(RemoteMediaPlayer.this).zza(this.zzTa, paramArrayOfInt, paramInt, paramJSONObject);
          }
          catch (IOException localIOException)
          {
            for (;;)
    ...
    paramGoogleApiClient.zzb(new zzb(paramGoogleApiClient)
    {
      protected void zza(zze arg1)
      {
        synchronized (RemoteMediaPlayer.zze(RemoteMediaPlayer.this))
        {
          ...
          try
          {
            RemoteMediaPlayer.zzg(RemoteMediaPlayer.this).zza(this.zzTa, 0, null, 0, Integer.valueOf(paramInt), paramJSONObject);
          }
          catch (IOException localIOException)
          {
            for (;;)
    ...
    paramGoogleApiClient.zzb(new zzb(paramGoogleApiClient)
    {
      protected void zza(zze arg1)
      {
        synchronized (RemoteMediaPlayer.zze(RemoteMediaPlayer.this))
        {
          ...
          try
          {
            RemoteMediaPlayer.zzg(RemoteMediaPlayer.this).zza(this.zzTa, 0, paramArrayOfMediaQueueItem, 0, null, paramJSONObject);
          }
          catch (IOException localIOException)
          {
            for (;;)
    ...
    paramGoogleApiClient.zzb(new zzb(paramGoogleApiClient)
    {
      protected void zza(zze arg1)
      {
        synchronized (RemoteMediaPlayer.zze(RemoteMediaPlayer.this))
        {
          ...
          try
          {
            RemoteMediaPlayer.zzg(RemoteMediaPlayer.this).zza(this.zzTa);
          }
          catch (IOException localIOException)
          {
            for (;;)
    ...
    paramGoogleApiClient.zzb(new zzb(paramGoogleApiClient)
    {
      protected void zza(zze arg1)
      {
        synchronized (RemoteMediaPlayer.zze(RemoteMediaPlayer.this))
        {
          ...
          try
          {
            RemoteMediaPlayer.zzg(RemoteMediaPlayer.this).zza(this.zzTa, paramLong, paramJSONObject, this.zzSG);
          }
          catch (IOException localIOException)
          {
            for (;;)
    ...
    paramGoogleApiClient.zzb(new zzb(paramGoogleApiClient)
    {
      protected void zza(zze arg1)
      {
        synchronized (RemoteMediaPlayer.zze(RemoteMediaPlayer.this))
        {
          ...
          try
          {
            RemoteMediaPlayer.zzg(RemoteMediaPlayer.this).zza(this.zzTa, paramArrayOfLong);
          }
          catch (IOException localIOException)
          {
            for (;;)
  ...
  public PendingResult<MediaChannelResult> setStreamMute(final GoogleApiClient paramGoogleApiClient, final boolean paramBoolean, final JSONObject paramJSONObject)
  {
    paramGoogleApiClient.zzb(new zzb(paramGoogleApiClient)
    {
      ...
      protected void zza(zze paramAnonymousZze)
      {
        // Byte code:
        //   0: aload_0
        //   1: getfield 21	com/google/android/gms/cast/RemoteMediaPlayer$21:zzSz	Lcom/google/android/gms/cast/RemoteMediaPlayer;
        ...
        //   9: monitorenter
        //   10: aload_0
        //   11: getfield 21	com/google/android/gms/cast/RemoteMediaPlayer$21:zzSz	Lcom/google/android/gms/cast/RemoteMediaPlayer;
        ...
        //   17: aload_0
        //   18: getfield 23	com/google/android/gms/cast/RemoteMediaPlayer$21:zzSA	Lcom/google/android/gms/common/api/GoogleApiClient;
        ...
        //   24: aload_0
        //   25: getfield 21	com/google/android/gms/cast/RemoteMediaPlayer$21:zzSz	Lcom/google/android/gms/cast/RemoteMediaPlayer;
        ...
        //   31: aload_0
        //   32: getfield 58	com/google/android/gms/cast/RemoteMediaPlayer$21:zzTa	Lcom/google/android/gms/cast/internal/zzo;
        //   35: aload_0
        //   36: getfield 25	com/google/android/gms/cast/RemoteMediaPlayer$21:zzSV	Z
        //   39: aload_0
        //   40: getfield 27	com/google/android/gms/cast/RemoteMediaPlayer$21:zzSG	Lorg/json/JSONObject;
        ...
        //   46: pop2
        //   47: aload_0
        //   48: getfield 21	com/google/android/gms/cast/RemoteMediaPlayer$21:zzSz	Lcom/google/android/gms/cast/RemoteMediaPlayer;
        ...
        //   74: invokevirtual 72	com/google/android/gms/cast/RemoteMediaPlayer$21:zzn	(Lcom/google/android/gms/common/api/Status;)Lcom/google/android/gms/cast/RemoteMediaPlayer$MediaChannelResult;
        //   77: invokevirtual 76	com/google/android/gms/cast/RemoteMediaPlayer$21:setResult	(Lcom/google/android/gms/common/api/Result;)V
        //   80: aload_0
        //   81: getfield 21	com/google/android/gms/cast/RemoteMediaPlayer$21:zzSz	Lcom/google/android/gms/cast/RemoteMediaPlayer;
        ...
        //   99: astore_2
        //   100: aload_0
        //   101: getfield 21	com/google/android/gms/cast/RemoteMediaPlayer$21:zzSz	Lcom/google/android/gms/cast/RemoteMediaPlayer;
    ...
    throws IllegalArgumentException
  {
    ...
    paramGoogleApiClient.zzb(new zzb(paramGoogleApiClient)
    {
      ...
      protected void zza(zze paramAnonymousZze)
      {
        // Byte code:
        //   0: aload_0
        //   1: getfield 21	com/google/android/gms/cast/RemoteMediaPlayer$20:zzSz	Lcom/google/android/gms/cast/RemoteMediaPlayer;
        ...
        //   9: monitorenter
        //   10: aload_0
        //   11: getfield 21	com/google/android/gms/cast/RemoteMediaPlayer$20:zzSz	Lcom/google/android/gms/cast/RemoteMediaPlayer;
        ...
        //   17: aload_0
        //   18: getfield 23	com/google/android/gms/cast/RemoteMediaPlayer$20:zzSA	Lcom/google/android/gms/common/api/GoogleApiClient;
        ...
        //   24: aload_0
        //   25: getfield 21	com/google/android/gms/cast/RemoteMediaPlayer$20:zzSz	Lcom/google/android/gms/cast/RemoteMediaPlayer;
        ...
        //   31: aload_0
        //   32: getfield 60	com/google/android/gms/cast/RemoteMediaPlayer$20:zzTa	Lcom/google/android/gms/cast/internal/zzo;
        //   35: aload_0
        //   36: getfield 25	com/google/android/gms/cast/RemoteMediaPlayer$20:zzSU	D
        //   39: aload_0
        //   40: getfield 27	com/google/android/gms/cast/RemoteMediaPlayer$20:zzSG	Lorg/json/JSONObject;
        ...
        //   46: pop2
        //   47: aload_0
        //   48: getfield 21	com/google/android/gms/cast/RemoteMediaPlayer$20:zzSz	Lcom/google/android/gms/cast/RemoteMediaPlayer;
        ...
        //   74: invokevirtual 74	com/google/android/gms/cast/RemoteMediaPlayer$20:zzn	(Lcom/google/android/gms/common/api/Status;)Lcom/google/android/gms/cast/RemoteMediaPlayer$MediaChannelResult;
        //   77: invokevirtual 78	com/google/android/gms/cast/RemoteMediaPlayer$20:setResult	(Lcom/google/android/gms/common/api/Result;)V
        //   80: aload_0
        //   81: getfield 21	com/google/android/gms/cast/RemoteMediaPlayer$20:zzSz	Lcom/google/android/gms/cast/RemoteMediaPlayer;
        ...
        //   99: astore_2
        //   100: aload_0
        //   101: getfield 21	com/google/android/gms/cast/RemoteMediaPlayer$20:zzSz	Lcom/google/android/gms/cast/RemoteMediaPlayer;
    ...
    paramGoogleApiClient.zzb(new zzb(paramGoogleApiClient)
    {
      protected void zza(zze arg1)
      {
        synchronized (RemoteMediaPlayer.zze(RemoteMediaPlayer.this))
        {
          ...
          try
          {
            RemoteMediaPlayer.zzg(RemoteMediaPlayer.this).zza(this.zzTa, paramTextTrackStyle);
          }
          catch (IOException localIOException)
          {
            for (;;)
    ...
    paramGoogleApiClient.zzb(new zzb(paramGoogleApiClient)
    {
      protected void zza(zze arg1)
      {
        synchronized (RemoteMediaPlayer.zze(RemoteMediaPlayer.this))
        {
          ...
          try
          {
            RemoteMediaPlayer.zzg(RemoteMediaPlayer.this).zzb(this.zzTa, paramJSONObject);
          }
          catch (IOException localIOException)
          {
            for (;;)
    ...
    implements zzn
  {
      ...
      throws IOException
    {
      ...
      Cast.CastApi.sendMessage(this.zzSW, paramString1, paramString2).setResultCallback(new zza(paramLong));
    }
    
    public void zzb(GoogleApiClient paramGoogleApiClient)
    {
      this.zzSW = paramGoogleApiClient;
    }
      ...
      implements ResultCallback<Status>
    {
      ...
      public void zzm(Status paramStatus)
      {
        if (!paramStatus.isSuccess()) {
          RemoteMediaPlayer.zzg(RemoteMediaPlayer.this).zzb(this.zzSY, paramStatus.getStatusCode());
        }
      }
    }
  }
    ...
    extends zzb<RemoteMediaPlayer.MediaChannelResult>
  {
    zzo zzTa = new zzo()
    {
      public void zza(long paramAnonymousLong, int paramAnonymousInt, Object paramAnonymousObject)
      {
        ...
        {
          RemoteMediaPlayer.zzb.this.setResult(new RemoteMediaPlayer.zzc(new Status(paramAnonymousInt), paramAnonymousObject));
          return;
        }
      }
      ...
      {
        RemoteMediaPlayer.zzb.this.setResult(RemoteMediaPlayer.zzb.this.zzn(new Status(2103)));
      }
    };
    ...
    public RemoteMediaPlayer.MediaChannelResult zzn(final Status paramStatus)
    {
