...
public abstract interface zzi
  extends IInterface
{
  public abstract void zza(AdRequestInfoParcel paramAdRequestInfoParcel, zzj paramZzj)
    ...
    implements zzi
  {
    ...
    public static zzi zzU(IBinder paramIBinder)
    {
      ...
      throws RemoteException
    {
      ...
      zza((AdRequestInfoParcel)localObject1, zzj.zza.zzV(paramParcel1.readStrongBinder()));
      paramParcel2.writeNoException();
      return true;
    }
      ...
      implements zzi
    {
      ...
      public void zza(AdRequestInfoParcel paramAdRequestInfoParcel, zzj paramZzj)
        throws RemoteException
      {
        ...
        for (;;)
        {
          try
          {
            ...
            if (paramAdRequestInfoParcel != null)
            {
              ...
              if (paramZzj != null)
              {
                paramAdRequestInfoParcel = paramZzj.asBinder();
