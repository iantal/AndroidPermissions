...
public final class PlusShare
{
  ...
  protected static boolean zzdU(String paramString)
  {
  ...
  public static class Builder
  {
    ...
    public Builder addCallToAction(String paramString1, Uri paramUri, String paramString2)
    {
      ...
      {
        zzu.zzb(bool, "Must provide a call to action URL");
        Bundle localBundle = new Bundle();
        if (!TextUtils.isEmpty(paramString1)) {
        ...
        if (!TextUtils.isEmpty(paramString2))
        {
          zzu.zza(PlusShare.zzdU(paramString2), "The specified deep-link ID was malformed.");
    ...
    public Builder addStream(Uri paramUri)
    {
      ...
      this.zzaHk.add(localUri);
      this.zzaHk.add(paramUri);
      return this;
    }
    ...
    public Intent getIntent()
    {
      ...
      if ((this.zzaHk != null) && (this.zzaHk.size() > 1))
      {
        ...
        bool1 = true;
        label59:
        zzu.zza(bool1, "Call-to-action buttons are only available for URLs.");
        if ((bool4) && (!this.mIntent.hasExtra("com.google.android.apps.plus.CONTENT_URL"))) {
          break label312;
        }
        bool1 = true;
        label84:
        zzu.zza(bool1, "The content URL is required for interactive posts.");
        bool1 = bool2;
        if (bool4)
        {
          bool1 = bool2;
        ...
        label125:
        zzu.zza(bool1, "Must set content URL or content deep-link ID to use a call-to-action button.");
        if (this.mIntent.hasExtra("com.google.android.apps.plus.CONTENT_DEEP_LINK_ID")) {
    ...
    public Builder setContentDeepLinkId(String paramString1, String paramString2, String paramString3, Uri paramUri)
    {
      ...
      for (boolean bool = true;; bool = false)
      {
        zzu.zzb(bool, "The deepLinkId parameter is required.");
