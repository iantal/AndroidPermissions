...
public class MediaSessionCompat
{
    ...
    implements MediaSessionCompat.MediaSessionImpl
  {
    ...
    public MediaSessionImplBase(Context paramContext, String paramString, ComponentName paramComponentName, PendingIntent paramPendingIntent)
    {
      ...
      this.mMediaButtonEventReceiver = localPendingIntent;
      ...
      {
        this.mRccObj = MediaSessionCompatApi14.createRemoteControlClient(localPendingIntent);
        return;
      }
      this.mRccObj = null;
    }
    ...
    public void setMetadata(MediaMetadataCompat paramMediaMetadataCompat)
    {
      ...
      do
      {
        ...
        {
          boolean bool;
          if ((this.mState != null) && ((this.mState.getActions() & 0x80) != 0L))
          {
            bool = true;
          ...
          for (paramMediaMetadataCompat = localObject1;; paramMediaMetadataCompat = paramMediaMetadataCompat.getBundle())
          {
            MediaSessionCompatApi19.setMetadata(localObject2, paramMediaMetadataCompat, bool);
            return;
            bool = false;
            break;
          }
      ...
      if (paramMediaMetadataCompat == null) {}
      for (paramMediaMetadataCompat = localObject2;; paramMediaMetadataCompat = paramMediaMetadataCompat.getBundle())
      {
