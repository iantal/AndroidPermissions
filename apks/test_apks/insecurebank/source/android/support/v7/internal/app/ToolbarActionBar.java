  ...
  extends ActionBar
{
    ...
    extends WindowCallbackWrapper
  {
    ...
    public View onCreatePanelView(int paramInt)
    {
      ...
      } while ((ToolbarActionBar.this.mWindowCallback == null) || (!ToolbarActionBar.this.mWindowCallback.onPreparePanel(paramInt, null, localMenu)) || (!ToolbarActionBar.this.mWindowCallback.onMenuOpened(paramInt, localMenu)));
