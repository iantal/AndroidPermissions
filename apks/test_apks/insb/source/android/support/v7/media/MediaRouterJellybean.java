...
final class MediaRouterJellybean
{
  ...
  public static List getCategories(Object paramObject)
  {
    ...
    while (i < j)
    {
      localArrayList.add(paramObject.getCategoryAt(i));
      i += 1;
    }
  ...
  public static List getRoutes(Object paramObject)
  {
    ...
    while (i < j)
    {
      localArrayList.add(paramObject.getRouteAt(i));
      i += 1;
    }
    return localArrayList;
  }
  ...
  public static final class SelectRouteWorkaround
  {
    ...
    public void selectRoute(Object paramObject1, int paramInt, Object paramObject2)
    {
      ...
      if (((0x800000 & paramObject2.getSupportedTypes()) != 0) || (this.mSelectRouteIntMethod != null)) {}
      for (;;)
      {
        try
        {
        ...
        catch (IllegalAccessException localIllegalAccessException)
        {
          ...
          paramObject1.selectRoute(paramInt, paramObject2);
          return;
        }
        catch (InvocationTargetException localInvocationTargetException)
        {
