  ...
  extends Service
{
  ...
  private static void sendReply(Messenger paramMessenger, int paramInt1, int paramInt2, int paramInt3, Object paramObject, Bundle paramBundle)
  {
    ...
    {
      Log.e("MediaRouteProviderSrv", "Could not send message to " + getClientId(paramMessenger), paramObject);
      return;
    }
  ...
  private boolean updateCompositeDiscoveryRequest()
  {
    ...
    if (localObject1 != null) {
      localObject2 = new MediaRouteDiscoveryRequest(localObject1.build(), bool1);
    }
    ...
    extends Handler
  {
    ...
    private boolean processMessage(int paramInt1, Messenger paramMessenger, int paramInt2, int paramInt3, Object paramObject, Bundle paramBundle)
    {
        ...
        do
        {
          do
          {
            do
            {
              ...
              return localMediaRouteProviderService.onCreateRouteController(paramMessenger, paramInt2, paramInt3, paramObject);
      ...
      if ((paramObject != null) && (paramObject.isValid())) {}
      for (;;)
      {
        return localMediaRouteProviderService.onSetDiscoveryRequest(paramMessenger, paramInt2, paramObject);
        paramObject = null;
      }
    }
