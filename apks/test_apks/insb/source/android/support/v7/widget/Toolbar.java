  ...
  extends ViewGroup
{
  ...
  public Toolbar(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    this.mMinHeight = paramContext.getDimensionPixelSize(R.styleable.Toolbar_android_minHeight, 0);
  ...
  private static Context themifyContext(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    paramInt = localTypedArray.getResourceId(R.styleable.Toolbar_theme, 0);
