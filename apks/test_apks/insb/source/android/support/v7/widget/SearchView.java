  ...
  implements CollapsibleActionView
{
  ...
  private final View.OnClickListener mOnClickListener = new View.OnClickListener()
  {
    public void onClick(View paramAnonymousView)
    {
      ...
      do
      {
        ...
        } while (!SearchView.IS_AT_LEAST_FROYO);
  ...
  View.OnKeyListener mTextKeyListener = new View.OnKeyListener()
  {
    public boolean onKey(View paramAnonymousView, int paramAnonymousInt, KeyEvent paramAnonymousKeyEvent)
    {
      ...
      } while ((SearchView.SearchAutoComplete.access$1700(SearchView.this.mQueryTextView)) || (!KeyEventCompat.hasNoModifiers(paramAnonymousKeyEvent)) || (paramAnonymousKeyEvent.getAction() != 1) || (paramAnonymousInt != 66));
  ...
  public SearchView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    this.mSearchIconResId = paramAttributeSet.getResourceId(R.styleable.SearchView_searchIcon, 0);
    this.mSearchButton.setImageResource(this.mSearchIconResId);
    this.mSubmitButton.setImageDrawable(paramAttributeSet.getDrawable(R.styleable.SearchView_goIcon));
    ...
    this.mSearchHintIcon.setImageDrawable(paramAttributeSet.getDrawable(R.styleable.SearchView_searchIcon));
    this.mSuggestionRowLayout = paramAttributeSet.getResourceId(R.styleable.SearchView_suggestionRowLayout, 0);
  ...
  private void adjustDropDownSizeAndPosition()
  {
    ...
    {
      this.mQueryTextView.setDropDownHorizontalOffset(j);
      j = this.mDropDownAnchor.getWidth();
      int m = localRect.left;
      int n = localRect.right;
      this.mQueryTextView.setDropDownWidth(j + m + n + i - k);
      return;
      i = 0;
      break;
    }
  ...
  private Intent createVoiceAppSearchIntent(Intent paramIntent, SearchableInfo paramSearchableInfo)
  {
    ...
    localIntent2.putExtra("android.speech.extra.PROMPT", localObject3);
