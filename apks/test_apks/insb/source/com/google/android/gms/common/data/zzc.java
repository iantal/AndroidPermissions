...
public abstract class zzc
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    if ((paramObject instanceof zzc))
    {
      ...
      bool1 = bool2;
      if (zzt.equal(Integer.valueOf(paramObject.zzYs), Integer.valueOf(this.zzYs)))
      {
        bool1 = bool2;
        if (zzt.equal(Integer.valueOf(paramObject.zzYt), Integer.valueOf(this.zzYt)))
        {
          bool1 = bool2;
          if (paramObject.zzWu == this.zzWu) {
            bool1 = true;
          }
        }
      }
