...
public final class zzj
{
  ...
  public zzj(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    for (this.zzsr = zzD(paramAttributeSet);; this.zzsr = zzD(str))
    {
      this.zzoL = paramContext.getString(R.styleable.AdsAttrs_adUnitId);
  ...
  private static AdSize[] zzD(String paramString)
  {
  ...
  {
    if ((!paramBoolean) && (this.zzsr.length != 1)) {
