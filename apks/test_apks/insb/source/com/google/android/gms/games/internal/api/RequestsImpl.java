  ...
  implements Requests
{
  ...
  {
    return Games.zzd(paramGoogleApiClient).zza(paramInt1, paramArrayOfByte, paramInt2, paramBitmap, paramString);
  }
  ...
  {
    public Requests.LoadRequestSummariesResult zzaq(final Status paramStatus)
    {
    ...
    extends Games.BaseGamesApiMethodImpl<Requests.LoadRequestsResult>
  {
    ...
    public Requests.LoadRequestsResult zzar(final Status paramStatus)
    {
      new Requests.LoadRequestsResult()
      {
        public GameRequestBuffer getRequests(int paramAnonymousInt)
        {
          return new GameRequestBuffer(DataHolder.zzbi(paramStatus.getStatusCode()));
        }
  ...
  {
    public Requests.SendRequestResult zzas(final Status paramStatus)
    {
    ...
    extends Games.BaseGamesApiMethodImpl<Requests.UpdateRequestsResult>
  {
    ...
    public Requests.UpdateRequestsResult zzat(final Status paramStatus)
    {
