  ...
  implements SafeParcelable
{
  ...
  {
    zzu.zzb(paramString, "key");
    zzu.zzb(zzagC.matcher(paramString).matches(), "key name characters must be alphanumeric or one of .!@$%^&*()-_/");
    boolean bool1 = bool2;
    if (paramInt2 != 0) {
      if (paramInt2 != 1) {
        break label69;
    ...
    {
      zzu.zzb(bool1, "visibility must be either PUBLIC or PRIVATE");
      this.zzCY = paramInt1;
  ...
  public boolean equals(Object paramObject)
  {
    ...
    if ((paramObject.getKey().equals(this.zztw)) && (paramObject.getVisibility() == this.mVisibility)) {}
    for (;;)
    {
      return bool;
      bool = false;
