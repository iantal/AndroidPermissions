...
public abstract interface zzff
  extends IInterface
{
  public abstract void zza(zzfe paramZzfe)
    ...
    implements zzff
  {
    ...
    public static zzff zzM(IBinder paramIBinder)
    {
      ...
      if ((localIInterface != null) && ((localIInterface instanceof zzff))) {
        return (zzff)localIInterface;
      }
      ...
      throws RemoteException
    {
      ...
      zza(zzfe.zza.zzL(paramParcel1.readStrongBinder()));
      ...
      implements zzff
    {
        ...
        throws RemoteException
      {
        ...
        //   30: aload_0
        //   31: getfield 18	com/google/android/gms/internal/zzff$zza$zza:zznF	Landroid/os/IBinder;
        //   34: iconst_1
        //   35: aload_2
        //   36: aload_3
        //   37: iconst_0
