...
public abstract interface zzor
  extends IInterface
{
  ...
  public abstract void zzhX(int paramInt)
    throws RemoteException;
  
  public abstract void zzhY(int paramInt)
    throws RemoteException;
  
  public abstract void zzhZ(int paramInt)
    throws RemoteException;
  
  public abstract void zzia(int paramInt)
    throws RemoteException;
  
  public abstract void zzib(int paramInt)
    throws RemoteException;
    ...
    implements zzor
  {
    ...
    public static zzor zzdb(IBinder paramIBinder)
    {
      ...
      throws RemoteException
    {
      ...
      case 1010: 
        paramParcel1.enforceInterface("com.google.android.gms.nearby.internal.connection.INearbyConnectionCallbacks");
        zzhX(paramParcel1.readInt());
        paramParcel2.writeNoException();
        return true;
      case 1011: 
        paramParcel1.enforceInterface("com.google.android.gms.nearby.internal.connection.INearbyConnectionCallbacks");
        zzhY(paramParcel1.readInt());
        paramParcel2.writeNoException();
        return true;
      case 1012: 
        paramParcel1.enforceInterface("com.google.android.gms.nearby.internal.connection.INearbyConnectionCallbacks");
        zzhZ(paramParcel1.readInt());
        paramParcel2.writeNoException();
        return true;
      case 1013: 
        paramParcel1.enforceInterface("com.google.android.gms.nearby.internal.connection.INearbyConnectionCallbacks");
        zzia(paramParcel1.readInt());
        paramParcel2.writeNoException();
        return true;
      }
      paramParcel1.enforceInterface("com.google.android.gms.nearby.internal.connection.INearbyConnectionCallbacks");
      zzib(paramParcel1.readInt());
      paramParcel2.writeNoException();
      return true;
    }
      ...
      implements zzor
    {
        ...
        throws RemoteException
      {
        ...
        try
        {
          ...
          this.zznF.transact(1001, localParcel1, localParcel2, 0);
        ...
        throws RemoteException
      {
        ...
        try
        {
          ...
          this.zznF.transact(1008, localParcel1, localParcel2, 0);
          localParcel2.readException();
          return;
        }
        finally
        ...
        throws RemoteException
      {
        ...
        try
        {
          localParcel1.writeInterfaceToken("com.google.android.gms.nearby.internal.connection.INearbyConnectionCallbacks");
          localParcel1.writeString(paramString);
          this.zznF.transact(1003, localParcel1, localParcel2, 0);
          localParcel2.readException();
          return;
        }
        finally
        ...
        throws RemoteException
      {
        ...
        try
        {
          ...
          this.zznF.transact(1007, localParcel1, localParcel2, 0);
          localParcel2.readException();
          return;
        }
        finally
        ...
        throws RemoteException
      {
        ...
        //   61: aload_0
        //   62: getfield 18	com/google/android/gms/internal/zzor$zza$zza:zznF	Landroid/os/IBinder;
        //   65: sipush 1004
        //   68: aload 6
        //   70: aload 7
        //   72: iconst_0
        ...
        throws RemoteException
      {
        ...
        try
        {
          localParcel1.writeInterfaceToken("com.google.android.gms.nearby.internal.connection.INearbyConnectionCallbacks");
          localParcel1.writeString(paramString);
          this.zznF.transact(1005, localParcel1, localParcel2, 0);
          localParcel2.readException();
          return;
        }
        finally
        ...
        throws RemoteException
      {
        ...
        try
        {
          ...
          localParcel1.writeInt(paramInt);
          localParcel1.writeString(paramString);
          this.zznF.transact(1009, localParcel1, localParcel2, 0);
          localParcel2.readException();
          return;
        }
        finally
