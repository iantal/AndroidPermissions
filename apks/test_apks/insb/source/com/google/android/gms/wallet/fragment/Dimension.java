...
public class Dimension
{
  ...
  public static int zza(long paramLong, DisplayMetrics paramDisplayMetrics)
  {
  ...
  public static long zza(int paramInt, float paramFloat)
  {
    switch (paramInt)
    {
    default: 
  ...
  public static long zza(TypedValue paramTypedValue)
  {
    ...
    case 16: 
      return zzjx(paramTypedValue.data);
    }
    return zzt(128, paramTypedValue.data);
  }
  
  public static long zzjx(int paramInt)
  {
    if (paramInt < 0)
    {
