  ...
  implements Players
{
    ...
    extends Games.BaseGamesApiMethodImpl<Players.LoadPlayersResult>
  {
    ...
    public Players.LoadPlayersResult zzaj(final Status paramStatus)
    {
  ...
  {
    protected Players.LoadProfileSettingsResult zzak(final Status paramStatus)
    {
  ...
  {
    public Players.LoadXpForGameCategoriesResult zzal(final Status paramStatus)
    {
  ...
  {
    public Players.LoadXpStreamResult zzam(final Status paramStatus)
    {
