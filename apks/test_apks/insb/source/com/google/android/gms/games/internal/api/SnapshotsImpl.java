  ...
  implements Snapshots
{
  ...
  {
    return Games.zzd(paramGoogleApiClient).zzsQ();
  }
  
  public int getMaxDataSize(GoogleApiClient paramGoogleApiClient)
  {
    return Games.zzd(paramGoogleApiClient).zzsP();
  }
    ...
    extends Games.BaseGamesApiMethodImpl<Snapshots.CommitSnapshotResult>
  {
    ...
    public Snapshots.CommitSnapshotResult zzau(final Status paramStatus)
    {
    ...
    extends Games.BaseGamesApiMethodImpl<Snapshots.DeleteSnapshotResult>
  {
    ...
    public Snapshots.DeleteSnapshotResult zzav(final Status paramStatus)
    {
    ...
    extends Games.BaseGamesApiMethodImpl<Snapshots.LoadSnapshotsResult>
  {
    ...
    public Snapshots.LoadSnapshotsResult zzaw(final Status paramStatus)
    {
    ...
    extends Games.BaseGamesApiMethodImpl<Snapshots.OpenSnapshotResult>
  {
    ...
    public Snapshots.OpenSnapshotResult zzax(final Status paramStatus)
    {
