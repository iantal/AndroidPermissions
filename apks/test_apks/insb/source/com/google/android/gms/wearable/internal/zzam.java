  ...
  implements Parcelable.Creator<GetConnectedNodesResponse>
{
  ...
  static void zza(GetConnectedNodesResponse paramGetConnectedNodesResponse, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zzc(paramParcel, 3, paramGetConnectedNodesResponse.zzaUw, false);
    zzb.zzH(paramParcel, paramInt);
  }
  
  public GetConnectedNodesResponse zzhe(Parcel paramParcel)
  {
    int j = 0;
  ...
  public GetConnectedNodesResponse[] zzkm(int paramInt)
  {
