...
public class zzbp
{
  ...
  public static void zza(String[] paramArrayOfString, int paramInt1, int paramInt2, PriorityQueue<zza> paramPriorityQueue)
  {
    ...
    {
      l1 = zza(zzbn.zzB(paramArrayOfString[(i - 1)]), zzbn.zzB(paramArrayOfString[(i + paramInt2 - 1)]), l1, l2, 16785407L);
  ...
  {
    long l = (zzbn.zzB(paramArrayOfString[paramInt1]) + 2147483647L) % 1073807359L;
    int i = paramInt1 + 1;
    while (i < paramInt1 + paramInt2)
    {
      l = (l * 16785407L % 1073807359L + (zzbn.zzB(paramArrayOfString[i]) + 2147483647L) % 1073807359L) % 1073807359L;
      i += 1;
    }
    return l;
  }
