  ...
  implements SafeParcelable, AutocompletePrediction
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    } while ((zzt.equal(this.zzakM, paramObject.zzakM)) && (zzt.equal(this.zzazK, paramObject.zzazK)) && (zzt.equal(this.zzazo, paramObject.zzazo)) && (zzt.equal(this.zzaAe, paramObject.zzaAe)) && (zzt.equal(Integer.valueOf(this.zzaAf), Integer.valueOf(paramObject.zzaAf))));
    return false;
  }
    ...
    implements SafeParcelable, AutocompletePrediction.Substring
  {
    ...
    public boolean equals(Object paramObject)
    {
      ...
      } while ((zzt.equal(Integer.valueOf(this.mOffset), Integer.valueOf(paramObject.mOffset))) && (zzt.equal(Integer.valueOf(this.mLength), Integer.valueOf(paramObject.mLength))));
      return false;
    }
