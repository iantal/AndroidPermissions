  ...
  implements zzy
{
  ...
  {
    this.zzaF = paramZza;
    this.zzaG = paramSSLSocketFactory;
  }
    ...
    throws IOException
  {
    ...
    if (("https".equals(paramURL.getProtocol())) && (this.zzaG != null)) {
      ((HttpsURLConnection)localHttpURLConnection).setSSLSocketFactory(this.zzaG);
    }
    ...
    throws IOException, zza
  {
    ...
    if (this.zzaF != null)
    {
      str = this.zzaF.zzh((String)localObject);
      paramMap = str;
      if (str == null) {
