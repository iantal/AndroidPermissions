  ...
  extends IInterface
{
    ...
    implements zzmh
  {
    ...
    public static zzmh zzbs(IBinder paramIBinder)
    {
      ...
      if ((localIInterface != null) && ((localIInterface instanceof zzmh))) {
        return (zzmh)localIInterface;
      }
      ...
      implements zzmh
    {
        ...
        throws RemoteException
      {
        ...
        //   24: aload_2
        //   25: iconst_0
        //   26: invokevirtual 46	com/google/android/gms/fitness/result/DataTypeResult:writeToParcel	(Landroid/os/Parcel;I)V
        //   29: aload_0
        //   30: getfield 18	com/google/android/gms/internal/zzmh$zza$zza:zznF	Landroid/os/IBinder;
        //   33: iconst_1
        //   34: aload_2
        //   35: aload_3
        //   36: iconst_0
