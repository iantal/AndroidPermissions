...
public abstract interface zzfe
  extends IInterface
{
    ...
    implements zzfe
  {
    ...
    public static zzfe zzL(IBinder paramIBinder)
    {
      ...
      if ((localIInterface != null) && ((localIInterface instanceof zzfe))) {
        return (zzfe)localIInterface;
      }
