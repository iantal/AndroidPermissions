  ...
  implements Parcelable.Creator<WalletFragmentOptions>
{
  ...
  static void zza(WalletFragmentOptions paramWalletFragmentOptions, Parcel paramParcel, int paramInt)
  {
    ...
    com.google.android.gms.common.internal.safeparcel.zzb.zzc(paramParcel, 1, paramWalletFragmentOptions.zzCY);
  ...
  public WalletFragmentOptions zzgw(Parcel paramParcel)
  {
    int i = 1;
    int j = 0;
  ...
  public WalletFragmentOptions[] zzjz(int paramInt)
  {
