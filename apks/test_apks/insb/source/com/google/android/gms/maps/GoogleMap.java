...
public final class GoogleMap
{
  ...
  {
    this.zzaBp = ((IGoogleMapDelegate)zzu.zzu(paramIGoogleMapDelegate));
  }
  ...
  public final Circle addCircle(CircleOptions paramCircleOptions)
  {
    try
    {
      paramCircleOptions = new Circle(this.zzaBp.addCircle(paramCircleOptions));
  ...
  public final GroundOverlay addGroundOverlay(GroundOverlayOptions paramGroundOverlayOptions)
  {
    try
    {
      paramGroundOverlayOptions = this.zzaBp.addGroundOverlay(paramGroundOverlayOptions);
  ...
  public final Marker addMarker(MarkerOptions paramMarkerOptions)
  {
    try
    {
      paramMarkerOptions = this.zzaBp.addMarker(paramMarkerOptions);
  ...
  public final Polygon addPolygon(PolygonOptions paramPolygonOptions)
  {
    try
    {
      paramPolygonOptions = new Polygon(this.zzaBp.addPolygon(paramPolygonOptions));
  ...
  public final Polyline addPolyline(PolylineOptions paramPolylineOptions)
  {
    try
    {
      paramPolylineOptions = new Polyline(this.zzaBp.addPolyline(paramPolylineOptions));
  ...
  public final TileOverlay addTileOverlay(TileOverlayOptions paramTileOverlayOptions)
  {
    try
    {
      paramTileOverlayOptions = this.zzaBp.addTileOverlay(paramTileOverlayOptions);
  ...
  public final void animateCamera(CameraUpdate paramCameraUpdate)
  {
    try
    {
      this.zzaBp.animateCamera(paramCameraUpdate.zzvg());
      return;
    }
  ...
  public final void animateCamera(CameraUpdate paramCameraUpdate, int paramInt, CancelableCallback paramCancelableCallback)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 104	com/google/android/gms/maps/GoogleMap:zzaBp	Lcom/google/android/gms/maps/internal/IGoogleMapDelegate;
    //   4: astore 4
    //   6: aload_1
    //   7: invokevirtual 180	com/google/android/gms/maps/CameraUpdate:zzvg	()Lcom/google/android/gms/dynamic/zzd;
    //   10: astore 5
    //   12: aload_3
    //   13: ifnonnull +17 -> 30
    //   16: aconst_null
  ...
  public final void animateCamera(CameraUpdate paramCameraUpdate, CancelableCallback paramCancelableCallback)
  {
    ...
    //   4: astore_3
    //   5: aload_1
    //   6: invokevirtual 180	com/google/android/gms/maps/CameraUpdate:zzvg	()Lcom/google/android/gms/dynamic/zzd;
    //   9: astore 4
    //   11: aload_2
    //   12: ifnonnull +15 -> 27
    //   15: aconst_null
  ...
  public final CameraPosition getCameraPosition()
  {
    try
    {
      CameraPosition localCameraPosition = this.zzaBp.getCameraPosition();
  ...
  public IndoorBuilding getFocusedBuilding()
  {
    try
    {
      Object localObject = this.zzaBp.getFocusedBuilding();
      if (localObject != null)
      {
        localObject = new IndoorBuilding((zzg)localObject);
        return localObject;
      }
      return null;
    }
  ...
  public final float getMaxZoomLevel()
  {
    try
    {
      float f = this.zzaBp.getMaxZoomLevel();
      return f;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public final float getMinZoomLevel()
  {
    try
    {
      float f = this.zzaBp.getMinZoomLevel();
      return f;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public final Location getMyLocation()
  {
    try
    {
      Location localLocation = this.zzaBp.getMyLocation();
  ...
  public final Projection getProjection()
  {
    try
    {
      Projection localProjection = new Projection(this.zzaBp.getProjection());
  ...
  public final UiSettings getUiSettings()
  {
    try
    {
      ...
      UiSettings localUiSettings = this.zzaBq;
  ...
  public final boolean isBuildingsEnabled()
  {
    try
    {
      boolean bool = this.zzaBp.isBuildingsEnabled();
      return bool;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public final boolean isIndoorEnabled()
  {
    try
    {
      boolean bool = this.zzaBp.isIndoorEnabled();
      return bool;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public final boolean isMyLocationEnabled()
  {
    try
    {
      boolean bool = this.zzaBp.isMyLocationEnabled();
      return bool;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public final boolean isTrafficEnabled()
  {
    try
    {
      boolean bool = this.zzaBp.isTrafficEnabled();
      return bool;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public final void moveCamera(CameraUpdate paramCameraUpdate)
  {
    try
    {
      this.zzaBp.moveCamera(paramCameraUpdate.zzvg());
      return;
    }
    catch (RemoteException paramCameraUpdate)
    {
  ...
  public final void setBuildingsEnabled(boolean paramBoolean)
  {
    try
    {
      this.zzaBp.setBuildingsEnabled(paramBoolean);
      return;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public final void setContentDescription(String paramString)
  {
    try
    {
      this.zzaBp.setContentDescription(paramString);
      return;
    }
  ...
  public final boolean setIndoorEnabled(boolean paramBoolean)
  {
    try
    {
      paramBoolean = this.zzaBp.setIndoorEnabled(paramBoolean);
      return paramBoolean;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public final void setInfoWindowAdapter(final InfoWindowAdapter paramInfoWindowAdapter)
  {
    ...
    this.zzaBp.setInfoWindowAdapter(new zzd.zza()
    {
      ...
      {
        return zze.zzw(paramInfoWindowAdapter.getInfoWindow(new Marker(paramAnonymousZzi)));
      }
      
      public zzd zzg(com.google.android.gms.maps.model.internal.zzi paramAnonymousZzi)
      {
        return zze.zzw(paramInfoWindowAdapter.getInfoContents(new Marker(paramAnonymousZzi)));
      }
    });
  }
  ...
  public final void setMapType(int paramInt)
  {
    try
    {
      this.zzaBp.setMapType(paramInt);
      return;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public final void setMyLocationEnabled(boolean paramBoolean)
  {
    try
    {
      this.zzaBp.setMyLocationEnabled(paramBoolean);
      return;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public final void setOnMyLocationChangeListener(final OnMyLocationChangeListener paramOnMyLocationChangeListener)
  {
    ...
    this.zzaBp.setOnMyLocationChangeListener(new zzq.zza()
    {
      ...
      public void zzo(zzd paramAnonymousZzd)
      {
        paramOnMyLocationChangeListener.onMyLocationChange((Location)zze.zzn(paramAnonymousZzd));
      }
    });
  }
  ...
  public final void setPadding(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    try
    {
      this.zzaBp.setPadding(paramInt1, paramInt2, paramInt3, paramInt4);
      return;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public final void setTrafficEnabled(boolean paramBoolean)
  {
    try
    {
      this.zzaBp.setTrafficEnabled(paramBoolean);
      return;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  {
    if (paramBitmap != null) {}
    for (paramBitmap = zze.zzw(paramBitmap);; paramBitmap = null)
    {
      ...
      try
      {
        this.zzaBp.snapshot(new zzw.zza()
        {
          ...
          public void zzp(zzd paramAnonymousZzd)
            throws RemoteException
          {
            paramSnapshotReadyCallback.onSnapshotReady((Bitmap)zze.zzn(paramAnonymousZzd));
          }
        }, paramBitmap);
        return;
      }
  ...
  private static final class zza
    extends zzb.zza
  {
    private final GoogleMap.CancelableCallback zzaBH;
    
    zza(GoogleMap.CancelableCallback paramCancelableCallback)
    {
      this.zzaBH = paramCancelableCallback;
    }
