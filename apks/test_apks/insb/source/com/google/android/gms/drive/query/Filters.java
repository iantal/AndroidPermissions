...
public class Filters
{
  ...
  {
    return new LogicalFilter(Operator.zzaim, paramFilter, paramVarArgs);
  }
  
  public static Filter and(Iterable<Filter> paramIterable)
  {
    return new LogicalFilter(Operator.zzaim, paramIterable);
  }
  
  public static Filter contains(SearchableMetadataField<String> paramSearchableMetadataField, String paramString)
  {
    return new ComparisonFilter(Operator.zzaip, paramSearchableMetadataField, paramString);
  }
  
  public static Filter eq(CustomPropertyKey paramCustomPropertyKey, String paramString)
  {
    return new HasFilter(SearchableField.zzahN, new AppVisibleCustomProperties.zza().zza(paramCustomPropertyKey, paramString).zzpU());
  }
  
  public static <T> Filter eq(SearchableMetadataField<T> paramSearchableMetadataField, T paramT)
  {
    return new ComparisonFilter(Operator.zzaih, paramSearchableMetadataField, paramT);
  }
  ...
  {
    return new ComparisonFilter(Operator.zzaik, paramSearchableOrderedMetadataField, paramT);
  }
  ...
  {
    return new ComparisonFilter(Operator.zzail, paramSearchableOrderedMetadataField, paramT);
  }
  ...
  {
    return new ComparisonFilter(Operator.zzaii, paramSearchableOrderedMetadataField, paramT);
  }
  ...
  {
    return new ComparisonFilter(Operator.zzaij, paramSearchableOrderedMetadataField, paramT);
  }
  ...
  {
    return new LogicalFilter(Operator.zzain, paramFilter, paramVarArgs);
  }
  
  public static Filter or(Iterable<Filter> paramIterable)
  {
    return new LogicalFilter(Operator.zzain, paramIterable);
  }
