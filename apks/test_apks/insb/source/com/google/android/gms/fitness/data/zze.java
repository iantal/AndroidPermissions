  ...
  implements Parcelable.Creator<DataSet>
{
  ...
  static void zza(DataSet paramDataSet, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zzd(paramParcel, 3, paramDataSet.zzqz(), false);
    zzb.zzc(paramParcel, 4, paramDataSet.zzqA(), false);
    zzb.zza(paramParcel, 5, paramDataSet.zzqr());
    zzb.zzH(paramParcel, i);
  }
  
  public DataSet zzcm(Parcel paramParcel)
  {
    boolean bool = false;
  ...
  public DataSet[] zzef(int paramInt)
  {
