  ...
  implements zzau
{
  ...
  {
    SQLiteDatabase localSQLiteDatabase = zzer("Error opening database for getNumStoredHits.");
    ...
    {
      zzbg.zzaC("Error setting HIT_FIRST_DISPATCH_TIME for hitId: " + paramLong1);
      zzq(paramLong1);
    }
  }
  
  private SQLiteDatabase zzer(String paramString)
  {
    try
    {
      SQLiteDatabase localSQLiteDatabase = this.zzaMs.getWritableDatabase();
  ...
  {
    SQLiteDatabase localSQLiteDatabase = zzer("Error opening database for putHit");
    if (localSQLiteDatabase == null) {
      return;
    }
    ContentValues localContentValues = new ContentValues();
  ...
  private void zzzb()
  {
    int i = zzzc() - this.zzaMx + 1;
    if (i > 0)
    {
      List localList = zziY(i);
      zzbg.zzaB("Store full, deleting " + localList.size() + " hits to make room.");
  ...
  void zzf(String[] paramArrayOfString)
  {
    ...
    {
      return;
      localSQLiteDatabase = zzer("Error opening database for deleteHits.");
    ...
    for (;;)
    {
      try
      {
        ...
        paramArrayOfString = this.zzaMu;
        if (zzzc() == 0)
        {
          paramArrayOfString.zzan(bool);
          return;
        }
      }
  ...
  /* Error */
  List<String> zziY(int paramInt)
  {
    // Byte code:
    //   0: new 305	java/util/ArrayList
    //   3: dup
    //   4: invokespecial 306	java/util/ArrayList:<init>	()V
    //   7: astore 6
    //   9: iload_1
    //   10: ifgt +12 -> 22
    //   13: ldc_w 308
    //   16: invokestatic 171	com/google/android/gms/tagmanager/zzbg:zzaC	(Ljava/lang/String;)V
    //   19: aload 6
    //   21: areturn
    //   22: aload_0
    //   23: ldc_w 310
    //   26: invokespecial 125	com/google/android/gms/tagmanager/zzby:zzer	(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    //   29: astore_3
    //   30: aload_3
    //   31: ifnonnull +6 -> 37
    //   34: aload 6
    ...
    //   52: astore 4
    //   54: iload_1
    //   55: invokestatic 315	java/lang/Integer:toString	(I)Ljava/lang/String;
    //   58: astore 5
    //   60: aload_3
    //   61: ldc 35
    //   63: iconst_1
    ...
    //   76: aload 4
    //   78: aload 5
    //   80: invokevirtual 319	android/database/sqlite/SQLiteDatabase:query	(Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   83: astore 4
    //   85: aload 4
    //   87: astore_3
    //   88: aload 4
    ...
    //   111: invokestatic 143	java/lang/String:valueOf	(J)Ljava/lang/String;
    ...
    //   171: aload 5
    //   173: invokevirtual 343	android/database/sqlite/SQLiteException:getMessage	()Ljava/lang/String;
    ...
    //   182: invokestatic 171	com/google/android/gms/tagmanager/zzbg:zzaC	(Ljava/lang/String;)V
    //   185: aload 4
    //   187: ifnull -40 -> 147
    //   190: aload 4
    //   192: invokeinterface 338 1 0
    //   197: goto -50 -> 147
    //   200: astore 4
    //   202: aconst_null
    //   203: astore_3
  ...
  /* Error */
  public List<zzaq> zziZ(int paramInt)
  {
    // Byte code:
    //   0: new 305	java/util/ArrayList
    //   3: dup
    ...
    //   9: aload_0
    //   10: ldc_w 347
    //   13: invokespecial 125	com/google/android/gms/tagmanager/zzby:zzer	(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    //   16: astore 8
    //   18: aload 8
    //   20: ifnonnull +10 -> 30
    //   23: aload 5
    ...
    //   48: astore 6
    //   50: iload_1
    //   51: invokestatic 315	java/lang/Integer:toString	(I)Ljava/lang/String;
    //   54: astore 7
    //   56: aload 8
    //   58: ldc 35
    //   60: iconst_3
    ...
    //   83: aload 6
    //   85: aload 7
    //   87: invokevirtual 319	android/database/sqlite/SQLiteDatabase:query	(Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   90: astore 6
    //   92: aload 6
    //   94: astore 4
    //   96: new 305	java/util/ArrayList
    //   99: dup
    //   100: invokespecial 306	java/util/ArrayList:<init>	()V
    //   103: astore 7
    //   105: aload 4
    //   107: invokeinterface 324 1 0
    //   112: ifeq +54 -> 166
    //   115: aload 7
    //   117: new 349	com/google/android/gms/tagmanager/zzaq
    //   120: dup
    //   121: aload 4
    //   123: iconst_0
    ...
    //   129: aload 4
    //   131: iconst_1
    //   132: invokeinterface 328 2 0
    //   137: aload 4
    //   139: iconst_2
    //   140: invokeinterface 328 2 0
    //   145: invokespecial 352	com/google/android/gms/tagmanager/zzaq:<init>	(JJJ)V
    //   148: invokeinterface 332 2 0
    //   153: pop
    //   154: aload 4
    //   156: invokeinterface 335 1 0
    //   161: istore_3
    //   162: iload_3
    //   163: ifne -48 -> 115
    //   166: aload 4
    ...
    //   201: astore 5
    //   203: iload_1
    //   204: invokestatic 315	java/lang/Integer:toString	(I)Ljava/lang/String;
    //   207: astore 9
    //   209: aload 4
    //   211: astore 5
    //   213: aload 8
    ...
    //   235: aload 6
    //   237: aload 9
    //   239: invokevirtual 319	android/database/sqlite/SQLiteDatabase:query	(Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   242: astore 6
    //   244: aload 6
    //   246: invokeinterface 324 1 0
    //   251: ifeq +53 -> 304
    //   254: iconst_0
    //   255: istore_1
    //   256: aload 6
    //   258: checkcast 354	android/database/sqlite/SQLiteCursor
    //   261: invokevirtual 358	android/database/sqlite/SQLiteCursor:getWindow	()Landroid/database/CursorWindow;
    //   264: invokevirtual 363	android/database/CursorWindow:getNumRows	()I
    //   267: ifle +136 -> 403
    //   270: aload 7
    //   272: iload_1
    //   273: invokeinterface 367 2 0
    //   278: checkcast 349	com/google/android/gms/tagmanager/zzaq
    //   281: aload 6
    //   283: iconst_1
    //   284: invokeinterface 370 2 0
    //   289: invokevirtual 373	com/google/android/gms/tagmanager/zzaq:zzev	(Ljava/lang/String;)V
    //   292: aload 6
    //   294: invokeinterface 335 1 0
    //   299: istore_3
    //   300: iload_3
    //   301: ifne +375 -> 676
    //   304: aload 6
    ...
    //   328: aload 7
    //   330: astore 5
    //   332: new 151	java/lang/StringBuilder
    //   335: dup
    //   336: invokespecial 152	java/lang/StringBuilder:<init>	()V
    //   339: ldc_w 340
    //   342: invokevirtual 158	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   345: aload 6
    //   347: invokevirtual 343	android/database/sqlite/SQLiteException:getMessage	()Ljava/lang/String;
    //   350: invokevirtual 158	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   353: invokevirtual 165	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   356: invokestatic 171	com/google/android/gms/tagmanager/zzbg:zzaC	(Ljava/lang/String;)V
    //   359: aload 4
    //   361: astore 6
    //   363: aload 5
    //   365: ifnull -338 -> 27
    //   368: aload 5
    //   370: invokeinterface 338 1 0
    //   375: aload 4
    //   377: areturn
    //   378: astore 6
    //   380: aload 4
    ...
    //   412: aload 7
    //   414: iload_1
    //   415: invokeinterface 367 2 0
    //   420: checkcast 349	com/google/android/gms/tagmanager/zzaq
    //   423: invokevirtual 379	com/google/android/gms/tagmanager/zzaq:zzyO	()J
    //   426: invokestatic 134	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   429: aastore
    //   430: invokestatic 49	java/lang/String:format	(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    //   433: invokestatic 171	com/google/android/gms/tagmanager/zzbg:zzaC	(Ljava/lang/String;)V
    //   436: goto -144 -> 292
    //   439: astore 5
    //   441: aload 6
    //   443: astore 4
    ...
    //   449: aload 4
    //   451: astore 5
    //   453: new 151	java/lang/StringBuilder
    //   456: dup
    //   457: invokespecial 152	java/lang/StringBuilder:<init>	()V
    //   460: ldc_w 381
    //   463: invokevirtual 158	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   466: aload 6
    //   468: invokevirtual 343	android/database/sqlite/SQLiteException:getMessage	()Ljava/lang/String;
    //   471: invokevirtual 158	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   474: invokevirtual 165	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   477: invokestatic 171	com/google/android/gms/tagmanager/zzbg:zzaC	(Ljava/lang/String;)V
    //   480: aload 4
    //   482: astore 5
    //   484: new 305	java/util/ArrayList
    //   487: dup
    //   488: invokespecial 306	java/util/ArrayList:<init>	()V
    //   491: astore 6
    //   493: iconst_0
    //   494: istore_1
    //   495: aload 4
    ...
    //   510: astore 5
    //   512: aload 7
    //   514: invokeinterface 390 1 0
    //   519: ifeq +42 -> 561
    //   522: aload 4
    //   524: astore 5
    //   526: aload 7
    //   528: invokeinterface 394 1 0
    //   533: checkcast 349	com/google/android/gms/tagmanager/zzaq
    //   536: astore 8
    //   538: aload 4
    //   540: astore 5
    //   542: aload 8
    //   544: invokevirtual 397	com/google/android/gms/tagmanager/zzaq:zzyQ	()Ljava/lang/String;
    //   547: invokestatic 400	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   550: istore_3
    //   551: iload_1
    //   552: istore_2
    //   553: iload_3
  ...
  int zzis()
  {
    ...
    if (l <= this.zzaMw + 86400000L) {}
    do
    {
      return 0;
      this.zzaMw = l;
      localObject = zzer("Error opening database for deleteStaleHits.");
    } while (localObject == null);
    int i = ((SQLiteDatabase)localObject).delete("gtm_hits", "HIT_TIME < ?", new String[] { Long.toString(this.zzpw.currentTimeMillis() - 2592000000L) });
    Object localObject = this.zzaMu;
    if (zzzc() == 0) {}
    for (;;)
    {
      ((zzav)localObject).zzan(bool);
      return i;
      bool = false;
    }
  }
  ...
  int zzzc()
  {
    ...
    int i = 0;
    int j = 0;
    Object localObject5 = zzer("Error opening database for getNumStoredHits.");
  ...
  int zzzd()
  {
    ...
    //   3: aload_0
    //   4: ldc 121
    //   6: invokespecial 125	com/google/android/gms/tagmanager/zzby:zzer	(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    //   9: astore_3
    //   10: aload_3
    //   11: ifnonnull +5 -> 16
    //   14: iconst_0
    ...
    //   69: astore_3
    //   70: ldc_w 434
    //   73: invokestatic 171	com/google/android/gms/tagmanager/zzbg:zzaC	(Ljava/lang/String;)V
    //   76: aload_3
    //   77: ifnull +56 -> 133
    //   80: aload_3
    ...
    implements zzcx.zza
  {
    ...
    {
      zzby.zza(zzby.this, paramZzaq.zzyO());
    }
    
    public void zzb(zzaq paramZzaq)
    {
      zzby.zza(zzby.this, paramZzaq.zzyO());
      zzbg.zzaB("Permanent failure dispatching hitId: " + paramZzaq.zzyO());
    }
    
    public void zzc(zzaq paramZzaq)
    {
      long l = paramZzaq.zzyP();
      if (l == 0L) {
        zzby.zza(zzby.this, paramZzaq.zzyO(), zzby.zza(zzby.this).currentTimeMillis());
      }
      while (l + 14400000L >= zzby.zza(zzby.this).currentTimeMillis()) {
        return;
      }
      zzby.zza(zzby.this, paramZzaq.zzyO());
      zzbg.zzaB("Giving up on failed hitId: " + paramZzaq.zzyO());
    }
  }
    ...
    extends SQLiteOpenHelper
  {
    ...
    private boolean zza(String paramString, SQLiteDatabase paramSQLiteDatabase)
    {
      ...
      //   73: invokestatic 71	com/google/android/gms/tagmanager/zzbg:zzaC	(Ljava/lang/String;)V
      //   76: aload_2
      //   77: ifnull +9 -> 86
      //   80: aload_2
    ...
    {
      if ((this.zzaMz) && (this.zzaMA + 3600000L > zzby.zza(zzby.this).currentTimeMillis())) {
        throw new SQLiteException("Database creation failed");
      }
      Object localObject1 = null;
      this.zzaMz = true;
      this.zzaMA = zzby.zza(zzby.this).currentTimeMillis();
      try
      {
    ...
    {
      zzal.zzbe(paramSQLiteDatabase.getPath());
    }
    ...
    public void onOpen(SQLiteDatabase paramSQLiteDatabase)
    {
      ...
      try
      {
        ...
        {
          paramSQLiteDatabase.execSQL(zzby.zzze());
          return;
        }
      }
      finally
