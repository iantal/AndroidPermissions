...
abstract class zzkv<K, V>
{
    ...
    implements Set<Map.Entry<K, V>>
  {
    ...
    public boolean contains(Object paramObject)
    {
      ...
      do
      {
        ...
        i = zzkv.this.colIndexOfKey(paramObject.getKey());
      } while (i < 0);
      return zzkt.equal(zzkv.this.colGetEntry(i, 1), paramObject.getValue());
    }
    ...
    implements Iterator<Map.Entry<K, V>>, Map.Entry<K, V>
  {
    ...
    public final boolean equals(Object paramObject)
    {
      ...
      paramObject = (Map.Entry)paramObject;
      if ((zzkt.equal(paramObject.getKey(), zzkv.this.colGetEntry(this.mIndex, 0))) && (zzkt.equal(paramObject.getValue(), zzkv.this.colGetEntry(this.mIndex, 1)))) {}
      for (;;)
      {
        return bool;
        bool = false;
    ...
    public V setValue(V paramV)
    {
      ...
      return zzkv.this.colSetValue(this.mIndex, paramV);
    }
