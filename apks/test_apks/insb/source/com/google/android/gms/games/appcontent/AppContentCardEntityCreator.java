  ...
  implements Parcelable.Creator<AppContentCardEntity>
{
  ...
  static void zza(AppContentCardEntity paramAppContentCardEntity, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zzc(paramParcel, 2, paramAppContentCardEntity.zzrZ(), false);
    zzb.zzc(paramParcel, 3, paramAppContentCardEntity.zzrO(), false);
    zzb.zza(paramParcel, 4, paramAppContentCardEntity.zzrP(), false);
    zzb.zzc(paramParcel, 5, paramAppContentCardEntity.zzsa());
    ...
    zzb.zza(paramParcel, 10, paramAppContentCardEntity.zzsb(), false);
    zzb.zza(paramParcel, 11, paramAppContentCardEntity.getTitle(), false);
    zzb.zzc(paramParcel, 12, paramAppContentCardEntity.zzsc());
  ...
  public AppContentCardEntity zzdy(Parcel paramParcel)
  {
  ...
  public AppContentCardEntity[] zzfu(int paramInt)
  {
