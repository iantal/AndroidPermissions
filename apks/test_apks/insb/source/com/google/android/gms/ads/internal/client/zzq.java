...
public abstract interface zzq
  extends IInterface
{
  public abstract IBinder zza(zzd paramZzd, String paramString, zzef paramZzef, int paramInt)
    ...
    implements zzq
  {
      ...
      throws RemoteException
    {
      ...
      paramParcel1 = zza(zzd.zza.zzbg(paramParcel1.readStrongBinder()), paramParcel1.readString(), zzef.zza.zzE(paramParcel1.readStrongBinder()), paramParcel1.readInt());
      ...
      implements zzq
    {
      ...
      /* Error */
      public IBinder zza(zzd paramZzd, String paramString, zzef paramZzef, int paramInt)
        throws RemoteException
      {
        // Byte code:
        //   0: aconst_null
        ...
        //   70: aload_0
        //   71: getfield 18	com/google/android/gms/ads/internal/client/zzq$zza$zza:zznF	Landroid/os/IBinder;
        //   74: iconst_1
        //   75: aload 6
        //   77: aload 7
        //   79: iconst_0
