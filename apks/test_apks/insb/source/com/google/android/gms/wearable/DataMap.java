...
public class DataMap
{
  ...
  public static DataMap fromByteArray(byte[] paramArrayOfByte)
  {
    try
    {
      paramArrayOfByte = zzrb.zza(new zzrb.zza(zzrc.zzw(paramArrayOfByte), new ArrayList()));
  ...
  {
    return this.zzaSU.containsKey(paramString);
  }
  ...
  {
    return this.zzaSU.get(paramString);
  }
  
  public Asset getAsset(String paramString)
  {
    Object localObject = this.zzaSU.get(paramString);
    if (localObject == null) {
      return null;
    }
    try
  ...
  public void putAll(DataMap paramDataMap)
  {
    ...
    {
      String str = (String)localIterator.next();
      this.zzaSU.put(str, paramDataMap.get(str));
    }
  }
  
  public void putAsset(String paramString, Asset paramAsset)
  {
    this.zzaSU.put(paramString, paramAsset);
  }
  
  public void putBoolean(String paramString, boolean paramBoolean)
  {
    this.zzaSU.put(paramString, Boolean.valueOf(paramBoolean));
  }
  
  public void putByte(String paramString, byte paramByte)
  {
    this.zzaSU.put(paramString, Byte.valueOf(paramByte));
  }
  
  public void putByteArray(String paramString, byte[] paramArrayOfByte)
  {
    this.zzaSU.put(paramString, paramArrayOfByte);
  }
  
  public void putDataMap(String paramString, DataMap paramDataMap)
  {
    this.zzaSU.put(paramString, paramDataMap);
  }
  
  public void putDataMapArrayList(String paramString, ArrayList<DataMap> paramArrayList)
  {
    this.zzaSU.put(paramString, paramArrayList);
  }
  
  public void putDouble(String paramString, double paramDouble)
  {
    this.zzaSU.put(paramString, Double.valueOf(paramDouble));
  }
  
  public void putFloat(String paramString, float paramFloat)
  {
    this.zzaSU.put(paramString, Float.valueOf(paramFloat));
  }
  
  public void putFloatArray(String paramString, float[] paramArrayOfFloat)
  {
    this.zzaSU.put(paramString, paramArrayOfFloat);
  }
  
  public void putInt(String paramString, int paramInt)
  {
    this.zzaSU.put(paramString, Integer.valueOf(paramInt));
  }
  ...
  {
    this.zzaSU.put(paramString, Long.valueOf(paramLong));
  }
  
  public void putLongArray(String paramString, long[] paramArrayOfLong)
  {
    this.zzaSU.put(paramString, paramArrayOfLong);
  }
  
  public void putString(String paramString1, String paramString2)
  {
    this.zzaSU.put(paramString1, paramString2);
  }
  
  public void putStringArray(String paramString, String[] paramArrayOfString)
  {
    this.zzaSU.put(paramString, paramArrayOfString);
  }
  ...
  {
    return this.zzaSU.remove(paramString);
  }
  ...
  public Bundle toBundle()
  {
    ...
    Iterator localIterator = this.zzaSU.keySet().iterator();
    while (localIterator.hasNext())
    {
      String str = (String)localIterator.next();
      zza(localBundle, str, this.zzaSU.get(str));
    }
    return localBundle;
  }
