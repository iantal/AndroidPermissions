  ...
  extends IInterface
{
    ...
    implements zzcx
  {
    ...
    public static zzcx zzC(IBinder paramIBinder)
    {
      ...
      throws RemoteException
    {
      ...
      zza(zzcs.zza.zzy(paramParcel1.readStrongBinder()));
      ...
      implements zzcx
    {
        ...
        throws RemoteException
      {
        ...
        //   30: aload_0
        //   31: getfield 18	com/google/android/gms/internal/zzcx$zza$zza:zznF	Landroid/os/IBinder;
        //   34: iconst_1
        //   35: aload_2
        //   36: aload_3
        //   37: iconst_0
