  ...
  extends zzi<zznm>
{
  ...
  public zznk(Activity paramActivity, Looper paramLooper, GoogleApiClient.ConnectionCallbacks paramConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener paramOnConnectionFailedListener, String paramString, int paramInt)
  {
  ...
  {
    zzuc();
    this.zzawz = new zza(paramInt, this.mActivity);
    try
    {
      ...
      if (!TextUtils.isEmpty(this.zzOx)) {
        localBundle.putParcelable("com.google.android.gms.identity.intents.EXTRA_ACCOUNT", new Account(this.zzOx, "com.google"));
      }
      localBundle.putInt("com.google.android.gms.identity.intents.EXTRA_THEME", this.mTheme);
      zzub().zza(this.zzawz, paramUserAddressRequest, localBundle);
      return;
    }
    catch (RemoteException paramUserAddressRequest)
    {
      ...
      this.zzawz.zzh(1, paramUserAddressRequest);
    }
  }
  
  protected zznm zzbO(IBinder paramIBinder)
  {
    return zznm.zza.zzbQ(paramIBinder);
  }
    ...
    extends zznl.zza
  {
    ...
    public void zzh(int paramInt, Bundle paramBundle)
    {
      ...
      if (paramInt == 1)
      {
        ...
        paramBundle = this.mActivity.createPendingResult(this.zzZY, (Intent)localObject, 1073741824);
        if (paramBundle != null) {}
      }
      for (;;)
      {
        ...
        if (paramBundle.hasResolution()) {
          try
          {
            paramBundle.startResolutionForResult(this.mActivity, this.zzZY);
            return;
          }
        ...
        try
        {
          paramBundle = this.mActivity.createPendingResult(this.zzZY, new Intent(), 1073741824);
          if (paramBundle != null)
          {
            paramBundle.send(1);
            return;
