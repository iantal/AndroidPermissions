...
public abstract interface zzir
  extends IInterface
{
    ...
    implements zzir
  {
    ...
    public static zzir zzae(IBinder paramIBinder)
    {
      ...
      if ((localIInterface != null) && ((localIInterface instanceof zzir))) {
        return (zzir)localIInterface;
      }
      ...
      implements zzir
    {
        ...
        throws RemoteException
      {
        ...
        //   25: aload_0
        //   26: getfield 18	com/google/android/gms/internal/zzir$zza$zza:zznF	Landroid/os/IBinder;
        //   29: iconst_4
        //   30: aload_2
        //   31: aconst_null
        //   32: iconst_1
