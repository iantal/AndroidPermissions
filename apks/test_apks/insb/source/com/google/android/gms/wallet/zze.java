  ...
  implements Parcelable.Creator<FullWallet>
{
  ...
  static void zza(FullWallet paramFullWallet, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zza(paramParcel, 2, paramFullWallet.zzaQm, false);
    zzb.zza(paramParcel, 3, paramFullWallet.zzaQn, false);
    zzb.zza(paramParcel, 4, paramFullWallet.zzaQo, paramInt, false);
    zzb.zza(paramParcel, 5, paramFullWallet.zzaQp, false);
    zzb.zza(paramParcel, 6, paramFullWallet.zzaQq, paramInt, false);
    zzb.zza(paramParcel, 7, paramFullWallet.zzaQr, paramInt, false);
    zzb.zza(paramParcel, 8, paramFullWallet.zzaQs, false);
    zzb.zza(paramParcel, 9, paramFullWallet.zzaQt, paramInt, false);
    zzb.zza(paramParcel, 10, paramFullWallet.zzaQu, paramInt, false);
    zzb.zza(paramParcel, 11, paramFullWallet.zzaQv, paramInt, false);
    zzb.zza(paramParcel, 12, paramFullWallet.zzaQw, paramInt, false);
    zzb.zzH(paramParcel, i);
  }
  
  public FullWallet zzge(Parcel paramParcel)
  {
  ...
  public FullWallet[] zzjg(int paramInt)
  {
