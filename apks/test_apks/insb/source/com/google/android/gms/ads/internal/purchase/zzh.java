...
public class zzh
{
  ...
  {
    this.zzAY = new zza(paramContext, "google_inapp_purchase.db");
  }
  ...
  public int getRecordCount()
  {
    ...
    catch (SQLiteException localSQLiteException)
    {
      for (;;)
      {
        ...
        zzb.zzaC("Error getting record count" + localSQLiteException.getMessage());
  ...
  public SQLiteDatabase getWritableDatabase()
  {
    try
    {
      SQLiteDatabase localSQLiteDatabase = this.zzAY.getWritableDatabase();
  ...
  public void zza(zzf paramZzf)
  {
    ...
    localSQLiteDatabase.delete("InAppPurchase", String.format("%s = %d", new Object[] { "purchase_id", Long.valueOf(paramZzf.zzAR) }), null);
  }
  ...
  public void zzb(zzf paramZzf)
  {
    ...
    localContentValues.put("product_id", paramZzf.zzAT);
    localContentValues.put("developer_payload", paramZzf.zzAS);
    localContentValues.put("record_time", Long.valueOf(SystemClock.elapsedRealtime()));
    paramZzf.zzAR = localSQLiteDatabase.insert("InAppPurchase", null, localContentValues);
  ...
  {
    // Byte code:
    //   0: getstatic 43	com/google/android/gms/ads/internal/purchase/zzh:zzqt	Ljava/lang/Object;
    //   3: astore 7
    //   5: aload 7
    //   7: monitorenter
    //   8: new 182	java/util/LinkedList
    //   11: dup
    //   12: invokespecial 183	java/util/LinkedList:<init>	()V
    //   15: astore 8
    //   17: lload_1
    //   18: lconst_0
    //   19: lcmp
    ...
    //   28: areturn
    //   29: aload_0
    //   30: invokevirtual 68	com/google/android/gms/ads/internal/purchase/zzh:getWritableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   33: astore 4
    //   35: aload 4
    //   37: ifnonnull +9 -> 46
    //   40: aload 7
    ...
    //   55: ldc -71
    //   57: lload_1
    //   58: invokestatic 188	java/lang/String:valueOf	(J)Ljava/lang/String;
    ...
    //   148: ldc -51
    //   150: invokevirtual 98	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   153: aload 6
    //   155: invokevirtual 101	android/database/sqlite/SQLiteException:getMessage	()Ljava/lang/String;
    ...
    //   164: invokestatic 110	com/google/android/gms/ads/internal/util/client/zzb:zzaC	(Ljava/lang/String;)V
    //   167: aload 5
    //   169: ifnull -43 -> 126
    //   172: aload 5
    //   174: invokeinterface 89 1 0
    //   179: goto -53 -> 126
    //   182: astore 4
    //   184: aload 7
    //   186: monitorexit
  ...
  public void zzfg()
  {
    ...
    //   7: monitorenter
    //   8: aload_0
    //   9: invokevirtual 68	com/google/android/gms/ads/internal/purchase/zzh:getWritableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   12: astore_1
    //   13: aload_1
    //   14: ifnonnull +7 -> 21
    //   17: aload 4
    ...
    //   60: invokevirtual 211	com/google/android/gms/ads/internal/purchase/zzh:zza	(Lcom/google/android/gms/ads/internal/purchase/zzf;)V
    //   63: aload_2
    //   64: ifnull +9 -> 73
    //   67: aload_2
    ...
    //   100: aload_3
    //   101: invokevirtual 101	android/database/sqlite/SQLiteException:getMessage	()Ljava/lang/String;
    //   104: invokevirtual 98	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   107: invokevirtual 104	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   110: invokestatic 110	com/google/android/gms/ads/internal/util/client/zzb:zzaC	(Ljava/lang/String;)V
    //   113: aload_2
    //   114: ifnull -41 -> 73
    //   117: aload_2
    ...
    extends SQLiteOpenHelper
  {
    ...
    {
      paramSQLiteDatabase.execSQL(zzh.zzfh());
    }
    
    public void onUpgrade(SQLiteDatabase paramSQLiteDatabase, int paramInt1, int paramInt2)
    {
      zzb.zzaA("Database updated from version " + paramInt1 + " to version " + paramInt2);
