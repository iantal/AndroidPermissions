...
public final class Primitives
{
  ...
  {
    Object localObject = (Class)WRAPPER_TO_PRIMITIVE_TYPE.get(.Gson.Preconditions.checkNotNull(paramClass));
    if (localObject == null) {
  ...
  {
    Object localObject = (Class)PRIMITIVE_TO_WRAPPER_TYPE.get(.Gson.Preconditions.checkNotNull(paramClass));
    if (localObject == null) {
      localObject = paramClass;
    }
    return localObject;
