  ...
  implements TabsContainer.TabItemListener
{
  ...
  private void extractValuesFromAttributes(AttributeSet paramAttributeSet, @AttrRes int paramInt)
  {
    ...
    {
      TypedArray localTypedArray = getContext().obtainStyledAttributes(paramAttributeSet, R.styleable.StepperLayout, paramInt, 0);
      if (localTypedArray.hasValue(R.styleable.StepperLayout_ms_backButtonColor)) {
        this.mBackButtonColor = localTypedArray.getColorStateList(R.styleable.StepperLayout_ms_backButtonColor);
      }
      if (localTypedArray.hasValue(R.styleable.StepperLayout_ms_nextButtonColor)) {
        this.mNextButtonColor = localTypedArray.getColorStateList(R.styleable.StepperLayout_ms_nextButtonColor);
      }
      if (localTypedArray.hasValue(R.styleable.StepperLayout_ms_completeButtonColor)) {
        this.mCompleteButtonColor = localTypedArray.getColorStateList(R.styleable.StepperLayout_ms_completeButtonColor);
      }
      if (localTypedArray.hasValue(R.styleable.StepperLayout_ms_activeStepColor)) {
        this.mSelectedColor = localTypedArray.getColor(R.styleable.StepperLayout_ms_activeStepColor, this.mSelectedColor);
      }
      if (localTypedArray.hasValue(R.styleable.StepperLayout_ms_inactiveStepColor)) {
        this.mUnselectedColor = localTypedArray.getColor(R.styleable.StepperLayout_ms_inactiveStepColor, this.mUnselectedColor);
      }
      if (localTypedArray.hasValue(R.styleable.StepperLayout_ms_errorColor)) {
        this.mErrorColor = localTypedArray.getColor(R.styleable.StepperLayout_ms_errorColor, this.mErrorColor);
      }
      if (localTypedArray.hasValue(R.styleable.StepperLayout_ms_bottomNavigationBackground)) {
        this.mBottomNavigationBackground = localTypedArray.getResourceId(R.styleable.StepperLayout_ms_bottomNavigationBackground, 0);
      }
      if (localTypedArray.hasValue(R.styleable.StepperLayout_ms_backButtonBackground)) {
        this.mBackButtonBackground = localTypedArray.getResourceId(R.styleable.StepperLayout_ms_backButtonBackground, 0);
      }
      if (localTypedArray.hasValue(R.styleable.StepperLayout_ms_nextButtonBackground)) {
        this.mNextButtonBackground = localTypedArray.getResourceId(R.styleable.StepperLayout_ms_nextButtonBackground, 0);
      }
      if (localTypedArray.hasValue(R.styleable.StepperLayout_ms_completeButtonBackground)) {
        this.mCompleteButtonBackground = localTypedArray.getResourceId(R.styleable.StepperLayout_ms_completeButtonBackground, 0);
      }
      if (localTypedArray.hasValue(R.styleable.StepperLayout_ms_backButtonText)) {
        this.mBackButtonText = localTypedArray.getString(R.styleable.StepperLayout_ms_backButtonText);
      }
      if (localTypedArray.hasValue(R.styleable.StepperLayout_ms_nextButtonText)) {
        this.mNextButtonText = localTypedArray.getString(R.styleable.StepperLayout_ms_nextButtonText);
      }
      if (localTypedArray.hasValue(R.styleable.StepperLayout_ms_completeButtonText)) {
        this.mCompleteButtonText = localTypedArray.getString(R.styleable.StepperLayout_ms_completeButtonText);
      }
      if (localTypedArray.hasValue(R.styleable.StepperLayout_ms_tabStepDividerWidth)) {
        this.mTabStepDividerWidth = localTypedArray.getDimensionPixelOffset(R.styleable.StepperLayout_ms_tabStepDividerWidth, -1);
      }
      this.mShowBackButtonOnFirstStep = localTypedArray.getBoolean(R.styleable.StepperLayout_ms_showBackButtonOnFirstStep, false);
      this.mShowBottomNavigation = localTypedArray.getBoolean(R.styleable.StepperLayout_ms_showBottomNavigation, true);
      this.mShowErrorStateEnabled = localTypedArray.getBoolean(R.styleable.StepperLayout_ms_showErrorState, false);
      this.mShowErrorStateEnabled = localTypedArray.getBoolean(R.styleable.StepperLayout_ms_showErrorStateEnabled, this.mShowErrorStateEnabled);
      if (localTypedArray.hasValue(R.styleable.StepperLayout_ms_stepperType)) {
        this.mTypeIdentifier = localTypedArray.getInt(R.styleable.StepperLayout_ms_stepperType, 2);
      }
      if (localTypedArray.hasValue(R.styleable.StepperLayout_ms_stepperFeedbackType)) {
        this.mFeedbackTypeMask = localTypedArray.getInt(R.styleable.StepperLayout_ms_stepperFeedbackType, 1);
      }
      if (localTypedArray.hasValue(R.styleable.StepperLayout_ms_stepperFeedback_contentFadeAlpha)) {
        this.mContentFadeAlpha = localTypedArray.getFloat(R.styleable.StepperLayout_ms_stepperFeedback_contentFadeAlpha, 0.5F);
      }
      if (localTypedArray.hasValue(R.styleable.StepperLayout_ms_stepperFeedback_contentOverlayBackground)) {
        this.mContentOverlayBackground = localTypedArray.getResourceId(R.styleable.StepperLayout_ms_stepperFeedback_contentOverlayBackground, 0);
      }
      this.mShowErrorStateOnBackEnabled = localTypedArray.getBoolean(R.styleable.StepperLayout_ms_showErrorStateOnBack, false);
      this.mShowErrorStateOnBackEnabled = localTypedArray.getBoolean(R.styleable.StepperLayout_ms_showErrorStateOnBackEnabled, this.mShowErrorStateOnBackEnabled);
      this.mShowErrorMessageEnabled = localTypedArray.getBoolean(R.styleable.StepperLayout_ms_showErrorMessageEnabled, false);
      this.mTabNavigationEnabled = localTypedArray.getBoolean(R.styleable.StepperLayout_ms_tabNavigationEnabled, true);
      this.mStepperLayoutTheme = localTypedArray.getResourceId(R.styleable.StepperLayout_ms_stepperLayoutTheme, R.style.MSDefaultStepperLayoutTheme);
  ...
  private void init(AttributeSet paramAttributeSet, @AttrRes int paramInt)
  {
    ...
    ContextThemeWrapper localContextThemeWrapper = new ContextThemeWrapper(localContext, localContext.getTheme());
    localContextThemeWrapper.setTheme(this.mStepperLayoutTheme);
    LayoutInflater.from(localContextThemeWrapper).inflate(R.layout.ms_stepper_layout, this, true);
    setOrientation(1);
    bindViews();
    this.mPager.setOnTouchListener(new StepperLayout.2(this));
    initNavigation();
    this.mDottedProgressBar.setVisibility(i);
  ...
  {
    return paramInt == -1 + this.mStepAdapter.getCount();
  }
  ...
  private void onUpdate(int paramInt, boolean paramBoolean)
  {
    ...
    boolean bool1 = isLastPosition(paramInt);
    int i;
    ...
    if (paramInt == 0)
    {
      ...
      j = 8;
      if ((!bool1) && (localStepViewModel.isEndButtonVisible())) {
        break label239;
      }
      k = 8;
      label73:
      ...
      boolean bool2 = localStepViewModel.isEndButtonVisible();
      m = 0;
      if (bool2) {}
    }
    label149:
    ...
    for (int m = 8;; m = 8)
    {
      ...
      AnimationUtil.fadeViewVisibility(this.mCompleteNavigationButton, m, paramBoolean);
      ...
      {
        updateEndButton(localCharSequence, str, localRightNavigationButton);
        ...
        Step localStep = this.mStepAdapter.findStep(paramInt);
        if (localStep != null) {
          localStep.onSelected();
        }
        return;
        i = 0;
        break;
  ...
  {
    CharSequence localCharSequence = paramStepViewModel.getBackButtonLabel();
    if (localCharSequence == null)
    {
      this.mBackNavigationButton.setText(this.mBackButtonText);
      return;
    }
    this.mBackNavigationButton.setText(localCharSequence);
  }
  ...
  {
    VerificationError localVerificationError = paramStep.verifyStep();
    boolean bool = false;
    if (localVerificationError != null)
    {
      onError(localVerificationError);
      bool = true;
    }
    updateError(localVerificationError);
    return bool;
