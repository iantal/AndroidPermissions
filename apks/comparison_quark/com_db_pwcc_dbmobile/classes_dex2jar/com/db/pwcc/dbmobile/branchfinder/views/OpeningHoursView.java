  ...
  extends LinearLayout
{
  ...
  private void init(Context paramContext, mvmmvm paramMvmmvm)
  {
    ...
    arrayOfInteger[4] = Integer.valueOf(6);
    arrayOfInteger[5] = Integer.valueOf(7);
    ...
    this.weekdays = Arrays.asList(arrayOfInteger);
    setOrientation(1);
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      int k = booo006F006F006F();
      switch (k * (k + bo006F006Fo006F006F) % b006F006F006Fo006F006F)
      {
      default: 
        boo006Fo006F006F = 76;
