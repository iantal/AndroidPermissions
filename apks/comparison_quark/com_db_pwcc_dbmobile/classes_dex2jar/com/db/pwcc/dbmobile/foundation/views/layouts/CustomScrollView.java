  ...
  extends ScrollView
{
  ...
  protected void onScrollChanged(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    {
      int m = bnnnn006E006Enn();
      switch (m * (m + bn006Enn006E006Enn) % b006E006Enn006E006Enn)
      {
      default: 
    ...
    int i = getChildAt(-1 + getChildCount()).getBottom();
    int j = getHeight();
    int k = getScrollY();
    if ((this.scrollViewListener != null) && (i - (j + k) == 0)) {
