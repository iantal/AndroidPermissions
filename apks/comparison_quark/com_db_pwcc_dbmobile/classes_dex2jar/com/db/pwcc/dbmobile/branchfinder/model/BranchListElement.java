  ...
  implements popopp
{
  ...
  public String getCategory()
  {
    ...
    int i = br0072rrrr;
    int j = i * (i + brr0072rrr);
    int k = br00720072rrr();
    switch (k * (k + brr0072rrr) % brrr0072rr())
    {
    default: 
      br0072rrrr = 61;
      b00720072rrrr = br00720072rrr();
    }
    switch (j % b0072r0072rrr)
    {
    default: 
      br0072rrrr = 81;
      b00720072rrrr = br00720072rrr();
  ...
  {
    int i = br0072rrrr;
    switch (i * (i + brr0072rrr) % b0072r0072rrr)
    {
    default: 
      br0072rrrr = br00720072rrr();
      b00720072rrrr = 54;
    ...
    int j = br0072rrrr;
    switch (j * (j + brr0072rrr) % b0072r0072rrr)
    {
    default: 
      br0072rrrr = 0;
      b00720072rrrr = 25;
  ...
  public String getSortNumber()
  {
    ...
    int i = br0072rrrr + b0072rr0072rr();
    int j = br0072rrrr;
    int k = br0072rrrr;
    switch (k * (k + brr0072rrr) % b0072r0072rrr)
    {
    default: 
      br0072rrrr = br00720072rrr();
      b00720072rrrr = 59;
    }
    if (i * j % b0072r0072rrr != b00720072rrrr)
    {
      br0072rrrr = 75;
      b00720072rrrr = br00720072rrr();
    }
