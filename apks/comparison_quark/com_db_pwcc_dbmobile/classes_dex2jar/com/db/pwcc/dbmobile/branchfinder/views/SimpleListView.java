  ...
  extends FrameLayout
{
  ...
  private TextView createListItem(int paramInt)
  {
    ...
    switch (i * (i + b006300630063c0063c) % bccc00630063c)
    {
    default: 
      b0063c0063c0063c = 69;
      bc00630063c0063c = b0063cc00630063c();
  ...
  {
    View localView = LayoutInflater.from(paramContext).inflate(R.layout.view_simple_list, this, false);
    if ((b0063c0063c0063c + b006300630063c0063c) * b0063c0063c0063c % bccc00630063c != bc00630063c0063c)
    {
  ...
  private void sortResId(List<Integer> paramList)
  {
    ...
    Comparator local1 = new Comparator()
    {
      ...
      public int baa0061a006100610061a00610061(Integer paramAnonymousInteger1, Integer paramAnonymousInteger2)
      {
        ...
        String str = SimpleListView.this.getContext().getResources().getString(paramAnonymousInteger1.intValue());
        ...
        return localCollator.compare(str, localResources.getString(paramAnonymousInteger2.intValue()));
      }
    };
    if ((b0063c0063c0063c + b006300630063c0063c) * b0063c0063c0063c % bccc00630063c != bc00630063c0063c)
    {
