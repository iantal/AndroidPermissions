  ...
  implements tttsss.tstsss, View.OnClickListener
{
  ...
  public void navigateToBackgroundChangeScreen()
  {
    ...
    switch (i * (i + bk006Bkkkk006B006B) % b006B006Bkkkk006B006B)
    {
    default: 
      bkkkkkk006B006B = 21;
      b006Bkkkkk006B006B = 47;
    }
    Intent localIntent = new Intent(localContext1, BackgroundChangeActivity.class);
    Context localContext2 = getContext();
    int j = bkkkkkk006B006B;
    switch (j * (j + bk006Bkkkk006B006B) % b006B006Bkkkk006B006B)
    {
    default: 
      bkkkkkk006B006B = 9;
  ...
  {
    int i = bkkkkkk006B006B;
    switch (i * (i + bk006Bkkkk006B006B) % bk006B006Bkkk006B006B())
    {
    default: 
      bkkkkkk006B006B = 16;
      int j = bkk006Bkkk006B006B();
      if ((bkkkkkk006B006B + bk006Bkkkk006B006B) * bkkkkkk006B006B % b006B006Bkkkk006B006B != b006Bkkkkk006B006B)
      {
        bkkkkkk006B006B = bkk006Bkkk006B006B();
        b006Bkkkkk006B006B = bkk006Bkkk006B006B();
      }
      b006Bkkkkk006B006B = j;
    }
    tttsss.sttsss localSttsss = this.presenter;
    ...
    try
    {
      localMethod.invoke(localSttsss, arrayOfObject);
      return;
    }
