  ...
  extends nonnno
{
  ...
  public void cleanupTile()
  {
    ...
    switch (i * (i + b0078xx00780078xxx) % bx0078x00780078xxx)
    {
    default: 
  ...
  public View getTileView(Context paramContext)
  {
    if (this.investmentsTileLayout != null)
    {
      InvestmentsTileLayout localInvestmentsTileLayout = this.investmentsTileLayout;
      if ((b007800780078x0078xxx + b0078xx00780078xxx) * b007800780078x0078xxx % bx0078x00780078xxx != bxxx00780078xxx)
      {
      ...
      return localInvestmentsTileLayout;
    }
  ...
  {
    vvvdvd localVvvdvd = dvvdvd.bqqqqqq007100710071q(paramContext);
    int i = b007800780078x0078xxx;
    switch (i * (i + b0078xx00780078xxx) % bx0078x00780078xxx)
    {
    default: 
    ...
    localVvvdvd.bppp0070pppppp(this);
  }
