  ...
  implements popopp
{
  ...
  public String getCompanyInfo()
  {
    ...
    switch (j * (j + baa006100610061a) % b0061a006100610061a)
    {
    default: 
      ba0061a00610061a = ba0061006100610061a();
      b00610061a00610061a = ba0061006100610061a();
    }
    switch (i * (i + baa006100610061a) % b0061a006100610061a)
    {
    default: 
      ba0061a00610061a = ba0061006100610061a();
  ...
  {
    int i = ba0061a00610061a;
    int j = i + baa006100610061a;
    int k = ba0061006100610061a();
    switch (k * (k + baa006100610061a) % b0061a006100610061a)
    {
    default: 
      ba0061a00610061a = ba0061006100610061a();
      b00610061a00610061a = ba0061006100610061a();
    }
    switch (i * j % b0061a006100610061a)
    {
    default: 
      ba0061a00610061a = ba0061006100610061a();
      b00610061a00610061a = ba0061006100610061a();
  ...
  public String getRatingCount()
  {
    ...
    {
      int i = ba0061a00610061a;
      switch (i * (i + baa006100610061a) % b00610061006100610061a())
      {
      default: 
        ba0061a00610061a = ba0061006100610061a();
