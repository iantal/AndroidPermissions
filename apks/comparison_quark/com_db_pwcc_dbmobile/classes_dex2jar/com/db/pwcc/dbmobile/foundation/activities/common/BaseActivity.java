  ...
  implements oonoon.onnoon, mmbbbb.mbbbbb, xxsxss, xsssss
{
  ...
  static
  {
    if ((bwww0077www + bw0077w0077www) * bwww0077www % b00770077w0077www != b0077ww0077www)
    {
      ...
      int i = bwww0077www;
      switch (i * (i + bw0077w0077www) % b00770077w0077www)
      {
      default: 
  ...
  {
    int i = bwww0077www;
    int j = i * (i + bw0077w0077www);
    if ((bwww0077www + bw0077w0077www) * bwww0077www % b00770077w0077www != b0077ww0077www)
    {
      bwww0077www = bww00770077www();
      b0077ww0077www = 93;
    }
    switch (j % b00770077w0077www)
    {
    default: 
      bwww0077www = bww00770077www();
      b0077ww0077www = 53;
  ...
  public boolean allowScreenshots()
  {
    ...
    int i = bwww0077www;
    int j = i * (i + b0077w00770077www()) % b00770077w0077www;
    boolean bool = false;
    switch (j)
    {
    }
  ...
  public boolean canShowPinDialog()
  {
    ...
    default: 
      bwww0077www = bww00770077www();
      int j = bwww0077www;
      switch (j * (j + bw0077w0077www) % b00770077w0077www)
      {
      default: 
        bwww0077www = bww00770077www();
        b0077ww0077www = 63;
  ...
  {
    int i = bwww0077www;
    switch (i * (i + b0077w00770077www()) % b00770077w0077www)
    {
    default: 
      bwww0077www = bww00770077www();
      b0077ww0077www = 94;
  ...
  public Context getDialogContext()
  {
    ...
    default: 
      ...
      b0077ww0077www = 4;
      int j = bwww0077www;
      switch (j * (j + bw0077w0077www) % bw007700770077www())
      {
      default: 
        bwww0077www = bww00770077www();
        b0077ww0077www = bww00770077www();
  ...
  public void hideProgress()
  {
    ...
    int i = bwww0077www;
    switch (i * (i + bw0077w0077www) % bw007700770077www())
    {
    default: 
      bwww0077www = bww00770077www();
      b0077ww0077www = bww00770077www();
    ...
    if (this.progress == null)
    {
      ...
      DialogInterface.OnCancelListener local3 = new DialogInterface.OnCancelListener()
      {
        ...
        public void onCancel(DialogInterface paramAnonymousDialogInterface)
        {
          ...
          switch (i * (i + bo006F006Fo006F006Fo006F006F006F()) % bs007300730073ss00730073s)
          {
          default: 
  ...
  public void initToolbar()
  {
    ...
    if (this.toolbar == null)
    {
      ...
      if (this.toolbar == null)
      {
        String str = uxxxxx.bbbb0062b0062b0062b0062("DZ\024\025\035\036_`\032\033#$\036\037'(i#$,-'(01r", 'Z', '\007', '\003');
        ...
        arrayOfObject[0] = ",KYZ\\b\017VZ`W\024i^\\\030]\\Zplmkbbtbznk~(rx+\006|\004\0020\nB";
  ...
  {
    String str1 = TAG;
    String str2 = uxxxxx.bbbb0062b0062b0062b0062("Yopqr,-56019:{56>?9:BC\005", 'L', '©', '\003');
    ...
    arrayOfObject[0] = "\t\t]\002\001\r\006c\004\007\020\r\031\027\036\030\017SU";
  ...
  public void onBecameForeground()
  {
    ...
    String str2 = uxxxxx.bb00620062bb0062b0062b0062("\003\027\026\025\024KJPOGFLK\013BAGF>=CB\002", '_', '\003');
    Class[] arrayOfClass = new Class[3];
    arrayOfClass[0] = String.class;
    arrayOfClass[1] = Character.TYPE;
    arrayOfClass[2] = Character.TYPE;
    Method localMethod = ppphhp.class.getMethod(str2, arrayOfClass);
    Object[] arrayOfObject = new Object[3];
    arrayOfObject[0] = "\037\035o\022\017\f\027\016m\026\030\n\013\025\021\026\016\003EE";
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    String str = uxxxxx.bb00620062bb0062b0062b0062("h|{zy1065-,21p('-,$#)(g", '|', '\004');
    Class[] arrayOfClass = new Class[3];
    arrayOfClass[0] = String.class;
    arrayOfClass[1] = Character.TYPE;
    arrayOfClass[2] = Character.TYPE;
    ...
    Object[] arrayOfObject = new Object[3];
    arrayOfObject[0] = "6A>}30z<B-,u+(23%+-%l\f\002\023\032z{\f\f}\b\f\021s\002sn\001pn";
    arrayOfObject[1] = Character.valueOf('¬');
  ...
  public void onDismissDialog()
  {
    ...
    int i = bwww0077www + bw0077w0077www;
    int j = bwww0077www;
    switch (j * (j + bw0077w0077www) % bw007700770077www())
    {
    default: 
    ...
    if (i * bwww0077www % b00770077w0077www != b0077007700770077www())
    {
      bwww0077www = 35;
      b0077ww0077www = bww00770077www();
    }
  ...
  public void onStart()
  {
    ...
    int i = (bwww0077www + bw0077w0077www) * bwww0077www % b00770077w0077www;
    int j = bwww0077www;
    switch (j * (j + bw0077w0077www) % b00770077w0077www)
    {
    default: 
  ...
  public void setInAnimation()
  {
    ...
    int k = bwww0077www;
    switch (k * (k + bw0077w0077www) % b00770077w0077www)
    {
    default: 
      bwww0077www = bww00770077www();
      b0077ww0077www = 71;
  ...
  public boolean showDemoModePopup()
  {
    ...
    for (;;)
    {
      ...
      return bool;
      int i = (bwww0077www + bw0077w0077www) * bwww0077www % bw007700770077www();
      int j = b0077ww0077www;
      bool = false;
      if (i != j)
      {
        bwww0077www = 42;
  ...
  public void showError(String paramString1, String paramString2)
  {
    ...
    int m = bwww0077www;
    switch (m * (m + bw0077w0077www) % b00770077w0077www)
    {
    default: 
      bwww0077www = 2;
      b0077ww0077www = bww00770077www();
      ...
      if (paramBoolean) {
        this.toolbar.setNavigationButtonToBack(new View.OnClickListener()
        {
          ...
          public void onClick(View paramAnonymousView)
          {
            ...
            localBaseActivity.onBackPressed();
          }
        });
      }
    }
        ...
        this.toolbar.setNavigationButtonToBack(paramInt, new View.OnClickListener()
        {
          ...
          public void onClick(View paramAnonymousView)
          {
            ...
            if ((bww0077w0077ww + bw00770077w0077ww()) * bww0077w0077ww % b007700770077w0077ww() != b0077w0077w0077ww())
            {
              ...
              switch (i * (i + bwww00770077ww) % b007700770077w0077ww())
              {
              default: 
                bww0077w0077ww = 7;
                bwww00770077ww = 60;
