  ...
  extends Activity
{
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    Method localMethod1 = puuuuu.class.getMethod(uxxxxx.bb00620062bb0062b0062b0062("+wv|v65qpvp0/.-,", '7', '\003'), new Class[] { Context.class });
    Object[] arrayOfObject1 = { localContext1 };
    try
    {
      localMethod1.invoke(null, arrayOfObject1);
      Context localContext2 = getApplicationContext();
      Method localMethod2 = puppuu.class.getMethod(uxxxxx.bbbb0062b0062b0062b0062("A\020\021\031\025V\025\026\036\032\031\032\"\036\035\036&\"!\"*&%&.*kl", 'û', '', '\002'), new Class[] { Context.class });
      Object[] arrayOfObject2 = { localContext2 };
      try
      {
        ...
        switch (i * (i + b006700670067gg00670067) % bggg0067g00670067())
        {
        default: 
        ...
        int k = b0067gg0067g00670067;
        switch (k * (k + b006700670067gg00670067) % bg0067g0067g00670067)
        {
        default: 
  ...
  {
    int i = b0067gg0067g00670067;
    switch (i * (i + b006700670067gg00670067) % bg0067g0067g00670067)
    {
    default: 
    ...
    switch (j * (j + b006700670067gg00670067) % bg0067g0067g00670067)
    {
    default: 
      b0067gg0067g00670067 = b0067g0067gg00670067();
      bg00670067gg00670067 = b0067g0067gg00670067();
  ...
  public void onStop()
  {
    if ((b0067gg0067g00670067 + b006700670067gg00670067) * b0067gg0067g00670067 % bg0067g0067g00670067 != bg00670067gg00670067)
    {
      b0067gg0067g00670067 = b0067g0067gg00670067();
      int i = b0067gg0067g00670067;
      switch (i * (i + b00670067g0067g00670067()) % bg0067g0067g00670067)
      {
      default: 
