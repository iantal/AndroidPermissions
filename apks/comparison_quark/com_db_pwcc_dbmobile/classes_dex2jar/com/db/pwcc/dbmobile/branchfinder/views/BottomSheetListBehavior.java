  ...
  extends BottomSheetBehavior<V>
{
  ...
  public boolean onInterceptTouchEvent(CoordinatorLayout paramCoordinatorLayout, V paramV, MotionEvent paramMotionEvent)
  {
    if (isHideable())
    {
      int j = bo006F006Foo006F;
      switch (j * (j + bo006Fo006Fo006F) % booo006Fo006F)
      {
      default: 
        bo006F006Foo006F = 82;
    ...
    boolean bool = super.onInterceptTouchEvent(paramCoordinatorLayout, paramV, paramMotionEvent);
    int i = bo006F006Foo006F;
    switch (i * (i + b006F006F006Foo006F()) % booo006Fo006F)
    {
    }
  ...
  public boolean onNestedPreFling(CoordinatorLayout paramCoordinatorLayout, V paramV, View paramView, float paramFloat1, float paramFloat2)
  {
    ...
    {
      return bool;
      bool = super.onNestedPreFling(paramCoordinatorLayout, paramV, paramView, paramFloat1, paramFloat2);
  ...
  public void onNestedPreScroll(CoordinatorLayout paramCoordinatorLayout, V paramV, View paramView, int paramInt1, int paramInt2, int[] paramArrayOfInt)
  {
    ...
    int i = bo006F006Foo006F;
    switch (i * (i + bo006Fo006Fo006F) % booo006Fo006F)
    {
    }
    bo006F006Foo006F = 93;
    boo006F006Fo006F = b006Foo006Fo006F();
  ...
  public boolean onStartNestedScroll(CoordinatorLayout paramCoordinatorLayout, V paramV, View paramView1, View paramView2, int paramInt)
  {
    ...
    switch (k * (k + bo006Fo006Fo006F) % booo006Fo006F)
    {
    default: 
      bo006F006Foo006F = b006Foo006Fo006F();
      boo006F006Fo006F = b006Foo006Fo006F();
  ...
  public boolean onTouchEvent(CoordinatorLayout paramCoordinatorLayout, V paramV, MotionEvent paramMotionEvent)
  {
    ...
    int i = bo006F006Foo006F + bo006Fo006Fo006F;
    int j = bo006F006Foo006F;
    switch (j * (j + bo006Fo006Fo006F) % b006Fo006F006Fo006F())
    {
    default: 
      bo006F006Foo006F = b006Foo006Fo006F();
      boo006F006Fo006F = b006Foo006Fo006F();
    }
    if (i * bo006F006Foo006F % b006Fo006F006Fo006F() != boo006F006Fo006F)
    {
      bo006F006Foo006F = 15;
      boo006F006Fo006F = b006Foo006Fo006F();
    }
