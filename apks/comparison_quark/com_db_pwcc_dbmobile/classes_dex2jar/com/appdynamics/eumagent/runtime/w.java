...
final class w
{
  ...
  final void a(URLConnection paramURLConnection, Exception paramException)
  {
    try
    {
      ...
      p localP = new p(paramURLConnection.getURL(), localU, new u(), paramException);
      this.a.a(localP);
      return;
    }
    finally {}
    ...
    final InputStream a(final URLConnection paramURLConnection)
    {
      ...
      new InputStream()
      {
        ...
        public final int read(byte[] paramAnonymousArrayOfByte)
        {
          try
          {
            int i = localInputStream.read(paramAnonymousArrayOfByte);
            a(i);
            return i;
          }
          catch (IOException localIOException)
        ...
        public final int read(byte[] paramAnonymousArrayOfByte, int paramAnonymousInt1, int paramAnonymousInt2)
        {
          try
          {
            int i = localInputStream.read(paramAnonymousArrayOfByte, paramAnonymousInt1, paramAnonymousInt2);
            a(i);
            return i;
          }
          catch (IOException localIOException)
