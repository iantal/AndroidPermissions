  ...
  extends BaseAdapter
{
  ...
  static
  {
    ...
    switch (i * (i + bvv0076v0076v0076vv) % b0076v0076v0076v0076vv)
    {
    default: 
  ...
  public int getCount()
  {
    ...
    switch (i * (i + bvv0076v0076v0076vv) % bu00750075u0075uuuu0075())
    {
    default: 
      int j = b00760076vv0076v0076vv;
      switch (j * (j + bvv0076v0076v0076vv) % b0076v0076v0076v0076vv)
      {
      default: 
  ...
  public Object getItem(int paramInt)
  {
    ...
    if ((i + bvv0076v0076v0076vv) * b00760076vv0076v0076vv % b0076v0076v0076v0076vv != bv00760076v0076v0076vv)
    {
  ...
  {
    qmqqmq.qqmqmq localQqmqmq2;
    if (paramView == null)
    {
      paramView = LayoutInflater.from(paramViewGroup.getContext()).inflate(R.layout.mba_institute_item, paramViewGroup, false);
      localQqmqmq2 = new qmqqmq.qqmqmq(paramView);
      paramView.setTag(localQqmqmq2);
    }
    for (qmqqmq.qqmqmq localQqmqmq1 = localQqmqmq2;; localQqmqmq1 = (qmqqmq.qqmqmq)paramView.getTag())
    {
      ...
      if (localMbaFinancialOverviewData != null)
      {
        ...
        localQqmqmq1.bvvv00760076v0076vv.setImageResource(R.drawable.ic_efi_refresh);
        localQqmqmq1.bvvv00760076v0076vv.setAnimation(soooso.b0069i0069i006900690069iii());
        paramView.setEnabled(false);
      }
      for (;;)
      {
        localQqmqmq1.b0076vv00760076v0076vv.setText(localMbaFinancialOverviewData.getBankName());
        InstrumentationCallbacks.setOnClickListenerCalled(localQqmqmq1.b007600760076v0076v0076vv, new qmqqmq.1(this, paramInt));
        int i = b00760076vv0076v0076vv;
        switch (i * (i + bvv0076v0076v0076vv) % b0076v0076v0076v0076vv)
        {
        default: 
        ...
        return paramView;
        label238:
        localQqmqmq1.bvvv00760076v0076vv.clearAnimation();
        localQqmqmq1.bvvv00760076v0076vv.setImageResource(this.bvvvv0076v0076vv.b00750075uu0075uuu00750075(localMbaFinancialOverviewData.getBankCode()));
