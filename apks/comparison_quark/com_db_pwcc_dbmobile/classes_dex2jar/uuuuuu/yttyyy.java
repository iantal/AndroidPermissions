  ...
  implements ViewPager.OnPageChangeListener
{
  ...
  public yttyyy(Context paramContext, List<CreditCard> paramList, yttyyy.yyytyy paramYyytyy)
  {
    ...
    this.b007800780078xx0078x0078x = ((int)(0.7D * onoonn.bkkkkk006Bk006Bk006B(paramContext)));
  }
  ...
  {
    CardLinearLayout localCardLinearLayout = (CardLinearLayout)paramView.findViewById(R.id.root);
    int i = bxxx0078x0078x0078x;
    switch (i * (i + b00710071qq0071qqq00710071()) % b0071q0071q0071qqq00710071())
    {
    default: 
      bxxx0078x0078x0078x = 40;
      b0078xx0078x0078x0078x = 29;
    }
    localCardLinearLayout.setScaleBoth(paramFloat);
    if (paramBoolean) {
      localCardLinearLayout.setAlpha(this.b00780078xxx0078x0078x);
    }
    ImageView localImageView = (ImageView)paramView.findViewById(R.id.credit_card);
    localImageView.setTag(paramCreditCard.getBackendCardId());
    localImageView.setMaxWidth(this.b007800780078xx0078x0078x);
    ppopoo localPpopoo = this.b0078x007800780078xx0078x;
    int j = bxxx0078x0078x0078x;
    switch (j * (j + b0078xx0078x0078x0078x) % b0071q0071q0071qqq00710071())
    {
    default: 
      bxxx0078x0078x0078x = bqq0071q0071qqq00710071();
      b0078xx0078x0078x0078x = 85;
    }
    ppopoo.opppoo localOpppoo;
    if (paramCreditCard.isActive())
    {
      localOpppoo = ppopoo.opppoo.b0067ggg00670067ggg;
      if (!paramCreditCard.isActive()) {
        break label218;
      }
    }
    label218:
    for (int k = -1;; k = R.drawable.ic_mopay_warning)
    {
      localPpopoo.bu0075u007500750075uuuu(paramCreditCard, paramContext, localOpppoo, k, new yttyyy.1(this, localImageView));
      return;
      localOpppoo = ppopoo.opppoo.bgggg00670067ggg;
      break;
    }
  }
  ...
  private CardLinearLayout bqqq00710071qqq00710071(int paramInt)
  {
    ...
    int i = bxxx0078x0078x0078x;
    switch (i * (i + b0078xx0078x0078x0078x) % b0071q0071q0071qqq00710071())
    {
    default: 
      bxxx0078x0078x0078x = bqq0071q0071qqq00710071();
    ...
    {
      int j = R.id.root;
      int k = bxxx0078x0078x0078x;
      switch (k * (k + b0078xx0078x0078x0078x) % bx0078x0078x0078x0078x)
      {
      default: 
        bxxx0078x0078x0078x = 10;
        b0078xx0078x0078x0078x = 18;
      }
      return (CardLinearLayout)localView.findViewById(j);
    }
    return null;
  }
  ...
  public boolean bq00710071q0071qqq00710071(List<CreditCard> paramList)
  {
    ...
    if ((bxxx0078x0078x0078x + b0078xx0078x0078x0078x) * bxxx0078x0078x0078x % bx0078x0078x0078x0078x != b00780078x0078x0078x0078x)
    {
      ...
      b00780078x0078x0078x0078x = bqq0071q0071qqq00710071();
      int i = bxxx0078x0078x0078x;
      switch (i * (i + b0078xx0078x0078x0078x) % bx0078x0078x0078x0078x)
      {
      default: 
        bxxx0078x0078x0078x = bqq0071q0071qqq00710071();
  ...
  {
    CardLinearLayout localCardLinearLayout = bqqq00710071qqq00710071(paramInt);
    if (localCardLinearLayout == null) {
      return;
    }
    ImageView localImageView = (ImageView)localCardLinearLayout.findViewById(R.id.credit_card);
    if (ytytyy.bqqq0071q0071qq00710071().b0071qq0071q0071qq00710071() == null)
    {
      ...
      localImageView.getLocationInWindow(arrayOfInt);
      if (arrayOfInt[0] == 0)
      {
        int j = arrayOfInt[1];
        int k = bxxx0078x0078x0078x;
    ...
    ytytyy.bqqq0071q0071qq00710071().bq0071q0071q0071qq00710071((String)localImageView.getTag());
    ytytyy.bqqq0071q0071qq00710071().bqq00710071q0071qq00710071(localImageView);
  }
  ...
  {
    int i = bxxx0078x0078x0078x;
    int j = i * (i + b0078xx0078x0078x0078x);
  ...
  public boolean isViewFromObject(View paramView, Object paramObject)
  {
    ...
    {
      return bool;
      i = (bxxx0078x0078x0078x + b0078xx0078x0078x0078x) * bxxx0078x0078x0078x % bx0078x0078x0078x0078x;
      j = b00780078x0078x0078x0078x;
      bool = false;
    } while (i == j);
    if ((bxxx0078x0078x0078x + b0078xx0078x0078x0078x) * bxxx0078x0078x0078x % bx0078x0078x0078x0078x != b00780078x0078x0078x0078x)
    {
  ...
  public void onPageScrolled(int paramInt1, float paramFloat, int paramInt2)
  {
    if ((paramFloat >= 0.0F) && (paramFloat <= 1.0F))
    {
      ...
      int i = paramInt1 - 1;
      int j = bxxx0078x0078x0078x;
      switch (j * (j + b00710071qq0071qqq00710071()) % bx0078x0078x0078x0078x)
      {
      default: 
        bxxx0078x0078x0078x = 47;
        b00780078x0078x0078x0078x = 10;
      }
      this.bx00780078xx0078x0078x = bqqq00710071qqq00710071(i);
    ...
    if ((paramFloat >= 1.0F) && (this.b00780078007800780078xx0078x != null)) {
  ...
  public void onPageSelected(int paramInt)
  {
    ...
    int j = i + b0078xx0078x0078x0078x;
    ...
    switch (i * j % bx0078x0078x0078x0078x)
    {
    default: 
