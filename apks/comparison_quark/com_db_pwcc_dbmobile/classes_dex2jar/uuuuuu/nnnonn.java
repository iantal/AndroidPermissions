...
public class nnnonn
{
  ...
  public void b006B006B006Bkkk006B006Bk006B(ononnn paramOnonnn)
  {
    ...
    switch (i * (i + b00660066006600660066f0066ff) % bfffff00660066ff)
    {
    default: 
      bf0066006600660066f0066ff = b006Bkkkkk006B006Bk006B();
      b0066ffff00660066ff = 1;
      int j = bf0066006600660066f0066ff;
      switch (j * (j + b00660066006600660066f0066ff) % bfffff00660066ff)
      {
      default: 
        bf0066006600660066f0066ff = b006Bkkkkk006B006Bk006B();
  ...
  {
    EditText localEditText = (EditText)paramDbToolbar.findViewById(R.id.search_input);
    String str;
  ...
  {
    String str = uxxxxx.bb00620062bb0062b0062b0062("AW\021\022\032\033\\]\027\030 !\033\034$%f !)*$%-.o", 'Ý', '\002');
    ...
    arrayOfObject[0] = "UKd[bbNY_X_Ui[i";
    arrayOfObject[1] = Character.valueOf('&');
    arrayOfObject[2] = Character.valueOf('B');
    arrayOfObject[3] = Character.valueOf('\003');
    try
    {
      Object localObject = localMethod.invoke(null, arrayOfObject);
      View localView = ((LayoutInflater)paramContext.getSystemService((String)localObject)).inflate(R.layout.search_bar, null);
      localView.setBackground(null);
      EditText localEditText = (EditText)localView.findViewById(R.id.search_input);
      ImageView localImageView = (ImageView)localView.findViewById(R.id.clear_search_input);
      int i = bf0066006600660066f0066ff;
      switch (i * (i + b00660066006600660066f0066ff) % bkkkkkk006B006Bk006B())
      {
      default: 
        bf0066006600660066f0066ff = 83;
        b0066ffff00660066ff = b006Bkkkkk006B006Bk006B();
        int j = b006Bkkkkk006B006Bk006B();
        switch (j * (j + b00660066006600660066f0066ff) % bfffff00660066ff)
        {
        default: 
      ...
      InstrumentationCallbacks.setOnClickListenerCalled(localView.findViewById(R.id.cancel_search), new nnnonn.3(this, paramDbToolbar, paramFragmentManager));
      paramDbToolbar.showCustomLayout(localView);
  ...
  {
    String str = uxxxxx.bb00620062bb0062b0062b0062("DXWVU\r\f\022\021\t\b\016\rL\004\003\t\b~\005\004C", '', '\003');
    ...
    arrayOfObject[0] = "cYripp\\gmfmcwiw";
    arrayOfObject[1] = Character.valueOf('õ');
    ...
    try
    {
      ...
      this.b0066f006600660066f0066ff = ((EditText)localView.findViewById(R.id.search_input));
      if ((bf0066006600660066f0066ff + b00660066006600660066f0066ff) * bf0066006600660066f0066ff % bkkkkkk006B006Bk006B() != b0066ffff00660066ff)
      {
        bf0066006600660066f0066ff = b006Bkkkkk006B006Bk006B();
        b0066ffff00660066ff = b006Bkkkkk006B006Bk006B();
      ...
      ImageView localImageView = (ImageView)localView.findViewById(R.id.clear_search_input);
      DbTextView localDbTextView = (DbTextView)localView.findViewById(R.id.cancel_search);
