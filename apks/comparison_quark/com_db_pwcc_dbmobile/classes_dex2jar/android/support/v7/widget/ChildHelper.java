  ...
  private int getOffset(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        int m = paramInt - (k - this.mBucket.countOnesBefore(k));
        if (m == 0)
        {
          for (i = k; this.mBucket.get(i); i++) {}
          break;
        }
        k += m;
      }
  ...
  static class Bucket
  {
    ...
    void insert(int paramInt, boolean paramBoolean)
    {
      ...
      for (;;)
      {
        ...
        if ((0x8000000000000000 & this.mData) != 0L)
        {
          ...
          this.mData = (l & this.mData | (this.mData & (l ^ 0xFFFFFFFFFFFFFFFF)) << 1);
          if (!paramBoolean) {
            break label109;
          }
          set(paramInt);
    ...
    boolean remove(int paramInt)
    {
      ...
      for (boolean bool = true;; bool = false)
      {
        ...
        long l2 = l1 - 1L;
        this.mData = (l2 & this.mData | Long.rotateRight(this.mData & (l2 ^ 0xFFFFFFFFFFFFFFFF), 1));
        if (this.mNext == null) {
          break;
        }
        if (this.mNext.get(0)) {
