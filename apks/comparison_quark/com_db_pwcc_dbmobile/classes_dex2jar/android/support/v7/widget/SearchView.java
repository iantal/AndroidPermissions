  ...
  implements CollapsibleActionView
{
  ...
  public SearchView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    InstrumentationCallbacks.setOnClickListenerCalled(this.mSearchButton, this.mOnClickListener);
    InstrumentationCallbacks.setOnClickListenerCalled(this.mCloseButton, this.mOnClickListener);
    InstrumentationCallbacks.setOnClickListenerCalled(this.mGoButton, this.mOnClickListener);
    InstrumentationCallbacks.setOnClickListenerCalled(this.mVoiceButton, this.mOnClickListener);
    InstrumentationCallbacks.setOnClickListenerCalled(this.mSearchSrcTextView, this.mOnClickListener);
    this.mSearchSrcTextView.addTextChangedListener(this.mTextWatcher);
    this.mSearchSrcTextView.setOnEditorActionListener(this.mOnEditorActionListener);
    this.mSearchSrcTextView.setOnItemClickListener(this.mOnItemClickListener);
    this.mSearchSrcTextView.setOnItemSelectedListener(this.mOnItemSelectedListener);
    this.mSearchSrcTextView.setOnKeyListener(this.mTextKeyListener);
    InstrumentationCallbacks.setOnFocusChangeListenerCalled(this.mSearchSrcTextView, new View.OnFocusChangeListener()
    {
  ...
  private Intent createIntentFromSuggestion(Cursor paramCursor, int paramInt, String paramString)
  {
    for (;;)
    {
      try
      {
        localObject1 = SuggestionsAdapter.getColumnString(paramCursor, "suggest_intent_action");
        if (localObject1 == null)
        {
          String str1 = this.mSearchable.getSuggestIntentAction();
          localObject1 = str1;
        }
        if (localObject1 == null) {
      ...
      str4 = SuggestionsAdapter.getColumnString(paramCursor, "suggest_intent_query");
      return createIntent((String)localObject1, (Uri)localObject2, SuggestionsAdapter.getColumnString(paramCursor, "suggest_intent_extra_data"), str4, paramInt, paramString);
  ...
  void adjustDropDownSizeAndPosition()
  {
    ...
    for (int k = -localRect.left;; k = i - (j + localRect.left))
    {
      ...
      this.mSearchSrcTextView.setDropDownWidth(j + (i1 + (m + n)) - i);
      return;
      j = 0;
      break;
    }
    ...
    public boolean onTouchEvent(MotionEvent paramMotionEvent)
    {
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          k = bool1;
          break;
          bool4 = this.mDelegateTargeted;
          if ((!bool4) || (this.mSlopBounds.contains(i, j))) {
            break label220;
          }
          bool1 = bool4;
          k = 0;
          break;
          boolean bool2 = this.mDelegateTargeted;
