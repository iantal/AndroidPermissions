...
public class SupportMenuInflater extends MenuInflater
{
    ...
    public void inflate(@LayoutRes final int n, final Menu menu) {
        Object layout = null;
    ...
    private class MenuState
    {
        ...
        private void setItem(final MenuItem menuItem) {
            int n = 1;
            menuItem.setChecked(this.itemChecked).setVisible(this.itemVisible).setEnabled(this.itemEnabled).setCheckable(this.itemCheckable >= n && n).setTitleCondensed(this.itemTitleCondensed).setIcon(this.itemIconResId);
