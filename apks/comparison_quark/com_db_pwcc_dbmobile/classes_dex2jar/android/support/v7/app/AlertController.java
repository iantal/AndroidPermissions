...
class AlertController
{
  ...
  static boolean canTextInput(View paramView)
  {
    ...
    do
    {
      ...
      i--;
    } while (!canTextInput(localViewGroup.getChildAt(i)));
    return true;
  }
  ...
  private ViewGroup resolvePanel(@Nullable View paramView1, @Nullable View paramView2)
  {
    ...
    label78:
    for (View localView2 = ((ViewStub)paramView2).inflate();; localView2 = paramView2)
    {
  ...
  private void setScrollIndicators(ViewGroup paramViewGroup, View paramView, int paramInt1, int paramInt2)
  {
    ...
    final View localView1 = this.mWindow.findViewById(R.id.scrollIndicatorUp);
      ...
      for (;;)
      {
        ...
        if (this.mMessage != null)
        {
          this.mScrollView.setOnScrollChangeListener(new NestedScrollView.OnScrollChangeListener()
          {
            ...
            {
              AlertController.manageScrollIndicators(paramAnonymousNestedScrollView, localView1, this.val$bottom);
            }
          });
          this.mScrollView.post(new Runnable()
          {
            public void run()
            {
              AlertController.manageScrollIndicators(AlertController.this.mScrollView, localView1, this.val$bottom);
            }
          });
          return;
        }
        if (this.mListView != null)
        {
          this.mListView.setOnScrollListener(new AbsListView.OnScrollListener()
          {
            ...
            {
              AlertController.manageScrollIndicators(paramAnonymousAbsListView, localView1, this.val$bottom);
            }
          ...
          this.mListView.post(new Runnable()
          {
            public void run()
            {
              AlertController.manageScrollIndicators(AlertController.this.mListView, localView1, this.val$bottom);
            }
          });
          return;
        }
  ...
  private void setupButtons(ViewGroup paramViewGroup)
  {
    ...
    InstrumentationCallbacks.setOnClickListenerCalled(this.mButtonPositive, this.mButtonHandler);
    int j;
    if (TextUtils.isEmpty(this.mButtonPositiveText))
    {
      ...
      InstrumentationCallbacks.setOnClickListenerCalled(this.mButtonNegative, this.mButtonHandler);
      ...
      InstrumentationCallbacks.setOnClickListenerCalled(this.mButtonNeutral, this.mButtonHandler);
  ...
  private void setupView()
  {
    ...
    for (int m = 2;; m = 0)
    {
      setScrollIndicators(localViewGroup3, (View)localObject, m | k, 3);
    ...
    private void createListView(final AlertController paramAlertController)
    {
      ...
      if (this.mIsMultiChoice) {
        if (this.mCursor == null)
        {
          ...
          InstrumentationCallbacks.setOnItemClickListenerCalled(localRecycleListView, new AdapterView.OnItemClickListener()
          {
