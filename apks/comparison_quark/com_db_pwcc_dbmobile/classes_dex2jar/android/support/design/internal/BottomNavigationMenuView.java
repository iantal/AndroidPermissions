  ...
  implements MenuView
{
  ...
  public void buildMenuView()
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      for (int i = 0; i < this.mMenu.size(); i++)
      {
        ...
        InstrumentationCallbacks.setOnClickListenerCalled(localBottomNavigationItemView1, this.mOnClickListener);
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    {
      int i5 = j - 1;
      int i6 = Math.min(i - i5 * this.mInactiveItemMinWidth, this.mActiveItemMaxWidth);
      i7 = Math.min((i - i6) / i5, this.mInactiveItemMaxWidth);
      i8 = i - i6 - i5 * i7;
      i9 = 0;
      if (i9 >= j) {
        break label252;
      ...
      if (i9 == this.mSelectedItemPosition)
      {
        i10 = i6;
        label111:
        arrayOfInt2[i9] = i10;
        ...
        arrayOfInt3[i9] = (1 + arrayOfInt3[i9]);
      }
    }
    label252:
    label364:
    for (int i11 = i8 - 1;; i11 = i8)
    {
      i9++;
      i8 = i11;
      break;
      ...
      setMeasuredDimension(View.resolveSizeAndState(i3, View.MeasureSpec.makeMeasureSpec(i3, 1073741824), 0), View.resolveSizeAndState(this.mItemHeight, k, 0));
      return;
    }
  }
