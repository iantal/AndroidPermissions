  ...
  extends CoordinatorLayout.Behavior<V>
{
  ...
  private final ViewDragHelper.Callback mDragCallback = new ViewDragHelper.Callback()
  {
    ...
    public void onViewReleased(View paramAnonymousView, float paramAnonymousFloat1, float paramAnonymousFloat2)
    {
      ...
      while (BottomSheetBehavior.this.mViewDragHelper.settleCapturedViewAt(paramAnonymousView.getLeft(), j))
      {
  ...
  public boolean onInterceptTouchEvent(CoordinatorLayout paramCoordinatorLayout, V paramV, MotionEvent paramMotionEvent)
  {
    ...
    while ((!this.mIgnoreEvents) && (this.mViewDragHelper.shouldInterceptTouchEvent(paramMotionEvent)))
    {
      ...
      if (this.mIgnoreEvents)
      {
        ...
        if (this.mNestedScrollingChildRef != null)
        {
          ...
          label163:
          if ((localView1 != null) && (paramCoordinatorLayout.isPointInChildBounds(localView1, j, this.mInitialY)))
          {
    ...
    return (i == 2) && (localView2 != null) && (!this.mIgnoreEvents) && (this.mState != 1) && (!paramCoordinatorLayout.isPointInChildBounds(localView2, (int)paramMotionEvent.getX(), (int)paramMotionEvent.getY())) && (Math.abs(this.mInitialY - paramMotionEvent.getY()) > this.mViewDragHelper.getTouchSlop());
  }
