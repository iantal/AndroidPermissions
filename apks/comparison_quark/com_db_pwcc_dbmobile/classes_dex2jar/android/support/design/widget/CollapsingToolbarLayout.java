  ...
  extends FrameLayout
{
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if (this.mLastInsets != null)
    {
      int i11 = this.mLastInsets.getSystemWindowInsetTop();
    ...
    if ((this.mCollapsingTitleEnabled) && (this.mDummyView != null))
    {
      ...
      if (this.mDrawCollapsingTitle)
      {
        ...
        int i4 = this.mToolbar.getTitleMarginTop();
        int i5 = this.mTmpRect.right;
        if (i == 0) {
          break label434;
        }
        i6 = this.mToolbar.getTitleMarginStart();
        localCollapsingTextHelper1.setCollapsedBounds(i2 + i1, i4 + (i3 + n), i6 + i5, n + this.mTmpRect.bottom - this.mToolbar.getTitleMarginBottom());
        localCollapsingTextHelper2 = this.mCollapsingTextHelper;
        if (i == 0) {
          break label446;
        }
        i7 = this.mExpandedMarginEnd;
        i8 = this.mTmpRect.top;
        i9 = this.mExpandedMarginTop;
        if (i == 0) {
          break label455;
        }
      }
    ...
    label446:
    label455:
    for (int i10 = this.mExpandedMarginStart;; i10 = this.mExpandedMarginEnd)
    {
      localCollapsingTextHelper2.setExpandedBounds(i7, i8 + i9, paramInt3 - paramInt1 - i10, paramInt4 - paramInt2 - this.mExpandedMarginBottom);
    ...
    implements AppBarLayout.OnOffsetChangedListener
  {
    ...
    public void onOffsetChanged(AppBarLayout paramAppBarLayout, int paramInt)
    {
      ...
      int m = CollapsingToolbarLayout.this.getHeight();
      int n = ViewCompat.getMinimumHeight(CollapsingToolbarLayout.this);
      CollapsingToolbarLayout.this.mCollapsingTextHelper.setExpansionFraction(Math.abs(paramInt) / (m - n - i));
    }
  }
}
