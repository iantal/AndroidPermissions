  ...
  extends TypefaceCompatBaseImpl
{
  ...
  static
  {
    try
    {
      ...
      localMethod2 = localClass.getMethod("addFontWeightStyle", arrayOfClass1);
      Class[] arrayOfClass2 = new Class[1];
      arrayOfClass2[0] = Array.newInstance(localClass, 1).getClass();
      Method localMethod3 = Typeface.class.getMethod("createFromFamiliesWithDefault", arrayOfClass2);
      localMethod1 = localMethod3;
    }
  ...
  public Typeface createFromFontFamilyFilesResourceEntry(Context paramContext, FontResourcesParserCompat.FontFamilyFilesResourceEntry paramFontFamilyFilesResourceEntry, Resources paramResources, int paramInt)
  {
    ...
    for (FontResourcesParserCompat.FontFileResourceEntry localFontFileResourceEntry : paramFontFamilyFilesResourceEntry.getEntries())
    {
      ...
      while (!addFontWeightStyle(localObject, localByteBuffer, 0, localFontFileResourceEntry.getWeight(), localFontFileResourceEntry.isItalic())) {
        return null;
      }
    }
