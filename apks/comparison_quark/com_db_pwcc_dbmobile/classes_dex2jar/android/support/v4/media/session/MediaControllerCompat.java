  ...
  public static MediaControllerCompat getMediaController(@NonNull Activity paramActivity)
  {
    if ((paramActivity instanceof SupportActivity))
    {
      ...
      if (localMediaControllerExtraData != null) {
        return localMediaControllerExtraData.getMediaController();
      }
    }
    else if (Build.VERSION.SDK_INT >= 21)
    {
      ...
      if (localObject1 != null)
      {
        ...
        try
        {
          MediaControllerCompat localMediaControllerCompat = new MediaControllerCompat(paramActivity, MediaSessionCompat.Token.fromToken(localObject2));
          return localMediaControllerCompat;
        }
