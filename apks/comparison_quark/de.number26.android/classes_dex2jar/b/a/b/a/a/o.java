...
final class o
{
  ...
  void a(int paramInt)
  {
    this.b = 3;
    this.c = paramInt;
    this.h = (0x7FFFFFFF & paramInt + this.b);
  }
  ...
  void a(int paramInt, String paramString1, String paramString2, String paramString3)
  {
    ...
    if (paramInt != 1) {
      if (paramInt != 12)
      {
        ...
        {
        default: 
          k = paramString1.hashCode() * paramString2.hashCode();
          m = paramString3.hashCode();
        }
      }
    }
    label120:
    for (int j = k * m;; j = paramString1.hashCode())
    {
      this.h = (0x7FFFFFFF & paramInt + j);
      return;
      k = paramString1.hashCode();
