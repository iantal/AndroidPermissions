  ...
  extends Activity
{
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    List localList = (List)Util_PhotoDataHolder.getDocumentListToCountryname(this.context).get(Util_PhotoDataHolder.getSelectedCountry(this.context));
    this.adapter = new Adapters_DocumentsAdapter(this, R.layout.view_documents_list_element, localList);
