...
public class PublisherKit
{
  ...
  void publisherStreamCreated(PublisherKit paramPublisherKit, long paramLong1, String paramString1, String paramString2, int paramInt1, int paramInt2, boolean paramBoolean1, boolean paramBoolean2, String paramString3, long paramLong2, String paramString4, int paramInt3)
  {
    StringBuilder localStringBuilder = new StringBuilder();
    localStringBuilder.append("Publisher with streamId: ");
    localStringBuilder.append(paramString1);
    localStringBuilder.append(" is created");
    Log.i("opentok-publisherkit", localStringBuilder.toString());
    ConnectionImpl localConnectionImpl = new ConnectionImpl(paramString3, paramLong2, paramString4);
    StreamImpl localStreamImpl = new StreamImpl(paramLong1, paramString1, paramString2, paramInt1, paramInt2, paramBoolean1, paramBoolean2, localConnectionImpl, getSession(), paramInt3);
    this.stream = localStreamImpl;
    getSession().addStream(this.stream);
    final Stream localStream = this.stream;
    this.mHandler.post(new Runnable()
    {
      public void run()
      {
        PublisherKit.this.onStreamCreated(localStream);
      }
    });
  }
  
  void publisherStreamDestroyed(PublisherKit paramPublisherKit, long paramLong, String paramString1, String paramString2, int paramInt1, int paramInt2, boolean paramBoolean1, boolean paramBoolean2, int paramInt3)
  {
    StringBuilder localStringBuilder = new StringBuilder();
    localStringBuilder.append("Publisher with streamId: ");
    localStringBuilder.append(paramString1);
    localStringBuilder.append(" is removed");
    Log.i("opentok-publisherkit", localStringBuilder.toString());
    if (this.stream != null)
    {
      ...
      this.mHandler.post(new Runnable()
      {
        public void run()
        {
          PublisherKit.this.onStreamDestroyed(localStream);
        }
      });
  ...
  public static enum PublisherKitVideoType
  {
    ...
    static
    {
      PublisherKitVideoType[] arrayOfPublisherKitVideoType = new PublisherKitVideoType[2];
      arrayOfPublisherKitVideoType[0] = PublisherKitVideoTypeCamera;
      arrayOfPublisherKitVideoType[1] = PublisherKitVideoTypeScreen;
      $VALUES = arrayOfPublisherKitVideoType;
    }
    ...
    {
      PublisherKitVideoType[] arrayOfPublisherKitVideoType = values();
      int i = 0;
      int j = arrayOfPublisherKitVideoType.length;
      while (i < j)
      {
        PublisherKitVideoType localPublisherKitVideoType = arrayOfPublisherKitVideoType[i];
