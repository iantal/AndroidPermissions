...
public class b
{
  ...
  {
    Intent localIntent = paramF.a(paramContext, ChatFeedActivity.class);
  ...
  void a(Bundle paramBundle)
  {
    ...
    this.f = this.c.a(this).a(this.b.getApplicationContext()).a(localC).a();
    ...
    this.f.a(localLayoutInflater, localViewGroup);
    Toolbar localToolbar = (Toolbar)localViewGroup.findViewById(e.d.toolbar);
    this.b.a(localToolbar);
    com.salesforce.android.service.common.utilities.h.a.a(this.b.g());
    this.b.g().a(null);
    this.b.g().c(e.h.chat_end_session_content_description);
    this.f.a(localToolbar);
    if (this.e != null) {
      this.f.a(this.e);
    }
