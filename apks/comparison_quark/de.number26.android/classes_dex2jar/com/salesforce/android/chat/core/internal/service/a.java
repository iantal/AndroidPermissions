...
class a
{
  ...
  {
    f localF = (f)paramIntent.getExtras().getSerializable("com.salesforce.android.chat.core.ChatConfiguration");
    com.salesforce.android.service.common.utilities.h.a.a(localF);
    return localF;
  }
}
