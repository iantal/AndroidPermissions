...
class c
{
  ...
  void a(Activity paramActivity, com.salesforce.android.service.common.utilities.f.a paramA)
  {
    ...
    {
      com.salesforce.android.service.common.utilities.e.a localA1 = f;
      Object[] arrayOfObject1 = new Object[1];
      arrayOfObject1[0] = paramActivity.getClass().getSimpleName();
      localA1.d("Couldn't find android.R.id.content in {}. Are you calling Activity.setContentView and AppCompatDelegate.setContentView?", arrayOfObject1);
      ((ViewGroup)paramActivity.getWindow().getDecorView()).addView(this.a);
    }
    if (paramA != null)
    {
      com.salesforce.android.service.common.utilities.e.a localA2 = f;
      Object[] arrayOfObject2 = new Object[2];
      arrayOfObject2[0] = Integer.valueOf(paramA.a());
      arrayOfObject2[1] = Integer.valueOf(paramA.b());
      localA2.a("Setting minimized location to {} {}", arrayOfObject2);
  ...
  {
    com.salesforce.android.service.common.utilities.e.a localA = f;
    Object[] arrayOfObject = new Object[2];
    arrayOfObject[0] = Integer.valueOf(paramA.a());
    arrayOfObject[1] = Integer.valueOf(paramA.b());
    localA.a("Setting minimized location to {} {}", arrayOfObject);
    this.b.setX(paramA.a());
    this.b.setY(paramA.b());
  }
