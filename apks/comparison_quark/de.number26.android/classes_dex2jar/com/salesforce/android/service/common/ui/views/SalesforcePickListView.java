  ...
  extends LinearLayout
{
  ...
  private void a(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    TypedArray localTypedArray = paramContext.getTheme().obtainStyledAttributes(paramAttributeSet, a.f.SalesforcePickListView, paramInt, 0);
    CharSequence localCharSequence = localTypedArray.getText(a.f.SalesforcePickListView_salesforce_label);
    if (!TextUtils.isEmpty(localCharSequence)) {
      setLabel(localCharSequence);
    }
