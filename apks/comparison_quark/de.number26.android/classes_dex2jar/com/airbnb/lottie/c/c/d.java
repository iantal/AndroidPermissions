...
public class d
{
  ...
  public String a(String paramString)
  {
    ...
    d localD1 = this.b.a(m());
    if (localD1 != null)
    {
      localStringBuilder.append("\t\tParents: ");
      localStringBuilder.append(localD1.f());
      for (d localD2 = this.b.a(localD1.m()); localD2 != null; localD2 = this.b.a(localD2.m()))
      {
        localStringBuilder.append("->");
        localStringBuilder.append(localD2.f());
      }
      localStringBuilder.append(paramString);
      localStringBuilder.append("\n");
    }
    ...
    if ((r() != 0) && (q() != 0))
    {
      ...
      arrayOfObject[0] = Integer.valueOf(r());
      arrayOfObject[1] = Integer.valueOf(q());
      arrayOfObject[2] = Integer.valueOf(p());
      localStringBuilder.append(String.format(localLocale, "%dx%d %X\n", arrayOfObject));
    }
    if (!this.a.isEmpty())
    {
      localStringBuilder.append(paramString);
