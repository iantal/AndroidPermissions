...
public class SessionParameters
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    SessionParameters localSessionParameters = (SessionParameters)paramObject;
    if (!Util.equalObject(this.callbackParameters, localSessionParameters.callbackParameters)) {
      return false;
    }
    return Util.equalObject(this.partnerParameters, localSessionParameters.partnerParameters);
  }
