  ...
  extends ReplacementSpan
{
  ...
  public void draw(Canvas paramCanvas, CharSequence paramCharSequence, int paramInt1, int paramInt2, float paramFloat, int paramInt3, int paramInt4, int paramInt5, Paint paramPaint)
  {
    prepView();
    paramCanvas.save();
    int i = (paramInt5 - paramInt3 - this.view.getBottom()) / 2;
    paramCanvas.translate(paramFloat, paramInt5 - this.view.getBottom() - i);
  ...
  public int getSize(Paint paramPaint, CharSequence paramCharSequence, int paramInt1, int paramInt2, Paint.FontMetricsInt paramFontMetricsInt)
  {
    ...
    if (paramFontMetricsInt != null)
    {
      ...
      if (i > 0)
      {
        ...
        int m = i - j;
        paramFontMetricsInt.descent = (k + m);
        paramFontMetricsInt.ascent -= j;
        paramFontMetricsInt.bottom = (m + paramFontMetricsInt.bottom);
