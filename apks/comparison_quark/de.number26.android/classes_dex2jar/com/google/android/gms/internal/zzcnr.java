  ...
  extends SSLSocket
{
  ...
  zzcnr(zzcnq paramZzcnq, SSLSocket paramSSLSocket)
  {
  ...
  public final void setEnabledProtocols(String[] paramArrayOfString)
  {
    ...
    {
      ArrayList localArrayList = new ArrayList(Arrays.asList(this.zza.getEnabledProtocols()));
      if (localArrayList.size() > 1) {
        localArrayList.remove("SSLv3");
      }
      paramArrayOfString = (String[])localArrayList.toArray(new String[localArrayList.size()]);
    }
    this.zza.setEnabledProtocols(paramArrayOfString);
  }
