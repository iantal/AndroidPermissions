...
public class LocationServices
{
  ...
  public static zzchi zza(GoogleApiClient paramGoogleApiClient)
  {
    ...
    zzchi localZzchi = (zzchi)paramGoogleApiClient.zza(zza);
    boolean bool2 = false;
    if (localZzchi != null) {
      bool2 = true;
    }
    zzbq.zza(bool2, "GoogleApiClient is not configured to use the LocationServices.API Api. Pass thisinto GoogleApiClient.Builder#addApi() to use this feature.");
    return localZzchi;
  }
}
