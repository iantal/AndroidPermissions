...
class KmlContainerParser
{
    ...
    throws XmlPullParserException, IOException
  {
    ...
    {
      if ((i == 3) && (paramXmlPullParser.getName().equals(str1)))
      {
        KmlContainer localKmlContainer = new KmlContainer(localHashMap1, localHashMap2, localHashMap3, localHashMap4, localArrayList, localHashMap5, str2);
        return localKmlContainer;
      }
      if (i == 2) {
    ...
    throws XmlPullParserException, IOException
  {
    if (paramXmlPullParser.getAttributeValue(null, "id") != null)
    {
      KmlStyle localKmlStyle = KmlStyleParser.createStyle(paramXmlPullParser);
      paramHashMap.put(localKmlStyle.getStyleId(), localKmlStyle);
    }
  }
    ...
    throws XmlPullParserException, IOException
  {
    ...
    for (;;)
    {
      ...
      if (i == 2) {
        ...
        {
          paramHashMap.put(str, paramXmlPullParser.nextText());
          str = null;
        }
      }
