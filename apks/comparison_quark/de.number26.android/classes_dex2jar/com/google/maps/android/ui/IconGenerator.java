...
public class IconGenerator
{
  ...
  public IconGenerator(Context paramContext)
  {
    ...
    TextView localTextView = (TextView)this.mRotationLayout.findViewById(R.id.amu_text);
    this.mTextView = localTextView;
    this.mContentView = localTextView;
    setStyle(1);
  }
  ...
  public Bitmap makeIcon()
  {
    ...
    int k = this.mContainer.getMeasuredHeight();
    this.mContainer.layout(0, 0, j, k);
    if ((this.mRotation == 1) || (this.mRotation == 3))
    {
      k = this.mContainer.getMeasuredWidth();
    ...
    if (this.mRotation != 0) {
      ...
      {
        localCanvas.rotate(180.0F, j / 2, k / 2);
      }
      else
      {
        localCanvas.translate(0.0F, k);
  ...
  public void setContentView(View paramView)
  {
    ...
    View localView = this.mRotationLayout.findViewById(R.id.amu_text);
