...
public class k
{
  ...
  public boolean a(float paramFloat1, float paramFloat2)
  {
    if (a())
    {
      ...
      if (localViewParent != null) {
        return w.a(localViewParent, this.c, paramFloat1, paramFloat2);
      }
    }
    return false;
  }
  ...
  public boolean a(float paramFloat1, float paramFloat2, boolean paramBoolean)
  {
    if (a())
    {
      ViewParent localViewParent = d(0);
      if (localViewParent != null) {
        return w.a(localViewParent, this.c, paramFloat1, paramFloat2, paramBoolean);
      }
    }
    return false;
  }
  ...
  public boolean a(int paramInt1, int paramInt2)
  {
    ...
    if (a())
    {
      ...
      {
        if (w.a(localViewParent, localView, this.c, paramInt1, paramInt2))
        {
          a(paramInt2, localViewParent);
          w.b(localViewParent, localView, this.c, paramInt1, paramInt2);
          return true;
        }
  ...
  public boolean a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int[] paramArrayOfInt, int paramInt5)
  {
    if (a())
    {
      ...
      else
      {
        ...
        w.a(localViewParent, this.c, paramInt1, paramInt2, paramInt3, paramInt4, paramInt5);
        if (paramArrayOfInt != null)
        {
          this.c.getLocationInWindow(paramArrayOfInt);
          paramArrayOfInt[0] -= i;
  ...
  public boolean a(int paramInt1, int paramInt2, int[] paramArrayOfInt1, int[] paramArrayOfInt2, int paramInt3)
  {
    if (a())
    {
      ...
      else
      {
        ...
        w.a(localViewParent, this.c, paramInt1, paramInt2, paramArrayOfInt1, paramInt3);
        if (paramArrayOfInt2 != null)
        {
          this.c.getLocationInWindow(paramArrayOfInt2);
  ...
  public void c(int paramInt)
  {
    ...
    if (localViewParent != null)
    {
      w.a(localViewParent, this.c, paramInt);
      a(paramInt, null);
    }
  }
}
