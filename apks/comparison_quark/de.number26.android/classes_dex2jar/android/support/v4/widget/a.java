  ...
  implements Animatable
{
  ...
  private void c()
  {
    ...
    Animation local3 = new Animation()
    {
      public void applyTransformation(float paramAnonymousFloat, Transformation paramAnonymousTransformation)
      {
        ...
        float f3 = localB.e();
        float f4 = localB.i();
        float f5 = f2 + (0.8F - f1) * a.a().getInterpolation(paramAnonymousFloat);
        localB.c(f5);
        float f6 = f3 + 0.8F * a.b().getInterpolation(paramAnonymousFloat);
        localB.b(f6);
        float f7 = f4 + 0.25F * paramAnonymousFloat;
        localB.d(f7);
        float f8 = 144.0F * paramAnonymousFloat + 720.0F * (a.c(a.this) / 5.0F);
        a.this.a(f8);
      }
    };
    ...
    local3.setAnimationListener(new Animation.AnimationListener()
    {
      ...
      public void onAnimationRepeat(Animation paramAnonymousAnimation)
      {
        ...
        localB.a();
        localB.b(localB.g());
        a.a(a.this, (1.0F + a.c(a.this)) % 5.0F);
      }
  ...
  void a(double paramDouble1, double paramDouble2, double paramDouble3, double paramDouble4, float paramFloat1, float paramFloat2)
  {
    ...
    localB.a(f1 * (float)paramDouble4);
