...
public enum d
{
  ...
  static
  {
    ...
    arrayOfD1[0] = Cp437;
    arrayOfD1[1] = ISO8859_1;
    arrayOfD1[2] = ISO8859_2;
    arrayOfD1[3] = ISO8859_3;
    arrayOfD1[4] = ISO8859_4;
    arrayOfD1[5] = ISO8859_5;
    arrayOfD1[6] = ISO8859_6;
    arrayOfD1[7] = ISO8859_7;
    arrayOfD1[8] = ISO8859_8;
    arrayOfD1[9] = ISO8859_9;
    arrayOfD1[10] = ISO8859_10;
    arrayOfD1[11] = ISO8859_11;
    arrayOfD1[12] = ISO8859_13;
    arrayOfD1[13] = ISO8859_14;
    arrayOfD1[14] = ISO8859_15;
    arrayOfD1[15] = ISO8859_16;
    arrayOfD1[16] = SJIS;
    arrayOfD1[17] = Cp1250;
    arrayOfD1[18] = Cp1251;
    arrayOfD1[19] = Cp1252;
    arrayOfD1[20] = Cp1256;
    arrayOfD1[21] = UnicodeBigUnmarked;
    arrayOfD1[22] = UTF8;
    arrayOfD1[23] = ASCII;
    arrayOfD1[24] = Big5;
    arrayOfD1[25] = GB18030;
    arrayOfD1[26] = EUC_KR;
    $VALUES = arrayOfD1;
    ...
    for (d localD : values())
    {
      for (int i2 : localD.values) {
        VALUE_TO_ECI.put(Integer.valueOf(i2), localD);
      }
      NAME_TO_ECI.put(localD.name(), localD);
      for (String str : localD.otherEncodingNames) {
        NAME_TO_ECI.put(str, localD);
      }
    }
  }
