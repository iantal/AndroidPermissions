  ...
  implements t
{
  ...
  static s<?> a(f paramF, com.google.a.e paramE, a<?> paramA, b paramB)
  {
    ...
    if (s.class.isAssignableFrom(localClass)) {
      return (s)paramF.a(a.a(localClass)).a();
    }
    if (t.class.isAssignableFrom(localClass)) {
      return ((t)paramF.a(a.a(localClass)).a()).a(paramE, paramA);
    }
