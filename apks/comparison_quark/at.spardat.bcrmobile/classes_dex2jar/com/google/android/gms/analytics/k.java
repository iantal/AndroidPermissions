  ...
  extends ThreadPoolExecutor
{
  ...
  protected final <T> RunnableFuture<T> newTaskFor(Runnable paramRunnable, T paramT)
  {
    new FutureTask(paramRunnable, paramT)
    {
      ...
      {
        Thread.UncaughtExceptionHandler localUncaughtExceptionHandler = j.b(k.this.a);
        ...
        for (;;)
        {
          ...
          {
            String str = String.valueOf(paramAnonymousThrowable);
            new StringBuilder(37 + String.valueOf(str).length()).append("MeasurementExecutor: job failed with ").append(str);
          }
        }
      }
    };
