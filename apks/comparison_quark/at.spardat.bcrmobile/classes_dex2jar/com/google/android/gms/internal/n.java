  ...
  implements q, r
{
  ...
  public n(Context paramContext, Handler paramHandler)
  {
    this.b = paramContext;
    this.c = paramHandler;
    GoogleSignInOptions localGoogleSignInOptions = b.a(this.b).b();
    if (localGoogleSignInOptions == null) {}
    for (HashSet localHashSet = new HashSet();; localHashSet = new HashSet(localGoogleSignInOptions.a()))
    {
      this.f = localHashSet;
  ...
  public final void a(o paramO)
  {
    ...
    GoogleSignInOptions localGoogleSignInOptions;
    if (this.e)
    {
      localGoogleSignInOptions = b.a(this.b).b();
      if (localGoogleSignInOptions != null) {
        break label128;
      }
    }
