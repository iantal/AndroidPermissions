  ...
  implements ar
{
  ...
  public boolean onTransact(int paramInt1, Parcel paramParcel1, Parcel paramParcel2, int paramInt2)
  {
    ...
    case 46: 
      ...
      zzj localZzj = null;
      if (j != 0) {
        localZzj = (zzj)zzj.CREATOR.createFromParcel(paramParcel1);
      }
      a(localAo2, localZzj);
      paramParcel2.writeNoException();
      return true;
    ...
    paramParcel1.enforceInterface("com.google.android.gms.common.internal.IGmsServiceBroker");
    ao localAo1 = ap.a(paramParcel1.readStrongBinder());
    int i = paramParcel1.readInt();
    zzan localZzan = null;
    if (i != 0) {
      localZzan = (zzan)zzan.CREATOR.createFromParcel(paramParcel1);
    }
    a(localAo1, localZzan);
    paramParcel2.writeNoException();
    return true;
  }
}
