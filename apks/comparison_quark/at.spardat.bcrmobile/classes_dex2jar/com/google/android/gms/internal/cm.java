...
abstract class cm<T extends cl>
  extends bw
{
  cn<T> a;
  
  public cm(bz paramBz, cn<T> paramCn)
  {
    super(paramBz);
    this.a = paramCn;
  }
  ...
  private T a(XmlResourceParser paramXmlResourceParser)
  {
    for (;;)
    {
      ...
      {
        String str1;
        e("Error parsing tracker configuration file", localIOException);
        continue;
  ...
  public final T a(int paramInt)
  {
    try
    {
      cl localCl = a(g().b().getResources().getXml(paramInt));
      return localCl;
    }
