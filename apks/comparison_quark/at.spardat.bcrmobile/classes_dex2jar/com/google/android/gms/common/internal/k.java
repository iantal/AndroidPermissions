...
public abstract class k<T extends IInterface>
{
        ...
        synchronized (this.n)
        {
          ...
          case 2: 
            if (this.s != null)
            {
              ...
              new StringBuilder(70 + String.valueOf(str3).length() + String.valueOf(str4).length()).append("Calling connect() while still connected, missing disconnect() for ").append(str3).append(" on ").append(str4);
            ...
            new StringBuilder(34 + String.valueOf(str1).length() + String.valueOf(str2).length()).append("unable to connect to service: ").append(str1).append(" on ").append(str2);
  ...
  public final void a(ai paramAi, Set<Scope> paramSet)
  {
    ...
    if (d())
    {
      ...
      localAccount = i();
      localZzj.h = localAccount;
      if (paramAi != null) {
        localZzj.e = paramAi.asBinder();
      }
    }
    try
    {
