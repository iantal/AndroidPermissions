...
public final class ac
{
  ...
  private int a(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    float f2 = i2 + i2 * (float)Math.sin((float)(0.4712389167638204D * (f1 - 0.5F)));
  ...
  {
    ac localAc = new ac(paramViewGroup.getContext(), paramViewGroup, paramAd);
    localAc.b = ((int)(1.0F * localAc.b));
    return localAc;
  }
  ...
  private boolean a(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    label259:
    for (float f2 = i10 / i11;; f2 = i8 / i12)
    {
      int i13 = a(i3, i5, this.r.c(localView));
      int i14 = a(i4, i6, 0);
      int i15 = (int)(f1 * i13 + f2 * i14);
      r localR = this.q;
      localR.b.a(localR.a, i1, i2, i3, i4, i15);
      b(2);
      return true;
      f1 = i7 / i12;
      break;
  ...
  {
    int i1 = android.support.v4.view.ac.c(paramMotionEvent);
    for (int i2 = 0; i2 < i1; i2++)
    {
      int i3 = android.support.v4.view.ac.b(paramMotionEvent, i2);
      float f1 = android.support.v4.view.ac.c(paramMotionEvent, i2);
      float f2 = android.support.v4.view.ac.d(paramMotionEvent, i2);
      this.f[i3] = f1;
      this.g[i3] = f2;
    }
  }
  ...
  private boolean f(int paramInt)
  {
    if (!e(paramInt))
    {
      new StringBuilder("Ignoring pointerId=").append(paramInt).append(" because ACTION_DOWN was not received for this pointer before ACTION_MOVE. It likely happened because ").append(" ViewDragHelper did not receive all the events in the event stream.");
      return false;
    }
    return true;
  }
  ...
  public final boolean a(MotionEvent paramMotionEvent)
  {
    ...
    int i2 = android.support.v4.view.ac.b(paramMotionEvent);
    if (i1 == 0) {
      e();
    }
    if (this.l == null) {
    ...
    while (this.a == 1)
    {
      ...
      int i12 = android.support.v4.view.ac.b(paramMotionEvent, 0);
      a(f7, f8, i12);
      ...
      if ((this.h[i12] & this.p) != 0)
      {
        this.r.b();
        continue;
        int i11 = android.support.v4.view.ac.b(paramMotionEvent, i2);
        float f5 = android.support.v4.view.ac.c(paramMotionEvent, i2);
        float f6 = android.support.v4.view.ac.d(paramMotionEvent, i2);
        a(f5, f6, i11);
        if (this.a == 0)
        {
        ...
        else if (this.a == 2)
        {
          ...
          if (localView2 == this.s)
          {
            ...
            {
              int i3 = android.support.v4.view.ac.c(paramMotionEvent);
              for (int i4 = 0;; i4++)
              {
                int i5;
                float f3;
                ...
                if (i4 < i3)
                {
                  i5 = android.support.v4.view.ac.b(paramMotionEvent, i4);
                  if (!f(i5)) {
                    continue;
                  }
                  float f1 = android.support.v4.view.ac.c(paramMotionEvent, i4);
                  float f2 = android.support.v4.view.ac.d(paramMotionEvent, i4);
                  f3 = f1 - this.d[i5];
                  f4 = f2 - this.e[i5];
              ...
              d(android.support.v4.view.ac.b(paramMotionEvent, i2));
              continue;
              e();
            }
          }
  ...
  public final boolean a(boolean paramBoolean)
  {
    if (this.a == 2)
    {
      ...
      {
        r localR1 = this.q;
        if (i2 == localR1.b.g(localR1.a))
        {
          r localR2 = this.q;
          if (i3 == localR2.b.h(localR2.a))
          {
            this.q.f();
            bool2 = false;
          }
  ...
  {
    int i1 = 0;
    int i2 = android.support.v4.view.ac.a(paramMotionEvent);
    int i3 = android.support.v4.view.ac.b(paramMotionEvent);
    if (i2 == 0) {
      e();
    }
    if (this.l == null) {
    ...
    case 2: 
        ...
        do
        {
          ...
          do
          {
            ...
            do
            {
              ...
              i20 = android.support.v4.view.ac.b(paramMotionEvent, 0);
            ...
            this.r.b();
            return;
            i17 = android.support.v4.view.ac.b(paramMotionEvent, i3);
            f9 = android.support.v4.view.ac.c(paramMotionEvent, i3);
            f10 = android.support.v4.view.ac.d(paramMotionEvent, i3);
            a(f9, f10, i17);
            if (this.a != 0) {
              break;
            }
      ...
      int i10 = android.support.v4.view.ac.a(paramMotionEvent, this.c);
      float f7 = android.support.v4.view.ac.c(paramMotionEvent, i10);
      float f8 = android.support.v4.view.ac.d(paramMotionEvent, i10);
      ...
      c(paramMotionEvent);
      return;
      int i8 = android.support.v4.view.ac.c(paramMotionEvent);
      while (i1 < i8)
      {
        int i9 = android.support.v4.view.ac.b(paramMotionEvent, i1);
        if (f(i9))
        {
          float f3 = android.support.v4.view.ac.c(paramMotionEvent, i1);
          float f4 = android.support.v4.view.ac.d(paramMotionEvent, i1);
      ...
      return;
    case 6: 
      i4 = android.support.v4.view.ac.b(paramMotionEvent, i3);
      if ((this.a == 1) && (i4 == this.c))
      {
        int i5 = android.support.v4.view.ac.c(paramMotionEvent);
        if (i1 >= i5) {
          break label780;
        }
        int i7 = android.support.v4.view.ac.b(paramMotionEvent, i1);
        if (i7 == this.c) {
          break label738;
        }
        float f1 = android.support.v4.view.ac.c(paramMotionEvent, i1);
        float f2 = android.support.v4.view.ac.d(paramMotionEvent, i1);
