  ...
  extends at.spardat.bcrmobile.activity.d
{
  ...
  private final View.OnClickListener d = new View.OnClickListener()
  {
    public final void onClick(View paramAnonymousView)
    {
      ...
      case 2131427453: 
        ...
        arrayOfObject[0] = "market://details?id=";
        arrayOfObject[1] = APIVersionUpdateActivity.this.getPackageName();
        Intent localIntent = new Intent("android.intent.action.VIEW", Uri.parse(at.spardat.bcrmobile.e.d.a(arrayOfObject)));
        APIVersionUpdateActivity.this.startActivity(localIntent);
        return;
      }
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    Button localButton1 = (Button)findViewById(2131427452);
    Button localButton2 = (Button)findViewById(2131427453);
    localButton1.setOnClickListener(this.d);
    localButton2.setOnClickListener(this.d);
  }
