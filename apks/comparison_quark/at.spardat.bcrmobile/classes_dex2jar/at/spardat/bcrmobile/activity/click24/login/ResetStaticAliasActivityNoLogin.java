  ...
  extends d
{
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    final EditText localEditText = (EditText)this.e.findViewById(2131427755);
    ...
    localButton1.setOnClickListener(new View.OnClickListener()
    {
      public final void onClick(View paramAnonymousView)
      {
        ...
        if (ResetStaticAliasActivityNoLogin.a(ResetStaticAliasActivityNoLogin.this, localEditText)) {
          ResetStaticAliasActivityNoLogin.b(ResetStaticAliasActivityNoLogin.this, localEditText);
        }
      }
    });
  ...
  protected void onResume()
  {
    ...
    for (long l2 = ((Long)localObject).longValue();; l2 = 0L)
    {
      ...
      if (b.a()) {
        b.a(at.spardat.bcrmobile.b.c.INFO, getClass().getName(), "TimeDifference " + (l1 - l2) / 1000L + "Sec.");
      }
