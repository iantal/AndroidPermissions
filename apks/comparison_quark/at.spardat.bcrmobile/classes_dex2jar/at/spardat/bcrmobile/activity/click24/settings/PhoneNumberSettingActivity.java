  ...
  extends at.spardat.bcrmobile.activity.click24.d
{
  ...
  private void a(String paramString)
  {
    ...
    {
      while (!b.a()) {}
      b.a(c.ERROR, PhoneNumberSettingActivity.class.getName(), "pushEtokenApp() " + localActivityNotFoundException.getLocalizedMessage());
    }
  }
  ...
  private boolean a(EditText paramEditText)
  {
    ...
    boolean bool1;
    if ((!at.spardat.bcrmobile.e.d.a(str)) && (str.length() == 10))
    {
      boolean bool2 = str.startsWith("07");
      bool1 = false;
      if (bool2) {}
    }
    else
