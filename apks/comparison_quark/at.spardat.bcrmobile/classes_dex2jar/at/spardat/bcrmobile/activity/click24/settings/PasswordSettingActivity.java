  ...
  extends at.spardat.bcrmobile.activity.click24.d
{
  ...
  private final View.OnClickListener h = new View.OnClickListener()
  {
    public final void onClick(View paramAnonymousView)
    {
      ...
      default: 
        return;
      case 2131427830: 
        Intent localIntent = new Intent(PasswordSettingActivity.this, ModifyPasswordSettingActivity.class);
        PasswordSettingActivity.this.startActivity(localIntent);
        return;
      case 2131427660: 
  ...
  protected void onDestroy()
  {
    ...
    arrayOfAsyncTask[0] = this.e;
    arrayOfAsyncTask[1] = this.f;
    arrayOfAsyncTask[2] = this.g;
    a(arrayOfAsyncTask);
    super.onDestroy();
  }
}
