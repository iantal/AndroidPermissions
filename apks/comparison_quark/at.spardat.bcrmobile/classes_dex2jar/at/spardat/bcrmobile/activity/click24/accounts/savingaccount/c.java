  ...
  implements AdapterView.OnItemSelectedListener
{
  ...
  public final void onItemSelected(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    if (!d.a(CallDepositTransferActivity.d(this.a)))
    {
      ...
      arrayOfObject[0] = d.a(this.a.getApplicationContext(), CallDepositTransferActivity.i(this.a).getAccountSaldo().trim(), CallDepositTransferActivity.i(this.a).getAccountCurrency(), true);
      arrayOfObject[1] = " ";
      arrayOfObject[2] = CallDepositTransferActivity.i(this.a).getAccountCurrency();
