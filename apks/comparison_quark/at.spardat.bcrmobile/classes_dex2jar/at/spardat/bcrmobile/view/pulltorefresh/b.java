  ...
  b(Context paramContext, c paramC, TypedArray paramTypedArray)
  {
    ...
    default: 
      ...
      if (paramTypedArray.hasValue(2))
      {
        ...
        paramTypedArray.getValue(2, localTypedValue);
    ...
    for (;;)
    {
      ...
      {
        ColorStateList localColorStateList = paramTypedArray.getColorStateList(0);
        if ((localColorStateList != null) && (this.f != null)) {
          this.f.setTextColor(localColorStateList);
        }
      }
      Drawable localDrawable = a.a(paramContext, 2130837592);
      this.b.setImageDrawable(localDrawable);
      this.g = (localDrawable instanceof AnimationDrawable);
      a(localDrawable);
      j();
      return;
