  ...
  extends FrameLayout
{
  ...
  public e(int paramInt, Context paramContext)
  {
    ...
    View localView = LayoutInflater.from(paramContext).inflate(2130903071, this.a);
    this.b = ((TextView)localView.findViewById(2131427487));
    this.c = ((TextView)localView.findViewById(2131427488));
    ((ImageView)localView.findViewById(2131427489)).setOnClickListener(new View.OnClickListener()
    {
