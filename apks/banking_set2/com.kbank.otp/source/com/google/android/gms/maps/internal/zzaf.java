  ...
  extends IInterface
{
    ...
    implements zzaf
  {
    ...
    public static zzaf zziy(IBinder paramIBinder)
    {
      ...
      throws RemoteException
    {
      ...
      zza(IStreetViewPanoramaDelegate.zza.zzjb(paramParcel1.readStrongBinder()));
      ...
      implements zzaf
    {
        ...
        throws RemoteException
      {
        ...
        //   30: aload_0
        //   31: getfield 18	com/google/android/gms/maps/internal/zzaf$zza$zza:zzajq	Landroid/os/IBinder;
        //   34: iconst_1
        //   35: aload_2
        //   36: aload_3
        //   37: iconst_0
