  ...
  implements Comparable<Flag>
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    if ((paramObject != null) && ((paramObject instanceof Flag)))
    {
      ...
      if ((this.mVersionCode != paramObject.mVersionCode) || (!zzz.equal(this.name, paramObject.name)) || (this.aAy != paramObject.aAy) || (this.aAz != paramObject.aAz)) {
        bool = false;
      }
      do
      {
        ...
        return false;
      } while (this.ahK == paramObject.ahK);
      return false;
      return zzz.equal(this.Fe, paramObject.Fe);
      return Arrays.equals(this.aAx, paramObject.aAx);
    }
    return false;
  }
