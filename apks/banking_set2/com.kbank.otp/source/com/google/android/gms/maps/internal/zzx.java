  ...
  extends IInterface
{
    ...
    implements zzx
  {
    ...
    public static zzx zziq(IBinder paramIBinder)
    {
      ...
      throws RemoteException
    {
      ...
      zzaf(zzd.zza.zzfd(paramParcel1.readStrongBinder()));
      ...
      implements zzx
    {
        ...
        throws RemoteException
      {
        ...
        //   30: aload_0
        //   31: getfield 18	com/google/android/gms/maps/internal/zzx$zza$zza:zzajq	Landroid/os/IBinder;
        //   34: iconst_1
        //   35: aload_2
        //   36: aload_3
        //   37: iconst_0
