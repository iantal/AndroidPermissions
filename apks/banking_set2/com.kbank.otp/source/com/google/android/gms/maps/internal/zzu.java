  ...
  extends IInterface
{
    ...
    implements zzu
  {
    ...
    public static zzu zzin(IBinder paramIBinder)
    {
      ...
      throws RemoteException
    {
      ...
      boolean bool = zza(zzf.zza.zzjk(paramParcel1.readStrongBinder()));
      ...
      implements zzu
    {
        ...
        throws RemoteException
      {
        ...
        //   36: aload_0
        //   37: getfield 18	com/google/android/gms/maps/internal/zzu$zza$zza:zzajq	Landroid/os/IBinder;
        //   40: iconst_1
        //   41: aload 4
        //   43: aload 5
        //   45: iconst_0
