  ...
  implements Serializable
{
  ...
  public java.util.SortedMap<Double, Double> getRange(double paramDouble1, double paramDouble2, boolean paramBoolean)
  {
    ...
    //   10: ifeq +123 -> 133
    //   13: aload_0
    //   14: getfield 39	org/achartengine/model/XYSeries:mXY	Lorg/achartengine/util/IndexXYMap;
    //   17: dload_1
    //   18: invokestatic 96	java/lang/Double:valueOf	(D)Ljava/lang/Double;
    //   21: invokevirtual 160	org/achartengine/util/IndexXYMap:headMap	(Ljava/lang/Object;)Ljava/util/SortedMap;
    //   24: astore 10
    //   26: aload 10
    ...
    //   43: checkcast 92	java/lang/Double
    //   46: invokevirtual 140	java/lang/Double:doubleValue	()D
    //   49: dstore_1
    //   50: aload_0
    //   51: getfield 39	org/achartengine/model/XYSeries:mXY	Lorg/achartengine/util/IndexXYMap;
    //   54: dload_3
    //   55: invokestatic 96	java/lang/Double:valueOf	(D)Ljava/lang/Double;
    //   58: invokevirtual 173	org/achartengine/util/IndexXYMap:tailMap	(Ljava/lang/Object;)Ljava/util/SortedMap;
    //   61: astore 10
    //   63: dload_1
    //   64: dstore 8
    //   66: dload_3
    ...
    //   100: checkcast 92	java/lang/Double
    //   103: astore 11
    //   105: aload 10
    //   107: invokeinterface 191 1 0
    //   112: ifeq +45 -> 157
    //   115: aload 10
    //   117: invokeinterface 188 1 0
    //   122: checkcast 92	java/lang/Double
    //   125: invokevirtual 140	java/lang/Double:doubleValue	()D
    //   128: dstore 6
    //   130: dload_1
    //   131: dstore 8
    //   133: aload_0
    //   134: getfield 39	org/achartengine/model/XYSeries:mXY	Lorg/achartengine/util/IndexXYMap;
    //   137: dload 8
    //   139: invokestatic 96	java/lang/Double:valueOf	(D)Ljava/lang/Double;
    //   142: dload 6
    //   144: invokestatic 96	java/lang/Double:valueOf	(D)Ljava/lang/Double;
    //   147: invokevirtual 195	org/achartengine/util/IndexXYMap:subMap	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/util/SortedMap;
    //   150: astore 10
    //   152: aload_0
    //   153: monitorexit
    //   154: aload 10
    //   156: areturn
    //   157: aload 11
    //   159: invokevirtual 140	java/lang/Double:doubleValue	()D
    //   162: dstore 6
    //   164: dload_3
    //   165: dload 6
    //   167: dadd
    ...
    //   0	183	0	this	XYSeries
    //   0	183	1	paramDouble1	double
    //   0	183	3	paramDouble2	double
    //   0	183	5	paramBoolean	boolean
    //   6	163	6	d1	double
    //   3	169	8	d2	double
    //   24	131	10	localObject1	Object
    //   176	5	10	localObject2	Object
    //   103	55	11	localDouble	Double
    // Exception table:
    //   from	to	target	type
    //   13	26	176	finally
    //   26	50	176	finally
