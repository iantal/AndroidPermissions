...
# static fields
.field static bkT:Lcom/google/firebase/messaging/zza;


# instance fields
.field private Cb:Landroid/os/Bundle;

.field private final bkU:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/google/firebase/messaging/zza;->bkU:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method private R()Landroid/os/Bundle;
    ...
    iget-object v0, p0, Lcom/google/firebase/messaging/zza;->Cb:Landroid/os/Bundle;
    ...
    iput-object v0, p0, Lcom/google/firebase/messaging/zza;->Cb:Landroid/os/Bundle;
...
.method private zza(Landroid/os/Bundle;Landroid/app/PendingIntent;)Landroid/app/PendingIntent;
    ...
    invoke-static {v1, v0}, Lcom/google/firebase/iid/FirebaseInstanceIdInternalReceiver;->zzg(Landroid/content/Context;Landroid/content/Intent;)Landroid/content/Intent;

    move-result-object v0

    iget-object v1, p0, Lcom/google/firebase/messaging/zza;->mContext:Landroid/content/Context;

    invoke-direct {p0}, Lcom/google/firebase/messaging/zza;->zzbnr()I
...
.method private zzag(Landroid/os/Bundle;)Landroid/app/Notification;
    ...
    invoke-direct {p0, v0}, Lcom/google/firebase/messaging/zza;->zzkl(Ljava/lang/String;)I
    ...
    invoke-direct {p0, v0}, Lcom/google/firebase/messaging/zza;->zzua(Ljava/lang/String;)Ljava/lang/Integer;
    ...
    invoke-direct {p0, v0}, Lcom/google/firebase/messaging/zza;->zzkm(Ljava/lang/String;)Landroid/net/Uri;

    move-result-object v6

    invoke-direct {p0, p1}, Lcom/google/firebase/messaging/zza;->zzah(Landroid/os/Bundle;)Landroid/app/PendingIntent;

    move-result-object v1

    const/4 v0, 0x0

    invoke-static {p1}, Lcom/google/firebase/messaging/FirebaseMessagingService;->zzav(Landroid/os/Bundle;)Z

    move-result v7

    if-eqz v7, :cond_0

    invoke-direct {p0, p1, v1}, Lcom/google/firebase/messaging/zza;->zza(Landroid/os/Bundle;Landroid/app/PendingIntent;)Landroid/app/PendingIntent;

    move-result-object v1

    invoke-direct {p0, p1}, Lcom/google/firebase/messaging/zza;->zzau(Landroid/os/Bundle;)Landroid/app/PendingIntent;
...
.method private zzah(Landroid/os/Bundle;)Landroid/app/PendingIntent;
    ...
    invoke-static {v0}, Lcom/google/firebase/messaging/FirebaseMessagingService;->zzac(Landroid/os/Bundle;)V
...
.method static zzat(Landroid/os/Bundle;)Ljava/lang/String;
    .locals 2
...
.method private zzau(Landroid/os/Bundle;)Landroid/app/PendingIntent;
    .locals 4
...
.method private zzbnr()I
    ...
    iget-object v0, p0, Lcom/google/firebase/messaging/zza;->bkU:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method static declared-synchronized zzev(Landroid/content/Context;)Lcom/google/firebase/messaging/zza;
    .locals 2
    ...
    :try_start_0
    sget-object v0, Lcom/google/firebase/messaging/zza;->bkT:Lcom/google/firebase/messaging/zza;
    ...
    sput-object v0, Lcom/google/firebase/messaging/zza;->bkT:Lcom/google/firebase/messaging/zza;
...
.method private zzg(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    :goto_1
    invoke-static {v0}, Lcom/google/firebase/messaging/zza;->zzkk(Ljava/lang/String;)Ljava/lang/String;
...
.method private static zzkk(Ljava/lang/String;)Ljava/lang/String;
    .locals 1
...
.method private zzkl(Ljava/lang/String;)I
    ...
    :cond_2
    invoke-direct {p0}, Lcom/google/firebase/messaging/zza;->R()Landroid/os/Bundle;
...
.method private zzua(Ljava/lang/String;)Ljava/lang/Integer;
    .locals 4
...
# virtual methods
.method zzas(Landroid/os/Bundle;)V
    .locals 2

    invoke-direct {p0, p1}, Lcom/google/firebase/messaging/zza;->zzag(Landroid/os/Bundle;)Landroid/app/Notification;
    ...
    invoke-direct {p0, v1, v0}, Lcom/google/firebase/messaging/zza;->zza(Ljava/lang/String;Landroid/app/Notification;)V
