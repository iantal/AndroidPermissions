...
public class StringUtils
{
  ...
  public static int getLevenshteinDistance(CharSequence paramCharSequence1, CharSequence paramCharSequence2, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      int n = localCharSequence1.charAt(k - 1);
      paramCharSequence1[0] = k;
      ...
      if (m <= i1)
      {
        if (localCharSequence2.charAt(m - 1) == n) {
  ...
  private static class InitStripAccents
  {
    ...
    static
    {
      ...
      try
      {
        ...
        localObject2 = ((Class)localObject6).getField("NFD").get(null);
        localObject1 = localObject2;
      ...
      java6Exception = localObject2;
      java6NormalizerFormNFD = localObject1;
      java6NormalizeMethod = localObject3;
      sunException = localObject5;
      sunDecomposeMethod = localObject4;
    }
