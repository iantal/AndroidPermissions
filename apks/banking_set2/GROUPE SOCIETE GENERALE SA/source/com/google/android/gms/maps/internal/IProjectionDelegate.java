    ...
    implements IProjectionDelegate
  {
      ...
      throws RemoteException
    {
      ...
      case 1: 
        ...
        paramParcel1 = fromScreenLocation(b.a.l(paramParcel1.readStrongBinder()));
      ...
      implements IProjectionDelegate
    {
        ...
        throws RemoteException
      {
        ...
        //   33: aload_0
        //   34: getfield 17	com/google/android/gms/maps/internal/IProjectionDelegate$a$a:a	Landroid/os/IBinder;
        //   37: iconst_1
        //   38: aload_3
        //   39: aload 4
        //   41: iconst_0
        ...
        //   60: ifeq +12 -> 72
        //   63: getstatic 62	com/google/android/gms/maps/model/LatLng:CREATOR	Lcom/google/android/gms/maps/model/LatLngCreator;
        //   66: aload 4
        //   68: invokevirtual 68	com/google/android/gms/maps/model/LatLngCreator:createFromParcel	(Landroid/os/Parcel;)Lcom/google/android/gms/maps/model/LatLng;
        //   71: astore_1
        //   72: aload 4
        ...
        throws RemoteException
      {
        ...
        //   14: aload_0
        //   15: getfield 17	com/google/android/gms/maps/internal/IProjectionDelegate$a$a:a	Landroid/os/IBinder;
        //   18: iconst_3
        //   19: aload_2
        //   20: aload_3
        //   21: iconst_0
        ...
        //   36: ifeq +21 -> 57
        //   39: getstatic 79	com/google/android/gms/maps/model/VisibleRegion:CREATOR	Lcom/google/android/gms/maps/model/VisibleRegionCreator;
        //   42: aload_3
        //   43: invokevirtual 84	com/google/android/gms/maps/model/VisibleRegionCreator:createFromParcel	(Landroid/os/Parcel;)Lcom/google/android/gms/maps/model/VisibleRegion;
        //   46: astore_1
        //   47: aload_3
        ...
        throws RemoteException
      {
        ...
        //   18: aload_2
        //   19: iconst_1
        //   20: invokevirtual 90	android/os/Parcel:writeInt	(I)V
        //   23: aload_1
        //   24: aload_2
        //   25: iconst_0
        //   26: invokevirtual 94	com/google/android/gms/maps/model/LatLng:writeToParcel	(Landroid/os/Parcel;I)V
        //   29: aload_0
        //   30: getfield 17	com/google/android/gms/maps/internal/IProjectionDelegate$a$a:a	Landroid/os/IBinder;
        //   33: iconst_2
        //   34: aload_2
        //   35: aload_3
        //   36: iconst_0
        ...
        //   47: aload_3
        //   48: invokevirtual 97	android/os/Parcel:readStrongBinder	()Landroid/os/IBinder;
        //   51: invokestatic 103	com/google/android/gms/dynamic/b$a:l	(Landroid/os/IBinder;)Lcom/google/android/gms/dynamic/b;
        //   54: astore_1
        //   55: aload_3
        ...
        //   65: aload_2
        //   66: iconst_0
        //   67: invokevirtual 90	android/os/Parcel:writeInt	(I)V
        //   70: goto -41 -> 29
        //   73: astore_1
        //   74: aload_3
