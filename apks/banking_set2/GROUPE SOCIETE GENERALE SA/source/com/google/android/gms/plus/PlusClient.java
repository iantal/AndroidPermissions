  ...
  implements GooglePlayServicesClient
{
  ...
  public static class Builder
  {
    ...
    public PlusClient build()
    {
      ...
      Object localObject = (String[])this.hW.toArray(new String[this.hW.size()]);
      localObject = new a(this.g, (String[])localObject, this.hX, this.hY, this.hZ, this.ia, this.ib);
      return new PlusClient(new bt(this.mContext, (a)localObject, this.hV, this.e));
    }
