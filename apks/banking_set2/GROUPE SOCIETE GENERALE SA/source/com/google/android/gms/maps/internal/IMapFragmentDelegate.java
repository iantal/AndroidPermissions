  ...
  extends IInterface
{
    ...
    implements IMapFragmentDelegate
  {
      ...
      throws RemoteException
    {
      ...
      case 2: 
        paramParcel1.enforceInterface("com.google.android.gms.maps.internal.IMapFragmentDelegate");
        localB1 = b.a.l(paramParcel1.readStrongBinder());
      ...
      implements IMapFragmentDelegate
    {
        ...
        throws RemoteException
      {
        ...
        //   29: aload_0
        //   30: getfield 17	com/google/android/gms/maps/internal/IMapFragmentDelegate$a$a:a	Landroid/os/IBinder;
        //   33: iconst_3
        //   34: aload_2
        //   35: aload_3
        //   36: iconst_0
        ...
        //   56: aload_2
        //   57: iconst_0
        //   58: invokevirtual 70	android/os/Parcel:writeInt	(I)V
        //   61: goto -32 -> 29
        //   64: astore_1
        //   65: aload_3
        ...
        throws RemoteException
      {
        ...
        //   31: aload 5
        //   33: aload_1
        //   34: invokevirtual 85	android/os/Parcel:writeStrongBinder	(Landroid/os/IBinder;)V
        //   37: aload 4
        //   39: astore_1
        //   40: aload_2
        //   41: ifnull +10 -> 51
        ...
        //   51: aload 5
        //   53: aload_1
        //   54: invokevirtual 85	android/os/Parcel:writeStrongBinder	(Landroid/os/IBinder;)V
        //   57: aload_3
        //   58: ifnull +63 -> 121
        //   61: aload 5
        //   63: iconst_1
        ...
        //   68: aload 5
        //   70: iconst_0
        //   71: invokevirtual 76	android/os/Bundle:writeToParcel	(Landroid/os/Parcel;I)V
        //   74: aload_0
        //   75: getfield 17	com/google/android/gms/maps/internal/IMapFragmentDelegate$a$a:a	Landroid/os/IBinder;
        //   78: iconst_4
        //   79: aload 5
        //   81: aload 6
        //   83: iconst_0
        //   84: invokeinterface 42 5 0
        //   89: pop
        //   90: aload 6
        //   92: invokevirtual 45	android/os/Parcel:readException	()V
        //   95: aload 6
        //   97: invokevirtual 48	android/os/Parcel:readStrongBinder	()Landroid/os/IBinder;
        //   100: invokestatic 91	com/google/android/gms/dynamic/b$a:l	(Landroid/os/IBinder;)Lcom/google/android/gms/dynamic/b;
        //   103: astore_1
        //   104: aload 6
        ...
        //   121: aload 5
        //   123: iconst_0
        //   124: invokevirtual 70	android/os/Parcel:writeInt	(I)V
        //   127: goto -53 -> 74
        //   130: astore_1
        //   131: aload 6
        ...
        throws RemoteException
      {
        ...
        //   69: aload_2
        //   70: iconst_0
        //   71: invokevirtual 70	android/os/Parcel:writeInt	(I)V
        //   74: goto -45 -> 29
        //   77: astore_1
        //   78: aload_3
