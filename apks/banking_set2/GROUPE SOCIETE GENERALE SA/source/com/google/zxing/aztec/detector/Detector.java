...
public final class Detector
{
  ...
  private Point getMatrixCenter()
  {
    ...
    return new Point(MathUtils.round((localObject1.getX() + ((ResultPoint)localObject2).getX() + localResultPoint3.getX() + localResultPoint4.getX()) / 4.0F), MathUtils.round((localObject1.getY() + ((ResultPoint)localObject2).getY() + localResultPoint3.getY() + localResultPoint4.getY()) / 4.0F), null);
  }
