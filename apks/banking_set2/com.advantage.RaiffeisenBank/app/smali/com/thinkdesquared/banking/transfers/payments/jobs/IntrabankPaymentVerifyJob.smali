.class public Lcom/thinkdesquared/banking/transfers/payments/jobs/IntrabankPaymentVerifyJob;
.super Lcom/thinkdesquared/banking/core/jobs/SessionBoundJob;
.source "IntrabankPaymentVerifyJob.java"
...
.field private mTuchIdAuthorizationData:Lcom/thinkdesquared/banking/models/TouchIdAuthorizationData;
...
.method public constructor <init>(Ljava/lang/String;Ljava/lang/String;Lcom/thinkdesquared/banking/models/PaymentData;Landroid/app/Activity;Lcom/thinkdesquared/banking/models/TouchIdAuthorizationData;)V
    ...
    iput-object v0, p0, Lcom/thinkdesquared/banking/transfers/payments/jobs/IntrabankPaymentVerifyJob;->TAG:Ljava/lang/String;

    .line 34
    iput-object p2, p0, Lcom/thinkdesquared/banking/transfers/payments/jobs/IntrabankPaymentVerifyJob;->mWorkflowId:Ljava/lang/String;

    .line 35
    iput-object p3, p0, Lcom/thinkdesquared/banking/transfers/payments/jobs/IntrabankPaymentVerifyJob;->mPaymentData:Lcom/thinkdesquared/banking/models/PaymentData;

    .line 36
    iput-object p4, p0, Lcom/thinkdesquared/banking/transfers/payments/jobs/IntrabankPaymentVerifyJob;->activity:Landroid/app/Activity;

    .line 37
    iput-object p5, p0, Lcom/thinkdesquared/banking/transfers/payments/jobs/IntrabankPaymentVerifyJob;->mTuchIdAuthorizationData:Lcom/thinkdesquared/banking/models/TouchIdAuthorizationData;
...
.method public onRun()V
    ...
    iget-object v3, p0, Lcom/thinkdesquared/banking/transfers/payments/jobs/IntrabankPaymentVerifyJob;->mPaymentData:Lcom/thinkdesquared/banking/models/PaymentData;
    ...
    :goto_0
    invoke-virtual {p0}, Lcom/thinkdesquared/banking/transfers/payments/jobs/IntrabankPaymentVerifyJob;->assertNotCancelled()V
    ...
    :cond_0
    iget-object v2, p0, Lcom/thinkdesquared/banking/transfers/payments/jobs/IntrabankPaymentVerifyJob;->activity:Landroid/app/Activity;
    ...
    iget-object v4, p0, Lcom/thinkdesquared/banking/transfers/payments/jobs/IntrabankPaymentVerifyJob;->mWorkflowId:Ljava/lang/String;

    iget-object v5, p0, Lcom/thinkdesquared/banking/transfers/payments/jobs/IntrabankPaymentVerifyJob;->mTuchIdAuthorizationData:Lcom/thinkdesquared/banking/models/TouchIdAuthorizationData;

    invoke-virtual {v2, v3, v4, v0, v5}, Lcom/thinkdesquared/banking/requests/SOAPRequests;->intrabankPaymentVerifyRequest(Lcom/thinkdesquared/banking/models/PaymentData;Ljava/lang/String;Ljava/lang/String;Lcom/thinkdesquared/banking/models/TouchIdAuthorizationData;)Lcom/thinkdesquared/banking/models/response/PaymentVerifyResponse;
...
.method protected shouldReRunOnThrowable(Ljava/lang/Throwable;II)Lcom/path/android/jobqueue/RetryConstraint;
    ...
    .prologue
    .line 67
    iget-object v0, p0, Lcom/thinkdesquared/banking/transfers/payments/jobs/IntrabankPaymentVerifyJob;->TAG:Ljava/lang/String;
