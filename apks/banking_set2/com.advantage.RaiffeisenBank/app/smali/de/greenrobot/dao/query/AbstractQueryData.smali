...
.method forCurrentThread()Lde/greenrobot/dao/query/AbstractQuery;
    ...
    .end local v0    # "id":J
    :cond_2
    iget-object v6, p0, Lde/greenrobot/dao/query/AbstractQueryData;->queriesForThreads:Landroid/util/SparseArray;

    monitor-enter v6

    .line 43
    :try_start_0
    iget-object v5, p0, Lde/greenrobot/dao/query/AbstractQueryData;->queriesForThreads:Landroid/util/SparseArray;
    ...
    check-cast v5, Lde/greenrobot/dao/query/AbstractQuery;

    move-object v2, v5

    .line 45
    .local v2, "query":Lde/greenrobot/dao/query/AbstractQuery;, "TQ;"
    :goto_0
    if-nez v2, :cond_4
    ...
    .line 44
    .end local v2    # "query":Lde/greenrobot/dao/query/AbstractQuery;, "TQ;"
    :cond_3
    const/4 v2, 0x0
    ...
    .line 50
    .restart local v2    # "query":Lde/greenrobot/dao/query/AbstractQuery;, "TQ;"
    :cond_4
    iget-object v5, p0, Lde/greenrobot/dao/query/AbstractQueryData;->initialValues:[Ljava/lang/String;

    const/4 v7, 0x0

    iget-object v8, v2, Lde/greenrobot/dao/query/AbstractQuery;->parameters:[Ljava/lang/String;

    const/4 v9, 0x0

    iget-object v10, p0, Lde/greenrobot/dao/query/AbstractQueryData;->initialValues:[Ljava/lang/String;
