  ...
  extends View
{
  ...
  private int calculateColor(float paramFloat)
  {
    ...
    int i = COLORS[j];
    int n = COLORS[(j + 1)];
    j = ave(Color.alpha(i), Color.alpha(n), paramFloat);
    int k = ave(Color.red(i), Color.red(n), paramFloat);
    int m = ave(Color.green(i), Color.green(n), paramFloat);
    i = ave(Color.blue(i), Color.blue(n), paramFloat);
    this.mColor = Color.argb(j, k, m, i);
    return Color.argb(j, k, m, i);
  }
  ...
  private void init(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    paramAttributeSet = getContext().obtainStyledAttributes(paramAttributeSet, R.styleable.ColorWheelView, paramInt, 0);
    Resources localResources = getContext().getResources();
    this.mColorWheelEnabled = paramAttributeSet.getBoolean(R.styleable.ColorWheelView_color_wheel_enabled, true);
    this.mColorWheelThickness = paramAttributeSet.getDimensionPixelSize(R.styleable.ColorWheelView_color_wheel_thickness, localResources.getDimensionPixelSize(R.dimen.color_wheel_thickness));
    this.mColorWheelRadius = paramAttributeSet.getDimensionPixelSize(R.styleable.ColorWheelView_color_wheel_radius, localResources.getDimensionPixelSize(R.dimen.color_wheel_radius));
    this.mPreferredColorWheelRadius = this.mColorWheelRadius;
    this.mColorCenterRadius = paramAttributeSet.getDimensionPixelSize(R.styleable.ColorWheelView_color_center_radius, localResources.getDimensionPixelSize(R.dimen.color_center_radius));
    this.mPreferredColorCenterRadius = this.mColorCenterRadius;
    this.mColorCenterHaloRadius = paramAttributeSet.getDimensionPixelSize(R.styleable.ColorWheelView_color_center_halo_radius, localResources.getDimensionPixelSize(R.dimen.color_center_halo_radius));
    this.mPreferredColorCenterHaloRadius = this.mColorCenterHaloRadius;
    this.mColorPointerRadius = paramAttributeSet.getDimensionPixelSize(R.styleable.ColorWheelView_color_pointer_radius, localResources.getDimensionPixelSize(R.dimen.color_pointer_radius));
    this.mColorPointerHaloRadius = paramAttributeSet.getDimensionPixelSize(R.styleable.ColorWheelView_color_pointer_halo_radius, localResources.getDimensionPixelSize(R.dimen.color_pointer_halo_radius));
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      break label50;
      label296:
      paramInt1 = this.mColorCenterRadius * 2;
    }
  }
