...
public class BitmapTransformer
{
  ...
  public Builder loadTransformation(TRANSFORMATIONS paramTRANSFORMATIONS)
  {
    ...
    {
    default: 
      paramTRANSFORMATIONS = new DoNothingTransformation();
    }
    for (;;)
    {
      return new Builder(this.mContext, paramTRANSFORMATIONS);
      paramTRANSFORMATIONS = new CircularTransformation(getCacheInternal());
      continue;
      paramTRANSFORMATIONS = new PolygonTransformation(getCacheInternal());
      ((PolygonTransformation)paramTRANSFORMATIONS).setShapeResId(this.mContext, R.raw.polygon);
    }
  }
  ...
  public static class Builder
  {
    ...
    public void into(final ImageView paramImageView)
    {
      paramImageView.getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener()
      {
        ...
        {
          Object localObject = BitmapTransformer.Builder.this.transFormer.setViewWidth(paramImageView.getMeasuredWidth()).setViewHeight(paramImageView.getMeasuredHeight());
          if (BitmapTransformer.Builder.this.bitmap == null) {}
          for (localObject = ((ResourceTransformation)localObject).transform(BitmapTransformer.Builder.this.mContext, BitmapTransformer.Builder.this.drawableRes);; localObject = new BitmapDrawable(BitmapTransformer.Builder.this.mContext.getResources(), ((ResourceTransformation)localObject).transform(BitmapTransformer.Builder.this.bitmap, false)))
          {
