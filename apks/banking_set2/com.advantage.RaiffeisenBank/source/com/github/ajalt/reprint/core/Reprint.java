...
public class Reprint
{
  ...
  {
    ReprintInternal.INSTANCE.initialize(paramContext, null);
  }
  
  public static void initialize(Context paramContext, Logger paramLogger)
  {
    ReprintInternal.INSTANCE.initialize(paramContext, paramLogger);
  }
