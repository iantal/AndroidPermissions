  ...
  implements TransferToTimeFragment.TransferToTimeFragmentListener, VerifyInternationalPaymentFragment.PaymentsRedirectListener, VerifyInternationalPaymentFragment.PaymentsCancelRedirectListener, LoadingListener, DatePickerFragment.DatePickerFragmentListener
{
  ...
  protected void onActivityResult(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    do
    {
      do
      {
        ...
        this.mTransferToTimeFragment.onAmountChooserDismissedWithAmount(paramIntent);
        return;
      } while (paramInt1 != 4);
      localObject = paramIntent.getExtras();
    } while (localObject == null);
    paramIntent = (DSQBeneficiary)((Bundle)localObject).getSerializable("BENEFICIARY");
    Object localObject = (DSQPaymentsRedirectData)((Bundle)localObject).getSerializable("REDIRECT_DATA");
    this.mTransferToTimeFragment.onBenficiaryChooserDismissedWithBeneficiary(paramIntent, (DSQPaymentsRedirectData)localObject);
  }
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    if (paramBundle == null)
    {
      ...
      paramBundle.replace(2131558652, this.mTransferToTimeFragment, str);
      paramBundle.commit();
      return;
    }
  ...
  public void openVerifyFragment(final TransferToTimeAccountData paramTransferToTimeAccountData, String paramString)
  {
    if (paramTransferToTimeAccountData.toAccountFilterValue.getName().equals("0243"))
    {
      paramTransferToTimeAccountData = TransferToTimeOtherAccountVerifyFragment.newInstance(paramTransferToTimeAccountData, paramString);
      new Handler().postDelayed(new Runnable()
      {
        public void run()
        {
          ...
          localFragmentTransaction.replace(2131558652, paramTransferToTimeAccountData);
    ...
    paramTransferToTimeAccountData = TransferToTimeOwnAccountVerifyFragment.newInstance(paramTransferToTimeAccountData, paramString);
    new Handler().postDelayed(new Runnable()
    {
      public void run()
      {
