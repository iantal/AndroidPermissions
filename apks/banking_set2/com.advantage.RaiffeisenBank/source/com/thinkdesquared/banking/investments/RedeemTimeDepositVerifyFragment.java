    ...
    extends AsyncTask<String, Void, RedeemTimeDepositResultResponse>
  {
    ...
    protected RedeemTimeDepositResultResponse doInBackground(String... paramVarArgs)
    {
      if (AibasStore.getInstance().getLoggedInState() == AibasStore.LoggedInState.LoggedInState_ON)
      {
        ...
        return new SOAPRequests().redeemTimeDepositResultRequest(paramVarArgs);
      }
    ...
    protected void onPostExecute(RedeemTimeDepositResultResponse paramRedeemTimeDepositResultResponse)
    {
      ...
      if (paramRedeemTimeDepositResultResponse.resultCode.equals("S"))
      {
        ...
        str1 = str2;
        if (!DSQHelper.isEmptyOrBlankString(paramRedeemTimeDepositResultResponse.retentionOffer).booleanValue())
        {
          str1 = str2;
          if (!DSQHelper.isEmptyOrBlankString(paramRedeemTimeDepositResultResponse.retentionOfferName).booleanValue())
          {
            str1 = str2 + " " + RedeemTimeDepositVerifyFragment.this.getString(2131165933) + " \"" + paramRedeemTimeDepositResultResponse.retentionOfferName + "\" " + RedeemTimeDepositVerifyFragment.this.getString(2131166046);
