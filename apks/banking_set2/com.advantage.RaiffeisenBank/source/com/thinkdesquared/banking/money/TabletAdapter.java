  ...
  implements ViewPager.OnPageChangeListener, ActionBar.TabListener, TabHost.OnTabChangeListener
{
  ...
  public void addTab(Fragment paramFragment, String paramString1, String paramString2, Class paramClass, Bundle paramBundle)
  {
    ...
    paramFragment = LayoutInflater.from(this.mContext).inflate(2130903427, null);
    ((TextView)paramFragment.findViewById(2131558817)).setText(paramString2.toUpperCase());
    paramFragment = this.mTabHost.newTabSpec(paramString2).setIndicator(paramFragment).setContent(new DummyTabFactory(this.mContext));
    paramString1 = new TabInfo(paramString2, paramBundle);
    this.mTabs.add(paramString1);
    this.mTabHost.addTab(paramFragment);
