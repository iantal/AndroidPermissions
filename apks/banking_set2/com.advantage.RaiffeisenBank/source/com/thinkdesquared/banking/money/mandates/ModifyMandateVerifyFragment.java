...
import com.thinkdesquared.banking.money.mandates.jobs.ModifyMandateResultJob;
import com.thinkdesquared.banking.money.mandates.jobs.ModifyMandateVerifyJob;
...
@FragmentWithArgs
public class ModifyMandateVerifyFragment
  extends VerifyFragment
{
  private ModifyMandateVerifyResponse mVerifyResponse;
  @Arg
  MandateData passedData;
  
  public ModifyMandateVerifyFragment() {}
  ...
  private void initWithVerifyResponse()
  {
    ...
    localArrayList2.add(getString(2131166099));
  ...
  public void executeResultTask()
  {
    ...
    SmartMobileApplication.getDefaultJobManager().addJob(new ModifyMandateResultJob(getSessionIdForJob(), this.workflowId, getAuthorizationElements()));
  }
  ...
  public void onEvent(ModifyMandateResultResponseEvent paramModifyMandateResultResponseEvent)
  {
    this.mProgressDialog.dismiss();
    LogHelper.d("VerifyFragment", "ModifyMandate Result Received");
    paramModifyMandateResultResponseEvent = paramModifyMandateResultResponseEvent.getResponse();
    if ("S".equalsIgnoreCase(paramModifyMandateResultResponseEvent.resultCode))
    {
      EventBus.getDefault().unregister(this);
      this.mListener.onReceivedSuccessfullResultResponse(getString(2131165725), true, paramModifyMandateResultResponseEvent, 2131166267);
      return;
    }
    if ((paramModifyMandateResultResponseEvent.resultCode.equals("AUTH_ERROR")) || (paramModifyMandateResultResponseEvent.resultCode.equals("CLIENT_ERROR")))
    {
      DSQHelper.showErrorDialog(getActivity(), paramModifyMandateResultResponseEvent, false, true);
      return;
    }
    String str = paramModifyMandateResultResponseEvent.getErrors();
    this.mListener.onReceivedSuccessfullResultResponse(str, true, paramModifyMandateResultResponseEvent, 2131166267);
  }
  
  @Subscribe(threadMode=ThreadMode.MAIN)
  public void onEvent(ModifyMandateVerifyResponseEvent paramModifyMandateVerifyResponseEvent)
  {
    this.mVerifyResponse = paramModifyMandateVerifyResponseEvent.getResponse();
    initWithVerifyResponse();
  }
  ...
  protected void restartLoading()
  {
    ...
    showLoading();
    SmartMobileApplication.getDefaultJobManager().addJob(new ModifyMandateVerifyJob(getSessionIdForJob(), this.workflowId, this.passedData));
  }
