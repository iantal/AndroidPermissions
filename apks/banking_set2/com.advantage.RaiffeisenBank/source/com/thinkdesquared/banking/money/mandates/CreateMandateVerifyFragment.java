  ...
  extends VerifyFragment
{
  ...
  public void onEvent(CreateMandateResultResponseEvent paramCreateMandateResultResponseEvent)
  {
    ...
    paramCreateMandateResultResponseEvent = paramCreateMandateResultResponseEvent.getResponse();
    if ("S".equalsIgnoreCase(paramCreateMandateResultResponseEvent.resultCode))
    {
      EventBus.getDefault().unregister(this);
      this.mListener.onReceivedSuccessfullResultResponse(getString(2131165414), true, paramCreateMandateResultResponseEvent, 2131166267);
      return;
    }
    if ((paramCreateMandateResultResponseEvent.resultCode.equals("AUTH_ERROR")) || (paramCreateMandateResultResponseEvent.resultCode.equals("CLIENT_ERROR")))
    {
      DSQHelper.showErrorDialog(getActivity(), paramCreateMandateResultResponseEvent, false, true);
      return;
    }
    String str = paramCreateMandateResultResponseEvent.getErrors();
    this.mListener.onReceivedSuccessfullResultResponse(str, true, paramCreateMandateResultResponseEvent, 2131166267);
  }
