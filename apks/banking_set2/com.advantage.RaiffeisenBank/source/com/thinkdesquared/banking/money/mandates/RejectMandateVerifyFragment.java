  ...
  extends VerifyFragment
{
  ...
  public void onEvent(RejectMandateResultResponseEvent paramRejectMandateResultResponseEvent)
  {
    ...
    paramRejectMandateResultResponseEvent = paramRejectMandateResultResponseEvent.getResponse();
    if ("S".equalsIgnoreCase(paramRejectMandateResultResponseEvent.resultCode))
    {
      EventBus.getDefault().unregister(this);
      this.mListener.onReceivedSuccessfullResultResponse(getString(2131165939), true, paramRejectMandateResultResponseEvent, 2131166267);
      return;
    }
    if ((paramRejectMandateResultResponseEvent.resultCode.equals("AUTH_ERROR")) || (paramRejectMandateResultResponseEvent.resultCode.equals("CLIENT_ERROR")))
    {
      DSQHelper.showErrorDialog(getActivity(), paramRejectMandateResultResponseEvent, false, true);
      return;
    }
    String str = paramRejectMandateResultResponseEvent.getErrors();
    this.mListener.onReceivedSuccessfullResultResponse(str, true, paramRejectMandateResultResponseEvent, 2131166267);
  }
