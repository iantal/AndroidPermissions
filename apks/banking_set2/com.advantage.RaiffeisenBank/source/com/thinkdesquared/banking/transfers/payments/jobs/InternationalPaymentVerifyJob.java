...
public class InternationalPaymentVerifyJob
  extends SessionBoundJob
{
  ...
  public InternationalPaymentVerifyJob(String paramString1, String paramString2, PaymentData paramPaymentData, Activity paramActivity)
  {
    ...
    throws Throwable
  {
    ...
    for (Object localObject = new DemoRequests().paymentVerifyDemoRequest(this.mPaymentData);; localObject = new SOAPRequests().internationalPaymentVerifyRequest(this.mPaymentData, this.mWorkflowId, (String)localObject, DSQHelper.getTouchIdAuthorizationData(getApplicationContext())))
    {
      assertNotCancelled();
