  ...
  extends PaymentsActivity
{
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    String str = getString(2131166258);
    if (paramBundle == null)
    {
      ...
      paramBundle.replace(2131558652, this.mDomesticPaymentFragment, str);
      paramBundle.commit();
    }
    for (;;)
    {
      ...
      if (paramBundle != null) {
        this.mDomesticPaymentFragment.setTemplateToOpen(paramBundle);
      }
      paramBundle = (DSQPaymentsRedirectData)getIntent().getParcelableExtra("REDIRECT_DATA");
      getIntent().removeExtra("REDIRECT_DATA");
      if (paramBundle != null) {
        this.mDomesticPaymentFragment.setRedirectData(paramBundle);
      }
      return;
      this.mDomesticPaymentFragment = ((DomesticPaymentFragment)getSupportFragmentManager().findFragmentByTag(str));
    }
  }
