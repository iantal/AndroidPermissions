  ...
  implements DSQInputFragment.TemplatesFragmentListener, ManageWidgetFragment.ManageWidgetListener, ManageWidgetVerifyFragment.ManageWidgetVerifyListener, ManageWidgetNotAvailableFragment.ManageWidgetNotAvailableListener, LoaderManager.LoaderCallbacks<ManageDirectDevicesServiceResponse>
{
  ...
  private void doOnSuccess(ManageDirectDevicesServiceResponse paramManageDirectDevicesServiceResponse)
  {
    ...
    {
      paramManageDirectDevicesServiceResponse = findCurrentDevice(paramManageDirectDevicesServiceResponse.devices);
      if (paramManageDirectDevicesServiceResponse != null) {
        AibasStore.getInstance().setRememberMeLogin(DeviceRegistrationHelper.getByEnrollmentId(paramManageDirectDevicesServiceResponse.enrolmentId, false));
      }
    }
    if (AibasStore.getInstance().getRememberMeLogin() == null)
    {
      ...
      paramManageDirectDevicesServiceResponse = getSupportFragmentManager().beginTransaction();
      paramManageDirectDevicesServiceResponse.replace(2131558652, this.mManageWidgetNotAvailableFragment, str);
      paramManageDirectDevicesServiceResponse.commitAllowingStateLoss();
      return;
    }
    paramManageDirectDevicesServiceResponse = getSupportFragmentManager().beginTransaction();
    paramManageDirectDevicesServiceResponse.replace(2131558652, new ManageWidgetFragment(), str);
    paramManageDirectDevicesServiceResponse.commitAllowingStateLoss();
  }
  ...
  private ManageDirectDevicesDevice findCurrentDevice(List<ManageDirectDevicesDevice> paramList)
  {
    ...
    {
      ManageDirectDevicesDevice localManageDirectDevicesDevice = (ManageDirectDevicesDevice)paramList.next();
  ...
  private ManageDirectDevicesDevice findDeviceByEnrollmentId(String paramString, ManageDirectDevicesServiceResponse paramManageDirectDevicesServiceResponse)
  {
    ...
    paramManageDirectDevicesServiceResponse = paramManageDirectDevicesServiceResponse.devices.iterator();
    while (paramManageDirectDevicesServiceResponse.hasNext())
    {
      ManageDirectDevicesDevice localManageDirectDevicesDevice = (ManageDirectDevicesDevice)paramManageDirectDevicesServiceResponse.next();
  ...
  private void findLocalDevices(ManageDirectDevicesServiceResponse paramManageDirectDevicesServiceResponse)
  {
    ...
    for (;;)
    {
      ...
      {
        ManageDirectDevicesDevice localManageDirectDevicesDevice = findDeviceByEnrollmentId(((DeviceRegistrationData)((Iterator)localObject).next()).getEnrollmentId(), paramManageDirectDevicesServiceResponse);
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    if (paramBundle == null) {
      if (AibasStore.getInstance().getLoggedInState() == AibasStore.LoggedInState.LoggedInState_DEMO)
      {
        ...
        paramBundle = this.mManageWidgetFragment;
        if (paramBundle != null)
        {
          FragmentTransaction localFragmentTransaction = getSupportFragmentManager().beginTransaction();
          localFragmentTransaction.replace(2131558652, paramBundle, str);
          localFragmentTransaction.commit();
        }
      }
    }
    for (;;)
    {
      ...
      for (paramBundle = this.mManageWidgetNotAvailableFragment;; paramBundle = this.mManageWidgetFragment)
      {
      ...
      if ((paramBundle.findFragmentByTag(str) instanceof ManageWidgetFragment)) {
        this.mManageWidgetFragment = ((ManageWidgetFragment)paramBundle.findFragmentByTag(str));
      } else if ((paramBundle.findFragmentByTag(str) instanceof ManageWidgetNotAvailableFragment)) {
        this.mManageWidgetNotAvailableFragment = ((ManageWidgetNotAvailableFragment)paramBundle.findFragmentByTag(str));
      } else if ((paramBundle.findFragmentByTag(str) instanceof ManageWidgetNoRememberMeLoginFragment)) {
        this.mManageWidgetNoRememberMeLoginFragment = ((ManageWidgetNoRememberMeLoginFragment)paramBundle.findFragmentByTag(str));
      }
    }
  }
  ...
  public void onSubmit(String paramString1, String paramString2, WidgetConfiguration paramWidgetConfiguration, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    if (this.startForSelectWidgetConfiguration)
    {
      ...
      paramString1 = new Intent(this, HomeActivity.class);
      paramString1.putExtras(getIntent());
      paramString1.putExtra("INTENT_FINISH_APP", true);
      paramString1.putExtra("INTENT_SELECT_DATA", paramWidgetConfiguration);
      paramString1.setFlags(335577088);
  ...
  public void onSuccess(ManageWidgetsResultServiceResponse paramManageWidgetsResultServiceResponse, DeviceRegistrationData paramDeviceRegistrationData, WidgetConfiguration paramWidgetConfiguration)
  {
    ...
    for (;;)
    {
      ...
      if (this.startForManageWidgetConfiguration)
      {
        ...
        paramManageWidgetsResultServiceResponse = new Intent(getApplication(), RZBAppWidgetConfigurationActivity.class);
        paramManageWidgetsResultServiceResponse.putExtra("INTENT_CHECK_AUTHORIZED_CONTENT", false);
        paramManageWidgetsResultServiceResponse.putExtra("appWidgetId", i);
        paramManageWidgetsResultServiceResponse.putExtra("INTENT_AUTHORIZED_COMPLETE", true);
        overridePendingTransition(2130968594, 2130968595);
        startActivity(paramManageWidgetsResultServiceResponse);
        finish();
      }
      return;
      label193:
