...
public class WidgetShowMessageAndStatesHelper
{
  ...
  public static void showUserNameIfExists(int paramInt, RemoteViews paramRemoteViews)
  {
    ...
    if (localObject != null)
    {
      ...
      if (((DeviceRegistrationData)localObject).getCustomerType() == AibasStore.CustomerType.CustomerTypeRetail)
      {
        paramRemoteViews.setTextViewText(2131558853, ((DeviceRegistrationData)localObject).getFirstName());
    ...
    paramRemoteViews.setTextViewText(2131558853, ((DeviceRegistrationData)localObject).getBusinessName() + " - " + ((DeviceRegistrationData)localObject).getFirstName() + " " + ((DeviceRegistrationData)localObject).getLastName());
    paramRemoteViews.setViewVisibility(2131559594, 8);
    return;
    label114:
