    ...
    extends BaseAdapter
  {
    ...
    public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
    {
      ...
      for (;;)
      {
        ...
        {
          paramViewGroup.signTextView.setText(localCurrencyModel.toString());
          paramViewGroup.nameTextView.setText(localCurrencyModel.getName(ChooseAmount_CurrencyFragment.this.getActivity()));
        }
        if (ChooseAmount_CurrencyFragment.this.mSelectedRow != paramInt) {
          break;
        }
        CalligraphyUtils.applyFontToTextView(ChooseAmount_CurrencyFragment.this.getActivity(), paramViewGroup.signTextView, ChooseAmount_CurrencyFragment.this.getString(DSQStylist.fetchThemedResourceId(ChooseAmount_CurrencyFragment.this.getActivity(), 2130772025)));
        CalligraphyUtils.applyFontToTextView(ChooseAmount_CurrencyFragment.this.getActivity(), paramViewGroup.nameTextView, ChooseAmount_CurrencyFragment.this.getString(DSQStylist.fetchThemedResourceId(ChooseAmount_CurrencyFragment.this.getActivity(), 2130772025)));
        return paramView;
        paramViewGroup = (ViewHolder)paramView.getTag();
      }
      CalligraphyUtils.applyFontToTextView(ChooseAmount_CurrencyFragment.this.getActivity(), paramViewGroup.signTextView, ChooseAmount_CurrencyFragment.this.getString(DSQStylist.fetchThemedResourceId(ChooseAmount_CurrencyFragment.this.getActivity(), 2130772027)));
      CalligraphyUtils.applyFontToTextView(ChooseAmount_CurrencyFragment.this.getActivity(), paramViewGroup.nameTextView, ChooseAmount_CurrencyFragment.this.getString(DSQStylist.fetchThemedResourceId(ChooseAmount_CurrencyFragment.this.getActivity(), 2130772027)));
      return paramView;
    }
