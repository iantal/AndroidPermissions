...
public class Utils
{
  ...
  public static void cropBitmapDrawableRes(Context paramContext, @DrawableRes int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, View paramView)
  {
    ...
    {
      Glide.with(paramContext).load(Integer.valueOf(paramInt1)).placeholder(localDrawable).bitmapTransform(new Transformation[] { new RegionCropTransformation(paramContext, paramInt2, paramInt3, paramInt4, paramInt5, paramInt6) }).dontAnimate().into(new SimpleTarget()
      {
  ...
  public static Drawable darkenDrawable(Drawable paramDrawable)
  {
    ...
    paramDrawable.setColorFilter(DARK_OVERLAY_COLOR, PorterDuff.Mode.SRC_ATOP);
