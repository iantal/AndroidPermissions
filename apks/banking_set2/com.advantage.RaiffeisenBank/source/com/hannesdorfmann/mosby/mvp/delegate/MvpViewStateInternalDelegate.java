  ...
  extends MvpInternalDelegate<V, P>
{
  ...
  public boolean createOrRestoreViewState(Bundle paramBundle)
  {
    ...
    {
      paramBundle = ((RestorableViewState)localBaseMvpViewStateDelegateCallback.getViewState()).restoreInstanceState(paramBundle);
      if (paramBundle != null) {}
      for (int i = 1; i != 0; i = 0)
      {
        localBaseMvpViewStateDelegateCallback.setViewState(paramBundle);
        this.applyViewState = true;
        return true;
      }
    }
