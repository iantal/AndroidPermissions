  ...
  implements ActivityMvpDelegate
{
  ...
  {
    paramBundle = (ActivityMvpNonConfigurationInstances)this.delegateCallback.getLastCustomNonConfigurationInstance();
    if ((paramBundle != null) && (paramBundle.presenter != null)) {
      this.delegateCallback.setPresenter(paramBundle.presenter);
    }
    for (;;)
    {
