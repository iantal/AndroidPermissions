...
public final class zzaob
{
  ...
  private static void zza(Object paramObject, zzapy paramZzapy)
  {
    if (paramObject != null) {
      ...
      {
        throw new zzaoq(paramObject);
      }
      catch (IOException paramObject)
      {
        throw new zzaoi(paramObject);
      }
    }
  }
    ...
    throws zzaoq
  {
    ...
    return zzaph.zzp(paramClass).cast(paramZzaoh);
  }
    ...
    throws zzaoq
  {
    ...
    return zza(new zzapo(paramZzaoh), paramType);
  }
    ...
    throws zzaoq
  {
    ...
    return zzaph.zzp(paramClass).cast(paramString);
  }
