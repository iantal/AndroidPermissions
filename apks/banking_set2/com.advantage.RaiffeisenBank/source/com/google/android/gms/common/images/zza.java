...
public abstract class zza
{
    ...
    extends zza
  {
    ...
    public boolean equals(Object paramObject)
    {
      ...
      ImageManager.OnImageLoadedListener localOnImageLoadedListener2 = (ImageManager.OnImageLoadedListener)paramObject.AB.get();
      if ((localOnImageLoadedListener2 != null) && (localOnImageLoadedListener1 != null) && (zzab.equal(localOnImageLoadedListener2, localOnImageLoadedListener1)) && (zzab.equal(paramObject.At, this.At))) {}
      for (boolean bool = true;; bool = false) {
        return bool;
      }
    }
