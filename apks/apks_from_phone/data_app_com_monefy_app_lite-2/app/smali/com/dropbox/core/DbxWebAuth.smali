...
.method private static appendCsrfToken(Lcom/dropbox/core/DbxWebAuth$Request;)Ljava/lang/String;
    ...
    const-string v3, "unexpected CSRF token length: "
    ...
    const-string v3, "unexpected combined state length: "
...
.method private static getParam(Ljava/util/Map;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v2, "multiple occurrences of \""
...
.method private static verifyAndStripCsrfToken(Ljava/lang/String;Lcom/dropbox/core/DbxSessionStore;)Ljava/lang/String;
    ...
    const-string v1, "No CSRF Token loaded from session store."
    ...
    const-string v3, "Token retrieved from session store is too small: "
    ...
    const-string v2, "Token too small: "
...
.method public finishFromRedirect(Ljava/lang/String;Lcom/dropbox/core/DbxSessionStore;Ljava/util/Map;)Lcom/dropbox/core/DbxAuthFinish;
    ...
    const-string v1, "Missing required parameter: \"state\"."
    ...
    const-string v1, "Missing both \"code\" and \"error\"."
    ...
    const-string v1, "Both \"code\" and \"error\" are set."
    ...
    const-string v1, "Both \"code\" and \"error_description\" are set."
    ...
    const-string v0, "No additional description from Dropbox"
    ...
    const-string v1, "Additional description from Dropbox: "
