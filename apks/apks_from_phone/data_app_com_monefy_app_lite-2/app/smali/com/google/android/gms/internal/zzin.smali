...
.method static synthetic a(Landroid/content/Context;)Landroid/content/SharedPreferences;
    ...
    invoke-static {p0}, Lcom/google/android/gms/internal/zzin;->b(Landroid/content/Context;)Landroid/content/SharedPreferences;
...
.method public static a(Landroid/content/Context;I)Ljava/util/concurrent/Future;
    ...
    invoke-virtual {v0}, Lcom/google/android/gms/internal/zzin$3;->g()Ljava/util/concurrent/Future;
...
.method public static a(Landroid/content/Context;Lcom/google/android/gms/internal/zzin$zzb;)Ljava/util/concurrent/Future;
    .locals 1
    ...
    invoke-virtual {v0}, Lcom/google/android/gms/internal/zzin$2;->g()Ljava/util/concurrent/Future;
...
.method public static a(Landroid/content/Context;Z)Ljava/util/concurrent/Future;
    ...
    invoke-virtual {v0}, Lcom/google/android/gms/internal/zzin$1;->g()Ljava/util/concurrent/Future;
...
.method public static b(Landroid/content/Context;Lcom/google/android/gms/internal/zzin$zzb;)Ljava/util/concurrent/Future;
    .locals 1
    ...
    invoke-virtual {v0}, Lcom/google/android/gms/internal/zzin$4;->g()Ljava/util/concurrent/Future;
...
.method public static b(Landroid/content/Context;Z)Ljava/util/concurrent/Future;
    ...
    invoke-virtual {v0}, Lcom/google/android/gms/internal/zzin$5;->g()Ljava/util/concurrent/Future;
...
.method public static c(Landroid/content/Context;Lcom/google/android/gms/internal/zzin$zzb;)Ljava/util/concurrent/Future;
    .locals 1
    ...
    invoke-virtual {v0}, Lcom/google/android/gms/internal/zzin$6;->g()Ljava/util/concurrent/Future;
