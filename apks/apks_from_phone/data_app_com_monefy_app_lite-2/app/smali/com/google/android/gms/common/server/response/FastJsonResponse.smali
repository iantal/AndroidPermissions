...
.method private zza(Ljava/lang/StringBuilder;Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;Ljava/lang/Object;)V
    ...
    invoke-virtual {p2}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->zzrd()Ljava/lang/Class;
    ...
    invoke-static {p3}, Lcom/google/android/gms/internal/zznu;->a(Ljava/lang/String;)Ljava/lang/String;
...
.method public toString()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/common/server/response/FastJsonResponse;->zzqV()Ljava/util/Map;
    ...
    :cond_2
    invoke-virtual {v1}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->zzqU()I

    move-result v0

    packed-switch v0, :pswitch_data_0

    invoke-virtual {v1}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->zzqZ()Z
    ...
    invoke-static {v2}, Lcom/google/android/gms/internal/zzni;->b([B)Ljava/lang/String;
    ...
    invoke-static {v4, v2}, Lcom/google/android/gms/internal/zznv;->a(Ljava/lang/StringBuilder;Ljava/util/HashMap;)V
...
.method protected zza(Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;)Z
    ...
    invoke-virtual {p1}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->zzqU()I
    ...
    invoke-virtual {p1}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->zzra()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {p1}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->zzrb()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {p0, v0}, Lcom/google/android/gms/common/server/response/FastJsonResponse;->zzcK(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, v0}, Lcom/google/android/gms/common/server/response/FastJsonResponse;->zzcJ(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, v0}, Lcom/google/android/gms/common/server/response/FastJsonResponse;->zzcI(Ljava/lang/String;)Z
...
.method protected zzb(Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;)Ljava/lang/Object;
    ...
    invoke-virtual {p1}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->zzrd()Ljava/lang/Class;
    ...
    invoke-virtual {p0, v0}, Lcom/google/android/gms/common/server/response/FastJsonResponse;->zzcH(Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-static {v0, v4, v1}, Lcom/google/android/gms/common/internal/zzx;->a(ZLjava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/common/server/response/FastJsonResponse;->zzqX()Ljava/util/HashMap;
    ...
    :cond_1
    invoke-virtual {p0}, Lcom/google/android/gms/common/server/response/FastJsonResponse;->zzqW()Ljava/util/HashMap;
