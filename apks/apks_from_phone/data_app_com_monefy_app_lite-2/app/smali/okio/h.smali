...
# direct methods
.method constructor <init>(Lokio/c;Ljava/util/zip/Inflater;)V
    .locals 2
    ...
    .line 51
    :cond_1
    iput-object p1, p0, Lokio/h;->a:Lokio/c;

    .line 52
    iput-object p2, p0, Lokio/h;->b:Ljava/util/zip/Inflater;
...
.method public constructor <init>(Lokio/o;Ljava/util/zip/Inflater;)V
    ...
    invoke-direct {p0, v0, p2}, Lokio/h;-><init>(Lokio/c;Ljava/util/zip/Inflater;)V
...
.method private c()V
    ...
    iget-object v1, p0, Lokio/h;->b:Ljava/util/zip/Inflater;
...
.method public a(Lokio/Buffer;J)J
    ...
    .line 58
    :cond_0
    iget-boolean v2, p0, Lokio/h;->d:Z
    ...
    :try_start_0
    invoke-virtual {p1, v1}, Lokio/Buffer;->e(I)Lokio/l;

    move-result-object v1

    .line 67
    iget-object v2, p0, Lokio/h;->b:Ljava/util/zip/Inflater;

    iget-object v3, v1, Lokio/l;->a:[B

    iget v4, v1, Lokio/l;->c:I

    iget v5, v1, Lokio/l;->c:I
...
.method public b()Z
    ...
    invoke-interface {v1}, Lokio/c;->f()Z
    ...
    invoke-interface {v1}, Lokio/c;->c()Lokio/Buffer;

    move-result-object v1

    iget-object v1, v1, Lokio/Buffer;->a:Lokio/l;
...
.method public close()V
    ...
    .line 124
    :cond_0
    iget-object v0, p0, Lokio/h;->b:Ljava/util/zip/Inflater;
    ...
    iput-boolean v0, p0, Lokio/h;->d:Z
