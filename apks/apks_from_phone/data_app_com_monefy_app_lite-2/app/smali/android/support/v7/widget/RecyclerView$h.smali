...
# instance fields
.field private final a:Landroid/support/v7/widget/bh$b;

.field private final b:Landroid/support/v7/widget/bh$b;
...
.field r:Landroid/support/v7/widget/bh;

.field s:Landroid/support/v7/widget/bh;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView$h;->a:Landroid/support/v7/widget/bh$b;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView$h;->b:Landroid/support/v7/widget/bh$b;

    .line 6965
    new-instance v0, Landroid/support/v7/widget/bh;

    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView$h;->a:Landroid/support/v7/widget/bh$b;

    invoke-direct {v0, v1}, Landroid/support/v7/widget/bh;-><init>(Landroid/support/v7/widget/bh$b;)V

    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView$h;->r:Landroid/support/v7/widget/bh;

    .line 6966
    new-instance v0, Landroid/support/v7/widget/bh;

    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView$h;->b:Landroid/support/v7/widget/bh$b;

    invoke-direct {v0, v1}, Landroid/support/v7/widget/bh;-><init>(Landroid/support/v7/widget/bh$b;)V

    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView$h;->s:Landroid/support/v7/widget/bh;
...
.method private a(Landroid/support/v7/widget/RecyclerView$o;ILandroid/view/View;)V
    ...
    iget-object v1, v1, Landroid/support/v7/widget/RecyclerView;->g:Landroid/support/v7/widget/bi;

    invoke-virtual {v1, v0}, Landroid/support/v7/widget/bi;->h(Landroid/support/v7/widget/RecyclerView$v;)V
...
.method private a(Landroid/view/View;IZ)V
    ...
    iget-object v0, v0, Landroid/support/v7/widget/RecyclerView;->g:Landroid/support/v7/widget/bi;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/bi;->f(Landroid/support/v7/widget/RecyclerView$v;)V
...
.method public E()I
    ...
    invoke-static {v0}, Landroid/support/v4/view/ai;->p(Landroid/view/View;)I
...
.method a(Landroid/support/v4/view/a/e;)V
    ...
    invoke-virtual {p0, v0, v1, p1}, Landroid/support/v7/widget/RecyclerView$h;->a(Landroid/support/v7/widget/RecyclerView$o;Landroid/support/v7/widget/RecyclerView$s;Landroid/support/v4/view/a/e;)V
...
.method public a(Landroid/support/v7/widget/RecyclerView$o;Landroid/support/v7/widget/RecyclerView$s;Landroid/support/v4/view/a/e;)V
    .locals 4
...
.method public a(Landroid/view/View;ILandroid/support/v7/widget/RecyclerView$i;)V
    ...
    invoke-virtual {v1, v0}, Landroid/support/v7/widget/bi;->e(Landroid/support/v7/widget/RecyclerView$v;)V
    ...
    invoke-virtual {v1, v0}, Landroid/support/v7/widget/bi;->f(Landroid/support/v7/widget/RecyclerView$v;)V
...
.method a(Landroid/view/View;Landroid/support/v4/view/a/e;)V
    ...
    invoke-virtual {p0, v0, v1, p1, p2}, Landroid/support/v7/widget/RecyclerView$h;->a(Landroid/support/v7/widget/RecyclerView$o;Landroid/support/v7/widget/RecyclerView$s;Landroid/view/View;Landroid/support/v4/view/a/e;)V
...
.method public a(Landroid/view/View;ZLandroid/graphics/Rect;)V
    ...
    .line 8865
    invoke-static {p1}, Landroid/support/v4/view/ai;->o(Landroid/view/View;)Landroid/graphics/Matrix;
...
.method public a(Landroid/view/View;ZZ)Z
    ...
    .line 9199
    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView$h;->r:Landroid/support/v7/widget/bh;

    invoke-virtual {v3, p1, v2}, Landroid/support/v7/widget/bh;->a(Landroid/view/View;I)Z

    move-result v3

    if-eqz v3, :cond_1

    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView$h;->s:Landroid/support/v7/widget/bh;
