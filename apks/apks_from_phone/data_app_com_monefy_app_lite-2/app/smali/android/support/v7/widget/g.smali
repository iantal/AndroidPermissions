...
.method private b(Landroid/graphics/drawable/Drawable;)Z
    ...
    .line 172
    iget-object v1, p0, Landroid/support/v7/widget/g;->f:Landroid/support/v7/widget/bc;
    ...
    invoke-direct {v1}, Landroid/support/v7/widget/bc;-><init>()V

    iput-object v1, p0, Landroid/support/v7/widget/g;->f:Landroid/support/v7/widget/bc;
    ...
    .line 176
    invoke-virtual {v1}, Landroid/support/v7/widget/bc;->a()V

    .line 178
    iget-object v2, p0, Landroid/support/v7/widget/g;->a:Landroid/view/View;

    invoke-static {v2}, Landroid/support/v4/view/ai;->A(Landroid/view/View;)Landroid/content/res/ColorStateList;
    ...
    .line 180
    iput-boolean v0, v1, Landroid/support/v7/widget/bc;->d:Z

    .line 181
    iput-object v2, v1, Landroid/support/v7/widget/bc;->a:Landroid/content/res/ColorStateList;

    .line 183
    :cond_1
    iget-object v2, p0, Landroid/support/v7/widget/g;->a:Landroid/view/View;

    invoke-static {v2}, Landroid/support/v4/view/ai;->B(Landroid/view/View;)Landroid/graphics/PorterDuff$Mode;
    ...
    .line 185
    iput-boolean v0, v1, Landroid/support/v7/widget/bc;->c:Z

    .line 186
    iput-object v2, v1, Landroid/support/v7/widget/bc;->b:Landroid/graphics/PorterDuff$Mode;

    .line 189
    :cond_2
    iget-boolean v2, v1, Landroid/support/v7/widget/bc;->d:Z

    if-nez v2, :cond_3

    iget-boolean v2, v1, Landroid/support/v7/widget/bc;->c:Z
    ...
    invoke-static {p1, v1, v2}, Landroid/support/v7/widget/l;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/bc;[I)V
...
.method private d()Z
    ...
    .line 162
    iget-object v2, p0, Landroid/support/v7/widget/g;->d:Landroid/support/v7/widget/bc;
...
.method a()Landroid/content/res/ColorStateList;
    ...
    .prologue
    .line 99
    iget-object v0, p0, Landroid/support/v7/widget/g;->e:Landroid/support/v7/widget/bc;
...
.method a(Landroid/content/res/ColorStateList;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/g;->e:Landroid/support/v7/widget/bc;
    ...
    iput-boolean v1, v0, Landroid/support/v7/widget/bc;->d:Z
...
.method a(Landroid/graphics/PorterDuff$Mode;)V
    ...
    iput-boolean v1, v0, Landroid/support/v7/widget/bc;->c:Z
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    invoke-virtual {v1, v0, v2}, Landroid/support/v7/widget/be;->g(II)I
    ...
    .line 60
    invoke-virtual {v1, v2}, Landroid/support/v7/widget/be;->e(I)Landroid/content/res/ColorStateList;
    ...
    .line 65
    invoke-virtual {v1, v2, v3}, Landroid/support/v7/widget/be;->a(II)I
...
.method b(Landroid/content/res/ColorStateList;)V
    ...
    .line 138
    iget-object v0, p0, Landroid/support/v7/widget/g;->d:Landroid/support/v7/widget/bc;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/g;->d:Landroid/support/v7/widget/bc;
...
.method c()V
    ...
    .line 126
    :cond_1
    iget-object v1, p0, Landroid/support/v7/widget/g;->e:Landroid/support/v7/widget/bc;
    ...
    .line 127
    invoke-static {v0, v1, v2}, Landroid/support/v7/widget/l;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/bc;[I)V

    goto :goto_0

    .line 129
    :cond_2
    iget-object v1, p0, Landroid/support/v7/widget/g;->d:Landroid/support/v7/widget/bc;
