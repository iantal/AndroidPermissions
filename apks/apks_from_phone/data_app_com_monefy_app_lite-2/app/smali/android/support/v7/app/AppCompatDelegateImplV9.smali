...
.field q:Landroid/support/v4/view/ba;
...
.method constructor <init>(Landroid/content/Context;Landroid/view/Window;Landroid/support/v7/app/f;)V
    ...
    iput-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV9;->q:Landroid/support/v4/view/ba;
...
.method private a(Landroid/support/v7/view/menu/h;Z)V
    ...
    .line 1210
    iget-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV9;->u:Landroid/support/v7/widget/ac;
    ...
    .line 1216
    iget-object v1, p0, Landroid/support/v7/app/AppCompatDelegateImplV9;->u:Landroid/support/v7/widget/ac;
...
.method private b(Landroid/support/v7/app/AppCompatDelegateImplV9$PanelFeatureState;Landroid/view/KeyEvent;)Z
    ...
    iget-object v4, p0, Landroid/support/v7/app/AppCompatDelegateImplV9;->u:Landroid/support/v7/widget/ac;
    ...
    iget-object v6, p0, Landroid/support/v7/app/AppCompatDelegateImplV9;->v:Landroid/support/v7/app/AppCompatDelegateImplV9$a;
    ...
    iget-object v1, p0, Landroid/support/v7/app/AppCompatDelegateImplV9;->v:Landroid/support/v7/app/AppCompatDelegateImplV9$a;
...
.method private y()Landroid/view/ViewGroup;
    ...
    iput-object v1, p0, Landroid/support/v7/app/AppCompatDelegateImplV9;->u:Landroid/support/v7/widget/ac;
    ...
    invoke-static {v1, v0}, Landroid/support/v4/view/ai;->a(Landroid/view/View;Landroid/support/v4/view/y;)V
    ...
    .line 489
    :cond_e
    invoke-static {v2}, Landroid/support/v7/widget/bj;->b(Landroid/view/View;)V
...
.method a(Landroid/support/v7/view/b$a;)Landroid/support/v7/view/b;
    ...
    .line 739
    :cond_1
    iget-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV9;->e:Landroid/support/v7/app/f;
    ...
    .line 832
    iput-object v4, p0, Landroid/support/v7/app/AppCompatDelegateImplV9;->m:Landroid/support/v7/view/b;
    ...
    invoke-virtual {v0, v7}, Landroid/support/v4/view/ba;->a(F)Landroid/support/v4/view/ba;
    ...
    .line 837
    iget-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV9;->q:Landroid/support/v4/view/ba;
    ...
    .line 869
    :cond_b
    iput-object v3, p0, Landroid/support/v7/app/AppCompatDelegateImplV9;->m:Landroid/support/v7/view/b;
...
.method public a(Landroid/os/Bundle;)V
    ...
    invoke-static {v0}, Landroid/support/v4/app/x;->b(Landroid/app/Activity;)Ljava/lang/String;
...
.method public a(Landroid/support/v7/widget/Toolbar;)V
    ...
    invoke-virtual {v1}, Landroid/support/v7/app/p;->i()Landroid/view/Window$Callback;
    ...
    .line 227
    :cond_3
    iput-object v2, p0, Landroid/support/v7/app/AppCompatDelegateImplV9;->f:Landroid/support/v7/app/a;
...
.method public b(Landroid/support/v7/view/b$a;)Landroid/support/v7/view/b;
    ...
    iget-object v1, p0, Landroid/support/v7/app/AppCompatDelegateImplV9;->e:Landroid/support/v7/app/f;
    ...
    iget-object v2, p0, Landroid/support/v7/app/AppCompatDelegateImplV9;->m:Landroid/support/v7/view/b;
    ...
    .line 712
    invoke-virtual {p0, v0}, Landroid/support/v7/app/AppCompatDelegateImplV9;->a(Landroid/support/v7/view/b$a;)Landroid/support/v7/view/b;
...
.method public c(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    .line 1016
    iget-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV9;->L:Landroid/support/v7/app/n;
    ...
    iput-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV9;->L:Landroid/support/v7/app/n;
...
.method g(I)I
    ...
    invoke-static {v5, v1, v4}, Landroid/support/v7/widget/bj;->a(Landroid/view/View;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
