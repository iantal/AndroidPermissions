.class Landroid/support/v7/app/p$d;
...
.method public onCreatePanelView(I)Landroid/view/View;
    ...
    iget-object v0, v0, Landroid/support/v7/app/p;->a:Landroid/support/v7/widget/ad;

    invoke-interface {v0}, Landroid/support/v7/widget/ad;->r()Landroid/view/Menu;
    ...
    invoke-virtual {p0, p1, v1, v0}, Landroid/support/v7/app/p$d;->onPreparePanel(ILandroid/view/View;Landroid/view/Menu;)Z

    move-result v1

    if-eqz v1, :cond_0

    invoke-virtual {p0, p1, v0}, Landroid/support/v7/app/p$d;->onMenuOpened(ILandroid/view/Menu;)Z
    ...
    .line 581
    iget-object v1, p0, Landroid/support/v7/app/p$d;->a:Landroid/support/v7/app/p;

    invoke-virtual {v1, v0}, Landroid/support/v7/app/p;->a(Landroid/view/Menu;)Landroid/view/View;
...
.method public onPreparePanel(ILandroid/view/View;Landroid/view/Menu;)Z
    ...
    iget-object v1, v1, Landroid/support/v7/app/p;->a:Landroid/support/v7/widget/ad;

    invoke-interface {v1}, Landroid/support/v7/widget/ad;->m()V
