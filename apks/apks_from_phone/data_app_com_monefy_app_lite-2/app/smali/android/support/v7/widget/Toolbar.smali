...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-static {v0, p2, v1, p3, v7}, Landroid/support/v7/widget/be;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/be;
    ...
    invoke-virtual {v1, v0, v7}, Landroid/support/v7/widget/be;->g(II)I
    ...
    invoke-virtual {v1, v0, v7}, Landroid/support/v7/widget/be;->d(II)I
    ...
    invoke-virtual {v1, v2}, Landroid/support/v7/widget/be;->g(I)Z
    ...
    invoke-virtual {v1, v2, v0}, Landroid/support/v7/widget/be;->d(II)I
    ...
    invoke-virtual {v1, v0, v6}, Landroid/support/v7/widget/be;->d(II)I
    ...
    invoke-virtual {v1, v0, v6}, Landroid/support/v7/widget/be;->e(II)I
    ...
    .line 278
    invoke-virtual {v1, v0, v8}, Landroid/support/v7/widget/be;->d(II)I
    ...
    .line 281
    invoke-virtual {v1, v2, v8}, Landroid/support/v7/widget/be;->d(II)I
    ...
    .line 284
    invoke-virtual {v1, v3, v7}, Landroid/support/v7/widget/be;->e(II)I
    ...
    .line 286
    invoke-virtual {v1, v4, v7}, Landroid/support/v7/widget/be;->e(II)I
    ...
    .line 289
    iget-object v5, p0, Landroid/support/v7/widget/Toolbar;->u:Landroid/support/v7/widget/au;

    invoke-virtual {v5, v3, v4}, Landroid/support/v7/widget/au;->b(II)V
    ...
    .line 293
    :cond_5
    iget-object v3, p0, Landroid/support/v7/widget/Toolbar;->u:Landroid/support/v7/widget/au;

    invoke-virtual {v3, v0, v2}, Landroid/support/v7/widget/au;->a(II)V
    ...
    invoke-virtual {v1, v0}, Landroid/support/v7/widget/be;->a(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v1, v0}, Landroid/support/v7/widget/be;->c(I)Ljava/lang/CharSequence;
    ...
    invoke-virtual {v1, v0}, Landroid/support/v7/widget/be;->g(I)Z
    ...
    invoke-virtual {v1, v0, v6}, Landroid/support/v7/widget/be;->b(II)I
...
.method private s()V
    ...
    .prologue
    .line 2171
    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->u:Landroid/support/v7/widget/au;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/Toolbar;->u:Landroid/support/v7/widget/au;
...
.method public getWrapper()Landroid/support/v7/widget/ad;
    ...
    .prologue
    .line 2114
    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->I:Landroid/support/v7/widget/bf;
    ...
    invoke-direct {v0, p0, v1}, Landroid/support/v7/widget/bf;-><init>(Landroid/support/v7/widget/Toolbar;Z)V

    iput-object v0, p0, Landroid/support/v7/widget/Toolbar;->I:Landroid/support/v7/widget/bf;
...
.method protected onLayout(ZIIII)V
    ...
    .line 1722
    invoke-static/range {p0 .. p0}, Landroid/support/v4/view/ai;->q(Landroid/view/View;)I
...
.method protected onMeasure(II)V
    ...
    .line 1579
    invoke-static {p0}, Landroid/support/v7/widget/bj;->a(Landroid/view/View;)Z
    ...
    .line 1596
    invoke-static {v9, v1}, Landroid/support/v7/widget/bj;->a(II)I
    ...
    .line 1636
    invoke-static {v0}, Landroid/support/v4/view/ai;->j(Landroid/view/View;)I

    move-result v0

    .line 1635
    invoke-static {v9, v0}, Landroid/support/v7/widget/bj;->a(II)I
    ...
    .line 1660
    invoke-static {v11, v0}, Landroid/support/v7/widget/bj;->a(II)I
    ...
    .line 1675
    invoke-static {v4}, Landroid/support/v4/view/ai;->j(Landroid/view/View;)I

    move-result v4

    .line 1674
    invoke-static {v11, v4}, Landroid/support/v7/widget/bj;->a(II)I
    ...
    .line 1685
    invoke-static {v2}, Landroid/support/v4/view/ai;->j(Landroid/view/View;)I

    move-result v2

    .line 1684
    invoke-static {v11, v2}, Landroid/support/v7/widget/bj;->a(II)I
...
.method public onRtlPropertiesChanged(I)V
    ...
    .line 489
    iget-object v1, p0, Landroid/support/v7/widget/Toolbar;->u:Landroid/support/v7/widget/au;

    if-ne p1, v0, :cond_1

    :goto_0
    invoke-virtual {v1, v0}, Landroid/support/v7/widget/au;->a(Z)V
