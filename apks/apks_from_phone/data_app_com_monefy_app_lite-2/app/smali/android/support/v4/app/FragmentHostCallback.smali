...
.method a(Ljava/lang/String;ZZ)Landroid/support/v4/app/w;
    ...
    invoke-direct {v0, p1, p0, p2}, Landroid/support/v4/app/w;-><init>(Ljava/lang/String;Landroid/support/v4/app/FragmentHostCallback;Z)V
...
.method a(Landroid/support/v4/util/j;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v0, p0}, Landroid/support/v4/app/w;->a(Landroid/support/v4/app/FragmentHostCallback;)V
...
.method a(Z)V
    ...
    .line 258
    iget-object v0, p0, Landroid/support/v4/app/FragmentHostCallback;->h:Landroid/support/v4/app/w;
...
.method k()V
    ...
    invoke-virtual {p0, v0, v1, v2}, Landroid/support/v4/app/FragmentHostCallback;->a(Ljava/lang/String;ZZ)Landroid/support/v4/app/w;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v4/app/FragmentHostCallback;->h:Landroid/support/v4/app/w;
...
.method n()Landroid/support/v4/util/j;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 327
    :cond_0
    invoke-virtual {p0}, Landroid/support/v4/app/FragmentHostCallback;->j()Z
    ...
    .line 340
    iget-object v6, p0, Landroid/support/v4/app/FragmentHostCallback;->f:Landroid/support/v4/util/j;

    iget-object v5, v5, Landroid/support/v4/app/w;->d:Ljava/lang/String;

    invoke-virtual {v6, v5}, Landroid/support/v4/util/j;->remove(Ljava/lang/Object;)Ljava/lang/Object;
