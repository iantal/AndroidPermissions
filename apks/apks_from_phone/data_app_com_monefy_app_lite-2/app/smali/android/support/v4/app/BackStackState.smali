...
.method public constructor <init>(Landroid/support/v4/app/BackStackRecord;)V
    ...
    .line 48
    iget-object v1, p1, Landroid/support/v4/app/BackStackRecord;->c:Ljava/util/ArrayList;
    ...
    .line 51
    iget-boolean v1, p1, Landroid/support/v4/app/BackStackRecord;->j:Z
    ...
    .line 57
    iget-object v0, p1, Landroid/support/v4/app/BackStackRecord;->c:Ljava/util/ArrayList;
    ...
    iget v6, v0, Landroid/support/v4/app/BackStackRecord$a;->a:I
    ...
    iget v6, v0, Landroid/support/v4/app/BackStackRecord$a;->d:I
    ...
    iget v6, v0, Landroid/support/v4/app/BackStackRecord$a;->e:I
    ...
    .line 67
    iget-object v0, p1, Landroid/support/v4/app/BackStackRecord;->l:Ljava/lang/String;
    ...
    .line 70
    iget-object v0, p1, Landroid/support/v4/app/BackStackRecord;->p:Ljava/lang/CharSequence;
    ...
    .line 75
    iget-boolean v0, p1, Landroid/support/v4/app/BackStackRecord;->u:Z
...
.method public instantiate(Landroid/support/v4/app/FragmentManagerImpl;)Landroid/support/v4/app/BackStackRecord;
    ...
    invoke-direct {v4}, Landroid/support/v4/app/BackStackRecord$a;-><init>()V
    ...
    iput v0, v4, Landroid/support/v4/app/BackStackRecord$a;->a:I
    ...
    .line 104
    iget-object v5, p1, Landroid/support/v4/app/FragmentManagerImpl;->e:Ljava/util/ArrayList;
    ...
    .line 105
    iput-object v0, v4, Landroid/support/v4/app/BackStackRecord$a;->b:Landroid/support/v4/app/Fragment;
    ...
    iput v0, v4, Landroid/support/v4/app/BackStackRecord$a;->c:I
    ...
    iput v0, v4, Landroid/support/v4/app/BackStackRecord$a;->d:I
    ...
    iput v0, v4, Landroid/support/v4/app/BackStackRecord$a;->e:I
    ...
    iput v0, v4, Landroid/support/v4/app/BackStackRecord$a;->f:I

    .line 113
    iget v0, v4, Landroid/support/v4/app/BackStackRecord$a;->c:I

    iput v0, v3, Landroid/support/v4/app/BackStackRecord;->d:I

    .line 114
    iget v0, v4, Landroid/support/v4/app/BackStackRecord$a;->d:I

    iput v0, v3, Landroid/support/v4/app/BackStackRecord;->e:I

    .line 115
    iget v0, v4, Landroid/support/v4/app/BackStackRecord$a;->e:I

    iput v0, v3, Landroid/support/v4/app/BackStackRecord;->f:I

    .line 116
    iget v0, v4, Landroid/support/v4/app/BackStackRecord$a;->f:I

    iput v0, v3, Landroid/support/v4/app/BackStackRecord;->g:I

    .line 117
    invoke-virtual {v3, v4}, Landroid/support/v4/app/BackStackRecord;->a(Landroid/support/v4/app/BackStackRecord$a;)V
    ...
    iput v0, v3, Landroid/support/v4/app/BackStackRecord;->i:I

    .line 122
    iget-object v0, p0, Landroid/support/v4/app/BackStackState;->mName:Ljava/lang/String;

    iput-object v0, v3, Landroid/support/v4/app/BackStackRecord;->l:Ljava/lang/String;
    ...
    iput-object v0, v3, Landroid/support/v4/app/BackStackRecord;->t:Ljava/util/ArrayList;

    .line 131
    iget-boolean v0, p0, Landroid/support/v4/app/BackStackState;->mAllowOptimization:Z

    iput-boolean v0, v3, Landroid/support/v4/app/BackStackRecord;->u:Z
