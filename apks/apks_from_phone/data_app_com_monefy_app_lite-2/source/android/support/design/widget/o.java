  ...
  extends android.support.v7.c.a.a
{
  ...
  public o(Context paramContext, Drawable paramDrawable, float paramFloat1, float paramFloat2, float paramFloat3)
  {
    super(paramDrawable);
    this.l = android.support.v4.content.a.c(paramContext, a.c.design_fab_shadow_start_color);
    this.m = android.support.v4.content.a.c(paramContext, a.c.design_fab_shadow_mid_color);
    this.n = android.support.v4.content.a.c(paramContext, a.c.design_fab_shadow_end_color);
    this.b = new Paint(5);
