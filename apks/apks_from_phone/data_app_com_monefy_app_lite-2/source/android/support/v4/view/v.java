...
public class v
{
  ...
  {
    if ((a()) && (this.b != null)) {
      return ax.a(this.b, this.a, paramFloat1, paramFloat2);
    }
    return false;
  }
  ...
  {
    if ((a()) && (this.b != null)) {
      return ax.a(this.b, this.a, paramFloat1, paramFloat2, paramBoolean);
    }
    return false;
  }
  ...
  public boolean a(int paramInt)
  {
    ...
    if (a())
    {
      ...
      {
        if (ax.a(localViewParent, localView, this.a, paramInt))
        {
          this.b = localViewParent;
          ax.b(localViewParent, localView, this.a, paramInt);
          return true;
        }
  ...
  public boolean a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int[] paramArrayOfInt)
  {
    ...
    for (;;)
    {
      ax.a(this.b, this.a, paramInt1, paramInt2, paramInt3, paramInt4);
      if (paramArrayOfInt != null)
      {
        this.a.getLocationInWindow(paramArrayOfInt);
        paramArrayOfInt[0] -= j;
  ...
  public boolean a(int paramInt1, int paramInt2, int[] paramArrayOfInt1, int[] paramArrayOfInt2)
  {
    ...
    for (;;)
    {
      ...
      arrayOfInt[0] = 0;
      arrayOfInt[1] = 0;
      ax.a(this.b, this.a, paramInt1, paramInt2, arrayOfInt);
      if (paramArrayOfInt2 != null)
      {
        this.a.getLocationInWindow(paramArrayOfInt2);
