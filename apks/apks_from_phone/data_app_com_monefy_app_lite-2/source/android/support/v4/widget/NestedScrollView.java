  ...
  implements ae, u, w
{
  ...
  private final android.support.v4.view.x x;
  private final v y;
  private float z;
  ...
  public NestedScrollView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    this.x = new android.support.v4.view.x(this);
    this.y = new v(this);
  ...
  private void g()
  {
    if (getOverScrollMode() != 2)
    {
      if (this.d == null)
      {
        ...
        this.d = new j(localContext);
        this.e = new j(localContext);
      }
      return;
    }
    this.d = null;
  ...
  public boolean onGenericMotionEvent(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      if (!this.j)
      {
        float f1 = s.a(paramMotionEvent, 9);
        if (f1 != 0.0F)
        {
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if (!this.h)
    {
      if (this.u != null)
      {
        scrollTo(getScrollX(), this.u.scrollPosition);
        this.u = null;
      }
      if (getChildCount() <= 0) {
        break label153;
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    case 2: 
      ...
      for (;;)
      {
        ...
        i3 = paramMotionEvent.findPointerIndex(this.q);
        if (i3 != -1) {
          break;
        }
    ...
    while (this.j)
    {
      ...
      if (i2 < 0)
      {
        this.d.a(i1 / getHeight(), paramMotionEvent.getX(i3) / getWidth());
        if (!this.e.a()) {
          this.e.c();
        }
      }
      while ((this.d != null) && ((!this.d.a()) || (!this.e.a())))
      {
        ...
        if (i2 > i4)
        {
          this.e.a(i1 / getHeight(), 1.0F - paramMotionEvent.getX(i3) / getWidth());
          if (!this.d.a()) {
            this.d.c();
          }
        }
      ...
      if (this.j)
      {
        ...
        i1 = (int)ag.b(paramMotionEvent, this.q);
    ...
    extends android.support.v4.view.a
  {
    ...
    public void a(View paramView, e paramE)
    {
      ...
      paramE.b(ScrollView.class.getName());
    ...
    public void a(View paramView, AccessibilityEvent paramAccessibilityEvent)
    {
      ...
      for (boolean bool = true;; bool = false)
      {
        paramAccessibilityEvent.d(bool);
        ...
        paramAccessibilityEvent.g(paramView.getScrollRange());
        return;
      }
    }
