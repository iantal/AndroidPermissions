  ...
  implements Parcelable
{
  ...
  public MediaDescriptionCompat getDescription()
  {
    ...
    if (!TextUtils.isEmpty((CharSequence)localObject1))
    {
      ...
      if (localObject1 != null)
      {
        ...
        localObject3 = new MediaDescriptionCompat.a();
        ((MediaDescriptionCompat.a)localObject3).a(str);
        ((MediaDescriptionCompat.a)localObject3).a(arrayOfCharSequence[0]);
        ((MediaDescriptionCompat.a)localObject3).b(arrayOfCharSequence[1]);
        ((MediaDescriptionCompat.a)localObject3).c(arrayOfCharSequence[2]);
        ((MediaDescriptionCompat.a)localObject3).a((Bitmap)localObject1);
        ((MediaDescriptionCompat.a)localObject3).a((Uri)localObject2);
        ((MediaDescriptionCompat.a)localObject3).b(localUri);
        if (this.mBundle.containsKey("android.media.metadata.BT_FOLDER_TYPE"))
        {
          ...
          ((MediaDescriptionCompat.a)localObject3).a((Bundle)localObject1);
        }
        this.mDescription = ((MediaDescriptionCompat.a)localObject3).a();
        return this.mDescription;
      }
    }
    else
  ...
  public Object getMediaMetadata()
  {
    ...
    localParcel.setDataPosition(0);
    this.mMetadataObj = e.a(localParcel);
    localParcel.recycle();
    return this.mMetadataObj;
  }
