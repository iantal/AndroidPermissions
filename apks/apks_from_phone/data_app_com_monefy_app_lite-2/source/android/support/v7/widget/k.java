...
class k
{
  ...
  int a(int paramInt)
  {
    ...
    {
      Drawable localDrawable = android.support.v4.widget.b.a(this.a);
      i = paramInt;
  ...
  void a(AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    try
    {
      if (paramAttributeSet.hasValue(a.j.CompoundButton_android_button))
      {
        ...
        if (paramInt != 0) {
          this.a.setButtonDrawable(android.support.v7.b.a.b.b(this.a.getContext(), paramInt));
        }
      }
      if (paramAttributeSet.hasValue(a.j.CompoundButton_buttonTint)) {
        android.support.v4.widget.b.a(this.a, paramAttributeSet.getColorStateList(a.j.CompoundButton_buttonTint));
      }
      if (paramAttributeSet.hasValue(a.j.CompoundButton_buttonTintMode)) {
        android.support.v4.widget.b.a(this.a, af.a(paramAttributeSet.getInt(a.j.CompoundButton_buttonTintMode, -1), null));
      }
      return;
    }
    finally
