  ...
  extends ViewGroup
{
  ...
  public ba a(int paramInt, long paramLong)
  {
    if (this.f != null) {
      this.f.b();
    }
    if (paramInt == 0)
    {
      ...
      localBa = ai.r(this).a(1.0F);
      localBa.a(paramLong);
      localBa.a(this.a.a(localBa, paramInt));
      return localBa;
    }
    ba localBa = ai.r(this).a(0.0F);
    localBa.a(paramLong);
    localBa.a(this.a.a(localBa, paramInt));
    return localBa;
  }
    ...
    implements be
  {
    ...
    public a a(ba paramBa, int paramInt)
    {
      a.this.f = paramBa;
      this.a = paramInt;
      return this;
