  ...
  extends FrameLayout
{
  ...
  public ActionBarContainer(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    if (Build.VERSION.SDK_INT >= 21)
    {
      ...
      ai.a(this, (Drawable)localObject);
  ...
  public void setTabContainer(aw paramAw)
  {
    if (this.g != null) {
      removeView(this.g);
    }
    ...
    {
      addView(paramAw);
      ViewGroup.LayoutParams localLayoutParams = paramAw.getLayoutParams();
      localLayoutParams.width = -1;
      localLayoutParams.height = -2;
      paramAw.setAllowCollapse(false);
    }
  }
