  ...
  implements Serializable
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    do
    {
      ...
      bool1 = bool3;
    } while (paramObject._sourceRef != null);
    if ((this._lineNr == paramObject._lineNr) && (this._columnNr == paramObject._columnNr) && (this._totalChars == paramObject._totalChars) && (getByteOffset() == paramObject.getByteOffset())) {}
    for (boolean bool1 = bool2;; bool1 = false)
    {
      return bool1;
      if (this._sourceRef.equals(paramObject._sourceRef)) {
        break;
      }
      return false;
    }
