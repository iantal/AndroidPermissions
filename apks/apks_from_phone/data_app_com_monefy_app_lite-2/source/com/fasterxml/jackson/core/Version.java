  ...
  implements Serializable, Comparable<Version>
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    } while ((paramObject._majorVersion == this._majorVersion) && (paramObject._minorVersion == this._minorVersion) && (paramObject._patchLevel == this._patchLevel) && (paramObject._artifactId.equals(this._artifactId)) && (paramObject._groupId.equals(this._groupId)));
    return false;
  }
