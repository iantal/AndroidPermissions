...
public final class MutableDebug
{
    ...
    implements MutableMessageLite
  {
    ...
    public int getSerializedSize()
    {
      ...
      for (int i = CodedOutputStream.d(1, this.rulesEvaluation_) + 0;; i = 0)
      {
        if (this.results_ != null) {
          for (;;)
          {
            ...
            k = CodedOutputStream.d(2, (MessageLite)this.results_.get(j));
            j += 1;
            i = k + i;
          }
        }
        int k = i;
        i = this.unknownFields.a() + k;
        this.cachedSize = i;
        return i;
      }
    }
    ...
    public DataLayerEventEvaluationInfo mergeFrom(DataLayerEventEvaluationInfo paramDataLayerEventEvaluationInfo)
    {
      ...
      this.unknownFields = this.unknownFields.a(paramDataLayerEventEvaluationInfo.unknownFields);
      return this;
    }
        ...
        for (;;)
        {
          ...
          default: 
            for (;;)
            {
              ...
              this.bitField0_ |= 0x1;
              paramCodedInputStream.a(this.rulesEvaluation_, paramExtensionRegistryLite);
              break;
              paramCodedInputStream.a(addResults(), paramExtensionRegistryLite);
              break;
    ...
    public void writeToWithCachedSizes(CodedOutputStream paramCodedOutputStream)
    {
      ...
      if ((this.bitField0_ & 0x1) == 1) {
        paramCodedOutputStream.a(1, this.rulesEvaluation_);
      }
      if (this.results_ != null)
      {
        i = 0;
        ...
        {
          paramCodedOutputStream.a(2, (MutableMessageLite)this.results_.get(i));
          i += 1;
        }
      }
    ...
    implements MutableMessageLite
  {
    ...
    public int getSerializedSize()
    {
      if (this.event_ != null)
      {
        ...
        for (;;)
        {
          ...
          i += CodedOutputStream.d(1, (MessageLite)this.event_.get(j));
          j += 1;
        }
      }
      int k = 0;
      int i = this.unknownFields.a() + k;
      this.cachedSize = i;
      return i;
    }
    ...
    public DebugEvents mergeFrom(DebugEvents paramDebugEvents)
    {
      ...
      this.unknownFields = this.unknownFields.a(paramDebugEvents.unknownFields);
      return this;
    }
        ...
        for (;;)
        {
          ...
          default: 
            for (;;)
            {
              ...
              i = 1;
              break;
              paramCodedInputStream.a(addEvent(), paramExtensionRegistryLite);
              break;
              localCodedOutputStream.a();
              this.unknownFields = localOutput.a();
              return true;
    ...
    public void writeToWithCachedSizes(CodedOutputStream paramCodedOutputStream)
    {
      ...
      if (this.event_ != null)
      {
        ...
        {
          paramCodedOutputStream.a(1, (MutableMessageLite)this.event_.get(i));
          i += 1;
        }
      }
      paramCodedOutputStream.c(this.unknownFields);
    ...
    implements MutableMessageLite
  {
    ...
    private static final long serialVersionUID = 0L;
    private int bitField0_;
    private Object containerId_ = Internal.a;
    private Object containerVersion_ = Internal.a;
    ...
    private Object key_ = Internal.a;
    ...
    public EventInfo clear()
    {
      ...
      this.eventType_ = EventType.DATA_LAYER_EVENT;
      this.bitField0_ &= 0xFFFFFFFE;
      this.containerVersion_ = Internal.a;
      this.bitField0_ &= 0xFFFFFFFD;
      this.containerId_ = Internal.a;
      this.bitField0_ &= 0xFFFFFFFB;
      this.key_ = Internal.a;
    ...
    public byte[] getContainerIdAsBytes()
    {
      ...
      if ((localObject instanceof String))
      {
        localObject = Internal.b((String)localObject);
    ...
    public int getSerializedSize()
    {
      ...
      if ((this.bitField0_ & 0x2) == 2) {
        i = j + CodedOutputStream.b(2, getContainerVersionAsBytes());
      }
      j = i;
      if ((this.bitField0_ & 0x4) == 4) {
        j = i + CodedOutputStream.b(3, getContainerIdAsBytes());
      }
      i = j;
      if ((this.bitField0_ & 0x8) == 8) {
        i = j + CodedOutputStream.b(4, getKeyAsBytes());
      }
      j = i;
    ...
    public int hashCode()
    {
      int j = 41;
      if (hasEventType()) {
        j = 80454 + Internal.a(getEventType());
      }
      int i = j;
      if (hasContainerVersion()) {
    ...
    public EventInfo mergeFrom(EventInfo paramEventInfo)
    {
      ...
      for (this.key_ = paramEventInfo.key_;; this.key_ = Arrays.copyOf(arrayOfByte, arrayOfByte.length))
      {
        ...
        this.unknownFields = this.unknownFields.a(paramEventInfo.unknownFields);
        return this;
        ...
        for (;;)
        {
          ...
          default: 
            for (;;)
            {
              ...
              i = 1;
              break;
              int k = paramCodedInputStream.p();
              EventType localEventType = EventType.valueOf(k);
              if (localEventType == null)
              {
                localCodedOutputStream.p(j);
                localCodedOutputStream.p(k);
                break;
              }
              this.bitField0_ |= 0x1;
              ...
              break;
              this.bitField0_ |= 0x2;
              this.containerVersion_ = paramCodedInputStream.n();
              break;
              this.bitField0_ |= 0x4;
              this.containerId_ = paramCodedInputStream.n();
              break;
              this.bitField0_ |= 0x8;
              this.key_ = paramCodedInputStream.n();
              break;
              if (this.macroResult_ == MutableDebug.MacroEvaluationInfo.getDefaultInstance()) {
                this.macroResult_ = MutableDebug.MacroEvaluationInfo.newMessage();
              }
              this.bitField0_ |= 0x10;
              paramCodedInputStream.a(this.macroResult_, paramExtensionRegistryLite);
              break;
              if (this.dataLayerEventResult_ == MutableDebug.DataLayerEventEvaluationInfo.getDefaultInstance()) {
                this.dataLayerEventResult_ = MutableDebug.DataLayerEventEvaluationInfo.newMessage();
              }
              this.bitField0_ |= 0x20;
              paramCodedInputStream.a(this.dataLayerEventResult_, paramExtensionRegistryLite);
              break;
              localCodedOutputStream.a();
              this.unknownFields = localOutput.a();
              return true;
    ...
    public void writeToWithCachedSizes(CodedOutputStream paramCodedOutputStream)
    {
      ...
      if ((this.bitField0_ & 0x2) == 2) {
        paramCodedOutputStream.a(2, getContainerVersionAsBytes());
      }
      if ((this.bitField0_ & 0x4) == 4) {
        paramCodedOutputStream.a(3, getContainerIdAsBytes());
      }
      if ((this.bitField0_ & 0x8) == 8) {
        paramCodedOutputStream.a(4, getKeyAsBytes());
      }
      if ((this.bitField0_ & 0x10) == 16) {
        paramCodedOutputStream.a(6, this.macroResult_);
      }
      if ((this.bitField0_ & 0x20) == 32) {
        paramCodedOutputStream.a(7, this.dataLayerEventResult_);
      }
      paramCodedOutputStream.c(this.unknownFields);
      int j = paramCodedOutputStream.d();
      ...
      implements Internal.EnumLite
    {
      ...
      {
        public MutableDebug.EventInfo.EventType a(int paramAnonymousInt)
        {
    ...
    implements MutableMessageLite
  {
    ...
    public MacroEvaluationInfo mergeFrom(MacroEvaluationInfo paramMacroEvaluationInfo)
    {
      ...
      this.unknownFields = this.unknownFields.a(paramMacroEvaluationInfo.unknownFields);
      return this;
    }
        ...
        for (;;)
        {
          ...
          default: 
            for (;;)
            {
              ...
              this.bitField0_ |= 0x2;
              paramCodedInputStream.a(this.result_, paramExtensionRegistryLite);
              break;
              localCodedOutputStream.a();
              this.unknownFields = localOutput.a();
              return true;
    ...
    public void writeToWithCachedSizes(CodedOutputStream paramCodedOutputStream)
    {
      ...
      if ((this.bitField0_ & 0x2) == 2) {
        paramCodedOutputStream.a(3, this.result_);
      }
      paramCodedOutputStream.c(this.unknownFields);
      int j = paramCodedOutputStream.d();
      if (getCachedSize() != j - i) {
    ...
    implements MutableMessageLite
  {
    ...
    private static volatile MessageLite immutableDefault = null;
    private static final long serialVersionUID = 0L;
    private Object associatedRuleName_ = Internal.a;
    private int bitField0_;
    ...
    public ResolvedFunctionCall clear()
    {
      ...
      this.bitField0_ &= 0xFFFFFFFE;
      this.associatedRuleName_ = Internal.a;
      this.bitField0_ &= 0xFFFFFFFD;
      return this;
    }
    ...
    public int getSerializedSize()
    {
      if (this.properties_ != null)
      {
        ...
        for (;;)
        {
          ...
          i += CodedOutputStream.d(1, (MessageLite)this.properties_.get(k));
          k += 1;
        }
      }
      int j = 0;
      int i = j;
      if ((this.bitField0_ & 0x1) == 1) {
        i = j + CodedOutputStream.d(2, this.result_);
      }
      j = i;
      if ((this.bitField0_ & 0x2) == 2) {
        j = i + CodedOutputStream.b(3, getAssociatedRuleNameAsBytes());
      }
    ...
    public ResolvedFunctionCall mergeFrom(ResolvedFunctionCall paramResolvedFunctionCall)
    {
      ...
      {
        this.unknownFields = this.unknownFields.a(paramResolvedFunctionCall.unknownFields);
        return this;
        ...
        for (;;)
        {
          ...
          default: 
            for (;;)
            {
              ...
              i = 1;
              break;
              paramCodedInputStream.a(addProperties(), paramExtensionRegistryLite);
              break;
              if (this.result_ == MutableTypeSystem.Value.getDefaultInstance()) {
                this.result_ = MutableTypeSystem.Value.newMessage();
              }
              ...
              break;
              this.bitField0_ |= 0x2;
              this.associatedRuleName_ = paramCodedInputStream.n();
              break;
              localCodedOutputStream.a();
              this.unknownFields = localOutput.a();
              return true;
    ...
    public void writeToWithCachedSizes(CodedOutputStream paramCodedOutputStream)
    {
      ...
      if (this.properties_ != null)
      {
        ...
        {
          paramCodedOutputStream.a(1, (MutableMessageLite)this.properties_.get(i));
          i += 1;
        }
      }
      if ((this.bitField0_ & 0x1) == 1) {
        paramCodedOutputStream.a(2, this.result_);
      }
      if ((this.bitField0_ & 0x2) == 2) {
        paramCodedOutputStream.a(3, getAssociatedRuleNameAsBytes());
      }
      paramCodedOutputStream.c(this.unknownFields);
      int i = paramCodedOutputStream.d();
      if (getCachedSize() != i - j) {
    ...
    implements MutableMessageLite
  {
    ...
    public int getSerializedSize()
    {
      int i = 0;
      if ((this.bitField0_ & 0x1) == 1) {
        i = 0 + CodedOutputStream.b(1, getKeyAsBytes());
      }
      int j = i;
      if ((this.bitField0_ & 0x2) == 2) {
    ...
    public ResolvedProperty mergeFrom(ResolvedProperty paramResolvedProperty)
    {
      ...
      for (this.key_ = paramResolvedProperty.key_;; this.key_ = Arrays.copyOf(arrayOfByte, arrayOfByte.length))
      {
        ...
        this.unknownFields = this.unknownFields.a(paramResolvedProperty.unknownFields);
        return this;
        ...
        for (;;)
        {
          ...
          default: 
            for (;;)
            {
              ...
              this.bitField0_ |= 0x2;
              paramCodedInputStream.a(this.value_, paramExtensionRegistryLite);
              break;
              localCodedOutputStream.a();
              this.unknownFields = localOutput.a();
              return true;
    ...
    public void writeToWithCachedSizes(CodedOutputStream paramCodedOutputStream)
    {
      int i = paramCodedOutputStream.d();
      if ((this.bitField0_ & 0x1) == 1) {
        paramCodedOutputStream.a(1, getKeyAsBytes());
      }
      if ((this.bitField0_ & 0x2) == 2) {
    ...
    implements MutableMessageLite
  {
    ...
    public int getSerializedSize()
    {
      ...
      if (this.positivePredicates_ != null)
      {
        ...
        for (;;)
        {
          ...
          i += CodedOutputStream.d(1, (MessageLite)this.positivePredicates_.get(k));
          k += 1;
        }
      }
      int j = 0;
      ...
      if (this.negativePredicates_ != null)
      {
        ...
        for (;;)
        {
          ...
          j += CodedOutputStream.d(2, (MessageLite)this.negativePredicates_.get(k));
          k += 1;
        }
      }
      j = i;
      if (this.addTags_ != null)
      {
        ...
        for (;;)
        {
          ...
          i += CodedOutputStream.d(3, (MessageLite)this.addTags_.get(k));
          k += 1;
        }
      }
      i = j;
      if (this.removeTags_ != null)
      {
        ...
        for (;;)
        {
          ...
          j += CodedOutputStream.d(4, (MessageLite)this.removeTags_.get(k));
          k += 1;
        }
      }
      j = i;
      ...
      if (this.removeMacros_ != null)
      {
        ...
        for (;;)
        {
          ...
          j += CodedOutputStream.d(6, (MessageLite)this.removeMacros_.get(k));
          k += 1;
        }
      }
      j = i;
      if ((this.bitField0_ & 0x1) == 1) {
        j = i + CodedOutputStream.d(7, this.result_);
      }
      i = this.unknownFields.a() + j;
      this.cachedSize = i;
      return i;
    ...
    public ResolvedRule mergeFrom(ResolvedRule paramResolvedRule)
    {
      ...
      this.unknownFields = this.unknownFields.a(paramResolvedRule.unknownFields);
      return this;
    }
        ...
        for (;;)
        {
          ...
          default: 
            for (;;)
            {
              ...
              i = 1;
              break;
              paramCodedInputStream.a(addPositivePredicates(), paramExtensionRegistryLite);
              break;
              paramCodedInputStream.a(addNegativePredicates(), paramExtensionRegistryLite);
              break;
              paramCodedInputStream.a(addAddTags(), paramExtensionRegistryLite);
              break;
              paramCodedInputStream.a(addRemoveTags(), paramExtensionRegistryLite);
              break;
              paramCodedInputStream.a(addAddMacros(), paramExtensionRegistryLite);
              break;
              paramCodedInputStream.a(addRemoveMacros(), paramExtensionRegistryLite);
              break;
              if (this.result_ == MutableTypeSystem.Value.getDefaultInstance()) {
                this.result_ = MutableTypeSystem.Value.newMessage();
              }
    ...
    {
      int j = 0;
      int k = paramCodedOutputStream.d();
      if (this.positivePredicates_ != null)
      {
        i = 0;
        while (i < this.positivePredicates_.size())
        {
          paramCodedOutputStream.a(1, (MutableMessageLite)this.positivePredicates_.get(i));
          i += 1;
        }
      }
      if (this.negativePredicates_ != null)
      {
        ...
        {
          paramCodedOutputStream.a(2, (MutableMessageLite)this.negativePredicates_.get(i));
          i += 1;
        }
      }
      if (this.addTags_ != null)
      {
        ...
        {
          paramCodedOutputStream.a(3, (MutableMessageLite)this.addTags_.get(i));
          i += 1;
        }
      }
      if (this.removeTags_ != null)
      {
        ...
        {
          paramCodedOutputStream.a(4, (MutableMessageLite)this.removeTags_.get(i));
          i += 1;
        }
      }
      if (this.addMacros_ != null)
      {
        ...
        {
          paramCodedOutputStream.a(5, (MutableMessageLite)this.addMacros_.get(i));
          i += 1;
        }
      }
      if (this.removeMacros_ != null)
      {
        ...
        {
          paramCodedOutputStream.a(6, (MutableMessageLite)this.removeMacros_.get(i));
          i += 1;
        }
      }
      if ((this.bitField0_ & 0x1) == 1) {
        paramCodedOutputStream.a(7, this.result_);
      }
      paramCodedOutputStream.c(this.unknownFields);
      int i = paramCodedOutputStream.d();
      if (getCachedSize() != i - k) {
        throw new RuntimeException("Serialized size doesn't match cached size. You may forget to call getSerializedSize() or the message is being modified concurrently.");
      }
    }
  }
    ...
    implements MutableMessageLite
  {
    ...
    public int getSerializedSize()
    {
      ...
      if (this.rules_ != null)
      {
        ...
        for (;;)
        {
          ...
          j += CodedOutputStream.d(1, (MessageLite)this.rules_.get(k));
          k += 1;
        }
      }
      int i = 0;
      ...
      if (this.enabledFunctions_ != null)
      {
        ...
        {
          j = i;
          if (k >= this.enabledFunctions_.size()) {
            break;
          }
          i += CodedOutputStream.d(2, (MessageLite)this.enabledFunctions_.get(k));
          k += 1;
        }
      }
      i = this.unknownFields.a() + j;
    ...
    public RuleEvaluationStepInfo mergeFrom(RuleEvaluationStepInfo paramRuleEvaluationStepInfo)
    {
      ...
      this.unknownFields = this.unknownFields.a(paramRuleEvaluationStepInfo.unknownFields);
      return this;
    }
        ...
        for (;;)
        {
          ...
          default: 
            for (;;)
            {
              ...
              i = 1;
              break;
              paramCodedInputStream.a(addRules(), paramExtensionRegistryLite);
              break;
              paramCodedInputStream.a(addEnabledFunctions(), paramExtensionRegistryLite);
              break;
              localCodedOutputStream.a();
              this.unknownFields = localOutput.a();
              return true;
    ...
    public void writeToWithCachedSizes(CodedOutputStream paramCodedOutputStream)
    {
      ...
      if (this.rules_ != null)
      {
        ...
        {
          paramCodedOutputStream.a(1, (MutableMessageLite)this.rules_.get(i));
          i += 1;
        }
      }
      if (this.enabledFunctions_ != null)
      {
        ...
        {
          paramCodedOutputStream.a(2, (MutableMessageLite)this.enabledFunctions_.get(i));
          i += 1;
        }
      }
      paramCodedOutputStream.c(this.unknownFields);
