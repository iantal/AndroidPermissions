  ...
  implements HitStore
{
  ...
  private final UrlDatabaseHelper b;
  ...
  PersistentHitStore(HitStoreStateListener paramHitStoreStateListener, Context paramContext, String paramString)
  {
    ...
    this.b = new UrlDatabaseHelper(this.e, this.f);
    this.c = new SimpleNetworkDispatcher(new DefaultHttpClient(), this.e, new StoreDispatchListener());
    this.g = 0L;
  }
  ...
  List<String> a(int paramInt)
  {
    ...
    //   10: ifgt +11 -> 21
    //   13: ldc -32
    //   15: invokestatic 110	com/google/tagmanager/Log:b	(Ljava/lang/String;)V
    //   18: aload 6
    //   20: areturn
    //   21: aload_0
    //   22: ldc -30
    //   24: invokespecial 124	com/google/tagmanager/PersistentHitStore:a	(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    //   27: astore_3
    //   28: aload_3
    //   29: ifnonnull +6 -> 35
    //   32: aload 6
    ...
    //   49: astore 4
    //   51: iload_1
    //   52: invokestatic 231	java/lang/Integer:toString	(I)Ljava/lang/String;
    //   55: astore 5
    //   57: aload_3
    //   58: ldc 35
    //   60: iconst_1
    ...
    //   73: aload 4
    //   75: aload 5
    //   77: invokevirtual 235	android/database/sqlite/SQLiteDatabase:query	(Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   80: astore 4
    //   82: aload 4
    //   84: astore_3
    //   85: aload 4
    //   87: invokeinterface 241 1 0
    //   92: ifeq +40 -> 132
    //   95: aload 4
    //   97: astore_3
    //   98: aload 6
    //   100: aload 4
    //   102: iconst_0
    //   103: invokeinterface 245 2 0
    //   108: invokestatic 116	java/lang/String:valueOf	(J)Ljava/lang/String;
    //   111: invokeinterface 249 2 0
    //   116: pop
    //   117: aload 4
    //   119: astore_3
    //   120: aload 4
    //   122: invokeinterface 252 1 0
    //   127: istore_2
    //   128: iload_2
    //   129: ifne -34 -> 95
    //   132: aload 4
    ...
    //   152: aload 4
    //   154: astore_3
    //   155: new 146	java/lang/StringBuilder
    //   158: dup
    //   159: invokespecial 147	java/lang/StringBuilder:<init>	()V
    //   162: ldc_w 257
    //   165: invokevirtual 153	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   168: aload 5
    //   170: invokevirtual 260	android/database/sqlite/SQLiteException:getMessage	()Ljava/lang/String;
    //   173: invokevirtual 153	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   176: invokevirtual 160	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   179: invokestatic 110	com/google/tagmanager/Log:b	(Ljava/lang/String;)V
    //   182: aload 4
    //   184: ifnull -40 -> 144
    //   187: aload 4
    ...
    //   0	224	0	this	PersistentHitStore
  ...
  int b()
  {
    ...
    int i = ((SQLiteDatabase)localObject).delete("gtm_hits", "HIT_TIME < ?", new String[] { Long.toString(this.h.a() - 2592000000L) });
    Object localObject = this.d;
    if (c() == 0) {}
    for (;;)
    {
      ((HitStoreStateListener)localObject).a(bool);
      return i;
      bool = false;
    }
  }
  ...
  public List<Hit> b(int paramInt)
  {
    ...
    //   9: aload_0
    //   10: ldc_w 336
    //   13: invokespecial 124	com/google/tagmanager/PersistentHitStore:a	(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    //   16: astore 8
    //   18: aload 8
    //   20: ifnonnull +10 -> 30
    //   23: aload 5
    ...
    //   47: astore 6
    //   49: iload_1
    //   50: invokestatic 231	java/lang/Integer:toString	(I)Ljava/lang/String;
    //   53: astore 7
    //   55: aload 8
    //   57: ldc 35
    //   59: iconst_3
    ...
    //   82: aload 6
    //   84: aload 7
    //   86: invokevirtual 235	android/database/sqlite/SQLiteDatabase:query	(Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   89: astore 6
    //   91: aload 6
    //   93: astore 4
    //   95: new 221	java/util/ArrayList
    //   98: dup
    //   99: invokespecial 222	java/util/ArrayList:<init>	()V
    //   102: astore 7
    //   104: aload 4
    //   106: invokeinterface 241 1 0
    //   111: ifeq +54 -> 165
    //   114: aload 7
    //   116: new 338	com/google/tagmanager/Hit
    //   119: dup
    //   120: aload 4
    //   122: iconst_0
    //   123: invokeinterface 245 2 0
    //   128: aload 4
    //   130: iconst_1
    //   131: invokeinterface 245 2 0
    //   136: aload 4
    //   138: iconst_2
    //   139: invokeinterface 245 2 0
    //   144: invokespecial 341	com/google/tagmanager/Hit:<init>	(JJJ)V
    //   147: invokeinterface 249 2 0
    //   152: pop
    //   153: aload 4
    //   155: invokeinterface 252 1 0
    //   160: istore_3
    //   161: iload_3
    //   162: ifne -48 -> 114
    //   165: aload 4
    ...
    //   199: astore 5
    //   201: iload_1
    //   202: invokestatic 231	java/lang/Integer:toString	(I)Ljava/lang/String;
    //   205: astore 9
    //   207: aload 4
    //   209: astore 5
    //   211: aload 8
    ...
    //   233: aload 6
    //   235: aload 9
    //   237: invokevirtual 235	android/database/sqlite/SQLiteDatabase:query	(Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   240: astore 6
    //   242: aload 6
    //   244: invokeinterface 241 1 0
    //   249: ifeq +53 -> 302
    //   252: iconst_0
    //   253: istore_1
    //   254: aload 6
    //   256: checkcast 343	android/database/sqlite/SQLiteCursor
    //   259: invokevirtual 347	android/database/sqlite/SQLiteCursor:getWindow	()Landroid/database/CursorWindow;
    //   262: invokevirtual 352	android/database/CursorWindow:getNumRows	()I
    //   265: ifle +136 -> 401
    //   268: aload 7
    //   270: iload_1
    //   271: invokeinterface 356 2 0
    //   276: checkcast 338	com/google/tagmanager/Hit
    //   279: aload 6
    //   281: iconst_1
    //   282: invokeinterface 359 2 0
    //   287: invokevirtual 361	com/google/tagmanager/Hit:a	(Ljava/lang/String;)V
    //   290: aload 6
    ...
    //   326: aload 7
    //   328: astore 5
    //   330: new 146	java/lang/StringBuilder
    //   333: dup
    //   334: invokespecial 147	java/lang/StringBuilder:<init>	()V
    //   337: ldc_w 257
    //   340: invokevirtual 153	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   343: aload 6
    //   345: invokevirtual 260	android/database/sqlite/SQLiteException:getMessage	()Ljava/lang/String;
    //   348: invokevirtual 153	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   351: invokevirtual 160	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   354: invokestatic 110	com/google/tagmanager/Log:b	(Ljava/lang/String;)V
    //   357: aload 4
    //   359: astore 6
    //   361: aload 5
    //   363: ifnull -336 -> 27
    //   366: aload 5
    //   368: invokeinterface 255 1 0
    //   373: aload 4
    //   375: areturn
    //   376: astore 6
    //   378: aload 4
    ...
    //   410: aload 7
    //   412: iload_1
    //   413: invokeinterface 356 2 0
    //   418: checkcast 338	com/google/tagmanager/Hit
    //   421: invokevirtual 364	com/google/tagmanager/Hit:a	()J
    //   424: invokestatic 132	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   427: aastore
    //   428: invokestatic 49	java/lang/String:format	(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    //   431: invokestatic 110	com/google/tagmanager/Log:b	(Ljava/lang/String;)V
    //   434: goto -144 -> 290
    //   437: astore 5
    //   439: aload 6
    //   441: astore 4
    ...
    //   447: aload 4
    //   449: astore 5
    //   451: new 146	java/lang/StringBuilder
    //   454: dup
    //   455: invokespecial 147	java/lang/StringBuilder:<init>	()V
    //   458: ldc_w 366
    //   461: invokevirtual 153	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   464: aload 6
    //   466: invokevirtual 260	android/database/sqlite/SQLiteException:getMessage	()Ljava/lang/String;
    //   469: invokevirtual 153	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   472: invokevirtual 160	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   475: invokestatic 110	com/google/tagmanager/Log:b	(Ljava/lang/String;)V
    //   478: aload 4
    //   480: astore 5
    //   482: new 221	java/util/ArrayList
    //   485: dup
    //   486: invokespecial 222	java/util/ArrayList:<init>	()V
    //   489: astore 6
    //   491: iconst_0
    //   492: istore_1
    //   493: aload 4
    //   495: astore 5
    //   497: aload 7
    //   499: invokeinterface 370 1 0
    //   504: astore 7
    //   506: aload 4
    //   508: astore 5
    //   510: aload 7
    //   512: invokeinterface 375 1 0
    //   517: ifeq +42 -> 559
    //   520: aload 4
    //   522: astore 5
    //   524: aload 7
    //   526: invokeinterface 379 1 0
    //   531: checkcast 338	com/google/tagmanager/Hit
    //   534: astore 8
    //   536: aload 4
    //   538: astore 5
    //   540: aload 8
    //   542: invokevirtual 381	com/google/tagmanager/Hit:c	()Ljava/lang/String;
    //   545: invokestatic 384	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   548: istore_3
    //   549: iload_1
    //   550: istore_2
    //   551: iload_3
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	681	0	this	PersistentHitStore
  ...
  int d()
  {
    ...
    //   3: aload_0
    //   4: ldc 122
    //   6: invokespecial 124	com/google/tagmanager/PersistentHitStore:a	(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    //   9: astore_3
    //   10: aload_3
    //   11: ifnonnull +5 -> 16
    //   14: iconst_0
    ...
    //   38: aconst_null
    //   39: aconst_null
    //   40: invokevirtual 398	android/database/sqlite/SQLiteDatabase:query	(Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   43: astore_3
    //   44: aload_3
    //   45: invokeinterface 401 1 0
    //   50: istore_2
    //   51: iload_2
    //   52: istore_1
    //   53: aload_3
    ...
    //   69: astore_3
    //   70: ldc_w 403
    //   73: invokestatic 110	com/google/tagmanager/Log:b	(Ljava/lang/String;)V
    //   76: aload_3
    //   77: ifnull +56 -> 133
    //   80: aload_3
    //   81: invokeinterface 255 1 0
    //   86: iconst_0
    //   87: istore_1
    //   88: goto -23 -> 65
    //   91: astore_3
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	138	0	this	PersistentHitStore
    //   52	83	1	i	int
    //   50	14	2	j	int
    ...
    implements SimpleNetworkDispatcher.DispatchListener
  {
    ...
    {
      PersistentHitStore.a(PersistentHitStore.this, paramHit.a());
    }
    ...
    public void c(Hit paramHit)
    {
      long l = paramHit.b();
      if (l == 0L) {
        PersistentHitStore.a(PersistentHitStore.this, paramHit.a(), PersistentHitStore.a(PersistentHitStore.this).a());
      }
      while (l + 14400000L >= PersistentHitStore.a(PersistentHitStore.this).a()) {
        return;
      }
      PersistentHitStore.a(PersistentHitStore.this, paramHit.a());
    ...
    extends SQLiteOpenHelper
  {
    ...
    private boolean a(String paramString, SQLiteDatabase paramSQLiteDatabase)
    {
      ...
      // Local variable table:
      //   start	length	slot	name	signature
      //   0	117	0	this	UrlDatabaseHelper
    ...
    {
      if ((this.b) && (this.c + 3600000L > PersistentHitStore.a(PersistentHitStore.this).a())) {
        throw new SQLiteException("Database creation failed");
      }
      Object localObject1 = null;
      this.b = true;
      this.c = PersistentHitStore.a(PersistentHitStore.this).a();
      try
      {
      ...
      catch (SQLiteException localSQLiteException)
      {
        ...
        {
          Object localObject2;
          PersistentHitStore.c(PersistentHitStore.this).getDatabasePath(PersistentHitStore.b(PersistentHitStore.this)).delete();
        }
      }
