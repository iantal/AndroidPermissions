  ...
  implements SafeParcelable
{
  ...
  public AdSizeParcel(Context paramContext, AdSize[] paramArrayOfAdSize)
  {
    ...
    if (this.zztZ)
    {
      this.width = AdSize.a.b();
      this.height = AdSize.a.a();
      if (this.width != -1) {
        break label312;
      }
      j = 1;
      ...
      if ((!zzl.a().c(paramContext)) || (!zzl.a().d(paramContext))) {
        break label324;
      }
      this.widthPixels = (zza(localDisplayMetrics) - zzl.a().e(paramContext));
      ...
      label180:
      this.heightPixels = zzl.a().a(localDisplayMetrics, m);
      if ((j == 0) && (k == 0)) {
        break label370;
      }
      this.zztV = (i + "x" + m + "_as");
    ...
    for (;;)
    {
      ...
      this.width = localAdSize.b();
      this.height = localAdSize.a();
      break;
      label312:
      j = 0;
      break label66;
      ...
      label336:
      i = this.width;
      this.widthPixels = zzl.a().a(localDisplayMetrics, this.width);
      break label168;
      label361:
      m = this.height;
      break label180;
  ...
  public AdSize zzcL()
  {
    return com.google.android.gms.ads.zza.a(this.width, this.height, this.zztV);
  }
