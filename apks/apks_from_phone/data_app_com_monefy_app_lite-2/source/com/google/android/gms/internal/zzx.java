...
public class zzx
{
  ...
  public static zzb.zza a(zzi paramZzi)
  {
    long l6 = System.currentTimeMillis();
    Map localMap = paramZzi.c;
    long l3 = 0L;
    long l2 = 0L;
    long l1 = 0L;
      ...
      if (localObject1 != null)
      {
        ...
        if (localObject1 != null)
        {
          ...
          for (;;)
          {
            ...
            ((zzb.zza)localObject2).a = paramZzi.b;
            ((zzb.zza)localObject2).b = ((String)localObject1);
            ((zzb.zza)localObject2).f = l2;
            ((zzb.zza)localObject2).e = l1;
            ((zzb.zza)localObject2).c = l3;
            ((zzb.zza)localObject2).d = l4;
            ((zzb.zza)localObject2).g = localMap;
            return localObject2;
            l1 = 1000L * l1 + l2;
            continue;
            if ((l3 <= 0L) || (l5 < l3)) {
