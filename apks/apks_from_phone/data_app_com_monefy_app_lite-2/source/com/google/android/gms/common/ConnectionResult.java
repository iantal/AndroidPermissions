  ...
  implements SafeParcelable
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    } while ((this.zzabx == paramObject.zzabx) && (zzw.a(this.mPendingIntent, paramObject.mPendingIntent)) && (zzw.a(this.zzadS, paramObject.zzadS)));
    return false;
  }
  ...
  public int hashCode()
  {
    return zzw.a(new Object[] { Integer.valueOf(this.zzabx), this.mPendingIntent, this.zzadS });
  }
  ...
  {
    return zzw.a(this).a("statusCode", getStatusString(this.zzabx)).a("resolution", this.mPendingIntent).a("message", this.zzadS).toString();
  }
