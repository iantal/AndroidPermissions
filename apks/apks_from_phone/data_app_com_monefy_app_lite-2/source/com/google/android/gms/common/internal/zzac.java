  ...
  extends Button
{
  ...
  {
    if (paramBoolean) {}
    for (paramInt1 = a(paramInt1, a(paramInt2, R.drawable.common_plus_signin_btn_icon_dark, R.drawable.common_plus_signin_btn_icon_light, R.drawable.common_plus_signin_btn_icon_dark), a(paramInt2, R.drawable.common_plus_signin_btn_text_dark, R.drawable.common_plus_signin_btn_text_light, R.drawable.common_plus_signin_btn_text_dark));; paramInt1 = a(paramInt1, a(paramInt2, R.drawable.common_google_signin_btn_icon_dark, R.drawable.common_google_signin_btn_icon_light, R.drawable.common_google_signin_btn_icon_light), a(paramInt2, R.drawable.common_google_signin_btn_text_dark, R.drawable.common_google_signin_btn_text_light, R.drawable.common_google_signin_btn_text_light)))
    {
  ...
  private boolean a(Scope[] paramArrayOfScope)
  {
  ...
  {
    if (paramBoolean) {}
    for (paramInt2 = a(paramInt2, R.color.common_plus_signin_btn_text_dark, R.color.common_plus_signin_btn_text_light, R.color.common_plus_signin_btn_text_dark);; paramInt2 = a(paramInt2, R.color.common_google_signin_btn_text_dark, R.color.common_google_signin_btn_text_light, R.color.common_google_signin_btn_text_light))
    {
      setTextColor((ColorStateList)zzx.a(paramResources.getColorStateList(paramInt2)));
      switch (paramInt1)
      {
      default: 
        throw new IllegalStateException("Unknown button size: " + paramInt1);
  ...
  public void a(Resources paramResources, int paramInt1, int paramInt2, Scope[] paramArrayOfScope)
  {
