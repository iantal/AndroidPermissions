  ...
  extends View
{
  ...
  private void a(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      float f2 = this.n[1];
      float f3 = this.o;
      this.m = Color.HSVToColor(new float[] { f1, f2, 1.0F - paramInt * f3 });
      return;
      paramInt = i1;
      if (i1 > this.b) {
        paramInt = this.b;
  ...
  protected void onSizeChanged(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if (this.r == true)
    {
      ...
      this.k = new LinearGradient(f1, 0.0F, f2, f3, new int[] { paramInt1, -16777216 }, null, (Shader.TileMode)localObject);
    }
    for (;;)
    {
      this.g.setShader(this.k);
      ...
      f1 = this.b;
      f2 = this.p;
      this.f = Math.round(f1 - localObject[2] * f2 + this.e);
      return;
      paramInt1 = this.a;
      paramInt3 = this.b;
      paramInt4 = this.e;
      ...
      f3 = paramInt2;
      localObject = Shader.TileMode.CLAMP;
      this.k = new LinearGradient(f1, 0.0F, f2, f3, new int[] { -8257792, -16777216 }, null, (Shader.TileMode)localObject);
  ...
  public void setColor(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      this.k = new LinearGradient(f1, 0.0F, f2, f3, new int[] { paramInt, -16777216 }, null, localTileMode);
      this.g.setShader(this.k);
      a(this.f);
      this.h.setColor(this.m);
      if (this.q != null)
  ...
  {
    this.f = Math.round(this.b - this.p * paramFloat + this.e);
    a(this.f);
    this.h.setColor(this.m);
    if (this.q != null)
    {
