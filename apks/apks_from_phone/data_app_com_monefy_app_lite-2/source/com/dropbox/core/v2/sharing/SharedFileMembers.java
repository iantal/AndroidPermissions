...
public class SharedFileMembers
{
  ...
  public SharedFileMembers(List<UserMembershipInfo> paramList, List<GroupMembershipInfo> paramList1, List<InviteeMembershipInfo> paramList2)
  {
    this(paramList, paramList1, paramList2, null);
  }
  
  public SharedFileMembers(List<UserMembershipInfo> paramList, List<GroupMembershipInfo> paramList1, List<InviteeMembershipInfo> paramList2, String paramString)
  {
    if (paramList == null) {
    ...
    extends StructSerializer<SharedFileMembers>
  {
    ...
    public SharedFileMembers deserialize(JsonParser paramJsonParser, boolean paramBoolean)
    {
      ...
      for (Object localObject1 = readTag(paramJsonParser);; localObject1 = null)
      {
        if (localObject1 == null)
        {
          ...
          localObject1 = new SharedFileMembers(localObject2, localObject4, localObject3, (String)localObject1);
          if (!paramBoolean) {
    ...
    public void serialize(SharedFileMembers paramSharedFileMembers, JsonGenerator paramJsonGenerator, boolean paramBoolean)
    {
      if (!paramBoolean) {
        paramJsonGenerator.writeStartObject();
      }
      paramJsonGenerator.writeFieldName("users");
      StoneSerializers.list(UserMembershipInfo.Serializer.INSTANCE).serialize(paramSharedFileMembers.users, paramJsonGenerator);
      paramJsonGenerator.writeFieldName("groups");
      StoneSerializers.list(GroupMembershipInfo.Serializer.INSTANCE).serialize(paramSharedFileMembers.groups, paramJsonGenerator);
      paramJsonGenerator.writeFieldName("invitees");
      StoneSerializers.list(InviteeMembershipInfo.Serializer.INSTANCE).serialize(paramSharedFileMembers.invitees, paramJsonGenerator);
      if (paramSharedFileMembers.cursor != null)
      {
        paramJsonGenerator.writeFieldName("cursor");
        StoneSerializers.nullable(StoneSerializers.string()).serialize(paramSharedFileMembers.cursor, paramJsonGenerator);
      }
      if (!paramBoolean) {
