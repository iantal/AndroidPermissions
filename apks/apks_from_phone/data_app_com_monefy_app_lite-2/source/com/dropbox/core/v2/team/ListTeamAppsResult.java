...
public class ListTeamAppsResult
{
    ...
    extends StructSerializer<ListTeamAppsResult>
  {
    ...
    public ListTeamAppsResult deserialize(JsonParser paramJsonParser, boolean paramBoolean)
    {
      ...
      for (Object localObject1 = readTag(paramJsonParser);; localObject1 = null)
      {
        if (localObject1 == null)
        {
          ...
          localObject1 = new ListTeamAppsResult(localObject2, localObject3.booleanValue(), (String)localObject1);
          if (!paramBoolean) {
    ...
    public void serialize(ListTeamAppsResult paramListTeamAppsResult, JsonGenerator paramJsonGenerator, boolean paramBoolean)
    {
      if (!paramBoolean) {
        paramJsonGenerator.writeStartObject();
      }
      paramJsonGenerator.writeFieldName("apps");
      StoneSerializers.list(MemberLinkedApps.Serializer.INSTANCE).serialize(paramListTeamAppsResult.apps, paramJsonGenerator);
      paramJsonGenerator.writeFieldName("has_more");
      StoneSerializers.boolean_().serialize(Boolean.valueOf(paramListTeamAppsResult.hasMore), paramJsonGenerator);
      if (paramListTeamAppsResult.cursor != null)
      {
        paramJsonGenerator.writeFieldName("cursor");
        StoneSerializers.nullable(StoneSerializers.string()).serialize(paramListTeamAppsResult.cursor, paramJsonGenerator);
      }
      if (!paramBoolean) {
