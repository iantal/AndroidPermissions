...
public class LinkPermission
{
    ...
    extends StructSerializer<LinkPermission>
  {
    ...
    public LinkPermission deserialize(JsonParser paramJsonParser, boolean paramBoolean)
    {
      ...
      for (Object localObject1 = readTag(paramJsonParser);; localObject1 = null)
      {
        if (localObject1 == null)
        {
          ...
          if (paramJsonParser.getCurrentToken() == JsonToken.FIELD_NAME)
          {
            ...
            {
              localObject4 = LinkAction.Serializer.INSTANCE.deserialize(paramJsonParser);
          ...
          localObject1 = new LinkPermission(localObject2, localObject3.booleanValue(), (PermissionDeniedReason)localObject1);
          if (!paramBoolean) {
    ...
    public void serialize(LinkPermission paramLinkPermission, JsonGenerator paramJsonGenerator, boolean paramBoolean)
    {
      if (!paramBoolean) {
        paramJsonGenerator.writeStartObject();
      }
      paramJsonGenerator.writeFieldName("action");
      LinkAction.Serializer.INSTANCE.serialize(paramLinkPermission.action, paramJsonGenerator);
      paramJsonGenerator.writeFieldName("allow");
      StoneSerializers.boolean_().serialize(Boolean.valueOf(paramLinkPermission.allow), paramJsonGenerator);
      if (paramLinkPermission.reason != null)
      {
        paramJsonGenerator.writeFieldName("reason");
        StoneSerializers.nullable(PermissionDeniedReason.Serializer.INSTANCE).serialize(paramLinkPermission.reason, paramJsonGenerator);
      }
      if (!paramBoolean) {
