...
public class DeleteArg
{
    ...
    extends StructSerializer<DeleteArg>
  {
    ...
    public DeleteArg deserialize(JsonParser paramJsonParser, boolean paramBoolean)
    {
      String str = null;
      if (!paramBoolean) {
      ...
      for (Object localObject = readTag(paramJsonParser);; localObject = null)
      {
        if (localObject == null)
        {
          ...
          localObject = new DeleteArg((String)localObject);
          if (!paramBoolean) {
    ...
    public void serialize(DeleteArg paramDeleteArg, JsonGenerator paramJsonGenerator, boolean paramBoolean)
    {
      if (!paramBoolean) {
        paramJsonGenerator.writeStartObject();
      }
      paramJsonGenerator.writeFieldName("path");
      StoneSerializers.string().serialize(paramDeleteArg.path, paramJsonGenerator);
      if (!paramBoolean) {
