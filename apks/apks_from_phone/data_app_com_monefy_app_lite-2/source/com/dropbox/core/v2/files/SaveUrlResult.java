...
public final class SaveUrlResult
{
  ...
  private SaveUrlResult(Tag paramTag, String paramString, FileMetadata paramFileMetadata)
  {
    this._tag = paramTag;
    this.asyncJobIdValue = paramString;
    this.completeValue = paramFileMetadata;
  }
  ...
  public static SaveUrlResult asyncJobId(String paramString)
  {
    ...
    return new SaveUrlResult(Tag.ASYNC_JOB_ID, paramString, null);
  }
  ...
  public static SaveUrlResult complete(FileMetadata paramFileMetadata)
  {
    ...
    return new SaveUrlResult(Tag.COMPLETE, null, paramFileMetadata);
  }
      ...
      do
      {
        do
        {
          do
          {
            return bool1;
            bool1 = bool2;
          } while (!(paramObject instanceof SaveUrlResult));
          paramObject = (SaveUrlResult)paramObject;
          bool1 = bool2;
        } while (this._tag != paramObject._tag);
        switch (1.$SwitchMap$com$dropbox$core$v2$files$SaveUrlResult$Tag[this._tag.ordinal()])
        {
        default: 
          return false;
        case 1: 
    ...
    extends UnionSerializer<SaveUrlResult>
  {
    ...
    public SaveUrlResult deserialize(JsonParser paramJsonParser)
    {
      int i;
      ...
      for (Object localObject = SaveUrlResult.asyncJobId((String)StoneSerializers.string().deserialize(paramJsonParser));; localObject = SaveUrlResult.complete(FileMetadata.Serializer.INSTANCE.deserialize(paramJsonParser, true)))
      {
        if (i == 0)
        {
    ...
    public void serialize(SaveUrlResult paramSaveUrlResult, JsonGenerator paramJsonGenerator)
    {
      switch (SaveUrlResult.1.$SwitchMap$com$dropbox$core$v2$files$SaveUrlResult$Tag[paramSaveUrlResult.tag().ordinal()])
      {
      default: 
        throw new IllegalArgumentException("Unrecognized tag: " + paramSaveUrlResult.tag());
      case 1: 
        paramJsonGenerator.writeStartObject();
        writeTag("async_job_id", paramJsonGenerator);
        paramJsonGenerator.writeFieldName("async_job_id");
        StoneSerializers.string().serialize(paramSaveUrlResult.asyncJobIdValue, paramJsonGenerator);
        paramJsonGenerator.writeEndObject();
        return;
      }
      paramJsonGenerator.writeStartObject();
      writeTag("complete", paramJsonGenerator);
      FileMetadata.Serializer.INSTANCE.serialize(paramSaveUrlResult.completeValue, paramJsonGenerator, true);
      paramJsonGenerator.writeEndObject();
    }
  }
