...
public class DeleteResult
{
    ...
    extends StructSerializer<DeleteResult>
  {
    ...
    public DeleteResult deserialize(JsonParser paramJsonParser, boolean paramBoolean)
    {
      String str = null;
      if (!paramBoolean) {
      ...
      for (Object localObject = readTag(paramJsonParser);; localObject = null)
      {
        if (localObject == null)
        {
          ...
          localObject = new DeleteResult((Metadata)localObject);
          if (!paramBoolean) {
    ...
    public void serialize(DeleteResult paramDeleteResult, JsonGenerator paramJsonGenerator, boolean paramBoolean)
    {
      if (!paramBoolean) {
        paramJsonGenerator.writeStartObject();
      }
      paramJsonGenerator.writeFieldName("metadata");
      Metadata.Serializer.INSTANCE.serialize(paramDeleteResult.metadata, paramJsonGenerator);
      if (!paramBoolean) {
