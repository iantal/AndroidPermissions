...
public class ListFolderGetLatestCursorResult
{
    ...
    extends StructSerializer<ListFolderGetLatestCursorResult>
  {
    ...
    public ListFolderGetLatestCursorResult deserialize(JsonParser paramJsonParser, boolean paramBoolean)
    {
      String str = null;
      if (!paramBoolean) {
      ...
      for (Object localObject = readTag(paramJsonParser);; localObject = null)
      {
        if (localObject == null)
        {
          ...
          localObject = new ListFolderGetLatestCursorResult((String)localObject);
          if (!paramBoolean) {
    ...
    public void serialize(ListFolderGetLatestCursorResult paramListFolderGetLatestCursorResult, JsonGenerator paramJsonGenerator, boolean paramBoolean)
    {
      if (!paramBoolean) {
        paramJsonGenerator.writeStartObject();
      }
      paramJsonGenerator.writeFieldName("cursor");
      StoneSerializers.string().serialize(paramListFolderGetLatestCursorResult.cursor, paramJsonGenerator);
      if (!paramBoolean) {
