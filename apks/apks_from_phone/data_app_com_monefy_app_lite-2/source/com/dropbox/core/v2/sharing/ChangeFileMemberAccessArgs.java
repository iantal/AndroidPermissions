...
class ChangeFileMemberAccessArgs
{
  ...
  public ChangeFileMemberAccessArgs(String paramString, MemberSelector paramMemberSelector, AccessLevel paramAccessLevel)
  {
    if (paramString == null) {
  ...
  public boolean equals(Object paramObject)
  {
    ...
    do
    {
      ...
      paramObject = (ChangeFileMemberAccessArgs)paramObject;
  ...
  static class Serializer
    extends StructSerializer<ChangeFileMemberAccessArgs>
  {
    public static final Serializer INSTANCE = new Serializer();
    
    Serializer() {}
    
    public ChangeFileMemberAccessArgs deserialize(JsonParser paramJsonParser, boolean paramBoolean)
    {
      ...
      for (Object localObject1 = readTag(paramJsonParser);; localObject1 = null)
      {
        if (localObject1 == null)
        {
          ...
          localObject1 = new ChangeFileMemberAccessArgs(localObject2, localObject3, (AccessLevel)localObject1);
          if (!paramBoolean) {
    ...
    public void serialize(ChangeFileMemberAccessArgs paramChangeFileMemberAccessArgs, JsonGenerator paramJsonGenerator, boolean paramBoolean)
    {
      if (!paramBoolean) {
        paramJsonGenerator.writeStartObject();
      }
      paramJsonGenerator.writeFieldName("file");
      StoneSerializers.string().serialize(paramChangeFileMemberAccessArgs.file, paramJsonGenerator);
      paramJsonGenerator.writeFieldName("member");
      MemberSelector.Serializer.INSTANCE.serialize(paramChangeFileMemberAccessArgs.member, paramJsonGenerator);
      paramJsonGenerator.writeFieldName("access_level");
      AccessLevel.Serializer.INSTANCE.serialize(paramChangeFileMemberAccessArgs.accessLevel, paramJsonGenerator);
      if (!paramBoolean) {
