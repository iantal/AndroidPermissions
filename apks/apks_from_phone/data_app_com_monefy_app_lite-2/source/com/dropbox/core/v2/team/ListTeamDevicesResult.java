...
public class ListTeamDevicesResult
{
    ...
    extends StructSerializer<ListTeamDevicesResult>
  {
    ...
    public ListTeamDevicesResult deserialize(JsonParser paramJsonParser, boolean paramBoolean)
    {
      ...
      for (Object localObject1 = readTag(paramJsonParser);; localObject1 = null)
      {
        if (localObject1 == null)
        {
          ...
          localObject1 = new ListTeamDevicesResult(localObject2, localObject3.booleanValue(), (String)localObject1);
          if (!paramBoolean) {
    ...
    public void serialize(ListTeamDevicesResult paramListTeamDevicesResult, JsonGenerator paramJsonGenerator, boolean paramBoolean)
    {
      if (!paramBoolean) {
        paramJsonGenerator.writeStartObject();
      }
      paramJsonGenerator.writeFieldName("devices");
      StoneSerializers.list(MemberDevices.Serializer.INSTANCE).serialize(paramListTeamDevicesResult.devices, paramJsonGenerator);
      paramJsonGenerator.writeFieldName("has_more");
      StoneSerializers.boolean_().serialize(Boolean.valueOf(paramListTeamDevicesResult.hasMore), paramJsonGenerator);
      if (paramListTeamDevicesResult.cursor != null)
      {
        paramJsonGenerator.writeFieldName("cursor");
        StoneSerializers.nullable(StoneSerializers.string()).serialize(paramListTeamDevicesResult.cursor, paramJsonGenerator);
      }
      if (!paramBoolean) {
