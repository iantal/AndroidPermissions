...
class UnmountFolderArg
{
  ...
  public UnmountFolderArg(String paramString)
  {
    if (paramString == null) {
  ...
  public boolean equals(Object paramObject)
  {
    ...
    do
    {
      ...
      paramObject = (UnmountFolderArg)paramObject;
  ...
  static class Serializer
    extends StructSerializer<UnmountFolderArg>
  {
    public static final Serializer INSTANCE = new Serializer();
    
    Serializer() {}
    
    public UnmountFolderArg deserialize(JsonParser paramJsonParser, boolean paramBoolean)
    {
      String str = null;
      if (!paramBoolean) {
      ...
      for (Object localObject = readTag(paramJsonParser);; localObject = null)
      {
        if (localObject == null)
        {
          ...
          localObject = new UnmountFolderArg((String)localObject);
          if (!paramBoolean) {
    ...
    public void serialize(UnmountFolderArg paramUnmountFolderArg, JsonGenerator paramJsonGenerator, boolean paramBoolean)
    {
      if (!paramBoolean) {
        paramJsonGenerator.writeStartObject();
      }
      paramJsonGenerator.writeFieldName("shared_folder_id");
      StoneSerializers.string().serialize(paramUnmountFolderArg.sharedFolderId, paramJsonGenerator);
      if (!paramBoolean) {
