...
class ListTeamDevicesArg
{
    ...
    extends StructSerializer<ListTeamDevicesArg>
  {
    ...
    public ListTeamDevicesArg deserialize(JsonParser paramJsonParser, boolean paramBoolean)
    {
      ...
      for (Object localObject1 = readTag(paramJsonParser);; localObject1 = null)
      {
        if (localObject1 == null)
        {
          ...
          localObject1 = new ListTeamDevicesArg(localObject2, ((Boolean)localObject4).booleanValue(), ((Boolean)localObject3).booleanValue(), ((Boolean)localObject1).booleanValue());
          if (!paramBoolean) {
    ...
    public void serialize(ListTeamDevicesArg paramListTeamDevicesArg, JsonGenerator paramJsonGenerator, boolean paramBoolean)
    {
      if (!paramBoolean) {
        paramJsonGenerator.writeStartObject();
      }
      if (paramListTeamDevicesArg.cursor != null)
      {
        paramJsonGenerator.writeFieldName("cursor");
        StoneSerializers.nullable(StoneSerializers.string()).serialize(paramListTeamDevicesArg.cursor, paramJsonGenerator);
      }
      paramJsonGenerator.writeFieldName("include_web_sessions");
      StoneSerializers.boolean_().serialize(Boolean.valueOf(paramListTeamDevicesArg.includeWebSessions), paramJsonGenerator);
      paramJsonGenerator.writeFieldName("include_desktop_clients");
      StoneSerializers.boolean_().serialize(Boolean.valueOf(paramListTeamDevicesArg.includeDesktopClients), paramJsonGenerator);
      paramJsonGenerator.writeFieldName("include_mobile_clients");
      StoneSerializers.boolean_().serialize(Boolean.valueOf(paramListTeamDevicesArg.includeMobileClients), paramJsonGenerator);
      if (!paramBoolean) {
