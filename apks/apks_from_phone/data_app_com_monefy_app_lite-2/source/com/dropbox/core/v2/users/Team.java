...
public class Team
{
  ...
  public Team(String paramString1, String paramString2)
  {
  ...
  public static class Serializer
    extends StructSerializer<Team>
  {
    public static final Serializer INSTANCE = new Serializer();
    
    public Serializer() {}
    
    public Team deserialize(JsonParser paramJsonParser, boolean paramBoolean)
    {
      ...
      for (Object localObject1 = readTag(paramJsonParser);; localObject1 = null)
      {
        if (localObject1 == null)
        {
          ...
          localObject1 = new Team((String)localObject1, localObject2);
          if (!paramBoolean) {
    ...
    public void serialize(Team paramTeam, JsonGenerator paramJsonGenerator, boolean paramBoolean)
    {
      if (!paramBoolean) {
        paramJsonGenerator.writeStartObject();
      }
      paramJsonGenerator.writeFieldName("id");
      StoneSerializers.string().serialize(paramTeam.id, paramJsonGenerator);
      paramJsonGenerator.writeFieldName("name");
      StoneSerializers.string().serialize(paramTeam.name, paramJsonGenerator);
      if (!paramBoolean) {
