...
class DownloadArg
{
  ...
  public DownloadArg(String paramString)
  {
    this(paramString, null);
  }
  
  public DownloadArg(String paramString1, String paramString2)
  {
  ...
  public boolean equals(Object paramObject)
  {
    ...
    do
    {
      ...
      paramObject = (DownloadArg)paramObject;
  ...
  static class Serializer
    extends StructSerializer<DownloadArg>
  {
    public static final Serializer INSTANCE = new Serializer();
    
    Serializer() {}
    
    public DownloadArg deserialize(JsonParser paramJsonParser, boolean paramBoolean)
    {
      ...
      for (Object localObject1 = readTag(paramJsonParser);; localObject1 = null)
      {
        if (localObject1 == null)
        {
          ...
          localObject1 = new DownloadArg((String)localObject1, localObject2);
          if (!paramBoolean) {
    ...
    public void serialize(DownloadArg paramDownloadArg, JsonGenerator paramJsonGenerator, boolean paramBoolean)
    {
      if (!paramBoolean) {
        paramJsonGenerator.writeStartObject();
      }
      paramJsonGenerator.writeFieldName("path");
      StoneSerializers.string().serialize(paramDownloadArg.path, paramJsonGenerator);
      if (paramDownloadArg.rev != null)
      {
        paramJsonGenerator.writeFieldName("rev");
        StoneSerializers.nullable(StoneSerializers.string()).serialize(paramDownloadArg.rev, paramJsonGenerator);
      }
      if (!paramBoolean) {
