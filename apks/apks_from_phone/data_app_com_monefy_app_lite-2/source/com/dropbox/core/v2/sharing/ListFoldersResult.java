...
public class ListFoldersResult
{
    ...
    extends StructSerializer<ListFoldersResult>
  {
    ...
    public ListFoldersResult deserialize(JsonParser paramJsonParser, boolean paramBoolean)
    {
      ...
      for (Object localObject1 = readTag(paramJsonParser);; localObject1 = null)
      {
        if (localObject1 == null)
        {
          ...
          if (paramJsonParser.getCurrentToken() == JsonToken.FIELD_NAME)
          {
            ...
            {
              localObject3 = (List)StoneSerializers.list(SharedFolderMetadata.Serializer.INSTANCE).deserialize(paramJsonParser);
          ...
          localObject1 = new ListFoldersResult((List)localObject1, localObject2);
          if (!paramBoolean) {
    ...
    public void serialize(ListFoldersResult paramListFoldersResult, JsonGenerator paramJsonGenerator, boolean paramBoolean)
    {
      if (!paramBoolean) {
        paramJsonGenerator.writeStartObject();
      }
      paramJsonGenerator.writeFieldName("entries");
      StoneSerializers.list(SharedFolderMetadata.Serializer.INSTANCE).serialize(paramListFoldersResult.entries, paramJsonGenerator);
      if (paramListFoldersResult.cursor != null)
      {
        paramJsonGenerator.writeFieldName("cursor");
        StoneSerializers.nullable(StoneSerializers.string()).serialize(paramListFoldersResult.cursor, paramJsonGenerator);
      }
      if (!paramBoolean) {
