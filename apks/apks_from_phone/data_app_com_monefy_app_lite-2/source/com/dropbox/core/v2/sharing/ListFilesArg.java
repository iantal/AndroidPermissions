...
class ListFilesArg
{
    ...
    extends StructSerializer<ListFilesArg>
  {
    ...
    public ListFilesArg deserialize(JsonParser paramJsonParser, boolean paramBoolean)
    {
      ...
      for (Object localObject1 = readTag(paramJsonParser);; localObject1 = null)
      {
        if (localObject1 == null)
        {
          ...
          localObject1 = new ListFilesArg(((Long)localObject1).longValue(), localObject2);
          if (!paramBoolean) {
    ...
    public void serialize(ListFilesArg paramListFilesArg, JsonGenerator paramJsonGenerator, boolean paramBoolean)
    {
      if (!paramBoolean) {
        paramJsonGenerator.writeStartObject();
      }
      paramJsonGenerator.writeFieldName("limit");
      StoneSerializers.uInt32().serialize(Long.valueOf(paramListFilesArg.limit), paramJsonGenerator);
      if (paramListFilesArg.actions != null)
      {
        paramJsonGenerator.writeFieldName("actions");
        StoneSerializers.nullable(StoneSerializers.list(FileAction.Serializer.INSTANCE)).serialize(paramListFilesArg.actions, paramJsonGenerator);
      }
      if (!paramBoolean) {
