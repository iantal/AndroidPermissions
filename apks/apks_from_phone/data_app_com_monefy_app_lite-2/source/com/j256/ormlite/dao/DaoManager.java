...
public class DaoManager
{
  ...
  public static <D extends Dao<T, ?>, T> D createDao(ConnectionSource paramConnectionSource, Class<T> paramClass)
  {
    ...
    Object localObject1 = lookupDao(new ClassConnectionSource(paramConnectionSource, paramClass));
  ...
  private static <D extends Dao<T, ?>, T> D doCreateDao(ConnectionSource paramConnectionSource, DatabaseTableConfig<T> paramDatabaseTableConfig)
  {
    ...
    localObject1 = new ClassConnectionSource(paramConnectionSource, localClass);
    Object localObject2 = lookupDao((ClassConnectionSource)localObject1);
    ...
    for (;;)
    {
      ...
      if (lookupDao((ClassConnectionSource)localObject1) != null) {
        break;
      }
      addDaoToClassMap((ClassConnectionSource)localObject1, paramConnectionSource);
      return paramConnectionSource;
  ...
  private static class ClassConnectionSource
  {
    ...
    public boolean equals(Object paramObject)
    {
      ...
      } while ((!this.clazz.equals(paramObject.clazz)) || (!this.connectionSource.equals(paramObject.connectionSource)));
      return true;
    }
  ...
  private static class TableConfigConnectionSource
  {
    ...
    public boolean equals(Object paramObject)
    {
      ...
      } while ((!this.tableConfig.equals(paramObject.tableConfig)) || (!this.connectionSource.equals(paramObject.connectionSource)));
      return true;
    }
