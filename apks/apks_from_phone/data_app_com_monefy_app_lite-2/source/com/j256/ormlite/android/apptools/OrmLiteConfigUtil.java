...
public class OrmLiteConfigUtil
{
  ...
  private static void findAnnotatedClasses(List<Class<?>> paramList, File paramFile, int paramInt)
  {
    // Byte code:
    //   0: aload_1
    //   1: invokevirtual 99	java/io/File:listFiles	()[Ljava/io/File;
    //   4: astore_1
    //   5: aload_1
    //   6: arraylength
    //   7: istore 5
    ...
    //   20: astore 7
    //   22: aload 7
    //   24: invokevirtual 103	java/io/File:isDirectory	()Z
    //   27: ifeq +26 -> 53
    //   30: iload_2
    ...
    //   41: iconst_1
    //   42: iadd
    //   43: invokestatic 105	com/j256/ormlite/android/apptools/OrmLiteConfigUtil:findAnnotatedClasses	(Ljava/util/List;Ljava/io/File;I)V
    //   46: iload_3
    //   47: iconst_1
    //   48: iadd
    //   49: istore_3
    //   50: goto -39 -> 11
    //   53: aload 7
    //   55: invokevirtual 108	java/io/File:getName	()Ljava/lang/String;
    //   58: ldc 110
    //   60: invokevirtual 116	java/lang/String:endsWith	(Ljava/lang/String;)Z
    //   63: ifeq -17 -> 46
    //   66: aload 7
    //   68: invokestatic 120	com/j256/ormlite/android/apptools/OrmLiteConfigUtil:getPackageOfClass	(Ljava/io/File;)Ljava/lang/String;
    //   71: astore 8
    //   73: aload 8
    //   75: ifnonnull +32 -> 107
    ...
    //   104: goto -58 -> 46
    //   107: aload 7
    //   109: invokevirtual 108	java/io/File:getName	()Ljava/lang/String;
    //   112: astore 9
    //   114: aload 9
    //   116: iconst_0
    //   117: aload 9
    //   119: invokevirtual 126	java/lang/String:length	()I
    //   122: ldc 110
    //   124: invokevirtual 126	java/lang/String:length	()I
    //   127: isub
    //   128: invokevirtual 130	java/lang/String:substring	(II)Ljava/lang/String;
    //   131: astore 9
    ...
    //   158: astore 8
    //   160: aload 8
    //   162: invokestatic 136	java/lang/Class:forName	(Ljava/lang/String;)Ljava/lang/Class;
    //   165: astore 8
    //   167: aload 8
    //   169: invokestatic 138	com/j256/ormlite/android/apptools/OrmLiteConfigUtil:classHasAnnotations	(Ljava/lang/Class;)Z
    //   172: ifeq +12 -> 184
    //   175: aload_0
    //   176: aload 8
    ...
    //   183: pop
    //   184: aload 8
    //   186: invokevirtual 148	java/lang/Class:getDeclaredClasses	()[Ljava/lang/Class;
    //   189: astore 7
    //   191: aload 7
    //   193: arraylength
    //   194: istore 6
    ...
    //   211: astore 9
    //   213: aload 9
    //   215: invokestatic 138	com/j256/ormlite/android/apptools/OrmLiteConfigUtil:classHasAnnotations	(Ljava/lang/Class;)Z
    //   218: ifeq +12 -> 230
    //   221: aload_0
    //   222: aload 9
    //   224: invokeinterface 144 2 0
    //   229: pop
    //   230: iload 4
    //   232: iconst_1
    //   233: iadd
