  ...
  extends BaseDataType
{
  ...
  public Object javaToSqlArg(FieldType paramFieldType, Object paramObject)
  {
    ...
    try
    {
      paramObject = paramObject.getBytes(paramFieldType);
      return paramObject;
    }
    catch (UnsupportedEncodingException paramObject)
    {
      throw SqlExceptionUtil.create("Could not convert string with charset name: " + paramFieldType, paramObject);
    }
  }
  ...
  public Object sqlArgToJava(FieldType paramFieldType, Object paramObject, int paramInt)
  {
    ...
    try
    {
      paramObject = new String(paramObject, paramFieldType);
      return paramObject;
    }
    catch (UnsupportedEncodingException paramObject)
    {
