  ...
  implements Log
{
  ...
  static List<PatternLevel> readLevelResourceFile(InputStream paramInputStream)
  {
    ...
    //   3: ifnull +12 -> 15
    //   6: aload_0
    //   7: invokestatic 262	com/j256/ormlite/logger/LocalLog:configureClassLevels	(Ljava/io/InputStream;)Ljava/util/List;
    //   10: astore_1
    //   11: aload_0
    //   12: invokevirtual 267	java/io/InputStream:close	()V
    //   15: aload_1
    //   16: areturn
    //   17: astore_1
    ...
    //   34: aload_1
    //   35: invokevirtual 272	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   38: invokevirtual 142	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   41: invokevirtual 185	java/io/PrintStream:println	(Ljava/lang/String;)V
    //   44: aload_0
    //   45: invokevirtual 267	java/io/InputStream:close	()V
    //   48: aconst_null
    //   49: areturn
    //   50: astore_0
    //   51: aconst_null
    ...
    //   53: astore_1
    //   54: aload_0
    //   55: invokevirtual 267	java/io/InputStream:close	()V
    //   58: aload_1
    //   59: athrow
    //   60: astore_0
    //   61: aload_1
    ...
    //   17	18	1	localIOException	java.io.IOException
