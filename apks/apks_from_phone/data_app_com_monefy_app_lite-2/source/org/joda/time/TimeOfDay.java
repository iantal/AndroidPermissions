  ...
  implements Serializable, ReadablePartial
{
    ...
    implements Serializable
  {
    ...
    {
      int[] arrayOfInt = this.iTimeOfDay.getValues();
      arrayOfInt = getField().add(this.iTimeOfDay, this.iFieldIndex, arrayOfInt, paramInt);
      return new TimeOfDay(this.iTimeOfDay, arrayOfInt);
    }
    
    public TimeOfDay addToCopy(int paramInt)
    {
      int[] arrayOfInt = this.iTimeOfDay.getValues();
      arrayOfInt = getField().addWrapPartial(this.iTimeOfDay, this.iFieldIndex, arrayOfInt, paramInt);
      return new TimeOfDay(this.iTimeOfDay, arrayOfInt);
    }
    ...
    {
      int[] arrayOfInt = this.iTimeOfDay.getValues();
      arrayOfInt = getField().addWrapField(this.iTimeOfDay, this.iFieldIndex, arrayOfInt, paramInt);
      return new TimeOfDay(this.iTimeOfDay, arrayOfInt);
    }
    ...
    {
      int[] arrayOfInt = this.iTimeOfDay.getValues();
      arrayOfInt = getField().set(this.iTimeOfDay, this.iFieldIndex, arrayOfInt, paramInt);
      return new TimeOfDay(this.iTimeOfDay, arrayOfInt);
    }
    ...
    {
      int[] arrayOfInt = this.iTimeOfDay.getValues();
      paramString = getField().set(this.iTimeOfDay, this.iFieldIndex, arrayOfInt, paramString, paramLocale);
      return new TimeOfDay(this.iTimeOfDay, paramString);
    }
