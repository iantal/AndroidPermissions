  ...
  implements Serializable, ReadablePartial
{
    ...
    implements Serializable
  {
    ...
    {
      int[] arrayOfInt = this.iBase.getValues();
      arrayOfInt = getField().add(this.iBase, this.iFieldIndex, arrayOfInt, paramInt);
      return new YearMonth(this.iBase, arrayOfInt);
    }
    
    public YearMonth addWrapFieldToCopy(int paramInt)
    {
      int[] arrayOfInt = this.iBase.getValues();
      arrayOfInt = getField().addWrapField(this.iBase, this.iFieldIndex, arrayOfInt, paramInt);
      return new YearMonth(this.iBase, arrayOfInt);
    }
    ...
    {
      int[] arrayOfInt = this.iBase.getValues();
      arrayOfInt = getField().set(this.iBase, this.iFieldIndex, arrayOfInt, paramInt);
      return new YearMonth(this.iBase, arrayOfInt);
    }
    ...
    {
      int[] arrayOfInt = this.iBase.getValues();
      paramString = getField().set(this.iBase, this.iFieldIndex, arrayOfInt, paramString, paramLocale);
      return new YearMonth(this.iBase, paramString);
    }
  }
}
