  ...
  implements Serializable
{
    ...
    if (paramInt != 0)
    {
      ...
      if (paramReadablePeriod != null)
      {
        ...
        while (i < j)
        {
          ...
          l1 = paramLong;
          if (l2 != 0L) {
            l1 = paramReadablePeriod.getFieldType(i).getField(this).add(paramLong, l2 * paramInt);
          }
          i += 1;
          paramLong = l1;
        }
  ...
  public int[] get(ReadablePeriod paramReadablePeriod, long paramLong1, long paramLong2)
  {
    ...
    if (paramLong1 != paramLong2)
    {
      ...
      while (i < j)
      {
        ...
        long l = paramLong1;
        if (k != 0) {
          l = localDurationField.add(paramLong1, k);
        }
        arrayOfInt[i] = k;
        i += 1;
        paramLong1 = l;
  ...
  {
    int k = 0;
    int m = paramReadablePartial.size();
    int i = 0;
    int j;
    ...
    for (;;)
    {
      ...
      if (j < localDateTimeField.getMinimumValue()) {
        throw new IllegalFieldValueException(localDateTimeField.getType(), Integer.valueOf(j), Integer.valueOf(localDateTimeField.getMinimumValue()), null);
      }
      if (j > localDateTimeField.getMaximumValue()) {
        throw new IllegalFieldValueException(localDateTimeField.getType(), Integer.valueOf(j), null, Integer.valueOf(localDateTimeField.getMaximumValue()));
      }
      i += 1;
    }
    do
    {
      ...
      if (i < localDateTimeField.getMinimumValue(paramReadablePartial, paramArrayOfInt)) {
        throw new IllegalFieldValueException(localDateTimeField.getType(), Integer.valueOf(i), Integer.valueOf(localDateTimeField.getMinimumValue(paramReadablePartial, paramArrayOfInt)), null);
      }
    } while (i <= localDateTimeField.getMaximumValue(paramReadablePartial, paramArrayOfInt));
    throw new IllegalFieldValueException(localDateTimeField.getType(), Integer.valueOf(i), null, Integer.valueOf(localDateTimeField.getMaximumValue(paramReadablePartial, paramArrayOfInt)));
  }
