  ...
  implements ReadableInterval
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    } while ((getStartMillis() == paramObject.getStartMillis()) && (getEndMillis() == paramObject.getEndMillis()) && (FieldUtils.equals(getChronology(), paramObject.getChronology())));
    return false;
  }
  ...
  public int hashCode()
  {
    long l1 = getStartMillis();
    long l2 = getEndMillis();
    return (((int)(l1 ^ l1 >>> 32) + 3007) * 31 + (int)(l2 ^ l2 >>> 32)) * 31 + getChronology().hashCode();
  }
