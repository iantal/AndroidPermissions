  ...
  implements Serializable, ReadablePartial
{
    ...
    implements Serializable
  {
    ...
    {
      int[] arrayOfInt = this.iYearMonthDay.getValues();
      arrayOfInt = getField().add(this.iYearMonthDay, this.iFieldIndex, arrayOfInt, paramInt);
      return new YearMonthDay(this.iYearMonthDay, arrayOfInt);
    }
    
    public YearMonthDay addWrapFieldToCopy(int paramInt)
    {
      int[] arrayOfInt = this.iYearMonthDay.getValues();
      arrayOfInt = getField().addWrapField(this.iYearMonthDay, this.iFieldIndex, arrayOfInt, paramInt);
      return new YearMonthDay(this.iYearMonthDay, arrayOfInt);
    }
    ...
    {
      int[] arrayOfInt = this.iYearMonthDay.getValues();
      arrayOfInt = getField().set(this.iYearMonthDay, this.iFieldIndex, arrayOfInt, paramInt);
      return new YearMonthDay(this.iYearMonthDay, arrayOfInt);
    }
    ...
    {
      int[] arrayOfInt = this.iYearMonthDay.getValues();
      paramString = getField().set(this.iYearMonthDay, this.iFieldIndex, arrayOfInt, paramString, paramLocale);
      return new YearMonthDay(this.iYearMonthDay, paramString);
    }
