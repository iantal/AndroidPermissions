...
public abstract class AbstractPartialFieldProperty
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    } while ((get() == paramObject.get()) && (getFieldType() == paramObject.getFieldType()) && (FieldUtils.equals(getReadablePartial().getChronology(), paramObject.getReadablePartial().getChronology())));
    return false;
  }
