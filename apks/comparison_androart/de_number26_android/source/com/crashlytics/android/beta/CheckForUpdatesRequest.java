  ...
  extends a
{
  ...
  public CheckForUpdatesRequest(i paramI, String paramString1, String paramString2, e paramE, CheckForUpdatesResponseTransform paramCheckForUpdatesResponseTransform)
  {
    super(paramI, paramString1, paramString2, paramE, c.a);
    this.responseTransform = paramCheckForUpdatesResponseTransform;
  }
  
  private d applyHeadersTo(d paramD, String paramString1, String paramString2)
  {
    paramD = paramD.a("Accept", "application/json");
    StringBuilder localStringBuilder = new StringBuilder();
    localStringBuilder.append("Crashlytics Android SDK/");
    localStringBuilder.append(this.kit.getVersion());
    return paramD.a("User-Agent", localStringBuilder.toString()).a("X-CRASHLYTICS-DEVELOPER-TOKEN", "470fa2b4ae81cd56ecbcda9735803434cec591fa").a("X-CRASHLYTICS-API-CLIENT-TYPE", "android").a("X-CRASHLYTICS-API-CLIENT-VERSION", this.kit.getVersion()).a("X-CRASHLYTICS-API-KEY", paramString1).a("X-CRASHLYTICS-BETA-TOKEN", createBetaTokenHeaderValueFor(paramString2));
  }
  ...
  public CheckForUpdatesResponse invoke(String paramString1, String paramString2, BuildProperties paramBuildProperties)
  {
    ...
    //   7: aload_0
    //   8: aload 4
    //   10: invokevirtual 129	com/crashlytics/android/beta/CheckForUpdatesRequest:getHttpRequest	(Ljava/util/Map;)Le/a/a/a/a/e/d;
    //   13: astore_3
    //   14: aload_0
    //   15: aload_3
    //   16: aload_1
    //   17: aload_2
    //   18: invokespecial 131	com/crashlytics/android/beta/CheckForUpdatesRequest:applyHeadersTo	(Le/a/a/a/a/e/d;Ljava/lang/String;Ljava/lang/String;)Le/a/a/a/a/e/d;
    //   21: astore_1
    //   22: aload_1
    //   23: astore_2
    //   24: invokestatic 137	e/a/a/a/c:h	()Le/a/a/a/l;
    //   27: astore_3
    //   28: aload_1
    //   29: astore_2
    ...
    //   76: aload_1
    //   77: astore_2
    //   78: invokestatic 137	e/a/a/a/c:h	()Le/a/a/a/l;
    //   81: astore_3
    //   82: aload_1
    //   83: astore_2
    ...
    //   129: astore_2
    //   130: aload_1
    //   131: invokevirtual 158	e/a/a/a/a/e/d:c	()Z
    //   134: ifeq +96 -> 230
    //   137: aload_1
    //   138: astore_2
    //   139: invokestatic 137	e/a/a/a/c:h	()Le/a/a/a/l;
    //   142: ldc -112
    //   144: ldc -96
    ...
    //   156: dup
    //   157: aload_1
    //   158: invokevirtual 165	e/a/a/a/a/e/d:e	()Ljava/lang/String;
    ...
    //   180: aload_1
    //   181: ldc -80
    //   183: invokevirtual 179	e/a/a/a/a/e/d:b	(Ljava/lang/String;)Ljava/lang/String;
    //   186: astore_1
    //   187: invokestatic 137	e/a/a/a/c:h	()Le/a/a/a/l;
    //   190: astore_2
    ...
    //   230: aload_1
    //   231: astore_2
    //   232: invokestatic 137	e/a/a/a/c:h	()Le/a/a/a/l;
    //   235: astore_3
    //   236: aload_1
    //   237: astore_2
    ...
    //   259: aload 4
    //   261: aload_1
    //   262: invokevirtual 188	e/a/a/a/a/e/d:b	()I
    ...
    //   288: aload_1
    //   289: ldc -80
    //   291: invokevirtual 179	e/a/a/a/a/e/d:b	(Ljava/lang/String;)Ljava/lang/String;
    //   294: astore_2
    //   295: invokestatic 137	e/a/a/a/c:h	()Le/a/a/a/l;
    //   298: astore_3
    ...
    //   337: aload_1
    //   338: astore_2
    //   339: invokestatic 137	e/a/a/a/c:h	()Le/a/a/a/l;
    //   342: astore 4
    //   344: aload_1
    //   345: astore_2
    ...
    //   398: aload_1
    //   399: ldc -80
    //   401: invokevirtual 179	e/a/a/a/a/e/d:b	(Ljava/lang/String;)Ljava/lang/String;
    //   404: astore_2
    //   405: invokestatic 137	e/a/a/a/c:h	()Le/a/a/a/l;
    //   408: astore_3
    ...
    //   449: aload_2
    //   450: ldc -80
    //   452: invokevirtual 179	e/a/a/a/a/e/d:b	(Ljava/lang/String;)Ljava/lang/String;
    //   455: astore_2
    //   456: invokestatic 137	e/a/a/a/c:h	()Le/a/a/a/l;
    //   459: astore_3
