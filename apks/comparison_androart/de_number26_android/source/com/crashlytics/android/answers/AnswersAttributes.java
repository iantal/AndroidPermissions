...
class AnswersAttributes
{
  ...
  {
    if (!this.validator.isNull(paramString, "key"))
    {
      if (this.validator.isNull(paramNumber, "value")) {
        return;
      }
  ...
  {
    if (!this.validator.isNull(paramString1, "key"))
    {
      if (this.validator.isNull(paramString2, "value")) {
        return;
      }
