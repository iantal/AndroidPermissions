  ...
  implements zzm
{
  ...
  private static List<zzl> zza(List<zzl> paramList, zzc paramZzc)
  {
    ...
    if (paramZzc.zzh != null)
    {
      if (!paramZzc.zzh.isEmpty())
      {
        paramZzc = paramZzc.zzh.iterator();
    ...
    else if (!paramZzc.zzg.isEmpty())
    {
      paramZzc = paramZzc.zzg.entrySet().iterator();
      while (paramZzc.hasNext())
      {
  ...
  {
    zzau localZzau = new zzau(this.zzd, paramInt);
    ...
    localObject1 = this.zzd.zza(1024);
    for (;;)
    {
      try
      {
    ...
    this.zzd.zza((byte[])localObject1);
    localZzau.close();
    return arrayOfByte;
    if (paramInputStream != null) {}
    try
      ...
      try
      {
        ...
        try
        {
          ...
          else
          {
            ...
            if (((zzc)localObject6).zzb != null) {
              ((Map)localObject1).put("If-None-Match", ((zzc)localObject6).zzb);
            }
            if (((zzc)localObject6).zzd <= 0L) {
              break label711;
            }
            ((Map)localObject1).put("If-Modified-Since", zzap.zza(((zzc)localObject6).zzd));
            break label711;
          }
          localZzaq = this.zzc.zza(paramZzr, (Map)localObject1);
          try
          {
            i = localZzaq.zza();
            ...
            if (i == 304) {
              try
              {
                ...
                localObject3 = new zzp(304, ((zzc)localObject3).zza, true, SystemClock.elapsedRealtime() - l1, (List)localObject6);
                return localObject3;
              }
