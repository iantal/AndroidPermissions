  ...
  static final class zza
  {
    ...
    public final void zza(String paramString)
    {
      try
      {
        ...
        {
          l1 = ((zzag)this.zzb.get(0)).zzc;
          l2 = ((zzag)this.zzb.get(this.zzb.size() - 1)).zzc;
          l1 = l2 - l1;
        }
        if (l1 <= 0L) {
          return;
        ...
        for (long l1 = l2; paramString.hasNext(); l1 = l2)
        {
          ...
          l2 = localZzag.zzc;
          zzaf.zzb("(+%-4d) [%2d] %s", new Object[] { Long.valueOf(l2 - l1), Long.valueOf(localZzag.zzb), localZzag.zza });
        }
        return;
      }
      finally {}
    ...
    public final void zza(String paramString, long paramLong)
    {
      try
      {
        ...
        this.zzb.add(new zzag(paramString, paramLong, SystemClock.elapsedRealtime()));
        return;
      }
      finally {}
    }
