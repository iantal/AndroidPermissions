  ...
  implements DialogInterface.OnCancelListener
{
  ...
  {
    super(paramZzcf);
    this.zzc = paramGoogleApiAvailability;
  }
  ...
  {
    zzp localZzp2 = (zzp)this.zzb.get();
    int j = 1;
    int i = 1;
    zzp localZzp1;
    switch (paramInt1)
    ...
    default: 
      ...
      break;
    case 2: 
      j = this.zzc.isGooglePlayServicesAvailable(zzg());
      if (j == 0) {
        paramInt1 = i;
      } else {
        paramInt1 = 0;
  ...
  public final void zzb(ConnectionResult paramConnectionResult, int paramInt)
  {
    ...
    if (this.zzb.compareAndSet(null, paramConnectionResult)) {
      this.zze.post(new zzq(this, paramConnectionResult));
    }
  }
