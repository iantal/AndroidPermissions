  ...
  implements zzcf
{
  ...
  private Map<String, LifecycleCallback> zzb = new a();
  private int zzc = 0;
  private Bundle zzd;
  ...
  public static zzdc zza(FragmentActivity paramFragmentActivity)
  {
    ...
    try
    {
      zzdc localZzdc = (zzdc)paramFragmentActivity.f().a("SupportLifecycleFragmentImpl");
      if (localZzdc != null)
      {
      ...
      else
      {
        ...
        paramFragmentActivity.f().a().a((i)localObject, "SupportLifecycleFragmentImpl").d();
      }
