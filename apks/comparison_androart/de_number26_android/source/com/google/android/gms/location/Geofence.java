...
public abstract interface Geofence
{
  ...
  public static final class Builder
  {
    ...
    public final Geofence build()
    {
      ...
      return new zzchq(this.zza, this.zzb, (short)1, this.zze, this.zzf, this.zzg, this.zzc, this.zzh, this.zzi);
    }
    ...
    public final Builder setExpirationDuration(long paramLong)
    {
      ...
      this.zzc = (SystemClock.elapsedRealtime() + paramLong);
      return this;
    }
