  ...
  extends Fragment
{
  ...
  public void onInflate(Activity paramActivity, AttributeSet paramAttributeSet, Bundle paramBundle)
  {
    ...
    try
    {
      ...
      this.zza.zza(paramActivity, paramAttributeSet, paramBundle);
      return;
    }
    finally
    {
    ...
    implements StreetViewLifecycleDelegate
  {
    ...
    {
      this.zzb = ((IStreetViewPanoramaFragmentDelegate)zzbq.zza(paramIStreetViewPanoramaFragmentDelegate));
      this.zza = ((Fragment)zzbq.zza(paramFragment));
    }
    ...
    public final void getStreetViewPanoramaAsync(OnStreetViewPanoramaReadyCallback paramOnStreetViewPanoramaReadyCallback)
    {
      try
      {
        this.zzb.getStreetViewPanoramaAsync(new zzah(this, paramOnStreetViewPanoramaReadyCallback));
        return;
      }
    ...
    public final void onInflate(Activity paramActivity, Bundle paramBundle1, Bundle paramBundle2)
    {
      try
      {
        ...
        this.zzb.onInflate(zzn.zza(paramActivity), null, paramBundle1);
  ...
  {
    private final Fragment zza;
    private zzo<StreetViewPanoramaFragment.zza> zzb;
    ...
    private final void zzi()
    {
      ...
      try
      {
        ...
        Object localObject = zzbz.zza(this.zzc).zzb(zzn.zza(this.zzc));
        this.zzb.zza(new StreetViewPanoramaFragment.zza(this.zza, (IStreetViewPanoramaFragmentDelegate)localObject));
        ...
        while (((Iterator)localObject).hasNext())
        {
          ...
          ((StreetViewPanoramaFragment.zza)zza()).getStreetViewPanoramaAsync(localOnStreetViewPanoramaReadyCallback);
        }
        this.zzd.clear();
        return;
      }
    ...
    public final void zza(OnStreetViewPanoramaReadyCallback paramOnStreetViewPanoramaReadyCallback)
    {
      if (zza() != null)
      {
        ((StreetViewPanoramaFragment.zza)zza()).getStreetViewPanoramaAsync(paramOnStreetViewPanoramaReadyCallback);
        return;
      }
      this.zzd.add(paramOnStreetViewPanoramaReadyCallback);
    }
  }
}
