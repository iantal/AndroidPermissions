...
final class zzfj
{
  ...
  {
    List localList = (List)this.zzb.get(paramZzdko);
  ...
  {
    List localList = (List)this.zzd.get(paramZzdko);
    Object localObject = localList;
    if (localList == null)
    {
      localObject = new ArrayList();
  ...
  {
    List localList = (List)this.zzc.get(paramZzdko);
    Object localObject = localList;
    if (localList == null)
    {
      localObject = new ArrayList();
  ...
  {
    List localList = (List)this.zze.get(paramZzdko);
    Object localObject = localList;
    if (localList == null)
    {
      localObject = new ArrayList();
