...
public abstract class PhenotypeFlag<T>
{
  ...
  {
    zzdpf.zzb(paramContext);
    if (zzc == null) {
      zzdpf.zza(paramContext);
    }
    for (;;)
    {
  ...
  private final T zzb()
  {
    ...
    {
      if (Factory.zzb(this.zzf) != null)
      {
        localObject = (String)zza(new zzo(this, zza.zza(zzc.getContentResolver(), Factory.zzb(this.zzf))));
        if (localObject != null) {
          return zza((String)localObject);
        }
      }
      else if (Factory.zza(this.zzf) != null)
      {
        ...
        localObject = zzc.getSharedPreferences(Factory.zza(this.zzf), 0);
        if (((SharedPreferences)localObject).contains(this.zza)) {
    ...
    {
      localObject = String.valueOf(this.zza);
  ...
  private static boolean zzd()
  {
    if (zze == null)
    {
      ...
      if (localContext != null)
      {
        if (g.b(zzc, "com.google.android.providers.gsf.permission.READ_GSERVICES") == 0) {
          bool = true;
        }
  ...
  public static class Factory
  {
    ...
    public Factory withGservicePrefix(String paramString)
    {
      ...
      return new Factory(this.zza, this.zzb, paramString, this.zzd, this.zze, this.zzf);
    }
    
    @KeepForSdk
    public Factory withPhenotypePrefix(String paramString)
    {
      return new Factory(this.zza, this.zzb, this.zzc, paramString, this.zze, this.zzf);
    }
  }
