...
public class zzs
{
  ...
  private static int zza(Context paramContext, boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        else if ((paramBoolean) && ((!zzt.zza((PackageInfo)localObject, true)) || (!localObject.signatures[0].equals(localPackageInfo.signatures[0]))))
        {
        ...
        {
          paramInt1 /= 1000;
          int i = localPackageInfo.versionCode / 1000;
  ...
  static boolean zza(Context paramContext, String paramString)
  {
    ...
    //   6: istore_3
    //   7: invokestatic 267	com/google/android/gms/common/util/zzr:zzg	()Z
    //   10: ifeq +56 -> 66
    //   13: aload_0
    ...
    //   95: ifeq +62 -> 157
    //   98: invokestatic 299	com/google/android/gms/common/util/zzr:zzd	()Z
    //   101: ifeq +48 -> 149
    //   104: aload_0
    //   105: ldc_w 301
  ...
  public static boolean zzb(Context paramContext)
  {
    ...
    //   3: ifne +82 -> 85
    //   6: aload_0
    //   7: invokestatic 327	com/google/android/gms/internal/zzbii:zza	(Landroid/content/Context;)Lcom/google/android/gms/internal/zzbih;
    //   10: ldc 9
    //   12: bipush 64
    //   14: invokevirtual 331	com/google/android/gms/internal/zzbih:zzb	(Ljava/lang/String;I)Landroid/content/pm/PackageInfo;
    //   17: astore_1
    //   18: aload_0
