  ...
  extends zzbgm
{
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    return (this.zzc == paramObject.zzc) && (zzbg.zza(this.zzd, paramObject.zzd)) && (zzbg.zza(this.zze, paramObject.zze));
  }
    ...
    throws IntentSender.SendIntentException
  {
    ...
    paramActivity.startIntentSenderForResult(this.zzd.getIntentSender(), paramInt, null, 0, 0, 0);
  }
  ...
  public final void writeToParcel(Parcel paramParcel, int paramInt)
  {
    ...
    zzbgp.zza(paramParcel, 2, getErrorCode());
    zzbgp.zza(paramParcel, 3, getResolution(), paramInt, false);
    zzbgp.zza(paramParcel, 4, getErrorMessage(), false);
