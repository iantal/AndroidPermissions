...
public class Renderer
{
  ...
  private void createInfoWindow()
  {
    this.mMap.setInfoWindowAdapter(new GoogleMap.InfoWindowAdapter()
    {
      ...
      {
        View localView = LayoutInflater.from(Renderer.this.mContext).inflate(R.layout.amu_info_window, null);
  ...
  public void addFeature(Feature paramFeature)
  {
    ...
    this.mFeatures.put(paramFeature, localObject1);
  }
  ...
  protected Polyline addLineStringToMap(PolylineOptions paramPolylineOptions, LineString paramLineString)
  {
    ...
    paramPolylineOptions = this.mMap.addPolyline(paramPolylineOptions);
  ...
  protected Polygon addPolygonToMap(PolygonOptions paramPolygonOptions, DataPolygon paramDataPolygon)
  {
    ...
    paramPolygonOptions = this.mMap.addPolygon(paramPolygonOptions);
