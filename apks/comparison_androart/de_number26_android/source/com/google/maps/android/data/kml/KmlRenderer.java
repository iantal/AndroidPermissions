  ...
  extends Renderer
{
  ...
  private void addGroundOverlays(HashMap<KmlGroundOverlay, GroundOverlay> paramHashMap)
  {
    ...
    while (paramHashMap.hasNext())
    {
      ...
      if ((str != null) && (localKmlGroundOverlay.getLatLngBox() != null)) {
        ...
        } else if (!this.mGroundOverlayUrls.contains(str)) {
  ...
  private void downloadGroundOverlays()
  {
    ...
    Iterator localIterator = this.mGroundOverlayUrls.iterator();
    while (localIterator.hasNext())
    {
    ...
    extends AsyncTask<String, Void, Bitmap>
  {
    ...
    {
      this.mGroundOverlayUrl = paramString;
    }
    ...
    protected Bitmap doInBackground(String... paramVarArgs)
    {
      try
      {
        paramVarArgs = BitmapFactory.decodeStream((InputStream)new URL(this.mGroundOverlayUrl).getContent());
        return paramVarArgs;
      }
      catch (IOException paramVarArgs)
      {
        ...
        localStringBuilder.append(this.mGroundOverlayUrl);
    ...
    protected void onPostExecute(Bitmap paramBitmap)
    {
      if (paramBitmap == null)
      {
        ...
        paramBitmap.append(this.mGroundOverlayUrl);
        Log.e("KmlRenderer", paramBitmap.toString());
        return;
      }
      KmlRenderer.this.putImagesCache(this.mGroundOverlayUrl, paramBitmap);
    ...
    extends AsyncTask<String, Void, Bitmap>
  {
    ...
    protected Bitmap doInBackground(String... paramVarArgs)
    {
      try
      {
        paramVarArgs = BitmapFactory.decodeStream((InputStream)new URL(this.mIconUrl).getContent());
        return paramVarArgs;
      }
      catch (IOException paramVarArgs)
      {
    ...
    protected void onPostExecute(Bitmap paramBitmap)
    {
      if (paramBitmap == null)
      {
        paramBitmap = new StringBuilder();
        paramBitmap.append("Image at this URL could not be found ");
        paramBitmap.append(this.mIconUrl);
        Log.e("KmlRenderer", paramBitmap.toString());
        return;
      }
      KmlRenderer.this.putImagesCache(this.mIconUrl, paramBitmap);
      if (KmlRenderer.this.isLayerOnMap())
      {
        KmlRenderer.this.addIconToMarkers(this.mIconUrl, KmlRenderer.access$000(KmlRenderer.this));
