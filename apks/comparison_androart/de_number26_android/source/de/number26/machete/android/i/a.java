  ...
  implements Parcelable
{
  ...
  {
    super(str, localA, bool);
  }
  
  public a(d paramD)
  {
    super(paramD.getValue(), paramD.getType(), paramD.isNumber26());
  }
  
  public static ArrayList<a> a(List<d> paramList)
  {
    ArrayList localArrayList = new ArrayList();
    paramList = paramList.iterator();
    while (paramList.hasNext()) {
      localArrayList.add(new a((d)paramList.next()));
    }
