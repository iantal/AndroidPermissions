...
public final class b
{
  ...
  private FrameLayout a(Resources paramResources)
  {
    ...
    int n;
    if (this.b.l > 0) {
      n = paramResources.getDimensionPixelSize(this.b.l);
    } else {
      n = this.b.k;
    }
    int m;
    if (this.b.n > 0) {
      m = paramResources.getDimensionPixelSize(this.b.n);
    } else {
      m = this.b.m;
    }
    if (m == 0) {
    ...
    localFrameLayout.setLayoutParams(new FrameLayout.LayoutParams(m, n));
    if (this.b.g != -1) {
    ...
    if (this.b.f != 0)
    {
      paramResources = new BitmapDrawable(paramResources, BitmapFactory.decodeResource(paramResources, this.b.f));
      if (this.b.h) {
        paramResources.setTileModeXY(Shader.TileMode.REPEAT, Shader.TileMode.REPEAT);
      }
      localFrameLayout.setBackgroundDrawable(paramResources);
    }
  ...
  private RelativeLayout b(Resources paramResources)
  {
    ...
    paramResources = c(paramResources);
    ...
    } else if ((this.b.o & 0x10) != 0) {
      localLayoutParams.addRule(15);
    } else if ((this.b.o & 0x1) != 0) {
      localLayoutParams.addRule(14);
    }
    localRelativeLayout.addView(paramResources, localLayoutParams);
  ...
  private void s()
  {
    ...
    this.h = a((Resources)localObject);
    localObject = b((Resources)localObject);
