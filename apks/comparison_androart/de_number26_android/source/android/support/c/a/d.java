...
public class d
{
    ...
    throws android.content.res.Resources.NotFoundException
  {
    ...
    //   23: ldc 24
    //   25: if_icmpne +11 -> 36
    //   28: new 26	android/support/v4/view/b/a
    //   31: dup
    //   32: invokespecial 30	android/support/v4/view/b/a:<init>	()V
    //   35: areturn
    //   36: iload_1
    //   37: ldc 31
    //   39: if_icmpne +11 -> 50
    //   42: new 33	android/support/v4/view/b/b
    //   45: dup
    //   46: invokespecial 34	android/support/v4/view/b/b:<init>	()V
    //   49: areturn
    //   50: iload_1
    //   51: ldc 35
    //   53: if_icmpne +11 -> 64
    //   56: new 37	android/support/v4/view/b/c
    //   59: dup
    //   60: invokespecial 38	android/support/v4/view/b/c:<init>	()V
    //   63: areturn
    //   64: aload_0
    //   65: invokevirtual 44	android/content/Context:getResources	()Landroid/content/res/Resources;
    //   68: iload_1
    //   69: invokevirtual 50	android/content/res/Resources:getAnimation	(I)Landroid/content/res/XmlResourceParser;
    //   72: astore_3
    //   73: aload_0
    //   74: aload_0
    //   75: invokevirtual 44	android/content/Context:getResources	()Landroid/content/res/Resources;
    //   78: aload_0
    //   79: invokevirtual 54	android/content/Context:getTheme	()Landroid/content/res/Resources$Theme;
    //   82: aload_3
    //   83: invokestatic 57	android/support/c/a/d:a	(Landroid/content/Context;Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Lorg/xmlpull/v1/XmlPullParser;)Landroid/view/animation/Interpolator;
    //   86: astore_0
    //   87: aload_3
    //   88: ifnull +9 -> 97
    //   91: aload_3
    ...
    //   121: aload_0
    //   122: astore_2
    //   123: new 64	java/lang/StringBuilder
    //   126: dup
    //   127: invokespecial 65	java/lang/StringBuilder:<init>	()V
    //   130: astore 4
    //   132: aload_0
    //   133: astore_2
    //   134: aload 4
    ...
    //   144: aload 4
    //   146: iload_1
    //   147: invokestatic 77	java/lang/Integer:toHexString	(I)Ljava/lang/String;
    //   150: invokevirtual 71	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   153: pop
    //   154: aload_0
    //   155: astore_2
    //   156: new 8	android/content/res/Resources$NotFoundException
    //   159: dup
    //   160: aload 4
    //   162: invokevirtual 81	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   165: invokespecial 84	android/content/res/Resources$NotFoundException:<init>	(Ljava/lang/String;)V
    //   168: astore 4
    //   170: aload_0
    //   171: astore_2
    //   172: aload 4
    //   174: aload_3
    //   175: invokevirtual 88	android/content/res/Resources$NotFoundException:initCause	(Ljava/lang/Throwable;)Ljava/lang/Throwable;
    //   178: pop
    //   179: aload_0
    //   180: astore_2
    //   181: aload 4
    ...
    //   189: dup
    //   190: invokespecial 65	java/lang/StringBuilder:<init>	()V
    //   193: astore 4
    //   195: aload_0
    //   196: astore_2
    //   197: aload 4
    //   199: ldc 67
    //   201: invokevirtual 71	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   204: pop
    //   205: aload_0
    //   206: astore_2
    //   207: aload 4
    //   209: iload_1
    //   210: invokestatic 77	java/lang/Integer:toHexString	(I)Ljava/lang/String;
    //   213: invokevirtual 71	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   216: pop
    //   217: aload_0
    //   218: astore_2
    //   219: new 8	android/content/res/Resources$NotFoundException
    //   222: dup
    //   223: aload 4
    //   225: invokevirtual 81	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   228: invokespecial 84	android/content/res/Resources$NotFoundException:<init>	(Ljava/lang/String;)V
    //   231: astore 4
    //   233: aload_0
    //   234: astore_2
    //   235: aload 4
    //   237: aload_3
    //   238: invokevirtual 88	android/content/res/Resources$NotFoundException:initCause	(Ljava/lang/Throwable;)Ljava/lang/Throwable;
    //   241: pop
    //   242: aload_0
    //   243: astore_2
    //   244: aload 4
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        else
        {
          ...
          paramResources = new g(paramContext, paramResources, paramXmlPullParser);
        }
      }
    }
    label277:
