...
public class e
{
  ...
  {
    paramResources = c.a(paramResources, paramTheme, paramAttributeSet, a.j);
    int k = 0;
    paramTheme = c.b(paramResources, paramXmlPullParser, "value", 0);
    int i;
    if (paramTheme != null) {
      i = 1;
    } else {
    ...
    throws Resources.NotFoundException
  {
    ...
    //   9: aload_1
    //   10: iload_3
    //   11: invokevirtual 88	android/content/res/Resources:getAnimation	(I)Landroid/content/res/XmlResourceParser;
    //   14: astore 6
    //   16: aload_0
    //   17: aload_1
    //   18: aload_2
    //   19: aload 6
    //   21: fload 4
    //   23: invokestatic 91	android/support/c/a/e:a	(Landroid/content/Context;Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Lorg/xmlpull/v1/XmlPullParser;F)Landroid/animation/Animator;
    //   26: astore_0
    //   27: aload 6
    //   29: ifnull +10 -> 39
    //   32: aload 6
    ...
    //   71: aload_0
    //   72: astore 5
    //   74: new 98	java/lang/StringBuilder
    //   77: dup
    //   78: invokespecial 101	java/lang/StringBuilder:<init>	()V
    //   81: astore_2
    //   82: aload_0
    //   83: astore 5
    //   85: aload_2
    ...
    //   95: aload_2
    //   96: iload_3
    //   97: invokestatic 113	java/lang/Integer:toHexString	(I)Ljava/lang/String;
    //   100: invokevirtual 107	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   103: pop
    //   104: aload_0
    //   105: astore 5
    //   107: new 51	android/content/res/Resources$NotFoundException
    //   110: dup
    //   111: aload_2
    ...
    //   157: aload_2
    //   158: iload_3
    //   159: invokestatic 113	java/lang/Integer:toHexString	(I)Ljava/lang/String;
    //   162: invokevirtual 107	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   165: pop
    //   166: aload_0
    //   167: astore 5
    //   169: new 51	android/content/res/Resources$NotFoundException
    //   172: dup
    //   173: aload_2
    //   174: invokevirtual 117	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   177: invokespecial 120	android/content/res/Resources$NotFoundException:<init>	(Ljava/lang/String;)V
    //   180: astore_2
    //   181: aload_0
    //   182: astore 5
    //   184: aload_2
    //   185: aload_1
    //   186: invokevirtual 124	android/content/res/Resources$NotFoundException:initCause	(Ljava/lang/Throwable;)Ljava/lang/Throwable;
    //   189: pop
    //   190: aload_0
    //   191: astore 5
    //   193: aload_2
      ...
      if (k == 2)
      {
        ...
        for (;;)
        {
          ...
          else if (((String)localObject1).equals("set"))
          {
            ...
            localObject3 = c.a(paramResources, paramTheme, paramAttributeSet, a.h);
            i = c.a((TypedArray)localObject3, paramXmlPullParser, "ordering", 0, 0);
  ...
  private static Keyframe a(Context paramContext, Resources paramResources, Resources.Theme paramTheme, AttributeSet paramAttributeSet, int paramInt, XmlPullParser paramXmlPullParser)
    throws XmlPullParserException, IOException
  {
    paramTheme = c.a(paramResources, paramTheme, paramAttributeSet, a.j);
    float f = c.a(paramTheme, paramXmlPullParser, "fraction", 3, -1.0F);
    paramResources = c.b(paramTheme, paramXmlPullParser, "value", 0);
    int j;
    ...
    if (j != 0)
    {
      if (i != 3) {
        ...
        default: 
          ...
          break;
        case 0: 
          paramResources = Keyframe.ofFloat(f, c.a(paramTheme, paramXmlPullParser, "value", 0, 0.0F));
          break;
        }
      } else {
        paramResources = Keyframe.ofInt(f, c.a(paramTheme, paramXmlPullParser, "value", 0, 0));
      }
    }
    else if (i == 0) {
    ...
    paramInt = c.c(paramTheme, paramXmlPullParser, "interpolator", 1, 0);
    if (paramInt > 0) {
  ...
  private static PropertyValuesHolder a(TypedArray paramTypedArray, int paramInt1, int paramInt2, int paramInt3, String paramString)
  {
    ...
    if (i == 2)
    {
      ...
      b.b[] arrayOfB1 = b.b((String)localObject2);
      b.b[] arrayOfB2 = b.b(str);
      if (arrayOfB1 == null)
      {
  ...
  private static ValueAnimator a(Context paramContext, Resources paramResources, Resources.Theme paramTheme, AttributeSet paramAttributeSet, ValueAnimator paramValueAnimator, float paramFloat, XmlPullParser paramXmlPullParser)
    throws Resources.NotFoundException
  {
    TypedArray localTypedArray = c.a(paramResources, paramTheme, paramAttributeSet, a.g);
    paramTheme = c.a(paramResources, paramTheme, paramAttributeSet, a.k);
    ...
    int i = c.c(localTypedArray, paramXmlPullParser, "interpolator", 0, 0);
    if (i > 0) {
  ...
  private static void a(ValueAnimator paramValueAnimator, TypedArray paramTypedArray, int paramInt, float paramFloat, XmlPullParser paramXmlPullParser)
  {
    ...
    if (str1 != null)
    {
      ...
      paramXmlPullParser = c.a(paramTypedArray, paramXmlPullParser, "propertyYName", 3);
      ...
      a(b.a(str1), paramValueAnimator, 0.5F * paramFloat, str2, paramXmlPullParser);
      return;
    }
    paramValueAnimator.setPropertyName(c.a(paramTypedArray, paramXmlPullParser, "propertyName", 0));
  }
  ...
  private static void a(ValueAnimator paramValueAnimator, TypedArray paramTypedArray1, TypedArray paramTypedArray2, float paramFloat, XmlPullParser paramXmlPullParser)
  {
    ...
    int j = c.a(paramTypedArray1, paramXmlPullParser, "valueType", 7, 4);
    int k = j;
    if (c.a(paramXmlPullParser, "valueFrom"))
    {
      k = j;
      if (c.a(paramXmlPullParser, "valueTo"))
      {
        int i = j;
        if (j == 4) {
    ...
    for (;;)
    {
      ...
      else
      {
        if (paramXmlPullParser.getName().equals("propertyValuesHolder"))
        {
          ...
          i = c.a(localTypedArray, paramXmlPullParser, "valueType", 2, 4);
