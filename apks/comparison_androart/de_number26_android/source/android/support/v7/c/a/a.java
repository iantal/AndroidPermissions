...
final class a
{
  ...
  {
    return android.support.v4.a.a.b(paramInt, Math.round(Color.alpha(paramInt) * paramFloat));
  }
    ...
    throws XmlPullParserException, IOException
  {
    ...
    for (;;)
    {
      ...
      if ((j == 2) && (k <= i1) && (paramXmlPullParser.getName().equals("item")))
      {
        ...
        arrayOfInt = c.a(arrayOfInt, i, j);
        localObject1 = (int[][])c.a((Object[])localObject1, i, localObject2);
        i += 1;
      }
    }
