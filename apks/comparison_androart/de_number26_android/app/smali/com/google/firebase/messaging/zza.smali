...
.method final zzc(Landroid/os/Bundle;)Z
    ...
    invoke-direct {v3, v8}, Landroid/support/v4/app/ab$c;-><init>(Landroid/content/Context;)V

    invoke-virtual {v3, v1}, Landroid/support/v4/app/ab$c;->a(Z)Landroid/support/v4/app/ab$c;

    move-result-object v3

    invoke-virtual {v3, v6}, Landroid/support/v4/app/ab$c;->a(I)Landroid/support/v4/app/ab$c;
    ...
    invoke-virtual {v3, v5}, Landroid/support/v4/app/ab$c;->b(Ljava/lang/CharSequence;)Landroid/support/v4/app/ab$c;

    new-instance v4, Landroid/support/v4/app/ab$b;

    invoke-direct {v4}, Landroid/support/v4/app/ab$b;-><init>()V

    invoke-virtual {v4, v5}, Landroid/support/v4/app/ab$b;->a(Ljava/lang/CharSequence;)Landroid/support/v4/app/ab$b;

    move-result-object v4

    invoke-virtual {v3, v4}, Landroid/support/v4/app/ab$c;->a(Landroid/support/v4/app/ab$e;)Landroid/support/v4/app/ab$c;
    ...
    invoke-virtual {v3, v4}, Landroid/support/v4/app/ab$c;->d(I)Landroid/support/v4/app/ab$c;

    :cond_11
    if-eqz v0, :cond_12

    invoke-virtual {v3, v0}, Landroid/support/v4/app/ab$c;->a(Landroid/net/Uri;)Landroid/support/v4/app/ab$c;

    :cond_12
    if-eqz v9, :cond_13

    invoke-virtual {v3, v9}, Landroid/support/v4/app/ab$c;->a(Landroid/app/PendingIntent;)Landroid/support/v4/app/ab$c;

    :cond_13
    if-eqz v10, :cond_14

    invoke-virtual {v3, v10}, Landroid/support/v4/app/ab$c;->b(Landroid/app/PendingIntent;)Landroid/support/v4/app/ab$c;

    :cond_14
    invoke-virtual {v3}, Landroid/support/v4/app/ab$c;->a()Landroid/app/Notification;
