...
.field e:Landroid/support/v4/widget/d;
...
.field j:Landroid/support/v4/widget/e;
...
.method private a(II)Landroid/view/animation/Animation;
    ...
    .line 489
    iget-object p1, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->e:Landroid/support/v4/widget/d;

    const/4 p2, 0x0

    invoke-virtual {p1, p2}, Landroid/support/v4/widget/d;->a(Landroid/view/animation/Animation$AnimationListener;)V

    .line 490
    iget-object p1, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->e:Landroid/support/v4/widget/d;

    invoke-virtual {p1}, Landroid/support/v4/widget/d;->clearAnimation()V

    .line 491
    iget-object p1, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->e:Landroid/support/v4/widget/d;

    invoke-virtual {p1, v0}, Landroid/support/v4/widget/d;->startAnimation(Landroid/view/animation/Animation;)V
...
.method private a(ILandroid/view/animation/Animation$AnimationListener;)V
    ...
    invoke-virtual {p1, p2}, Landroid/support/v4/widget/d;->startAnimation(Landroid/view/animation/Animation;)V
...
.method private b(F)V
    ...
    .line 897
    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->j:Landroid/support/v4/widget/e;

    const/4 v1, 0x1

    invoke-virtual {v0, v1}, Landroid/support/v4/widget/e;->a(Z)V
    ...
    .line 913
    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->e:Landroid/support/v4/widget/d;

    invoke-virtual {v0}, Landroid/support/v4/widget/d;->getVisibility()I
    ...
    invoke-virtual {v0, v4}, Landroid/support/v4/widget/d;->setVisibility(I)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/widget/d;->setScaleX(F)V

    .line 918
    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->e:Landroid/support/v4/widget/d;

    invoke-virtual {v0, v1}, Landroid/support/v4/widget/d;->setScaleY(F)V
    ...
    .line 925
    iget-object p1, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->j:Landroid/support/v4/widget/e;

    invoke-virtual {p1}, Landroid/support/v4/widget/e;->getAlpha()I
    ...
    .line 937
    iget-object v4, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->j:Landroid/support/v4/widget/e;

    invoke-static {p1, v0}, Ljava/lang/Math;->min(FF)F

    move-result p1

    invoke-virtual {v4, v6, p1}, Landroid/support/v4/widget/e;->a(FF)V
    ...
    invoke-virtual {p1, v0}, Landroid/support/v4/widget/e;->b(F)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/widget/e;->c(F)V
...
.method private b(Landroid/view/animation/Animation$AnimationListener;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/widget/e;->setAlpha(I)V
...
.method private c()V
    ...
    invoke-direct {v0, v1, v2}, Landroid/support/v4/widget/d;-><init>(Landroid/content/Context;I)V

    iput-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->e:Landroid/support/v4/widget/d;
    ...
    invoke-direct {v0, v1}, Landroid/support/v4/widget/e;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->j:Landroid/support/v4/widget/e;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/widget/e;->a(I)V

    .line 382
    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->e:Landroid/support/v4/widget/d;

    iget-object v1, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->j:Landroid/support/v4/widget/e;
...
.method private c(F)V
    ...
    invoke-virtual {v0, v1, v1}, Landroid/support/v4/widget/e;->a(FF)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/widget/e;->a(Z)V
...
.method private c(ILandroid/view/animation/Animation$AnimationListener;)V
    ...
    invoke-virtual {p1}, Landroid/support/v4/widget/d;->getScaleX()F
...
.method private d(F)V
    ...
    invoke-virtual {p1, v0}, Landroid/support/v4/widget/e;->setAlpha(I)V
...
.method private f()V
    ...
    .line 571
    iget-object v2, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->e:Landroid/support/v4/widget/d;
...
.method a()V
    ...
    invoke-virtual {v0}, Landroid/support/v4/widget/e;->stop()V
...
.method a(F)V
    ...
    invoke-virtual {p1}, Landroid/support/v4/widget/d;->getTop()I
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v1, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->e:Landroid/support/v4/widget/d;
...
.method protected onLayout(ZIIII)V
    ...
    .line 607
    iget-object p2, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->e:Landroid/support/v4/widget/d;

    invoke-virtual {p2}, Landroid/support/v4/widget/d;->getMeasuredWidth()I

    move-result p2

    .line 608
    iget-object p3, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->e:Landroid/support/v4/widget/d;

    invoke-virtual {p3}, Landroid/support/v4/widget/d;->getMeasuredHeight()I

    move-result p3

    .line 609
    iget-object p4, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->e:Landroid/support/v4/widget/d;
    ...
    invoke-virtual {p4, p5, v0, p1, p2}, Landroid/support/v4/widget/d;->layout(IIII)V
...
.method public onMeasure(II)V
    ...
    .line 626
    invoke-virtual {p1, p2, v0}, Landroid/support/v4/widget/d;->measure(II)V
...
.method public onNestedPreScroll(Landroid/view/View;II[I)V
    ...
    invoke-virtual {p1, v1}, Landroid/support/v4/widget/d;->setVisibility(I)V
...
.method public varargs setColorSchemeColors([I)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/widget/e;->a([I)V
...
.method public setSize(I)V
    ...
    invoke-virtual {p1, v0}, Landroid/support/v4/widget/d;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V
...
.method setTargetOffsetTopAndBottom(I)V
    ...
    invoke-static {v0, p1}, Landroid/support/v4/view/t;->d(Landroid/view/View;I)V
