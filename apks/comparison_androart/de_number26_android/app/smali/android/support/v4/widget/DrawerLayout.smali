...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 313
    new-instance v3, Landroid/support/v4/widget/DrawerLayout$f;

    invoke-direct {v3, p0, p3}, Landroid/support/v4/widget/DrawerLayout$f;-><init>(Landroid/support/v4/widget/DrawerLayout;I)V

    iput-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->m:Landroid/support/v4/widget/DrawerLayout$f;

    .line 314
    new-instance p3, Landroid/support/v4/widget/DrawerLayout$f;

    const/4 v3, 0x5

    invoke-direct {p3, p0, v3}, Landroid/support/v4/widget/DrawerLayout$f;-><init>(Landroid/support/v4/widget/DrawerLayout;I)V

    iput-object p3, p0, Landroid/support/v4/widget/DrawerLayout;->n:Landroid/support/v4/widget/DrawerLayout$f;

    .line 316
    iget-object p3, p0, Landroid/support/v4/widget/DrawerLayout;->m:Landroid/support/v4/widget/DrawerLayout$f;

    const/high16 v3, 0x3f800000    # 1.0f

    invoke-static {p0, v3, p3}, Landroid/support/v4/widget/s;->a(Landroid/view/ViewGroup;FLandroid/support/v4/widget/s$a;)Landroid/support/v4/widget/s;

    move-result-object p3

    iput-object p3, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/s;

    .line 317
    iget-object p3, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/s;

    invoke-virtual {p3, p2}, Landroid/support/v4/widget/s;->a(I)V

    .line 318
    iget-object p3, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/s;

    invoke-virtual {p3, v2}, Landroid/support/v4/widget/s;->a(F)V
    ...
    invoke-virtual {p3, v4}, Landroid/support/v4/widget/DrawerLayout$f;->a(Landroid/support/v4/widget/s;)V

    .line 321
    iget-object p3, p0, Landroid/support/v4/widget/DrawerLayout;->n:Landroid/support/v4/widget/DrawerLayout$f;

    invoke-static {p0, v3, p3}, Landroid/support/v4/widget/s;->a(Landroid/view/ViewGroup;FLandroid/support/v4/widget/s$a;)Landroid/support/v4/widget/s;

    move-result-object p3

    iput-object p3, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/s;

    .line 322
    iget-object p3, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/s;

    const/4 v3, 0x2

    invoke-virtual {p3, v3}, Landroid/support/v4/widget/s;->a(I)V
    ...
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/s;

    invoke-virtual {p3, v2}, Landroid/support/v4/widget/DrawerLayout$f;->a(Landroid/support/v4/widget/s;)V

    .line 327
    invoke-virtual {p0, p2}, Landroid/support/v4/widget/DrawerLayout;->setFocusableInTouchMode(Z)V

    .line 329
    invoke-static {p0, p2}, Landroid/support/v4/view/t;->b(Landroid/view/View;I)V
    ...
    invoke-static {p0, p2}, Landroid/support/v4/view/t;->a(Landroid/view/View;Landroid/support/v4/view/b;)V
    ...
    .line 334
    invoke-static {p0}, Landroid/support/v4/view/t;->p(Landroid/view/View;)Z
...
.method private c(Landroid/view/View;Z)V
    ...
    .line 847
    invoke-static {v2, v3}, Landroid/support/v4/view/t;->b(Landroid/view/View;I)V
...
.method public a(II)V
    ...
    .line 590
    iget-object p2, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/s;

    goto :goto_1

    :cond_4
    iget-object p2, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/s;

    .line 591
    :goto_1
    invoke-virtual {p2}, Landroid/support/v4/widget/s;->e()V
...
.method a(IILandroid/view/View;)V
    ...
    .line 755
    iget-object p1, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/s;

    invoke-virtual {p1}, Landroid/support/v4/widget/s;->a()I
...
.method public a(Landroid/view/View;Z)V
    ...
    invoke-virtual {p2, p1, v1, v0}, Landroid/support/v4/widget/s;->a(Landroid/view/View;II)Z
    ...
    .line 1607
    invoke-virtual {p2, p1, v0, v1}, Landroid/support/v4/widget/s;->a(Landroid/view/View;II)Z
...
.method a(Z)V
    ...
    .line 1557
    invoke-virtual {v7, v4, v6, v8}, Landroid/support/v4/widget/s;->a(Landroid/view/View;II)Z
    ...
    .line 1560
    invoke-virtual {v6, v4, v7, v8}, Landroid/support/v4/widget/s;->a(Landroid/view/View;II)Z
    ...
    .line 1567
    :cond_3
    iget-object p1, p0, Landroid/support/v4/widget/DrawerLayout;->m:Landroid/support/v4/widget/DrawerLayout$f;

    invoke-virtual {p1}, Landroid/support/v4/widget/DrawerLayout$f;->a()V

    .line 1568
    iget-object p1, p0, Landroid/support/v4/widget/DrawerLayout;->n:Landroid/support/v4/widget/DrawerLayout$f;
...
.method public addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-static {p1, p2}, Landroid/support/v4/view/t;->a(Landroid/view/View;Landroid/support/v4/view/b;)V
...
.method public computeScroll()V
    ...
    invoke-virtual {v2, v1}, Landroid/support/v4/widget/s;->a(Z)Z
...
.method protected drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    .line 1380
    iget-object v9, v0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/s;

    invoke-virtual {v9}, Landroid/support/v4/widget/s;->b()I
    ...
    .line 1392
    iget-object v10, v0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/s;

    invoke-virtual {v10}, Landroid/support/v4/widget/s;->b()I
...
.method public f(I)Z
    ...
    .line 1741
    invoke-virtual {p0, p1}, Landroid/support/v4/widget/DrawerLayout;->j(Landroid/view/View;)Z
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 1428
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/s;

    invoke-virtual {v1, p1}, Landroid/support/v4/widget/s;->a(Landroid/view/MotionEvent;)Z
    ...
    .line 1429
    invoke-virtual {v2, p1}, Landroid/support/v4/widget/s;->a(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {p1, v0}, Landroid/support/v4/widget/s;->d(I)Z
    ...
    invoke-virtual {v4, v0, p1}, Landroid/support/v4/widget/s;->d(II)Landroid/view/View;
...
.method protected onMeasure(II)V
    ...
    invoke-static/range {p0 .. p0}, Landroid/support/v4/view/t;->p(Landroid/view/View;)Z
    ...
    .line 1019
    invoke-static {v12}, Landroid/support/v4/view/t;->p(Landroid/view/View;)Z
    ...
    .line 1062
    invoke-static {v12}, Landroid/support/v4/view/t;->l(Landroid/view/View;)F
    ...
    invoke-static {v12, v2}, Landroid/support/v4/view/t;->a(Landroid/view/View;F)V
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    .line 1906
    invoke-virtual {p1}, Landroid/support/v4/widget/DrawerLayout$e;->getSuperState()Landroid/os/Parcelable;
    ...
    .line 1908
    iget v0, p1, Landroid/support/v4/widget/DrawerLayout$e;->a:I
    ...
    .line 1925
    iget p1, p1, Landroid/support/v4/widget/DrawerLayout$e;->e:I
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    iput v0, v1, Landroid/support/v4/widget/DrawerLayout$e;->a:I

    .line 1950
    :cond_4
    iget v0, p0, Landroid/support/v4/widget/DrawerLayout;->r:I

    iput v0, v1, Landroid/support/v4/widget/DrawerLayout$e;->b:I

    .line 1951
    iget v0, p0, Landroid/support/v4/widget/DrawerLayout;->s:I

    iput v0, v1, Landroid/support/v4/widget/DrawerLayout$e;->c:I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v1, v4, v5}, Landroid/support/v4/widget/s;->d(II)Landroid/view/View;
    ...
    invoke-virtual {v1}, Landroid/support/v4/widget/s;->d()I
