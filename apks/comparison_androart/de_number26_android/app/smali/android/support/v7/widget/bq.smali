...
.method public constructor <init>(Landroid/support/v7/widget/Toolbar;Z)V
    ...
    invoke-direct {p0, p1, p2, v0, v1}, Landroid/support/v7/widget/bq;-><init>(Landroid/support/v7/widget/Toolbar;ZII)V
...
.method public constructor <init>(Landroid/support/v7/widget/Toolbar;ZII)V
    ...
    .line 89
    iput p4, p0, Landroid/support/v7/widget/bq;->o:I

    .line 91
    iput p4, p0, Landroid/support/v7/widget/bq;->p:I
    ...
    invoke-static {p1, v0, v1, v2, p4}, Landroid/support/v7/widget/bp;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/bp;
    ...
    invoke-virtual {p1, v0}, Landroid/support/v7/widget/bp;->a(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p1, p2}, Landroid/support/v7/widget/bp;->c(I)Ljava/lang/CharSequence;
    ...
    .line 112
    invoke-virtual {p0, p2}, Landroid/support/v7/widget/bq;->b(Ljava/lang/CharSequence;)V
    ...
    .line 117
    invoke-virtual {p0, p2}, Landroid/support/v7/widget/bq;->c(Ljava/lang/CharSequence;)V
    ...
    .line 122
    invoke-virtual {p0, p2}, Landroid/support/v7/widget/bq;->d(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 127
    invoke-virtual {p0, p2}, Landroid/support/v7/widget/bq;->a(Landroid/graphics/drawable/Drawable;)V

    .line 129
    :cond_4
    iget-object p2, p0, Landroid/support/v7/widget/bq;->j:Landroid/graphics/drawable/Drawable;

    if-nez p2, :cond_5

    iget-object p2, p0, Landroid/support/v7/widget/bq;->q:Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, p2}, Landroid/support/v7/widget/bq;->b(Landroid/graphics/drawable/Drawable;)V

    .line 132
    :cond_5
    sget p2, Landroid/support/v7/a/a$j;->ActionBar_displayOptions:I

    invoke-virtual {p1, p2, p4}, Landroid/support/v7/widget/bp;->a(II)I

    move-result p2

    invoke-virtual {p0, p2}, Landroid/support/v7/widget/bq;->c(I)V

    .line 134
    sget p2, Landroid/support/v7/a/a$j;->ActionBar_customNavigationLayout:I

    invoke-virtual {p1, p2, p4}, Landroid/support/v7/widget/bp;->g(II)I
    ...
    invoke-virtual {p0, p2}, Landroid/support/v7/widget/bq;->a(Landroid/view/View;)V

    .line 139
    iget p2, p0, Landroid/support/v7/widget/bq;->e:I
    ...
    invoke-virtual {p1, p2, p4}, Landroid/support/v7/widget/bp;->f(II)I
    ...
    .line 146
    iget-object p2, p0, Landroid/support/v7/widget/bq;->a:Landroid/support/v7/widget/Toolbar;
    ...
    invoke-virtual {p1, p2, v0}, Landroid/support/v7/widget/bp;->d(II)I
    ...
    invoke-virtual {p1, v1, v0}, Landroid/support/v7/widget/bp;->d(II)I
    ...
    .line 171
    iget-object p4, p0, Landroid/support/v7/widget/bq;->a:Landroid/support/v7/widget/Toolbar;
    ...
    .line 174
    :cond_c
    invoke-direct {p0}, Landroid/support/v7/widget/bq;->r()I

    move-result p2

    iput p2, p0, Landroid/support/v7/widget/bq;->e:I
    ...
    .line 178
    invoke-virtual {p0, p3}, Landroid/support/v7/widget/bq;->g(I)V

    .line 179
    iget-object p1, p0, Landroid/support/v7/widget/bq;->a:Landroid/support/v7/widget/Toolbar;

    invoke-virtual {p1}, Landroid/support/v7/widget/Toolbar;->getNavigationContentDescription()Ljava/lang/CharSequence;

    move-result-object p1

    iput-object p1, p0, Landroid/support/v7/widget/bq;->m:Ljava/lang/CharSequence;

    .line 181
    iget-object p1, p0, Landroid/support/v7/widget/bq;->a:Landroid/support/v7/widget/Toolbar;

    new-instance p2, Landroid/support/v7/widget/bq$1;

    invoke-direct {p2, p0}, Landroid/support/v7/widget/bq$1;-><init>(Landroid/support/v7/widget/bq;)V
...
.method private t()V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/bq;->j:Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    iget-object v1, p0, Landroid/support/v7/widget/bq;->q:Landroid/graphics/drawable/Drawable;
...
.method public a(IJ)Landroid/support/v4/view/x;
    ...
    new-instance p3, Landroid/support/v7/widget/bq$2;

    invoke-direct {p3, p0, p1}, Landroid/support/v7/widget/bq$2;-><init>(Landroid/support/v7/widget/bq;I)V
...
.method public a(I)V
    ...
    .line 300
    invoke-virtual {p0}, Landroid/support/v7/widget/bq;->b()Landroid/content/Context;
    ...
    :goto_0
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/bq;->a(Landroid/graphics/drawable/Drawable;)V
...
.method public a(Landroid/view/View;)V
    ...
    .line 543
    iget p1, p0, Landroid/support/v7/widget/bq;->e:I
...
.method public a(Ljava/lang/CharSequence;)V
    ...
    .line 243
    invoke-direct {p0, p1}, Landroid/support/v7/widget/bq;->e(Ljava/lang/CharSequence;)V
...
.method public b(I)V
    ...
    :goto_0
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/bq;->d(Landroid/graphics/drawable/Drawable;)V
...
.method public b(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 593
    invoke-direct {p0}, Landroid/support/v7/widget/bq;->t()V
...
.method public c(I)V
    ...
    .line 390
    invoke-direct {p0}, Landroid/support/v7/widget/bq;->u()V
...
.method public d(I)V
    ...
    :goto_0
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/bq;->b(Landroid/graphics/drawable/Drawable;)V
...
.method public e(I)V
    ...
    :goto_0
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/bq;->d(Ljava/lang/CharSequence;)V
...
.method public g(I)V
    ...
    .line 198
    :cond_0
    iput p1, p0, Landroid/support/v7/widget/bq;->p:I
    ...
    .line 200
    iget p1, p0, Landroid/support/v7/widget/bq;->p:I

    invoke-virtual {p0, p1}, Landroid/support/v7/widget/bq;->e(I)V
