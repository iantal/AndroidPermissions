...
.method private constructor <init>(Lokhttp3/internal/framed/FramedConnection$Builder;)V
    ...
    invoke-static {p1}, Lokhttp3/internal/framed/FramedConnection$Builder;->access$600(Lokhttp3/internal/framed/FramedConnection$Builder;)Lg/d;

    move-result-object v1

    iget-boolean v2, p0, Lokhttp3/internal/framed/FramedConnection;->client:Z

    invoke-interface {v0, v1, v2}, Lokhttp3/internal/framed/Variant;->newWriter(Lg/d;Z)Lokhttp3/internal/framed/FrameWriter;
    ...
    invoke-static {p1}, Lokhttp3/internal/framed/FramedConnection$Builder;->access$700(Lokhttp3/internal/framed/FramedConnection$Builder;)Lg/e;

    move-result-object p1

    iget-boolean v2, p0, Lokhttp3/internal/framed/FramedConnection;->client:Z

    invoke-interface {v1, p1, v2}, Lokhttp3/internal/framed/Variant;->newReader(Lg/e;Z)Lokhttp3/internal/framed/FrameReader;
...
.method static synthetic access$1400(Lokhttp3/internal/framed/FramedConnection;ILg/e;IZ)V
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 55
    invoke-direct {p0, p1, p2, p3, p4}, Lokhttp3/internal/framed/FramedConnection;->pushDataLater(ILg/e;IZ)V
...
.method private pushDataLater(ILg/e;IZ)V
    .locals 9
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 873
    invoke-interface {p2, v5, v0, v1}, Lg/e;->read(Lg/c;J)J

    .line 874
    invoke-virtual {v5}, Lg/c;->a()J
    ...
    invoke-direct/range {v0 .. v7}, Lokhttp3/internal/framed/FramedConnection$6;-><init>(Lokhttp3/internal/framed/FramedConnection;Ljava/lang/String;[Ljava/lang/Object;ILg/c;IZ)V
...
.method public writeData(IZLg/c;J)V
    .locals 8
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-interface {p4, p2, p1, p3, v3}, Lokhttp3/internal/framed/FrameWriter;->data(ZILg/c;I)V
    ...
    :goto_2
    invoke-interface {v4, v5, p1, p3, v2}, Lokhttp3/internal/framed/FrameWriter;->data(ZILg/c;I)V
