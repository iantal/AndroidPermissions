...
.field private final inflaterSource:Lg/l;
...
.method public constructor <init>(Lg/e;)V
    ...
    invoke-direct {v0, p0, p1}, Lokhttp3/internal/framed/NameValueBlockReader$1;-><init>(Lokhttp3/internal/framed/NameValueBlockReader;Lg/t;)V
    ...
    invoke-direct {v1, v0, p1}, Lg/l;-><init>(Lg/t;Ljava/util/zip/Inflater;)V

    iput-object v1, p0, Lokhttp3/internal/framed/NameValueBlockReader;->inflaterSource:Lg/l;

    .line 77
    iget-object p1, p0, Lokhttp3/internal/framed/NameValueBlockReader;->inflaterSource:Lg/l;

    invoke-static {p1}, Lg/m;->a(Lg/t;)Lg/e;

    move-result-object p1

    iput-object p1, p0, Lokhttp3/internal/framed/NameValueBlockReader;->source:Lg/e;
...
.method private doneReading()V
    ...
    .line 109
    iget-object v0, p0, Lokhttp3/internal/framed/NameValueBlockReader;->inflaterSource:Lg/l;
...
.method private readByteString()Lg/f;
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 100
    iget-object v0, p0, Lokhttp3/internal/framed/NameValueBlockReader;->source:Lg/e;
    ...
    .line 101
    iget-object v1, p0, Lokhttp3/internal/framed/NameValueBlockReader;->source:Lg/e;
...
.method public readNameValueBlock(I)Ljava/util/List;
    ...
    .line 83
    iget-object p1, p0, Lokhttp3/internal/framed/NameValueBlockReader;->source:Lg/e;

    invoke-interface {p1}, Lg/e;->k()I
    ...
    .line 89
    invoke-direct {p0}, Lokhttp3/internal/framed/NameValueBlockReader;->readByteString()Lg/f;

    move-result-object v2

    invoke-virtual {v2}, Lg/f;->d()Lg/f;
    ...
    invoke-direct {v4, v2, v3}, Lokhttp3/internal/framed/Header;-><init>(Lg/f;Lg/f;)V
