...
.method static synthetic access$1000(Lg/e;)I
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 136
    invoke-static {p0}, Lokhttp3/Cache;->readInt(Lg/e;)I
...
.method private static readInt(Lg/e;)I
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 725
    :try_start_0
    invoke-interface {p0}, Lg/e;->o()J

    move-result-wide v0

    .line 726
    invoke-interface {p0}, Lg/e;->s()Ljava/lang/String;
...
.method get(Lokhttp3/Request;)Lokhttp3/Response;
    ...
    invoke-virtual {v0, v3}, Lokhttp3/internal/cache/DiskLruCache$Snapshot;->getSource(I)Lg/t;

    move-result-object v3

    invoke-direct {v2, v3}, Lokhttp3/Cache$Entry;-><init>(Lg/t;)V
    :try_end_1
