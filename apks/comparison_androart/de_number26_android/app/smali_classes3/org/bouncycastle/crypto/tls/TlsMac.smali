...
.method public calculateMac(JS[BII)[B
    ...
    .line 112
    invoke-static {p1, p2, v2, v3}, Lorg/bouncycastle/crypto/tls/TlsUtils;->writeUint64(J[BI)V

    const/16 p1, 0x8

    .line 113
    invoke-static {p3, v2, p1}, Lorg/bouncycastle/crypto/tls/TlsUtils;->writeUint8(S[BI)V
    ...
    .line 116
    invoke-static {v0, v2, p1}, Lorg/bouncycastle/crypto/tls/TlsUtils;->writeVersion(Lorg/bouncycastle/crypto/tls/ProtocolVersion;[BI)V
    ...
    invoke-static {p6, v2, p1}, Lorg/bouncycastle/crypto/tls/TlsUtils;->writeUint16(I[BI)V
    ...
    invoke-interface {p1, v2, v3, p2}, Lorg/bouncycastle/crypto/Mac;->update([BII)V
    ...
    invoke-interface {p2, p1, v3}, Lorg/bouncycastle/crypto/Mac;->doFinal([BI)I
