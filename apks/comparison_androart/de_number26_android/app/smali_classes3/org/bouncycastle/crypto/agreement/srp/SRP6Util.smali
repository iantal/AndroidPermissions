...
.method public static calculateKey(Lorg/bouncycastle/crypto/Digest;Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;
    ...
    invoke-interface {p0, p1, p2, v1}, Lorg/bouncycastle/crypto/Digest;->update([BII)V
...
.method public static calculateX(Lorg/bouncycastle/crypto/Digest;Ljava/math/BigInteger;[B[B[B)Ljava/math/BigInteger;
    ...
    invoke-interface {p0, p3, v0, v3}, Lorg/bouncycastle/crypto/Digest;->update([BII)V
    ...
    invoke-interface {p0, p4, v0, p3}, Lorg/bouncycastle/crypto/Digest;->update([BII)V
...
.method private static hashPaddedPair(Lorg/bouncycastle/crypto/Digest;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;
    ...
    invoke-interface {p0, p2, p3, v1}, Lorg/bouncycastle/crypto/Digest;->update([BII)V

    .line 136
    array-length p2, p1

    invoke-interface {p0, p1, p3, p2}, Lorg/bouncycastle/crypto/Digest;->update([BII)V
    ...
    .line 139
    invoke-interface {p0, p1, p3}, Lorg/bouncycastle/crypto/Digest;->doFinal([BI)I
...
.method private static hashPaddedTriplet(Lorg/bouncycastle/crypto/Digest;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;
    ...
    invoke-interface {p0, p2, p4, v1}, Lorg/bouncycastle/crypto/Digest;->update([BII)V

    .line 119
    array-length p2, p3

    invoke-interface {p0, p3, p4, p2}, Lorg/bouncycastle/crypto/Digest;->update([BII)V

    .line 120
    array-length p2, p1

    invoke-interface {p0, p1, p4, p2}, Lorg/bouncycastle/crypto/Digest;->update([BII)V
    ...
    .line 123
    invoke-interface {p0, p1, p4}, Lorg/bouncycastle/crypto/Digest;->doFinal([BI)I
