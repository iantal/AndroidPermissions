...
.method public final a(Landroid/support/v4/app/aq;Landroid/support/v4/app/ar;)Landroid/app/Notification;
    ...
    iget-object v0, p1, Landroid/support/v4/app/aq;->a:Landroid/content/Context;

    iget-object v1, p1, Landroid/support/v4/app/aq;->F:Landroid/app/Notification;
    ...
    iget-object v4, p1, Landroid/support/v4/app/aq;->h:Ljava/lang/CharSequence;

    iget-object v5, p1, Landroid/support/v4/app/aq;->f:Landroid/widget/RemoteViews;

    iget v6, p1, Landroid/support/v4/app/aq;->i:I

    iget-object v7, p1, Landroid/support/v4/app/aq;->d:Landroid/app/PendingIntent;

    iget-object v8, p1, Landroid/support/v4/app/aq;->e:Landroid/app/PendingIntent;

    iget-object v9, p1, Landroid/support/v4/app/aq;->g:Landroid/graphics/Bitmap;
