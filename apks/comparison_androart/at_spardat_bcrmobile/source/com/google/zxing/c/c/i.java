...
public final class i
{
  ...
  {
    if (paramString.length() != paramK.f()) {
      throw new IllegalArgumentException("The number of codewords does not match the selected symbol");
    }
    StringBuilder localStringBuilder = new StringBuilder(paramK.f() + paramK.g());
    localStringBuilder.append(paramString);
    int m = paramK.a();
    if (m == 1) {
      localStringBuilder.append(a(paramString, paramK.g()));
    }
    for (;;)
    {
      ...
      while (i < m)
      {
        ...
        {
          localStringBuilder.setCharAt(paramK.f() + k, ((String)localObject).charAt(j));
          k += m;
          j += 1;
        }
        i += 1;
