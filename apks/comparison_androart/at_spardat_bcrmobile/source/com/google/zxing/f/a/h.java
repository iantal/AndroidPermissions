...
class h
{
  ...
  {
    this.a = new c(paramC);
    this.b = new d[paramC.d() - paramC.c() + 1];
  }
  ...
  public String toString()
  {
    ...
    if (j < m)
    {
      ...
      for (i = k;; i = k)
      {
        ...
        break;
        k = i + 1;
        localFormatter.format("%3d: %3d|%3d%n", new Object[] { Integer.valueOf(i), Integer.valueOf(localObject2.h()), Integer.valueOf(localObject2.g()) });
      }
    }
