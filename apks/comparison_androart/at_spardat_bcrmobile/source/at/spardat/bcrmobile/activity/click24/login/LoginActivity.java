  ...
  implements View.OnClickListener
{
  ...
  private final BroadcastReceiver s = new BroadcastReceiver()
  {
    public final void onReceive(Context paramAnonymousContext, Intent paramAnonymousIntent)
    {
      ...
      for (;;)
      {
        paramAnonymousContext = at.spardat.bcrmobile.d.a.a(true, LoginActivity.this, paramAnonymousIntent, paramAnonymousContext);
        if ((paramAnonymousContext != null) && (at.spardat.bcrmobile.b.a.b.compareTo(paramAnonymousContext) == 0))
        {
          paramAnonymousContext = LoginActivity.q(LoginActivity.this).getText().toString();
          paramAnonymousIntent = LoginActivity.d(LoginActivity.this).getText().toString();
          LoginActivity.b(LoginActivity.this, paramAnonymousContext, paramAnonymousIntent);
        }
  ...
  private void b(String paramString)
  {
    ...
    catch (ActivityNotFoundException paramString)
    {
      ...
      at.spardat.bcrmobile.b.b.a(at.spardat.bcrmobile.b.c.ERROR, LoginActivity.class.getName(), "pushEtokenApp() " + paramString.getLocalizedMessage());
    }
  }
  ...
  private void b(String paramString1, String paramString2)
  {
    ...
    paramString1.addAction("api_update");
    g.a(this).a(this.s, paramString1);
    n();
  }
  ...
  private void c(String paramString1, String paramString2)
  {
    ...
    this.m = new at.spardat.bcrmobile.a.b.b.b(this, this.g, getResources().getString(2131165683))
    {
      private void b(LoginModel paramAnonymousLoginModel)
      {
        if (this.f != null)
        {
          paramAnonymousLoginModel = a(LoginActivity.this, this.f, LoginActivity.this.getResources().getString(2131165883));
          LoginActivity.a(LoginActivity.this, true);
          if ((this.f instanceof at.spardat.bcrmobile.c.c)) {
            LoginActivity.a(LoginActivity.this, paramAnonymousLoginModel, LoginActivity.f(LoginActivity.this), this.f);
          }
          for (;;)
          {
            ...
            {
              a(2131166009, LoginActivity.a(LoginActivity.this, this.h, paramAnonymousLoginModel));
            }
            else
            {
              LoginActivity.f(LoginActivity.this).setVisibility(0);
              LoginActivity.f(LoginActivity.this).setText(paramAnonymousLoginModel);
        ...
        if (paramAnonymousLoginModel != null)
        {
          ...
          Object localObject1 = LoginActivity.this.getBaseContext().getSharedPreferences("PREF_LOCALE_FILE", 0).edit();
          if (localObject1 != null)
          {
            ((SharedPreferences.Editor)localObject1).putBoolean("PREF_FIRST_TIME_LOGIN", true);
            ((SharedPreferences.Editor)localObject1).commit();
          }
          Object localObject2 = LoginActivity.this.getBaseContext();
          localObject1 = LoginActivity.k(LoginActivity.this);
          localObject2 = ((Context)localObject2).getSharedPreferences("PREF_LOCALE_FILE", 0).edit();
          if ((localObject2 != null) && (localObject1 != null))
          {
            ((SharedPreferences.Editor)localObject2).putInt("PREF_LAST_LOGIN_TYPE", ((at.spardat.bcrmobile.b.a.l)localObject1).ordinal());
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      do
      {
        do
        {
          ...
          paramView.putExtra("app_browser_url", getResources().getString(2131165687));
          ...
          {
            i1 = paramView.getId();
            paramView = (RelativeLayout)this.i.findViewById(2131427653);
            localObject = (Button)this.i.findViewById(2131427656);
      ...
      paramView.setData(Uri.parse(getString(2131165710)));
      if (at.spardat.bcrmobile.b.b.a()) {
        at.spardat.bcrmobile.b.b.a(at.spardat.bcrmobile.b.c.DEBUG, LoginActivity.class.getName(), "New user register URL " + paramView.getDataString());
      }
      startActivity(paramView);
      return;
      paramView = new Intent("android.intent.action.VIEW");
      paramView.setData(Uri.parse(getString(2131165610)));
      if (at.spardat.bcrmobile.b.b.a()) {
        at.spardat.bcrmobile.b.b.a(at.spardat.bcrmobile.b.c.DEBUG, LoginActivity.class.getName(), "Reset password URL " + paramView.getDataString());
      }
      startActivity(paramView);
      return;
    ...
    {
    default: 
      b(paramView, this.k.getText().toString());
      return;
    }
    ...
    Object localObject = this.k.getText().toString();
    if (!at.spardat.bcrmobile.e.d.a((String)localObject))
    {
      b(paramView, (String)localObject);
      return;
    }
    paramView = new Intent("android.intent.action.VIEW");
    paramView.addCategory("android.intent.category.DEFAULT");
    localObject = getString(2131165931);
    paramView.setData(Uri.parse((String)localObject));
    if (getPackageManager().queryIntentActivities(paramView, 0).size() > 0)
    {
      i1 = 1;
      if (i1 == 0) {
        break label1267;
  ...
  protected void onCreate(final Bundle paramBundle)
  {
    ...
    paramBundle = (LinearLayout)findViewById(2131427644).findViewById(2131427645);
    this.f = ((TextView)paramBundle.findViewById(2131427372));
    paramBundle = (LinearLayout)paramBundle.findViewById(2131427646);
    this.h = ((LinearLayout)paramBundle.findViewById(2131427647));
    TextView localTextView2 = (TextView)this.h.findViewById(2131427648);
    localTextView2.setOnClickListener(this);
    TextView localTextView3 = (TextView)this.h.findViewById(2131427649);
    localTextView3.setOnClickListener(this);
    TextView localTextView4 = (TextView)this.h.findViewById(2131427650);
    localTextView4.setOnClickListener(this);
    this.i = ((RelativeLayout)paramBundle.findViewById(2131427651));
    TextView localTextView5 = (TextView)this.i.findViewById(2131427652);
    ...
    TextView localTextView1 = (TextView)((RelativeLayout)paramBundle.findViewById(2131427657)).findViewById(2131427659);
    localTextView1.setText(Html.fromHtml(at.spardat.bcrmobile.e.d.a(new Object[] { "<u>", getResources().getString(2131165806), "</u>" })));
    localTextView1.setOnClickListener(this);
    this.l = ((TextView)paramBundle.findViewById(2131427660));
    this.l.setText(Html.fromHtml(at.spardat.bcrmobile.e.d.a(new Object[] { "<u>", getResources().getString(2131165609), "</u>" })));
    ...
    if (at.spardat.bcrmobile.e.l.d(getBaseContext()))
    {
      ...
      paramBundle = getBaseContext().getSharedPreferences("PREF_LOCALE_FILE", 0);
      localTextView1 = null;
      int i1 = paramBundle.getInt("PREF_LAST_LOGIN_TYPE", -1);
      paramBundle = localTextView1;
      if (i1 != -1)
      {
        paramBundle = localTextView1;
        if (at.spardat.bcrmobile.b.a.l.values().length > i1) {
          paramBundle = at.spardat.bcrmobile.b.a.l.values()[i1];
        }
      }
      if ((!getBaseContext().getSharedPreferences("PREF_LOCALE_FILE", 0).getBoolean("PREF_FIRST_TIME_LOGIN", false)) || (paramBundle == null)) {
        break label709;
      }
    ...
    for (;;)
    {
      paramBundle = (ScrollView)findViewById(2131427644);
        ...
        public final void onGlobalLayout()
        {
          if (LoginActivity.a(LoginActivity.this, LoginActivity.d(LoginActivity.this).getRootView())) {
            paramBundle.post(new Runnable()
            {
              ...
              {
                LoginActivity.3.this.a.scrollTo(0, LoginActivity.e(LoginActivity.this).getTop() - LoginActivity.3.this.a.getHeight() + LoginActivity.f(LoginActivity.this).getHeight() + (int)(LoginActivity.e(LoginActivity.this).getHeight() * 1.1F));
              }
            });
          }
        }
      ...
      if (paramBundle != null) {
        a(paramBundle.getStringExtra("LOGIN_PASSWORD"));
      }
      return;
      this.j.requestFocus();
      break;
