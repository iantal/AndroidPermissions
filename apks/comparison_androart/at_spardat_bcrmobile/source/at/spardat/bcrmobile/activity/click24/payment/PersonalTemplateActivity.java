  ...
  implements j
{
  ...
  private void a(TemplateListModel paramTemplateListModel)
  {
    ...
    {
      paramTemplateListModel = paramTemplateListModel.getTemplateList().iterator();
      while (paramTemplateListModel.hasNext())
      {
        TemplateListItemModel localTemplateListItemModel = (TemplateListItemModel)paramTemplateListModel.next();
  ...
  public final void a(int paramInt)
  {
    ...
    Object localObject = (TemplateListItemModel)this.d.get(paramInt);
    if ((localObject != null) && (!at.spardat.bcrmobile.e.d.a(((TemplateListItemModel)localObject).getTemplateType()))) {
      if (((TemplateListItemModel)localObject).getTemplateType().equals(x.DPO.name()))
      {
    ...
    for (;;)
    {
      ...
      return;
      if (((TemplateListItemModel)localObject).getTemplateType().equals(x.BMK.name()))
      {
