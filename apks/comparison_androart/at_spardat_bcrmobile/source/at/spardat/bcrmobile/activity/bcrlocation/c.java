  ...
  extends BaseAdapter
{
  ...
  public c(BCRPartnerDetailActivity paramBCRPartnerDetailActivity, Context paramContext, ATMBranchItemModel paramATMBranchItemModel)
  {
    ...
    if (paramATMBranchItemModel != null)
    {
      ...
      {
        this.c.add(d.a(new Object[] { paramATMBranchItemModel.getDiscount(), "%" }));
  ...
  public final View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null) {
      paramViewGroup = LayoutInflater.from(this.b).inflate(2130903073, null);
    }
    if ((this.c.get(paramInt) != null) && (this.d.get(paramInt) != null))
    {
      ((TextView)paramViewGroup.findViewById(2131427492)).setText((CharSequence)this.c.get(paramInt));
      ((TextView)paramViewGroup.findViewById(2131427493)).setText((CharSequence)this.d.get(paramInt));
    }
