  ...
  extends at.spardat.bcrmobile.activity.click24.d
{
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    paramBundle = (MailBoxModel)this.a.a("mailbox_model");
    if (paramBundle != null) {
      if (!at.spardat.bcrmobile.e.d.a(paramBundle.getMessages())) {
        a(paramBundle.getMessages());
      }
    }
    for (;;)
    {
      paramBundle = new IntentFilter();
      paramBundle.addAction("update_mail_status");
      g.a(getApplicationContext()).a(this.d, paramBundle);
      return;
      paramBundle = findViewById(2131427374);
      paramBundle.setVisibility(0);
      ((ProgressBar)paramBundle.findViewById(2131427380)).setVisibility(8);
      ((TextView)paramBundle.findViewById(2131427381)).setText(getString(2131165697));
      continue;
