  ...
  implements View.OnClickListener, e
{
  ...
  private void a(final k paramK, String paramString, final at.spardat.bcrmobile.b.a.i paramI)
  {
    ...
    try
    {
      ...
      if ((!d.a(paramString)) && (!d.a((String)localObject)))
      {
        paramK.a(this.e, at.spardat.bcrmobile.e.i.a(paramI), true);
        this.g = new at.spardat.bcrmobile.a.b.a.a(this.a, (String)localObject, paramString)
        {
          private void a(AccountDescriptionModel paramAnonymousAccountDescriptionModel)
          {
            AccountDescriptionModel localAccountDescriptionModel = (AccountDescriptionModel)c.a(c.this).a(str);
            List localList2;
            List localList1;
            if ((paramAnonymousAccountDescriptionModel != null) && (localAccountDescriptionModel != null))
            {
              ...
              localList2 = d.a(paramAnonymousAccountDescriptionModel.getLoadMoreTransactionsList());
              if (!d.a(localList2))
              {
                localList1 = d.a(localAccountDescriptionModel.getTransactionModelList());
                if (paramI != at.spardat.bcrmobile.b.a.i.ONE_WEEK) {
                  break label142;
                }
                localList2 = c.a(c.this, this.k, localList1, localList2);
            ...
            for (;;)
            {
              ...
              c.a(c.this).a(str, localAccountDescriptionModel);
  ...
  {
    this.e.a(this);
    Object localObject = (AccountDescriptionModel)this.b.a(this.c.getAccountInternalId());
    if (localObject == null)
    {
      localObject = this.c.getAccountInternalId();
      this.g = new at.spardat.bcrmobile.a.b.a.a(this.a, this.d, this.a.getResources().getString(2131165673))
      {
        protected final void b(String paramAnonymousString) {}
      };
      this.g.execute(new String[] { localObject });
      return;
    }
    a((AccountDescriptionModel)localObject);
  }
