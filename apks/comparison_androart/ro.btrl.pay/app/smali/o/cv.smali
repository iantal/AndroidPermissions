...
.method private constructor <init>(Lo/cz;)V
    ...
    iput-object p1, p0, Lo/cv;->ˎ:Lo/cz;
...
.method synthetic constructor <init>(Lo/cz;Lo/cx;)V
    .locals 0

    invoke-direct {p0, p1}, Lo/cv;-><init>(Lo/cz;)V
...
.method public final ॱ(Lo/mp;)V
    ...
    iget-object v0, p0, Lo/cv;->ˎ:Lo/cz;
    ...
    iget-object v2, p0, Lo/cv;->ˎ:Lo/cz;

    invoke-static {v2}, Lo/cz;->ॱ(Lo/cz;)Ljava/util/Map;
    ...
    invoke-static {v0, v1}, Lo/cz;->ˏ(Lo/cz;Ljava/util/Map;)Ljava/util/Map;

    iget-object v0, p0, Lo/cv;->ˎ:Lo/cz;

    invoke-static {v0}, Lo/cz;->ॱ(Lo/cz;)Ljava/util/Map;
    ...
    iget-object v1, p0, Lo/cv;->ˎ:Lo/cz;

    invoke-static {v1}, Lo/cz;->ᐝ(Lo/cz;)Lo/bW;

    move-result-object v1

    invoke-static {v0, v1}, Lo/cz;->ˏ(Lo/cz;Lo/bW;)Lo/bW;
    ...
    invoke-static {v0}, Lo/cz;->ʻ(Lo/cz;)Lo/bW;
    ...
    invoke-static {v0, v1}, Lo/cz;->ˎ(Lo/cz;Z)Z

    iget-object v0, p0, Lo/cv;->ˎ:Lo/cz;

    invoke-static {v0}, Lo/cz;->ॱˊ(Lo/cz;)Lo/cX;

    move-result-object v0

    iget-object v1, p0, Lo/cv;->ˎ:Lo/cz;

    invoke-static {v1}, Lo/cz;->ʻ(Lo/cz;)Lo/bW;

    move-result-object v1

    invoke-virtual {v0, v1}, Lo/cX;->ˊ(Lo/bW;)V
