...
.method constructor <init>(Lo/jH;)V
    ...
    invoke-direct {v0, p0, v1, v2}, Lo/jc;-><init>(Lo/jd;Landroid/content/Context;Ljava/lang/String;)V

    iput-object v0, p0, Lo/jd;->ॱ:Lo/jc;

    return-void
.end method

.method private final ˈ()Landroid/database/sqlite/SQLiteDatabase;
    .locals 2
    ...
    :cond_0
    iget-object v0, p0, Lo/jd;->ॱ:Lo/jc;

    invoke-virtual {v0}, Lo/jc;->getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
...
.method private final ˏ(I[B)Z
    ...
    :try_start_0
    invoke-direct/range {p0 .. p0}, Lo/jd;->ˈ()Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-virtual {v0, v1, v11}, Lo/ji;->ॱ(Ljava/lang/String;Ljava/lang/Object;)V
...
.method public final ˋ(I)Ljava/util/List;
    .locals 24
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(I)Ljava/util/List<Lo/hS;>;"
        }
    .end annotation
    ...
    check-cast v19, Lo/iT;
    :try_end_2
    .catch Lo/hP; {:try_start_2 .. :try_end_2} :catch_0
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
    ...
    check-cast v0, Lo/kZ;
    :try_end_6
    .catch Lo/hP; {:try_start_6 .. :try_end_6} :catch_1
    ...
    check-cast v0, Lo/iA;
    :try_end_a
    .catch Lo/hP; {:try_start_a .. :try_end_a} :catch_2
...
.method public final ˋ(Lo/kZ;)Z
    ...
    invoke-virtual {p1, v2, v0}, Lo/kZ;->writeToParcel(Landroid/os/Parcel;I)V
    ...
    invoke-direct {p0, v0, v3}, Lo/jd;->ˏ(I[B)Z
...
.method public final ˏ(Lo/iA;)Z
    .locals 3

    invoke-virtual {p0}, Lo/ke;->ॱˎ()Lo/la;

    invoke-static {p1}, Lo/la;->ˎ(Landroid/os/Parcelable;)[B
    ...
    invoke-direct {p0, v0, v2}, Lo/jd;->ˏ(I[B)Z
...
.method public final ˏ(Lo/iT;)Z
    ...
    invoke-virtual {p1, v2, v0}, Lo/iT;->writeToParcel(Landroid/os/Parcel;I)V
