...
.method public constructor <init>(Lo/jx;)V
    ...
    iput-object p1, p0, Lo/jt;->ˎ:Lo/jx;
...
.method public final ˊ(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-static/range {p1 .. p1}, Lo/jH;->ˋ(Landroid/content/Context;)Lo/jH;

    move-result-object v10

    invoke-virtual {v10}, Lo/jH;->ᐝ()Lo/je;

    move-result-object v11

    if-nez p2, :cond_0

    invoke-virtual {v11}, Lo/je;->ˊˊ()Lo/ji;
    ...
    invoke-virtual {v11}, Lo/je;->ˎˎ()Lo/ji;

    move-result-object v0

    const-string v1, "Local receiver got"

    invoke-virtual {v0, v1, v12}, Lo/ji;->ॱ(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    iget-object v0, v0, Lo/jt;->ˎ:Lo/jx;

    move-object/from16 v1, p1

    invoke-interface {v0, v1, v13}, Lo/jx;->ॱ(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-interface {v0}, Lo/jx;->ॱ()Landroid/content/BroadcastReceiver$PendingResult;
    ...
    :cond_3
    invoke-virtual {v11}, Lo/je;->ˋˊ()Lo/ji;
    ...
    invoke-virtual {v10}, Lo/jH;->ˋॱ()Lo/la;

    move-result-object v0

    invoke-virtual {v0, v15}, Lo/la;->ॱ(Landroid/net/Uri;)Landroid/os/Bundle;
    ...
    :cond_7
    invoke-virtual {v10}, Lo/jH;->ॱॱ()Lo/jy;
    ...
    invoke-direct/range {v1 .. v9}, Lo/ju;-><init>(Lo/jt;Lo/jH;JLandroid/os/Bundle;Landroid/content/Context;Lo/je;Landroid/content/BroadcastReceiver$PendingResult;)V
