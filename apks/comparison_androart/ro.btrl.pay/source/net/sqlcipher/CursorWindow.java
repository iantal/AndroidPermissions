  ...
  implements Parcelable
{
  ...
  {
    public CursorWindow ˎ(Parcel paramAnonymousParcel)
    {
      return new CursorWindow(paramAnonymousParcel, 0);
    }
    
    public CursorWindow[] ˏ(int paramAnonymousInt)
    {
  ...
  public void copyStringToBuffer(int paramInt1, int paramInt2, CharArrayBuffer paramCharArrayBuffer)
  {
    ...
    try
    {
      char[] arrayOfChar = copyStringToBuffer_native(paramInt1 - this.ˎ, paramInt2, paramCharArrayBuffer.data.length, paramCharArrayBuffer);
      if (arrayOfChar != null) {
  ...
  public byte[] getBlob(int paramInt1, int paramInt2)
  {
    ...
    try
    {
      byte[] arrayOfByte = getBlob_native(paramInt1 - this.ˎ, paramInt2);
      return arrayOfByte;
    }
    finally
    {
  ...
  public double getDouble(int paramInt1, int paramInt2)
  {
    ...
    try
    {
      double d = getDouble_native(paramInt1 - this.ˎ, paramInt2);
      return d;
    }
    finally
    {
  ...
  public int getInt(int paramInt1, int paramInt2)
  {
    ...
    try
    {
      long l = getLong_native(paramInt1 - this.ˎ, paramInt2);
      paramInt1 = (int)l;
      return paramInt1;
    }
    finally
  ...
  public String getString(int paramInt1, int paramInt2)
  {
    ...
    try
    {
      String str = getString_native(paramInt1 - this.ˎ, paramInt2);
      return str;
    }
    finally
    {
  ...
  public int getType(int paramInt1, int paramInt2)
  {
    ...
    try
    {
      paramInt1 = getType_native(paramInt1 - this.ˎ, paramInt2);
      return paramInt1;
    }
    finally
    {
  ...
  public boolean isBlob(int paramInt1, int paramInt2)
  {
    ...
    try
    {
      boolean bool = isBlob_native(paramInt1 - this.ˎ, paramInt2);
      return bool;
    }
    finally
    {
  ...
  public boolean isFloat(int paramInt1, int paramInt2)
  {
    ...
    try
    {
      boolean bool = isFloat_native(paramInt1 - this.ˎ, paramInt2);
      return bool;
    }
    finally
    {
  ...
  public boolean isLong(int paramInt1, int paramInt2)
  {
    ...
    try
    {
      boolean bool = isInteger_native(paramInt1 - this.ˎ, paramInt2);
      return bool;
    }
    finally
    {
  ...
  public boolean isNull(int paramInt1, int paramInt2)
  {
    ...
    try
    {
      boolean bool = isNull_native(paramInt1 - this.ˎ, paramInt2);
      return bool;
    }
    finally
    {
  ...
  public boolean isString(int paramInt1, int paramInt2)
  {
    ...
    try
    {
      boolean bool = isString_native(paramInt1 - this.ˎ, paramInt2);
      return bool;
    }
    finally
    {
  ...
  public boolean putBlob(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    ...
    try
    {
      boolean bool = putBlob_native(paramArrayOfByte, paramInt1 - this.ˎ, paramInt2);
      return bool;
    }
    finally
    {
  ...
  public boolean putDouble(double paramDouble, int paramInt1, int paramInt2)
  {
    ...
    try
    {
      boolean bool = putDouble_native(paramDouble, paramInt1 - this.ˎ, paramInt2);
      return bool;
    }
    finally
    {
  ...
  public boolean putLong(long paramLong, int paramInt1, int paramInt2)
  {
    ...
    try
    {
      boolean bool = putLong_native(paramLong, paramInt1 - this.ˎ, paramInt2);
      return bool;
    }
    finally
    {
  ...
  public boolean putNull(int paramInt1, int paramInt2)
  {
    ...
    try
    {
      boolean bool = putNull_native(paramInt1 - this.ˎ, paramInt2);
      return bool;
    }
    finally
    {
  ...
  public boolean putString(String paramString, int paramInt1, int paramInt2)
  {
    ...
    try
    {
      boolean bool = putString_native(paramString, paramInt1 - this.ˎ, paramInt2);
      return bool;
    }
    finally
    {
