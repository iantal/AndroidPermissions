...
final class ry
{
  public static X509Certificate[] ˋ(X509Certificate[] paramArrayOfX509Certificate, rJ paramRJ)
  {
    LinkedList localLinkedList = new LinkedList();
    int i = 0;
    if (paramRJ.ˎ(paramArrayOfX509Certificate[0])) {
      i = 1;
    }
    ...
    for (;;)
    {
      ...
      if (paramRJ.ˎ(paramArrayOfX509Certificate[k])) {
        i = 1;
      }
      j = i;
      if (!ॱ(paramArrayOfX509Certificate[k], paramArrayOfX509Certificate[(k - 1)])) {
        break;
      }
      localLinkedList.add(paramArrayOfX509Certificate[k]);
      k += 1;
    }
    paramArrayOfX509Certificate = paramRJ.ˏ(paramArrayOfX509Certificate[(k - 1)]);
  ...
  private static boolean ॱ(X509Certificate paramX509Certificate1, X509Certificate paramX509Certificate2)
  {
