...
{
  private static final ThreadLocal<double[]> ˊ = new ThreadLocal();
  ...
  public static int ˊ(int paramInt1, int paramInt2)
  {
    ...
    int k = ˎ(j, i);
    return Color.argb(k, ˋ(Color.red(paramInt1), j, Color.red(paramInt2), i, k), ˋ(Color.green(paramInt1), j, Color.green(paramInt2), i, k), ˋ(Color.blue(paramInt1), j, Color.blue(paramInt2), i, k));
  }
