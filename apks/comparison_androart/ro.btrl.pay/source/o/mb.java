...
{
  public static <T extends mc> String ˊ(T paramT)
  {
    if (paramT == null) {
      return "";
    }
    ...
    try
    {
      ˏ(null, paramT, new StringBuffer(), localStringBuffer);
    }
  ...
  private static void ˏ(String paramString, Object paramObject, StringBuffer paramStringBuffer1, StringBuffer paramStringBuffer2)
  {
    if (paramObject != null)
    {
      if ((paramObject instanceof mc))
      {
        ...
        if (paramString != null)
        {
          paramStringBuffer2.append(paramStringBuffer1).append(ॱ(paramString)).append(" <\n");
        ...
        while (i < n)
        {
          ...
          if ((!"cachedSize".equals(localObject2)) && ((j & 0x1) == 1) && ((j & 0x8) != 8) && (!((String)localObject2).startsWith("_")) && (!((String)localObject2).endsWith("_")))
          {
            ...
            if ((((Class)localObject3).isArray()) && (((Class)localObject3).getComponentType() != Byte.TYPE))
            {
              ...
              while (k < j)
              {
                ˏ((String)localObject2, Array.get(localObject4, k), paramStringBuffer1, paramStringBuffer2);
                k += 1;
              }
            }
            else
            {
              ˏ((String)localObject2, localObject4, paramStringBuffer1, paramStringBuffer2);
            }
          }
          i += 1;
        }
        ...
        while (i < j)
        {
          ...
          break label449;
          ˏ((String)localObject3, ((Method)localObject1).invoke(paramObject, new Object[0]), paramStringBuffer1, paramStringBuffer2);
          label449:
          i += 1;
        }
        if (paramString != null)
