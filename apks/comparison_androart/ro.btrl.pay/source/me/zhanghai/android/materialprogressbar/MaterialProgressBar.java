  ...
  extends ProgressBar
{
  ...
  private void applyPrimaryProgressTint()
  {
    ...
    {
      Drawable localDrawable = getTintTargetFromProgressDrawable(16908301, true);
      if (localDrawable != null) {
  ...
  private void applyProgressBackgroundTint()
  {
    ...
    {
      Drawable localDrawable = getTintTargetFromProgressDrawable(16908288, false);
      if (localDrawable != null) {
  ...
  private void applySecondaryProgressTint()
  {
    ...
    {
      Drawable localDrawable = getTintTargetFromProgressDrawable(16908303, false);
      if (localDrawable != null) {
  ...
  private void init(AttributeSet paramAttributeSet, int paramInt1, int paramInt2)
  {
    ...
    paramAttributeSet = о.ˊ(localContext, paramAttributeSet, R.styleable.MaterialProgressBar, paramInt1, paramInt2);
    this.mProgressStyle = paramAttributeSet.ˏ(R.styleable.MaterialProgressBar_mpb_progressStyle, 0);
    boolean bool2 = paramAttributeSet.ˊ(R.styleable.MaterialProgressBar_mpb_setBothDrawables, false);
    boolean bool3 = paramAttributeSet.ˊ(R.styleable.MaterialProgressBar_mpb_useIntrinsicPadding, true);
    ...
    boolean bool1 = paramAttributeSet.ˊ(paramInt1, bool1);
    paramInt1 = paramAttributeSet.ˏ(R.styleable.MaterialProgressBar_mpb_determinateCircularProgressStyle, 0);
    if (paramAttributeSet.ʻ(R.styleable.MaterialProgressBar_mpb_progressTint))
    {
      this.mProgressTintInfo.mProgressTint = paramAttributeSet.ॱ(R.styleable.MaterialProgressBar_mpb_progressTint);
      this.mProgressTintInfo.mHasProgressTint = true;
    }
    if (paramAttributeSet.ʻ(R.styleable.MaterialProgressBar_mpb_progressTintMode))
    {
      this.mProgressTintInfo.mProgressTintMode = DrawableCompat.parseTintMode(paramAttributeSet.ˏ(R.styleable.MaterialProgressBar_mpb_progressTintMode, -1), null);
      this.mProgressTintInfo.mHasProgressTintMode = true;
    }
    if (paramAttributeSet.ʻ(R.styleable.MaterialProgressBar_mpb_secondaryProgressTint))
    {
      this.mProgressTintInfo.mSecondaryProgressTint = paramAttributeSet.ॱ(R.styleable.MaterialProgressBar_mpb_secondaryProgressTint);
      this.mProgressTintInfo.mHasSecondaryProgressTint = true;
    }
    if (paramAttributeSet.ʻ(R.styleable.MaterialProgressBar_mpb_secondaryProgressTintMode))
    {
      this.mProgressTintInfo.mSecondaryProgressTintMode = DrawableCompat.parseTintMode(paramAttributeSet.ˏ(R.styleable.MaterialProgressBar_mpb_secondaryProgressTintMode, -1), null);
      this.mProgressTintInfo.mHasSecondaryProgressTintMode = true;
    }
    if (paramAttributeSet.ʻ(R.styleable.MaterialProgressBar_mpb_progressBackgroundTint))
    {
      this.mProgressTintInfo.mProgressBackgroundTint = paramAttributeSet.ॱ(R.styleable.MaterialProgressBar_mpb_progressBackgroundTint);
      this.mProgressTintInfo.mHasProgressBackgroundTint = true;
    }
    if (paramAttributeSet.ʻ(R.styleable.MaterialProgressBar_mpb_progressBackgroundTintMode))
    {
      this.mProgressTintInfo.mProgressBackgroundTintMode = DrawableCompat.parseTintMode(paramAttributeSet.ˏ(R.styleable.MaterialProgressBar_mpb_progressBackgroundTintMode, -1), null);
      this.mProgressTintInfo.mHasProgressBackgroundTintMode = true;
    }
    if (paramAttributeSet.ʻ(R.styleable.MaterialProgressBar_mpb_indeterminateTint))
    {
      this.mProgressTintInfo.mIndeterminateTint = paramAttributeSet.ॱ(R.styleable.MaterialProgressBar_mpb_indeterminateTint);
      this.mProgressTintInfo.mHasIndeterminateTint = true;
    }
    if (paramAttributeSet.ʻ(R.styleable.MaterialProgressBar_mpb_indeterminateTintMode))
    {
      this.mProgressTintInfo.mIndeterminateTintMode = DrawableCompat.parseTintMode(paramAttributeSet.ˏ(R.styleable.MaterialProgressBar_mpb_indeterminateTintMode, -1), null);
