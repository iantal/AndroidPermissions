...
class Animators
{
  ...
  public static Animator createIndeterminate(Object paramObject)
  {
    ...
    paramObject.setInterpolator(Interpolators.LINEAR.INSTANCE);
  ...
  public static Animator createIndeterminateHorizontalRect1(Object paramObject)
  {
    ...
    paramObject.setInterpolator(Interpolators.INDETERMINATE_HORIZONTAL_RECT1_SCALE_X.INSTANCE);
    paramObject.setRepeatCount(-1);
    AnimatorSet localAnimatorSet = new AnimatorSet();
  ...
  public static Animator createIndeterminateHorizontalRect2(Object paramObject)
  {
    ...
    paramObject.setDuration(2000L);
    paramObject.setInterpolator(Interpolators.INDETERMINATE_HORIZONTAL_RECT2_SCALE_X.INSTANCE);
    paramObject.setRepeatCount(-1);
    AnimatorSet localAnimatorSet = new AnimatorSet();
    localAnimatorSet.playTogether(new Animator[] { localObjectAnimator, paramObject });
    return localAnimatorSet;
