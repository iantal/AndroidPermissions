  ...
  extends FrameLayout
{
  ...
  {
    int i = 0;
    paramContext = v.a("http://schemas.android.com/apk/lib/com.google.android.gms.plus", "annotation", paramContext, paramAttributeSet, true, false, "PlusOneButton");
  ...
  {
    paramContext = v.a("http://schemas.android.com/apk/lib/com.google.android.gms.plus", "size", paramContext, paramAttributeSet, true, false, "PlusOneButton");
    ...
    implements View.OnClickListener, PlusOneButton.OnPlusOneClickListener
  {
    ...
    public void onClick(View paramView)
    {
      ...
      if (this.ih != null)
      {
        this.ih.onPlusOneClick(paramView);
        return;
      }
