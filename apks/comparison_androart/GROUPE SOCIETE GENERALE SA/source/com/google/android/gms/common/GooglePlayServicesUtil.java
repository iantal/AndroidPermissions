...
public final class GooglePlayServicesUtil
{
  ...
  public static Dialog a(int paramInt1, Activity paramActivity, int paramInt2, DialogInterface.OnCancelListener paramOnCancelListener, int paramInt3)
  {
    ...
    paramOnCancelListener = new i(paramActivity, a(paramActivity, paramInt1, paramInt3), paramInt2);
  ...
  private static boolean c(Context paramContext)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        paramContext = a(paramContext.getPackageManager().getPackageInfo("com.google.android.apps.bazaar", 64), I);
  ...
  public static int isGooglePlayServicesAvailable(Context paramContext)
  {
    ...
    if (localPackageInfo.versionCode < 3265100)
    {
      Log.w("GooglePlayServicesUtil", "Google Play services out of date.  Requires 3265100 but found " + localPackageInfo.versionCode);
      return 2;
    }
    try
    {
