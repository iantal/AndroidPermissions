    ...
    implements ICameraUpdateFactoryDelegate
  {
      ...
      implements ICameraUpdateFactoryDelegate
    {
        ...
        throws RemoteException
      {
        ...
        //   29: aload_0
        //   30: getfield 17	com/google/android/gms/maps/internal/ICameraUpdateFactoryDelegate$a$a:a	Landroid/os/IBinder;
        //   33: bipush 7
        //   35: aload_2
        //   36: aload_3
        //   37: iconst_0
        ...
        //   52: invokestatic 64	com/google/android/gms/dynamic/b$a:l	(Landroid/os/IBinder;)Lcom/google/android/gms/dynamic/b;
        //   55: astore_1
        //   56: aload_3
        ...
        throws RemoteException
      {
        ...
        //   24: aload_2
        //   25: iconst_0
        //   26: invokevirtual 73	com/google/android/gms/maps/model/LatLng:writeToParcel	(Landroid/os/Parcel;I)V
        //   29: aload_0
        //   30: getfield 17	com/google/android/gms/maps/internal/ICameraUpdateFactoryDelegate$a$a:a	Landroid/os/IBinder;
        //   33: bipush 8
        //   35: aload_2
        ...
        throws RemoteException
      {
        ...
        //   25: aload_3
        //   26: iconst_0
        //   27: invokevirtual 78	com/google/android/gms/maps/model/LatLngBounds:writeToParcel	(Landroid/os/Parcel;I)V
        //   30: aload_3
        //   31: iload_2
        //   32: invokevirtual 40	android/os/Parcel:writeInt	(I)V
        //   35: aload_0
        //   36: getfield 17	com/google/android/gms/maps/internal/ICameraUpdateFactoryDelegate$a$a:a	Landroid/os/IBinder;
        //   39: bipush 10
        //   41: aload_3
        //   42: aload 4
        //   44: iconst_0
        ...
        //   61: invokestatic 64	com/google/android/gms/dynamic/b$a:l	(Landroid/os/IBinder;)Lcom/google/android/gms/dynamic/b;
        //   64: astore_1
        //   65: aload 4
        ...
        throws RemoteException
      {
        ...
        //   28: aload 5
        //   30: iconst_0
        //   31: invokevirtual 78	com/google/android/gms/maps/model/LatLngBounds:writeToParcel	(Landroid/os/Parcel;I)V
        //   34: aload 5
        //   36: iload_2
        ...
        //   53: aload_0
        //   54: getfield 17	com/google/android/gms/maps/internal/ICameraUpdateFactoryDelegate$a$a:a	Landroid/os/IBinder;
        //   57: bipush 11
        //   59: aload 5
        //   61: aload 6
        //   63: iconst_0
        ...
        //   80: invokestatic 64	com/google/android/gms/dynamic/b$a:l	(Landroid/os/IBinder;)Lcom/google/android/gms/dynamic/b;
        //   83: astore_1
        //   84: aload 6
        ...
        throws RemoteException
      {
        ...
        //   25: aload_3
        //   26: iconst_0
        //   27: invokevirtual 73	com/google/android/gms/maps/model/LatLng:writeToParcel	(Landroid/os/Parcel;I)V
        //   30: aload_3
        //   31: fload_2
