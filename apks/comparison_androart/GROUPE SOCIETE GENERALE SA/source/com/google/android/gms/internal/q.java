  ...
  extends IInterface
{
    ...
    implements q
  {
      ...
      throws RemoteException
    {
      ...
      paramParcel1 = a(b.a.l(paramParcel1.readStrongBinder()), paramParcel1.readInt(), paramParcel1.readInt());
      ...
      implements q
    {
        ...
        throws RemoteException
      {
        ...
        //   46: aload_0
        //   47: getfield 17	com/google/android/gms/internal/q$a$a:a	Landroid/os/IBinder;
        //   50: iconst_1
        //   51: aload 4
        //   53: aload 5
        //   55: iconst_0
        ...
        //   67: aload 5
        //   69: invokevirtual 58	android/os/Parcel:readStrongBinder	()Landroid/os/IBinder;
        //   72: invokestatic 64	com/google/android/gms/dynamic/b$a:l	(Landroid/os/IBinder;)Lcom/google/android/gms/dynamic/b;
        //   75: astore_1
        //   76: aload 5
