    ...
    implements bp
  {
      ...
      throws RemoteException
    {
      ...
      case 5: 
        ...
        for (localObject1 = (Bundle)Bundle.CREATOR.createFromParcel(paramParcel1);; localObject1 = null)
        {
          localObject2 = str;
          if (paramParcel1.readInt() != 0) {
            localObject2 = ak.CREATOR.m(paramParcel1);
          }
          a(paramInt1, (Bundle)localObject1, (ak)localObject2);
          paramParcel2.writeNoException();
          return true;
        }
      case 6: 
      ...
      case 8: 
        ...
        b((d)localObject1, paramParcel1.readString());
        paramParcel2.writeNoException();
        return true;
      case 9: 
        paramParcel1.enforceInterface("com.google.android.gms.plus.internal.IPlusCallbacks");
        ...
        for (paramParcel1 = (Bundle)Bundle.CREATOR.createFromParcel(paramParcel1);; paramParcel1 = null)
        {
          b(paramInt1, (Bundle)localObject1, paramParcel1);
          paramParcel2.writeNoException();
          return true;
          localObject1 = null;
          break;
      ...
      case 10: 
        ...
        a(paramInt1, (Bundle)localObject1, paramParcel1.readString(), paramParcel1.createStringArrayList(), paramParcel1.createStringArrayList(), paramParcel1.createStringArrayList());
        paramParcel2.writeNoException();
        return true;
      case 11: 
        paramParcel1.enforceInterface("com.google.android.gms.plus.internal.IPlusCallbacks");
        ...
        for (localObject1 = (Bundle)Bundle.CREATOR.createFromParcel(paramParcel1);; localObject1 = null)
        {
          ...
          if (paramParcel1.readInt() != 0) {
            localObject2 = bv.CREATOR.v(paramParcel1);
          }
          a(paramInt1, (Bundle)localObject1, str, (bv)localObject2);
          paramParcel2.writeNoException();
          return true;
        }
      case 12: 
      ...
      case 13: 
        ...
        for (localObject1 = (Bundle)Bundle.CREATOR.createFromParcel(paramParcel1);; localObject1 = null)
        {
          ...
          if (paramParcel1.readInt() != 0) {
            localObject2 = co.CREATOR.I(paramParcel1);
          }
          a(paramInt1, (Bundle)localObject1, (co)localObject2);
          paramParcel2.writeNoException();
          return true;
        }
      case 14: 
        ...
        for (localObject1 = (Bundle)Bundle.CREATOR.createFromParcel(paramParcel1);; localObject1 = null)
        {
          ...
          if (paramParcel1.readInt() != 0) {
            localObject2 = cq.CREATOR.J(paramParcel1);
          }
          a(paramInt1, (Bundle)localObject1, (cq)localObject2);
          paramParcel2.writeNoException();
          return true;
        }
      case 15: 
        ...
        for (localObject1 = (Bundle)Bundle.CREATOR.createFromParcel(paramParcel1);; localObject1 = null)
        {
          a(paramInt1, (Bundle)localObject1, paramParcel1.readString());
          paramParcel2.writeNoException();
          return true;
        }
      case 16: 
        ...
        for (localObject1 = (Bundle)Bundle.CREATOR.createFromParcel(paramParcel1);; localObject1 = null)
        {
          a(paramInt1, (Bundle)localObject1, paramParcel1.createTypedArrayList(x.CREATOR));
          paramParcel2.writeNoException();
          return true;
        }
      }
      ...
      implements bp
    {
        ...
        throws RemoteException
      {
        ...
        //   27: aload 4
        //   29: iconst_1
        //   30: invokevirtual 54	android/os/Parcel:writeInt	(I)V
        //   33: aload_2
        //   34: aload 4
        //   36: iconst_0
        //   37: invokevirtual 60	android/os/Bundle:writeToParcel	(Landroid/os/Parcel;I)V
        //   40: aload 4
        //   42: iload_3
        //   43: invokevirtual 54	android/os/Parcel:writeInt	(I)V
        //   46: aload_0
        //   47: getfield 17	com/google/android/gms/internal/bp$a$a:a	Landroid/os/IBinder;
        //   50: bipush 17
        //   52: aload 4
        //   54: aload 5
        //   56: iconst_0
        ...
        //   79: aload 4
        //   81: iconst_0
        //   82: invokevirtual 54	android/os/Parcel:writeInt	(I)V
        //   85: goto -45 -> 40
        //   88: astore_2
        //   89: aload 5
        ...
        throws RemoteException
      {
        ...
        //   40: aload 4
        //   42: aload_3
        //   43: invokevirtual 36	android/os/Parcel:writeString	(Ljava/lang/String;)V
        //   46: aload_0
        //   47: getfield 17	com/google/android/gms/internal/bp$a$a:a	Landroid/os/IBinder;
        //   50: bipush 15
        //   52: aload 4
        ...
        throws RemoteException
      {
        ...
        //   46: aload 7
        //   48: aload 4
        //   50: invokevirtual 87	android/os/Parcel:writeStringList	(Ljava/util/List;)V
        //   53: aload 7
        //   55: aload 5
        //   57: invokevirtual 87	android/os/Parcel:writeStringList	(Ljava/util/List;)V
        //   60: aload 7
        //   62: aload 6
        //   64: invokevirtual 87	android/os/Parcel:writeStringList	(Ljava/util/List;)V
        //   67: aload_0
        //   68: getfield 17	com/google/android/gms/internal/bp$a$a:a	Landroid/os/IBinder;
        //   71: bipush 10
        //   73: aload 7
        //   75: aload 8
        //   77: iconst_0
        //   78: invokeinterface 42 5 0
        //   83: pop
        //   84: aload 8
        //   86: invokevirtual 45	android/os/Parcel:readException	()V
        //   89: aload 8
        //   91: invokevirtual 48	android/os/Parcel:recycle	()V
        //   94: aload 7
        //   96: invokevirtual 48	android/os/Parcel:recycle	()V
        ...
        //   115: aload 7
        //   117: invokevirtual 48	android/os/Parcel:recycle	()V
        //   120: aload_2
        //   121: athrow
        // Local variable table:
        //   start	length	slot	name	signature
        ...
        //   0	122	2	paramBundle	Bundle
        //   0	122	3	paramString	String
        //   0	122	4	paramList1	List<String>
        //   0	122	5	paramList2	List<String>
        //   0	122	6	paramList3	List<String>
        ...
        throws RemoteException
      {
        ...
        //   40: aload 4
        //   42: aload_3
        //   43: invokevirtual 93	android/os/Parcel:writeTypedList	(Ljava/util/List;)V
        //   46: aload_0
        //   47: getfield 17	com/google/android/gms/internal/bp$a$a:a	Landroid/os/IBinder;
        //   50: bipush 16
        //   52: aload 4
        ...
        throws RemoteException
      {
        ...
        //   25: aload_3
        //   26: iconst_0
        //   27: invokevirtual 98	com/google/android/gms/common/data/d:writeToParcel	(Landroid/os/Parcel;I)V
        //   30: aload_3
        //   31: aload_2
        //   32: invokevirtual 36	android/os/Parcel:writeString	(Ljava/lang/String;)V
        //   35: aload_0
        //   36: getfield 17	com/google/android/gms/internal/bp$a$a:a	Landroid/os/IBinder;
        //   39: iconst_4
        //   40: aload_3
        //   41: aload 4
        //   43: iconst_0
        ...
        throws RemoteException
      {
        ...
        //   28: aload 4
        //   30: iconst_0
        //   31: invokevirtual 98	com/google/android/gms/common/data/d:writeToParcel	(Landroid/os/Parcel;I)V
        //   34: aload 4
        //   36: aload_2
        //   37: invokevirtual 36	android/os/Parcel:writeString	(Ljava/lang/String;)V
        //   40: aload 4
        //   42: aload_3
        //   43: invokevirtual 36	android/os/Parcel:writeString	(Ljava/lang/String;)V
        //   46: aload_0
        ...
        throws RemoteException
      {
        ...
        //   15: aload_3
        //   16: iload_1
        //   17: invokevirtual 54	android/os/Parcel:writeInt	(I)V
        //   20: aload_2
        //   21: ifnull +45 -> 66
        //   24: aload_3
        //   25: iconst_1
        ...
        //   30: aload_3
        //   31: iconst_0
        //   32: invokevirtual 60	android/os/Bundle:writeToParcel	(Landroid/os/Parcel;I)V
        //   35: aload_0
        //   36: getfield 17	com/google/android/gms/internal/bp$a$a:a	Landroid/os/IBinder;
        //   39: bipush 7
        //   41: aload_3
