    ...
    implements bq
  {
      ...
      throws RemoteException
    {
      ...
      case 1: 
        ...
        paramParcel1 = a(b.a.l(paramParcel1.readStrongBinder()), paramParcel1.readInt(), paramParcel1.readInt(), paramParcel1.readString(), paramParcel1.readInt());
      ...
      paramParcel1.enforceInterface("com.google.android.gms.plus.internal.IPlusOneButtonCreator");
      b localB = a(b.a.l(paramParcel1.readStrongBinder()), paramParcel1.readInt(), paramParcel1.readInt(), paramParcel1.readString(), paramParcel1.readString());
      paramParcel2.writeNoException();
      ...
      implements bq
    {
        ...
        throws RemoteException
      {
        ...
        //   40: aload 6
        //   42: iload_3
        //   43: invokevirtual 46	android/os/Parcel:writeInt	(I)V
        //   46: aload 6
        //   48: aload 4
        //   50: invokevirtual 49	android/os/Parcel:writeString	(Ljava/lang/String;)V
        //   53: aload 6
        //   55: iload 5
        //   57: invokevirtual 46	android/os/Parcel:writeInt	(I)V
        //   60: aload_0
        //   61: getfield 17	com/google/android/gms/internal/bq$a$a:a	Landroid/os/IBinder;
        //   64: iconst_1
        //   65: aload 6
        //   67: aload 7
        //   69: iconst_0
        //   70: invokeinterface 55 5 0
        //   75: pop
        //   76: aload 7
        //   78: invokevirtual 58	android/os/Parcel:readException	()V
        //   81: aload 7
        //   83: invokevirtual 61	android/os/Parcel:readStrongBinder	()Landroid/os/IBinder;
        //   86: invokestatic 67	com/google/android/gms/dynamic/b$a:l	(Landroid/os/IBinder;)Lcom/google/android/gms/dynamic/b;
        //   89: astore_1
        //   90: aload 7
        //   92: invokevirtual 70	android/os/Parcel:recycle	()V
        //   95: aload 6
        //   97: invokevirtual 70	android/os/Parcel:recycle	()V
        //   100: aload_1
        //   101: areturn
        //   102: aconst_null
        //   103: astore_1
        ...
        //   113: aload 6
        //   115: invokevirtual 70	android/os/Parcel:recycle	()V
        //   118: aload_1
        //   119: athrow
