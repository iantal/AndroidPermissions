  ...
  extends AbstractRSSReader
{
  ...
  static
  {
    ...
    arrayOfInt1 = new int[] { 193, 157, 49, 147, 19, 57, 171, 91 };
    arrayOfInt2 = new int[] { 62, 186, 136, 197, 169, 85, 44, 132 };
    arrayOfInt3 = new int[] { 16, 48, 144, 10, 30, 90, 59, 177 };
    arrayOfInt4 = new int[] { 148, 22, 66, 198, 172, 94, 71, 2 };
    arrayOfInt5 = new int[] { 55, 165, 73, 8, 24, 72, 5, 15 };
    WEIGHTS = new int[][] { { 1, 3, 9, 27, 81, 32, 96, 77 }, { 20, 60, 180, 118, 143, 7, 21, 63 }, { 189, 145, 13, 39, 117, 140, 209, 205 }, arrayOfInt1, arrayOfInt2, { 185, 133, 188, 142, 4, 12, 36, 108 }, { 113, 128, 173, 97, 80, 29, 87, 50 }, { 150, 28, 84, 41, 123, 158, 52, 156 }, { 46, 138, 203, 187, 139, 206, 196, 166 }, { 76, 17, 51, 153, 37, 111, 122, 155 }, { 43, 129, 176, 106, 107, 110, 119, 146 }, arrayOfInt3, { 109, 116, 137, 200, 178, 112, 125, 164 }, { 70, 210, 208, 202, 184, 130, 179, 115 }, { 134, 191, 151, 31, 93, 68, 204, 190 }, arrayOfInt4, { 6, 18, 54, 162, 64, 192, 154, 40 }, { 120, 149, 25, 75, 14, 42, 126, 167 }, { 79, 26, 78, 23, 69, 207, 199, 175 }, { 103, 98, 83, 38, 114, 131, 182, 124 }, { 161, 61, 183, 127, 170, 88, 53, 159 }, arrayOfInt5, { 45, 135, 194, 160, 58, 174, 100, 89 } };
    arrayOfInt1 = new int[] { 0, 4, 1, 3, 4, 5, 5 };
    arrayOfInt2 = new int[] { 0, 0, 1, 1, 2, 2, 3, 3 };
    arrayOfInt3 = new int[] { 0, 0, 1, 1, 2, 2, 3, 4, 5, 5 };
    arrayOfInt4 = new int[] { 0, 0, 1, 1, 2, 3, 3, 4, 4, 5, 5 };
    FINDER_PATTERN_SEQUENCES = new int[][] { { 0, 0 }, { 0, 1, 1 }, { 0, 2, 1, 3 }, { 0, 4, 1, 3, 2 }, { 0, 4, 1, 3, 3, 5 }, arrayOfInt1, arrayOfInt2, { 0, 0, 1, 1, 2, 2, 3, 4, 4 }, arrayOfInt3, arrayOfInt4 };
  }
