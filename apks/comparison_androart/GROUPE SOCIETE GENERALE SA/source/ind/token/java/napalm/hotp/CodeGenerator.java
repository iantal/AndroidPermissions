  ...
  extends AbstractCodeGenerator
{
    ...
    throws NapalmRuntimeException
  {
    try
    {
      paramArrayOfString = HOTPGenerator.generateOTP("HmacSHA1", this.params.getDecryptedSecret(), paramLong, concatValues(paramArrayOfString), this.params.getCodeLength(), false, 0);
