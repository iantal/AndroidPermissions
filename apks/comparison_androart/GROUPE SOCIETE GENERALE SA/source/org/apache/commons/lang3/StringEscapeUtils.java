...
public class StringEscapeUtils
{
  ...
  static
  {
    ...
    OctalUnescaper localOctalUnescaper = new OctalUnescaper();
    UnicodeUnescaper localUnicodeUnescaper = new UnicodeUnescaper();
    LookupTranslator localLookupTranslator = new LookupTranslator(EntityArrays.JAVA_CTRL_CHARS_UNESCAPE());
    String[] arrayOfString = { "\\", "" };
    UNESCAPE_JAVA = new AggregateTranslator(new CharSequenceTranslator[] { localOctalUnescaper, localUnicodeUnescaper, localLookupTranslator, new LookupTranslator(new String[][] { { "\\\\", "\\" }, { "\\\"", "\"" }, { "\\'", "'" }, arrayOfString }) });
