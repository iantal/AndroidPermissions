  ...
  static
  {
    zzapu.bph = new zzapu()
    {
        ...
        throws IOException
      {
        ...
        int j = zzaqp.zzag(paramAnonymousZzaqp);
        int i = j;
        if (j == 0) {
        ...
        i = zzaqp.zzai(paramAnonymousZzaqp);
        j = zzaqp.zzaj(paramAnonymousZzaqp);
        paramAnonymousZzaqp = paramAnonymousZzaqp.getPath();
        throw new IllegalStateException(String.valueOf(str).length() + 70 + String.valueOf(paramAnonymousZzaqp).length() + "Expected a name but was " + str + " " + " at line " + i + " column " + j + " path " + paramAnonymousZzaqp);
      }
    };
  }
