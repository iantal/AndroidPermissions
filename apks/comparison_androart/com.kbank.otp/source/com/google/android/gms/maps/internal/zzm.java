  ...
  extends IInterface
{
    ...
    implements zzm
  {
    ...
    public static zzm zzif(IBinder paramIBinder)
    {
      ...
      throws RemoteException
    {
      ...
      zze(zzf.zza.zzjk(paramParcel1.readStrongBinder()));
      ...
      implements zzm
    {
        ...
        throws RemoteException
      {
        ...
        //   30: aload_0
        //   31: getfield 18	com/google/android/gms/maps/internal/zzm$zza$zza:zzajq	Landroid/os/IBinder;
        //   34: iconst_1
        //   35: aload_2
        //   36: aload_3
        //   37: iconst_0
