...
public abstract class zzaqa
{
  ...
  public static zzaqa bo()
  {
    try
    {
      ...
      localObject1 = new zzaqa()
      {
        public <T> T zzf(Class<T> paramAnonymousClass)
          throws Exception
        {
          return this.bpC.invoke(localObject4, new Object[] { paramAnonymousClass });
        }
      };
      return localObject1;
    }
    catch (Exception localException1)
    {
      try
      {
        ...
        ((Method)localObject2).setAccessible(true);
        localObject2 = new zzaqa()
        {
          public <T> T zzf(Class<T> paramAnonymousClass)
            throws Exception
          {
            return this.bpE.invoke(null, new Object[] { paramAnonymousClass, Integer.valueOf(i) });
          }
        };
        return localObject2;
      }
      catch (Exception localException2)
      {
        try
        {
          ...
          localObject3 = new zzaqa()
          {
            public <T> T zzf(Class<T> paramAnonymousClass)
              throws Exception
            {
              return this.bpE.invoke(null, new Object[] { paramAnonymousClass, Object.class });
            }
          };
          return localObject3;
        }
