...
public final class Projection
{
  ...
  {
    this.aoW = paramIProjectionDelegate;
  }
  ...
  public LatLng fromScreenLocation(Point paramPoint)
  {
    try
    {
      paramPoint = this.aoW.fromScreenLocation(zze.zzac(paramPoint));
      return paramPoint;
    }
  ...
  public VisibleRegion getVisibleRegion()
  {
    try
    {
      VisibleRegion localVisibleRegion = this.aoW.getVisibleRegion();
  ...
  public Point toScreenLocation(LatLng paramLatLng)
  {
    try
    {
      paramLatLng = (Point)zze.zzae(this.aoW.toScreenLocation(paramLatLng));
      return paramLatLng;
    }
