    ...
    public boolean equals(Object paramObject)
    {
      ...
      do
      {
        do
        {
          ...
          if (this.awA == null)
          {
            if (paramObject.awA != null) {
              return false;
            }
          }
          else if (!this.awA.equals(paramObject.awA)) {
            return false;
          }
          if (this.awB != null) {
            break;
          }
        } while (paramObject.awB == null);
        return false;
      } while (this.awB.equals(paramObject.awB));
      return false;
    }
    ...
    extends zzasa
  {
    ...
    public boolean equals(Object paramObject)
    {
      ...
      do
      {
        ...
        if (this.awC == null)
        {
          if (paramObject.awC != null) {
            return false;
          }
        }
        else if (!this.awC.equals(paramObject.awC)) {
          return false;
        }
        if (this.aqZ == null)
        {
        ...
        if (!zzary.equals(this.awE, paramObject.awE)) {
          return false;
        }
        if (!zzary.equals(this.awF, paramObject.awF)) {
          return false;
        }
      } while (zzary.equals(this.awG, paramObject.awG));
      return false;
    }
    ...
    public boolean equals(Object paramObject)
    {
      ...
      do
      {
        do
        {
          ...
          if (this.zzcb == null)
          {
            if (paramObject.zzcb != null) {
              return false;
            }
          }
          else if (!this.zzcb.equals(paramObject.zzcb)) {
            return false;
          }
          if (this.value != null) {
            break;
