  ...
  extends XYChart
{
  ...
  public void drawSeries(Canvas paramCanvas, Paint paramPaint, List<Float> paramList, SimpleSeriesRenderer paramSimpleSeriesRenderer, float paramFloat, int paramInt1, int paramInt2)
  {
    ...
    paramPaint.setStyle(Paint.Style.FILL);
    int i = paramList.size();
    paramSimpleSeriesRenderer = (XYValueSeries)this.mDataset.getSeriesAt(paramInt1);
    double d1 = 20.0D / paramSimpleSeriesRenderer.getMaxValue();
    paramInt1 = 0;
    while (paramInt1 < i)
    {
      double d2 = paramSimpleSeriesRenderer.getValue(paramInt1 / 2 + paramInt2);
