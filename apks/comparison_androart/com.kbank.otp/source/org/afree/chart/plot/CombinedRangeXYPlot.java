  ...
  implements PlotChangeListener
{
  ...
  public CombinedRangeXYPlot(ValueAxis paramValueAxis)
  {
  ...
  public void add(XYPlot paramXYPlot, int paramInt)
  {
    ...
    paramXYPlot.setInsets(new RectangleInsets(0.0D, 0.0D, 0.0D, 0.0D));
    paramXYPlot.setRangeAxis(null);
  ...
  protected AxisSpace calculateAxisSpace(Canvas paramCanvas, RectShape paramRectShape)
  {
    ...
    for (;;)
    {
      ((AxisSpace)localObject1).ensureAtLeast(((XYPlot)localObject2).calculateDomainAxisSpace(paramCanvas, this.subplotAreas[j], null));
      j += 1;
      d3 = d4;
      d2 = d5;
      break label256;
  ...
  public boolean equals(Object paramObject)
  {
    ...
    CombinedRangeXYPlot localCombinedRangeXYPlot;
    do
    {
      do
      {
        return bool1;
        bool1 = bool2;
      } while (!(paramObject instanceof CombinedRangeXYPlot));
      localCombinedRangeXYPlot = (CombinedRangeXYPlot)paramObject;
      bool1 = bool2;
    } while (this.gap != localCombinedRangeXYPlot.gap);
  ...
  public void moveDomainAxes(double paramDouble, PlotRenderingInfo paramPlotRenderingInfo, PointF paramPointF)
  {
    ...
    {
      int i = 0;
      while (i < paramPlotRenderingInfo.getDomainAxisCount())
      {
        paramPointF = paramPlotRenderingInfo.getDomainAxis(i);
        if (paramPointF != null) {
  ...
  protected void setFixedDomainAxisSpaceForSubplots(AxisSpace paramAxisSpace)
  {
    ...
    while (localIterator.hasNext()) {
      ((XYPlot)localIterator.next()).setFixedDomainAxisSpace(paramAxisSpace, false);
    }
  }
  ...
  public void zoomDomainAxes(double paramDouble1, double paramDouble2, PlotRenderingInfo paramPlotRenderingInfo, PointF paramPointF)
  {
    ...
    if (localObject != null) {
      ((XYPlot)localObject).zoomDomainAxes(paramDouble1, paramDouble2, paramPlotRenderingInfo, paramPointF);
    }
    for (;;)
    {
      return;
      ...
      while (((Iterator)localObject).hasNext()) {
        ((XYPlot)((Iterator)localObject).next()).zoomDomainAxes(paramDouble1, paramDouble2, paramPlotRenderingInfo, paramPointF);
      }
    }
  }
  ...
  public void zoomDomainAxes(double paramDouble, PlotRenderingInfo paramPlotRenderingInfo, PointF paramPointF, boolean paramBoolean)
  {
    Object localObject = findSubplot(paramPlotRenderingInfo, paramPointF);
    if (localObject != null) {
      ((XYPlot)localObject).zoomDomainAxes(paramDouble, paramPlotRenderingInfo, paramPointF, paramBoolean);
    }
    for (;;)
    {
      return;
      localObject = getSubplots().iterator();
      while (((Iterator)localObject).hasNext()) {
        ((XYPlot)((Iterator)localObject).next()).zoomDomainAxes(paramDouble, paramPlotRenderingInfo, paramPointF, paramBoolean);
      }
    }
  }
}
