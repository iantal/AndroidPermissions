...
public class MeasurementEvent
{
  ...
  static void sendBroadcastEvent(Context paramContext, String paramString, Intent paramIntent, Map<String, String> paramMap)
  {
    ...
    label190:
    for (paramIntent = getApplinkLogData(paramContext, paramString, (Bundle)localObject2, paramIntent);; paramIntent = (Intent)localObject1)
    {
      if (paramMap != null)
      {
        ...
        while (((Iterator)localObject1).hasNext())
        {
          ...
          while (((Iterator)localObject2).hasNext())
          {
            ...
            ((Bundle)localObject1).putString(str, objectToJSONString(paramIntent.get(str)));
          }
        }
      }
      new MeasurementEvent(paramContext, paramString, paramIntent).sendBroadcast();
      return;
    }
  }
}
