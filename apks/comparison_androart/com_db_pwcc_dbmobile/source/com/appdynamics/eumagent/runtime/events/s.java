  ...
  extends f
{
  ...
  public static s a(AdapterView<?> paramAdapterView, View paramView, int paramInt, String paramString, u paramU)
  {
    ...
    {
      i1 = ((GridView)paramAdapterView).getNumColumns();
      if ((i1 == -1) || (i1 <= 0)) {}
    }
    for (String str1 = String.format("%d, %d", new Object[] { Integer.valueOf(paramInt % i1), Integer.valueOf(paramInt / i1) });; str1 = null)
    {
      String str2 = str1;
      if (str1 == null) {
        str2 = Integer.toString(paramInt);
      }
      str1 = ((Activity)paramAdapterView.getContext()).getClass().getName();
      if (paramView.getContentDescription() == null) {}
      for (paramAdapterView = null;; paramAdapterView = paramView.getContentDescription().toString()) {
        return new s(str1, "Table Cell Selected", paramU, null, null, paramAdapterView, paramString, paramView.getClass().getName(), str2, paramView.getId());
      }
    }
  }
  ...
  {
    String str2 = ((Activity)paramButton.getContext()).getClass().getName();
    String str3 = paramButton.getText().toString();
    if (paramButton.getContentDescription() == null) {}
    for (String str1 = null;; str1 = paramButton.getContentDescription().toString()) {
      return new s(str2, "Button Pressed", paramU, null, str3, str1, paramString, paramButton.getClass().getName(), paramButton.getId());
    }
  }
  
  public static s a(EditText paramEditText, u paramU, boolean paramBoolean)
  {
    String str3 = ((Activity)paramEditText.getContext()).getClass().getName();
    String str1;
    if (paramBoolean)
    {
      str1 = "Text View Focused";
      if (paramEditText.getContentDescription() != null) {
        break label66;
      }
    }
    label66:
    for (String str2 = null;; str2 = paramEditText.getContentDescription().toString())
    {
      return new s(str3, str1, paramU, null, null, str2, null, paramEditText.getClass().getName(), paramEditText.getId());
      str1 = "Text View Unfocused";
      break;
    }
  }
