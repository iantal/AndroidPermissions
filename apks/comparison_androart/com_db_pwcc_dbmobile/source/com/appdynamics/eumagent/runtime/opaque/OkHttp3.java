  ...
  private static HttpRequestTracker startNewTracker(Request paramRequest)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localObject = Instrumentation.beginHttpRequest(((HttpUrl)localObject).url());
        threadLocalTracker.set(localObject);
        try
        {
          ((HttpRequestTracker)localObject).withRequestHeaderFields(paramRequest.headers().toMultimap());
          return localObject;
        }
        catch (Throwable paramRequest)
        {
          InstrumentationCallbacks.safeLog("Trying to transfer headers to tracker.", paramRequest);
          return localObject;
        }
        return null;
      }
      ...
      {
        InstrumentationCallbacks.safeLog("Trying to obtain URL to create tracker.", paramRequest);
      }
    }
  }
  ...
  public static class RealCall
  {
    ...
    public static class getResponse
    {
      ...
      public static Object Enter(Object paramObject1, Object paramObject2, boolean paramBoolean)
      {
        try
        {
          paramObject1 = OkHttp3.startNewTracker((Request)paramObject2);
          return paramObject1;
        }
        catch (Throwable paramObject1)
        {
          InstrumentationCallbacks.safeLog("Trying to get tracker.", paramObject1);
        }
        return null;
      }
      ...
      public static void Exit(Object paramObject1, Object paramObject2, Object paramObject3, Object paramObject4, boolean paramBoolean)
      {
        ...
        {
          InstrumentationCallbacks.safeLog("Trying to report tracker.", paramObject1);
        }
      }
      ...
      public static void ThrowMe(Object paramObject1, Object paramObject2, IOException paramIOException)
      {
        ...
        {
          InstrumentationCallbacks.safeLog("Trying to report exception.", paramObject1);
        }
      }
    }
  }
    ...
    public static class Builder
    {
      ...
      public static class build
      {
        ...
        public static Object Enter(Object paramObject)
        {
          try
          {
            paramObject = (Request.Builder)paramObject;
            ...
            while (localIterator1.hasNext())
            {
              ...
              while (localIterator2.hasNext())
              {
                ...
                paramObject.header((String)localEntry.getKey(), str);
              }
            }
            return null;
          }
          ...
          {
            InstrumentationCallbacks.safeLog("Trying to add correlation headers.", paramObject);
          }
        }
        ...
        public static void Exit(Object paramObject1, Object paramObject2, Object paramObject3)
        {
          try
          {
            paramObject1 = (HttpRequestTracker)OkHttp3.threadLocalTracker.get();
            if (paramObject1 == null) {
              return;
            }
            paramObject1.withRequestHeaderFields(((Request)paramObject2).headers().toMultimap());
            return;
          }
          catch (Throwable paramObject1)
          {
            InstrumentationCallbacks.safeLog("Trying to add request headers.", paramObject1);
          }
        }
      }
    }
