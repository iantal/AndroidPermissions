    ...
    implements View.OnClickListener
  {
    ...
    public final void onClick(View paramView)
    {
      if (!((Boolean)this.a.get()).booleanValue())
      {
        ...
        try
        {
          View.OnClickListener localOnClickListener1 = (View.OnClickListener)k.a(k.this).get(paramView);
          Object localObject = localOnClickListener1;
          if (localOnClickListener1 != null) {
            localObject = localOnClickListener1;
          }
        ...
        catch (Throwable localThrowable1)
        {
          for (;;)
          {
            ...
            c.a("Exception in onClick", localThrowable1);
            localOnClickListener2 = localOnClickListener1;
          }
        }
        finally
        {
