...
public final class TransformationUtils
{
  ...
  public static Bitmap centerCrop(Bitmap paramBitmap1, Bitmap paramBitmap2, int paramInt1, int paramInt2)
  {
    ...
    {
      f2 = paramInt2 / paramBitmap2.getHeight();
      f1 = (paramInt1 - paramBitmap2.getWidth() * f2) * 0.5F;
      f3 = 0.0F;
      ((Matrix)localObject).setScale(f2, f2);
      ((Matrix)localObject).postTranslate((int)(f1 + 0.5F), (int)(f3 + 0.5F));
    ...
    for (;;)
    {
      ...
      return paramBitmap1;
      f2 = paramInt1 / paramBitmap2.getWidth();
      f3 = (paramInt2 - paramBitmap2.getHeight() * f2) * 0.5F;
      f1 = 0.0F;
      break;
      label177:
