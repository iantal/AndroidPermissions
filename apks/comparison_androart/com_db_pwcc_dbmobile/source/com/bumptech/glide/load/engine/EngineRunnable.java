  ...
  implements Runnable, Prioritized
{
    ...
    throws Exception
  {
    try
    {
      Resource localResource1 = this.decodeJob.decodeResultFromCache();
      Resource localResource2 = localResource1;
      if (localResource1 == null) {
        localResource2 = this.decodeJob.decodeSourceFromCache();
      }
