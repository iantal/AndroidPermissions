  ...
  implements popopp, Parcelable
{
  ...
  static
  {
    ...
    switch (i * (b0067g00670067g0067g + i) % bg006700670067g0067g)
    {
    default: 
  ...
  {
    int i = bgg00670067g0067g;
    int j = b0067g00670067g0067g;
    int k = bgg00670067g0067g;
    switch (k * (b0067g00670067g0067g + k) % bg006700670067g0067g)
    {
    default: 
      bgg00670067g0067g = b0067006700670067g0067g();
      bgggg00670067g = 51;
    }
    if ((i + j) * bgg00670067g0067g % bg006700670067g0067g != bgggg00670067g)
    {
  ...
  public void transformBalanceHistoryGraphData()
  {
    ...
    int i = 0;
    while (i < this.balancesInBaseCurrency.size())
    {
