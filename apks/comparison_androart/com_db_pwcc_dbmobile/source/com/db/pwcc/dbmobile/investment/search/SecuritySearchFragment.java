  ...
  implements vvvrvr.vrrvvr, kkvkvk, rrvrvr.vrvrvr
{
  ...
  static
  {
    ...
    switch (i * (bee006500650065e00650065 + i) % b0065e006500650065e00650065)
    {
    default: 
  ...
  private void hideProgress()
  {
    if (this.workflowEnvironment != null)
    {
      ...
      int k = be0065e00650065e00650065;
      int m = b0065e006500650065e00650065;
      int n = b00650065e00650065e00650065;
      if ((be0065e00650065e00650065 + bee006500650065e00650065) * be0065e00650065e00650065 % b0065e006500650065e00650065 != b00650065e00650065e00650065)
      {
        be0065e00650065e00650065 = be0065006500650065e00650065();
  ...
  private void initDefaults()
  {
    ...
    if ((be0065e00650065e00650065 + bee006500650065e00650065) * be0065e00650065e00650065 % b0065e006500650065e00650065 != b00650065e00650065e00650065)
    {
      ...
      int i = be0065e00650065e00650065;
      switch (i * (beeeee006500650065() + i) % b0065e006500650065e00650065)
      {
      default: 
        be0065e00650065e00650065 = be0065006500650065e00650065();
  ...
  private void initSearchBar(View paramView)
  {
    ...
    localEditText.setOnEditorActionListener(localOnEditorActionListener);
    ...
    localEditText = this.searchField;
    ...
    localEditText.setInputType(4097);
  ...
  private void initView(View paramView)
  {
    ...
    this.searchResultsAdapter = paramView;
  ...
  private void securitySelected()
  {
    ...
    try
    {
      localMethod.invoke(localVrvvvr, new Object[0]);
      return;
    }
  ...
  {
    int i = be0065e00650065e00650065;
    switch (i * (bee006500650065e00650065 + i) % b00650065006500650065e00650065())
    {
    default: 
      be0065e00650065e00650065 = be0065006500650065e00650065();
  ...
  {
    hideProgress();
    paramInt = be0065e00650065e00650065;
    switch (paramInt * (beeeee006500650065() + paramInt) % b0065e006500650065e00650065)
    {
    default: 
      be0065e00650065e00650065 = 95;
      b00650065e00650065e00650065 = be0065006500650065e00650065();
      paramInt = be0065e00650065e00650065;
      switch (paramInt * (bee006500650065e00650065 + paramInt) % b0065e006500650065e00650065)
      {
      default: 
  ...
  public void navigateToNextWorkflowStep(Bundle paramBundle)
  {
    ...
    if (this.workflowEnvironment != null)
    {
      ...
      localObject = ppphhp.class.getMethod(uxxxxx.bbbb0062b0062b0062b0062("^t./78yz45=>89AB\004=>FGABJK\r", '#', '¦', '\002'), new Class[] { String.class, Character.TYPE, Character.TYPE, Character.TYPE });
    }
    try
    {
      localObject = ((Method)localObject).invoke(null, new Object[] { "km^^j%mdf^X]_f\034QQ_KRTZ", Character.valueOf('6'), Character.valueOf('Ì'), Character.valueOf('\000') });
  ...
  public void onAttach(Context paramContext)
  {
    ...
    if (getActivity().getIntent().getExtras() != null)
    {
      ...
      localBundle = getActivity().getIntent().getExtras();
    ...
    try
    {
      localMethod.invoke(localVrvvvr, new Object[] { localBundle });
  ...
  public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle)
  {
    ...
    if ((i + j) * be0065e00650065e00650065 % b0065e006500650065e00650065 != b00650065e00650065e00650065)
    {
      be0065e00650065e00650065 = be0065006500650065e00650065();
