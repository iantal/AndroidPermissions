  ...
  implements popopp, Parcelable
{
  ...
  static
  {
    ...
    int j = bqqqq0071q0071q;
    int k = bq007100710071qq0071q;
    int m = bq007100710071qq0071q;
    switch (m * (bq0071qq0071q0071q() + m) % b0071qqq0071q0071q)
    {
    default: 
      bq007100710071qq0071q = b00710071qq0071q0071q();
      b0071007100710071qq0071q = 50;
    }
    if ((i + j) * k % b0071qqq0071q0071q != b0071007100710071qq0071q)
    {
  ...
  public int describeContents()
  {
    ...
    switch (i * (bqqqq0071q0071q + i) % b0071qqq0071q0071q)
    {
    default: 
  ...
  public List<CashAccountTransaction> getBookedTransactions()
  {
    ...
    if ((bq007100710071qq0071q + bqqqq0071q0071q) * bq007100710071qq0071q % b0071qqq0071q0071q != b0071007100710071qq0071q)
    {
      ...
      switch (j * (bqqqq0071q0071q + j) % b0071qqq0071q0071q)
      {
      default: 
        bq007100710071qq0071q = b00710071qq0071q0071q();
        b0071007100710071qq0071q = b00710071qq0071q0071q();
  ...
  {
    int i = bq007100710071qq0071q;
    switch (i * (bq0071qq0071q0071q() + i) % b0071qqq0071q0071q)
    {
    default: 
  ...
  public boolean isMaxResultsReached()
  {
    ...
    int j = bqqqq0071q0071q;
    int k = bq007100710071qq0071q;
    int m = b0071qqq0071q0071q;
    if ((bq007100710071qq0071q + bqqqq0071q0071q) * bq007100710071qq0071q % b0071qqq0071q0071q != b0071007100710071qq0071q)
    {
      bq007100710071qq0071q = b00710071qq0071q0071q();
      b0071007100710071qq0071q = 86;
    }
    if ((i + j) * k % m != b0071007100710071qq0071q)
    {
      bq007100710071qq0071q = 57;
      b0071007100710071qq0071q = b00710071qq0071q0071q();
    }
  ...
  {
    int i = bq007100710071qq0071q;
    switch (i * (bq0071qq0071q0071q() + i) % bqq0071q0071q0071q())
    {
    default: 
  ...
  public void setOpeningDate(String paramString)
  {
    int i = bq007100710071qq0071q;
    int j = bqqqq0071q0071q;
    int k = b0071qqq0071q0071q;
    int m = bq007100710071qq0071q;
    switch (m * (bqqqq0071q0071q + m) % b0071qqq0071q0071q)
    {
    default: 
  ...
  public void setQueuedTransactions(List<CashAccountTransaction> paramList)
  {
    ...
    i = bq007100710071qq0071q;
    switch (i * (bqqqq0071q0071q + i) % bqq0071q0071q0071q())
    {
    default: 
      bq007100710071qq0071q = b00710071qq0071q0071q();
  ...
  public void writeToParcel(Parcel paramParcel, int paramInt)
  {
    ...
    for (byte b = 1;; b = 0)
    {
      ...
      paramInt = bq007100710071qq0071q;
      switch (paramInt * (bqqqq0071q0071q + paramInt) % b0071qqq0071q0071q)
      {
      default: 
        bq007100710071qq0071q = b00710071qq0071q0071q();
        b0071007100710071qq0071q = b00710071qq0071q0071q();
