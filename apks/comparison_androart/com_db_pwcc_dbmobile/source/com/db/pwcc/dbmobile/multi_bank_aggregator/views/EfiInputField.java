  ...
  extends RelativeLayout
{
  ...
  private void init(Context paramContext)
  {
    ...
    for (;;)
    {
      ...
      switch (i * (bf0066f0066f006600660066 + i) % b00660066f0066f006600660066)
      {
      }
      b0066ff0066f006600660066 = bff00660066f006600660066();
      i = bff00660066f006600660066();
      int j = b0066ff0066f006600660066;
      switch (j * (bf0066f0066f006600660066 + j) % b00660066f0066f006600660066)
      {
      default: 
        b0066ff0066f006600660066 = 51;
        bf0066f0066f006600660066 = 27;
      }
      bf0066f0066f006600660066 = i;
    }
  }
  ...
  public boolean hasValidInput()
  {
    ...
    {
      return true;
      localObject = this.inputEditText.getText();
      int i = b0066ff0066f006600660066;
      switch (i * (bf0066f0066f006600660066 + i) % b00660066f0066f006600660066)
      {
      default: 
  ...
  public boolean isMasked()
  {
    ...
    {
      int i = b0066ff0066f006600660066;
      switch (i * (bf006600660066f006600660066() + i) % b00660066f0066f006600660066)
      {
      default: 
        b0066ff0066f006600660066 = bff00660066f006600660066();
  ...
  public void setFocusable(boolean paramBoolean)
  {
    ...
    int i = b0066ff0066f006600660066;
    switch (i * (bf0066f0066f006600660066 + i) % b0066006600660066f006600660066())
    {
    default: 
