  ...
  extends DbEditText
{
  ...
  private Runnable characterAdder = new Runnable()
  {
    ...
    public void run()
    {
      ...
      if (LoginTypewriter.access$000(LoginTypewriter.this) <= LoginTypewriter.access$100(LoginTypewriter.this).length())
      {
        ...
        switch (i * (biiii00690069iii + i) % b0069iii00690069iii)
        {
        default: 
          b0069006900690069i0069iii = 25;
          biiii00690069iii = 64;
          i = b0069006900690069i0069iii;
          switch (i * (biiii00690069iii + i) % b0069iii00690069iii)
          {
          default: 
  ...
  public void animateText(CharSequence paramCharSequence)
  {
    ...
    paramCharSequence = this.handler;
    Runnable localRunnable = this.characterAdder;
    int i = bs007300730073s0073;
    switch (i * (b0073007300730073s0073 + i) % bssss00730073)
    {
    default: 
      bs007300730073s0073 = b0073sss00730073();
      bs0073ss00730073 = 40;
    }
    paramCharSequence.postDelayed(localRunnable, this.delay);
  }
}
