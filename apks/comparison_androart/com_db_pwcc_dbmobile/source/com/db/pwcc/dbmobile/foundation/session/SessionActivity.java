  ...
  extends BaseActivity
{
  ...
  static
  {
    if ((b006B006Bk006B006Bkkk + b006Bk006B006B006Bkkk) * b006B006Bk006B006Bkkk % bk006B006B006B006Bkkk != bkk006B006B006Bkkk)
    {
      ...
      switch (i * (b006Bk006B006B006Bkkk + i) % bk006B006B006B006Bkkk)
      {
      default: 
  ...
  private void subscribeToSessionState()
  {
    ...
    this.sessionStateSubscription = localObservable.observeOn(localScheduler).subscribe(new Action1()
    {
      ...
      public void bk006Bkkk006B006Bk006Bk(hyhyhh paramAnonymousHyhyhh)
      {
        ...
        String str = SessionActivity.access$000();
        StringBuilder localStringBuilder = new StringBuilder();
        Object localObject = ppphhp.class.getMethod(uxxxxx.bb00620062bb0062b0062b0062("Ymlkj\"!'&\036\035#\"a\031\030\036\035\025\024\032\031X", '', '\003'), new Class[] { String.class, Character.TYPE, Character.TYPE });
        try
        {
          localObject = ((Method)localObject).invoke(null, new Object[] { "\f~\002\007\025\005\005a\026\t\030\031\020\027\027i \034\021\017#\025\013", Character.valueOf('Û'), Character.valueOf('\001') });
          rvvvrv.bq0071qq00710071q0071q0071(str, (String)localObject + paramAnonymousHyhyhh.b0070p0070007000700070p007000700070());
          ...
          switch (i * (b006Bkkkk006B006Bk006Bk() + i) % b006B006B006B006B006Bk006Bk006Bk())
          {
          }
          b006Ennn006E006E006E006En = 28;
          return;
        }
        catch (InvocationTargetException paramAnonymousHyhyhh)
        {
          throw paramAnonymousHyhyhh.getCause();
        }
      }
    });
  }
  ...
  {
    int i = b006B006B006B006B006Bkkk();
    switch (i * (b006Bk006B006B006Bkkk + i) % bk006Bkkk006Bkk())
    {
    default: 
      i = b006B006Bk006B006Bkkk;
      switch (i * (b006Bk006B006B006Bkkk + i) % bk006B006B006B006Bkkk)
      {
      default: 
  ...
  public void logout(boolean paramBoolean)
  {
    ...
    String str = TAG;
    StringBuilder localStringBuilder = new StringBuilder();
    Object localObject = ppphhp.class.getMethod(uxxxxx.bb00620062bb0062b0062b0062("EY\021\020\026\025TS\013\n\020\017\007\006\f\013J\002\001\007\006}|\003\002A", 'Í', '\004'), new Class[] { String.class, Character.TYPE, Character.TYPE, Character.TYPE });
    try
    {
      localObject = ((Method)localObject).invoke(null, new Object[] { "!#\032!&$hM \021\036\035\022\027\025E\030\030\004\026\006Y", Character.valueOf('¤'), Character.valueOf('Y'), Character.valueOf('\001') });
      ...
      rvvvrv.bq0071qq00710071q0071q0071(str, (String)localObject + this.sessionManager.b006Bk006B006Bk006B006Bk006Bk());
      return;
    }
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    paramBundle = pqqppq.bkkk006Bkk006Bkkk(this);
    int i = b006B006Bk006B006Bkkk;
    switch (i * (b006Bk006B006B006Bkkk + i) % bk006B006B006B006Bkkk)
    {
    default: 
    ...
    paramBundle.b0061aaa006100610061006100610061(this);
    paramBundle = oonoon.bk006B006Bkk006B006Bkk006B();
    if ((b006B006Bk006B006Bkkk + b006Bk006B006B006Bkkk) * b006B006Bk006B006Bkkk % bk006B006B006B006Bkkk != b006Bkkkk006Bkk())
    {
      b006B006Bk006B006Bkkk = b006B006B006B006B006Bkkk();
      bkk006B006B006Bkkk = 78;
    }
    paramBundle.bkkkkk006B006Bkk006B(this);
  }
  ...
  public void onDestroy()
  {
    ...
    default: 
      i = b006B006Bk006B006Bkkk;
      switch (i * (bkkkkk006Bkk() + i) % bk006B006B006B006Bkkk)
      {
      default: 
        b006B006Bk006B006Bkkk = b006B006B006B006B006Bkkk();
  ...
  public void onPause()
  {
    unsubscribeFromSessionState();
    int i = b006B006B006B006B006Bkkk();
    int j = b006Bk006B006B006Bkkk;
    int k = b006B006B006B006B006Bkkk();
    if ((b006B006Bk006B006Bkkk + b006Bk006B006B006Bkkk) * b006B006Bk006B006Bkkk % bk006B006B006B006Bkkk != bkk006B006B006Bkkk)
    {
      b006B006Bk006B006Bkkk = b006B006B006B006B006Bkkk();
      bkk006B006B006Bkkk = b006B006B006B006B006Bkkk();
    }
    if ((i + j) * k % bk006B006B006B006Bkkk != bkk006B006B006Bkkk)
    {
