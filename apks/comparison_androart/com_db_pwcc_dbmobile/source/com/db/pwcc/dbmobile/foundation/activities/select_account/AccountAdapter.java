  ...
  extends RecyclerView.Adapter<AccountViewHolder>
{
  ...
  public int getItemCount()
  {
    ...
    switch (j * (b006Fooo006Foo + j) % bo006Foo006Foo)
    {
    default: 
  ...
  public String getSelectedAccountId()
  {
    ...
    switch (i * (b006Fooo006Foo + i) % bo006Foo006Foo)
    {
    default: 
  ...
  {
    int i = b006F006F006F006Fooo;
    switch (i * (b006Fooo006Foo + i) % boo006Fo006Foo())
    {
    default: 
  ...
  {
    paramInt = b006F006F006F006Fooo;
    switch (paramInt * (b006Fooo006Foo + paramInt) % boo006Fo006Foo())
    {
    default: 
      if ((b006F006F006F006Fooo + b006Fooo006Foo) * b006F006F006F006Fooo % bo006Foo006Foo != boooo006Foo)
      {
  ...
  public void setAccounts(List<Account> paramList)
  {
    if ((b006F006F006F006Fooo + b006Fooo006Foo) * b006F006F006F006Fooo % bo006Foo006Foo != boooo006Foo)
    {
      ...
      switch (i * (b006Fo006Fo006Foo() + i) % bo006Foo006Foo)
      {
      default: 
    ...
    public void bindView(final Account paramAccount)
    {
      InstrumentationCallbacks.setOnClickListenerCalled(this.itemView, new View.OnClickListener()
      {
        ...
        public void onClick(View paramAnonymousView)
        {
          ...
          {
            paramAnonymousView = AccountAdapter.access$000(AccountAdapter.this);
            ...
            paramAnonymousView.boo006F006F006F006F006F006F006F006F(str);
          }
        }
      });
      ...
      paramAccount = paramAccount.getId();
      ...
      if (paramAccount.equals(AccountAdapter.access$100(localAccountAdapter))) {
