  ...
  implements yyhyyh.hhyyyh
{
  ...
  private View.OnClickListener deleteMbaProductClickListener = new View.OnClickListener()
  {
    ...
    public void onClick(View paramAnonymousView)
    {
      ...
      {
        paramAnonymousView = BaseTransactionsActivity.access$100(BaseTransactionsActivity.this);
        BaseTransactionsActivity localBaseTransactionsActivity = BaseTransactionsActivity.this;
        ...
        Object localObject = BaseTransactionsActivity.this;
        ...
        localObject = ((BaseTransactionsActivity)localObject).getString(i);
        String str3 = BaseTransactionsActivity.this.getString(R.string.mba_delete_product_dialog_cancel);
        DialogInterface.OnClickListener localOnClickListener = BaseTransactionsActivity.access$000(BaseTransactionsActivity.this);
        i = b0062b00620062bbb;
        switch (i * (bb006200620062bbb + i) % b0062006200620062bbb)
        {
        default: 
          b0062b00620062bbb = 2;
          bb006200620062bbb = 76;
        }
        paramAnonymousView.b006Bk006Bkk006B006B006Bk006B(localBaseTransactionsActivity, str1, str2, (String)localObject, str3, localOnClickListener, null);
      }
    }
  };
  ...
  private void initAccountIdFromExtras()
  {
    ...
    {
      return;
      Object localObject = ppphhp.class.getMethod(uxxxxx.bbbb0062b0062b0062b0062("\003\027\026\025\024KJPOGFLK\013BAGF>=CB\002", '', 'À', '\000'), new Class[] { String.class, Character.TYPE, Character.TYPE });
      try
      {
        localObject = ((Method)localObject).invoke(null, new Object[] { "P]\\\036UT!dlYZ&]\\hk_gke/g{xwg5ILMZa[bnYU", Character.valueOf('6'), Character.valueOf('\001') });
  ...
  private void initDeleteMbaProductBroadcastHelper()
  {
    ...
    int m = bb0062bbbbb;
    int n = b00620062bbbbb;
    switch (n * (b0062bbbbbb + n) % bb0062bbbbb)
    {
    default: 
      b00620062bbbbb = 93;
      bbb0062bbbb = bq007100710071007100710071();
    }
    if ((i + j) * k % m != bbb0062bbbb)
    {
      b00620062bbbbb = 48;
      bbb0062bbbb = bq007100710071007100710071();
    }
  ...
  public View.OnClickListener getDeleteMbaProductClickListener()
  {
    ...
    int i = b00620062bbbbb;
    switch (i * (b0062bbbbbb + i) % bb0062bbbbb)
    {
    default: 
      b00620062bbbbb = 64;
      bbb0062bbbb = bq007100710071007100710071();
  ...
  public void onResume()
  {
    ...
    {
      int i = bq007100710071007100710071();
      int j = b0062bbbbbb;
      int k = bq007100710071007100710071();
      int m = bb0062bbbbb;
      int n = b00620062bbbbb;
      switch (n * (b0062bbbbbb + n) % bb00620062bbbb())
      {
      default: 
        b00620062bbbbb = bq007100710071007100710071();
        bbb0062bbbb = bq007100710071007100710071();
  ...
  public void onSaveInstanceState(Bundle paramBundle)
  {
    ...
    {
      int i = b00620062bbbbb;
      switch (i * (b0062bbbbbb + i) % bb00620062bbbb())
      {
      default: 
        b00620062bbbbb = bq007100710071007100710071();
        bbb0062bbbb = 45;
  ...
  public boolean unregisterBroadcastReceiver(BroadcastReceiver paramBroadcastReceiver)
  {
    ...
    {
      int i = b00620062bbbbb;
      switch (i * (b0062b0062bbbb() + i) % bb00620062bbbb())
      {
      default: 
        b00620062bbbbb = 4;
        bbb0062bbbb = 65;
