  ...
  extends RecyclerView.Adapter<MortgagePropertyHolder>
{
  ...
  public int getItemCount()
  {
    List localList = this.fields;
    int i = bgg0067ggggg;
    switch (i * (bg0067g0067gggg + i) % b00670067g0067gggg())
    {
    default: 
      i = bgg0067ggggg;
      switch (i * (bg0067g0067gggg + i) % b00670067g0067gggg())
  ...
  public void onBindViewHolder(MortgagePropertyHolder paramMortgagePropertyHolder, int paramInt)
  {
    ...
    {
      int i = bggg0067gggg();
      switch (i * (bg0067g0067gggg + i) % b006700670067ggggg)
      {
      default: 
        bgg0067ggggg = bggg0067gggg();
        b0067g0067ggggg = bggg0067gggg();
  ...
  public MortgagePropertyHolder onCreateViewHolder(ViewGroup paramViewGroup, int paramInt)
  {
    ...
    paramViewGroup = new MortgagePropertyHolder(LayoutInflater.from(paramViewGroup.getContext()).inflate(R.layout.mortgage_details_property, paramViewGroup, false));
    paramInt = bgg0067ggggg;
    switch (paramInt * (bg00670067ggggg() + paramInt) % b006700670067ggggg)
    {
    default: 
      bgg0067ggggg = bggg0067gggg();
      b0067g0067ggggg = 58;
    ...
    extends RecyclerView.ViewHolder
  {
    ...
    public void populate(yvvvyv paramYvvvyv, final MortgagePropertiesAdapter.vyvvyv paramVyvvyv)
    {
      ...
      paramYvvvyv.setCompoundDrawables(null, null, null, null);
