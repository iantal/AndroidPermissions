  ...
  extends SessionActivity
{
  ...
  private void initDbToolbar()
  {
    ...
    getActionToolbar().setPrimaryActionButton(R.drawable.ic_info, new View.OnClickListener()
    {
      ...
      public void onClick(View paramAnonymousView)
      {
        ...
        switch (i * (b00650065e00650065e0065 + i) % bee006500650065e0065)
        {
        default: 
  ...
  private void initView()
  {
    ...
    if ((i + j) * be0065ee0065e0065 % bee0065e0065e0065 != b006500650065e0065e0065)
    {
      be0065ee0065e0065 = 2;
      b006500650065e0065e0065 = b0065e0065e0065e0065();
    }
  ...
  public void onActivityResult(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    if ((paramInt2 == -1) && (paramInt1 == 29) && (paramIntent != null)) {
      localObject = ppphhp.class.getMethod(uxxxxx.bbbb0062b0062b0062b0062("5I\001\006\005DCzy~vu{z:qpvumlrq1", '×', 'ª', '\001'), new Class[] { String.class, Character.TYPE, Character.TYPE, Character.TYPE });
    }
    try
    {
      localObject = ((Method)localObject).invoke(null, new Object[] { "h\0371,)\027b\035!(\026##\033\022\032\037\035V\032\f\032\032\026\021u\020o\016\021\006\020\004\t\007c\t\t", Character.valueOf('J'), Character.valueOf(''), Character.valueOf('\001') });
      localObject = (String)localObject;
      paramInt1 = be0065ee0065e0065;
      switch (paramInt1 * (b00650065ee0065e0065 + paramInt1) % bee0065e0065e0065)
      {
      default: 
        be0065ee0065e0065 = b0065e0065e0065e0065();
        b006500650065e0065e0065 = b0065e0065e0065e0065();
      ...
      if (paramIntent.getBooleanExtra((String)localObject, false)) {
        finish();
      }
      return;
    }
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    switch (i * (j + i) % bee0065e0065e0065)
    {
    default: 
  ...
  public void onStop()
  {
    ...
    try
    {
      localMethod.invoke(localSsssst, new Object[0]);
      super.onStop();
      if ((be0065ee0065e0065 + b00650065ee0065e0065) * be0065ee0065e0065 % bee0065e0065e0065 != b006500650065e0065e0065)
      {
        if ((be0065ee0065e0065 + b00650065ee0065e0065) * be0065ee0065e0065 % bee0065e0065e0065 != b006500650065e0065e0065)
