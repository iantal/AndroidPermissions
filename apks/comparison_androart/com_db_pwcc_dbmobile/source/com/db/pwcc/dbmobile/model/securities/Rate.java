  ...
  implements popopp, Parcelable
{
  ...
  static
  {
    ...
    switch (i * (baaa0061a0061aa + i) % b0061aa0061a0061aa())
    {
    default: 
    ...
    i = b006100610061aa0061aa;
    switch (i * (baaa0061a0061aa + i) % b00610061a0061a0061aa)
    {
    default: 
  ...
  {
    String str = this.rate;
    paramInt = ba0061a0061a0061aa();
    int i = baaa0061a0061aa;
    int j = b006100610061aa0061aa;
    switch (j * (b0061a00610061a0061aa() + j) % b00610061a0061a0061aa)
    {
    default: 
      b006100610061aa0061aa = ba0061a0061a0061aa();
      baa00610061a0061aa = 70;
    }
    switch (paramInt * (i + paramInt) % b00610061a0061a0061aa)
    {
    default: 
      b006100610061aa0061aa = ba0061a0061a0061aa();
