                ...
                do
                {
                  do
                  {
                    do
                    {
                      return bool1;
                      bool1 = bool2;
                    } while (!(paramObject instanceof LocationRequest));
                    paramObject = (LocationRequest)paramObject;
                    bool1 = bool2;
                  } while (this.mPriority != paramObject.mPriority);
                  bool1 = bool2;
                } while (this.zzijq != paramObject.zzijq);
                bool1 = bool2;
              } while (this.zzijr != paramObject.zzijr);
              bool1 = bool2;
            } while (this.zzhhr != paramObject.zzhhr);
            bool1 = bool2;
          } while (this.zziiz != paramObject.zziiz);
          bool1 = bool2;
        } while (this.zziiv != paramObject.zziiv);
        bool1 = bool2;
      } while (this.zzijs != paramObject.zzijs);
    } while (getMaxWaitTime() == paramObject.getMaxWaitTime());
    return false;
  }
