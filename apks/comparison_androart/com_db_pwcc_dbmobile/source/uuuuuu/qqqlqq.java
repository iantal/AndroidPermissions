  ...
  implements lqqlqq<T, TransactionGroupItemView>
{
  ...
  public void b006Foooo006F006Fo006Fo(String paramString)
  {
    ...
    switch (i * (bw00770077ww0077www + i) % b007700770077ww0077www)
    {
    default: 
  ...
  {
    paramViewGroup = this.bw0077www0077www.inflate(R.layout.securities_first_item, paramViewGroup, false);
    qqqlqq.lllqqq localLllqqq = new qqqlqq.lllqqq();
    localLllqqq.b00770077w0077w0077www = ((TextView)paramViewGroup.findViewById(R.id.risk_class));
    int i = b0077w0077ww0077www;
    ...
    localLllqqq.b0077ww0077w0077www = ((TextView)paramViewGroup.findViewById(R.id.investment_aim));
    localLllqqq.bw0077w0077w0077www = ((TextView)paramViewGroup.findViewById(R.id.investment_value));
    paramViewGroup.setTag(localLllqqq);
  ...
  {
    paramViewGroup = this.bw0077www0077www.inflate(R.layout.securities_item, paramViewGroup, false);
    qqqlqq.qllqqq localQllqqq = new qqqlqq.qllqqq();
    localQllqqq.bw007700770077w0077www = ((TextView)paramViewGroup.findViewById(R.id.section_label));
    localQllqqq.b0077w00770077w0077www = ((TextView)paramViewGroup.findViewById(R.id.sec_name));
    int i = R.id.sec_units;
    int j = b0077w0077ww0077www;
    switch (j * (bo006Fo006F006Fo006Fo006Fo() + j) % b007700770077ww0077www)
    {
    default: 
      b0077w0077ww0077www = b006F006Fo006F006Fo006Fo006Fo();
      bwww0077w0077www = 11;
    }
    localQllqqq.b0077www00770077www = ((TextView)paramViewGroup.findViewById(i));
    localQllqqq.bw0077ww00770077www = ((TextView)paramViewGroup.findViewById(R.id.sec_currency_value));
    localQllqqq.bww0077w00770077www = ((TextView)paramViewGroup.findViewById(R.id.sec_win_loss_in_currency));
    localQllqqq.b00770077ww00770077www = ((LinearLayout)paramViewGroup.findViewById(R.id.security_group_win_loss));
    localQllqqq.b0077w0077w00770077www = ((TextView)paramViewGroup.findViewById(R.id.sec_win_loss_in_percent));
    ImageView localImageView = (ImageView)paramViewGroup.findViewById(R.id.trend_indicator);
    if ((b0077w0077ww0077www + bw00770077ww0077www) * b0077w0077ww0077www % b007700770077ww0077www != bwww0077w0077www)
    {
    ...
    localQllqqq.b0077007700770077w0077www = paramViewGroup.findViewById(R.id.separator);
    paramViewGroup.setTag(localQllqqq);
    return paramViewGroup;
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    label70:
    for (localView = bo006F006F006F006Fo006Fo006Fo(paramViewGroup);; localView = booooo006F006Fo006Fo(paramViewGroup))
    {
    ...
    while (i != 0)
    {
      do
      {
        paramView = b006F006F006F006F006Fo006Fo006Fo(paramView, localView, paramInt);
        localView = paramView;
    ...
    return b006Fo006F006F006Fo006Fo006Fo(paramView, localView);
  }
