  ...
  extends DefaultClusterRenderer<mvvvmm>
{
  ...
  public void b0061006100610061006100610061aa0061(mmvvmm paramMmvvmm)
  {
    ...
    int j = biiii00690069006900690069;
    int k = b0069iii00690069006900690069;
    int m = b0069006900690069i0069006900690069;
    switch (m * (biiii00690069006900690069 + m) % b0069iii00690069006900690069)
    {
    default: 
  ...
  public void b0061a00610061006100610061aa0061(mvvvmm paramMvvvmm, MarkerOptions paramMarkerOptions)
  {
    ...
    {
      localObject = this.bi006900690069i0069006900690069.b00610061a0061aa0061a00610061(paramMvvvmm.b00610061a0061aaa0061a0061(), (String)localObject);
      int i = b0069006900690069i0069006900690069;
      switch (i * (biiii00690069006900690069 + i) % b0069iii00690069006900690069)
      {
      default: 
        b0069006900690069i0069006900690069 = b00610061a0061006100610061aa0061();
        biiii00690069006900690069 = b00610061a0061006100610061aa0061();
      }
      paramMarkerOptions.position(paramMvvvmm.getPosition()).title(paramMvvvmm.getTitle()).icon((BitmapDescriptor)localObject);
      return;
      str = String.valueOf(paramMvvvmm.baa00610061aaa0061a0061());
      i = b0069006900690069i0069006900690069;
      localObject = str;
      switch (i * (biiii00690069006900690069 + i) % b0069iii00690069006900690069)
      {
      }
  ...
  public void ba006100610061006100610061aa0061(mvvvmm paramMvvvmm, Marker paramMarker)
  {
    ...
    {
      paramMarker = this.b0069i00690069i0069006900690069;
      ...
      paramMarker.b00610061aaaaaaa0061(paramMvvvmm);
    }
  }
