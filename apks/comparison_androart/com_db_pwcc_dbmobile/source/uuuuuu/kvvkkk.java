  ...
  implements xssxxs
{
  ...
  public void b006B006B006Bkkk006Bk006B006B()
  {
    ...
    switch (i * (bccccc0063c0063c + i) % b0063cccc0063c0063c)
    {
    default: 
  ...
  public Gini b0071q0071q00710071q0071qq(Context paramContext)
  {
    ...
    if (this.bcc006300630063cc0063c == null)
    {
      ...
      localObject = ppphhp.class.getMethod(uxxxxx.bb00620062bb0062b0062b0062("E[\\]^\030\031!\"\034\035%&g!\"*+%&./p", 'K', '\000'), new Class[] { String.class, Character.TYPE, Character.TYPE });
    }
    try
    {
      localObject = ((Method)localObject).invoke(null, new Object[] { ")&p%0-", Character.valueOf(';'), Character.valueOf('\003') });
  ...
  public kkkvkk bq00710071q00710071q0071qq(@Nullable Fragment paramFragment)
  {
    ...
    {
      paramFragment = kkkvkk.b0063c00630063ccc0063c;
      i = b00630063006300630063cc0063c;
      j = bccccc0063c0063c;
      ...
      switch (i * (j + i) % b0063cccc0063c0063c)
      {
      default: 
        b00630063006300630063cc0063c = b0071qqq00710071q0071qq();
