  ...
  implements allaal
{
  ...
  public void bi0069iiiiiiii(String paramString, DbErrorsPayload paramDbErrorsPayload, allaal.lalaal paramLalaal)
  {
    ...
    switch (i * (b006C006C006C006Clllll + i) % bllll006Cllll)
    {
    default: 
    ...
    while (paramString.hasNext()) {
      paramLalaal.buuu00750075uu0075u0075((DbError)paramString.next());
    }
  }
  ...
  {
    paramString2 = this.bkk006Bk006B006Bkk006B.bpp00700070p00700070007000700070(lolllo.b00710071qq0071qqq0071, Arrays.asList(new String[] { paramString1, paramString2 }));
    ...
    this.b006B006Bkk006B006Bkk006B = new llllol(paramString2, new PatchConsentResponse(paramStatus), new aaaaal.1(this, paramString1, paramLalaal));
    paramLalaal = this.b006B006Bkk006B006Bkk006B;
    paramString1 = lolllo.b00710071qq0071qqq0071;
    ...
    paramLalaal.b0070p0070007000700070pp00700070(paramString1.name());
