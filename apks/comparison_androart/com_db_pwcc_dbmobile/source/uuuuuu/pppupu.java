...
public class pppupu
{
    ...
    throws IOException
  {
    try
    {
      ...
      paramArrayOfByte1 = new SecretKeySpec(paramArrayOfByte1, ppphhp.bw0077ww00770077w00770077w("\\_l", '*', 'Ä', '\001'));
      ...
      localCipher.init(2, paramArrayOfByte1, paramArrayOfByte2);
      int i = b0075u007500750075u0075u0075;
      switch (i * (b00750075007500750075u0075u0075 + i) % buuuuu00750075u0075)
      {
      default: 
        b0075u007500750075u0075u0075 = 73;
        bu0075007500750075u0075u0075 = br00720072r00720072rr0072();
      }
      paramInputStream = new uuuppu(paramInputStream, localCipher);
      i = b0075u007500750075u0075u0075;
      switch (i * (b00750075007500750075u0075u0075 + i) % buuuuu00750075u0075)
      {
      default: 
