...
public class uppupu
{
  ...
  static
  {
    ...
    if ((b0075uu00750075u0075u0075 + b00750075u00750075u0075u0075) * b0075uu00750075u0075u0075 % buu007500750075u0075u0075 != bu0075u00750075u0075u0075)
    {
      ...
      switch (i * (b00750075u00750075u0075u0075 + i) % buu007500750075u0075u0075)
      {
      default: 
    ...
    throws IOException
  {
    ...
    paramInt = b00720072r0072r0072rr0072();
    switch (paramInt * (brr00720072r0072rr0072() + paramInt) % buu007500750075u0075u0075)
    {
    default: 
      b0075uu00750075u0075u0075 = b00720072r0072r0072rr0072();
      bu0075u00750075u0075u0075 = 59;
    }
    paramAssetManager = localInputStream;
    if (buuu00750075u0075u0075.containsKey(paramString))
    {
      paramString = pppupu.brrr007200720072rr0072(localInputStream, bu00750075u0075u0075u0075.getBytes(), b007500750075u0075u0075u0075.getBytes());
      paramAssetManager = paramString;
  ...
  {
    int i = b0075uu00750075u0075u0075;
    switch (i * (brr00720072r0072rr0072() + i) % buu007500750075u0075u0075)
    {
    default: 
      b0075uu00750075u0075u0075 = b00720072r0072r0072rr0072();
    ...
    throws IOException
  {
    ...
    if (buuu00750075u0075u0075.containsKey(paramString))
    {
      ...
      {
        int i = b0075uu00750075u0075u0075;
        switch (i * (b00750075u00750075u0075u0075 + i) % br0072r0072r0072rr0072())
        {
        default: 
          b0075uu00750075u0075u0075 = b00720072r0072r0072rr0072();
      ...
      paramAssetManager = pppupu.brrr007200720072rr0072(localInputStream, bu00750075u0075u0075u0075.getBytes(), b007500750075u0075u0075u0075.getBytes());
    }
    return paramAssetManager;
  }
    ...
    throws IOException
  {
    ...
    if (buuu00750075u0075u0075.containsKey(paramString))
    {
      paramAssetManager = new pupupu(paramAssetManager, b0075u0075u0075u0075u0075);
      paramAssetManager.b0072rr0072r0072rr0072(bu00750075u0075u0075u0075.getBytes(), b007500750075u0075u0075u0075.getBytes());
      int i = b0075uu00750075u0075u0075;
      switch (i * (b00750075u00750075u0075u0075 + i) % buu007500750075u0075u0075)
      {
      default: 
