  ...
  extends RecyclerView.Adapter<SupportedFormatsAdapter.FormatItemViewHolder>
{
  ...
  public void onBindViewHolder(SupportedFormatsAdapter.FormatItemViewHolder paramFormatItemViewHolder, int paramInt)
  {
    ...
    {
      paramFormatItemViewHolder = (SupportedFormatsAdapter.HeaderItemViewHolder)paramFormatItemViewHolder;
      localObject = (SupportedFormatsAdapter.SectionHeader)this.mItems.get(paramInt);
      paramFormatItemViewHolder.title.setText(((SupportedFormatsAdapter.SectionHeader)localObject).title);
    }
    while (!(paramFormatItemViewHolder instanceof SupportedFormatsAdapter.FormatInfoItemViewHolder)) {
      return;
    }
    paramFormatItemViewHolder = (SupportedFormatsAdapter.FormatInfoItemViewHolder)paramFormatItemViewHolder;
    Object localObject = (SupportedFormatsAdapter.FormatInfo)this.mItems.get(paramInt);
    paramFormatItemViewHolder.label.setText(((SupportedFormatsAdapter.FormatInfo)localObject).getLabel());
    paramFormatItemViewHolder.backgroundIcon.setImageResource(((SupportedFormatsAdapter.FormatInfo)localObject).getIconBackground());
    paramFormatItemViewHolder.foregroundIcon.setImageResource(((SupportedFormatsAdapter.FormatInfo)localObject).getIconForeground());
    paramInt = ContextCompat.getColor(paramFormatItemViewHolder.itemView.getContext(), ((SupportedFormatsAdapter.FormatInfo)localObject).getIconForegroundTint());
    paramFormatItemViewHolder.foregroundIcon.setColorFilter(paramInt, PorterDuff.Mode.MULTIPLY);
  }
