  ...
  extends ViewGroup
{
  ...
  private int getViewListMeasuredWidth(List<View> paramList, int[] paramArrayOfInt)
  {
    ...
    while (i < n)
    {
      ...
      m = localLayoutParams.rightMargin - m;
      int i1 = Math.max(0, k);
      int i2 = Math.max(0, m);
      k = Math.max(0, -k);
      m = Math.max(0, -m);
      j = paramArrayOfInt.getMeasuredWidth() + i1 + i2 + j;
      i += 1;
    }
    return j;
  }
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        paramInt1 = Math.min(paramInt1, i1 - i2 - paramInt3);
        ...
        paramInt3 = layoutChildRight(this.mExpandedActionView, paramInt1, arrayOfInt, i);
        paramInt1 = paramInt2;
        paramInt2 = paramInt3;
      }
      for (;;)
          ...
          for (int n = ((LayoutParams)localObject1).bottomMargin + (paramInt4 + m) + paramInt1;; n = paramInt1)
          {
            ...
            else
            {
              ...
              default: 
                ...
                if (paramInt1 < ((LayoutParams)localObject1).topMargin + this.mTitleMarginTop)
                {
                  ...
                  this.mTitleTextView.layout(k, paramInt1, paramInt2, paramInt4);
                  k -= this.mTitleMarginEnd;
                  paramInt1 = paramInt4 + ((LayoutParams)localObject1).bottomMargin;
                }
                break;
              }
            }
            for (;;)
            {
              if (bool)
              {
                localObject1 = (LayoutParams)this.mSubtitleTextView.getLayoutParams();
                paramInt1 += ((LayoutParams)localObject1).topMargin;
                paramInt4 = this.mSubtitleTextView.getMeasuredWidth();
                n = this.mSubtitleTextView.getMeasuredHeight();
                this.mSubtitleTextView.layout(paramInt2 - paramInt4, paramInt1, paramInt2, n + paramInt1);
                paramInt1 = this.mTitleMarginEnd;
                paramInt4 = ((LayoutParams)localObject1).bottomMargin;
              }
              for (n = paramInt2 - paramInt1;; n = paramInt2)
              {
                paramInt1 = paramInt2;
                paramInt4 = paramInt3;
                if (m != 0)
                ...
                for (;;)
                {
                  if (paramInt3 < k)
                  {
                    ...
                    break label204;
                    label960:
                    paramInt3 = layoutChildLeft(this.mExpandedActionView, paramInt2, arrayOfInt, i);
                    paramInt2 = paramInt1;
                    paramInt1 = paramInt3;
                    break label302;
                    ...
                    paramInt4 = ((LayoutParams)localObject1).topMargin;
                    paramInt1 = this.mTitleMarginTop + (paramInt4 + paramInt1);
                    break label612;
                    ...
                    if (m != 0)
                    {
                      paramInt4 = this.mTitleMarginStart;
                      label1143:
                      k = paramInt4 - arrayOfInt[0];
                      paramInt4 = paramInt3 + Math.max(0, k);
                      arrayOfInt[0] = Math.max(0, -k);
                      if (!paramBoolean) {
                        break label1564;
                      }
                      localObject1 = (LayoutParams)this.mTitleTextView.getLayoutParams();
                      paramInt3 = this.mTitleTextView.getMeasuredWidth() + paramInt4;
                ...
                for (;;)
                {
                  ...
                  {
                    localObject1 = (LayoutParams)this.mSubtitleTextView.getLayoutParams();
                    k = paramInt1 + ((LayoutParams)localObject1).topMargin;
                    paramInt1 = this.mSubtitleTextView.getMeasuredWidth() + paramInt4;
                    n = this.mSubtitleTextView.getMeasuredHeight();
                    this.mSubtitleTextView.layout(paramInt4, k, paramInt1, n + k);
                    k = this.mTitleMarginEnd;
                  ...
                  for (;;)
                  {
                    ...
                    paramInt4 = Math.max(paramInt3, k);
                    paramInt1 = paramInt2;
                    break;
                    paramInt4 = 0;
                    break label1143;
                    ...
                    paramInt4 = (i1 - j - i2) / 2 + j - paramInt1 / 2;
                    j = paramInt1 + paramInt4;
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    for (int j = View.combineMeasuredStates(0, this.mNavButtonView.getMeasuredState());; j = 0)
    {
      int i2 = i;
      int k = m;
      i = j;
      ...
      if (shouldLayout(this.mExpandedActionView))
      {
        i1 = k + measureChildCollapseMargins(this.mExpandedActionView, paramInt1, k, paramInt2, 0, arrayOfInt);
        n = Math.max(m, this.mExpandedActionView.getMeasuredHeight() + getVerticalMargins(this.mExpandedActionView));
      ...
      if (shouldLayout(this.mLogoView))
      {
        ...
        j = Math.max(n, this.mLogoView.getMeasuredHeight() + getVerticalMargins(this.mLogoView));
      ...
      for (;;)
      {
        ...
        paramInt1 = View.resolveSizeAndState(Math.max(k + m + j, getSuggestedMinimumHeight()), paramInt2, i << 16);
        if (shouldCollapse()) {
          paramInt1 = 0;
        }
