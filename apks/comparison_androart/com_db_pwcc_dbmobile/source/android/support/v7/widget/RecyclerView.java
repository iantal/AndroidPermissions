  ...
  implements ScrollingView, NestedScrollingChild2
{
    ...
    if (paramString != null)
    {
      ...
      if (!paramString.isEmpty())
      {
        ...
        try
        {
          ...
          {
            localObject = paramString.loadClass(str).asSubclass(LayoutManager.class);
            try
            {
              paramString = ((Class)localObject).getConstructor(LAYOUT_MANAGER_CONSTRUCTOR_SIGNATURE);
              localObject = new Object[4];
              localObject[0] = paramContext;
              localObject[1] = paramAttributeSet;
            ...
            catch (NoSuchMethodException paramContext)
            {
              try
              {
                paramString = ((Class)localObject).getConstructor(new Class[0]);
                paramContext = null;
              }
  ...
  public ViewHolder findViewHolderForItemId(long paramLong)
  {
    ...
    Object localObject1 = localViewHolder;
    if (this.mAdapter != null)
    {
      if (!this.mAdapter.hasStableIds()) {
        localObject1 = localViewHolder;
  ...
  void offsetPositionRecordsForMove(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if ((localViewHolder != null) && (localViewHolder.mPosition >= i) && (localViewHolder.mPosition <= k)) {
          break;
        }
        m += 1;
      }
    ...
    for (;;)
    {
      ...
      if ((!this.mLayoutFrozen) && (paramMotionEvent.getAction() == 8))
      {
        ...
        for (;;)
        {
          ...
          scrollByInternal((int)(this.mScaledHorizontalScrollFactor * f1), (int)(f2 * this.mScaledVerticalScrollFactor), paramMotionEvent);
          break;
          f2 = 0.0F;
          break label52;
          f1 = 0.0F;
  ...
  public static abstract class LayoutManager
  {
    ...
    private int[] getChildRectangleOnScreenScrollAmount(RecyclerView paramRecyclerView, View paramView, Rect paramRect, boolean paramBoolean)
    {
      ...
      int i5 = i3 + paramRect.width();
      int i7 = paramRect.height();
      int k = Math.min(0, i3 - i2);
      int j = Math.min(0, i1 - n);
      int m = Math.max(0, i5 - i);
      i4 = Math.max(0, i7 + i1 - (i4 - i6));
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          for (;;)
          {
            ...
            ((RecyclerView.LayoutParams)localObject2).mPendingInvalidate = bool1;
            return localObject1;
    ...
    boolean validateViewHolderForOffsetPosition(RecyclerView.ViewHolder paramViewHolder)
    {
      ...
      do
      {
        do
        {
          ...
          bool1 = bool2;
        } while (RecyclerView.this.mAdapter.getItemViewType(paramViewHolder.mPosition) != paramViewHolder.getItemViewType());
        if (!RecyclerView.this.mAdapter.hasStableIds()) {
          break;
        }
        bool1 = bool2;
    ...
    implements Runnable
  {
    ...
    public void run()
    {
      ...
      if (localOverScroller.computeScrollOffset())
      {
        ...
        i4 = localOverScroller.getCurrX();
        i5 = localOverScroller.getCurrY();
        i1 = i4 - this.mLastFlingX;
        i2 = i5 - this.mLastFlingY;
        this.mLastFlingX = i4;
        this.mLastFlingY = i5;
        if (!RecyclerView.this.dispatchNestedPreScroll(i1, i2, arrayOfInt, null, 1)) {
          break label892;
        }
        j = arrayOfInt[0];
        i = arrayOfInt[1];
      ...
      for (;;)
      {
        ...
        if (RecyclerView.this.mAdapter != null)
        {
          ...
          if (i1 != 0)
          {
            ...
            j = RecyclerView.this.mLayout.scrollVerticallyBy(i2, RecyclerView.this.mRecycler, RecyclerView.this.mState);
          }
        }
        for (int k = i2 - j;; k = 0)
        {
          ...
          for (;;)
          {
            ...
            if ((!RecyclerView.this.dispatchNestedScroll(i, j, i3, k, null, 1)) && ((i3 != 0) || (k != 0)))
            {
              n = (int)localOverScroller.getCurrVelocity();
              if (i3 == i4) {
                break label872;
              }
              if (i3 >= 0) {
            ...
            for (;;)
            {
              ...
              {
                if (RecyclerView.this.getOverScrollMode() != 2) {
                  RecyclerView.this.absorbGlows(m, n);
                }
                if (((m != 0) || (i3 == i4) || (localOverScroller.getFinalX() == 0)) && ((n != 0) || (k == i5) || (localOverScroller.getFinalY() == 0))) {
                ...
                if ((i2 != 0) && (RecyclerView.this.mLayout.canScrollVertically()) && (j == i2))
                {
                  j = 1;
                ...
                for (;;)
                {
                  ...
                  if (localSmoothScroller.getTargetPosition() >= n)
                  {
                    ...
                    localSmoothScroller.onAnimation(i1 - m, i2 - k);
                    i3 = m;
                    break;
                  }
                  localSmoothScroller.onAnimation(i1 - m, i2 - k);
