  ...
  extends ViewGroup
{
  ...
  private int computeLayoutParamsHashCode()
  {
    ...
    if (i < k)
    {
      ...
      for (;;)
      {
        i += 1;
        break;
        j = ((LayoutParams)localView.getLayoutParams()).hashCode() + j * 31;
      }
    }
    return j;
  }
  ...
  final class Axis
  {
    ...
    private void solveAndDistributeSpace(int[] paramArrayOfInt)
    {
      ...
      solve(paramArrayOfInt);
      int k = this.parentMin.value * GridLayout.this.getChildCount() + 1;
      if (k < 2) {}
      float f;
      boolean bool;
      int j;
    ...
    GridLayout.Arc[][] groupArcsByFirstVertex(GridLayout.Arc[] paramArrayOfArc)
    {
      ...
      while (i < k)
      {
        GridLayout.Arc localArc = paramArrayOfArc[i];
        j = localArc.span.min;
        [Landroid.support.v7.widget.GridLayout.Arc localArc; = arrayOfArc;[j];
        m = arrayOfInt[j];
        arrayOfInt[j] = (m + 1);
        localArc;[m] = localArc;
        i += 1;
    ...
    public boolean equals(Object paramObject)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          bool1 = bool2;
        } while (this.max != paramObject.max);
    ...
    public boolean equals(Object paramObject)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          bool1 = bool2;
        } while (!this.columnSpec.equals(paramObject.columnSpec));
      } while (this.rowSpec.equals(paramObject.rowSpec));
      return false;
    }
    ...
    public boolean equals(Object paramObject)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          bool1 = bool2;
        } while (!this.alignment.equals(paramObject.alignment));
      } while (this.span.equals(paramObject.span));
      return false;
    }
