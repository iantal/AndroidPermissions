...
class AppCompatViewInflater
{
  ...
  private void checkOnClickListener(View paramView, AttributeSet paramAttributeSet)
  {
    ...
    if (localObject != null) {
      InstrumentationCallbacks.setOnClickListenerCalled(paramView, new DeclaredOnClickListener(paramView, (String)localObject));
    }
  ...
  private View createViewFromTag(Context paramContext, String paramString, AttributeSet paramAttributeSet)
  {
    ...
    //   38: aload 5
    //   40: bipush 46
    //   42: invokevirtual 177	java/lang/String:indexOf	(I)I
    //   45: if_icmpne +74 -> 119
    //   48: iconst_0
    //   49: istore 4
    //   51: iload 4
    ...
    //   67: iload 4
    //   69: aaload
    //   70: invokespecial 179	android/support/v7/app/AppCompatViewInflater:createView	(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    //   73: astore_2
    //   74: aload_2
    //   75: ifnull +19 -> 94
    //   78: aload_0
    ...
    //   121: aload 5
    //   123: aconst_null
    //   124: invokespecial 179	android/support/v7/app/AppCompatViewInflater:createView	(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    //   127: astore_1
    //   128: aload_0
  ...
  private static Context themifyContext(Context paramContext, AttributeSet paramAttributeSet, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (paramBoolean1) {}
    for (int j = paramAttributeSet.getResourceId(R.styleable.View_android_theme, 0);; j = 0)
    {
      int i = j;
      if (paramBoolean2)
      {
