  ...
  extends CoordinatorLayout.Behavior<V>
{
  ...
  public boolean onInterceptTouchEvent(CoordinatorLayout paramCoordinatorLayout, V paramV, MotionEvent paramMotionEvent)
  {
    ...
    return (i == 2) && (paramV != null) && (!this.mIgnoreEvents) && (this.mState != 1) && (!paramCoordinatorLayout.isPointInChildBounds(paramV, (int)paramMotionEvent.getX(), (int)paramMotionEvent.getY())) && (Math.abs(this.mInitialY - paramMotionEvent.getY()) > this.mViewDragHelper.getTouchSlop());
  }
  ...
  boolean shouldHide(View paramView, float paramFloat)
  {
    ...
    do
    {
      ...
      {
        return bool;
      } while (paramView.getTop() < this.mMaxOffset);
