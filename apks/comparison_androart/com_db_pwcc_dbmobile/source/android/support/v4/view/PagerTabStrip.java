  ...
  extends PagerTitleStrip
{
  ...
  public PagerTabStrip(@NonNull Context paramContext, @Nullable AttributeSet paramAttributeSet)
  {
    ...
    InstrumentationCallbacks.setOnClickListenerCalled(this.mPrevText, new View.OnClickListener()
    {
    ...
    InstrumentationCallbacks.setOnClickListenerCalled(this.mNextText, new View.OnClickListener()
    {
      public void onClick(View paramAnonymousView)
      {
        PagerTabStrip.this.mPager.setCurrentItem(PagerTabStrip.this.mPager.getCurrentItem() + 1);
