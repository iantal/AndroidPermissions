  ...
  implements Parcelable
{
  ...
  public MediaDescriptionCompat getDescription()
  {
    ...
    for (;;)
    {
      ...
      for (Object localObject2 = Uri.parse((String)localObject2);; localObject2 = null)
      {
        ...
        i = 0;
        int k;
        for (int j = 0; (j < arrayOfCharSequence.length) && (i < PREFERRED_DESCRIPTION_ORDER.length); j = k)
        {
