...
public class ContextCompat
{
  ...
  @ColorInt
  public static final int getColor(@NonNull Context paramContext, @ColorRes int paramInt)
  {
  ...
  @Nullable
  public static final ColorStateList getColorStateList(@NonNull Context paramContext, @ColorRes int paramInt)
  {
    if (Build.VERSION.SDK_INT >= 23) {
  ...
  @Nullable
  public static final Drawable getDrawable(@NonNull Context paramContext, @DrawableRes int paramInt)
  {
    if (Build.VERSION.SDK_INT >= 21) {
  ...
  @Nullable
  public static final File getNoBackupFilesDir(@NonNull Context paramContext)
  {
    if (Build.VERSION.SDK_INT >= 21) {
