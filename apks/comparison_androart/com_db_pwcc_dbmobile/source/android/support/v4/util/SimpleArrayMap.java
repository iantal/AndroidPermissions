...
public class SimpleArrayMap<K, V>
{
  ...
  int indexOf(Object paramObject, int paramInt)
  {
    ...
    int m = binarySearchHashes(this.mHashes, k, paramInt);
    if ((m >= 0) && (!paramObject.equals(this.mArray[(m << 1)])))
    {
      int i = m + 1;
      for (;;)
      {
  ...
  int indexOfNull()
  {
    ...
    int m = binarySearchHashes(this.mHashes, k, 0);
    if ((m >= 0) && (this.mArray[(m << 1)] != null))
    {
      int i = m + 1;
      for (;;)
      {
