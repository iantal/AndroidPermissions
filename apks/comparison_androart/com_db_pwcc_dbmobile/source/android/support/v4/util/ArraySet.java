  ...
  implements Collection<E>, Set<E>
{
  ...
  private int indexOf(Object paramObject, int paramInt)
  {
    ...
    int m = ContainerHelpers.binarySearch(this.mHashes, k, paramInt);
    if ((m >= 0) && (!paramObject.equals(this.mArray[m])))
    {
      int i = m + 1;
      for (;;)
      {
  ...
  private int indexOfNull()
  {
    ...
    int m = ContainerHelpers.binarySearch(this.mHashes, k, 0);
    if ((m >= 0) && (this.mArray[m] != null))
    {
      int i = m + 1;
      for (;;)
      {
