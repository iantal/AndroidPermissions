...
public class TypefaceCompatUtil
{
  ...
  public static boolean copyToFile(File paramFile, java.io.InputStream paramInputStream)
  {
    ...
    //   6: aload_0
    //   7: iconst_0
    //   8: invokespecial 69	java/io/FileOutputStream:<init>	(Ljava/io/File;Z)V
    //   11: astore_0
    //   12: sipush 1024
    //   15: newarray byte
    //   17: astore_3
    //   18: aload_1
    //   19: aload_3
    //   20: invokevirtual 75	java/io/InputStream:read	([B)I
    //   23: istore_2
    //   24: iload_2
    //   25: iconst_m1
    //   26: if_icmpeq +48 -> 74
    ...
    //   31: iconst_0
    //   32: iload_2
    //   33: invokevirtual 79	java/io/FileOutputStream:write	([BII)V
    //   36: goto -18 -> 18
    //   39: astore_1
    //   40: ldc 15
    //   42: new 81	java/lang/StringBuilder
    //   45: dup
    //   46: invokespecial 82	java/lang/StringBuilder:<init>	()V
    //   49: ldc 84
    //   51: invokevirtual 88	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   54: aload_1
    //   55: invokevirtual 92	java/io/IOException:getMessage	()Ljava/lang/String;
    //   58: invokevirtual 88	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   61: invokevirtual 95	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   64: invokestatic 101	android/util/Log:e	(Ljava/lang/String;Ljava/lang/String;)I
    //   67: pop
    //   68: aload_0
    //   69: invokestatic 64	android/support/v4/graphics/TypefaceCompatUtil:closeQuietly	(Ljava/io/Closeable;)V
    //   72: iconst_0
    //   73: ireturn
    //   74: aload_0
    //   75: invokestatic 64	android/support/v4/graphics/TypefaceCompatUtil:closeQuietly	(Ljava/io/Closeable;)V
    //   78: iconst_1
    //   79: ireturn
    //   80: astore_1
    //   81: aload_0
  ...
  public static ByteBuffer mmap(Context paramContext, android.os.CancellationSignal paramCancellationSignal, android.net.Uri paramUri)
  {
    ...
    //   13: astore_2
    //   14: new 144	java/io/FileInputStream
    //   17: dup
    //   18: aload_2
    //   19: invokevirtual 150	android/os/ParcelFileDescriptor:getFileDescriptor	()Ljava/io/FileDescriptor;
    //   22: invokespecial 153	java/io/FileInputStream:<init>	(Ljava/io/FileDescriptor;)V
    //   25: astore 5
    //   27: aload 5
    //   29: invokevirtual 157	java/io/FileInputStream:getChannel	()Ljava/nio/channels/FileChannel;
    //   32: astore_0
    //   33: aload_0
    //   34: invokevirtual 163	java/nio/channels/FileChannel:size	()J
    //   37: lstore_3
    //   38: aload_0
    //   39: getstatic 169	java/nio/channels/FileChannel$MapMode:READ_ONLY	Ljava/nio/channels/FileChannel$MapMode;
    //   42: lconst_0
    //   43: lload_3
    //   44: invokevirtual 173	java/nio/channels/FileChannel:map	(Ljava/nio/channels/FileChannel$MapMode;JJ)Ljava/nio/MappedByteBuffer;
    //   47: astore_0
    //   48: aload 5
    //   50: ifnull +8 -> 58
    //   53: aload 5
    //   55: invokevirtual 174	java/io/FileInputStream:close	()V
    //   58: aload_2
    //   59: ifnull +7 -> 66
    //   62: aload_2
    //   63: invokevirtual 175	android/os/ParcelFileDescriptor:close	()V
    //   66: aload_0
    //   67: areturn
    //   68: astore_0
    //   69: aload_0
    ...
    //   77: ifnull +66 -> 143
    //   80: aload_2
    //   81: invokevirtual 175	android/os/ParcelFileDescriptor:close	()V
    //   84: aload_1
    //   85: athrow
    //   86: astore_0
    //   87: aconst_null
    ...
    //   105: ifnull +21 -> 126
    //   108: aload 5
    //   110: invokevirtual 174	java/io/FileInputStream:close	()V
    //   113: aload_1
    //   114: athrow
    //   115: astore 5
    //   117: aload_0
    ...
    //   123: goto -10 -> 113
    //   126: aload 5
    //   128: invokevirtual 174	java/io/FileInputStream:close	()V
    //   131: goto -18 -> 113
    //   134: astore_2
    //   135: aload_0
    //   136: aload_2
    //   137: invokevirtual 179	java/lang/Throwable:addSuppressed	(Ljava/lang/Throwable;)V
    //   140: goto -56 -> 84
    //   143: aload_2
    //   144: invokevirtual 175	android/os/ParcelFileDescriptor:close	()V
    //   147: goto -63 -> 84
    //   150: astore_1
    //   151: aconst_null
    //   152: astore_0
  ...
  private static ByteBuffer mmap(File paramFile)
  {
    ...
    //   8: astore 4
    //   10: aload 4
    //   12: invokevirtual 157	java/io/FileInputStream:getChannel	()Ljava/nio/channels/FileChannel;
    //   15: astore_0
    //   16: aload_0
    //   17: invokevirtual 163	java/nio/channels/FileChannel:size	()J
    //   20: lstore_1
    //   21: aload_0
    //   22: getstatic 169	java/nio/channels/FileChannel$MapMode:READ_ONLY	Ljava/nio/channels/FileChannel$MapMode;
    //   25: lconst_0
    //   26: lload_1
    //   27: invokevirtual 173	java/nio/channels/FileChannel:map	(Ljava/nio/channels/FileChannel$MapMode;JJ)Ljava/nio/MappedByteBuffer;
    //   30: astore_0
    //   31: aload 4
    //   33: ifnull +8 -> 41
    //   36: aload 4
    //   38: invokevirtual 174	java/io/FileInputStream:close	()V
    //   41: aload_0
    //   42: areturn
    //   43: astore_0
    //   44: aconst_null
    ...
    //   56: ifnull +21 -> 77
    //   59: aload 4
    //   61: invokevirtual 174	java/io/FileInputStream:close	()V
    //   64: aload_0
    //   65: athrow
    //   66: astore 4
    //   68: aload_3
    //   69: aload 4
    //   71: invokevirtual 179	java/lang/Throwable:addSuppressed	(Ljava/lang/Throwable;)V
    //   74: goto -10 -> 64
    //   77: aload 4
    //   79: invokevirtual 174	java/io/FileInputStream:close	()V
    //   82: goto -18 -> 64
    //   85: astore_0
    //   86: aconst_null
    //   87: astore_3
