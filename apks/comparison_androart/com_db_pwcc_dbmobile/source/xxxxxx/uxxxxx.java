...
public class uxxxxx
{
  ...
  public static String b006200620062bb0062b0062b0062(String paramString, char paramChar1, char paramChar2)
  {
    ...
    try
    {
      paramString = ((xuxxxx)b006200620062bbbb0062b0062.get(paramChar2)).bbb0062bb0062b0062b0062(paramString, new Character(paramChar1).charValue());
      return paramString;
    }
  ...
  public static String b0062bb0062b0062b0062b0062(String paramString, char paramChar1, char paramChar2, char paramChar3)
  {
    ...
    try
    {
      paramString = ((uuxxxx)bbbb0062bbb0062b0062.get(paramChar3)).b0062b0062bb0062b0062b0062(paramString, new Character(paramChar1).charValue(), new Character(paramChar2).charValue());
      return paramString;
    }
    catch (Exception paramString) {}
    return new String("");
    ...
    extends uxxxxx.xuxxxx
  {
    ...
    public String bbb0062bb0062b0062b0062(String paramString, char paramChar)
    {
      ...
      paramString = new xuuuxx(paramString);
      char c = '\000';
      while (paramString.bbb00620062b0062b0062b0062())
      {
        int i = paramString.b0062b00620062b0062b0062b0062();
    ...
    extends uxxxxx.xuxxxx
  {
    ...
    public String bbb0062bb0062b0062b0062(String paramString, char paramChar)
    {
      ...
      while (paramString.bbb00620062b0062b0062b0062())
      {
        int j = paramString.b0062b00620062b0062b0062b0062();
        uuuuxx localUuuuxx = uuuuxx.bbbbb00620062b0062b0062(j);
        arrayOfInt[i] = localUuuuxx.b0062006200620062b0062b0062b0062(localUuuuxx.bb006200620062b0062b0062b0062(j) - (paramChar + paramChar + i));
        i += 1;
      }
    ...
    extends uxxxxx.xuxxxx
  {
    ...
    public String bbb0062bb0062b0062b0062(String paramString, char paramChar)
    {
      ...
      while (paramString.bbb00620062b0062b0062b0062())
      {
        int j = paramString.b0062b00620062b0062b0062b0062();
        uuuuxx localUuuuxx = uuuuxx.bbbbb00620062b0062b0062(j);
        arrayOfInt[i] = localUuuuxx.b0062006200620062b0062b0062b0062(localUuuuxx.bb006200620062b0062b0062b0062(j) + (paramChar + paramChar + paramChar + i));
        i += 1;
      }
      return new String(arrayOfInt, 0, i);
    }
