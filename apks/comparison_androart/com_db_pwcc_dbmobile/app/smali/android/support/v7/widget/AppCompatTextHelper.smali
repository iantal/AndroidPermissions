...
.method private updateTypefaceAndStyle(Landroid/content/Context;Landroid/support/v7/widget/TintTypedArray;)V
    ...
    invoke-direct {v3, p0, v4}, Landroid/support/v7/widget/AppCompatTextHelper$1;-><init>(Landroid/support/v7/widget/AppCompatTextHelper;Ljava/lang/ref/WeakReference;)V

    :try_start_0
    iget v4, p0, Landroid/support/v7/widget/AppCompatTextHelper;->mStyle:I

    invoke-virtual {p2, v0, v4, v3}, Landroid/support/v7/widget/TintTypedArray;->getFont(IILandroid/support/v4/content/res/ResourcesCompat$FontCallback;)Landroid/graphics/Typeface;
...
.method loadFromAttributes(Landroid/util/AttributeSet;I)V
    ...
    invoke-static {v7, p1, v2, p2, v1}, Landroid/support/v7/widget/TintTypedArray;->obtainStyledAttributes(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/TintTypedArray;

    move-result-object v2

    sget v4, Landroid/support/v7/appcompat/R$styleable;->AppCompatTextHelper_android_textAppearance:I

    invoke-virtual {v2, v4, v9}, Landroid/support/v7/widget/TintTypedArray;->getResourceId(II)I
    ...
    invoke-virtual {v2, v6, v1}, Landroid/support/v7/widget/TintTypedArray;->getResourceId(II)I
    ...
    invoke-virtual {v9, v0, v1}, Landroid/support/v7/widget/TintTypedArray;->getBoolean(IZ)Z
    ...
    invoke-static {v7, p1, v9, p2, v1}, Landroid/support/v7/widget/TintTypedArray;->obtainStyledAttributes(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/TintTypedArray;
    ...
    invoke-virtual {v9, v3}, Landroid/support/v7/widget/TintTypedArray;->hasValue(I)Z
    ...
    invoke-virtual {v9, v3}, Landroid/support/v7/widget/TintTypedArray;->getColorStateList(I)Landroid/content/res/ColorStateList;
    ...
    :cond_7
    sget v3, Landroid/support/v7/appcompat/R$styleable;->TextAppearance_android_textColorLink:I
