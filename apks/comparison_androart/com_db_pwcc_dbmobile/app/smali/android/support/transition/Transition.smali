...
.method protected createAnimators(Landroid/view/ViewGroup;Landroid/support/transition/TransitionValuesMaps;Landroid/support/transition/TransitionValuesMaps;Ljava/util/ArrayList;Ljava/util/ArrayList;)V
    ...
    iget-object v6, v2, Landroid/support/transition/TransitionValues;->mTargetedTransitions:Ljava/util/ArrayList;
    ...
    invoke-virtual {v0, v12, v9}, Landroid/support/transition/Transition;->isTransitionRequired(Landroid/support/transition/TransitionValues;Landroid/support/transition/TransitionValues;)Z
    ...
    invoke-virtual {v0, v1, v12, v9}, Landroid/support/transition/Transition;->createAnimator(Landroid/view/ViewGroup;Landroid/support/transition/TransitionValues;Landroid/support/transition/TransitionValues;)Landroid/animation/Animator;
    ...
    iget-object v6, v9, Landroid/support/transition/TransitionValues;->view:Landroid/view/View;
    ...
    new-instance v7, Landroid/support/transition/TransitionValues;

    invoke-direct {v7}, Landroid/support/transition/TransitionValues;-><init>()V

    iput-object v6, v7, Landroid/support/transition/TransitionValues;->view:Landroid/view/View;
    ...
    iget-object v0, v7, Landroid/support/transition/TransitionValues;->values:Ljava/util/Map;
    ...
    invoke-virtual {v13, v3}, Landroid/support/v4/util/ArrayMap;->keyAt(I)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Landroid/animation/Animator;

    invoke-virtual {v13, v2}, Landroid/support/v4/util/ArrayMap;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Landroid/support/transition/Transition$AnimationInfo;

    iget-object v0, v2, Landroid/support/transition/Transition$AnimationInfo;->mValues:Landroid/support/transition/TransitionValues;

    move-object/from16 v16, v0

    if-eqz v16, :cond_4

    iget-object v0, v2, Landroid/support/transition/Transition$AnimationInfo;->mView:Landroid/view/View;
    ...
    iget-object v0, v2, Landroid/support/transition/Transition$AnimationInfo;->mName:Ljava/lang/String;
    ...
    invoke-virtual {v2, v7}, Landroid/support/transition/TransitionValues;->equals(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v2, v0, v1, v12, v9}, Landroid/support/transition/TransitionPropagation;->getStartDelay(Landroid/view/ViewGroup;Landroid/support/transition/Transition;Landroid/support/transition/TransitionValues;Landroid/support/transition/TransitionValues;)J
    ...
    invoke-virtual {v13, v10, v2}, Landroid/support/v4/util/ArrayMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
