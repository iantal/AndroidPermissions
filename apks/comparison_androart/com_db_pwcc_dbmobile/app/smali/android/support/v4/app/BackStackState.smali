...
.method public instantiate(Landroid/support/v4/app/FragmentManagerImpl;)Landroid/support/v4/app/BackStackRecord;
    ...
    new-instance v2, Landroid/support/v4/app/BackStackRecord;

    invoke-direct {v2, p1}, Landroid/support/v4/app/BackStackRecord;-><init>(Landroid/support/v4/app/FragmentManagerImpl;)V
    ...
    iput v0, v3, Landroid/support/v4/app/BackStackRecord$Op;->enterAnim:I
    ...
    iput v0, v3, Landroid/support/v4/app/BackStackRecord$Op;->exitAnim:I
    ...
    iput v0, v3, Landroid/support/v4/app/BackStackRecord$Op;->popEnterAnim:I
    ...
    iput v4, v2, Landroid/support/v4/app/BackStackRecord;->mEnterAnim:I

    iget v4, v3, Landroid/support/v4/app/BackStackRecord$Op;->exitAnim:I

    iput v4, v2, Landroid/support/v4/app/BackStackRecord;->mExitAnim:I

    iget v4, v3, Landroid/support/v4/app/BackStackRecord$Op;->popEnterAnim:I

    iput v4, v2, Landroid/support/v4/app/BackStackRecord;->mPopEnterAnim:I

    iget v4, v3, Landroid/support/v4/app/BackStackRecord$Op;->popExitAnim:I

    iput v4, v2, Landroid/support/v4/app/BackStackRecord;->mPopExitAnim:I

    invoke-virtual {v2, v3}, Landroid/support/v4/app/BackStackRecord;->addOp(Landroid/support/v4/app/BackStackRecord$Op;)V
    ...
    iput v0, v2, Landroid/support/v4/app/BackStackRecord;->mTransition:I

    iget v0, p0, Landroid/support/v4/app/BackStackState;->mTransitionStyle:I

    iput v0, v2, Landroid/support/v4/app/BackStackRecord;->mTransitionStyle:I

    iget-object v0, p0, Landroid/support/v4/app/BackStackState;->mName:Ljava/lang/String;

    iput-object v0, v2, Landroid/support/v4/app/BackStackRecord;->mName:Ljava/lang/String;

    iget v0, p0, Landroid/support/v4/app/BackStackState;->mIndex:I

    iput v0, v2, Landroid/support/v4/app/BackStackRecord;->mIndex:I

    iput-boolean v7, v2, Landroid/support/v4/app/BackStackRecord;->mAddToBackStack:Z

    iget v0, p0, Landroid/support/v4/app/BackStackState;->mBreadCrumbTitleRes:I

    iput v0, v2, Landroid/support/v4/app/BackStackRecord;->mBreadCrumbTitleRes:I

    iget-object v0, p0, Landroid/support/v4/app/BackStackState;->mBreadCrumbTitleText:Ljava/lang/CharSequence;

    iput-object v0, v2, Landroid/support/v4/app/BackStackRecord;->mBreadCrumbTitleText:Ljava/lang/CharSequence;

    iget v0, p0, Landroid/support/v4/app/BackStackState;->mBreadCrumbShortTitleRes:I

    iput v0, v2, Landroid/support/v4/app/BackStackRecord;->mBreadCrumbShortTitleRes:I

    iget-object v0, p0, Landroid/support/v4/app/BackStackState;->mBreadCrumbShortTitleText:Ljava/lang/CharSequence;

    iput-object v0, v2, Landroid/support/v4/app/BackStackRecord;->mBreadCrumbShortTitleText:Ljava/lang/CharSequence;

    iget-object v0, p0, Landroid/support/v4/app/BackStackState;->mSharedElementSourceNames:Ljava/util/ArrayList;

    iput-object v0, v2, Landroid/support/v4/app/BackStackRecord;->mSharedElementSourceNames:Ljava/util/ArrayList;

    iget-object v0, p0, Landroid/support/v4/app/BackStackState;->mSharedElementTargetNames:Ljava/util/ArrayList;

    iput-object v0, v2, Landroid/support/v4/app/BackStackRecord;->mSharedElementTargetNames:Ljava/util/ArrayList;

    iget-boolean v0, p0, Landroid/support/v4/app/BackStackState;->mReorderingAllowed:Z

    iput-boolean v0, v2, Landroid/support/v4/app/BackStackRecord;->mReorderingAllowed:Z

    invoke-virtual {v2, v7}, Landroid/support/v4/app/BackStackRecord;->bumpBackStackNesting(I)V
