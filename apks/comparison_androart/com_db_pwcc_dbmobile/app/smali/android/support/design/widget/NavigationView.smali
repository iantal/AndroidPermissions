...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-virtual {v6, v0, v3}, Landroid/support/v7/widget/TintTypedArray;->getDimensionPixelSize(II)I
    ...
    invoke-virtual {v6, v0, v3}, Landroid/support/v7/widget/TintTypedArray;->getBoolean(IZ)Z
    ...
    invoke-virtual {v6, v1, v3}, Landroid/support/v7/widget/TintTypedArray;->getResourceId(II)I
    ...
    invoke-virtual {v8, v2}, Landroid/support/design/internal/NavigationMenuPresenter;->setId(I)V
    ...
    invoke-virtual {v2, p1, v8}, Landroid/support/design/internal/NavigationMenuPresenter;->initForMenu(Landroid/content/Context;Landroid/support/v7/view/menu/MenuBuilder;)V

    iget-object v2, p0, Landroid/support/design/widget/NavigationView;->mPresenter:Landroid/support/design/internal/NavigationMenuPresenter;

    invoke-virtual {v2, v0}, Landroid/support/design/internal/NavigationMenuPresenter;->setItemIconTintList(Landroid/content/res/ColorStateList;)V
    ...
    invoke-virtual {v0, v4}, Landroid/support/design/internal/NavigationMenuPresenter;->setItemTextAppearance(I)V
    ...
    invoke-virtual {v6, v0, v3}, Landroid/support/v7/widget/TintTypedArray;->getResourceId(II)I
...
.method private createDefaultColorStateList(I)Landroid/content/res/ColorStateList;
    ...
    sget-object v4, Landroid/support/design/widget/NavigationView;->DISABLED_STATE_SET:[I
    ...
    sget-object v0, Landroid/support/design/widget/NavigationView;->DISABLED_STATE_SET:[I
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-virtual {v1, v2}, Landroid/support/design/internal/NavigationMenu;->savePresenterStates(Landroid/os/Bundle;)V
