...
.method public open(Lorg/spongycastle/asn1/ASN1ObjectIdentifier;Ljava/io/OutputStream;Lorg/spongycastle/operator/MacCalculator;Lorg/spongycastle/operator/DigestCalculator;)Ljava/io/OutputStream;
    ...
    iget-object v0, p0, Lorg/spongycastle/cms/CMSAuthenticatedDataStreamGenerator;->recipientInfoGenerators:Ljava/util/List;
    ...
    invoke-interface {v0, v3}, Lorg/spongycastle/cms/RecipientInfoGenerator;->generate(Lorg/spongycastle/operator/GenericKey;)Lorg/spongycastle/asn1/cms/RecipientInfo;
    ...
    invoke-virtual {v6, v0}, Lorg/spongycastle/asn1/BERSequenceGenerator;->addObject(Lorg/spongycastle/asn1/ASN1Encodable;)V
    ...
    invoke-direct {v7, v0, v2, v3}, Lorg/spongycastle/asn1/BERSequenceGenerator;-><init>(Ljava/io/OutputStream;IZ)V

    new-instance v0, Lorg/spongycastle/asn1/ASN1Integer;

    iget-object v2, p0, Lorg/spongycastle/cms/CMSAuthenticatedDataStreamGenerator;->originatorInfo:Lorg/spongycastle/asn1/cms/OriginatorInfo;

    invoke-static {v2}, Lorg/spongycastle/asn1/cms/AuthenticatedData;->calculateVersion(Lorg/spongycastle/asn1/cms/OriginatorInfo;)I
    ...
    invoke-virtual {v7, v0}, Lorg/spongycastle/asn1/BERSequenceGenerator;->addObject(Lorg/spongycastle/asn1/ASN1Encodable;)V

    iget-object v0, p0, Lorg/spongycastle/cms/CMSAuthenticatedDataStreamGenerator;->originatorInfo:Lorg/spongycastle/asn1/cms/OriginatorInfo;
    ...
    iget-object v4, p0, Lorg/spongycastle/cms/CMSAuthenticatedDataStreamGenerator;->originatorInfo:Lorg/spongycastle/asn1/cms/OriginatorInfo;

    invoke-direct {v0, v2, v3, v4}, Lorg/spongycastle/asn1/DERTaggedObject;-><init>(ZILorg/spongycastle/asn1/ASN1Encodable;)V

    invoke-virtual {v7, v0}, Lorg/spongycastle/asn1/BERSequenceGenerator;->addObject(Lorg/spongycastle/asn1/ASN1Encodable;)V

    :cond_1
    iget-boolean v0, p0, Lorg/spongycastle/cms/CMSAuthenticatedDataStreamGenerator;->berEncodeRecipientSet:Z
    ...
    invoke-virtual {v2}, Lorg/spongycastle/asn1/BERSet;->getEncoded()[B
    ...
    invoke-direct {v8, v0}, Lorg/spongycastle/asn1/BERSequenceGenerator;-><init>(Ljava/io/OutputStream;)V
    ...
    iget v3, p0, Lorg/spongycastle/cms/CMSAuthenticatedDataStreamGenerator;->bufferSize:I

    invoke-static {v0, v1, v2, v3}, Lorg/spongycastle/cms/CMSUtils;->createBEROctetOutputStream(Ljava/io/OutputStream;IZI)Ljava/io/OutputStream;
    ...
    invoke-direct {v5, v0, v1}, Lorg/spongycastle/util/io/TeeOutputStream;-><init>(Ljava/io/OutputStream;Ljava/io/OutputStream;)V
