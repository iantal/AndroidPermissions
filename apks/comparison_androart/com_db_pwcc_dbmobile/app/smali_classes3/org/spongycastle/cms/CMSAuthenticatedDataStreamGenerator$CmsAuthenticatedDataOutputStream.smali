...
.method public close()V
    ...
    iget-object v1, p0, Lorg/spongycastle/cms/CMSAuthenticatedDataStreamGenerator$CmsAuthenticatedDataOutputStream;->contentType:Lorg/spongycastle/asn1/ASN1ObjectIdentifier;

    iget-object v2, p0, Lorg/spongycastle/cms/CMSAuthenticatedDataStreamGenerator$CmsAuthenticatedDataOutputStream;->digestCalculator:Lorg/spongycastle/operator/DigestCalculator;
    ...
    iget-object v4, p0, Lorg/spongycastle/cms/CMSAuthenticatedDataStreamGenerator$CmsAuthenticatedDataOutputStream;->digestCalculator:Lorg/spongycastle/operator/DigestCalculator;

    invoke-interface {v4}, Lorg/spongycastle/operator/DigestCalculator;->getDigest()[B

    move-result-object v4

    invoke-virtual {v0, v1, v2, v3, v4}, Lorg/spongycastle/cms/CMSAuthenticatedDataStreamGenerator;->getBaseParameters(Lorg/spongycastle/asn1/ASN1ObjectIdentifier;Lorg/spongycastle/asn1/x509/AlgorithmIdentifier;Lorg/spongycastle/asn1/x509/AlgorithmIdentifier;[B)Ljava/util/Map;
    ...
    iget-object v1, v1, Lorg/spongycastle/cms/CMSAuthenticatedDataStreamGenerator;->authGen:Lorg/spongycastle/cms/CMSAttributeTableGenerator;
    ...
    iput-object v2, v1, Lorg/spongycastle/cms/CMSAuthenticatedDataStreamGenerator;->authGen:Lorg/spongycastle/cms/CMSAttributeTableGenerator;
    ...
    iget-object v2, p0, Lorg/spongycastle/cms/CMSAuthenticatedDataStreamGenerator$CmsAuthenticatedDataOutputStream;->macCalculator:Lorg/spongycastle/operator/MacCalculator;

    invoke-interface {v2}, Lorg/spongycastle/operator/MacCalculator;->getOutputStream()Ljava/io/OutputStream;

    move-result-object v2

    const-string v3, "DER"

    invoke-virtual {v1, v3}, Lorg/spongycastle/asn1/ASN1Set;->getEncoded(Ljava/lang/String;)[B
    ...
    invoke-direct {v3, v6, v4, v1}, Lorg/spongycastle/asn1/DERTaggedObject;-><init>(ZILorg/spongycastle/asn1/ASN1Encodable;)V

    invoke-virtual {v2, v3}, Lorg/spongycastle/asn1/BERSequenceGenerator;->addObject(Lorg/spongycastle/asn1/ASN1Encodable;)V

    :goto_0
    iget-object v1, p0, Lorg/spongycastle/cms/CMSAuthenticatedDataStreamGenerator$CmsAuthenticatedDataOutputStream;->envGen:Lorg/spongycastle/asn1/BERSequenceGenerator;

    new-instance v2, Lorg/spongycastle/asn1/DEROctetString;

    iget-object v3, p0, Lorg/spongycastle/cms/CMSAuthenticatedDataStreamGenerator$CmsAuthenticatedDataOutputStream;->macCalculator:Lorg/spongycastle/operator/MacCalculator;

    invoke-interface {v3}, Lorg/spongycastle/operator/MacCalculator;->getMac()[B
    ...
    iget-object v1, v1, Lorg/spongycastle/cms/CMSAuthenticatedDataStreamGenerator;->unauthGen:Lorg/spongycastle/cms/CMSAttributeTableGenerator;
