...
.method public open(Lorg/spongycastle/asn1/ASN1ObjectIdentifier;Ljava/io/OutputStream;Lorg/spongycastle/operator/OutputCompressor;)Ljava/io/OutputStream;
    ...
    invoke-direct {v4, v0, v8, v9}, Lorg/spongycastle/asn1/BERSequenceGenerator;-><init>(Ljava/io/OutputStream;IZ)V
    ...
    iget v2, p0, Lorg/spongycastle/cms/CMSCompressedDataStreamGenerator;->_bufferSize:I

    invoke-static {v1, v8, v9, v2}, Lorg/spongycastle/cms/CMSUtils;->createBEROctetOutputStream(Ljava/io/OutputStream;IZI)Ljava/io/OutputStream;

    move-result-object v1

    invoke-interface {p3, v1}, Lorg/spongycastle/operator/OutputCompressor;->getOutputStream(Ljava/io/OutputStream;)Ljava/io/OutputStream;
