...
.method private generateDerivedKey(II)[B
    ...
    :cond_0
    iget-object v0, p0, Lorg/spongycastle/jce/provider/OldPKCS12ParametersGenerator;->salt:[B
    ...
    iget-object v2, p0, Lorg/spongycastle/jce/provider/OldPKCS12ParametersGenerator;->salt:[B

    array-length v2, v2

    iget v3, p0, Lorg/spongycastle/jce/provider/OldPKCS12ParametersGenerator;->v:I
    ...
    iget-object v3, p0, Lorg/spongycastle/jce/provider/OldPKCS12ParametersGenerator;->salt:[B

    iget-object v7, p0, Lorg/spongycastle/jce/provider/OldPKCS12ParametersGenerator;->salt:[B
    ...
    :goto_2
    iget-object v2, p0, Lorg/spongycastle/jce/provider/OldPKCS12ParametersGenerator;->password:[B
    ...
    iget v2, p0, Lorg/spongycastle/jce/provider/OldPKCS12ParametersGenerator;->v:I

    iget-object v3, p0, Lorg/spongycastle/jce/provider/OldPKCS12ParametersGenerator;->password:[B

    array-length v3, v3

    iget v7, p0, Lorg/spongycastle/jce/provider/OldPKCS12ParametersGenerator;->v:I
    ...
    iget-object v8, p0, Lorg/spongycastle/jce/provider/OldPKCS12ParametersGenerator;->password:[B
    ...
    iget v0, p0, Lorg/spongycastle/jce/provider/OldPKCS12ParametersGenerator;->u:I

    add-int/2addr v0, p2

    add-int/lit8 v0, v0, -0x1

    iget v2, p0, Lorg/spongycastle/jce/provider/OldPKCS12ParametersGenerator;->u:I
    ...
    iget-object v0, p0, Lorg/spongycastle/jce/provider/OldPKCS12ParametersGenerator;->digest:Lorg/spongycastle/crypto/Digest;
    ...
    :goto_6
    iget v10, p0, Lorg/spongycastle/jce/provider/OldPKCS12ParametersGenerator;->iterationCount:I

    if-eq v0, v10, :cond_3

    iget-object v10, p0, Lorg/spongycastle/jce/provider/OldPKCS12ParametersGenerator;->digest:Lorg/spongycastle/crypto/Digest;
    ...
    iget v11, p0, Lorg/spongycastle/jce/provider/OldPKCS12ParametersGenerator;->v:I

    div-int/2addr v10, v11

    if-eq v0, v10, :cond_5

    iget v10, p0, Lorg/spongycastle/jce/provider/OldPKCS12ParametersGenerator;->v:I

    mul-int/2addr v10, v0

    invoke-direct {p0, v3, v10, v7}, Lorg/spongycastle/jce/provider/OldPKCS12ParametersGenerator;->adjust([BI[B)V
    ...
    iget v10, p0, Lorg/spongycastle/jce/provider/OldPKCS12ParametersGenerator;->u:I
    ...
    iget v12, p0, Lorg/spongycastle/jce/provider/OldPKCS12ParametersGenerator;->u:I
...
.method public generateDerivedMacParameters(I)Lorg/spongycastle/crypto/CipherParameters;
    ...
    invoke-direct {p0, v2, v0}, Lorg/spongycastle/jce/provider/OldPKCS12ParametersGenerator;->generateDerivedKey(II)[B
...
.method public generateDerivedParameters(II)Lorg/spongycastle/crypto/CipherParameters;
    ...
    invoke-direct {p0, v3, v1}, Lorg/spongycastle/jce/provider/OldPKCS12ParametersGenerator;->generateDerivedKey(II)[B
