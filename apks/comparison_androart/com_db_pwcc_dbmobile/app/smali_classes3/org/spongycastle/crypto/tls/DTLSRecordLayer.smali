...
.method private raiseAlert(SSLjava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-direct {p0, v0, v1, v4, v5}, Lorg/spongycastle/crypto/tls/DTLSRecordLayer;->sendRecord(S[BII)V
...
.method private sendRecord(S[BII)V
    ...
    invoke-static {v0, v8, v9}, Lorg/spongycastle/crypto/tls/DTLSRecordLayer;->getMacSequenceNumber(IJ)J
    ...
    invoke-static {p1, v2, v3}, Lorg/spongycastle/crypto/tls/TlsUtils;->writeUint8(S[BI)V

    iget-object v3, p0, Lorg/spongycastle/crypto/tls/DTLSRecordLayer;->writeVersion:Lorg/spongycastle/crypto/tls/ProtocolVersion;

    const/4 v4, 0x1

    invoke-static {v3, v2, v4}, Lorg/spongycastle/crypto/tls/TlsUtils;->writeVersion(Lorg/spongycastle/crypto/tls/ProtocolVersion;[BI)V

    const/4 v3, 0x3

    invoke-static {v0, v2, v3}, Lorg/spongycastle/crypto/tls/TlsUtils;->writeUint16(I[BI)V

    const/4 v0, 0x5

    invoke-static {v8, v9, v2, v0}, Lorg/spongycastle/crypto/tls/TlsUtils;->writeUint48(J[BI)V
    ...
    invoke-interface {v0, v2, v1, v3}, Lorg/spongycastle/crypto/tls/DatagramTransport;->send([BII)V
...
.method public receive([BIII)I
    ...
    :cond_2
    :try_start_0
    iget-object v3, p0, Lorg/spongycastle/crypto/tls/DTLSRecordLayer;->retransmit:Lorg/spongycastle/crypto/tls/DTLSHandshakeRetransmit;
    ...
    iget-wide v8, p0, Lorg/spongycastle/crypto/tls/DTLSRecordLayer;->retransmitExpiry:J
    ...
    iput-object v3, p0, Lorg/spongycastle/crypto/tls/DTLSRecordLayer;->retransmit:Lorg/spongycastle/crypto/tls/DTLSHandshakeRetransmit;

    const/4 v3, 0x0

    iput-object v3, p0, Lorg/spongycastle/crypto/tls/DTLSRecordLayer;->retransmitEpoch:Lorg/spongycastle/crypto/tls/DTLSEpoch;
    ...
    invoke-direct {p0, v7, v3, v2, v0}, Lorg/spongycastle/crypto/tls/DTLSRecordLayer;->receiveRecord([BIII)I
    ...
    iget-object v4, p0, Lorg/spongycastle/crypto/tls/DTLSRecordLayer;->readEpoch:Lorg/spongycastle/crypto/tls/DTLSEpoch;
    ...
    iget-object v3, p0, Lorg/spongycastle/crypto/tls/DTLSRecordLayer;->readEpoch:Lorg/spongycastle/crypto/tls/DTLSEpoch;
    ...
    invoke-virtual {v10}, Lorg/spongycastle/crypto/tls/DTLSEpoch;->getReplayWindow()Lorg/spongycastle/crypto/tls/DTLSReplayWindow;

    move-result-object v3

    invoke-virtual {v3, v12, v13}, Lorg/spongycastle/crypto/tls/DTLSReplayWindow;->shouldDiscard(J)Z
    ...
    invoke-virtual {v14}, Lorg/spongycastle/crypto/tls/ProtocolVersion;->isDTLS()Z

    move-result v3

    if-eqz v3, :cond_0

    iget-object v3, p0, Lorg/spongycastle/crypto/tls/DTLSRecordLayer;->readVersion:Lorg/spongycastle/crypto/tls/ProtocolVersion;
    ...
    :cond_5
    invoke-virtual {v10}, Lorg/spongycastle/crypto/tls/DTLSEpoch;->getCipher()Lorg/spongycastle/crypto/tls/TlsCipher;

    move-result-object v3

    invoke-virtual {v10}, Lorg/spongycastle/crypto/tls/DTLSEpoch;->getEpoch()I

    move-result v4

    invoke-static {v4, v12, v13}, Lorg/spongycastle/crypto/tls/DTLSRecordLayer;->getMacSequenceNumber(IJ)J
    ...
    invoke-virtual {v2, v12, v13}, Lorg/spongycastle/crypto/tls/DTLSReplayWindow;->reportAuthenticated(J)V

    array-length v2, v3

    iget v4, p0, Lorg/spongycastle/crypto/tls/DTLSRecordLayer;->plaintextLimit:I

    if-gt v2, v4, :cond_0

    iget-object v2, p0, Lorg/spongycastle/crypto/tls/DTLSRecordLayer;->readVersion:Lorg/spongycastle/crypto/tls/ProtocolVersion;

    if-nez v2, :cond_6

    iput-object v14, p0, Lorg/spongycastle/crypto/tls/DTLSRecordLayer;->readVersion:Lorg/spongycastle/crypto/tls/ProtocolVersion;

    :cond_6
    packed-switch v6, :pswitch_data_1

    :cond_7
    iget-boolean v2, p0, Lorg/spongycastle/crypto/tls/DTLSRecordLayer;->inHandshake:Z

    if-nez v2, :cond_8

    iget-object v2, p0, Lorg/spongycastle/crypto/tls/DTLSRecordLayer;->retransmit:Lorg/spongycastle/crypto/tls/DTLSHandshakeRetransmit;
    ...
    iget-object v3, p0, Lorg/spongycastle/crypto/tls/DTLSRecordLayer;->retransmitEpoch:Lorg/spongycastle/crypto/tls/DTLSEpoch;
    ...
    :try_start_1
    iget-object v4, p0, Lorg/spongycastle/crypto/tls/DTLSRecordLayer;->peer:Lorg/spongycastle/crypto/tls/TlsPeer;
    ...
    invoke-virtual {p0, v3}, Lorg/spongycastle/crypto/tls/DTLSRecordLayer;->fail(S)V
    ...
    :cond_c
    iget-object v4, p0, Lorg/spongycastle/crypto/tls/DTLSRecordLayer;->pendingEpoch:Lorg/spongycastle/crypto/tls/DTLSEpoch;

    if-eqz v4, :cond_b

    iget-object v4, p0, Lorg/spongycastle/crypto/tls/DTLSRecordLayer;->pendingEpoch:Lorg/spongycastle/crypto/tls/DTLSEpoch;

    iput-object v4, p0, Lorg/spongycastle/crypto/tls/DTLSRecordLayer;->readEpoch:Lorg/spongycastle/crypto/tls/DTLSEpoch;
    ...
    invoke-interface {v2, v11, v3, v4, v5}, Lorg/spongycastle/crypto/tls/DTLSHandshakeRetransmit;->receivedHandshakeRecord(I[BII)V
    :try_end_2
...
.method public send([BII)V
    ...
    :cond_2
    iget-object v2, p0, Lorg/spongycastle/crypto/tls/DTLSRecordLayer;->writeEpoch:Lorg/spongycastle/crypto/tls/DTLSEpoch;
    ...
    invoke-direct {p0, v6, v2, v4, v3}, Lorg/spongycastle/crypto/tls/DTLSRecordLayer;->sendRecord(S[BII)V
