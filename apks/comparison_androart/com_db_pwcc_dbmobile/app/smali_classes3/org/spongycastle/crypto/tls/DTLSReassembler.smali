...
.method constructor <init>(SI)V
    ...
    iput-short v0, p0, Lorg/spongycastle/crypto/tls/DTLSReassembler;->msg_type:S
...
.method contributeFragment(SI[BIII)V
    ...
    invoke-virtual {v0}, Lorg/spongycastle/crypto/tls/DTLSReassembler$Range;->getStart()I
    ...
    iget-object v6, p0, Lorg/spongycastle/crypto/tls/DTLSReassembler;->body:[B

    sub-int v7, v4, v3

    invoke-static {p3, v5, v6, v3, v7}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
    ...
    :cond_4
    invoke-virtual {v0, v4}, Lorg/spongycastle/crypto/tls/DTLSReassembler$Range;->setStart(I)V
    ...
    iget-object v5, p0, Lorg/spongycastle/crypto/tls/DTLSReassembler;->missing:Ljava/util/Vector;

    new-instance v6, Lorg/spongycastle/crypto/tls/DTLSReassembler$Range;

    invoke-virtual {v0}, Lorg/spongycastle/crypto/tls/DTLSReassembler$Range;->getEnd()I

    move-result v7

    invoke-direct {v6, v4, v7}, Lorg/spongycastle/crypto/tls/DTLSReassembler$Range;-><init>(II)V
    ...
    :cond_6
    invoke-virtual {v0, v3}, Lorg/spongycastle/crypto/tls/DTLSReassembler$Range;->setEnd(I)V
