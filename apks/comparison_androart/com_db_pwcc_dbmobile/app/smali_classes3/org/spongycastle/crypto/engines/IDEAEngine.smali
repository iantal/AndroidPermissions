...
.method private ideaFunc([I[BI[BI)V
    ...
    invoke-direct {p0, p2, v3}, Lorg/spongycastle/crypto/engines/IDEAEngine;->bytesToWord([BI)I

    move-result v3

    add-int/lit8 v4, p3, 0x6

    invoke-direct {p0, p2, v4}, Lorg/spongycastle/crypto/engines/IDEAEngine;->bytesToWord([BI)I
    ...
    invoke-direct {p0, v0, v1}, Lorg/spongycastle/crypto/engines/IDEAEngine;->mul(II)I
    ...
    invoke-direct {p0, v4, v2}, Lorg/spongycastle/crypto/engines/IDEAEngine;->mul(II)I
    ...
    invoke-direct {p0, v7, v1}, Lorg/spongycastle/crypto/engines/IDEAEngine;->mul(II)I
    ...
    invoke-direct {p0, v8, v4}, Lorg/spongycastle/crypto/engines/IDEAEngine;->mul(II)I
    ...
    invoke-direct {p0, v1, p4, v3}, Lorg/spongycastle/crypto/engines/IDEAEngine;->wordToBytes(I[BI)V
    ...
    invoke-direct {p0, v1, p4, v2}, Lorg/spongycastle/crypto/engines/IDEAEngine;->wordToBytes(I[BI)V

    add-int/lit8 v0, v0, 0x1

    aget v0, p1, v0

    invoke-direct {p0, v4, v0}, Lorg/spongycastle/crypto/engines/IDEAEngine;->mul(II)I

    move-result v0

    add-int/lit8 v1, p5, 0x6

    invoke-direct {p0, v0, p4, v1}, Lorg/spongycastle/crypto/engines/IDEAEngine;->wordToBytes(I[BI)V
...
.method private invertKey([I)[I
    ...
    invoke-direct {p0, v0}, Lorg/spongycastle/crypto/engines/IDEAEngine;->mulInv(I)I
    ...
    invoke-virtual {p0, v0}, Lorg/spongycastle/crypto/engines/IDEAEngine;->addInv(I)I
