...
.method decodeAndVerify(SLjava/io/InputStream;I)[B
    ...
    invoke-static {p3, v0, v10}, Lorg/spongycastle/crypto/tls/RecordStream;->checkLength(IIS)V
    ...
    iput-wide v8, p0, Lorg/spongycastle/crypto/tls/RecordStream;->readSeqNo:J
...
.method readRecord()Z
    ...
    :cond_0
    invoke-static {v2, v1}, Lorg/spongycastle/crypto/tls/TlsUtils;->readUint8([BI)S

    move-result v3

    const/16 v4, 0xa

    invoke-static {v3, v4}, Lorg/spongycastle/crypto/tls/RecordStream;->checkType(SS)V

    iget-boolean v4, p0, Lorg/spongycastle/crypto/tls/RecordStream;->restrictReadVersion:Z

    if-nez v4, :cond_1

    invoke-static {v2, v0}, Lorg/spongycastle/crypto/tls/TlsUtils;->readVersionRaw([BI)I
    ...
    :cond_1
    invoke-static {v2, v0}, Lorg/spongycastle/crypto/tls/TlsUtils;->readVersion([BI)Lorg/spongycastle/crypto/tls/ProtocolVersion;

    move-result-object v4

    iget-object v5, p0, Lorg/spongycastle/crypto/tls/RecordStream;->readVersion:Lorg/spongycastle/crypto/tls/ProtocolVersion;
    ...
    iget-object v4, p0, Lorg/spongycastle/crypto/tls/RecordStream;->handler:Lorg/spongycastle/crypto/tls/TlsProtocol;

    array-length v5, v2

    invoke-virtual {v4, v3, v2, v1, v5}, Lorg/spongycastle/crypto/tls/TlsProtocol;->processRecord(S[BII)V
...
.method writeRecord(S[BII)V
    ...
    :cond_0
    invoke-static {p1, v8}, Lorg/spongycastle/crypto/tls/RecordStream;->checkType(SS)V

    iget v0, p0, Lorg/spongycastle/crypto/tls/RecordStream;->plaintextLimit:I

    invoke-static {p4, v0, v8}, Lorg/spongycastle/crypto/tls/RecordStream;->checkLength(IIS)V
    ...
    iput-wide v4, p0, Lorg/spongycastle/crypto/tls/RecordStream;->writeSeqNo:J
    ...
    invoke-static {v1, v2, v8}, Lorg/spongycastle/crypto/tls/RecordStream;->checkLength(IIS)V
    ...
    iget-object v2, p0, Lorg/spongycastle/crypto/tls/RecordStream;->writeVersion:Lorg/spongycastle/crypto/tls/ProtocolVersion;
    ...
    invoke-static {v0, v1, v8}, Lorg/spongycastle/crypto/tls/RecordStream;->checkLength(IIS)V
