...
.method public decryptBlock(Lorg/spongycastle/crypto/engines/CramerShoupCiphertext;)Ljava/math/BigInteger;
    ...
    :cond_2
    new-instance v0, Lorg/spongycastle/crypto/engines/CramerShoupCoreEngine$CramerShoupCiphertextException;

    const-string v1, "Sorry, that ciphertext is not correct"

    invoke-direct {v0, v1}, Lorg/spongycastle/crypto/engines/CramerShoupCoreEngine$CramerShoupCiphertextException;-><init>(Ljava/lang/String;)V
...
.method public encryptBlock(Ljava/math/BigInteger;)Lorg/spongycastle/crypto/engines/CramerShoupCiphertext;
    ...
    invoke-virtual {v3, v6, v2}, Ljava/math/BigInteger;->modPow(Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;
    ...
    invoke-virtual {v1}, Lorg/spongycastle/crypto/params/CramerShoupParameters;->getH()Lorg/spongycastle/crypto/Digest;
    ...
    iget-object v7, p0, Lorg/spongycastle/crypto/engines/CramerShoupCoreEngine;->label:Ljava/lang/String;
    ...
    invoke-interface {v1, v7, v9}, Lorg/spongycastle/crypto/Digest;->doFinal([BI)I

    new-instance v8, Ljava/math/BigInteger;

    const/4 v1, 0x1

    invoke-direct {v8, v1, v7}, Ljava/math/BigInteger;-><init>(I[B)V
    ...
    invoke-virtual {v7, v6, v2}, Ljava/math/BigInteger;->modPow(Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;
    ...
    invoke-virtual {v0, v6, v2}, Ljava/math/BigInteger;->modPow(Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;
    ...
    invoke-direct {v1, v3, v4, v5, v0}, Lorg/spongycastle/crypto/engines/CramerShoupCiphertext;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)V
...
.method public init(ZLorg/spongycastle/crypto/CipherParameters;)V
    ...
    iput-object v0, p0, Lorg/spongycastle/crypto/engines/CramerShoupCoreEngine;->random:Ljava/security/SecureRandom;
