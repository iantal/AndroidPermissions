...
.method public build(Ljava/lang/String;)Lorg/spongycastle/cert/dane/DANEEntryStore;
    ...
    invoke-interface {v1}, Lorg/spongycastle/cert/dane/DANEEntryFetcher;->getEntries()Ljava/util/List;

    move-result-object v1

    invoke-direct {v0, v1}, Lorg/spongycastle/cert/dane/DANEEntryStore;-><init>(Ljava/util/List;)V
