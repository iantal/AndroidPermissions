...
.method public build([C)Lorg/spongycastle/operator/MacCalculator;
    ...
    invoke-direct {v0, v1, v5}, Ljavax/crypto/spec/PBEParameterSpec;-><init>([BI)V

    new-instance v5, Lorg/spongycastle/jcajce/PKCS12Key;

    invoke-direct {v5, p1}, Lorg/spongycastle/jcajce/PKCS12Key;-><init>([C)V

    invoke-virtual {v4, v5, v0}, Ljavax/crypto/Mac;->init(Ljava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;)V

    new-instance v0, Lorg/spongycastle/pkcs/jcajce/JcePKCS12MacCalculatorBuilderProvider$1$1;

    move-object v1, p0

    invoke-direct/range {v0 .. v5}, Lorg/spongycastle/pkcs/jcajce/JcePKCS12MacCalculatorBuilderProvider$1$1;-><init>(Lorg/spongycastle/pkcs/jcajce/JcePKCS12MacCalculatorBuilderProvider$1;Lorg/spongycastle/asn1/ASN1ObjectIdentifier;Lorg/spongycastle/asn1/pkcs/PKCS12PBEParams;Ljavax/crypto/Mac;Ljavax/crypto/SecretKey;)V
    :try_end_0
    ...
    const-string v3, "unable to create MAC calculator: "
