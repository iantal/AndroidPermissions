...
.method public static generateCompactNaf(Ljava/math/BigInteger;)[I
    ...
    invoke-virtual {v3, p0}, Ljava/math/BigInteger;->xor(Ljava/math/BigInteger;)Ljava/math/BigInteger;
    ...
    invoke-virtual {v8, v4}, Ljava/math/BigInteger;->testBit(I)Z
    ...
    invoke-static {v0, v1}, Lorg/spongycastle/math/ec/WNafUtil;->trim([II)[I
...
.method public static generateCompactWindowNaf(ILjava/math/BigInteger;)[I
    ...
    invoke-static {v0, v3}, Lorg/spongycastle/math/ec/WNafUtil;->trim([II)[I
...
.method public static generateJSF(Ljava/math/BigInteger;Ljava/math/BigInteger;)[B
    ...
    invoke-virtual {v2, v9}, Ljava/math/BigInteger;->shiftRight(I)Ljava/math/BigInteger;
    ...
    invoke-static {v3, v8}, Lorg/spongycastle/math/ec/WNafUtil;->trim([BI)[B
...
.method public static generateWindowNaf(ILjava/math/BigInteger;)[B
    ...
    invoke-static {v0, v3}, Lorg/spongycastle/math/ec/WNafUtil;->trim([BI)[B
...
.method public static precompute(Lorg/spongycastle/math/ec/ECPoint;IZ)Lorg/spongycastle/math/ec/WNafPreCompInfo;
    ...
    invoke-virtual {v8, p0, v1}, Lorg/spongycastle/math/ec/ECCurve;->getPreCompInfo(Lorg/spongycastle/math/ec/ECPoint;Ljava/lang/String;)Lorg/spongycastle/math/ec/PreCompInfo;
    ...
    sget-object v1, Lorg/spongycastle/math/ec/WNafUtil;->EMPTY_POINTS:[Lorg/spongycastle/math/ec/ECPoint;
    ...
    invoke-static {v1, v10}, Lorg/spongycastle/math/ec/WNafUtil;->resizeTable([Lorg/spongycastle/math/ec/ECPoint;I)[Lorg/spongycastle/math/ec/ECPoint;
    ...
    invoke-virtual {v8, v1, v6, v2, v0}, Lorg/spongycastle/math/ec/ECCurve;->normalizeAll([Lorg/spongycastle/math/ec/ECPoint;IILorg/spongycastle/math/ec/ECFieldElement;)V
    ...
    :pswitch_0
    invoke-virtual {v4, v7}, Lorg/spongycastle/math/ec/ECPoint;->getZCoord(I)Lorg/spongycastle/math/ec/ECFieldElement;
    ...
    invoke-virtual {v2, v0}, Lorg/spongycastle/math/ec/ECPoint;->scaleX(Lorg/spongycastle/math/ec/ECFieldElement;)Lorg/spongycastle/math/ec/ECPoint;
    ...
    :cond_6
    invoke-virtual {v9, v1}, Lorg/spongycastle/math/ec/WNafPreCompInfo;->setPreCompNeg([Lorg/spongycastle/math/ec/ECPoint;)V
