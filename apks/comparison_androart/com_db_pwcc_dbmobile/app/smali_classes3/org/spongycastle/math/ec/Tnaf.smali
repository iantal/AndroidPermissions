...
.method public static getSi(IILjava/math/BigInteger;)[Ljava/math/BigInteger;
    ...
    invoke-static {v0, v2, v5}, Lorg/spongycastle/math/ec/Tnaf;->getLucas(BIZ)[Ljava/math/BigInteger;
...
.method public static getSi(Lorg/spongycastle/math/ec/ECCurve$AbstractF2m;)[Ljava/math/BigInteger;
    ...
    invoke-static {v2, v0, v5}, Lorg/spongycastle/math/ec/Tnaf;->getLucas(BIZ)[Ljava/math/BigInteger;
...
.method public static partModReduction(Ljava/math/BigInteger;IB[Ljava/math/BigInteger;BB)Lorg/spongycastle/math/ec/ZTauElement;
    ...
    iget-object v2, v0, Lorg/spongycastle/math/ec/ZTauElement;->u:Ljava/math/BigInteger;
    ...
    iget-object v4, v0, Lorg/spongycastle/math/ec/ZTauElement;->v:Ljava/math/BigInteger;
    ...
    invoke-direct {v1, v2, v0}, Lorg/spongycastle/math/ec/ZTauElement;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;)V
...
.method public static round(Lorg/spongycastle/math/ec/SimpleBigDecimal;Lorg/spongycastle/math/ec/SimpleBigDecimal;B)Lorg/spongycastle/math/ec/ZTauElement;
    ...
    invoke-virtual {v8, v2}, Lorg/spongycastle/math/ec/SimpleBigDecimal;->add(Lorg/spongycastle/math/ec/SimpleBigDecimal;)Lorg/spongycastle/math/ec/SimpleBigDecimal;
    ...
    invoke-virtual {v1, v8}, Lorg/spongycastle/math/ec/SimpleBigDecimal;->subtract(Lorg/spongycastle/math/ec/SimpleBigDecimal;)Lorg/spongycastle/math/ec/SimpleBigDecimal;

    move-result-object v2

    invoke-virtual {v1, v9}, Lorg/spongycastle/math/ec/SimpleBigDecimal;->add(Lorg/spongycastle/math/ec/SimpleBigDecimal;)Lorg/spongycastle/math/ec/SimpleBigDecimal;
    ...
    invoke-virtual {v2, v8}, Lorg/spongycastle/math/ec/SimpleBigDecimal;->compareTo(Ljava/math/BigInteger;)I
    ...
    invoke-direct {v0, v1, v2}, Lorg/spongycastle/math/ec/ZTauElement;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;)V

    return-object v0

    :cond_3
    invoke-virtual {v0, v2}, Lorg/spongycastle/math/ec/SimpleBigDecimal;->subtract(Lorg/spongycastle/math/ec/SimpleBigDecimal;)Lorg/spongycastle/math/ec/SimpleBigDecimal;
    ...
    :cond_4
    invoke-virtual {v1, v8}, Lorg/spongycastle/math/ec/SimpleBigDecimal;->add(Lorg/spongycastle/math/ec/SimpleBigDecimal;)Lorg/spongycastle/math/ec/SimpleBigDecimal;

    move-result-object v2

    invoke-virtual {v1, v9}, Lorg/spongycastle/math/ec/SimpleBigDecimal;->subtract(Lorg/spongycastle/math/ec/SimpleBigDecimal;)Lorg/spongycastle/math/ec/SimpleBigDecimal;
    ...
    invoke-virtual {v1, v4}, Lorg/spongycastle/math/ec/SimpleBigDecimal;->compareTo(Ljava/math/BigInteger;)I
...
.method public static tauAdicNaf(BLorg/spongycastle/math/ec/ZTauElement;)[B
    ...
    iget-object v0, p1, Lorg/spongycastle/math/ec/ZTauElement;->v:Ljava/math/BigInteger;
    ...
    invoke-virtual {v4, v2}, Ljava/math/BigInteger;->clearBit(I)Ljava/math/BigInteger;
