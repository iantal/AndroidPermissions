...
.method public static createSingleState(Lrx/functions/Func0;Lrx/functions/Action2;)Lrx/observables/SyncOnSubscribe;
    ...
    new-instance v1, Lrx/observables/SyncOnSubscribe$1;

    invoke-direct {v1, p1}, Lrx/observables/SyncOnSubscribe$1;-><init>(Lrx/functions/Action2;)V

    invoke-direct {v0, p0, v1}, Lrx/observables/SyncOnSubscribe$SyncOnSubscribeImpl;-><init>(Lrx/functions/Func0;Lrx/functions/Func2;)V
...
.method public static createSingleState(Lrx/functions/Func0;Lrx/functions/Action2;Lrx/functions/Action1;)Lrx/observables/SyncOnSubscribe;
    ...
    new-instance v1, Lrx/observables/SyncOnSubscribe$2;

    invoke-direct {v1, p1}, Lrx/observables/SyncOnSubscribe$2;-><init>(Lrx/functions/Action2;)V

    invoke-direct {v0, p0, v1, p2}, Lrx/observables/SyncOnSubscribe$SyncOnSubscribeImpl;-><init>(Lrx/functions/Func0;Lrx/functions/Func2;Lrx/functions/Action1;)V
...
.method public static createStateless(Lrx/functions/Action1;)Lrx/observables/SyncOnSubscribe;
    ...
    new-instance v1, Lrx/observables/SyncOnSubscribe$3;

    invoke-direct {v1, p0}, Lrx/observables/SyncOnSubscribe$3;-><init>(Lrx/functions/Action1;)V

    invoke-direct {v0, v1}, Lrx/observables/SyncOnSubscribe$SyncOnSubscribeImpl;-><init>(Lrx/functions/Func2;)V
...
.method public static createStateless(Lrx/functions/Action1;Lrx/functions/Action0;)Lrx/observables/SyncOnSubscribe;
    ...
    new-instance v1, Lrx/observables/SyncOnSubscribe$4;

    invoke-direct {v1, p0}, Lrx/observables/SyncOnSubscribe$4;-><init>(Lrx/functions/Action1;)V

    new-instance v2, Lrx/observables/SyncOnSubscribe$5;

    invoke-direct {v2, p1}, Lrx/observables/SyncOnSubscribe$5;-><init>(Lrx/functions/Action0;)V

    invoke-direct {v0, v1, v2}, Lrx/observables/SyncOnSubscribe$SyncOnSubscribeImpl;-><init>(Lrx/functions/Func2;Lrx/functions/Action1;)V
