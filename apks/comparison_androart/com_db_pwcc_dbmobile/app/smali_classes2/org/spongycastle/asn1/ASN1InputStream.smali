...
.method protected buildObject(III)Lorg/spongycastle/asn1/ASN1Primitive;
    ...
    invoke-virtual {v1, v0, p2}, Lorg/spongycastle/asn1/ASN1StreamParser;->readTaggedObject(ZI)Lorg/spongycastle/asn1/ASN1Primitive;
    ...
    invoke-static {p2, v2, v0}, Lorg/spongycastle/asn1/ASN1InputStream;->createPrimitiveDERObject(ILorg/spongycastle/asn1/DefiniteLengthInputStream;[[B)Lorg/spongycastle/asn1/ASN1Primitive;
...
.method public readObject()Lorg/spongycastle/asn1/ASN1Primitive;
    ...
    :cond_1
    invoke-static {p0, v2}, Lorg/spongycastle/asn1/ASN1InputStream;->readTagNumber(Ljava/io/InputStream;I)I
    ...
    new-instance v4, Lorg/spongycastle/asn1/IndefiniteLengthInputStream;

    iget v5, p0, Lorg/spongycastle/asn1/ASN1InputStream;->limit:I

    invoke-direct {v4, p0, v5}, Lorg/spongycastle/asn1/IndefiniteLengthInputStream;-><init>(Ljava/io/InputStream;I)V

    iget v5, p0, Lorg/spongycastle/asn1/ASN1InputStream;->limit:I

    invoke-direct {v0, v4, v5}, Lorg/spongycastle/asn1/ASN1StreamParser;-><init>(Ljava/io/InputStream;I)V

    and-int/lit8 v4, v2, 0x40

    if-eqz v4, :cond_4

    new-instance v1, Lorg/spongycastle/asn1/BERApplicationSpecificParser;

    invoke-direct {v1, v3, v0}, Lorg/spongycastle/asn1/BERApplicationSpecificParser;-><init>(ILorg/spongycastle/asn1/ASN1StreamParser;)V

    invoke-virtual {v1}, Lorg/spongycastle/asn1/BERApplicationSpecificParser;->getLoadedObject()Lorg/spongycastle/asn1/ASN1Primitive;
    ...
    new-instance v2, Lorg/spongycastle/asn1/BERTaggedObjectParser;

    invoke-direct {v2, v1, v3, v0}, Lorg/spongycastle/asn1/BERTaggedObjectParser;-><init>(ZILorg/spongycastle/asn1/ASN1StreamParser;)V

    invoke-virtual {v2}, Lorg/spongycastle/asn1/BERTaggedObjectParser;->getLoadedObject()Lorg/spongycastle/asn1/ASN1Primitive;
    ...
    :sswitch_0
    new-instance v1, Lorg/spongycastle/asn1/BEROctetStringParser;

    invoke-direct {v1, v0}, Lorg/spongycastle/asn1/BEROctetStringParser;-><init>(Lorg/spongycastle/asn1/ASN1StreamParser;)V

    invoke-virtual {v1}, Lorg/spongycastle/asn1/BEROctetStringParser;->getLoadedObject()Lorg/spongycastle/asn1/ASN1Primitive;
    ...
    :sswitch_1
    new-instance v1, Lorg/spongycastle/asn1/BERSequenceParser;

    invoke-direct {v1, v0}, Lorg/spongycastle/asn1/BERSequenceParser;-><init>(Lorg/spongycastle/asn1/ASN1StreamParser;)V

    invoke-virtual {v1}, Lorg/spongycastle/asn1/BERSequenceParser;->getLoadedObject()Lorg/spongycastle/asn1/ASN1Primitive;
    ...
    :sswitch_2
    new-instance v1, Lorg/spongycastle/asn1/BERSetParser;

    invoke-direct {v1, v0}, Lorg/spongycastle/asn1/BERSetParser;-><init>(Lorg/spongycastle/asn1/ASN1StreamParser;)V

    invoke-virtual {v1}, Lorg/spongycastle/asn1/BERSetParser;->getLoadedObject()Lorg/spongycastle/asn1/ASN1Primitive;
    ...
    :sswitch_3
    new-instance v1, Lorg/spongycastle/asn1/DERExternalParser;

    invoke-direct {v1, v0}, Lorg/spongycastle/asn1/DERExternalParser;-><init>(Lorg/spongycastle/asn1/ASN1StreamParser;)V

    invoke-virtual {v1}, Lorg/spongycastle/asn1/DERExternalParser;->getLoadedObject()Lorg/spongycastle/asn1/ASN1Primitive;
    ...
    :cond_6
    :try_start_0
    invoke-virtual {p0, v2, v3, v4}, Lorg/spongycastle/asn1/ASN1InputStream;->buildObject(III)Lorg/spongycastle/asn1/ASN1Primitive;
    :try_end_0
