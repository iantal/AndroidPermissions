...
.method public decompress(Ljava/io/InputStream;I)[B
    ...
    invoke-direct {v2, p1, v1}, Lorg/apache/commons/imaging/common/mylzw/MyBitInputStream;-><init>(Ljava/io/InputStream;Ljava/nio/ByteOrder;)V
    ...
    iget v4, p0, Lorg/apache/commons/imaging/common/mylzw/MyLzwDecompressor;->eoiCode:I

    if-eq v1, v4, :cond_2

    iget v4, p0, Lorg/apache/commons/imaging/common/mylzw/MyLzwDecompressor;->clearCode:I
    ...
    invoke-direct {p0, v3, v1}, Lorg/apache/commons/imaging/common/mylzw/MyLzwDecompressor;->writeToResult(Ljava/io/OutputStream;[B)V
    ...
    invoke-direct {p0, v3, v4}, Lorg/apache/commons/imaging/common/mylzw/MyLzwDecompressor;->writeToResult(Ljava/io/OutputStream;[B)V
    ...
    invoke-direct {p0, v4}, Lorg/apache/commons/imaging/common/mylzw/MyLzwDecompressor;->firstChar([B)B

    move-result v4

    invoke-direct {p0, v0, v4}, Lorg/apache/commons/imaging/common/mylzw/MyLzwDecompressor;->appendBytes([BB)[B

    move-result-object v0

    invoke-direct {p0, v0}, Lorg/apache/commons/imaging/common/mylzw/MyLzwDecompressor;->addStringToTable([B)V
    ...
    invoke-direct {p0, v0}, Lorg/apache/commons/imaging/common/mylzw/MyLzwDecompressor;->firstChar([B)B

    move-result v0

    invoke-direct {p0, v4, v0}, Lorg/apache/commons/imaging/common/mylzw/MyLzwDecompressor;->appendBytes([BB)[B

    move-result-object v0

    invoke-direct {p0, v3, v0}, Lorg/apache/commons/imaging/common/mylzw/MyLzwDecompressor;->writeToResult(Ljava/io/OutputStream;[B)V
