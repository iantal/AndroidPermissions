...
.method private followUpRequest(Lokhttp3/Response;)Lokhttp3/Request;
    ...
    invoke-static {v0, v1, v2}, Lcom/appdynamics/eumagent/runtime/opaque/OkHttp3$Request$Builder$build;->Exit(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
...
.method public intercept(Lokhttp3/Interceptor$Chain;)Lokhttp3/Response;
    ...
    invoke-direct {p0, v5}, Lokhttp3/internal/http/RetryAndFollowUpInterceptor;->createAddress(Lokhttp3/HttpUrl;)Lokhttp3/Address;

    move-result-object v5

    invoke-direct {v2, v3, v5}, Lokhttp3/internal/connection/StreamAllocation;-><init>(Lokhttp3/ConnectionPool;Lokhttp3/Address;)V
    ...
    invoke-static {v1, v4, v5, v2, v3}, Lcom/appdynamics/eumagent/runtime/opaque/OkHttp3$RealInterceptorChain$proceed;->Enter(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    :try_end_0
    ...
    :try_start_1
    invoke-virtual {v1, v4, v5, v2, v6}, Lokhttp3/internal/http/RealInterceptorChain;->proceed(Lokhttp3/Request;Lokhttp3/internal/connection/StreamAllocation;Lokhttp3/internal/http/HttpStream;Lokhttp3/Connection;)Lokhttp3/Response;
    ...
    invoke-static/range {v1 .. v7}, Lcom/appdynamics/eumagent/runtime/opaque/OkHttp3$RealInterceptorChain$proceed;->Exit(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
    :try_end_1
    ...
    :try_start_2
    invoke-static {v1, v3, v2}, Lcom/appdynamics/eumagent/runtime/opaque/OkHttp3$RealInterceptorChain$proceed;->ThrowMe(Ljava/lang/Object;Ljava/lang/Object;Ljava/io/IOException;)V
    ...
    invoke-direct {p0, v2, v3, v4}, Lokhttp3/internal/http/RetryAndFollowUpInterceptor;->recover(Ljava/io/IOException;ZLokhttp3/Request;)Z
    ...
    invoke-virtual {v2, v9}, Lokhttp3/internal/connection/StreamAllocation;->streamFailed(Ljava/io/IOException;)V
    ...
    :try_start_4
    invoke-direct {p0, v1, v2, v4}, Lokhttp3/internal/http/RetryAndFollowUpInterceptor;->recover(Ljava/io/IOException;ZLokhttp3/Request;)Z
    ...
    invoke-direct {p0, v1, v3}, Lokhttp3/internal/http/RetryAndFollowUpInterceptor;->sameConnection(Lokhttp3/Response;Lokhttp3/HttpUrl;)Z
    ...
    new-instance v3, Lokhttp3/internal/connection/StreamAllocation;
    ...
    invoke-direct {v3, v5, v6}, Lokhttp3/internal/connection/StreamAllocation;-><init>(Lokhttp3/ConnectionPool;Lokhttp3/Address;)V

    iput-object v3, p0, Lokhttp3/internal/http/RetryAndFollowUpInterceptor;->streamAllocation:Lokhttp3/internal/connection/StreamAllocation;
    ...
    invoke-virtual {v3}, Lokhttp3/internal/connection/StreamAllocation;->stream()Lokhttp3/internal/http/HttpStream;
