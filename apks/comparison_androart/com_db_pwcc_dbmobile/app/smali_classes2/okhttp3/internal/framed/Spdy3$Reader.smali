...
.method private readSettings(Lokhttp3/internal/framed/FrameReader$Handler;II)V
    ...
    iget-object v7, p0, Lokhttp3/internal/framed/Spdy3$Reader;->source:Lokio/BufferedSource;

    invoke-interface {v7}, Lokio/BufferedSource;->readInt()I

    move-result v7

    invoke-virtual {v4, v6, v5, v7}, Lokhttp3/internal/framed/Settings;->set(III)Lokhttp3/internal/framed/Settings;
...
.method public nextFrame(Lokhttp3/internal/framed/FrameReader$Handler;)Z
    ...
    invoke-interface {p1, v1, v2, v3, v4}, Lokhttp3/internal/framed/FrameReader$Handler;->data(ZILokio/BufferedSource;I)V
