...
public class AsyncSession
{
  ...
  {
    paramOperationType = new AsyncOperation(paramOperationType, this.daoSession.getDao(paramClass), null, paramObject, paramInt | this.sessionFlags);
  ...
  {
    paramOperationType = new AsyncOperation(paramOperationType, null, this.daoSession.getDatabase(), paramObject, paramInt | this.sessionFlags);
    this.executor.enqueue(paramOperationType);
    return paramOperationType;
  }
