  ...
  implements Runnable, Handler.Callback
{
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (i < localArrayList.size())
        {
          ...
          bool1 = localAsyncOperation.isFailed();
          if (!bool1) {
            break label136;
          }
          bool1 = bool2;
      ...
      finally
      {
        try
        {
          ...
          if (bool1)
          {
            ...
            for (;;)
            {
              if (paramAsyncOperation1.hasNext())
              {
        ...
        catch (RuntimeException paramAsyncOperation1)
        {
          try
          {
            for (;;)
            ...
            paramAsyncOperation1 = paramAsyncOperation1;
            DaoLog.i("Async transaction could not be ended, success so far was: " + bool1, paramAsyncOperation1);
            bool1 = false;
          }
          catch (RuntimeException paramAsyncOperation1)
          {
            for (;;)
            {
              DaoLog.i("Async transaction could not be ended, success so far was: " + false, paramAsyncOperation1);
            }
          }
  ...
  public boolean isCompleted()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 276	de/greenrobot/dao/async/AsyncOperationExecutor:countOperationsEnqueued	I
    //   6: istore_1
    //   7: aload_0
    //   8: getfield 274	de/greenrobot/dao/async/AsyncOperationExecutor:countOperationsCompleted	I
    //   11: istore_2
    //   12: iload_1
    //   13: iload_2
    //   14: if_icmpne +9 -> 23
  ...
  public boolean waitForCompletion(int paramInt)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: invokevirtual 423	de/greenrobot/dao/async/AsyncOperationExecutor:isCompleted	()Z
    //   6: istore_2
    //   7: iload_2
    //   8: ifne +11 -> 19
    //   11: iload_1
    ...
    //   14: aload_0
    //   15: lload_3
    //   16: invokevirtual 435	java/lang/Object:wait	(J)V
    //   19: aload_0
    //   20: invokevirtual 423	de/greenrobot/dao/async/AsyncOperationExecutor:isCompleted	()Z
    //   23: istore_2
    //   24: aload_0
    //   25: monitorexit
    //   26: iload_2
    ...
    //   34: ldc_w 428
    //   37: aload 5
    //   39: invokespecial 431	de/greenrobot/dao/DaoException:<init>	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   42: athrow
    //   43: astore 5
    //   45: aload_0
    //   46: monitorexit
