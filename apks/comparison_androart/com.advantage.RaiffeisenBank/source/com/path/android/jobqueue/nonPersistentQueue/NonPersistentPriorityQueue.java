  ...
  implements JobQueue
{
  ...
  public final Comparator<JobHolder> jobComparator = new Comparator()
  {
    public int compare(JobHolder paramAnonymousJobHolder1, JobHolder paramAnonymousJobHolder2)
    {
      ...
      i = -NonPersistentPriorityQueue.compareLong(paramAnonymousJobHolder1.getCreatedNs(), paramAnonymousJobHolder2.getCreatedNs());
      if (i != 0) {
        return i;
      }
  ...
  {
    paramCollection = this.jobs.peek(paramBoolean, paramCollection);
    if (paramCollection == null) {
      return null;
    }
    return Long.valueOf(paramCollection.getDelayUntilNs());
  }
  ...
  public long insert(JobHolder paramJobHolder)
  {
    try
    {
      this.nonPersistentJobIdGenerator += 1L;
  ...
  public JobHolder nextJobAndIncRunCount(boolean paramBoolean, Collection<String> paramCollection)
  {
    ...
    paramCollection = localJobHolder;
    ...
    localJobHolder.setRunCount(localJobHolder.getRunCount() + 1);
