  ...
  extends TextView
{
  ...
  public TextViewWithCircularIndicator(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.mCircleColor = paramAttributeSet.getColor(R.color.mdtp_accent_color);
    this.mRadius = paramAttributeSet.getDimensionPixelOffset(R.dimen.mdtp_month_select_circle_radius);
  ...
  private ColorStateList createTextColor(int paramInt)
  {
    ...
    return new ColorStateList(new int[][] { { 16842919 }, { 16842913 }, arrayOfInt }, new int[] { paramInt, -16777216, -16777216 });
  }
  ...
  public CharSequence getContentDescription()
  {
    ...
    if (this.mDrawCircle) {
      localObject = String.format(this.mItemIsSelectedText, new Object[] { localCharSequence });
    }
    return localObject;
  }
