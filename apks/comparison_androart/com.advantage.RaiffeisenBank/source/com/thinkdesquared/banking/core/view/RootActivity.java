  ...
  implements MenuFragment.OnDSQMenuItemSelectedListener, AIBASConstants, OkButtonWasClickedInDialogListener
{
  ...
  public void onConfigurationChanged(Configuration paramConfiguration)
  {
    ...
    paramConfiguration = findViewById(2131558613);
    if (paramConfiguration != null) {
      paramConfiguration.setBackgroundDrawable(getResources().getDrawable(DSQStylist.fetchThemedResourceId(this, 2130772072)));
    }
    ...
    for (;;)
    {
      ...
      if (paramBundle == null)
      {
        ...
        if (findViewById(2131558621) != null)
        {
          ...
          localFragmentTransaction.replace(2131558621, paramBundle);
  ...
  protected void onResume()
  {
    ...
    Object localObject = AibasStore.getInstance();
    if (((((AibasStore)localObject).isShowRegisterDevice()) || (((AibasStore)localObject).isShowSetupFingerprintForApp()) || (((AibasStore)localObject).isShowSetupFingerprinForDeviceSettings())) && (!AibasStore.LoggedInState.LoggedInState_OFF.equals(AibasStore.getInstance().getLoggedInState()))) {
      if ((((AibasStore)localObject).isShowSetupFingerprinForDeviceSettings()) && (!((AibasStore)localObject).isShowRegisterDevice())) {
    ...
    do
    {
      do
      {
        ...
        {
          return;
        } while ((((AibasStore)localObject).getRememberMeLogin() != null) && ((((AibasStore)localObject).getRememberMeLogin() == null) || (DeviceRegistrationHelper.checkIfOtherUserHasEnrolledFingerprint(((AibasStore)localObject).getRememberMeLogin().getEnrollmentId()))));
      ...
      localObject = getIntent().getStringExtra("INTENT_CODE_TO_LAUNCH");
    ...
    } while ((localObject != null) && (((String)localObject).equals(getString(2131166271))) && (i != 0));
