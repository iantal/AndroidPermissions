  ...
  extends RootInputActivity
{
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    if (paramBundle != null)
    {
      paramBundle = (ContactInformationFragment)getSupportFragmentManager().findFragmentByTag(getString(2131166249));
      return;
    }
    paramBundle = new ContactInformationFragment();
    getSupportFragmentManager().beginTransaction().add(2131558617, paramBundle, getString(2131166249)).commit();
  }
