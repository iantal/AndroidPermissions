  ...
  implements LoaderManager.LoaderCallbacks<ForgetDevicesVerifyResponse>
{
  ...
  private void initWithVerifyResponse()
  {
    ...
    Object localObject1 = this.passedData;
    ...
    extends AsyncTask<String, Void, ForgetDeviceResultResponse>
  {
    ...
    protected ForgetDeviceResultResponse doInBackground(String... paramVarArgs)
    {
      if (AibasStore.getInstance().getLoggedInState() == AibasStore.LoggedInState.LoggedInState_ON)
      {
        ...
        return new SOAPRequests().executeForgetDeviceResult(paramVarArgs, ManageDeviceForgetVerifyFragment.this.getAuthorizationElements());
      }
    ...
    protected void onPostExecute(ForgetDeviceResultResponse paramForgetDeviceResultResponse)
    {
      ...
      {
        str = ManageDeviceForgetVerifyFragment.this.getString(2131165598);
        ...
        ManageDeviceForgetVerifyFragment.this.mListener.onReceivedSuccessfullResultResponse(str, true, paramForgetDeviceResultResponse, 2131166271);
        return;
      }
      ...
      String str = paramForgetDeviceResultResponse.getErrors();
      ManageDeviceForgetVerifyFragment.this.mListener.onReceivedSuccessfullResultResponse(str, true, paramForgetDeviceResultResponse, 2131166271);
    }
