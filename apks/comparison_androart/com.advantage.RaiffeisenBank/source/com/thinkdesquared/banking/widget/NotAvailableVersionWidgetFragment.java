  ...
  extends Fragment
{
  ...
  public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle)
  {
    ...
    paramLayoutInflater = paramLayoutInflater.inflate(2130903301, paramViewGroup, false);
    ((Button)paramLayoutInflater.findViewById(2131559286)).setOnClickListener(new View.OnClickListener()
    {
