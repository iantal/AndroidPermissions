...
public class DomesticPaymentResultJob
  extends SessionBoundJob
{
  ...
  public DomesticPaymentResultJob(String paramString1, String paramString2, String paramString3, ArrayList<DSQAuthorizationInfo> paramArrayList, TouchIdAuthorizationData paramTouchIdAuthorizationData)
  {
    ...
    throws Throwable
  {
    ...
    for (GenericResultResponse localGenericResultResponse = new DemoRequests().paymentsDemoResultRequest(this.mTemplate);; localGenericResultResponse = new SOAPRequests().domesticPaymentResultRequest(this.mWorkflowId, this.mAuthorizationInfo, this.mTouchIdAuthorizationData))
    {
      assertNotCancelled();
