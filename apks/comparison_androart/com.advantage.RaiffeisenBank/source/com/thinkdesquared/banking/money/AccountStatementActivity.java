  ...
  implements AccountStatementFragment.OnAccountStatementFiltersButtonClickedListener
{
  ...
  {
    paramAccountStatementDownloadResponse = AccountStatementUtils.getExtras(paramAccountStatementDownloadResponse, this.mWorkflowId, this.mAccountStatementData, this.mFormat);
    Intent localIntent = new Intent(this, ViewAccountStatementActivity.class);
    localIntent.putExtras(paramAccountStatementDownloadResponse);
  ...
  public void onFilterButtonClicked(AccountStatementInputResponse paramAccountStatementInputResponse, AccountStatementData paramAccountStatementData)
  {
    if ((paramAccountStatementInputResponse != null) && (paramAccountStatementData != null))
    {
      ...
      paramAccountStatementInputResponse = new Intent(this, AccountStatementFilterActivity.class);
      paramAccountStatementInputResponse.putExtras(localBundle);
      startActivityForResult(paramAccountStatementInputResponse, 0);
    }
  }
  ...
  protected void onResumeFragments()
  {
    ...
    {
      Object localObject = this.mOnActivityResultIntent.getExtras();
      AccountStatementData localAccountStatementData = (AccountStatementData)((Bundle)localObject).getSerializable("accountStatementData");
      localObject = ((Bundle)localObject).getString("FORMAT");
      this.mFragment.openResultFragment(localAccountStatementData, (String)localObject);
  ...
  public void openResultFragment(AccountStatementDisplayResponse paramAccountStatementDisplayResponse)
  {
    ...
    for (paramAccountStatementDisplayResponse = AccountStatementDisplayResultsFragment.newInstance(paramAccountStatementDisplayResponse, this.mAccountStatementData, this.mWorkflowId);; paramAccountStatementDisplayResponse = AccountStatementDisplayRecordsFragment.newInstance(paramAccountStatementDisplayResponse, this.mAccountStatementData, this.mWorkflowId))
    {
      FragmentTransaction localFragmentTransaction = getSupportFragmentManager().beginTransaction();
      localFragmentTransaction.setTransition(4097);
      localFragmentTransaction.replace(2131558617, paramAccountStatementDisplayResponse).addToBackStack(null);
