  ...
  implements LoaderManager.LoaderCallbacks<CreateDirectDebitVerifyResponse>
{
  ...
  private void initWithVerifyResponse()
  {
    ...
    {
      localObject = localDirectDebitModel.getFromAccountNumber() + " - " + this.mVerifyResponse.getFromAccountCurrency().getCode();
    ...
    for (;;)
    {
      ...
      localObject = this.mVerifyResponse.getBillerFieldsDetails();
      int i = 0;
      while (i < ((ArrayList)localObject).size())
      {
        BillPaymentVariableField localBillPaymentVariableField = (BillPaymentVariableField)((ArrayList)localObject).get(i);
      ...
      localObject = localDirectDebitModel.getFromAccountNickname() + " (" + localDirectDebitModel.getFromAccountNumber() + ") - " + this.mVerifyResponse.getFromAccountCurrency().getCode();
      break;
      label363:
      localArrayList2.add("-");
    }
  ...
  public static CreateDirectDebitVerifyFragment newInstance(String paramString, DirectDebitModel paramDirectDebitModel)
  {
    ...
    paramString = new CreateDirectDebitVerifyFragment();
    ...
    extends AsyncTask<String, Void, GenericResultResponse>
  {
    ...
    protected GenericResultResponse doInBackground(String... paramVarArgs)
    {
      ...
      if (AibasStore.getInstance().getLoggedInState() == AibasStore.LoggedInState.LoggedInState_ON)
      {
        ...
        return new SOAPRequests().createDirectDebitResultRequest(paramVarArgs, CreateDirectDebitVerifyFragment.this.getAuthorizationElements());
      }
    ...
    protected void onPostExecute(GenericResultResponse paramGenericResultResponse)
    {
      ...
      {
        str = CreateDirectDebitVerifyFragment.this.getString(2131165413);
        CreateDirectDebitVerifyFragment.this.mListener.onReceivedSuccessfullResultResponse(str, true, paramGenericResultResponse, 2131166257);
        return;
      }
