  ...
  implements VerifyInternationalPaymentFragment.PaymentsCancelRedirectListener, LoaderManager.LoaderCallbacks<TransferToTimeAccountVerifyResponse>, CancelAuthenticationResponse, AuthenticationResponse
{
  ...
  private static TransferToTimeOtherAccountVerifyFragment newInstance(Bundle paramBundle, String paramString)
  {
    ...
    paramString = new TransferToTimeOtherAccountVerifyFragment();
    ...
    protected GenericResultResponse doInBackground(String... paramVarArgs)
    {
      if (TransferToTimeOtherAccountVerifyFragment.this.isActiveTransfersDeleteVerify())
      {
        if (AibasStore.getInstance().getLoggedInState() == AibasStore.LoggedInState.LoggedInState_ON)
        {
          ...
          return new SOAPRequests().activeTransfersDeleteTransferToTimeDepositResultRequest(paramVarArgs, TransferToTimeOtherAccountVerifyFragment.this.getAuthorizationElements(), this.mTouchIdAuthorizationData);
        }
      ...
      {
        paramVarArgs = paramVarArgs[0];
        return new SOAPRequests().transferToTimeAccountResultRequest(paramVarArgs, TransferToTimeOtherAccountVerifyFragment.this.getAuthorizationElements(), this.mTouchIdAuthorizationData);
      }
    ...
    protected void onPostExecute(GenericResultResponse paramGenericResultResponse)
    {
      ...
      while (paramGenericResultResponse.resultCode.equals("S")) {
        if (bool)
        {
          ...
          str = TransferToTimeOtherAccountVerifyFragment.this.getString(2131165476);
          TransferToTimeOtherAccountVerifyFragment.this.mListener.onReceivedSuccessfullResultResponse(str, true, paramGenericResultResponse, i);
          return;
          i = 2131166287;
        }
        else
        {
          str = TransferToTimeOtherAccountVerifyFragment.this.getString(2131166151);
          TransferToTimeOtherAccountVerifyFragment.this.mListener.onReceivedSuccessfullResultResponse(str, true, paramGenericResultResponse, i);
          return;
        }
      }
