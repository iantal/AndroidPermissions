  ...
  implements DatePickerDialog.OnDateSetListener
{
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    int i;
    int j;
    if (paramBundle.containsKey("selected_day"))
    {
      i = paramBundle.getInt("selected_day");
      j = paramBundle.getInt("selected_month");
    }
    for (int k = paramBundle.getInt("selected_year");; k = paramBundle.getInt("year"))
    {
      initialize(this, k, j, i);
      setHeaderBackground(DSQStylist.getDatePickerBkgDrawable());
      vibrate(false);
      return;
      i = paramBundle.getInt("day");
      j = paramBundle.getInt("month");
    }
  }
