  ...
  extends AutoFilteringSpinnerAdapter<BankAccount>
{
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if (paramView == null)
    {
      ...
      ((ViewHolder)localObject).titleView = ((TextView)paramView.findViewById(2131558817));
    ...
    Object localObject = this.mAccounts[(paramInt - 1)];
    paramViewGroup.titleView.setText(((BankAccount)localObject).getNicknameOrNumberString());
    return paramView;
  }
  ...
  protected void setAlphaToViewHolder(AutoFilteringSpinnerAdapter<BankAccount>.AutoFilteringSpinnerListViewHolder paramAutoFilteringSpinnerAdapter, float paramFloat)
  {
    ...
    DSQHelper.setAlpha(paramAutoFilteringSpinnerAdapter.titleView, paramFloat);
    DSQHelper.setAlpha(paramAutoFilteringSpinnerAdapter.subtitleView, paramFloat);
    DSQHelper.setAlpha(paramAutoFilteringSpinnerAdapter.rightTextView, paramFloat);
  }
