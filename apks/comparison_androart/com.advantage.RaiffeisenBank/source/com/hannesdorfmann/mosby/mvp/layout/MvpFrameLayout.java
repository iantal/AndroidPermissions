  ...
  implements BaseMvpDelegateCallback<V, P>, MvpView
{
  ...
  public MvpFrameLayout(Context paramContext)
  {
    super(paramContext);
  }
  
  public MvpFrameLayout(Context paramContext, AttributeSet paramAttributeSet)
  {
    super(paramContext, paramAttributeSet);
  }
  
  public MvpFrameLayout(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    super(paramContext, paramAttributeSet, paramInt);
  }
  
  @TargetApi(21)
  public MvpFrameLayout(Context paramContext, AttributeSet paramAttributeSet, int paramInt1, int paramInt2)
  {
