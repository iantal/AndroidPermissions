  ...
  implements ImageProcessor.ImageProcessorListener
{
  ...
  void processMedia(Constants.MediaAction paramMediaAction, Intent paramIntent)
  {
    ...
    do
    {
      ...
      {
        return;
        paramMediaAction = determineOriginalFile(paramIntent);
      } while (paramMediaAction == null);
      startBackgroundJob(new ImageProcessor(paramMediaAction, this.mMediaFactory, this));
      return;
      paramMediaAction = getOriginalFile();
    } while (paramMediaAction == null);
    startBackgroundJob(new ImageProcessor(paramMediaAction, this.mMediaFactory, this));
  }
