  ...
  implements Serializable
{
  ...
  public UrlValidator(String[] paramArrayOfString, RegexValidator paramRegexValidator, long paramLong)
  {
    ...
    for (;;)
    {
      ...
      this.allowedSchemes = new HashSet(arrayOfString.length);
      int i = 0;
      while (i < arrayOfString.length)
      {
        this.allowedSchemes.add(arrayOfString[i].toLowerCase(Locale.ENGLISH));
        i += 1;
      }
    }
  }
      ...
      do
      {
        do
        {
          do
          {
            ...
            paramString = DomainValidator.unicodeToASCII(paramString);
