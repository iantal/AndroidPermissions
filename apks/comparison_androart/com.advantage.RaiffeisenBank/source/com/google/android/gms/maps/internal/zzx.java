...
public abstract interface zzx
  extends IInterface
{
  public abstract void zzaf(zzd paramZzd)
    ...
    implements zzx
  {
    ...
    public static zzx zzim(IBinder paramIBinder)
    {
      ...
      throws RemoteException
    {
      ...
      zzaf(zzd.zza.zzfe(paramParcel1.readStrongBinder()));
      ...
      implements zzx
    {
        ...
        throws RemoteException
      {
        ...
        //   30: aload_0
        //   31: getfield 18	com/google/android/gms/maps/internal/zzx$zza$zza:zzajf	Landroid/os/IBinder;
        //   34: iconst_1
        //   35: aload_2
        //   36: aload_3
        //   37: iconst_0
