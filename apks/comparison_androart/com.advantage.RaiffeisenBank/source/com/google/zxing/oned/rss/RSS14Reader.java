  ...
  extends AbstractRSSReader
{
  ...
  static
  {
    ...
    int[] arrayOfInt6 = { 2, 5, 6, 1 };
    int[] arrayOfInt7 = { 2, 3, 8, 1 };
    int[] arrayOfInt8 = { 1, 3, 9, 1 };
    FINDER_PATTERNS = new int[][] { arrayOfInt1, arrayOfInt2, arrayOfInt3, arrayOfInt4, arrayOfInt5, arrayOfInt6, arrayOfInt7, { 1, 5, 7, 1 }, arrayOfInt8 };
  }
