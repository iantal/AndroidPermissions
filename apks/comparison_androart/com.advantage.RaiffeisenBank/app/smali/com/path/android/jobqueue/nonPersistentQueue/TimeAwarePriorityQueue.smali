.class public Lcom/path/android/jobqueue/nonPersistentQueue/TimeAwarePriorityQueue;
...
.method public countReadyJobs(JLjava/util/Collection;)Lcom/path/android/jobqueue/nonPersistentQueue/CountWithGroupIdsResult;
    ...
    invoke-super {p0, v0, p3}, Lcom/path/android/jobqueue/nonPersistentQueue/MergedQueue;->countReadyJobs(Lcom/path/android/jobqueue/nonPersistentQueue/MergedQueue$SetId;Ljava/util/Collection;)Lcom/path/android/jobqueue/nonPersistentQueue/CountWithGroupIdsResult;
    ...
    invoke-super {p0, v1, p1, p2, p3}, Lcom/path/android/jobqueue/nonPersistentQueue/MergedQueue;->countReadyJobs(Lcom/path/android/jobqueue/nonPersistentQueue/MergedQueue$SetId;JLjava/util/Collection;)Lcom/path/android/jobqueue/nonPersistentQueue/CountWithGroupIdsResult;

    move-result-object v1

    invoke-virtual {v0, v1}, Lcom/path/android/jobqueue/nonPersistentQueue/CountWithGroupIdsResult;->mergeWith(Lcom/path/android/jobqueue/nonPersistentQueue/CountWithGroupIdsResult;)Lcom/path/android/jobqueue/nonPersistentQueue/CountWithGroupIdsResult;
...
.method public countReadyJobs(Ljava/util/Collection;)Lcom/path/android/jobqueue/nonPersistentQueue/CountWithGroupIdsResult;
    ...
    const-string v1, "cannot call time aware priority queue\'s count ready jobs w/o providing a time"
...
.method protected createQueue(Lcom/path/android/jobqueue/nonPersistentQueue/MergedQueue$SetId;ILjava/util/Comparator;)Lcom/path/android/jobqueue/nonPersistentQueue/JobSet;
    ...
    .line 40
    new-instance v0, Lcom/path/android/jobqueue/nonPersistentQueue/NonPersistentJobSet;

    invoke-direct {v0, p3}, Lcom/path/android/jobqueue/nonPersistentQueue/NonPersistentJobSet;-><init>(Ljava/util/Comparator;)V
    ...
    new-instance v1, Lcom/path/android/jobqueue/nonPersistentQueue/ConsistentTimedComparator;

    invoke-direct {v1, p3}, Lcom/path/android/jobqueue/nonPersistentQueue/ConsistentTimedComparator;-><init>(Ljava/util/Comparator;)V

    invoke-direct {v0, v1}, Lcom/path/android/jobqueue/nonPersistentQueue/NonPersistentJobSet;-><init>(Ljava/util/Comparator;)V
