...
.method public testDeleteAll()V
    ...
    invoke-virtual {v5}, Lde/greenrobot/dao/AbstractDao;->count()J
...
.method public testDeleteInTx()V
    ...
    invoke-static {v8, v9, v10, v11}, Lde/greenrobot/dao/test/AbstractDaoTestSinglePk;->assertEquals(JJ)V
...
.method public testInsertOrReplaceTwice()V
    ...
    invoke-virtual {v1}, Lde/greenrobot/dao/AbstractDao;->getPkProperty()Lde/greenrobot/dao/Property;

    move-result-object v1

    iget-object v1, v1, Lde/greenrobot/dao/Property;->type:Ljava/lang/Class;
