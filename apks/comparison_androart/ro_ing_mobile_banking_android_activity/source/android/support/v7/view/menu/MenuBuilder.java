  ...
  implements SupportMenu
{
  ...
  public boolean performItemAction(MenuItem paramMenuItem, MenuPresenter paramMenuPresenter, int paramInt)
  {
    ...
    {
      boolean bool3 = ((MenuItemImpl)localObject).expandActionView() | bool2;
      bool2 = bool3;
      bool1 = bool2;
      if (bool3)
      {
    ...
    else
    {
      if ((((MenuItemImpl)localObject).hasSubMenu()) || (i != 0))
      {
        ...
        bool1 = dispatchSubMenuSelected((SubMenuBuilder)localObject, paramMenuPresenter) | bool2;
        if (!bool1) {
          close(true);
        }
        return bool1;
  ...
  public void removeGroup(int paramInt)
  {
    ...
    if (k >= 0)
    {
      ...
      {
        j = i + 1;
        if ((i >= m - k) || (((MenuItemImpl)this.mItems.get(k)).getGroupId() != paramInt)) {
          break;
        }
