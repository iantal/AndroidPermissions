...
public final class TextViewCompat
{
  ...
  static class TextViewCompatBaseImpl
  {
    ...
    private static Field retrieveField(String paramString)
    {
      ...
      try
      {
        Field localField2 = TextView.class.getDeclaredField(paramString);
      ...
      Log.e("TextViewCompatBase", new StringBuilder("Could not retrieve ").append(paramString).append(" field.").toString());
      return localObject;
    }
    ...
    private static int retrieveIntFromField(Field paramField, TextView paramTextView)
    {
      ...
      Log.d("TextViewCompatBase", new StringBuilder("Could not retrieve value of ").append(paramField.getName()).append(" field.").toString());
      return -1;
    }
