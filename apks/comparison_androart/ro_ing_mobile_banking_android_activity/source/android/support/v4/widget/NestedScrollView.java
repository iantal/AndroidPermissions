  ...
  implements NestedScrollingParent, NestedScrollingChild2, ScrollingView
{
  ...
  public boolean onInterceptTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    case 2: 
      ...
      if (i != -1)
      {
        ...
        if (j == -1)
        {
          Log.e("NestedScrollView", new StringBuilder("Invalid pointerId=").append(i).append(" in onInterceptTouchEvent").toString());
        }
        else
        {
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    case 2: 
      ...
      if (k == -1)
      {
        Log.e("NestedScrollView", new StringBuilder("Invalid pointerId=").append(this.mActivePointerId).append(" in onTouchEvent").toString());
      }
      else
      {
    ...
    extends View.BaseSavedState
  {
    ...
    {
      return new StringBuilder("HorizontalScrollView.SavedState{").append(Integer.toHexString(System.identityHashCode(this))).append(" scrollPosition=").append(this.scrollPosition).append("}").toString();
    }
