...
public final class ShareCompat
{
  ...
  public static void configureMenuItem(Menu paramMenu, int paramInt, IntentBuilder paramIntentBuilder)
  {
    ...
    if (paramMenu == null) {
      throw new IllegalArgumentException(new StringBuilder("Could not find menu item with id ").append(paramInt).append(" in the supplied menu").toString());
    }
  ...
  public static void configureMenuItem(MenuItem paramMenuItem, IntentBuilder paramIntentBuilder)
  {
    ...
    ((ShareActionProvider)localObject).setShareHistoryFileName(new StringBuilder(".sharecompat_").append(paramIntentBuilder.getActivity().getClass().getName()).toString());
  ...
  public static class IntentReader
  {
    ...
    private static void withinStyle(StringBuilder paramStringBuilder, CharSequence paramCharSequence, int paramInt1, int paramInt2)
    {
      while (paramInt1 < paramInt2)
      {
        ...
        {
          paramStringBuilder.append(new StringBuilder("&#").append(c).append(";").toString());
        }
        else if (c == ' ')
        {
    ...
    public Uri getStream(int paramInt)
    {
      ...
      throw new IndexOutOfBoundsException(new StringBuilder("Stream items available: ").append(getStreamCount()).append(" index requested: ").append(paramInt).toString());
    }
