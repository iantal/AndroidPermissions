...
public class AccessibilityNodeInfoCompat
{
  ...
  {
    Object localObject = IMPL.findAccessibilityNodeInfosByViewId(this.mInfo, paramString);
    if (localObject != null)
    {
  ...
  public String toString()
  {
    ...
    localStringBuilder.append("; boundsInParent: ".concat(String.valueOf(localRect)));
    getBoundsInScreen(localRect);
    localStringBuilder.append("; boundsInScreen: ".concat(String.valueOf(localRect)));
    ...
    localStringBuilder.append(new StringBuilder("; scrollable: ").append(isScrollable()).toString());
