  ...
  extends DocumentFile
{
  ...
  private static boolean deleteContents(File paramFile)
  {
    ...
    if (paramFile != null)
    {
      ...
      for (;;)
      {
        ...
        if (!localFile.delete())
        {
          Log.w("DocumentFile", "Failed to delete ".concat(String.valueOf(localFile)));
          bool1 = false;
        }
        i += 1;
      }
  ...
  public DocumentFile createFile(String paramString1, String paramString2)
  {
    ...
    if (str != null) {
      paramString1 = new StringBuilder().append(paramString2).append(".").append(str).toString();
    }
    ...
    {
      Log.w("DocumentFile", "Failed to createFile: ".concat(String.valueOf(paramString1)));
    }
    return null;
  }
