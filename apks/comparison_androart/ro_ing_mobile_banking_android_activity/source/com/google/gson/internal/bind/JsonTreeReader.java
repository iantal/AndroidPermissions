  ...
  extends JsonReader
{
  ...
  private void expect(JsonToken paramJsonToken)
  {
    if (peek() != paramJsonToken) {
      throw new IllegalStateException(new StringBuilder("Expected ").append(paramJsonToken).append(" but was ").append(peek()).toString());
    }
  }
  ...
  public final double nextDouble()
  {
    ...
    if ((localJsonToken != JsonToken.NUMBER) && (localJsonToken != JsonToken.STRING)) {
      throw new IllegalStateException(new StringBuilder("Expected ").append(JsonToken.NUMBER).append(" but was ").append(localJsonToken).toString());
    }
  ...
  public final String nextString()
  {
    ...
    if ((localJsonToken != JsonToken.STRING) && (localJsonToken != JsonToken.NUMBER)) {
      throw new IllegalStateException(new StringBuilder("Expected ").append(JsonToken.STRING).append(" but was ").append(localJsonToken).toString());
    }
