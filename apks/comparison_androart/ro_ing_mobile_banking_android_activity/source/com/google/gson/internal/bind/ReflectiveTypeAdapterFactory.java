    ...
    while (paramClass != Object.class)
    {
      ...
      while (i < j)
      {
        ...
        if ((bool1) || (bool2))
        {
          ...
          if (localObject != null) {
            throw new IllegalArgumentException(new StringBuilder().append(localType1).append(" declares multiple JSON fields named ").append(((BoundField)localObject).name).toString());
          }
        }
        i += 1;
      }
