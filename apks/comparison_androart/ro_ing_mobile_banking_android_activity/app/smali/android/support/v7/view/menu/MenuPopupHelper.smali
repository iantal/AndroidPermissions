...
.method private createPopup()Landroid/support/v7/view/menu/MenuPopup;
    ...
    invoke-virtual {v7, v0}, Landroid/support/v7/view/menu/MenuPopup;->addMenu(Landroid/support/v7/view/menu/MenuBuilder;)V
    ...
    invoke-virtual {v7, v0}, Landroid/support/v7/view/menu/MenuPopup;->setOnDismissListener(Landroid/widget/PopupWindow$OnDismissListener;)V

    .line 252
    iget-object v0, p0, Landroid/support/v7/view/menu/MenuPopupHelper;->mAnchorView:Landroid/view/View;

    invoke-virtual {v7, v0}, Landroid/support/v7/view/menu/MenuPopup;->setAnchorView(Landroid/view/View;)V
    ...
    invoke-virtual {v7, v0}, Landroid/support/v7/view/menu/MenuPopup;->setCallback(Landroid/support/v7/view/menu/MenuPresenter$Callback;)V

    .line 254
    iget-boolean v0, p0, Landroid/support/v7/view/menu/MenuPopupHelper;->mForceShowIcon:Z

    invoke-virtual {v7, v0}, Landroid/support/v7/view/menu/MenuPopup;->setForceShowIcon(Z)V

    .line 255
    iget v0, p0, Landroid/support/v7/view/menu/MenuPopupHelper;->mDropDownGravity:I

    invoke-virtual {v7, v0}, Landroid/support/v7/view/menu/MenuPopup;->setGravity(I)V
...
.method private showPopup(IIZZ)V
    ...
    .line 262
    invoke-virtual {v5, p4}, Landroid/support/v7/view/menu/MenuPopup;->setShowTitle(Z)V
    ...
    .line 274
    :cond_0
    invoke-virtual {v5, p1}, Landroid/support/v7/view/menu/MenuPopup;->setHorizontalOffset(I)V

    .line 275
    invoke-virtual {v5, p2}, Landroid/support/v7/view/menu/MenuPopup;->setVerticalOffset(I)V
    ...
    .line 285
    invoke-virtual {v5, p1}, Landroid/support/v7/view/menu/MenuPopup;->setEpicenterBounds(Landroid/graphics/Rect;)V

    .line 288
    :cond_1
    invoke-virtual {v5}, Landroid/support/v7/view/menu/MenuPopup;->show()V
