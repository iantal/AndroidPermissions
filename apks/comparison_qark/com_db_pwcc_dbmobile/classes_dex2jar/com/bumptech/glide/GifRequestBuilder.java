  ...
  implements BitmapOptions, DrawableOptions
{
  ...
  private GifDrawableTransformation[] toGifTransformations(Transformation<Bitmap>[] paramArrayOfTransformation)
  {
    ...
    for (int i = 0; i < paramArrayOfTransformation.length; i++) {
  ...
  {
    BitmapTransformation[] arrayOfBitmapTransformation = new BitmapTransformation[1];
    arrayOfBitmapTransformation[0] = this.glide.getBitmapCenterCrop();
    return transformFrame(arrayOfBitmapTransformation);
  }
  ...
  {
    BitmapTransformation[] arrayOfBitmapTransformation = new BitmapTransformation[1];
    arrayOfBitmapTransformation[0] = this.glide.getBitmapFitCenter();
    return transformFrame(arrayOfBitmapTransformation);
  }
