  ...
  implements Runnable
{
  ...
  private void addToBitmapPool(PreFillType paramPreFillType, Bitmap paramBitmap)
  {
    ...
    {
      Bitmap localBitmap = this.bitmapPool.get(paramPreFillType.getWidth(), paramPreFillType.getHeight(), paramPreFillType.getConfig());
      if (localBitmap != null) {
  ...
  private long getNextDelay()
  {
    ...
    this.currentDelay = Math.min(4L * this.currentDelay, MAX_BACKOFF_MS);
    return l;
  }
