  ...
  implements popopp, Parcelable
{
  ...
  static
  {
    String str1 = NA_AMOUNT;
    String str2 = uxxxxx.bbbb0062b0062b0062b0062("Thgfe\035\034\"!\031\030\036\035\\\024\023\031\030\020\017\025\024S", 'ú', '\022', '\000');
    ...
    try
    {
      ...
      switch (i * (i + b00710071qqq0071qq()) % bqq0071qq0071qq)
      {
      default: 
        bq0071qqq0071qq = 81;
        bqq0071qq0071qq = 26;
      ...
      CREATOR = new Parcelable.Creator()
      {
        ...
        public FinancialOverviewData[] b0075u0075uu007500750075uu(int paramAnonymousInt)
        {
          ...
          {
            int i = bg0067g0067gggg0067;
            switch (i * (i + bggg0067gggg0067) % b00750075uuu007500750075uu())
            {
            default: 
  ...
  public FinancialOverviewData(Parcel paramParcel)
  {
    ...
    {
      bool2 = bool1;
      this.hasMortgagesAccounts = bool2;
  ...
  private List<ParcelableAccountList> createSortedAccountBlocks(int paramInt)
  {
    ...
    ParcelableAccountList localParcelableAccountList1 = new ParcelableAccountList();
    Iterator localIterator = getSortedAccounts().iterator();
    Object localObject = localParcelableAccountList1;
    int i = 0;
    for (;;)
    {
      int j;
      ParcelableAccountList localParcelableAccountList2;
      int n;
      if (localIterator.hasNext())
      {
        ...
        if (i == 0) {
          this.sortedAccountBlocks.add(localObject);
        }
        ((ParcelableAccountList)localObject).add(localAccount);
        j = i + 1;
        int k = paramInt - 1;
        int m = bq0071qqq0071qq;
        switch (m * (m + bq00710071qq0071qq) % bqq0071qq0071qq)
        {
        default: 
          bq0071qqq0071qq = b007100710071qq0071qq();
        ...
        if (j > k)
        {
          localParcelableAccountList2 = new ParcelableAccountList();
          n = b007100710071qq0071qq();
        }
      }
      else
      {
        switch (n * (n + bq00710071qq0071qq) % bqq0071qq0071qq)
        {
        default: 
          bq0071qqq0071qq = 85;
          b0071q0071qq0071qq = b007100710071qq0071qq();
          localObject = localParcelableAccountList2;
          i = 0;
          continue;
  ...
  private Account getAccountById(String paramString, List<Account> paramList)
  {
    if ((paramString != null) && (paramList != null))
    {
      ...
      int i = bq0071qqq0071qq;
      switch (i * (i + bq00710071qq0071qq) % bqq0071qq0071qq)
      {
      default: 
        bq0071qqq0071qq = 87;
        b0071q0071qq0071qq = b007100710071qq0071qq();
  ...
  private Account getParcelableAccountById(String paramString)
  {
    ...
    for (;;)
    {
      ...
      default: 
        ...
        switch (j * (j + bq00710071qq0071qq) % bqq0071qq0071qq)
        {
        default: 
          bq0071qqq0071qq = 86;
          b0071q0071qq0071qq = b007100710071qq0071qq();
  ...
  {
    Account localAccount = getAccountById(paramString, this.accounts);
    if ((bq0071qqq0071qq + bq00710071qq0071qq) * bq0071qqq0071qq % bqq0071qq0071qq != b0071q0071qq0071qq)
    {
      bq0071qqq0071qq = 95;
  ...
  public String getBookedBalanceInBaseCurrencyLocalized(Locale paramLocale)
  {
    ...
    {
      String str2 = uxxxxx.bbbb0062b0062b0062b0062("x\017\020\021\022KLTUOPXY\033TU]^XYab$", 'w', 'à', '\002');
      Class[] arrayOfClass = new Class[3];
      arrayOfClass[0] = String.class;
      arrayOfClass[1] = Character.TYPE;
      arrayOfClass[2] = Character.TYPE;
    ...
    for (;;)
    {
      ...
      String str1 = hhhpph.bw0077wwwwww0077w(this.bookedBalanceInBaseCurrency, this.baseCurrency, paramLocale);
      if ((bq0071qqq0071qq + bq00710071qq0071qq) * bq0071qqq0071qq % bqq0071qq0071qq != b0071q0071qq0071qq)
      {
        bq0071qqq0071qq = 41;
  ...
  public long getLastTransactionTimestamp()
  {
    ...
    int i = (bq0071qqq0071qq + bq00710071qq0071qq) * bq0071qqq0071qq % bqq0071qq0071qq;
    int j = bqqq0071q0071qq();
    if ((bq0071qqq0071qq + bq00710071qq0071qq) * bq0071qqq0071qq % bqq0071qq0071qq != b0071q0071qq0071qq)
    {
      bq0071qqq0071qq = 68;
      b0071q0071qq0071qq = b007100710071qq0071qq();
  ...
  public BigDecimal getOnlineBalanceInBaseCurrency()
  {
    ...
    int i = (bq0071qqq0071qq + b00710071qqq0071qq()) * bq0071qqq0071qq;
    if ((bq0071qqq0071qq + bq00710071qq0071qq) * bq0071qqq0071qq % bqq0071qq0071qq != b0071q0071qq0071qq)
    {
      bq0071qqq0071qq = b007100710071qq0071qq();
      b0071q0071qq0071qq = b007100710071qq0071qq();
    }
    if (i % bqq0071qq0071qq != b0071q0071qq0071qq)
    {
      bq0071qqq0071qq = b007100710071qq0071qq();
      b0071q0071qq0071qq = b007100710071qq0071qq();
    }
  ...
  public String getOnlineBalanceInBaseCurrencyLocalized(Locale paramLocale)
  {
    ...
    int j = bq0071qqq0071qq;
    switch (j * (j + b00710071qqq0071qq()) % bqq0071qq0071qq)
    {
    default: 
      bq0071qqq0071qq = b007100710071qq0071qq();
      b0071q0071qq0071qq = b007100710071qq0071qq();
  ...
  public List<ParcelableAccountList> getSortedAccountBlocks(int paramInt)
  {
    ...
    if ((this.sortedAccountBlocks == null) || (paramInt != this.numberOfItemsPerPage)) {
      localList = createSortedAccountBlocks(paramInt);
    }
    do
    {
      return localList;
  ...
  public List<Account> getStandingOrderCapableAccounts()
  {
    ...
    for (;;)
    {
      ...
      switch (k * (k + bq00710071qq0071qq) % bqq0071qq0071qq)
      {
      }
      bq0071qqq0071qq = b007100710071qq0071qq();
  ...
  public boolean hasPrebookedBalanceInAccounts()
  {
    ...
    int j = bq0071qqq0071qq;
    int k = j * (j + bq00710071qq0071qq) % bqq0071qq0071qq;
    boolean bool = false;
    switch (k)
    {
    }
  ...
  public boolean isForSameInstitute(FinancialOverviewData paramFinancialOverviewData)
  {
    ...
    {
      return bool;
      i = (bq0071qqq0071qq + bq00710071qq0071qq) * bq0071qqq0071qq % bqq0071qq0071qq;
      j = b0071q0071qq0071qq;
      bool = false;
    } while (i == j);
    int k = bq0071qqq0071qq;
    switch (k * (k + bq00710071qq0071qq) % bqq0071qq0071qq)
  ...
  public boolean removeAccountAndUpdateBalance(Account.ProductType paramProductType)
  {
      ...
      while (localIterator.hasNext())
      {
        ...
        if (paramProductType == localAccount.getProductType())
        {
          ...
          if (localAccount.getBookedBalanceInBaseCurrency() != null) {
            localObject3 = ((BigDecimal)localObject3).add(localAccount.getBookedBalanceInBaseCurrency());
          }
          if (localAccount.getOnlineBalanceInBaseCurrency() != null) {
            localObject4 = ((BigDecimal)localObject4).add(localAccount.getOnlineBalanceInBaseCurrency());
          }
          localIterator.remove();
          int j = bq0071qqq0071qq;
          switch (j * (j + bq00710071qq0071qq) % b0071qq0071q0071qq())
          {
          }
          bq0071qqq0071qq = 4;
          b0071q0071qq0071qq = b007100710071qq0071qq();
    ...
    if (this.bookedBalanceInBaseCurrency != null) {
      this.bookedBalanceInBaseCurrency = this.bookedBalanceInBaseCurrency.subtract((BigDecimal)localObject1);
    }
    if (this.onlineBalanceInBaseCurrency != null) {
      this.onlineBalanceInBaseCurrency = this.onlineBalanceInBaseCurrency.subtract((BigDecimal)localObject2);
    }
    return bool1;
  }
