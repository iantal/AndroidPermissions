  ...
  implements vvkvvv
{
  ...
  {
    TypedArray localTypedArray = paramContext.getTheme().obtainStyledAttributes(paramAttributeSet, R.styleable.Button, 0, 0);
    try
    {
      this.iconResource = localTypedArray.getDrawable(R.styleable.Button_drawableResource);
      this.buttonString = localTypedArray.getString(R.styleable.Button_buttonText);
      this.lateralPadding = ((int)localTypedArray.getDimension(R.styleable.Button_lateralPadding, 0.0F));
      this.buttonState = kvkvvv.b0071qq00710071qqqqq(localTypedArray.getInteger(R.styleable.Button_buttonType, 0));
      if ((b006E006E006Ennnnn + b006Enn006Ennnn) * b006E006E006Ennnnn % bnn006E006Ennnn != bnnn006Ennnn)
      {
      ...
      this.elevation = localTypedArray.getDimensionPixelSize(R.styleable.Button_elevation, 0);
      Drawable localDrawable = this.iconResource;
      boolean bool = false;
  ...
  private int getProgressButtonVisibility()
  {
    ...
    {
      j = this.buttonProgressSecondary.getVisibility();
      return j;
    }
    int i = b006E006E006Ennnnn;
    switch (i * (i + bn006E006E006Ennnn()) % bn006En006Ennnn())
    {
    default: 
      b006E006E006Ennnnn = b006E006En006Ennnn();
      bnnn006Ennnn = b006E006En006Ennnn();
    ...
    switch (k * (k + b006Enn006Ennnn) % bnn006E006Ennnn)
    {
    }
  ...
  private void init(Context paramContext)
  {
    ...
    if (this.elevation > 0)
    {
      ...
      int i = 2 * this.elevation;
      int j = 2 * this.elevation;
      ...
      localLayoutParams.setMargins(i, j, 2 * this.elevation, 2 * this.elevation);
  ...
  private void initProgressButton(ProgressBar paramProgressBar, Context paramContext)
  {
    ...
    {
      Drawable localDrawable2 = DrawableCompat.wrap(this.buttonProgressPrimary.getIndeterminateDrawable());
      DrawableCompat.setTint(localDrawable2, ContextCompat.getColor(paramContext, R.color.loadingButtonProgressColor));
      paramProgressBar.setIndeterminateDrawable(DrawableCompat.unwrap(localDrawable2));
      return;
    }
    Drawable localDrawable1 = paramProgressBar.getIndeterminateDrawable();
    int j = ContextCompat.getColor(paramContext, R.color.loadingButtonProgressColor);
    if ((b006E006E006Ennnnn + b006Enn006Ennnn) * b006E006E006Ennnnn % bnn006E006Ennnn != bnnn006Ennnn)
    {
      b006E006E006Ennnnn = b006E006En006Ennnn();
      bnnn006Ennnn = b006E006En006Ennnn();
    }
    localDrawable1.setColorFilter(j, PorterDuff.Mode.SRC_IN);
  }
  ...
  private void setProgressButtonVisibility(int paramInt)
  {
    ...
    int i = (b006E006E006Ennnnn + b006Enn006Ennnn) * b006E006E006Ennnnn % bnn006E006Ennnn;
    int j = bnnn006Ennnn;
    int k = b006E006E006Ennnnn;
    switch (k * (k + b006Enn006Ennnn) % bnn006E006Ennnn)
    {
  ...
  public void changeButtonState(kvkvvv paramKvkvvv)
  {
    ...
    localTextView.setTextColor(ContextCompat.getColor(localContext, R.color.btn_disabled_text_selector));
    hideButtonProgress();
    return;
  ...
  {
    int i = b006E006E006Ennnnn;
    switch (i * (i + bn006E006E006Ennnn()) % bnn006E006Ennnn)
    {
    default: 
  ...
  public vkkvvv getButtonType()
  {
    ...
    int i = (b006E006E006Ennnnn + b006Enn006Ennnn) * b006E006E006Ennnnn;
    if ((b006E006E006Ennnnn + b006Enn006Ennnn) * b006E006E006Ennnnn % bnn006E006Ennnn != bnnn006Ennnn)
    {
      b006E006E006Ennnnn = 26;
      bnnn006Ennnn = b006E006En006Ennnn();
    }
    if (i % bnn006E006Ennnn != bnnn006Ennnn)
    {
      b006E006E006Ennnnn = b006E006En006Ennnn();
      bnnn006Ennnn = 96;
    }
  ...
  public boolean isShowingProgress()
  {
    ...
    {
      return bool;
      i = (b006E006E006Ennnnn + b006Enn006Ennnn) * b006E006E006Ennnnn % bnn006E006Ennnn;
      j = b006En006E006Ennnn();
      bool = false;
    } while (i == j);
    if ((b006E006E006Ennnnn + b006Enn006Ennnn) * b006E006E006Ennnnn % bnn006E006Ennnn != bnnn006Ennnn)
    {
  ...
  public void setDrawableResource(int paramInt)
  {
    ...
    Context localContext = getContext();
    int i = b006E006E006Ennnnn;
    switch (i * (i + b006Enn006Ennnn) % bn006En006Ennnn())
    {
    default: 
  ...
  public void setOnClickListener(final View.OnClickListener paramOnClickListener)
  {
    ...
    super.setOnClickListener(new View.OnClickListener()
    {
      ...
      public void onClick(View paramAnonymousView)
      {
        ...
        switch (i * (i + bnnnn006Ennn) % b006Ennn006Ennn)
        {
        default: 
  ...
  {
    int i = b006E006E006Ennnnn + b006Enn006Ennnn;
    int j = b006E006E006Ennnnn;
    int k = b006E006E006Ennnnn;
    switch (k * (k + b006Enn006Ennnn) % bnn006E006Ennnn)
    {
    default: 
    ...
    if (i * j % bnn006E006Ennnn != bnnn006Ennnn)
    {
  ...
  public void showButtonProgress()
  {
    ...
    int j = b006E006E006Ennnnn;
    switch (j * (j + b006Enn006Ennnn) % bnn006E006Ennnn)
    {
    default: 
      b006E006E006Ennnnn = 57;
      bnnn006Ennnn = 71;
