  ...
  implements popopp
{
  ...
  public String getBusinessId()
  {
    ...
    switch (i * (i + b00720072r0072rr) % brr00720072rr)
    {
    default: 
      b0072r00720072rr = 80;
    ...
    int j = br0072r0072rr();
    switch (j * (j + b00720072r0072rr) % brr00720072rr)
    {
    default: 
      b00720072r0072rr = 59;
    }
  ...
  public boolean isCompany()
  {
    ...
    default: 
      b0072r00720072rr = br0072r0072rr();
      br007200720072rr = 60;
      int j = b0072r00720072rr;
      switch (j * (j + b00720072r0072rr) % b0072007200720072rr())
      {
      default: 
        b0072r00720072rr = 2;
        br007200720072rr = 7;
