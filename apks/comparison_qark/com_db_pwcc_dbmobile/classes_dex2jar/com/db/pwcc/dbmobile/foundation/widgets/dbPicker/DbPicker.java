  ...
  extends FrameLayout
{
  ...
  private void createAnimations()
  {
    ...
    Animation localAnimation1 = this.slideIn;
    if ((b0072rrrr0072rr + b00720072rrr0072rr) * b0072rrrr0072rr % brr0072rr0072rr != br0072rrr0072rr)
    {
      b0072rrrr0072rr = 99;
      br0072rrr0072rr = b0072r0072rr0072rr();
    }
    localAnimation1.setFillEnabled(true);
    this.slideIn.setFillAfter(true);
    Animation localAnimation2 = AnimationUtils.loadAnimation(getContext(), R.anim.slide_out_up_picker);
    int i = b0072rrrr0072rr;
    switch (i * (i + b00720072rrr0072rr) % brr0072rr0072rr)
    {
    default: 
      b0072rrrr0072rr = b0072r0072rr0072rr();
      br0072rrr0072rr = b0072r0072rr0072rr();
    }
    this.slideOut = localAnimation2;
  ...
  private void setAnimationListeners()
  {
    this.slideOut.setAnimationListener(new Animation.AnimationListener()
    {
      ...
      public void onAnimationEnd(Animation paramAnonymousAnimation)
      {
        ...
        DbPicker.access$500(localDbPicker).setVisibility(8);
      ...
      public void onAnimationStart(Animation paramAnonymousAnimation)
      {
        ...
        int i = bcc006300630063cccc + bc0063006300630063cccc;
        int j = bcc006300630063cccc;
        int k = bqq0071qqq0071qqq();
        switch (k * (k + b0071q0071qqq0071qqq()) % b00630063006300630063cccc)
        {
        default: 
          bcc006300630063cccc = bqq0071qqq0071qqq();
          b0063c006300630063cccc = bqq0071qqq0071qqq();
        }
        if (i * j % b00630063006300630063cccc != b0063c006300630063cccc)
        {
    ...
    int i = b0072rrrr0072rr;
    switch (i * (i + brrr0072r0072rr()) % brr0072rr0072rr)
    {
    default: 
      if ((b0072rrrr0072rr + b00720072rrr0072rr) * b0072rrrr0072rr % brr0072rr0072rr != br0072rrr0072rr)
      {
    ...
    localAnimation.setAnimationListener(new Animation.AnimationListener()
    {
      ...
      public void onAnimationEnd(Animation paramAnonymousAnimation)
      {
        ...
        {
          vkkvvk localVkkvvk = DbPicker.access$600(DbPicker.this);
          DbPicker localDbPicker = DbPicker.this;
          if ((b0063cccc0063ccc + bc0063ccc0063ccc) * b0063cccc0063ccc % b00630063ccc0063ccc != b007100710071qqq0071qqq())
          {
            ...
            switch (i * (i + bc0063ccc0063ccc) % b00630063ccc0063ccc)
            {
            default: 
          ...
          localVkkvvk.onPickerExpanded(localDbPicker);
        }
        DbPicker.access$002(DbPicker.this, false);
      }
      ...
      public void onAnimationStart(Animation paramAnonymousAnimation)
      {
        ...
        default: 
          b0063cccc0063ccc = bq00710071qqq0071qqq();
          bc0063ccc0063ccc = 99;
          int j = b0063cccc0063ccc;
          switch (j * (j + bc0063ccc0063ccc) % b00630063ccc0063ccc)
          {
          default: 
            b0063cccc0063ccc = 10;
            bc0063ccc0063ccc = bq00710071qqq0071qqq();
        ...
        DbPicker.access$002(localDbPicker, true);
      }
    });
  }
      ...
      public boolean onTouch(View paramAnonymousView, MotionEvent paramAnonymousMotionEvent)
      {
        if ((paramAnonymousMotionEvent.getPointerCount() == 1) && (paramAnonymousMotionEvent.getAction() == 1) && (!DbPicker.access$000(DbPicker.this)))
        {
          ...
          if ((br0072rr00720072rr + brr0072r00720072rr) * br0072rr00720072rr % b0072r0072r00720072rr != b00720072rr00720072rr())
          {
            ...
            switch (i * (i + brr0072r00720072rr) % b0072r0072r00720072rr)
            {
            default: 
  ...
  private void setupEvents()
  {
    ...
    switch (j * (j + b00720072rrr0072rr) % brr0072rr0072rr)
    {
    default: 
      b0072rrrr0072rr = b0072r0072rr0072rr();
      br0072rrr0072rr = b0072r0072rr0072rr();
  ...
  public Rect getRectForListOnly()
  {
    ...
    int i = b0072rrrr0072rr;
    switch (i * (i + b00720072rrr0072rr) % br00720072rr0072rr())
    {
    default: 
      b0072rrrr0072rr = b0072r0072rr0072rr();
      br0072rrr0072rr = b0072r0072rr0072rr();
  ...
  public boolean isPickerVisible()
  {
    ...
    int i = (b0072rrrr0072rr + b00720072rrr0072rr) * b0072rrrr0072rr;
    if ((b0072rrrr0072rr + b00720072rrr0072rr) * b0072rrrr0072rr % brr0072rr0072rr != br0072rrr0072rr)
    {
      b0072rrrr0072rr = b0072r0072rr0072rr();
      br0072rrr0072rr = b0072r0072rr0072rr();
    }
    if (i % brr0072rr0072rr != br0072rrr0072rr)
    {
      b0072rrrr0072rr = 11;
      br0072rrr0072rr = b0072r0072rr0072rr();
    }
  ...
  public void setAdapter(ArrayAdapter paramArrayAdapter)
  {
    ...
    if ((paramArrayAdapter instanceof kvkvvk))
    {
      ...
      int j = this.pickerActions.bq007100710071qq0071qqq(0);
      this.itemPicker.setItemChecked(j, true);
      this.itemPicker.setSelection(j);
      this.resultViewer.setText(this.pickerActions.b0071q00710071qq0071qqq(j));
      adjustListHeight();
      return;
    }
    String str1 = TAG;
    ...
    String str2 = uxxxxx.bb00620062bb0062b0062b0062("4H~\005\004CByx~}utzy9poutlkqp0", '\027', '\004');
    ...
    arrayOfObject[0] = "\\~z\t\f{\b4\001\b\005\005/wz|wovmuz%Tleleq?`pdigk\027_chXdWQRS";
  ...
  public void setHint(String paramString)
  {
    ...
    default: 
      ...
      br0072rrr0072rr = 58;
      int j = b0072rrrr0072rr;
      switch (j * (j + brrr0072r0072rr()) % brr0072rr0072rr)
      {
      default: 
        b0072rrrr0072rr = b0072r0072rr0072rr();
        br0072rrr0072rr = b0072r0072rr0072rr();
    ...
    implements AdapterView.OnItemClickListener
  {
    ...
    public void onItemClick(AdapterView<?> paramAdapterView, View paramView, final int paramInt, long paramLong)
    {
          ...
          localHandler.postDelayed(new Runnable()
          {
            ...
            public void run()
            {
              ...
              if ((b00630063c0063c0063ccc + b0063c00630063c0063ccc) * b00630063c0063c0063ccc % b0071qq0071qq0071qqq() != bcc00630063c0063ccc)
              {
                ...
                switch (j * (j + b0063c00630063c0063ccc) % bc006300630063c0063ccc)
                {
                default: 
      ...
      final int i = DbPicker.access$700(DbPicker.this).bq007100710071qq0071qqq(paramInt);
      int j = b0063c0063cc0063ccc;
      switch (j * (j + b006300630063cc0063ccc) % bccc0063c0063ccc)
      {
      default: 
        b0063c0063cc0063ccc = bqq00710071qq0071qqq();
        bc00630063cc0063ccc = 90;
      }
      DbPicker.access$500(DbPicker.this).setItemChecked(i, true);
      DbPicker.access$500(DbPicker.this).setSelection(i);
      localHandler.postDelayed(new Runnable()
      {
        ...
        public void run()
        {
          ...
          localDbEditText.setText(DbPicker.access$700(localDbPicker).b0071q00710071qq0071qqq(i));
          DbPicker.this.hidePicker();
        }
      }, DbPicker.access$900().intValue());
    }
