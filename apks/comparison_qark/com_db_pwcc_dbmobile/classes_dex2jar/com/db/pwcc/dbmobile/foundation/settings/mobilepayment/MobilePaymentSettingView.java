  ...
  implements oonono.onnono, View.OnClickListener
{
  ...
  private void initViews()
  {
    ...
    int j = i * (i + b006F006F006Fooo006Fo());
  ...
  public Context getActivityContext()
  {
    ...
    switch (j * (j + b006F006Fo006Foo006Fo) % booo006Foo006Fo)
    {
    default: 
      bo006F006Fooo006Fo = 54;
      bo006Fo006Foo006Fo = b006Foo006Foo006Fo();
    }
    switch (i * (i + b006F006Fo006Foo006Fo) % boo006F006Foo006Fo())
    {
    default: 
      bo006F006Fooo006Fo = b006Foo006Foo006Fo();
  ...
  public void onClick(View paramView)
  {
    ...
    try
    {
      localMethod.invoke(localNonono, arrayOfObject);
      return;
    }
  ...
  {
    int i = bo006F006Fooo006Fo;
    switch (i * (i + b006F006Fo006Foo006Fo) % booo006Foo006Fo)
    {
    default: 
  ...
  public void setMobilePaymentSettingState(int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    TextView localTextView = this.mobilePaymentSettingButton;
    if (paramBoolean) {}
    for (int i = 0;; i = 8)
    {
