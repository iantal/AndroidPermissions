  ...
  extends DbEditText
{
  ...
  private void init()
  {
    setupDecimalFomat();
    setupTextWatcher();
    int i = bx0078x0078xx0078x + bxx00780078xx0078x;
    ...
    if (i * bx0078x0078xx0078x % b0078007800780078xx0078x != b00780078x0078xx0078x)
    {
  ...
  private void setupDecimalFomat()
  {
    ...
    switch (i * (i + bxx00780078xx0078x) % b0078007800780078xx0078x)
    {
    default: 
      bx0078x0078xx0078x = bx007800780078xx0078x();
    ...
    {
      this.decimalFormat = ((DecimalFormat)localNumberFormat);
      localDecimalFormat = this.decimalFormat;
      String str = uxxxxx.bbbb0062b0062b0062b0062("\023'&%$[Z`_WV\\[\033RQWVNMSR\022", '¸', 'è', '\001');
      ...
      arrayOfObject[0] = "_`akcdeoghiuxy";
    ...
    try
    {
      ...
      localDecimalFormat.applyPattern((String)localObject);
  ...
  {
    int i = bx0078x0078xx0078x;
    switch (i * (i + bxx00780078xx0078x) % b0078x00780078xx0078x())
    {
    default: 
      bx0078x0078xx0078x = bx007800780078xx0078x();
      b00780078x0078xx0078x = bx007800780078xx0078x();
  ...
  {
    int i = bx0078x0078xx0078x;
    switch (i * (i + bxxxx0078x0078x()) % b0078x00780078xx0078x())
    {
    default: 
      bx0078x0078xx0078x = bx007800780078xx0078x();
    ...
    implements TextWatcher
  {
    ...
    public void afterTextChanged(Editable paramEditable)
    {
      ...
      if ((!paramEditable.toString().isEmpty()) && (this.b0068hh00680068hhh0068.isEmpty()))
      {
        ...
        int i = MonetaryValueInputView.this.getSelectionStart();
        int j = MonetaryValueInputView.this.getSelectionEnd();
        if (i > this.b0068hh00680068hhh0068.length()) {
          i = this.b0068hh00680068hhh0068.length();
        }
        if (j > this.b0068hh00680068hhh0068.length())
        {
          String str = this.b0068hh00680068hhh0068;
          int k = bhh006800680068hhh0068;
          switch (k * (k + b0068h006800680068hhh0068) % bh0068006800680068hhh0068)
          {
          default: 
            bhh006800680068hhh0068 = b0071qq0071qqq0071q0071();
            b0068h006800680068hhh0068 = 7;
            int m = bhh006800680068hhh0068;
            switch (m * (m + b0068h006800680068hhh0068) % bh0068006800680068hhh0068)
            {
            default: 
