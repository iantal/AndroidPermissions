  ...
  implements popopp, Parcelable
{
  ...
  static
  {
    ...
    switch (i * (i + bf0066ff00660066f0066) % b00660066ff00660066f0066)
    {
    default: 
    ...
    int j = b0066fff00660066f0066;
    switch (j * (j + bf0066ff00660066f0066) % b00660066ff00660066f0066)
    {
    default: 
  ...
  {
    int i = (b0066fff00660066f0066 + bf0066ff00660066f0066) * b0066fff00660066f0066 % b00660066ff00660066f0066;
    int j = b0066fff00660066f0066;
    switch (j * (j + bf0066ff00660066f0066) % b00660066ff00660066f0066)
    {
    default: 
  ...
  {
    int i = b0066fff00660066f0066;
    int j = i * (i + bf0066ff00660066f0066);
    int k = b00660066ff00660066f0066;
    int m = b0066fff00660066f0066;
    switch (m * (m + bf0066ff00660066f0066) % b00660066ff00660066f0066)
    {
    default: 
      b0066fff00660066f0066 = bff0066f00660066f0066();
