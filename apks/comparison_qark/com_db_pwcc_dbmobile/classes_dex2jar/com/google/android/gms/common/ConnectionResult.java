  ...
  extends zzbfm
{
    ...
    do
    {
      ...
      do
      {
        ...
        do
        {
          ...
          {
            return bool2;
            bool1 = paramObject instanceof ConnectionResult;
            bool2 = false;
          } while (!bool1);
          localConnectionResult = (ConnectionResult)paramObject;
          i = this.zzcd;
          j = localConnectionResult.zzcd;
          bool2 = false;
        } while (i != j);
        bool3 = zzbg.equal(this.zzeeo, localConnectionResult.zzeeo);
        bool2 = false;
      } while (!bool3);
    } while (zzbg.equal(this.zzfks, localConnectionResult.zzfks));
    return false;
  }
  ...
  public final int hashCode()
  {
    ...
    arrayOfObject[0] = Integer.valueOf(this.zzcd);
    arrayOfObject[1] = this.zzeeo;
