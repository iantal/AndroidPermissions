  ...
  implements ActivityChooserModel.ActivityChooserModelClient
{
  ...
  public ActivityChooserView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    InstrumentationCallbacks.setOnClickListenerCalled(this.mDefaultActivityButton, this.mCallbacks);
    this.mDefaultActivityButton.setOnLongClickListener(this.mCallbacks);
    this.mDefaultActivityButtonImage = ((ImageView)this.mDefaultActivityButton.findViewById(R.id.image));
    FrameLayout localFrameLayout = (FrameLayout)findViewById(R.id.expand_activities_button);
    InstrumentationCallbacks.setOnClickListenerCalled(localFrameLayout, this.mCallbacks);
