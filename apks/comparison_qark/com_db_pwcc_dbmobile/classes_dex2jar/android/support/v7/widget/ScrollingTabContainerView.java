  ...
  implements AdapterView.OnItemSelectedListener
{
  ...
  TabView createTabView(ActionBar.Tab paramTab, boolean paramBoolean)
  {
    ...
    InstrumentationCallbacks.setOnClickListenerCalled(localTabView, this.mTabClickListener);
    return localTabView;
  }
  ...
  public void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    if (j == 1073741824)
    {
      ...
      if ((k <= i) || ((j != 1073741824) && (j != Integer.MIN_VALUE))) {
        break label206;
      }
      if (k <= 2) {
        break label193;
    ...
    extends LinearLayoutCompat
  {
    ...
    public void update()
    {
      ...
      label372:
      label399:
      for (CharSequence localCharSequence2 = null;; localCharSequence2 = localTab.getContentDescription())
      {
