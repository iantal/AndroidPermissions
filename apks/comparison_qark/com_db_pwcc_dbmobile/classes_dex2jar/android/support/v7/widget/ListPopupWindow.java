  ...
  implements ShowableListMenu
{
  ...
  private int buildDropDown()
  {
    ...
    if (this.mDropDownList == null)
    {
      ...
      if (!this.mModal)
      {
        ...
        InstrumentationCallbacks.setOnItemClickListenerCalled(this.mDropDownList, this.mItemClickListener);
  ...
  public void show()
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        localPopupWindow4.update(localView, n, i1, m, i);
        return;
