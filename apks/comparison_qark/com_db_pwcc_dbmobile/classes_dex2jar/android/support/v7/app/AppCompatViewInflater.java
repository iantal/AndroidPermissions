...
class AppCompatViewInflater {
    ...
    private void checkOnClickListener(View view, AttributeSet attributeSet) {
        ...
        if (string2 != null) {
            InstrumentationCallbacks.setOnClickListenerCalled(view, new DeclaredOnClickListener(view, string2));
        }
        typedArray.recycle();
    }
...
lbl8: // 2 sources:
        ...
        block8 : {
            ...
            do {
                block9 : {
                    ...
                    View view = this.createView(context, string2, sClassPrefixList[n2]);
    ...
    private static Context themifyContext(Context object, AttributeSet attributeSet, boolean bl, boolean bl2) {
        ...
        int n3 = bl ? typedArray.getResourceId(R.styleable.View_android_theme, 0) : 0;
        if (bl2 && n3 == 0 && (n3 = typedArray.getResourceId(R.styleable.View_theme, 0)) != 0) {
        ...
        if (!(object instanceof ContextThemeWrapper)) return new ContextThemeWrapper((Context)object, n2);
        if (((ContextThemeWrapper)((Object)object)).getThemeResId() == n2) return object;
        return new ContextThemeWrapper((Context)object, n2);
    }
    ...
    public final View createView(View var1_1, String var2_2, @NonNull Context var3_3, @NonNull AttributeSet var4_4, boolean var5_5, boolean var6_6, boolean var7_7, boolean var8_8) {
        ...
        if (var6_6 || var7_7) {
            var9_9 = AppCompatViewInflater.themifyContext(var9_9, var4_4, var6_6, var7_7);
        }
        if (var8_8) {
            var9_9 = TintContextWrapper.wrap(var9_9);
        }
        var10_10 = -1;
...
lbl71: // 4 sources:
        ...
        switch (var10_10) {
            case 0: {
                var11_11 = new AppCompatTextView(var9_9, var4_4);
                break;
            }
            case 1: {
                var11_11 = new AppCompatImageView(var9_9, var4_4);
                break;
            }
            case 2: {
                var11_11 = new AppCompatButton(var9_9, var4_4);
                break;
            }
            case 3: {
                var11_11 = new AppCompatEditText(var9_9, var4_4);
                break;
            }
            case 4: {
                var11_11 = new AppCompatSpinner(var9_9, var4_4);
                break;
            }
            case 5: {
                var11_11 = new AppCompatImageButton(var9_9, var4_4);
                break;
            }
            case 6: {
                var11_11 = new AppCompatCheckBox(var9_9, var4_4);
                break;
            }
            case 7: {
                var11_11 = new AppCompatRadioButton(var9_9, var4_4);
                break;
            }
            case 8: {
                var11_11 = new AppCompatCheckedTextView(var9_9, var4_4);
                break;
            }
            case 9: {
                var11_11 = new AppCompatAutoCompleteTextView(var9_9, var4_4);
                break;
            }
            case 10: {
                var11_11 = new AppCompatMultiAutoCompleteTextView(var9_9, var4_4);
                break;
            }
            case 11: {
                var11_11 = new AppCompatRatingBar(var9_9, var4_4);
                break;
            }
            case 12: {
                var11_11 = new AppCompatSeekBar(var9_9, var4_4);
            }
        }
        var12_12 = var11_11 == null && var3_3 != var9_9 ? this.createViewFromTag(var9_9, var2_2, var4_4) : var11_11;
        if (var12_12 == null) return var12_12;
        this.checkOnClickListener((View)var12_12, var4_4);
        return var12_12;
    }
    ...
    implements View.OnClickListener {
        ...
        private void resolveMethod(@Nullable Context context, @NonNull String string2) {
            ...
            string3 = " with id '" + this.mHostView.getContext().getResources().getResourceEntryName(n2) + "'";
            throw new IllegalStateException("Could not find method " + this.mMethodName + "(View) in a parent or ancestor Context for android:onClick " + "attribute defined on view " + this.mHostView.getClass() + string3);
        }
