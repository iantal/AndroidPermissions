...
public class Scene
{
  ...
  {
    SparseArray localSparseArray1 = (SparseArray)paramViewGroup.getTag(R.id.transition_scene_layoutid_cache);
    SparseArray localSparseArray2;
    if (localSparseArray1 == null)
    {
      localSparseArray2 = new SparseArray();
      paramViewGroup.setTag(R.id.transition_scene_layoutid_cache, localSparseArray2);
    }
    for (SparseArray localSparseArray3 = localSparseArray2;; localSparseArray3 = localSparseArray1)
    {
      Scene localScene1 = (Scene)localSparseArray3.get(paramInt);
      if (localScene1 != null) {
        return localScene1;
      }
      Scene localScene2 = new Scene(paramViewGroup, paramInt, paramContext);
      localSparseArray3.put(paramInt, localScene2);
      return localScene2;
    }
  }
