  ...
  extends BaseTransientBottomBar<Snackbar>
{
  ...
  private static ViewGroup findSuitableParent(View paramView)
  {
    ...
    for (;;)
    {
      ...
      label69:
      for (localView = (View)localViewParent; localView == null; localView = null) {
  ...
  public Snackbar setAction(CharSequence paramCharSequence, final View.OnClickListener paramOnClickListener)
  {
    ...
    if ((TextUtils.isEmpty(paramCharSequence)) || (paramOnClickListener == null))
    {
      ...
      InstrumentationCallbacks.setOnClickListenerCalled(localButton, null);
      return this;
    }
    ...
    protected void onMeasure(int paramInt1, int paramInt2)
    {
      ...
      for (int n = 0; n < i; n++)
      {
        ...
        if (localView.getLayoutParams().width == -1) {
          localView.measure(View.MeasureSpec.makeMeasureSpec(j - k - m, 1073741824), View.MeasureSpec.makeMeasureSpec(localView.getMeasuredHeight(), 1073741824));
        }
      }
    }
  }
