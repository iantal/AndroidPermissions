  ...
  implements WithHint
{
      ...
      do
      {
        ...
        if (shouldShowPasswordIcon())
        {
          if (this.mPasswordToggleView == null)
          {
            ...
            InstrumentationCallbacks.setOnClickListenerCalled(this.mPasswordToggleView, new View.OnClickListener()
            {
  ...
  protected void drawableStateChanged()
  {
    ...
    label84:
    for (boolean bool2 = false | this.mCollapsingTextHelper.setState(arrayOfInt);; bool2 = false)
    {
      if (bool2) {
        invalidate();
      }
  ...
  public void setErrorEnabled(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        int j = this.mErrorView.getTextColors().getDefaultColor();
        if (j != -65281) {
          break label206;
        }
        i = 1;
