  ...
  public boolean onMeasureChild(CoordinatorLayout paramCoordinatorLayout, View paramView, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if ((i == -1) || (i == -2))
    {
      ...
      if (localView != null)
      {
        ...
        if (i == -1) {}
        for (int n = 1073741824;; n = Integer.MIN_VALUE)
        {
          paramCoordinatorLayout.onMeasureChild(paramView, paramInt1, paramInt2, View.MeasureSpec.makeMeasureSpec(m + (j - k), n), paramInt4);
          return true;
        }
      }
    }
