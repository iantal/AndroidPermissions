  ...
  extends ScrimInsetsFrameLayout
{
  ...
  public NavigationView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if ((i == 0) && (localColorStateList2 == null)) {
      ...
      if (i != 0) {
        this.mPresenter.setItemTextAppearance(j);
      }
  ...
  private ColorStateList createDefaultColorStateList(int paramInt)
  {
    ...
    int k = localColorStateList.getColorForState(DISABLED_STATE_SET, j);
    return new ColorStateList(new int[][] { arrayOfInt1, arrayOfInt2, arrayOfInt3 }, new int[] { k, i, j });
  }
