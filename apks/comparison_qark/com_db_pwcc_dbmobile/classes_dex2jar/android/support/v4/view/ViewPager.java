  ...
  extends ViewGroup
{
    ...
    for (int j = 0;; j = 1)
    {
      ...
      for (int k = 0;; k = 1)
      {
        ...
        if (f2 < f3)
        {
          ...
          if (j != 0)
          {
            this.mLeftEdge.onPull(Math.abs(f3 - f2) / i);
            bool = true;
          }
        }
        for (;;)
        {
          ...
          if (f2 > f5)
          {
            ...
            if (k != 0)
            {
              this.mRightEdge.onPull(Math.abs(f2 - f5) / i);
              bool = true;
            }
            f3 = f5;
          }
  ...
  protected void onDraw(Canvas paramCanvas)
  {
    ...
    for (int i2 = m;; i2++)
    {
      ...
      label276:
      float f4;
      for (f3 = f1 + (localItemInfo.offset + localItemInfo.widthFactor);; f3 += f4 + f1)
      {
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      while (bool1)
      {
        ...
        label396:
        for (float f6 = this.mInitialMotionX + this.mTouchSlop;; f6 = this.mInitialMotionX - this.mTouchSlop)
        {
    ...
    for (ItemInfo localItemInfo1 = localItemInfo12;; localItemInfo1 = null)
    {
      ...
      for (;;)
      {
        ...
        for (ItemInfo localItemInfo3 = addNewItem(this.mCurItem, n);; localItemInfo3 = localItemInfo2)
        {
          ...
          label971:
          label1092:
          for (Object localObject = localItemInfo3.object;; localObject = null)
          {
            ...
            localItemInfo8 = null;
            break label441;
            f4 = 2.0F + getPaddingRight() / i6;
            break label449;
            if ((i13 == localItemInfo10.position) && (!localItemInfo10.scrolling))
            {
            ...
            for (;;)
            {
              ...
              continue;
              if ((localItemInfo10 != null) && (i13 == localItemInfo10.position))
              {
      ...
      do
      {
        ...
        do
        {
          ...
          default: 
            return false;
          case 4096: 
            bool3 = ViewPager.this.canScrollHorizontally(1);
            bool2 = false;
          }
        } while (!bool3);
