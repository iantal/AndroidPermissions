    ...
    implements IMediaSession {
        ...
        public boolean onTransact(int n2, Parcel parcel, Parcel parcel2, int n3) throws RemoteException {
            ...
            switch (n2) {
                ...
                case 38: {
                    parcel.enforceInterface("android.support.v4.media.session.IMediaSession");
                    boolean bl = this.isShuffleModeEnabledRemoved();
                    parcel2.writeNoException();
                    int n9 = 0;
                    if (bl) {
                        n9 = 1;
                ...
                case 51: {
                    ...
                    RatingCompat ratingCompat = parcel.readInt() != 0 ? (RatingCompat)RatingCompat.CREATOR.createFromParcel(parcel) : null;
                    Bundle bundle = parcel.readInt() != 0 ? (Bundle)Bundle.CREATOR.createFromParcel(parcel) : null;
                    this.rateWithExtras(ratingCompat, bundle);
                    parcel2.writeNoException();
                    return true;
                }
                case 46: {
                ...
                case 40: {
                    ...
                    this.setShuffleModeEnabledRemoved(bl);
                    parcel2.writeNoException();
                    return true;
                }
                case 48: {
        ...
        implements IMediaSession {
             ...
             */
            @Override
            public void addQueueItemAt(MediaDescriptionCompat mediaDescriptionCompat, int n2) throws RemoteException {
                Parcel parcel = Parcel.obtain();
                Parcel parcel2 = Parcel.obtain();
                try {
                    parcel.writeInterfaceToken("android.support.v4.media.session.IMediaSession");
            ...
            @Override
            public void removeQueueItemAt(int n2) throws RemoteException {
                Parcel parcel = Parcel.obtain();
                Parcel parcel2 = Parcel.obtain();
                try {
                    parcel.writeInterfaceToken("android.support.v4.media.session.IMediaSession");
