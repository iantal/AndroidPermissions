  ...
  extends ViewGroup
{
  ...
  private void dimChildView(View paramView, float paramFloat, int paramInt)
  {
    ...
    {
      i = (int)(paramFloat * ((0xFF000000 & paramInt) >>> 24));
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        else
        {
          ...
          {
            i19 = View.MeasureSpec.makeMeasureSpec(i4 - i18, Integer.MIN_VALUE);
            if (localLayoutParams2.height != -2) {
              break label571;
            }
            i20 = View.MeasureSpec.makeMeasureSpec(i3, Integer.MIN_VALUE);
            label421:
            localView2.measure(i19, i20);
            int i21 = localView2.getMeasuredWidth();
            int i22 = localView2.getMeasuredHeight();
            if ((n == Integer.MIN_VALUE) && (i22 > i7)) {
              i7 = Math.min(i22, i3);
            }
            i8 -= i21;
            if (i8 >= 0) {
              ...
              for (;;)
              {
                ...
                if (localView1.getVisibility() != 8)
                {
                  ...
                  if ((localLayoutParams1.width == 0) && (localLayoutParams1.weight > 0.0F))
                  {
                    ...
                    i17 = View.MeasureSpec.makeMeasureSpec(i3, Integer.MIN_VALUE);
                  }
                  for (;;)
                  {
                  ...
                  if (localLayoutParams1.weight > 0.0F)
                  {
                    ...
                    if (localLayoutParams1.width == 0) {
                      if (localLayoutParams1.height == -2) {
                        i13 = View.MeasureSpec.makeMeasureSpec(i3, Integer.MIN_VALUE);
                      }
                    }
                    for (;;)
                    {
          ...
          setMeasuredDimension(i1, i7 + getPaddingTop() + getPaddingBottom());
  ...
  void updateObscuredViewsVisibility(View paramView)
  {
    ...
    if (bool)
    {
      ...
      i10 = i;
      label205:
      int i11 = Math.min(i10, localView.getRight());
      int i12 = Math.min(m - n, localView.getBottom());
      if ((i8 < i3) || (i9 < i1) || (i11 > i2) || (i12 > i4)) {
        break label286;
      }
    }
    label279:
