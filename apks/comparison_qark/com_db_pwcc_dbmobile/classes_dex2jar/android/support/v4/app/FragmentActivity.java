  ...
  implements ActivityCompat.OnRequestPermissionsResultCallback, ActivityCompat.RequestPermissionsRequestCodeValidator
{
  ...
  protected void onCreate(@Nullable Bundle paramBundle)
  {
    ...
    label165:
    label213:
    for (FragmentManagerNonConfig localFragmentManagerNonConfig = localNonConfigurationInstances.fragments;; localFragmentManagerNonConfig = null)
    {
