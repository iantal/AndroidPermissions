...
public class NotificationCompat
{
  ...
  static Action getActionCompatFromAction(Notification.Action paramAction)
  {
    ...
    for (Object localObject = null;; localObject = arrayOfRemoteInput1)
    {
      ...
      for (;;)
      {
        return new Action(paramAction.icon, paramAction.title, paramAction.actionIntent, paramAction.getExtras(), (RemoteInput[])localObject, null, bool);
  ...
  public static class Builder
  {
    ...
    public Builder setLights(@ColorInt int paramInt1, int paramInt2, int paramInt3)
    {
      ...
      for (;;)
      {
        localNotification.flags = (i | k & 0xFFFFFFFE);
        return this;
        j = 0;
        break;
        label92:
    ...
    extends NotificationCompat.Style
  {
    ...
    private CharSequence makeMessageLine(Message paramMessage)
    {
      ...
      for (;;)
      {
        CharSequence localCharSequence2 = localBidiFormatter.unicodeWrap((CharSequence)localObject1);
  ...
  public static abstract class Style
  {
    ...
    public RemoteViews applyStandardTemplate(boolean paramBoolean1, int paramInt, boolean paramBoolean2)
    {
      ...
      if (this.mBuilder.getPriority() < -1)
      {
        ...
        {
          int i10 = localResources.getDimensionPixelSize(R.dimen.notification_right_icon_size);
          int i11 = localResources.getDimensionPixelSize(R.dimen.notification_small_icon_background_padding);
          if (Build.VERSION.SDK_INT < 21) {
            break label641;
          }
          Bitmap localBitmap2 = createIconWithBackground(this.mBuilder.mNotification.icon, i10, i10 - i11 * 2, this.mBuilder.getColor());
      ...
      for (int j = 1;; j = 0)
      {
        ...
        for (;;)
        {
          ...
          for (int i5 = 0;; i5 = 8)
          {
            ...
            if (Build.VERSION.SDK_INT >= 21)
            {
              int i7 = localResources.getDimensionPixelSize(R.dimen.notification_large_icon_width);
              int i8 = localResources.getDimensionPixelSize(R.dimen.notification_big_circle_margin);
              int i9 = localResources.getDimensionPixelSize(R.dimen.notification_small_icon_size_as_large);
              Bitmap localBitmap1 = createIconWithBackground(this.mBuilder.mNotification.icon, i7 - i8, i9, this.mBuilder.getColor());
