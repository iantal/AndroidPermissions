...
public class nnnnon
{
  ...
  {
    SharedPreferencesHelper localSharedPreferencesHelper = this.bfff006600660066fff;
    Method localMethod = SharedPreferencesHelper.class.getMethod(uxxxxx.bb00620062bb0062b0062b0062("V_;RX\\V:FR,PBCSGSA", '', '\003'), new Class[0]);
    ...
    try
    {
      ...
      if (((Boolean)localObject).booleanValue())
      {
        ...
        arrayOfInteger[0] = Integer.valueOf(R.layout.tutorial_page_phototan);
        ...
        arrayOfInteger[1] = Integer.valueOf(R.layout.tutorial_page_1);
        localList = Arrays.asList(arrayOfInteger);
        return localList;
      }
      List localList = Collections.singletonList(Integer.valueOf(R.layout.tutorial_page_1));
      int i = b006B006B006Bkkkk006Bk006B();
      switch (i * (i + b00660066f006600660066fff) % bff0066006600660066fff)
      {
      }
