  ...
  extends qqqlqq<MbaSecurity, MbaSecurityPositions>
{
  ...
  public View b006F006F006Foo006F006Fo006Fo(MbaSecurity paramMbaSecurity, View paramView, int paramInt)
  {
    ...
    TextView localTextView = localQllqqq.bw007700770077w0077www;
    ...
    for (int i = 0;; i = 8)
    {
      ...
      View localView = localQllqqq.b0077007700770077w0077www;
      int j = 0;
      if (paramInt == 1) {
        j = 8;
      }
  ...
  public boolean b006F006Fo006Fo006F006Fo006Fo(MbaSecurity paramMbaSecurity)
  {
    if ((b007700770077w00770077www + bwww007700770077www) * b007700770077w00770077www % b0077ww007700770077www != bw0077w007700770077www)
    {
      ...
      switch (i * (i + bwww007700770077www) % b0077ww007700770077www)
      {
      default: 
        b007700770077w00770077www = b006Fo006Foo006F006Fo006Fo();
        bw0077w007700770077www = b006Fo006Foo006F006Fo006Fo();
  ...
  public View bo006F006Foo006F006Fo006Fo(MbaSecurity paramMbaSecurity, View paramView)
  {
    ...
    int i = b007700770077w00770077www;
    int j = i * (i + bwww007700770077www) % b0077ww007700770077www;
    ...
    ((qqqlqq.lllqqq)localObject).bw0077w0077w0077www.setText(this.bwwwww0077www);
    return paramView;
  }
  
  public String bo006Fo006Fo006F006Fo006Fo(MbaSecurity paramMbaSecurity)
  {
    Context localContext = this.b0077wwww0077www;
    int i = b007700770077w00770077www;
    int j = bwww007700770077www;
    int k = b007700770077w00770077www;
    switch (k * (k + bwww007700770077www) % b0077ww007700770077www)
    {
    default: 
    ...
    return localContext.getString(R.string.sec_account_positions);
  }
  ...
  {
    Object localObject = paramTransactionGroupItemView.getTag(R.id.securities_data);
    if ((b007700770077w00770077www + bwww007700770077www) * b007700770077w00770077www % b0077ww007700770077www != bw0077w007700770077www)
    {
      b007700770077w00770077www = b006Fo006Foo006F006Fo006Fo();
      bw0077w007700770077www = b006Fo006Foo006F006Fo006Fo();
    ...
    return (MbaSecurity)localObject;
  }
  ...
  public int getCount()
  {
    ...
    {
      int j = (b007700770077w00770077www + bwww007700770077www) * b007700770077w00770077www;
      int k = b007700770077w00770077www;
      switch (k * (k + bwww007700770077www) % b0077ww007700770077www)
      {
      default: 
      ...
      if (j % b0077ww007700770077www != bw0077w007700770077www)
      {
