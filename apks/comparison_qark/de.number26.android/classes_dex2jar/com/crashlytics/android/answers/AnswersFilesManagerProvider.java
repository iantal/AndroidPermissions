...
class AnswersFilesManagerProvider
{
    ...
    throws IOException
  {
    ...
    s localS = new s();
    File localFile = this.fileStore.a();
    g localG = new g(this.context, localFile, "session_analytics.tap", "session_analytics_to_send");
    return new SessionAnalyticsFilesManager(this.context, localSessionEventTransform, localS, localG);
  }
}
