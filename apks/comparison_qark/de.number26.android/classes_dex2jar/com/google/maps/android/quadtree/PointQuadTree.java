...
public class PointQuadTree<T extends Item>
{
  ...
  private void search(Bounds paramBounds, Collection<T> paramCollection)
  {
    ...
    if (this.mChildren != null)
    {
      ...
      while (localIterator2.hasNext()) {
        ((PointQuadTree)localIterator2.next()).search(paramBounds, paramCollection);
      }
    }
    if (this.mItems != null)
    {
  ...
  private void split()
  {
    ...
    List localList1 = this.mChildren;
    PointQuadTree localPointQuadTree1 = new PointQuadTree(this.mBounds.minX, this.mBounds.midX, this.mBounds.minY, this.mBounds.midY, 1 + this.mDepth);
    localList1.add(localPointQuadTree1);
    List localList2 = this.mChildren;
    PointQuadTree localPointQuadTree2 = new PointQuadTree(this.mBounds.midX, this.mBounds.maxX, this.mBounds.minY, this.mBounds.midY, 1 + this.mDepth);
    localList2.add(localPointQuadTree2);
    List localList3 = this.mChildren;
    PointQuadTree localPointQuadTree3 = new PointQuadTree(this.mBounds.minX, this.mBounds.midX, this.mBounds.midY, this.mBounds.maxY, 1 + this.mDepth);
    localList3.add(localPointQuadTree3);
    List localList4 = this.mChildren;
    PointQuadTree localPointQuadTree4 = new PointQuadTree(this.mBounds.midX, this.mBounds.maxX, this.mBounds.midY, this.mBounds.maxY, 1 + this.mDepth);
    localList4.add(localPointQuadTree4);
    List localList5 = this.mItems;
    this.mItems = null;
    Iterator localIterator = localList5.iterator();
