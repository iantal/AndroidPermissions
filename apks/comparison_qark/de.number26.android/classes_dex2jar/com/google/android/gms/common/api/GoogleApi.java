...
public class GoogleApi<O extends Api.ApiOptions>
{
  ...
  {
    zzs localZzs1 = new zzs();
    Account localAccount;
    if ((this.zzd instanceof Api.ApiOptions.HasGoogleSignInAccountOptions))
    {
      GoogleSignInAccount localGoogleSignInAccount2 = ((Api.ApiOptions.HasGoogleSignInAccountOptions)this.zzd).getGoogleSignInAccount();
    ...
    if ((this.zzd instanceof Api.ApiOptions.HasAccountOptions)) {
      localAccount = ((Api.ApiOptions.HasAccountOptions)this.zzd).getAccount();
    } else {
      localAccount = null;
    }
    label74:
    zzs localZzs2 = localZzs1.zza(localAccount);
    if ((this.zzd instanceof Api.ApiOptions.HasGoogleSignInAccountOptions))
    {
      GoogleSignInAccount localGoogleSignInAccount1 = ((Api.ApiOptions.HasGoogleSignInAccountOptions)this.zzd).getGoogleSignInAccount();
      if (localGoogleSignInAccount1 != null)
      {
        localSet = localGoogleSignInAccount1.zzc();
        break label124;
      }
    }
    Set localSet = Collections.emptySet();
    label124:
    return localZzs2.zza(localSet);
  }
