...
public class MacAddressUtil
{
    ...
    private static String loadAddress(final String s) {
        try {
            ...
            final BufferedReader bufferedReader = new BufferedReader(new FileReader(string), 1024);
    ...
    private static String removeSpaceString(final String s) {
        if (s == null) {
            return null;
        }
