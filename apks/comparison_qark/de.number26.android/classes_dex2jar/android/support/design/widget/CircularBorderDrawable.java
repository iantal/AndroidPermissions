  ...
  extends Drawable
{
  ...
  private Shader createGradientShader()
  {
    ...
    arrayOfInt[0] = a.a(this.mTopOuterStrokeColor, this.mCurrentBorderTintColor);
    arrayOfInt[1] = a.a(this.mTopInnerStrokeColor, this.mCurrentBorderTintColor);
    arrayOfInt[2] = a.a(a.b(this.mTopInnerStrokeColor, 0), this.mCurrentBorderTintColor);
    arrayOfInt[3] = a.a(a.b(this.mBottomInnerStrokeColor, 0), this.mCurrentBorderTintColor);
    arrayOfInt[4] = a.a(this.mBottomInnerStrokeColor, this.mCurrentBorderTintColor);
    arrayOfInt[5] = a.a(this.mBottomOuterStrokeColor, this.mCurrentBorderTintColor);
    ...
    arrayOfFloat[5] = 1.0F;
    LinearGradient localLinearGradient = new LinearGradient(0.0F, localRect.top, 0.0F, localRect.bottom, arrayOfInt, arrayOfFloat, Shader.TileMode.CLAMP);
