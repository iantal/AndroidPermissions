  ...
  public b(Context paramContext, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (paramBoolean1) {
      if (getResources().getConfiguration().orientation == 2)
      {
        ...
        localTextView1.setBackgroundColor(Color.rgb(230, 236, 239));
        ...
        localTextView2.setBackgroundColor(Color.rgb(230, 236, 239));
    ...
    for (;;)
    {
      ...
      localImageView2.setBackgroundDrawable(h.a());
      ...
      break label748;
      label1010:
      localLayoutParams6.addRule(3, 4097);
      break label776;
      label1022:
      localLayoutParams7 = new RelativeLayout.LayoutParams(-1, n);
      localLayoutParams7.addRule(10, -1);
      localImageView1.setBackgroundDrawable(h.a());
      break label876;
      label1053:
      localLayoutParams8.addRule(3, 4097);
    }
  }
}
