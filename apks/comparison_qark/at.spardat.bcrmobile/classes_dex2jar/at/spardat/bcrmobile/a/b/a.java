  ...
  extends at.spardat.bcrmobile.a.a<Params, Progress, Result>
{
  ...
  protected static boolean b(Exception paramException)
  {
    ...
    if (bool1)
    {
      ...
      if ((!"err_general".equals(str)) && (!"err_user_locked".equals(str)) && (!"err_session_expired".equals(str)))
      {
        boolean bool3 = "err_token_blocked".equals(str);
        bool2 = false;
        if (!bool3) {}
      }
      else
  ...
  {
    String str1 = paramContext.getString(2131165525);
    String str2 = paramContext.getString(2131165526);
    String str3 = a(paramContext, paramException, str1);
    at.spardat.bcrmobile.a.b.b.c.a(paramContext, b(paramContext, paramException, str2), str3, true, false);
  }
