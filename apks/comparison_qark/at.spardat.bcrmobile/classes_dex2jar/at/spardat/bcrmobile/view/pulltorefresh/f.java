  ...
  extends LinearLayout
{
  ...
  {
    a localA = new a(paramContext, paramC, paramTypedArray);
  ...
  private void o()
  {
    ...
    for (int i2 = -i1;; i2 = 0)
    {
      boolean bool = this.h.showFooterLoadingLayout();
      int i3 = 0;
      if (bool)
      {
        this.o.a(i1);
  ...
  private void p()
  {
    ...
    if (this.h.showHeaderLoadingLayout()) {
      super.addView(this.n, 0, localLayoutParams);
    }
    if (this == this.o.getParent()) {
      removeView(this.o);
    }
    if (this.h.showFooterLoadingLayout()) {
      super.addView(this.o, -1, localLayoutParams);
    }
    o();
    if (this.h != c.BOTH) {}
    for (c localC = this.h;; localC = c.PULL_FROM_START)
    {
      this.i = localC;
      return;
    }
    ...
    do
    {
      do
      {
        ...
        default: 
          ...
          if ((i1 != 0) && (!e()))
          {
            if ((this.g == h.PULL_TO_REFRESH) || (i2 < Math.abs(i1))) {
              break label243;
            }
