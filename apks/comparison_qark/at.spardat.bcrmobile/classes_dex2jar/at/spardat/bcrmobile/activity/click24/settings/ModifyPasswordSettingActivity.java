  ...
  implements h
{
  ...
  private final View.OnFocusChangeListener o = new View.OnFocusChangeListener()
  {
    public final void onFocusChange(View paramAnonymousView, boolean paramAnonymousBoolean)
    {
      ...
      {
        str1 = ModifyPasswordSettingActivity.a(ModifyPasswordSettingActivity.this).c();
        if (!at.spardat.bcrmobile.e.d.a(str1)) {
          break label113;
        }
        String str2 = ModifyPasswordSettingActivity.this.getResources().getString(2131165487);
        Object[] arrayOfObject = new Object[1];
        arrayOfObject[0] = ModifyPasswordSettingActivity.this.getResources().getString(2131165452);
        str3 = String.format(str2, arrayOfObject);
        if (paramAnonymousBoolean) {
          ModifyPasswordSettingActivity.a(ModifyPasswordSettingActivity.this).b(str3);
        }
      }
      else
      {
      ...
      ModifyPasswordSettingActivity.a(ModifyPasswordSettingActivity.this).a(str3);
      return;
      label113:
      if (str1.length() < 8)
      {
  ...
  private final View.OnFocusChangeListener p = new View.OnFocusChangeListener()
  {
    public final void onFocusChange(View paramAnonymousView, boolean paramAnonymousBoolean)
    {
      ...
      {
        str = ModifyPasswordSettingActivity.b(ModifyPasswordSettingActivity.this).c();
      ...
      for (;;)
      {
        ...
        if (paramAnonymousBoolean)
        {
          if (!localK.a(str, ModifyPasswordSettingActivity.c(ModifyPasswordSettingActivity.this), ModifyPasswordSettingActivity.d(ModifyPasswordSettingActivity.this))) {
        ...
        else if (!localK.a(str, ModifyPasswordSettingActivity.c(ModifyPasswordSettingActivity.this), ModifyPasswordSettingActivity.d(ModifyPasswordSettingActivity.this)))
        {
          ModifyPasswordSettingActivity.b(ModifyPasswordSettingActivity.this).b();
  ...
  private final View.OnFocusChangeListener q = new View.OnFocusChangeListener()
  {
    public final void onFocusChange(View paramAnonymousView, boolean paramAnonymousBoolean)
    {
      ...
      {
        str1 = ModifyPasswordSettingActivity.g(ModifyPasswordSettingActivity.this).c();
        if (!at.spardat.bcrmobile.e.d.a(str1)) {
          break label113;
        }
        String str2 = ModifyPasswordSettingActivity.this.getResources().getString(2131165487);
        Object[] arrayOfObject = new Object[1];
        arrayOfObject[0] = ModifyPasswordSettingActivity.this.getResources().getString(2131165423);
        str3 = String.format(str2, arrayOfObject);
        if (paramAnonymousBoolean) {
          ModifyPasswordSettingActivity.g(ModifyPasswordSettingActivity.this).b(str3);
        }
      }
      else
      {
      ...
      ModifyPasswordSettingActivity.g(ModifyPasswordSettingActivity.this).a(str3);
      return;
      label113:
      if (ModifyPasswordSettingActivity.b(ModifyPasswordSettingActivity.this) != null)
      {
        if (!str1.equals(ModifyPasswordSettingActivity.b(ModifyPasswordSettingActivity.this).c()))
        {
          if (paramAnonymousBoolean)
          {
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    LinearLayout localLinearLayout = (LinearLayout)this.g.findViewById(2131427823);
    ...
    this.j = ((LinearLayout)localLayoutInflater.inflate(2130903161, null));
    this.k = new b(this, true, getString(2131165423), "");
    this.k.c(16);
    EditText localEditText3 = (EditText)this.k.findViewById(2131427723);
    ...
    localEditText3.setOnEditorActionListener(this.r);
    ...
    RelativeLayout localRelativeLayout = (RelativeLayout)this.g.findViewById(2131427405);
    this.m = ((Button)localRelativeLayout.findViewById(2131427824));
    ...
    this.l = localRelativeLayout.findViewById(2131427825);
