  ...
  implements AdapterView.OnItemSelectedListener
{
  ...
  public final void onItemSelected(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    if (!d.a(RapidTransferPaymentActivity.d(this.a)))
    {
      ...
      arrayOfObject[0] = d.a(this.a.getApplicationContext(), RapidTransferPaymentActivity.i(this.a).getAccountSaldo().trim(), RapidTransferPaymentActivity.i(this.a).getAccountCurrency(), true);
      arrayOfObject[1] = " ";
      arrayOfObject[2] = RapidTransferPaymentActivity.i(this.a).getAccountCurrency();
