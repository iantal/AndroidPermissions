  ...
  implements AdapterView.OnItemSelectedListener
{
  ...
  public final void onItemSelected(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    {
      TextView localTextView = (TextView)this.a.findViewById(2131427423);
      Object[] arrayOfObject = new Object[3];
      arrayOfObject[0] = d.a(this.a.getApplicationContext(), CurrentAccountRapidTransferPaymentActivity.m(this.a).getAccountSaldo().trim(), CurrentAccountRapidTransferPaymentActivity.m(this.a).getAccountCurrency(), true);
      arrayOfObject[1] = " ";
      arrayOfObject[2] = CurrentAccountRapidTransferPaymentActivity.m(this.a).getAccountCurrency();
      localTextView.setText(d.a(arrayOfObject));
