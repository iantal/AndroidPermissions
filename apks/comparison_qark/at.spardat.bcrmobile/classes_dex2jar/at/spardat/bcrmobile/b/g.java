  ...
  extends BaseAdapter
{
  ...
  public final View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (this.a != null)
    {
      localTermDepositNameModel = (TermDepositNameModel)this.a.get(paramInt);
      if ("DEFAULT_COMBO_KEY".equals(localTermDepositNameModel.getDepositName())) {
    ...
    localTextView.setText(localTermDepositNameModel.getDepositName());
    return paramView;
  }
}
